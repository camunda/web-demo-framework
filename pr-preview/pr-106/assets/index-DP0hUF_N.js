const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/driver-CTZuBZOi.css","assets/diagram-js-DAKGYcfb.css","assets/bpmn-js-BEOU0ddW.css","assets/bpmn-embedded-CpBeWzVm.css","assets/RuntimeDiagram-DTnJz5cT.js","assets/vendor-react-9Ma26nY1.js","assets/Viewer-D_7S4Gwm.js","assets/MonacoEditor-bqKos0LD.js","assets/MonacoEditor-CYJFmcx2.css","assets/vendor-modeler-Bt2tvxef.js","assets/vendor-design-system-eFCp_OAm.js","assets/vendor-design-system-DeH1oJZm.css","assets/parser-DkgAe_kI.js","assets/ModelEditor-Dwlgp6JA.css","assets/FormRenderer-DzLbDUG5.js","assets/FormRenderer-D1JIHOW6.css"])))=>i.map(i=>d[i]);
var $t=Object.defineProperty;var Gt=(e,n,t)=>n in e?$t(e,n,{enumerable:!0,configurable:!0,writable:!0,value:t}):e[n]=t;var $=(e,n,t)=>Gt(e,typeof n!="symbol"?n+"":n,t);import{r as h,j as i,i as Vt}from"./vendor-react-9Ma26nY1.js";import{B as J,a as te,L as Ve,S as vn,b as Mn,c as xn,d as Nn,e as En,A as se,f as de,g as le,I as $n,C as Yt,h as Qt,i as qt,j as Jt,k as Ht,l as Wt,T as Zt,m as Kt,n as on,o as an,p as Xt,q as er}from"./vendor-design-system-eFCp_OAm.js";(function(){const n=document.createElement("link").relList;if(n&&n.supports&&n.supports("modulepreload"))return;for(const o of document.querySelectorAll('link[rel="modulepreload"]'))r(o);new MutationObserver(o=>{for(const s of o)if(s.type==="childList")for(const d of s.addedNodes)d.tagName==="LINK"&&d.rel==="modulepreload"&&r(d)}).observe(document,{childList:!0,subtree:!0});function t(o){const s={};return o.integrity&&(s.integrity=o.integrity),o.referrerPolicy&&(s.referrerPolicy=o.referrerPolicy),o.crossOrigin==="use-credentials"?s.credentials="include":o.crossOrigin==="anonymous"?s.credentials="omit":s.credentials="same-origin",s}function r(o){if(o.ep)return;o.ep=!0;const s=t(o);fetch(o.href,s)}})();const nr="modulepreload",tr=function(e){return"/pr-preview/pr-106/"+e},Gn={},ce=function(n,t,r){let o=Promise.resolve();if(t&&t.length>0){let d=function(a){return Promise.all(a.map(l=>Promise.resolve(l).then(u=>({status:"fulfilled",value:u}),u=>({status:"rejected",reason:u}))))};document.getElementsByTagName("link");const p=document.querySelector("meta[property=csp-nonce]"),g=(p==null?void 0:p.nonce)||(p==null?void 0:p.getAttribute("nonce"));o=d(t.map(a=>{if(a=tr(a),a in Gn)return;Gn[a]=!0;const l=a.endsWith(".css"),u=l?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${a}"]${u}`))return;const c=document.createElement("link");if(c.rel=l?"stylesheet":nr,l||(c.as="script"),c.crossOrigin="",c.href=a,g&&c.setAttribute("nonce",g),document.head.appendChild(c),l)return new Promise((f,_)=>{c.addEventListener("load",f),c.addEventListener("error",()=>_(new Error(`Unable to preload CSS for ${a}`)))})}))}function s(d){const p=new Event("vite:preloadError",{cancelable:!0});if(p.payload=d,window.dispatchEvent(p),!p.defaultPrevented)throw d}return o.then(d=>{for(const p of d||[])p.status==="rejected"&&s(p.reason);return n().catch(s)})},rr="io.camunda.agenticai:aiagent",ke="http://www.omg.org/spec/BPMN/20100524/MODEL",ir="http://camunda.org/schema/zeebe/1.0";function kn(e,n){return Array.from(e.getElementsByTagNameNS(ir,n))}function ft(e,n){return kn(e,n).filter(t=>or(t)===e)}function or(e){let n=e.parentElement;for(;n;){if(n.namespaceURI===ke&&n.localName!=="extensionElements")return n;n=n.parentElement}return null}function Pn(e){const n=ft(e,"taskDefinition")[0],t=n==null?void 0:n.getAttribute("type");return t||(e.localName==="scriptTask"?e.getAttribute("id")??null:null)}function Vn(e){const n=Array.from(e.children).find(t=>t.namespaceURI===ke&&t.localName==="documentation");return((n==null?void 0:n.textContent)??"").trim()}function Yn(e){if(!e)return"";const n=e.startsWith("=")?e.slice(1):e,t=n.match(/"((?:[^"\\]|\\.)*)"/g);return t?t.map(r=>r.slice(1,-1).replace(/\\n/g,`
`).replace(/\\t/g,"	").replace(/\\"/g,'"').replace(/\\\\/g,"\\")).join("").trim():n.trim()}function wt(e){const n=[],t=r=>{for(const o of Array.from(r.attributes))n.push(o.value);for(const o of Array.from(r.children))t(o)};return t(e),n.join(`
`)}function ar(e){return yt(wt(e))}function sr(e){const n=Array.from(e.children).find(t=>t.namespaceURI===ke&&t.localName==="extensionElements");return n?yt(wt(n)):[]}function yt(e){const n=/fromAi\(\s*toolCall\.([A-Za-z_$][\w$]*)\s*,\s*"((?:[^"\\]|\\.)*)"\s*(?:,\s*"(\w+)")?/g,t=[],r=new Set;for(const o of e.matchAll(n)){const s=o[1];r.has(s)||(r.add(s),t.push({name:s,description:(o[2]??"").replace(/&#10;/g,`
`).replace(/\\"/g,'"').replace(/&quot;/g,'"').replace(/&#39;/g,"'").trim(),type:o[3]??"string"}))}return t}function dr(e){const n={};for(const t of ft(e,"input")){const r=t.getAttribute("target");r&&(n[r]=t.getAttribute("source")??"")}return n}function lr(e){return Array.from(e.getElementsByTagNameNS(ke,"adHocSubProcess")).filter(n=>(Pn(n)??"").startsWith(rr))}const cr=new Set(["subProcess","adHocSubProcess","callActivity"]),mr=new Set(["adHocSubProcess","subProcess","transaction"]);function pr(e){let n=e.parentElement;for(;n;){if(n.namespaceURI===ke&&mr.has(n.localName))return n;n=n.parentElement}return null}function ur(e,n){const t=dr(e),r=Number((t["data.limits.maxModelCalls"]??"").replace(/^=/,""));return{elementId:e.getAttribute("id")??"agent",label:e.getAttribute("name")??"Agent",jobType:Pn(e),systemPrompt:Yn(t["data.systemPrompt.prompt"]),userPrompt:Yn(t["data.userPrompt.prompt"]),maxModelCalls:Number.isFinite(r)&&r>0?r:10,tools:n}}function gr(e,n){var u;const t=e.getAttribute("id")??"",r=e.getAttribute("name")??t,o=lr(e);o.length>1&&n.push({severity:"warning",elementId:o.map(c=>c.getAttribute("id")).join(", "),message:`Process "${r}" hosts ${o.length} AI Agent sub-processes (${o.map(c=>c.getAttribute("id")).join(", ")}). Each gets its own independent agent state (turn counter, called tools) — the run itself is shared across hosts, but each host's agent state within it is not.`});const s=[],d=new Map(o.map(c=>[c,[]]));for(const c of Array.from(e.getElementsByTagName("*"))){if(c.namespaceURI!==ke||o.includes(c))continue;const f=c.getAttribute("id");if(!f)continue;const _=pr(c),y=_&&o.includes(_)?_:null;if(y&&cr.has(c.localName)){const k=c.getAttribute("name")??f,B=Vn(c);s.push({elementId:f,label:k,jobType:"",documentation:B,isTool:!0,compound:!0}),d.get(y).push({elementId:f,label:k,jobType:"",documentation:B,args:sr(c),compound:!0});continue}const b=Pn(c);if(!b)continue;const M={elementId:f,label:c.getAttribute("name")??f,jobType:b,documentation:Vn(c),isTool:y!=null};s.push(M),y&&d.get(y).push({elementId:f,label:M.label,jobType:b,documentation:M.documentation,args:ar(c)})}const p=o.map(c=>ur(c,d.get(c))),g=Array.from(e.getElementsByTagNameNS(ke,"userTask")).map(c=>{var f;return{elementId:c.getAttribute("id")??"",label:c.getAttribute("name")??c.getAttribute("id")??"",formId:((f=kn(c,"formDefinition")[0])==null?void 0:f.getAttribute("formId"))??void 0}}),a=e.getElementsByTagNameNS(ke,"startEvent")[0],l=a?((u=kn(a,"formDefinition")[0])==null?void 0:u.getAttribute("formId"))??void 0:void 0;return{processId:t,processName:r,tasks:s,agents:p,userTasks:g,startFormId:l}}function hr(e,n={}){const t=new DOMParser().parseFromString(e,"application/xml"),r=t.getElementsByTagName("parsererror")[0];if(r)throw new Error(`Invalid BPMN XML: ${r.textContent}`);const o=Array.from(t.getElementsByTagNameNS(ke,"process"));if(o.length===0)throw new Error("No <bpmn:process> in the diagram.");const s=[],d=o.map(g=>gr(g,s));let p=n.processId?d.find(g=>g.processId===n.processId):void 0;return n.processId&&!p&&s.push({severity:"warning",message:`Requested process "${n.processId}" not found — falling back to "${d[0].processId}".`}),p??(p=d[0]),d.length>1&&s.push({severity:"warning",message:`Diagram has ${d.length} <bpmn:process> elements (${d.map(g=>g.processId).join(", ")}); using "${p.processId}" as the active process. Pass a processId to parseModel to target another.`}),{processes:d,diagnostics:s,processId:p.processId,processName:p.processName,tasks:p.tasks,agent:p.agents[0]??null,agents:d.flatMap(g=>g.agents),userTasks:p.userTasks,startFormId:p.startFormId}}function br(e){return e?e.imageId?{imageId:e.imageId}:e.imageName?{imageName:e.imageName}:{}:{}}function vt(e,n){return n?e.pixels:e.imageId??e.pixels}const _r="No image selected — pick or upload a photo to read.";function Qn(){return _r}function fr(e,n){return async t=>{const r=e.resolve(n);if(!r)return Qn();const o=vt(r,e.live);if(o===void 0)return Qn();try{return await e.read(o,t)}catch(s){return`Couldn't read the image (${s instanceof Error?s.message:String(s)}).`}}}function wr(e,n){return async()=>{const t=e.resolve(n);if(t)return vt(t,e.live)}}function yr(){return`<!doctype html><html><head><meta charset="utf-8"></head><body><script>
    "use strict";
    ...
    post({ kind: "ready" });
  <\/script></body></html>`}function Mt(e,n={}){const{timeoutMs:t=5e3,onTrace:r,onVision:o,onImage:s}=n,d=`${Date.now()}-${Math.random().toString(36).slice(2)}`;return new Promise((p,g)=>{const a=document.createElement("iframe");a.setAttribute("sandbox","allow-scripts"),a.style.display="none",a.setAttribute("aria-hidden","true");let l=!1,u;const c=()=>{u&&clearTimeout(u),window.removeEventListener("message",_),a.remove()},f=b=>{l||(l=!0,c(),b())};function _(b){var k;if(b.source!==a.contentWindow)return;const M=b.data;if(!(!M||typeof M!="object")){if(M.kind==="ready"){const B=e.job,q=e.kind==="run-handler"?{kind:"run-handler",id:d,source:e.source,job:B,hasVision:e.hasVision}:{kind:"run-agent",id:d,source:e.source,job:B};(k=a.contentWindow)==null||k.postMessage(q,"*");return}"id"in M&&M.id!==d||(M.kind==="trace"?r==null||r(M.text):M.kind==="vision-request"?y(M.callId,o,"vision",M.prompt):M.kind==="image-request"?y(M.callId,s,"image"):M.kind==="result"?f(()=>p(M.value)):M.kind==="error"&&f(()=>g(new Error(M.message))))}}function y(b,M,k,...B){const q=H=>{var fe;return(fe=a.contentWindow)==null?void 0:fe.postMessage(H,"*")};if(!M){q({kind:"helper-error",id:d,callId:b,message:`${k} helper is not available.`});return}Promise.resolve().then(()=>M(...B)).then(H=>q({kind:"helper-result",id:d,callId:b,value:H}),H=>q({kind:"helper-error",id:d,callId:b,message:H instanceof Error?H.message:String(H)}))}window.addEventListener("message",_),u=setTimeout(()=>{f(()=>g(new Error(`Handler timed out after ${t}ms — the sandboxed run was terminated.`)))},t),a.srcdoc=yr(),document.body.appendChild(a)})}function xt(e){return{key:e.key,type:e.type,elementId:e.elementId,instanceKey:e.instanceKey,variables:e.variables??{}}}function vr(e,n,t){const r=typeof t.vision=="function";return Mt({kind:"run-handler",source:e,job:xt(n),hasVision:r},{onTrace:t.trace,onVision:t.vision?o=>t.vision(o):void 0,onImage:t.image?()=>t.image():void 0})}function Mr(e,n){return Mt({kind:"run-agent",source:e,job:xt(n)})}function Nt(e,n){try{new Function(`"use strict"; return (${e});`)}catch{throw new Error(`${n} has a syntax error.`)}}function xr(e){return Nt(e,"Handler code"),(n,t)=>vr(e,n,t)}function Nr(e){return Nt(e,"Agent code"),n=>Mr(e,n)}function Er(e,n,t,r){return{sleep:o=>new Promise(s=>setTimeout(s,o)),trace:o=>n({kind:"tool",text:`   ${o}`,elementId:e.elementId,turn:t}),text:(o,s="")=>{const d=e.variables[o];return typeof d=="string"?d:d==null?s:String(d)},num:(o,s=0)=>{const d=e.variables[o],p=typeof d=="number"?d:Number(d);return Number.isFinite(p)?p:s},...r?{vision:fr(r,e.instanceKey),image:wr(r,e.instanceKey)}:{}}}function kr(e){if(e===void 0)return"undefined";try{return JSON.stringify(e)}catch{return"[unserializable value]"}}function Ir(e,n,t,r,o){const s={},d=e.processes.flatMap(g=>g.tasks),p=new Map(d.map(g=>[g.elementId,g.label]));for(const g of d)g.compound||s[g.jobType]||(s[g.jobType]=async a=>{const l=n[a.elementId];if(!l)throw new Error(`No handler registered for ${a.elementId} (job type ${a.type})`);const u=p.get(a.elementId)??a.elementId,c=r==null?void 0:r.current;t({kind:"tool",text:`▶ ${u}`,elementId:a.elementId,turn:c});const f=await l(a,Er(a,t,c,o));return t({kind:"vars",text:`  ↳ ${kr(f)}`,elementId:a.elementId,result:f,turn:c}),f});return s}const Tr=/\{\{\s*([A-Za-z][A-Za-z0-9_-]*)\s*\}\}/g;function nn(...e){const n=Object.create(null);for(const t of e)if(t)for(const r of Object.keys(t))n[r]=t[r];return n}function Et(e){return(e.split("/").pop()??e).replace(/\.[^./]+$/,"")}function kt(e){return e.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;")}function jr(e){return kt(e).replace(/"/g,"&quot;").replace(/\n/g,"&#10;").replace(/\t/g,"&#9;")}function Sr(e){return e.replace(/\\/g,"\\\\").replace(/&/g,"&amp;").replace(/"/g,"\\&#34;").replace(/\n/g,"&#10;").replace(/\t/g,"&#9;").replace(/</g,"&lt;").replace(/>/g,"&gt;")}function Pr(e){return JSON.stringify(e).slice(1,-1)}function Ar(e,n){const t=e.lastIndexOf("<",n),r=e.lastIndexOf(">",n);if(t<=r)return"text";const o=e.slice(t,n);if((o.match(/"/g)??[]).length%2===0)return"text";const d=o.lastIndexOf('"');return(o.slice(d+1).match(/&#34;|&quot;/g)??[]).length%2===1?"feel-literal":"attribute"}function Dr(e,n,t="xml"){const r=[],o=new Set;return{result:e.replace(Tr,(d,p,g)=>{const a=p.trim();if(!Object.prototype.hasOwnProperty.call(n,a))return o.has(a)||(o.add(a),r.push(a)),d;const l=n[a];if(t==="json")return Pr(l);const u=Ar(e,g);return u==="feel-literal"?Sr(l):u==="attribute"?jr(l):kt(l)}),unresolved:r}}function Cr(){return{processes:[],diagnostics:[],processId:"",processName:"",tasks:[],agent:null,agents:[],userTasks:[],startFormId:void 0}}function Br(e,n={},t=e.bpmn,r={}){const o=[],s=nn(e.templates,r),{result:d,unresolved:p}=Dr(t,s,"xml");for(const M of p)o.push({severity:"warning",message:`Template placeholder "{{${M}}}" has no matching prompt/template content — left in the model as-is, not substituted.`});let g;try{g=hr(d)}catch(M){return o.push({severity:"error",message:M instanceof Error?M.message:String(M)}),{resolvedBpmn:d,model:Cr(),handlers:{},forms:{},diagnostics:o,hasErrors:!0}}o.push(...g.diagnostics);const a=g.processes.flatMap(M=>M.tasks),l=new Map(e.handlers.map(M=>[M.elementId,M.source])),u={};for(const M of a){if(M.compound)continue;const k=n[M.elementId]??l.get(M.elementId);if(k===void 0){o.push({severity:"error",elementId:M.elementId,jobType:M.jobType,message:`No handler for "${M.label}" (${M.elementId}, job type "${M.jobType}"). Add a handler for this element, or remove it from the diagram.`});continue}try{u[M.elementId]=xr(k)}catch(B){o.push({severity:"error",elementId:M.elementId,jobType:M.jobType,message:`"${M.label}" (${M.elementId}): handler code didn't compile — ${B instanceof Error?B.message:String(B)}`})}}const c=new Set(a.map(M=>M.elementId)),f=new Set([...l.keys(),...Object.keys(n)]);for(const M of f)c.has(M)||o.push({severity:"error",elementId:M,message:`Handler "${M}" doesn't match any element in the current diagram — likely orphaned by a rename. Rename it back, or remove the handler.`});const _={},y=e.forms??{},b=(M,k)=>{if(!M)return;const B=y[M];B?_[M]=B:o.push({severity:"error",formId:M,message:`${k} references form "${M}", which has no matching schema.`})};for(const M of g.processes){b(M.startFormId,`The start event of process "${M.processName}"`);for(const k of M.userTasks)b(k.formId,`User task "${k.label}" (${k.elementId})`)}return{resolvedBpmn:d,model:g,handlers:u,forms:_,diagnostics:o,hasErrors:o.some(M=>M.severity==="error")}}function Lr(e){const n=e.indexOf("{");if(n<0)return null;let t=0;for(let r=n;r<e.length;r++)if(e[r]==="{")t++;else if(e[r]==="}"&&(t--,t===0))try{const o=JSON.parse(e.slice(n,r+1));return typeof o=="object"&&o!==null&&!Array.isArray(o)?o:null}catch{return null}return null}function In(e,n=220){const t=e.replace(/\s+/g," ").trim();return t.length>n?`${t.slice(0,n-1)}…`:t}function qn(e){const n=e.arguments??e.args??e.parameters??e.input;return n&&typeof n=="object"&&!Array.isArray(n)?n:{}}function Jn(e){if(!e)return[];const n=e.tool??e.name??e.action;if(typeof n=="string"&&n.trim())return[{name:n.trim(),args:qn(e)}];const t=e.tools??e.tool_calls??e.toolset??e.actions,r=Array.isArray(t)?t:Object.values(e).find(s=>Array.isArray(s))??[],o=[];for(const s of r)if(typeof s=="string")s.trim()&&o.push({name:s.trim(),args:{}});else if(s&&typeof s=="object"){const d=s,p=d.name??d.tool??d.id??d.function;typeof p=="string"&&p.trim()&&o.push({name:p.trim(),args:qn(d)})}return o}function Rr(e){if(!e)return!1;const n=e.done??e.finished??e.complete;return typeof n=="boolean"?n:typeof n=="string"?n.toLowerCase()==="true":!1}function Hn(e){const n=e.args.length?e.args.map(r=>`      ${r.name} (${r.type}) — ${r.description}`).join(`
`):"      (none)",t=e.documentation||e.label;return`${e.elementId}
    purpose: ${t}
    arguments:
${n}`}function Fr(e,n,t){const r=e.systemPrompt||"You are an agent driving a business process. Use the tools available to you.",o=t[0]??e.tools[0];if(t.length===0)return`${r}

Every tool has already run. Reply with JSON only — no prose, no explanation, no
markdown fence — exactly:

{"done": true}`;const s=o!=null&&o.args.length?`{${o.args.map(d=>`"${d.name}": "…"`).join(", ")}}`:"{}";return n?`${r}
...
character, with nothing added. When your work is finished, reply exactly
{"done": true} and no tool.`}function zr(e,n,t,r,o=[],s=[],d=!1){const p=e.userPrompt||"Carry out your task.",g=Object.entries(n).filter(([,l])=>typeof l=="string"&&l.trim().length>0).map(([l,u])=>`  ${l}: ${String(u)}`),a=[p,g.length?`Case data:
${g.join(`
...
`)}async function Or(e,n,t,r,o,s){let d="";n({kind:"llm",text:"LLM thinking…",key:t,pending:!0,turn:s});const p=await e(r,o,g=>{d+=g,n({kind:"llm",text:`${In(d)} ▍`,key:t,pending:!0,turn:s})});return n({kind:"llm",text:In(p||d)||"(empty reply)",key:t,pending:!1,turn:s}),p}function Ur(e,n){switch(e){case"number":return typeof n=="number"&&Number.isFinite(n)?{ok:!0,value:n}:typeof n=="string"&&n.trim()!==""&&Number.isFinite(Number(n))?{ok:!0,value:Number(n)}:{ok:!1};case"boolean":return typeof n=="boolean"?{ok:!0,value:n}:typeof n=="string"&&/^(true|false)$/i.test(n.trim())?{ok:!0,value:n.trim().toLowerCase()==="true"}:{ok:!1};default:return typeof n=="object"?{ok:!1}:{ok:!0,value:String(n)}}}function $r(e,n,t){const r={},o=new Map,s=new Map;for(const{tool:d,args:p}of e){const g={};for(const a of d.args){const l=p[a.name];if(!(l!=null&&l!=="")){n({kind:"error",text:`🤖 ${d.elementId}: model supplied no value for "${a.name}"`,turn:t,elementId:d.elementId});continue}const c=o.get(a.name);if(c!==void 0&&c!==d.elementId){n({kind:"error",text:`🤖 argument name collision on "${a.name}": both ${c} and ${d.elementId} declare it — ${c} already claimed it this turn, ${d.elementId}'s value is dropped`,turn:t,elementId:d.elementId});continue}const f=Ur(a.type,l);if(!f.ok){n({kind:"error",text:`🤖 ${d.elementId}: "${a.name}" is declared as ${a.type} but the model supplied ${JSON.stringify(l)} — rejected, not passed through`,turn:t,elementId:d.elementId});continue}r[a.name]=f.value,g[a.name]=f.value,o.set(a.name,d.elementId)}s.set(d.elementId,g)}return{variablesOut:r,forHistory:s}}function Gr(e,n,t,r={}){const{maxNewTokens:o=384,allowRepeats:s=!1,allowMultiToolTurns:d=!1,turnRef:p,requiredTools:g=[],maxEarlyDoneNudges:a=1}=r;let l=0;const u=new Set,c=[];let f=0,_=[],y=[];return async b=>{const M=b.variables,k=M.toolCallResult;for(k!==void 0&&c.length&&(c[c.length-1]=`${c[c.length-1]} → ${In(JSON.stringify(k),160)}`);;){const q=await B();if(q)return q}async function B(){if(l+=1,p&&(p.current=l),l>e.maxModelCalls)return t({kind:"error",text:`Turn budget spent (maxModelCalls=${e.maxModelCalls}) — completing the agent.`,turn:l}),{completionConditionFulfilled:!0};const q=s?e.tools:e.tools.filter(N=>!u.has(N.elementId)),H=[{role:"system",content:Fr(e,d,q)},{role:"user",content:zr(e,M,c,q,_,y,s)}];_=[],y=[];let fe;try{fe=await Or(n,t,`llm-turn-${l}`,H,o,l)}catch(N){return t({kind:"error",text:`LLM call failed: ${N instanceof Error?N.message:String(N)} — completing the agent.`,turn:l}),{completionConditionFulfilled:!0}}const me=Lr(fe);if(Rr(me)&&Jn(me).length===0){const N=g.filter(z=>!u.has(z));return N.length&&f<a?(f+=1,_=N,t({kind:"agent",text:`🤖 model says it is done, but ${N.join(", ")} hasn't run — asking once more`,turn:l}),null):(t({kind:"agent",text:"🤖 model says it is done",turn:l}),{completionConditionFulfilled:!0})}const Ie=Jn(me);if(Ie.length===0)return t({kind:"error",text:"🤖 model named no tool (and didn't say it was done) — asking again",turn:l}),y=['it named no tool and did not say it was done — reply with {"tool": "...", "arguments": {...}} or {"done": true}'],null;const K=[],oe=[],Q=[];for(const N of Ie){const z=e.tools.find(O=>O.elementId===N.name);if(!z){oe.push(N.name);continue}if(!s&&u.has(z.elementId)){Q.push(z.elementId);continue}K.push({tool:z,args:N.args})}if(oe.length&&t({kind:"error",text:`🤖 model named a tool that doesn't exist: ${oe.join(", ")} — nothing activated`,turn:l}),Q.length&&t({kind:"error",text:`🤖 model asked to re-run ${Q.join(", ")} — skipped (already run)`,turn:l}),K.length===0)return t({kind:"agent",text:"🤖 nothing activated — asking again",turn:l}),y=[...oe.length?[`${oe.join(", ")} ${oe.length===1?"is":"are"} not a real tool`]:[],...Q.length?[`${Q.join(", ")} has already run and will never run again — pick a different tool, or reply {"done": true} if nothing is left to do`]:[]],null;const{variablesOut:j,forHistory:E}=$r(K,t,l);for(const{tool:N}of K)u.add(N.elementId),c.push(`- ${N.elementId}(${JSON.stringify(E.get(N.elementId))})`);for(const{tool:N}of K)t({kind:"agent",text:`🤖 calling ${N.elementId}`,turn:l,elementId:N.elementId,args:E.get(N.elementId)??{}});return{activateElements:K.map(N=>({elementId:N.tool.elementId})),variables:j}}}}function Vr(e,n,t,r={}){const o=new Map(e.map(s=>[s.elementId,Gr(s,n,t,r)]));return async s=>{const d=o.get(s.elementId);if(!d)throw new Error(`No agent host registered for "${s.elementId}"`);return d(s)}}class Tn{__destroy_into_raw(){const n=this.__wbg_ptr;return this.__wbg_ptr=0,Wn.unregister(this),n}free(){const n=this.__destroy_into_raw();m.__wbg_testengine_free(n,0)}activateJobs(n,t,r,o){let s,d;try{const f=m.__wbindgen_add_to_stack_pointer(-16),_=A(n,m.__wbindgen_export,m.__wbindgen_export2),y=S,b=A(o,m.__wbindgen_export,m.__wbindgen_export2),M=S;m.testengine_activateJobs(f,this.__wbg_ptr,_,y,t,r,b,M);var p=w().getInt32(f+0,!0),g=w().getInt32(f+4,!0),a=w().getInt32(f+8,!0),l=w().getInt32(f+12,!0),u=p,c=g;if(l)throw u=0,c=0,F(a);return s=u,d=c,R(u,c)}finally{m.__wbindgen_add_to_stack_pointer(16),m.__wbindgen_export3(s,d,1)}}advanceTime(n){let t,r;try{const l=m.__wbindgen_add_to_stack_pointer(-16);m.testengine_advanceTime(l,this.__wbg_ptr,n);var o=w().getInt32(l+0,!0),s=w().getInt32(l+4,!0),d=w().getInt32(l+8,!0),p=w().getInt32(l+12,!0),g=o,a=s;if(p)throw g=0,a=0,F(d);return t=g,r=a,R(g,a)}finally{m.__wbindgen_add_to_stack_pointer(16),m.__wbindgen_export3(t,r,1)}}assignUserTask(n,t,r){let o,s;try{const c=m.__wbindgen_add_to_stack_pointer(-16),f=A(n,m.__wbindgen_export,m.__wbindgen_export2),_=S,y=A(t,m.__wbindgen_export,m.__wbindgen_export2),b=S;m.testengine_assignUserTask(c,this.__wbg_ptr,f,_,y,b,r);var d=w().getInt32(c+0,!0),p=w().getInt32(c+4,!0),g=w().getInt32(c+8,!0),a=w().getInt32(c+12,!0),l=d,u=p;if(a)throw l=0,u=0,F(g);return o=l,s=u,R(l,u)}finally{m.__wbindgen_add_to_stack_pointer(16),m.__wbindgen_export3(o,s,1)}}broadcastSignal(n,t){let r,o;try{const u=m.__wbindgen_add_to_stack_pointer(-16),c=A(n,m.__wbindgen_export,m.__wbindgen_export2),f=S,_=A(t,m.__wbindgen_export,m.__wbindgen_export2),y=S;m.testengine_broadcastSignal(u,this.__wbg_ptr,c,f,_,y);var s=w().getInt32(u+0,!0),d=w().getInt32(u+4,!0),p=w().getInt32(u+8,!0),g=w().getInt32(u+12,!0),a=s,l=d;if(g)throw a=0,l=0,F(p);return r=a,o=l,R(a,l)}finally{m.__wbindgen_add_to_stack_pointer(16),m.__wbindgen_export3(r,o,1)}}cancelInstance(n){let t,r;try{const l=m.__wbindgen_add_to_stack_pointer(-16),u=A(n,m.__wbindgen_export,m.__wbindgen_export2),c=S;m.testengine_cancelInstance(l,this.__wbg_ptr,u,c);var o=w().getInt32(l+0,!0),s=w().getInt32(l+4,!0),d=w().getInt32(l+8,!0),p=w().getInt32(l+12,!0),g=o,a=s;if(p)throw g=0,a=0,F(d);return t=g,r=a,R(g,a)}finally{m.__wbindgen_add_to_stack_pointer(16),m.__wbindgen_export3(t,r,1)}}completeAgentJob(n,t,r){let o,s;try{const c=m.__wbindgen_add_to_stack_pointer(-16),f=A(n,m.__wbindgen_export,m.__wbindgen_export2),_=S,y=A(t,m.__wbindgen_export,m.__wbindgen_export2),b=S,M=A(r,m.__wbindgen_export,m.__wbindgen_export2),k=S;m.testengine_completeAgentJob(c,this.__wbg_ptr,f,_,y,b,M,k);var d=w().getInt32(c+0,!0),p=w().getInt32(c+4,!0),g=w().getInt32(c+8,!0),a=w().getInt32(c+12,!0),l=d,u=p;if(a)throw l=0,u=0,F(g);return o=l,s=u,R(l,u)}finally{m.__wbindgen_add_to_stack_pointer(16),m.__wbindgen_export3(o,s,1)}}completeJob(n,t){let r,o;try{const u=m.__wbindgen_add_to_stack_pointer(-16),c=A(n,m.__wbindgen_export,m.__wbindgen_export2),f=S,_=A(t,m.__wbindgen_export,m.__wbindgen_export2),y=S;m.testengine_completeJob(u,this.__wbg_ptr,c,f,_,y);var s=w().getInt32(u+0,!0),d=w().getInt32(u+4,!0),p=w().getInt32(u+8,!0),g=w().getInt32(u+12,!0),a=s,l=d;if(g)throw a=0,l=0,F(p);return r=a,o=l,R(a,l)}finally{m.__wbindgen_add_to_stack_pointer(16),m.__wbindgen_export3(r,o,1)}}completeUserTask(n,t){let r,o;try{const u=m.__wbindgen_add_to_stack_pointer(-16),c=A(n,m.__wbindgen_export,m.__wbindgen_export2),f=S,_=A(t,m.__wbindgen_export,m.__wbindgen_export2),y=S;m.testengine_completeUserTask(u,this.__wbg_ptr,c,f,_,y);var s=w().getInt32(u+0,!0),d=w().getInt32(u+4,!0),p=w().getInt32(u+8,!0),g=w().getInt32(u+12,!0),a=s,l=d;if(g)throw a=0,l=0,F(p);return r=a,o=l,R(a,l)}finally{m.__wbindgen_add_to_stack_pointer(16),m.__wbindgen_export3(r,o,1)}}correlateMessage(n,t,r){let o,s;try{const c=m.__wbindgen_add_to_stack_pointer(-16),f=A(n,m.__wbindgen_export,m.__wbindgen_export2),_=S,y=A(t,m.__wbindgen_export,m.__wbindgen_export2),b=S,M=A(r,m.__wbindgen_export,m.__wbindgen_export2),k=S;m.testengine_correlateMessage(c,this.__wbg_ptr,f,_,y,b,M,k);var d=w().getInt32(c+0,!0),p=w().getInt32(c+4,!0),g=w().getInt32(c+8,!0),a=w().getInt32(c+12,!0),l=d,u=p;if(a)throw l=0,u=0,F(g);return o=l,s=u,R(l,u)}finally{m.__wbindgen_add_to_stack_pointer(16),m.__wbindgen_export3(o,s,1)}}createInstance(n,t,r){let o,s;try{const c=m.__wbindgen_add_to_stack_pointer(-16),f=A(n,m.__wbindgen_export,m.__wbindgen_export2),_=S,y=A(t,m.__wbindgen_export,m.__wbindgen_export2),b=S;m.testengine_createInstance(c,this.__wbg_ptr,f,_,y,b,Hr(r)?Number.MAX_SAFE_INTEGER:r>>0);var d=w().getInt32(c+0,!0),p=w().getInt32(c+4,!0),g=w().getInt32(c+8,!0),a=w().getInt32(c+12,!0),l=d,u=p;if(a)throw l=0,u=0,F(g);return o=l,s=u,R(l,u)}finally{m.__wbindgen_add_to_stack_pointer(16),m.__wbindgen_export3(o,s,1)}}debugClear(){m.testengine_debugClear(this.__wbg_ptr)}debugCreateInstance(n,t,r){let o,s;try{const c=m.__wbindgen_add_to_stack_pointer(-16),f=A(n,m.__wbindgen_export,m.__wbindgen_export2),_=S,y=A(t,m.__wbindgen_export,m.__wbindgen_export2),b=S,M=A(r,m.__wbindgen_export,m.__wbindgen_export2),k=S;m.testengine_debugCreateInstance(c,this.__wbg_ptr,f,_,y,b,M,k);var d=w().getInt32(c+0,!0),p=w().getInt32(c+4,!0),g=w().getInt32(c+8,!0),a=w().getInt32(c+12,!0),l=d,u=p;if(a)throw l=0,u=0,F(g);return o=l,s=u,R(l,u)}finally{m.__wbindgen_add_to_stack_pointer(16),m.__wbindgen_export3(o,s,1)}}get debugIsPaused(){return m.testengine_debugIsPaused(this.__wbg_ptr)!==0}debugResume(){let n,t;try{const a=m.__wbindgen_add_to_stack_pointer(-16);m.testengine_debugResume(a,this.__wbg_ptr);var r=w().getInt32(a+0,!0),o=w().getInt32(a+4,!0),s=w().getInt32(a+8,!0),d=w().getInt32(a+12,!0),p=r,g=o;if(d)throw p=0,g=0,F(s);return n=p,t=g,R(p,g)}finally{m.__wbindgen_add_to_stack_pointer(16),m.__wbindgen_export3(n,t,1)}}debugStep(){let n,t;try{const a=m.__wbindgen_add_to_stack_pointer(-16);m.testengine_debugStep(a,this.__wbg_ptr);var r=w().getInt32(a+0,!0),o=w().getInt32(a+4,!0),s=w().getInt32(a+8,!0),d=w().getInt32(a+12,!0),p=r,g=o;if(d)throw p=0,g=0,F(s);return n=p,t=g,R(p,g)}finally{m.__wbindgen_add_to_stack_pointer(16),m.__wbindgen_export3(n,t,1)}}deploy(n){let t,r;try{const l=m.__wbindgen_add_to_stack_pointer(-16),u=A(n,m.__wbindgen_export,m.__wbindgen_export2),c=S;m.testengine_deploy(l,this.__wbg_ptr,u,c);var o=w().getInt32(l+0,!0),s=w().getInt32(l+4,!0),d=w().getInt32(l+8,!0),p=w().getInt32(l+12,!0),g=o,a=s;if(p)throw g=0,a=0,F(d);return t=g,r=a,R(g,a)}finally{m.__wbindgen_add_to_stack_pointer(16),m.__wbindgen_export3(t,r,1)}}deployForm(n){let t,r;try{const l=m.__wbindgen_add_to_stack_pointer(-16),u=A(n,m.__wbindgen_export,m.__wbindgen_export2),c=S;m.testengine_deployForm(l,this.__wbg_ptr,u,c);var o=w().getInt32(l+0,!0),s=w().getInt32(l+4,!0),d=w().getInt32(l+8,!0),p=w().getInt32(l+12,!0),g=o,a=s;if(p)throw g=0,a=0,F(d);return t=g,r=a,R(g,a)}finally{m.__wbindgen_add_to_stack_pointer(16),m.__wbindgen_export3(t,r,1)}}deployResource(n,t){let r,o;try{const u=m.__wbindgen_add_to_stack_pointer(-16),c=A(n,m.__wbindgen_export,m.__wbindgen_export2),f=S,_=A(t,m.__wbindgen_export,m.__wbindgen_export2),y=S;m.testengine_deployResource(u,this.__wbg_ptr,c,f,_,y);var s=w().getInt32(u+0,!0),d=w().getInt32(u+4,!0),p=w().getInt32(u+8,!0),g=w().getInt32(u+12,!0),a=s,l=d;if(g)throw a=0,l=0,F(p);return r=a,o=l,R(a,l)}finally{m.__wbindgen_add_to_stack_pointer(16),m.__wbindgen_export3(r,o,1)}}events(){let n,t;try{const a=m.__wbindgen_add_to_stack_pointer(-16);m.testengine_events(a,this.__wbg_ptr);var r=w().getInt32(a+0,!0),o=w().getInt32(a+4,!0),s=w().getInt32(a+8,!0),d=w().getInt32(a+12,!0),p=r,g=o;if(d)throw p=0,g=0,F(s);return n=p,t=g,R(p,g)}finally{m.__wbindgen_add_to_stack_pointer(16),m.__wbindgen_export3(n,t,1)}}failJob(n,t,r){let o,s;try{const c=m.__wbindgen_add_to_stack_pointer(-16),f=A(n,m.__wbindgen_export,m.__wbindgen_export2),_=S,y=A(r,m.__wbindgen_export,m.__wbindgen_export2),b=S;m.testengine_failJob(c,this.__wbg_ptr,f,_,t,y,b);var d=w().getInt32(c+0,!0),p=w().getInt32(c+4,!0),g=w().getInt32(c+8,!0),a=w().getInt32(c+12,!0),l=d,u=p;if(a)throw l=0,u=0,F(g);return o=l,s=u,R(l,u)}finally{m.__wbindgen_add_to_stack_pointer(16),m.__wbindgen_export3(o,s,1)}}migrate(n,t,r){let o,s;try{const c=m.__wbindgen_add_to_stack_pointer(-16),f=A(n,m.__wbindgen_export,m.__wbindgen_export2),_=S,y=A(t,m.__wbindgen_export,m.__wbindgen_export2),b=S,M=A(r,m.__wbindgen_export,m.__wbindgen_export2),k=S;m.testengine_migrate(c,this.__wbg_ptr,f,_,y,b,M,k);var d=w().getInt32(c+0,!0),p=w().getInt32(c+4,!0),g=w().getInt32(c+8,!0),a=w().getInt32(c+12,!0),l=d,u=p;if(a)throw l=0,u=0,F(g);return o=l,s=u,R(l,u)}finally{m.__wbindgen_add_to_stack_pointer(16),m.__wbindgen_export3(o,s,1)}}modify(n,t,r){let o,s;try{const c=m.__wbindgen_add_to_stack_pointer(-16),f=A(n,m.__wbindgen_export,m.__wbindgen_export2),_=S,y=A(t,m.__wbindgen_export,m.__wbindgen_export2),b=S,M=A(r,m.__wbindgen_export,m.__wbindgen_export2),k=S;m.testengine_modify(c,this.__wbg_ptr,f,_,y,b,M,k);var d=w().getInt32(c+0,!0),p=w().getInt32(c+4,!0),g=w().getInt32(c+8,!0),a=w().getInt32(c+12,!0),l=d,u=p;if(a)throw l=0,u=0,F(g);return o=l,s=u,R(l,u)}finally{m.__wbindgen_add_to_stack_pointer(16),m.__wbindgen_export3(o,s,1)}}constructor(){const n=m.testengine_new();return this.__wbg_ptr=n,Wn.register(this,this.__wbg_ptr,this),this}get now(){return m.testengine_now(this.__wbg_ptr)}reset(){m.testengine_reset(this.__wbg_ptr)}resolveIncident(n){let t,r;try{const l=m.__wbindgen_add_to_stack_pointer(-16),u=A(n,m.__wbindgen_export,m.__wbindgen_export2),c=S;m.testengine_resolveIncident(l,this.__wbg_ptr,u,c);var o=w().getInt32(l+0,!0),s=w().getInt32(l+4,!0),d=w().getInt32(l+8,!0),p=w().getInt32(l+12,!0),g=o,a=s;if(p)throw g=0,a=0,F(d);return t=g,r=a,R(g,a)}finally{m.__wbindgen_add_to_stack_pointer(16),m.__wbindgen_export3(t,r,1)}}setVariables(n,t,r){let o,s;try{const c=m.__wbindgen_add_to_stack_pointer(-16),f=A(n,m.__wbindgen_export,m.__wbindgen_export2),_=S,y=A(t,m.__wbindgen_export,m.__wbindgen_export2),b=S;m.testengine_setVariables(c,this.__wbg_ptr,f,_,y,b,r);var d=w().getInt32(c+0,!0),p=w().getInt32(c+4,!0),g=w().getInt32(c+8,!0),a=w().getInt32(c+12,!0),l=d,u=p;if(a)throw l=0,u=0,F(g);return o=l,s=u,R(l,u)}finally{m.__wbindgen_add_to_stack_pointer(16),m.__wbindgen_export3(o,s,1)}}snapshot(){let n,t;try{const a=m.__wbindgen_add_to_stack_pointer(-16);m.testengine_snapshot(a,this.__wbg_ptr);var r=w().getInt32(a+0,!0),o=w().getInt32(a+4,!0),s=w().getInt32(a+8,!0),d=w().getInt32(a+12,!0),p=r,g=o;if(d)throw p=0,g=0,F(s);return n=p,t=g,R(p,g)}finally{m.__wbindgen_add_to_stack_pointer(16),m.__wbindgen_export3(n,t,1)}}throwError(n,t,r){let o,s;try{const c=m.__wbindgen_add_to_stack_pointer(-16),f=A(n,m.__wbindgen_export,m.__wbindgen_export2),_=S,y=A(t,m.__wbindgen_export,m.__wbindgen_export2),b=S,M=A(r,m.__wbindgen_export,m.__wbindgen_export2),k=S;m.testengine_throwError(c,this.__wbg_ptr,f,_,y,b,M,k);var d=w().getInt32(c+0,!0),p=w().getInt32(c+4,!0),g=w().getInt32(c+8,!0),a=w().getInt32(c+12,!0),l=d,u=p;if(a)throw l=0,u=0,F(g);return o=l,s=u,R(l,u)}finally{m.__wbindgen_add_to_stack_pointer(16),m.__wbindgen_export3(o,s,1)}}tickNow(n){let t,r;try{const l=m.__wbindgen_add_to_stack_pointer(-16);m.testengine_tickNow(l,this.__wbg_ptr,n);var o=w().getInt32(l+0,!0),s=w().getInt32(l+4,!0),d=w().getInt32(l+8,!0),p=w().getInt32(l+12,!0),g=o,a=s;if(p)throw g=0,a=0,F(d);return t=g,r=a,R(g,a)}finally{m.__wbindgen_add_to_stack_pointer(16),m.__wbindgen_export3(t,r,1)}}unassignUserTask(n){let t,r;try{const l=m.__wbindgen_add_to_stack_pointer(-16),u=A(n,m.__wbindgen_export,m.__wbindgen_export2),c=S;m.testengine_unassignUserTask(l,this.__wbg_ptr,u,c);var o=w().getInt32(l+0,!0),s=w().getInt32(l+4,!0),d=w().getInt32(l+8,!0),p=w().getInt32(l+12,!0),g=o,a=s;if(p)throw g=0,a=0,F(d);return t=g,r=a,R(g,a)}finally{m.__wbindgen_add_to_stack_pointer(16),m.__wbindgen_export3(t,r,1)}}updateRetries(n,t){let r,o;try{const u=m.__wbindgen_add_to_stack_pointer(-16),c=A(n,m.__wbindgen_export,m.__wbindgen_export2),f=S;m.testengine_updateRetries(u,this.__wbg_ptr,c,f,t);var s=w().getInt32(u+0,!0),d=w().getInt32(u+4,!0),p=w().getInt32(u+8,!0),g=w().getInt32(u+12,!0),a=s,l=d;if(g)throw a=0,l=0,F(p);return r=a,o=l,R(a,l)}finally{m.__wbindgen_add_to_stack_pointer(16),m.__wbindgen_export3(r,o,1)}}updateUserTask(n,t){let r,o;try{const u=m.__wbindgen_add_to_stack_pointer(-16),c=A(n,m.__wbindgen_export,m.__wbindgen_export2),f=S,_=A(t,m.__wbindgen_export,m.__wbindgen_export2),y=S;m.testengine_updateUserTask(u,this.__wbg_ptr,c,f,_,y);var s=w().getInt32(u+0,!0),d=w().getInt32(u+4,!0),p=w().getInt32(u+8,!0),g=w().getInt32(u+12,!0),a=s,l=d;if(g)throw a=0,l=0,F(p);return r=a,o=l,R(a,l)}finally{m.__wbindgen_add_to_stack_pointer(16),m.__wbindgen_export3(r,o,1)}}}Symbol.dispose&&(Tn.prototype[Symbol.dispose]=Tn.prototype.free);function Yr(){return{__proto__:null,"./nanobpmn_engine_bg.js":{__proto__:null,__wbg___wbindgen_throw_bb96b2010945f0bc:function(n,t){throw new Error(R(n,t))},__wbindgen_cast_0000000000000001:function(n,t){const r=R(n,t);return Qr(r)},__wbindgen_object_drop_ref:function(n){F(n)}}}}const Wn=typeof FinalizationRegistry>"u"?{register:()=>{},unregister:()=>{}}:new FinalizationRegistry(e=>m.__wbg_testengine_free(e,1));function Qr(e){Xe===Ee.length&&Ee.push(Ee.length+1);const n=Xe;return Xe=Ee[n],Ee[n]=e,n}function qr(e){e<1028||(Ee[e]=Xe,Xe=e)}let Fe=null;function w(){return(Fe===null||Fe.buffer.detached===!0||Fe.buffer.detached===void 0&&Fe.buffer!==m.memory.buffer)&&(Fe=new DataView(m.memory.buffer)),Fe}function R(e,n){return Zr(e>>>0,n)}let Ke=null;function ln(){return(Ke===null||Ke.byteLength===0)&&(Ke=new Uint8Array(m.memory.buffer)),Ke}function Jr(e){return Ee[e]}let Ee=new Array(1024).fill(void 0);Ee.push(void 0,null,!0,!1);let Xe=Ee.length;function Hr(e){return e==null}function A(e,n,t){if(t===void 0){const p=en.encode(e),g=n(p.length,1)>>>0;return ln().subarray(g,g+p.length).set(p),S=p.length,g}let r=e.length,o=n(r,1)>>>0;const s=ln();let d=0;for(;d<r;d++){const p=e.charCodeAt(d);if(p>127)break;s[o+d]=p}if(d!==r){d!==0&&(e=e.slice(d)),o=t(o,r,r=d+e.length*3,1)>>>0;const p=ln().subarray(o+d,o+r),g=en.encodeInto(e,p);d+=g.written,o=t(o,r,d,1)>>>0}return S=d,o}function F(e){const n=Jr(e);return qr(e),n}let cn=new TextDecoder("utf-8",{ignoreBOM:!0,fatal:!0});cn.decode();const Wr=2146435072;let _n=0;function Zr(e,n){return _n+=n,_n>=Wr&&(cn=new TextDecoder("utf-8",{ignoreBOM:!0,fatal:!0}),cn.decode(),_n=n),cn.decode(ln().subarray(e,e+n))}const en=new TextEncoder;"encodeInto"in en||(en.encodeInto=function(e,n){const t=en.encode(e);return n.set(t),{read:e.length,written:t.length}});let S=0,m;function Kr(e,n){return m=e.exports,Fe=null,Ke=null,m}async function Xr(e,n){if(typeof Response=="function"&&e instanceof Response){if(!e.ok)throw new Error(`failed to fetch Wasm: ${e.status} ${e.statusText} fetching '${e.url}'`);if(typeof WebAssembly.instantiateStreaming=="function")try{return await WebAssembly.instantiateStreaming(e,n)}catch(o){if(t(e.type)&&e.headers.get("Content-Type")!=="application/wasm")console.warn("`WebAssembly.instantiateStreaming` failed because your server does not serve Wasm with `application/wasm` MIME type. Falling back to `WebAssembly.instantiate` which is slower. Original error:\n",o);else throw o}const r=await e.arrayBuffer();return await WebAssembly.instantiate(r,n)}else{const r=await WebAssembly.instantiate(e,n);return r instanceof WebAssembly.Instance?{instance:r,module:e}:r}function t(r){switch(r){case"basic":case"cors":case"default":return!0}return!1}}async function ei(e){if(m!==void 0)return m;e!==void 0&&(Object.getPrototypeOf(e)===Object.prototype?{module_or_path:e}=e:console.warn("using deprecated parameters for the initialization function; pass a single object instead")),e===void 0&&(e=new URL("/pr-preview/pr-106/assets/nanobpmn_engine_bg-DRNrIVE8.wasm",import.meta.url));const n=Yr();(typeof e=="string"||typeof Request=="function"&&e instanceof Request||typeof URL=="function"&&e instanceof URL)&&(e=fetch(e));const{instance:t,module:r}=await Xr(await e,n);return Kr(t)}let sn=null;function ni(e){return sn||(sn=ei(void 0).then(()=>{}).catch(n=>{throw sn=null,n})),sn}function Z(e){return JSON.parse(e)}class ti{constructor(n){$(this,"engine");this.engine=n}deploy(n){return JSON.parse(this.engine.deploy(n))}createInstance(n,t){return Z(this.engine.createInstance(n,t||"{}"))}activateJobs(n,t,r,o){return JSON.parse(this.engine.activateJobs(n,t,r,o))}completeJob(n,t){return Z(this.engine.completeJob(n,t||"{}"))}completeAgentJob(n,t){const{variables:r,...o}=t??{};return Z(this.engine.completeAgentJob(n,JSON.stringify(r??{}),JSON.stringify(o??{})))}failJob(n,t,r){return Z(this.engine.failJob(n,t,r))}throwError(n,t,r){return Z(this.engine.throwError(n,t,r))}updateRetries(n,t){return Z(this.engine.updateRetries(n,t))}resolveIncident(n){return Z(this.engine.resolveIncident(n))}setVariables(n,t,r){return Z(this.engine.setVariables(n,t||"{}",r))}broadcastSignal(n,t){return Z(this.engine.broadcastSignal(n,t||"{}"))}cancelInstance(n){return Z(this.engine.cancelInstance(n))}modify(n,t,r){return Z(this.engine.modify(n,JSON.stringify(t??[]),JSON.stringify(r??[])))}completeUserTask(n,t){return Z(this.engine.completeUserTask(n,t||"{}"))}assignUserTask(n,t,r){return Z(this.engine.assignUserTask(n,t,r))}unassignUserTask(n){return Z(this.engine.unassignUserTask(n))}updateUserTask(n,t){return Z(this.engine.updateUserTask(n,t||"{}"))}correlateMessage(n,t,r){return Z(this.engine.correlateMessage(n,t,r||"{}"))}advanceTime(n){return Z(this.engine.advanceTime(n))}reset(){this.engine.reset()}events(){return JSON.parse(this.engine.events())}snapshot(){return Z(this.engine.snapshot())}free(){this.engine.free()}}async function ri(e){return await ni(),new ti(new Tn)}class It extends Error{constructor(t,r){super(t);$(this,"retries");this.name="JobFailure",this.retries=r==null?void 0:r.retries}}function ii(e,n=[]){if(e.instances.filter(o=>!o.completed).length===0)return e.totalInstances>0?"completed":"idle";if(e.incidents.length>0)return"incidents";const r=new Set(n);return e.jobs.some(o=>!r.has(o.jobType))?"unhandledJobs":e.userTasks.some(o=>o.state==="Created")?"userTasks":e.timers.length>0?"timers":e.messageSubscriptions.length>0?"messages":e.signalSubscriptions.length>0?"signals":"idle"}function oi(e,n=[]){const t=new Set(n);return[...new Set(e.jobs.map(r=>r.jobType))].filter(r=>!t.has(r)).sort()}async function ai(e,n,t){let r;try{const o=await n(t);r=JSON.stringify(o??{})}catch(o){const s=o instanceof It&&o.retries!==void 0?o.retries:Math.max(0,t.retries-1),d=o instanceof Error?o.message:String(o);e.failJob(t.key,s,d);return}e.completeJob(t.key,r)}async function si(e,n,t){let r;try{r=await n(t),JSON.stringify(r)}catch(o){const s=o instanceof It&&o.retries!==void 0?o.retries:Math.max(0,t.retries-1),d=o instanceof Error?o.message:String(o);e.failJob(t.key,s,d);return}e.completeAgentJob(t.key,r)}async function di(e,n,t={}){const r=t.maxJobsPerActivation??10,o=t.lockTimeoutMs??3e4,s=t.worker??"bojtos",d=t.agents??{};for(const c of Object.keys(d))if(c in n)throw new Error(`dispatchRound: job type "${c}" is registered as both a worker and an agent — register it as exactly one`);const p=[];for(const[c,f]of Object.entries(n))for(const _ of e.activateJobs(c,r,o,s))p.push({handler:f,job:_});const g=[];for(const[c,f]of Object.entries(d))for(const _ of e.activateJobs(c,r,o,s))g.push({handler:f,job:_});for(const{handler:c,job:f}of p)await ai(e,c,f);for(const{handler:c,job:f}of g)await si(e,c,f);const a=e.snapshot(),l=p.length+g.length;if(l>0)return{snapshot:a,handled:l};const u=[...Object.keys(n),...Object.keys(d)];return{snapshot:a,handled:l,reason:ii(a,u),unhandled:oi(a,u)}}function li({bpmn:e}){const n=h.useRef(null),[t,r]=h.useState("loading"),[o,s]=h.useState(null),[d,p]=h.useState([]),[g,a]=h.useState(null),l=h.useRef(e),u=h.useRef(0),c=h.useRef(new Map),f=h.useCallback((j,E)=>{c.current.set(j,E)},[]),_=h.useCallback(j=>c.current.get(j),[]),y=h.useCallback((j,E)=>{const N=j.deploy(E);return l.current=E,c.current.clear(),p(N.processIds),a(null),s(null),N.processIds},[]);h.useEffect(()=>{let j=!1;return r("loading"),p([]),a(null),s(null),ri().then(E=>{if(j){E.free();return}try{y(E,e)}catch(N){E.free(),s(String(N)),r("error");return}n.current=E,r("ready")}).catch(E=>{j||(s(String(E)),r("error"))}),()=>{var E;j=!0,(E=n.current)==null||E.free(),n.current=null,c.current.clear()}},[e]);const b=h.useCallback(j=>{const E=n.current;if(!E)return null;try{const N=j(E);return a(N),s(null),N}catch(N){return s(String(N)),null}},[]),M=h.useCallback((j,E)=>b(N=>N.createInstance(j,E)),[b]),k=h.useCallback((j,E)=>b(N=>N.completeUserTask(j,E)),[b]),B=h.useCallback(j=>b(E=>E.advanceTime(j)),[b]),q=h.useCallback((j,E)=>b(N=>N.broadcastSignal(j,E)),[b]);function H(j,E){const[N]=j.activateJobs(E,1,3e4,"manual-control");if(!N)throw new Error(`No waiting job of type "${E}" to resolve.`);return N}const fe=h.useCallback((j,E)=>b(N=>{const z=H(N,j);return N.completeJob(z.key,E)}),[b]),me=h.useCallback((j,E,N)=>b(z=>{const O=H(z,j);return z.throwError(O.key,E,N)}),[b]),Ie=h.useCallback((j,E,N)=>b(z=>z.correlateMessage(j,E,N)),[b]),K=h.useCallback(async(j,E)=>{const N=n.current;if(!N)return null;const z=u.current;try{const O=await di(N,j,E);return n.current!==N||u.current!==z?null:(a(O.snapshot),s(null),O)}catch(O){return n.current!==N||u.current!==z||(a(N.snapshot()),s(String(O))),null}},[]),oe=h.useCallback(()=>{const j=n.current;if(j){u.current++;try{j.reset(),y(j,l.current)}catch(E){s(String(E))}}},[y]),Q=h.useCallback(j=>{const E=n.current;if(!E)return null;u.current++;try{return E.reset(),y(E,j)}catch(N){return s(String(N)),null}},[y]);return{phase:t,error:o,processIds:d,snapshot:g,createInstance:M,stepWorkers:K,completeUserTask:k,advanceTime:B,broadcastSignal:q,completeJobManually:fe,throwJobError:me,correlateMessage:Ie,reset:oe,redeploy:Q,setRunImage:f,getRunImage:_}}function ci(e,n){return e.slice(n)}function mi(e,n,t,r){const o=e.snapshot,s="⏸ waiting for a human — complete the task below to continue",d=o.userTasks.some(p=>p.state==="Created");if(e.handled>0){const p=o.activeElementIds.map(t),g=n.length?` via ${n.map(a=>`${t(a.from)} → ${t(a.to)}`).join(", ")}`:"";return o.completedInstances>=1?{kind:"done",text:`⏭ round handled ${e.handled} job${e.handled===1?"":"s"}${g} — ✅ process instance completed`}:d?{kind:"human",text:`⏭ round handled ${e.handled} job${e.handled===1?"":"s"}${g} — ${s}`}:{kind:"step",text:`⏭ round handled ${e.handled} job${e.handled===1?"":"s"}${g} — now at ${p.length?p.join(", "):"—"}`}}switch(e.reason){case"completed":return{kind:"done",text:"✅ process instance completed"};case"userTasks":return{kind:"human",text:s};case"timers":return{kind:"step",text:"⏱ waiting on a timer — advance the clock to continue"};case"messages":return{kind:"step",text:"✉ waiting on a message — correlate it to continue"};case"signals":return{kind:"step",text:"📶 waiting on a signal — broadcast it to continue"};case"incidents":return{kind:"error",text:"A job failed — incident on the diagram"};case"unhandledJobs":{const p=e.unhandled??[];return r&&p.length>0&&p.every(g=>r.has(g))?{kind:"human",text:s}:{kind:"error",text:`⏭ waiting on job type(s) with no worker registered: ${p.join(", ")}`}}case"idle":return{kind:"step",text:"Nothing to step — no instance is running."};default:return{kind:"step",text:e.reason?`Step blocked on an unrecognized reason: ${e.reason}`:"Nothing to step — no instance is running."}}}const pi="the Scripted or Endpoint brain";async function pn(e=pi){const n=navigator.gpu;if(!n)return`This browser doesn't expose WebGPU at all. Use a recent Chrome, Edge, or Safari 17+ with hardware acceleration on, or pick ${e}.`;let t;try{t=await n.requestAdapter()}catch(r){return`WebGPU adapter request failed (${r instanceof Error?r.message:String(r)}). Try ${e} instead.`}return t?null:`This browser supports the WebGPU API, but no GPU adapter is available — hardware acceleration may be off, or this device/VM has no usable GPU. Pick ${e} instead.`}const ui=[{id:"Qwen2.5-1.5B-Instruct-q4f16_1-MLC",label:"Qwen2.5 1.5B",downloadLabel:"~1.0 GB"},{id:"SmolLM2-1.7B-Instruct-q4f16_1-MLC",label:"SmolLM2 1.7B",downloadLabel:"~1.1 GB"},{id:"Llama-3.2-1B-Instruct-q4f16_1-MLC",label:"Llama 3.2 1B",downloadLabel:"~0.7 GB"},{id:"gemma-2-2b-it-q4f16_1-MLC",label:"Gemma 2 2B",downloadLabel:"~1.5 GB"},{id:"Llama-3.2-1B-Instruct-q4f32_1-MLC",label:"Llama 3.2 1B (f32, wider GPU support)",downloadLabel:"~1.1 GB"},{id:"SmolLM2-360M-Instruct-q4f32_1-MLC",label:"SmolLM2 360M (tiny, f32)",downloadLabel:"~0.6 GB"},{id:"SmolLM2-360M-Instruct-q4f16_1-MLC",label:"SmolLM2 360M (tiny)",downloadLabel:"~0.3 GB"}];function Tt(e){return jn.get(e)??{}}const jn=new Map;async function gi(){if(jn.size>0)return;const{prebuiltAppConfig:e}=await ce(async()=>{const{prebuiltAppConfig:n}=await import("./vendor-webllm-DT0Ab8E6.js");return{prebuiltAppConfig:n}},[]);for(const n of e.model_list)jn.set(n.model_id,{vramRequiredMB:n.vram_required_MB,requiredFeatures:n.required_features})}const hn=ui.map(e=>({id:e.id,label:`${e.label} (${e.downloadLabel})`,downloadLabel:e.downloadLabel,...Tt(e.id)})),jt=hn[0].id;async function hi(){return await gi(),hn.map(e=>({...e,...Tt(e.id)}))}function St(){const e=navigator.deviceMemory;return typeof e=="number"?e*1024:null}function bi(e,n=St()){return n==null||e.vramRequiredMB==null||n>=e.vramRequiredMB?null:`${e.label} needs roughly ${Math.round(e.vramRequiredMB)} MB of GPU memory; this device looks like it has about ${Math.round(n)} MB available. It may still work, but expect it to fail or fall back to slow shared memory — try a smaller model (e.g. SmolLM2 360M) if it doesn't load.`}async function _i(e){try{const{hasModelInCache:n}=await ce(async()=>{const{hasModelInCache:t}=await import("./vendor-webllm-DT0Ab8E6.js");return{hasModelInCache:t}},[]);return await n(e)}catch{return!1}}function un(e){return/device (was )?lost|device_hung|device_removed|already been disposed|gpudevicelostinfo/i.test(e)}function Zn(){return"The GPU device was lost — the driver reset while the model was loading or running. This is a browser/driver-level failure, not a problem with the model: fully quit and reopen the browser (a lost device usually persists for the life of the GPU process), check chrome://gpu still reports hardware acceleration, and update your GPU driver if it recurs. The Scripted and Endpoint brains don't use the GPU at all."}class dn{constructor(){$(this,"kind","browser");$(this,"model",null);$(this,"engine",null);$(this,"worker",null);$(this,"generation",0);$(this,"chat",async(n,t=512,r)=>{var s,d;const o=this.engine;if(!o||!this.model)throw new Error("BrowserBrain.chat called before connect()");try{const p=await o.chat.completions.create({messages:n,temperature:0,max_tokens:t,stream:!0});let g="";for await(const a of p){const l=((d=(s=a.choices[0])==null?void 0:s.delta)==null?void 0:d.content)??"";l&&(g+=l,r==null||r(l))}return g}catch(p){const g=p instanceof Error?p.message:String(p);throw un(g)?(this.teardown(),new Error(`The in-browser model stopped: ${Zn()}`)):p}})}async connect(n=jt,t){var g,a;const r=await pn();if(r)throw new Error(r);if(this.engine&&this.model===n)return n;const o=++this.generation,s=l=>{o===this.generation&&(t==null||t({progress:l.progress??0,text:l.text??""}))};this.teardown();let d,p;try{const{CreateWebWorkerMLCEngine:l}=await ce(async()=>{const{CreateWebWorkerMLCEngine:u}=await import("./vendor-webllm-DT0Ab8E6.js");return{CreateWebWorkerMLCEngine:u}},[]);p=new Worker(new URL("/pr-preview/pr-106/assets/webllm.worker-Dc1cCqhL.js",import.meta.url),{type:"module"}),d=await l(p,n,{initProgressCallback:s})}catch(l){if(p==null||p.terminate(),o!==this.generation)throw new Error("cancelled");const u=l instanceof Error?l.message:String(l);if(un(u))throw new Error(`Couldn't load ${n} in the browser (${u}). ${Zn()}`);const c=(a=(g=hn.find(f=>f.id===n))==null?void 0:g.requiredFeatures)==null?void 0:a.includes("shader-f16");throw new Error(`Couldn't load ${n} in the browser (${u}). `+(c?"This model needs WebGPU with shader-f16; try one of the f32 models in the list, or the endpoint brain.":"Try a smaller model, check your connection, or use the endpoint brain instead."))}if(o!==this.generation)throw d.unload().catch(()=>{}),p==null||p.terminate(),new Error("cancelled");return this.engine=d,this.worker=p??null,this.model=n,n}teardown(){const{engine:n,worker:t}=this;this.engine=null,this.worker=null,this.model=null,n==null||n.unload().catch(()=>{}),t==null||t.terminate()}cancelConnect(){this.generation++}dispose(){this.generation++,this.teardown()}}const Pt="http://localhost:11434/v1";function gn(e,n={hostname:(t=>(t=globalThis.location)==null?void 0:t.hostname)()??"",origin:(r=>(r=globalThis.location)==null?void 0:r.origin)()??""}){let o;try{o=new URL(At(e)).hostname}catch{return null}const s=d=>d==="localhost"||d==="127.0.0.1"||d==="::1"||d==="[::1]";return!s(o)||s(n.hostname)?null:`This page is served from ${n.origin||"a non-local origin"}, so it can't reach ${e}. A local model server only accepts requests from a page on localhost. Open this page at http://localhost instead, or use the Scripted or In-browser brain.`}function At(e){let n=e.trim().replace(/\/+$/,"");return n.endsWith("/chat/completions")&&(n=n.slice(0,-17)),/\/v\d+$/.test(n)||(n=`${n}/v1`),n}class Kn extends Error{constructor(n,t){super(n),this.status=t,this.name="HttpError"}}class Xn{constructor(n=Pt,t="",r=""){$(this,"kind","endpoint");$(this,"baseUrl");$(this,"model",null);$(this,"models",[]);$(this,"apiKey");$(this,"requestedModel");$(this,"chat",async(n,t=512,r)=>{var a,l,u;if(!this.model)throw new Error("EndpointBrain.chat called before connect()");const o=await fetch(`${this.baseUrl}/chat/completions`,{method:"POST",headers:this.headers(),body:JSON.stringify({model:this.model,messages:n,temperature:0,max_tokens:t,stream:!0})});if(!o.ok||!o.body){const c=await o.text().catch(()=>"");throw new Error(`chat/completions HTTP ${o.status} ${o.statusText}${c?` — ${c.slice(0,300)}`:""}`)}const s=o.body.getReader(),d=new TextDecoder;let p="",g="";for(;;){const{value:c,done:f}=await s.read();if(f)break;p+=d.decode(c,{stream:!0});let _;for(;(_=p.indexOf(`
`))>=0;){const y=p.slice(0,_).trim();if(p=p.slice(_+1),!y.startsWith("data:"))continue;const b=y.slice(5).trim();if(b==="[DONE]")continue;let M;try{M=JSON.parse(b)}catch{continue}M.model&&(this.model=M.model);const k=(a=M.choices)==null?void 0:a[0],B=((l=k==null?void 0:k.delta)==null?void 0:l.content)??((u=k==null?void 0:k.message)==null?void 0:u.content)??"";B&&(g+=B,r==null||r(B))}}return g});this.baseUrl=At(n),this.apiKey=t.trim(),this.requestedModel=r.trim()}headers(){const n={"Content-Type":"application/json"};return this.apiKey&&(n.Authorization=`Bearer ${this.apiKey}`),n}async listModels(){let n;try{n=await fetch(`${this.baseUrl}/models`,{headers:this.headers()})}catch(r){const o=gn(this.baseUrl);throw new Error(o??`Can't reach ${this.baseUrl} (${r instanceof Error?r.message:String(r)}). Is the server running? For Ollama, check the app is up — and if this page is served from another origin, allow it with OLLAMA_ORIGINS.`)}if(!n.ok)throw new Kn(`${this.baseUrl}/models returned HTTP ${n.status} ${n.statusText}`,n.status);const t=await n.json();return this.models=(t.data??[]).map(r=>r.id).filter(r=>!!r),this.models}async connect(){try{const n=await this.listModels(),t=this.requestedModel||n[0];if(!t)throw new Error(`No models available at ${this.baseUrl}. Pull one first — e.g. \`ollama pull llama3.2:3b\` — or name one explicitly.`);this.model=t}catch(n){const t=n instanceof Kn&&[404,405,501].includes(n.status);if(!this.requestedModel||!t)throw n;this.models=[],this.model=this.requestedModel}return await this.validate(),this.model}async validate(){const n=await fetch(`${this.baseUrl}/chat/completions`,{method:"POST",headers:this.headers(),body:JSON.stringify({model:this.model,messages:[{role:"user",content:"Reply with ok."}],temperature:0,max_tokens:1,stream:!1})}).catch(r=>{throw new Error(`Can't reach ${this.baseUrl}/chat/completions (${r instanceof Error?r.message:String(r)}). Check the endpoint URL, API key, model name, and any local CORS settings.`)});if(!n.ok){const r=await n.text().catch(()=>"");throw new Error(`chat/completions HTTP ${n.status} ${n.statusText}${r?` — ${r.slice(0,300)}`:""}`)}const t=await n.json().catch(()=>({}));t.model&&(this.model=t.model)}dispose(){}}const fi=[{id:"onnx-community/Florence-2-base-ft",label:"Florence-2 base",downloadLabel:"~0.4 GB"},{id:"onnx-community/Florence-2-large-ft",label:"Florence-2 large (higher quality)",downloadLabel:"~1.6 GB"}],Dt=fi.map(e=>({...e,label:`${e.label} (${e.downloadLabel})`})),Ct=Dt[0].id,wi="<OCR>",et="UNKNOWN (scripted brain — connect the in-browser model to read a photo)";function yi(e,n){if(e)return typeof e=="function"?e(n):e[n]}class vi{constructor(n){$(this,"kind","scripted-vision");$(this,"model",null);$(this,"read",async(n,t,r)=>{const o=typeof n=="string"?yi(this.lookup,n)??et:et;return r==null||r(o),o});this.lookup=n}dispose(){}}function Mi(e){return new vi(e)}class nt{constructor(){$(this,"kind","browser-vision");$(this,"model",null);$(this,"modelHandle",null);$(this,"processor",null);$(this,"loadImage",null);$(this,"generation",0);$(this,"read",async(n,t,r)=>{const o=this.modelHandle,s=this.processor,d=this.loadImage;if(!o||!s||!d||!this.model)throw new Error("BrowserVisionBrain.read called before connect()");const p=t&&t.startsWith("<")?t:wi,g=await d(n),a=s.construct_prompts(p),l=await s(g,a),u=await o.generate({...l,max_new_tokens:512,num_beams:1,do_sample:!1}),c=s.batch_decode(u,{skip_special_tokens:!1})[0],f=s.post_process_generation(c,p,g.size),_=xi(f,p);return r==null||r(_),_})}async connect(n=Ct,t){var p,g;const r=await pn("the scripted-vision fallback");if(r)throw new Error(r);if(this.modelHandle&&this.model===n)return n;const o=++this.generation,s=a=>{o===this.generation&&(t==null||t({progress:(a.progress??0)/100,text:a.file?`${a.status??"loading"} ${a.file}`:a.status??""}))};this.teardown();let d;try{const{Florence2ForConditionalGeneration:a,AutoProcessor:l,load_image:u}=await ce(async()=>{const{Florence2ForConditionalGeneration:_,AutoProcessor:y,load_image:b}=await import("./transformers.web-DIpo0ToB.js");return{Florence2ForConditionalGeneration:_,AutoProcessor:y,load_image:b}},[]),c=await a.from_pretrained(n,{dtype:"fp32",device:"webgpu",progress_callback:s}),f=await l.from_pretrained(n);d={model:c,processor:f,loadImage:u}}catch(a){if(o!==this.generation)throw new Error("cancelled");const l=a instanceof Error?a.message:String(a);throw new Error(`Couldn't load ${n} in the browser (${l}). Try the smaller Florence-2 base model, check your connection, or use the scripted-vision fallback.`)}if(o!==this.generation)throw Promise.resolve((g=(p=d.model).dispose)==null?void 0:g.call(p)).catch(()=>{}),new Error("cancelled");return this.modelHandle=d.model,this.processor=d.processor,this.loadImage=d.loadImage,this.model=n,n}teardown(){var t;const n=this.modelHandle;this.modelHandle=null,this.processor=null,this.loadImage=null,this.model=null,Promise.resolve((t=n==null?void 0:n.dispose)==null?void 0:t.call(n)).catch(()=>{})}cancelConnect(){this.generation++}dispose(){this.generation++,this.teardown()}}function xi(e,n){const t=e[n];if(typeof t=="string")return t.trim();if(t&&typeof t=="object"){const r=t.labels;return Array.isArray(r)?r.join(" ").trim():JSON.stringify(t)}return""}function Ni(){const[e,n]=h.useState("scripted"),[t,r]=h.useState("idle"),[o,s]=h.useState(null),[d,p]=h.useState(null),[g,a]=h.useState(null),[l,u]=h.useState(null),[c,f]=h.useState(null),[_,y]=h.useState(null),[b,M]=h.useState(jt),[k,B]=h.useState(Pt),[q,H]=h.useState(""),[fe,me]=h.useState([]),[Ie,K]=h.useState("idle"),[oe,Q]=h.useState(null),[j,E]=h.useState(""),[N,z]=h.useState(null),O=h.useRef(null),[Ye,Oe]=h.useState("scripted-vision"),[Qe,re]=h.useState("idle"),[qe,Te]=h.useState(null),[Je,Ae]=h.useState(Ct),[De,je]=h.useState(null),[bn,Ce]=h.useState(null),[He,pe]=h.useState(null),[ie,Be]=h.useState(null),X=h.useRef(null),Se=h.useRef(!1),Le=h.useRef(0),Re=h.useCallback(T=>async(...C)=>{try{return await T.chat(...C)}catch(G){const ye=G instanceof Error?G.message:String(G);throw T instanceof dn&&un(ye)&&(z(null),p(null),r("error"),s(ye)),G}},[]),L=h.useCallback(T=>async(...C)=>{try{return await T.read(...C)}catch(G){const ye=G instanceof Error?G.message:String(G);throw un(ye)&&(Be(null),je(null),re("error"),Te(ye)),G}},[]);h.useEffect(()=>{pn().then(T=>{f(T),u(T===null)}),pn("the scripted-vision fallback").then(T=>{pe(T),Se.current||(Se.current=!0,Oe(T===null?"browser-vision":"scripted-vision"))})},[]),h.useEffect(()=>{let T=!1;return y(null),_i(b).then(C=>{T||y(C)}),()=>{T=!0}},[b]),h.useEffect(()=>()=>{var T;return(T=O.current)==null?void 0:T.dispose()},[]),h.useEffect(()=>()=>{var T;return(T=X.current)==null?void 0:T.dispose()},[]);const we=h.useCallback(T=>{n(T),r("idle"),s(null),p(null),a(null),z(null)},[]),Pe=h.useCallback(T=>{var C,G;Se.current=!0,(C=X.current)==null||C.cancelConnect(),(G=X.current)==null||G.dispose(),X.current=null,Oe(T),re("idle"),Te(null),je(null),Ce(null),Be(null)},[]),ue=h.useCallback(()=>{var T;(T=O.current)==null||T.dispose(),O.current=null,z(null),p(null)},[]),tn=h.useCallback(()=>{O.current instanceof dn&&O.current.cancelConnect(),ue(),r("idle"),a(null),s(null)},[ue]),ge=h.useCallback(async()=>{const T=++Le.current,C=()=>T!==Le.current,G=gn(k);if(G){me([]),K("error"),Q(G);return}K("loading"),Q(null);const ye=new Xn(k,j);try{const xe=await ye.listModels();if(C())return;me(xe),K("ready"),H(We=>We&&xe.includes(We)?We:xe[0]??"")}catch(xe){if(C())return;me([]),H(""),K("error"),Q(xe instanceof Error?xe.message:String(xe))}finally{ye.dispose()}},[k,j]),Ue=h.useCallback(async()=>{var T;if(e==="scripted"){z(null),r("ready");return}if(e==="endpoint"){const C=gn(k);if(C){ue(),s(C),r("error");return}}r("connecting"),s(null),a(null);try{if(e==="browser"){const C=O.current instanceof dn?O.current:new dn;O.current&&O.current!==C&&O.current.dispose(),O.current=C;const G=await C.connect(b,a);p(G),z(()=>Re(C)),y(!0)}else{(T=O.current)==null||T.dispose();const C=new Xn(k,j,q);O.current=C;const G=await C.connect();p(G),z(()=>Re(C))}r("ready")}catch(C){const G=C instanceof Error?C.message:String(C);if(G==="cancelled")return;s(G),r("error"),z(null)}finally{a(null)}},[e,b,k,q,j,ue,Re]),Me=h.useCallback(()=>{var T;(T=X.current)==null||T.dispose(),X.current=null,Be(null),je(null)},[]),rn=h.useCallback(()=>{var T;(T=X.current)==null||T.cancelConnect(),Me(),re("idle"),Ce(null),Te(null)},[Me]),$e=h.useCallback(async()=>{if(Ye==="scripted-vision"){Me(),re("ready"),Te(null);return}re("connecting"),Te(null),Ce(null);try{const T=X.current instanceof nt?X.current:new nt;X.current&&X.current!==T&&X.current.dispose(),X.current=T;const C=await T.connect(Je,Ce);je(C),Be(()=>L(T)),re("ready")}catch(T){const C=T instanceof Error?T.message:String(T);if(C==="cancelled")return;Te(C),re("error"),Be(null),je(null)}finally{Ce(null)}},[Ye,Je,Me,L]);return{kind:e,setKind:we,status:t,error:o,modelInUse:d,progress:g,webgpu:l,webgpuReason:c,browserModelCached:_,cancelConnect:tn,browserModel:b,setBrowserModel:M,endpointUrl:k,setEndpointUrl:B,endpointModel:q,setEndpointModel:H,endpointModels:fe,endpointModelsStatus:Ie,endpointModelsError:oe,listEndpointModels:ge,apiKey:j,setApiKey:E,connect:Ue,chat:N,visionKind:Ye,setVisionKind:Pe,visionStatus:Qe,visionError:qe,visionModel:Je,setVisionModel:Ae,visionModelInUse:De,visionProgress:bn,visionWebgpuReason:He,connectVision:$e,cancelVisionConnect:rn,vision:ie}}const Sn="#s=",Ei=["scripted","browser","endpoint"];function ki(e){return typeof e=="string"&&Ei.includes(e)}function Ii(e){try{const n=JSON.parse(e);if(n&&typeof n=="object"){const t=n,r={};return ki(t.brain)&&(r.brain=t.brain),r}}catch{}return{}}function Bt(e=location.hash){if(!e.startsWith(Sn))return{};let n;try{n=decodeURIComponent(e.slice(Sn.length))}catch{return{}}return Ii(n)}function Ti(e){const n=Object.entries(e).filter(([,t])=>t!==void 0);return n.length===0?"":Sn+encodeURIComponent(JSON.stringify(Object.fromEntries(n)))}function ji(e){const n={...Bt(),...e},t=Ti(n),r=new URL(location.href);r.hash=t,history.replaceState(history.state,"",r)}const tt=[{kind:"scripted",label:"Scripted",hint:"No model. The example's stand-in decides — deterministic and offline."},{kind:"browser",label:"In-browser (WebGPU)",hint:"A small quantised model on your GPU. First run downloads weights."},{kind:"endpoint",label:"API endpoint",hint:"Any OpenAI-compatible server. Ollama by default. Local pages only."}],rt=[{kind:"scripted-vision",label:"Scripted",hint:"No model. The example's known plate is returned — deterministic and offline."},{kind:"browser-vision",label:"In-browser (WebGPU)",hint:"Reads the photo with a vision model on your GPU. First run downloads weights."}];function Si({brain:e,showText:n=!0,showVision:t=!1}){return i.jsxs("div",{className:"brain",children:[n&&i.jsx(Pi,{brain:e}),n&&t&&i.jsx("hr",{className:"brain-divider"}),t&&i.jsx(Ai,{brain:e})]})}function Pi({brain:e}){const n=tt.find(u=>u.kind===e.kind),t=gn(e.endpointUrl),[r,o]=h.useState(hn);h.useEffect(()=>{hi().then(o)},[]);const{kind:s,endpointUrl:d,apiKey:p,listEndpointModels:g}=e;h.useEffect(()=>{if(s!=="endpoint"||t)return;const u=setTimeout(()=>void g(),400);return()=>clearTimeout(u)},[s,d,p,t,g]);const a=r.find(u=>u.id===e.browserModel),l=a?bi(a,St()):null;return i.jsxs("div",{className:"brain-section",children:[i.jsxs("div",{className:"brain-modes",children:[i.jsx("div",{className:"brain-kinds",role:"group","aria-label":"Agent brain",children:tt.map(u=>i.jsx(J,{size:"sm",variant:e.kind===u.kind?"default":"secondary","aria-pressed":e.kind===u.kind,onClick:()=>e.setKind(u.kind),children:u.label},u.kind))}),i.jsxs("div",{className:"brain-status",children:[e.status==="ready"&&e.kind!=="scripted"&&i.jsx(te,{variant:"success",className:"brain-status-badge",children:e.modelInUse??"connected"}),e.status==="connecting"&&i.jsx(te,{variant:"info",className:"brain-status-badge",children:"connecting…"}),e.status==="error"&&i.jsx(te,{variant:"danger",className:"brain-status-badge",children:"not connected"})]})]}),i.jsx("p",{className:"field-hint",children:n.hint}),e.kind==="browser"&&i.jsxs("div",{className:"brain-config",children:[i.jsxs("div",{className:"field",children:[i.jsx(Ve,{htmlFor:"browser-model",children:"Model"}),i.jsxs(vn,{value:e.browserModel,onValueChange:e.setBrowserModel,disabled:e.status==="connecting",children:[i.jsx(Mn,{id:"browser-model",children:i.jsx(xn,{})}),i.jsx(Nn,{children:r.map(u=>i.jsx(En,{value:u.id,children:u.label},u.id))})]}),e.browserModelCached===!0&&i.jsx("p",{className:"field-hint",children:"Already downloaded in this browser — connecting will be fast."}),e.browserModelCached===!1&&i.jsx("p",{className:"field-hint",children:"Not downloaded yet — connecting fetches the weights once, then caches them for next time."})]}),e.webgpu===!1&&e.webgpuReason&&i.jsxs(se,{variant:"destructive",children:[i.jsx(de,{children:"No WebGPU in this browser"}),i.jsx(le,{children:e.webgpuReason})]}),e.webgpu!==!1&&l&&i.jsxs(se,{variant:"destructive",children:[i.jsx(de,{children:"This model may not fit in GPU memory"}),i.jsx(le,{children:l})]})]}),e.kind==="endpoint"&&i.jsxs("div",{className:"brain-config",children:[i.jsxs("div",{className:"field",children:[i.jsx(Ve,{htmlFor:"endpoint-url",children:"Endpoint"}),i.jsx($n,{id:"endpoint-url",value:e.endpointUrl,onChange:u=>e.setEndpointUrl(u.target.value),disabled:e.status==="connecting"}),i.jsxs("p",{className:"field-hint",children:["Ollama allows ",i.jsx("code",{children:"localhost"})," origins out of the box; set"," ",i.jsx("code",{children:"OLLAMA_ORIGINS"})," only when serving this page from another host. Best for local development — a hosted copy of this page can't reach a server on your machine at all."]}),t&&i.jsxs(se,{variant:"destructive",children:[i.jsx(de,{children:"A local server won't work from this URL"}),i.jsx(le,{children:t})]})]}),i.jsxs("div",{className:"field",children:[i.jsx(Ve,{htmlFor:"endpoint-model",children:"Model"}),i.jsxs("div",{className:"endpoint-model-row",children:[i.jsxs(vn,{value:e.endpointModel,onValueChange:e.setEndpointModel,disabled:e.status==="connecting"||e.endpointModelsStatus==="loading"||e.endpointModels.length===0,children:[i.jsx(Mn,{id:"endpoint-model",className:"endpoint-model-select",children:i.jsx(xn,{placeholder:e.endpointModelsStatus==="loading"?"Loading models…":e.endpointModelsStatus==="idle"?"Enter an endpoint above":e.endpointModelsStatus==="error"?"No models — check the endpoint":e.endpointModels.length===0?"No models served":"Select a model"})}),i.jsx(Nn,{children:e.endpointModels.map(u=>i.jsx(En,{value:u,children:u},u))})]}),i.jsx(J,{size:"sm",variant:"secondary",onClick:()=>void e.listEndpointModels(),disabled:e.status==="connecting"||e.endpointModelsStatus==="loading"||t!==null,children:e.endpointModelsStatus==="loading"?"Refreshing…":"Refresh"})]}),i.jsxs("p",{className:"field-hint",children:["Fetched from the endpoint's ",i.jsx("code",{children:"/models"}),". Tiny models (e.g. SmolLM2) usually can't follow the tool-calling format — prefer ",i.jsx("code",{children:"llama3.2:3b"}),", ",i.jsx("code",{children:"qwen2.5"})," or larger."]}),e.endpointModelsStatus==="error"&&!t&&i.jsxs(se,{variant:"destructive",children:[i.jsx(de,{children:"Couldn't list models"}),i.jsx(le,{children:e.endpointModelsError})]})]}),i.jsxs("div",{className:"field",children:[i.jsx(Ve,{htmlFor:"endpoint-key",children:"API key (optional)"}),i.jsx($n,{id:"endpoint-key",type:"password",value:e.apiKey,onChange:u=>e.setApiKey(u.target.value),disabled:e.status==="connecting"})]})]}),e.kind!=="scripted"&&i.jsxs("div",{className:"brain-actions",children:[i.jsx(J,{size:"sm",onClick:()=>void e.connect(),disabled:e.status==="connecting"||e.kind==="endpoint"&&(e.endpointModel===""||e.endpointModelsStatus==="loading"||t!==null),children:e.status==="ready"?"Reconnect":"Connect"}),e.status==="connecting"&&e.kind==="browser"&&i.jsx(J,{size:"sm",variant:"secondary",onClick:e.cancelConnect,children:"Cancel"}),e.progress&&i.jsxs("span",{className:"field-hint",children:[Math.round(e.progress.progress*100),"% —"," ",e.progress.text]})]}),e.progress&&i.jsx("div",{className:"brain-progress",role:"progressbar","aria-valuenow":Math.round(e.progress.progress*100),"aria-valuemin":0,"aria-valuemax":100,children:i.jsx("div",{className:"brain-progress-bar",style:{width:`${Math.round(e.progress.progress*100)}%`}})}),e.error&&i.jsxs(se,{variant:"destructive",children:[i.jsx(de,{children:"Couldn't connect"}),i.jsx(le,{children:e.error})]})]})}function Ai({brain:e}){const n=rt.find(t=>t.kind===e.visionKind);return i.jsxs("div",{className:"brain-section brain-vision",children:[i.jsx(Ve,{children:"Vision (reads the image)"}),i.jsxs("div",{className:"brain-modes",children:[i.jsx("div",{className:"brain-kinds",role:"group","aria-label":"Vision brain",children:rt.map(t=>i.jsx(J,{size:"sm",variant:e.visionKind===t.kind?"default":"secondary","aria-pressed":e.visionKind===t.kind,onClick:()=>e.setVisionKind(t.kind),children:t.label},t.kind))}),i.jsxs("div",{className:"brain-status",children:[e.visionStatus==="ready"&&e.visionKind==="browser-vision"&&i.jsx(te,{variant:"success",className:"brain-status-badge",children:e.visionModelInUse??"connected"}),e.visionStatus==="connecting"&&i.jsx(te,{variant:"info",className:"brain-status-badge",children:"connecting…"}),e.visionStatus==="error"&&i.jsx(te,{variant:"danger",className:"brain-status-badge",children:"not connected"})]})]}),i.jsx("p",{className:"field-hint",children:n.hint}),e.visionKind==="scripted-vision"&&e.webgpu===!1&&e.visionWebgpuReason&&i.jsxs(se,{variant:"destructive",children:[i.jsx(de,{children:"No WebGPU in this browser"}),i.jsx(le,{children:e.visionWebgpuReason})]}),e.visionKind==="browser-vision"&&i.jsxs("div",{className:"brain-config",children:[i.jsxs("div",{className:"field",children:[i.jsx(Ve,{htmlFor:"vision-model",children:"Model"}),i.jsxs(vn,{value:e.visionModel,onValueChange:e.setVisionModel,disabled:e.visionStatus==="connecting",children:[i.jsx(Mn,{id:"vision-model",children:i.jsx(xn,{})}),i.jsx(Nn,{children:Dt.map(t=>i.jsx(En,{value:t.id,children:t.label},t.id))})]}),i.jsx("p",{className:"field-hint",children:"Connecting downloads the weights once (size shown above), then caches them — every token is read on your GPU, no server."})]}),e.webgpu===!1&&e.visionWebgpuReason&&i.jsxs(se,{variant:"destructive",children:[i.jsx(de,{children:"No WebGPU in this browser"}),i.jsx(le,{children:e.visionWebgpuReason})]})]}),e.visionKind==="browser-vision"&&i.jsxs("div",{className:"brain-actions",children:[i.jsx(J,{size:"sm",onClick:()=>void e.connectVision(),disabled:e.visionStatus==="connecting",children:e.visionStatus==="ready"?"Reconnect":"Connect"}),e.visionStatus==="connecting"&&i.jsx(J,{size:"sm",variant:"secondary",onClick:e.cancelVisionConnect,children:"Cancel"}),e.visionProgress&&i.jsxs("span",{className:"field-hint",children:[Math.round(e.visionProgress.progress*100),"% —"," ",e.visionProgress.text]})]}),e.visionError&&i.jsxs(se,{variant:"destructive",children:[i.jsx(de,{children:"Couldn't connect the vision brain"}),i.jsx(le,{children:e.visionError})]})]})}function Di({imageInput:e,value:n,onSelect:t,disabled:r=!1}){const[o,s]=h.useState(null),[d,p]=h.useState(!1),g=h.useRef(null),a=h.useId(),l=h.useId(),u=h.useCallback(_=>{s(URL.createObjectURL(_)),t({imageName:_.name,pixels:_})},[t]);h.useEffect(()=>{if(o)return()=>URL.revokeObjectURL(o)},[o]);const c=h.useCallback(_=>{const y=_==null?void 0:_[0];y&&y.type.startsWith("image/")&&u(y)},[u]),f=(n==null?void 0:n.imageId)!=null?e.seedImages.find(_=>_.id===n.imageId):void 0;return i.jsxs("div",{className:"image-input",children:[e.label&&i.jsx("p",{className:"field-hint",children:e.label}),i.jsx("p",{className:"image-input-label",id:a,children:"Seed photos"}),i.jsx("div",{className:"image-gallery",role:"group","aria-labelledby":a,children:e.seedImages.map(_=>{const y=(n==null?void 0:n.imageId)===_.id;return i.jsxs("button",{type:"button","aria-pressed":y,className:`image-thumb${y?" image-thumb--selected":""}`,disabled:r,title:_.label??_.id,onClick:()=>{s(null),g.current&&(g.current.value=""),t({imageId:_.id,pixels:_.file})},children:[i.jsx("img",{src:_.thumb??_.file,alt:_.label??_.id}),_.label&&i.jsx("span",{children:_.label})]},_.id)})}),i.jsx("label",{className:"image-input-label",htmlFor:l,children:"Or upload your own photo"}),i.jsxs("div",{className:`image-drop${d?" image-drop--over":""}`,onDragOver:_=>{_.preventDefault(),r||p(!0)},onDragLeave:()=>p(!1),onDrop:_=>{_.preventDefault(),p(!1),r||c(_.dataTransfer.files)},children:[i.jsx("input",{ref:g,id:l,type:"file",accept:"image/*",disabled:r,onChange:_=>c(_.target.files)}),i.jsx("p",{className:"field-hint",children:"Drag a photo here, or pick one. Uploading a photo the model has never seen is the proof this runs for real — nothing leaves your browser."})]}),(o||f)&&i.jsxs("div",{className:"image-preview",children:[i.jsx("img",{src:o??(f==null?void 0:f.file),alt:o?(n==null?void 0:n.imageName)??"uploaded photo":(f==null?void 0:f.label)??(f==null?void 0:f.id)??"selected photo"}),i.jsx("span",{className:"field-hint",children:o?`Uploaded: ${(n==null?void 0:n.imageName)??"your photo"}`:`Selected: ${(f==null?void 0:f.label)??(f==null?void 0:f.id)}`}),i.jsx("button",{type:"button",className:"image-clear-btn",disabled:r,onClick:()=>{s(null),g.current&&(g.current.value=""),t(null)},children:"Clear"})]})]})}function Lt(e){return typeof e=="object"&&e!==null}function fd(e){const n=new Set,t=r=>{Lt(r)&&(typeof r.key=="string"&&n.add(r.key),Array.isArray(r.components)&&r.components.forEach(t))};return t(e),n}function Ci(e){const n={},t=r=>{Lt(r)&&(typeof r.key=="string"&&"defaultValue"in r&&(n[r.key]=r.defaultValue??""),Array.isArray(r.components)&&r.components.forEach(t))};return t(e),n}const Bi="wdf:section:v2:";function Rt(e){return Bi+e}function it(e){try{const n=window.localStorage.getItem(Rt(e));return n==="1"?!0:n==="0"?!1:void 0}catch{return}}function Li(e,n){try{window.localStorage.setItem(Rt(e),n?"1":"0")}catch{}}function An(e,n=!0){const[t,r]=h.useState(()=>it(e)??n);h.useEffect(()=>{r(it(e)??n)},[e,n]);const o=h.useCallback(s=>{r(s),Li(e,s)},[e]);return[t,o]}function ze({sectionId:e,title:n,description:t,defaultOpen:r=!0,className:o,children:s,...d}){const[p,g]=An(e,r);return i.jsx(Yt,{className:["panel",o].filter(Boolean).join(" "),"data-tour":d["data-tour"],children:i.jsxs(Qt,{open:p,onOpenChange:g,children:[i.jsxs(qt,{className:"panel-trigger",children:[i.jsxs("span",{className:"panel-trigger-text",children:[i.jsx("span",{className:"panel-title",children:n}),t!=null&&i.jsx("span",{className:"panel-desc",children:t})]}),i.jsx(Jt,{className:"panel-chevron","aria-hidden":!0})]}),i.jsx(Ht,{children:i.jsx(Wt,{children:s})})]})})}function Ri(e){return e.entries!==void 0}function Fi(e){const n=[];let t=null;for(const r of e)r.turn!==void 0?t&&t.turn===r.turn?t.entries.push(r):(t={turn:r.turn,entries:[r]},n.push(t)):(t=null,n.push(r));return n}function ot(e){if(e===void 0)return"undefined";try{return JSON.stringify(e)}catch{return"[unserializable value]"}}function zi({activation:e,result:n,labelFor:t}){const r=e.elementId??"";return i.jsxs("div",{className:"timeline-tool",children:[i.jsxs("div",{className:"timeline-tool-head",children:[i.jsx(te,{variant:"info",children:"tool"}),i.jsx("strong",{children:t(r)||r}),i.jsx("code",{children:r})]}),e.args!==void 0&&Object.keys(e.args).length>0&&i.jsxs("div",{className:"timeline-kv",children:[i.jsx("span",{className:"timeline-kv-label",children:"arguments"}),i.jsx("code",{children:ot(e.args)})]}),i.jsxs("div",{className:"timeline-kv",children:[i.jsx("span",{className:"timeline-kv-label",children:"returned"}),i.jsx("code",{children:n?ot(n.result):"— waiting for the job to complete —"})]})]})}function Oi({group:e,labelFor:n}){const t=e.entries.find(a=>a.kind==="llm"),r=e.entries.filter(a=>a.kind==="agent"&&a.elementId),o=e.entries.filter(a=>a.kind==="vars"&&a.elementId),s=e.entries.filter(a=>a.kind==="agent"&&!a.elementId),d=e.entries.filter(a=>a.kind==="error"),p=new Set(r.map(a=>a.elementId)),g=e.entries.filter(a=>a.kind==="tool"||a.kind==="vars"&&a.elementId&&!p.has(a.elementId)).sort((a,l)=>a.id-l.id);return i.jsxs("div",{className:"timeline-turn",children:[i.jsxs("div",{className:"timeline-turn-head",children:[i.jsxs(te,{variant:t!=null&&t.pending?"warning":"neutral",children:["Turn ",e.turn]}),(t==null?void 0:t.pending)&&i.jsx("span",{className:"timeline-pending",children:"thinking…"})]}),t&&i.jsx("blockquote",{className:"timeline-reply",children:t.text}),s.map(a=>i.jsx("div",{className:"timeline-note",children:a.text},a.id)),r.map(a=>i.jsx(zi,{activation:a,result:o.find(l=>l.elementId===a.elementId),labelFor:n},a.id)),g.map(a=>i.jsxs("div",{className:`log-line log-${a.kind}`,children:[a.pending?"⏳ ":"",a.text]},a.id)),d.map(a=>i.jsxs("div",{className:"timeline-error",children:["⚠ ",a.text]},a.id))]})}function Ui({log:e,elementStats:n=[],incidents:t=[],labelFor:r=s=>s,variables:o}){const s=h.useMemo(()=>Fi(e),[e]),[d,p]=h.useState(!1),[g,a]=An("engine-view",!1),l=h.useRef(null);h.useEffect(()=>{const c=l.current;c&&(c.scrollTop=c.scrollHeight)},[s]);const u=()=>{var _;const c={log:e.map(({id:y,...b})=>b),elementStats:n,incidents:t},f=JSON.stringify(c,null,2);(_=navigator.clipboard)!=null&&_.writeText&&navigator.clipboard.writeText(f).then(()=>{p(!0),setTimeout(()=>p(!1),1500)}).catch(()=>{})};return i.jsxs(ze,{sectionId:"activity",className:"grow activity-card",title:"Agent activity",description:"Agent turns, model replies, and tool calls — read top to bottom as a story.",children:[i.jsx("div",{className:"timeline-toolbar",children:i.jsx(J,{variant:"secondary",size:"sm",onClick:u,children:d?"Copied!":"Copy run as JSON"})}),i.jsx("div",{className:"timeline",ref:l,children:s.length===0?i.jsx("div",{className:"log-empty",children:"Press Run or Step to start."}):s.map(c=>Ri(c)?i.jsx(Oi,{group:c,labelFor:r},`turn-${c.turn}-${c.entries[0].id}`):i.jsxs("div",{className:`log-line log-${c.kind}`,children:[c.pending?"⏳ ":"",c.text]},c.id))}),o,(n.length>0||t.length>0)&&i.jsxs("details",{className:"engine-view",open:g,onToggle:c=>a(c.currentTarget.open),children:[i.jsxs("summary",{children:["Element completion",t.length>0&&` · ${t.length} incident${t.length===1?"":"s"}`]}),i.jsxs("div",{className:"timeline-engine-view",children:[n.length>0&&i.jsxs("div",{className:"timeline-stats",children:[i.jsx("span",{className:"timeline-kv-label",children:"Element completion"}),i.jsx("ul",{children:n.filter(c=>c.completed>0||(c.active??0)>0).map(c=>i.jsxs("li",{children:[i.jsx("code",{children:r(c.elementId)||c.elementId})," ","completed ",c.completed,c.active?`, ${c.active} active`:""]},c.elementId))})]}),t.length>0&&i.jsxs("div",{className:"timeline-incidents",children:[i.jsx("span",{className:"timeline-kv-label",children:"Incidents"}),i.jsx("ul",{children:t.map((c,f)=>i.jsxs("li",{children:[i.jsx("code",{children:r(c.elementId)||c.elementId})," —"," ",c.reason]},`${c.elementId}-${f}`))})]})]})]})]})}const ve={diagram:"diagram",runButton:"run-button",variablesPanel:"variables-panel",codePanel:"code-panel",brainPanel:"brain-panel"};function at(e){return`[data-tour="${e}"]`}function $i(e=location.search){return new URLSearchParams(e).get("tour")}function Gi(e,n){var t;return((t=e.elementStats.find(r=>r.elementId===n))==null?void 0:t.completed)??0}function Vi(e,n){return!e||e.kind==="click"||!n?!1:e.kind==="activeElement"?n.activeElementIds.includes(e.elementId):Gi(n,e.elementId)>=(e.atLeast??1)}function Yi(e){return"anchor"in e?at(e.anchor):`${at(ve.diagram)} [data-element-id="${Qi(e.elementId)}"]`}function Qi(e){return typeof CSS<"u"&&typeof CSS.escape=="function"?CSS.escape(e):e.replace(/[^a-zA-Z0-9_-]/g,n=>`\\${n}`)}function qi(e){return e.map(n=>{const t=!!n.waitFor&&n.waitFor.kind!=="click";return{element:Yi(n.target),popover:{title:n.title,description:t?`${n.description} (continues automatically once you reach that point — or use Next to skip ahead)`:n.description,showButtons:["next","previous","close"]},disableActiveInteraction:!1,skipMissingElement:n.skipMissingElement??!0}})}async function Ji(e,n={}){var s;const[{driver:t}]=await Promise.all([ce(()=>import("./driver.js-bj_ppY-Q.js"),[]),ce(()=>Promise.resolve({}),__vite__mapDeps([0]))]),r=qi(e),o=t({steps:r,showProgress:!0,allowClose:!0,skipMissingElement:!0,onHighlighted:(d,p,{index:g})=>{var a;g!==void 0&&((a=n.onIndexChange)==null||a.call(n,g))},onDestroyed:()=>{var d;(d=n.onDestroyed)==null||d.call(n)}});return o.drive(),(s=n.onIndexChange)==null||s.call(n,o.getActiveIndex()??0),{moveNext:()=>o.moveNext(),activeIndex:()=>o.getActiveIndex()??-1,destroy:()=>o.destroy()}}const Hi=300;function Wi(e,n){const[t,r]=h.useState(!1),o=h.useRef(null),s=h.useRef(0),d=h.useRef(-1),p=h.useRef(null),g=h.useRef(n);h.useEffect(()=>{g.current=n},[n]);const a=h.useCallback(()=>{p.current!==null&&(clearInterval(p.current),p.current=null)},[]),l=h.useRef(0),u=h.useCallback(()=>{var f;l.current+=1,a(),(f=o.current)==null||f.destroy(),o.current=null,r(!1)},[a]),c=h.useCallback(()=>{if(!e||e.steps.length===0||o.current)return;const f=l.current+=1;Ji(e.steps,{onIndexChange:_=>{s.current=_},onDestroyed:()=>{a(),o.current=null,r(!1)}}).then(_=>{if(f!==l.current){_.destroy();return}o.current=_,r(!0),p.current=setInterval(()=>{const y=s.current;if(y===d.current)return;const b=e.steps[y];b&&Vi(b.waitFor,g.current())&&(d.current=y,_.moveNext())},Hi)})},[e,a]);return h.useEffect(()=>u,[u]),{active:t,start:c,stop:u}}const Ne=650,fn="__agent__",st="__model__",dt="__template__:",Zi=h.lazy(async()=>{await Promise.all([ce(()=>Promise.resolve({}),__vite__mapDeps([1])),ce(()=>Promise.resolve({}),__vite__mapDeps([2])),ce(()=>Promise.resolve({}),__vite__mapDeps([3]))]);const{RuntimeDiagram:e}=await ce(async()=>{const{RuntimeDiagram:n}=await import("./RuntimeDiagram-DTnJz5cT.js");return{RuntimeDiagram:n}},__vite__mapDeps([4,5,6]));return{default:e}}),wn=h.lazy(()=>ce(()=>import("./MonacoEditor-bqKos0LD.js").then(e=>e.M),__vite__mapDeps([7,5,8]))),Ki=h.lazy(()=>ce(()=>import("./vendor-modeler-Bt2tvxef.js"),__vite__mapDeps([9,5,6,10,11,12,13,1,2,3]))),lt=h.lazy(async()=>{const{FormRenderer:e}=await ce(async()=>{const{FormRenderer:n}=await import("./FormRenderer-DzLbDUG5.js");return{FormRenderer:n}},__vite__mapDeps([14,5,12,10,11,15]));return{default:e}});function mn(e,n){try{return JSON.stringify(e??{},null,n)}catch{return"[unserializable value]"}}function Xi(e){const n=mn(e).replace(/\s+/g," ");return n.length>78?`${n.slice(0,78)}…`:n}function eo({example:e,initialBrainKind:n,initialTourId:t}){var Cn,Bn,Ln,Rn,Fn,zn,On,Un;const[r,o]=h.useState(e.bpmn),s=Ni(),[d,p]=h.useState(null);h.useEffect(()=>{n&&n!==s.kind&&s.setKind(n)},[]),h.useEffect(()=>{ji({brain:s.kind})},[s.kind]);const[g,a]=h.useState(()=>Object.fromEntries(e.handlers.map(v=>[v.elementId,v.source]))),[l,u]=h.useState(e.scriptedAgent??""),[c,f]=h.useState(()=>nn(e.templates)),_=h.useMemo(()=>Br(e,g,r,c),[e,g,r,c]),y=_.model,b=li({bpmn:_.resolvedBpmn}),M=Wi(e.tour,()=>b.snapshot);h.useEffect(()=>{var v;t&&((v=e.tour)==null?void 0:v.id)===t&&M.start()},[]);const k=y.startFormId?((Cn=e.forms)==null?void 0:Cn[y.startFormId])??null:null,[B,q]=h.useState(()=>({...e.seed,...k?Ci(k):{}})),[H,fe]=h.useState(y.agent?fn:((Bn=e.handlers[0])==null?void 0:Bn.elementId)??""),[me,Ie]=h.useState(()=>{const v=(e.scenarios??[]).findIndex(x=>Object.entries(x.variables).every(([I,D])=>JSON.stringify(e.seed[I])===JSON.stringify(D)));return v===-1?null:v}),[K,oe]=An("start",!!k),[Q,j]=h.useState(!1),[E,N]=h.useState(!1),[z,O]=h.useState(null),[Ye,Oe]=h.useState([]),[Qe,re]=h.useState({}),qe=h.useMemo(()=>({...e.seed,...B,...br(e.imageInput?d:null)}),[e.seed,e.imageInput,B,d]),[Te,Je]=h.useState(!1),Ae=h.useRef(null),[De,je]=h.useState({}),[bn,Ce]=h.useState(!1),He=h.useRef(null),pe=h.useRef(!1),ie=h.useRef(0),Be=h.useRef(0),X=h.useRef({current:void 0}),Se=h.useRef({}),Le=h.useRef({}),Re=h.useMemo(()=>{const v=new Map;for(const x of y.processes){for(const I of x.tasks)v.set(I.elementId,I.label);for(const I of x.agents){v.set(I.elementId,I.label);for(const D of I.tools)v.set(D.elementId,D.label)}for(const I of x.userTasks)v.set(I.elementId,I.label)}return x=>v.get(x)??x},[y]),L=h.useCallback(v=>{Oe(x=>{if(v.key){const I=x.findIndex(D=>D.key===v.key);if(I>=0){const D=[...x];return D[I]={...D[I],...v},D}}return[...x,{...v,id:Be.current++}].slice(-80)})},[]),we=h.useMemo(()=>{var v;return((v=b.snapshot)==null?void 0:v.userTasks.find(x=>x.state==="Created"))??null},[b.snapshot]),Pe=h.useMemo(()=>{const v=y.processes.flatMap(I=>I.tasks),x=new Map;for(const I of e.handlers){if(!I.manualControl)continue;const D=v.find(P=>P.elementId===I.elementId);D&&x.set(D.jobType,{...I.manualControl,elementId:I.elementId})}return x},[e.handlers,y]),ue=h.useMemo(()=>{if(!b.snapshot)return null;for(const v of b.snapshot.jobs){const x=Pe.get(v.jobType);if(x&&v.state==="Created")return{job:v,control:x}}return null},[b.snapshot,Pe]),tn=h.useMemo(()=>{if(!y.agent||!b.snapshot)return[];const v=new Map(b.snapshot.elementStats.map(x=>[x.elementId,x.completed]));return y.agent.tools.filter(x=>(v.get(x.elementId)??0)===0)},[y.agent,b.snapshot]),ge=we?y.userTasks.find(v=>v.elementId===we.elementId):void 0,Ue=ge!=null&&ge.formId?((Ln=e.forms)==null?void 0:Ln[ge.formId])??null:null,Me=h.useCallback(async(v,x,I,D)=>{var ae,ee,be;let P=I,he=0;for(;ie.current===D&&P&&P.completedInstances<1&&he++<80;){const V=await b.stepWorkers(v,{agents:x});if(ie.current!==D)return P;P=(V==null?void 0:V.snapshot)??P;const ne=(ae=P.instances[0])==null?void 0:ae.variables;if(ne&&re({...ne}),P.userTasks.some(Y=>Y.state==="Created")){L({kind:"human",text:"⏸ waiting for a human — complete the task below to continue"});break}if(!V){L({kind:"error",text:"▶ run stopped — no dispatch round was returned"});break}if(V.handled===0){const Y=P.messageSubscriptions[0];if(V.reason==="messages"&&Y){if(L({kind:"step",text:`⏳ parked on a message catch event — waiting for "${Y.messageName}"`,elementId:Y.elementId}),await new Promise(W=>setTimeout(W,Ne)),ie.current!==D)return P;L({kind:"vars",text:`📨 correlating message "${Y.messageName}" (key: ${Y.correlationKey})`,elementId:Y.elementId});const U=b.correlateMessage(Y.messageName,Y.correlationKey,"{}");if(U){P=U;const W=(ee=P.instances[0])==null?void 0:ee.variables;W&&re({...W}),await new Promise(_e=>setTimeout(_e,Ne));continue}L({kind:"error",text:`▶ run stopped — correlating "${Y.messageName}" (key: ${Y.correlationKey}) failed`,elementId:Y.elementId})}if(V.reason==="signals"&&P.signalSubscriptions.length>0){const U=P.signalSubscriptions[0],W=P.signalSubscriptions.length;if(L({kind:"step",text:`⏳ parked on ${W} open signal subscription${W===1?"":"s"} — waiting for "${U.signalName}"`,elementId:U.elementId}),await new Promise(Ge=>setTimeout(Ge,Ne)),ie.current!==D)return P;const _e=b.broadcastSignal(U.signalName,"{}");if(_e){P=_e,L({kind:"vars",text:`📡 broadcasting signal "${U.signalName}" — every waiting subscription unblocks`,elementId:U.elementId});const Ge=(be=P.instances[0])==null?void 0:be.variables;Ge&&re({...Ge}),await new Promise(Ut=>setTimeout(Ut,Ne));continue}L({kind:"error",text:`▶ run stopped — broadcasting signal "${U.signalName}" failed`,elementId:U.elementId})}if(V.reason==="timers"){const U=P.timers.reduce((W,_e)=>Math.min(W,_e.dueInMs),1/0);if(Number.isFinite(U)){if(L({kind:"step",text:`⏳ parked on a timer — ${(Math.max(U,0)/1e3).toFixed(1)}s left on the clock`}),await new Promise(_e=>setTimeout(_e,Ne)),ie.current!==D)return P;const W=b.advanceTime(Math.max(U,0)+1);if(W){P=W,L({kind:"step",text:"🕐 the clock advanced — timer fired"}),await new Promise(_e=>setTimeout(_e,Ne));continue}}}break}await new Promise(Y=>setTimeout(Y,Ne))}return ie.current!==D||(P&&P.completedInstances>=1?L({kind:"done",text:"✅ process instance completed"}):P&&P.incidentElementIds.length>0&&L({kind:"error",text:"A job failed — incident on the diagram"})),P},[b,L]),rn=h.useCallback(async v=>{var P,he,ae;if(!ue||pe.current)return;const{job:x,control:I}=ue,D=++ie.current;pe.current=!0,j(!0);try{let ee,be;if(v==="complete")ee=b.completeJobManually(x.jobType,"{}"),be="  ↳ completed normally";else if(I.action.kind==="timer"){const V=((he=(P=b.snapshot)==null?void 0:P.timers[0])==null?void 0:he.dueInMs)??0;ee=b.advanceTime(Math.max(V,0)+1),be="  ↳ advanced the clock — timer fired"}else{const{errorCode:V,message:ne}=I.action;ee=b.throwJobError(x.jobType,V,ne),be=`  ↳ threw BPMN error ${V}: ${ne}`}if(ee){L({kind:"vars",text:be,elementId:x.elementId});const V=(ae=ee.instances[0])==null?void 0:ae.variables;V&&re({...V}),await new Promise(ne=>setTimeout(ne,Ne)),await Me(Se.current,Le.current,ee,D)}else L({kind:"error",text:"  ↳ failed to resolve the manual job",elementId:x.elementId})}finally{ie.current===D&&(pe.current=!1,j(!1))}},[ue,b,L,Me]),$e=h.useCallback(async()=>{var V;let v=null;try{y.agent&&l.trim()&&(v=Nr(l))}catch(ne){return O(ne instanceof Error?ne.message:String(ne)),null}X.current={current:void 0};let x;if(e.imageInput){const ne=s.vision;x={read:ne??Mi(e.scriptedVision).read,live:!!ne,resolve:U=>b.getRunImage(U)}}const I=Ir(y,_.handlers,L,X.current,x);for(const ne of Pe.keys())delete I[ne];const D={};if(y.agents.length>0){if(s.kind!=="scripted"&&s.chat){const Y=new Map;for(const U of y.agents)Y.set(U.jobType,[...Y.get(U.jobType)??[],U]);for(const[U,W]of Y)D[U]=Vr(W,s.chat,L,{turnRef:X.current,requiredTools:e.requiredTools})}else if(v&&y.agent){const Y=y.agent.elementId;D[y.agent.jobType]=async U=>{if(U.elementId!==Y)throw new Error(`No scripted agent handler for "${U.elementId}" — only "${Y}" (the primary process's first agent host) is driven by the scripted brain. Use a live brain to exercise more than one host.`);const W=await v(U),_e=(W.activateElements??[]).map(Ge=>Ge.elementId).join(", ");return L({kind:"agent",text:W.completionConditionFulfilled?"🤖 scripted agent: done":`🤖 scripted agent: calling ${_e||"(nothing)"}`}),W}}}Oe([]),je({});const P=qe;re(P),Se.current=I,Le.current=D;const he=b.redeploy(r),ae=(he==null?void 0:he[0])??y.processId;L({kind:"start",text:`Starting "${ae}" — ${y.agent?s.kind==="scripted"||!s.chat?"scripted brain":`live brain (${s.modelInUse??s.kind})`:"no agent in this model"}`});const ee=b.createInstance(ae,JSON.stringify(P)),be=(V=ee==null?void 0:ee.instances[0])==null?void 0:V.key;return e.imageInput&&d&&be&&b.setRunImage(be,d),{workers:I,agents:D,snap:ee}},[b,e,_,r,l,B,d,qe,y,s,L,Pe]),T=!!b.snapshot&&b.snapshot.completedInstances<1,C=!T&&!!k&&!Te,G=h.useCallback(async()=>{if(b.phase!=="ready"||pe.current||E||_.hasErrors)return;pe.current=!0,j(!0);const v=++ie.current;try{let x=Se.current,I=Le.current,D=b.snapshot;if(!T){if(Ae.current&&!Ae.current.validate())return;O(null);const P=await $e();if(!P)return;x=P.workers,I=P.agents,D=P.snap,await new Promise(he=>setTimeout(he,Ne))}await Me(x,I,D,v)}finally{ie.current===v&&(pe.current=!1,j(!1))}},[b,E,_.hasErrors,T,$e,Me]),ye=h.useCallback(async()=>{var x;if(b.phase!=="ready"||pe.current||E||_.hasErrors)return;pe.current=!0,N(!0);const v=++ie.current;try{let I=Se.current,D=Le.current,P=b.snapshot;if(!T){if(Ae.current&&!Ae.current.validate())return;O(null);const V=await $e();if(!V)return;I=V.workers,D=V.agents,P=V.snap}if(!P||P.completedInstances>=1)return;const he=P.takenSequenceFlows.length,ae=await b.stepWorkers(I,{agents:D});if(!ae){L({kind:"error",text:"⏭ step failed — no dispatch round was returned"});return}const ee=(x=ae.snapshot.instances[0])==null?void 0:x.variables;ee&&re({...ee});const be=ci(ae.snapshot.takenSequenceFlows,he);L(mi(ae,be,Re,Pe))}finally{ie.current===v&&(pe.current=!1,N(!1))}},[b,E,_.hasErrors,T,$e,L,Re,Pe]),xe=h.useCallback(()=>{pe.current=!1,ie.current++,j(!1),N(!1),b.reset(),Oe([]),re({})},[b]),We=h.useCallback(()=>{var I;if(!we||He.current&&!He.current.validate())return;const v=b.completeUserTask(we.key,JSON.stringify(De));L({kind:"human",text:`👤 ${mn(De)}`});const x=(I=v==null?void 0:v.instances[0])==null?void 0:I.variables;re(D=>({...D,...De,...x??{}})),v&&v.completedInstances>=1&&L({kind:"done",text:"✅ process instance completed"})},[we,De,b,L]),zt=h.useMemo(()=>{var v,x;return b.phase==="loading"?i.jsx(te,{variant:"neutral",children:"Booting engine…"}):b.phase==="error"?i.jsx(te,{variant:"danger",children:"Engine error"}):Q?i.jsx(te,{variant:"info",children:"Running…"}):E?i.jsx(te,{variant:"info",children:"Stepping…"}):(((v=b.snapshot)==null?void 0:v.incidentElementIds.length)??0)>0?i.jsx(te,{variant:"danger",children:"Incident"}):we?i.jsx(te,{variant:"warning",children:"Waiting for a human"}):(((x=b.snapshot)==null?void 0:x.completedInstances)??0)>=1?i.jsx(te,{variant:"success",children:"Completed"}):b.snapshot?i.jsx(te,{variant:"warning",children:"Paused"}):i.jsx(te,{variant:"neutral",children:"Ready"})},[b.phase,b.snapshot,Q,E,we]),Ot=h.useMemo(()=>e.blurb.split(/\n\s*\n/).map(v=>v.trim()).filter(Boolean),[e.blurb]);return i.jsxs("div",{className:"runner",children:[i.jsxs("section",{className:"intro",children:[i.jsx("h1",{children:e.title}),Ot.map(v=>i.jsx("p",{children:v},v))]}),e.imageInput&&i.jsx(Di,{imageInput:e.imageInput,value:d,onSelect:p,disabled:Q}),i.jsxs("div",{className:"scenario",children:[i.jsx("span",{className:"scenario-label",id:"scenario-label",children:e.scenariosLabel??"Example input"}),e.scenarios&&i.jsx("div",{className:"scenario-toggle",role:"group","aria-labelledby":"scenario-label",children:e.scenarios.map((v,x)=>i.jsx(J,{size:"sm",variant:x===me?"default":"secondary","aria-pressed":x===me,disabled:Q,onClick:()=>{Ie(x),q(I=>({...I,...v.variables}))},children:v.label},v.label))}),i.jsxs("button",{type:"button",className:"scenario-input-button",onClick:()=>oe(!K),"aria-expanded":K,"aria-controls":"start-input-editor",title:"Edit the starting payload",children:[i.jsx("span",{className:"scenario-edit-icon","aria-hidden":!0,children:"✎"})," ","input: ",i.jsx("code",{children:Xi(B)})]}),C&&i.jsx("span",{className:"scenario-hint",children:"Fill in the input to enable Run"})]}),i.jsxs("div",{className:"inline-input-editor",id:"start-input-editor",hidden:!K,children:[i.jsxs("div",{className:"inline-input-editor-head",children:[i.jsxs("div",{children:[i.jsx("div",{className:"inline-input-editor-title",children:y.startFormId?"Start form":"Start payload"}),i.jsx("div",{className:"inline-input-editor-copy",children:y.startFormId?`Rendered from the model's start form "${y.startFormId}".`:"The variables the instance starts with."})]}),i.jsx(J,{size:"sm",variant:"secondary",onClick:()=>oe(!1),children:"Done"})]}),k?i.jsx(h.Suspense,{fallback:i.jsx("div",{className:"form-fallback",children:"Loading form…"}),children:i.jsx(lt,{ref:Ae,schema:k,values:B,onChange:(v,x)=>q(I=>({...I,[v]:x})),disabled:Q,onValidityChange:Je})}):i.jsx("pre",{className:"vars",children:mn(B,2)})]}),(y.agent||e.imageInput)&&i.jsx(ze,{sectionId:"brain",className:"brain-card","data-tour":ve.brainPanel,title:"Agent brain",description:y.agent?`What drives “${y.agent.label}”. The model recommends; the process governs.`:"What reads the image. The model recommends; the process governs.",children:i.jsx(Si,{brain:s,showText:!!y.agent,showVision:!!e.imageInput})}),i.jsxs("div",{className:"controls",children:[i.jsx(J,{"data-tour":ve.runButton,onClick:()=>void G(),disabled:b.phase!=="ready"||Q||E||_.hasErrors||C,children:"▶ Run"}),i.jsx(J,{variant:"secondary",onClick:()=>void ye(),disabled:b.phase!=="ready"||Q||E||_.hasErrors||C||(((Rn=b.snapshot)==null?void 0:Rn.completedInstances)??0)>=1,children:"⏭ Step"}),i.jsx(J,{variant:"secondary",onClick:xe,disabled:b.phase!=="ready"||E,children:"↺ Reset"}),e.tour&&i.jsx(J,{variant:"secondary",onClick:M.start,disabled:M.active,children:M.active?"Touring…":`🧭 ${e.tour.label}`}),zt]}),b.phase==="error"&&i.jsxs(se,{variant:"destructive",children:[i.jsx(de,{children:"Engine error"}),i.jsx(le,{children:b.error})]}),z&&i.jsxs(se,{variant:"destructive",children:[i.jsx(de,{children:"Code didn't compile"}),i.jsx(le,{children:z})]}),_.hasErrors&&i.jsxs(se,{variant:"destructive",children:[i.jsx(de,{children:"Run is disabled — the diagram has unresolved references"}),i.jsx(le,{children:i.jsx("ul",{className:"diagnostics",children:_.diagnostics.filter(v=>v.severity==="error").map((v,x)=>i.jsx("li",{children:v.message},x))})})]}),!_.hasErrors&&_.diagnostics.length>0&&i.jsxs(se,{children:[i.jsx(de,{children:"Heads up"}),i.jsx(le,{children:i.jsx("ul",{className:"diagnostics",children:_.diagnostics.map((v,x)=>i.jsx("li",{children:v.message},x))})})]}),i.jsxs("div",{className:"grid",children:[i.jsxs("div",{className:"col",children:[i.jsx(ze,{sectionId:"process","data-tour":ve.diagram,title:"Process",description:`${y.processName} — live token (green), incidents (red).`,children:i.jsx(h.Suspense,{fallback:i.jsx("div",{className:"diagram-fallback",children:b.phase==="loading"?"Booting the engine…":"Loading diagram…"}),children:i.jsx(Zi,{xml:_.resolvedBpmn,activeIds:((Fn=b.snapshot)==null?void 0:Fn.activeElementIds)??[],incidentIds:((zn=b.snapshot)==null?void 0:zn.incidentElementIds)??[],className:"diagram"})})}),we&&i.jsxs(ze,{sectionId:"human-task",title:(ge==null?void 0:ge.label)??"Human task",description:Ue?`Rendered from the model's form "${ge==null?void 0:ge.formId}".`:"This task has no linked form — complete it with no variables.",children:[tn.length>0&&i.jsxs(se,{variant:"destructive",children:[i.jsx(de,{children:"The agent didn't finish its checks"}),i.jsxs(le,{children:["It completed without running"," ",tn.map(v=>v.label||v.elementId).join(", "),". The process took the default path to this task, so the findings below have no value to report."]})]}),Ue&&i.jsx(h.Suspense,{fallback:i.jsx("div",{className:"form-fallback",children:"Loading form…"}),children:i.jsx(lt,{ref:He,schema:Ue,values:De,onChange:(v,x)=>je(I=>({...I,[v]:x})),context:Qe,onValidityChange:Ce})}),i.jsx(J,{onClick:We,disabled:!!Ue&&!bn,children:"Complete task"})]}),ue&&i.jsx(ze,{sectionId:"manual-job",title:ue.control.label,description:"This job is held here on purpose — pick how it resolves.",children:i.jsxs("div",{className:"controls",children:[i.jsx(J,{onClick:()=>void rn("complete"),disabled:Q||E,children:ue.control.completeLabel??"✅ Complete normally"}),i.jsx(J,{variant:"secondary",onClick:()=>void rn("action"),disabled:Q||E,children:ue.control.action.label})]})})]}),i.jsx("div",{className:"col",children:i.jsx(Ui,{log:Ye,elementStats:(On=b.snapshot)==null?void 0:On.elementStats,incidents:(Un=b.snapshot)==null?void 0:Un.incidents,labelFor:Re,variables:i.jsxs("div",{className:"vars-block","data-tour":ve.variablesPanel,children:[i.jsx("div",{className:"vars-head",children:"Instance variables"}),i.jsx("pre",{className:"vars",children:mn(Object.keys(Qe).length>0?Qe:qe,2)})]})})})]}),i.jsxs("div",{className:"runner-secondary",children:[i.jsx(ze,{sectionId:"code",className:"editors","data-tour":ve.codePanel,defaultOpen:!1,title:"Code",description:"One handler per BPMN element, plus a model tab holding the editable diagram — select an element there to edit its properties. Return variables to merge, or throw to fail the job.",children:i.jsx(h.Suspense,{fallback:i.jsx("div",{className:"editor-fallback",children:"Loading editor…"}),children:i.jsxs(Zt,{value:H,onValueChange:fe,children:[i.jsxs(Kt,{children:[i.jsx(on,{value:st,children:"model"}),y.agent&&i.jsx(on,{value:fn,children:"agent (scripted)"}),e.handlers.map(v=>{var x;return i.jsx(on,{value:v.elementId,children:((x=y.tasks.find(I=>I.elementId===v.elementId))==null?void 0:x.label)??v.elementId},v.elementId)}),Object.keys(c).map(v=>i.jsx(on,{value:dt+v,children:v},v))]}),i.jsxs(an,{value:st,children:[i.jsxs("div",{className:"editor-meta",children:[i.jsx("strong",{children:"Model"}),i.jsx("code",{children:"click an element to edit its properties on the right — Run re-reads whatever you leave here"}),i.jsx(J,{variant:"secondary",size:"sm",onClick:()=>o(e.bpmn),disabled:r===e.bpmn,children:"Revert to original"})]}),i.jsx(Ki,{value:r,onChange:o})]}),y.agent&&i.jsxs(an,{value:fn,children:[i.jsxs("div",{className:"editor-meta",children:[i.jsx("strong",{children:y.agent.label}),i.jsx("code",{children:s.kind==="scripted"||!s.chat?"in use":"unused — a live brain is connected"})]}),i.jsx("div",{className:"editor-wrap",children:i.jsx(wn,{height:"360px",defaultLanguage:"javascript",value:l,onChange:v=>u(v??""),options:yn})})]}),e.handlers.map(v=>{var x;return i.jsxs(an,{value:v.elementId,children:[i.jsxs("div",{className:"editor-meta",children:[i.jsx("strong",{children:((x=y.tasks.find(I=>I.elementId===v.elementId))==null?void 0:x.label)??v.elementId}),i.jsx("code",{children:v.standsInFor??v.elementId})]}),i.jsx("div",{className:"editor-wrap",children:i.jsx(wn,{height:"360px",defaultLanguage:"javascript",value:g[v.elementId],onChange:I=>a(D=>({...D,[v.elementId]:I??""})),options:yn})})]},v.elementId)}),Object.keys(c).map(v=>i.jsxs(an,{value:dt+v,children:[i.jsxs("div",{className:"editor-meta",children:[i.jsx("strong",{children:v}),i.jsxs("code",{children:["prompt / template text — substitutes"," ","{{"+v+"}}"]})]}),i.jsx("div",{className:"editor-wrap",children:i.jsx(wn,{height:"360px",defaultLanguage:"markdown",value:c[v],onChange:x=>f(I=>nn(I,{[v]:x??""})),options:yn})})]},v))]})})}),y.agent&&i.jsx(ze,{sectionId:"tools",defaultOpen:!1,title:"Tools, as the model sees them",description:i.jsxs(i.Fragment,{children:["Read from the diagram — element name, documentation, and every",i.jsx("code",{children:" fromAi(…)"})," argument."]}),children:i.jsx("ul",{className:"tool-list",children:y.agent.tools.map(v=>i.jsxs("li",{children:[i.jsx("code",{children:v.elementId}),i.jsxs("span",{children:[" — ",v.documentation||v.label]}),v.args.length>0&&i.jsx("ul",{children:v.args.map(x=>i.jsxs("li",{children:[i.jsxs("code",{children:[x.name,": ",x.type]})," ","— ",x.description]},x.name))})]},v.elementId))})})]})]})}const yn={minimap:{enabled:!1},fontSize:13,scrollBeyondLastLine:!1,tabSize:2,automaticLayout:!0},no=`<?xml version="1.0" encoding="UTF-8"?>\r
...
}`,wo={id:"learn-multi-instance-parallel",title:"Parallel multi-instance",group:"learn-bpmn",blurb:["A multi-instance activity runs its task once per element of a collection, spawning that many job instances of the same element in parallel, and only lets the token move on once every one of them completes.",`Run this and watch three 'Process item' jobs activate together for apple, banana, cherry, and complete (in any order) before the process reaches its end event. Nothing about the diagram says "three" — that comes from the collection, so use the buttons in the Start panel on the right to swap between one, three, and six items and hit Run again; the Activity panel logs one 'Process item' line per element, so the fan-out is right there to count.`,'The property tying the two together is in the Code panel: open the model tab, click "Process item", and expand Multi-instance in the properties panel on the right — Input collection holds `items`, the FEEL expression naming the variable to fan out over. Drop it entirely and the activity silently degenerates to a single ordinary instance, with no error to tell you it happened. Revert to original puts it back.'].join(`

`),docsUrl:"https://docs.camunda.io/docs/components/modeler/bpmn/multi-instance/",bpmn:_o,seed:{items:["apple","banana","cherry"]},scenarios:[{label:"One item — a single instance",variables:{items:["apple"]}},{label:"Three items — fans out to three",variables:{items:["apple","banana","cherry"]}},{label:"Six items — fans out to six",variables:{items:["apple","banana","cherry","damson","elderberry","fig"]}}],handlers:[{elementId:"Activity_process",standsInFor:"job worker — process-item",source:fo}]},yo=Object.freeze(Object.defineProperty({__proto__:null,default:wo},Symbol.toStringTag,{value:"Module"})),vo=`<?xml version="1.0" encoding="UTF-8"?>\r
...
}`,No={id:"learn-service-task",title:"Service task + sequence flow",group:"learn-bpmn",blurb:["A service task is a unit of work a worker (not a human) performs; a sequence flow is the arrow that hands the token from one to the next once its task completes.","Run this and watch each task activate, run its handler, and complete in order — Prepare package, then Dispatch courier — before the process reaches its end event.",`The link between the two halves is the job type: in the Code panel, open the model tab, click "Prepare package", and expand Task definition in the properties panel on the right — Job type is the name a worker has to subscribe to in order to be handed this task's work.`,"(This page wires its own handlers up from whatever the model declares, so renaming it here keeps working; on a real cluster the worker is a separate process started with a job type of its own, and a mismatch means nobody ever activates the job, so the run stalls forever.)"].join(`

`),docsUrl:"https://docs.camunda.io/docs/components/modeler/bpmn/service-tasks/",bpmn:vo,seed:{item:"camunda-t-shirt"},handlers:[{elementId:"Activity_prepare",standsInFor:"job worker — prepare-package",source:Mo},{elementId:"Activity_dispatch",standsInFor:"job worker — dispatch-courier",source:xo}]},Eo=Object.freeze(Object.defineProperty({__proto__:null,default:No},Symbol.toStringTag,{value:"Module"})),ko=`<?xml version="1.0" encoding="UTF-8"?>\r
...
`,Lo="Camunda Cloud",Ro="8.10.0",Fo={name:"Camunda Web Modeler",version:"9b5d5ef"},zo=19,Oo="learn-user-task-form-review",Uo=[{text:`# Review request
...
`,Jo={id:"compliance-walkthrough",label:"Take the tour",steps:[{title:"Start a run",description:"Press Run to send a shipment through the compliance agent.",target:{anchor:ve.runButton}},{title:"The agent picks its own tools",description:"This AI Agent reads the shipment notes and decides, turn by turn, which of the tools below it to call — nothing here is hard-coded into a fixed sequence.",target:{elementId:"ComplianceCheckAgent"}},{title:"Watch the token move",description:"The agent's first move is to look up the genetic marker mentioned in the notes.",target:{elementId:"VerifyGeneticMarker"},waitFor:{kind:"activeElement",elementId:"VerifyGeneticMarker"}},{title:"A cleared shipment notifies the export team",description:"Once the compliance score comes back clean, the process notifies the export team automatically — no human review needed for this scenario.",target:{elementId:"NotifyExportTeam"},waitFor:{kind:"elementCompleted",elementId:"NotifyExportTeam"}},{title:"Everything the run recorded",description:"The variables panel shows the marker record, the country lookup, the compliance score, and the final decision — exactly what each tool and the agent wrote along the way.",target:{anchor:ve.variablesPanel}}],successEvent:{kind:"instanceCompleted"}},Ho=`<?xml version="1.0" encoding="UTF-8"?>
...
}`,va={id:"seed-export-compliance",title:"Seed export compliance agent",blurb:"An AI agent picks its own tools to check a shipment, then a gateway routes on its decision — cleared shipments notify the export team, flagged ones go to a human. The LLM recommends; the BPMN process governs.",hero:{headline:"The LLM *recommends*. The process *governs*.",lede:"An agentic ad-hoc sub-process chooses its own compliance checks, but the gateway after it — not the model — decides whether a shipment ships or goes to a human.",tagline:"Anatomy of an enterprise agent"},docsUrl:"https://camunda.com/blog/agentic-ai/",bpmn:Ho,forms:{"seed-export-shipment-ready":ra,"seed-export-compliance-review":ma},seed:{scenario:ct,shipmentNotes:""},scenariosLabel:"Example shipment",scenarios:[{label:"Likely cleared (TP53 → Brazil)",variables:{scenario:ct,shipmentNotes:""}},{label:"Likely flagged (BRCA1 → Germany)",variables:{scenario:ga,shipmentNotes:""}}],scriptedAgent:ha,templates:ua,tour:Jo,requiredTools:["RecordComplianceDecision"],handlers:[{elementId:"VerifyGeneticMarker",standsInFor:"JDBC connector — UCSC hg38",source:ba},{elementId:"CheckDestinationCountry",standsInFor:"GraphQL connector — countries API",source:_a},{elementId:"ComputeComplianceScore",standsInFor:"REST connector — api.mathjs.org",source:fa},{elementId:"RecordComplianceDecision",standsInFor:"Script task — FEEL",source:wa},{elementId:"NotifyExportTeam",standsInFor:"REST connector — httpbin.io",source:ya}]},Ma=`You are a loan origination assistant at a retail bank. Your job is to gather everything a senior loan officer needs to decide an application — you do **not** decide it yourself.
...
}`,qa=`async (job, { text, num, sleep, trace }) => {
...
}`,Ka={id:"loan-origination",title:"Loan origination agent",blurb:"An AI agent gathers a loan case with its own tools — customer lookup, credit bureau, an underwriting policy, a status update — then every application passes through a mandatory senior-officer review before a gateway routes it to an offer or a decline. The agent advises; the process governs.",docsUrl:"https://camunda.com/orchestrate/agents/",bpmn:Ea,forms:{"loan-application":Da,"loan-senior-officer-review":Ua},seed:mt,scenarios:[{label:"Strong applicant (policy recommends approve)",variables:mt},{label:"Marginal applicant (policy recommends decline)",variables:Va}],scriptedAgent:Ya,templates:Ga,tour:Na,requiredTools:["AssessApplication","UpdateApplicationStatus"],handlers:[{elementId:"QueryCustomer",standsInFor:"CRM connector — customer lookup",source:Qa},{elementId:"CreditBureauLookup",standsInFor:"REST connector — credit bureau",source:qa},{elementId:"AssessApplication",standsInFor:"Script task — underwriting policy (FEEL)",source:Ja},{elementId:"UpdateApplicationStatus",standsInFor:"REST connector — origination system",source:Ha},{elementId:"IssueLoanOffer",standsInFor:"REST connector — offer/booking system",source:Wa},{elementId:"SendDeclineNotice",standsInFor:"REST connector — notifications",source:Za}]},Xa=`<?xml version="1.0" encoding="UTF-8"?>
...
`,es=`async (job, { text, sleep }) => {
  ...
  return { shipped: true, tracking: "1Z" + Math.floor(Math.random() * 1e9) };
}`,rs={id:"order-process",title:"Order process with service workers",blurb:"The getting-started order process: check inventory, charge payment, ship. No agent and no human step — the same runner, driven entirely by what's in the diagram.",docsUrl:"https://docs.camunda.io/docs/next/guides/getting-started-orchestration-cluster/",bpmn:Xa,seed:{item:"camunda-t-shirt",quantity:3},handlers:[{elementId:"Activity_0tw2fu0",standsInFor:"job worker — check-inventory",source:es},{elementId:"Activity_1ppsbgi",standsInFor:"job worker — charge-payment",source:ns},{elementId:"Activity_08pg6im",standsInFor:"job worker — ship-items",source:ts}]},is=`<?xml version="1.0" encoding="UTF-8"?>\r
...
}`,as={id:"rocket-launch",title:"Rocket launch",blurb:"The getting-started rocket launch, boiled down to one service task: launch. The smallest possible example, and the smallest possible test of the framework's extensibility.",bpmn:is,seed:{missionName:"Apollo 11",destination:"the Moon",fuelLevel:100},scenarios:[{label:"Full tanks — launch succeeds",variables:{missionName:"Apollo 11",destination:"the Moon",fuelLevel:100}},{label:"Low fuel — mission scrubbed",variables:{missionName:"Apollo 13",destination:"the Moon",fuelLevel:30}}],handlers:[{elementId:"Activity_LaunchRocket",standsInFor:"job worker — launch-rocket",source:os}]},ss=`<?xml version="1.0" encoding="UTF-8"?>\r
...
`,ds=`async (job, { text, sleep }) => {
  ...
  return { shipped: true, tracking: "1Z" + Math.floor(Math.random() * 1e9) };
}`,ms={id:"order-process-boundary-events",title:"Order process with boundary events",blurb:"The getting-started order process, extended with a timer and an error boundary event: charge payment can be declined, and a delayed shipment can escalate — both fired by hand from the runner rather than by chance.",docsUrl:"https://github.com/camunda/camunda-8-get-started/tree/main/2-order-process-with-service-workers",bpmn:ss,seed:{item:"camunda-t-shirt",quantity:3},handlers:[{elementId:"Activity_0tw2fu0",standsInFor:"job worker — check-inventory",source:ds},{elementId:"Activity_1ppsbgi",standsInFor:"job worker — charge-payment",source:ls,manualControl:{label:"Charge payment method",completeLabel:"✅ Complete normally",action:{kind:"error",errorCode:"CHARGE_DECLINED",message:"The card issuer declined the charge.",label:"❌ Simulate: card declined"}}},{elementId:"Activity_08pg6im",standsInFor:"job worker — ship-items",source:cs,manualControl:{label:"Ship items",completeLabel:"✅ Ship it",action:{kind:"timer",label:"🕐 Fire the shipping-delayed timer"}}}]},ps="/pr-preview/pr-106/assets/de-bmw-mini-JBSk7QcF.jpg",us="/pr-preview/pr-106/assets/de-bmw-mini.thumb-CUUmJrRO.jpg",gs="/pr-preview/pr-106/assets/uk-d651-rnb-XGipy2QN.jpg",hs="/pr-preview/pr-106/assets/uk-d651-rnb.thumb-mjEcbhUf.jpg",bs="/pr-preview/pr-106/assets/uk-mk70-orj-Cn6O3Xfm.jpg",_s="/pr-preview/pr-106/assets/uk-mk70-orj.thumb-CaeZ2vqU.jpg",fs="/pr-preview/pr-106/assets/uk-ni-ijz-8992-YXV44tgk.jpg",ws="/pr-preview/pr-106/assets/uk-ni-ijz-8992.thumb-DYwok8jV.jpg",ys="/pr-preview/pr-106/assets/us-hyundai-genesis-gGpAIEpi.jpg",vs="/pr-preview/pr-106/assets/us-hyundai-genesis.thumb-DEEt19Mw.jpg",Ms=`<?xml version="1.0" encoding="UTF-8"?>
...
}`,Xs={id:"plate-recognition",title:"Read a number plate from a photo",blurb:"Pick the plate's country, then a photo goes into the run, an in-browser vision model reads the number plate on the reader's own GPU, and a human confirms or corrects it before the process records the result. The vision model recommends; the BPMN process governs. No server, no API key — with no model connected it falls back to a deterministic scripted reading.",docsUrl:"https://docs.camunda.io/docs/components/modeler/forms/camunda-forms-reference/",bpmn:Ms,forms:{"plate-recognition-country":Qs,"plate-recognition-confirm":Ss,"plate-recognition-manual":Fs},seed:{country:"auto"},imageInput:{label:"Pick a seed photo (its plate is known, so the scripted reader works offline) or upload your own — a live in-browser model reads a photo it has never seen.",seedImages:Hs},scriptedVision:Ws,handlers:[{elementId:"ExtractPlate",standsInFor:"Vision model — Florence-2 <OCR> on WebGPU (in-browser)",source:Zs},{elementId:"RecordResult",standsInFor:"Script task — records the governed outcome",source:Ks}]},ed=[as,va,Ka,rs,ms,Xs],nd=Object.assign({"./learn-error-boundary/index.ts":oo,"./learn-exclusive-gateway/index.ts":po,"./learn-message-correlation/index.ts":bo,"./learn-multi-instance-parallel/index.ts":yo,"./learn-service-task/index.ts":Eo,"./learn-signal-broadcast/index.ts":So,"./learn-timer-catch-event/index.ts":Co,"./learn-user-task-form/index.ts":Yo}),td=Object.values(nd).map(e=>e.default).sort((e,n)=>e.id.localeCompare(n.id)),Ze=[...ed,...td];function Dn(){return"/pr-preview/pr-106/"}function rd(e){const n=Dn();return e.startsWith(n)?"/"+e.slice(n.length):e}function id(e=location.pathname){const t=rd(e).match(/^\/examples\/([^/]+)\/?$/);if(t)try{return{kind:"example",id:decodeURIComponent(t[1])}}catch{return{kind:"gallery"}}return{kind:"gallery"}}function od(e=location.search){return new URLSearchParams(e).get("embed")==="1"}function ut(e){return`${Dn()}examples/${encodeURIComponent(e)}`}const gt="p";function ad(){const e=new URLSearchParams(location.search),n=e.get(gt);if(!n)return!1;const t=n.replace(/[\t\n\r]/g,"");if(!t.startsWith("/")||t.startsWith("//")||t.startsWith("/\\"))return!1;e.delete(gt);try{const r=new URL(Dn(),location.href),o=new URL(t.slice(1),r);return o.origin!==location.origin?!1:(o.search=e.toString(),o.hash=location.hash,history.replaceState(null,"",o),!0)}catch{return!1}}function sd(e,n={}){const t=new URL(location.href);t.pathname=e,t.search=n.search??t.search,n.hash!==void 0&&(t.hash=n.hash),n.replace?history.replaceState(history.state,"",t):history.pushState(history.state,"",t),window.dispatchEvent(new PopStateEvent("popstate"))}function ht(){return{route:id(),embed:od()}}function dd(){const[e,n]=h.useState(ht);return h.useEffect(()=>{const t=()=>n(ht());return window.addEventListener("popstate",t),()=>window.removeEventListener("popstate",t)},[]),e}const ld="web-demo-framework:height",cd="web-demo-framework:request-height";function md(e){return{type:ld,height:Math.ceil(e)}}const bt="embed-height-auto";function pd(e){h.useEffect(()=>{if(!e||typeof window>"u"||window.parent===window)return;const n=document.documentElement;n.classList.add(bt);let t=-1;const r=(d=!1)=>{const p=document.documentElement.scrollHeight;!d&&Math.abs(p-t)<2||(t=p,window.parent.postMessage(md(p),"*"))},o=d=>{if(d.source!==window.parent)return;const p=d.data;!p||p.type!==cd||r(!0)};window.addEventListener("message",o),r();const s=new ResizeObserver(()=>r());return s.observe(n),()=>{s.disconnect(),window.removeEventListener("message",o),n.classList.remove(bt)}},[e])}const _t={headline:"The model *runs*. The code is *yours* to edit.",lede:"Every example on this page is a real BPMN process executing in your browser on the nano WebAssembly engine — edit the model, edit the handlers, swap the LLM, and run it again.",tagline:"Runnable Camunda examples"};function ud({text:e}){return i.jsx(i.Fragment,{children:e.split(/\*([^*]+)\*/g).map((n,t)=>t%2===1?i.jsx("em",{children:n},t):i.jsx(h.Fragment,{children:n},t))})}function gd(){const{route:e,embed:n}=dd(),t=Bt().brain,r=$i();pd(n);const o=e.kind==="example"?e.id:Ze[0].id,s=Ze.find(u=>u.id===o)??Ze[0],d=Ze.filter(u=>u.group!=="learn-bpmn"),p=Ze.filter(u=>u.group==="learn-bpmn"),g=u=>{sd(ut(u),{hash:location.hash})},a=s.hero??_t,l=i.jsxs(i.Fragment,{children:[!n&&i.jsxs(i.Fragment,{children:[i.jsxs("section",{className:"hero",children:[i.jsx("h1",{children:i.jsx(ud,{text:a.headline})}),a.lede&&i.jsx("p",{children:a.lede})]}),i.jsx("nav",{className:"example-picker","aria-label":"Scenario examples",children:d.map(u=>i.jsx(J,{size:"sm",variant:u.id===s.id?"default":"secondary","aria-current":u.id===s.id?"page":void 0,onClick:()=>g(u.id),children:u.title},u.id))}),p.length>0&&i.jsxs(i.Fragment,{children:[i.jsx("h2",{className:"example-group-heading",id:"learn-bpmn-heading",children:"Learn BPMN"}),i.jsx("nav",{className:"example-picker","aria-labelledby":"learn-bpmn-heading",children:p.map(u=>i.jsx(J,{size:"sm",variant:u.id===s.id?"default":"secondary","aria-current":u.id===s.id?"page":void 0,onClick:()=>g(u.id),children:u.title},u.id))})]})]}),i.jsxs("div",{className:"example-meta",children:[s.docsUrl&&i.jsx("a",{className:"docs-link",href:s.docsUrl,target:"_blank",rel:"noreferrer noopener",children:"View on camunda.com ↗"}),n&&i.jsx("a",{className:"open-full-page",href:ut(s.id)+(location.hash||""),target:"_top",rel:"noreferrer",children:"Open full page ↗"})]}),i.jsx(eo,{example:s,initialBrainKind:t,initialTourId:r},s.id)]});return n?i.jsx("div",{className:"c4-ui app-shell app-embed",children:i.jsx("main",{id:"main",className:"layout layout-embed",children:l})}):i.jsxs("div",{className:"c4-ui app-shell",children:[i.jsx(Xt,{className:"topbar",logo:i.jsx("span",{className:"brand-dot","aria-hidden":!0}),appName:"Runnable Camunda examples",trailing:i.jsx("span",{className:"app-subtitle",children:a.tagline??_t.tagline})}),i.jsx("main",{id:"main",className:"layout",children:l}),i.jsx("footer",{className:"footer",children:"Running locally in your browser on the nano WebAssembly BPMN engine — no cluster, no server, no data leaving the page."})]})}ad();Vt.createRoot(document.getElementById("root")).render(i.jsx(h.StrictMode,{children:i.jsx(er,{children:i.jsx(gd,{})})}));export{ce as _,fd as c};
