const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/driver-CTZuBZOi.css","assets/diagram-js-DAKGYcfb.css","assets/bpmn-js-BEOU0ddW.css","assets/bpmn-embedded-CpBeWzVm.css","assets/RuntimeDiagram-DTnJz5cT.js","assets/vendor-react-9Ma26nY1.js","assets/Viewer-D_7S4Gwm.js","assets/MonacoEditor-CmppV2jt.js","assets/MonacoEditor-CYJFmcx2.css","assets/vendor-modeler-Bt2tvxef.js","assets/vendor-design-system-eFCp_OAm.js","assets/vendor-design-system-DeH1oJZm.css","assets/parser-DkgAe_kI.js","assets/ModelEditor-Dwlgp6JA.css","assets/FormRenderer-SvIRYxck.js","assets/FormRenderer-D1JIHOW6.css"])))=>i.map(i=>d[i]);
var Ut=Object.defineProperty;var $t=(e,n,t)=>n in e?Ut(e,n,{enumerable:!0,configurable:!0,writable:!0,value:t}):e[n]=t;var U=(e,n,t)=>$t(e,typeof n!="symbol"?n+"":n,t);import{r as h,j as i,i as Gt}from"./vendor-react-9Ma26nY1.js";import{B as J,a as te,L as Je,S as vn,b as Mn,c as xn,d as Nn,e as En,A as ae,f as se,g as de,I as $n,C as Vt,h as Yt,i as Qt,j as qt,k as Jt,l as Ht,T as Wt,m as Zt,n as tn,o as rn,p as Kt,q as Xt}from"./vendor-design-system-eFCp_OAm.js";(function(){const n=document.createElement("link").relList;if(n&&n.supports&&n.supports("modulepreload"))return;for(const o of document.querySelectorAll('link[rel="modulepreload"]'))r(o);new MutationObserver(o=>{for(const s of o)if(s.type==="childList")for(const d of s.addedNodes)d.tagName==="LINK"&&d.rel==="modulepreload"&&r(d)}).observe(document,{childList:!0,subtree:!0});function t(o){const s={};return o.integrity&&(s.integrity=o.integrity),o.referrerPolicy&&(s.referrerPolicy=o.referrerPolicy),o.crossOrigin==="use-credentials"?s.credentials="include":o.crossOrigin==="anonymous"?s.credentials="omit":s.credentials="same-origin",s}function r(o){if(o.ep)return;o.ep=!0;const s=t(o);fetch(o.href,s)}})();const er="modulepreload",nr=function(e){return"/pr-preview/pr-106/"+e},Gn={},le=function(n,t,r){let o=Promise.resolve();if(t&&t.length>0){let d=function(a){return Promise.all(a.map(l=>Promise.resolve(l).then(u=>({status:"fulfilled",value:u}),u=>({status:"rejected",reason:u}))))};document.getElementsByTagName("link");const p=document.querySelector("meta[property=csp-nonce]"),g=(p==null?void 0:p.nonce)||(p==null?void 0:p.getAttribute("nonce"));o=d(t.map(a=>{if(a=nr(a),a in Gn)return;Gn[a]=!0;const l=a.endsWith(".css"),u=l?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${a}"]${u}`))return;const c=document.createElement("link");if(c.rel=l?"stylesheet":er,l||(c.as="script"),c.crossOrigin="",c.href=a,g&&c.setAttribute("nonce",g),document.head.appendChild(c),l)return new Promise((f,_)=>{c.addEventListener("load",f),c.addEventListener("error",()=>_(new Error(`Unable to preload CSS for ${a}`)))})}))}function s(d){const p=new Event("vite:preloadError",{cancelable:!0});if(p.payload=d,window.dispatchEvent(p),!p.defaultPrevented)throw d}return o.then(d=>{for(const p of d||[])p.status==="rejected"&&s(p.reason);return n().catch(s)})},tr="io.camunda.agenticai:aiagent",Se="http://www.omg.org/spec/BPMN/20100524/MODEL",rr="http://camunda.org/schema/zeebe/1.0";function kn(e,n){return Array.from(e.getElementsByTagNameNS(rr,n))}function ft(e,n){return kn(e,n).filter(t=>ir(t)===e)}function ir(e){let n=e.parentElement;for(;n;){if(n.namespaceURI===Se&&n.localName!=="extensionElements")return n;n=n.parentElement}return null}function Pn(e){const n=ft(e,"taskDefinition")[0],t=n==null?void 0:n.getAttribute("type");return t||(e.localName==="scriptTask"?e.getAttribute("id")??null:null)}function Vn(e){const n=Array.from(e.children).find(t=>t.namespaceURI===Se&&t.localName==="documentation");return((n==null?void 0:n.textContent)??"").trim()}function Yn(e){if(!e)return"";const n=e.startsWith("=")?e.slice(1):e,t=n.match(/"((?:[^"\\]|\\.)*)"/g);return t?t.map(r=>r.slice(1,-1).replace(/\\n/g,`
...
`)}function or(e){return yt(wt(e))}function ar(e){const n=Array.from(e.children).find(t=>t.namespaceURI===Se&&t.localName==="extensionElements");return n?yt(wt(n)):[]}function yt(e){const n=/fromAi\(\s*toolCall\.([A-Za-z_$][\w$]*)\s*,\s*"((?:[^"\\]|\\.)*)"\s*(?:,\s*"(\w+)")?/g,t=[],r=new Set;for(const o of e.matchAll(n)){const s=o[1];r.has(s)||(r.add(s),t.push({name:s,description:(o[2]??"").replace(/&#10;/g,`
`).replace(/\\"/g,'"').replace(/&quot;/g,'"').replace(/&#39;/g,"'").trim(),type:o[3]??"string"}))}return t}function sr(e){const n={};for(const t of ft(e,"input")){const r=t.getAttribute("target");r&&(n[r]=t.getAttribute("source")??"")}return n}function dr(e){return Array.from(e.getElementsByTagNameNS(Se,"adHocSubProcess")).filter(n=>(Pn(n)??"").startsWith(tr))}const lr=new Set(["subProcess","adHocSubProcess","callActivity"]),cr=new Set(["adHocSubProcess","subProcess","transaction"]);function mr(e){let n=e.parentElement;for(;n;){if(n.namespaceURI===Se&&cr.has(n.localName))return n;n=n.parentElement}return null}function pr(e,n){const t=sr(e),r=Number((t["data.limits.maxModelCalls"]??"").replace(/^=/,""));return{elementId:e.getAttribute("id")??"agent",label:e.getAttribute("name")??"Agent",jobType:Pn(e),systemPrompt:Yn(t["data.systemPrompt.prompt"]),userPrompt:Yn(t["data.userPrompt.prompt"]),maxModelCalls:Number.isFinite(r)&&r>0?r:10,tools:n}}function ur(e,n){var u;const t=e.getAttribute("id")??"",r=e.getAttribute("name")??t,o=dr(e);o.length>1&&n.push({severity:"warning",elementId:o.map(c=>c.getAttribute("id")).join(", "),message:`Process "${r}" hosts ${o.length} AI Agent sub-processes (${o.map(c=>c.getAttribute("id")).join(", ")}). Each gets its own independent agent state (turn counter, called tools) — the run itself is shared across hosts, but each host's agent state within it is not.`});const s=[],d=new Map(o.map(c=>[c,[]]));for(const c of Array.from(e.getElementsByTagName("*"))){if(c.namespaceURI!==Se||o.includes(c))continue;const f=c.getAttribute("id");if(!f)continue;const _=mr(c),y=_&&o.includes(_)?_:null;if(y&&lr.has(c.localName)){const E=c.getAttribute("name")??f,B=Vn(c);s.push({elementId:f,label:E,jobType:"",documentation:B,isTool:!0,compound:!0}),d.get(y).push({elementId:f,label:E,jobType:"",documentation:B,args:ar(c),compound:!0});continue}const b=Pn(c);if(!b)continue;const M={elementId:f,label:c.getAttribute("name")??f,jobType:b,documentation:Vn(c),isTool:y!=null};s.push(M),y&&d.get(y).push({elementId:f,label:M.label,jobType:b,documentation:M.documentation,args:or(c)})}const p=o.map(c=>pr(c,d.get(c))),g=Array.from(e.getElementsByTagNameNS(Se,"userTask")).map(c=>{var f;return{elementId:c.getAttribute("id")??"",label:c.getAttribute("name")??c.getAttribute("id")??"",formId:((f=kn(c,"formDefinition")[0])==null?void 0:f.getAttribute("formId"))??void 0}}),a=e.getElementsByTagNameNS(Se,"startEvent")[0],l=a?((u=kn(a,"formDefinition")[0])==null?void 0:u.getAttribute("formId"))??void 0:void 0;return{processId:t,processName:r,tasks:s,agents:p,userTasks:g,startFormId:l}}function gr(e,n={}){const t=new DOMParser().parseFromString(e,"application/xml"),r=t.getElementsByTagName("parsererror")[0];if(r)throw new Error(`Invalid BPMN XML: ${r.textContent}`);const o=Array.from(t.getElementsByTagNameNS(Se,"process"));if(o.length===0)throw new Error("No <bpmn:process> in the diagram.");const s=[],d=o.map(g=>ur(g,s));let p=n.processId?d.find(g=>g.processId===n.processId):void 0;return n.processId&&!p&&s.push({severity:"warning",message:`Requested process "${n.processId}" not found — falling back to "${d[0].processId}".`}),p??(p=d[0]),d.length>1&&s.push({severity:"warning",message:`Diagram has ${d.length} <bpmn:process> elements (${d.map(g=>g.processId).join(", ")}); using "${p.processId}" as the active process. Pass a processId to parseModel to target another.`}),{processes:d,diagnostics:s,processId:p.processId,processName:p.processName,tasks:p.tasks,agent:p.agents[0]??null,agents:d.flatMap(g=>g.agents),userTasks:p.userTasks,startFormId:p.startFormId}}function hr(e){return e?e.imageId?{imageId:e.imageId}:e.imageName?{imageName:e.imageName}:{}:{}}function vt(e,n){return n?e.pixels:e.imageId??e.pixels}const br="No image selected — pick or upload a photo to read.";function Qn(){return br}function _r(e,n){return async t=>{const r=e.resolve(n);if(!r)return Qn();const o=vt(r,e.live);if(o===void 0)return Qn();try{return await e.read(o,t)}catch(s){return`Couldn't read the image (${s instanceof Error?s.message:String(s)}).`}}}function fr(e,n){return async()=>{const t=e.resolve(n);if(t)return vt(t,e.live)}}function wr(){return`<!doctype html><html><head><meta charset="utf-8"></head><body><script>
    "use strict";
    ...
    post({ kind: "ready" });
  <\/script></body></html>`}function Mt(e,n={}){const{timeoutMs:t=5e3,onTrace:r,onVision:o,onImage:s}=n,d=`${Date.now()}-${Math.random().toString(36).slice(2)}`;return new Promise((p,g)=>{const a=document.createElement("iframe");a.setAttribute("sandbox","allow-scripts"),a.style.display="none",a.setAttribute("aria-hidden","true");let l=!1,u;const c=()=>{u&&clearTimeout(u),window.removeEventListener("message",_),a.remove()},f=b=>{l||(l=!0,c(),b())};function _(b){var E;if(b.source!==a.contentWindow)return;const M=b.data;if(!(!M||typeof M!="object")){if(M.kind==="ready"){const B=e.job,Q=e.kind==="run-handler"?{kind:"run-handler",id:d,source:e.source,job:B,hasVision:e.hasVision}:{kind:"run-agent",id:d,source:e.source,job:B};(E=a.contentWindow)==null||E.postMessage(Q,"*");return}"id"in M&&M.id!==d||(M.kind==="trace"?r==null||r(M.text):M.kind==="vision-request"?y(M.callId,o,"vision",M.prompt):M.kind==="image-request"?y(M.callId,s,"image"):M.kind==="result"?f(()=>p(M.value)):M.kind==="error"&&f(()=>g(new Error(M.message))))}}function y(b,M,E,...B){const Q=H=>{var be;return(be=a.contentWindow)==null?void 0:be.postMessage(H,"*")};if(!M){Q({kind:"helper-error",id:d,callId:b,message:`${E} helper is not available.`});return}Promise.resolve().then(()=>M(...B)).then(H=>Q({kind:"helper-result",id:d,callId:b,value:H}),H=>Q({kind:"helper-error",id:d,callId:b,message:H instanceof Error?H.message:String(H)}))}window.addEventListener("message",_),u=setTimeout(()=>{f(()=>g(new Error(`Handler timed out after ${t}ms — the sandboxed run was terminated.`)))},t),a.srcdoc=wr(),document.body.appendChild(a)})}function xt(e){return{key:e.key,type:e.type,elementId:e.elementId,instanceKey:e.instanceKey,variables:e.variables??{}}}function yr(e,n,t){const r=typeof t.vision=="function";return Mt({kind:"run-handler",source:e,job:xt(n),hasVision:r},{onTrace:t.trace,onVision:t.vision?o=>t.vision(o):void 0,onImage:t.image?()=>t.image():void 0})}function vr(e,n){return Mt({kind:"run-agent",source:e,job:xt(n)})}function Nt(e,n){try{new Function(`"use strict"; return (${e});`)}catch{throw new Error(`${n} has a syntax error.`)}}function Mr(e){return Nt(e,"Handler code"),(n,t)=>yr(e,n,t)}function xr(e){return Nt(e,"Agent code"),n=>vr(e,n)}function Nr(e,n,t,r){return{sleep:o=>new Promise(s=>setTimeout(s,o)),trace:o=>n({kind:"tool",text:`   ${o}`,elementId:e.elementId,turn:t}),text:(o,s="")=>{const d=e.variables[o];return typeof d=="string"?d:d==null?s:String(d)},num:(o,s=0)=>{const d=e.variables[o],p=typeof d=="number"?d:Number(d);return Number.isFinite(p)?p:s},...r?{vision:_r(r,e.instanceKey),image:fr(r,e.instanceKey)}:{}}}function Er(e){if(e===void 0)return"undefined";try{return JSON.stringify(e)}catch{return"[unserializable value]"}}function kr(e,n,t,r,o){const s={},d=e.processes.flatMap(g=>g.tasks),p=new Map(d.map(g=>[g.elementId,g.label]));for(const g of d)g.compound||s[g.jobType]||(s[g.jobType]=async a=>{const l=n[a.elementId];if(!l)throw new Error(`No handler registered for ${a.elementId} (job type ${a.type})`);const u=p.get(a.elementId)??a.elementId,c=r==null?void 0:r.current;t({kind:"tool",text:`▶ ${u}`,elementId:a.elementId,turn:c});const f=await l(a,Nr(a,t,c,o));return t({kind:"vars",text:`  ↳ ${Er(f)}`,elementId:a.elementId,result:f,turn:c}),f});return s}const Ir=/\{\{\s*([A-Za-z][A-Za-z0-9_-]*)\s*\}\}/g;function en(...e){const n=Object.create(null);for(const t of e)if(t)for(const r of Object.keys(t))n[r]=t[r];return n}function Et(e){return(e.split("/").pop()??e).replace(/\.[^./]+$/,"")}function kt(e){return e.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;")}function Tr(e){return kt(e).replace(/"/g,"&quot;").replace(/\n/g,"&#10;").replace(/\t/g,"&#9;")}function jr(e){return e.replace(/\\/g,"\\\\").replace(/&/g,"&amp;").replace(/"/g,"\\&#34;").replace(/\n/g,"&#10;").replace(/\t/g,"&#9;").replace(/</g,"&lt;").replace(/>/g,"&gt;")}function Sr(e){return JSON.stringify(e).slice(1,-1)}function Pr(e,n){const t=e.lastIndexOf("<",n),r=e.lastIndexOf(">",n);if(t<=r)return"text";const o=e.slice(t,n);if((o.match(/"/g)??[]).length%2===0)return"text";const d=o.lastIndexOf('"');return(o.slice(d+1).match(/&#34;|&quot;/g)??[]).length%2===1?"feel-literal":"attribute"}function Ar(e,n,t="xml"){const r=[],o=new Set;return{result:e.replace(Ir,(d,p,g)=>{const a=p.trim();if(!Object.prototype.hasOwnProperty.call(n,a))return o.has(a)||(o.add(a),r.push(a)),d;const l=n[a];if(t==="json")return Sr(l);const u=Pr(e,g);return u==="feel-literal"?jr(l):u==="attribute"?Tr(l):kt(l)}),unresolved:r}}function Dr(){return{processes:[],diagnostics:[],processId:"",processName:"",tasks:[],agent:null,agents:[],userTasks:[],startFormId:void 0}}function Cr(e,n={},t=e.bpmn,r={}){const o=[],s=en(e.templates,r),{result:d,unresolved:p}=Ar(t,s,"xml");for(const M of p)o.push({severity:"warning",message:`Template placeholder "{{${M}}}" has no matching prompt/template content — left in the model as-is, not substituted.`});let g;try{g=gr(d)}catch(M){return o.push({severity:"error",message:M instanceof Error?M.message:String(M)}),{resolvedBpmn:d,model:Dr(),handlers:{},forms:{},diagnostics:o,hasErrors:!0}}o.push(...g.diagnostics);const a=g.processes.flatMap(M=>M.tasks),l=new Map(e.handlers.map(M=>[M.elementId,M.source])),u={};for(const M of a){if(M.compound)continue;const E=n[M.elementId]??l.get(M.elementId);if(E===void 0){o.push({severity:"error",elementId:M.elementId,jobType:M.jobType,message:`No handler for "${M.label}" (${M.elementId}, job type "${M.jobType}"). Add a handler for this element, or remove it from the diagram.`});continue}try{u[M.elementId]=Mr(E)}catch(B){o.push({severity:"error",elementId:M.elementId,jobType:M.jobType,message:`"${M.label}" (${M.elementId}): handler code didn't compile — ${B instanceof Error?B.message:String(B)}`})}}const c=new Set(a.map(M=>M.elementId)),f=new Set([...l.keys(),...Object.keys(n)]);for(const M of f)c.has(M)||o.push({severity:"error",elementId:M,message:`Handler "${M}" doesn't match any element in the current diagram — likely orphaned by a rename. Rename it back, or remove the handler.`});const _={},y=e.forms??{},b=(M,E)=>{if(!M)return;const B=y[M];B?_[M]=B:o.push({severity:"error",formId:M,message:`${E} references form "${M}", which has no matching schema.`})};for(const M of g.processes){b(M.startFormId,`The start event of process "${M.processName}"`);for(const E of M.userTasks)b(E.formId,`User task "${E.label}" (${E.elementId})`)}return{resolvedBpmn:d,model:g,handlers:u,forms:_,diagnostics:o,hasErrors:o.some(M=>M.severity==="error")}}function Br(e){const n=e.indexOf("{");if(n<0)return null;let t=0;for(let r=n;r<e.length;r++)if(e[r]==="{")t++;else if(e[r]==="}"&&(t--,t===0))try{const o=JSON.parse(e.slice(n,r+1));return typeof o=="object"&&o!==null&&!Array.isArray(o)?o:null}catch{return null}return null}function In(e,n=220){const t=e.replace(/\s+/g," ").trim();return t.length>n?`${t.slice(0,n-1)}…`:t}function qn(e){const n=e.arguments??e.args??e.parameters??e.input;return n&&typeof n=="object"&&!Array.isArray(n)?n:{}}function Jn(e){if(!e)return[];const n=e.tool??e.name??e.action;if(typeof n=="string"&&n.trim())return[{name:n.trim(),args:qn(e)}];const t=e.tools??e.tool_calls??e.toolset??e.actions,r=Array.isArray(t)?t:Object.values(e).find(s=>Array.isArray(s))??[],o=[];for(const s of r)if(typeof s=="string")s.trim()&&o.push({name:s.trim(),args:{}});else if(s&&typeof s=="object"){const d=s,p=d.name??d.tool??d.id??d.function;typeof p=="string"&&p.trim()&&o.push({name:p.trim(),args:qn(d)})}return o}function Lr(e){if(!e)return!1;const n=e.done??e.finished??e.complete;return typeof n=="boolean"?n:typeof n=="string"?n.toLowerCase()==="true":!1}function Hn(e){const n=e.args.length?e.args.map(r=>`      ${r.name} (${r.type}) — ${r.description}`).join(`
`):"      (none)",t=e.documentation||e.label;return`${e.elementId}
    purpose: ${t}
    arguments:
${n}`}function Rr(e,n,t){const r=e.systemPrompt||"You are an agent driving a business process. Use the tools available to you.",o=t[0]??e.tools[0];if(t.length===0)return`${r}
...
character, with nothing added. When your work is finished, reply exactly
{"done": true} and no tool.`}function Fr(e,n,t,r,o=[],s=[],d=!1){const p=e.userPrompt||"Carry out your task.",g=Object.entries(n).filter(([,l])=>typeof l=="string"&&l.trim().length>0).map(([l,u])=>`  ${l}: ${String(u)}`),a=[p,g.length?`Case data:
${g.join(`
...
`)}async function zr(e,n,t,r,o,s){let d="";n({kind:"llm",text:"LLM thinking…",key:t,pending:!0,turn:s});const p=await e(r,o,g=>{d+=g,n({kind:"llm",text:`${In(d)} ▍`,key:t,pending:!0,turn:s})});return n({kind:"llm",text:In(p||d)||"(empty reply)",key:t,pending:!1,turn:s}),p}function Or(e,n){switch(e){case"number":return typeof n=="number"&&Number.isFinite(n)?{ok:!0,value:n}:typeof n=="string"&&n.trim()!==""&&Number.isFinite(Number(n))?{ok:!0,value:Number(n)}:{ok:!1};case"boolean":return typeof n=="boolean"?{ok:!0,value:n}:typeof n=="string"&&/^(true|false)$/i.test(n.trim())?{ok:!0,value:n.trim().toLowerCase()==="true"}:{ok:!1};default:return typeof n=="object"?{ok:!1}:{ok:!0,value:String(n)}}}function Ur(e,n,t){const r={},o=new Map,s=new Map;for(const{tool:d,args:p}of e){const g={};for(const a of d.args){const l=p[a.name];if(!(l!=null&&l!=="")){n({kind:"error",text:`🤖 ${d.elementId}: model supplied no value for "${a.name}"`,turn:t,elementId:d.elementId});continue}const c=o.get(a.name);if(c!==void 0&&c!==d.elementId){n({kind:"error",text:`🤖 argument name collision on "${a.name}": both ${c} and ${d.elementId} declare it — ${c} already claimed it this turn, ${d.elementId}'s value is dropped`,turn:t,elementId:d.elementId});continue}const f=Or(a.type,l);if(!f.ok){n({kind:"error",text:`🤖 ${d.elementId}: "${a.name}" is declared as ${a.type} but the model supplied ${JSON.stringify(l)} — rejected, not passed through`,turn:t,elementId:d.elementId});continue}r[a.name]=f.value,g[a.name]=f.value,o.set(a.name,d.elementId)}s.set(d.elementId,g)}return{variablesOut:r,forHistory:s}}function $r(e,n,t,r={}){const{maxNewTokens:o=384,allowRepeats:s=!1,allowMultiToolTurns:d=!1,turnRef:p,requiredTools:g=[],maxEarlyDoneNudges:a=1}=r;let l=0;const u=new Set,c=[];let f=0,_=[],y=[];return async b=>{const M=b.variables,E=M.toolCallResult;for(E!==void 0&&c.length&&(c[c.length-1]=`${c[c.length-1]} → ${In(JSON.stringify(E),160)}`);;){const Q=await B();if(Q)return Q}async function B(){if(l+=1,p&&(p.current=l),l>e.maxModelCalls)return t({kind:"error",text:`Turn budget spent (maxModelCalls=${e.maxModelCalls}) — completing the agent.`,turn:l}),{completionConditionFulfilled:!0};const Q=s?e.tools:e.tools.filter(N=>!u.has(N.elementId)),H=[{role:"system",content:Rr(e,d,Q)},{role:"user",content:Fr(e,M,c,Q,_,y,s)}];_=[],y=[];let be;try{be=await zr(n,t,`llm-turn-${l}`,H,o,l)}catch(N){return t({kind:"error",text:`LLM call failed: ${N instanceof Error?N.message:String(N)} — completing the agent.`,turn:l}),{completionConditionFulfilled:!0}}const ce=Br(be);if(Lr(ce)&&Jn(ce).length===0){const N=g.filter(z=>!u.has(z));return N.length&&f<a?(f+=1,_=N,t({kind:"agent",text:`🤖 model says it is done, but ${N.join(", ")} hasn't run — asking once more`,turn:l}),null):(t({kind:"agent",text:"🤖 model says it is done",turn:l}),{completionConditionFulfilled:!0})}const we=Jn(ce);if(we.length===0)return t({kind:"error",text:"🤖 model named no tool (and didn't say it was done) — asking again",turn:l}),y=['it named no tool and did not say it was done — reply with {"tool": "...", "arguments": {...}} or {"done": true}'],null;const re=[],q=[],X=[];for(const N of we){const z=e.tools.find($=>$.elementId===N.name);if(!z){q.push(N.name);continue}if(!s&&u.has(z.elementId)){X.push(z.elementId);continue}re.push({tool:z,args:N.args})}if(q.length&&t({kind:"error",text:`🤖 model named a tool that doesn't exist: ${q.join(", ")} — nothing activated`,turn:l}),X.length&&t({kind:"error",text:`🤖 model asked to re-run ${X.join(", ")} — skipped (already run)`,turn:l}),re.length===0)return t({kind:"agent",text:"🤖 nothing activated — asking again",turn:l}),y=[...q.length?[`${q.join(", ")} ${q.length===1?"is":"are"} not a real tool`]:[],...X.length?[`${X.join(", ")} has already run and will never run again — pick a different tool, or reply {"done": true} if nothing is left to do`]:[]],null;const{variablesOut:k,forHistory:T}=Ur(re,t,l);for(const{tool:N}of re)u.add(N.elementId),c.push(`- ${N.elementId}(${JSON.stringify(T.get(N.elementId))})`);for(const{tool:N}of re)t({kind:"agent",text:`🤖 calling ${N.elementId}`,turn:l,elementId:N.elementId,args:T.get(N.elementId)??{}});return{activateElements:re.map(N=>({elementId:N.tool.elementId})),variables:k}}}}function Gr(e,n,t,r={}){const o=new Map(e.map(s=>[s.elementId,$r(s,n,t,r)]));return async s=>{const d=o.get(s.elementId);if(!d)throw new Error(`No agent host registered for "${s.elementId}"`);return d(s)}}class Tn{__destroy_into_raw(){const n=this.__wbg_ptr;return this.__wbg_ptr=0,Wn.unregister(this),n}free(){const n=this.__destroy_into_raw();m.__wbg_testengine_free(n,0)}activateJobs(n,t,r,o){let s,d;try{const f=m.__wbindgen_add_to_stack_pointer(-16),_=A(n,m.__wbindgen_export,m.__wbindgen_export2),y=S,b=A(o,m.__wbindgen_export,m.__wbindgen_export2),M=S;m.testengine_activateJobs(f,this.__wbg_ptr,_,y,t,r,b,M);var p=w().getInt32(f+0,!0),g=w().getInt32(f+4,!0),a=w().getInt32(f+8,!0),l=w().getInt32(f+12,!0),u=p,c=g;if(l)throw u=0,c=0,F(a);return s=u,d=c,R(u,c)}finally{m.__wbindgen_add_to_stack_pointer(16),m.__wbindgen_export3(s,d,1)}}advanceTime(n){let t,r;try{const l=m.__wbindgen_add_to_stack_pointer(-16);m.testengine_advanceTime(l,this.__wbg_ptr,n);var o=w().getInt32(l+0,!0),s=w().getInt32(l+4,!0),d=w().getInt32(l+8,!0),p=w().getInt32(l+12,!0),g=o,a=s;if(p)throw g=0,a=0,F(d);return t=g,r=a,R(g,a)}finally{m.__wbindgen_add_to_stack_pointer(16),m.__wbindgen_export3(t,r,1)}}assignUserTask(n,t,r){let o,s;try{const c=m.__wbindgen_add_to_stack_pointer(-16),f=A(n,m.__wbindgen_export,m.__wbindgen_export2),_=S,y=A(t,m.__wbindgen_export,m.__wbindgen_export2),b=S;m.testengine_assignUserTask(c,this.__wbg_ptr,f,_,y,b,r);var d=w().getInt32(c+0,!0),p=w().getInt32(c+4,!0),g=w().getInt32(c+8,!0),a=w().getInt32(c+12,!0),l=d,u=p;if(a)throw l=0,u=0,F(g);return o=l,s=u,R(l,u)}finally{m.__wbindgen_add_to_stack_pointer(16),m.__wbindgen_export3(o,s,1)}}broadcastSignal(n,t){let r,o;try{const u=m.__wbindgen_add_to_stack_pointer(-16),c=A(n,m.__wbindgen_export,m.__wbindgen_export2),f=S,_=A(t,m.__wbindgen_export,m.__wbindgen_export2),y=S;m.testengine_broadcastSignal(u,this.__wbg_ptr,c,f,_,y);var s=w().getInt32(u+0,!0),d=w().getInt32(u+4,!0),p=w().getInt32(u+8,!0),g=w().getInt32(u+12,!0),a=s,l=d;if(g)throw a=0,l=0,F(p);return r=a,o=l,R(a,l)}finally{m.__wbindgen_add_to_stack_pointer(16),m.__wbindgen_export3(r,o,1)}}cancelInstance(n){let t,r;try{const l=m.__wbindgen_add_to_stack_pointer(-16),u=A(n,m.__wbindgen_export,m.__wbindgen_export2),c=S;m.testengine_cancelInstance(l,this.__wbg_ptr,u,c);var o=w().getInt32(l+0,!0),s=w().getInt32(l+4,!0),d=w().getInt32(l+8,!0),p=w().getInt32(l+12,!0),g=o,a=s;if(p)throw g=0,a=0,F(d);return t=g,r=a,R(g,a)}finally{m.__wbindgen_add_to_stack_pointer(16),m.__wbindgen_export3(t,r,1)}}completeAgentJob(n,t,r){let o,s;try{const c=m.__wbindgen_add_to_stack_pointer(-16),f=A(n,m.__wbindgen_export,m.__wbindgen_export2),_=S,y=A(t,m.__wbindgen_export,m.__wbindgen_export2),b=S,M=A(r,m.__wbindgen_export,m.__wbindgen_export2),E=S;m.testengine_completeAgentJob(c,this.__wbg_ptr,f,_,y,b,M,E);var d=w().getInt32(c+0,!0),p=w().getInt32(c+4,!0),g=w().getInt32(c+8,!0),a=w().getInt32(c+12,!0),l=d,u=p;if(a)throw l=0,u=0,F(g);return o=l,s=u,R(l,u)}finally{m.__wbindgen_add_to_stack_pointer(16),m.__wbindgen_export3(o,s,1)}}completeJob(n,t){let r,o;try{const u=m.__wbindgen_add_to_stack_pointer(-16),c=A(n,m.__wbindgen_export,m.__wbindgen_export2),f=S,_=A(t,m.__wbindgen_export,m.__wbindgen_export2),y=S;m.testengine_completeJob(u,this.__wbg_ptr,c,f,_,y);var s=w().getInt32(u+0,!0),d=w().getInt32(u+4,!0),p=w().getInt32(u+8,!0),g=w().getInt32(u+12,!0),a=s,l=d;if(g)throw a=0,l=0,F(p);return r=a,o=l,R(a,l)}finally{m.__wbindgen_add_to_stack_pointer(16),m.__wbindgen_export3(r,o,1)}}completeUserTask(n,t){let r,o;try{const u=m.__wbindgen_add_to_stack_pointer(-16),c=A(n,m.__wbindgen_export,m.__wbindgen_export2),f=S,_=A(t,m.__wbindgen_export,m.__wbindgen_export2),y=S;m.testengine_completeUserTask(u,this.__wbg_ptr,c,f,_,y);var s=w().getInt32(u+0,!0),d=w().getInt32(u+4,!0),p=w().getInt32(u+8,!0),g=w().getInt32(u+12,!0),a=s,l=d;if(g)throw a=0,l=0,F(p);return r=a,o=l,R(a,l)}finally{m.__wbindgen_add_to_stack_pointer(16),m.__wbindgen_export3(r,o,1)}}correlateMessage(n,t,r){let o,s;try{const c=m.__wbindgen_add_to_stack_pointer(-16),f=A(n,m.__wbindgen_export,m.__wbindgen_export2),_=S,y=A(t,m.__wbindgen_export,m.__wbindgen_export2),b=S,M=A(r,m.__wbindgen_export,m.__wbindgen_export2),E=S;m.testengine_correlateMessage(c,this.__wbg_ptr,f,_,y,b,M,E);var d=w().getInt32(c+0,!0),p=w().getInt32(c+4,!0),g=w().getInt32(c+8,!0),a=w().getInt32(c+12,!0),l=d,u=p;if(a)throw l=0,u=0,F(g);return o=l,s=u,R(l,u)}finally{m.__wbindgen_add_to_stack_pointer(16),m.__wbindgen_export3(o,s,1)}}createInstance(n,t,r){let o,s;try{const c=m.__wbindgen_add_to_stack_pointer(-16),f=A(n,m.__wbindgen_export,m.__wbindgen_export2),_=S,y=A(t,m.__wbindgen_export,m.__wbindgen_export2),b=S;m.testengine_createInstance(c,this.__wbg_ptr,f,_,y,b,Jr(r)?Number.MAX_SAFE_INTEGER:r>>0);var d=w().getInt32(c+0,!0),p=w().getInt32(c+4,!0),g=w().getInt32(c+8,!0),a=w().getInt32(c+12,!0),l=d,u=p;if(a)throw l=0,u=0,F(g);return o=l,s=u,R(l,u)}finally{m.__wbindgen_add_to_stack_pointer(16),m.__wbindgen_export3(o,s,1)}}debugClear(){m.testengine_debugClear(this.__wbg_ptr)}debugCreateInstance(n,t,r){let o,s;try{const c=m.__wbindgen_add_to_stack_pointer(-16),f=A(n,m.__wbindgen_export,m.__wbindgen_export2),_=S,y=A(t,m.__wbindgen_export,m.__wbindgen_export2),b=S,M=A(r,m.__wbindgen_export,m.__wbindgen_export2),E=S;m.testengine_debugCreateInstance(c,this.__wbg_ptr,f,_,y,b,M,E);var d=w().getInt32(c+0,!0),p=w().getInt32(c+4,!0),g=w().getInt32(c+8,!0),a=w().getInt32(c+12,!0),l=d,u=p;if(a)throw l=0,u=0,F(g);return o=l,s=u,R(l,u)}finally{m.__wbindgen_add_to_stack_pointer(16),m.__wbindgen_export3(o,s,1)}}get debugIsPaused(){return m.testengine_debugIsPaused(this.__wbg_ptr)!==0}debugResume(){let n,t;try{const a=m.__wbindgen_add_to_stack_pointer(-16);m.testengine_debugResume(a,this.__wbg_ptr);var r=w().getInt32(a+0,!0),o=w().getInt32(a+4,!0),s=w().getInt32(a+8,!0),d=w().getInt32(a+12,!0),p=r,g=o;if(d)throw p=0,g=0,F(s);return n=p,t=g,R(p,g)}finally{m.__wbindgen_add_to_stack_pointer(16),m.__wbindgen_export3(n,t,1)}}debugStep(){let n,t;try{const a=m.__wbindgen_add_to_stack_pointer(-16);m.testengine_debugStep(a,this.__wbg_ptr);var r=w().getInt32(a+0,!0),o=w().getInt32(a+4,!0),s=w().getInt32(a+8,!0),d=w().getInt32(a+12,!0),p=r,g=o;if(d)throw p=0,g=0,F(s);return n=p,t=g,R(p,g)}finally{m.__wbindgen_add_to_stack_pointer(16),m.__wbindgen_export3(n,t,1)}}deploy(n){let t,r;try{const l=m.__wbindgen_add_to_stack_pointer(-16),u=A(n,m.__wbindgen_export,m.__wbindgen_export2),c=S;m.testengine_deploy(l,this.__wbg_ptr,u,c);var o=w().getInt32(l+0,!0),s=w().getInt32(l+4,!0),d=w().getInt32(l+8,!0),p=w().getInt32(l+12,!0),g=o,a=s;if(p)throw g=0,a=0,F(d);return t=g,r=a,R(g,a)}finally{m.__wbindgen_add_to_stack_pointer(16),m.__wbindgen_export3(t,r,1)}}deployForm(n){let t,r;try{const l=m.__wbindgen_add_to_stack_pointer(-16),u=A(n,m.__wbindgen_export,m.__wbindgen_export2),c=S;m.testengine_deployForm(l,this.__wbg_ptr,u,c);var o=w().getInt32(l+0,!0),s=w().getInt32(l+4,!0),d=w().getInt32(l+8,!0),p=w().getInt32(l+12,!0),g=o,a=s;if(p)throw g=0,a=0,F(d);return t=g,r=a,R(g,a)}finally{m.__wbindgen_add_to_stack_pointer(16),m.__wbindgen_export3(t,r,1)}}deployResource(n,t){let r,o;try{const u=m.__wbindgen_add_to_stack_pointer(-16),c=A(n,m.__wbindgen_export,m.__wbindgen_export2),f=S,_=A(t,m.__wbindgen_export,m.__wbindgen_export2),y=S;m.testengine_deployResource(u,this.__wbg_ptr,c,f,_,y);var s=w().getInt32(u+0,!0),d=w().getInt32(u+4,!0),p=w().getInt32(u+8,!0),g=w().getInt32(u+12,!0),a=s,l=d;if(g)throw a=0,l=0,F(p);return r=a,o=l,R(a,l)}finally{m.__wbindgen_add_to_stack_pointer(16),m.__wbindgen_export3(r,o,1)}}events(){let n,t;try{const a=m.__wbindgen_add_to_stack_pointer(-16);m.testengine_events(a,this.__wbg_ptr);var r=w().getInt32(a+0,!0),o=w().getInt32(a+4,!0),s=w().getInt32(a+8,!0),d=w().getInt32(a+12,!0),p=r,g=o;if(d)throw p=0,g=0,F(s);return n=p,t=g,R(p,g)}finally{m.__wbindgen_add_to_stack_pointer(16),m.__wbindgen_export3(n,t,1)}}failJob(n,t,r){let o,s;try{const c=m.__wbindgen_add_to_stack_pointer(-16),f=A(n,m.__wbindgen_export,m.__wbindgen_export2),_=S,y=A(r,m.__wbindgen_export,m.__wbindgen_export2),b=S;m.testengine_failJob(c,this.__wbg_ptr,f,_,t,y,b);var d=w().getInt32(c+0,!0),p=w().getInt32(c+4,!0),g=w().getInt32(c+8,!0),a=w().getInt32(c+12,!0),l=d,u=p;if(a)throw l=0,u=0,F(g);return o=l,s=u,R(l,u)}finally{m.__wbindgen_add_to_stack_pointer(16),m.__wbindgen_export3(o,s,1)}}migrate(n,t,r){let o,s;try{const c=m.__wbindgen_add_to_stack_pointer(-16),f=A(n,m.__wbindgen_export,m.__wbindgen_export2),_=S,y=A(t,m.__wbindgen_export,m.__wbindgen_export2),b=S,M=A(r,m.__wbindgen_export,m.__wbindgen_export2),E=S;m.testengine_migrate(c,this.__wbg_ptr,f,_,y,b,M,E);var d=w().getInt32(c+0,!0),p=w().getInt32(c+4,!0),g=w().getInt32(c+8,!0),a=w().getInt32(c+12,!0),l=d,u=p;if(a)throw l=0,u=0,F(g);return o=l,s=u,R(l,u)}finally{m.__wbindgen_add_to_stack_pointer(16),m.__wbindgen_export3(o,s,1)}}modify(n,t,r){let o,s;try{const c=m.__wbindgen_add_to_stack_pointer(-16),f=A(n,m.__wbindgen_export,m.__wbindgen_export2),_=S,y=A(t,m.__wbindgen_export,m.__wbindgen_export2),b=S,M=A(r,m.__wbindgen_export,m.__wbindgen_export2),E=S;m.testengine_modify(c,this.__wbg_ptr,f,_,y,b,M,E);var d=w().getInt32(c+0,!0),p=w().getInt32(c+4,!0),g=w().getInt32(c+8,!0),a=w().getInt32(c+12,!0),l=d,u=p;if(a)throw l=0,u=0,F(g);return o=l,s=u,R(l,u)}finally{m.__wbindgen_add_to_stack_pointer(16),m.__wbindgen_export3(o,s,1)}}constructor(){const n=m.testengine_new();return this.__wbg_ptr=n,Wn.register(this,this.__wbg_ptr,this),this}get now(){return m.testengine_now(this.__wbg_ptr)}reset(){m.testengine_reset(this.__wbg_ptr)}resolveIncident(n){let t,r;try{const l=m.__wbindgen_add_to_stack_pointer(-16),u=A(n,m.__wbindgen_export,m.__wbindgen_export2),c=S;m.testengine_resolveIncident(l,this.__wbg_ptr,u,c);var o=w().getInt32(l+0,!0),s=w().getInt32(l+4,!0),d=w().getInt32(l+8,!0),p=w().getInt32(l+12,!0),g=o,a=s;if(p)throw g=0,a=0,F(d);return t=g,r=a,R(g,a)}finally{m.__wbindgen_add_to_stack_pointer(16),m.__wbindgen_export3(t,r,1)}}setVariables(n,t,r){let o,s;try{const c=m.__wbindgen_add_to_stack_pointer(-16),f=A(n,m.__wbindgen_export,m.__wbindgen_export2),_=S,y=A(t,m.__wbindgen_export,m.__wbindgen_export2),b=S;m.testengine_setVariables(c,this.__wbg_ptr,f,_,y,b,r);var d=w().getInt32(c+0,!0),p=w().getInt32(c+4,!0),g=w().getInt32(c+8,!0),a=w().getInt32(c+12,!0),l=d,u=p;if(a)throw l=0,u=0,F(g);return o=l,s=u,R(l,u)}finally{m.__wbindgen_add_to_stack_pointer(16),m.__wbindgen_export3(o,s,1)}}snapshot(){let n,t;try{const a=m.__wbindgen_add_to_stack_pointer(-16);m.testengine_snapshot(a,this.__wbg_ptr);var r=w().getInt32(a+0,!0),o=w().getInt32(a+4,!0),s=w().getInt32(a+8,!0),d=w().getInt32(a+12,!0),p=r,g=o;if(d)throw p=0,g=0,F(s);return n=p,t=g,R(p,g)}finally{m.__wbindgen_add_to_stack_pointer(16),m.__wbindgen_export3(n,t,1)}}throwError(n,t,r){let o,s;try{const c=m.__wbindgen_add_to_stack_pointer(-16),f=A(n,m.__wbindgen_export,m.__wbindgen_export2),_=S,y=A(t,m.__wbindgen_export,m.__wbindgen_export2),b=S,M=A(r,m.__wbindgen_export,m.__wbindgen_export2),E=S;m.testengine_throwError(c,this.__wbg_ptr,f,_,y,b,M,E);var d=w().getInt32(c+0,!0),p=w().getInt32(c+4,!0),g=w().getInt32(c+8,!0),a=w().getInt32(c+12,!0),l=d,u=p;if(a)throw l=0,u=0,F(g);return o=l,s=u,R(l,u)}finally{m.__wbindgen_add_to_stack_pointer(16),m.__wbindgen_export3(o,s,1)}}tickNow(n){let t,r;try{const l=m.__wbindgen_add_to_stack_pointer(-16);m.testengine_tickNow(l,this.__wbg_ptr,n);var o=w().getInt32(l+0,!0),s=w().getInt32(l+4,!0),d=w().getInt32(l+8,!0),p=w().getInt32(l+12,!0),g=o,a=s;if(p)throw g=0,a=0,F(d);return t=g,r=a,R(g,a)}finally{m.__wbindgen_add_to_stack_pointer(16),m.__wbindgen_export3(t,r,1)}}unassignUserTask(n){let t,r;try{const l=m.__wbindgen_add_to_stack_pointer(-16),u=A(n,m.__wbindgen_export,m.__wbindgen_export2),c=S;m.testengine_unassignUserTask(l,this.__wbg_ptr,u,c);var o=w().getInt32(l+0,!0),s=w().getInt32(l+4,!0),d=w().getInt32(l+8,!0),p=w().getInt32(l+12,!0),g=o,a=s;if(p)throw g=0,a=0,F(d);return t=g,r=a,R(g,a)}finally{m.__wbindgen_add_to_stack_pointer(16),m.__wbindgen_export3(t,r,1)}}updateRetries(n,t){let r,o;try{const u=m.__wbindgen_add_to_stack_pointer(-16),c=A(n,m.__wbindgen_export,m.__wbindgen_export2),f=S;m.testengine_updateRetries(u,this.__wbg_ptr,c,f,t);var s=w().getInt32(u+0,!0),d=w().getInt32(u+4,!0),p=w().getInt32(u+8,!0),g=w().getInt32(u+12,!0),a=s,l=d;if(g)throw a=0,l=0,F(p);return r=a,o=l,R(a,l)}finally{m.__wbindgen_add_to_stack_pointer(16),m.__wbindgen_export3(r,o,1)}}updateUserTask(n,t){let r,o;try{const u=m.__wbindgen_add_to_stack_pointer(-16),c=A(n,m.__wbindgen_export,m.__wbindgen_export2),f=S,_=A(t,m.__wbindgen_export,m.__wbindgen_export2),y=S;m.testengine_updateUserTask(u,this.__wbg_ptr,c,f,_,y);var s=w().getInt32(u+0,!0),d=w().getInt32(u+4,!0),p=w().getInt32(u+8,!0),g=w().getInt32(u+12,!0),a=s,l=d;if(g)throw a=0,l=0,F(p);return r=a,o=l,R(a,l)}finally{m.__wbindgen_add_to_stack_pointer(16),m.__wbindgen_export3(r,o,1)}}}Symbol.dispose&&(Tn.prototype[Symbol.dispose]=Tn.prototype.free);function Vr(){return{__proto__:null,"./nanobpmn_engine_bg.js":{__proto__:null,__wbg___wbindgen_throw_bb96b2010945f0bc:function(n,t){throw new Error(R(n,t))},__wbindgen_cast_0000000000000001:function(n,t){const r=R(n,t);return Yr(r)},__wbindgen_object_drop_ref:function(n){F(n)}}}}const Wn=typeof FinalizationRegistry>"u"?{register:()=>{},unregister:()=>{}}:new FinalizationRegistry(e=>m.__wbg_testengine_free(e,1));function Yr(e){Ke===je.length&&je.push(je.length+1);const n=Ke;return Ke=je[n],je[n]=e,n}function Qr(e){e<1028||(je[e]=Ke,Ke=e)}let Oe=null;function w(){return(Oe===null||Oe.buffer.detached===!0||Oe.buffer.detached===void 0&&Oe.buffer!==m.memory.buffer)&&(Oe=new DataView(m.memory.buffer)),Oe}function R(e,n){return Wr(e>>>0,n)}let Ze=null;function sn(){return(Ze===null||Ze.byteLength===0)&&(Ze=new Uint8Array(m.memory.buffer)),Ze}function qr(e){return je[e]}let je=new Array(1024).fill(void 0);je.push(void 0,null,!0,!1);let Ke=je.length;function Jr(e){return e==null}function A(e,n,t){if(t===void 0){const p=Xe.encode(e),g=n(p.length,1)>>>0;return sn().subarray(g,g+p.length).set(p),S=p.length,g}let r=e.length,o=n(r,1)>>>0;const s=sn();let d=0;for(;d<r;d++){const p=e.charCodeAt(d);if(p>127)break;s[o+d]=p}if(d!==r){d!==0&&(e=e.slice(d)),o=t(o,r,r=d+e.length*3,1)>>>0;const p=sn().subarray(o+d,o+r),g=Xe.encodeInto(e,p);d+=g.written,o=t(o,r,d,1)>>>0}return S=d,o}function F(e){const n=qr(e);return Qr(e),n}let dn=new TextDecoder("utf-8",{ignoreBOM:!0,fatal:!0});dn.decode();const Hr=2146435072;let _n=0;function Wr(e,n){return _n+=n,_n>=Hr&&(dn=new TextDecoder("utf-8",{ignoreBOM:!0,fatal:!0}),dn.decode(),_n=n),dn.decode(sn().subarray(e,e+n))}const Xe=new TextEncoder;"encodeInto"in Xe||(Xe.encodeInto=function(e,n){const t=Xe.encode(e);return n.set(t),{read:e.length,written:t.length}});let S=0,m;function Zr(e,n){return m=e.exports,Oe=null,Ze=null,m}async function Kr(e,n){if(typeof Response=="function"&&e instanceof Response){if(!e.ok)throw new Error(`failed to fetch Wasm: ${e.status} ${e.statusText} fetching '${e.url}'`);if(typeof WebAssembly.instantiateStreaming=="function")try{return await WebAssembly.instantiateStreaming(e,n)}catch(o){if(t(e.type)&&e.headers.get("Content-Type")!=="application/wasm")console.warn("`WebAssembly.instantiateStreaming` failed because your server does not serve Wasm with `application/wasm` MIME type. Falling back to `WebAssembly.instantiate` which is slower. Original error:\n",o);else throw o}const r=await e.arrayBuffer();return await WebAssembly.instantiate(r,n)}else{const r=await WebAssembly.instantiate(e,n);return r instanceof WebAssembly.Instance?{instance:r,module:e}:r}function t(r){switch(r){case"basic":case"cors":case"default":return!0}return!1}}async function Xr(e){if(m!==void 0)return m;e!==void 0&&(Object.getPrototypeOf(e)===Object.prototype?{module_or_path:e}=e:console.warn("using deprecated parameters for the initialization function; pass a single object instead")),e===void 0&&(e=new URL("/pr-preview/pr-106/assets/nanobpmn_engine_bg-DRNrIVE8.wasm",import.meta.url));const n=Vr();(typeof e=="string"||typeof Request=="function"&&e instanceof Request||typeof URL=="function"&&e instanceof URL)&&(e=fetch(e));const{instance:t,module:r}=await Kr(await e,n);return Zr(t)}let on=null;function ei(e){return on||(on=Xr(void 0).then(()=>{}).catch(n=>{throw on=null,n})),on}function K(e){return JSON.parse(e)}class ni{constructor(n){U(this,"engine");this.engine=n}deploy(n){return JSON.parse(this.engine.deploy(n))}createInstance(n,t){return K(this.engine.createInstance(n,t||"{}"))}activateJobs(n,t,r,o){return JSON.parse(this.engine.activateJobs(n,t,r,o))}completeJob(n,t){return K(this.engine.completeJob(n,t||"{}"))}completeAgentJob(n,t){const{variables:r,...o}=t??{};return K(this.engine.completeAgentJob(n,JSON.stringify(r??{}),JSON.stringify(o??{})))}failJob(n,t,r){return K(this.engine.failJob(n,t,r))}throwError(n,t,r){return K(this.engine.throwError(n,t,r))}updateRetries(n,t){return K(this.engine.updateRetries(n,t))}resolveIncident(n){return K(this.engine.resolveIncident(n))}setVariables(n,t,r){return K(this.engine.setVariables(n,t||"{}",r))}broadcastSignal(n,t){return K(this.engine.broadcastSignal(n,t||"{}"))}cancelInstance(n){return K(this.engine.cancelInstance(n))}modify(n,t,r){return K(this.engine.modify(n,JSON.stringify(t??[]),JSON.stringify(r??[])))}completeUserTask(n,t){return K(this.engine.completeUserTask(n,t||"{}"))}assignUserTask(n,t,r){return K(this.engine.assignUserTask(n,t,r))}unassignUserTask(n){return K(this.engine.unassignUserTask(n))}updateUserTask(n,t){return K(this.engine.updateUserTask(n,t||"{}"))}correlateMessage(n,t,r){return K(this.engine.correlateMessage(n,t,r||"{}"))}advanceTime(n){return K(this.engine.advanceTime(n))}reset(){this.engine.reset()}events(){return JSON.parse(this.engine.events())}snapshot(){return K(this.engine.snapshot())}free(){this.engine.free()}}async function ti(e){return await ei(),new ni(new Tn)}class It extends Error{constructor(t,r){super(t);U(this,"retries");this.name="JobFailure",this.retries=r==null?void 0:r.retries}}function ri(e,n=[]){if(e.instances.filter(o=>!o.completed).length===0)return e.totalInstances>0?"completed":"idle";if(e.incidents.length>0)return"incidents";const r=new Set(n);return e.jobs.some(o=>!r.has(o.jobType))?"unhandledJobs":e.userTasks.some(o=>o.state==="Created")?"userTasks":e.timers.length>0?"timers":e.messageSubscriptions.length>0?"messages":e.signalSubscriptions.length>0?"signals":"idle"}function ii(e,n=[]){const t=new Set(n);return[...new Set(e.jobs.map(r=>r.jobType))].filter(r=>!t.has(r)).sort()}async function oi(e,n,t){let r;try{const o=await n(t);r=JSON.stringify(o??{})}catch(o){const s=o instanceof It&&o.retries!==void 0?o.retries:Math.max(0,t.retries-1),d=o instanceof Error?o.message:String(o);e.failJob(t.key,s,d);return}e.completeJob(t.key,r)}async function ai(e,n,t){let r;try{r=await n(t),JSON.stringify(r)}catch(o){const s=o instanceof It&&o.retries!==void 0?o.retries:Math.max(0,t.retries-1),d=o instanceof Error?o.message:String(o);e.failJob(t.key,s,d);return}e.completeAgentJob(t.key,r)}async function si(e,n,t={}){const r=t.maxJobsPerActivation??10,o=t.lockTimeoutMs??3e4,s=t.worker??"bojtos",d=t.agents??{};for(const c of Object.keys(d))if(c in n)throw new Error(`dispatchRound: job type "${c}" is registered as both a worker and an agent — register it as exactly one`);const p=[];for(const[c,f]of Object.entries(n))for(const _ of e.activateJobs(c,r,o,s))p.push({handler:f,job:_});const g=[];for(const[c,f]of Object.entries(d))for(const _ of e.activateJobs(c,r,o,s))g.push({handler:f,job:_});for(const{handler:c,job:f}of p)await oi(e,c,f);for(const{handler:c,job:f}of g)await ai(e,c,f);const a=e.snapshot(),l=p.length+g.length;if(l>0)return{snapshot:a,handled:l};const u=[...Object.keys(n),...Object.keys(d)];return{snapshot:a,handled:l,reason:ri(a,u),unhandled:ii(a,u)}}function di({bpmn:e}){const n=h.useRef(null),[t,r]=h.useState("loading"),[o,s]=h.useState(null),[d,p]=h.useState([]),[g,a]=h.useState(null),l=h.useRef(e),u=h.useRef(0),c=h.useRef(new Map),f=h.useCallback((k,T)=>{c.current.set(k,T)},[]),_=h.useCallback(k=>c.current.get(k),[]),y=h.useCallback((k,T)=>{const N=k.deploy(T);return l.current=T,c.current.clear(),p(N.processIds),a(null),s(null),N.processIds},[]);h.useEffect(()=>{let k=!1;return r("loading"),p([]),a(null),s(null),ti().then(T=>{if(k){T.free();return}try{y(T,e)}catch(N){T.free(),s(String(N)),r("error");return}n.current=T,r("ready")}).catch(T=>{k||(s(String(T)),r("error"))}),()=>{var T;k=!0,(T=n.current)==null||T.free(),n.current=null,c.current.clear()}},[e]);const b=h.useCallback(k=>{const T=n.current;if(!T)return null;try{const N=k(T);return a(N),s(null),N}catch(N){return s(String(N)),null}},[]),M=h.useCallback((k,T)=>b(N=>N.createInstance(k,T)),[b]),E=h.useCallback((k,T)=>b(N=>N.completeUserTask(k,T)),[b]),B=h.useCallback(k=>b(T=>T.advanceTime(k)),[b]),Q=h.useCallback((k,T)=>b(N=>N.broadcastSignal(k,T)),[b]);function H(k,T){const[N]=k.activateJobs(T,1,3e4,"manual-control");if(!N)throw new Error(`No waiting job of type "${T}" to resolve.`);return N}const be=h.useCallback((k,T)=>b(N=>{const z=H(N,k);return N.completeJob(z.key,T)}),[b]),ce=h.useCallback((k,T,N)=>b(z=>{const $=H(z,k);return z.throwError($.key,T,N)}),[b]),we=h.useCallback((k,T,N)=>b(z=>z.correlateMessage(k,T,N)),[b]),re=h.useCallback(async(k,T)=>{const N=n.current;if(!N)return null;const z=u.current;try{const $=await si(N,k,T);return n.current!==N||u.current!==z?null:(a($.snapshot),s(null),$)}catch($){return n.current!==N||u.current!==z||(a(N.snapshot()),s(String($))),null}},[]),q=h.useCallback(()=>{const k=n.current;if(k){u.current++;try{k.reset(),y(k,l.current)}catch(T){s(String(T))}}},[y]),X=h.useCallback(k=>{const T=n.current;if(!T)return null;u.current++;try{return T.reset(),y(T,k)}catch(N){return s(String(N)),null}},[y]);return{phase:t,error:o,processIds:d,snapshot:g,createInstance:M,stepWorkers:re,completeUserTask:E,advanceTime:B,broadcastSignal:Q,completeJobManually:be,throwJobError:ce,correlateMessage:we,reset:q,redeploy:X,setRunImage:f,getRunImage:_}}function li(e,n){return e.slice(n)}function ci(e,n,t,r){const o=e.snapshot,s="⏸ waiting for a human — complete the task below to continue",d=o.userTasks.some(p=>p.state==="Created");if(e.handled>0){const p=o.activeElementIds.map(t),g=n.length?` via ${n.map(a=>`${t(a.from)} → ${t(a.to)}`).join(", ")}`:"";return o.completedInstances>=1?{kind:"done",text:`⏭ round handled ${e.handled} job${e.handled===1?"":"s"}${g} — ✅ process instance completed`}:d?{kind:"human",text:`⏭ round handled ${e.handled} job${e.handled===1?"":"s"}${g} — ${s}`}:{kind:"step",text:`⏭ round handled ${e.handled} job${e.handled===1?"":"s"}${g} — now at ${p.length?p.join(", "):"—"}`}}switch(e.reason){case"completed":return{kind:"done",text:"✅ process instance completed"};case"userTasks":return{kind:"human",text:s};case"timers":return{kind:"step",text:"⏱ waiting on a timer — advance the clock to continue"};case"messages":return{kind:"step",text:"✉ waiting on a message — correlate it to continue"};case"signals":return{kind:"step",text:"📶 waiting on a signal — broadcast it to continue"};case"incidents":return{kind:"error",text:"A job failed — incident on the diagram"};case"unhandledJobs":{const p=e.unhandled??[];return r&&p.length>0&&p.every(g=>r.has(g))?{kind:"human",text:s}:{kind:"error",text:`⏭ waiting on job type(s) with no worker registered: ${p.join(", ")}`}}case"idle":return{kind:"step",text:"Nothing to step — no instance is running."};default:return{kind:"step",text:e.reason?`Step blocked on an unrecognized reason: ${e.reason}`:"Nothing to step — no instance is running."}}}const mi="the Scripted or Endpoint brain";async function cn(e=mi){const n=navigator.gpu;if(!n)return`This browser doesn't expose WebGPU at all. Use a recent Chrome, Edge, or Safari 17+ with hardware acceleration on, or pick ${e}.`;let t;try{t=await n.requestAdapter()}catch(r){return`WebGPU adapter request failed (${r instanceof Error?r.message:String(r)}). Try ${e} instead.`}return t?null:`This browser supports the WebGPU API, but no GPU adapter is available — hardware acceleration may be off, or this device/VM has no usable GPU. Pick ${e} instead.`}const pi=[{id:"Qwen2.5-1.5B-Instruct-q4f16_1-MLC",label:"Qwen2.5 1.5B",downloadLabel:"~1.0 GB"},{id:"SmolLM2-1.7B-Instruct-q4f16_1-MLC",label:"SmolLM2 1.7B",downloadLabel:"~1.1 GB"},{id:"Llama-3.2-1B-Instruct-q4f16_1-MLC",label:"Llama 3.2 1B",downloadLabel:"~0.7 GB"},{id:"gemma-2-2b-it-q4f16_1-MLC",label:"Gemma 2 2B",downloadLabel:"~1.5 GB"},{id:"Llama-3.2-1B-Instruct-q4f32_1-MLC",label:"Llama 3.2 1B (f32, wider GPU support)",downloadLabel:"~1.1 GB"},{id:"SmolLM2-360M-Instruct-q4f32_1-MLC",label:"SmolLM2 360M (tiny, f32)",downloadLabel:"~0.6 GB"},{id:"SmolLM2-360M-Instruct-q4f16_1-MLC",label:"SmolLM2 360M (tiny)",downloadLabel:"~0.3 GB"}];function Tt(e){return jn.get(e)??{}}const jn=new Map;async function ui(){if(jn.size>0)return;const{prebuiltAppConfig:e}=await le(async()=>{const{prebuiltAppConfig:n}=await import("./vendor-webllm-DT0Ab8E6.js");return{prebuiltAppConfig:n}},[]);for(const n of e.model_list)jn.set(n.model_id,{vramRequiredMB:n.vram_required_MB,requiredFeatures:n.required_features})}const un=pi.map(e=>({id:e.id,label:`${e.label} (${e.downloadLabel})`,downloadLabel:e.downloadLabel,...Tt(e.id)})),jt=un[0].id;async function gi(){return await ui(),un.map(e=>({...e,...Tt(e.id)}))}function St(){const e=navigator.deviceMemory;return typeof e=="number"?e*1024:null}function hi(e,n=St()){return n==null||e.vramRequiredMB==null||n>=e.vramRequiredMB?null:`${e.label} needs roughly ${Math.round(e.vramRequiredMB)} MB of GPU memory; this device looks like it has about ${Math.round(n)} MB available. It may still work, but expect it to fail or fall back to slow shared memory — try a smaller model (e.g. SmolLM2 360M) if it doesn't load.`}async function bi(e){try{const{hasModelInCache:n}=await le(async()=>{const{hasModelInCache:t}=await import("./vendor-webllm-DT0Ab8E6.js");return{hasModelInCache:t}},[]);return await n(e)}catch{return!1}}function mn(e){return/device (was )?lost|device_hung|device_removed|already been disposed|gpudevicelostinfo/i.test(e)}function Zn(){return"The GPU device was lost — the driver reset while the model was loading or running. This is a browser/driver-level failure, not a problem with the model: fully quit and reopen the browser (a lost device usually persists for the life of the GPU process), check chrome://gpu still reports hardware acceleration, and update your GPU driver if it recurs. The Scripted and Endpoint brains don't use the GPU at all."}class an{constructor(){U(this,"kind","browser");U(this,"model",null);U(this,"engine",null);U(this,"worker",null);U(this,"generation",0);U(this,"chat",async(n,t=512,r)=>{var s,d;const o=this.engine;if(!o||!this.model)throw new Error("BrowserBrain.chat called before connect()");try{const p=await o.chat.completions.create({messages:n,temperature:0,max_tokens:t,stream:!0});let g="";for await(const a of p){const l=((d=(s=a.choices[0])==null?void 0:s.delta)==null?void 0:d.content)??"";l&&(g+=l,r==null||r(l))}return g}catch(p){const g=p instanceof Error?p.message:String(p);throw mn(g)?(this.teardown(),new Error(`The in-browser model stopped: ${Zn()}`)):p}})}async connect(n=jt,t){var g,a;const r=await cn();if(r)throw new Error(r);if(this.engine&&this.model===n)return n;const o=++this.generation,s=l=>{o===this.generation&&(t==null||t({progress:l.progress??0,text:l.text??""}))};this.teardown();let d,p;try{const{CreateWebWorkerMLCEngine:l}=await le(async()=>{const{CreateWebWorkerMLCEngine:u}=await import("./vendor-webllm-DT0Ab8E6.js");return{CreateWebWorkerMLCEngine:u}},[]);p=new Worker(new URL("/pr-preview/pr-106/assets/webllm.worker-Dc1cCqhL.js",import.meta.url),{type:"module"}),d=await l(p,n,{initProgressCallback:s})}catch(l){if(p==null||p.terminate(),o!==this.generation)throw new Error("cancelled");const u=l instanceof Error?l.message:String(l);if(mn(u))throw new Error(`Couldn't load ${n} in the browser (${u}). ${Zn()}`);const c=(a=(g=un.find(f=>f.id===n))==null?void 0:g.requiredFeatures)==null?void 0:a.includes("shader-f16");throw new Error(`Couldn't load ${n} in the browser (${u}). `+(c?"This model needs WebGPU with shader-f16; try one of the f32 models in the list, or the endpoint brain.":"Try a smaller model, check your connection, or use the endpoint brain instead."))}if(o!==this.generation)throw d.unload().catch(()=>{}),p==null||p.terminate(),new Error("cancelled");return this.engine=d,this.worker=p??null,this.model=n,n}teardown(){const{engine:n,worker:t}=this;this.engine=null,this.worker=null,this.model=null,n==null||n.unload().catch(()=>{}),t==null||t.terminate()}cancelConnect(){this.generation++}dispose(){this.generation++,this.teardown()}}const Pt="http://localhost:11434/v1";function pn(e,n={hostname:(t=>(t=globalThis.location)==null?void 0:t.hostname)()??"",origin:(r=>(r=globalThis.location)==null?void 0:r.origin)()??""}){let o;try{o=new URL(At(e)).hostname}catch{return null}const s=d=>d==="localhost"||d==="127.0.0.1"||d==="::1"||d==="[::1]";return!s(o)||s(n.hostname)?null:`This page is served from ${n.origin||"a non-local origin"}, so it can't reach ${e}. A local model server only accepts requests from a page on localhost. Open this page at http://localhost instead, or use the Scripted or In-browser brain.`}function At(e){let n=e.trim().replace(/\/+$/,"");return n.endsWith("/chat/completions")&&(n=n.slice(0,-17)),/\/v\d+$/.test(n)||(n=`${n}/v1`),n}class Kn extends Error{constructor(n,t){super(n),this.status=t,this.name="HttpError"}}class Xn{constructor(n=Pt,t="",r=""){U(this,"kind","endpoint");U(this,"baseUrl");U(this,"model",null);U(this,"models",[]);U(this,"apiKey");U(this,"requestedModel");U(this,"chat",async(n,t=512,r)=>{var a,l,u;if(!this.model)throw new Error("EndpointBrain.chat called before connect()");const o=await fetch(`${this.baseUrl}/chat/completions`,{method:"POST",headers:this.headers(),body:JSON.stringify({model:this.model,messages:n,temperature:0,max_tokens:t,stream:!0})});if(!o.ok||!o.body){const c=await o.text().catch(()=>"");throw new Error(`chat/completions HTTP ${o.status} ${o.statusText}${c?` — ${c.slice(0,300)}`:""}`)}const s=o.body.getReader(),d=new TextDecoder;let p="",g="";for(;;){const{value:c,done:f}=await s.read();if(f)break;p+=d.decode(c,{stream:!0});let _;for(;(_=p.indexOf(`
`))>=0;){const y=p.slice(0,_).trim();if(p=p.slice(_+1),!y.startsWith("data:"))continue;const b=y.slice(5).trim();if(b==="[DONE]")continue;let M;try{M=JSON.parse(b)}catch{continue}M.model&&(this.model=M.model);const E=(a=M.choices)==null?void 0:a[0],B=((l=E==null?void 0:E.delta)==null?void 0:l.content)??((u=E==null?void 0:E.message)==null?void 0:u.content)??"";B&&(g+=B,r==null||r(B))}}return g});this.baseUrl=At(n),this.apiKey=t.trim(),this.requestedModel=r.trim()}headers(){const n={"Content-Type":"application/json"};return this.apiKey&&(n.Authorization=`Bearer ${this.apiKey}`),n}async listModels(){let n;try{n=await fetch(`${this.baseUrl}/models`,{headers:this.headers()})}catch(r){const o=pn(this.baseUrl);throw new Error(o??`Can't reach ${this.baseUrl} (${r instanceof Error?r.message:String(r)}). Is the server running? For Ollama, check the app is up — and if this page is served from another origin, allow it with OLLAMA_ORIGINS.`)}if(!n.ok)throw new Kn(`${this.baseUrl}/models returned HTTP ${n.status} ${n.statusText}`,n.status);const t=await n.json();return this.models=(t.data??[]).map(r=>r.id).filter(r=>!!r),this.models}async connect(){try{const n=await this.listModels(),t=this.requestedModel||n[0];if(!t)throw new Error(`No models available at ${this.baseUrl}. Pull one first — e.g. \`ollama pull llama3.2:3b\` — or name one explicitly.`);this.model=t}catch(n){const t=n instanceof Kn&&[404,405,501].includes(n.status);if(!this.requestedModel||!t)throw n;this.models=[],this.model=this.requestedModel}return await this.validate(),this.model}async validate(){const n=await fetch(`${this.baseUrl}/chat/completions`,{method:"POST",headers:this.headers(),body:JSON.stringify({model:this.model,messages:[{role:"user",content:"Reply with ok."}],temperature:0,max_tokens:1,stream:!1})}).catch(r=>{throw new Error(`Can't reach ${this.baseUrl}/chat/completions (${r instanceof Error?r.message:String(r)}). Check the endpoint URL, API key, model name, and any local CORS settings.`)});if(!n.ok){const r=await n.text().catch(()=>"");throw new Error(`chat/completions HTTP ${n.status} ${n.statusText}${r?` — ${r.slice(0,300)}`:""}`)}const t=await n.json().catch(()=>({}));t.model&&(this.model=t.model)}dispose(){}}const _i=[{id:"onnx-community/Florence-2-base-ft",label:"Florence-2 base",downloadLabel:"~0.4 GB"},{id:"onnx-community/Florence-2-large-ft",label:"Florence-2 large (higher quality)",downloadLabel:"~1.6 GB"}],Dt=_i.map(e=>({...e,label:`${e.label} (${e.downloadLabel})`})),Ct=Dt[0].id,fi="<OCR>",et="UNKNOWN (scripted brain — connect the in-browser model to read a photo)";function wi(e,n){if(e)return typeof e=="function"?e(n):e[n]}class yi{constructor(n){U(this,"kind","scripted-vision");U(this,"model",null);U(this,"read",async(n,t,r)=>{const o=typeof n=="string"?wi(this.lookup,n)??et:et;return r==null||r(o),o});this.lookup=n}dispose(){}}function vi(e){return new yi(e)}class nt{constructor(){U(this,"kind","browser-vision");U(this,"model",null);U(this,"modelHandle",null);U(this,"processor",null);U(this,"loadImage",null);U(this,"generation",0);U(this,"read",async(n,t,r)=>{const o=this.modelHandle,s=this.processor,d=this.loadImage;if(!o||!s||!d||!this.model)throw new Error("BrowserVisionBrain.read called before connect()");const p=t&&t.startsWith("<")?t:fi,g=await d(n),a=s.construct_prompts(p),l=await s(g,a),u=await o.generate({...l,max_new_tokens:512,num_beams:1,do_sample:!1}),c=s.batch_decode(u,{skip_special_tokens:!1})[0],f=s.post_process_generation(c,p,g.size),_=Mi(f,p);return r==null||r(_),_})}async connect(n=Ct,t){var p,g;const r=await cn("the scripted-vision fallback");if(r)throw new Error(r);if(this.modelHandle&&this.model===n)return n;const o=++this.generation,s=a=>{o===this.generation&&(t==null||t({progress:(a.progress??0)/100,text:a.file?`${a.status??"loading"} ${a.file}`:a.status??""}))};this.teardown();let d;try{const{Florence2ForConditionalGeneration:a,AutoProcessor:l,load_image:u}=await le(async()=>{const{Florence2ForConditionalGeneration:_,AutoProcessor:y,load_image:b}=await import("./transformers.web-DIpo0ToB.js");return{Florence2ForConditionalGeneration:_,AutoProcessor:y,load_image:b}},[]),c=await a.from_pretrained(n,{dtype:"fp32",device:"webgpu",progress_callback:s}),f=await l.from_pretrained(n);d={model:c,processor:f,loadImage:u}}catch(a){if(o!==this.generation)throw new Error("cancelled");const l=a instanceof Error?a.message:String(a);throw new Error(`Couldn't load ${n} in the browser (${l}). Try the smaller Florence-2 base model, check your connection, or use the scripted-vision fallback.`)}if(o!==this.generation)throw Promise.resolve((g=(p=d.model).dispose)==null?void 0:g.call(p)).catch(()=>{}),new Error("cancelled");return this.modelHandle=d.model,this.processor=d.processor,this.loadImage=d.loadImage,this.model=n,n}teardown(){var t;const n=this.modelHandle;this.modelHandle=null,this.processor=null,this.loadImage=null,this.model=null,Promise.resolve((t=n==null?void 0:n.dispose)==null?void 0:t.call(n)).catch(()=>{})}cancelConnect(){this.generation++}dispose(){this.generation++,this.teardown()}}function Mi(e,n){const t=e[n];if(typeof t=="string")return t.trim();if(t&&typeof t=="object"){const r=t.labels;return Array.isArray(r)?r.join(" ").trim():JSON.stringify(t)}return""}function xi(){const[e,n]=h.useState("scripted"),[t,r]=h.useState("idle"),[o,s]=h.useState(null),[d,p]=h.useState(null),[g,a]=h.useState(null),[l,u]=h.useState(null),[c,f]=h.useState(null),[_,y]=h.useState(null),[b,M]=h.useState(jt),[E,B]=h.useState(Pt),[Q,H]=h.useState(""),[be,ce]=h.useState([]),[we,re]=h.useState("idle"),[q,X]=h.useState(null),[k,T]=h.useState(""),[N,z]=h.useState(null),$=h.useRef(null),[Ce,$e]=h.useState("scripted-vision"),[ye,_e]=h.useState("idle"),[gn,Pe]=h.useState(null),[xe,Be]=h.useState(Ct),[nn,Le]=h.useState(null),[hn,Ne]=h.useState(null),[me,ie]=h.useState(null),[bn,Ee]=h.useState(null),W=h.useRef(null),Ae=h.useRef(!1),Ge=h.useRef(0),L=h.useCallback(j=>async(...C)=>{try{return await j.chat(...C)}catch(G){const ve=G instanceof Error?G.message:String(G);throw j instanceof an&&mn(ve)&&(z(null),p(null),r("error"),s(ve)),G}},[]),fe=h.useCallback(j=>async(...C)=>{try{return await j.read(...C)}catch(G){const ve=G instanceof Error?G.message:String(G);throw mn(ve)&&(Ee(null),Le(null),_e("error"),Pe(ve)),G}},[]);h.useEffect(()=>{cn().then(j=>{f(j),u(j===null)}),cn("the scripted-vision fallback").then(j=>{ie(j),Ae.current||(Ae.current=!0,$e(j===null?"browser-vision":"scripted-vision"))})},[]),h.useEffect(()=>{let j=!1;return y(null),bi(b).then(C=>{j||y(C)}),()=>{j=!0}},[b]),h.useEffect(()=>()=>{var j;return(j=$.current)==null?void 0:j.dispose()},[]),h.useEffect(()=>()=>{var j;return(j=W.current)==null?void 0:j.dispose()},[]);const De=h.useCallback(j=>{n(j),r("idle"),s(null),p(null),a(null),z(null)},[]),ke=h.useCallback(j=>{var C,G;Ae.current=!0,(C=W.current)==null||C.cancelConnect(),(G=W.current)==null||G.dispose(),W.current=null,$e(j),_e("idle"),Pe(null),Le(null),Ne(null),Ee(null)},[]),Re=h.useCallback(()=>{var j;(j=$.current)==null||j.dispose(),$.current=null,z(null),p(null)},[]),pe=h.useCallback(()=>{$.current instanceof an&&$.current.cancelConnect(),Re(),r("idle"),a(null),s(null)},[Re]),Ve=h.useCallback(async()=>{const j=++Ge.current,C=()=>j!==Ge.current,G=pn(E);if(G){ce([]),re("error"),X(G);return}re("loading"),X(null);const ve=new Xn(E,k);try{const Ie=await ve.listModels();if(C())return;ce(Ie),re("ready"),H(He=>He&&Ie.includes(He)?He:Ie[0]??"")}catch(Ie){if(C())return;ce([]),H(""),re("error"),X(Ie instanceof Error?Ie.message:String(Ie))}finally{ve.dispose()}},[E,k]),Ye=h.useCallback(async()=>{var j;if(e==="scripted"){z(null),r("ready");return}if(e==="endpoint"){const C=pn(E);if(C){Re(),s(C),r("error");return}}r("connecting"),s(null),a(null);try{if(e==="browser"){const C=$.current instanceof an?$.current:new an;$.current&&$.current!==C&&$.current.dispose(),$.current=C;const G=await C.connect(b,a);p(G),z(()=>L(C)),y(!0)}else{(j=$.current)==null||j.dispose();const C=new Xn(E,k,Q);$.current=C;const G=await C.connect();p(G),z(()=>L(C))}r("ready")}catch(C){const G=C instanceof Error?C.message:String(C);if(G==="cancelled")return;s(G),r("error"),z(null)}finally{a(null)}},[e,b,E,Q,k,Re,L]),Fe=h.useCallback(()=>{var j;(j=W.current)==null||j.dispose(),W.current=null,Ee(null),Le(null)},[]),Qe=h.useCallback(()=>{var j;(j=W.current)==null||j.cancelConnect(),Fe(),_e("idle"),Ne(null),Pe(null)},[Fe]),ze=h.useCallback(async()=>{if(Ce==="scripted-vision"){Fe(),_e("ready"),Pe(null);return}_e("connecting"),Pe(null),Ne(null);try{const j=W.current instanceof nt?W.current:new nt;W.current&&W.current!==j&&W.current.dispose(),W.current=j;const C=await j.connect(xe,Ne);Le(C),Ee(()=>fe(j)),_e("ready")}catch(j){const C=j instanceof Error?j.message:String(j);if(C==="cancelled")return;Pe(C),_e("error"),Ee(null),Le(null)}finally{Ne(null)}},[Ce,xe,Fe,fe]);return{kind:e,setKind:De,status:t,error:o,modelInUse:d,progress:g,webgpu:l,webgpuReason:c,browserModelCached:_,cancelConnect:pe,browserModel:b,setBrowserModel:M,endpointUrl:E,setEndpointUrl:B,endpointModel:Q,setEndpointModel:H,endpointModels:be,endpointModelsStatus:we,endpointModelsError:q,listEndpointModels:Ve,apiKey:k,setApiKey:T,connect:Ye,chat:N,visionKind:Ce,setVisionKind:ke,visionStatus:ye,visionError:gn,visionModel:xe,setVisionModel:Be,visionModelInUse:nn,visionProgress:hn,visionWebgpuReason:me,connectVision:ze,cancelVisionConnect:Qe,vision:bn}}const Sn="#s=",Ni=["scripted","browser","endpoint"];function Ei(e){return typeof e=="string"&&Ni.includes(e)}function ki(e){try{const n=JSON.parse(e);if(n&&typeof n=="object"){const t=n,r={};return Ei(t.brain)&&(r.brain=t.brain),r}}catch{}return{}}function Bt(e=location.hash){if(!e.startsWith(Sn))return{};let n;try{n=decodeURIComponent(e.slice(Sn.length))}catch{return{}}return ki(n)}function Ii(e){const n=Object.entries(e).filter(([,t])=>t!==void 0);return n.length===0?"":Sn+encodeURIComponent(JSON.stringify(Object.fromEntries(n)))}function Ti(e){const n={...Bt(),...e},t=Ii(n),r=new URL(location.href);r.hash=t,history.replaceState(history.state,"",r)}const tt=[{kind:"scripted",label:"Scripted",hint:"No model. The example's stand-in decides — deterministic and offline."},{kind:"browser",label:"In-browser (WebGPU)",hint:"A small quantised model on your GPU. First run downloads weights."},{kind:"endpoint",label:"API endpoint",hint:"Any OpenAI-compatible server. Ollama by default. Local pages only."}],rt=[{kind:"scripted-vision",label:"Scripted",hint:"No model. The example's known plate is returned — deterministic and offline."},{kind:"browser-vision",label:"In-browser (WebGPU)",hint:"Reads the photo with a vision model on your GPU. First run downloads weights."}];function ji({brain:e,showText:n=!0,showVision:t=!1}){return i.jsxs("div",{className:"brain",children:[n&&i.jsx(Si,{brain:e}),n&&t&&i.jsx("hr",{className:"brain-divider"}),t&&i.jsx(Pi,{brain:e})]})}function Si({brain:e}){const n=tt.find(u=>u.kind===e.kind),t=pn(e.endpointUrl),[r,o]=h.useState(un);h.useEffect(()=>{gi().then(o)},[]);const{kind:s,endpointUrl:d,apiKey:p,listEndpointModels:g}=e;h.useEffect(()=>{if(s!=="endpoint"||t)return;const u=setTimeout(()=>void g(),400);return()=>clearTimeout(u)},[s,d,p,t,g]);const a=r.find(u=>u.id===e.browserModel),l=a?hi(a,St()):null;return i.jsxs("div",{className:"brain-section",children:[i.jsxs("div",{className:"brain-modes",children:[i.jsx("div",{className:"brain-kinds",role:"group","aria-label":"Agent brain",children:tt.map(u=>i.jsx(J,{size:"sm",variant:e.kind===u.kind?"default":"secondary","aria-pressed":e.kind===u.kind,onClick:()=>e.setKind(u.kind),children:u.label},u.kind))}),i.jsxs("div",{className:"brain-status",children:[e.status==="ready"&&e.kind!=="scripted"&&i.jsx(te,{variant:"success",className:"brain-status-badge",children:e.modelInUse??"connected"}),e.status==="connecting"&&i.jsx(te,{variant:"info",className:"brain-status-badge",children:"connecting…"}),e.status==="error"&&i.jsx(te,{variant:"danger",className:"brain-status-badge",children:"not connected"})]})]}),i.jsx("p",{className:"field-hint",children:n.hint}),e.kind==="browser"&&i.jsxs("div",{className:"brain-config",children:[i.jsxs("div",{className:"field",children:[i.jsx(Je,{htmlFor:"browser-model",children:"Model"}),i.jsxs(vn,{value:e.browserModel,onValueChange:e.setBrowserModel,disabled:e.status==="connecting",children:[i.jsx(Mn,{id:"browser-model",children:i.jsx(xn,{})}),i.jsx(Nn,{children:r.map(u=>i.jsx(En,{value:u.id,children:u.label},u.id))})]}),e.browserModelCached===!0&&i.jsx("p",{className:"field-hint",children:"Already downloaded in this browser — connecting will be fast."}),e.browserModelCached===!1&&i.jsx("p",{className:"field-hint",children:"Not downloaded yet — connecting fetches the weights once, then caches them for next time."})]}),e.webgpu===!1&&e.webgpuReason&&i.jsxs(ae,{variant:"destructive",children:[i.jsx(se,{children:"No WebGPU in this browser"}),i.jsx(de,{children:e.webgpuReason})]}),e.webgpu!==!1&&l&&i.jsxs(ae,{variant:"destructive",children:[i.jsx(se,{children:"This model may not fit in GPU memory"}),i.jsx(de,{children:l})]})]}),e.kind==="endpoint"&&i.jsxs("div",{className:"brain-config",children:[i.jsxs("div",{className:"field",children:[i.jsx(Je,{htmlFor:"endpoint-url",children:"Endpoint"}),i.jsx($n,{id:"endpoint-url",value:e.endpointUrl,onChange:u=>e.setEndpointUrl(u.target.value),disabled:e.status==="connecting"}),i.jsxs("p",{className:"field-hint",children:["Ollama allows ",i.jsx("code",{children:"localhost"})," origins out of the box; set"," ",i.jsx("code",{children:"OLLAMA_ORIGINS"})," only when serving this page from another host. Best for local development — a hosted copy of this page can't reach a server on your machine at all."]}),t&&i.jsxs(ae,{variant:"destructive",children:[i.jsx(se,{children:"A local server won't work from this URL"}),i.jsx(de,{children:t})]})]}),i.jsxs("div",{className:"field",children:[i.jsx(Je,{htmlFor:"endpoint-model",children:"Model"}),i.jsxs("div",{className:"endpoint-model-row",children:[i.jsxs(vn,{value:e.endpointModel,onValueChange:e.setEndpointModel,disabled:e.status==="connecting"||e.endpointModelsStatus==="loading"||e.endpointModels.length===0,children:[i.jsx(Mn,{id:"endpoint-model",className:"endpoint-model-select",children:i.jsx(xn,{placeholder:e.endpointModelsStatus==="loading"?"Loading models…":e.endpointModelsStatus==="idle"?"Enter an endpoint above":e.endpointModelsStatus==="error"?"No models — check the endpoint":e.endpointModels.length===0?"No models served":"Select a model"})}),i.jsx(Nn,{children:e.endpointModels.map(u=>i.jsx(En,{value:u,children:u},u))})]}),i.jsx(J,{size:"sm",variant:"secondary",onClick:()=>void e.listEndpointModels(),disabled:e.status==="connecting"||e.endpointModelsStatus==="loading"||t!==null,children:e.endpointModelsStatus==="loading"?"Refreshing…":"Refresh"})]}),i.jsxs("p",{className:"field-hint",children:["Fetched from the endpoint's ",i.jsx("code",{children:"/models"}),". Tiny models (e.g. SmolLM2) usually can't follow the tool-calling format — prefer ",i.jsx("code",{children:"llama3.2:3b"}),", ",i.jsx("code",{children:"qwen2.5"})," or larger."]}),e.endpointModelsStatus==="error"&&!t&&i.jsxs(ae,{variant:"destructive",children:[i.jsx(se,{children:"Couldn't list models"}),i.jsx(de,{children:e.endpointModelsError})]})]}),i.jsxs("div",{className:"field",children:[i.jsx(Je,{htmlFor:"endpoint-key",children:"API key (optional)"}),i.jsx($n,{id:"endpoint-key",type:"password",value:e.apiKey,onChange:u=>e.setApiKey(u.target.value),disabled:e.status==="connecting"})]})]}),e.kind!=="scripted"&&i.jsxs("div",{className:"brain-actions",children:[i.jsx(J,{size:"sm",onClick:()=>void e.connect(),disabled:e.status==="connecting"||e.kind==="endpoint"&&(e.endpointModel===""||e.endpointModelsStatus==="loading"||t!==null),children:e.status==="ready"?"Reconnect":"Connect"}),e.status==="connecting"&&e.kind==="browser"&&i.jsx(J,{size:"sm",variant:"secondary",onClick:e.cancelConnect,children:"Cancel"}),e.progress&&i.jsxs("span",{className:"field-hint",children:[Math.round(e.progress.progress*100),"% —"," ",e.progress.text]})]}),e.progress&&i.jsx("div",{className:"brain-progress",role:"progressbar","aria-valuenow":Math.round(e.progress.progress*100),"aria-valuemin":0,"aria-valuemax":100,children:i.jsx("div",{className:"brain-progress-bar",style:{width:`${Math.round(e.progress.progress*100)}%`}})}),e.error&&i.jsxs(ae,{variant:"destructive",children:[i.jsx(se,{children:"Couldn't connect"}),i.jsx(de,{children:e.error})]})]})}function Pi({brain:e}){const n=rt.find(t=>t.kind===e.visionKind);return i.jsxs("div",{className:"brain-section brain-vision",children:[i.jsx(Je,{children:"Vision (reads the image)"}),i.jsxs("div",{className:"brain-modes",children:[i.jsx("div",{className:"brain-kinds",role:"group","aria-label":"Vision brain",children:rt.map(t=>i.jsx(J,{size:"sm",variant:e.visionKind===t.kind?"default":"secondary","aria-pressed":e.visionKind===t.kind,onClick:()=>e.setVisionKind(t.kind),children:t.label},t.kind))}),i.jsxs("div",{className:"brain-status",children:[e.visionStatus==="ready"&&e.visionKind==="browser-vision"&&i.jsx(te,{variant:"success",className:"brain-status-badge",children:e.visionModelInUse??"connected"}),e.visionStatus==="connecting"&&i.jsx(te,{variant:"info",className:"brain-status-badge",children:"connecting…"}),e.visionStatus==="error"&&i.jsx(te,{variant:"danger",className:"brain-status-badge",children:"not connected"})]})]}),i.jsx("p",{className:"field-hint",children:n.hint}),e.visionKind==="scripted-vision"&&e.webgpu===!1&&e.visionWebgpuReason&&i.jsxs(ae,{variant:"destructive",children:[i.jsx(se,{children:"No WebGPU in this browser"}),i.jsx(de,{children:e.visionWebgpuReason})]}),e.visionKind==="browser-vision"&&i.jsxs("div",{className:"brain-config",children:[i.jsxs("div",{className:"field",children:[i.jsx(Je,{htmlFor:"vision-model",children:"Model"}),i.jsxs(vn,{value:e.visionModel,onValueChange:e.setVisionModel,disabled:e.visionStatus==="connecting",children:[i.jsx(Mn,{id:"vision-model",children:i.jsx(xn,{})}),i.jsx(Nn,{children:Dt.map(t=>i.jsx(En,{value:t.id,children:t.label},t.id))})]}),i.jsx("p",{className:"field-hint",children:"Connecting downloads the weights once (size shown above), then caches them — every token is read on your GPU, no server."})]}),e.webgpu===!1&&e.visionWebgpuReason&&i.jsxs(ae,{variant:"destructive",children:[i.jsx(se,{children:"No WebGPU in this browser"}),i.jsx(de,{children:e.visionWebgpuReason})]})]}),e.visionKind==="browser-vision"&&i.jsxs("div",{className:"brain-actions",children:[i.jsx(J,{size:"sm",onClick:()=>void e.connectVision(),disabled:e.visionStatus==="connecting",children:e.visionStatus==="ready"?"Reconnect":"Connect"}),e.visionStatus==="connecting"&&i.jsx(J,{size:"sm",variant:"secondary",onClick:e.cancelVisionConnect,children:"Cancel"}),e.visionProgress&&i.jsxs("span",{className:"field-hint",children:[Math.round(e.visionProgress.progress*100),"% —"," ",e.visionProgress.text]})]}),e.visionError&&i.jsxs(ae,{variant:"destructive",children:[i.jsx(se,{children:"Couldn't connect the vision brain"}),i.jsx(de,{children:e.visionError})]})]})}function Ai({imageInput:e,value:n,onSelect:t,disabled:r=!1}){const[o,s]=h.useState(null),[d,p]=h.useState(!1),g=h.useRef(null),a=h.useId(),l=h.useId(),u=h.useCallback(_=>{s(URL.createObjectURL(_)),t({imageName:_.name,pixels:_})},[t]);h.useEffect(()=>{if(o)return()=>URL.revokeObjectURL(o)},[o]);const c=h.useCallback(_=>{const y=_==null?void 0:_[0];y&&y.type.startsWith("image/")&&u(y)},[u]),f=(n==null?void 0:n.imageId)!=null?e.seedImages.find(_=>_.id===n.imageId):void 0;return i.jsxs("div",{className:"image-input",children:[e.label&&i.jsx("p",{className:"field-hint",children:e.label}),i.jsx("p",{className:"image-input-label",id:a,children:"Seed photos"}),i.jsx("div",{className:"image-gallery",role:"group","aria-labelledby":a,children:e.seedImages.map(_=>{const y=(n==null?void 0:n.imageId)===_.id;return i.jsxs("button",{type:"button","aria-pressed":y,className:`image-thumb${y?" image-thumb--selected":""}`,disabled:r,title:_.label??_.id,onClick:()=>{s(null),g.current&&(g.current.value=""),t({imageId:_.id,pixels:_.file})},children:[i.jsx("img",{src:_.thumb??_.file,alt:_.label??_.id}),_.label&&i.jsx("span",{children:_.label})]},_.id)})}),i.jsx("label",{className:"image-input-label",htmlFor:l,children:"Or upload your own photo"}),i.jsxs("div",{className:`image-drop${d?" image-drop--over":""}`,onDragOver:_=>{_.preventDefault(),r||p(!0)},onDragLeave:()=>p(!1),onDrop:_=>{_.preventDefault(),p(!1),r||c(_.dataTransfer.files)},children:[i.jsx("input",{ref:g,id:l,type:"file",accept:"image/*",disabled:r,onChange:_=>c(_.target.files)}),i.jsx("p",{className:"field-hint",children:"Drag a photo here, or pick one. Uploading a photo the model has never seen is the proof this runs for real — nothing leaves your browser."})]}),(o||f)&&i.jsxs("div",{className:"image-preview",children:[i.jsx("img",{src:o??(f==null?void 0:f.file),alt:o?(n==null?void 0:n.imageName)??"uploaded photo":(f==null?void 0:f.label)??(f==null?void 0:f.id)??"selected photo"}),i.jsx("span",{className:"field-hint",children:o?`Uploaded: ${(n==null?void 0:n.imageName)??"your photo"}`:`Selected: ${(f==null?void 0:f.label)??(f==null?void 0:f.id)}`}),i.jsx("button",{type:"button",className:"image-clear-btn",disabled:r,onClick:()=>{s(null),g.current&&(g.current.value=""),t(null)},children:"Clear"})]})]})}function Lt(e){return typeof e=="object"&&e!==null}function _d(e){const n=new Set,t=r=>{Lt(r)&&(typeof r.key=="string"&&n.add(r.key),Array.isArray(r.components)&&r.components.forEach(t))};return t(e),n}function Di(e){const n={},t=r=>{Lt(r)&&(typeof r.key=="string"&&"defaultValue"in r&&(n[r.key]=r.defaultValue??""),Array.isArray(r.components)&&r.components.forEach(t))};return t(e),n}const Ci="wdf:section:v2:";function Rt(e){return Ci+e}function it(e){try{const n=window.localStorage.getItem(Rt(e));return n==="1"?!0:n==="0"?!1:void 0}catch{return}}function Bi(e,n){try{window.localStorage.setItem(Rt(e),n?"1":"0")}catch{}}function An(e,n=!0){const[t,r]=h.useState(()=>it(e)??n);h.useEffect(()=>{r(it(e)??n)},[e,n]);const o=h.useCallback(s=>{r(s),Bi(e,s)},[e]);return[t,o]}function Ue({sectionId:e,title:n,description:t,defaultOpen:r=!0,className:o,children:s,...d}){const[p,g]=An(e,r);return i.jsx(Vt,{className:["panel",o].filter(Boolean).join(" "),"data-tour":d["data-tour"],children:i.jsxs(Yt,{open:p,onOpenChange:g,children:[i.jsxs(Qt,{className:"panel-trigger",children:[i.jsxs("span",{className:"panel-trigger-text",children:[i.jsx("span",{className:"panel-title",children:n}),t!=null&&i.jsx("span",{className:"panel-desc",children:t})]}),i.jsx(qt,{className:"panel-chevron","aria-hidden":!0})]}),i.jsx(Jt,{children:i.jsx(Ht,{children:s})})]})})}function Li(e){return e.entries!==void 0}function Ri(e){const n=[];let t=null;for(const r of e)r.turn!==void 0?t&&t.turn===r.turn?t.entries.push(r):(t={turn:r.turn,entries:[r]},n.push(t)):(t=null,n.push(r));return n}function ot(e){if(e===void 0)return"undefined";try{return JSON.stringify(e)}catch{return"[unserializable value]"}}function Fi({activation:e,result:n,labelFor:t}){const r=e.elementId??"";return i.jsxs("div",{className:"timeline-tool",children:[i.jsxs("div",{className:"timeline-tool-head",children:[i.jsx(te,{variant:"info",children:"tool"}),i.jsx("strong",{children:t(r)||r}),i.jsx("code",{children:r})]}),e.args!==void 0&&Object.keys(e.args).length>0&&i.jsxs("div",{className:"timeline-kv",children:[i.jsx("span",{className:"timeline-kv-label",children:"arguments"}),i.jsx("code",{children:ot(e.args)})]}),i.jsxs("div",{className:"timeline-kv",children:[i.jsx("span",{className:"timeline-kv-label",children:"returned"}),i.jsx("code",{children:n?ot(n.result):"— waiting for the job to complete —"})]})]})}function zi({group:e,labelFor:n}){const t=e.entries.find(a=>a.kind==="llm"),r=e.entries.filter(a=>a.kind==="agent"&&a.elementId),o=e.entries.filter(a=>a.kind==="vars"&&a.elementId),s=e.entries.filter(a=>a.kind==="agent"&&!a.elementId),d=e.entries.filter(a=>a.kind==="error"),p=new Set(r.map(a=>a.elementId)),g=e.entries.filter(a=>a.kind==="tool"||a.kind==="vars"&&a.elementId&&!p.has(a.elementId)).sort((a,l)=>a.id-l.id);return i.jsxs("div",{className:"timeline-turn",children:[i.jsxs("div",{className:"timeline-turn-head",children:[i.jsxs(te,{variant:t!=null&&t.pending?"warning":"neutral",children:["Turn ",e.turn]}),(t==null?void 0:t.pending)&&i.jsx("span",{className:"timeline-pending",children:"thinking…"})]}),t&&i.jsx("blockquote",{className:"timeline-reply",children:t.text}),s.map(a=>i.jsx("div",{className:"timeline-note",children:a.text},a.id)),r.map(a=>i.jsx(Fi,{activation:a,result:o.find(l=>l.elementId===a.elementId),labelFor:n},a.id)),g.map(a=>i.jsxs("div",{className:`log-line log-${a.kind}`,children:[a.pending?"⏳ ":"",a.text]},a.id)),d.map(a=>i.jsxs("div",{className:"timeline-error",children:["⚠ ",a.text]},a.id))]})}function Oi({log:e,elementStats:n=[],incidents:t=[],labelFor:r=s=>s,variables:o}){const s=h.useMemo(()=>Ri(e),[e]),[d,p]=h.useState(!1),[g,a]=An("engine-view",!1),l=h.useRef(null);h.useEffect(()=>{const c=l.current;c&&(c.scrollTop=c.scrollHeight)},[s]);const u=()=>{var _;const c={log:e.map(({id:y,...b})=>b),elementStats:n,incidents:t},f=JSON.stringify(c,null,2);(_=navigator.clipboard)!=null&&_.writeText&&navigator.clipboard.writeText(f).then(()=>{p(!0),setTimeout(()=>p(!1),1500)}).catch(()=>{})};return i.jsxs(Ue,{sectionId:"activity",className:"grow activity-card",title:"Agent activity",description:"Agent turns, model replies, and tool calls — read top to bottom as a story.",children:[i.jsx("div",{className:"timeline-toolbar",children:i.jsx(J,{variant:"secondary",size:"sm",onClick:u,children:d?"Copied!":"Copy run as JSON"})}),i.jsx("div",{className:"timeline",ref:l,children:s.length===0?i.jsx("div",{className:"log-empty",children:"Press Run or Step to start."}):s.map(c=>Li(c)?i.jsx(zi,{group:c,labelFor:r},`turn-${c.turn}-${c.entries[0].id}`):i.jsxs("div",{className:`log-line log-${c.kind}`,children:[c.pending?"⏳ ":"",c.text]},c.id))}),o,(n.length>0||t.length>0)&&i.jsxs("details",{className:"engine-view",open:g,onToggle:c=>a(c.currentTarget.open),children:[i.jsxs("summary",{children:["Element completion",t.length>0&&` · ${t.length} incident${t.length===1?"":"s"}`]}),i.jsxs("div",{className:"timeline-engine-view",children:[n.length>0&&i.jsxs("div",{className:"timeline-stats",children:[i.jsx("span",{className:"timeline-kv-label",children:"Element completion"}),i.jsx("ul",{children:n.filter(c=>c.completed>0||(c.active??0)>0).map(c=>i.jsxs("li",{children:[i.jsx("code",{children:r(c.elementId)||c.elementId})," ","completed ",c.completed,c.active?`, ${c.active} active`:""]},c.elementId))})]}),t.length>0&&i.jsxs("div",{className:"timeline-incidents",children:[i.jsx("span",{className:"timeline-kv-label",children:"Incidents"}),i.jsx("ul",{children:t.map((c,f)=>i.jsxs("li",{children:[i.jsx("code",{children:r(c.elementId)||c.elementId})," —"," ",c.reason]},`${c.elementId}-${f}`))})]})]})]})]})}const Me={diagram:"diagram",runButton:"run-button",variablesPanel:"variables-panel",codePanel:"code-panel",brainPanel:"brain-panel"};function at(e){return`[data-tour="${e}"]`}function Ui(e=location.search){return new URLSearchParams(e).get("tour")}function $i(e,n){var t;return((t=e.elementStats.find(r=>r.elementId===n))==null?void 0:t.completed)??0}function Gi(e,n){return!e||e.kind==="click"||!n?!1:e.kind==="activeElement"?n.activeElementIds.includes(e.elementId):$i(n,e.elementId)>=(e.atLeast??1)}function Vi(e){return"anchor"in e?at(e.anchor):`${at(Me.diagram)} [data-element-id="${Yi(e.elementId)}"]`}function Yi(e){return typeof CSS<"u"&&typeof CSS.escape=="function"?CSS.escape(e):e.replace(/[^a-zA-Z0-9_-]/g,n=>`\\${n}`)}function Qi(e){return e.map(n=>{const t=!!n.waitFor&&n.waitFor.kind!=="click";return{element:Vi(n.target),popover:{title:n.title,description:t?`${n.description} (continues automatically once you reach that point — or use Next to skip ahead)`:n.description,showButtons:["next","previous","close"]},disableActiveInteraction:!1,skipMissingElement:n.skipMissingElement??!0}})}async function qi(e,n={}){var s;const[{driver:t}]=await Promise.all([le(()=>import("./driver.js-bj_ppY-Q.js"),[]),le(()=>Promise.resolve({}),__vite__mapDeps([0]))]),r=Qi(e),o=t({steps:r,showProgress:!0,allowClose:!0,skipMissingElement:!0,onHighlighted:(d,p,{index:g})=>{var a;g!==void 0&&((a=n.onIndexChange)==null||a.call(n,g))},onDestroyed:()=>{var d;(d=n.onDestroyed)==null||d.call(n)}});return o.drive(),(s=n.onIndexChange)==null||s.call(n,o.getActiveIndex()??0),{moveNext:()=>o.moveNext(),activeIndex:()=>o.getActiveIndex()??-1,destroy:()=>o.destroy()}}const Ji=300;function Hi(e,n){const[t,r]=h.useState(!1),o=h.useRef(null),s=h.useRef(0),d=h.useRef(-1),p=h.useRef(null),g=h.useRef(n);h.useEffect(()=>{g.current=n},[n]);const a=h.useCallback(()=>{p.current!==null&&(clearInterval(p.current),p.current=null)},[]),l=h.useRef(0),u=h.useCallback(()=>{var f;l.current+=1,a(),(f=o.current)==null||f.destroy(),o.current=null,r(!1)},[a]),c=h.useCallback(()=>{if(!e||e.steps.length===0||o.current)return;const f=l.current+=1;qi(e.steps,{onIndexChange:_=>{s.current=_},onDestroyed:()=>{a(),o.current=null,r(!1)}}).then(_=>{if(f!==l.current){_.destroy();return}o.current=_,r(!0),p.current=setInterval(()=>{const y=s.current;if(y===d.current)return;const b=e.steps[y];b&&Gi(b.waitFor,g.current())&&(d.current=y,_.moveNext())},Ji)})},[e,a]);return h.useEffect(()=>u,[u]),{active:t,start:c,stop:u}}const Te=650,fn="__agent__",st="__model__",dt="__template__:",Wi=h.lazy(async()=>{await Promise.all([le(()=>Promise.resolve({}),__vite__mapDeps([1])),le(()=>Promise.resolve({}),__vite__mapDeps([2])),le(()=>Promise.resolve({}),__vite__mapDeps([3]))]);const{RuntimeDiagram:e}=await le(async()=>{const{RuntimeDiagram:n}=await import("./RuntimeDiagram-DTnJz5cT.js");return{RuntimeDiagram:n}},__vite__mapDeps([4,5,6]));return{default:e}}),wn=h.lazy(()=>le(()=>import("./MonacoEditor-CmppV2jt.js").then(e=>e.M),__vite__mapDeps([7,5,8]))),Zi=h.lazy(()=>le(()=>import("./vendor-modeler-Bt2tvxef.js"),__vite__mapDeps([9,5,6,10,11,12,13,1,2,3]))),lt=h.lazy(async()=>{const{FormRenderer:e}=await le(async()=>{const{FormRenderer:n}=await import("./FormRenderer-SvIRYxck.js");return{FormRenderer:n}},__vite__mapDeps([14,5,12,10,11,15]));return{default:e}});function ln(e,n){try{return JSON.stringify(e??{},null,n)}catch{return"[unserializable value]"}}function Ki(e){const n=ln(e).replace(/\s+/g," ");return n.length>78?`${n.slice(0,78)}…`:n}function Xi({example:e,initialBrainKind:n,initialTourId:t}){var Cn,Bn,Ln,Rn,Fn,zn,On,Un;const[r,o]=h.useState(e.bpmn),s=xi(),[d,p]=h.useState(null);h.useEffect(()=>{n&&n!==s.kind&&s.setKind(n)},[]),h.useEffect(()=>{Ti({brain:s.kind})},[s.kind]);const[g,a]=h.useState(()=>Object.fromEntries(e.handlers.map(v=>[v.elementId,v.source]))),[l,u]=h.useState(e.scriptedAgent??""),[c,f]=h.useState(()=>en(e.templates)),_=h.useMemo(()=>Cr(e,g,r,c),[e,g,r,c]),y=_.model,b=di({bpmn:_.resolvedBpmn}),M=Hi(e.tour,()=>b.snapshot);h.useEffect(()=>{var v;t&&((v=e.tour)==null?void 0:v.id)===t&&M.start()},[]);const E=y.startFormId?((Cn=e.forms)==null?void 0:Cn[y.startFormId])??null:null,[B,Q]=h.useState(()=>({...e.seed,...E?Di(E):{}})),[H,be]=h.useState(y.agent?fn:((Bn=e.handlers[0])==null?void 0:Bn.elementId)??""),ce=h.useMemo(()=>{const v=(e.scenarios??[]).findIndex(x=>Object.entries(x.variables).every(([I,D])=>JSON.stringify(B[I])===JSON.stringify(D)));return v===-1?null:v},[e.scenarios,B]),[we,re]=An("start",!!E),[q,X]=h.useState(!1),[k,T]=h.useState(!1),[N,z]=h.useState(null),[$,Ce]=h.useState([]),[$e,ye]=h.useState({}),_e=h.useMemo(()=>({...e.seed,...B,...hr(e.imageInput?d:null)}),[e.seed,e.imageInput,B,d]),[gn,Pe]=h.useState(!1),xe=h.useRef(null),[Be,nn]=h.useState({}),[Le,hn]=h.useState(!1),Ne=h.useRef(null),me=h.useRef(!1),ie=h.useRef(0),bn=h.useRef(0),Ee=h.useRef({current:void 0}),W=h.useRef({}),Ae=h.useRef({}),Ge=h.useMemo(()=>{const v=new Map;for(const x of y.processes){for(const I of x.tasks)v.set(I.elementId,I.label);for(const I of x.agents){v.set(I.elementId,I.label);for(const D of I.tools)v.set(D.elementId,D.label)}for(const I of x.userTasks)v.set(I.elementId,I.label)}return x=>v.get(x)??x},[y]),L=h.useCallback(v=>{Ce(x=>{if(v.key){const I=x.findIndex(D=>D.key===v.key);if(I>=0){const D=[...x];return D[I]={...D[I],...v},D}}return[...x,{...v,id:bn.current++}].slice(-80)})},[]),fe=h.useMemo(()=>{var v;return((v=b.snapshot)==null?void 0:v.userTasks.find(x=>x.state==="Created"))??null},[b.snapshot]),De=h.useMemo(()=>{const v=y.processes.flatMap(I=>I.tasks),x=new Map;for(const I of e.handlers){if(!I.manualControl)continue;const D=v.find(P=>P.elementId===I.elementId);D&&x.set(D.jobType,{...I.manualControl,elementId:I.elementId})}return x},[e.handlers,y]),ke=h.useMemo(()=>{if(!b.snapshot)return null;for(const v of b.snapshot.jobs){const x=De.get(v.jobType);if(x&&v.state==="Created")return{job:v,control:x}}return null},[b.snapshot,De]),Re=h.useMemo(()=>{if(!y.agent||!b.snapshot)return[];const v=new Map(b.snapshot.elementStats.map(x=>[x.elementId,x.completed]));return y.agent.tools.filter(x=>(v.get(x.elementId)??0)===0)},[y.agent,b.snapshot]),pe=fe?y.userTasks.find(v=>v.elementId===fe.elementId):void 0,Ve=pe!=null&&pe.formId?((Ln=e.forms)==null?void 0:Ln[pe.formId])??null:null,Ye=h.useCallback(async(v,x,I,D)=>{var oe,ee,ge;let P=I,ue=0;for(;ie.current===D&&P&&P.completedInstances<1&&ue++<80;){const V=await b.stepWorkers(v,{agents:x});if(ie.current!==D)return P;P=(V==null?void 0:V.snapshot)??P;const ne=(oe=P.instances[0])==null?void 0:oe.variables;if(ne&&ye({...ne}),P.userTasks.some(Y=>Y.state==="Created")){L({kind:"human",text:"⏸ waiting for a human — complete the task below to continue"});break}if(!V){L({kind:"error",text:"▶ run stopped — no dispatch round was returned"});break}if(V.handled===0){const Y=P.messageSubscriptions[0];if(V.reason==="messages"&&Y){if(L({kind:"step",text:`⏳ parked on a message catch event — waiting for "${Y.messageName}"`,elementId:Y.elementId}),await new Promise(Z=>setTimeout(Z,Te)),ie.current!==D)return P;L({kind:"vars",text:`📨 correlating message "${Y.messageName}" (key: ${Y.correlationKey})`,elementId:Y.elementId});const O=b.correlateMessage(Y.messageName,Y.correlationKey,"{}");if(O){P=O;const Z=(ee=P.instances[0])==null?void 0:ee.variables;Z&&ye({...Z}),await new Promise(he=>setTimeout(he,Te));continue}L({kind:"error",text:`▶ run stopped — correlating "${Y.messageName}" (key: ${Y.correlationKey}) failed`,elementId:Y.elementId})}if(V.reason==="signals"&&P.signalSubscriptions.length>0){const O=P.signalSubscriptions[0],Z=P.signalSubscriptions.length;if(L({kind:"step",text:`⏳ parked on ${Z} open signal subscription${Z===1?"":"s"} — waiting for "${O.signalName}"`,elementId:O.elementId}),await new Promise(qe=>setTimeout(qe,Te)),ie.current!==D)return P;const he=b.broadcastSignal(O.signalName,"{}");if(he){P=he,L({kind:"vars",text:`📡 broadcasting signal "${O.signalName}" — every waiting subscription unblocks`,elementId:O.elementId});const qe=(ge=P.instances[0])==null?void 0:ge.variables;qe&&ye({...qe}),await new Promise(Ot=>setTimeout(Ot,Te));continue}L({kind:"error",text:`▶ run stopped — broadcasting signal "${O.signalName}" failed`,elementId:O.elementId})}if(V.reason==="timers"){const O=P.timers.reduce((Z,he)=>Math.min(Z,he.dueInMs),1/0);if(Number.isFinite(O)){if(L({kind:"step",text:`⏳ parked on a timer — ${(Math.max(O,0)/1e3).toFixed(1)}s left on the clock`}),await new Promise(he=>setTimeout(he,Te)),ie.current!==D)return P;const Z=b.advanceTime(Math.max(O,0)+1);if(Z){P=Z,L({kind:"step",text:"🕐 the clock advanced — timer fired"}),await new Promise(he=>setTimeout(he,Te));continue}}}break}await new Promise(Y=>setTimeout(Y,Te))}return ie.current!==D||(P&&P.completedInstances>=1?L({kind:"done",text:"✅ process instance completed"}):P&&P.incidentElementIds.length>0&&L({kind:"error",text:"A job failed — incident on the diagram"})),P},[b,L]),Fe=h.useCallback(async v=>{var P,ue,oe;if(!ke||me.current)return;const{job:x,control:I}=ke,D=++ie.current;me.current=!0,X(!0);try{let ee,ge;if(v==="complete")ee=b.completeJobManually(x.jobType,"{}"),ge="  ↳ completed normally";else if(I.action.kind==="timer"){const V=((ue=(P=b.snapshot)==null?void 0:P.timers[0])==null?void 0:ue.dueInMs)??0;ee=b.advanceTime(Math.max(V,0)+1),ge="  ↳ advanced the clock — timer fired"}else{const{errorCode:V,message:ne}=I.action;ee=b.throwJobError(x.jobType,V,ne),ge=`  ↳ threw BPMN error ${V}: ${ne}`}if(ee){L({kind:"vars",text:ge,elementId:x.elementId});const V=(oe=ee.instances[0])==null?void 0:oe.variables;V&&ye({...V}),await new Promise(ne=>setTimeout(ne,Te)),await Ye(W.current,Ae.current,ee,D)}else L({kind:"error",text:"  ↳ failed to resolve the manual job",elementId:x.elementId})}finally{ie.current===D&&(me.current=!1,X(!1))}},[ke,b,L,Ye]),Qe=h.useCallback(async()=>{var V;let v=null;try{y.agent&&l.trim()&&(v=xr(l))}catch(ne){return z(ne instanceof Error?ne.message:String(ne)),null}Ee.current={current:void 0};let x;if(e.imageInput){const ne=s.vision;x={read:ne??vi(e.scriptedVision).read,live:!!ne,resolve:O=>b.getRunImage(O)}}const I=kr(y,_.handlers,L,Ee.current,x);for(const ne of De.keys())delete I[ne];const D={};if(y.agents.length>0){if(s.kind!=="scripted"&&s.chat){const Y=new Map;for(const O of y.agents)Y.set(O.jobType,[...Y.get(O.jobType)??[],O]);for(const[O,Z]of Y)D[O]=Gr(Z,s.chat,L,{turnRef:Ee.current,requiredTools:e.requiredTools})}else if(v&&y.agent){const Y=y.agent.elementId;D[y.agent.jobType]=async O=>{if(O.elementId!==Y)throw new Error(`No scripted agent handler for "${O.elementId}" — only "${Y}" (the primary process's first agent host) is driven by the scripted brain. Use a live brain to exercise more than one host.`);const Z=await v(O),he=(Z.activateElements??[]).map(qe=>qe.elementId).join(", ");return L({kind:"agent",text:Z.completionConditionFulfilled?"🤖 scripted agent: done":`🤖 scripted agent: calling ${he||"(nothing)"}`}),Z}}}Ce([]),nn({});const P=_e;ye(P),W.current=I,Ae.current=D;const ue=b.redeploy(r),oe=(ue==null?void 0:ue[0])??y.processId;L({kind:"start",text:`Starting "${oe}" — ${y.agent?s.kind==="scripted"||!s.chat?"scripted brain":`live brain (${s.modelInUse??s.kind})`:"no agent in this model"}`});const ee=b.createInstance(oe,JSON.stringify(P)),ge=(V=ee==null?void 0:ee.instances[0])==null?void 0:V.key;return e.imageInput&&d&&ge&&b.setRunImage(ge,d),{workers:I,agents:D,snap:ee}},[b,e,_,r,l,B,d,_e,y,s,L,De]),ze=!!b.snapshot&&b.snapshot.completedInstances<1,j=!ze&&!!E&&!gn,C=h.useCallback(async()=>{if(b.phase!=="ready"||me.current||k||_.hasErrors)return;me.current=!0,X(!0);const v=++ie.current;try{let x=W.current,I=Ae.current,D=b.snapshot;if(!ze){if(xe.current&&!xe.current.validate())return;z(null);const P=await Qe();if(!P)return;x=P.workers,I=P.agents,D=P.snap,await new Promise(ue=>setTimeout(ue,Te))}await Ye(x,I,D,v)}finally{ie.current===v&&(me.current=!1,X(!1))}},[b,k,_.hasErrors,ze,Qe,Ye]),G=h.useCallback(async()=>{var x;if(b.phase!=="ready"||me.current||k||_.hasErrors)return;me.current=!0,T(!0);const v=++ie.current;try{let I=W.current,D=Ae.current,P=b.snapshot;if(!ze){if(xe.current&&!xe.current.validate())return;z(null);const V=await Qe();if(!V)return;I=V.workers,D=V.agents,P=V.snap}if(!P||P.completedInstances>=1)return;const ue=P.takenSequenceFlows.length,oe=await b.stepWorkers(I,{agents:D});if(!oe){L({kind:"error",text:"⏭ step failed — no dispatch round was returned"});return}const ee=(x=oe.snapshot.instances[0])==null?void 0:x.variables;ee&&ye({...ee});const ge=li(oe.snapshot.takenSequenceFlows,ue);L(ci(oe,ge,Ge,De))}finally{ie.current===v&&(me.current=!1,T(!1))}},[b,k,_.hasErrors,ze,Qe,L,Ge,De]),ve=h.useCallback(()=>{me.current=!1,ie.current++,X(!1),T(!1),b.reset(),Ce([]),ye({})},[b]),Ie=h.useCallback(()=>{var I;if(!fe||Ne.current&&!Ne.current.validate())return;const v=b.completeUserTask(fe.key,JSON.stringify(Be));L({kind:"human",text:`👤 ${ln(Be)}`});const x=(I=v==null?void 0:v.instances[0])==null?void 0:I.variables;ye(D=>({...D,...Be,...x??{}})),v&&v.completedInstances>=1&&L({kind:"done",text:"✅ process instance completed"})},[fe,Be,b,L]),He=h.useMemo(()=>{var v,x;return b.phase==="loading"?i.jsx(te,{variant:"neutral",children:"Booting engine…"}):b.phase==="error"?i.jsx(te,{variant:"danger",children:"Engine error"}):q?i.jsx(te,{variant:"info",children:"Running…"}):k?i.jsx(te,{variant:"info",children:"Stepping…"}):(((v=b.snapshot)==null?void 0:v.incidentElementIds.length)??0)>0?i.jsx(te,{variant:"danger",children:"Incident"}):fe?i.jsx(te,{variant:"warning",children:"Waiting for a human"}):(((x=b.snapshot)==null?void 0:x.completedInstances)??0)>=1?i.jsx(te,{variant:"success",children:"Completed"}):b.snapshot?i.jsx(te,{variant:"warning",children:"Paused"}):i.jsx(te,{variant:"neutral",children:"Ready"})},[b.phase,b.snapshot,q,k,fe]),zt=h.useMemo(()=>e.blurb.split(/\n\s*\n/).map(v=>v.trim()).filter(Boolean),[e.blurb]);return i.jsxs("div",{className:"runner",children:[i.jsxs("section",{className:"intro",children:[i.jsx("h1",{children:e.title}),zt.map(v=>i.jsx("p",{children:v},v))]}),e.imageInput&&i.jsx(Ai,{imageInput:e.imageInput,value:d,onSelect:p,disabled:q}),i.jsxs("div",{className:"scenario",children:[i.jsx("span",{className:"scenario-label",id:"scenario-label",children:e.scenariosLabel??"Example input"}),e.scenarios&&i.jsx("div",{className:"scenario-toggle",role:"group","aria-labelledby":"scenario-label",children:e.scenarios.map((v,x)=>i.jsx(J,{size:"sm",variant:x===ce?"default":"secondary","aria-pressed":x===ce,disabled:q,onClick:()=>Q(I=>({...I,...v.variables})),children:v.label},v.label))}),i.jsxs("button",{type:"button",className:"scenario-input-button",onClick:()=>re(!we),"aria-expanded":we,"aria-controls":"start-input-editor",title:"Edit the starting payload",children:[i.jsx("span",{className:"scenario-edit-icon","aria-hidden":!0,children:"✎"})," ","input: ",i.jsx("code",{children:Ki(B)})]}),j&&i.jsx("span",{className:"scenario-hint",children:"Fill in the input to enable Run"})]}),i.jsxs("div",{className:"inline-input-editor",id:"start-input-editor",hidden:!we,children:[i.jsxs("div",{className:"inline-input-editor-head",children:[i.jsxs("div",{children:[i.jsx("div",{className:"inline-input-editor-title",children:y.startFormId?"Start form":"Start payload"}),i.jsx("div",{className:"inline-input-editor-copy",children:y.startFormId?`Rendered from the model's start form "${y.startFormId}".`:"The variables the instance starts with."})]}),i.jsx(J,{size:"sm",variant:"secondary",onClick:()=>re(!1),children:"Done"})]}),E?i.jsx(h.Suspense,{fallback:i.jsx("div",{className:"form-fallback",children:"Loading form…"}),children:i.jsx(lt,{ref:xe,schema:E,values:B,onChange:(v,x)=>Q(I=>({...I,[v]:x})),disabled:q,onValidityChange:Pe})}):i.jsx("pre",{className:"vars",children:ln(B,2)})]}),(y.agent||e.imageInput)&&i.jsx(Ue,{sectionId:"brain",className:"brain-card","data-tour":Me.brainPanel,title:"Agent brain",description:y.agent?`What drives “${y.agent.label}”. The model recommends; the process governs.`:"What reads the image. The model recommends; the process governs.",children:i.jsx(ji,{brain:s,showText:!!y.agent,showVision:!!e.imageInput})}),i.jsxs("div",{className:"controls",children:[i.jsx(J,{"data-tour":Me.runButton,onClick:()=>void C(),disabled:b.phase!=="ready"||q||k||_.hasErrors||j,children:"▶ Run"}),i.jsx(J,{variant:"secondary",onClick:()=>void G(),disabled:b.phase!=="ready"||q||k||_.hasErrors||j||(((Rn=b.snapshot)==null?void 0:Rn.completedInstances)??0)>=1,children:"⏭ Step"}),i.jsx(J,{variant:"secondary",onClick:ve,disabled:b.phase!=="ready"||k,children:"↺ Reset"}),e.tour&&i.jsx(J,{variant:"secondary",onClick:M.start,disabled:M.active,children:M.active?"Touring…":`🧭 ${e.tour.label}`}),He]}),b.phase==="error"&&i.jsxs(ae,{variant:"destructive",children:[i.jsx(se,{children:"Engine error"}),i.jsx(de,{children:b.error})]}),N&&i.jsxs(ae,{variant:"destructive",children:[i.jsx(se,{children:"Code didn't compile"}),i.jsx(de,{children:N})]}),_.hasErrors&&i.jsxs(ae,{variant:"destructive",children:[i.jsx(se,{children:"Run is disabled — the diagram has unresolved references"}),i.jsx(de,{children:i.jsx("ul",{className:"diagnostics",children:_.diagnostics.filter(v=>v.severity==="error").map((v,x)=>i.jsx("li",{children:v.message},x))})})]}),!_.hasErrors&&_.diagnostics.length>0&&i.jsxs(ae,{children:[i.jsx(se,{children:"Heads up"}),i.jsx(de,{children:i.jsx("ul",{className:"diagnostics",children:_.diagnostics.map((v,x)=>i.jsx("li",{children:v.message},x))})})]}),i.jsxs("div",{className:"grid",children:[i.jsxs("div",{className:"col",children:[i.jsx(Ue,{sectionId:"process","data-tour":Me.diagram,title:"Process",description:`${y.processName} — live token (green), incidents (red).`,children:i.jsx(h.Suspense,{fallback:i.jsx("div",{className:"diagram-fallback",children:b.phase==="loading"?"Booting the engine…":"Loading diagram…"}),children:i.jsx(Wi,{xml:_.resolvedBpmn,activeIds:((Fn=b.snapshot)==null?void 0:Fn.activeElementIds)??[],incidentIds:((zn=b.snapshot)==null?void 0:zn.incidentElementIds)??[],className:"diagram"})})}),fe&&i.jsxs(Ue,{sectionId:"human-task",title:(pe==null?void 0:pe.label)??"Human task",description:Ve?`Rendered from the model's form "${pe==null?void 0:pe.formId}".`:"This task has no linked form — complete it with no variables.",children:[Re.length>0&&i.jsxs(ae,{variant:"destructive",children:[i.jsx(se,{children:"The agent didn't finish its checks"}),i.jsxs(de,{children:["It completed without running"," ",Re.map(v=>v.label||v.elementId).join(", "),". The process took the default path to this task, so the findings below have no value to report."]})]}),Ve&&i.jsx(h.Suspense,{fallback:i.jsx("div",{className:"form-fallback",children:"Loading form…"}),children:i.jsx(lt,{ref:Ne,schema:Ve,values:Be,onChange:(v,x)=>nn(I=>({...I,[v]:x})),context:$e,onValidityChange:hn})}),i.jsx(J,{onClick:Ie,disabled:!!Ve&&!Le,children:"Complete task"})]}),ke&&i.jsx(Ue,{sectionId:"manual-job",title:ke.control.label,description:"This job is held here on purpose — pick how it resolves.",children:i.jsxs("div",{className:"controls",children:[i.jsx(J,{onClick:()=>void Fe("complete"),disabled:q||k,children:ke.control.completeLabel??"✅ Complete normally"}),i.jsx(J,{variant:"secondary",onClick:()=>void Fe("action"),disabled:q||k,children:ke.control.action.label})]})})]}),i.jsx("div",{className:"col",children:i.jsx(Oi,{log:$,elementStats:(On=b.snapshot)==null?void 0:On.elementStats,incidents:(Un=b.snapshot)==null?void 0:Un.incidents,labelFor:Ge,variables:i.jsxs("div",{className:"vars-block","data-tour":Me.variablesPanel,children:[i.jsx("div",{className:"vars-head",children:"Instance variables"}),i.jsx("pre",{className:"vars",children:ln(Object.keys($e).length>0?$e:_e,2)})]})})})]}),i.jsxs("div",{className:"runner-secondary",children:[i.jsx(Ue,{sectionId:"code",className:"editors","data-tour":Me.codePanel,defaultOpen:!1,title:"Code",description:"One handler per BPMN element, plus a model tab holding the editable diagram — select an element there to edit its properties. Return variables to merge, or throw to fail the job.",children:i.jsx(h.Suspense,{fallback:i.jsx("div",{className:"editor-fallback",children:"Loading editor…"}),children:i.jsxs(Wt,{value:H,onValueChange:be,children:[i.jsxs(Zt,{children:[i.jsx(tn,{value:st,children:"model"}),y.agent&&i.jsx(tn,{value:fn,children:"agent (scripted)"}),e.handlers.map(v=>{var x;return i.jsx(tn,{value:v.elementId,children:((x=y.tasks.find(I=>I.elementId===v.elementId))==null?void 0:x.label)??v.elementId},v.elementId)}),Object.keys(c).map(v=>i.jsx(tn,{value:dt+v,children:v},v))]}),i.jsxs(rn,{value:st,children:[i.jsxs("div",{className:"editor-meta",children:[i.jsx("strong",{children:"Model"}),i.jsx("code",{children:"click an element to edit its properties on the right — Run re-reads whatever you leave here"}),i.jsx(J,{variant:"secondary",size:"sm",onClick:()=>o(e.bpmn),disabled:r===e.bpmn,children:"Revert to original"})]}),i.jsx(Zi,{value:r,onChange:o})]}),y.agent&&i.jsxs(rn,{value:fn,children:[i.jsxs("div",{className:"editor-meta",children:[i.jsx("strong",{children:y.agent.label}),i.jsx("code",{children:s.kind==="scripted"||!s.chat?"in use":"unused — a live brain is connected"})]}),i.jsx("div",{className:"editor-wrap",children:i.jsx(wn,{height:"360px",defaultLanguage:"javascript",value:l,onChange:v=>u(v??""),options:yn})})]}),e.handlers.map(v=>{var x;return i.jsxs(rn,{value:v.elementId,children:[i.jsxs("div",{className:"editor-meta",children:[i.jsx("strong",{children:((x=y.tasks.find(I=>I.elementId===v.elementId))==null?void 0:x.label)??v.elementId}),i.jsx("code",{children:v.standsInFor??v.elementId})]}),i.jsx("div",{className:"editor-wrap",children:i.jsx(wn,{height:"360px",defaultLanguage:"javascript",value:g[v.elementId],onChange:I=>a(D=>({...D,[v.elementId]:I??""})),options:yn})})]},v.elementId)}),Object.keys(c).map(v=>i.jsxs(rn,{value:dt+v,children:[i.jsxs("div",{className:"editor-meta",children:[i.jsx("strong",{children:v}),i.jsxs("code",{children:["prompt / template text — substitutes"," ","{{"+v+"}}"]})]}),i.jsx("div",{className:"editor-wrap",children:i.jsx(wn,{height:"360px",defaultLanguage:"markdown",value:c[v],onChange:x=>f(I=>en(I,{[v]:x??""})),options:yn})})]},v))]})})}),y.agent&&i.jsx(Ue,{sectionId:"tools",defaultOpen:!1,title:"Tools, as the model sees them",description:i.jsxs(i.Fragment,{children:["Read from the diagram — element name, documentation, and every",i.jsx("code",{children:" fromAi(…)"})," argument."]}),children:i.jsx("ul",{className:"tool-list",children:y.agent.tools.map(v=>i.jsxs("li",{children:[i.jsx("code",{children:v.elementId}),i.jsxs("span",{children:[" — ",v.documentation||v.label]}),v.args.length>0&&i.jsx("ul",{children:v.args.map(x=>i.jsxs("li",{children:[i.jsxs("code",{children:[x.name,": ",x.type]})," ","— ",x.description]},x.name))})]},v.elementId))})})]})]})}const yn={minimap:{enabled:!1},fontSize:13,scrollBeyondLastLine:!1,tabSize:2,automaticLayout:!0},eo=`<?xml version="1.0" encoding="UTF-8"?>\r
...
}`,fo={id:"learn-multi-instance-parallel",title:"Parallel multi-instance",group:"learn-bpmn",blurb:["A multi-instance activity runs its task once per element of a collection, spawning that many job instances of the same element in parallel, and only lets the token move on once every one of them completes.",`Run this and watch three 'Process item' jobs activate together for apple, banana, cherry, and complete (in any order) before the process reaches its end event. Nothing about the diagram says "three" — that comes from the collection, so use the buttons in the Start panel on the right to swap between one, three, and six items and hit Run again; the Activity panel logs one 'Process item' line per element, so the fan-out is right there to count.`,'The property tying the two together is in the Code panel: open the model tab, click "Process item", and expand Multi-instance in the properties panel on the right — Input collection holds `items`, the FEEL expression naming the variable to fan out over. Drop it entirely and the activity silently degenerates to a single ordinary instance, with no error to tell you it happened. Revert to original puts it back.'].join(`

`),docsUrl:"https://docs.camunda.io/docs/components/modeler/bpmn/multi-instance/",bpmn:bo,seed:{items:["apple","banana","cherry"]},scenarios:[{label:"One item — a single instance",variables:{items:["apple"]}},{label:"Three items — fans out to three",variables:{items:["apple","banana","cherry"]}},{label:"Six items — fans out to six",variables:{items:["apple","banana","cherry","damson","elderberry","fig"]}}],handlers:[{elementId:"Activity_process",standsInFor:"job worker — process-item",source:_o}]},wo=Object.freeze(Object.defineProperty({__proto__:null,default:fo},Symbol.toStringTag,{value:"Module"})),yo=`<?xml version="1.0" encoding="UTF-8"?>\r
...
}`,xo={id:"learn-service-task",title:"Service task + sequence flow",group:"learn-bpmn",blurb:["A service task is a unit of work a worker (not a human) performs; a sequence flow is the arrow that hands the token from one to the next once its task completes.","Run this and watch each task activate, run its handler, and complete in order — Prepare package, then Dispatch courier — before the process reaches its end event.",`The link between the two halves is the job type: in the Code panel, open the model tab, click "Prepare package", and expand Task definition in the properties panel on the right — Job type is the name a worker has to subscribe to in order to be handed this task's work.`,"(This page wires its own handlers up from whatever the model declares, so renaming it here keeps working; on a real cluster the worker is a separate process started with a job type of its own, and a mismatch means nobody ever activates the job, so the run stalls forever.)"].join(`

`),docsUrl:"https://docs.camunda.io/docs/components/modeler/bpmn/service-tasks/",bpmn:yo,seed:{item:"camunda-t-shirt"},handlers:[{elementId:"Activity_prepare",standsInFor:"job worker — prepare-package",source:vo},{elementId:"Activity_dispatch",standsInFor:"job worker — dispatch-courier",source:Mo}]},No=Object.freeze(Object.defineProperty({__proto__:null,default:xo},Symbol.toStringTag,{value:"Module"})),Eo=`<?xml version="1.0" encoding="UTF-8"?>\r
...
`,Bo="Camunda Cloud",Lo="8.10.0",Ro={name:"Camunda Web Modeler",version:"9b5d5ef"},Fo=19,zo="learn-user-task-form-review",Oo=[{text:`# Review request
...
`,qo={id:"compliance-walkthrough",label:"Take the tour",steps:[{title:"Start a run",description:"Press Run to send a shipment through the compliance agent.",target:{anchor:Me.runButton}},{title:"The agent picks its own tools",description:"This AI Agent reads the shipment notes and decides, turn by turn, which of the tools below it to call — nothing here is hard-coded into a fixed sequence.",target:{elementId:"ComplianceCheckAgent"}},{title:"Watch the token move",description:"The agent's first move is to look up the genetic marker mentioned in the notes.",target:{elementId:"VerifyGeneticMarker"},waitFor:{kind:"activeElement",elementId:"VerifyGeneticMarker"}},{title:"A cleared shipment notifies the export team",description:"Once the compliance score comes back clean, the process notifies the export team automatically — no human review needed for this scenario.",target:{elementId:"NotifyExportTeam"},waitFor:{kind:"elementCompleted",elementId:"NotifyExportTeam"}},{title:"Everything the run recorded",description:"The variables panel shows the marker record, the country lookup, the compliance score, and the final decision — exactly what each tool and the agent wrote along the way.",target:{anchor:Me.variablesPanel}}],successEvent:{kind:"instanceCompleted"}},Jo=`<?xml version="1.0" encoding="UTF-8"?>
...
**Agent's decision:** {{decision}}`,type:"text",layout:{row:"Row_findings",columns:null},id:"Field_ReviewFindings"},{label:"Reviewer decision",values:[{label:"Approve for export",value:"approved"},{label:"Reject shipment",value:"rejected"}],type:"radio",layout:{row:"Row_review_decision",columns:null},id:"Field_ReviewDecision",key:"reviewDecision",validate:{required:!0}},{label:"Reviewer comments",description:"Explain your decision - this is recorded alongside the process instance.",type:"textarea",layout:{row:"Row_review_comments",columns:null},id:"Field_ReviewComments",key:"reviewComments"}],la="default",ca={executionPlatform:ra,executionPlatformVersion:ia,exporter:oa,schemaVersion:aa,id:sa,components:da,type:la},ma=Object.assign({"./prompts/system-prompt.md":Yo,"./prompts/user-prompt.md":Qo}),pa=en(Object.fromEntries(Object.entries(ma).map(([e,n])=>[Et(e),n.trimEnd()]))),ct="SHIP-2026-0731 is prepared for transfer to Brazil. Supporting paperwork includes reference code TP53",ua="SHIP-2026-0900 is prepared for transfer to Germany. Supporting paperwork includes reference code BRCA1",ga=`async (job) => {
...
}`,ya={id:"seed-export-compliance",title:"Seed export compliance agent",blurb:"An AI agent picks its own tools to check a shipment, then a gateway routes on its decision — cleared shipments notify the export team, flagged ones go to a human. The LLM recommends; the BPMN process governs.",hero:{headline:"The LLM *recommends*. The process *governs*.",lede:"An agentic ad-hoc sub-process chooses its own compliance checks, but the gateway after it — not the model — decides whether a shipment ships or goes to a human.",tagline:"Anatomy of an enterprise agent"},docsUrl:"https://camunda.com/blog/agentic-ai/",bpmn:Jo,forms:{"seed-export-shipment-ready":ta,"seed-export-compliance-review":ca},seed:{scenario:ct,shipmentNotes:""},scenariosLabel:"Example shipment",scenarios:[{label:"Likely cleared (TP53 → Brazil)",variables:{scenario:ct,shipmentNotes:""}},{label:"Likely flagged (BRCA1 → Germany)",variables:{scenario:ua,shipmentNotes:""}}],scriptedAgent:ga,templates:pa,tour:qo,requiredTools:["RecordComplianceDecision"],handlers:[{elementId:"VerifyGeneticMarker",standsInFor:"JDBC connector — UCSC hg38",source:ha},{elementId:"CheckDestinationCountry",standsInFor:"GraphQL connector — countries API",source:ba},{elementId:"ComputeComplianceScore",standsInFor:"REST connector — api.mathjs.org",source:_a},{elementId:"RecordComplianceDecision",standsInFor:"Script task — FEEL",source:fa},{elementId:"NotifyExportTeam",standsInFor:"REST connector — httpbin.io",source:wa}]},va=`You are a loan origination assistant at a retail bank. Your job is to gather everything a senior loan officer needs to decide an application — you do **not** decide it yourself.
...
}`,Za={id:"loan-origination",title:"Loan origination agent",blurb:"An AI agent gathers a loan case with its own tools — customer lookup, credit bureau, an underwriting policy, a status update — then every application passes through a mandatory senior-officer review before a gateway routes it to an offer or a decline. The agent advises; the process governs.",docsUrl:"https://camunda.com/orchestrate/agents/",bpmn:Na,forms:{"loan-application":Aa,"loan-senior-officer-review":Oa},seed:mt,scenarios:[{label:"Strong applicant (policy recommends approve)",variables:mt},{label:"Marginal applicant (policy recommends decline)",variables:Ga}],scriptedAgent:Va,templates:$a,tour:xa,requiredTools:["AssessApplication","UpdateApplicationStatus"],handlers:[{elementId:"QueryCustomer",standsInFor:"CRM connector — customer lookup",source:Ya},{elementId:"CreditBureauLookup",standsInFor:"REST connector — credit bureau",source:Qa},{elementId:"AssessApplication",standsInFor:"Script task — underwriting policy (FEEL)",source:qa},{elementId:"UpdateApplicationStatus",standsInFor:"REST connector — origination system",source:Ja},{elementId:"IssueLoanOffer",standsInFor:"REST connector — offer/booking system",source:Ha},{elementId:"SendDeclineNotice",standsInFor:"REST connector — notifications",source:Wa}]},Ka=`<?xml version="1.0" encoding="UTF-8"?>
...
`,Xa=`async (job, { text, sleep }) => {
  ...
  return { shipped: true, tracking: "1Z" + Math.floor(Math.random() * 1e9) };
}`,ts={id:"order-process",title:"Order process with service workers",blurb:"The getting-started order process: check inventory, charge payment, ship. No agent and no human step — the same runner, driven entirely by what's in the diagram.",docsUrl:"https://docs.camunda.io/docs/next/guides/getting-started-orchestration-cluster/",bpmn:Ka,seed:{item:"camunda-t-shirt",quantity:3},handlers:[{elementId:"Activity_0tw2fu0",standsInFor:"job worker — check-inventory",source:Xa},{elementId:"Activity_1ppsbgi",standsInFor:"job worker — charge-payment",source:es},{elementId:"Activity_08pg6im",standsInFor:"job worker — ship-items",source:ns}]},rs=`<?xml version="1.0" encoding="UTF-8"?>\r
...
}`,os={id:"rocket-launch",title:"Rocket launch",blurb:"The getting-started rocket launch, boiled down to one service task: launch. The smallest possible example, and the smallest possible test of the framework's extensibility.",bpmn:rs,seed:{missionName:"Apollo 11",destination:"the Moon",fuelLevel:100},scenarios:[{label:"Full tanks — launch succeeds",variables:{missionName:"Apollo 11",destination:"the Moon",fuelLevel:100}},{label:"Low fuel — mission scrubbed",variables:{missionName:"Apollo 13",destination:"the Moon",fuelLevel:30}}],handlers:[{elementId:"Activity_LaunchRocket",standsInFor:"job worker — launch-rocket",source:is}]},as=`<?xml version="1.0" encoding="UTF-8"?>\r
...
`,ss=`async (job, { text, sleep }) => {
  ...
  return { shipped: true, tracking: "1Z" + Math.floor(Math.random() * 1e9) };
}`,cs={id:"order-process-boundary-events",title:"Order process with boundary events",blurb:"The getting-started order process, extended with a timer and an error boundary event: charge payment can be declined, and a delayed shipment can escalate — both fired by hand from the runner rather than by chance.",docsUrl:"https://github.com/camunda/camunda-8-get-started/tree/main/2-order-process-with-service-workers",bpmn:as,seed:{item:"camunda-t-shirt",quantity:3},handlers:[{elementId:"Activity_0tw2fu0",standsInFor:"job worker — check-inventory",source:ss},{elementId:"Activity_1ppsbgi",standsInFor:"job worker — charge-payment",source:ds,manualControl:{label:"Charge payment method",completeLabel:"✅ Complete normally",action:{kind:"error",errorCode:"CHARGE_DECLINED",message:"The card issuer declined the charge.",label:"❌ Simulate: card declined"}}},{elementId:"Activity_08pg6im",standsInFor:"job worker — ship-items",source:ls,manualControl:{label:"Ship items",completeLabel:"✅ Ship it",action:{kind:"timer",label:"🕐 Fire the shipping-delayed timer"}}}]},ms="/pr-preview/pr-106/assets/de-bmw-mini-JBSk7QcF.jpg",ps="/pr-preview/pr-106/assets/de-bmw-mini.thumb-CUUmJrRO.jpg",us="/pr-preview/pr-106/assets/uk-d651-rnb-XGipy2QN.jpg",gs="/pr-preview/pr-106/assets/uk-d651-rnb.thumb-mjEcbhUf.jpg",hs="/pr-preview/pr-106/assets/uk-mk70-orj-Cn6O3Xfm.jpg",bs="/pr-preview/pr-106/assets/uk-mk70-orj.thumb-CaeZ2vqU.jpg",_s="/pr-preview/pr-106/assets/uk-ni-ijz-8992-YXV44tgk.jpg",fs="/pr-preview/pr-106/assets/uk-ni-ijz-8992.thumb-DYwok8jV.jpg",ws="/pr-preview/pr-106/assets/us-hyundai-genesis-gGpAIEpi.jpg",ys="/pr-preview/pr-106/assets/us-hyundai-genesis.thumb-DEEt19Mw.jpg",vs=`<?xml version="1.0" encoding="UTF-8"?>
...
}`,Ks={id:"plate-recognition",title:"Read a number plate from a photo",blurb:"Pick the plate's country, then a photo goes into the run, an in-browser vision model reads the number plate on the reader's own GPU, and a human confirms or corrects it before the process records the result. The vision model recommends; the BPMN process governs. No server, no API key — with no model connected it falls back to a deterministic scripted reading.",docsUrl:"https://docs.camunda.io/docs/components/modeler/forms/camunda-forms-reference/",bpmn:vs,forms:{"plate-recognition-country":Ys,"plate-recognition-confirm":js,"plate-recognition-manual":Rs},seed:{country:"auto"},imageInput:{label:"Pick a seed photo (its plate is known, so the scripted reader works offline) or upload your own — a live in-browser model reads a photo it has never seen.",seedImages:Js},scriptedVision:Hs,handlers:[{elementId:"ExtractPlate",standsInFor:"Vision model — Florence-2 <OCR> on WebGPU (in-browser)",source:Ws},{elementId:"RecordResult",standsInFor:"Script task — records the governed outcome",source:Zs}]},Xs=[os,ya,Za,ts,cs,Ks],ed=Object.assign({"./learn-error-boundary/index.ts":io,"./learn-exclusive-gateway/index.ts":mo,"./learn-message-correlation/index.ts":ho,"./learn-multi-instance-parallel/index.ts":wo,"./learn-service-task/index.ts":No,"./learn-signal-broadcast/index.ts":jo,"./learn-timer-catch-event/index.ts":Do,"./learn-user-task-form/index.ts":Vo}),nd=Object.values(ed).map(e=>e.default).sort((e,n)=>e.id.localeCompare(n.id)),We=[...Xs,...nd];function Dn(){return"/pr-preview/pr-106/"}function td(e){const n=Dn();return e.startsWith(n)?"/"+e.slice(n.length):e}function rd(e=location.pathname){const t=td(e).match(/^\/examples\/([^/]+)\/?$/);if(t)try{return{kind:"example",id:decodeURIComponent(t[1])}}catch{return{kind:"gallery"}}return{kind:"gallery"}}function id(e=location.search){return new URLSearchParams(e).get("embed")==="1"}function ut(e){return`${Dn()}examples/${encodeURIComponent(e)}`}const gt="p";function od(){const e=new URLSearchParams(location.search),n=e.get(gt);if(!n)return!1;const t=n.replace(/[\t\n\r]/g,"");if(!t.startsWith("/")||t.startsWith("//")||t.startsWith("/\\"))return!1;e.delete(gt);try{const r=new URL(Dn(),location.href),o=new URL(t.slice(1),r);return o.origin!==location.origin?!1:(o.search=e.toString(),o.hash=location.hash,history.replaceState(null,"",o),!0)}catch{return!1}}function ad(e,n={}){const t=new URL(location.href);t.pathname=e,t.search=n.search??t.search,n.hash!==void 0&&(t.hash=n.hash),n.replace?history.replaceState(history.state,"",t):history.pushState(history.state,"",t),window.dispatchEvent(new PopStateEvent("popstate"))}function ht(){return{route:rd(),embed:id()}}function sd(){const[e,n]=h.useState(ht);return h.useEffect(()=>{const t=()=>n(ht());return window.addEventListener("popstate",t),()=>window.removeEventListener("popstate",t)},[]),e}const dd="web-demo-framework:height",ld="web-demo-framework:request-height";function cd(e){return{type:dd,height:Math.ceil(e)}}const bt="embed-height-auto";function md(e){h.useEffect(()=>{if(!e||typeof window>"u"||window.parent===window)return;const n=document.documentElement;n.classList.add(bt);let t=-1;const r=(d=!1)=>{const p=document.documentElement.scrollHeight;!d&&Math.abs(p-t)<2||(t=p,window.parent.postMessage(cd(p),"*"))},o=d=>{if(d.source!==window.parent)return;const p=d.data;!p||p.type!==ld||r(!0)};window.addEventListener("message",o),r();const s=new ResizeObserver(()=>r());return s.observe(n),()=>{s.disconnect(),window.removeEventListener("message",o),n.classList.remove(bt)}},[e])}const _t={headline:"The model *runs*. The code is *yours* to edit.",lede:"Every example on this page is a real BPMN process executing in your browser on the nano WebAssembly engine — edit the model, edit the handlers, swap the LLM, and run it again.",tagline:"Runnable Camunda examples"};function pd({text:e}){return i.jsx(i.Fragment,{children:e.split(/\*([^*]+)\*/g).map((n,t)=>t%2===1?i.jsx("em",{children:n},t):i.jsx(h.Fragment,{children:n},t))})}function ud(){const{route:e,embed:n}=sd(),t=Bt().brain,r=Ui();md(n);const o=e.kind==="example"?e.id:We[0].id,s=We.find(u=>u.id===o)??We[0],d=We.filter(u=>u.group!=="learn-bpmn"),p=We.filter(u=>u.group==="learn-bpmn"),g=u=>{ad(ut(u),{hash:location.hash})},a=s.hero??_t,l=i.jsxs(i.Fragment,{children:[!n&&i.jsxs(i.Fragment,{children:[i.jsxs("section",{className:"hero",children:[i.jsx("h1",{children:i.jsx(pd,{text:a.headline})}),a.lede&&i.jsx("p",{children:a.lede})]}),i.jsx("nav",{className:"example-picker","aria-label":"Scenario examples",children:d.map(u=>i.jsx(J,{size:"sm",variant:u.id===s.id?"default":"secondary","aria-current":u.id===s.id?"page":void 0,onClick:()=>g(u.id),children:u.title},u.id))}),p.length>0&&i.jsxs(i.Fragment,{children:[i.jsx("h2",{className:"example-group-heading",id:"learn-bpmn-heading",children:"Learn BPMN"}),i.jsx("nav",{className:"example-picker","aria-labelledby":"learn-bpmn-heading",children:p.map(u=>i.jsx(J,{size:"sm",variant:u.id===s.id?"default":"secondary","aria-current":u.id===s.id?"page":void 0,onClick:()=>g(u.id),children:u.title},u.id))})]})]}),i.jsxs("div",{className:"example-meta",children:[s.docsUrl&&i.jsx("a",{className:"docs-link",href:s.docsUrl,target:"_blank",rel:"noreferrer noopener",children:"View on camunda.com ↗"}),n&&i.jsx("a",{className:"open-full-page",href:ut(s.id)+(location.hash||""),target:"_top",rel:"noreferrer",children:"Open full page ↗"})]}),i.jsx(Xi,{example:s,initialBrainKind:t,initialTourId:r},s.id)]});return n?i.jsx("div",{className:"c4-ui app-shell app-embed",children:i.jsx("main",{id:"main",className:"layout layout-embed",children:l})}):i.jsxs("div",{className:"c4-ui app-shell",children:[i.jsx(Kt,{className:"topbar",logo:i.jsx("span",{className:"brand-dot","aria-hidden":!0}),appName:"Runnable Camunda examples",trailing:i.jsx("span",{className:"app-subtitle",children:a.tagline??_t.tagline})}),i.jsx("main",{id:"main",className:"layout",children:l}),i.jsx("footer",{className:"footer",children:"Running locally in your browser on the nano WebAssembly BPMN engine — no cluster, no server, no data leaving the page."})]})}od();Gt.createRoot(document.getElementById("root")).render(i.jsx(h.StrictMode,{children:i.jsx(Xt,{children:i.jsx(ud,{})})}));export{le as _,_d as c};
