const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/driver-CTZuBZOi.css","assets/diagram-js-DAKGYcfb.css","assets/bpmn-embedded-DPaOFtAb.css","assets/RuntimeDiagram-B2IYfHo7.js","assets/vendor-react-9Ma26nY1.js","assets/Viewer-D_7S4Gwm.js","assets/MonacoEditor-fJke69d6.js","assets/MonacoEditor-o_NvE1By.css","assets/vendor-modeler-CrQzfmmj.js","assets/vendor-design-system-MFk2Fr7N.js","assets/vendor-design-system-COOayRt3.css","assets/parser-DkgAe_kI.js","assets/ModelEditor-Dwlgp6JA.css","assets/FormRenderer-BL5pJ1tD.js","assets/FormRenderer-D1JIHOW6.css"])))=>i.map(i=>d[i]);
var Dt=Object.defineProperty;var Lt=(e,n,t)=>n in e?Dt(e,n,{enumerable:!0,configurable:!0,writable:!0,value:t}):e[n]=t;var O=(e,n,t)=>Lt(e,typeof n!="symbol"?n+"":n,t);import{r as h,j as a,i as Pt}from"./vendor-react-9Ma26nY1.js";import{B as H,a as Q,L as Re,S as Xn,b as et,c as nt,d as tt,e as rt,A as ae,f as se,g as ce,I as tn,C as Rt,h as zt,i as Bt,j as Ot,k as Ft,l as Ut,T as $t,m as Yt,n as Qe,o as Je,p as Gt,q as Vt}from"./vendor-design-system-MFk2Fr7N.js";(function(){const n=document.createElement("link").relList;if(n&&n.supports&&n.supports("modulepreload"))return;for(const i of document.querySelectorAll('link[rel="modulepreload"]'))r(i);new MutationObserver(i=>{for(const s of i)if(s.type==="childList")for(const c of s.addedNodes)c.tagName==="LINK"&&c.rel==="modulepreload"&&r(c)}).observe(document,{childList:!0,subtree:!0});function t(i){const s={};return i.integrity&&(s.integrity=i.integrity),i.referrerPolicy&&(s.referrerPolicy=i.referrerPolicy),i.crossOrigin==="use-credentials"?s.credentials="include":i.crossOrigin==="anonymous"?s.credentials="omit":s.credentials="same-origin",s}function r(i){if(i.ep)return;i.ep=!0;const s=t(i);fetch(i.href,s)}})();const Qt="modulepreload",Jt=function(e){return"/pr-preview/pr-83/"+e},kn={},le=function(n,t,r){let i=Promise.resolve();if(t&&t.length>0){let c=function(o){return Promise.all(o.map(l=>Promise.resolve(l).then(g=>({status:"fulfilled",value:g}),g=>({status:"rejected",reason:g}))))};document.getElementsByTagName("link");const u=document.querySelector("meta[property=csp-nonce]"),m=(u==null?void 0:u.nonce)||(u==null?void 0:u.getAttribute("nonce"));i=c(t.map(o=>{if(o=Jt(o),o in kn)return;kn[o]=!0;const l=o.endsWith(".css"),g=l?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${o}"]${g}`))return;const p=document.createElement("link");if(p.rel=l?"stylesheet":Qt,l||(p.as="script"),p.crossOrigin="",p.href=o,m&&p.setAttribute("nonce",m),document.head.appendChild(p),l)return new Promise((y,b)=>{p.addEventListener("load",y),p.addEventListener("error",()=>b(new Error(`Unable to preload CSS for ${o}`)))})}))}function s(c){const u=new Event("vite:preloadError",{cancelable:!0});if(u.payload=c,window.dispatchEvent(u),!u.defaultPrevented)throw c}return i.then(c=>{for(const u of c||[])u.status==="rejected"&&s(u.reason);return n().catch(s)})},Ht="io.camunda.agenticai:aiagent",_e="http://www.omg.org/spec/BPMN/20100524/MODEL",Wt="http://camunda.org/schema/zeebe/1.0";function dn(e,n){return Array.from(e.getElementsByTagNameNS(Wt,n))}function it(e,n){return dn(e,n).filter(t=>Zt(t)===e)}function Zt(e){let n=e.parentElement;for(;n;){if(n.namespaceURI===_e&&n.localName!=="extensionElements")return n;n=n.parentElement}return null}function hn(e){const n=it(e,"taskDefinition")[0],t=n==null?void 0:n.getAttribute("type");return t||(e.localName==="scriptTask"?e.getAttribute("id")??null:null)}function En(e){const n=Array.from(e.children).find(t=>t.namespaceURI===_e&&t.localName==="documentation");return((n==null?void 0:n.textContent)??"").trim()}function Tn(e){if(!e)return"";const n=e.startsWith("=")?e.slice(1):e,t=n.match(/"((?:[^"\\]|\\.)*)"/g);return t?t.map(r=>r.slice(1,-1).replace(/\\n/g,`
...
character, with nothing added. When your work is finished, reply exactly
{"done": true} and no tool.`}function Sr(e,n,t,r,i=[],s=[],c=!1){const u=e.userPrompt||"Carry out your task.",m=Object.entries(n).filter(([,l])=>typeof l=="string"&&l.trim().length>0).map(([l,g])=>`  ${l}: ${String(g)}`),o=[u,m.length?`Case data:
${m.join(`
...
`)}async function Ar(e,n,t,r,i,s){let c="";n({kind:"llm",text:"LLM thinking…",key:t,pending:!0,turn:s});const u=await e(r,i,m=>{c+=m,n({kind:"llm",text:`${un(c)} ▍`,key:t,pending:!0,turn:s})});return n({kind:"llm",text:un(u||c)||"(empty reply)",key:t,pending:!1,turn:s}),u}function Cr(e,n){switch(e){case"number":return typeof n=="number"&&Number.isFinite(n)?{ok:!0,value:n}:typeof n=="string"&&n.trim()!==""&&Number.isFinite(Number(n))?{ok:!0,value:Number(n)}:{ok:!1};case"boolean":return typeof n=="boolean"?{ok:!0,value:n}:typeof n=="string"&&/^(true|false)$/i.test(n.trim())?{ok:!0,value:n.trim().toLowerCase()==="true"}:{ok:!1};default:return typeof n=="object"?{ok:!1}:{ok:!0,value:String(n)}}}function Dr(e,n,t){const r={},i=new Map,s=new Map;for(const{tool:c,args:u}of e){const m={};for(const o of c.args){const l=u[o.name];if(!(l!=null&&l!=="")){n({kind:"error",text:`🤖 ${c.elementId}: model supplied no value for "${o.name}"`,turn:t,elementId:c.elementId});continue}const p=i.get(o.name);if(p!==void 0&&p!==c.elementId){n({kind:"error",text:`🤖 argument name collision on "${o.name}": both ${p} and ${c.elementId} declare it — ${p} already claimed it this turn, ${c.elementId}'s value is dropped`,turn:t,elementId:c.elementId});continue}const y=Cr(o.type,l);if(!y.ok){n({kind:"error",text:`🤖 ${c.elementId}: "${o.name}" is declared as ${o.type} but the model supplied ${JSON.stringify(l)} — rejected, not passed through`,turn:t,elementId:c.elementId});continue}r[o.name]=y.value,m[o.name]=y.value,i.set(o.name,c.elementId)}s.set(c.elementId,m)}return{variablesOut:r,forHistory:s}}function Lr(e,n,t,r={}){const{maxNewTokens:i=384,allowRepeats:s=!1,allowMultiToolTurns:c=!1,turnRef:u,requiredTools:m=[],maxEarlyDoneNudges:o=1}=r;let l=0;const g=new Set,p=[];let y=0,b=[],_=[];return async f=>{const M=f.variables,k=M.toolCallResult;for(k!==void 0&&p.length&&(p[p.length-1]=`${p[p.length-1]} → ${un(JSON.stringify(k),160)}`);;){const Y=await L();if(Y)return Y}async function L(){if(l+=1,u&&(u.current=l),l>e.maxModelCalls)return t({kind:"error",text:`Turn budget spent (maxModelCalls=${e.maxModelCalls}) — completing the agent.`,turn:l}),{completionConditionFulfilled:!0};const Y=s?e.tools:e.tools.filter(C=>!g.has(C.elementId)),W=[{role:"system",content:jr(e,c,Y)},{role:"user",content:Sr(e,M,p,Y,b,_,s)}];b=[],_=[];let de;try{de=await Ar(n,t,`llm-turn-${l}`,W,i,l)}catch(C){return t({kind:"error",text:`LLM call failed: ${C instanceof Error?C.message:String(C)} — completing the agent.`,turn:l}),{completionConditionFulfilled:!0}}const G=Er(de);if(Tr(G)&&An(G).length===0){const C=m.filter(Z=>!g.has(Z));return C.length&&y<o?(y+=1,b=C,t({kind:"agent",text:`🤖 model says it is done, but ${C.join(", ")} hasn't run — asking once more`,turn:l}),null):(t({kind:"agent",text:"🤖 model says it is done",turn:l}),{completionConditionFulfilled:!0})}const ie=An(G);if(ie.length===0)return t({kind:"error",text:"🤖 model named no tool (and didn't say it was done) — asking again",turn:l}),_=['it named no tool and did not say it was done — reply with {"tool": "...", "arguments": {...}} or {"done": true}'],null;const U=[],I=[],N=[];for(const C of ie){const Z=e.tools.find(be=>be.elementId===C.name);if(!Z){I.push(C.name);continue}if(!s&&g.has(Z.elementId)){N.push(Z.elementId);continue}U.push({tool:Z,args:C.args})}if(I.length&&t({kind:"error",text:`🤖 model named a tool that doesn't exist: ${I.join(", ")} — nothing activated`,turn:l}),N.length&&t({kind:"error",text:`🤖 model asked to re-run ${N.join(", ")} — skipped (already run)`,turn:l}),U.length===0)return t({kind:"agent",text:"🤖 nothing activated — asking again",turn:l}),_=[...I.length?[`${I.join(", ")} ${I.length===1?"is":"are"} not a real tool`]:[],...N.length?[`${N.join(", ")} has already run and will never run again — pick a different tool, or reply {"done": true} if nothing is left to do`]:[]],null;const{variablesOut:A,forHistory:K}=Dr(U,t,l);for(const{tool:C}of U)g.add(C.elementId),p.push(`- ${C.elementId}(${JSON.stringify(K.get(C.elementId))})`);for(const{tool:C}of U)t({kind:"agent",text:`🤖 calling ${C.elementId}`,turn:l,elementId:C.elementId,args:K.get(C.elementId)??{}});return{activateElements:U.map(C=>({elementId:C.tool.elementId})),variables:A}}}}function Pr(e,n,t,r={}){const i=new Map(e.map(s=>[s.elementId,Lr(s,n,t,r)]));return async s=>{const c=i.get(s.elementId);if(!c)throw new Error(`No agent host registered for "${s.elementId}"`);return c(s)}}class mn{__destroy_into_raw(){const n=this.__wbg_ptr;return this.__wbg_ptr=0,Dn.unregister(this),n}free(){const n=this.__destroy_into_raw();d.__wbg_testengine_free(n,0)}activateJobs(n,t,r,i){let s,c;try{const y=d.__wbindgen_add_to_stack_pointer(-16),b=S(n,d.__wbindgen_export,d.__wbindgen_export2),_=j,f=S(i,d.__wbindgen_export,d.__wbindgen_export2),M=j;d.testengine_activateJobs(y,this.__wbg_ptr,b,_,t,r,f,M);var u=w().getInt32(y+0,!0),m=w().getInt32(y+4,!0),o=w().getInt32(y+8,!0),l=w().getInt32(y+12,!0),g=u,p=m;if(l)throw g=0,p=0,z(o);return s=g,c=p,R(g,p)}finally{d.__wbindgen_add_to_stack_pointer(16),d.__wbindgen_export3(s,c,1)}}advanceTime(n){let t,r;try{const l=d.__wbindgen_add_to_stack_pointer(-16);d.testengine_advanceTime(l,this.__wbg_ptr,n);var i=w().getInt32(l+0,!0),s=w().getInt32(l+4,!0),c=w().getInt32(l+8,!0),u=w().getInt32(l+12,!0),m=i,o=s;if(u)throw m=0,o=0,z(c);return t=m,r=o,R(m,o)}finally{d.__wbindgen_add_to_stack_pointer(16),d.__wbindgen_export3(t,r,1)}}assignUserTask(n,t,r){let i,s;try{const p=d.__wbindgen_add_to_stack_pointer(-16),y=S(n,d.__wbindgen_export,d.__wbindgen_export2),b=j,_=S(t,d.__wbindgen_export,d.__wbindgen_export2),f=j;d.testengine_assignUserTask(p,this.__wbg_ptr,y,b,_,f,r);var c=w().getInt32(p+0,!0),u=w().getInt32(p+4,!0),m=w().getInt32(p+8,!0),o=w().getInt32(p+12,!0),l=c,g=u;if(o)throw l=0,g=0,z(m);return i=l,s=g,R(l,g)}finally{d.__wbindgen_add_to_stack_pointer(16),d.__wbindgen_export3(i,s,1)}}broadcastSignal(n,t){let r,i;try{const g=d.__wbindgen_add_to_stack_pointer(-16),p=S(n,d.__wbindgen_export,d.__wbindgen_export2),y=j,b=S(t,d.__wbindgen_export,d.__wbindgen_export2),_=j;d.testengine_broadcastSignal(g,this.__wbg_ptr,p,y,b,_);var s=w().getInt32(g+0,!0),c=w().getInt32(g+4,!0),u=w().getInt32(g+8,!0),m=w().getInt32(g+12,!0),o=s,l=c;if(m)throw o=0,l=0,z(u);return r=o,i=l,R(o,l)}finally{d.__wbindgen_add_to_stack_pointer(16),d.__wbindgen_export3(r,i,1)}}cancelInstance(n){let t,r;try{const l=d.__wbindgen_add_to_stack_pointer(-16),g=S(n,d.__wbindgen_export,d.__wbindgen_export2),p=j;d.testengine_cancelInstance(l,this.__wbg_ptr,g,p);var i=w().getInt32(l+0,!0),s=w().getInt32(l+4,!0),c=w().getInt32(l+8,!0),u=w().getInt32(l+12,!0),m=i,o=s;if(u)throw m=0,o=0,z(c);return t=m,r=o,R(m,o)}finally{d.__wbindgen_add_to_stack_pointer(16),d.__wbindgen_export3(t,r,1)}}completeAgentJob(n,t,r){let i,s;try{const p=d.__wbindgen_add_to_stack_pointer(-16),y=S(n,d.__wbindgen_export,d.__wbindgen_export2),b=j,_=S(t,d.__wbindgen_export,d.__wbindgen_export2),f=j,M=S(r,d.__wbindgen_export,d.__wbindgen_export2),k=j;d.testengine_completeAgentJob(p,this.__wbg_ptr,y,b,_,f,M,k);var c=w().getInt32(p+0,!0),u=w().getInt32(p+4,!0),m=w().getInt32(p+8,!0),o=w().getInt32(p+12,!0),l=c,g=u;if(o)throw l=0,g=0,z(m);return i=l,s=g,R(l,g)}finally{d.__wbindgen_add_to_stack_pointer(16),d.__wbindgen_export3(i,s,1)}}completeJob(n,t){let r,i;try{const g=d.__wbindgen_add_to_stack_pointer(-16),p=S(n,d.__wbindgen_export,d.__wbindgen_export2),y=j,b=S(t,d.__wbindgen_export,d.__wbindgen_export2),_=j;d.testengine_completeJob(g,this.__wbg_ptr,p,y,b,_);var s=w().getInt32(g+0,!0),c=w().getInt32(g+4,!0),u=w().getInt32(g+8,!0),m=w().getInt32(g+12,!0),o=s,l=c;if(m)throw o=0,l=0,z(u);return r=o,i=l,R(o,l)}finally{d.__wbindgen_add_to_stack_pointer(16),d.__wbindgen_export3(r,i,1)}}completeUserTask(n,t){let r,i;try{const g=d.__wbindgen_add_to_stack_pointer(-16),p=S(n,d.__wbindgen_export,d.__wbindgen_export2),y=j,b=S(t,d.__wbindgen_export,d.__wbindgen_export2),_=j;d.testengine_completeUserTask(g,this.__wbg_ptr,p,y,b,_);var s=w().getInt32(g+0,!0),c=w().getInt32(g+4,!0),u=w().getInt32(g+8,!0),m=w().getInt32(g+12,!0),o=s,l=c;if(m)throw o=0,l=0,z(u);return r=o,i=l,R(o,l)}finally{d.__wbindgen_add_to_stack_pointer(16),d.__wbindgen_export3(r,i,1)}}correlateMessage(n,t,r){let i,s;try{const p=d.__wbindgen_add_to_stack_pointer(-16),y=S(n,d.__wbindgen_export,d.__wbindgen_export2),b=j,_=S(t,d.__wbindgen_export,d.__wbindgen_export2),f=j,M=S(r,d.__wbindgen_export,d.__wbindgen_export2),k=j;d.testengine_correlateMessage(p,this.__wbg_ptr,y,b,_,f,M,k);var c=w().getInt32(p+0,!0),u=w().getInt32(p+4,!0),m=w().getInt32(p+8,!0),o=w().getInt32(p+12,!0),l=c,g=u;if(o)throw l=0,g=0,z(m);return i=l,s=g,R(l,g)}finally{d.__wbindgen_add_to_stack_pointer(16),d.__wbindgen_export3(i,s,1)}}createInstance(n,t,r){let i,s;try{const p=d.__wbindgen_add_to_stack_pointer(-16),y=S(n,d.__wbindgen_export,d.__wbindgen_export2),b=j,_=S(t,d.__wbindgen_export,d.__wbindgen_export2),f=j;d.testengine_createInstance(p,this.__wbg_ptr,y,b,_,f,Fr(r)?Number.MAX_SAFE_INTEGER:r>>0);var c=w().getInt32(p+0,!0),u=w().getInt32(p+4,!0),m=w().getInt32(p+8,!0),o=w().getInt32(p+12,!0),l=c,g=u;if(o)throw l=0,g=0,z(m);return i=l,s=g,R(l,g)}finally{d.__wbindgen_add_to_stack_pointer(16),d.__wbindgen_export3(i,s,1)}}debugClear(){d.testengine_debugClear(this.__wbg_ptr)}debugCreateInstance(n,t,r){let i,s;try{const p=d.__wbindgen_add_to_stack_pointer(-16),y=S(n,d.__wbindgen_export,d.__wbindgen_export2),b=j,_=S(t,d.__wbindgen_export,d.__wbindgen_export2),f=j,M=S(r,d.__wbindgen_export,d.__wbindgen_export2),k=j;d.testengine_debugCreateInstance(p,this.__wbg_ptr,y,b,_,f,M,k);var c=w().getInt32(p+0,!0),u=w().getInt32(p+4,!0),m=w().getInt32(p+8,!0),o=w().getInt32(p+12,!0),l=c,g=u;if(o)throw l=0,g=0,z(m);return i=l,s=g,R(l,g)}finally{d.__wbindgen_add_to_stack_pointer(16),d.__wbindgen_export3(i,s,1)}}get debugIsPaused(){return d.testengine_debugIsPaused(this.__wbg_ptr)!==0}debugResume(){let n,t;try{const o=d.__wbindgen_add_to_stack_pointer(-16);d.testengine_debugResume(o,this.__wbg_ptr);var r=w().getInt32(o+0,!0),i=w().getInt32(o+4,!0),s=w().getInt32(o+8,!0),c=w().getInt32(o+12,!0),u=r,m=i;if(c)throw u=0,m=0,z(s);return n=u,t=m,R(u,m)}finally{d.__wbindgen_add_to_stack_pointer(16),d.__wbindgen_export3(n,t,1)}}debugStep(){let n,t;try{const o=d.__wbindgen_add_to_stack_pointer(-16);d.testengine_debugStep(o,this.__wbg_ptr);var r=w().getInt32(o+0,!0),i=w().getInt32(o+4,!0),s=w().getInt32(o+8,!0),c=w().getInt32(o+12,!0),u=r,m=i;if(c)throw u=0,m=0,z(s);return n=u,t=m,R(u,m)}finally{d.__wbindgen_add_to_stack_pointer(16),d.__wbindgen_export3(n,t,1)}}deploy(n){let t,r;try{const l=d.__wbindgen_add_to_stack_pointer(-16),g=S(n,d.__wbindgen_export,d.__wbindgen_export2),p=j;d.testengine_deploy(l,this.__wbg_ptr,g,p);var i=w().getInt32(l+0,!0),s=w().getInt32(l+4,!0),c=w().getInt32(l+8,!0),u=w().getInt32(l+12,!0),m=i,o=s;if(u)throw m=0,o=0,z(c);return t=m,r=o,R(m,o)}finally{d.__wbindgen_add_to_stack_pointer(16),d.__wbindgen_export3(t,r,1)}}deployForm(n){let t,r;try{const l=d.__wbindgen_add_to_stack_pointer(-16),g=S(n,d.__wbindgen_export,d.__wbindgen_export2),p=j;d.testengine_deployForm(l,this.__wbg_ptr,g,p);var i=w().getInt32(l+0,!0),s=w().getInt32(l+4,!0),c=w().getInt32(l+8,!0),u=w().getInt32(l+12,!0),m=i,o=s;if(u)throw m=0,o=0,z(c);return t=m,r=o,R(m,o)}finally{d.__wbindgen_add_to_stack_pointer(16),d.__wbindgen_export3(t,r,1)}}deployResource(n,t){let r,i;try{const g=d.__wbindgen_add_to_stack_pointer(-16),p=S(n,d.__wbindgen_export,d.__wbindgen_export2),y=j,b=S(t,d.__wbindgen_export,d.__wbindgen_export2),_=j;d.testengine_deployResource(g,this.__wbg_ptr,p,y,b,_);var s=w().getInt32(g+0,!0),c=w().getInt32(g+4,!0),u=w().getInt32(g+8,!0),m=w().getInt32(g+12,!0),o=s,l=c;if(m)throw o=0,l=0,z(u);return r=o,i=l,R(o,l)}finally{d.__wbindgen_add_to_stack_pointer(16),d.__wbindgen_export3(r,i,1)}}events(){let n,t;try{const o=d.__wbindgen_add_to_stack_pointer(-16);d.testengine_events(o,this.__wbg_ptr);var r=w().getInt32(o+0,!0),i=w().getInt32(o+4,!0),s=w().getInt32(o+8,!0),c=w().getInt32(o+12,!0),u=r,m=i;if(c)throw u=0,m=0,z(s);return n=u,t=m,R(u,m)}finally{d.__wbindgen_add_to_stack_pointer(16),d.__wbindgen_export3(n,t,1)}}failJob(n,t,r){let i,s;try{const p=d.__wbindgen_add_to_stack_pointer(-16),y=S(n,d.__wbindgen_export,d.__wbindgen_export2),b=j,_=S(r,d.__wbindgen_export,d.__wbindgen_export2),f=j;d.testengine_failJob(p,this.__wbg_ptr,y,b,t,_,f);var c=w().getInt32(p+0,!0),u=w().getInt32(p+4,!0),m=w().getInt32(p+8,!0),o=w().getInt32(p+12,!0),l=c,g=u;if(o)throw l=0,g=0,z(m);return i=l,s=g,R(l,g)}finally{d.__wbindgen_add_to_stack_pointer(16),d.__wbindgen_export3(i,s,1)}}migrate(n,t,r){let i,s;try{const p=d.__wbindgen_add_to_stack_pointer(-16),y=S(n,d.__wbindgen_export,d.__wbindgen_export2),b=j,_=S(t,d.__wbindgen_export,d.__wbindgen_export2),f=j,M=S(r,d.__wbindgen_export,d.__wbindgen_export2),k=j;d.testengine_migrate(p,this.__wbg_ptr,y,b,_,f,M,k);var c=w().getInt32(p+0,!0),u=w().getInt32(p+4,!0),m=w().getInt32(p+8,!0),o=w().getInt32(p+12,!0),l=c,g=u;if(o)throw l=0,g=0,z(m);return i=l,s=g,R(l,g)}finally{d.__wbindgen_add_to_stack_pointer(16),d.__wbindgen_export3(i,s,1)}}modify(n,t,r){let i,s;try{const p=d.__wbindgen_add_to_stack_pointer(-16),y=S(n,d.__wbindgen_export,d.__wbindgen_export2),b=j,_=S(t,d.__wbindgen_export,d.__wbindgen_export2),f=j,M=S(r,d.__wbindgen_export,d.__wbindgen_export2),k=j;d.testengine_modify(p,this.__wbg_ptr,y,b,_,f,M,k);var c=w().getInt32(p+0,!0),u=w().getInt32(p+4,!0),m=w().getInt32(p+8,!0),o=w().getInt32(p+12,!0),l=c,g=u;if(o)throw l=0,g=0,z(m);return i=l,s=g,R(l,g)}finally{d.__wbindgen_add_to_stack_pointer(16),d.__wbindgen_export3(i,s,1)}}constructor(){const n=d.testengine_new();return this.__wbg_ptr=n,Dn.register(this,this.__wbg_ptr,this),this}get now(){return d.testengine_now(this.__wbg_ptr)}reset(){d.testengine_reset(this.__wbg_ptr)}resolveIncident(n){let t,r;try{const l=d.__wbindgen_add_to_stack_pointer(-16),g=S(n,d.__wbindgen_export,d.__wbindgen_export2),p=j;d.testengine_resolveIncident(l,this.__wbg_ptr,g,p);var i=w().getInt32(l+0,!0),s=w().getInt32(l+4,!0),c=w().getInt32(l+8,!0),u=w().getInt32(l+12,!0),m=i,o=s;if(u)throw m=0,o=0,z(c);return t=m,r=o,R(m,o)}finally{d.__wbindgen_add_to_stack_pointer(16),d.__wbindgen_export3(t,r,1)}}setVariables(n,t,r){let i,s;try{const p=d.__wbindgen_add_to_stack_pointer(-16),y=S(n,d.__wbindgen_export,d.__wbindgen_export2),b=j,_=S(t,d.__wbindgen_export,d.__wbindgen_export2),f=j;d.testengine_setVariables(p,this.__wbg_ptr,y,b,_,f,r);var c=w().getInt32(p+0,!0),u=w().getInt32(p+4,!0),m=w().getInt32(p+8,!0),o=w().getInt32(p+12,!0),l=c,g=u;if(o)throw l=0,g=0,z(m);return i=l,s=g,R(l,g)}finally{d.__wbindgen_add_to_stack_pointer(16),d.__wbindgen_export3(i,s,1)}}snapshot(){let n,t;try{const o=d.__wbindgen_add_to_stack_pointer(-16);d.testengine_snapshot(o,this.__wbg_ptr);var r=w().getInt32(o+0,!0),i=w().getInt32(o+4,!0),s=w().getInt32(o+8,!0),c=w().getInt32(o+12,!0),u=r,m=i;if(c)throw u=0,m=0,z(s);return n=u,t=m,R(u,m)}finally{d.__wbindgen_add_to_stack_pointer(16),d.__wbindgen_export3(n,t,1)}}throwError(n,t,r){let i,s;try{const p=d.__wbindgen_add_to_stack_pointer(-16),y=S(n,d.__wbindgen_export,d.__wbindgen_export2),b=j,_=S(t,d.__wbindgen_export,d.__wbindgen_export2),f=j,M=S(r,d.__wbindgen_export,d.__wbindgen_export2),k=j;d.testengine_throwError(p,this.__wbg_ptr,y,b,_,f,M,k);var c=w().getInt32(p+0,!0),u=w().getInt32(p+4,!0),m=w().getInt32(p+8,!0),o=w().getInt32(p+12,!0),l=c,g=u;if(o)throw l=0,g=0,z(m);return i=l,s=g,R(l,g)}finally{d.__wbindgen_add_to_stack_pointer(16),d.__wbindgen_export3(i,s,1)}}tickNow(n){let t,r;try{const l=d.__wbindgen_add_to_stack_pointer(-16);d.testengine_tickNow(l,this.__wbg_ptr,n);var i=w().getInt32(l+0,!0),s=w().getInt32(l+4,!0),c=w().getInt32(l+8,!0),u=w().getInt32(l+12,!0),m=i,o=s;if(u)throw m=0,o=0,z(c);return t=m,r=o,R(m,o)}finally{d.__wbindgen_add_to_stack_pointer(16),d.__wbindgen_export3(t,r,1)}}unassignUserTask(n){let t,r;try{const l=d.__wbindgen_add_to_stack_pointer(-16),g=S(n,d.__wbindgen_export,d.__wbindgen_export2),p=j;d.testengine_unassignUserTask(l,this.__wbg_ptr,g,p);var i=w().getInt32(l+0,!0),s=w().getInt32(l+4,!0),c=w().getInt32(l+8,!0),u=w().getInt32(l+12,!0),m=i,o=s;if(u)throw m=0,o=0,z(c);return t=m,r=o,R(m,o)}finally{d.__wbindgen_add_to_stack_pointer(16),d.__wbindgen_export3(t,r,1)}}updateRetries(n,t){let r,i;try{const g=d.__wbindgen_add_to_stack_pointer(-16),p=S(n,d.__wbindgen_export,d.__wbindgen_export2),y=j;d.testengine_updateRetries(g,this.__wbg_ptr,p,y,t);var s=w().getInt32(g+0,!0),c=w().getInt32(g+4,!0),u=w().getInt32(g+8,!0),m=w().getInt32(g+12,!0),o=s,l=c;if(m)throw o=0,l=0,z(u);return r=o,i=l,R(o,l)}finally{d.__wbindgen_add_to_stack_pointer(16),d.__wbindgen_export3(r,i,1)}}updateUserTask(n,t){let r,i;try{const g=d.__wbindgen_add_to_stack_pointer(-16),p=S(n,d.__wbindgen_export,d.__wbindgen_export2),y=j,b=S(t,d.__wbindgen_export,d.__wbindgen_export2),_=j;d.testengine_updateUserTask(g,this.__wbg_ptr,p,y,b,_);var s=w().getInt32(g+0,!0),c=w().getInt32(g+4,!0),u=w().getInt32(g+8,!0),m=w().getInt32(g+12,!0),o=s,l=c;if(m)throw o=0,l=0,z(u);return r=o,i=l,R(o,l)}finally{d.__wbindgen_add_to_stack_pointer(16),d.__wbindgen_export3(r,i,1)}}}Symbol.dispose&&(mn.prototype[Symbol.dispose]=mn.prototype.free);function Rr(){return{__proto__:null,"./nanobpmn_engine_bg.js":{__proto__:null,__wbg___wbindgen_throw_bb96b2010945f0bc:function(n,t){throw new Error(R(n,t))},__wbindgen_cast_0000000000000001:function(n,t){const r=R(n,t);return zr(r)},__wbindgen_object_drop_ref:function(n){z(n)}}}}const Dn=typeof FinalizationRegistry>"u"?{register:()=>{},unregister:()=>{}}:new FinalizationRegistry(e=>d.__wbg_testengine_free(e,1));function zr(e){Ue===we.length&&we.push(we.length+1);const n=Ue;return Ue=we[n],we[n]=e,n}function Br(e){e<1028||(we[e]=Ue,Ue=e)}let Ae=null;function w(){return(Ae===null||Ae.buffer.detached===!0||Ae.buffer.detached===void 0&&Ae.buffer!==d.memory.buffer)&&(Ae=new DataView(d.memory.buffer)),Ae}function R(e,n){return $r(e>>>0,n)}let Fe=null;function qe(){return(Fe===null||Fe.byteLength===0)&&(Fe=new Uint8Array(d.memory.buffer)),Fe}function Or(e){return we[e]}let we=new Array(1024).fill(void 0);we.push(void 0,null,!0,!1);let Ue=we.length;function Fr(e){return e==null}function S(e,n,t){if(t===void 0){const u=$e.encode(e),m=n(u.length,1)>>>0;return qe().subarray(m,m+u.length).set(u),j=u.length,m}let r=e.length,i=n(r,1)>>>0;const s=qe();let c=0;for(;c<r;c++){const u=e.charCodeAt(c);if(u>127)break;s[i+c]=u}if(c!==r){c!==0&&(e=e.slice(c)),i=t(i,r,r=c+e.length*3,1)>>>0;const u=qe().subarray(i+c,i+r),m=$e.encodeInto(e,u);c+=m.written,i=t(i,r,c,1)>>>0}return j=c,i}function z(e){const n=Or(e);return Br(e),n}let Ke=new TextDecoder("utf-8",{ignoreBOM:!0,fatal:!0});Ke.decode();const Ur=2146435072;let rn=0;function $r(e,n){return rn+=n,rn>=Ur&&(Ke=new TextDecoder("utf-8",{ignoreBOM:!0,fatal:!0}),Ke.decode(),rn=n),Ke.decode(qe().subarray(e,e+n))}const $e=new TextEncoder;"encodeInto"in $e||($e.encodeInto=function(e,n){const t=$e.encode(e);return n.set(t),{read:e.length,written:t.length}});let j=0,d;function Yr(e,n){return d=e.exports,Ae=null,Fe=null,d}async function Gr(e,n){if(typeof Response=="function"&&e instanceof Response){if(!e.ok)throw new Error(`failed to fetch Wasm: ${e.status} ${e.statusText} fetching '${e.url}'`);if(typeof WebAssembly.instantiateStreaming=="function")try{return await WebAssembly.instantiateStreaming(e,n)}catch(i){if(t(e.type)&&e.headers.get("Content-Type")!=="application/wasm")console.warn("`WebAssembly.instantiateStreaming` failed because your server does not serve Wasm with `application/wasm` MIME type. Falling back to `WebAssembly.instantiate` which is slower. Original error:\n",i);else throw i}const r=await e.arrayBuffer();return await WebAssembly.instantiate(r,n)}else{const r=await WebAssembly.instantiate(e,n);return r instanceof WebAssembly.Instance?{instance:r,module:e}:r}function t(r){switch(r){case"basic":case"cors":case"default":return!0}return!1}}async function Vr(e){if(d!==void 0)return d;e!==void 0&&(Object.getPrototypeOf(e)===Object.prototype?{module_or_path:e}=e:console.warn("using deprecated parameters for the initialization function; pass a single object instead")),e===void 0&&(e=new URL("/pr-preview/pr-83/assets/nanobpmn_engine_bg-DRNrIVE8.wasm",import.meta.url));const n=Rr();(typeof e=="string"||typeof Request=="function"&&e instanceof Request||typeof URL=="function"&&e instanceof URL)&&(e=fetch(e));const{instance:t,module:r}=await Gr(await e,n);return Yr(t)}let He=null;function Qr(e){return He||(He=Vr(void 0).then(()=>{}).catch(n=>{throw He=null,n})),He}function J(e){return JSON.parse(e)}class Jr{constructor(n){O(this,"engine");this.engine=n}deploy(n){return JSON.parse(this.engine.deploy(n))}createInstance(n,t){return J(this.engine.createInstance(n,t||"{}"))}activateJobs(n,t,r,i){return JSON.parse(this.engine.activateJobs(n,t,r,i))}completeJob(n,t){return J(this.engine.completeJob(n,t||"{}"))}completeAgentJob(n,t){const{variables:r,...i}=t??{};return J(this.engine.completeAgentJob(n,JSON.stringify(r??{}),JSON.stringify(i??{})))}failJob(n,t,r){return J(this.engine.failJob(n,t,r))}throwError(n,t,r){return J(this.engine.throwError(n,t,r))}updateRetries(n,t){return J(this.engine.updateRetries(n,t))}resolveIncident(n){return J(this.engine.resolveIncident(n))}setVariables(n,t,r){return J(this.engine.setVariables(n,t||"{}",r))}broadcastSignal(n,t){return J(this.engine.broadcastSignal(n,t||"{}"))}cancelInstance(n){return J(this.engine.cancelInstance(n))}modify(n,t,r){return J(this.engine.modify(n,JSON.stringify(t??[]),JSON.stringify(r??[])))}completeUserTask(n,t){return J(this.engine.completeUserTask(n,t||"{}"))}assignUserTask(n,t,r){return J(this.engine.assignUserTask(n,t,r))}unassignUserTask(n){return J(this.engine.unassignUserTask(n))}updateUserTask(n,t){return J(this.engine.updateUserTask(n,t||"{}"))}correlateMessage(n,t,r){return J(this.engine.correlateMessage(n,t,r||"{}"))}advanceTime(n){return J(this.engine.advanceTime(n))}reset(){this.engine.reset()}events(){return JSON.parse(this.engine.events())}snapshot(){return J(this.engine.snapshot())}free(){this.engine.free()}}async function Hr(e){return await Qr(),new Jr(new mn)}class pt extends Error{constructor(t,r){super(t);O(this,"retries");this.name="JobFailure",this.retries=r==null?void 0:r.retries}}function Wr(e,n=[]){if(e.instances.filter(i=>!i.completed).length===0)return e.totalInstances>0?"completed":"idle";if(e.incidents.length>0)return"incidents";const r=new Set(n);return e.jobs.some(i=>!r.has(i.jobType))?"unhandledJobs":e.userTasks.some(i=>i.state==="Created")?"userTasks":e.timers.length>0?"timers":e.messageSubscriptions.length>0?"messages":e.signalSubscriptions.length>0?"signals":"idle"}function Zr(e,n=[]){const t=new Set(n);return[...new Set(e.jobs.map(r=>r.jobType))].filter(r=>!t.has(r)).sort()}async function qr(e,n,t){let r;try{const i=await n(t);r=JSON.stringify(i??{})}catch(i){const s=i instanceof pt&&i.retries!==void 0?i.retries:Math.max(0,t.retries-1),c=i instanceof Error?i.message:String(i);e.failJob(t.key,s,c);return}e.completeJob(t.key,r)}async function Kr(e,n,t){let r;try{r=await n(t),JSON.stringify(r)}catch(i){const s=i instanceof pt&&i.retries!==void 0?i.retries:Math.max(0,t.retries-1),c=i instanceof Error?i.message:String(i);e.failJob(t.key,s,c);return}e.completeAgentJob(t.key,r)}async function Xr(e,n,t={}){const r=t.maxJobsPerActivation??10,i=t.lockTimeoutMs??3e4,s=t.worker??"bojtos",c=t.agents??{};for(const p of Object.keys(c))if(p in n)throw new Error(`dispatchRound: job type "${p}" is registered as both a worker and an agent — register it as exactly one`);const u=[];for(const[p,y]of Object.entries(n))for(const b of e.activateJobs(p,r,i,s))u.push({handler:y,job:b});const m=[];for(const[p,y]of Object.entries(c))for(const b of e.activateJobs(p,r,i,s))m.push({handler:y,job:b});for(const{handler:p,job:y}of u)await qr(e,p,y);for(const{handler:p,job:y}of m)await Kr(e,p,y);const o=e.snapshot(),l=u.length+m.length;if(l>0)return{snapshot:o,handled:l};const g=[...Object.keys(n),...Object.keys(c)];return{snapshot:o,handled:l,reason:Wr(o,g),unhandled:Zr(o,g)}}function ei({bpmn:e}){const n=h.useRef(null),[t,r]=h.useState("loading"),[i,s]=h.useState(null),[c,u]=h.useState([]),[m,o]=h.useState(null),l=h.useRef(e),g=h.useRef(0),p=h.useRef(new Map),y=h.useCallback((I,N)=>{p.current.set(I,N)},[]),b=h.useCallback(I=>p.current.get(I),[]),_=h.useCallback((I,N)=>{const A=I.deploy(N);return l.current=N,p.current.clear(),u(A.processIds),o(null),s(null),A.processIds},[]);h.useEffect(()=>{let I=!1;return r("loading"),u([]),o(null),s(null),Hr().then(N=>{if(I){N.free();return}try{_(N,e)}catch(A){N.free(),s(String(A)),r("error");return}n.current=N,r("ready")}).catch(N=>{I||(s(String(N)),r("error"))}),()=>{var N;I=!0,(N=n.current)==null||N.free(),n.current=null,p.current.clear()}},[e]);const f=h.useCallback(I=>{const N=n.current;if(!N)return null;try{const A=I(N);return o(A),s(null),A}catch(A){return s(String(A)),null}},[]),M=h.useCallback((I,N)=>f(A=>A.createInstance(I,N)),[f]),k=h.useCallback((I,N)=>f(A=>A.completeUserTask(I,N)),[f]),L=h.useCallback(I=>f(N=>N.advanceTime(I)),[f]);function Y(I,N){const[A]=I.activateJobs(N,1,3e4,"manual-control");if(!A)throw new Error(`No waiting job of type "${N}" to resolve.`);return A}const W=h.useCallback((I,N)=>f(A=>{const K=Y(A,I);return A.completeJob(K.key,N)}),[f]),de=h.useCallback((I,N,A)=>f(K=>{const C=Y(K,I);return K.throwError(C.key,N,A)}),[f]),G=h.useCallback(async(I,N)=>{const A=n.current;if(!A)return null;const K=g.current;try{const C=await Xr(A,I,N);return n.current!==A||g.current!==K?null:(o(C.snapshot),s(null),C)}catch(C){return n.current!==A||g.current!==K||(o(A.snapshot()),s(String(C))),null}},[]),ie=h.useCallback(()=>{const I=n.current;if(I){g.current++;try{I.reset(),_(I,l.current)}catch(N){s(String(N))}}},[_]),U=h.useCallback(I=>{const N=n.current;if(!N)return null;g.current++;try{return N.reset(),_(N,I)}catch(A){return s(String(A)),null}},[_]);return{phase:t,error:i,processIds:c,snapshot:m,createInstance:M,stepWorkers:G,completeUserTask:k,advanceTime:L,completeJobManually:W,throwJobError:de,reset:ie,redeploy:U,setRunImage:y,getRunImage:b}}function ni(e,n){return e.slice(n)}function ti(e,n,t,r){const i=e.snapshot,s="⏸ waiting for a human — complete the task below to continue",c=i.userTasks.some(u=>u.state==="Created");if(e.handled>0){const u=i.activeElementIds.map(t),m=n.length?` via ${n.map(o=>`${t(o.from)} → ${t(o.to)}`).join(", ")}`:"";return i.completedInstances>=1?{kind:"done",text:`⏭ round handled ${e.handled} job${e.handled===1?"":"s"}${m} — ✅ process instance completed`}:c?{kind:"human",text:`⏭ round handled ${e.handled} job${e.handled===1?"":"s"}${m} — ${s}`}:{kind:"step",text:`⏭ round handled ${e.handled} job${e.handled===1?"":"s"}${m} — now at ${u.length?u.join(", "):"—"}`}}switch(e.reason){case"completed":return{kind:"done",text:"✅ process instance completed"};case"userTasks":return{kind:"human",text:s};case"timers":return{kind:"step",text:"⏱ waiting on a timer — advance the clock to continue"};case"messages":return{kind:"step",text:"✉ waiting on a message — correlate it to continue"};case"signals":return{kind:"step",text:"📶 waiting on a signal — broadcast it to continue"};case"incidents":return{kind:"error",text:"A job failed — incident on the diagram"};case"unhandledJobs":{const u=e.unhandled??[];return r&&u.length>0&&u.every(m=>r.has(m))?{kind:"human",text:s}:{kind:"error",text:`⏭ waiting on job type(s) with no worker registered: ${u.join(", ")}`}}case"idle":return{kind:"step",text:"Nothing to step — no instance is running."};default:return{kind:"step",text:e.reason?`Step blocked on an unrecognized reason: ${e.reason}`:"Nothing to step — no instance is running."}}}const ri="the Scripted or Endpoint brain";async function ii(){return await Ge()===null}async function Ge(e=ri){const n=navigator.gpu;if(!n)return`This browser doesn't expose WebGPU at all. Use a recent Chrome, Edge, or Safari 17+ with hardware acceleration on, or pick ${e}.`;let t;try{t=await n.requestAdapter()}catch(r){return`WebGPU adapter request failed (${r instanceof Error?r.message:String(r)}). Try ${e} instead.`}return t?null:`This browser supports the WebGPU API, but no GPU adapter is available — hardware acceleration may be off, or this device/VM has no usable GPU. Pick ${e} instead.`}const oi=[{id:"Qwen2.5-1.5B-Instruct-q4f16_1-MLC",label:"Qwen2.5 1.5B",downloadLabel:"~1.0 GB"},{id:"SmolLM2-1.7B-Instruct-q4f16_1-MLC",label:"SmolLM2 1.7B",downloadLabel:"~1.1 GB"},{id:"Llama-3.2-1B-Instruct-q4f16_1-MLC",label:"Llama 3.2 1B",downloadLabel:"~0.7 GB"},{id:"gemma-2-2b-it-q4f16_1-MLC",label:"Gemma 2 2B",downloadLabel:"~1.5 GB"},{id:"Llama-3.2-1B-Instruct-q4f32_1-MLC",label:"Llama 3.2 1B (f32, wider GPU support)",downloadLabel:"~1.1 GB"},{id:"SmolLM2-360M-Instruct-q4f32_1-MLC",label:"SmolLM2 360M (tiny, f32)",downloadLabel:"~0.6 GB"},{id:"SmolLM2-360M-Instruct-q4f16_1-MLC",label:"SmolLM2 360M (tiny)",downloadLabel:"~0.3 GB"}];function gt(e){return pn.get(e)??{}}const pn=new Map;async function ai(){if(pn.size>0)return;const{prebuiltAppConfig:e}=await le(async()=>{const{prebuiltAppConfig:n}=await import("./vendor-webllm-DT0Ab8E6.js");return{prebuiltAppConfig:n}},[]);for(const n of e.model_list)pn.set(n.model_id,{vramRequiredMB:n.vram_required_MB,requiredFeatures:n.required_features})}const en=oi.map(e=>({id:e.id,label:`${e.label} (${e.downloadLabel})`,downloadLabel:e.downloadLabel,...gt(e.id)})),ht=en[0].id;async function si(){return await ai(),en.map(e=>({...e,...gt(e.id)}))}function bt(){const e=navigator.deviceMemory;return typeof e=="number"?e*1024:null}function ci(e,n=bt()){return n==null||e.vramRequiredMB==null||n>=e.vramRequiredMB?null:`${e.label} needs roughly ${Math.round(e.vramRequiredMB)} MB of GPU memory; this device looks like it has about ${Math.round(n)} MB available. It may still work, but expect it to fail or fall back to slow shared memory — try a smaller model (e.g. SmolLM2 360M) if it doesn't load.`}async function li(e){try{const{hasModelInCache:n}=await le(async()=>{const{hasModelInCache:t}=await import("./vendor-webllm-DT0Ab8E6.js");return{hasModelInCache:t}},[]);return await n(e)}catch{return!1}}function Xe(e){return/device (was )?lost|device_hung|device_removed|already been disposed|gpudevicelostinfo/i.test(e)}function Ln(){return"The GPU device was lost — the driver reset while the model was loading or running. This is a browser/driver-level failure, not a problem with the model: fully quit and reopen the browser (a lost device usually persists for the life of the GPU process), check chrome://gpu still reports hardware acceleration, and update your GPU driver if it recurs. The Scripted and Endpoint brains don't use the GPU at all."}class We{constructor(){O(this,"kind","browser");O(this,"model",null);O(this,"engine",null);O(this,"worker",null);O(this,"generation",0);O(this,"chat",async(n,t=512,r)=>{var s,c;const i=this.engine;if(!i||!this.model)throw new Error("BrowserBrain.chat called before connect()");try{const u=await i.chat.completions.create({messages:n,temperature:0,max_tokens:t,stream:!0});let m="";for await(const o of u){const l=((c=(s=o.choices[0])==null?void 0:s.delta)==null?void 0:c.content)??"";l&&(m+=l,r==null||r(l))}return m}catch(u){const m=u instanceof Error?u.message:String(u);throw Xe(m)?(this.teardown(),new Error(`The in-browser model stopped: ${Ln()}`)):u}})}async connect(n=ht,t){var m,o;const r=await Ge();if(r)throw new Error(r);if(this.engine&&this.model===n)return n;const i=++this.generation,s=l=>{i===this.generation&&(t==null||t({progress:l.progress??0,text:l.text??""}))};this.teardown();let c,u;try{const{CreateWebWorkerMLCEngine:l}=await le(async()=>{const{CreateWebWorkerMLCEngine:g}=await import("./vendor-webllm-DT0Ab8E6.js");return{CreateWebWorkerMLCEngine:g}},[]);u=new Worker(new URL("/pr-preview/pr-83/assets/webllm.worker-Dc1cCqhL.js",import.meta.url),{type:"module"}),c=await l(u,n,{initProgressCallback:s})}catch(l){if(u==null||u.terminate(),i!==this.generation)throw new Error("cancelled");const g=l instanceof Error?l.message:String(l);if(Xe(g))throw new Error(`Couldn't load ${n} in the browser (${g}). ${Ln()}`);const p=(o=(m=en.find(y=>y.id===n))==null?void 0:m.requiredFeatures)==null?void 0:o.includes("shader-f16");throw new Error(`Couldn't load ${n} in the browser (${g}). `+(p?"This model needs WebGPU with shader-f16; try one of the f32 models in the list, or the endpoint brain.":"Try a smaller model, check your connection, or use the endpoint brain instead."))}if(i!==this.generation)throw c.unload().catch(()=>{}),u==null||u.terminate(),new Error("cancelled");return this.engine=c,this.worker=u??null,this.model=n,n}teardown(){const{engine:n,worker:t}=this;this.engine=null,this.worker=null,this.model=null,n==null||n.unload().catch(()=>{}),t==null||t.terminate()}cancelConnect(){this.generation++}dispose(){this.generation++,this.teardown()}}const ft="http://localhost:11434/v1";function yt(){var n;const e=((n=globalThis.location)==null?void 0:n.hostname)??"";return e==="localhost"||e==="127.0.0.1"||e==="[::1]"||e==="::1"}function bn(e,n={hostname:(t=>(t=globalThis.location)==null?void 0:t.hostname)()??"",origin:(r=>(r=globalThis.location)==null?void 0:r.origin)()??""}){let i;try{i=new URL(wt(e)).hostname}catch{return null}const s=c=>c==="localhost"||c==="127.0.0.1"||c==="::1"||c==="[::1]";return!s(i)||s(n.hostname)?null:`This page is served from ${n.origin||"a non-local origin"}, so it can't reach ${e}. A local model server only accepts requests from a page on localhost. Open this page at http://localhost instead, or use the Scripted or In-browser brain.`}function wt(e){let n=e.trim().replace(/\/+$/,"");return n.endsWith("/chat/completions")&&(n=n.slice(0,-17)),/\/v\d+$/.test(n)||(n=`${n}/v1`),n}class Pn extends Error{constructor(n,t){super(n),this.status=t,this.name="HttpError"}}class di{constructor(n=ft,t="",r=""){O(this,"kind","endpoint");O(this,"baseUrl");O(this,"model",null);O(this,"models",[]);O(this,"apiKey");O(this,"requestedModel");O(this,"chat",async(n,t=512,r)=>{var o,l,g;if(!this.model)throw new Error("EndpointBrain.chat called before connect()");const i=await fetch(`${this.baseUrl}/chat/completions`,{method:"POST",headers:this.headers(),body:JSON.stringify({model:this.model,messages:n,temperature:0,max_tokens:t,stream:!0})});if(!i.ok||!i.body){const p=await i.text().catch(()=>"");throw new Error(`chat/completions HTTP ${i.status} ${i.statusText}${p?` — ${p.slice(0,300)}`:""}`)}const s=i.body.getReader(),c=new TextDecoder;let u="",m="";for(;;){const{value:p,done:y}=await s.read();if(y)break;u+=c.decode(p,{stream:!0});let b;for(;(b=u.indexOf(`
`))>=0;){const _=u.slice(0,b).trim();if(u=u.slice(b+1),!_.startsWith("data:"))continue;const f=_.slice(5).trim();if(f==="[DONE]")continue;let M;try{M=JSON.parse(f)}catch{continue}M.model&&(this.model=M.model);const k=(o=M.choices)==null?void 0:o[0],L=((l=k==null?void 0:k.delta)==null?void 0:l.content)??((g=k==null?void 0:k.message)==null?void 0:g.content)??"";L&&(m+=L,r==null||r(L))}}return m});this.baseUrl=wt(n),this.apiKey=t.trim(),this.requestedModel=r.trim()}headers(){const n={"Content-Type":"application/json"};return this.apiKey&&(n.Authorization=`Bearer ${this.apiKey}`),n}async listModels(){let n;try{n=await fetch(`${this.baseUrl}/models`,{headers:this.headers()})}catch(r){const i=bn(this.baseUrl);throw new Error(i??`Can't reach ${this.baseUrl} (${r instanceof Error?r.message:String(r)}). Is the server running? For Ollama, check the app is up — and if this page is served from another origin, allow it with OLLAMA_ORIGINS.`)}if(!n.ok)throw new Pn(`${this.baseUrl}/models returned HTTP ${n.status} ${n.statusText}`,n.status);const t=await n.json();return this.models=(t.data??[]).map(r=>r.id).filter(r=>!!r),this.models}async connect(){try{const n=await this.listModels(),t=this.requestedModel||n[0];if(!t)throw new Error(`No models available at ${this.baseUrl}. Pull one first — e.g. \`ollama pull llama3.2:3b\` — or name one explicitly.`);this.model=t}catch(n){const t=n instanceof Pn&&[404,405,501].includes(n.status);if(!this.requestedModel||!t)throw n;this.models=[],this.model=this.requestedModel}return await this.validate(),this.model}async validate(){const n=await fetch(`${this.baseUrl}/chat/completions`,{method:"POST",headers:this.headers(),body:JSON.stringify({model:this.model,messages:[{role:"user",content:"Reply with ok."}],temperature:0,max_tokens:1,stream:!1})}).catch(r=>{throw new Error(`Can't reach ${this.baseUrl}/chat/completions (${r instanceof Error?r.message:String(r)}). Check the endpoint URL, API key, model name, and any local CORS settings.`)});if(!n.ok){const r=await n.text().catch(()=>"");throw new Error(`chat/completions HTTP ${n.status} ${n.statusText}${r?` — ${r.slice(0,300)}`:""}`)}const t=await n.json().catch(()=>({}));t.model&&(this.model=t.model)}dispose(){}}const ui=[{id:"onnx-community/Florence-2-base-ft",label:"Florence-2 base",downloadLabel:"~0.4 GB"},{id:"onnx-community/Florence-2-large-ft",label:"Florence-2 large (higher quality)",downloadLabel:"~1.6 GB"}],_t=ui.map(e=>({...e,label:`${e.label} (${e.downloadLabel})`})),Mt=_t[0].id,mi="<OCR>",Rn="UNKNOWN (scripted brain — connect the in-browser model to read a photo)";function pi(e,n){if(e)return typeof e=="function"?e(n):e[n]}class gi{constructor(n){O(this,"kind","scripted-vision");O(this,"model",null);O(this,"read",async(n,t,r)=>{const i=typeof n=="string"?pi(this.lookup,n)??Rn:Rn;return r==null||r(i),i});this.lookup=n}dispose(){}}function hi(e){return new gi(e)}class zn{constructor(){O(this,"kind","browser-vision");O(this,"model",null);O(this,"modelHandle",null);O(this,"processor",null);O(this,"loadImage",null);O(this,"generation",0);O(this,"read",async(n,t,r)=>{const i=this.modelHandle,s=this.processor,c=this.loadImage;if(!i||!s||!c||!this.model)throw new Error("BrowserVisionBrain.read called before connect()");const u=t&&t.startsWith("<")?t:mi,m=await c(n),o=s.construct_prompts(u),l=await s(m,o),g=await i.generate({...l,max_new_tokens:512,num_beams:1,do_sample:!1}),p=s.batch_decode(g,{skip_special_tokens:!1})[0],y=s.post_process_generation(p,u,m.size),b=bi(y,u);return r==null||r(b),b})}async connect(n=Mt,t){var u,m;const r=await Ge("the scripted-vision fallback");if(r)throw new Error(r);if(this.modelHandle&&this.model===n)return n;const i=++this.generation,s=o=>{i===this.generation&&(t==null||t({progress:(o.progress??0)/100,text:o.file?`${o.status??"loading"} ${o.file}`:o.status??""}))};this.teardown();let c;try{const{Florence2ForConditionalGeneration:o,AutoProcessor:l,load_image:g}=await le(async()=>{const{Florence2ForConditionalGeneration:b,AutoProcessor:_,load_image:f}=await import("./transformers.web-B28Uxsgd.js");return{Florence2ForConditionalGeneration:b,AutoProcessor:_,load_image:f}},[]),p=await o.from_pretrained(n,{dtype:"fp32",device:"webgpu",progress_callback:s}),y=await l.from_pretrained(n);c={model:p,processor:y,loadImage:g}}catch(o){if(i!==this.generation)throw new Error("cancelled");const l=o instanceof Error?o.message:String(o);throw new Error(`Couldn't load ${n} in the browser (${l}). Try the smaller Florence-2 base model, check your connection, or use the scripted-vision fallback.`)}if(i!==this.generation)throw Promise.resolve((m=(u=c.model).dispose)==null?void 0:m.call(u)).catch(()=>{}),new Error("cancelled");return this.modelHandle=c.model,this.processor=c.processor,this.loadImage=c.loadImage,this.model=n,n}teardown(){var t;const n=this.modelHandle;this.modelHandle=null,this.processor=null,this.loadImage=null,this.model=null,Promise.resolve((t=n==null?void 0:n.dispose)==null?void 0:t.call(n)).catch(()=>{})}cancelConnect(){this.generation++}dispose(){this.generation++,this.teardown()}}function bi(e,n){const t=e[n];if(typeof t=="string")return t.trim();if(t&&typeof t=="object"){const r=t.labels;return Array.isArray(r)?r.join(" ").trim():JSON.stringify(t)}return""}async function fi(){return await ii()?"browser":yt()?"endpoint":"scripted"}function yi(){const[e,n]=h.useState("scripted"),t=h.useRef(!1),[r,i]=h.useState("idle"),[s,c]=h.useState(null),[u,m]=h.useState(null),[o,l]=h.useState(null),[g,p]=h.useState(null),[y,b]=h.useState(null),[_,f]=h.useState(null),[M,k]=h.useState(ht),[L,Y]=h.useState(ft),[W,de]=h.useState(""),[G,ie]=h.useState(""),[U,I]=h.useState(null),N=h.useRef(null),[A,K]=h.useState("scripted-vision"),[C,Z]=h.useState("idle"),[be,Me]=h.useState(null),[ze,ke]=h.useState(Mt),[Ce,ve]=h.useState(null),[nn,Ee]=h.useState(null),[Be,oe]=h.useState(null),[Te,je]=h.useState(null),q=h.useRef(null),xe=h.useRef(!1),Ne=h.useCallback(E=>async(...D)=>{try{return await E.chat(...D)}catch(F){const Ie=F instanceof Error?F.message:String(F);throw E instanceof We&&Xe(Ie)&&(I(null),m(null),i("error"),c(Ie)),F}},[]),De=h.useCallback(E=>async(...D)=>{try{return await E.read(...D)}catch(F){const Ie=F instanceof Error?F.message:String(F);throw Xe(Ie)&&(je(null),ve(null),Z("error"),Me(Ie)),F}},[]);h.useEffect(()=>{Ge().then(E=>{b(E),p(E===null),t.current||(t.current=!0,fi().then(n))}),Ge("the scripted-vision fallback").then(E=>{oe(E),xe.current||(xe.current=!0,K(E===null?"browser-vision":"scripted-vision"))})},[]),h.useEffect(()=>{let E=!1;return f(null),li(M).then(D=>{E||f(D)}),()=>{E=!0}},[M]),h.useEffect(()=>()=>{var E;return(E=N.current)==null?void 0:E.dispose()},[]),h.useEffect(()=>()=>{var E;return(E=q.current)==null?void 0:E.dispose()},[]);const $=h.useCallback(E=>{n(E),i("idle"),c(null),m(null),l(null),I(null)},[]),ge=h.useCallback(E=>{var D,F;xe.current=!0,(D=q.current)==null||D.cancelConnect(),(F=q.current)==null||F.dispose(),q.current=null,K(E),Z("idle"),Me(null),ve(null),Ee(null),je(null)},[]),ue=h.useCallback(()=>{var E;(E=N.current)==null||E.dispose(),N.current=null,I(null),m(null)},[]),fe=h.useCallback(()=>{N.current instanceof We&&N.current.cancelConnect(),ue(),i("idle"),l(null),c(null)},[ue]),Ve=h.useCallback(async()=>{var E;if(e==="scripted"){I(null),i("ready");return}if(e==="endpoint"){const D=bn(L);if(D){ue(),c(D),i("error");return}}i("connecting"),c(null),l(null);try{if(e==="browser"){const D=N.current instanceof We?N.current:new We;N.current&&N.current!==D&&N.current.dispose(),N.current=D;const F=await D.connect(M,l);m(F),I(()=>Ne(D)),f(!0)}else{(E=N.current)==null||E.dispose();const D=new di(L,G,W);N.current=D;const F=await D.connect();m(F),I(()=>Ne(D))}i("ready")}catch(D){const F=D instanceof Error?D.message:String(D);if(F==="cancelled")return;c(F),i("error"),I(null)}finally{l(null)}},[e,M,L,W,G,ue,Ne]),X=h.useCallback(()=>{var E;(E=q.current)==null||E.dispose(),q.current=null,je(null),ve(null)},[]),Le=h.useCallback(()=>{var E;(E=q.current)==null||E.cancelConnect(),X(),Z("idle"),Ee(null),Me(null)},[X]),Pe=h.useCallback(async()=>{if(A==="scripted-vision"){X(),Z("ready"),Me(null);return}Z("connecting"),Me(null),Ee(null);try{const E=q.current instanceof zn?q.current:new zn;q.current&&q.current!==E&&q.current.dispose(),q.current=E;const D=await E.connect(ze,Ee);ve(D),je(()=>De(E)),Z("ready")}catch(E){const D=E instanceof Error?E.message:String(E);if(D==="cancelled")return;Me(D),Z("error"),je(null),ve(null)}finally{Ee(null)}},[A,ze,X,De]);return{kind:e,setKind:$,status:r,error:s,modelInUse:u,progress:o,webgpu:g,webgpuReason:y,browserModelCached:_,cancelConnect:fe,browserModel:M,setBrowserModel:k,endpointUrl:L,setEndpointUrl:Y,endpointModel:W,setEndpointModel:de,apiKey:G,setApiKey:ie,connect:Ve,chat:U,visionKind:A,setVisionKind:ge,visionStatus:C,visionError:be,visionModel:ze,setVisionModel:ke,visionModelInUse:Ce,visionProgress:nn,visionWebgpuReason:Be,connectVision:Pe,cancelVisionConnect:Le,vision:Te}}const gn="#s=",wi=["scripted","browser","endpoint"];function _i(e){return typeof e=="string"&&wi.includes(e)}function Mi(e){try{const n=JSON.parse(e);if(n&&typeof n=="object"){const t=n,r={};return _i(t.brain)&&(r.brain=t.brain),r}}catch{}return{}}function vt(e=location.hash){if(!e.startsWith(gn))return{};let n;try{n=decodeURIComponent(e.slice(gn.length))}catch{return{}}return Mi(n)}function vi(e){const n=Object.entries(e).filter(([,t])=>t!==void 0);return n.length===0?"":gn+encodeURIComponent(JSON.stringify(Object.fromEntries(n)))}function xi(e){const n={...vt(),...e},t=vi(n),r=new URL(location.href);r.hash=t,history.replaceState(history.state,"",r)}const Bn=[{kind:"scripted",label:"Scripted",hint:"No model. The example's stand-in decides — deterministic and offline."},{kind:"browser",label:"In-browser (WebGPU)",hint:"A small quantised model on your GPU. First run downloads weights."},{kind:"endpoint",label:"API endpoint",hint:"Any OpenAI-compatible server. Ollama by default. Local pages only."}],On=[{kind:"scripted-vision",label:"Scripted",hint:"No model. The example's known plate is returned — deterministic and offline."},{kind:"browser-vision",label:"In-browser (WebGPU)",hint:"Reads the photo with a vision model on your GPU. First run downloads weights."}];function Ni({brain:e,showText:n=!0,showVision:t=!1}){return a.jsxs("div",{className:"brain",children:[n&&a.jsx(Ii,{brain:e}),n&&t&&a.jsx("hr",{className:"brain-divider"}),t&&a.jsx(ki,{brain:e})]})}function Ii({brain:e}){const n=Bn.find(o=>o.kind===e.kind),t=bn(e.endpointUrl),r=yt(),[i,s]=h.useState(en);h.useEffect(()=>{si().then(s)},[]);const c=i.find(o=>o.id===e.browserModel),u=c?ci(c,bt()):null,m=e.webgpu===!0?"browser":r&&e.webgpu===!1?"endpoint":null;return a.jsxs("div",{className:"brain-section",children:[a.jsxs("div",{className:"brain-kinds",children:[Bn.map(o=>a.jsxs(H,{size:"sm",variant:e.kind===o.kind?"default":"secondary",onClick:()=>e.setKind(o.kind),children:[o.label,o.kind===m&&a.jsx(Q,{variant:"info",className:"brain-recommended-badge",children:"recommended"})]},o.kind)),e.status==="ready"&&e.kind!=="scripted"&&a.jsx(Q,{variant:"success",children:e.modelInUse??"connected"}),e.status==="connecting"&&a.jsx(Q,{variant:"info",children:"connecting…"}),e.status==="error"&&a.jsx(Q,{variant:"danger",children:"not connected"})]}),a.jsx("p",{className:"field-hint",children:n.hint}),e.kind==="browser"&&a.jsxs("div",{className:"brain-config",children:[a.jsxs("div",{className:"field",children:[a.jsx(Re,{htmlFor:"browser-model",children:"Model"}),a.jsxs(Xn,{value:e.browserModel,onValueChange:e.setBrowserModel,disabled:e.status==="connecting",children:[a.jsx(et,{id:"browser-model",children:a.jsx(nt,{})}),a.jsx(tt,{children:i.map(o=>a.jsx(rt,{value:o.id,children:o.label},o.id))})]}),e.browserModelCached===!0&&a.jsx("p",{className:"field-hint",children:"Already downloaded in this browser — connecting will be fast."}),e.browserModelCached===!1&&a.jsx("p",{className:"field-hint",children:"Not downloaded yet — connecting fetches the weights once, then caches them for next time."})]}),e.webgpu===!1&&e.webgpuReason&&a.jsxs(ae,{variant:"destructive",children:[a.jsx(se,{children:"No WebGPU in this browser"}),a.jsx(ce,{children:e.webgpuReason})]}),e.webgpu!==!1&&u&&a.jsxs(ae,{variant:"destructive",children:[a.jsx(se,{children:"This model may not fit in GPU memory"}),a.jsx(ce,{children:u})]})]}),e.kind==="endpoint"&&a.jsxs("div",{className:"brain-config",children:[a.jsxs("div",{className:"field",children:[a.jsx(Re,{htmlFor:"endpoint-url",children:"Endpoint"}),a.jsx(tn,{id:"endpoint-url",value:e.endpointUrl,onChange:o=>e.setEndpointUrl(o.target.value),disabled:e.status==="connecting"}),a.jsxs("p",{className:"field-hint",children:["Ollama allows ",a.jsx("code",{children:"localhost"})," origins out of the box; set"," ",a.jsx("code",{children:"OLLAMA_ORIGINS"})," only when serving this page from another host. Best for local development — a hosted copy of this page can't reach a server on your machine at all."]}),t&&a.jsxs(ae,{variant:"destructive",children:[a.jsx(se,{children:"A local server won't work from this URL"}),a.jsx(ce,{children:t})]})]}),a.jsxs("div",{className:"field",children:[a.jsx(Re,{htmlFor:"endpoint-model",children:"Model (blank = first served)"}),a.jsx(tn,{id:"endpoint-model",placeholder:"llama3.2:3b",value:e.endpointModel,onChange:o=>e.setEndpointModel(o.target.value),disabled:e.status==="connecting"})]}),a.jsxs("div",{className:"field",children:[a.jsx(Re,{htmlFor:"endpoint-key",children:"API key (optional)"}),a.jsx(tn,{id:"endpoint-key",type:"password",value:e.apiKey,onChange:o=>e.setApiKey(o.target.value),disabled:e.status==="connecting"})]})]}),e.kind!=="scripted"&&a.jsxs("div",{className:"brain-actions",children:[a.jsx(H,{size:"sm",onClick:()=>void e.connect(),disabled:e.status==="connecting",children:e.status==="ready"?"Reconnect":"Connect"}),e.status==="connecting"&&e.kind==="browser"&&a.jsx(H,{size:"sm",variant:"secondary",onClick:e.cancelConnect,children:"Cancel"}),e.progress&&a.jsxs("span",{className:"field-hint",children:[Math.round(e.progress.progress*100),"% —"," ",e.progress.text]})]}),e.error&&a.jsxs(ae,{variant:"destructive",children:[a.jsx(se,{children:"Couldn't connect"}),a.jsx(ce,{children:e.error})]})]})}function ki({brain:e}){const n=On.find(r=>r.kind===e.visionKind),t=e.webgpu===!0?"browser-vision":null;return a.jsxs("div",{className:"brain-section brain-vision",children:[a.jsx(Re,{children:"Vision (reads the image)"}),a.jsxs("div",{className:"brain-kinds",children:[On.map(r=>a.jsxs(H,{size:"sm",variant:e.visionKind===r.kind?"default":"secondary",onClick:()=>e.setVisionKind(r.kind),children:[r.label,r.kind===t&&a.jsx(Q,{variant:"info",className:"brain-recommended-badge",children:"recommended"})]},r.kind)),e.visionStatus==="ready"&&e.visionKind==="browser-vision"&&a.jsx(Q,{variant:"success",children:e.visionModelInUse??"connected"}),e.visionStatus==="connecting"&&a.jsx(Q,{variant:"info",children:"connecting…"}),e.visionStatus==="error"&&a.jsx(Q,{variant:"danger",children:"not connected"})]}),a.jsx("p",{className:"field-hint",children:n.hint}),e.visionKind==="scripted-vision"&&e.webgpu===!1&&e.visionWebgpuReason&&a.jsxs(ae,{variant:"destructive",children:[a.jsx(se,{children:"No WebGPU in this browser"}),a.jsx(ce,{children:e.visionWebgpuReason})]}),e.visionKind==="browser-vision"&&a.jsxs("div",{className:"brain-config",children:[a.jsxs("div",{className:"field",children:[a.jsx(Re,{htmlFor:"vision-model",children:"Model"}),a.jsxs(Xn,{value:e.visionModel,onValueChange:e.setVisionModel,disabled:e.visionStatus==="connecting",children:[a.jsx(et,{id:"vision-model",children:a.jsx(nt,{})}),a.jsx(tt,{children:_t.map(r=>a.jsx(rt,{value:r.id,children:r.label},r.id))})]}),a.jsx("p",{className:"field-hint",children:"Connecting downloads the weights once (size shown above), then caches them — every token is read on your GPU, no server."})]}),e.webgpu===!1&&e.visionWebgpuReason&&a.jsxs(ae,{variant:"destructive",children:[a.jsx(se,{children:"No WebGPU in this browser"}),a.jsx(ce,{children:e.visionWebgpuReason})]})]}),e.visionKind==="browser-vision"&&a.jsxs("div",{className:"brain-actions",children:[a.jsx(H,{size:"sm",onClick:()=>void e.connectVision(),disabled:e.visionStatus==="connecting",children:e.visionStatus==="ready"?"Reconnect":"Connect"}),e.visionStatus==="connecting"&&a.jsx(H,{size:"sm",variant:"secondary",onClick:e.cancelVisionConnect,children:"Cancel"}),e.visionProgress&&a.jsxs("span",{className:"field-hint",children:[Math.round(e.visionProgress.progress*100),"% —"," ",e.visionProgress.text]})]}),e.visionError&&a.jsxs(ae,{variant:"destructive",children:[a.jsx(se,{children:"Couldn't connect the vision brain"}),a.jsx(ce,{children:e.visionError})]})]})}function Ei({imageInput:e,value:n,onSelect:t,disabled:r=!1}){const[i,s]=h.useState(null),[c,u]=h.useState(!1),m=h.useRef(null),o=h.useId(),l=h.useId(),g=h.useCallback(b=>{s(URL.createObjectURL(b)),t({imageName:b.name,pixels:b})},[t]);h.useEffect(()=>{if(i)return()=>URL.revokeObjectURL(i)},[i]);const p=h.useCallback(b=>{const _=b==null?void 0:b[0];_&&_.type.startsWith("image/")&&g(_)},[g]),y=(n==null?void 0:n.imageId)!=null?e.seedImages.find(b=>b.id===n.imageId):void 0;return a.jsxs("div",{className:"image-input",children:[e.label&&a.jsx("p",{className:"field-hint",children:e.label}),a.jsx("p",{className:"image-input-label",id:o,children:"Seed photos"}),a.jsx("div",{className:"image-gallery",role:"group","aria-labelledby":o,children:e.seedImages.map(b=>{const _=(n==null?void 0:n.imageId)===b.id;return a.jsxs("button",{type:"button","aria-pressed":_,className:`image-thumb${_?" image-thumb--selected":""}`,disabled:r,title:b.label??b.id,onClick:()=>{s(null),m.current&&(m.current.value=""),t({imageId:b.id,pixels:b.file})},children:[a.jsx("img",{src:b.thumb??b.file,alt:b.label??b.id}),b.label&&a.jsx("span",{children:b.label})]},b.id)})}),a.jsx("label",{className:"image-input-label",htmlFor:l,children:"Or upload your own photo"}),a.jsxs("div",{className:`image-drop${c?" image-drop--over":""}`,onDragOver:b=>{b.preventDefault(),r||u(!0)},onDragLeave:()=>u(!1),onDrop:b=>{b.preventDefault(),u(!1),r||p(b.dataTransfer.files)},children:[a.jsx("input",{ref:m,id:l,type:"file",accept:"image/*",disabled:r,onChange:b=>p(b.target.files)}),a.jsx("p",{className:"field-hint",children:"Drag a photo here, or pick one. Uploading a photo the model has never seen is the proof this runs for real — nothing leaves your browser."})]}),(i||y)&&a.jsxs("div",{className:"image-preview",children:[a.jsx("img",{src:i??(y==null?void 0:y.file),alt:i?(n==null?void 0:n.imageName)??"uploaded photo":(y==null?void 0:y.label)??(y==null?void 0:y.id)??"selected photo"}),a.jsx("span",{className:"field-hint",children:i?`Uploaded: ${(n==null?void 0:n.imageName)??"your photo"}`:`Selected: ${(y==null?void 0:y.label)??(y==null?void 0:y.id)}`}),a.jsx("button",{type:"button",className:"image-clear-btn",disabled:r,onClick:()=>{s(null),m.current&&(m.current.value=""),t(null)},children:"Clear"})]})]})}function xt(e){return typeof e=="object"&&e!==null}function fs(e){const n=new Set,t=r=>{xt(r)&&(typeof r.key=="string"&&n.add(r.key),Array.isArray(r.components)&&r.components.forEach(t))};return t(e),n}function Ti(e){const n={},t=r=>{xt(r)&&(typeof r.key=="string"&&"defaultValue"in r&&(n[r.key]=r.defaultValue??""),Array.isArray(r.components)&&r.components.forEach(t))};return t(e),n}const ji="wdf:section:";function Nt(e){return ji+e}function Fn(e){try{const n=window.localStorage.getItem(Nt(e));return n==="1"?!0:n==="0"?!1:void 0}catch{return}}function Si(e,n){try{window.localStorage.setItem(Nt(e),n?"1":"0")}catch{}}function Ai(e,n=!0){const[t,r]=h.useState(()=>Fn(e)??n);h.useEffect(()=>{r(Fn(e)??n)},[e,n]);const i=h.useCallback(s=>{r(s),Si(e,s)},[e]);return[t,i]}function ye({sectionId:e,title:n,description:t,defaultOpen:r=!0,className:i,children:s,...c}){const[u,m]=Ai(e,r);return a.jsx(Rt,{className:["panel",i].filter(Boolean).join(" "),"data-tour":c["data-tour"],children:a.jsxs(zt,{open:u,onOpenChange:m,children:[a.jsxs(Bt,{className:"panel-trigger",children:[a.jsxs("span",{className:"panel-trigger-text",children:[a.jsx("span",{className:"panel-title",children:n}),t!=null&&a.jsx("span",{className:"panel-desc",children:t})]}),a.jsx(Ot,{className:"panel-chevron","aria-hidden":!0})]}),a.jsx(Ft,{children:a.jsx(Ut,{children:s})})]})})}function Ci(e){return e.entries!==void 0}function Di(e){const n=[];let t=null;for(const r of e)r.turn!==void 0?t&&t.turn===r.turn?t.entries.push(r):(t={turn:r.turn,entries:[r]},n.push(t)):(t=null,n.push(r));return n}function Un(e){if(e===void 0)return"undefined";try{return JSON.stringify(e)}catch{return"[unserializable value]"}}function Li({activation:e,result:n,labelFor:t}){const r=e.elementId??"";return a.jsxs("div",{className:"timeline-tool",children:[a.jsxs("div",{className:"timeline-tool-head",children:[a.jsx(Q,{variant:"info",children:"tool"}),a.jsx("strong",{children:t(r)||r}),a.jsx("code",{children:r})]}),e.args!==void 0&&Object.keys(e.args).length>0&&a.jsxs("div",{className:"timeline-kv",children:[a.jsx("span",{className:"timeline-kv-label",children:"arguments"}),a.jsx("code",{children:Un(e.args)})]}),a.jsxs("div",{className:"timeline-kv",children:[a.jsx("span",{className:"timeline-kv-label",children:"returned"}),a.jsx("code",{children:n?Un(n.result):"— waiting for the job to complete —"})]})]})}function Pi({group:e,labelFor:n}){const t=e.entries.find(o=>o.kind==="llm"),r=e.entries.filter(o=>o.kind==="agent"&&o.elementId),i=e.entries.filter(o=>o.kind==="vars"&&o.elementId),s=e.entries.filter(o=>o.kind==="agent"&&!o.elementId),c=e.entries.filter(o=>o.kind==="error"),u=new Set(r.map(o=>o.elementId)),m=e.entries.filter(o=>o.kind==="tool"||o.kind==="vars"&&o.elementId&&!u.has(o.elementId)).sort((o,l)=>o.id-l.id);return a.jsxs("div",{className:"timeline-turn",children:[a.jsxs("div",{className:"timeline-turn-head",children:[a.jsxs(Q,{variant:t!=null&&t.pending?"warning":"neutral",children:["Turn ",e.turn]}),(t==null?void 0:t.pending)&&a.jsx("span",{className:"timeline-pending",children:"thinking…"})]}),t&&a.jsx("blockquote",{className:"timeline-reply",children:t.text}),s.map(o=>a.jsx("div",{className:"timeline-note",children:o.text},o.id)),r.map(o=>a.jsx(Li,{activation:o,result:i.find(l=>l.elementId===o.elementId),labelFor:n},o.id)),m.map(o=>a.jsxs("div",{className:`log-line log-${o.kind}`,children:[o.pending?"⏳ ":"",o.text]},o.id)),c.map(o=>a.jsxs("div",{className:"timeline-error",children:["⚠ ",o.text]},o.id))]})}function Ri({log:e,elementStats:n=[],incidents:t=[],labelFor:r=i=>i}){const i=h.useMemo(()=>Di(e),[e]),[s,c]=h.useState(!1),u=h.useRef(null);h.useEffect(()=>{const o=u.current;o&&(o.scrollTop=o.scrollHeight)},[i]);const m=()=>{var g;const o={log:e.map(({id:p,...y})=>y),elementStats:n,incidents:t},l=JSON.stringify(o,null,2);(g=navigator.clipboard)!=null&&g.writeText&&navigator.clipboard.writeText(l).then(()=>{c(!0),setTimeout(()=>c(!1),1500)}).catch(()=>{})};return a.jsxs(ye,{sectionId:"activity",className:"grow",title:"Activity",description:"Agent turns, model replies, and tool calls — read top to bottom as a story.",children:[a.jsx("div",{className:"timeline-toolbar",children:a.jsx(H,{variant:"secondary",size:"sm",onClick:m,children:s?"Copied!":"Copy run as JSON"})}),a.jsx("div",{className:"timeline",ref:u,children:i.length===0?a.jsx("div",{className:"log-empty",children:"Press Run or Step to start."}):i.map(o=>Ci(o)?a.jsx(Pi,{group:o,labelFor:r},`turn-${o.turn}-${o.entries[0].id}`):a.jsxs("div",{className:`log-line log-${o.kind}`,children:[o.pending?"⏳ ":"",o.text]},o.id))}),(n.length>0||t.length>0)&&a.jsxs("div",{className:"timeline-engine-view",children:[n.length>0&&a.jsxs("div",{className:"timeline-stats",children:[a.jsx("span",{className:"timeline-kv-label",children:"Element completion"}),a.jsx("ul",{children:n.filter(o=>o.completed>0||(o.active??0)>0).map(o=>a.jsxs("li",{children:[a.jsx("code",{children:r(o.elementId)||o.elementId})," ","completed ",o.completed,o.active?`, ${o.active} active`:""]},o.elementId))})]}),t.length>0&&a.jsxs("div",{className:"timeline-incidents",children:[a.jsx("span",{className:"timeline-kv-label",children:"Incidents"}),a.jsx("ul",{children:t.map((o,l)=>a.jsxs("li",{children:[a.jsx("code",{children:r(o.elementId)||o.elementId})," —"," ",o.reason]},`${o.elementId}-${l}`))})]})]})]})}const he={diagram:"diagram",runButton:"run-button",variablesPanel:"variables-panel",codePanel:"code-panel",brainPanel:"brain-panel"};function $n(e){return`[data-tour="${e}"]`}function zi(e=location.search){return new URLSearchParams(e).get("tour")}function Bi(e,n){var t;return((t=e.elementStats.find(r=>r.elementId===n))==null?void 0:t.completed)??0}function Oi(e,n){return!e||e.kind==="click"||!n?!1:e.kind==="activeElement"?n.activeElementIds.includes(e.elementId):Bi(n,e.elementId)>=(e.atLeast??1)}function Fi(e){return"anchor"in e?$n(e.anchor):`${$n(he.diagram)} [data-element-id="${Ui(e.elementId)}"]`}function Ui(e){return typeof CSS<"u"&&typeof CSS.escape=="function"?CSS.escape(e):e.replace(/[^a-zA-Z0-9_-]/g,n=>`\\${n}`)}function $i(e){return e.map(n=>{const t=!!n.waitFor&&n.waitFor.kind!=="click";return{element:Fi(n.target),popover:{title:n.title,description:t?`${n.description} (continues automatically once you reach that point — or use Next to skip ahead)`:n.description,showButtons:["next","previous","close"]},disableActiveInteraction:!1,skipMissingElement:n.skipMissingElement??!0}})}async function Yi(e,n={}){var s;const[{driver:t}]=await Promise.all([le(()=>import("./driver.js-bj_ppY-Q.js"),[]),le(()=>Promise.resolve({}),__vite__mapDeps([0]))]),r=$i(e),i=t({steps:r,showProgress:!0,allowClose:!0,skipMissingElement:!0,onHighlighted:(c,u,{index:m})=>{var o;m!==void 0&&((o=n.onIndexChange)==null||o.call(n,m))},onDestroyed:()=>{var c;(c=n.onDestroyed)==null||c.call(n)}});return i.drive(),(s=n.onIndexChange)==null||s.call(n,i.getActiveIndex()??0),{moveNext:()=>i.moveNext(),activeIndex:()=>i.getActiveIndex()??-1,destroy:()=>i.destroy()}}const Gi=300;function Vi(e,n){const[t,r]=h.useState(!1),i=h.useRef(null),s=h.useRef(0),c=h.useRef(-1),u=h.useRef(null),m=h.useRef(n);h.useEffect(()=>{m.current=n},[n]);const o=h.useCallback(()=>{u.current!==null&&(clearInterval(u.current),u.current=null)},[]),l=h.useRef(0),g=h.useCallback(()=>{var y;l.current+=1,o(),(y=i.current)==null||y.destroy(),i.current=null,r(!1)},[o]),p=h.useCallback(()=>{if(!e||e.steps.length===0||i.current)return;const y=l.current+=1;Yi(e.steps,{onIndexChange:b=>{s.current=b},onDestroyed:()=>{o(),i.current=null,r(!1)}}).then(b=>{if(y!==l.current){b.destroy();return}i.current=b,r(!0),u.current=setInterval(()=>{const _=s.current;if(_===c.current)return;const f=e.steps[_];f&&Oi(f.waitFor,m.current())&&(c.current=_,b.moveNext())},Gi)})},[e,o]);return h.useEffect(()=>g,[g]),{active:t,start:p,stop:g}}const on=650,an="__agent__",Yn="__model__",Gn="__template__:",Qi=h.lazy(async()=>{await Promise.all([le(()=>Promise.resolve({}),__vite__mapDeps([1])),le(()=>Promise.resolve({}),__vite__mapDeps([2]))]);const{RuntimeDiagram:e}=await le(async()=>{const{RuntimeDiagram:n}=await import("./RuntimeDiagram-B2IYfHo7.js");return{RuntimeDiagram:n}},__vite__mapDeps([3,4,5]));return{default:e}}),sn=h.lazy(()=>le(()=>import("./MonacoEditor-fJke69d6.js").then(e=>e.M),__vite__mapDeps([6,4,7]))),Ji=h.lazy(()=>le(()=>import("./vendor-modeler-CrQzfmmj.js"),__vite__mapDeps([8,4,5,9,10,11,12,1,2]))),Vn=h.lazy(async()=>{const{FormRenderer:e}=await le(async()=>{const{FormRenderer:n}=await import("./FormRenderer-BL5pJ1tD.js");return{FormRenderer:n}},__vite__mapDeps([13,4,11,9,10,14]));return{default:e}});function cn(e,n){try{return JSON.stringify(e??{},null,n)}catch{return"[unserializable value]"}}function Hi({example:e,initialBrainKind:n,initialTourId:t}){var yn,wn,_n,Mn,vn,xn,Nn,In;const[r,i]=h.useState(e.bpmn),s=yi(),[c,u]=h.useState(null);h.useEffect(()=>{n&&n!==s.kind&&s.setKind(n)},[]),h.useEffect(()=>{xi({brain:s.kind})},[s.kind]);const[m,o]=h.useState(()=>Object.fromEntries(e.handlers.map(v=>[v.elementId,v.source]))),[l,g]=h.useState(e.scriptedAgent??""),[p,y]=h.useState(()=>Ye(e.templates)),b=h.useMemo(()=>kr(e,m,r,p),[e,m,r,p]),_=b.model,f=ei({bpmn:b.resolvedBpmn}),M=Vi(e.tour,()=>f.snapshot);h.useEffect(()=>{var v;t&&((v=e.tour)==null?void 0:v.id)===t&&M.start()},[]);const k=_.startFormId?((yn=e.forms)==null?void 0:yn[_.startFormId])??null:null,[L,Y]=h.useState(()=>({...e.seed,...k?Ti(k):{}})),[W,de]=h.useState(_.agent?an:((wn=e.handlers[0])==null?void 0:wn.elementId)??""),[G,ie]=h.useState(!1),[U,I]=h.useState(!1),[N,A]=h.useState(null),[K,C]=h.useState([]),[Z,be]=h.useState({}),[Me,ze]=h.useState(!1),ke=h.useRef(null),[Ce,ve]=h.useState({}),[nn,Ee]=h.useState(!1),Be=h.useRef(null),oe=h.useRef(!1),Te=h.useRef(0),je=h.useRef(0),q=h.useRef({current:void 0}),xe=h.useRef({}),Ne=h.useRef({}),De=h.useMemo(()=>{const v=new Map;for(const x of _.processes){for(const T of x.tasks)v.set(T.elementId,T.label);for(const T of x.agents){v.set(T.elementId,T.label);for(const P of T.tools)v.set(P.elementId,P.label)}for(const T of x.userTasks)v.set(T.elementId,T.label)}return x=>v.get(x)??x},[_]),$=h.useCallback(v=>{C(x=>{if(v.key){const T=x.findIndex(P=>P.key===v.key);if(T>=0){const P=[...x];return P[T]={...P[T],...v},P}}return[...x,{...v,id:je.current++}].slice(-80)})},[]),ge=h.useMemo(()=>{var v;return((v=f.snapshot)==null?void 0:v.userTasks.find(x=>x.state==="Created"))??null},[f.snapshot]),ue=h.useMemo(()=>{const v=_.processes.flatMap(T=>T.tasks),x=new Map;for(const T of e.handlers){if(!T.manualControl)continue;const P=v.find(B=>B.elementId===T.elementId);P&&x.set(P.jobType,{...T.manualControl,elementId:T.elementId})}return x},[e.handlers,_]),fe=h.useMemo(()=>{if(!f.snapshot)return null;for(const v of f.snapshot.jobs){const x=ue.get(v.jobType);if(x&&v.state==="Created")return{job:v,control:x}}return null},[f.snapshot,ue]),Ve=h.useMemo(()=>{if(!_.agent||!f.snapshot)return[];const v=new Map(f.snapshot.elementStats.map(x=>[x.elementId,x.completed]));return _.agent.tools.filter(x=>(v.get(x.elementId)??0)===0)},[_.agent,f.snapshot]),X=ge?_.userTasks.find(v=>v.elementId===ge.elementId):void 0,Le=X!=null&&X.formId?((_n=e.forms)==null?void 0:_n[X.formId])??null:null,Pe=h.useCallback(async(v,x,T,P)=>{var me;let B=T,ee=0;for(;Te.current===P&&B&&B.completedInstances<1&&ee++<80;){const V=await f.stepWorkers(v,{agents:x});if(Te.current!==P)return B;B=(V==null?void 0:V.snapshot)??B;const ne=(me=B.instances[0])==null?void 0:me.variables;if(ne&&be({...ne}),B.userTasks.some(te=>te.state==="Created")){$({kind:"human",text:"⏸ waiting for a human — complete the task below to continue"});break}if(!V){$({kind:"error",text:"▶ run stopped — no dispatch round was returned"});break}if(V.handled===0)break;await new Promise(te=>setTimeout(te,on))}return B&&B.completedInstances>=1?$({kind:"done",text:"✅ process instance completed"}):B&&B.incidentElementIds.length>0&&$({kind:"error",text:"A job failed — incident on the diagram"}),B},[f,$]),E=h.useCallback(async v=>{var B,ee,me;if(!fe||oe.current)return;const{job:x,control:T}=fe,P=++Te.current;oe.current=!0,ie(!0);try{let V,ne;if(v==="complete")V=f.completeJobManually(x.jobType,"{}"),ne="  ↳ completed normally";else if(T.action.kind==="timer"){const te=((ee=(B=f.snapshot)==null?void 0:B.timers[0])==null?void 0:ee.dueInMs)??0;V=f.advanceTime(Math.max(te,0)+1),ne="  ↳ advanced the clock — timer fired"}else{const{errorCode:te,message:re}=T.action;V=f.throwJobError(x.jobType,te,re),ne=`  ↳ threw BPMN error ${te}: ${re}`}if(V){$({kind:"vars",text:ne,elementId:x.elementId});const te=(me=V.instances[0])==null?void 0:me.variables;te&&be({...te}),await new Promise(re=>setTimeout(re,on)),await Pe(xe.current,Ne.current,V,P)}else $({kind:"error",text:"  ↳ failed to resolve the manual job",elementId:x.elementId})}finally{oe.current=!1,ie(!1)}},[fe,f,$,Pe]),D=h.useCallback(async()=>{var te;let v=null;try{_.agent&&l.trim()&&(v=hr(l))}catch(re){return A(re instanceof Error?re.message:String(re)),null}q.current={current:void 0};let x;if(e.imageInput){const re=s.vision;x={read:re??hi(e.scriptedVision).read,live:!!re,resolve:pe=>f.getRunImage(pe)}}const T=yr(_,b.handlers,$,q.current,x);for(const re of ue.keys())delete T[re];const P={};if(_.agents.length>0){if(s.kind!=="scripted"&&s.chat){const Se=new Map;for(const pe of _.agents)Se.set(pe.jobType,[...Se.get(pe.jobType)??[],pe]);for(const[pe,Oe]of Se)P[pe]=Pr(Oe,s.chat,$,{turnRef:q.current,requiredTools:e.requiredTools})}else if(v&&_.agent){const Se=_.agent.elementId;P[_.agent.jobType]=async pe=>{if(pe.elementId!==Se)throw new Error(`No scripted agent handler for "${pe.elementId}" — only "${Se}" (the primary process's first agent host) is driven by the scripted brain. Use a live brain to exercise more than one host.`);const Oe=await v(pe),At=(Oe.activateElements??[]).map(Ct=>Ct.elementId).join(", ");return $({kind:"agent",text:Oe.completionConditionFulfilled?"🤖 scripted agent: done":`🤖 scripted agent: calling ${At||"(nothing)"}`}),Oe}}}C([]),ve({});const B={...e.seed,...L,...sr(e.imageInput?c:null)};be(B),xe.current=T,Ne.current=P;const ee=f.redeploy(r),me=(ee==null?void 0:ee[0])??_.processId;$({kind:"start",text:`Starting "${me}" — ${_.agent?s.kind==="scripted"||!s.chat?"scripted brain":`live brain (${s.modelInUse??s.kind})`:"no agent in this model"}`});const V=f.createInstance(me,JSON.stringify(B)),ne=(te=V==null?void 0:V.instances[0])==null?void 0:te.key;return e.imageInput&&c&&ne&&f.setRunImage(ne,c),{workers:T,agents:P,snap:V}},[f,e,b,r,l,L,c,_,s,$,ue]),F=!!f.snapshot&&f.snapshot.completedInstances<1,Ie=!F&&!!k&&!Me,kt=h.useCallback(async()=>{if(!(f.phase!=="ready"||oe.current||U||b.hasErrors)){oe.current=!0,ie(!0);try{let v=xe.current,x=Ne.current,T=f.snapshot;const P=++Te.current;if(!F){if(ke.current&&!ke.current.validate())return;A(null);const B=await D();if(!B)return;v=B.workers,x=B.agents,T=B.snap,await new Promise(ee=>setTimeout(ee,on))}await Pe(v,x,T,P)}finally{oe.current=!1,ie(!1)}}},[f,U,b.hasErrors,F,D,Pe]),Et=h.useCallback(async()=>{var v;if(!(f.phase!=="ready"||oe.current||U||b.hasErrors)){oe.current=!0,I(!0);try{let x=xe.current,T=Ne.current,P=f.snapshot;if(!F){if(ke.current&&!ke.current.validate())return;A(null);const ne=await D();if(!ne)return;x=ne.workers,T=ne.agents,P=ne.snap}if(!P||P.completedInstances>=1)return;const B=P.takenSequenceFlows.length,ee=await f.stepWorkers(x,{agents:T});if(!ee){$({kind:"error",text:"⏭ step failed — no dispatch round was returned"});return}const me=(v=ee.snapshot.instances[0])==null?void 0:v.variables;me&&be({...me});const V=ni(ee.snapshot.takenSequenceFlows,B);$(ti(ee,V,De,ue))}finally{oe.current=!1,I(!1)}}},[f,U,b.hasErrors,F,D,$,De,ue]),Tt=h.useCallback(()=>{oe.current=!1,Te.current++,ie(!1),I(!1),f.reset(),C([]),be({})},[f]),jt=h.useCallback(()=>{if(!ge||Be.current&&!Be.current.validate())return;const v=f.completeUserTask(ge.key,JSON.stringify(Ce));$({kind:"human",text:`👤 ${cn(Ce)}`}),v&&v.completedInstances>=1&&$({kind:"done",text:"✅ process instance completed"})},[ge,Ce,f,$]),St=h.useMemo(()=>{var v,x;return f.phase==="loading"?a.jsx(Q,{variant:"neutral",children:"Booting engine…"}):f.phase==="error"?a.jsx(Q,{variant:"danger",children:"Engine error"}):G?a.jsx(Q,{variant:"info",children:"Running…"}):U?a.jsx(Q,{variant:"info",children:"Stepping…"}):(((v=f.snapshot)==null?void 0:v.incidentElementIds.length)??0)>0?a.jsx(Q,{variant:"danger",children:"Incident"}):ge?a.jsx(Q,{variant:"warning",children:"Waiting for a human"}):(((x=f.snapshot)==null?void 0:x.completedInstances)??0)>=1?a.jsx(Q,{variant:"success",children:"Completed"}):f.snapshot?a.jsx(Q,{variant:"warning",children:"Paused"}):a.jsx(Q,{variant:"neutral",children:"Ready"})},[f.phase,f.snapshot,G,U,ge]);return a.jsxs("div",{className:"runner",children:[a.jsxs("section",{className:"intro",children:[a.jsx("h1",{children:e.title}),a.jsx("p",{children:e.blurb}),a.jsxs("div",{className:"controls",children:[a.jsx(H,{"data-tour":he.runButton,onClick:()=>void kt(),disabled:f.phase!=="ready"||G||U||b.hasErrors||Ie,children:"▶ Run"}),a.jsx(H,{variant:"secondary",onClick:()=>void Et(),disabled:f.phase!=="ready"||G||U||b.hasErrors||Ie||(((Mn=f.snapshot)==null?void 0:Mn.completedInstances)??0)>=1,children:"⏭ Step"}),a.jsx(H,{variant:"secondary",onClick:Tt,disabled:f.phase!=="ready"||U,children:"↺ Reset"}),e.tour&&a.jsx(H,{variant:"secondary",onClick:M.start,disabled:M.active,children:M.active?"Touring…":`🧭 ${e.tour.label}`}),St]}),f.phase==="error"&&a.jsxs(ae,{variant:"destructive",children:[a.jsx(se,{children:"Engine error"}),a.jsx(ce,{children:f.error})]}),N&&a.jsxs(ae,{variant:"destructive",children:[a.jsx(se,{children:"Code didn't compile"}),a.jsx(ce,{children:N})]}),b.hasErrors&&a.jsxs(ae,{variant:"destructive",children:[a.jsx(se,{children:"Run is disabled — the diagram has unresolved references"}),a.jsx(ce,{children:a.jsx("ul",{className:"diagnostics",children:b.diagnostics.filter(v=>v.severity==="error").map((v,x)=>a.jsx("li",{children:v.message},x))})})]}),!b.hasErrors&&b.diagnostics.length>0&&a.jsxs(ae,{children:[a.jsx(se,{children:"Heads up"}),a.jsx(ce,{children:a.jsx("ul",{className:"diagnostics",children:b.diagnostics.map((v,x)=>a.jsx("li",{children:v.message},x))})})]})]}),a.jsxs("div",{className:"grid",children:[a.jsxs("div",{className:"col",children:[a.jsx(ye,{sectionId:"process","data-tour":he.diagram,title:"Process",description:`${_.processName} — live token (green), incidents (red).`,children:a.jsx(h.Suspense,{fallback:a.jsx("div",{className:"diagram-fallback",children:f.phase==="loading"?"Booting the engine…":"Loading diagram…"}),children:a.jsx(Qi,{xml:b.resolvedBpmn,activeIds:((vn=f.snapshot)==null?void 0:vn.activeElementIds)??[],incidentIds:((xn=f.snapshot)==null?void 0:xn.incidentElementIds)??[],className:"diagram"})})}),ge&&a.jsxs(ye,{sectionId:"human-task",title:(X==null?void 0:X.label)??"Human task",description:Le?`Rendered from the model's form "${X==null?void 0:X.formId}".`:"This task has no linked form — complete it with no variables.",children:[Ve.length>0&&a.jsxs(ae,{variant:"destructive",children:[a.jsx(se,{children:"The agent didn't finish its checks"}),a.jsxs(ce,{children:["It completed without running"," ",Ve.map(v=>v.label||v.elementId).join(", "),". The process took the default path to this task, so the findings below have no value to report."]})]}),Le&&a.jsx(h.Suspense,{fallback:a.jsx("div",{className:"form-fallback",children:"Loading form…"}),children:a.jsx(Vn,{ref:Be,schema:Le,values:Ce,onChange:(v,x)=>ve(T=>({...T,[v]:x})),context:Z,onValidityChange:Ee})}),a.jsx(H,{onClick:jt,disabled:!!Le&&!nn,children:"Complete task"})]}),fe&&a.jsx(ye,{sectionId:"manual-job",title:fe.control.label,description:"This job is held here on purpose — pick how it resolves.",children:a.jsxs("div",{className:"controls",children:[a.jsx(H,{onClick:()=>void E("complete"),disabled:G||U,children:fe.control.completeLabel??"✅ Complete normally"}),a.jsx(H,{variant:"secondary",onClick:()=>void E("action"),disabled:G||U,children:fe.control.action.label})]})}),a.jsxs("div",{className:"row",children:[a.jsx(ye,{sectionId:"variables",className:"grow","data-tour":he.variablesPanel,title:"Variables",description:"The instance payload, live.",children:a.jsx("pre",{className:"vars",children:cn(Z,2)})}),a.jsx(Ri,{log:K,elementStats:(Nn=f.snapshot)==null?void 0:Nn.elementStats,incidents:(In=f.snapshot)==null?void 0:In.incidents,labelFor:De})]})]}),a.jsxs("div",{className:"col",children:[(_.agent||e.imageInput)&&a.jsx(ye,{sectionId:"brain","data-tour":he.brainPanel,title:"Brain",description:_.agent?`What drives “${_.agent.label}”. The model recommends; the process governs.`:"What reads the image. The model recommends; the process governs.",children:a.jsx(Ni,{brain:s,showText:!!_.agent,showVision:!!e.imageInput})}),a.jsxs(ye,{sectionId:"start",title:"Start",description:_.startFormId?`The model's start form "${_.startFormId}".`:e.imageInput?"Pick a seed photo or upload your own to read.":"The starting payload.",children:[e.imageInput&&a.jsx(Ei,{imageInput:e.imageInput,value:c,onSelect:u,disabled:G}),e.scenarios&&a.jsx("div",{className:"scenarios",children:e.scenarios.map(v=>a.jsx(H,{size:"sm",variant:"secondary",disabled:G,onClick:()=>Y(x=>({...x,...v.variables})),children:v.label},v.label))}),k?a.jsx(h.Suspense,{fallback:a.jsx("div",{className:"form-fallback",children:"Loading form…"}),children:a.jsx(Vn,{ref:ke,schema:k,values:L,onChange:(v,x)=>Y(T=>({...T,[v]:x})),disabled:G,onValidityChange:ze})}):a.jsx("pre",{className:"vars",children:cn(L,2)})]}),a.jsx(ye,{sectionId:"code",className:"editors","data-tour":he.codePanel,title:"Code",description:"One handler per BPMN element. Return variables to merge, or throw to fail the job.",children:a.jsx(h.Suspense,{fallback:a.jsx("div",{className:"editor-fallback",children:"Loading editor…"}),children:a.jsxs($t,{value:W,onValueChange:de,children:[a.jsxs(Yt,{children:[a.jsx(Qe,{value:Yn,children:"model"}),_.agent&&a.jsx(Qe,{value:an,children:"agent (scripted)"}),e.handlers.map(v=>{var x;return a.jsx(Qe,{value:v.elementId,children:((x=_.tasks.find(T=>T.elementId===v.elementId))==null?void 0:x.label)??v.elementId},v.elementId)}),Object.keys(p).map(v=>a.jsx(Qe,{value:Gn+v,children:v},v))]}),a.jsxs(Je,{value:Yn,children:[a.jsxs("div",{className:"editor-meta",children:[a.jsx("strong",{children:"Model"}),a.jsx("code",{children:"edit the diagram visually — Run re-checks it below"}),a.jsx(H,{variant:"secondary",size:"sm",onClick:()=>i(e.bpmn),disabled:r===e.bpmn,children:"Revert to original"})]}),a.jsx(Ji,{value:r,onChange:i})]}),_.agent&&a.jsxs(Je,{value:an,children:[a.jsxs("div",{className:"editor-meta",children:[a.jsx("strong",{children:_.agent.label}),a.jsx("code",{children:s.kind==="scripted"||!s.chat?"in use":"unused — a live brain is connected"})]}),a.jsx("div",{className:"editor-wrap",children:a.jsx(sn,{height:"360px",defaultLanguage:"javascript",value:l,onChange:v=>g(v??""),options:ln})})]}),e.handlers.map(v=>{var x;return a.jsxs(Je,{value:v.elementId,children:[a.jsxs("div",{className:"editor-meta",children:[a.jsx("strong",{children:((x=_.tasks.find(T=>T.elementId===v.elementId))==null?void 0:x.label)??v.elementId}),a.jsx("code",{children:v.standsInFor??v.elementId})]}),a.jsx("div",{className:"editor-wrap",children:a.jsx(sn,{height:"360px",defaultLanguage:"javascript",value:m[v.elementId],onChange:T=>o(P=>({...P,[v.elementId]:T??""})),options:ln})})]},v.elementId)}),Object.keys(p).map(v=>a.jsxs(Je,{value:Gn+v,children:[a.jsxs("div",{className:"editor-meta",children:[a.jsx("strong",{children:v}),a.jsxs("code",{children:["prompt / template text — substitutes"," ","{{"+v+"}}"]})]}),a.jsx("div",{className:"editor-wrap",children:a.jsx(sn,{height:"360px",defaultLanguage:"markdown",value:p[v],onChange:x=>y(T=>Ye(T,{[v]:x??""})),options:ln})})]},v))]})})}),_.agent&&a.jsx(ye,{sectionId:"tools",title:"Tools, as the model sees them",description:a.jsxs(a.Fragment,{children:["Read from the diagram — element name, documentation, and every",a.jsx("code",{children:" fromAi(…)"})," argument."]}),children:a.jsx("ul",{className:"tool-list",children:_.agent.tools.map(v=>a.jsxs("li",{children:[a.jsx("code",{children:v.elementId}),a.jsxs("span",{children:[" — ",v.documentation||v.label]}),v.args.length>0&&a.jsx("ul",{children:v.args.map(x=>a.jsxs("li",{children:[a.jsxs("code",{children:[x.name,": ",x.type]})," ","— ",x.description]},x.name))})]},v.elementId))})})]})]})]})}const ln={minimap:{enabled:!1},fontSize:13,scrollBeyondLastLine:!1,tabSize:2,automaticLayout:!0},Wi=`You are a demo workflow assistant for fictional compliance checks.
...
`,qi={id:"compliance-walkthrough",label:"Take the tour",steps:[{title:"Start a run",description:"Press Run to send a shipment through the compliance agent.",target:{anchor:he.runButton}},{title:"The agent picks its own tools",description:"This AI Agent reads the shipment notes and decides, turn by turn, which of the tools below it to call — nothing here is hard-coded into a fixed sequence.",target:{elementId:"ComplianceCheckAgent"}},{title:"Watch the token move",description:"The agent's first move is to look up the genetic marker mentioned in the notes.",target:{elementId:"VerifyGeneticMarker"},waitFor:{kind:"activeElement",elementId:"VerifyGeneticMarker"}},{title:"A cleared shipment notifies the export team",description:"Once the compliance score comes back clean, the process notifies the export team automatically — no human review needed for this scenario.",target:{elementId:"NotifyExportTeam"},waitFor:{kind:"elementCompleted",elementId:"NotifyExportTeam"}},{title:"Everything the run recorded",description:"The variables panel shows the marker record, the country lookup, the compliance score, and the final decision — exactly what each tool and the agent wrote along the way.",target:{anchor:he.variablesPanel}}],successEvent:{kind:"instanceCompleted"}},Ki=`<?xml version="1.0" encoding="UTF-8"?>
  ...
  <bpmn:process id="loan-origination-agent" name="Loan origination agent" isExecutable="true">
    ...
    <bpmn:adHocSubProcess id="LoanOriginationAgent" name="Loan origination agent">
      ...
      <bpmn:scriptTask id="AssessApplication" name="Assess application">
        <bpmn:documentation>Applies the lender's deterministic underwriting policy — computes the debt-to-income ratio, a risk band, and a recommend/decline recommendation from the verified application figures. This is the policy step the senior officer's review depends on.</bpmn:documentation>
        <bpmn:extensionElements>
...
}`,ta={id:"loan-origination",title:"Loan origination agent",blurb:"An AI agent gathers a loan case with its own tools — customer lookup, credit bureau, an underwriting policy, a status update — then every application passes through a mandatory senior-officer review before a gateway routes it to an offer or a decline. The agent advises; the process governs.",docsUrl:"https://camunda.com/orchestrate/agents/",bpmn:jo,forms:{"loan-application":zo,"loan-senior-officer-review":Vo},seed:Jn,scenarios:[{label:"Strong applicant (policy recommends approve)",variables:Jn},{label:"Marginal applicant (policy recommends decline)",variables:Ho}],scriptedAgent:Wo,templates:Jo,tour:To,requiredTools:["AssessApplication"],handlers:[{elementId:"QueryCustomer",standsInFor:"CRM connector — customer lookup",source:Zo},{elementId:"CreditBureauLookup",standsInFor:"REST connector — credit bureau",source:qo},{elementId:"AssessApplication",standsInFor:"Script task — underwriting policy (FEEL)",source:Ko},{elementId:"UpdateApplicationStatus",standsInFor:"REST connector — origination system",source:Xo},{elementId:"IssueLoanOffer",standsInFor:"REST connector — offer/booking system",source:ea},{elementId:"SendDeclineNotice",standsInFor:"REST connector — notifications",source:na}]},ra=`<?xml version="1.0" encoding="UTF-8"?>
...
}`,sa={id:"order-process",title:"Order process with service workers",blurb:"The getting-started order process: check inventory, charge payment, ship. No agent and no human step — the same runner, driven entirely by what's in the diagram.",docsUrl:"https://docs.camunda.io/docs/next/guides/getting-started-orchestration-cluster/",bpmn:ra,seed:{item:"camunda-t-shirt",quantity:3},handlers:[{elementId:"Activity_0tw2fu0",standsInFor:"job worker — check-inventory",source:ia},{elementId:"Activity_1ppsbgi",standsInFor:"job worker — charge-payment",source:oa},{elementId:"Activity_08pg6im",standsInFor:"job worker — ship-items",source:aa}]},ca=`<?xml version="1.0" encoding="UTF-8"?>\r
...
}`,da={id:"rocket-launch",title:"Rocket launch",blurb:"The getting-started rocket launch, boiled down to one service task: launch. The smallest possible example, and the smallest possible test of the framework's extensibility.",bpmn:ca,seed:{missionName:"Apollo 11",destination:"the Moon",fuelLevel:100},scenarios:[{label:"Full tanks — launch succeeds",variables:{missionName:"Apollo 11",destination:"the Moon",fuelLevel:100}},{label:"Low fuel — mission scrubbed",variables:{missionName:"Apollo 13",destination:"the Moon",fuelLevel:30}}],handlers:[{elementId:"Activity_LaunchRocket",standsInFor:"job worker — launch-rocket",source:la}]},ua=`<?xml version="1.0" encoding="UTF-8"?>\r
...
`,ma=`async (job, { text, sleep }) => {
  ...
  return { shipped: true, tracking: "1Z" + Math.floor(Math.random() * 1e9) };
}`,ha={id:"order-process-boundary-events",title:"Order process with boundary events",blurb:"The getting-started order process, extended with a timer and an error boundary event: charge payment can be declined, and a delayed shipment can escalate — both fired by hand from the runner rather than by chance.",docsUrl:"https://github.com/camunda/camunda-8-get-started/tree/main/2-order-process-with-service-workers",bpmn:ua,seed:{item:"camunda-t-shirt",quantity:3},handlers:[{elementId:"Activity_0tw2fu0",standsInFor:"job worker — check-inventory",source:ma},{elementId:"Activity_1ppsbgi",standsInFor:"job worker — charge-payment",source:pa,manualControl:{label:"Charge payment method",completeLabel:"✅ Complete normally",action:{kind:"error",errorCode:"CHARGE_DECLINED",message:"The card issuer declined the charge.",label:"❌ Simulate: card declined"}}},{elementId:"Activity_08pg6im",standsInFor:"job worker — ship-items",source:ga,manualControl:{label:"Ship items",completeLabel:"✅ Ship it",action:{kind:"timer",label:"🕐 Fire the shipping-delayed timer"}}}]},ba="/pr-preview/pr-83/assets/de-bmw-mini-JBSk7QcF.jpg",fa="/pr-preview/pr-83/assets/de-bmw-mini.thumb-CUUmJrRO.jpg",ya="/pr-preview/pr-83/assets/uk-d651-rnb-XGipy2QN.jpg",wa="/pr-preview/pr-83/assets/uk-d651-rnb.thumb-mjEcbhUf.jpg",_a="/pr-preview/pr-83/assets/uk-mk70-orj-Cn6O3Xfm.jpg",Ma="/pr-preview/pr-83/assets/uk-mk70-orj.thumb-CaeZ2vqU.jpg",va="/pr-preview/pr-83/assets/uk-ni-ijz-8992-YXV44tgk.jpg",xa="/pr-preview/pr-83/assets/uk-ni-ijz-8992.thumb-DYwok8jV.jpg",Na="/pr-preview/pr-83/assets/us-hyundai-genesis-gGpAIEpi.jpg",Ia="/pr-preview/pr-83/assets/us-hyundai-genesis.thumb-DEEt19Mw.jpg",ka=`<?xml version="1.0" encoding="UTF-8"?>
...
}`,rs={id:"plate-recognition",title:"Read a number plate from a photo",blurb:"Pick the plate's country, then a photo goes into the run, an in-browser vision model reads the number plate on the reader's own GPU, and a human confirms or corrects it before the process records the result. The vision model recommends; the BPMN process governs. No server, no API key — with no model connected it falls back to a deterministic scripted reading.",docsUrl:"https://docs.camunda.io/docs/components/modeler/forms/camunda-forms-reference/",bpmn:ka,forms:{"plate-recognition-country":Za,"plate-recognition-confirm":La,"plate-recognition-manual":$a},seed:{country:"auto"},imageInput:{label:"Pick a seed photo (its plate is known, so the scripted reader works offline) or upload your own — a live in-browser model reads a photo it has never seen.",seedImages:Xa},scriptedVision:es,handlers:[{elementId:"ExtractPlate",standsInFor:"Vision model — Florence-2 <OCR> on WebGPU (in-browser)",source:ns},{elementId:"RecordResult",standsInFor:"Script task — records the governed outcome",source:ts}]},Ze=[da,Io,ta,sa,ha,rs];function fn(){return"/pr-preview/pr-83/"}function is(e){const n=fn();return e.startsWith(n)?"/"+e.slice(n.length):e}function os(e=location.pathname){const t=is(e).match(/^\/examples\/([^/]+)\/?$/);if(t)try{return{kind:"example",id:decodeURIComponent(t[1])}}catch{return{kind:"gallery"}}return{kind:"gallery"}}function as(e=location.search){return new URLSearchParams(e).get("embed")==="1"}function ss(){return fn()}function Wn(e){return`${fn()}examples/${encodeURIComponent(e)}`}function Zn(e,n={}){const t=new URL(location.href);t.pathname=e,t.search=n.search??t.search,n.hash!==void 0&&(t.hash=n.hash),n.replace?history.replaceState(history.state,"",t):history.pushState(history.state,"",t),window.dispatchEvent(new PopStateEvent("popstate"))}function qn(){return{route:os(),embed:as()}}function cs(){const[e,n]=h.useState(qn);return h.useEffect(()=>{const t=()=>n(qn());return window.addEventListener("popstate",t),()=>window.removeEventListener("popstate",t)},[]),e}const ls="web-demo-framework:height",ds="web-demo-framework:request-height";function us(e){return{type:ls,height:Math.ceil(e)}}const Kn="embed-height-auto";function ms(e){h.useEffect(()=>{if(!e||typeof window>"u"||window.parent===window)return;const n=document.documentElement;n.classList.add(Kn);let t=-1;const r=(c=!1)=>{const u=document.documentElement.scrollHeight;!c&&Math.abs(u-t)<2||(t=u,window.parent.postMessage(us(u),"*"))},i=c=>{if(c.source!==window.parent)return;const u=c.data;!u||u.type!==ds||r(!0)};window.addEventListener("message",i),r();const s=new ResizeObserver(()=>r());return s.observe(n),()=>{s.disconnect(),window.removeEventListener("message",i),n.classList.remove(Kn)}},[e])}function ps(){const{route:e,embed:n}=cs(),t=vt().brain,r=zi();ms(n);const i=e.kind==="example"?e.id:Ze[0].id,s=Ze.find(m=>m.id===i)??Ze[0],c=m=>{Zn(Wn(m),{hash:location.hash})},u=a.jsxs(a.Fragment,{children:[!n&&e.kind==="gallery"&&a.jsx("nav",{className:"example-picker",children:Ze.map(m=>a.jsx(H,{size:"sm",variant:m.id===s.id?"default":"secondary",onClick:()=>c(m.id),children:m.title},m.id))}),!n&&e.kind==="example"&&a.jsx("div",{className:"example-nav",children:a.jsx(H,{size:"sm",variant:"secondary",onClick:()=>Zn(ss()),children:"← All examples"})}),a.jsxs("div",{className:"example-meta",children:[s.docsUrl&&a.jsx("a",{className:"docs-link",href:s.docsUrl,target:"_blank",rel:"noreferrer noopener",children:"View on camunda.com ↗"}),n&&a.jsx("a",{className:"open-full-page",href:Wn(s.id)+(location.hash||""),target:"_top",rel:"noreferrer",children:"Open full page ↗"})]}),a.jsx(Hi,{example:s,initialBrainKind:t,initialTourId:r},s.id)]});return n?a.jsx("div",{className:"c4-ui app-shell app-embed",children:a.jsx("main",{id:"main",className:"layout layout-embed",children:u})}):a.jsxs("div",{className:"c4-ui app-shell",children:[a.jsx(Gt,{appName:"Runnable Camunda examples",trailing:a.jsx("span",{className:"app-subtitle",children:"model + code + optional LLM, in your browser"})}),a.jsx("main",{id:"main",className:"layout",children:u})]})}Pt.createRoot(document.getElementById("root")).render(a.jsx(h.StrictMode,{children:a.jsx(Vt,{children:a.jsx(ps,{})})}));export{le as _,fs as c};
