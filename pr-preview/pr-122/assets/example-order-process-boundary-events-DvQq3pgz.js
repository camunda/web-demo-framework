import{l as n}from"./index-DKUlZ9Pw.js";import"./vendor-react-9Ma26nY1.js";import"./vendor-design-system-DKA-dWDZ.js";const e=`<?xml version="1.0" encoding="UTF-8"?>\r
...
}`,m={...n,bpmn:e,seed:{item:"camunda-t-shirt",quantity:3},handlers:[{elementId:"Activity_0tw2fu0",standsInFor:"job worker — check-inventory",source:i},{elementId:"Activity_1ppsbgi",standsInFor:"job worker — charge-payment",source:t,manualControl:{label:"Charge payment method",completeLabel:"✅ Complete normally",action:{kind:"error",errorCode:"CHARGE_DECLINED",message:"The card issuer declined the charge.",label:"❌ Simulate: card declined"}}},{elementId:"Activity_08pg6im",standsInFor:"job worker — ship-items",source:r,manualControl:{label:"Ship items",completeLabel:"✅ Ship it",action:{kind:"timer",label:"🕐 Fire the shipping-delayed timer"}}}]};export{m as orderProcessBoundaryEvents};
