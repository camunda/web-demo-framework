const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/driver-CTZuBZOi.css","assets/diagram-js-DAKGYcfb.css","assets/bpmn-js-BEOU0ddW.css","assets/bpmn-embedded-Cmm4Mj1L.css","assets/RuntimeDiagram-DTnJz5cT.js","assets/vendor-react-9Ma26nY1.js","assets/Viewer-D_7S4Gwm.js","assets/MonacoEditor-Bl9r9bi7.js","assets/MonacoEditor-Ba2QdL_h.css","assets/vendor-modeler-DOpG6HQX.js","assets/vendor-design-system-MBDIleAi.js","assets/vendor-design-system-B3ysEu8S.css","assets/parser-DkgAe_kI.js","assets/ModelEditor-Dwlgp6JA.css","assets/FormRenderer-BI_nfXvc.js","assets/FormRenderer-D1JIHOW6.css"])))=>i.map(i=>d[i]);
var er=Object.defineProperty;var nr=(e,n,t)=>n in e?er(e,n,{enumerable:!0,configurable:!0,writable:!0,value:t}):e[n]=t;var R=(e,n,t)=>nr(e,typeof n!="symbol"?n+"":n,t);import{r as g,j as i,i as tr}from"./vendor-react-9Ma26nY1.js";import{B as Z,a as ie,L as Ye,S as Nn,b as En,c as kn,d as In,e as Tn,A as se,f as de,g as le,I as Jn,C as rr,h as ir,i as or,j as ar,k as sr,l as dr,T as lr,m as cr,n as rn,o as on,p as mr,q as pr}from"./vendor-design-system-MBDIleAi.js";(function(){const n=document.createElement("link").relList;if(n&&n.supports&&n.supports("modulepreload"))return;for(const o of document.querySelectorAll('link[rel="modulepreload"]'))r(o);new MutationObserver(o=>{for(const s of o)if(s.type==="childList")for(const l of s.addedNodes)l.tagName==="LINK"&&l.rel==="modulepreload"&&r(l)}).observe(document,{childList:!0,subtree:!0});function t(o){const s={};return o.integrity&&(s.integrity=o.integrity),o.referrerPolicy&&(s.referrerPolicy=o.referrerPolicy),o.crossOrigin==="use-credentials"?s.credentials="include":o.crossOrigin==="anonymous"?s.credentials="omit":s.credentials="same-origin",s}function r(o){if(o.ep)return;o.ep=!0;const s=t(o);fetch(o.href,s)}})();const ur="modulepreload",hr=function(e){return"/web-demo-framework/pr-preview/pr-114/"+e},Hn={},ue=function(n,t,r){let o=Promise.resolve();if(t&&t.length>0){let l=function(a){return Promise.all(a.map(u=>Promise.resolve(u).then(h=>({status:"fulfilled",value:h}),h=>({status:"rejected",reason:h}))))};document.getElementsByTagName("link");const m=document.querySelector("meta[property=csp-nonce]"),p=(m==null?void 0:m.nonce)||(m==null?void 0:m.getAttribute("nonce"));o=l(t.map(a=>{if(a=hr(a),a in Hn)return;Hn[a]=!0;const u=a.endsWith(".css"),h=u?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${a}"]${h}`))return;const d=document.createElement("link");if(d.rel=u?"stylesheet":ur,u||(d.as="script"),d.crossOrigin="",d.href=a,p&&d.setAttribute("nonce",p),document.head.appendChild(d),u)return new Promise((b,f)=>{d.addEventListener("load",b),d.addEventListener("error",()=>f(new Error(`Unable to preload CSS for ${a}`)))})}))}function s(l){const m=new Event("vite:preloadError",{cancelable:!0});if(m.payload=l,window.dispatchEvent(m),!m.defaultPrevented)throw l}return o.then(l=>{for(const m of l||[])m.status==="rejected"&&s(m.reason);return n().catch(s)})},gr="io.camunda.agenticai:aiagent",Se="http://www.omg.org/spec/BPMN/20100524/MODEL",br="http://camunda.org/schema/zeebe/1.0";function jn(e,n){return Array.from(e.getElementsByTagNameNS(br,n))}function kt(e,n){return jn(e,n).filter(t=>_r(t)===e)}function _r(e){let n=e.parentElement;for(;n;){if(n.namespaceURI===Se&&n.localName!=="extensionElements")return n;n=n.parentElement}return null}function Dn(e){const n=kt(e,"taskDefinition")[0],t=n==null?void 0:n.getAttribute("type");return t||(e.localName==="scriptTask"?e.getAttribute("id")??null:null)}function Wn(e){const n=Array.from(e.children).find(t=>t.namespaceURI===Se&&t.localName==="documentation");return((n==null?void 0:n.textContent)??"").trim()}function Zn(e){if(!e)return"";const n=e.startsWith("=")?e.slice(1):e,t=n.match(/"((?:[^"\\]|\\.)*)"/g);return t?t.map(r=>r.slice(1,-1).replace(/\\n/g,`
`).replace(/\\t/g,"	").replace(/\\"/g,'"').replace(/\\\\/g,"\\")).join("").trim():n.trim()}function It(e){const n=[],t=r=>{for(const o of Array.from(r.attributes))n.push(o.value);for(const o of Array.from(r.children))t(o)};return t(e),n.join(`
`)}function fr(e){return Tt(It(e))}function wr(e){const n=Array.from(e.children).find(t=>t.namespaceURI===Se&&t.localName==="extensionElements");return n?Tt(It(n)):[]}function Tt(e){const n=/fromAi\(\s*toolCall\.([A-Za-z_$][\w$]*)\s*,\s*"((?:[^"\\]|\\.)*)"\s*(?:,\s*"(\w+)")?/g,t=[],r=new Set;for(const o of e.matchAll(n)){const s=o[1];r.has(s)||(r.add(s),t.push({name:s,description:(o[2]??"").replace(/&#10;/g,`
`).replace(/\\"/g,'"').replace(/&quot;/g,'"').replace(/&#39;/g,"'").trim(),type:o[3]??"string"}))}return t}function yr(e){const n={};for(const t of kt(e,"input")){const r=t.getAttribute("target");r&&(n[r]=t.getAttribute("source")??"")}return n}function vr(e){return Array.from(e.getElementsByTagNameNS(Se,"adHocSubProcess")).filter(n=>(Dn(n)??"").startsWith(gr))}const Mr=new Set(["subProcess","adHocSubProcess","callActivity"]),xr=new Set(["adHocSubProcess","subProcess","transaction"]);function Nr(e){let n=e.parentElement;for(;n;){if(n.namespaceURI===Se&&xr.has(n.localName))return n;n=n.parentElement}return null}function Er(e,n){const t=yr(e),r=Number((t["data.limits.maxModelCalls"]??"").replace(/^=/,""));return{elementId:e.getAttribute("id")??"agent",label:e.getAttribute("name")??"Agent",jobType:Dn(e),systemPrompt:Zn(t["data.systemPrompt.prompt"]),userPrompt:Zn(t["data.userPrompt.prompt"]),maxModelCalls:Number.isFinite(r)&&r>0?r:10,tools:n}}function kr(e,n){var h;const t=e.getAttribute("id")??"",r=e.getAttribute("name")??t,o=vr(e);o.length>1&&n.push({severity:"warning",elementId:o.map(d=>d.getAttribute("id")).join(", "),message:`Process "${r}" hosts ${o.length} AI Agent sub-processes (${o.map(d=>d.getAttribute("id")).join(", ")}). Each gets its own independent agent state (turn counter, called tools) — the run itself is shared across hosts, but each host's agent state within it is not.`});const s=[],l=new Map(o.map(d=>[d,[]]));for(const d of Array.from(e.getElementsByTagName("*"))){if(d.namespaceURI!==Se||o.includes(d))continue;const b=d.getAttribute("id");if(!b)continue;const f=Nr(d),x=f&&o.includes(f)?f:null;if(x&&Mr.has(d.localName)){const v=d.getAttribute("name")??b,M=Wn(d);s.push({elementId:b,label:v,jobType:"",documentation:M,isTool:!0,compound:!0}),l.get(x).push({elementId:b,label:v,jobType:"",documentation:M,args:wr(d),compound:!0});continue}const k=Dn(d);if(!k)continue;const _={elementId:b,label:d.getAttribute("name")??b,jobType:k,documentation:Wn(d),isTool:x!=null};s.push(_),x&&l.get(x).push({elementId:b,label:_.label,jobType:k,documentation:_.documentation,args:fr(d)})}const m=o.map(d=>Er(d,l.get(d))),p=Array.from(e.getElementsByTagNameNS(Se,"userTask")).map(d=>{var b;return{elementId:d.getAttribute("id")??"",label:d.getAttribute("name")??d.getAttribute("id")??"",formId:((b=jn(d,"formDefinition")[0])==null?void 0:b.getAttribute("formId"))??void 0}}),a=e.getElementsByTagNameNS(Se,"startEvent")[0],u=a?((h=jn(a,"formDefinition")[0])==null?void 0:h.getAttribute("formId"))??void 0:void 0;return{processId:t,processName:r,tasks:s,agents:m,userTasks:p,startFormId:u}}function Ir(e,n={}){const t=new DOMParser().parseFromString(e,"application/xml"),r=t.getElementsByTagName("parsererror")[0];if(r)throw new Error(`Invalid BPMN XML: ${r.textContent}`);const o=Array.from(t.getElementsByTagNameNS(Se,"process"));if(o.length===0)throw new Error("No <bpmn:process> in the diagram.");const s=[],l=o.map(p=>kr(p,s));let m=n.processId?l.find(p=>p.processId===n.processId):void 0;return n.processId&&!m&&s.push({severity:"warning",message:`Requested process "${n.processId}" not found — falling back to "${l[0].processId}".`}),m??(m=l[0]),l.length>1&&s.push({severity:"warning",message:`Diagram has ${l.length} <bpmn:process> elements (${l.map(p=>p.processId).join(", ")}); using "${m.processId}" as the active process. Pass a processId to parseModel to target another.`}),{processes:l,diagnostics:s,processId:m.processId,processName:m.processName,tasks:m.tasks,agent:m.agents[0]??null,agents:l.flatMap(p=>p.agents),userTasks:m.userTasks,startFormId:m.startFormId}}function Tr(e){return e?e.imageId?{imageId:e.imageId}:e.imageName?{imageName:e.imageName}:{}:{}}function jt(e,n){return n?e.pixels:e.imageId??e.pixels}const jr="No image selected — pick or upload a photo to read.";function Kn(){return jr}function Sr(e,n){return async t=>{const r=e.resolve(n);if(!r)return Kn();const o=jt(r,e.live);if(o===void 0)return Kn();try{return await e.read(o,t)}catch(s){return`Couldn't read the image (${s instanceof Error?s.message:String(s)}).`}}}function Pr(e,n){return async()=>{const t=e.resolve(n);if(t)return jt(t,e.live)}}function Ar(){return`<!doctype html><html><head><meta charset="utf-8"></head><body><script>
    "use strict";
    ...
    post({ kind: "ready" });
  <\/script></body></html>`}function St(e,n={}){const{timeoutMs:t=5e3,onTrace:r,onVision:o,onImage:s}=n,l=`${Date.now()}-${Math.random().toString(36).slice(2)}`;return new Promise((m,p)=>{const a=document.createElement("iframe");a.setAttribute("sandbox","allow-scripts"),a.style.display="none",a.setAttribute("aria-hidden","true");let u=!1,h;const d=()=>{h&&clearTimeout(h),window.removeEventListener("message",f),a.remove()},b=k=>{u||(u=!0,d(),k())};function f(k){var v;if(k.source!==a.contentWindow)return;const _=k.data;if(!(!_||typeof _!="object")){if(_.kind==="ready"){const M=e.job,Y=e.kind==="run-handler"?{kind:"run-handler",id:l,source:e.source,job:M,hasVision:e.hasVision}:{kind:"run-agent",id:l,source:e.source,job:M};(v=a.contentWindow)==null||v.postMessage(Y,"*");return}"id"in _&&_.id!==l||(_.kind==="trace"?r==null||r(_.text):_.kind==="vision-request"?x(_.callId,o,"vision",_.prompt):_.kind==="image-request"?x(_.callId,s,"image"):_.kind==="result"?b(()=>m(_.value)):_.kind==="error"&&b(()=>p(new Error(_.message))))}}function x(k,_,v,...M){const Y=H=>{var V;return(V=a.contentWindow)==null?void 0:V.postMessage(H,"*")};if(!_){Y({kind:"helper-error",id:l,callId:k,message:`${v} helper is not available.`});return}Promise.resolve().then(()=>_(...M)).then(H=>Y({kind:"helper-result",id:l,callId:k,value:H}),H=>Y({kind:"helper-error",id:l,callId:k,message:H instanceof Error?H.message:String(H)}))}window.addEventListener("message",f),h=setTimeout(()=>{b(()=>p(new Error(`Handler timed out after ${t}ms — the sandboxed run was terminated.`)))},t),a.srcdoc=Ar(),document.body.appendChild(a)})}function Pt(e){return{key:e.key,type:e.type,elementId:e.elementId,instanceKey:e.instanceKey,variables:e.variables??{}}}function Cr(e,n,t){const r=typeof t.vision=="function";return St({kind:"run-handler",source:e,job:Pt(n),hasVision:r},{onTrace:t.trace,onVision:t.vision?o=>t.vision(o):void 0,onImage:t.image?()=>t.image():void 0})}function Dr(e,n){return St({kind:"run-agent",source:e,job:Pt(n)})}function At(e,n){try{new Function(`"use strict"; return (${e});`)}catch{throw new Error(`${n} has a syntax error.`)}}function Br(e){return At(e,"Handler code"),(n,t)=>Cr(e,n,t)}function Lr(e){return At(e,"Agent code"),n=>Dr(e,n)}function Rr(e,n,t,r){return{sleep:o=>new Promise(s=>setTimeout(s,o)),trace:o=>n({kind:"tool",text:`   ${o}`,elementId:e.elementId,turn:t}),text:(o,s="")=>{const l=e.variables[o];return typeof l=="string"?l:l==null?s:String(l)},num:(o,s=0)=>{const l=e.variables[o],m=typeof l=="number"?l:Number(l);return Number.isFinite(m)?m:s},...r?{vision:Sr(r,e.instanceKey),image:Pr(r,e.instanceKey)}:{}}}function Fr(e){if(e===void 0)return"undefined";try{return JSON.stringify(e)}catch{return"[unserializable value]"}}function zr(e,n,t,r,o){const s={},l=e.processes.flatMap(p=>p.tasks),m=new Map(l.map(p=>[p.elementId,p.label]));for(const p of l)p.compound||s[p.jobType]||(s[p.jobType]=async a=>{const u=n[a.elementId];if(!u)throw new Error(`No handler registered for ${a.elementId} (job type ${a.type})`);const h=m.get(a.elementId)??a.elementId,d=r==null?void 0:r.current;t({kind:"tool",text:`▶ ${h}`,elementId:a.elementId,turn:d});const b=await u(a,Rr(a,t,d,o));return t({kind:"vars",text:`  ↳ ${Fr(b)}`,elementId:a.elementId,result:b,turn:d}),b});return s}const Or=/\{\{\s*([A-Za-z][A-Za-z0-9_-]*)\s*\}\}/g;function en(...e){const n=Object.create(null);for(const t of e)if(t)for(const r of Object.keys(t))n[r]=t[r];return n}function Ct(e){return(e.split("/").pop()??e).replace(/\.[^./]+$/,"")}function Dt(e){return e.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;")}function Ur(e){return Dt(e).replace(/"/g,"&quot;").replace(/\n/g,"&#10;").replace(/\t/g,"&#9;")}function $r(e){return e.replace(/\\/g,"\\\\").replace(/&/g,"&amp;").replace(/"/g,"\\&#34;").replace(/\n/g,"&#10;").replace(/\t/g,"&#9;").replace(/</g,"&lt;").replace(/>/g,"&gt;")}function Gr(e){return JSON.stringify(e).slice(1,-1)}function Vr(e,n){const t=e.lastIndexOf("<",n),r=e.lastIndexOf(">",n);if(t<=r)return"text";const o=e.slice(t,n);if((o.match(/"/g)??[]).length%2===0)return"text";const l=o.lastIndexOf('"');return(o.slice(l+1).match(/&#34;|&quot;/g)??[]).length%2===1?"feel-literal":"attribute"}function Yr(e,n,t="xml"){const r=[],o=new Set;return{result:e.replace(Or,(l,m,p)=>{const a=m.trim();if(!Object.prototype.hasOwnProperty.call(n,a))return o.has(a)||(o.add(a),r.push(a)),l;const u=n[a];if(t==="json")return Gr(u);const h=Vr(e,p);return h==="feel-literal"?$r(u):h==="attribute"?Ur(u):Dt(u)}),unresolved:r}}function Qr(){return{processes:[],diagnostics:[],processId:"",processName:"",tasks:[],agent:null,agents:[],userTasks:[],startFormId:void 0}}function qr(e,n={},t=e.bpmn,r={}){const o=[],s=en(e.templates,r),{result:l,unresolved:m}=Yr(t,s,"xml");for(const _ of m)o.push({severity:"warning",message:`Template placeholder "{{${_}}}" has no matching prompt/template content — left in the model as-is, not substituted.`});let p;try{p=Ir(l)}catch(_){return o.push({severity:"error",message:_ instanceof Error?_.message:String(_)}),{resolvedBpmn:l,model:Qr(),handlers:{},forms:{},diagnostics:o,hasErrors:!0}}o.push(...p.diagnostics);const a=p.processes.flatMap(_=>_.tasks),u=new Map(e.handlers.map(_=>[_.elementId,_.source])),h={};for(const _ of a){if(_.compound)continue;const v=n[_.elementId]??u.get(_.elementId);if(v===void 0){o.push({severity:"error",elementId:_.elementId,jobType:_.jobType,message:`No handler for "${_.label}" (${_.elementId}, job type "${_.jobType}"). Add a handler for this element, or remove it from the diagram.`});continue}try{h[_.elementId]=Br(v)}catch(M){o.push({severity:"error",elementId:_.elementId,jobType:_.jobType,message:`"${_.label}" (${_.elementId}): handler code didn't compile — ${M instanceof Error?M.message:String(M)}`})}}const d=new Set(a.map(_=>_.elementId)),b=new Set([...u.keys(),...Object.keys(n)]);for(const _ of b)d.has(_)||o.push({severity:"error",elementId:_,message:`Handler "${_}" doesn't match any element in the current diagram — likely orphaned by a rename. Rename it back, or remove the handler.`});const f={},x=e.forms??{},k=(_,v)=>{if(!_)return;const M=x[_];M?f[_]=M:o.push({severity:"error",formId:_,message:`${v} references form "${_}", which has no matching schema.`})};for(const _ of p.processes){k(_.startFormId,`The start event of process "${_.processName}"`);for(const v of _.userTasks)k(v.formId,`User task "${v.label}" (${v.elementId})`)}return{resolvedBpmn:l,model:p,handlers:h,forms:f,diagnostics:o,hasErrors:o.some(_=>_.severity==="error")}}function Jr(e){const n=e.indexOf("{");if(n<0)return null;let t=0;for(let r=n;r<e.length;r++)if(e[r]==="{")t++;else if(e[r]==="}"&&(t--,t===0))try{const o=JSON.parse(e.slice(n,r+1));return typeof o=="object"&&o!==null&&!Array.isArray(o)?o:null}catch{return null}return null}function Sn(e,n=220){const t=e.replace(/\s+/g," ").trim();return t.length>n?`${t.slice(0,n-1)}…`:t}function Xn(e){const n=e.arguments??e.args??e.parameters??e.input;return n&&typeof n=="object"&&!Array.isArray(n)?n:{}}function et(e){if(!e)return[];const n=e.tool??e.name??e.action;if(typeof n=="string"&&n.trim())return[{name:n.trim(),args:Xn(e)}];const t=e.tools??e.tool_calls??e.toolset??e.actions,r=Array.isArray(t)?t:Object.values(e).find(s=>Array.isArray(s))??[],o=[];for(const s of r)if(typeof s=="string")s.trim()&&o.push({name:s.trim(),args:{}});else if(s&&typeof s=="object"){const l=s,m=l.name??l.tool??l.id??l.function;typeof m=="string"&&m.trim()&&o.push({name:m.trim(),args:Xn(l)})}return o}function Hr(e){if(!e)return!1;const n=e.done??e.finished??e.complete;return typeof n=="boolean"?n:typeof n=="string"?n.toLowerCase()==="true":!1}function nt(e){const n=e.args.length?e.args.map(r=>`      ${r.name} (${r.type}) — ${r.description}`).join(`
`):"      (none)",t=e.documentation||e.label;return`${e.elementId}
    purpose: ${t}
    arguments:
${n}`}function Wr(e,n,t){const r=e.systemPrompt||"You are an agent driving a business process. Use the tools available to you.",o=t[0]??e.tools[0],s=o!=null&&o.args.length?`{${o.args.map(l=>`"${l.name}": "…"`).join(", ")}}`:"{}";return n?`${r}
...
character, with nothing added. When your work is finished, reply exactly
{"done": true} and no tool.`}function Zr(e,n,t,r,o=[],s=[],l=!1){const m=e.userPrompt||"Carry out your task.",p=Object.entries(n).filter(([,u])=>typeof u=="string"&&u.trim().length>0).map(([u,h])=>`  ${u}: ${String(h)}`),a=[m,p.length?`Case data:
${p.join(`
...
`)}async function Kr(e,n,t,r,o,s){let l="";n({kind:"llm",text:"LLM thinking…",key:t,pending:!0,turn:s});const m=await e(r,o,p=>{l+=p,n({kind:"llm",text:`${Sn(l)} ▍`,key:t,pending:!0,turn:s})});return n({kind:"llm",text:Sn(m||l)||"(empty reply)",key:t,pending:!1,turn:s}),m}function Xr(e,n){switch(e){case"number":return typeof n=="number"&&Number.isFinite(n)?{ok:!0,value:n}:typeof n=="string"&&n.trim()!==""&&Number.isFinite(Number(n))?{ok:!0,value:Number(n)}:{ok:!1};case"boolean":return typeof n=="boolean"?{ok:!0,value:n}:typeof n=="string"&&/^(true|false)$/i.test(n.trim())?{ok:!0,value:n.trim().toLowerCase()==="true"}:{ok:!1};default:return typeof n=="object"?{ok:!1}:{ok:!0,value:String(n)}}}function ei(e,n,t){const r={},o=new Map,s=new Map;for(const{tool:l,args:m}of e){const p={};for(const a of l.args){const u=m[a.name];if(!(u!=null&&u!=="")){n({kind:"error",text:`🤖 ${l.elementId}: model supplied no value for "${a.name}"`,turn:t,elementId:l.elementId});continue}const d=o.get(a.name);if(d!==void 0&&d!==l.elementId){n({kind:"error",text:`🤖 argument name collision on "${a.name}": both ${d} and ${l.elementId} declare it — ${d} already claimed it this turn, ${l.elementId}'s value is dropped`,turn:t,elementId:l.elementId});continue}const b=Xr(a.type,u);if(!b.ok){n({kind:"error",text:`🤖 ${l.elementId}: "${a.name}" is declared as ${a.type} but the model supplied ${JSON.stringify(u)} — rejected, not passed through`,turn:t,elementId:l.elementId});continue}r[a.name]=b.value,p[a.name]=b.value,o.set(a.name,l.elementId)}s.set(l.elementId,p)}return{variablesOut:r,forHistory:s}}function ni(e,n,t,r={}){const{maxNewTokens:o=384,allowRepeats:s=!1,allowMultiToolTurns:l=!1,turnRef:m,requiredTools:p=[],maxEarlyDoneNudges:a=1,maxUnproductiveTurns:u=3}=r;let h=0;const d=new Set,b=[];let f=0,x=[],k=[];return async _=>{const v=_.variables,M=v.toolCallResult;M!==void 0&&b.length&&(b[b.length-1]=`${b[b.length-1]} → ${Sn(JSON.stringify(M),160)}`);let Y=0;for(;;){const V=await H();if(V)return V;if(Y+=1,Y>=u)return t({kind:"error",text:`🤖 ${Y} turns in a row activated nothing — completing the agent. The model has lost the reply format; whatever it has already run stands.`,turn:h}),{completionConditionFulfilled:!0}}async function H(){if(h+=1,m&&(m.current=h),h>e.maxModelCalls)return t({kind:"error",text:`Turn budget spent (maxModelCalls=${e.maxModelCalls}) — completing the agent.`,turn:h}),{completionConditionFulfilled:!0};const V=s?e.tools:e.tools.filter(E=>!d.has(E.elementId));if(V.length===0)return t({kind:"agent",text:"🤖 every tool has run — completing the agent",turn:h}),{completionConditionFulfilled:!0};const Me=[{role:"system",content:Wr(e,l,V)},{role:"user",content:Zr(e,v,b,V,x,k,s)}];x=[],k=[];let Pe;try{Pe=await Kr(n,t,`llm-turn-${h}`,Me,o,h)}catch(E){return t({kind:"error",text:`LLM call failed: ${E instanceof Error?E.message:String(E)} — completing the agent.`,turn:h}),{completionConditionFulfilled:!0}}const fe=Jr(Pe);if(Hr(fe)&&et(fe).length===0){const E=p.filter(L=>!d.has(L));return E.length&&f<a?(f+=1,x=E,t({kind:"agent",text:`🤖 model says it is done, but ${E.join(", ")} hasn't run — asking once more`,turn:h}),null):(t({kind:"agent",text:"🤖 model says it is done",turn:h}),{completionConditionFulfilled:!0})}const Ee=et(fe);if(Ee.length===0)return t({kind:"error",text:"🤖 model named no tool (and didn't say it was done) — asking again",turn:h}),k=['it named no tool and did not say it was done — reply with {"tool": "...", "arguments": {...}} or {"done": true}'],null;const K=[],he=[],ce=[];for(const E of Ee){const L=e.tools.find($=>$.elementId===E.name);if(!L){he.push(E.name);continue}if(!s&&d.has(L.elementId)){ce.push(L.elementId);continue}K.push({tool:L,args:E.args})}if(he.length&&t({kind:"error",text:`🤖 model named a tool that doesn't exist: ${he.join(", ")} — nothing activated`,turn:h}),ce.length&&t({kind:"error",text:`🤖 model asked to re-run ${ce.join(", ")} — skipped (already run)`,turn:h}),K.length===0)return t({kind:"agent",text:"🤖 nothing activated — asking again",turn:h}),k=[...he.length?[`${he.join(", ")} ${he.length===1?"is":"are"} not a real tool`]:[],...ce.length?[`${ce.join(", ")} has already run and will never run again — pick a different tool, or reply {"done": true} if nothing is left to do`]:[]],null;const{variablesOut:S,forHistory:I}=ei(K,t,h);for(const{tool:E}of K)d.add(E.elementId),b.push(`- ${E.elementId}(${JSON.stringify(I.get(E.elementId))})`);for(const{tool:E}of K)t({kind:"agent",text:`🤖 calling ${E.elementId}`,turn:h,elementId:E.elementId,args:I.get(E.elementId)??{}});return{activateElements:K.map(E=>({elementId:E.tool.elementId})),variables:S}}}}function ti(e,n,t,r={}){const o=new Map(e.map(s=>[s.elementId,ni(s,n,t,r)]));return async s=>{const l=o.get(s.elementId);if(!l)throw new Error(`No agent host registered for "${s.elementId}"`);return l(s)}}class Pn{__destroy_into_raw(){const n=this.__wbg_ptr;return this.__wbg_ptr=0,tt.unregister(this),n}free(){const n=this.__destroy_into_raw();c.__wbg_testengine_free(n,0)}activateJobs(n,t,r,o){let s,l;try{const b=c.__wbindgen_add_to_stack_pointer(-16),f=C(n,c.__wbindgen_export,c.__wbindgen_export2),x=P,k=C(o,c.__wbindgen_export,c.__wbindgen_export2),_=P;c.testengine_activateJobs(b,this.__wbg_ptr,f,x,t,r,k,_);var m=y().getInt32(b+0,!0),p=y().getInt32(b+4,!0),a=y().getInt32(b+8,!0),u=y().getInt32(b+12,!0),h=m,d=p;if(u)throw h=0,d=0,O(a);return s=h,l=d,F(h,d)}finally{c.__wbindgen_add_to_stack_pointer(16),c.__wbindgen_export3(s,l,1)}}advanceTime(n){let t,r;try{const u=c.__wbindgen_add_to_stack_pointer(-16);c.testengine_advanceTime(u,this.__wbg_ptr,n);var o=y().getInt32(u+0,!0),s=y().getInt32(u+4,!0),l=y().getInt32(u+8,!0),m=y().getInt32(u+12,!0),p=o,a=s;if(m)throw p=0,a=0,O(l);return t=p,r=a,F(p,a)}finally{c.__wbindgen_add_to_stack_pointer(16),c.__wbindgen_export3(t,r,1)}}assignUserTask(n,t,r){let o,s;try{const d=c.__wbindgen_add_to_stack_pointer(-16),b=C(n,c.__wbindgen_export,c.__wbindgen_export2),f=P,x=C(t,c.__wbindgen_export,c.__wbindgen_export2),k=P;c.testengine_assignUserTask(d,this.__wbg_ptr,b,f,x,k,r);var l=y().getInt32(d+0,!0),m=y().getInt32(d+4,!0),p=y().getInt32(d+8,!0),a=y().getInt32(d+12,!0),u=l,h=m;if(a)throw u=0,h=0,O(p);return o=u,s=h,F(u,h)}finally{c.__wbindgen_add_to_stack_pointer(16),c.__wbindgen_export3(o,s,1)}}broadcastSignal(n,t){let r,o;try{const h=c.__wbindgen_add_to_stack_pointer(-16),d=C(n,c.__wbindgen_export,c.__wbindgen_export2),b=P,f=C(t,c.__wbindgen_export,c.__wbindgen_export2),x=P;c.testengine_broadcastSignal(h,this.__wbg_ptr,d,b,f,x);var s=y().getInt32(h+0,!0),l=y().getInt32(h+4,!0),m=y().getInt32(h+8,!0),p=y().getInt32(h+12,!0),a=s,u=l;if(p)throw a=0,u=0,O(m);return r=a,o=u,F(a,u)}finally{c.__wbindgen_add_to_stack_pointer(16),c.__wbindgen_export3(r,o,1)}}cancelInstance(n){let t,r;try{const u=c.__wbindgen_add_to_stack_pointer(-16),h=C(n,c.__wbindgen_export,c.__wbindgen_export2),d=P;c.testengine_cancelInstance(u,this.__wbg_ptr,h,d);var o=y().getInt32(u+0,!0),s=y().getInt32(u+4,!0),l=y().getInt32(u+8,!0),m=y().getInt32(u+12,!0),p=o,a=s;if(m)throw p=0,a=0,O(l);return t=p,r=a,F(p,a)}finally{c.__wbindgen_add_to_stack_pointer(16),c.__wbindgen_export3(t,r,1)}}completeAgentJob(n,t,r){let o,s;try{const d=c.__wbindgen_add_to_stack_pointer(-16),b=C(n,c.__wbindgen_export,c.__wbindgen_export2),f=P,x=C(t,c.__wbindgen_export,c.__wbindgen_export2),k=P,_=C(r,c.__wbindgen_export,c.__wbindgen_export2),v=P;c.testengine_completeAgentJob(d,this.__wbg_ptr,b,f,x,k,_,v);var l=y().getInt32(d+0,!0),m=y().getInt32(d+4,!0),p=y().getInt32(d+8,!0),a=y().getInt32(d+12,!0),u=l,h=m;if(a)throw u=0,h=0,O(p);return o=u,s=h,F(u,h)}finally{c.__wbindgen_add_to_stack_pointer(16),c.__wbindgen_export3(o,s,1)}}completeJob(n,t){let r,o;try{const h=c.__wbindgen_add_to_stack_pointer(-16),d=C(n,c.__wbindgen_export,c.__wbindgen_export2),b=P,f=C(t,c.__wbindgen_export,c.__wbindgen_export2),x=P;c.testengine_completeJob(h,this.__wbg_ptr,d,b,f,x);var s=y().getInt32(h+0,!0),l=y().getInt32(h+4,!0),m=y().getInt32(h+8,!0),p=y().getInt32(h+12,!0),a=s,u=l;if(p)throw a=0,u=0,O(m);return r=a,o=u,F(a,u)}finally{c.__wbindgen_add_to_stack_pointer(16),c.__wbindgen_export3(r,o,1)}}completeUserTask(n,t){let r,o;try{const h=c.__wbindgen_add_to_stack_pointer(-16),d=C(n,c.__wbindgen_export,c.__wbindgen_export2),b=P,f=C(t,c.__wbindgen_export,c.__wbindgen_export2),x=P;c.testengine_completeUserTask(h,this.__wbg_ptr,d,b,f,x);var s=y().getInt32(h+0,!0),l=y().getInt32(h+4,!0),m=y().getInt32(h+8,!0),p=y().getInt32(h+12,!0),a=s,u=l;if(p)throw a=0,u=0,O(m);return r=a,o=u,F(a,u)}finally{c.__wbindgen_add_to_stack_pointer(16),c.__wbindgen_export3(r,o,1)}}correlateMessage(n,t,r){let o,s;try{const d=c.__wbindgen_add_to_stack_pointer(-16),b=C(n,c.__wbindgen_export,c.__wbindgen_export2),f=P,x=C(t,c.__wbindgen_export,c.__wbindgen_export2),k=P,_=C(r,c.__wbindgen_export,c.__wbindgen_export2),v=P;c.testengine_correlateMessage(d,this.__wbg_ptr,b,f,x,k,_,v);var l=y().getInt32(d+0,!0),m=y().getInt32(d+4,!0),p=y().getInt32(d+8,!0),a=y().getInt32(d+12,!0),u=l,h=m;if(a)throw u=0,h=0,O(p);return o=u,s=h,F(u,h)}finally{c.__wbindgen_add_to_stack_pointer(16),c.__wbindgen_export3(o,s,1)}}createInstance(n,t,r){let o,s;try{const d=c.__wbindgen_add_to_stack_pointer(-16),b=C(n,c.__wbindgen_export,c.__wbindgen_export2),f=P,x=C(t,c.__wbindgen_export,c.__wbindgen_export2),k=P;c.testengine_createInstance(d,this.__wbg_ptr,b,f,x,k,si(r)?Number.MAX_SAFE_INTEGER:r>>0);var l=y().getInt32(d+0,!0),m=y().getInt32(d+4,!0),p=y().getInt32(d+8,!0),a=y().getInt32(d+12,!0),u=l,h=m;if(a)throw u=0,h=0,O(p);return o=u,s=h,F(u,h)}finally{c.__wbindgen_add_to_stack_pointer(16),c.__wbindgen_export3(o,s,1)}}debugClear(){c.testengine_debugClear(this.__wbg_ptr)}debugCreateInstance(n,t,r){let o,s;try{const d=c.__wbindgen_add_to_stack_pointer(-16),b=C(n,c.__wbindgen_export,c.__wbindgen_export2),f=P,x=C(t,c.__wbindgen_export,c.__wbindgen_export2),k=P,_=C(r,c.__wbindgen_export,c.__wbindgen_export2),v=P;c.testengine_debugCreateInstance(d,this.__wbg_ptr,b,f,x,k,_,v);var l=y().getInt32(d+0,!0),m=y().getInt32(d+4,!0),p=y().getInt32(d+8,!0),a=y().getInt32(d+12,!0),u=l,h=m;if(a)throw u=0,h=0,O(p);return o=u,s=h,F(u,h)}finally{c.__wbindgen_add_to_stack_pointer(16),c.__wbindgen_export3(o,s,1)}}get debugIsPaused(){return c.testengine_debugIsPaused(this.__wbg_ptr)!==0}debugResume(){let n,t;try{const a=c.__wbindgen_add_to_stack_pointer(-16);c.testengine_debugResume(a,this.__wbg_ptr);var r=y().getInt32(a+0,!0),o=y().getInt32(a+4,!0),s=y().getInt32(a+8,!0),l=y().getInt32(a+12,!0),m=r,p=o;if(l)throw m=0,p=0,O(s);return n=m,t=p,F(m,p)}finally{c.__wbindgen_add_to_stack_pointer(16),c.__wbindgen_export3(n,t,1)}}debugStep(){let n,t;try{const a=c.__wbindgen_add_to_stack_pointer(-16);c.testengine_debugStep(a,this.__wbg_ptr);var r=y().getInt32(a+0,!0),o=y().getInt32(a+4,!0),s=y().getInt32(a+8,!0),l=y().getInt32(a+12,!0),m=r,p=o;if(l)throw m=0,p=0,O(s);return n=m,t=p,F(m,p)}finally{c.__wbindgen_add_to_stack_pointer(16),c.__wbindgen_export3(n,t,1)}}deploy(n){let t,r;try{const u=c.__wbindgen_add_to_stack_pointer(-16),h=C(n,c.__wbindgen_export,c.__wbindgen_export2),d=P;c.testengine_deploy(u,this.__wbg_ptr,h,d);var o=y().getInt32(u+0,!0),s=y().getInt32(u+4,!0),l=y().getInt32(u+8,!0),m=y().getInt32(u+12,!0),p=o,a=s;if(m)throw p=0,a=0,O(l);return t=p,r=a,F(p,a)}finally{c.__wbindgen_add_to_stack_pointer(16),c.__wbindgen_export3(t,r,1)}}deployForm(n){let t,r;try{const u=c.__wbindgen_add_to_stack_pointer(-16),h=C(n,c.__wbindgen_export,c.__wbindgen_export2),d=P;c.testengine_deployForm(u,this.__wbg_ptr,h,d);var o=y().getInt32(u+0,!0),s=y().getInt32(u+4,!0),l=y().getInt32(u+8,!0),m=y().getInt32(u+12,!0),p=o,a=s;if(m)throw p=0,a=0,O(l);return t=p,r=a,F(p,a)}finally{c.__wbindgen_add_to_stack_pointer(16),c.__wbindgen_export3(t,r,1)}}deployResource(n,t){let r,o;try{const h=c.__wbindgen_add_to_stack_pointer(-16),d=C(n,c.__wbindgen_export,c.__wbindgen_export2),b=P,f=C(t,c.__wbindgen_export,c.__wbindgen_export2),x=P;c.testengine_deployResource(h,this.__wbg_ptr,d,b,f,x);var s=y().getInt32(h+0,!0),l=y().getInt32(h+4,!0),m=y().getInt32(h+8,!0),p=y().getInt32(h+12,!0),a=s,u=l;if(p)throw a=0,u=0,O(m);return r=a,o=u,F(a,u)}finally{c.__wbindgen_add_to_stack_pointer(16),c.__wbindgen_export3(r,o,1)}}events(){let n,t;try{const a=c.__wbindgen_add_to_stack_pointer(-16);c.testengine_events(a,this.__wbg_ptr);var r=y().getInt32(a+0,!0),o=y().getInt32(a+4,!0),s=y().getInt32(a+8,!0),l=y().getInt32(a+12,!0),m=r,p=o;if(l)throw m=0,p=0,O(s);return n=m,t=p,F(m,p)}finally{c.__wbindgen_add_to_stack_pointer(16),c.__wbindgen_export3(n,t,1)}}failJob(n,t,r){let o,s;try{const d=c.__wbindgen_add_to_stack_pointer(-16),b=C(n,c.__wbindgen_export,c.__wbindgen_export2),f=P,x=C(r,c.__wbindgen_export,c.__wbindgen_export2),k=P;c.testengine_failJob(d,this.__wbg_ptr,b,f,t,x,k);var l=y().getInt32(d+0,!0),m=y().getInt32(d+4,!0),p=y().getInt32(d+8,!0),a=y().getInt32(d+12,!0),u=l,h=m;if(a)throw u=0,h=0,O(p);return o=u,s=h,F(u,h)}finally{c.__wbindgen_add_to_stack_pointer(16),c.__wbindgen_export3(o,s,1)}}migrate(n,t,r){let o,s;try{const d=c.__wbindgen_add_to_stack_pointer(-16),b=C(n,c.__wbindgen_export,c.__wbindgen_export2),f=P,x=C(t,c.__wbindgen_export,c.__wbindgen_export2),k=P,_=C(r,c.__wbindgen_export,c.__wbindgen_export2),v=P;c.testengine_migrate(d,this.__wbg_ptr,b,f,x,k,_,v);var l=y().getInt32(d+0,!0),m=y().getInt32(d+4,!0),p=y().getInt32(d+8,!0),a=y().getInt32(d+12,!0),u=l,h=m;if(a)throw u=0,h=0,O(p);return o=u,s=h,F(u,h)}finally{c.__wbindgen_add_to_stack_pointer(16),c.__wbindgen_export3(o,s,1)}}modify(n,t,r){let o,s;try{const d=c.__wbindgen_add_to_stack_pointer(-16),b=C(n,c.__wbindgen_export,c.__wbindgen_export2),f=P,x=C(t,c.__wbindgen_export,c.__wbindgen_export2),k=P,_=C(r,c.__wbindgen_export,c.__wbindgen_export2),v=P;c.testengine_modify(d,this.__wbg_ptr,b,f,x,k,_,v);var l=y().getInt32(d+0,!0),m=y().getInt32(d+4,!0),p=y().getInt32(d+8,!0),a=y().getInt32(d+12,!0),u=l,h=m;if(a)throw u=0,h=0,O(p);return o=u,s=h,F(u,h)}finally{c.__wbindgen_add_to_stack_pointer(16),c.__wbindgen_export3(o,s,1)}}constructor(){const n=c.testengine_new();return this.__wbg_ptr=n,tt.register(this,this.__wbg_ptr,this),this}get now(){return c.testengine_now(this.__wbg_ptr)}reset(){c.testengine_reset(this.__wbg_ptr)}resolveIncident(n){let t,r;try{const u=c.__wbindgen_add_to_stack_pointer(-16),h=C(n,c.__wbindgen_export,c.__wbindgen_export2),d=P;c.testengine_resolveIncident(u,this.__wbg_ptr,h,d);var o=y().getInt32(u+0,!0),s=y().getInt32(u+4,!0),l=y().getInt32(u+8,!0),m=y().getInt32(u+12,!0),p=o,a=s;if(m)throw p=0,a=0,O(l);return t=p,r=a,F(p,a)}finally{c.__wbindgen_add_to_stack_pointer(16),c.__wbindgen_export3(t,r,1)}}setVariables(n,t,r){let o,s;try{const d=c.__wbindgen_add_to_stack_pointer(-16),b=C(n,c.__wbindgen_export,c.__wbindgen_export2),f=P,x=C(t,c.__wbindgen_export,c.__wbindgen_export2),k=P;c.testengine_setVariables(d,this.__wbg_ptr,b,f,x,k,r);var l=y().getInt32(d+0,!0),m=y().getInt32(d+4,!0),p=y().getInt32(d+8,!0),a=y().getInt32(d+12,!0),u=l,h=m;if(a)throw u=0,h=0,O(p);return o=u,s=h,F(u,h)}finally{c.__wbindgen_add_to_stack_pointer(16),c.__wbindgen_export3(o,s,1)}}snapshot(){let n,t;try{const a=c.__wbindgen_add_to_stack_pointer(-16);c.testengine_snapshot(a,this.__wbg_ptr);var r=y().getInt32(a+0,!0),o=y().getInt32(a+4,!0),s=y().getInt32(a+8,!0),l=y().getInt32(a+12,!0),m=r,p=o;if(l)throw m=0,p=0,O(s);return n=m,t=p,F(m,p)}finally{c.__wbindgen_add_to_stack_pointer(16),c.__wbindgen_export3(n,t,1)}}throwError(n,t,r){let o,s;try{const d=c.__wbindgen_add_to_stack_pointer(-16),b=C(n,c.__wbindgen_export,c.__wbindgen_export2),f=P,x=C(t,c.__wbindgen_export,c.__wbindgen_export2),k=P,_=C(r,c.__wbindgen_export,c.__wbindgen_export2),v=P;c.testengine_throwError(d,this.__wbg_ptr,b,f,x,k,_,v);var l=y().getInt32(d+0,!0),m=y().getInt32(d+4,!0),p=y().getInt32(d+8,!0),a=y().getInt32(d+12,!0),u=l,h=m;if(a)throw u=0,h=0,O(p);return o=u,s=h,F(u,h)}finally{c.__wbindgen_add_to_stack_pointer(16),c.__wbindgen_export3(o,s,1)}}tickNow(n){let t,r;try{const u=c.__wbindgen_add_to_stack_pointer(-16);c.testengine_tickNow(u,this.__wbg_ptr,n);var o=y().getInt32(u+0,!0),s=y().getInt32(u+4,!0),l=y().getInt32(u+8,!0),m=y().getInt32(u+12,!0),p=o,a=s;if(m)throw p=0,a=0,O(l);return t=p,r=a,F(p,a)}finally{c.__wbindgen_add_to_stack_pointer(16),c.__wbindgen_export3(t,r,1)}}unassignUserTask(n){let t,r;try{const u=c.__wbindgen_add_to_stack_pointer(-16),h=C(n,c.__wbindgen_export,c.__wbindgen_export2),d=P;c.testengine_unassignUserTask(u,this.__wbg_ptr,h,d);var o=y().getInt32(u+0,!0),s=y().getInt32(u+4,!0),l=y().getInt32(u+8,!0),m=y().getInt32(u+12,!0),p=o,a=s;if(m)throw p=0,a=0,O(l);return t=p,r=a,F(p,a)}finally{c.__wbindgen_add_to_stack_pointer(16),c.__wbindgen_export3(t,r,1)}}updateRetries(n,t){let r,o;try{const h=c.__wbindgen_add_to_stack_pointer(-16),d=C(n,c.__wbindgen_export,c.__wbindgen_export2),b=P;c.testengine_updateRetries(h,this.__wbg_ptr,d,b,t);var s=y().getInt32(h+0,!0),l=y().getInt32(h+4,!0),m=y().getInt32(h+8,!0),p=y().getInt32(h+12,!0),a=s,u=l;if(p)throw a=0,u=0,O(m);return r=a,o=u,F(a,u)}finally{c.__wbindgen_add_to_stack_pointer(16),c.__wbindgen_export3(r,o,1)}}updateUserTask(n,t){let r,o;try{const h=c.__wbindgen_add_to_stack_pointer(-16),d=C(n,c.__wbindgen_export,c.__wbindgen_export2),b=P,f=C(t,c.__wbindgen_export,c.__wbindgen_export2),x=P;c.testengine_updateUserTask(h,this.__wbg_ptr,d,b,f,x);var s=y().getInt32(h+0,!0),l=y().getInt32(h+4,!0),m=y().getInt32(h+8,!0),p=y().getInt32(h+12,!0),a=s,u=l;if(p)throw a=0,u=0,O(m);return r=a,o=u,F(a,u)}finally{c.__wbindgen_add_to_stack_pointer(16),c.__wbindgen_export3(r,o,1)}}}Symbol.dispose&&(Pn.prototype[Symbol.dispose]=Pn.prototype.free);function ri(){return{__proto__:null,"./nanobpmn_engine_bg.js":{__proto__:null,__wbg___wbindgen_throw_bb96b2010945f0bc:function(n,t){throw new Error(F(n,t))},__wbindgen_cast_0000000000000001:function(n,t){const r=F(n,t);return ii(r)},__wbindgen_object_drop_ref:function(n){O(n)}}}}const tt=typeof FinalizationRegistry>"u"?{register:()=>{},unregister:()=>{}}:new FinalizationRegistry(e=>c.__wbg_testengine_free(e,1));function ii(e){Ke===je.length&&je.push(je.length+1);const n=Ke;return Ke=je[n],je[n]=e,n}function oi(e){e<1028||(je[e]=Ke,Ke=e)}let Fe=null;function y(){return(Fe===null||Fe.buffer.detached===!0||Fe.buffer.detached===void 0&&Fe.buffer!==c.memory.buffer)&&(Fe=new DataView(c.memory.buffer)),Fe}function F(e,n){return li(e>>>0,n)}let Ze=null;function dn(){return(Ze===null||Ze.byteLength===0)&&(Ze=new Uint8Array(c.memory.buffer)),Ze}function ai(e){return je[e]}let je=new Array(1024).fill(void 0);je.push(void 0,null,!0,!1);let Ke=je.length;function si(e){return e==null}function C(e,n,t){if(t===void 0){const m=Xe.encode(e),p=n(m.length,1)>>>0;return dn().subarray(p,p+m.length).set(m),P=m.length,p}let r=e.length,o=n(r,1)>>>0;const s=dn();let l=0;for(;l<r;l++){const m=e.charCodeAt(l);if(m>127)break;s[o+l]=m}if(l!==r){l!==0&&(e=e.slice(l)),o=t(o,r,r=l+e.length*3,1)>>>0;const m=dn().subarray(o+l,o+r),p=Xe.encodeInto(e,m);l+=p.written,o=t(o,r,l,1)>>>0}return P=l,o}function O(e){const n=ai(e);return oi(e),n}let ln=new TextDecoder("utf-8",{ignoreBOM:!0,fatal:!0});ln.decode();const di=2146435072;let yn=0;function li(e,n){return yn+=n,yn>=di&&(ln=new TextDecoder("utf-8",{ignoreBOM:!0,fatal:!0}),ln.decode(),yn=n),ln.decode(dn().subarray(e,e+n))}const Xe=new TextEncoder;"encodeInto"in Xe||(Xe.encodeInto=function(e,n){const t=Xe.encode(e);return n.set(t),{read:e.length,written:t.length}});let P=0,c;function ci(e,n){return c=e.exports,Fe=null,Ze=null,c}async function mi(e,n){if(typeof Response=="function"&&e instanceof Response){if(!e.ok)throw new Error(`failed to fetch Wasm: ${e.status} ${e.statusText} fetching '${e.url}'`);if(typeof WebAssembly.instantiateStreaming=="function")try{return await WebAssembly.instantiateStreaming(e,n)}catch(o){if(t(e.type)&&e.headers.get("Content-Type")!=="application/wasm")console.warn("`WebAssembly.instantiateStreaming` failed because your server does not serve Wasm with `application/wasm` MIME type. Falling back to `WebAssembly.instantiate` which is slower. Original error:\n",o);else throw o}const r=await e.arrayBuffer();return await WebAssembly.instantiate(r,n)}else{const r=await WebAssembly.instantiate(e,n);return r instanceof WebAssembly.Instance?{instance:r,module:e}:r}function t(r){switch(r){case"basic":case"cors":case"default":return!0}return!1}}async function pi(e){if(c!==void 0)return c;e!==void 0&&(Object.getPrototypeOf(e)===Object.prototype?{module_or_path:e}=e:console.warn("using deprecated parameters for the initialization function; pass a single object instead")),e===void 0&&(e=new URL("/web-demo-framework/pr-preview/pr-114/assets/nanobpmn_engine_bg-DRNrIVE8.wasm",import.meta.url));const n=ri();(typeof e=="string"||typeof Request=="function"&&e instanceof Request||typeof URL=="function"&&e instanceof URL)&&(e=fetch(e));const{instance:t,module:r}=await mi(await e,n);return ci(t)}let an=null;function ui(e){return an||(an=pi(void 0).then(()=>{}).catch(n=>{throw an=null,n})),an}function ne(e){return JSON.parse(e)}class hi{constructor(n){R(this,"engine");this.engine=n}deploy(n){return JSON.parse(this.engine.deploy(n))}createInstance(n,t){return ne(this.engine.createInstance(n,t||"{}"))}activateJobs(n,t,r,o){return JSON.parse(this.engine.activateJobs(n,t,r,o))}completeJob(n,t){return ne(this.engine.completeJob(n,t||"{}"))}completeAgentJob(n,t){const{variables:r,...o}=t??{};return ne(this.engine.completeAgentJob(n,JSON.stringify(r??{}),JSON.stringify(o??{})))}failJob(n,t,r){return ne(this.engine.failJob(n,t,r))}throwError(n,t,r){return ne(this.engine.throwError(n,t,r))}updateRetries(n,t){return ne(this.engine.updateRetries(n,t))}resolveIncident(n){return ne(this.engine.resolveIncident(n))}setVariables(n,t,r){return ne(this.engine.setVariables(n,t||"{}",r))}broadcastSignal(n,t){return ne(this.engine.broadcastSignal(n,t||"{}"))}cancelInstance(n){return ne(this.engine.cancelInstance(n))}modify(n,t,r){return ne(this.engine.modify(n,JSON.stringify(t??[]),JSON.stringify(r??[])))}completeUserTask(n,t){return ne(this.engine.completeUserTask(n,t||"{}"))}assignUserTask(n,t,r){return ne(this.engine.assignUserTask(n,t,r))}unassignUserTask(n){return ne(this.engine.unassignUserTask(n))}updateUserTask(n,t){return ne(this.engine.updateUserTask(n,t||"{}"))}correlateMessage(n,t,r){return ne(this.engine.correlateMessage(n,t,r||"{}"))}advanceTime(n){return ne(this.engine.advanceTime(n))}reset(){this.engine.reset()}events(){return JSON.parse(this.engine.events())}snapshot(){return ne(this.engine.snapshot())}free(){this.engine.free()}}async function gi(e){return await ui(),new hi(new Pn)}class Bt extends Error{constructor(t,r){super(t);R(this,"retries");this.name="JobFailure",this.retries=r==null?void 0:r.retries}}function bi(e,n=[]){if(e.instances.filter(o=>!o.completed).length===0)return e.totalInstances>0?"completed":"idle";if(e.incidents.length>0)return"incidents";const r=new Set(n);return e.jobs.some(o=>!r.has(o.jobType))?"unhandledJobs":e.userTasks.some(o=>o.state==="Created")?"userTasks":e.timers.length>0?"timers":e.messageSubscriptions.length>0?"messages":e.signalSubscriptions.length>0?"signals":"idle"}function _i(e,n=[]){const t=new Set(n);return[...new Set(e.jobs.map(r=>r.jobType))].filter(r=>!t.has(r)).sort()}async function fi(e,n,t){let r;try{const o=await n(t);r=JSON.stringify(o??{})}catch(o){const s=o instanceof Bt&&o.retries!==void 0?o.retries:Math.max(0,t.retries-1),l=o instanceof Error?o.message:String(o);e.failJob(t.key,s,l);return}e.completeJob(t.key,r)}async function wi(e,n,t){let r;try{r=await n(t),JSON.stringify(r)}catch(o){const s=o instanceof Bt&&o.retries!==void 0?o.retries:Math.max(0,t.retries-1),l=o instanceof Error?o.message:String(o);e.failJob(t.key,s,l);return}e.completeAgentJob(t.key,r)}async function yi(e,n,t={}){const r=t.maxJobsPerActivation??10,o=t.lockTimeoutMs??3e4,s=t.worker??"bojtos",l=t.agents??{};for(const d of Object.keys(l))if(d in n)throw new Error(`dispatchRound: job type "${d}" is registered as both a worker and an agent — register it as exactly one`);const m=[];for(const[d,b]of Object.entries(n))for(const f of e.activateJobs(d,r,o,s))m.push({handler:b,job:f});const p=[];for(const[d,b]of Object.entries(l))for(const f of e.activateJobs(d,r,o,s))p.push({handler:b,job:f});for(const{handler:d,job:b}of m)await fi(e,d,b);for(const{handler:d,job:b}of p)await wi(e,d,b);const a=e.snapshot(),u=m.length+p.length;if(u>0)return{snapshot:a,handled:u};const h=[...Object.keys(n),...Object.keys(l)];return{snapshot:a,handled:u,reason:bi(a,h),unhandled:_i(a,h)}}function vi({bpmn:e}){const n=g.useRef(null),[t,r]=g.useState("loading"),[o,s]=g.useState(null),[l,m]=g.useState([]),[p,a]=g.useState(null),u=g.useRef(e),h=g.useRef(0),d=g.useRef(null),b=g.useRef(new Map),f=g.useCallback((S,I)=>{b.current.set(S,I)},[]),x=g.useCallback(S=>b.current.get(S),[]),k=g.useCallback((S,I)=>{const E=S.deploy(I);return u.current=I,b.current.clear(),m(E.processIds),a(null),s(null),E.processIds},[]);g.useEffect(()=>{let S=!1;return r("loading"),m([]),a(null),s(null),gi().then(I=>{if(S){I.free();return}try{k(I,e)}catch(E){I.free(),s(String(E)),r("error");return}n.current=I,r("ready")}).catch(I=>{S||(s(String(I)),r("error"))}),()=>{var I;S=!0,(I=n.current)==null||I.free(),n.current=null,b.current.clear()}},[e]);const _=g.useCallback(S=>{const I=n.current;if(!I)return null;try{const E=S(I);return a(E),s(null),E}catch(E){return s(String(E)),null}},[]),v=g.useCallback((S,I)=>_(E=>E.createInstance(S,I)),[_]),M=g.useCallback((S,I)=>_(E=>E.completeUserTask(S,I)),[_]),Y=g.useCallback(S=>_(I=>I.advanceTime(S)),[_]),H=g.useCallback((S,I)=>_(E=>E.broadcastSignal(S,I)),[_]);function V(S,I){const[E]=S.activateJobs(I,1,3e4,"manual-control");if(!E)throw new Error(`No waiting job of type "${I}" to resolve.`);return E}const Me=g.useCallback((S,I)=>_(E=>{const L=V(E,S);return E.completeJob(L.key,I)}),[_]),Pe=g.useCallback((S,I,E)=>_(L=>{const $=V(L,S);return L.throwError($.key,I,E)}),[_]),fe=g.useCallback((S,I,E)=>_(L=>L.correlateMessage(S,I,E)),[_]),Ee=g.useCallback(async(S,I)=>{const E=n.current;if(!E)return null;const L=h.current,$=yi(E,S,I);d.current=$;try{const we=await $;return n.current!==E||h.current!==L?null:(a(we.snapshot),s(null),we)}catch(we){return n.current!==E||h.current!==L||(a(E.snapshot()),s(String(we))),null}finally{d.current===$&&(d.current=null)}},[]),K=g.useCallback(async()=>{var S;await((S=d.current)==null?void 0:S.catch(()=>{}))},[]),he=g.useCallback(async()=>{await K();const S=n.current;if(S){h.current++;try{S.reset(),k(S,u.current)}catch(I){s(String(I))}}},[k,K]),ce=g.useCallback(async S=>{await K();const I=n.current;if(!I)return null;h.current++;try{return I.reset(),k(I,S)}catch(E){return s(String(E)),null}},[k,K]);return{phase:t,error:o,processIds:l,snapshot:p,createInstance:v,stepWorkers:Ee,completeUserTask:M,advanceTime:Y,broadcastSignal:H,completeJobManually:Me,throwJobError:Pe,correlateMessage:fe,reset:he,redeploy:ce,setRunImage:f,getRunImage:x}}function Mi(e,n){return e.slice(n)}function xi(e,n,t,r){const o=e.snapshot,s="⏸ waiting for a human — complete the task below to continue",l=o.userTasks.some(m=>m.state==="Created");if(e.handled>0){const m=o.activeElementIds.map(t),p=n.length?` via ${n.map(a=>`${t(a.from)} → ${t(a.to)}`).join(", ")}`:"";return o.completedInstances>=1?{kind:"done",text:`⏭ round handled ${e.handled} job${e.handled===1?"":"s"}${p} — ✅ process instance completed`}:l?{kind:"human",text:`⏭ round handled ${e.handled} job${e.handled===1?"":"s"}${p} — ${s}`}:{kind:"step",text:`⏭ round handled ${e.handled} job${e.handled===1?"":"s"}${p} — now at ${m.length?m.join(", "):"—"}`}}switch(e.reason){case"completed":return{kind:"done",text:"✅ process instance completed"};case"userTasks":return{kind:"human",text:s};case"timers":return{kind:"step",text:"⏱ waiting on a timer — advance the clock to continue"};case"messages":return{kind:"step",text:"✉ waiting on a message — correlate it to continue"};case"signals":return{kind:"step",text:"📶 waiting on a signal — broadcast it to continue"};case"incidents":return{kind:"error",text:"A job failed — incident on the diagram"};case"unhandledJobs":{const m=e.unhandled??[];return r&&m.length>0&&m.every(p=>r.has(p))?{kind:"human",text:s}:{kind:"error",text:`⏭ waiting on job type(s) with no worker registered: ${m.join(", ")}`}}case"idle":return{kind:"step",text:"Nothing to step — no instance is running."};default:return{kind:"step",text:e.reason?`Step blocked on an unrecognized reason: ${e.reason}`:"Nothing to step — no instance is running."}}}const Ni="the Scripted or Endpoint brain";async function mn(e=Ni){const n=navigator.gpu;if(!n)return`This browser doesn't expose WebGPU at all. Use a recent Chrome, Edge, or Safari 17+ with hardware acceleration on, or pick ${e}.`;let t;try{t=await n.requestAdapter()}catch(r){return`WebGPU adapter request failed (${r instanceof Error?r.message:String(r)}). Try ${e} instead.`}return t?null:`This browser supports the WebGPU API, but no GPU adapter is available — hardware acceleration may be off, or this device/VM has no usable GPU. Pick ${e} instead.`}const Ei=[{id:"Qwen2.5-1.5B-Instruct-q4f16_1-MLC",label:"Qwen2.5 1.5B",downloadLabel:"~1.0 GB"},{id:"SmolLM2-1.7B-Instruct-q4f16_1-MLC",label:"SmolLM2 1.7B",downloadLabel:"~1.1 GB"},{id:"Llama-3.2-1B-Instruct-q4f16_1-MLC",label:"Llama 3.2 1B",downloadLabel:"~0.7 GB"},{id:"gemma-2-2b-it-q4f16_1-MLC",label:"Gemma 2 2B",downloadLabel:"~1.5 GB"},{id:"Llama-3.2-1B-Instruct-q4f32_1-MLC",label:"Llama 3.2 1B (f32, wider GPU support)",downloadLabel:"~1.1 GB"},{id:"SmolLM2-360M-Instruct-q4f32_1-MLC",label:"SmolLM2 360M (tiny, f32)",downloadLabel:"~0.6 GB"},{id:"SmolLM2-360M-Instruct-q4f16_1-MLC",label:"SmolLM2 360M (tiny)",downloadLabel:"~0.3 GB"}];function Lt(e){return An.get(e)??{}}const An=new Map;async function ki(){if(An.size>0)return;const{prebuiltAppConfig:e}=await ue(async()=>{const{prebuiltAppConfig:n}=await import("./vendor-webllm-DT0Ab8E6.js");return{prebuiltAppConfig:n}},[]);for(const n of e.model_list)An.set(n.model_id,{vramRequiredMB:n.vram_required_MB,requiredFeatures:n.required_features})}const gn=Ei.map(e=>({id:e.id,label:`${e.label} (${e.downloadLabel})`,downloadLabel:e.downloadLabel,...Lt(e.id)})),Rt=gn[0].id;async function Ii(){return await ki(),gn.map(e=>({...e,...Lt(e.id)}))}function Ft(){const e=navigator.deviceMemory;return typeof e=="number"?e*1024:null}function Ti(e,n=Ft()){return n==null||e.vramRequiredMB==null||n>=e.vramRequiredMB?null:`${e.label} needs roughly ${Math.round(e.vramRequiredMB)} MB of GPU memory; this device looks like it has about ${Math.round(n)} MB available. It may still work, but expect it to fail or fall back to slow shared memory — try a smaller model (e.g. SmolLM2 360M) if it doesn't load.`}async function ji(e){try{const{hasModelInCache:n}=await ue(async()=>{const{hasModelInCache:t}=await import("./vendor-webllm-DT0Ab8E6.js");return{hasModelInCache:t}},[]);return await n(e)}catch{return!1}}function pn(e){return/device (was )?lost|device_hung|device_removed|already been disposed|gpudevicelostinfo/i.test(e)}function rt(){return"The GPU device was lost — the driver reset while the model was loading or running. This is a browser/driver-level failure, not a problem with the model: fully quit and reopen the browser (a lost device usually persists for the life of the GPU process), check chrome://gpu still reports hardware acceleration, and update your GPU driver if it recurs. The Scripted and Endpoint brains don't use the GPU at all."}class sn{constructor(){R(this,"kind","browser");R(this,"model",null);R(this,"engine",null);R(this,"worker",null);R(this,"generation",0);R(this,"chat",async(n,t=512,r)=>{var s,l;const o=this.engine;if(!o||!this.model)throw new Error("BrowserBrain.chat called before connect()");try{const m=await o.chat.completions.create({messages:n,temperature:0,max_tokens:t,stream:!0});let p="";for await(const a of m){const u=((l=(s=a.choices[0])==null?void 0:s.delta)==null?void 0:l.content)??"";u&&(p+=u,r==null||r(u))}return p}catch(m){const p=m instanceof Error?m.message:String(m);throw pn(p)?(this.teardown(),new Error(`The in-browser model stopped: ${rt()}`)):m}})}async connect(n=Rt,t){var p,a;const r=await mn();if(r)throw new Error(r);if(this.engine&&this.model===n)return n;const o=++this.generation,s=u=>{o===this.generation&&(t==null||t({progress:u.progress??0,text:u.text??""}))};this.teardown();let l,m;try{const{CreateWebWorkerMLCEngine:u}=await ue(async()=>{const{CreateWebWorkerMLCEngine:h}=await import("./vendor-webllm-DT0Ab8E6.js");return{CreateWebWorkerMLCEngine:h}},[]);m=new Worker(new URL("/web-demo-framework/pr-preview/pr-114/assets/webllm.worker-Dc1cCqhL.js",import.meta.url),{type:"module"}),l=await u(m,n,{initProgressCallback:s})}catch(u){if(m==null||m.terminate(),o!==this.generation)throw new Error("cancelled");const h=u instanceof Error?u.message:String(u);if(pn(h))throw new Error(`Couldn't load ${n} in the browser (${h}). ${rt()}`);const d=(a=(p=gn.find(b=>b.id===n))==null?void 0:p.requiredFeatures)==null?void 0:a.includes("shader-f16");throw new Error(`Couldn't load ${n} in the browser (${h}). `+(d?"This model needs WebGPU with shader-f16; try one of the f32 models in the list, or the endpoint brain.":"Try a smaller model, check your connection, or use the endpoint brain instead."))}if(o!==this.generation)throw l.unload().catch(()=>{}),m==null||m.terminate(),new Error("cancelled");return this.engine=l,this.worker=m??null,this.model=n,n}teardown(){const{engine:n,worker:t}=this;this.engine=null,this.worker=null,this.model=null,n==null||n.unload().catch(()=>{}),t==null||t.terminate()}cancelConnect(){this.generation++}dispose(){this.generation++,this.teardown()}}const zt="http://localhost:11434/v1";function un(e,n={hostname:(t=>(t=globalThis.location)==null?void 0:t.hostname)()??"",origin:(r=>(r=globalThis.location)==null?void 0:r.origin)()??""}){let o;try{o=new URL(Ot(e)).hostname}catch{return null}const s=l=>l==="localhost"||l==="127.0.0.1"||l==="::1"||l==="[::1]";return!s(o)||s(n.hostname)?null:`This page is served from ${n.origin||"a non-local origin"}, so it can't reach ${e}. A local model server only accepts requests from a page on localhost. Open this page at http://localhost instead, or use the Scripted or In-browser brain.`}function Ot(e){let n=e.trim().replace(/\/+$/,"");return n.endsWith("/chat/completions")&&(n=n.slice(0,-17)),/\/v\d+$/.test(n)||(n=`${n}/v1`),n}class it extends Error{constructor(n,t){super(n),this.status=t,this.name="HttpError"}}class ot{constructor(n=zt,t="",r=""){R(this,"kind","endpoint");R(this,"baseUrl");R(this,"model",null);R(this,"models",[]);R(this,"apiKey");R(this,"requestedModel");R(this,"chat",async(n,t=512,r)=>{var a,u,h;if(!this.model)throw new Error("EndpointBrain.chat called before connect()");const o=await fetch(`${this.baseUrl}/chat/completions`,{method:"POST",headers:this.headers(),body:JSON.stringify({model:this.model,messages:n,temperature:0,max_tokens:t,stream:!0})});if(!o.ok||!o.body){const d=await o.text().catch(()=>"");throw new Error(`chat/completions HTTP ${o.status} ${o.statusText}${d?` — ${d.slice(0,300)}`:""}`)}const s=o.body.getReader(),l=new TextDecoder;let m="",p="";for(;;){const{value:d,done:b}=await s.read();if(b)break;m+=l.decode(d,{stream:!0});let f;for(;(f=m.indexOf(`
`))>=0;){const x=m.slice(0,f).trim();if(m=m.slice(f+1),!x.startsWith("data:"))continue;const k=x.slice(5).trim();if(k==="[DONE]")continue;let _;try{_=JSON.parse(k)}catch{continue}_.model&&(this.model=_.model);const v=(a=_.choices)==null?void 0:a[0],M=((u=v==null?void 0:v.delta)==null?void 0:u.content)??((h=v==null?void 0:v.message)==null?void 0:h.content)??"";M&&(p+=M,r==null||r(M))}}return p});this.baseUrl=Ot(n),this.apiKey=t.trim(),this.requestedModel=r.trim()}headers(){const n={"Content-Type":"application/json"};return this.apiKey&&(n.Authorization=`Bearer ${this.apiKey}`),n}async listModels(){let n;try{n=await fetch(`${this.baseUrl}/models`,{headers:this.headers()})}catch(r){const o=un(this.baseUrl);throw new Error(o??`Can't reach ${this.baseUrl} (${r instanceof Error?r.message:String(r)}). Is the server running? For Ollama, check the app is up — and if this page is served from another origin, allow it with OLLAMA_ORIGINS.`)}if(!n.ok)throw new it(`${this.baseUrl}/models returned HTTP ${n.status} ${n.statusText}`,n.status);const t=await n.json();return this.models=(t.data??[]).map(r=>r.id).filter(r=>!!r),this.models}async connect(){try{const n=await this.listModels(),t=this.requestedModel||n[0];if(!t)throw new Error(`No models available at ${this.baseUrl}. Pull one first — e.g. \`ollama pull llama3.2:3b\` — or name one explicitly.`);this.model=t}catch(n){const t=n instanceof it&&[404,405,501].includes(n.status);if(!this.requestedModel||!t)throw n;this.models=[],this.model=this.requestedModel}return await this.validate(),this.model}async validate(){const n=await fetch(`${this.baseUrl}/chat/completions`,{method:"POST",headers:this.headers(),body:JSON.stringify({model:this.model,messages:[{role:"user",content:"Reply with ok."}],temperature:0,max_tokens:1,stream:!1})}).catch(r=>{throw new Error(`Can't reach ${this.baseUrl}/chat/completions (${r instanceof Error?r.message:String(r)}). Check the endpoint URL, API key, model name, and any local CORS settings.`)});if(!n.ok){const r=await n.text().catch(()=>"");throw new Error(`chat/completions HTTP ${n.status} ${n.statusText}${r?` — ${r.slice(0,300)}`:""}`)}const t=await n.json().catch(()=>({}));t.model&&(this.model=t.model)}dispose(){}}const at="gemini-nano";function hn(){const e=globalThis.LanguageModel;return typeof(e==null?void 0:e.create)=="function"&&typeof e.availability=="function"?e:null}function Si(){return hn()!==null}async function Ut(){const e=hn();if(!e)return"This browser has no built-in AI model. Chrome's Prompt API (Gemini Nano) needs Chrome 138+ on desktop Windows 10/11, macOS 13+, Linux or a Chromebook Plus. Use the Scripted, In-browser (WebGPU) or API endpoint brain instead.";let n;try{n=await e.availability()}catch(t){return`Chrome couldn't report on its built-in model (${t instanceof Error?t.message:String(t)}).`}return n==="unavailable"?"Chrome exposes the built-in AI API here, but Gemini Nano can't run on this device. Chrome requires ~22 GB free on the volume holding your Chrome profile, and either a GPU with more than 4 GB of VRAM or 16 GB of RAM with 4+ CPU cores. Check chrome://on-device-internals for the details.":null}class st{constructor(){R(this,"kind","chrome");R(this,"model",null);R(this,"warm",null);R(this,"connecting",null);R(this,"chat",async(n,t,r)=>{if(!this.model)throw new Error("ChromeBrain.chat called before connect()");const o=hn();if(!o)throw new Error("Chrome's built-in AI API went away.");const s=n.filter(p=>p.role==="system"),l=n.filter(p=>p.role!=="system"),m=await o.create(s.length?{initialPrompts:s}:void 0);try{const p=m.promptStreaming(l).getReader();let a="";for(;;){const{done:u,value:h}=await p.read();if(u)break;h&&(a+=h,r==null||r(h))}return a}finally{m.destroy()}})}async connect(n){const t=await Ut();if(t)throw new Error(t);const r=hn();this.dispose();const o=new AbortController;this.connecting=o;try{this.warm=await r.create({signal:o.signal,monitor:s=>{s.addEventListener("downloadprogress",l=>{n==null||n({progress:l.loaded,text:"Downloading Gemini Nano"})})}})}catch(s){if(o.signal.aborted)throw new Error("cancelled");const l=s instanceof Error?s.message:String(s);throw new Error(`Chrome couldn't start its built-in model (${l}). The first run downloads Gemini Nano and must be triggered by a click — press Connect again, and check chrome://on-device-internals if it keeps failing.`)}finally{this.connecting=null}return this.model=at,at}cancelConnect(){var n;(n=this.connecting)==null||n.abort()}dispose(){var n,t;(n=this.connecting)==null||n.abort(),this.connecting=null,(t=this.warm)==null||t.destroy(),this.warm=null,this.model=null}}const Pi=[{id:"onnx-community/Florence-2-base-ft",label:"Florence-2 base",downloadLabel:"~0.4 GB"},{id:"onnx-community/Florence-2-large-ft",label:"Florence-2 large (higher quality)",downloadLabel:"~1.6 GB"}],$t=Pi.map(e=>({...e,label:`${e.label} (${e.downloadLabel})`})),Gt=$t[0].id,Ai="<OCR>",dt="UNKNOWN (scripted brain — connect the in-browser model to read a photo)";function Ci(e,n){if(e)return typeof e=="function"?e(n):e[n]}class Di{constructor(n){R(this,"kind","scripted-vision");R(this,"model",null);R(this,"read",async(n,t,r)=>{const o=typeof n=="string"?Ci(this.lookup,n)??dt:dt;return r==null||r(o),o});this.lookup=n}dispose(){}}function Bi(e){return new Di(e)}class lt{constructor(){R(this,"kind","browser-vision");R(this,"model",null);R(this,"modelHandle",null);R(this,"processor",null);R(this,"loadImage",null);R(this,"generation",0);R(this,"read",async(n,t,r)=>{const o=this.modelHandle,s=this.processor,l=this.loadImage;if(!o||!s||!l||!this.model)throw new Error("BrowserVisionBrain.read called before connect()");const m=t&&t.startsWith("<")?t:Ai,p=await l(n),a=s.construct_prompts(m),u=await s(p,a),h=await o.generate({...u,max_new_tokens:512,num_beams:1,do_sample:!1}),d=s.batch_decode(h,{skip_special_tokens:!1})[0],b=s.post_process_generation(d,m,p.size),f=Li(b,m);return r==null||r(f),f})}async connect(n=Gt,t){var m,p;const r=await mn("the scripted-vision fallback");if(r)throw new Error(r);if(this.modelHandle&&this.model===n)return n;const o=++this.generation,s=a=>{o===this.generation&&(t==null||t({progress:(a.progress??0)/100,text:a.file?`${a.status??"loading"} ${a.file}`:a.status??""}))};this.teardown();let l;try{const{Florence2ForConditionalGeneration:a,AutoProcessor:u,load_image:h}=await ue(async()=>{const{Florence2ForConditionalGeneration:f,AutoProcessor:x,load_image:k}=await import("./transformers.web-B-hhwfmJ.js");return{Florence2ForConditionalGeneration:f,AutoProcessor:x,load_image:k}},[]),d=await a.from_pretrained(n,{dtype:"fp32",device:"webgpu",progress_callback:s}),b=await u.from_pretrained(n);l={model:d,processor:b,loadImage:h}}catch(a){if(o!==this.generation)throw new Error("cancelled");const u=a instanceof Error?a.message:String(a);throw new Error(`Couldn't load ${n} in the browser (${u}). Try the smaller Florence-2 base model, check your connection, or use the scripted-vision fallback.`)}if(o!==this.generation)throw Promise.resolve((p=(m=l.model).dispose)==null?void 0:p.call(m)).catch(()=>{}),new Error("cancelled");return this.modelHandle=l.model,this.processor=l.processor,this.loadImage=l.loadImage,this.model=n,n}teardown(){var t;const n=this.modelHandle;this.modelHandle=null,this.processor=null,this.loadImage=null,this.model=null,Promise.resolve((t=n==null?void 0:n.dispose)==null?void 0:t.call(n)).catch(()=>{})}cancelConnect(){this.generation++}dispose(){this.generation++,this.teardown()}}function Li(e,n){const t=e[n];if(typeof t=="string")return t.trim();if(t&&typeof t=="object"){const r=t.labels;return Array.isArray(r)?r.join(" ").trim():JSON.stringify(t)}return""}function Ri(){const[e,n]=g.useState("scripted"),[t,r]=g.useState("idle"),[o,s]=g.useState(null),[l,m]=g.useState(null),[p,a]=g.useState(null),[u,h]=g.useState(null),[d,b]=g.useState(null),[f,x]=g.useState(null),[k,_]=g.useState(null),[v,M]=g.useState(Rt),[Y,H]=g.useState(zt),[V,Me]=g.useState(""),[Pe,fe]=g.useState([]),[Ee,K]=g.useState("idle"),[he,ce]=g.useState(null),[S,I]=g.useState(""),[E,L]=g.useState(null),$=g.useRef(null),[we,Oe]=g.useState("scripted-vision"),[bn,ye]=g.useState("idle"),[Qe,oe]=g.useState(null),[De,nn]=g.useState(Gt),[_n,ve]=g.useState(null),[Be,Ae]=g.useState(null),[fn,wn]=g.useState(null),[qe,X]=g.useState(null),U=g.useRef(null),Je=g.useRef(!1),Ue=g.useRef(0),ke=g.useCallback(j=>async(...Q)=>{try{return await j.chat(...Q)}catch(D){const W=D instanceof Error?D.message:String(D);throw j instanceof sn&&pn(W)&&(L(null),m(null),r("error"),s(W)),D}},[]),Le=g.useCallback(j=>async(...Q)=>{try{return await j.read(...Q)}catch(D){const W=D instanceof Error?D.message:String(D);throw pn(W)&&(X(null),ve(null),ye("error"),oe(W)),D}},[]);g.useEffect(()=>{mn().then(j=>{b(j),h(j===null)}),Ut().then(_),mn("the scripted-vision fallback").then(j=>{wn(j),Je.current||(Je.current=!0,Oe(j===null?"browser-vision":"scripted-vision"))})},[]),g.useEffect(()=>{let j=!1;return x(null),ji(v).then(Q=>{j||x(Q)}),()=>{j=!0}},[v]),g.useEffect(()=>()=>{var j;return(j=$.current)==null?void 0:j.dispose()},[]),g.useEffect(()=>()=>{var j;return(j=U.current)==null?void 0:j.dispose()},[]);const He=g.useCallback(j=>{n(j),r("idle"),s(null),m(null),a(null),L(null)},[]),z=g.useCallback(j=>{var Q,D;Je.current=!0,(Q=U.current)==null||Q.cancelConnect(),(D=U.current)==null||D.dispose(),U.current=null,Oe(j),ye("idle"),oe(null),ve(null),Ae(null),X(null)},[]),me=g.useCallback(()=>{var j;(j=$.current)==null||j.dispose(),$.current=null,L(null),m(null)},[]),Ce=g.useCallback(()=>{const j=$.current;(j instanceof sn||j instanceof st)&&j.cancelConnect(),me(),r("idle"),a(null),s(null)},[me]),Ie=g.useCallback(async()=>{const j=++Ue.current,Q=()=>j!==Ue.current,D=un(Y);if(D){fe([]),K("error"),ce(D);return}K("loading"),ce(null);const W=new ot(Y,S);try{const xe=await W.listModels();if(Q())return;fe(xe),K("ready"),Me(Re=>Re&&xe.includes(Re)?Re:xe[0]??"")}catch(xe){if(Q())return;fe([]),Me(""),K("error"),ce(xe instanceof Error?xe.message:String(xe))}finally{W.dispose()}},[Y,S]),tn=g.useCallback(async()=>{var j,Q;if(e==="scripted"){L(null),r("ready");return}if(e==="endpoint"){const D=un(Y);if(D){me(),s(D),r("error");return}}r("connecting"),s(null),a(null);try{if(e==="browser"){const D=$.current instanceof sn?$.current:new sn;$.current&&$.current!==D&&$.current.dispose(),$.current=D;const W=await D.connect(v,a);m(W),L(()=>ke(D)),x(!0)}else if(e==="chrome"){(j=$.current)==null||j.dispose();const D=new st;$.current=D;const W=await D.connect(a);_(null),m(W),L(()=>ke(D))}else{(Q=$.current)==null||Q.dispose();const D=new ot(Y,S,V);$.current=D;const W=await D.connect();m(W),L(()=>ke(D))}r("ready")}catch(D){const W=D instanceof Error?D.message:String(D);if(W==="cancelled")return;s(W),r("error"),L(null)}finally{a(null)}},[e,v,Y,V,S,me,ke]),ae=g.useCallback(()=>{var j;(j=U.current)==null||j.dispose(),U.current=null,X(null),ve(null)},[]),$e=g.useCallback(()=>{var j;(j=U.current)==null||j.cancelConnect(),ae(),ye("idle"),Ae(null),oe(null)},[ae]),Ge=g.useCallback(async()=>{if(we==="scripted-vision"){ae(),ye("ready"),oe(null);return}ye("connecting"),oe(null),Ae(null);try{const j=U.current instanceof lt?U.current:new lt;U.current&&U.current!==j&&U.current.dispose(),U.current=j;const Q=await j.connect(De,Ae);ve(Q),X(()=>Le(j)),ye("ready")}catch(j){const Q=j instanceof Error?j.message:String(j);if(Q==="cancelled")return;oe(Q),ye("error"),X(null),ve(null)}finally{Ae(null)}},[we,De,ae,Le]);return{kind:e,setKind:He,status:t,error:o,modelInUse:l,progress:p,webgpu:u,webgpuReason:d,browserModelCached:f,chromeAiReason:k,cancelConnect:Ce,browserModel:v,setBrowserModel:M,endpointUrl:Y,setEndpointUrl:H,endpointModel:V,setEndpointModel:Me,endpointModels:Pe,endpointModelsStatus:Ee,endpointModelsError:he,listEndpointModels:Ie,apiKey:S,setApiKey:I,connect:tn,chat:E,visionKind:we,setVisionKind:z,visionStatus:bn,visionError:Qe,visionModel:De,setVisionModel:nn,visionModelInUse:_n,visionProgress:Be,visionWebgpuReason:fn,connectVision:Ge,cancelVisionConnect:$e,vision:qe}}const Cn="#s=",Fi=["scripted","browser","chrome","endpoint"];function zi(e){return typeof e=="string"&&Fi.includes(e)}function Oi(e){try{const n=JSON.parse(e);if(n&&typeof n=="object"){const t=n,r={};return zi(t.brain)&&(r.brain=t.brain),r}}catch{}return{}}function Vt(e=location.hash){if(!e.startsWith(Cn))return{};let n;try{n=decodeURIComponent(e.slice(Cn.length))}catch{return{}}return Oi(n)}function Ui(e){const n=Object.entries(e).filter(([,t])=>t!==void 0);return n.length===0?"":Cn+encodeURIComponent(JSON.stringify(Object.fromEntries(n)))}function $i(e){const n={...Vt(),...e},t=Ui(n),r=new URL(location.href);r.hash=t,history.replaceState(history.state,"",r)}const ct=[{kind:"scripted",label:"Scripted",hint:"No model. The example's stand-in decides — deterministic and offline."},{kind:"browser",label:"In-browser (WebGPU)",hint:"A small quantised model on your GPU. First run downloads weights."},{kind:"chrome",label:"Chrome built-in",hint:"Gemini Nano, built into Chrome. Chrome owns the weights — no download from this page, no API key."},{kind:"endpoint",label:"API endpoint",hint:"Any OpenAI-compatible server. Ollama by default. Local pages only."}],mt=[{kind:"scripted-vision",label:"Scripted",hint:"No model. The example's known plate is returned — deterministic and offline."},{kind:"browser-vision",label:"In-browser (WebGPU)",hint:"Reads the photo with a vision model on your GPU. First run downloads weights."}];function Gi({brain:e,showText:n=!0,showVision:t=!1}){return i.jsxs("div",{className:"brain",children:[n&&i.jsx(Vi,{brain:e}),n&&t&&i.jsx("hr",{className:"brain-divider"}),t&&i.jsx(Yi,{brain:e})]})}function Vi({brain:e}){const n=ct.find(d=>d.kind===e.kind),t=ct.filter(d=>d.kind!=="chrome"||Si()),r=un(e.endpointUrl),[o,s]=g.useState(gn);g.useEffect(()=>{Ii().then(s)},[]);const{kind:l,endpointUrl:m,apiKey:p,listEndpointModels:a}=e;g.useEffect(()=>{if(l!=="endpoint"||r)return;const d=setTimeout(()=>void a(),400);return()=>clearTimeout(d)},[l,m,p,r,a]);const u=o.find(d=>d.id===e.browserModel),h=u?Ti(u,Ft()):null;return i.jsxs("div",{className:"brain-section",children:[i.jsxs("div",{className:"brain-modes",children:[i.jsx("div",{className:"brain-kinds",role:"group","aria-label":"Agent brain",children:t.map(d=>i.jsx(Z,{size:"sm",variant:e.kind===d.kind?"default":"secondary","aria-pressed":e.kind===d.kind,onClick:()=>e.setKind(d.kind),children:d.label},d.kind))}),i.jsxs("div",{className:"brain-status",children:[e.status==="ready"&&e.kind!=="scripted"&&i.jsx(ie,{variant:"success",className:"brain-status-badge",children:e.modelInUse??"connected"}),e.status==="connecting"&&i.jsx(ie,{variant:"info",className:"brain-status-badge",children:"connecting…"}),e.status==="error"&&i.jsx(ie,{variant:"danger",className:"brain-status-badge",children:"not connected"})]})]}),i.jsx("p",{className:"field-hint",children:n.hint}),e.kind==="browser"&&i.jsxs("div",{className:"brain-config",children:[i.jsxs("div",{className:"field",children:[i.jsx(Ye,{htmlFor:"browser-model",children:"Model"}),i.jsxs(Nn,{value:e.browserModel,onValueChange:e.setBrowserModel,disabled:e.status==="connecting",children:[i.jsx(En,{id:"browser-model",children:i.jsx(kn,{})}),i.jsx(In,{children:o.map(d=>i.jsx(Tn,{value:d.id,children:d.label},d.id))})]}),e.browserModelCached===!0&&i.jsx("p",{className:"field-hint",children:"Already downloaded in this browser — connecting will be fast."}),e.browserModelCached===!1&&i.jsx("p",{className:"field-hint",children:"Not downloaded yet — connecting fetches the weights once, then caches them for next time."})]}),e.webgpu===!1&&e.webgpuReason&&i.jsxs(se,{variant:"destructive",children:[i.jsx(de,{children:"No WebGPU in this browser"}),i.jsx(le,{children:e.webgpuReason})]}),e.webgpu!==!1&&h&&i.jsxs(se,{variant:"destructive",children:[i.jsx(de,{children:"This model may not fit in GPU memory"}),i.jsx(le,{children:h})]})]}),e.kind==="chrome"&&i.jsxs("div",{className:"brain-config",children:[i.jsx("p",{className:"field-hint",children:"Nothing to configure: Chrome downloads and manages Gemini Nano itself, so the first Connect may fetch it once and later visits reuse it. Prompts never leave your machine. It's a very small model — expect it to follow the tool-calling format less reliably than an endpoint model."}),e.chromeAiReason&&i.jsxs(se,{variant:"destructive",children:[i.jsx(de,{children:"Chrome's built-in model isn't available here"}),i.jsx(le,{children:e.chromeAiReason})]})]}),e.kind==="endpoint"&&i.jsxs("div",{className:"brain-config",children:[i.jsxs("div",{className:"field",children:[i.jsx(Ye,{htmlFor:"endpoint-url",children:"Endpoint"}),i.jsx(Jn,{id:"endpoint-url",value:e.endpointUrl,onChange:d=>e.setEndpointUrl(d.target.value),disabled:e.status==="connecting"}),i.jsxs("p",{className:"field-hint",children:["Ollama allows ",i.jsx("code",{children:"localhost"})," origins out of the box; set"," ",i.jsx("code",{children:"OLLAMA_ORIGINS"})," only when serving this page from another host. Best for local development — a hosted copy of this page can't reach a server on your machine at all."]}),r&&i.jsxs(se,{variant:"destructive",children:[i.jsx(de,{children:"A local server won't work from this URL"}),i.jsx(le,{children:r})]})]}),i.jsxs("div",{className:"field",children:[i.jsx(Ye,{htmlFor:"endpoint-model",children:"Model"}),i.jsxs("div",{className:"endpoint-model-row",children:[i.jsxs(Nn,{value:e.endpointModel,onValueChange:e.setEndpointModel,disabled:e.status==="connecting"||e.endpointModelsStatus==="loading"||e.endpointModels.length===0,children:[i.jsx(En,{id:"endpoint-model",className:"endpoint-model-select",children:i.jsx(kn,{placeholder:e.endpointModelsStatus==="loading"?"Loading models…":e.endpointModelsStatus==="idle"?"Enter an endpoint above":e.endpointModelsStatus==="error"?"No models — check the endpoint":e.endpointModels.length===0?"No models served":"Select a model"})}),i.jsx(In,{children:e.endpointModels.map(d=>i.jsx(Tn,{value:d,children:d},d))})]}),i.jsx(Z,{size:"sm",variant:"secondary",onClick:()=>void e.listEndpointModels(),disabled:e.status==="connecting"||e.endpointModelsStatus==="loading"||r!==null,children:e.endpointModelsStatus==="loading"?"Refreshing…":"Refresh"})]}),i.jsxs("p",{className:"field-hint",children:["Fetched from the endpoint's ",i.jsx("code",{children:"/models"}),". Tiny models (e.g. SmolLM2) usually can't follow the tool-calling format — prefer ",i.jsx("code",{children:"llama3.2:3b"}),", ",i.jsx("code",{children:"qwen2.5"})," or larger."]}),e.endpointModelsStatus==="error"&&!r&&i.jsxs(se,{variant:"destructive",children:[i.jsx(de,{children:"Couldn't list models"}),i.jsx(le,{children:e.endpointModelsError})]})]}),i.jsxs("div",{className:"field",children:[i.jsx(Ye,{htmlFor:"endpoint-key",children:"API key (optional)"}),i.jsx(Jn,{id:"endpoint-key",type:"password",value:e.apiKey,onChange:d=>e.setApiKey(d.target.value),disabled:e.status==="connecting"})]})]}),e.kind!=="scripted"&&i.jsxs("div",{className:"brain-actions",children:[i.jsx(Z,{size:"sm",onClick:()=>void e.connect(),disabled:e.status==="connecting"||e.kind==="chrome"&&e.chromeAiReason!==null||e.kind==="endpoint"&&(e.endpointModel===""||e.endpointModelsStatus==="loading"||r!==null),children:e.status==="ready"?"Reconnect":"Connect"}),e.status==="connecting"&&(e.kind==="browser"||e.kind==="chrome")&&i.jsx(Z,{size:"sm",variant:"secondary",onClick:e.cancelConnect,children:"Cancel"}),e.progress&&i.jsxs("span",{className:"field-hint",children:[Math.round(e.progress.progress*100),"% —"," ",e.progress.text]})]}),e.progress&&i.jsx("div",{className:"brain-progress",role:"progressbar","aria-valuenow":Math.round(e.progress.progress*100),"aria-valuemin":0,"aria-valuemax":100,children:i.jsx("div",{className:"brain-progress-bar",style:{width:`${Math.round(e.progress.progress*100)}%`}})}),e.error&&i.jsxs(se,{variant:"destructive",children:[i.jsx(de,{children:"Couldn't connect"}),i.jsx(le,{children:e.error})]})]})}function Yi({brain:e}){const n=mt.find(t=>t.kind===e.visionKind);return i.jsxs("div",{className:"brain-section brain-vision",children:[i.jsx(Ye,{children:"Vision (reads the image)"}),i.jsxs("div",{className:"brain-modes",children:[i.jsx("div",{className:"brain-kinds",role:"group","aria-label":"Vision brain",children:mt.map(t=>i.jsx(Z,{size:"sm",variant:e.visionKind===t.kind?"default":"secondary","aria-pressed":e.visionKind===t.kind,onClick:()=>e.setVisionKind(t.kind),children:t.label},t.kind))}),i.jsxs("div",{className:"brain-status",children:[e.visionStatus==="ready"&&e.visionKind==="browser-vision"&&i.jsx(ie,{variant:"success",className:"brain-status-badge",children:e.visionModelInUse??"connected"}),e.visionStatus==="connecting"&&i.jsx(ie,{variant:"info",className:"brain-status-badge",children:"connecting…"}),e.visionStatus==="error"&&i.jsx(ie,{variant:"danger",className:"brain-status-badge",children:"not connected"})]})]}),i.jsx("p",{className:"field-hint",children:n.hint}),e.visionKind==="scripted-vision"&&e.webgpu===!1&&e.visionWebgpuReason&&i.jsxs(se,{variant:"destructive",children:[i.jsx(de,{children:"No WebGPU in this browser"}),i.jsx(le,{children:e.visionWebgpuReason})]}),e.visionKind==="browser-vision"&&i.jsxs("div",{className:"brain-config",children:[i.jsxs("div",{className:"field",children:[i.jsx(Ye,{htmlFor:"vision-model",children:"Model"}),i.jsxs(Nn,{value:e.visionModel,onValueChange:e.setVisionModel,disabled:e.visionStatus==="connecting",children:[i.jsx(En,{id:"vision-model",children:i.jsx(kn,{})}),i.jsx(In,{children:$t.map(t=>i.jsx(Tn,{value:t.id,children:t.label},t.id))})]}),i.jsx("p",{className:"field-hint",children:"Connecting downloads the weights once (size shown above), then caches them — every token is read on your GPU, no server."})]}),e.webgpu===!1&&e.visionWebgpuReason&&i.jsxs(se,{variant:"destructive",children:[i.jsx(de,{children:"No WebGPU in this browser"}),i.jsx(le,{children:e.visionWebgpuReason})]})]}),e.visionKind==="browser-vision"&&i.jsxs("div",{className:"brain-actions",children:[i.jsx(Z,{size:"sm",onClick:()=>void e.connectVision(),disabled:e.visionStatus==="connecting",children:e.visionStatus==="ready"?"Reconnect":"Connect"}),e.visionStatus==="connecting"&&i.jsx(Z,{size:"sm",variant:"secondary",onClick:e.cancelVisionConnect,children:"Cancel"}),e.visionProgress&&i.jsxs("span",{className:"field-hint",children:[Math.round(e.visionProgress.progress*100),"% —"," ",e.visionProgress.text]})]}),e.visionError&&i.jsxs(se,{variant:"destructive",children:[i.jsx(de,{children:"Couldn't connect the vision brain"}),i.jsx(le,{children:e.visionError})]})]})}function Qi({imageInput:e,value:n,onSelect:t,disabled:r=!1}){const[o,s]=g.useState(null),[l,m]=g.useState(!1),p=g.useRef(null),a=g.useId(),u=g.useId(),h=g.useCallback(f=>{s(URL.createObjectURL(f)),t({imageName:f.name,pixels:f})},[t]);g.useEffect(()=>{if(o)return()=>URL.revokeObjectURL(o)},[o]);const d=g.useCallback(f=>{const x=f==null?void 0:f[0];x&&x.type.startsWith("image/")&&h(x)},[h]),b=(n==null?void 0:n.imageId)!=null?e.seedImages.find(f=>f.id===n.imageId):void 0;return i.jsxs("div",{className:"image-input",children:[e.label&&i.jsx("p",{className:"field-hint",children:e.label}),i.jsx("p",{className:"image-input-label",id:a,children:"Seed photos"}),i.jsx("div",{className:"image-gallery",role:"group","aria-labelledby":a,children:e.seedImages.map(f=>{const x=(n==null?void 0:n.imageId)===f.id;return i.jsxs("button",{type:"button","aria-pressed":x,className:`image-thumb${x?" image-thumb--selected":""}`,disabled:r,title:f.label??f.id,onClick:()=>{s(null),p.current&&(p.current.value=""),t({imageId:f.id,pixels:f.file})},children:[i.jsx("img",{src:f.thumb??f.file,alt:f.label??f.id}),f.label&&i.jsx("span",{children:f.label})]},f.id)})}),i.jsx("label",{className:"image-input-label",htmlFor:u,children:"Or upload your own photo"}),i.jsxs("div",{className:`image-drop${l?" image-drop--over":""}`,onDragOver:f=>{f.preventDefault(),r||m(!0)},onDragLeave:()=>m(!1),onDrop:f=>{f.preventDefault(),m(!1),r||d(f.dataTransfer.files)},children:[i.jsx("input",{ref:p,id:u,type:"file",accept:"image/*",disabled:r,onChange:f=>d(f.target.files)}),i.jsx("p",{className:"field-hint",children:"Drag a photo here, or pick one. Uploading a photo the model has never seen is the proof this runs for real — nothing leaves your browser."})]}),(o||b)&&i.jsxs("div",{className:"image-preview",children:[i.jsx("img",{src:o??(b==null?void 0:b.file),alt:o?(n==null?void 0:n.imageName)??"uploaded photo":(b==null?void 0:b.label)??(b==null?void 0:b.id)??"selected photo"}),i.jsx("span",{className:"field-hint",children:o?`Uploaded: ${(n==null?void 0:n.imageName)??"your photo"}`:`Selected: ${(b==null?void 0:b.label)??(b==null?void 0:b.id)}`}),i.jsx("button",{type:"button",className:"image-clear-btn",disabled:r,onClick:()=>{s(null),p.current&&(p.current.value=""),t(null)},children:"Clear"})]})]})}function Yt(e){return typeof e=="object"&&e!==null}function Dd(e){const n=new Set,t=r=>{Yt(r)&&(typeof r.key=="string"&&n.add(r.key),Array.isArray(r.components)&&r.components.forEach(t))};return t(e),n}function qi(e){const n={},t=r=>{Yt(r)&&(typeof r.key=="string"&&"defaultValue"in r&&(n[r.key]=r.defaultValue??""),Array.isArray(r.components)&&r.components.forEach(t))};return t(e),n}const Ji="wdf:section:v2:";function Qt(e){return Ji+e}function pt(e){try{const n=window.localStorage.getItem(Qt(e));return n==="1"?!0:n==="0"?!1:void 0}catch{return}}function Hi(e,n){try{window.localStorage.setItem(Qt(e),n?"1":"0")}catch{}}function Bn(e,n=!0){const[t,r]=g.useState(()=>pt(e)??n);g.useEffect(()=>{r(pt(e)??n)},[e,n]);const o=g.useCallback(s=>{r(s),Hi(e,s)},[e]);return[t,o]}function ze({sectionId:e,title:n,description:t,defaultOpen:r=!0,className:o,children:s,...l}){const[m,p]=Bn(e,r);return i.jsx(rr,{className:["panel",o].filter(Boolean).join(" "),"data-tour":l["data-tour"],children:i.jsxs(ir,{open:m,onOpenChange:p,children:[i.jsxs(or,{className:"panel-trigger",children:[i.jsxs("span",{className:"panel-trigger-text",children:[i.jsx("span",{className:"panel-title",children:n}),t!=null&&i.jsx("span",{className:"panel-desc",children:t})]}),i.jsx(ar,{className:"panel-chevron","aria-hidden":!0})]}),i.jsx(sr,{children:i.jsx(dr,{children:s})})]})})}function Wi(e){return e.entries!==void 0}function Zi(e){const n=[];let t=null;for(const r of e)r.turn!==void 0?t&&t.turn===r.turn?t.entries.push(r):(t={turn:r.turn,entries:[r]},n.push(t)):(t=null,n.push(r));return n}function ut(e){if(e===void 0)return"undefined";try{return JSON.stringify(e)}catch{return"[unserializable value]"}}function Ki({activation:e,result:n,labelFor:t}){const r=e.elementId??"";return i.jsxs("div",{className:"timeline-tool",children:[i.jsxs("div",{className:"timeline-tool-head",children:[i.jsx(ie,{variant:"info",children:"tool"}),i.jsx("strong",{children:t(r)||r}),i.jsx("code",{children:r})]}),e.args!==void 0&&Object.keys(e.args).length>0&&i.jsxs("div",{className:"timeline-kv",children:[i.jsx("span",{className:"timeline-kv-label",children:"arguments"}),i.jsx("code",{children:ut(e.args)})]}),i.jsxs("div",{className:"timeline-kv",children:[i.jsx("span",{className:"timeline-kv-label",children:"returned"}),i.jsx("code",{children:n?ut(n.result):"— waiting for the job to complete —"})]})]})}function Xi({group:e,labelFor:n}){const t=e.entries.find(a=>a.kind==="llm"),r=e.entries.filter(a=>a.kind==="agent"&&a.elementId),o=e.entries.filter(a=>a.kind==="vars"&&a.elementId),s=e.entries.filter(a=>a.kind==="agent"&&!a.elementId),l=e.entries.filter(a=>a.kind==="error"),m=new Set(r.map(a=>a.elementId)),p=e.entries.filter(a=>a.kind==="tool"||a.kind==="vars"&&a.elementId&&!m.has(a.elementId)).sort((a,u)=>a.id-u.id);return i.jsxs("div",{className:"timeline-turn",children:[i.jsxs("div",{className:"timeline-turn-head",children:[i.jsxs(ie,{variant:t!=null&&t.pending?"warning":"neutral",children:["Turn ",e.turn]}),(t==null?void 0:t.pending)&&i.jsx("span",{className:"timeline-pending",children:"thinking…"})]}),t&&i.jsx("blockquote",{className:"timeline-reply",children:t.text}),s.map(a=>i.jsx("div",{className:"timeline-note",children:a.text},a.id)),r.map(a=>i.jsx(Ki,{activation:a,result:o.find(u=>u.elementId===a.elementId),labelFor:n},a.id)),p.map(a=>i.jsxs("div",{className:`log-line log-${a.kind}`,children:[a.pending?"⏳ ":"",a.text]},a.id)),l.map(a=>i.jsxs("div",{className:"timeline-error",children:["⚠ ",a.text]},a.id))]})}function eo({log:e,elementStats:n=[],incidents:t=[],labelFor:r=s=>s,variables:o}){const s=g.useMemo(()=>Zi(e),[e]),[l,m]=g.useState(!1),[p,a]=Bn("engine-view",!1),u=g.useRef(null);g.useEffect(()=>{const d=u.current;d&&(d.scrollTop=d.scrollHeight)},[s]);const h=()=>{var f;const d={log:e.map(({id:x,...k})=>k),elementStats:n,incidents:t},b=JSON.stringify(d,null,2);(f=navigator.clipboard)!=null&&f.writeText&&navigator.clipboard.writeText(b).then(()=>{m(!0),setTimeout(()=>m(!1),1500)}).catch(()=>{})};return i.jsxs(ze,{sectionId:"activity",className:"grow activity-card",title:"Agent activity",description:"Agent turns, model replies, and tool calls — read top to bottom as a story.",children:[i.jsx("div",{className:"timeline-toolbar",children:i.jsx(Z,{variant:"secondary",size:"sm",onClick:h,children:l?"Copied!":"Copy run as JSON"})}),i.jsx("div",{className:"timeline",ref:u,children:s.length===0?i.jsx("div",{className:"log-empty",children:"Press Run or Step to start."}):s.map(d=>Wi(d)?i.jsx(Xi,{group:d,labelFor:r},`turn-${d.turn}-${d.entries[0].id}`):i.jsxs("div",{className:`log-line log-${d.kind}`,children:[d.pending?"⏳ ":"",d.text]},d.id))}),o,(n.length>0||t.length>0)&&i.jsxs("details",{className:"engine-view",open:p,onToggle:d=>a(d.currentTarget.open),children:[i.jsxs("summary",{children:["Element completion",t.length>0&&` · ${t.length} incident${t.length===1?"":"s"}`]}),i.jsxs("div",{className:"timeline-engine-view",children:[n.length>0&&i.jsxs("div",{className:"timeline-stats",children:[i.jsx("span",{className:"timeline-kv-label",children:"Element completion"}),i.jsx("ul",{children:n.filter(d=>d.completed>0||(d.active??0)>0).map(d=>i.jsxs("li",{children:[i.jsx("code",{children:r(d.elementId)||d.elementId})," ","completed ",d.completed,d.active?`, ${d.active} active`:""]},d.elementId))})]}),t.length>0&&i.jsxs("div",{className:"timeline-incidents",children:[i.jsx("span",{className:"timeline-kv-label",children:"Incidents"}),i.jsx("ul",{children:t.map((d,b)=>i.jsxs("li",{children:[i.jsx("code",{children:r(d.elementId)||d.elementId})," —"," ",d.reason]},`${d.elementId}-${b}`))})]})]})]})]})}const Ne={diagram:"diagram",runButton:"run-button",variablesPanel:"variables-panel",codePanel:"code-panel",brainPanel:"brain-panel"};function ht(e){return`[data-tour="${e}"]`}function no(e=location.search){return new URLSearchParams(e).get("tour")}function to(e){return"anchor"in e?ht(e.anchor):`${ht(Ne.diagram)} [data-element-id="${ro(e.elementId)}"]`}function ro(e){return typeof CSS<"u"&&typeof CSS.escape=="function"?CSS.escape(e):e.replace(/[^a-zA-Z0-9_-]/g,n=>`\\${n}`)}function io(e){return e.map(n=>({element:to(n.target),popover:{title:n.title,description:n.description,showButtons:["next","previous","close"]},disableActiveInteraction:!1,skipMissingElement:n.skipMissingElement??!0}))}async function oo(e){const[{driver:n}]=await Promise.all([ue(()=>import("./driver.js-bj_ppY-Q.js"),[]),ue(()=>Promise.resolve({}),__vite__mapDeps([0]))]),t=n({steps:io(e),showProgress:!0,allowClose:!0,skipMissingElement:!0});return t.drive(),{isActive:()=>t.isActive(),destroy:()=>t.destroy()}}const ao=300;function so(e){const[n,t]=g.useState(!1),r=g.useRef(null),o=g.useRef(null),s=g.useRef(0),l=g.useCallback(()=>{o.current!==null&&(clearInterval(o.current),o.current=null)},[]),m=g.useCallback(()=>{var a;s.current+=1,l(),(a=r.current)==null||a.destroy(),r.current=null,t(!1)},[l]),p=g.useCallback(()=>{if(!e||e.steps.length===0||r.current)return;const a=s.current+=1;oo(e.steps).then(u=>{if(a!==s.current||!u.isActive()){u.destroy();return}r.current=u,t(!0),o.current=setInterval(()=>{u.isActive()||(l(),r.current=null,t(!1))},ao)})},[e,l]);return g.useEffect(()=>m,[m]),{active:n,start:p,stop:m}}function lo(){return typeof window>"u"||!window.matchMedia?!1:window.matchMedia("(prefers-reduced-motion: reduce)").matches}function co({enabled:e,ready:n,targetRef:t,start:r}){const o=g.useRef(!1),[s,l]=g.useState(!1),m=g.useRef(r);g.useEffect(()=>{m.current=r},[r]),g.useEffect(()=>{if(!e||o.current)return;const p=t.current;if(!p||typeof IntersectionObserver>"u"){l(!0);return}const a=new IntersectionObserver(u=>{u.some(h=>h.isIntersecting)&&(l(!0),a.disconnect())},{threshold:.01});return a.observe(p),()=>a.disconnect()},[e,t]),g.useEffect(()=>{!e||o.current||!n||!s||lo()||(o.current=!0,m.current())},[e,n,s])}const Te=650,vn="__agent__",gt="__model__",bt="__template__:",mo=g.lazy(async()=>{await Promise.all([ue(()=>Promise.resolve({}),__vite__mapDeps([1])),ue(()=>Promise.resolve({}),__vite__mapDeps([2])),ue(()=>Promise.resolve({}),__vite__mapDeps([3]))]);const{RuntimeDiagram:e}=await ue(async()=>{const{RuntimeDiagram:n}=await import("./RuntimeDiagram-DTnJz5cT.js");return{RuntimeDiagram:n}},__vite__mapDeps([4,5,6]));return{default:e}}),Mn=g.lazy(()=>ue(()=>import("./MonacoEditor-Bl9r9bi7.js").then(e=>e.M),__vite__mapDeps([7,5,8]))),po=g.lazy(()=>ue(()=>import("./vendor-modeler-DOpG6HQX.js"),__vite__mapDeps([9,5,6,10,11,12,13,1,2,3]))),_t=g.lazy(async()=>{const{FormRenderer:e}=await ue(async()=>{const{FormRenderer:n}=await import("./FormRenderer-BI_nfXvc.js");return{FormRenderer:n}},__vite__mapDeps([14,5,12,10,11,15]));return{default:e}});function cn(e,n){try{return JSON.stringify(e??{},null,n)}catch{return"[unserializable value]"}}function uo(e){const n=cn(e).replace(/\s+/g," ");return n.length>78?`${n.slice(0,78)}…`:n}function ho({example:e,compact:n=!1,autostart:t=!1,initialBrainKind:r,initialTourId:o}){var On,Un,$n,Gn,Vn,Yn,Qn,qn;const[s,l]=g.useState(e.bpmn),m=g.useRef(null),p=Ri(),[a,u]=g.useState(null);g.useEffect(()=>{r&&r!==p.kind&&p.setKind(r)},[]),g.useEffect(()=>{$i({brain:p.kind})},[p.kind]);const[h,d]=g.useState(()=>Object.fromEntries(e.handlers.map(w=>[w.elementId,w.source]))),[b,f]=g.useState(e.scriptedAgent??""),[x,k]=g.useState(()=>en(e.templates)),_=g.useMemo(()=>qr(e,h,s,x),[e,h,s,x]),v=_.model,M=vi({bpmn:_.resolvedBpmn}),Y=so(e.tour);g.useEffect(()=>{var w;o&&((w=e.tour)==null?void 0:w.id)===o&&Y.start()},[]);const H=v.startFormId?((On=e.forms)==null?void 0:On[v.startFormId])??null:null,[V,Me]=g.useState(()=>({...e.seed,...H?qi(H):{}})),[Pe,fe]=g.useState(v.agent?vn:((Un=e.handlers[0])==null?void 0:Un.elementId)??""),Ee=g.useMemo(()=>{const w=(e.scenarios??[]).findIndex(N=>Object.entries(N.variables).every(([T,B])=>JSON.stringify(V[T])===JSON.stringify(B)));return w===-1?null:w},[e.scenarios,V]),[K,he]=Bn(n?"start-compact":"start",n?!1:!!H),[ce,S]=g.useState(!1),[I,E]=g.useState(!1),[L,$]=g.useState(!1),[we,Oe]=g.useState(null),[bn,ye]=g.useState([]),[Qe,oe]=g.useState({}),De=g.useMemo(()=>({...e.seed,...V,...Tr(e.imageInput?a:null)}),[e.seed,e.imageInput,V,a]),[nn,_n]=g.useState(null),ve=g.useRef(null),[Be,Ae]=g.useState({}),[fn,wn]=g.useState(!1),qe=g.useRef(null),X=g.useRef(!1),U=g.useRef(0),Je=g.useRef(0),Ue=g.useRef({current:void 0}),ke=g.useRef({}),Le=g.useRef({}),He=g.useMemo(()=>{const w=new Map;for(const N of v.processes){for(const T of N.tasks)w.set(T.elementId,T.label);for(const T of N.agents){w.set(T.elementId,T.label);for(const B of T.tools)w.set(B.elementId,B.label)}for(const T of N.userTasks)w.set(T.elementId,T.label)}return N=>w.get(N)??N},[v]),z=g.useCallback(w=>{ye(N=>{if(w.key){const T=N.findIndex(B=>B.key===w.key);if(T>=0){const B=[...N];return B[T]={...B[T],...w},B}}return[...N,{...w,id:Je.current++}].slice(-80)})},[]),me=g.useMemo(()=>{var w;return((w=M.snapshot)==null?void 0:w.userTasks.find(N=>N.state==="Created"))??null},[M.snapshot]),Ce=g.useMemo(()=>{const w=v.processes.flatMap(T=>T.tasks),N=new Map;for(const T of e.handlers){if(!T.manualControl)continue;const B=w.find(A=>A.elementId===T.elementId);B&&N.set(B.jobType,{...T.manualControl,elementId:T.elementId})}return N},[e.handlers,v]),Ie=g.useMemo(()=>{if(!M.snapshot)return null;for(const w of M.snapshot.jobs){const N=Ce.get(w.jobType);if(N&&w.state==="Created")return{job:w,control:N}}return null},[M.snapshot,Ce]),tn=g.useMemo(()=>{if(!v.agent||!M.snapshot)return[];const w=new Map(M.snapshot.elementStats.map(N=>[N.elementId,N.completed]));return v.agent.tools.filter(N=>(w.get(N.elementId)??0)===0)},[v.agent,M.snapshot]),ae=me?v.userTasks.find(w=>w.elementId===me.elementId):void 0,$e=ae!=null&&ae.formId?(($n=e.forms)==null?void 0:$n[ae.formId])??null:null,Ge=g.useCallback(async(w,N,T,B)=>{var pe,te,be;let A=T,ge=0;for(;U.current===B&&A&&A.completedInstances<1&&ge++<80;){const q=await M.stepWorkers(w,{agents:N});if(U.current!==B)return A;A=(q==null?void 0:q.snapshot)??A;const re=(pe=A.instances[0])==null?void 0:pe.variables;if(re&&oe({...re}),A.userTasks.some(J=>J.state==="Created")){z({kind:"human",text:"⏸ waiting for a human — complete the task below to continue"});break}if(!q){z({kind:"error",text:"▶ run stopped — no dispatch round was returned"});break}if(q.handled===0){const J=A.messageSubscriptions[0];if(q.reason==="messages"&&J){if(z({kind:"step",text:`⏳ parked on a message catch event — waiting for "${J.messageName}"`,elementId:J.elementId}),await new Promise(ee=>setTimeout(ee,Te)),U.current!==B)return A;z({kind:"vars",text:`📨 correlating message "${J.messageName}" (key: ${J.correlationKey})`,elementId:J.elementId});const G=M.correlateMessage(J.messageName,J.correlationKey,"{}");if(G){A=G;const ee=(te=A.instances[0])==null?void 0:te.variables;ee&&oe({...ee}),await new Promise(_e=>setTimeout(_e,Te));continue}z({kind:"error",text:`▶ run stopped — correlating "${J.messageName}" (key: ${J.correlationKey}) failed`,elementId:J.elementId})}if(q.reason==="signals"&&A.signalSubscriptions.length>0){const G=A.signalSubscriptions[0],ee=A.signalSubscriptions.length;if(z({kind:"step",text:`⏳ parked on ${ee} open signal subscription${ee===1?"":"s"} — waiting for "${G.signalName}"`,elementId:G.elementId}),await new Promise(Ve=>setTimeout(Ve,Te)),U.current!==B)return A;const _e=M.broadcastSignal(G.signalName,"{}");if(_e){A=_e,z({kind:"vars",text:`📡 broadcasting signal "${G.signalName}" — every waiting subscription unblocks`,elementId:G.elementId});const Ve=(be=A.instances[0])==null?void 0:be.variables;Ve&&oe({...Ve}),await new Promise(Xt=>setTimeout(Xt,Te));continue}z({kind:"error",text:`▶ run stopped — broadcasting signal "${G.signalName}" failed`,elementId:G.elementId})}if(q.reason==="timers"){const G=A.timers.reduce((ee,_e)=>Math.min(ee,_e.dueInMs),1/0);if(Number.isFinite(G)){if(z({kind:"step",text:`⏳ parked on a timer — ${(Math.max(G,0)/1e3).toFixed(1)}s left on the clock`}),await new Promise(_e=>setTimeout(_e,Te)),U.current!==B)return A;const ee=M.advanceTime(Math.max(G,0)+1);if(ee){A=ee,z({kind:"step",text:"🕐 the clock advanced — timer fired"}),await new Promise(_e=>setTimeout(_e,Te));continue}}}break}await new Promise(J=>setTimeout(J,Te))}return U.current!==B||(A&&A.completedInstances>=1?z({kind:"done",text:"✅ process instance completed"}):A&&A.incidentElementIds.length>0&&z({kind:"error",text:"A job failed — incident on the diagram"})),A},[M,z]),j=g.useCallback(async w=>{var A,ge,pe;if(!Ie||X.current)return;const{job:N,control:T}=Ie,B=++U.current;X.current=!0,E(!0);try{let te,be;if(w==="complete")te=M.completeJobManually(N.jobType,"{}"),be="  ↳ completed normally";else if(T.action.kind==="timer"){const q=((ge=(A=M.snapshot)==null?void 0:A.timers[0])==null?void 0:ge.dueInMs)??0;te=M.advanceTime(Math.max(q,0)+1),be="  ↳ advanced the clock — timer fired"}else{const{errorCode:q,message:re}=T.action;te=M.throwJobError(N.jobType,q,re),be=`  ↳ threw BPMN error ${q}: ${re}`}if(te){z({kind:"vars",text:be,elementId:N.elementId});const q=(pe=te.instances[0])==null?void 0:pe.variables;q&&oe({...q}),await new Promise(re=>setTimeout(re,Te)),await Ge(ke.current,Le.current,te,B)}else z({kind:"error",text:"  ↳ failed to resolve the manual job",elementId:N.elementId})}finally{U.current===B&&(X.current=!1,E(!1))}},[Ie,M,z,Ge]),Q=g.useCallback(async()=>{var q;let w=null;try{v.agent&&b.trim()&&(w=Lr(b))}catch(re){return Oe(re instanceof Error?re.message:String(re)),null}Ue.current={current:void 0};let N;if(e.imageInput){const re=p.vision;N={read:re??Bi(e.scriptedVision).read,live:!!re,resolve:G=>M.getRunImage(G)}}const T=zr(v,_.handlers,z,Ue.current,N);for(const re of Ce.keys())delete T[re];const B={};if(v.agents.length>0){if(p.kind!=="scripted"&&p.chat){const J=new Map;for(const G of v.agents)J.set(G.jobType,[...J.get(G.jobType)??[],G]);for(const[G,ee]of J)B[G]=ti(ee,p.chat,z,{turnRef:Ue.current,requiredTools:e.requiredTools})}else if(w&&v.agent){const J=v.agent.elementId;B[v.agent.jobType]=async G=>{if(G.elementId!==J)throw new Error(`No scripted agent handler for "${G.elementId}" — only "${J}" (the primary process's first agent host) is driven by the scripted brain. Use a live brain to exercise more than one host.`);const ee=await w(G),_e=(ee.activateElements??[]).map(Ve=>Ve.elementId).join(", ");return z({kind:"agent",text:ee.completionConditionFulfilled?"🤖 scripted agent: done":`🤖 scripted agent: calling ${_e||"(nothing)"}`}),ee}}}ye([]),Ae({});const A=De;oe(A),ke.current=T,Le.current=B;const ge=await M.redeploy(s),pe=(ge==null?void 0:ge[0])??v.processId;z({kind:"start",text:`Starting "${pe}" — ${v.agent?p.kind==="scripted"||!p.chat?"scripted brain":`live brain (${p.modelInUse??p.kind})`:"no agent in this model"}`});const te=M.createInstance(pe,JSON.stringify(A)),be=(q=te==null?void 0:te.instances[0])==null?void 0:q.key;return e.imageInput&&a&&be&&M.setRunImage(be,a),{workers:T,agents:B,snap:te}},[M,e,_,s,b,V,a,De,v,p,z,Ce]),D=!!M.snapshot&&M.snapshot.completedInstances<1,W=!D&&!!H&&nn!==!0,xe=!D&&!!H&&nn===!1,Re=K||ce;g.useEffect(()=>{n&&xe&&S(!0)},[n,xe]);const Rn=w=>{he(w),w||S(!1)},Fn=g.useCallback(async()=>{if(M.phase!=="ready"||X.current||L||_.hasErrors)return;X.current=!0,E(!0);const w=++U.current;try{let N=ke.current,T=Le.current,B=M.snapshot;if(!D){if(ve.current&&!ve.current.validate())return;Oe(null);const A=await Q();if(!A)return;N=A.workers,T=A.agents,B=A.snap,await new Promise(ge=>setTimeout(ge,Te))}await Ge(N,T,B,w)}finally{U.current===w&&(X.current=!1,E(!1))}},[M,L,_.hasErrors,D,Q,Ge]),zn=M.phase==="ready"&&!I&&!L&&!_.hasErrors&&!W;co({enabled:t,ready:zn,targetRef:m,start:()=>void Fn()});const Jt=g.useCallback(async()=>{var N;if(M.phase!=="ready"||X.current||L||_.hasErrors)return;X.current=!0,$(!0);const w=++U.current;try{let T=ke.current,B=Le.current,A=M.snapshot;if(!D){if(ve.current&&!ve.current.validate())return;Oe(null);const q=await Q();if(!q)return;T=q.workers,B=q.agents,A=q.snap}if(!A||A.completedInstances>=1)return;const ge=A.takenSequenceFlows.length,pe=await M.stepWorkers(T,{agents:B});if(!pe){z({kind:"error",text:"⏭ step failed — no dispatch round was returned"});return}const te=(N=pe.snapshot.instances[0])==null?void 0:N.variables;te&&oe({...te});const be=Mi(pe.snapshot.takenSequenceFlows,ge);z(xi(pe,be,He,Ce))}finally{U.current===w&&(X.current=!1,$(!1))}},[M,L,_.hasErrors,D,Q,z,He,Ce]),Ht=g.useCallback(async()=>{X.current=!1,U.current++,E(!1),$(!1),X.current=!0;try{await M.reset()}finally{X.current=!1}ye([]),oe({})},[M]),Wt=g.useCallback(()=>{var T;if(!me||qe.current&&!qe.current.validate())return;const w=M.completeUserTask(me.key,JSON.stringify(Be));z({kind:"human",text:`👤 ${cn(Be)}`});const N=(T=w==null?void 0:w.instances[0])==null?void 0:T.variables;oe(B=>({...B,...Be,...N??{}})),w&&w.completedInstances>=1&&z({kind:"done",text:"✅ process instance completed"})},[me,Be,M,z]),Zt=g.useMemo(()=>{var w,N;return M.phase==="loading"?i.jsx(ie,{variant:"neutral",children:"Booting engine…"}):M.phase==="error"?i.jsx(ie,{variant:"danger",children:"Engine error"}):I?i.jsx(ie,{variant:"info",children:"Running…"}):L?i.jsx(ie,{variant:"info",children:"Stepping…"}):(((w=M.snapshot)==null?void 0:w.incidentElementIds.length)??0)>0?i.jsx(ie,{variant:"danger",children:"Incident"}):me?i.jsx(ie,{variant:"warning",children:"Waiting for a human"}):(((N=M.snapshot)==null?void 0:N.completedInstances)??0)>=1?i.jsx(ie,{variant:"success",children:"Completed"}):M.snapshot?i.jsx(ie,{variant:"warning",children:"Paused"}):i.jsx(ie,{variant:"neutral",children:"Ready"})},[M.phase,M.snapshot,I,L,me]),Kt=g.useMemo(()=>e.blurb.split(/\n\s*\n/).map(w=>w.trim()).filter(Boolean),[e.blurb]);return i.jsxs("div",{className:"runner",ref:m,children:[n?i.jsx("h1",{className:"visually-hidden",children:e.title}):i.jsxs("section",{className:"intro",children:[i.jsx("h1",{children:e.title}),Kt.map(w=>i.jsx("p",{children:w},w))]}),e.imageInput&&i.jsx(Qi,{imageInput:e.imageInput,value:a,onSelect:u,disabled:I}),i.jsxs("div",{className:"scenario",children:[i.jsx("span",{className:"scenario-label",id:"scenario-label",children:e.scenariosLabel??"Example input"}),e.scenarios&&i.jsx("div",{className:"scenario-toggle",role:"group","aria-labelledby":"scenario-label",children:e.scenarios.map((w,N)=>i.jsx(Z,{size:"sm",variant:N===Ee?"default":"secondary","aria-pressed":N===Ee,disabled:I,onClick:()=>Me(T=>({...T,...w.variables})),children:w.label},w.label))}),i.jsxs("button",{type:"button",className:"scenario-input-button",onClick:()=>Rn(!Re),"aria-expanded":Re,"aria-controls":"start-input-editor",title:"Edit the starting payload",children:[i.jsx("span",{className:"scenario-edit-icon","aria-hidden":!0,children:"✎"})," ","input: ",i.jsx("code",{children:uo(V)})]}),W&&i.jsx("span",{className:"scenario-hint",children:"Fill in the input to enable Run"})]}),i.jsxs("div",{className:"inline-input-editor",id:"start-input-editor",hidden:!Re,children:[i.jsxs("div",{className:"inline-input-editor-head",children:[i.jsxs("div",{children:[i.jsx("div",{className:"inline-input-editor-title",children:v.startFormId?"Start form":"Start payload"}),i.jsx("div",{className:"inline-input-editor-copy",children:v.startFormId?`Rendered from the model's start form "${v.startFormId}".`:"The variables the instance starts with."})]}),i.jsx(Z,{size:"sm",variant:"secondary",onClick:()=>Rn(!1),children:"Done"})]}),H?i.jsx(g.Suspense,{fallback:i.jsx("div",{className:"form-fallback",children:"Loading form…"}),children:i.jsx(_t,{ref:ve,schema:H,values:V,onChange:(w,N)=>Me(T=>({...T,[w]:N})),disabled:I,onValidityChange:_n})}):i.jsx("pre",{className:"vars",children:cn(V,2)})]}),!n&&(v.agent||e.imageInput)&&i.jsx(ze,{sectionId:"brain",className:"brain-card","data-tour":Ne.brainPanel,title:"Agent brain",description:v.agent?`What drives “${v.agent.label}”. The model recommends; the process governs.`:"What reads the image. The model recommends; the process governs.",children:i.jsx(Gi,{brain:p,showText:!!v.agent,showVision:!!e.imageInput})}),i.jsxs("div",{className:"controls",children:[i.jsx(Z,{"data-tour":Ne.runButton,onClick:()=>void Fn(),disabled:!zn,children:"▶ Run"}),i.jsx(Z,{variant:"secondary",onClick:()=>void Jt(),disabled:M.phase!=="ready"||I||L||_.hasErrors||W||(((Gn=M.snapshot)==null?void 0:Gn.completedInstances)??0)>=1,children:"⏭ Step"}),i.jsx(Z,{variant:"secondary",onClick:()=>void Ht(),disabled:M.phase!=="ready"||L,children:"↺ Reset"}),e.tour&&i.jsx(Z,{variant:"secondary",onClick:Y.start,disabled:Y.active,children:Y.active?"Touring…":`🧭 ${e.tour.label}`}),Zt]}),M.phase==="error"&&i.jsxs(se,{variant:"destructive",children:[i.jsx(de,{children:"Engine error"}),i.jsx(le,{children:M.error})]}),we&&i.jsxs(se,{variant:"destructive",children:[i.jsx(de,{children:"Code didn't compile"}),i.jsx(le,{children:we})]}),_.hasErrors&&i.jsxs(se,{variant:"destructive",children:[i.jsx(de,{children:"Run is disabled — the diagram has unresolved references"}),i.jsx(le,{children:i.jsx("ul",{className:"diagnostics",children:_.diagnostics.filter(w=>w.severity==="error").map((w,N)=>i.jsx("li",{children:w.message},N))})})]}),!_.hasErrors&&_.diagnostics.length>0&&i.jsxs(se,{children:[i.jsx(de,{children:"Heads up"}),i.jsx(le,{children:i.jsx("ul",{className:"diagnostics",children:_.diagnostics.map((w,N)=>i.jsx("li",{children:w.message},N))})})]}),i.jsxs("div",{className:"grid",children:[i.jsxs("div",{className:"col",children:[i.jsx(ze,{sectionId:"process","data-tour":Ne.diagram,title:"Process",description:`${v.processName} — live token (green), incidents (red).`,children:i.jsx(g.Suspense,{fallback:i.jsx("div",{className:"diagram-fallback",children:M.phase==="loading"?"Booting the engine…":"Loading diagram…"}),children:i.jsx(mo,{xml:_.resolvedBpmn,activeIds:((Vn=M.snapshot)==null?void 0:Vn.activeElementIds)??[],incidentIds:((Yn=M.snapshot)==null?void 0:Yn.incidentElementIds)??[],className:"diagram"})})}),me&&i.jsxs(ze,{sectionId:"human-task",title:(ae==null?void 0:ae.label)??"Human task",description:$e?`Rendered from the model's form "${ae==null?void 0:ae.formId}".`:"This task has no linked form — complete it with no variables.",children:[tn.length>0&&i.jsxs(se,{variant:"destructive",children:[i.jsx(de,{children:"The agent didn't finish its checks"}),i.jsxs(le,{children:["It completed without running"," ",tn.map(w=>w.label||w.elementId).join(", "),". The process took the default path to this task, so the findings below have no value to report."]})]}),$e&&i.jsx(g.Suspense,{fallback:i.jsx("div",{className:"form-fallback",children:"Loading form…"}),children:i.jsx(_t,{ref:qe,schema:$e,values:Be,onChange:(w,N)=>Ae(T=>({...T,[w]:N})),context:Qe,onValidityChange:wn})}),i.jsx(Z,{onClick:Wt,disabled:!!$e&&!fn,children:"Complete task"})]}),Ie&&i.jsx(ze,{sectionId:"manual-job",title:Ie.control.label,description:"This job is held here on purpose — pick how it resolves.",children:i.jsxs("div",{className:"controls",children:[i.jsx(Z,{onClick:()=>void j("complete"),disabled:I||L,children:Ie.control.completeLabel??"✅ Complete normally"}),i.jsx(Z,{variant:"secondary",onClick:()=>void j("action"),disabled:I||L,children:Ie.control.action.label})]})})]}),i.jsx("div",{className:"col",children:i.jsx(eo,{log:bn,elementStats:(Qn=M.snapshot)==null?void 0:Qn.elementStats,incidents:(qn=M.snapshot)==null?void 0:qn.incidents,labelFor:He,variables:i.jsxs("div",{className:"vars-block","data-tour":Ne.variablesPanel,children:[i.jsx("div",{className:"vars-head",children:"Instance variables"}),i.jsx("pre",{className:"vars",children:cn(Object.keys(Qe).length>0?Qe:De,2)})]})})})]}),!n&&i.jsxs("div",{className:"runner-secondary",children:[i.jsx(ze,{sectionId:"code",className:"editors","data-tour":Ne.codePanel,defaultOpen:!1,title:"Code",description:"One handler per BPMN element, plus a model tab holding the editable diagram — select an element there to edit its properties. Return variables to merge, or throw to fail the job.",children:i.jsx(g.Suspense,{fallback:i.jsx("div",{className:"editor-fallback",children:"Loading editor…"}),children:i.jsxs(lr,{value:Pe,onValueChange:fe,children:[i.jsxs(cr,{children:[i.jsx(rn,{value:gt,children:"model"}),v.agent&&i.jsx(rn,{value:vn,children:"agent (scripted)"}),e.handlers.map(w=>{var N;return i.jsx(rn,{value:w.elementId,children:((N=v.tasks.find(T=>T.elementId===w.elementId))==null?void 0:N.label)??w.elementId},w.elementId)}),Object.keys(x).map(w=>i.jsx(rn,{value:bt+w,children:w},w))]}),i.jsxs(on,{value:gt,children:[i.jsxs("div",{className:"editor-meta",children:[i.jsx("strong",{children:"Model"}),i.jsx("code",{children:"click an element to edit its properties on the right — Run re-reads whatever you leave here"}),i.jsx(Z,{variant:"secondary",size:"sm",onClick:()=>l(e.bpmn),disabled:s===e.bpmn,children:"Revert to original"})]}),i.jsx(po,{value:s,onChange:l})]}),v.agent&&i.jsxs(on,{value:vn,children:[i.jsxs("div",{className:"editor-meta",children:[i.jsx("strong",{children:v.agent.label}),i.jsx("code",{children:p.kind==="scripted"||!p.chat?"in use":"unused — a live brain is connected"})]}),i.jsx("div",{className:"editor-wrap",children:i.jsx(Mn,{height:"360px",defaultLanguage:"javascript",value:b,onChange:w=>f(w??""),options:xn})})]}),e.handlers.map(w=>{var N;return i.jsxs(on,{value:w.elementId,children:[i.jsxs("div",{className:"editor-meta",children:[i.jsx("strong",{children:((N=v.tasks.find(T=>T.elementId===w.elementId))==null?void 0:N.label)??w.elementId}),i.jsx("code",{children:w.standsInFor??w.elementId})]}),i.jsx("div",{className:"editor-wrap",children:i.jsx(Mn,{height:"360px",defaultLanguage:"javascript",value:h[w.elementId],onChange:T=>d(B=>({...B,[w.elementId]:T??""})),options:xn})})]},w.elementId)}),Object.keys(x).map(w=>i.jsxs(on,{value:bt+w,children:[i.jsxs("div",{className:"editor-meta",children:[i.jsx("strong",{children:w}),i.jsxs("code",{children:["prompt / template text — substitutes"," ","{{"+w+"}}"]})]}),i.jsx("div",{className:"editor-wrap",children:i.jsx(Mn,{height:"360px",defaultLanguage:"markdown",value:x[w],onChange:N=>k(T=>en(T,{[w]:N??""})),options:xn})})]},w))]})})}),v.agent&&i.jsx(ze,{sectionId:"tools",defaultOpen:!1,title:"Tools, as the model sees them",description:i.jsxs(i.Fragment,{children:["Read from the diagram — element name, documentation, and every",i.jsx("code",{children:" fromAi(…)"})," argument."]}),children:i.jsx("ul",{className:"tool-list",children:v.agent.tools.map(w=>i.jsxs("li",{children:[i.jsx("code",{children:w.elementId}),i.jsxs("span",{children:[" — ",w.documentation||w.label]}),w.args.length>0&&i.jsx("ul",{children:w.args.map(N=>i.jsxs("li",{children:[i.jsxs("code",{children:[N.name,": ",N.type]})," ","— ",N.description]},N.name))})]},w.elementId))})})]})]})}const xn={minimap:{enabled:!1},fontSize:13,scrollBeyondLastLine:!1,tabSize:2,automaticLayout:!0},go=`<?xml version="1.0" encoding="UTF-8"?>\r
...
}`,Ao={id:"learn-multi-instance-parallel",title:"Parallel multi-instance",group:"learn-bpmn",blurb:["A multi-instance activity runs its task once per element of a collection, spawning that many job instances of the same element in parallel, and only lets the token move on once every one of them completes.",`Run this and watch three 'Process item' jobs activate together for apple, banana, cherry, and complete (in any order) before the process reaches its end event. Nothing about the diagram says "three" — that comes from the collection, so use the buttons in the Start panel on the right to swap between one, three, and six items and hit Run again; the Activity panel logs one 'Process item' line per element, so the fan-out is right there to count.`,'The property tying the two together is in the Code panel: open the model tab, click "Process item", and expand Multi-instance in the properties panel on the right — Input collection holds `items`, the FEEL expression naming the variable to fan out over. Drop it entirely and the activity silently degenerates to a single ordinary instance, with no error to tell you it happened. Revert to original puts it back.'].join(`

`),docsUrl:"https://docs.camunda.io/docs/components/modeler/bpmn/multi-instance/",bpmn:So,seed:{items:["apple","banana","cherry"]},scenarios:[{label:"One item — a single instance",variables:{items:["apple"]}},{label:"Three items — fans out to three",variables:{items:["apple","banana","cherry"]}},{label:"Six items — fans out to six",variables:{items:["apple","banana","cherry","damson","elderberry","fig"]}}],handlers:[{elementId:"Activity_process",standsInFor:"job worker — process-item",source:Po}]},Co=Object.freeze(Object.defineProperty({__proto__:null,default:Ao},Symbol.toStringTag,{value:"Module"})),Do=`<?xml version="1.0" encoding="UTF-8"?>\r
...
`,Ho="Camunda Cloud",Wo="8.10.0",Zo={name:"Camunda Web Modeler",version:"9b5d5ef"},Ko=19,Xo="learn-user-task-form-review",ea=[{text:`# Review request
...
`,aa=`Please verify export compliance for this shipment and notify the team of your decision.\r
`,sa={id:"compliance-walkthrough",label:"Take the tour",steps:[{title:"Start a run",description:"Press Run to send a shipment through the compliance agent.",target:{anchor:Ne.runButton}},{title:"The agent picks its own tools",description:"This AI Agent reads the shipment notes and decides, turn by turn, which of the tools below it to call — nothing here is hard-coded into a fixed sequence.",target:{elementId:"ComplianceCheckAgent"}},{title:"Watch the token move",description:"The agent's first move is to look up the genetic marker mentioned in the notes.",target:{elementId:"VerifyGeneticMarker"}},{title:"A cleared shipment notifies the export team",description:"Once the compliance score comes back clean, the process notifies the export team automatically — no human review needed for this scenario.",target:{elementId:"NotifyExportTeam"}},{title:"Everything the run recorded",description:"The variables panel shows the marker record, the country lookup, the compliance score, and the final decision — exactly what each tool and the agent wrote along the way.",target:{anchor:Ne.variablesPanel}}]},da=`<?xml version="1.0" encoding="UTF-8"?>
...
**Agent's decision:** {{decision}}`,type:"text",layout:{row:"Row_findings",columns:null},id:"Field_ReviewFindings"},{label:"Reviewer decision",values:[{label:"Approve for export",value:"approved"},{label:"Reject shipment",value:"rejected"}],type:"radio",layout:{row:"Row_review_decision",columns:null},id:"Field_ReviewDecision",key:"reviewDecision",validate:{required:!0}},{label:"Reviewer comments",description:"Explain your decision - this is recorded alongside the process instance.",type:"textarea",layout:{row:"Row_review_comments",columns:null},id:"Field_ReviewComments",key:"reviewComments"}],xa="default",Na={executionPlatform:_a,executionPlatformVersion:fa,exporter:wa,schemaVersion:ya,id:va,components:Ma,type:xa},Ea=Object.assign({"./prompts/system-prompt.md":oa,"./prompts/user-prompt.md":aa}),ka=en(Object.fromEntries(Object.entries(Ea).map(([e,n])=>[Ct(e),n.trimEnd()]))),ft="SHIP-2026-0731 is prepared for transfer to Brazil. Supporting paperwork includes reference code TP53",Ia="SHIP-2026-0900 is prepared for transfer to Germany. Supporting paperwork includes reference code BRCA1",Ta=`async (job) => {
...
}`,Da={id:"seed-export-compliance",title:"Seed export compliance agent",blurb:"An AI agent picks its own tools to check a shipment, then a gateway routes on its decision — cleared shipments notify the export team, flagged ones go to a human. The LLM recommends; the BPMN process governs.",hero:{headline:"The LLM *recommends*. The process *governs*.",lede:"An agentic ad-hoc sub-process chooses its own compliance checks, but the gateway after it — not the model — decides whether a shipment ships or goes to a human.",tagline:"Anatomy of an enterprise agent"},docsUrl:"https://camunda.com/blog/agentic-ai/",bpmn:da,forms:{"seed-export-shipment-ready":ba,"seed-export-compliance-review":Na},seed:{scenario:ft,shipmentNotes:""},scenariosLabel:"Example shipment",scenarios:[{label:"Likely cleared (TP53 → Brazil)",variables:{scenario:ft,shipmentNotes:""}},{label:"Likely flagged (BRCA1 → Germany)",variables:{scenario:Ia,shipmentNotes:""}}],scriptedAgent:Ta,templates:ka,tour:sa,requiredTools:["RecordComplianceDecision"],handlers:[{elementId:"VerifyGeneticMarker",standsInFor:"JDBC connector — UCSC hg38",source:ja},{elementId:"CheckDestinationCountry",standsInFor:"GraphQL connector — countries API",source:Sa},{elementId:"ComputeComplianceScore",standsInFor:"REST connector — api.mathjs.org",source:Pa},{elementId:"RecordComplianceDecision",standsInFor:"Script task — FEEL",source:Aa},{elementId:"NotifyExportTeam",standsInFor:"REST connector — httpbin.io",source:Ca}]},Ba=`You are a loan origination assistant at a retail bank. Your job is to gather everything a senior loan officer needs to decide an application — you do **not** decide it yourself.
...
}`,as=`async (job, { text, num, sleep, trace }) => {
...
}`,ms={id:"loan-origination",title:"Loan origination agent",blurb:"An AI agent gathers a loan case with its own tools — customer lookup, credit bureau, an underwriting policy, a status update — then every application passes through a mandatory senior-officer review before a gateway routes it to an offer or a decline. The agent advises; the process governs.",docsUrl:"https://camunda.com/orchestrate/agents/",bpmn:Fa,forms:{"loan-application":Qa,"loan-senior-officer-review":es},seed:wt,scenarios:[{label:"Strong applicant (policy recommends approve)",variables:wt},{label:"Marginal applicant (policy recommends decline)",variables:rs}],scriptedAgent:is,templates:ts,tour:Ra,requiredTools:["AssessApplication","UpdateApplicationStatus"],handlers:[{elementId:"QueryCustomer",standsInFor:"CRM connector — customer lookup",source:os},{elementId:"CreditBureauLookup",standsInFor:"REST connector — credit bureau",source:as},{elementId:"AssessApplication",standsInFor:"Script task — underwriting policy (FEEL)",source:ss},{elementId:"UpdateApplicationStatus",standsInFor:"REST connector — origination system",source:ds},{elementId:"IssueLoanOffer",standsInFor:"REST connector — offer/booking system",source:ls},{elementId:"SendDeclineNotice",standsInFor:"REST connector — notifications",source:cs}]},ps=`<?xml version="1.0" encoding="UTF-8"?>
...
`,us=`async (job, { text, sleep }) => {
  ...
  return { shipped: true, tracking: "1Z" + Math.floor(Math.random() * 1e9) };
}`,bs={id:"order-process",title:"Order process with service workers",blurb:"The getting-started order process: check inventory, charge payment, ship. No agent and no human step — the same runner, driven entirely by what's in the diagram.",docsUrl:"https://docs.camunda.io/docs/next/guides/getting-started-orchestration-cluster/",bpmn:ps,seed:{item:"camunda-t-shirt",quantity:3},handlers:[{elementId:"Activity_0tw2fu0",standsInFor:"job worker — check-inventory",source:us},{elementId:"Activity_1ppsbgi",standsInFor:"job worker — charge-payment",source:hs},{elementId:"Activity_08pg6im",standsInFor:"job worker — ship-items",source:gs}]},_s=`<?xml version="1.0" encoding="UTF-8"?>\r
...
}`,ws={id:"rocket-launch",title:"Rocket launch",blurb:"The getting-started rocket launch, boiled down to one service task: launch. The smallest possible example, and the smallest possible test of the framework's extensibility.",bpmn:_s,seed:{missionName:"Apollo 11",destination:"the Moon",fuelLevel:100},scenarios:[{label:"Full tanks — launch succeeds",variables:{missionName:"Apollo 11",destination:"the Moon",fuelLevel:100}},{label:"Low fuel — mission scrubbed",variables:{missionName:"Apollo 13",destination:"the Moon",fuelLevel:30}}],handlers:[{elementId:"Activity_LaunchRocket",standsInFor:"job worker — launch-rocket",source:fs}]},ys=`<?xml version="1.0" encoding="UTF-8"?>\r
...
`,vs=`async (job, { text, sleep }) => {
  ...
  return { shipped: true, tracking: "1Z" + Math.floor(Math.random() * 1e9) };
}`,Ns={id:"order-process-boundary-events",title:"Order process with boundary events",blurb:"The getting-started order process, extended with a timer and an error boundary event: charge payment can be declined, and a delayed shipment can escalate — both fired by hand from the runner rather than by chance.",docsUrl:"https://github.com/camunda/camunda-8-get-started/tree/main/2-order-process-with-service-workers",bpmn:ys,seed:{item:"camunda-t-shirt",quantity:3},handlers:[{elementId:"Activity_0tw2fu0",standsInFor:"job worker — check-inventory",source:vs},{elementId:"Activity_1ppsbgi",standsInFor:"job worker — charge-payment",source:Ms,manualControl:{label:"Charge payment method",completeLabel:"✅ Complete normally",action:{kind:"error",errorCode:"CHARGE_DECLINED",message:"The card issuer declined the charge.",label:"❌ Simulate: card declined"}}},{elementId:"Activity_08pg6im",standsInFor:"job worker — ship-items",source:xs,manualControl:{label:"Ship items",completeLabel:"✅ Ship it",action:{kind:"timer",label:"🕐 Fire the shipping-delayed timer"}}}]},Es="/web-demo-framework/pr-preview/pr-114/assets/de-bmw-mini-JBSk7QcF.jpg",ks="/web-demo-framework/pr-preview/pr-114/assets/de-bmw-mini.thumb-CUUmJrRO.jpg",Is="/web-demo-framework/pr-preview/pr-114/assets/uk-d651-rnb-XGipy2QN.jpg",Ts="/web-demo-framework/pr-preview/pr-114/assets/uk-d651-rnb.thumb-mjEcbhUf.jpg",js="/web-demo-framework/pr-preview/pr-114/assets/uk-mk70-orj-Cn6O3Xfm.jpg",Ss="/web-demo-framework/pr-preview/pr-114/assets/uk-mk70-orj.thumb-CaeZ2vqU.jpg",Ps="/web-demo-framework/pr-preview/pr-114/assets/uk-ni-ijz-8992-YXV44tgk.jpg",As="/web-demo-framework/pr-preview/pr-114/assets/uk-ni-ijz-8992.thumb-DYwok8jV.jpg",Cs="/web-demo-framework/pr-preview/pr-114/assets/us-hyundai-genesis-gGpAIEpi.jpg",Ds="/web-demo-framework/pr-preview/pr-114/assets/us-hyundai-genesis.thumb-DEEt19Mw.jpg",Bs=`<?xml version="1.0" encoding="UTF-8"?>
...
}`,pd={id:"plate-recognition",title:"Read a number plate from a photo",blurb:"Pick the plate's country, then a photo goes into the run, an in-browser vision model reads the number plate on the reader's own GPU, and a human confirms or corrects it before the process records the result. The vision model recommends; the BPMN process governs. No server, no API key — with no model connected it falls back to a deterministic scripted reading.",docsUrl:"https://docs.camunda.io/docs/components/modeler/forms/camunda-forms-reference/",bpmn:Bs,forms:{"plate-recognition-country":od,"plate-recognition-confirm":Gs,"plate-recognition-manual":Zs},seed:{country:"auto"},imageInput:{label:"Pick a seed photo (its plate is known, so the scripted reader works offline) or upload your own — a live in-browser model reads a photo it has never seen.",seedImages:dd},scriptedVision:ld,handlers:[{elementId:"ExtractPlate",standsInFor:"Vision model — Florence-2 <OCR> on WebGPU (in-browser)",source:cd},{elementId:"RecordResult",standsInFor:"Script task — records the governed outcome",source:md}]},ud=[ws,Da,ms,bs,Ns,pd],hd=Object.assign({"./learn-error-boundary/index.ts":wo,"./learn-exclusive-gateway/index.ts":Eo,"./learn-message-correlation/index.ts":jo,"./learn-multi-instance-parallel/index.ts":Co,"./learn-service-task/index.ts":Fo,"./learn-signal-broadcast/index.ts":Go,"./learn-timer-catch-event/index.ts":qo,"./learn-user-task-form/index.ts":ia}),gd=Object.values(hd).map(e=>e.default).sort((e,n)=>e.id.localeCompare(n.id)),We=[...ud,...gd];function Ln(){return"/web-demo-framework/pr-preview/pr-114/"}function bd(e){const n=Ln();return e.startsWith(n)?"/"+e.slice(n.length):e}function _d(e=location.pathname){const t=bd(e).match(/^\/examples\/([^/]+)\/?$/);if(t)try{return{kind:"example",id:decodeURIComponent(t[1])}}catch{return{kind:"gallery"}}return{kind:"gallery"}}function fd(e=location.search){return new URLSearchParams(e).get("embed")==="1"}function wd(e=location.search){return new URLSearchParams(e).get("view")==="compact"?"compact":"full"}function yd(e=location.search){return new URLSearchParams(e).get("autostart")==="1"}function vt(e){return`${Ln()}examples/${encodeURIComponent(e)}`}const Mt="p";function vd(){const e=new URLSearchParams(location.search),n=e.get(Mt);if(!n)return!1;const t=n.replace(/[\t\n\r]/g,"");if(!t.startsWith("/")||t.startsWith("//")||t.startsWith("/\\"))return!1;e.delete(Mt);try{const r=new URL(Ln(),location.href),o=new URL(t.slice(1),r);return o.origin!==location.origin?!1:(o.search=e.toString(),o.hash=location.hash,history.replaceState(null,"",o),!0)}catch{return!1}}function Md(e,n={}){const t=new URL(location.href);t.pathname=e,t.search=n.search??t.search,n.hash!==void 0&&(t.hash=n.hash),n.replace?history.replaceState(history.state,"",t):history.pushState(history.state,"",t),window.dispatchEvent(new PopStateEvent("popstate"))}function xt(){return{route:_d(),embed:fd(),view:wd(),autostart:yd()}}function xd(){const[e,n]=g.useState(xt);return g.useEffect(()=>{const t=()=>n(xt());return window.addEventListener("popstate",t),()=>window.removeEventListener("popstate",t)},[]),e}const Nd="web-demo-framework:height",Ed="web-demo-framework:request-height";function kd(e){return{type:Nd,height:Math.ceil(e)}}const Nt="embed-height-auto";function Id(e=document){return Math.max(e.documentElement.offsetHeight,e.body.scrollHeight)}function Td(e){g.useEffect(()=>{if(!e||typeof window>"u"||window.parent===window)return;const n=document.documentElement;n.classList.add(Nt);let t=-1;const r=(l=!1)=>{const m=Id();!l&&Math.abs(m-t)<2||(t=m,window.parent.postMessage(kd(m),"*"))},o=l=>{if(l.source!==window.parent)return;const m=l.data;!m||m.type!==Ed||r(!0)};window.addEventListener("message",o),r();const s=new ResizeObserver(()=>r());return s.observe(n),()=>{s.disconnect(),window.removeEventListener("message",o),n.classList.remove(Nt)}},[e])}const Et={headline:"The model *runs*. The code is *yours* to edit.",lede:"Every example on this page is a real BPMN process executing in your browser on the nano WebAssembly engine — edit the model, edit the handlers, swap the LLM, and run it again.",tagline:"Runnable Camunda examples"};function jd({text:e}){return i.jsx(i.Fragment,{children:e.split(/\*([^*]+)\*/g).map((n,t)=>t%2===1?i.jsx("em",{children:n},t):i.jsx(g.Fragment,{children:n},t))})}function Sd(){const{route:e,embed:n,view:t,autostart:r}=xd(),o=n&&t==="compact",s=Vt().brain,l=no();Td(n);const m=e.kind==="example"?e.id:We[0].id,p=We.find(f=>f.id===m)??We[0],a=We.filter(f=>f.group!=="learn-bpmn"),u=We.filter(f=>f.group==="learn-bpmn"),h=f=>{Md(vt(f),{hash:location.hash})},d=p.hero??Et,b=i.jsxs(i.Fragment,{children:[!n&&i.jsxs(i.Fragment,{children:[i.jsxs("section",{className:"hero",children:[i.jsx("h1",{children:i.jsx(jd,{text:d.headline})}),d.lede&&i.jsx("p",{children:d.lede})]}),i.jsx("nav",{className:"example-picker","aria-label":"Scenario examples",children:a.map(f=>i.jsx(Z,{size:"sm",variant:f.id===p.id?"default":"secondary","aria-current":f.id===p.id?"page":void 0,onClick:()=>h(f.id),children:f.title},f.id))}),u.length>0&&i.jsxs(i.Fragment,{children:[i.jsx("h2",{className:"example-group-heading",id:"learn-bpmn-heading",children:"Learn BPMN"}),i.jsx("nav",{className:"example-picker","aria-labelledby":"learn-bpmn-heading",children:u.map(f=>i.jsx(Z,{size:"sm",variant:f.id===p.id?"default":"secondary","aria-current":f.id===p.id?"page":void 0,onClick:()=>h(f.id),children:f.title},f.id))})]})]}),i.jsxs("div",{className:"example-meta",children:[p.docsUrl&&i.jsx("a",{className:"docs-link",href:p.docsUrl,target:"_blank",rel:"noreferrer noopener",children:"View on camunda.com ↗"}),n&&i.jsx("a",{className:"open-full-page",href:vt(p.id)+(location.hash||""),target:"_top",rel:"noreferrer",children:o?"Open the editable version ↗":"Open full page ↗"})]}),i.jsx(ho,{example:p,compact:o,autostart:r,initialBrainKind:s,initialTourId:l},p.id)]});return n?i.jsx("div",{className:`c4-ui app-shell app-embed${o?" app-compact":""}`,children:i.jsx("main",{id:"main",className:`layout layout-embed${o?" layout-compact":""}`,children:b})}):i.jsxs("div",{className:"c4-ui app-shell",children:[i.jsx(mr,{className:"topbar",logo:i.jsx("span",{className:"brand-dot","aria-hidden":!0}),appName:"Runnable Camunda examples",trailing:i.jsx("span",{className:"app-subtitle",children:d.tagline??Et.tagline})}),i.jsx("main",{id:"main",className:"layout",children:b}),i.jsx("footer",{className:"footer",children:"Running locally in your browser on the nano WebAssembly BPMN engine — no cluster, no server, no data leaving the page."})]})}vd();tr.createRoot(document.getElementById("root")).render(i.jsx(g.StrictMode,{children:i.jsx(pr,{children:i.jsx(Sd,{})})}));export{ue as _,Dd as c};
