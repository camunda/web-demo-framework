const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/driver-CTZuBZOi.css","assets/diagram-js-DAKGYcfb.css","assets/bpmn-js-BEOU0ddW.css","assets/bpmn-embedded-BShRnYy3.css","assets/RuntimeDiagram-DTnJz5cT.js","assets/vendor-react-9Ma26nY1.js","assets/Viewer-D_7S4Gwm.js","assets/MonacoEditor-BxyGwDvD.js","assets/MonacoEditor-BCIKKqeL.css","assets/vendor-modeler-HLLXEONQ.js","assets/vendor-design-system-CkuJYG9s.js","assets/vendor-design-system-B3_RJ05e.css","assets/parser-DkgAe_kI.js","assets/ModelEditor-Dwlgp6JA.css","assets/FormRenderer-Dy_itFDZ.js","assets/FormRenderer-D1JIHOW6.css"])))=>i.map(i=>d[i]);
var rr=Object.defineProperty;var ir=(e,n,t)=>n in e?rr(e,n,{enumerable:!0,configurable:!0,writable:!0,value:t}):e[n]=t;var R=(e,n,t)=>ir(e,typeof n!="symbol"?n+"":n,t);import{r as g,j as i,i as or}from"./vendor-react-9Ma26nY1.js";import{B as Z,a as ie,L as Ye,S as kn,b as In,c as Tn,d as jn,e as Sn,A as de,f as le,g as ce,I as Kn,C as ar,h as sr,i as dr,j as lr,k as cr,l as mr,T as pr,m as ur,n as rn,o as on,p as hr,q as gr}from"./vendor-design-system-CkuJYG9s.js";(function(){const n=document.createElement("link").relList;if(n&&n.supports&&n.supports("modulepreload"))return;for(const o of document.querySelectorAll('link[rel="modulepreload"]'))r(o);new MutationObserver(o=>{for(const s of o)if(s.type==="childList")for(const d of s.addedNodes)d.tagName==="LINK"&&d.rel==="modulepreload"&&r(d)}).observe(document,{childList:!0,subtree:!0});function t(o){const s={};return o.integrity&&(s.integrity=o.integrity),o.referrerPolicy&&(s.referrerPolicy=o.referrerPolicy),o.crossOrigin==="use-credentials"?s.credentials="include":o.crossOrigin==="anonymous"?s.credentials="omit":s.credentials="same-origin",s}function r(o){if(o.ep)return;o.ep=!0;const s=t(o);fetch(o.href,s)}})();const br="modulepreload",fr=function(e){return"/web-demo-framework/pr-preview/pr-120/"+e},Xn={},ue=function(n,t,r){let o=Promise.resolve();if(t&&t.length>0){let d=function(a){return Promise.all(a.map(p=>Promise.resolve(p).then(h=>({status:"fulfilled",value:h}),h=>({status:"rejected",reason:h}))))};document.getElementsByTagName("link");const m=document.querySelector("meta[property=csp-nonce]"),c=(m==null?void 0:m.nonce)||(m==null?void 0:m.getAttribute("nonce"));o=d(t.map(a=>{if(a=fr(a),a in Xn)return;Xn[a]=!0;const p=a.endsWith(".css"),h=p?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${a}"]${h}`))return;const u=document.createElement("link");if(u.rel=p?"stylesheet":br,p||(u.as="script"),u.crossOrigin="",u.href=a,c&&u.setAttribute("nonce",c),document.head.appendChild(u),p)return new Promise((b,_)=>{u.addEventListener("load",b),u.addEventListener("error",()=>_(new Error(`Unable to preload CSS for ${a}`)))})}))}function s(d){const m=new Event("vite:preloadError",{cancelable:!0});if(m.payload=d,window.dispatchEvent(m),!m.defaultPrevented)throw d}return o.then(d=>{for(const m of d||[])m.status==="rejected"&&s(m.reason);return n().catch(s)})},_r="io.camunda.agenticai:aiagent",Se="http://www.omg.org/spec/BPMN/20100524/MODEL",wr="http://camunda.org/schema/zeebe/1.0";function Pn(e,n){return Array.from(e.getElementsByTagNameNS(wr,n))}function St(e,n){return Pn(e,n).filter(t=>yr(t)===e)}function yr(e){let n=e.parentElement;for(;n;){if(n.namespaceURI===Se&&n.localName!=="extensionElements")return n;n=n.parentElement}return null}function Ln(e){const n=St(e,"taskDefinition")[0],t=n==null?void 0:n.getAttribute("type");return t||(e.localName==="scriptTask"?e.getAttribute("id")??null:null)}function et(e){const n=Array.from(e.children).find(t=>t.namespaceURI===Se&&t.localName==="documentation");return((n==null?void 0:n.textContent)??"").trim()}function nt(e){if(!e)return"";const n=e.startsWith("=")?e.slice(1):e,t=n.match(/"((?:[^"\\]|\\.)*)"/g);return t?t.map(r=>r.slice(1,-1).replace(/\\n/g,`
`).replace(/\\t/g,"	").replace(/\\"/g,'"').replace(/\\\\/g,"\\")).join("").trim():n.trim()}function Pt(e){const n=[],t=r=>{for(const o of Array.from(r.attributes))n.push(o.value);for(const o of Array.from(r.children))t(o)};return t(e),n.join(`
`)}function vr(e){return At(Pt(e))}function Mr(e){const n=Array.from(e.children).find(t=>t.namespaceURI===Se&&t.localName==="extensionElements");return n?At(Pt(n)):[]}function At(e){const n=/fromAi\(\s*toolCall\.([A-Za-z_$][\w$]*)\s*,\s*"((?:[^"\\]|\\.)*)"\s*(?:,\s*"(\w+)")?/g,t=[],r=new Set;for(const o of e.matchAll(n)){const s=o[1];r.has(s)||(r.add(s),t.push({name:s,description:(o[2]??"").replace(/&#10;/g,`
`).replace(/\\"/g,'"').replace(/&quot;/g,'"').replace(/&#39;/g,"'").trim(),type:o[3]??"string"}))}return t}function xr(e){const n={};for(const t of St(e,"input")){const r=t.getAttribute("target");r&&(n[r]=t.getAttribute("source")??"")}return n}function Nr(e){return Array.from(e.getElementsByTagNameNS(Se,"adHocSubProcess")).filter(n=>(Ln(n)??"").startsWith(_r))}const Er=new Set(["subProcess","adHocSubProcess","callActivity"]),kr=new Set(["adHocSubProcess","subProcess","transaction"]);function Ir(e){let n=e.parentElement;for(;n;){if(n.namespaceURI===Se&&kr.has(n.localName))return n;n=n.parentElement}return null}function Tr(e,n){const t=xr(e),r=Number((t["data.limits.maxModelCalls"]??"").replace(/^=/,""));return{elementId:e.getAttribute("id")??"agent",label:e.getAttribute("name")??"Agent",jobType:Ln(e),systemPrompt:nt(t["data.systemPrompt.prompt"]),userPrompt:nt(t["data.userPrompt.prompt"]),maxModelCalls:Number.isFinite(r)&&r>0?r:10,tools:n}}function jr(e,n){var h;const t=e.getAttribute("id")??"",r=e.getAttribute("name")??t,o=Nr(e);o.length>1&&n.push({severity:"warning",elementId:o.map(u=>u.getAttribute("id")).join(", "),message:`Process "${r}" hosts ${o.length} AI Agent sub-processes (${o.map(u=>u.getAttribute("id")).join(", ")}). Each gets its own independent agent state (turn counter, called tools) — the run itself is shared across hosts, but each host's agent state within it is not.`});const s=[],d=new Map(o.map(u=>[u,[]]));for(const u of Array.from(e.getElementsByTagName("*"))){if(u.namespaceURI!==Se||o.includes(u))continue;const b=u.getAttribute("id");if(!b)continue;const _=Ir(u),N=_&&o.includes(_)?_:null;if(N&&Er.has(u.localName)){const M=u.getAttribute("name")??b,x=et(u);s.push({elementId:b,label:M,jobType:"",documentation:x,isTool:!0,compound:!0}),d.get(N).push({elementId:b,label:M,jobType:"",documentation:x,args:Mr(u),compound:!0});continue}const v=Ln(u);if(!v)continue;const f={elementId:b,label:u.getAttribute("name")??b,jobType:v,documentation:et(u),isTool:N!=null};s.push(f),N&&d.get(N).push({elementId:b,label:f.label,jobType:v,documentation:f.documentation,args:vr(u)})}const m=o.map(u=>Tr(u,d.get(u))),c=Array.from(e.getElementsByTagNameNS(Se,"userTask")).map(u=>{var b;return{elementId:u.getAttribute("id")??"",label:u.getAttribute("name")??u.getAttribute("id")??"",formId:((b=Pn(u,"formDefinition")[0])==null?void 0:b.getAttribute("formId"))??void 0}}),a=e.getElementsByTagNameNS(Se,"startEvent")[0],p=a?((h=Pn(a,"formDefinition")[0])==null?void 0:h.getAttribute("formId"))??void 0:void 0;return{processId:t,processName:r,tasks:s,agents:m,userTasks:c,startFormId:p}}function Sr(e,n={}){const t=new DOMParser().parseFromString(e,"application/xml"),r=t.getElementsByTagName("parsererror")[0];if(r)throw new Error(`Invalid BPMN XML: ${r.textContent}`);const o=Array.from(t.getElementsByTagNameNS(Se,"process"));if(o.length===0)throw new Error("No <bpmn:process> in the diagram.");const s=[],d=o.map(c=>jr(c,s));let m=n.processId?d.find(c=>c.processId===n.processId):void 0;return n.processId&&!m&&s.push({severity:"warning",message:`Requested process "${n.processId}" not found — falling back to "${d[0].processId}".`}),m??(m=d[0]),d.length>1&&s.push({severity:"warning",message:`Diagram has ${d.length} <bpmn:process> elements (${d.map(c=>c.processId).join(", ")}); using "${m.processId}" as the active process. Pass a processId to parseModel to target another.`}),{processes:d,diagnostics:s,processId:m.processId,processName:m.processName,tasks:m.tasks,agent:m.agents[0]??null,agents:d.flatMap(c=>c.agents),userTasks:m.userTasks,startFormId:m.startFormId}}function Pr(e){return e?e.imageId?{imageId:e.imageId}:e.imageName?{imageName:e.imageName}:{}:{}}function Dt(e,n){return n?e.pixels:e.imageId??e.pixels}const Ar="No image selected — pick or upload a photo to read.";function tt(){return Ar}function Dr(e,n){return async t=>{const r=e.resolve(n);if(!r)return tt();const o=Dt(r,e.live);if(o===void 0)return tt();try{return await e.read(o,t)}catch(s){return`Couldn't read the image (${s instanceof Error?s.message:String(s)}).`}}}function Cr(e,n){return async()=>{const t=e.resolve(n);if(t)return Dt(t,e.live)}}function Br(){return`<!doctype html><html><head><meta charset="utf-8"></head><body><script>
    "use strict";
    ...
    post({ kind: "ready" });
  <\/script></body></html>`}function Ct(e,n={}){const{timeoutMs:t=5e3,onTrace:r,onVision:o,onImage:s}=n,d=`${Date.now()}-${Math.random().toString(36).slice(2)}`;return new Promise((m,c)=>{const a=document.createElement("iframe");a.setAttribute("sandbox","allow-scripts"),a.style.display="none",a.setAttribute("aria-hidden","true");let p=!1,h;const u=()=>{h&&clearTimeout(h),window.removeEventListener("message",_),a.remove()},b=v=>{p||(p=!0,u(),v())};function _(v){var M;if(v.source!==a.contentWindow)return;const f=v.data;if(!(!f||typeof f!="object")){if(f.kind==="ready"){const x=e.job,V=e.kind==="run-handler"?{kind:"run-handler",id:d,source:e.source,job:x,hasVision:e.hasVision}:{kind:"run-agent",id:d,source:e.source,job:x};(M=a.contentWindow)==null||M.postMessage(V,"*");return}"id"in f&&f.id!==d||(f.kind==="trace"?r==null||r(f.text):f.kind==="vision-request"?N(f.callId,o,"vision",f.prompt):f.kind==="image-request"?N(f.callId,s,"image"):f.kind==="result"?b(()=>m(f.value)):f.kind==="error"&&b(()=>c(new Error(f.message))))}}function N(v,f,M,...x){const V=H=>{var Y;return(Y=a.contentWindow)==null?void 0:Y.postMessage(H,"*")};if(!f){V({kind:"helper-error",id:d,callId:v,message:`${M} helper is not available.`});return}Promise.resolve().then(()=>f(...x)).then(H=>V({kind:"helper-result",id:d,callId:v,value:H}),H=>V({kind:"helper-error",id:d,callId:v,message:H instanceof Error?H.message:String(H)}))}window.addEventListener("message",_),h=setTimeout(()=>{b(()=>c(new Error(`Handler timed out after ${t}ms — the sandboxed run was terminated.`)))},t),a.srcdoc=Br(),document.body.appendChild(a)})}function Bt(e){return{key:e.key,type:e.type,elementId:e.elementId,instanceKey:e.instanceKey,variables:e.variables??{}}}function Lr(e,n,t){const r=typeof t.vision=="function";return Ct({kind:"run-handler",source:e,job:Bt(n),hasVision:r},{onTrace:t.trace,onVision:t.vision?o=>t.vision(o):void 0,onImage:t.image?()=>t.image():void 0})}function Rr(e,n){return Ct({kind:"run-agent",source:e,job:Bt(n)})}function Lt(e,n){try{new Function(`"use strict"; return (${e});`)}catch{throw new Error(`${n} has a syntax error.`)}}function Fr(e){return Lt(e,"Handler code"),(n,t)=>Lr(e,n,t)}function Or(e){return Lt(e,"Agent code"),n=>Rr(e,n)}function zr(e,n,t,r){return{sleep:o=>new Promise(s=>setTimeout(s,o)),trace:o=>n({kind:"tool",text:`   ${o}`,elementId:e.elementId,turn:t}),text:(o,s="")=>{const d=e.variables[o];return typeof d=="string"?d:d==null?s:String(d)},num:(o,s=0)=>{const d=e.variables[o],m=typeof d=="number"?d:Number(d);return Number.isFinite(m)?m:s},...r?{vision:Dr(r,e.instanceKey),image:Cr(r,e.instanceKey)}:{}}}function Ur(e){if(e===void 0)return"undefined";try{return JSON.stringify(e)}catch{return"[unserializable value]"}}function $r(e,n,t,r,o){const s={},d=e.processes.flatMap(c=>c.tasks),m=new Map(d.map(c=>[c.elementId,c.label]));for(const c of d)c.compound||s[c.jobType]||(s[c.jobType]=async a=>{const p=n[a.elementId];if(!p)throw new Error(`No handler registered for ${a.elementId} (job type ${a.type})`);const h=m.get(a.elementId)??a.elementId,u=r==null?void 0:r.current;t({kind:"tool",text:`▶ ${h}`,elementId:a.elementId,turn:u});const b=await p(a,zr(a,t,u,o));return t({kind:"vars",text:`  ↳ ${Ur(b)}`,elementId:a.elementId,result:b,turn:u}),b});return s}const Gr=/\{\{\s*([A-Za-z][A-Za-z0-9_-]*)\s*\}\}/g;function en(...e){const n=Object.create(null);for(const t of e)if(t)for(const r of Object.keys(t))n[r]=t[r];return n}function Rt(e){return(e.split("/").pop()??e).replace(/\.[^./]+$/,"")}function Ft(e){return e.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;")}function Vr(e){return Ft(e).replace(/"/g,"&quot;").replace(/\n/g,"&#10;").replace(/\t/g,"&#9;")}function Yr(e){return e.replace(/\\/g,"\\\\").replace(/&/g,"&amp;").replace(/"/g,"\\&#34;").replace(/\n/g,"&#10;").replace(/\t/g,"&#9;").replace(/</g,"&lt;").replace(/>/g,"&gt;")}function Qr(e){return JSON.stringify(e).slice(1,-1)}function qr(e,n){const t=e.lastIndexOf("<",n),r=e.lastIndexOf(">",n);if(t<=r)return"text";const o=e.slice(t,n);if((o.match(/"/g)??[]).length%2===0)return"text";const d=o.lastIndexOf('"');return(o.slice(d+1).match(/&#34;|&quot;/g)??[]).length%2===1?"feel-literal":"attribute"}function Jr(e,n,t="xml"){const r=[],o=new Set;return{result:e.replace(Gr,(d,m,c)=>{const a=m.trim();if(!Object.prototype.hasOwnProperty.call(n,a))return o.has(a)||(o.add(a),r.push(a)),d;const p=n[a];if(t==="json")return Qr(p);const h=qr(e,c);return h==="feel-literal"?Yr(p):h==="attribute"?Vr(p):Ft(p)}),unresolved:r}}function Hr(){return{processes:[],diagnostics:[],processId:"",processName:"",tasks:[],agent:null,agents:[],userTasks:[],startFormId:void 0}}function Wr(e,n={},t=e.bpmn,r={}){const o=[],s=en(e.templates,r),{result:d,unresolved:m}=Jr(t,s,"xml");for(const f of m)o.push({severity:"warning",message:`Template placeholder "{{${f}}}" has no matching prompt/template content — left in the model as-is, not substituted.`});let c;try{c=Sr(d)}catch(f){return o.push({severity:"error",message:f instanceof Error?f.message:String(f)}),{resolvedBpmn:d,model:Hr(),handlers:{},forms:{},diagnostics:o,hasErrors:!0}}o.push(...c.diagnostics);const a=c.processes.flatMap(f=>f.tasks),p=new Map(e.handlers.map(f=>[f.elementId,f.source])),h={};for(const f of a){if(f.compound)continue;const M=n[f.elementId]??p.get(f.elementId);if(M===void 0){o.push({severity:"error",elementId:f.elementId,jobType:f.jobType,message:`No handler for "${f.label}" (${f.elementId}, job type "${f.jobType}"). Add a handler for this element, or remove it from the diagram.`});continue}try{h[f.elementId]=Fr(M)}catch(x){o.push({severity:"error",elementId:f.elementId,jobType:f.jobType,message:`"${f.label}" (${f.elementId}): handler code didn't compile — ${x instanceof Error?x.message:String(x)}`})}}const u=new Set(a.map(f=>f.elementId)),b=new Set([...p.keys(),...Object.keys(n)]);for(const f of b)u.has(f)||o.push({severity:"error",elementId:f,message:`Handler "${f}" doesn't match any element in the current diagram — likely orphaned by a rename. Rename it back, or remove the handler.`});const _={},N=e.forms??{},v=(f,M)=>{if(!f)return;const x=N[f];x?_[f]=x:o.push({severity:"error",formId:f,message:`${M} references form "${f}", which has no matching schema.`})};for(const f of c.processes){v(f.startFormId,`The start event of process "${f.processName}"`);for(const M of f.userTasks)v(M.formId,`User task "${M.label}" (${M.elementId})`)}return{resolvedBpmn:d,model:c,handlers:h,forms:_,diagnostics:o,hasErrors:o.some(f=>f.severity==="error")}}function Zr(e){const n=e.indexOf("{");if(n<0)return null;let t=0;for(let r=n;r<e.length;r++)if(e[r]==="{")t++;else if(e[r]==="}"&&(t--,t===0))try{const o=JSON.parse(e.slice(n,r+1));return typeof o=="object"&&o!==null&&!Array.isArray(o)?o:null}catch{return null}return null}function An(e,n=220){const t=e.replace(/\s+/g," ").trim();return t.length>n?`${t.slice(0,n-1)}…`:t}function rt(e){const n=e.arguments??e.args??e.parameters??e.input;return n&&typeof n=="object"&&!Array.isArray(n)?n:{}}function it(e){if(!e)return[];const n=e.tool??e.name??e.action;if(typeof n=="string"&&n.trim())return[{name:n.trim(),args:rt(e)}];const t=e.tools??e.tool_calls??e.toolset??e.actions,r=Array.isArray(t)?t:Object.values(e).find(s=>Array.isArray(s))??[],o=[];for(const s of r)if(typeof s=="string")s.trim()&&o.push({name:s.trim(),args:{}});else if(s&&typeof s=="object"){const d=s,m=d.name??d.tool??d.id??d.function;typeof m=="string"&&m.trim()&&o.push({name:m.trim(),args:rt(d)})}return o}function Kr(e){if(!e)return!1;const n=e.done??e.finished??e.complete;return typeof n=="boolean"?n:typeof n=="string"?n.toLowerCase()==="true":!1}function ot(e){const n=e.args.length?e.args.map(r=>`      ${r.name} (${r.type}) — ${r.description}`).join(`
`):"      (none)",t=e.documentation||e.label;return`${e.elementId}
    purpose: ${t}
    arguments:
${n}`}function Xr(e,n,t){const r=e.systemPrompt||"You are an agent driving a business process. Use the tools available to you.",o=t[0]??e.tools[0],s=o!=null&&o.args.length?`{${o.args.map(d=>`"${d.name}": "…"`).join(", ")}}`:"{}";return n?`${r}
...
character, with nothing added. When your work is finished, reply exactly
{"done": true} and no tool.`}function ei(e,n,t,r,o=[],s=[],d=!1){const m=e.userPrompt||"Carry out your task.",c=Object.entries(n).filter(([,p])=>typeof p=="string"&&p.trim().length>0).map(([p,h])=>`  ${p}: ${String(h)}`),a=[m,c.length?`Case data:
${c.join(`
...
`)}async function ni(e,n,t,r,o,s){let d="";n({kind:"llm",text:"LLM thinking…",key:t,pending:!0,turn:s});const m=await e(r,o,c=>{d+=c,n({kind:"llm",text:`${An(d)} ▍`,key:t,pending:!0,turn:s})});return n({kind:"llm",text:An(m||d)||"(empty reply)",key:t,pending:!1,turn:s}),m}function ti(e,n){switch(e){case"number":return typeof n=="number"&&Number.isFinite(n)?{ok:!0,value:n}:typeof n=="string"&&n.trim()!==""&&Number.isFinite(Number(n))?{ok:!0,value:Number(n)}:{ok:!1};case"boolean":return typeof n=="boolean"?{ok:!0,value:n}:typeof n=="string"&&/^(true|false)$/i.test(n.trim())?{ok:!0,value:n.trim().toLowerCase()==="true"}:{ok:!1};default:return typeof n=="object"?{ok:!1}:{ok:!0,value:String(n)}}}function ri(e,n,t){const r={},o=new Map,s=new Map;for(const{tool:d,args:m}of e){const c={};for(const a of d.args){const p=m[a.name];if(!(p!=null&&p!=="")){n({kind:"error",text:`🤖 ${d.elementId}: model supplied no value for "${a.name}"`,turn:t,elementId:d.elementId});continue}const u=o.get(a.name);if(u!==void 0&&u!==d.elementId){n({kind:"error",text:`🤖 argument name collision on "${a.name}": both ${u} and ${d.elementId} declare it — ${u} already claimed it this turn, ${d.elementId}'s value is dropped`,turn:t,elementId:d.elementId});continue}const b=ti(a.type,p);if(!b.ok){n({kind:"error",text:`🤖 ${d.elementId}: "${a.name}" is declared as ${a.type} but the model supplied ${JSON.stringify(p)} — rejected, not passed through`,turn:t,elementId:d.elementId});continue}r[a.name]=b.value,c[a.name]=b.value,o.set(a.name,d.elementId)}s.set(d.elementId,c)}return{variablesOut:r,forHistory:s}}function ii(e,n,t,r={}){const{maxNewTokens:o=384,allowRepeats:s=!1,allowMultiToolTurns:d=!1,turnRef:m,requiredTools:c=[],maxEarlyDoneNudges:a=1,maxUnproductiveTurns:p=3}=r;let h=0;const u=new Set,b=[];let _=0,N=[],v=[];return async f=>{const M=f.variables,x=M.toolCallResult;x!==void 0&&b.length&&(b[b.length-1]=`${b[b.length-1]} → ${An(JSON.stringify(x),160)}`);let V=0;for(;;){const Y=await H();if(Y)return Y;if(V+=1,V>=p)return t({kind:"error",text:`🤖 ${V} turns in a row activated nothing — completing the agent. The model has lost the reply format; whatever it has already run stands.`,turn:h}),{completionConditionFulfilled:!0}}async function H(){if(h+=1,m&&(m.current=h),h>e.maxModelCalls)return t({kind:"error",text:`Turn budget spent (maxModelCalls=${e.maxModelCalls}) — completing the agent.`,turn:h}),{completionConditionFulfilled:!0};const Y=s?e.tools:e.tools.filter(k=>!u.has(k.elementId));if(Y.length===0)return t({kind:"agent",text:"🤖 every tool has run — completing the agent",turn:h}),{completionConditionFulfilled:!0};const he=[{role:"system",content:Xr(e,d,Y)},{role:"user",content:ei(e,M,b,Y,N,v,s)}];N=[],v=[];let Pe;try{Pe=await ni(n,t,`llm-turn-${h}`,he,o,h)}catch(k){return t({kind:"error",text:`LLM call failed: ${k instanceof Error?k.message:String(k)} — completing the agent.`,turn:h}),{completionConditionFulfilled:!0}}const ge=Zr(Pe);if(Kr(ge)&&it(ge).length===0){const k=c.filter(L=>!u.has(L));return k.length&&_<a?(_+=1,N=k,t({kind:"agent",text:`🤖 model says it is done, but ${k.join(", ")} hasn't run — asking once more`,turn:h}),null):(t({kind:"agent",text:"🤖 model says it is done",turn:h}),{completionConditionFulfilled:!0})}const Ee=it(ge);if(Ee.length===0)return t({kind:"error",text:"🤖 model named no tool (and didn't say it was done) — asking again",turn:h}),v=['it named no tool and did not say it was done — reply with {"tool": "...", "arguments": {...}} or {"done": true}'],null;const K=[],be=[],se=[];for(const k of Ee){const L=e.tools.find($=>$.elementId===k.name);if(!L){be.push(k.name);continue}if(!s&&u.has(L.elementId)){se.push(L.elementId);continue}K.push({tool:L,args:k.args})}if(be.length&&t({kind:"error",text:`🤖 model named a tool that doesn't exist: ${be.join(", ")} — nothing activated`,turn:h}),se.length&&t({kind:"error",text:`🤖 model asked to re-run ${se.join(", ")} — skipped (already run)`,turn:h}),K.length===0)return t({kind:"agent",text:"🤖 nothing activated — asking again",turn:h}),v=[...be.length?[`${be.join(", ")} ${be.length===1?"is":"are"} not a real tool`]:[],...se.length?[`${se.join(", ")} has already run and will never run again — pick a different tool, or reply {"done": true} if nothing is left to do`]:[]],null;const{variablesOut:S,forHistory:I}=ri(K,t,h);for(const{tool:k}of K)u.add(k.elementId),b.push(`- ${k.elementId}(${JSON.stringify(I.get(k.elementId))})`);for(const{tool:k}of K)t({kind:"agent",text:`🤖 calling ${k.elementId}`,turn:h,elementId:k.elementId,args:I.get(k.elementId)??{}});return{activateElements:K.map(k=>({elementId:k.tool.elementId})),variables:S}}}}function oi(e,n,t,r={}){const o=new Map(e.map(s=>[s.elementId,ii(s,n,t,r)]));return async s=>{const d=o.get(s.elementId);if(!d)throw new Error(`No agent host registered for "${s.elementId}"`);return d(s)}}class Dn{__destroy_into_raw(){const n=this.__wbg_ptr;return this.__wbg_ptr=0,at.unregister(this),n}free(){const n=this.__destroy_into_raw();l.__wbg_testengine_free(n,0)}activateJobs(n,t,r,o){let s,d;try{const b=l.__wbindgen_add_to_stack_pointer(-16),_=D(n,l.__wbindgen_export,l.__wbindgen_export2),N=P,v=D(o,l.__wbindgen_export,l.__wbindgen_export2),f=P;l.testengine_activateJobs(b,this.__wbg_ptr,_,N,t,r,v,f);var m=y().getInt32(b+0,!0),c=y().getInt32(b+4,!0),a=y().getInt32(b+8,!0),p=y().getInt32(b+12,!0),h=m,u=c;if(p)throw h=0,u=0,z(a);return s=h,d=u,F(h,u)}finally{l.__wbindgen_add_to_stack_pointer(16),l.__wbindgen_export3(s,d,1)}}advanceTime(n){let t,r;try{const p=l.__wbindgen_add_to_stack_pointer(-16);l.testengine_advanceTime(p,this.__wbg_ptr,n);var o=y().getInt32(p+0,!0),s=y().getInt32(p+4,!0),d=y().getInt32(p+8,!0),m=y().getInt32(p+12,!0),c=o,a=s;if(m)throw c=0,a=0,z(d);return t=c,r=a,F(c,a)}finally{l.__wbindgen_add_to_stack_pointer(16),l.__wbindgen_export3(t,r,1)}}assignUserTask(n,t,r){let o,s;try{const u=l.__wbindgen_add_to_stack_pointer(-16),b=D(n,l.__wbindgen_export,l.__wbindgen_export2),_=P,N=D(t,l.__wbindgen_export,l.__wbindgen_export2),v=P;l.testengine_assignUserTask(u,this.__wbg_ptr,b,_,N,v,r);var d=y().getInt32(u+0,!0),m=y().getInt32(u+4,!0),c=y().getInt32(u+8,!0),a=y().getInt32(u+12,!0),p=d,h=m;if(a)throw p=0,h=0,z(c);return o=p,s=h,F(p,h)}finally{l.__wbindgen_add_to_stack_pointer(16),l.__wbindgen_export3(o,s,1)}}broadcastSignal(n,t){let r,o;try{const h=l.__wbindgen_add_to_stack_pointer(-16),u=D(n,l.__wbindgen_export,l.__wbindgen_export2),b=P,_=D(t,l.__wbindgen_export,l.__wbindgen_export2),N=P;l.testengine_broadcastSignal(h,this.__wbg_ptr,u,b,_,N);var s=y().getInt32(h+0,!0),d=y().getInt32(h+4,!0),m=y().getInt32(h+8,!0),c=y().getInt32(h+12,!0),a=s,p=d;if(c)throw a=0,p=0,z(m);return r=a,o=p,F(a,p)}finally{l.__wbindgen_add_to_stack_pointer(16),l.__wbindgen_export3(r,o,1)}}cancelInstance(n){let t,r;try{const p=l.__wbindgen_add_to_stack_pointer(-16),h=D(n,l.__wbindgen_export,l.__wbindgen_export2),u=P;l.testengine_cancelInstance(p,this.__wbg_ptr,h,u);var o=y().getInt32(p+0,!0),s=y().getInt32(p+4,!0),d=y().getInt32(p+8,!0),m=y().getInt32(p+12,!0),c=o,a=s;if(m)throw c=0,a=0,z(d);return t=c,r=a,F(c,a)}finally{l.__wbindgen_add_to_stack_pointer(16),l.__wbindgen_export3(t,r,1)}}completeAgentJob(n,t,r){let o,s;try{const u=l.__wbindgen_add_to_stack_pointer(-16),b=D(n,l.__wbindgen_export,l.__wbindgen_export2),_=P,N=D(t,l.__wbindgen_export,l.__wbindgen_export2),v=P,f=D(r,l.__wbindgen_export,l.__wbindgen_export2),M=P;l.testengine_completeAgentJob(u,this.__wbg_ptr,b,_,N,v,f,M);var d=y().getInt32(u+0,!0),m=y().getInt32(u+4,!0),c=y().getInt32(u+8,!0),a=y().getInt32(u+12,!0),p=d,h=m;if(a)throw p=0,h=0,z(c);return o=p,s=h,F(p,h)}finally{l.__wbindgen_add_to_stack_pointer(16),l.__wbindgen_export3(o,s,1)}}completeJob(n,t){let r,o;try{const h=l.__wbindgen_add_to_stack_pointer(-16),u=D(n,l.__wbindgen_export,l.__wbindgen_export2),b=P,_=D(t,l.__wbindgen_export,l.__wbindgen_export2),N=P;l.testengine_completeJob(h,this.__wbg_ptr,u,b,_,N);var s=y().getInt32(h+0,!0),d=y().getInt32(h+4,!0),m=y().getInt32(h+8,!0),c=y().getInt32(h+12,!0),a=s,p=d;if(c)throw a=0,p=0,z(m);return r=a,o=p,F(a,p)}finally{l.__wbindgen_add_to_stack_pointer(16),l.__wbindgen_export3(r,o,1)}}completeUserTask(n,t){let r,o;try{const h=l.__wbindgen_add_to_stack_pointer(-16),u=D(n,l.__wbindgen_export,l.__wbindgen_export2),b=P,_=D(t,l.__wbindgen_export,l.__wbindgen_export2),N=P;l.testengine_completeUserTask(h,this.__wbg_ptr,u,b,_,N);var s=y().getInt32(h+0,!0),d=y().getInt32(h+4,!0),m=y().getInt32(h+8,!0),c=y().getInt32(h+12,!0),a=s,p=d;if(c)throw a=0,p=0,z(m);return r=a,o=p,F(a,p)}finally{l.__wbindgen_add_to_stack_pointer(16),l.__wbindgen_export3(r,o,1)}}correlateMessage(n,t,r){let o,s;try{const u=l.__wbindgen_add_to_stack_pointer(-16),b=D(n,l.__wbindgen_export,l.__wbindgen_export2),_=P,N=D(t,l.__wbindgen_export,l.__wbindgen_export2),v=P,f=D(r,l.__wbindgen_export,l.__wbindgen_export2),M=P;l.testengine_correlateMessage(u,this.__wbg_ptr,b,_,N,v,f,M);var d=y().getInt32(u+0,!0),m=y().getInt32(u+4,!0),c=y().getInt32(u+8,!0),a=y().getInt32(u+12,!0),p=d,h=m;if(a)throw p=0,h=0,z(c);return o=p,s=h,F(p,h)}finally{l.__wbindgen_add_to_stack_pointer(16),l.__wbindgen_export3(o,s,1)}}createInstance(n,t,r){let o,s;try{const u=l.__wbindgen_add_to_stack_pointer(-16),b=D(n,l.__wbindgen_export,l.__wbindgen_export2),_=P,N=D(t,l.__wbindgen_export,l.__wbindgen_export2),v=P;l.testengine_createInstance(u,this.__wbg_ptr,b,_,N,v,ci(r)?Number.MAX_SAFE_INTEGER:r>>0);var d=y().getInt32(u+0,!0),m=y().getInt32(u+4,!0),c=y().getInt32(u+8,!0),a=y().getInt32(u+12,!0),p=d,h=m;if(a)throw p=0,h=0,z(c);return o=p,s=h,F(p,h)}finally{l.__wbindgen_add_to_stack_pointer(16),l.__wbindgen_export3(o,s,1)}}debugClear(){l.testengine_debugClear(this.__wbg_ptr)}debugCreateInstance(n,t,r){let o,s;try{const u=l.__wbindgen_add_to_stack_pointer(-16),b=D(n,l.__wbindgen_export,l.__wbindgen_export2),_=P,N=D(t,l.__wbindgen_export,l.__wbindgen_export2),v=P,f=D(r,l.__wbindgen_export,l.__wbindgen_export2),M=P;l.testengine_debugCreateInstance(u,this.__wbg_ptr,b,_,N,v,f,M);var d=y().getInt32(u+0,!0),m=y().getInt32(u+4,!0),c=y().getInt32(u+8,!0),a=y().getInt32(u+12,!0),p=d,h=m;if(a)throw p=0,h=0,z(c);return o=p,s=h,F(p,h)}finally{l.__wbindgen_add_to_stack_pointer(16),l.__wbindgen_export3(o,s,1)}}get debugIsPaused(){return l.testengine_debugIsPaused(this.__wbg_ptr)!==0}debugResume(){let n,t;try{const a=l.__wbindgen_add_to_stack_pointer(-16);l.testengine_debugResume(a,this.__wbg_ptr);var r=y().getInt32(a+0,!0),o=y().getInt32(a+4,!0),s=y().getInt32(a+8,!0),d=y().getInt32(a+12,!0),m=r,c=o;if(d)throw m=0,c=0,z(s);return n=m,t=c,F(m,c)}finally{l.__wbindgen_add_to_stack_pointer(16),l.__wbindgen_export3(n,t,1)}}debugStep(){let n,t;try{const a=l.__wbindgen_add_to_stack_pointer(-16);l.testengine_debugStep(a,this.__wbg_ptr);var r=y().getInt32(a+0,!0),o=y().getInt32(a+4,!0),s=y().getInt32(a+8,!0),d=y().getInt32(a+12,!0),m=r,c=o;if(d)throw m=0,c=0,z(s);return n=m,t=c,F(m,c)}finally{l.__wbindgen_add_to_stack_pointer(16),l.__wbindgen_export3(n,t,1)}}deploy(n){let t,r;try{const p=l.__wbindgen_add_to_stack_pointer(-16),h=D(n,l.__wbindgen_export,l.__wbindgen_export2),u=P;l.testengine_deploy(p,this.__wbg_ptr,h,u);var o=y().getInt32(p+0,!0),s=y().getInt32(p+4,!0),d=y().getInt32(p+8,!0),m=y().getInt32(p+12,!0),c=o,a=s;if(m)throw c=0,a=0,z(d);return t=c,r=a,F(c,a)}finally{l.__wbindgen_add_to_stack_pointer(16),l.__wbindgen_export3(t,r,1)}}deployForm(n){let t,r;try{const p=l.__wbindgen_add_to_stack_pointer(-16),h=D(n,l.__wbindgen_export,l.__wbindgen_export2),u=P;l.testengine_deployForm(p,this.__wbg_ptr,h,u);var o=y().getInt32(p+0,!0),s=y().getInt32(p+4,!0),d=y().getInt32(p+8,!0),m=y().getInt32(p+12,!0),c=o,a=s;if(m)throw c=0,a=0,z(d);return t=c,r=a,F(c,a)}finally{l.__wbindgen_add_to_stack_pointer(16),l.__wbindgen_export3(t,r,1)}}deployResource(n,t){let r,o;try{const h=l.__wbindgen_add_to_stack_pointer(-16),u=D(n,l.__wbindgen_export,l.__wbindgen_export2),b=P,_=D(t,l.__wbindgen_export,l.__wbindgen_export2),N=P;l.testengine_deployResource(h,this.__wbg_ptr,u,b,_,N);var s=y().getInt32(h+0,!0),d=y().getInt32(h+4,!0),m=y().getInt32(h+8,!0),c=y().getInt32(h+12,!0),a=s,p=d;if(c)throw a=0,p=0,z(m);return r=a,o=p,F(a,p)}finally{l.__wbindgen_add_to_stack_pointer(16),l.__wbindgen_export3(r,o,1)}}events(){let n,t;try{const a=l.__wbindgen_add_to_stack_pointer(-16);l.testengine_events(a,this.__wbg_ptr);var r=y().getInt32(a+0,!0),o=y().getInt32(a+4,!0),s=y().getInt32(a+8,!0),d=y().getInt32(a+12,!0),m=r,c=o;if(d)throw m=0,c=0,z(s);return n=m,t=c,F(m,c)}finally{l.__wbindgen_add_to_stack_pointer(16),l.__wbindgen_export3(n,t,1)}}failJob(n,t,r){let o,s;try{const u=l.__wbindgen_add_to_stack_pointer(-16),b=D(n,l.__wbindgen_export,l.__wbindgen_export2),_=P,N=D(r,l.__wbindgen_export,l.__wbindgen_export2),v=P;l.testengine_failJob(u,this.__wbg_ptr,b,_,t,N,v);var d=y().getInt32(u+0,!0),m=y().getInt32(u+4,!0),c=y().getInt32(u+8,!0),a=y().getInt32(u+12,!0),p=d,h=m;if(a)throw p=0,h=0,z(c);return o=p,s=h,F(p,h)}finally{l.__wbindgen_add_to_stack_pointer(16),l.__wbindgen_export3(o,s,1)}}migrate(n,t,r){let o,s;try{const u=l.__wbindgen_add_to_stack_pointer(-16),b=D(n,l.__wbindgen_export,l.__wbindgen_export2),_=P,N=D(t,l.__wbindgen_export,l.__wbindgen_export2),v=P,f=D(r,l.__wbindgen_export,l.__wbindgen_export2),M=P;l.testengine_migrate(u,this.__wbg_ptr,b,_,N,v,f,M);var d=y().getInt32(u+0,!0),m=y().getInt32(u+4,!0),c=y().getInt32(u+8,!0),a=y().getInt32(u+12,!0),p=d,h=m;if(a)throw p=0,h=0,z(c);return o=p,s=h,F(p,h)}finally{l.__wbindgen_add_to_stack_pointer(16),l.__wbindgen_export3(o,s,1)}}modify(n,t,r){let o,s;try{const u=l.__wbindgen_add_to_stack_pointer(-16),b=D(n,l.__wbindgen_export,l.__wbindgen_export2),_=P,N=D(t,l.__wbindgen_export,l.__wbindgen_export2),v=P,f=D(r,l.__wbindgen_export,l.__wbindgen_export2),M=P;l.testengine_modify(u,this.__wbg_ptr,b,_,N,v,f,M);var d=y().getInt32(u+0,!0),m=y().getInt32(u+4,!0),c=y().getInt32(u+8,!0),a=y().getInt32(u+12,!0),p=d,h=m;if(a)throw p=0,h=0,z(c);return o=p,s=h,F(p,h)}finally{l.__wbindgen_add_to_stack_pointer(16),l.__wbindgen_export3(o,s,1)}}constructor(){const n=l.testengine_new();return this.__wbg_ptr=n,at.register(this,this.__wbg_ptr,this),this}get now(){return l.testengine_now(this.__wbg_ptr)}reset(){l.testengine_reset(this.__wbg_ptr)}resolveIncident(n){let t,r;try{const p=l.__wbindgen_add_to_stack_pointer(-16),h=D(n,l.__wbindgen_export,l.__wbindgen_export2),u=P;l.testengine_resolveIncident(p,this.__wbg_ptr,h,u);var o=y().getInt32(p+0,!0),s=y().getInt32(p+4,!0),d=y().getInt32(p+8,!0),m=y().getInt32(p+12,!0),c=o,a=s;if(m)throw c=0,a=0,z(d);return t=c,r=a,F(c,a)}finally{l.__wbindgen_add_to_stack_pointer(16),l.__wbindgen_export3(t,r,1)}}setVariables(n,t,r){let o,s;try{const u=l.__wbindgen_add_to_stack_pointer(-16),b=D(n,l.__wbindgen_export,l.__wbindgen_export2),_=P,N=D(t,l.__wbindgen_export,l.__wbindgen_export2),v=P;l.testengine_setVariables(u,this.__wbg_ptr,b,_,N,v,r);var d=y().getInt32(u+0,!0),m=y().getInt32(u+4,!0),c=y().getInt32(u+8,!0),a=y().getInt32(u+12,!0),p=d,h=m;if(a)throw p=0,h=0,z(c);return o=p,s=h,F(p,h)}finally{l.__wbindgen_add_to_stack_pointer(16),l.__wbindgen_export3(o,s,1)}}snapshot(){let n,t;try{const a=l.__wbindgen_add_to_stack_pointer(-16);l.testengine_snapshot(a,this.__wbg_ptr);var r=y().getInt32(a+0,!0),o=y().getInt32(a+4,!0),s=y().getInt32(a+8,!0),d=y().getInt32(a+12,!0),m=r,c=o;if(d)throw m=0,c=0,z(s);return n=m,t=c,F(m,c)}finally{l.__wbindgen_add_to_stack_pointer(16),l.__wbindgen_export3(n,t,1)}}throwError(n,t,r){let o,s;try{const u=l.__wbindgen_add_to_stack_pointer(-16),b=D(n,l.__wbindgen_export,l.__wbindgen_export2),_=P,N=D(t,l.__wbindgen_export,l.__wbindgen_export2),v=P,f=D(r,l.__wbindgen_export,l.__wbindgen_export2),M=P;l.testengine_throwError(u,this.__wbg_ptr,b,_,N,v,f,M);var d=y().getInt32(u+0,!0),m=y().getInt32(u+4,!0),c=y().getInt32(u+8,!0),a=y().getInt32(u+12,!0),p=d,h=m;if(a)throw p=0,h=0,z(c);return o=p,s=h,F(p,h)}finally{l.__wbindgen_add_to_stack_pointer(16),l.__wbindgen_export3(o,s,1)}}tickNow(n){let t,r;try{const p=l.__wbindgen_add_to_stack_pointer(-16);l.testengine_tickNow(p,this.__wbg_ptr,n);var o=y().getInt32(p+0,!0),s=y().getInt32(p+4,!0),d=y().getInt32(p+8,!0),m=y().getInt32(p+12,!0),c=o,a=s;if(m)throw c=0,a=0,z(d);return t=c,r=a,F(c,a)}finally{l.__wbindgen_add_to_stack_pointer(16),l.__wbindgen_export3(t,r,1)}}unassignUserTask(n){let t,r;try{const p=l.__wbindgen_add_to_stack_pointer(-16),h=D(n,l.__wbindgen_export,l.__wbindgen_export2),u=P;l.testengine_unassignUserTask(p,this.__wbg_ptr,h,u);var o=y().getInt32(p+0,!0),s=y().getInt32(p+4,!0),d=y().getInt32(p+8,!0),m=y().getInt32(p+12,!0),c=o,a=s;if(m)throw c=0,a=0,z(d);return t=c,r=a,F(c,a)}finally{l.__wbindgen_add_to_stack_pointer(16),l.__wbindgen_export3(t,r,1)}}updateRetries(n,t){let r,o;try{const h=l.__wbindgen_add_to_stack_pointer(-16),u=D(n,l.__wbindgen_export,l.__wbindgen_export2),b=P;l.testengine_updateRetries(h,this.__wbg_ptr,u,b,t);var s=y().getInt32(h+0,!0),d=y().getInt32(h+4,!0),m=y().getInt32(h+8,!0),c=y().getInt32(h+12,!0),a=s,p=d;if(c)throw a=0,p=0,z(m);return r=a,o=p,F(a,p)}finally{l.__wbindgen_add_to_stack_pointer(16),l.__wbindgen_export3(r,o,1)}}updateUserTask(n,t){let r,o;try{const h=l.__wbindgen_add_to_stack_pointer(-16),u=D(n,l.__wbindgen_export,l.__wbindgen_export2),b=P,_=D(t,l.__wbindgen_export,l.__wbindgen_export2),N=P;l.testengine_updateUserTask(h,this.__wbg_ptr,u,b,_,N);var s=y().getInt32(h+0,!0),d=y().getInt32(h+4,!0),m=y().getInt32(h+8,!0),c=y().getInt32(h+12,!0),a=s,p=d;if(c)throw a=0,p=0,z(m);return r=a,o=p,F(a,p)}finally{l.__wbindgen_add_to_stack_pointer(16),l.__wbindgen_export3(r,o,1)}}}Symbol.dispose&&(Dn.prototype[Symbol.dispose]=Dn.prototype.free);function ai(){return{__proto__:null,"./nanobpmn_engine_bg.js":{__proto__:null,__wbg___wbindgen_throw_bb96b2010945f0bc:function(n,t){throw new Error(F(n,t))},__wbindgen_cast_0000000000000001:function(n,t){const r=F(n,t);return si(r)},__wbindgen_object_drop_ref:function(n){z(n)}}}}const at=typeof FinalizationRegistry>"u"?{register:()=>{},unregister:()=>{}}:new FinalizationRegistry(e=>l.__wbg_testengine_free(e,1));function si(e){Ke===je.length&&je.push(je.length+1);const n=Ke;return Ke=je[n],je[n]=e,n}function di(e){e<1028||(je[e]=Ke,Ke=e)}let Fe=null;function y(){return(Fe===null||Fe.buffer.detached===!0||Fe.buffer.detached===void 0&&Fe.buffer!==l.memory.buffer)&&(Fe=new DataView(l.memory.buffer)),Fe}function F(e,n){return pi(e>>>0,n)}let Ze=null;function dn(){return(Ze===null||Ze.byteLength===0)&&(Ze=new Uint8Array(l.memory.buffer)),Ze}function li(e){return je[e]}let je=new Array(1024).fill(void 0);je.push(void 0,null,!0,!1);let Ke=je.length;function ci(e){return e==null}function D(e,n,t){if(t===void 0){const m=Xe.encode(e),c=n(m.length,1)>>>0;return dn().subarray(c,c+m.length).set(m),P=m.length,c}let r=e.length,o=n(r,1)>>>0;const s=dn();let d=0;for(;d<r;d++){const m=e.charCodeAt(d);if(m>127)break;s[o+d]=m}if(d!==r){d!==0&&(e=e.slice(d)),o=t(o,r,r=d+e.length*3,1)>>>0;const m=dn().subarray(o+d,o+r),c=Xe.encodeInto(e,m);d+=c.written,o=t(o,r,d,1)>>>0}return P=d,o}function z(e){const n=li(e);return di(e),n}let ln=new TextDecoder("utf-8",{ignoreBOM:!0,fatal:!0});ln.decode();const mi=2146435072;let vn=0;function pi(e,n){return vn+=n,vn>=mi&&(ln=new TextDecoder("utf-8",{ignoreBOM:!0,fatal:!0}),ln.decode(),vn=n),ln.decode(dn().subarray(e,e+n))}const Xe=new TextEncoder;"encodeInto"in Xe||(Xe.encodeInto=function(e,n){const t=Xe.encode(e);return n.set(t),{read:e.length,written:t.length}});let P=0,l;function ui(e,n){return l=e.exports,Fe=null,Ze=null,l}async function hi(e,n){if(typeof Response=="function"&&e instanceof Response){if(!e.ok)throw new Error(`failed to fetch Wasm: ${e.status} ${e.statusText} fetching '${e.url}'`);if(typeof WebAssembly.instantiateStreaming=="function")try{return await WebAssembly.instantiateStreaming(e,n)}catch(o){if(t(e.type)&&e.headers.get("Content-Type")!=="application/wasm")console.warn("`WebAssembly.instantiateStreaming` failed because your server does not serve Wasm with `application/wasm` MIME type. Falling back to `WebAssembly.instantiate` which is slower. Original error:\n",o);else throw o}const r=await e.arrayBuffer();return await WebAssembly.instantiate(r,n)}else{const r=await WebAssembly.instantiate(e,n);return r instanceof WebAssembly.Instance?{instance:r,module:e}:r}function t(r){switch(r){case"basic":case"cors":case"default":return!0}return!1}}async function gi(e){if(l!==void 0)return l;e!==void 0&&(Object.getPrototypeOf(e)===Object.prototype?{module_or_path:e}=e:console.warn("using deprecated parameters for the initialization function; pass a single object instead")),e===void 0&&(e=new URL("/web-demo-framework/pr-preview/pr-120/assets/nanobpmn_engine_bg-DRNrIVE8.wasm",import.meta.url));const n=ai();(typeof e=="string"||typeof Request=="function"&&e instanceof Request||typeof URL=="function"&&e instanceof URL)&&(e=fetch(e));const{instance:t,module:r}=await hi(await e,n);return ui(t)}let an=null;function bi(e){return an||(an=gi(void 0).then(()=>{}).catch(n=>{throw an=null,n})),an}function ne(e){return JSON.parse(e)}class fi{constructor(n){R(this,"engine");this.engine=n}deploy(n){return JSON.parse(this.engine.deploy(n))}createInstance(n,t){return ne(this.engine.createInstance(n,t||"{}"))}activateJobs(n,t,r,o){return JSON.parse(this.engine.activateJobs(n,t,r,o))}completeJob(n,t){return ne(this.engine.completeJob(n,t||"{}"))}completeAgentJob(n,t){const{variables:r,...o}=t??{};return ne(this.engine.completeAgentJob(n,JSON.stringify(r??{}),JSON.stringify(o??{})))}failJob(n,t,r){return ne(this.engine.failJob(n,t,r))}throwError(n,t,r){return ne(this.engine.throwError(n,t,r))}updateRetries(n,t){return ne(this.engine.updateRetries(n,t))}resolveIncident(n){return ne(this.engine.resolveIncident(n))}setVariables(n,t,r){return ne(this.engine.setVariables(n,t||"{}",r))}broadcastSignal(n,t){return ne(this.engine.broadcastSignal(n,t||"{}"))}cancelInstance(n){return ne(this.engine.cancelInstance(n))}modify(n,t,r){return ne(this.engine.modify(n,JSON.stringify(t??[]),JSON.stringify(r??[])))}completeUserTask(n,t){return ne(this.engine.completeUserTask(n,t||"{}"))}assignUserTask(n,t,r){return ne(this.engine.assignUserTask(n,t,r))}unassignUserTask(n){return ne(this.engine.unassignUserTask(n))}updateUserTask(n,t){return ne(this.engine.updateUserTask(n,t||"{}"))}correlateMessage(n,t,r){return ne(this.engine.correlateMessage(n,t,r||"{}"))}advanceTime(n){return ne(this.engine.advanceTime(n))}reset(){this.engine.reset()}events(){return JSON.parse(this.engine.events())}snapshot(){return ne(this.engine.snapshot())}free(){this.engine.free()}}async function _i(e){return await bi(),new fi(new Dn)}class Ot extends Error{constructor(t,r){super(t);R(this,"retries");this.name="JobFailure",this.retries=r==null?void 0:r.retries}}function wi(e,n=[]){if(e.instances.filter(o=>!o.completed).length===0)return e.totalInstances>0?"completed":"idle";if(e.incidents.length>0)return"incidents";const r=new Set(n);return e.jobs.some(o=>!r.has(o.jobType))?"unhandledJobs":e.userTasks.some(o=>o.state==="Created")?"userTasks":e.timers.length>0?"timers":e.messageSubscriptions.length>0?"messages":e.signalSubscriptions.length>0?"signals":"idle"}function yi(e,n=[]){const t=new Set(n);return[...new Set(e.jobs.map(r=>r.jobType))].filter(r=>!t.has(r)).sort()}async function vi(e,n,t){let r;try{const o=await n(t);r=JSON.stringify(o??{})}catch(o){const s=o instanceof Ot&&o.retries!==void 0?o.retries:Math.max(0,t.retries-1),d=o instanceof Error?o.message:String(o);e.failJob(t.key,s,d);return}e.completeJob(t.key,r)}async function Mi(e,n,t){let r;try{r=await n(t),JSON.stringify(r)}catch(o){const s=o instanceof Ot&&o.retries!==void 0?o.retries:Math.max(0,t.retries-1),d=o instanceof Error?o.message:String(o);e.failJob(t.key,s,d);return}e.completeAgentJob(t.key,r)}async function xi(e,n,t={}){const r=t.maxJobsPerActivation??10,o=t.lockTimeoutMs??3e4,s=t.worker??"bojtos",d=t.agents??{};for(const u of Object.keys(d))if(u in n)throw new Error(`dispatchRound: job type "${u}" is registered as both a worker and an agent — register it as exactly one`);const m=[];for(const[u,b]of Object.entries(n))for(const _ of e.activateJobs(u,r,o,s))m.push({handler:b,job:_});const c=[];for(const[u,b]of Object.entries(d))for(const _ of e.activateJobs(u,r,o,s))c.push({handler:b,job:_});for(const{handler:u,job:b}of m)await vi(e,u,b);for(const{handler:u,job:b}of c)await Mi(e,u,b);const a=e.snapshot(),p=m.length+c.length;if(p>0)return{snapshot:a,handled:p};const h=[...Object.keys(n),...Object.keys(d)];return{snapshot:a,handled:p,reason:wi(a,h),unhandled:yi(a,h)}}function Ni({bpmn:e}){const n=g.useRef(null),[t,r]=g.useState("loading"),[o,s]=g.useState(null),[d,m]=g.useState([]),[c,a]=g.useState(null),p=g.useRef(e),h=g.useRef(0),u=g.useRef(null),b=g.useRef(new Map),_=g.useCallback((S,I)=>{b.current.set(S,I)},[]),N=g.useCallback(S=>b.current.get(S),[]),v=g.useCallback((S,I)=>{const k=S.deploy(I);return p.current=I,b.current.clear(),m(k.processIds),a(null),s(null),k.processIds},[]);g.useEffect(()=>{let S=!1;return r("loading"),m([]),a(null),s(null),_i().then(I=>{if(S){I.free();return}try{v(I,e)}catch(k){I.free(),s(String(k)),r("error");return}n.current=I,r("ready")}).catch(I=>{S||(s(String(I)),r("error"))}),()=>{var I;S=!0,(I=n.current)==null||I.free(),n.current=null,b.current.clear()}},[e]);const f=g.useCallback(S=>{const I=n.current;if(!I)return null;try{const k=S(I);return a(k),s(null),k}catch(k){return s(String(k)),null}},[]),M=g.useCallback((S,I)=>f(k=>k.createInstance(S,I)),[f]),x=g.useCallback((S,I)=>f(k=>k.completeUserTask(S,I)),[f]),V=g.useCallback(S=>f(I=>I.advanceTime(S)),[f]),H=g.useCallback((S,I)=>f(k=>k.broadcastSignal(S,I)),[f]);function Y(S,I){const[k]=S.activateJobs(I,1,3e4,"manual-control");if(!k)throw new Error(`No waiting job of type "${I}" to resolve.`);return k}const he=g.useCallback((S,I)=>f(k=>{const L=Y(k,S);return k.completeJob(L.key,I)}),[f]),Pe=g.useCallback((S,I,k)=>f(L=>{const $=Y(L,S);return L.throwError($.key,I,k)}),[f]),ge=g.useCallback((S,I,k)=>f(L=>L.correlateMessage(S,I,k)),[f]),Ee=g.useCallback(async(S,I)=>{const k=n.current;if(!k)return null;const L=h.current,$=xi(k,S,I);u.current=$;try{const ye=await $;return n.current!==k||h.current!==L?null:(a(ye.snapshot),s(null),ye)}catch(ye){return n.current!==k||h.current!==L||(a(k.snapshot()),s(String(ye))),null}finally{u.current===$&&(u.current=null)}},[]),K=g.useCallback(async()=>{var S;await((S=u.current)==null?void 0:S.catch(()=>{}))},[]),be=g.useCallback(async()=>{await K();const S=n.current;if(S){h.current++;try{S.reset(),v(S,p.current)}catch(I){s(String(I))}}},[v,K]),se=g.useCallback(async S=>{await K();const I=n.current;if(!I)return null;h.current++;try{return I.reset(),v(I,S)}catch(k){return s(String(k)),null}},[v,K]);return{phase:t,error:o,processIds:d,snapshot:c,createInstance:M,stepWorkers:Ee,completeUserTask:x,advanceTime:V,broadcastSignal:H,completeJobManually:he,throwJobError:Pe,correlateMessage:ge,reset:be,redeploy:se,setRunImage:_,getRunImage:N}}const Ei="web-demo-framework:height",ki="web-demo-framework:ready";function Ii(){return{type:ki}}const Ti="web-demo-framework:request-height";function ji(e){return{type:Ei,height:Math.ceil(e)}}const st="embed-height-auto";function Si(e=document){return Math.max(e.documentElement.offsetHeight,e.body.scrollHeight)}function Pi(e){g.useEffect(()=>{if(!e||typeof window>"u"||window.parent===window)return;const n=document.documentElement;n.classList.add(st);let t=-1;const r=(d=!1)=>{const m=Si();!d&&Math.abs(m-t)<2||(t=m,window.parent.postMessage(ji(m),"*"))},o=d=>{if(d.source!==window.parent)return;const m=d.data;!m||m.type!==Ti||r(!0)};window.addEventListener("message",o),r();const s=new ResizeObserver(()=>r());return s.observe(n),()=>{s.disconnect(),window.removeEventListener("message",o),n.classList.remove(st)}},[e])}function Ai(e){const n=g.useRef(!1);g.useEffect(()=>{!e||n.current||typeof window>"u"||window.parent===window||(n.current=!0,window.parent.postMessage(Ii(),"*"))},[e])}function Di(e,n){return e.slice(n)}function Ci(e,n,t,r){const o=e.snapshot,s="⏸ waiting for a human — complete the task below to continue",d=o.userTasks.some(m=>m.state==="Created");if(e.handled>0){const m=o.activeElementIds.map(t),c=n.length?` via ${n.map(a=>`${t(a.from)} → ${t(a.to)}`).join(", ")}`:"";return o.completedInstances>=1?{kind:"done",text:`⏭ round handled ${e.handled} job${e.handled===1?"":"s"}${c} — ✅ process instance completed`}:d?{kind:"human",text:`⏭ round handled ${e.handled} job${e.handled===1?"":"s"}${c} — ${s}`}:{kind:"step",text:`⏭ round handled ${e.handled} job${e.handled===1?"":"s"}${c} — now at ${m.length?m.join(", "):"—"}`}}switch(e.reason){case"completed":return{kind:"done",text:"✅ process instance completed"};case"userTasks":return{kind:"human",text:s};case"timers":return{kind:"step",text:"⏱ waiting on a timer — advance the clock to continue"};case"messages":return{kind:"step",text:"✉ waiting on a message — correlate it to continue"};case"signals":return{kind:"step",text:"📶 waiting on a signal — broadcast it to continue"};case"incidents":return{kind:"error",text:"A job failed — incident on the diagram"};case"unhandledJobs":{const m=e.unhandled??[];return r&&m.length>0&&m.every(c=>r.has(c))?{kind:"human",text:s}:{kind:"error",text:`⏭ waiting on job type(s) with no worker registered: ${m.join(", ")}`}}case"idle":return{kind:"step",text:"Nothing to step — no instance is running."};default:return{kind:"step",text:e.reason?`Step blocked on an unrecognized reason: ${e.reason}`:"Nothing to step — no instance is running."}}}const Bi="the Scripted or Endpoint brain";async function mn(e=Bi){const n=navigator.gpu;if(!n)return`This browser doesn't expose WebGPU at all. Use a recent Chrome, Edge, or Safari 17+ with hardware acceleration on, or pick ${e}.`;let t;try{t=await n.requestAdapter()}catch(r){return`WebGPU adapter request failed (${r instanceof Error?r.message:String(r)}). Try ${e} instead.`}return t?null:`This browser supports the WebGPU API, but no GPU adapter is available — hardware acceleration may be off, or this device/VM has no usable GPU. Pick ${e} instead.`}const Li=[{id:"Qwen2.5-1.5B-Instruct-q4f16_1-MLC",label:"Qwen2.5 1.5B",downloadLabel:"~1.0 GB"},{id:"SmolLM2-1.7B-Instruct-q4f16_1-MLC",label:"SmolLM2 1.7B",downloadLabel:"~1.1 GB"},{id:"Llama-3.2-1B-Instruct-q4f16_1-MLC",label:"Llama 3.2 1B",downloadLabel:"~0.7 GB"},{id:"gemma-2-2b-it-q4f16_1-MLC",label:"Gemma 2 2B",downloadLabel:"~1.5 GB"},{id:"Llama-3.2-1B-Instruct-q4f32_1-MLC",label:"Llama 3.2 1B (f32, wider GPU support)",downloadLabel:"~1.1 GB"},{id:"SmolLM2-360M-Instruct-q4f32_1-MLC",label:"SmolLM2 360M (tiny, f32)",downloadLabel:"~0.6 GB"},{id:"SmolLM2-360M-Instruct-q4f16_1-MLC",label:"SmolLM2 360M (tiny)",downloadLabel:"~0.3 GB"}];function zt(e){return Cn.get(e)??{}}const Cn=new Map;async function Ri(){if(Cn.size>0)return;const{prebuiltAppConfig:e}=await ue(async()=>{const{prebuiltAppConfig:n}=await import("./vendor-webllm-DT0Ab8E6.js");return{prebuiltAppConfig:n}},[]);for(const n of e.model_list)Cn.set(n.model_id,{vramRequiredMB:n.vram_required_MB,requiredFeatures:n.required_features})}const bn=Li.map(e=>({id:e.id,label:`${e.label} (${e.downloadLabel})`,downloadLabel:e.downloadLabel,...zt(e.id)})),Ut=bn[0].id;async function Fi(){return await Ri(),bn.map(e=>({...e,...zt(e.id)}))}function $t(){const e=navigator.deviceMemory;return typeof e=="number"?e*1024:null}function Oi(e,n=$t()){return n==null||e.vramRequiredMB==null||n>=e.vramRequiredMB?null:`${e.label} needs roughly ${Math.round(e.vramRequiredMB)} MB of GPU memory; this device looks like it has about ${Math.round(n)} MB available. It may still work, but expect it to fail or fall back to slow shared memory — try a smaller model (e.g. SmolLM2 360M) if it doesn't load.`}async function zi(e){try{const{hasModelInCache:n}=await ue(async()=>{const{hasModelInCache:t}=await import("./vendor-webllm-DT0Ab8E6.js");return{hasModelInCache:t}},[]);return await n(e)}catch{return!1}}function pn(e){return/device (was )?lost|device_hung|device_removed|already been disposed|gpudevicelostinfo/i.test(e)}function dt(){return"The GPU device was lost — the driver reset while the model was loading or running. This is a browser/driver-level failure, not a problem with the model: fully quit and reopen the browser (a lost device usually persists for the life of the GPU process), check chrome://gpu still reports hardware acceleration, and update your GPU driver if it recurs. The Scripted and Endpoint brains don't use the GPU at all."}class sn{constructor(){R(this,"kind","browser");R(this,"model",null);R(this,"engine",null);R(this,"worker",null);R(this,"generation",0);R(this,"chat",async(n,t=512,r)=>{var s,d;const o=this.engine;if(!o||!this.model)throw new Error("BrowserBrain.chat called before connect()");try{const m=await o.chat.completions.create({messages:n,temperature:0,max_tokens:t,stream:!0});let c="";for await(const a of m){const p=((d=(s=a.choices[0])==null?void 0:s.delta)==null?void 0:d.content)??"";p&&(c+=p,r==null||r(p))}return c}catch(m){const c=m instanceof Error?m.message:String(m);throw pn(c)?(this.teardown(),new Error(`The in-browser model stopped: ${dt()}`)):m}})}async connect(n=Ut,t){var c,a;const r=await mn();if(r)throw new Error(r);if(this.engine&&this.model===n)return n;const o=++this.generation,s=p=>{o===this.generation&&(t==null||t({progress:p.progress??0,text:p.text??""}))};this.teardown();let d,m;try{const{CreateWebWorkerMLCEngine:p}=await ue(async()=>{const{CreateWebWorkerMLCEngine:h}=await import("./vendor-webllm-DT0Ab8E6.js");return{CreateWebWorkerMLCEngine:h}},[]);m=new Worker(new URL("/web-demo-framework/pr-preview/pr-120/assets/webllm.worker-Dc1cCqhL.js",import.meta.url),{type:"module"}),d=await p(m,n,{initProgressCallback:s})}catch(p){if(m==null||m.terminate(),o!==this.generation)throw new Error("cancelled");const h=p instanceof Error?p.message:String(p);if(pn(h))throw new Error(`Couldn't load ${n} in the browser (${h}). ${dt()}`);const u=(a=(c=bn.find(b=>b.id===n))==null?void 0:c.requiredFeatures)==null?void 0:a.includes("shader-f16");throw new Error(`Couldn't load ${n} in the browser (${h}). `+(u?"This model needs WebGPU with shader-f16; try one of the f32 models in the list, or the endpoint brain.":"Try a smaller model, check your connection, or use the endpoint brain instead."))}if(o!==this.generation)throw d.unload().catch(()=>{}),m==null||m.terminate(),new Error("cancelled");return this.engine=d,this.worker=m??null,this.model=n,n}teardown(){const{engine:n,worker:t}=this;this.engine=null,this.worker=null,this.model=null,n==null||n.unload().catch(()=>{}),t==null||t.terminate()}cancelConnect(){this.generation++}dispose(){this.generation++,this.teardown()}}const Rn="http://localhost:11434/v1",un=e=>e==="localhost"||e==="127.0.0.1"||e==="::1"||e==="[::1]";function Gt(){var e;return un(((e=globalThis.location)==null?void 0:e.hostname)??"")}function Mn(e){try{return un(new URL(Fn(e)).hostname)}catch{return!1}}function hn(e,n={hostname:(t=>(t=globalThis.location)==null?void 0:t.hostname)()??"",origin:(r=>(r=globalThis.location)==null?void 0:r.origin)()??""}){let o;try{o=new URL(Fn(e)).hostname}catch{return null}return!un(o)||un(n.hostname)?null:`This page is served from ${n.origin||"a non-local origin"}, so it can't reach ${e}. A local model server only accepts requests from a page on localhost. Open this page at http://localhost instead, or use the Scripted or In-browser brain.`}function Fn(e){let n=e.trim().replace(/\/+$/,"");return n.endsWith("/chat/completions")&&(n=n.slice(0,-17)),/\/v\d+$/.test(n)||(n=`${n}/v1`),n}class lt extends Error{constructor(n,t){super(n),this.status=t,this.name="HttpError"}}class ct{constructor(n=Rn,t="",r=""){R(this,"kind","endpoint");R(this,"baseUrl");R(this,"model",null);R(this,"models",[]);R(this,"apiKey");R(this,"requestedModel");R(this,"chat",async(n,t=512,r)=>{var a,p,h;if(!this.model)throw new Error("EndpointBrain.chat called before connect()");const o=await fetch(`${this.baseUrl}/chat/completions`,{method:"POST",headers:this.headers(),body:JSON.stringify({model:this.model,messages:n,temperature:0,max_tokens:t,stream:!0})});if(!o.ok||!o.body){const u=await o.text().catch(()=>"");throw new Error(`chat/completions HTTP ${o.status} ${o.statusText}${u?` — ${u.slice(0,300)}`:""}`)}const s=o.body.getReader(),d=new TextDecoder;let m="",c="";for(;;){const{value:u,done:b}=await s.read();if(b)break;m+=d.decode(u,{stream:!0});let _;for(;(_=m.indexOf(`
`))>=0;){const N=m.slice(0,_).trim();if(m=m.slice(_+1),!N.startsWith("data:"))continue;const v=N.slice(5).trim();if(v==="[DONE]")continue;let f;try{f=JSON.parse(v)}catch{continue}f.model&&(this.model=f.model);const M=(a=f.choices)==null?void 0:a[0],x=((p=M==null?void 0:M.delta)==null?void 0:p.content)??((h=M==null?void 0:M.message)==null?void 0:h.content)??"";x&&(c+=x,r==null||r(x))}}return c});this.baseUrl=Fn(n),this.apiKey=t.trim(),this.requestedModel=r.trim()}headers(){const n={"Content-Type":"application/json"};return this.apiKey&&(n.Authorization=`Bearer ${this.apiKey}`),n}async listModels(){let n;try{n=await fetch(`${this.baseUrl}/models`,{headers:this.headers()})}catch(r){const o=hn(this.baseUrl);throw new Error(o??`Can't reach ${this.baseUrl} (${r instanceof Error?r.message:String(r)}). Is the server running? For Ollama, check the app is up — and if this page is served from another origin, allow it with OLLAMA_ORIGINS.`)}if(!n.ok)throw new lt(`${this.baseUrl}/models returned HTTP ${n.status} ${n.statusText}`,n.status);const t=await n.json();return this.models=(t.data??[]).map(r=>r.id).filter(r=>!!r),this.models}async connect(){try{const n=await this.listModels(),t=this.requestedModel||n[0];if(!t)throw new Error(`No models available at ${this.baseUrl}. Pull one first — e.g. \`ollama pull llama3.2:3b\` — or name one explicitly.`);this.model=t}catch(n){const t=n instanceof lt&&[404,405,501].includes(n.status);if(!this.requestedModel||!t)throw n;this.models=[],this.model=this.requestedModel}return await this.validate(),this.model}async validate(){const n=await fetch(`${this.baseUrl}/chat/completions`,{method:"POST",headers:this.headers(),body:JSON.stringify({model:this.model,messages:[{role:"user",content:"Reply with ok."}],temperature:0,max_tokens:1,stream:!1})}).catch(r=>{throw new Error(`Can't reach ${this.baseUrl}/chat/completions (${r instanceof Error?r.message:String(r)}). Check the endpoint URL, API key, model name, and any local CORS settings.`)});if(!n.ok){const r=await n.text().catch(()=>"");throw new Error(`chat/completions HTTP ${n.status} ${n.statusText}${r?` — ${r.slice(0,300)}`:""}`)}const t=await n.json().catch(()=>({}));t.model&&(this.model=t.model)}dispose(){}}const mt="gemini-nano";function gn(){const e=globalThis.LanguageModel;return typeof(e==null?void 0:e.create)=="function"&&typeof e.availability=="function"?e:null}function Ui(){return gn()!==null}async function Vt(){const e=gn();if(!e)return"This browser has no built-in AI model. Chrome's Prompt API (Gemini Nano) needs Chrome 138+ on desktop Windows 10/11, macOS 13+, Linux or a Chromebook Plus. Use the Scripted, In-browser (WebGPU) or API endpoint brain instead.";let n;try{n=await e.availability()}catch(t){return`Chrome couldn't report on its built-in model (${t instanceof Error?t.message:String(t)}).`}return n==="unavailable"?"Chrome exposes the built-in AI API here, but Gemini Nano can't run on this device. Chrome requires ~22 GB free on the volume holding your Chrome profile, and either a GPU with more than 4 GB of VRAM or 16 GB of RAM with 4+ CPU cores. Check chrome://on-device-internals for the details.":null}class pt{constructor(){R(this,"kind","chrome");R(this,"model",null);R(this,"warm",null);R(this,"connecting",null);R(this,"chat",async(n,t,r)=>{if(!this.model)throw new Error("ChromeBrain.chat called before connect()");const o=gn();if(!o)throw new Error("Chrome's built-in AI API went away.");const s=n.filter(c=>c.role==="system"),d=n.filter(c=>c.role!=="system"),m=await o.create(s.length?{initialPrompts:s}:void 0);try{const c=m.promptStreaming(d).getReader();let a="";for(;;){const{done:p,value:h}=await c.read();if(p)break;h&&(a+=h,r==null||r(h))}return a}finally{m.destroy()}})}async connect(n){const t=await Vt();if(t)throw new Error(t);const r=gn();this.dispose();const o=new AbortController;this.connecting=o;try{this.warm=await r.create({signal:o.signal,monitor:s=>{s.addEventListener("downloadprogress",d=>{n==null||n({progress:d.loaded,text:"Downloading Gemini Nano"})})}})}catch(s){if(o.signal.aborted)throw new Error("cancelled");const d=s instanceof Error?s.message:String(s);throw new Error(`Chrome couldn't start its built-in model (${d}). The first run downloads Gemini Nano and must be triggered by a click — press Connect again, and check chrome://on-device-internals if it keeps failing.`)}finally{this.connecting=null}return this.model=mt,mt}cancelConnect(){var n;(n=this.connecting)==null||n.abort()}dispose(){var n,t;(n=this.connecting)==null||n.abort(),this.connecting=null,(t=this.warm)==null||t.destroy(),this.warm=null,this.model=null}}const $i=[{id:"onnx-community/Florence-2-base-ft",label:"Florence-2 base",downloadLabel:"~0.4 GB"},{id:"onnx-community/Florence-2-large-ft",label:"Florence-2 large (higher quality)",downloadLabel:"~1.6 GB"}],Yt=$i.map(e=>({...e,label:`${e.label} (${e.downloadLabel})`})),Qt=Yt[0].id,Gi="<OCR>",ut="UNKNOWN (scripted brain — connect the in-browser model to read a photo)";function Vi(e,n){if(e)return typeof e=="function"?e(n):e[n]}class Yi{constructor(n){R(this,"kind","scripted-vision");R(this,"model",null);R(this,"read",async(n,t,r)=>{const o=typeof n=="string"?Vi(this.lookup,n)??ut:ut;return r==null||r(o),o});this.lookup=n}dispose(){}}function Qi(e){return new Yi(e)}class ht{constructor(){R(this,"kind","browser-vision");R(this,"model",null);R(this,"modelHandle",null);R(this,"processor",null);R(this,"loadImage",null);R(this,"generation",0);R(this,"read",async(n,t,r)=>{const o=this.modelHandle,s=this.processor,d=this.loadImage;if(!o||!s||!d||!this.model)throw new Error("BrowserVisionBrain.read called before connect()");const m=t&&t.startsWith("<")?t:Gi,c=await d(n),a=s.construct_prompts(m),p=await s(c,a),h=await o.generate({...p,max_new_tokens:512,num_beams:1,do_sample:!1}),u=s.batch_decode(h,{skip_special_tokens:!1})[0],b=s.post_process_generation(u,m,c.size),_=qi(b,m);return r==null||r(_),_})}async connect(n=Qt,t){var m,c;const r=await mn("the scripted-vision fallback");if(r)throw new Error(r);if(this.modelHandle&&this.model===n)return n;const o=++this.generation,s=a=>{o===this.generation&&(t==null||t({progress:(a.progress??0)/100,text:a.file?`${a.status??"loading"} ${a.file}`:a.status??""}))};this.teardown();let d;try{const{Florence2ForConditionalGeneration:a,AutoProcessor:p,load_image:h}=await ue(async()=>{const{Florence2ForConditionalGeneration:_,AutoProcessor:N,load_image:v}=await import("./transformers.web-G7o3DWFp.js");return{Florence2ForConditionalGeneration:_,AutoProcessor:N,load_image:v}},[]),u=await a.from_pretrained(n,{dtype:"fp32",device:"webgpu",progress_callback:s}),b=await p.from_pretrained(n);d={model:u,processor:b,loadImage:h}}catch(a){if(o!==this.generation)throw new Error("cancelled");const p=a instanceof Error?a.message:String(a);throw new Error(`Couldn't load ${n} in the browser (${p}). Try the smaller Florence-2 base model, check your connection, or use the scripted-vision fallback.`)}if(o!==this.generation)throw Promise.resolve((c=(m=d.model).dispose)==null?void 0:c.call(m)).catch(()=>{}),new Error("cancelled");return this.modelHandle=d.model,this.processor=d.processor,this.loadImage=d.loadImage,this.model=n,n}teardown(){var t;const n=this.modelHandle;this.modelHandle=null,this.processor=null,this.loadImage=null,this.model=null,Promise.resolve((t=n==null?void 0:n.dispose)==null?void 0:t.call(n)).catch(()=>{})}cancelConnect(){this.generation++}dispose(){this.generation++,this.teardown()}}function qi(e,n){const t=e[n];if(typeof t=="string")return t.trim();if(t&&typeof t=="object"){const r=t.labels;return Array.isArray(r)?r.join(" ").trim():JSON.stringify(t)}return""}function Ji(){const[e,n]=g.useState("scripted"),[t,r]=g.useState("idle"),[o,s]=g.useState(null),[d,m]=g.useState(null),[c,a]=g.useState(null),[p,h]=g.useState(null),[u,b]=g.useState(null),[_,N]=g.useState(null),[v,f]=g.useState(null),[M,x]=g.useState(Ut),[V,H]=g.useState(Gt()?Rn:""),[Y,he]=g.useState(""),[Pe,ge]=g.useState([]),[Ee,K]=g.useState("idle"),[be,se]=g.useState(null),[S,I]=g.useState(""),[k,L]=g.useState(null),$=g.useRef(null),[ye,ze]=g.useState("scripted-vision"),[fn,ve]=g.useState("idle"),[Qe,oe]=g.useState(null),[Ce,nn]=g.useState(Qt),[_n,Me]=g.useState(null),[Be,Ae]=g.useState(null),[wn,yn]=g.useState(null),[qe,X]=g.useState(null),U=g.useRef(null),Je=g.useRef(!1),Ue=g.useRef(0),ke=g.useCallback(j=>async(...Q)=>{try{return await j.chat(...Q)}catch(C){const W=C instanceof Error?C.message:String(C);throw j instanceof sn&&pn(W)&&(L(null),m(null),r("error"),s(W)),C}},[]),Le=g.useCallback(j=>async(...Q)=>{try{return await j.read(...Q)}catch(C){const W=C instanceof Error?C.message:String(C);throw pn(W)&&(X(null),Me(null),ve("error"),oe(W)),C}},[]);g.useEffect(()=>{mn().then(j=>{b(j),h(j===null)}),Vt().then(f),mn("the scripted-vision fallback").then(j=>{yn(j),Je.current||(Je.current=!0,ze(j===null?"browser-vision":"scripted-vision"))})},[]),g.useEffect(()=>{let j=!1;return N(null),zi(M).then(Q=>{j||N(Q)}),()=>{j=!0}},[M]),g.useEffect(()=>()=>{var j;return(j=$.current)==null?void 0:j.dispose()},[]),g.useEffect(()=>()=>{var j;return(j=U.current)==null?void 0:j.dispose()},[]);const He=g.useCallback(j=>{n(j),r("idle"),s(null),m(null),a(null),L(null)},[]),O=g.useCallback(j=>{var Q,C;Je.current=!0,(Q=U.current)==null||Q.cancelConnect(),(C=U.current)==null||C.dispose(),U.current=null,ze(j),ve("idle"),oe(null),Me(null),Ae(null),X(null)},[]),me=g.useCallback(()=>{var j;(j=$.current)==null||j.dispose(),$.current=null,L(null),m(null)},[]),De=g.useCallback(()=>{const j=$.current;(j instanceof sn||j instanceof pt)&&j.cancelConnect(),me(),r("idle"),a(null),s(null)},[me]),Ie=g.useCallback(async()=>{const j=++Ue.current,Q=()=>j!==Ue.current;if(!V.trim()){ge([]),he(""),K("idle"),se(null);return}const C=hn(V);if(C){ge([]),he(""),K("error"),se(C);return}K("loading"),se(null);const W=new ct(V,S);try{const xe=await W.listModels();if(Q())return;ge(xe),K("ready"),he(Re=>Re&&xe.includes(Re)?Re:xe[0]??"")}catch(xe){if(Q())return;ge([]),he(""),K("error"),se(xe instanceof Error?xe.message:String(xe))}finally{W.dispose()}},[V,S]),tn=g.useCallback(async()=>{var j,Q;if(e==="scripted"){L(null),r("ready");return}if(e==="endpoint"){const C=hn(V);if(C){me(),s(C),r("error");return}}r("connecting"),s(null),a(null);try{if(e==="browser"){const C=$.current instanceof sn?$.current:new sn;$.current&&$.current!==C&&$.current.dispose(),$.current=C;const W=await C.connect(M,a);m(W),L(()=>ke(C)),N(!0)}else if(e==="chrome"){(j=$.current)==null||j.dispose();const C=new pt;$.current=C;const W=await C.connect(a);f(null),m(W),L(()=>ke(C))}else{(Q=$.current)==null||Q.dispose();const C=new ct(V,S,Y);$.current=C;const W=await C.connect();m(W),L(()=>ke(C))}r("ready")}catch(C){const W=C instanceof Error?C.message:String(C);if(W==="cancelled")return;s(W),r("error"),L(null)}finally{a(null)}},[e,M,V,Y,S,me,ke]),ae=g.useCallback(()=>{var j;(j=U.current)==null||j.dispose(),U.current=null,X(null),Me(null)},[]),$e=g.useCallback(()=>{var j;(j=U.current)==null||j.cancelConnect(),ae(),ve("idle"),Ae(null),oe(null)},[ae]),Ge=g.useCallback(async()=>{if(ye==="scripted-vision"){ae(),ve("ready"),oe(null);return}ve("connecting"),oe(null),Ae(null);try{const j=U.current instanceof ht?U.current:new ht;U.current&&U.current!==j&&U.current.dispose(),U.current=j;const Q=await j.connect(Ce,Ae);Me(Q),X(()=>Le(j)),ve("ready")}catch(j){const Q=j instanceof Error?j.message:String(j);if(Q==="cancelled")return;oe(Q),ve("error"),X(null),Me(null)}finally{Ae(null)}},[ye,Ce,ae,Le]);return{kind:e,setKind:He,status:t,error:o,modelInUse:d,progress:c,webgpu:p,webgpuReason:u,browserModelCached:_,chromeAiReason:v,cancelConnect:De,browserModel:M,setBrowserModel:x,endpointUrl:V,setEndpointUrl:H,endpointModel:Y,setEndpointModel:he,endpointModels:Pe,endpointModelsStatus:Ee,endpointModelsError:be,listEndpointModels:Ie,apiKey:S,setApiKey:I,connect:tn,chat:k,visionKind:ye,setVisionKind:O,visionStatus:fn,visionError:Qe,visionModel:Ce,setVisionModel:nn,visionModelInUse:_n,visionProgress:Be,visionWebgpuReason:wn,connectVision:Ge,cancelVisionConnect:$e,vision:qe}}const Bn="#s=",Hi=["scripted","browser","chrome","endpoint"];function Wi(e){return typeof e=="string"&&Hi.includes(e)}function Zi(e){try{const n=JSON.parse(e);if(n&&typeof n=="object"){const t=n,r={};return Wi(t.brain)&&(r.brain=t.brain),r}}catch{}return{}}function qt(e=location.hash){if(!e.startsWith(Bn))return{};let n;try{n=decodeURIComponent(e.slice(Bn.length))}catch{return{}}return Zi(n)}function Ki(e){const n=Object.entries(e).filter(([,t])=>t!==void 0);return n.length===0?"":Bn+encodeURIComponent(JSON.stringify(Object.fromEntries(n)))}function Xi(e){const n={...qt(),...e},t=Ki(n),r=new URL(location.href);r.hash=t,history.replaceState(history.state,"",r)}const gt=[{kind:"scripted",label:"Scripted",hint:"No model. The example's stand-in decides — deterministic and offline."},{kind:"browser",label:"In-browser (WebGPU)",hint:"A small quantised model on your GPU. First run downloads weights."},{kind:"chrome",label:"Chrome built-in",hint:"Gemini Nano, built into Chrome. Chrome owns the weights — no download from this page, no API key."},{kind:"endpoint",label:"API endpoint",hint:"Any OpenAI-compatible server: a local Ollama, or a remote provider with an API key."}],eo=[{mode:"ollama",label:"Ollama (local)"},{mode:"remote",label:"Provider URL + key"}],bt=[{kind:"scripted-vision",label:"Scripted",hint:"No model. The example's known plate is returned — deterministic and offline."},{kind:"browser-vision",label:"In-browser (WebGPU)",hint:"Reads the photo with a vision model on your GPU. First run downloads weights."}];function no({brain:e,showText:n=!0,showVision:t=!1}){return i.jsxs("div",{className:"brain",children:[n&&i.jsx(to,{brain:e}),n&&t&&i.jsx("hr",{className:"brain-divider"}),t&&i.jsx(ro,{brain:e})]})}function to({brain:e}){const n=gt.find(v=>v.kind===e.kind),t=gt.filter(v=>v.kind!=="chrome"||Ui()),r=hn(e.endpointUrl),o=Gt(),s=o&&Mn(e.endpointUrl)?"ollama":"remote",d=v=>{Mn(v)!==Mn(e.endpointUrl)&&e.setApiKey(""),e.setEndpointUrl(v)},m=v=>{v!==s&&d(v==="ollama"?Rn:"")},[c,a]=g.useState(bn);g.useEffect(()=>{Fi().then(a)},[]);const{kind:p,endpointUrl:h,apiKey:u,listEndpointModels:b}=e;g.useEffect(()=>{if(p!=="endpoint"||r)return;const v=setTimeout(()=>void b(),400);return()=>clearTimeout(v)},[p,h,u,r,b]);const _=c.find(v=>v.id===e.browserModel),N=_?Oi(_,$t()):null;return i.jsxs("div",{className:"brain-section",children:[i.jsxs("div",{className:"brain-modes",children:[i.jsx("div",{className:"brain-kinds",role:"group","aria-label":"Agent brain",children:t.map(v=>i.jsx(Z,{size:"sm",variant:e.kind===v.kind?"default":"secondary","aria-pressed":e.kind===v.kind,onClick:()=>e.setKind(v.kind),children:v.label},v.kind))}),i.jsxs("div",{className:"brain-status",children:[e.status==="ready"&&e.kind!=="scripted"&&i.jsx(ie,{variant:"success",className:"brain-status-badge",children:e.modelInUse??"connected"}),e.status==="connecting"&&i.jsx(ie,{variant:"info",className:"brain-status-badge",children:"connecting…"}),e.status==="error"&&i.jsx(ie,{variant:"danger",className:"brain-status-badge",children:"not connected"})]})]}),i.jsx("p",{className:"field-hint",children:n.hint}),e.kind==="browser"&&i.jsxs("div",{className:"brain-config",children:[i.jsxs("div",{className:"field",children:[i.jsx(Ye,{htmlFor:"browser-model",children:"Model"}),i.jsxs(kn,{value:e.browserModel,onValueChange:e.setBrowserModel,disabled:e.status==="connecting",children:[i.jsx(In,{id:"browser-model",children:i.jsx(Tn,{})}),i.jsx(jn,{children:c.map(v=>i.jsx(Sn,{value:v.id,children:v.label},v.id))})]}),e.browserModelCached===!0&&i.jsx("p",{className:"field-hint",children:"Already downloaded in this browser — connecting will be fast."}),e.browserModelCached===!1&&i.jsx("p",{className:"field-hint",children:"Not downloaded yet — connecting fetches the weights once, then caches them for next time."})]}),e.webgpu===!1&&e.webgpuReason&&i.jsxs(de,{variant:"destructive",children:[i.jsx(le,{children:"No WebGPU in this browser"}),i.jsx(ce,{children:e.webgpuReason})]}),e.webgpu!==!1&&N&&i.jsxs(de,{variant:"destructive",children:[i.jsx(le,{children:"This model may not fit in GPU memory"}),i.jsx(ce,{children:N})]})]}),e.kind==="chrome"&&i.jsxs("div",{className:"brain-config",children:[i.jsx("p",{className:"field-hint",children:"Nothing to configure: Chrome downloads and manages Gemini Nano itself, so the first Connect may fetch it once and later visits reuse it. Prompts never leave your machine. It's a very small model — expect it to follow the tool-calling format less reliably than an endpoint model."}),e.chromeAiReason&&i.jsxs(de,{variant:"destructive",children:[i.jsx(le,{children:"Chrome's built-in model isn't available here"}),i.jsx(ce,{children:e.chromeAiReason})]})]}),e.kind==="endpoint"&&i.jsxs("div",{className:"brain-config",children:[o?i.jsx("div",{className:"brain-kinds",role:"group","aria-label":"Endpoint provider",children:eo.map(v=>i.jsx(Z,{size:"sm",variant:s===v.mode?"default":"secondary","aria-pressed":s===v.mode,disabled:e.status==="connecting",onClick:()=>m(v.mode),children:v.label},v.mode))}):i.jsxs("p",{className:"field-hint",children:["This page isn't served from ",i.jsx("code",{children:"localhost"}),", so a local Ollama isn't offered — it only accepts requests from a page on localhost. Point this at a remote OpenAI-compatible provider, or open this page at ",i.jsx("code",{children:"http://localhost"})," to use Ollama."]}),i.jsxs("div",{className:"field",children:[i.jsx(Ye,{htmlFor:"endpoint-url",children:"Endpoint"}),i.jsx(Kn,{id:"endpoint-url",value:e.endpointUrl,placeholder:"https://api.openai.com/v1",onChange:v=>d(v.target.value),disabled:e.status==="connecting"}),s==="ollama"?i.jsxs("p",{className:"field-hint",children:["Ollama allows ",i.jsx("code",{children:"localhost"})," origins out of the box; set"," ",i.jsx("code",{children:"OLLAMA_ORIGINS"})," only when serving this page from another host. Best for local development — a hosted copy of this page can't reach a server on your machine at all."]}):i.jsxs("p",{className:"field-hint",children:["The base URL of any OpenAI-compatible provider — it must serve"," ",i.jsx("code",{children:"/models"})," and ",i.jsx("code",{children:"/chat/completions"}),". Calls go straight from this browser to that host."]}),r&&i.jsxs(de,{variant:"destructive",children:[i.jsx(le,{children:"A local server won't work from this URL"}),i.jsx(ce,{children:r})]})]}),i.jsxs("div",{className:"field",children:[i.jsx(Ye,{htmlFor:"endpoint-model",children:"Model"}),i.jsxs("div",{className:"endpoint-model-row",children:[i.jsxs(kn,{value:e.endpointModel,onValueChange:e.setEndpointModel,disabled:e.status==="connecting"||e.endpointModelsStatus==="loading"||e.endpointModels.length===0,children:[i.jsx(In,{id:"endpoint-model",className:"endpoint-model-select",children:i.jsx(Tn,{placeholder:e.endpointModelsStatus==="loading"?"Loading models…":e.endpointModelsStatus==="idle"?"Enter an endpoint above":e.endpointModelsStatus==="error"?"No models — check the endpoint":e.endpointModels.length===0?"No models served":"Select a model"})}),i.jsx(jn,{children:e.endpointModels.map(v=>i.jsx(Sn,{value:v,children:v},v))})]}),i.jsx(Z,{size:"sm",variant:"secondary",onClick:()=>void e.listEndpointModels(),disabled:e.status==="connecting"||e.endpointModelsStatus==="loading"||e.endpointUrl.trim()===""||r!==null,children:e.endpointModelsStatus==="loading"?"Refreshing…":"Refresh"})]}),i.jsxs("p",{className:"field-hint",children:["Fetched from the endpoint's ",i.jsx("code",{children:"/models"}),". Tiny models (e.g. SmolLM2) usually can't follow the tool-calling format — prefer ",i.jsx("code",{children:"llama3.2:3b"}),", ",i.jsx("code",{children:"qwen2.5"})," or larger."]}),e.endpointModelsStatus==="error"&&!r&&i.jsxs(de,{variant:"destructive",children:[i.jsx(le,{children:"Couldn't list models"}),i.jsx(ce,{children:e.endpointModelsError})]})]}),i.jsxs("div",{className:"field",children:[i.jsx(Ye,{htmlFor:"endpoint-key",children:s==="ollama"?"API key (optional)":"API key"}),i.jsx(Kn,{id:"endpoint-key",type:"password",value:e.apiKey,onChange:v=>e.setApiKey(v.target.value),disabled:e.status==="connecting"}),i.jsx("p",{className:"field-hint",children:s==="ollama"?"A local Ollama ignores this — leave it blank.":"Sent as a bearer token to the endpoint above, from this browser only. It's held in memory for this tab, never stored or logged, and cleared if the endpoint moves between a local and a remote host."})]})]}),e.kind!=="scripted"&&i.jsxs("div",{className:"brain-actions",children:[i.jsx(Z,{size:"sm",onClick:()=>void e.connect(),disabled:e.status==="connecting"||e.kind==="chrome"&&e.chromeAiReason!==null||e.kind==="endpoint"&&(e.endpointUrl.trim()===""||e.endpointModel===""||e.endpointModelsStatus==="loading"||r!==null),children:e.status==="ready"?"Reconnect":"Connect"}),e.status==="connecting"&&(e.kind==="browser"||e.kind==="chrome")&&i.jsx(Z,{size:"sm",variant:"secondary",onClick:e.cancelConnect,children:"Cancel"}),e.progress&&i.jsxs("span",{className:"field-hint",children:[Math.round(e.progress.progress*100),"% —"," ",e.progress.text]})]}),e.progress&&i.jsx("div",{className:"brain-progress",role:"progressbar","aria-valuenow":Math.round(e.progress.progress*100),"aria-valuemin":0,"aria-valuemax":100,children:i.jsx("div",{className:"brain-progress-bar",style:{width:`${Math.round(e.progress.progress*100)}%`}})}),e.error&&i.jsxs(de,{variant:"destructive",children:[i.jsx(le,{children:"Couldn't connect"}),i.jsx(ce,{children:e.error})]})]})}function ro({brain:e}){const n=bt.find(t=>t.kind===e.visionKind);return i.jsxs("div",{className:"brain-section brain-vision",children:[i.jsx(Ye,{children:"Vision (reads the image)"}),i.jsxs("div",{className:"brain-modes",children:[i.jsx("div",{className:"brain-kinds",role:"group","aria-label":"Vision brain",children:bt.map(t=>i.jsx(Z,{size:"sm",variant:e.visionKind===t.kind?"default":"secondary","aria-pressed":e.visionKind===t.kind,onClick:()=>e.setVisionKind(t.kind),children:t.label},t.kind))}),i.jsxs("div",{className:"brain-status",children:[e.visionStatus==="ready"&&e.visionKind==="browser-vision"&&i.jsx(ie,{variant:"success",className:"brain-status-badge",children:e.visionModelInUse??"connected"}),e.visionStatus==="connecting"&&i.jsx(ie,{variant:"info",className:"brain-status-badge",children:"connecting…"}),e.visionStatus==="error"&&i.jsx(ie,{variant:"danger",className:"brain-status-badge",children:"not connected"})]})]}),i.jsx("p",{className:"field-hint",children:n.hint}),e.visionKind==="scripted-vision"&&e.webgpu===!1&&e.visionWebgpuReason&&i.jsxs(de,{variant:"destructive",children:[i.jsx(le,{children:"No WebGPU in this browser"}),i.jsx(ce,{children:e.visionWebgpuReason})]}),e.visionKind==="browser-vision"&&i.jsxs("div",{className:"brain-config",children:[i.jsxs("div",{className:"field",children:[i.jsx(Ye,{htmlFor:"vision-model",children:"Model"}),i.jsxs(kn,{value:e.visionModel,onValueChange:e.setVisionModel,disabled:e.visionStatus==="connecting",children:[i.jsx(In,{id:"vision-model",children:i.jsx(Tn,{})}),i.jsx(jn,{children:Yt.map(t=>i.jsx(Sn,{value:t.id,children:t.label},t.id))})]}),i.jsx("p",{className:"field-hint",children:"Connecting downloads the weights once (size shown above), then caches them — every token is read on your GPU, no server."})]}),e.webgpu===!1&&e.visionWebgpuReason&&i.jsxs(de,{variant:"destructive",children:[i.jsx(le,{children:"No WebGPU in this browser"}),i.jsx(ce,{children:e.visionWebgpuReason})]})]}),e.visionKind==="browser-vision"&&i.jsxs("div",{className:"brain-actions",children:[i.jsx(Z,{size:"sm",onClick:()=>void e.connectVision(),disabled:e.visionStatus==="connecting",children:e.visionStatus==="ready"?"Reconnect":"Connect"}),e.visionStatus==="connecting"&&i.jsx(Z,{size:"sm",variant:"secondary",onClick:e.cancelVisionConnect,children:"Cancel"}),e.visionProgress&&i.jsxs("span",{className:"field-hint",children:[Math.round(e.visionProgress.progress*100),"% —"," ",e.visionProgress.text]})]}),e.visionError&&i.jsxs(de,{variant:"destructive",children:[i.jsx(le,{children:"Couldn't connect the vision brain"}),i.jsx(ce,{children:e.visionError})]})]})}function io({imageInput:e,value:n,onSelect:t,disabled:r=!1}){const[o,s]=g.useState(null),[d,m]=g.useState(!1),c=g.useRef(null),a=g.useId(),p=g.useId(),h=g.useCallback(_=>{s(URL.createObjectURL(_)),t({imageName:_.name,pixels:_})},[t]);g.useEffect(()=>{if(o)return()=>URL.revokeObjectURL(o)},[o]);const u=g.useCallback(_=>{const N=_==null?void 0:_[0];N&&N.type.startsWith("image/")&&h(N)},[h]),b=(n==null?void 0:n.imageId)!=null?e.seedImages.find(_=>_.id===n.imageId):void 0;return i.jsxs("div",{className:"image-input",children:[e.label&&i.jsx("p",{className:"field-hint",children:e.label}),i.jsx("p",{className:"image-input-label",id:a,children:"Seed photos"}),i.jsx("div",{className:"image-gallery",role:"group","aria-labelledby":a,children:e.seedImages.map(_=>{const N=(n==null?void 0:n.imageId)===_.id;return i.jsxs("button",{type:"button","aria-pressed":N,className:`image-thumb${N?" image-thumb--selected":""}`,disabled:r,title:_.label??_.id,onClick:()=>{s(null),c.current&&(c.current.value=""),t({imageId:_.id,pixels:_.file})},children:[i.jsx("img",{src:_.thumb??_.file,alt:_.label??_.id}),_.label&&i.jsx("span",{children:_.label})]},_.id)})}),i.jsx("label",{className:"image-input-label",htmlFor:p,children:"Or upload your own photo"}),i.jsxs("div",{className:`image-drop${d?" image-drop--over":""}`,onDragOver:_=>{_.preventDefault(),r||m(!0)},onDragLeave:()=>m(!1),onDrop:_=>{_.preventDefault(),m(!1),r||u(_.dataTransfer.files)},children:[i.jsx("input",{ref:c,id:p,type:"file",accept:"image/*",disabled:r,onChange:_=>u(_.target.files)}),i.jsx("p",{className:"field-hint",children:"Drag a photo here, or pick one. Uploading a photo the model has never seen is the proof this runs for real — nothing leaves your browser."})]}),(o||b)&&i.jsxs("div",{className:"image-preview",children:[i.jsx("img",{src:o??(b==null?void 0:b.file),alt:o?(n==null?void 0:n.imageName)??"uploaded photo":(b==null?void 0:b.label)??(b==null?void 0:b.id)??"selected photo"}),i.jsx("span",{className:"field-hint",children:o?`Uploaded: ${(n==null?void 0:n.imageName)??"your photo"}`:`Selected: ${(b==null?void 0:b.label)??(b==null?void 0:b.id)}`}),i.jsx("button",{type:"button",className:"image-clear-btn",disabled:r,onClick:()=>{s(null),c.current&&(c.current.value=""),t(null)},children:"Clear"})]})]})}function Jt(e){return typeof e=="object"&&e!==null}function Ud(e){const n=new Set,t=r=>{Jt(r)&&(typeof r.key=="string"&&n.add(r.key),Array.isArray(r.components)&&r.components.forEach(t))};return t(e),n}function oo(e){const n={},t=r=>{Jt(r)&&(typeof r.key=="string"&&"defaultValue"in r&&(n[r.key]=r.defaultValue??""),Array.isArray(r.components)&&r.components.forEach(t))};return t(e),n}const ao="wdf:section:v2:";function Ht(e){return ao+e}function ft(e){try{const n=window.localStorage.getItem(Ht(e));return n==="1"?!0:n==="0"?!1:void 0}catch{return}}function so(e,n){try{window.localStorage.setItem(Ht(e),n?"1":"0")}catch{}}function On(e,n=!0){const[t,r]=g.useState(()=>ft(e)??n);g.useEffect(()=>{r(ft(e)??n)},[e,n]);const o=g.useCallback(s=>{r(s),so(e,s)},[e]);return[t,o]}function Oe({sectionId:e,title:n,description:t,defaultOpen:r=!0,className:o,children:s,...d}){const[m,c]=On(e,r);return i.jsx(ar,{className:["panel",o].filter(Boolean).join(" "),"data-tour":d["data-tour"],children:i.jsxs(sr,{open:m,onOpenChange:c,children:[i.jsxs(dr,{className:"panel-trigger",children:[i.jsxs("span",{className:"panel-trigger-text",children:[i.jsx("span",{className:"panel-title",children:n}),t!=null&&i.jsx("span",{className:"panel-desc",children:t})]}),i.jsx(lr,{className:"panel-chevron","aria-hidden":!0})]}),i.jsx(cr,{children:i.jsx(mr,{children:s})})]})})}function lo(e){return e.entries!==void 0}function co(e){const n=[];let t=null;for(const r of e)r.turn!==void 0?t&&t.turn===r.turn?t.entries.push(r):(t={turn:r.turn,entries:[r]},n.push(t)):(t=null,n.push(r));return n}function _t(e){if(e===void 0)return"undefined";try{return JSON.stringify(e)}catch{return"[unserializable value]"}}function mo({activation:e,result:n,labelFor:t}){const r=e.elementId??"";return i.jsxs("div",{className:"timeline-tool",children:[i.jsxs("div",{className:"timeline-tool-head",children:[i.jsx(ie,{variant:"info",children:"tool"}),i.jsx("strong",{children:t(r)||r}),i.jsx("code",{children:r})]}),e.args!==void 0&&Object.keys(e.args).length>0&&i.jsxs("div",{className:"timeline-kv",children:[i.jsx("span",{className:"timeline-kv-label",children:"arguments"}),i.jsx("code",{children:_t(e.args)})]}),i.jsxs("div",{className:"timeline-kv",children:[i.jsx("span",{className:"timeline-kv-label",children:"returned"}),i.jsx("code",{children:n?_t(n.result):"— waiting for the job to complete —"})]})]})}function po({group:e,labelFor:n}){const t=e.entries.find(a=>a.kind==="llm"),r=e.entries.filter(a=>a.kind==="agent"&&a.elementId),o=e.entries.filter(a=>a.kind==="vars"&&a.elementId),s=e.entries.filter(a=>a.kind==="agent"&&!a.elementId),d=e.entries.filter(a=>a.kind==="error"),m=new Set(r.map(a=>a.elementId)),c=e.entries.filter(a=>a.kind==="tool"||a.kind==="vars"&&a.elementId&&!m.has(a.elementId)).sort((a,p)=>a.id-p.id);return i.jsxs("div",{className:"timeline-turn",children:[i.jsxs("div",{className:"timeline-turn-head",children:[i.jsxs(ie,{variant:t!=null&&t.pending?"warning":"neutral",children:["Turn ",e.turn]}),(t==null?void 0:t.pending)&&i.jsx("span",{className:"timeline-pending",children:"thinking…"})]}),t&&i.jsx("blockquote",{className:"timeline-reply",children:t.text}),s.map(a=>i.jsx("div",{className:"timeline-note",children:a.text},a.id)),r.map(a=>i.jsx(mo,{activation:a,result:o.find(p=>p.elementId===a.elementId),labelFor:n},a.id)),c.map(a=>i.jsxs("div",{className:`log-line log-${a.kind}`,children:[a.pending?"⏳ ":"",a.text]},a.id)),d.map(a=>i.jsxs("div",{className:"timeline-error",children:["⚠ ",a.text]},a.id))]})}function uo({log:e,elementStats:n=[],incidents:t=[],labelFor:r=d=>d,variables:o,hasAgent:s=!1}){const d=g.useMemo(()=>co(e),[e]),[m,c]=g.useState(!1),[a,p]=On("engine-view",!1),h=g.useRef(null);g.useEffect(()=>{const b=h.current;b&&(b.scrollTop=b.scrollHeight)},[d]);const u=()=>{var N;const b={log:e.map(({id:v,...f})=>f),elementStats:n,incidents:t},_=JSON.stringify(b,null,2);(N=navigator.clipboard)!=null&&N.writeText&&navigator.clipboard.writeText(_).then(()=>{c(!0),setTimeout(()=>c(!1),1500)}).catch(()=>{})};return i.jsxs(Oe,{sectionId:"activity",className:"grow activity-card",title:s?"Agent activity":"Activity",description:s?"Agent turns, model replies, and tool calls — read top to bottom as a story.":"Every step the engine took — read top to bottom as a story.",children:[i.jsx("div",{className:"timeline-toolbar",children:i.jsx(Z,{variant:"secondary",size:"sm",onClick:u,children:m?"Copied!":"Copy run as JSON"})}),i.jsx("div",{className:"timeline",ref:h,children:d.length===0?i.jsx("div",{className:"log-empty",children:"Press Run or Step to start."}):d.map(b=>lo(b)?i.jsx(po,{group:b,labelFor:r},`turn-${b.turn}-${b.entries[0].id}`):i.jsxs("div",{className:`log-line log-${b.kind}`,children:[b.pending?"⏳ ":"",b.text]},b.id))}),o,(n.length>0||t.length>0)&&i.jsxs("details",{className:"engine-view",open:a,onToggle:b=>p(b.currentTarget.open),children:[i.jsxs("summary",{children:["Element completion",t.length>0&&` · ${t.length} incident${t.length===1?"":"s"}`]}),i.jsxs("div",{className:"timeline-engine-view",children:[n.length>0&&i.jsxs("div",{className:"timeline-stats",children:[i.jsx("span",{className:"timeline-kv-label",children:"Element completion"}),i.jsx("ul",{children:n.filter(b=>b.completed>0||(b.active??0)>0).map(b=>i.jsxs("li",{children:[i.jsx("code",{children:r(b.elementId)||b.elementId})," ","completed ",b.completed,b.active?`, ${b.active} active`:""]},b.elementId))})]}),t.length>0&&i.jsxs("div",{className:"timeline-incidents",children:[i.jsx("span",{className:"timeline-kv-label",children:"Incidents"}),i.jsx("ul",{children:t.map((b,_)=>i.jsxs("li",{children:[i.jsx("code",{children:r(b.elementId)||b.elementId})," —"," ",b.reason]},`${b.elementId}-${_}`))})]})]})]})]})}const Ne={diagram:"diagram",runButton:"run-button",variablesPanel:"variables-panel",codePanel:"code-panel",brainPanel:"brain-panel"};function wt(e){return`[data-tour="${e}"]`}function ho(e=location.search){return new URLSearchParams(e).get("tour")}function go(e){return"anchor"in e?wt(e.anchor):`${wt(Ne.diagram)} [data-element-id="${bo(e.elementId)}"]`}function bo(e){return typeof CSS<"u"&&typeof CSS.escape=="function"?CSS.escape(e):e.replace(/[^a-zA-Z0-9_-]/g,n=>`\\${n}`)}function fo(e){return e.map(n=>({element:go(n.target),popover:{title:n.title,description:n.description,showButtons:["next","previous","close"]},disableActiveInteraction:!1,skipMissingElement:n.skipMissingElement??!0}))}async function _o(e){const[{driver:n}]=await Promise.all([ue(()=>import("./driver.js-bj_ppY-Q.js"),[]),ue(()=>Promise.resolve({}),__vite__mapDeps([0]))]),t=n({steps:fo(e),showProgress:!0,allowClose:!0,skipMissingElement:!0});return t.drive(),{isActive:()=>t.isActive(),destroy:()=>t.destroy()}}const wo=300;function yo(e){const[n,t]=g.useState(!1),r=g.useRef(null),o=g.useRef(null),s=g.useRef(0),d=g.useCallback(()=>{o.current!==null&&(clearInterval(o.current),o.current=null)},[]),m=g.useCallback(()=>{var a;s.current+=1,d(),(a=r.current)==null||a.destroy(),r.current=null,t(!1)},[d]),c=g.useCallback(()=>{if(!e||e.steps.length===0||r.current)return;const a=s.current+=1;_o(e.steps).then(p=>{if(a!==s.current||!p.isActive()){p.destroy();return}r.current=p,t(!0);const h=setInterval(()=>{if(r.current!==p){clearInterval(h);return}p.isActive()||(clearInterval(h),o.current===h&&(o.current=null),r.current=null,t(!1))},wo);o.current=h})},[e,d]);return g.useEffect(()=>m,[m]),{active:n,start:c,stop:m}}function vo(){return typeof window>"u"||!window.matchMedia?!1:window.matchMedia("(prefers-reduced-motion: reduce)").matches}function Mo({enabled:e,ready:n,targetRef:t,start:r}){const o=g.useRef(!1),[s,d]=g.useState(!1),m=g.useRef(r);g.useEffect(()=>{m.current=r},[r]),g.useEffect(()=>{if(!e||o.current)return;const c=t.current;if(!c||typeof IntersectionObserver>"u"){d(!0);return}const a=new IntersectionObserver(p=>{p.some(h=>h.isIntersecting)&&(d(!0),a.disconnect())},{threshold:.01});return a.observe(c),()=>a.disconnect()},[e,t]),g.useEffect(()=>{!e||o.current||!n||!s||vo()||(o.current=!0,m.current())},[e,n,s])}const Te=650,xn="__agent__",yt="__model__",vt="__template__:",xo=g.lazy(async()=>{await Promise.all([ue(()=>Promise.resolve({}),__vite__mapDeps([1])),ue(()=>Promise.resolve({}),__vite__mapDeps([2])),ue(()=>Promise.resolve({}),__vite__mapDeps([3]))]);const{RuntimeDiagram:e}=await ue(async()=>{const{RuntimeDiagram:n}=await import("./RuntimeDiagram-DTnJz5cT.js");return{RuntimeDiagram:n}},__vite__mapDeps([4,5,6]));return{default:e}}),Nn=g.lazy(()=>ue(()=>import("./MonacoEditor-BxyGwDvD.js").then(e=>e.M),__vite__mapDeps([7,5,8]))),No=g.lazy(()=>ue(()=>import("./vendor-modeler-HLLXEONQ.js"),__vite__mapDeps([9,5,6,10,11,12,13,1,2,3]))),Mt=g.lazy(async()=>{const{FormRenderer:e}=await ue(async()=>{const{FormRenderer:n}=await import("./FormRenderer-Dy_itFDZ.js");return{FormRenderer:n}},__vite__mapDeps([14,5,12,10,11,15]));return{default:e}});function cn(e,n){try{return JSON.stringify(e??{},null,n)}catch{return"[unserializable value]"}}function Eo(e){const n=cn(e).replace(/\s+/g," ");return n.length>78?`${n.slice(0,78)}…`:n}function ko({example:e,compact:n=!1,autostart:t=!1,initialBrainKind:r,initialTourId:o}){var Vn,Yn,Qn,qn,Jn,Hn,Wn,Zn;const[s,d]=g.useState(e.bpmn),m=g.useRef(null),c=Ji(),[a,p]=g.useState(null);g.useEffect(()=>{r&&r!==c.kind&&c.setKind(r)},[]),g.useEffect(()=>{Xi({brain:c.kind})},[c.kind]);const[h,u]=g.useState(()=>Object.fromEntries(e.handlers.map(w=>[w.elementId,w.source]))),[b,_]=g.useState(e.scriptedAgent??""),[N,v]=g.useState(()=>en(e.templates)),f=g.useMemo(()=>Wr(e,h,s,N),[e,h,s,N]),M=f.model,x=Ni({bpmn:f.resolvedBpmn});Ai(x.phase==="ready");const V=yo(e.tour);g.useEffect(()=>{var w;o&&((w=e.tour)==null?void 0:w.id)===o&&V.start()},[]);const H=M.startFormId?((Vn=e.forms)==null?void 0:Vn[M.startFormId])??null:null,[Y,he]=g.useState(()=>({...e.seed,...H?oo(H):{}})),[Pe,ge]=g.useState(M.agent?xn:((Yn=e.handlers[0])==null?void 0:Yn.elementId)??""),Ee=g.useMemo(()=>{const w=(e.scenarios??[]).findIndex(E=>Object.entries(E.variables).every(([T,B])=>JSON.stringify(Y[T])===JSON.stringify(B)));return w===-1?null:w},[e.scenarios,Y]),[K,be]=On(n?"start-compact":"start",n?!1:!!H),[se,S]=g.useState(!1),[I,k]=g.useState(!1),[L,$]=g.useState(!1),[ye,ze]=g.useState(null),[fn,ve]=g.useState([]),[Qe,oe]=g.useState({}),Ce=g.useMemo(()=>({...e.seed,...Y,...Pr(e.imageInput?a:null)}),[e.seed,e.imageInput,Y,a]),[nn,_n]=g.useState(null),Me=g.useRef(null),[Be,Ae]=g.useState({}),[wn,yn]=g.useState(!1),qe=g.useRef(null),X=g.useRef(!1),U=g.useRef(0),Je=g.useRef(0),Ue=g.useRef({current:void 0}),ke=g.useRef({}),Le=g.useRef({}),He=g.useMemo(()=>{const w=new Map;for(const E of M.processes){for(const T of E.tasks)w.set(T.elementId,T.label);for(const T of E.agents){w.set(T.elementId,T.label);for(const B of T.tools)w.set(B.elementId,B.label)}for(const T of E.userTasks)w.set(T.elementId,T.label)}return E=>w.get(E)??E},[M]),O=g.useCallback(w=>{ve(E=>{if(w.key){const T=E.findIndex(B=>B.key===w.key);if(T>=0){const B=[...E];return B[T]={...B[T],...w},B}}return[...E,{...w,id:Je.current++}].slice(-80)})},[]),me=g.useMemo(()=>{var w;return((w=x.snapshot)==null?void 0:w.userTasks.find(E=>E.state==="Created"))??null},[x.snapshot]),De=g.useMemo(()=>{const w=M.processes.flatMap(T=>T.tasks),E=new Map;for(const T of e.handlers){if(!T.manualControl)continue;const B=w.find(A=>A.elementId===T.elementId);B&&E.set(B.jobType,{...T.manualControl,elementId:T.elementId})}return E},[e.handlers,M]),Ie=g.useMemo(()=>{if(!x.snapshot)return null;for(const w of x.snapshot.jobs){const E=De.get(w.jobType);if(E&&w.state==="Created")return{job:w,control:E}}return null},[x.snapshot,De]),tn=g.useMemo(()=>{if(!M.agent||!x.snapshot)return[];const w=new Map(x.snapshot.elementStats.map(E=>[E.elementId,E.completed]));return M.agent.tools.filter(E=>(w.get(E.elementId)??0)===0)},[M.agent,x.snapshot]),ae=me?M.userTasks.find(w=>w.elementId===me.elementId):void 0,$e=ae!=null&&ae.formId?((Qn=e.forms)==null?void 0:Qn[ae.formId])??null:null,Ge=g.useCallback(async(w,E,T,B)=>{var pe,te,_e;let A=T,fe=0;for(;U.current===B&&A&&A.completedInstances<1&&fe++<80;){const q=await x.stepWorkers(w,{agents:E});if(U.current!==B)return A;A=(q==null?void 0:q.snapshot)??A;const re=(pe=A.instances[0])==null?void 0:pe.variables;if(re&&oe({...re}),A.userTasks.some(J=>J.state==="Created")){O({kind:"human",text:"⏸ waiting for a human — complete the task below to continue"});break}if(!q){O({kind:"error",text:"▶ run stopped — no dispatch round was returned"});break}if(q.handled===0){const J=A.messageSubscriptions[0];if(q.reason==="messages"&&J){if(O({kind:"step",text:`⏳ parked on a message catch event — waiting for "${J.messageName}"`,elementId:J.elementId}),await new Promise(ee=>setTimeout(ee,Te)),U.current!==B)return A;O({kind:"vars",text:`📨 correlating message "${J.messageName}" (key: ${J.correlationKey})`,elementId:J.elementId});const G=x.correlateMessage(J.messageName,J.correlationKey,"{}");if(G){A=G;const ee=(te=A.instances[0])==null?void 0:te.variables;ee&&oe({...ee}),await new Promise(we=>setTimeout(we,Te));continue}O({kind:"error",text:`▶ run stopped — correlating "${J.messageName}" (key: ${J.correlationKey}) failed`,elementId:J.elementId})}if(q.reason==="signals"&&A.signalSubscriptions.length>0){const G=A.signalSubscriptions[0],ee=A.signalSubscriptions.length;if(O({kind:"step",text:`⏳ parked on ${ee} open signal subscription${ee===1?"":"s"} — waiting for "${G.signalName}"`,elementId:G.elementId}),await new Promise(Ve=>setTimeout(Ve,Te)),U.current!==B)return A;const we=x.broadcastSignal(G.signalName,"{}");if(we){A=we,O({kind:"vars",text:`📡 broadcasting signal "${G.signalName}" — every waiting subscription unblocks`,elementId:G.elementId});const Ve=(_e=A.instances[0])==null?void 0:_e.variables;Ve&&oe({...Ve}),await new Promise(tr=>setTimeout(tr,Te));continue}O({kind:"error",text:`▶ run stopped — broadcasting signal "${G.signalName}" failed`,elementId:G.elementId})}if(q.reason==="timers"){const G=A.timers.reduce((ee,we)=>Math.min(ee,we.dueInMs),1/0);if(Number.isFinite(G)){if(O({kind:"step",text:`⏳ parked on a timer — ${(Math.max(G,0)/1e3).toFixed(1)}s left on the clock`}),await new Promise(we=>setTimeout(we,Te)),U.current!==B)return A;const ee=x.advanceTime(Math.max(G,0)+1);if(ee){A=ee,O({kind:"step",text:"🕐 the clock advanced — timer fired"}),await new Promise(we=>setTimeout(we,Te));continue}}}break}await new Promise(J=>setTimeout(J,Te))}return U.current!==B||(A&&A.completedInstances>=1?O({kind:"done",text:"✅ process instance completed"}):A&&A.incidentElementIds.length>0&&O({kind:"error",text:"A job failed — incident on the diagram"})),A},[x,O]),j=g.useCallback(async w=>{var A,fe,pe;if(!Ie||X.current)return;const{job:E,control:T}=Ie,B=++U.current;X.current=!0,k(!0);try{let te,_e;if(w==="complete")te=x.completeJobManually(E.jobType,"{}"),_e="  ↳ completed normally";else if(T.action.kind==="timer"){const q=((fe=(A=x.snapshot)==null?void 0:A.timers[0])==null?void 0:fe.dueInMs)??0;te=x.advanceTime(Math.max(q,0)+1),_e="  ↳ advanced the clock — timer fired"}else{const{errorCode:q,message:re}=T.action;te=x.throwJobError(E.jobType,q,re),_e=`  ↳ threw BPMN error ${q}: ${re}`}if(te){O({kind:"vars",text:_e,elementId:E.elementId});const q=(pe=te.instances[0])==null?void 0:pe.variables;q&&oe({...q}),await new Promise(re=>setTimeout(re,Te)),await Ge(ke.current,Le.current,te,B)}else O({kind:"error",text:"  ↳ failed to resolve the manual job",elementId:E.elementId})}finally{U.current===B&&(X.current=!1,k(!1))}},[Ie,x,O,Ge]),Q=g.useCallback(async()=>{var q;let w=null;try{M.agent&&b.trim()&&(w=Or(b))}catch(re){return ze(re instanceof Error?re.message:String(re)),null}Ue.current={current:void 0};let E;if(e.imageInput){const re=c.vision;E={read:re??Qi(e.scriptedVision).read,live:!!re,resolve:G=>x.getRunImage(G)}}const T=$r(M,f.handlers,O,Ue.current,E);for(const re of De.keys())delete T[re];const B={};if(M.agents.length>0){if(c.kind!=="scripted"&&c.chat){const J=new Map;for(const G of M.agents)J.set(G.jobType,[...J.get(G.jobType)??[],G]);for(const[G,ee]of J)B[G]=oi(ee,c.chat,O,{turnRef:Ue.current,requiredTools:e.requiredTools})}else if(w&&M.agent){const J=M.agent.elementId;B[M.agent.jobType]=async G=>{if(G.elementId!==J)throw new Error(`No scripted agent handler for "${G.elementId}" — only "${J}" (the primary process's first agent host) is driven by the scripted brain. Use a live brain to exercise more than one host.`);const ee=await w(G),we=(ee.activateElements??[]).map(Ve=>Ve.elementId).join(", ");return O({kind:"agent",text:ee.completionConditionFulfilled?"🤖 scripted agent: done":`🤖 scripted agent: calling ${we||"(nothing)"}`}),ee}}}ve([]),Ae({});const A=Ce;oe(A),ke.current=T,Le.current=B;const fe=await x.redeploy(s),pe=(fe==null?void 0:fe[0])??M.processId;O({kind:"start",text:`Starting "${pe}" — ${M.agent?c.kind==="scripted"||!c.chat?"scripted brain":`live brain (${c.modelInUse??c.kind})`:"no agent in this model"}`});const te=x.createInstance(pe,JSON.stringify(A)),_e=(q=te==null?void 0:te.instances[0])==null?void 0:q.key;return e.imageInput&&a&&_e&&x.setRunImage(_e,a),{workers:T,agents:B,snap:te}},[x,e,f,s,b,Y,a,Ce,M,c,O,De]),C=!!x.snapshot&&x.snapshot.completedInstances<1,W=!C&&!!H&&nn!==!0,xe=!C&&!!H&&nn===!1,Re=K||se;g.useEffect(()=>{n&&xe&&S(!0)},[n,xe]);const Un=w=>{be(w),w||S(!1)},$n=g.useCallback(async()=>{if(x.phase!=="ready"||X.current||L||f.hasErrors)return;X.current=!0,k(!0);const w=++U.current;try{let E=ke.current,T=Le.current,B=x.snapshot;if(!C){if(Me.current&&!Me.current.validate())return;ze(null);const A=await Q();if(!A)return;E=A.workers,T=A.agents,B=A.snap,await new Promise(fe=>setTimeout(fe,Te))}await Ge(E,T,B,w)}finally{U.current===w&&(X.current=!1,k(!1))}},[x,L,f.hasErrors,C,Q,Ge]),Gn=x.phase==="ready"&&!I&&!L&&!f.hasErrors&&!W;Mo({enabled:t,ready:Gn,targetRef:m,start:()=>void $n()});const Zt=g.useCallback(async()=>{var E;if(x.phase!=="ready"||X.current||L||f.hasErrors)return;X.current=!0,$(!0);const w=++U.current;try{let T=ke.current,B=Le.current,A=x.snapshot;if(!C){if(Me.current&&!Me.current.validate())return;ze(null);const q=await Q();if(!q)return;T=q.workers,B=q.agents,A=q.snap}if(!A||A.completedInstances>=1)return;const fe=A.takenSequenceFlows.length,pe=await x.stepWorkers(T,{agents:B});if(!pe){O({kind:"error",text:"⏭ step failed — no dispatch round was returned"});return}const te=(E=pe.snapshot.instances[0])==null?void 0:E.variables;te&&oe({...te});const _e=Di(pe.snapshot.takenSequenceFlows,fe);O(Ci(pe,_e,He,De))}finally{U.current===w&&(X.current=!1,$(!1))}},[x,L,f.hasErrors,C,Q,O,He,De]),Kt=g.useCallback(async()=>{X.current=!1,U.current++,k(!1),$(!1),X.current=!0;try{await x.reset()}finally{X.current=!1}ve([]),oe({})},[x]),Xt=g.useCallback(()=>{var T;if(!me||qe.current&&!qe.current.validate())return;const w=x.completeUserTask(me.key,JSON.stringify(Be));O({kind:"human",text:`👤 ${cn(Be)}`});const E=(T=w==null?void 0:w.instances[0])==null?void 0:T.variables;oe(B=>({...B,...Be,...E??{}})),w&&w.completedInstances>=1&&O({kind:"done",text:"✅ process instance completed"})},[me,Be,x,O]),er=g.useMemo(()=>{var w,E;return x.phase==="loading"?i.jsx(ie,{variant:"neutral",children:"Booting engine…"}):x.phase==="error"?i.jsx(ie,{variant:"danger",children:"Engine error"}):I?i.jsx(ie,{variant:"info",children:"Running…"}):L?i.jsx(ie,{variant:"info",children:"Stepping…"}):(((w=x.snapshot)==null?void 0:w.incidentElementIds.length)??0)>0?i.jsx(ie,{variant:"danger",children:"Incident"}):me?i.jsx(ie,{variant:"warning",children:"Waiting for a human"}):(((E=x.snapshot)==null?void 0:E.completedInstances)??0)>=1?i.jsx(ie,{variant:"success",children:"Completed"}):x.snapshot?i.jsx(ie,{variant:"warning",children:"Paused"}):i.jsx(ie,{variant:"neutral",children:"Ready"})},[x.phase,x.snapshot,I,L,me]),nr=g.useMemo(()=>e.blurb.split(/\n\s*\n/).map(w=>w.trim()).filter(Boolean),[e.blurb]);return i.jsxs("div",{className:"runner",ref:m,children:[n?i.jsx("h1",{className:"visually-hidden",children:e.title}):i.jsxs("section",{className:"intro",children:[i.jsx("h1",{children:e.title}),nr.map(w=>i.jsx("p",{children:w},w))]}),e.imageInput&&i.jsx(io,{imageInput:e.imageInput,value:a,onSelect:p,disabled:I}),i.jsxs("div",{className:"scenario",children:[i.jsx("span",{className:"scenario-label",id:"scenario-label",children:e.scenariosLabel??"Example input"}),e.scenarios&&i.jsx("div",{className:"scenario-toggle",role:"group","aria-labelledby":"scenario-label",children:e.scenarios.map((w,E)=>i.jsx(Z,{size:"sm",variant:E===Ee?"default":"secondary","aria-pressed":E===Ee,disabled:I,onClick:()=>he(T=>({...T,...w.variables})),children:w.label},w.label))}),i.jsxs("button",{type:"button",className:"scenario-input-button",onClick:()=>Un(!Re),"aria-expanded":Re,"aria-controls":"start-input-editor",title:"Edit the starting payload",children:[i.jsx("span",{className:"scenario-edit-icon","aria-hidden":!0,children:"✎"})," ","input: ",i.jsx("code",{children:Eo(Y)})]}),W&&i.jsx("span",{className:"scenario-hint",children:"Fill in the input to enable Run"})]}),i.jsxs("div",{className:"inline-input-editor",id:"start-input-editor",hidden:!Re,children:[i.jsxs("div",{className:"inline-input-editor-head",children:[i.jsxs("div",{children:[i.jsx("div",{className:"inline-input-editor-title",children:M.startFormId?"Start form":"Start payload"}),i.jsx("div",{className:"inline-input-editor-copy",children:M.startFormId?`Rendered from the model's start form "${M.startFormId}".`:"The variables the instance starts with."})]}),i.jsx(Z,{size:"sm",variant:"secondary",onClick:()=>Un(!1),children:"Done"})]}),H?i.jsx(g.Suspense,{fallback:i.jsx("div",{className:"form-fallback",children:"Loading form…"}),children:i.jsx(Mt,{ref:Me,schema:H,values:Y,onChange:(w,E)=>he(T=>({...T,[w]:E})),disabled:I,onValidityChange:_n})}):i.jsx("pre",{className:"vars",children:cn(Y,2)})]}),!n&&(M.agent||e.imageInput)&&i.jsx(Oe,{sectionId:"brain",className:"brain-card","data-tour":Ne.brainPanel,title:"Agent brain",description:M.agent?`What drives “${M.agent.label}”. The model recommends; the process governs.`:"What reads the image. The model recommends; the process governs.",children:i.jsx(no,{brain:c,showText:!!M.agent,showVision:!!e.imageInput})}),i.jsxs("div",{className:"controls",children:[i.jsx(Z,{"data-tour":Ne.runButton,onClick:()=>void $n(),disabled:!Gn,children:"▶ Run"}),i.jsx(Z,{variant:"secondary",onClick:()=>void Zt(),disabled:x.phase!=="ready"||I||L||f.hasErrors||W||(((qn=x.snapshot)==null?void 0:qn.completedInstances)??0)>=1,children:"⏭ Step"}),i.jsx(Z,{variant:"secondary",onClick:()=>void Kt(),disabled:x.phase!=="ready"||L,children:"↺ Reset"}),e.tour&&i.jsx(Z,{variant:"secondary",onClick:V.start,disabled:V.active,children:V.active?"Touring…":`🧭 ${e.tour.label}`}),er]}),x.phase==="error"&&i.jsxs(de,{variant:"destructive",children:[i.jsx(le,{children:"Engine error"}),i.jsx(ce,{children:x.error})]}),ye&&i.jsxs(de,{variant:"destructive",children:[i.jsx(le,{children:"Code didn't compile"}),i.jsx(ce,{children:ye})]}),f.hasErrors&&i.jsxs(de,{variant:"destructive",children:[i.jsx(le,{children:"Run is disabled — the diagram has unresolved references"}),i.jsx(ce,{children:i.jsx("ul",{className:"diagnostics",children:f.diagnostics.filter(w=>w.severity==="error").map((w,E)=>i.jsx("li",{children:w.message},E))})})]}),!f.hasErrors&&f.diagnostics.length>0&&i.jsxs(de,{children:[i.jsx(le,{children:"Heads up"}),i.jsx(ce,{children:i.jsx("ul",{className:"diagnostics",children:f.diagnostics.map((w,E)=>i.jsx("li",{children:w.message},E))})})]}),i.jsxs("div",{className:"grid",children:[i.jsxs("div",{className:"col",children:[i.jsx(Oe,{sectionId:"process","data-tour":Ne.diagram,title:"Process",description:`${M.processName} — live token (green), incidents (red).`,children:i.jsx(g.Suspense,{fallback:i.jsx("div",{className:"diagram-fallback",children:x.phase==="loading"?"Booting the engine…":"Loading diagram…"}),children:i.jsx(xo,{xml:f.resolvedBpmn,activeIds:((Jn=x.snapshot)==null?void 0:Jn.activeElementIds)??[],incidentIds:((Hn=x.snapshot)==null?void 0:Hn.incidentElementIds)??[],className:"diagram"})})}),me&&i.jsxs(Oe,{sectionId:"human-task",title:(ae==null?void 0:ae.label)??"Human task",description:$e?`Rendered from the model's form "${ae==null?void 0:ae.formId}".`:"This task has no linked form — complete it with no variables.",children:[tn.length>0&&i.jsxs(de,{variant:"destructive",children:[i.jsx(le,{children:"The agent didn't finish its checks"}),i.jsxs(ce,{children:["It completed without running"," ",tn.map(w=>w.label||w.elementId).join(", "),". The process took the default path to this task, so the findings below have no value to report."]})]}),$e&&i.jsx(g.Suspense,{fallback:i.jsx("div",{className:"form-fallback",children:"Loading form…"}),children:i.jsx(Mt,{ref:qe,schema:$e,values:Be,onChange:(w,E)=>Ae(T=>({...T,[w]:E})),context:Qe,onValidityChange:yn})}),i.jsx(Z,{onClick:Xt,disabled:!!$e&&!wn,children:"Complete task"})]}),Ie&&i.jsx(Oe,{sectionId:"manual-job",title:Ie.control.label,description:"This job is held here on purpose — pick how it resolves.",children:i.jsxs("div",{className:"controls",children:[i.jsx(Z,{onClick:()=>void j("complete"),disabled:I||L,children:Ie.control.completeLabel??"✅ Complete normally"}),i.jsx(Z,{variant:"secondary",onClick:()=>void j("action"),disabled:I||L,children:Ie.control.action.label})]})})]}),i.jsx("div",{className:"col",children:i.jsx(uo,{log:fn,elementStats:(Wn=x.snapshot)==null?void 0:Wn.elementStats,incidents:(Zn=x.snapshot)==null?void 0:Zn.incidents,labelFor:He,hasAgent:!!M.agent,variables:i.jsxs("div",{className:"vars-block","data-tour":Ne.variablesPanel,children:[i.jsx("div",{className:"vars-head",children:"Instance variables"}),i.jsx("pre",{className:"vars",children:cn(Object.keys(Qe).length>0?Qe:Ce,2)})]})})})]}),!n&&i.jsxs("div",{className:"runner-secondary",children:[i.jsx(Oe,{sectionId:"code",className:"editors","data-tour":Ne.codePanel,defaultOpen:!1,title:"Code",description:"One handler per BPMN element, plus a model tab holding the editable diagram — select an element there to edit its properties. Return variables to merge, or throw to fail the job.",children:i.jsx(g.Suspense,{fallback:i.jsx("div",{className:"editor-fallback",children:"Loading editor…"}),children:i.jsxs(pr,{value:Pe,onValueChange:ge,children:[i.jsxs(ur,{children:[i.jsx(rn,{value:yt,children:"model"}),M.agent&&i.jsx(rn,{value:xn,children:"agent (scripted)"}),e.handlers.map(w=>{var E;return i.jsx(rn,{value:w.elementId,children:((E=M.tasks.find(T=>T.elementId===w.elementId))==null?void 0:E.label)??w.elementId},w.elementId)}),Object.keys(N).map(w=>i.jsx(rn,{value:vt+w,children:w},w))]}),i.jsxs(on,{value:yt,children:[i.jsxs("div",{className:"editor-meta",children:[i.jsx("strong",{children:"Model"}),i.jsx("code",{children:"click an element to edit its properties on the right — Run re-reads whatever you leave here"}),i.jsx(Z,{variant:"secondary",size:"sm",onClick:()=>d(e.bpmn),disabled:s===e.bpmn,children:"Revert to original"})]}),i.jsx(No,{value:s,onChange:d})]}),M.agent&&i.jsxs(on,{value:xn,children:[i.jsxs("div",{className:"editor-meta",children:[i.jsx("strong",{children:M.agent.label}),i.jsx("code",{children:c.kind==="scripted"||!c.chat?"in use":"unused — a live brain is connected"})]}),i.jsx("div",{className:"editor-wrap",children:i.jsx(Nn,{height:"360px",defaultLanguage:"javascript",value:b,onChange:w=>_(w??""),options:En})})]}),e.handlers.map(w=>{var E;return i.jsxs(on,{value:w.elementId,children:[i.jsxs("div",{className:"editor-meta",children:[i.jsx("strong",{children:((E=M.tasks.find(T=>T.elementId===w.elementId))==null?void 0:E.label)??w.elementId}),i.jsx("code",{children:w.standsInFor??w.elementId})]}),i.jsx("div",{className:"editor-wrap",children:i.jsx(Nn,{height:"360px",defaultLanguage:"javascript",value:h[w.elementId],onChange:T=>u(B=>({...B,[w.elementId]:T??""})),options:En})})]},w.elementId)}),Object.keys(N).map(w=>i.jsxs(on,{value:vt+w,children:[i.jsxs("div",{className:"editor-meta",children:[i.jsx("strong",{children:w}),i.jsxs("code",{children:["prompt / template text — substitutes"," ","{{"+w+"}}"]})]}),i.jsx("div",{className:"editor-wrap",children:i.jsx(Nn,{height:"360px",defaultLanguage:"markdown",value:N[w],onChange:E=>v(T=>en(T,{[w]:E??""})),options:En})})]},w))]})})}),M.agent&&i.jsx(Oe,{sectionId:"tools",defaultOpen:!1,title:"Tools, as the model sees them",description:i.jsxs(i.Fragment,{children:["Read from the diagram — element name, documentation, and every",i.jsx("code",{children:" fromAi(…)"})," argument."]}),children:i.jsx("ul",{className:"tool-list",children:M.agent.tools.map(w=>i.jsxs("li",{children:[i.jsx("code",{children:w.elementId}),i.jsxs("span",{children:[" — ",w.documentation||w.label]}),w.args.length>0&&i.jsx("ul",{children:w.args.map(E=>i.jsxs("li",{children:[i.jsxs("code",{children:[E.name,": ",E.type]})," ","— ",E.description]},E.name))})]},w.elementId))})})]})]})}const En={minimap:{enabled:!1},fontSize:13,scrollBeyondLastLine:!1,tabSize:2,automaticLayout:!0},Io=`<?xml version="1.0" encoding="UTF-8"?>\r
...
}`,xs={id:"loan-origination",title:"Loan origination agent",blurb:"An AI agent gathers a loan case with its own tools — customer lookup, credit bureau, an underwriting policy, a status update — then every application passes through a mandatory senior-officer review before a gateway routes it to an offer or a decline. The agent advises; the process governs.",docsUrl:"https://camunda.com/orchestrate/agents/",bpmn:Wa,forms:{"loan-application":is,"loan-senior-officer-review":ps},seed:Nt,scenarios:[{label:"Strong applicant (policy recommends approve)",variables:Nt},{label:"Marginal applicant (policy recommends decline)",variables:gs}],scriptedAgent:bs,templates:hs,tour:Ha,requiredTools:["AssessApplication","UpdateApplicationStatus"],handlers:[{elementId:"QueryCustomer",standsInFor:"CRM connector — customer lookup",source:fs},{elementId:"CreditBureauLookup",standsInFor:"REST connector — credit bureau",source:_s},{elementId:"AssessApplication",standsInFor:"Script task — underwriting policy (FEEL)",source:ws},{elementId:"UpdateApplicationStatus",standsInFor:"REST connector — origination system",source:ys},{elementId:"IssueLoanOffer",standsInFor:"REST connector — offer/booking system",source:vs},{elementId:"SendDeclineNotice",standsInFor:"REST connector — notifications",source:Ms}]},Ns=`<?xml version="1.0" encoding="UTF-8"?>
...
}`,Nd={id:"plate-recognition",title:"Read a number plate from a photo",blurb:"Pick the plate's country, then a photo goes into the run, an in-browser vision model reads the number plate on the reader's own GPU, and a human confirms or corrects it before the process records the result. The vision model recommends; the BPMN process governs. No server, no API key — with no model connected it falls back to a deterministic scripted reading.",docsUrl:"https://docs.camunda.io/docs/components/modeler/forms/camunda-forms-reference/",bpmn:qs,forms:{"plate-recognition-country":fd,"plate-recognition-confirm":nd,"plate-recognition-manual":ld},seed:{country:"auto"},imageInput:{label:"Pick a seed photo (its plate is known, so the scripted reader works offline) or upload your own — a live in-browser model reads a photo it has never seen.",seedImages:yd},scriptedVision:vd,handlers:[{elementId:"ExtractPlate",standsInFor:"Vision model — Florence-2 <OCR> on WebGPU (in-browser)",source:Md},{elementId:"RecordResult",standsInFor:"Script task — records the governed outcome",source:xd}]},Ed=[Ps,Qa,xs,Ts,Ls,Nd],kd=Object.assign({"./learn-error-boundary/index.ts":Po,"./learn-exclusive-gateway/index.ts":Ro,"./learn-message-correlation/index.ts":Uo,"./learn-multi-instance-parallel/index.ts":Yo,"./learn-service-task/index.ts":Wo,"./learn-signal-broadcast/index.ts":na,"./learn-timer-catch-event/index.ts":oa,"./learn-user-task-form/index.ts":ba}),Id=Object.values(kd).map(e=>e.default).sort((e,n)=>e.id.localeCompare(n.id)),We=[...Ed,...Id];function zn(){return"/web-demo-framework/pr-preview/pr-120/"}function Td(e){const n=zn();return e.startsWith(n)?"/"+e.slice(n.length):e}function jd(e=location.pathname){const t=Td(e).match(/^\/examples\/([^/]+)\/?$/);if(t)try{return{kind:"example",id:decodeURIComponent(t[1])}}catch{return{kind:"gallery"}}return{kind:"gallery"}}function Sd(e=location.search){return new URLSearchParams(e).get("embed")==="1"}function Pd(e=location.search){return new URLSearchParams(e).get("view")==="compact"?"compact":"full"}function Ad(e=location.search){return new URLSearchParams(e).get("autostart")==="1"}function kt(e){return`${zn()}examples/${encodeURIComponent(e)}`}const It="p";function Dd(){const e=new URLSearchParams(location.search),n=e.get(It);if(!n)return!1;const t=n.replace(/[\t\n\r]/g,"");if(!t.startsWith("/")||t.startsWith("//")||t.startsWith("/\\"))return!1;e.delete(It);try{const r=new URL(zn(),location.href),o=new URL(t.slice(1),r);return o.origin!==location.origin?!1:(o.search=e.toString(),o.hash=location.hash,history.replaceState(null,"",o),!0)}catch{return!1}}function Cd(e,n={}){const t=new URL(location.href);t.pathname=e,t.search=n.search??t.search,n.hash!==void 0&&(t.hash=n.hash),n.replace?history.replaceState(history.state,"",t):history.pushState(history.state,"",t),window.dispatchEvent(new PopStateEvent("popstate"))}function Tt(){return{route:jd(),embed:Sd(),view:Pd(),autostart:Ad()}}function Bd(){const[e,n]=g.useState(Tt);return g.useEffect(()=>{const t=()=>n(Tt());return window.addEventListener("popstate",t),()=>window.removeEventListener("popstate",t)},[]),e}const jt={headline:"The model *runs*. The code is *yours* to edit.",lede:"Every example on this page is a real BPMN process executing in your browser on the nano WebAssembly engine — edit the model, edit the handlers, swap the LLM, and run it again.",tagline:"Runnable Camunda examples"};function Ld({text:e}){return i.jsx(i.Fragment,{children:e.split(/\*([^*]+)\*/g).map((n,t)=>t%2===1?i.jsx("em",{children:n},t):i.jsx(g.Fragment,{children:n},t))})}function Rd(){const{route:e,embed:n,view:t,autostart:r}=Bd(),o=n&&t==="compact",s=qt().brain,d=ho();Pi(n);const m=e.kind==="example"?e.id:We[0].id,c=We.find(_=>_.id===m)??We[0],a=We.filter(_=>_.group!=="learn-bpmn"),p=We.filter(_=>_.group==="learn-bpmn"),h=_=>{Cd(kt(_),{hash:location.hash})},u=c.hero??jt,b=i.jsxs(i.Fragment,{children:[!n&&i.jsxs(i.Fragment,{children:[i.jsxs("section",{className:"hero",children:[i.jsx("h1",{children:i.jsx(Ld,{text:u.headline})}),u.lede&&i.jsx("p",{children:u.lede})]}),i.jsx("nav",{className:"example-picker","aria-label":"Scenario examples",children:a.map(_=>i.jsx(Z,{size:"sm",variant:_.id===c.id?"default":"secondary","aria-current":_.id===c.id?"page":void 0,onClick:()=>h(_.id),children:_.title},_.id))}),p.length>0&&i.jsxs(i.Fragment,{children:[i.jsx("h2",{className:"example-group-heading",id:"learn-bpmn-heading",children:"Learn BPMN"}),i.jsx("nav",{className:"example-picker","aria-labelledby":"learn-bpmn-heading",children:p.map(_=>i.jsx(Z,{size:"sm",variant:_.id===c.id?"default":"secondary","aria-current":_.id===c.id?"page":void 0,onClick:()=>h(_.id),children:_.title},_.id))})]})]}),i.jsxs("div",{className:"example-meta",children:[!n&&c.docsUrl&&i.jsx("a",{className:"docs-link",href:c.docsUrl,target:"_blank",rel:"noreferrer noopener",children:"View on camunda.com ↗"}),n&&i.jsx("a",{className:"open-full-page",href:kt(c.id)+(location.hash||""),target:"_top",rel:"noreferrer",children:o?"Open the editable version ↗":"Open full page ↗"})]}),i.jsx(ko,{example:c,compact:o,autostart:r,initialBrainKind:s,initialTourId:d},c.id)]});return n?i.jsx("div",{className:`c4-ui app-shell app-embed${o?" app-compact":""}`,children:i.jsx("main",{id:"main",className:`layout layout-embed${o?" layout-compact":""}`,children:b})}):i.jsxs("div",{className:"c4-ui app-shell",children:[i.jsx(hr,{className:"topbar",logo:i.jsx("span",{className:"brand-dot","aria-hidden":!0}),appName:"Runnable Camunda examples",trailing:i.jsx("span",{className:"app-subtitle",children:u.tagline??jt.tagline})}),i.jsx("main",{id:"main",className:"layout",children:b}),i.jsx("footer",{className:"footer",children:"Running locally in your browser on the nano WebAssembly BPMN engine — no cluster, no server, no data leaving the page."})]})}Dd();or.createRoot(document.getElementById("root")).render(i.jsx(g.StrictMode,{children:i.jsx(gr,{children:i.jsx(Rd,{})})}));export{ue as _,Ud as c};
