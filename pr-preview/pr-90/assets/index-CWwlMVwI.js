const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/driver-CTZuBZOi.css","assets/diagram-js-DAKGYcfb.css","assets/bpmn-embedded-ByaGq9mP.css","assets/RuntimeDiagram-B2IYfHo7.js","assets/vendor-react-9Ma26nY1.js","assets/Viewer-D_7S4Gwm.js","assets/MonacoEditor-8UugpDpm.js","assets/MonacoEditor-CprnVYr9.css","assets/vendor-modeler-BlMG6Goy.js","assets/vendor-design-system-tOwp6dSM.js","assets/vendor-design-system-CiBxOXkH.css","assets/parser-DkgAe_kI.js","assets/ModelEditor-Dwlgp6JA.css","assets/FormRenderer-Cjy4CRy1.js","assets/FormRenderer-D1JIHOW6.css"])))=>i.map(i=>d[i]);
var Lt=Object.defineProperty;var Pt=(e,n,t)=>n in e?Lt(e,n,{enumerable:!0,configurable:!0,writable:!0,value:t}):e[n]=t;var F=(e,n,t)=>Pt(e,typeof n!="symbol"?n+"":n,t);import{r as h,j as o,i as Rt}from"./vendor-react-9Ma26nY1.js";import{B as Q,a as J,L as Fe,S as fn,b as yn,c as wn,d as _n,e as Mn,A as le,f as ce,g as de,I as Pn,C as zt,h as Bt,i as Ot,j as Ft,k as Ut,l as $t,T as Yt,m as Gt,n as qe,o as Ke,p as Vt,q as Qt}from"./vendor-design-system-tOwp6dSM.js";(function(){const n=document.createElement("link").relList;if(n&&n.supports&&n.supports("modulepreload"))return;for(const i of document.querySelectorAll('link[rel="modulepreload"]'))r(i);new MutationObserver(i=>{for(const a of i)if(a.type==="childList")for(const l of a.addedNodes)l.tagName==="LINK"&&l.rel==="modulepreload"&&r(l)}).observe(document,{childList:!0,subtree:!0});function t(i){const a={};return i.integrity&&(a.integrity=i.integrity),i.referrerPolicy&&(a.referrerPolicy=i.referrerPolicy),i.crossOrigin==="use-credentials"?a.credentials="include":i.crossOrigin==="anonymous"?a.credentials="omit":a.credentials="same-origin",a}function r(i){if(i.ep)return;i.ep=!0;const a=t(i);fetch(i.href,a)}})();const Jt="modulepreload",Ht=function(e){return"/pr-preview/pr-90/"+e},Rn={},pe=function(n,t,r){let i=Promise.resolve();if(t&&t.length>0){let l=function(s){return Promise.all(s.map(c=>Promise.resolve(c).then(g=>({status:"fulfilled",value:g}),g=>({status:"rejected",reason:g}))))};document.getElementsByTagName("link");const u=document.querySelector("meta[property=csp-nonce]"),m=(u==null?void 0:u.nonce)||(u==null?void 0:u.getAttribute("nonce"));i=l(t.map(s=>{if(s=Ht(s),s in Rn)return;Rn[s]=!0;const c=s.endsWith(".css"),g=c?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${s}"]${g}`))return;const p=document.createElement("link");if(p.rel=c?"stylesheet":Jt,c||(p.as="script"),p.crossOrigin="",p.href=s,m&&p.setAttribute("nonce",m),document.head.appendChild(p),c)return new Promise((b,f)=>{p.addEventListener("load",b),p.addEventListener("error",()=>f(new Error(`Unable to preload CSS for ${s}`)))})}))}function a(l){const u=new Event("vite:preloadError",{cancelable:!0});if(u.payload=l,window.dispatchEvent(u),!u.defaultPrevented)throw l}return i.then(l=>{for(const u of l||[])u.status==="rejected"&&a(u.reason);return n().catch(a)})},Wt="io.camunda.agenticai:aiagent",xe="http://www.omg.org/spec/BPMN/20100524/MODEL",Zt="http://camunda.org/schema/zeebe/1.0";function vn(e,n){return Array.from(e.getElementsByTagNameNS(Zt,n))}function dt(e,n){return vn(e,n).filter(t=>qt(t)===e)}function qt(e){let n=e.parentElement;for(;n;){if(n.namespaceURI===xe&&n.localName!=="extensionElements")return n;n=n.parentElement}return null}function En(e){const n=dt(e,"taskDefinition")[0],t=n==null?void 0:n.getAttribute("type");return t||(e.localName==="scriptTask"?e.getAttribute("id")??null:null)}function zn(e){const n=Array.from(e.children).find(t=>t.namespaceURI===xe&&t.localName==="documentation");return((n==null?void 0:n.textContent)??"").trim()}function Bn(e){if(!e)return"";const n=e.startsWith("=")?e.slice(1):e,t=n.match(/"((?:[^"\\]|\\.)*)"/g);return t?t.map(r=>r.slice(1,-1).replace(/\\n/g,`
...
`)}function Kt(e){return mt(ut(e))}function Xt(e){const n=Array.from(e.children).find(t=>t.namespaceURI===xe&&t.localName==="extensionElements");return n?mt(ut(n)):[]}function mt(e){const n=/fromAi\(\s*toolCall\.([A-Za-z_$][\w$]*)\s*,\s*"((?:[^"\\]|\\.)*)"\s*(?:,\s*"(\w+)")?/g,t=[],r=new Set;for(const i of e.matchAll(n)){const a=i[1];r.has(a)||(r.add(a),t.push({name:a,description:(i[2]??"").replace(/&#10;/g,`
`).replace(/\\"/g,'"').replace(/&quot;/g,'"').replace(/&#39;/g,"'").trim(),type:i[3]??"string"}))}return t}function er(e){const n={};for(const t of dt(e,"input")){const r=t.getAttribute("target");r&&(n[r]=t.getAttribute("source")??"")}return n}function nr(e){return Array.from(e.getElementsByTagNameNS(xe,"adHocSubProcess")).filter(n=>(En(n)??"").startsWith(Wt))}const tr=new Set(["subProcess","adHocSubProcess","callActivity"]),rr=new Set(["adHocSubProcess","subProcess","transaction"]);function ir(e){let n=e.parentElement;for(;n;){if(n.namespaceURI===xe&&rr.has(n.localName))return n;n=n.parentElement}return null}function or(e,n){const t=er(e),r=Number((t["data.limits.maxModelCalls"]??"").replace(/^=/,""));return{elementId:e.getAttribute("id")??"agent",label:e.getAttribute("name")??"Agent",jobType:En(e),systemPrompt:Bn(t["data.systemPrompt.prompt"]),userPrompt:Bn(t["data.userPrompt.prompt"]),maxModelCalls:Number.isFinite(r)&&r>0?r:10,tools:n}}function sr(e,n){var g;const t=e.getAttribute("id")??"",r=e.getAttribute("name")??t,i=nr(e);i.length>1&&n.push({severity:"warning",elementId:i.map(p=>p.getAttribute("id")).join(", "),message:`Process "${r}" hosts ${i.length} AI Agent sub-processes (${i.map(p=>p.getAttribute("id")).join(", ")}). Each gets its own independent agent state (turn counter, called tools) — the run itself is shared across hosts, but each host's agent state within it is not.`});const a=[],l=new Map(i.map(p=>[p,[]]));for(const p of Array.from(e.getElementsByTagName("*"))){if(p.namespaceURI!==xe||i.includes(p))continue;const b=p.getAttribute("id");if(!b)continue;const f=ir(p),_=f&&i.includes(f)?f:null;if(_&&tr.has(p.localName)){const k=p.getAttribute("name")??b,D=zn(p);a.push({elementId:b,label:k,jobType:"",documentation:D,isTool:!0,compound:!0}),l.get(_).push({elementId:b,label:k,jobType:"",documentation:D,args:Xt(p),compound:!0});continue}const y=En(p);if(!y)continue;const M={elementId:b,label:p.getAttribute("name")??b,jobType:y,documentation:zn(p),isTool:_!=null};a.push(M),_&&l.get(_).push({elementId:b,label:M.label,jobType:y,documentation:M.documentation,args:Kt(p)})}const u=i.map(p=>or(p,l.get(p))),m=Array.from(e.getElementsByTagNameNS(xe,"userTask")).map(p=>{var b;return{elementId:p.getAttribute("id")??"",label:p.getAttribute("name")??p.getAttribute("id")??"",formId:((b=vn(p,"formDefinition")[0])==null?void 0:b.getAttribute("formId"))??void 0}}),s=e.getElementsByTagNameNS(xe,"startEvent")[0],c=s?((g=vn(s,"formDefinition")[0])==null?void 0:g.getAttribute("formId"))??void 0:void 0;return{processId:t,processName:r,tasks:a,agents:u,userTasks:m,startFormId:c}}function ar(e,n={}){const t=new DOMParser().parseFromString(e,"application/xml"),r=t.getElementsByTagName("parsererror")[0];if(r)throw new Error(`Invalid BPMN XML: ${r.textContent}`);const i=Array.from(t.getElementsByTagNameNS(xe,"process"));if(i.length===0)throw new Error("No <bpmn:process> in the diagram.");const a=[],l=i.map(m=>sr(m,a));let u=n.processId?l.find(m=>m.processId===n.processId):void 0;return n.processId&&!u&&a.push({severity:"warning",message:`Requested process "${n.processId}" not found — falling back to "${l[0].processId}".`}),u??(u=l[0]),l.length>1&&a.push({severity:"warning",message:`Diagram has ${l.length} <bpmn:process> elements (${l.map(m=>m.processId).join(", ")}); using "${u.processId}" as the active process. Pass a processId to parseModel to target another.`}),{processes:l,diagnostics:a,processId:u.processId,processName:u.processName,tasks:u.tasks,agent:u.agents[0]??null,agents:l.flatMap(m=>m.agents),userTasks:u.userTasks,startFormId:u.startFormId}}function lr(e){return e?e.imageId?{imageId:e.imageId}:e.imageName?{imageName:e.imageName}:{}:{}}function pt(e,n){return n?e.pixels:e.imageId??e.pixels}const cr="No image selected — pick or upload a photo to read.";function On(){return cr}function dr(e,n){return async t=>{const r=e.resolve(n);if(!r)return On();const i=pt(r,e.live);if(i===void 0)return On();try{return await e.read(i,t)}catch(a){return`Couldn't read the image (${a instanceof Error?a.message:String(a)}).`}}}function ur(e,n){return async()=>{const t=e.resolve(n);if(t)return pt(t,e.live)}}function mr(){return`<!doctype html><html><head><meta charset="utf-8"></head><body><script>
    "use strict";
    ...
    post({ kind: "ready" });
  <\/script></body></html>`}function gt(e,n={}){const{timeoutMs:t=5e3,onTrace:r,onVision:i,onImage:a}=n,l=`${Date.now()}-${Math.random().toString(36).slice(2)}`;return new Promise((u,m)=>{const s=document.createElement("iframe");s.setAttribute("sandbox","allow-scripts"),s.style.display="none",s.setAttribute("aria-hidden","true");let c=!1,g;const p=()=>{g&&clearTimeout(g),window.removeEventListener("message",f),s.remove()},b=y=>{c||(c=!0,p(),y())};function f(y){var k;if(y.source!==s.contentWindow)return;const M=y.data;if(!(!M||typeof M!="object")){if(M.kind==="ready"){const D=e.job,G=e.kind==="run-handler"?{kind:"run-handler",id:l,source:e.source,job:D,hasVision:e.hasVision}:{kind:"run-agent",id:l,source:e.source,job:D};(k=s.contentWindow)==null||k.postMessage(G,"*");return}"id"in M&&M.id!==l||(M.kind==="trace"?r==null||r(M.text):M.kind==="vision-request"?_(M.callId,i,"vision",M.prompt):M.kind==="image-request"?_(M.callId,a,"image"):M.kind==="result"?b(()=>u(M.value)):M.kind==="error"&&b(()=>m(new Error(M.message))))}}function _(y,M,k,...D){const G=Z=>{var se;return(se=s.contentWindow)==null?void 0:se.postMessage(Z,"*")};if(!M){G({kind:"helper-error",id:l,callId:y,message:`${k} helper is not available.`});return}Promise.resolve().then(()=>M(...D)).then(Z=>G({kind:"helper-result",id:l,callId:y,value:Z}),Z=>G({kind:"helper-error",id:l,callId:y,message:Z instanceof Error?Z.message:String(Z)}))}window.addEventListener("message",f),g=setTimeout(()=>{b(()=>m(new Error(`Handler timed out after ${t}ms — the sandboxed run was terminated.`)))},t),s.srcdoc=mr(),document.body.appendChild(s)})}function ht(e){return{key:e.key,type:e.type,elementId:e.elementId,instanceKey:e.instanceKey,variables:e.variables??{}}}function pr(e,n,t){const r=typeof t.vision=="function";return gt({kind:"run-handler",source:e,job:ht(n),hasVision:r},{onTrace:t.trace,onVision:t.vision?i=>t.vision(i):void 0,onImage:t.image?()=>t.image():void 0})}function gr(e,n){return gt({kind:"run-agent",source:e,job:ht(n)})}function bt(e,n){try{new Function(`"use strict"; return (${e});`)}catch{throw new Error(`${n} has a syntax error.`)}}function hr(e){return bt(e,"Handler code"),(n,t)=>pr(e,n,t)}function br(e){return bt(e,"Agent code"),n=>gr(e,n)}function fr(e,n,t,r){return{sleep:i=>new Promise(a=>setTimeout(a,i)),trace:i=>n({kind:"tool",text:`   ${i}`,elementId:e.elementId,turn:t}),text:(i,a="")=>{const l=e.variables[i];return typeof l=="string"?l:l==null?a:String(l)},num:(i,a=0)=>{const l=e.variables[i],u=typeof l=="number"?l:Number(l);return Number.isFinite(u)?u:a},...r?{vision:dr(r,e.instanceKey),image:ur(r,e.instanceKey)}:{}}}function yr(e){if(e===void 0)return"undefined";try{return JSON.stringify(e)}catch{return"[unserializable value]"}}function wr(e,n,t,r,i){const a={},l=e.processes.flatMap(m=>m.tasks),u=new Map(l.map(m=>[m.elementId,m.label]));for(const m of l)m.compound||a[m.jobType]||(a[m.jobType]=async s=>{const c=n[s.elementId];if(!c)throw new Error(`No handler registered for ${s.elementId} (job type ${s.type})`);const g=u.get(s.elementId)??s.elementId,p=r==null?void 0:r.current;t({kind:"tool",text:`▶ ${g}`,elementId:s.elementId,turn:p});const b=await c(s,fr(s,t,p,i));return t({kind:"vars",text:`  ↳ ${yr(b)}`,elementId:s.elementId,result:b,turn:p}),b});return a}const _r=/\{\{\s*([A-Za-z][A-Za-z0-9_-]*)\s*\}\}/g;function He(...e){const n=Object.create(null);for(const t of e)if(t)for(const r of Object.keys(t))n[r]=t[r];return n}function ft(e){return(e.split("/").pop()??e).replace(/\.[^./]+$/,"")}function yt(e){return e.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;")}function Mr(e){return yt(e).replace(/"/g,"&quot;").replace(/\n/g,"&#10;").replace(/\t/g,"&#9;")}function vr(e){return e.replace(/\\/g,"\\\\").replace(/&/g,"&amp;").replace(/"/g,"\\&#34;").replace(/\n/g,"&#10;").replace(/\t/g,"&#9;").replace(/</g,"&lt;").replace(/>/g,"&gt;")}function xr(e){return JSON.stringify(e).slice(1,-1)}function Nr(e,n){const t=e.lastIndexOf("<",n),r=e.lastIndexOf(">",n);if(t<=r)return"text";const i=e.slice(t,n);if((i.match(/"/g)??[]).length%2===0)return"text";const l=i.lastIndexOf('"');return(i.slice(l+1).match(/&#34;|&quot;/g)??[]).length%2===1?"feel-literal":"attribute"}function Ir(e,n,t="xml"){const r=[],i=new Set;return{result:e.replace(_r,(l,u,m)=>{const s=u.trim();if(!Object.prototype.hasOwnProperty.call(n,s))return i.has(s)||(i.add(s),r.push(s)),l;const c=n[s];if(t==="json")return xr(c);const g=Nr(e,m);return g==="feel-literal"?vr(c):g==="attribute"?Mr(c):yt(c)}),unresolved:r}}function kr(){return{processes:[],diagnostics:[],processId:"",processName:"",tasks:[],agent:null,agents:[],userTasks:[],startFormId:void 0}}function Er(e,n={},t=e.bpmn,r={}){const i=[],a=He(e.templates,r),{result:l,unresolved:u}=Ir(t,a,"xml");for(const M of u)i.push({severity:"warning",message:`Template placeholder "{{${M}}}" has no matching prompt/template content — left in the model as-is, not substituted.`});let m;try{m=ar(l)}catch(M){return i.push({severity:"error",message:M instanceof Error?M.message:String(M)}),{resolvedBpmn:l,model:kr(),handlers:{},forms:{},diagnostics:i,hasErrors:!0}}i.push(...m.diagnostics);const s=m.processes.flatMap(M=>M.tasks),c=new Map(e.handlers.map(M=>[M.elementId,M.source])),g={};for(const M of s){if(M.compound)continue;const k=n[M.elementId]??c.get(M.elementId);if(k===void 0){i.push({severity:"error",elementId:M.elementId,jobType:M.jobType,message:`No handler for "${M.label}" (${M.elementId}, job type "${M.jobType}"). Add a handler for this element, or remove it from the diagram.`});continue}try{g[M.elementId]=hr(k)}catch(D){i.push({severity:"error",elementId:M.elementId,jobType:M.jobType,message:`"${M.label}" (${M.elementId}): handler code didn't compile — ${D instanceof Error?D.message:String(D)}`})}}const p=new Set(s.map(M=>M.elementId)),b=new Set([...c.keys(),...Object.keys(n)]);for(const M of b)p.has(M)||i.push({severity:"error",elementId:M,message:`Handler "${M}" doesn't match any element in the current diagram — likely orphaned by a rename. Rename it back, or remove the handler.`});const f={},_=e.forms??{},y=(M,k)=>{if(!M)return;const D=_[M];D?f[M]=D:i.push({severity:"error",formId:M,message:`${k} references form "${M}", which has no matching schema.`})};for(const M of m.processes){y(M.startFormId,`The start event of process "${M.processName}"`);for(const k of M.userTasks)y(k.formId,`User task "${k.label}" (${k.elementId})`)}return{resolvedBpmn:l,model:m,handlers:g,forms:f,diagnostics:i,hasErrors:i.some(M=>M.severity==="error")}}function Tr(e){const n=e.indexOf("{");if(n<0)return null;let t=0;for(let r=n;r<e.length;r++)if(e[r]==="{")t++;else if(e[r]==="}"&&(t--,t===0))try{const i=JSON.parse(e.slice(n,r+1));return typeof i=="object"&&i!==null&&!Array.isArray(i)?i:null}catch{return null}return null}function xn(e,n=220){const t=e.replace(/\s+/g," ").trim();return t.length>n?`${t.slice(0,n-1)}…`:t}function Fn(e){const n=e.arguments??e.args??e.parameters??e.input;return n&&typeof n=="object"&&!Array.isArray(n)?n:{}}function Un(e){if(!e)return[];const n=e.tool??e.name??e.action;if(typeof n=="string"&&n.trim())return[{name:n.trim(),args:Fn(e)}];const t=e.tools??e.tool_calls??e.toolset??e.actions,r=Array.isArray(t)?t:Object.values(e).find(a=>Array.isArray(a))??[],i=[];for(const a of r)if(typeof a=="string")a.trim()&&i.push({name:a.trim(),args:{}});else if(a&&typeof a=="object"){const l=a,u=l.name??l.tool??l.id??l.function;typeof u=="string"&&u.trim()&&i.push({name:u.trim(),args:Fn(l)})}return i}function jr(e){if(!e)return!1;const n=e.done??e.finished??e.complete;return typeof n=="boolean"?n:typeof n=="string"?n.toLowerCase()==="true":!1}function $n(e){const n=e.args.length?e.args.map(r=>`      ${r.name} (${r.type}) — ${r.description}`).join(`
...
character, with nothing added. When your work is finished, reply exactly
{"done": true} and no tool.`}function Ar(e,n,t,r,i=[],a=[],l=!1){const u=e.userPrompt||"Carry out your task.",m=Object.entries(n).filter(([,c])=>typeof c=="string"&&c.trim().length>0).map(([c,g])=>`  ${c}: ${String(g)}`),s=[u,m.length?`Case data:
${m.join(`
...
`)}async function Cr(e,n,t,r,i,a){let l="";n({kind:"llm",text:"LLM thinking…",key:t,pending:!0,turn:a});const u=await e(r,i,m=>{l+=m,n({kind:"llm",text:`${xn(l)} ▍`,key:t,pending:!0,turn:a})});return n({kind:"llm",text:xn(u||l)||"(empty reply)",key:t,pending:!1,turn:a}),u}function Dr(e,n){switch(e){case"number":return typeof n=="number"&&Number.isFinite(n)?{ok:!0,value:n}:typeof n=="string"&&n.trim()!==""&&Number.isFinite(Number(n))?{ok:!0,value:Number(n)}:{ok:!1};case"boolean":return typeof n=="boolean"?{ok:!0,value:n}:typeof n=="string"&&/^(true|false)$/i.test(n.trim())?{ok:!0,value:n.trim().toLowerCase()==="true"}:{ok:!1};default:return typeof n=="object"?{ok:!1}:{ok:!0,value:String(n)}}}function Lr(e,n,t){const r={},i=new Map,a=new Map;for(const{tool:l,args:u}of e){const m={};for(const s of l.args){const c=u[s.name];if(!(c!=null&&c!=="")){n({kind:"error",text:`🤖 ${l.elementId}: model supplied no value for "${s.name}"`,turn:t,elementId:l.elementId});continue}const p=i.get(s.name);if(p!==void 0&&p!==l.elementId){n({kind:"error",text:`🤖 argument name collision on "${s.name}": both ${p} and ${l.elementId} declare it — ${p} already claimed it this turn, ${l.elementId}'s value is dropped`,turn:t,elementId:l.elementId});continue}const b=Dr(s.type,c);if(!b.ok){n({kind:"error",text:`🤖 ${l.elementId}: "${s.name}" is declared as ${s.type} but the model supplied ${JSON.stringify(c)} — rejected, not passed through`,turn:t,elementId:l.elementId});continue}r[s.name]=b.value,m[s.name]=b.value,i.set(s.name,l.elementId)}a.set(l.elementId,m)}return{variablesOut:r,forHistory:a}}function Pr(e,n,t,r={}){const{maxNewTokens:i=384,allowRepeats:a=!1,allowMultiToolTurns:l=!1,turnRef:u,requiredTools:m=[],maxEarlyDoneNudges:s=1}=r;let c=0;const g=new Set,p=[];let b=0,f=[],_=[];return async y=>{const M=y.variables,k=M.toolCallResult;for(k!==void 0&&p.length&&(p[p.length-1]=`${p[p.length-1]} → ${xn(JSON.stringify(k),160)}`);;){const G=await D();if(G)return G}async function D(){if(c+=1,u&&(u.current=c),c>e.maxModelCalls)return t({kind:"error",text:`Turn budget spent (maxModelCalls=${e.maxModelCalls}) — completing the agent.`,turn:c}),{completionConditionFulfilled:!0};const G=a?e.tools:e.tools.filter(C=>!g.has(C.elementId)),Z=[{role:"system",content:Sr(e,l,G)},{role:"user",content:Ar(e,M,p,G,f,_,a)}];f=[],_=[];let se;try{se=await Cr(n,t,`llm-turn-${c}`,Z,i,c)}catch(C){return t({kind:"error",text:`LLM call failed: ${C instanceof Error?C.message:String(C)} — completing the agent.`,turn:c}),{completionConditionFulfilled:!0}}const q=Tr(se);if(jr(q)&&Un(q).length===0){const C=m.filter(ge=>!g.has(ge));return C.length&&b<s?(b+=1,f=C,t({kind:"agent",text:`🤖 model says it is done, but ${C.join(", ")} hasn't run — asking once more`,turn:c}),null):(t({kind:"agent",text:"🤖 model says it is done",turn:c}),{completionConditionFulfilled:!0})}const te=Un(q);if(te.length===0)return t({kind:"error",text:"🤖 model named no tool (and didn't say it was done) — asking again",turn:c}),_=['it named no tool and did not say it was done — reply with {"tool": "...", "arguments": {...}} or {"done": true}'],null;const U=[],E=[],N=[];for(const C of te){const ge=e.tools.find(K=>K.elementId===C.name);if(!ge){E.push(C.name);continue}if(!a&&g.has(ge.elementId)){N.push(ge.elementId);continue}U.push({tool:ge,args:C.args})}if(E.length&&t({kind:"error",text:`🤖 model named a tool that doesn't exist: ${E.join(", ")} — nothing activated`,turn:c}),N.length&&t({kind:"error",text:`🤖 model asked to re-run ${N.join(", ")} — skipped (already run)`,turn:c}),U.length===0)return t({kind:"agent",text:"🤖 nothing activated — asking again",turn:c}),_=[...E.length?[`${E.join(", ")} ${E.length===1?"is":"are"} not a real tool`]:[],...N.length?[`${N.join(", ")} has already run and will never run again — pick a different tool, or reply {"done": true} if nothing is left to do`]:[]],null;const{variablesOut:A,forHistory:H}=Lr(U,t,c);for(const{tool:C}of U)g.add(C.elementId),p.push(`- ${C.elementId}(${JSON.stringify(H.get(C.elementId))})`);for(const{tool:C}of U)t({kind:"agent",text:`🤖 calling ${C.elementId}`,turn:c,elementId:C.elementId,args:H.get(C.elementId)??{}});return{activateElements:U.map(C=>({elementId:C.tool.elementId})),variables:A}}}}function Rr(e,n,t,r={}){const i=new Map(e.map(a=>[a.elementId,Pr(a,n,t,r)]));return async a=>{const l=i.get(a.elementId);if(!l)throw new Error(`No agent host registered for "${a.elementId}"`);return l(a)}}class Nn{__destroy_into_raw(){const n=this.__wbg_ptr;return this.__wbg_ptr=0,Yn.unregister(this),n}free(){const n=this.__destroy_into_raw();d.__wbg_testengine_free(n,0)}activateJobs(n,t,r,i){let a,l;try{const b=d.__wbindgen_add_to_stack_pointer(-16),f=S(n,d.__wbindgen_export,d.__wbindgen_export2),_=j,y=S(i,d.__wbindgen_export,d.__wbindgen_export2),M=j;d.testengine_activateJobs(b,this.__wbg_ptr,f,_,t,r,y,M);var u=w().getInt32(b+0,!0),m=w().getInt32(b+4,!0),s=w().getInt32(b+8,!0),c=w().getInt32(b+12,!0),g=u,p=m;if(c)throw g=0,p=0,B(s);return a=g,l=p,z(g,p)}finally{d.__wbindgen_add_to_stack_pointer(16),d.__wbindgen_export3(a,l,1)}}advanceTime(n){let t,r;try{const c=d.__wbindgen_add_to_stack_pointer(-16);d.testengine_advanceTime(c,this.__wbg_ptr,n);var i=w().getInt32(c+0,!0),a=w().getInt32(c+4,!0),l=w().getInt32(c+8,!0),u=w().getInt32(c+12,!0),m=i,s=a;if(u)throw m=0,s=0,B(l);return t=m,r=s,z(m,s)}finally{d.__wbindgen_add_to_stack_pointer(16),d.__wbindgen_export3(t,r,1)}}assignUserTask(n,t,r){let i,a;try{const p=d.__wbindgen_add_to_stack_pointer(-16),b=S(n,d.__wbindgen_export,d.__wbindgen_export2),f=j,_=S(t,d.__wbindgen_export,d.__wbindgen_export2),y=j;d.testengine_assignUserTask(p,this.__wbg_ptr,b,f,_,y,r);var l=w().getInt32(p+0,!0),u=w().getInt32(p+4,!0),m=w().getInt32(p+8,!0),s=w().getInt32(p+12,!0),c=l,g=u;if(s)throw c=0,g=0,B(m);return i=c,a=g,z(c,g)}finally{d.__wbindgen_add_to_stack_pointer(16),d.__wbindgen_export3(i,a,1)}}broadcastSignal(n,t){let r,i;try{const g=d.__wbindgen_add_to_stack_pointer(-16),p=S(n,d.__wbindgen_export,d.__wbindgen_export2),b=j,f=S(t,d.__wbindgen_export,d.__wbindgen_export2),_=j;d.testengine_broadcastSignal(g,this.__wbg_ptr,p,b,f,_);var a=w().getInt32(g+0,!0),l=w().getInt32(g+4,!0),u=w().getInt32(g+8,!0),m=w().getInt32(g+12,!0),s=a,c=l;if(m)throw s=0,c=0,B(u);return r=s,i=c,z(s,c)}finally{d.__wbindgen_add_to_stack_pointer(16),d.__wbindgen_export3(r,i,1)}}cancelInstance(n){let t,r;try{const c=d.__wbindgen_add_to_stack_pointer(-16),g=S(n,d.__wbindgen_export,d.__wbindgen_export2),p=j;d.testengine_cancelInstance(c,this.__wbg_ptr,g,p);var i=w().getInt32(c+0,!0),a=w().getInt32(c+4,!0),l=w().getInt32(c+8,!0),u=w().getInt32(c+12,!0),m=i,s=a;if(u)throw m=0,s=0,B(l);return t=m,r=s,z(m,s)}finally{d.__wbindgen_add_to_stack_pointer(16),d.__wbindgen_export3(t,r,1)}}completeAgentJob(n,t,r){let i,a;try{const p=d.__wbindgen_add_to_stack_pointer(-16),b=S(n,d.__wbindgen_export,d.__wbindgen_export2),f=j,_=S(t,d.__wbindgen_export,d.__wbindgen_export2),y=j,M=S(r,d.__wbindgen_export,d.__wbindgen_export2),k=j;d.testengine_completeAgentJob(p,this.__wbg_ptr,b,f,_,y,M,k);var l=w().getInt32(p+0,!0),u=w().getInt32(p+4,!0),m=w().getInt32(p+8,!0),s=w().getInt32(p+12,!0),c=l,g=u;if(s)throw c=0,g=0,B(m);return i=c,a=g,z(c,g)}finally{d.__wbindgen_add_to_stack_pointer(16),d.__wbindgen_export3(i,a,1)}}completeJob(n,t){let r,i;try{const g=d.__wbindgen_add_to_stack_pointer(-16),p=S(n,d.__wbindgen_export,d.__wbindgen_export2),b=j,f=S(t,d.__wbindgen_export,d.__wbindgen_export2),_=j;d.testengine_completeJob(g,this.__wbg_ptr,p,b,f,_);var a=w().getInt32(g+0,!0),l=w().getInt32(g+4,!0),u=w().getInt32(g+8,!0),m=w().getInt32(g+12,!0),s=a,c=l;if(m)throw s=0,c=0,B(u);return r=s,i=c,z(s,c)}finally{d.__wbindgen_add_to_stack_pointer(16),d.__wbindgen_export3(r,i,1)}}completeUserTask(n,t){let r,i;try{const g=d.__wbindgen_add_to_stack_pointer(-16),p=S(n,d.__wbindgen_export,d.__wbindgen_export2),b=j,f=S(t,d.__wbindgen_export,d.__wbindgen_export2),_=j;d.testengine_completeUserTask(g,this.__wbg_ptr,p,b,f,_);var a=w().getInt32(g+0,!0),l=w().getInt32(g+4,!0),u=w().getInt32(g+8,!0),m=w().getInt32(g+12,!0),s=a,c=l;if(m)throw s=0,c=0,B(u);return r=s,i=c,z(s,c)}finally{d.__wbindgen_add_to_stack_pointer(16),d.__wbindgen_export3(r,i,1)}}correlateMessage(n,t,r){let i,a;try{const p=d.__wbindgen_add_to_stack_pointer(-16),b=S(n,d.__wbindgen_export,d.__wbindgen_export2),f=j,_=S(t,d.__wbindgen_export,d.__wbindgen_export2),y=j,M=S(r,d.__wbindgen_export,d.__wbindgen_export2),k=j;d.testengine_correlateMessage(p,this.__wbg_ptr,b,f,_,y,M,k);var l=w().getInt32(p+0,!0),u=w().getInt32(p+4,!0),m=w().getInt32(p+8,!0),s=w().getInt32(p+12,!0),c=l,g=u;if(s)throw c=0,g=0,B(m);return i=c,a=g,z(c,g)}finally{d.__wbindgen_add_to_stack_pointer(16),d.__wbindgen_export3(i,a,1)}}createInstance(n,t,r){let i,a;try{const p=d.__wbindgen_add_to_stack_pointer(-16),b=S(n,d.__wbindgen_export,d.__wbindgen_export2),f=j,_=S(t,d.__wbindgen_export,d.__wbindgen_export2),y=j;d.testengine_createInstance(p,this.__wbg_ptr,b,f,_,y,Ur(r)?Number.MAX_SAFE_INTEGER:r>>0);var l=w().getInt32(p+0,!0),u=w().getInt32(p+4,!0),m=w().getInt32(p+8,!0),s=w().getInt32(p+12,!0),c=l,g=u;if(s)throw c=0,g=0,B(m);return i=c,a=g,z(c,g)}finally{d.__wbindgen_add_to_stack_pointer(16),d.__wbindgen_export3(i,a,1)}}debugClear(){d.testengine_debugClear(this.__wbg_ptr)}debugCreateInstance(n,t,r){let i,a;try{const p=d.__wbindgen_add_to_stack_pointer(-16),b=S(n,d.__wbindgen_export,d.__wbindgen_export2),f=j,_=S(t,d.__wbindgen_export,d.__wbindgen_export2),y=j,M=S(r,d.__wbindgen_export,d.__wbindgen_export2),k=j;d.testengine_debugCreateInstance(p,this.__wbg_ptr,b,f,_,y,M,k);var l=w().getInt32(p+0,!0),u=w().getInt32(p+4,!0),m=w().getInt32(p+8,!0),s=w().getInt32(p+12,!0),c=l,g=u;if(s)throw c=0,g=0,B(m);return i=c,a=g,z(c,g)}finally{d.__wbindgen_add_to_stack_pointer(16),d.__wbindgen_export3(i,a,1)}}get debugIsPaused(){return d.testengine_debugIsPaused(this.__wbg_ptr)!==0}debugResume(){let n,t;try{const s=d.__wbindgen_add_to_stack_pointer(-16);d.testengine_debugResume(s,this.__wbg_ptr);var r=w().getInt32(s+0,!0),i=w().getInt32(s+4,!0),a=w().getInt32(s+8,!0),l=w().getInt32(s+12,!0),u=r,m=i;if(l)throw u=0,m=0,B(a);return n=u,t=m,z(u,m)}finally{d.__wbindgen_add_to_stack_pointer(16),d.__wbindgen_export3(n,t,1)}}debugStep(){let n,t;try{const s=d.__wbindgen_add_to_stack_pointer(-16);d.testengine_debugStep(s,this.__wbg_ptr);var r=w().getInt32(s+0,!0),i=w().getInt32(s+4,!0),a=w().getInt32(s+8,!0),l=w().getInt32(s+12,!0),u=r,m=i;if(l)throw u=0,m=0,B(a);return n=u,t=m,z(u,m)}finally{d.__wbindgen_add_to_stack_pointer(16),d.__wbindgen_export3(n,t,1)}}deploy(n){let t,r;try{const c=d.__wbindgen_add_to_stack_pointer(-16),g=S(n,d.__wbindgen_export,d.__wbindgen_export2),p=j;d.testengine_deploy(c,this.__wbg_ptr,g,p);var i=w().getInt32(c+0,!0),a=w().getInt32(c+4,!0),l=w().getInt32(c+8,!0),u=w().getInt32(c+12,!0),m=i,s=a;if(u)throw m=0,s=0,B(l);return t=m,r=s,z(m,s)}finally{d.__wbindgen_add_to_stack_pointer(16),d.__wbindgen_export3(t,r,1)}}deployForm(n){let t,r;try{const c=d.__wbindgen_add_to_stack_pointer(-16),g=S(n,d.__wbindgen_export,d.__wbindgen_export2),p=j;d.testengine_deployForm(c,this.__wbg_ptr,g,p);var i=w().getInt32(c+0,!0),a=w().getInt32(c+4,!0),l=w().getInt32(c+8,!0),u=w().getInt32(c+12,!0),m=i,s=a;if(u)throw m=0,s=0,B(l);return t=m,r=s,z(m,s)}finally{d.__wbindgen_add_to_stack_pointer(16),d.__wbindgen_export3(t,r,1)}}deployResource(n,t){let r,i;try{const g=d.__wbindgen_add_to_stack_pointer(-16),p=S(n,d.__wbindgen_export,d.__wbindgen_export2),b=j,f=S(t,d.__wbindgen_export,d.__wbindgen_export2),_=j;d.testengine_deployResource(g,this.__wbg_ptr,p,b,f,_);var a=w().getInt32(g+0,!0),l=w().getInt32(g+4,!0),u=w().getInt32(g+8,!0),m=w().getInt32(g+12,!0),s=a,c=l;if(m)throw s=0,c=0,B(u);return r=s,i=c,z(s,c)}finally{d.__wbindgen_add_to_stack_pointer(16),d.__wbindgen_export3(r,i,1)}}events(){let n,t;try{const s=d.__wbindgen_add_to_stack_pointer(-16);d.testengine_events(s,this.__wbg_ptr);var r=w().getInt32(s+0,!0),i=w().getInt32(s+4,!0),a=w().getInt32(s+8,!0),l=w().getInt32(s+12,!0),u=r,m=i;if(l)throw u=0,m=0,B(a);return n=u,t=m,z(u,m)}finally{d.__wbindgen_add_to_stack_pointer(16),d.__wbindgen_export3(n,t,1)}}failJob(n,t,r){let i,a;try{const p=d.__wbindgen_add_to_stack_pointer(-16),b=S(n,d.__wbindgen_export,d.__wbindgen_export2),f=j,_=S(r,d.__wbindgen_export,d.__wbindgen_export2),y=j;d.testengine_failJob(p,this.__wbg_ptr,b,f,t,_,y);var l=w().getInt32(p+0,!0),u=w().getInt32(p+4,!0),m=w().getInt32(p+8,!0),s=w().getInt32(p+12,!0),c=l,g=u;if(s)throw c=0,g=0,B(m);return i=c,a=g,z(c,g)}finally{d.__wbindgen_add_to_stack_pointer(16),d.__wbindgen_export3(i,a,1)}}migrate(n,t,r){let i,a;try{const p=d.__wbindgen_add_to_stack_pointer(-16),b=S(n,d.__wbindgen_export,d.__wbindgen_export2),f=j,_=S(t,d.__wbindgen_export,d.__wbindgen_export2),y=j,M=S(r,d.__wbindgen_export,d.__wbindgen_export2),k=j;d.testengine_migrate(p,this.__wbg_ptr,b,f,_,y,M,k);var l=w().getInt32(p+0,!0),u=w().getInt32(p+4,!0),m=w().getInt32(p+8,!0),s=w().getInt32(p+12,!0),c=l,g=u;if(s)throw c=0,g=0,B(m);return i=c,a=g,z(c,g)}finally{d.__wbindgen_add_to_stack_pointer(16),d.__wbindgen_export3(i,a,1)}}modify(n,t,r){let i,a;try{const p=d.__wbindgen_add_to_stack_pointer(-16),b=S(n,d.__wbindgen_export,d.__wbindgen_export2),f=j,_=S(t,d.__wbindgen_export,d.__wbindgen_export2),y=j,M=S(r,d.__wbindgen_export,d.__wbindgen_export2),k=j;d.testengine_modify(p,this.__wbg_ptr,b,f,_,y,M,k);var l=w().getInt32(p+0,!0),u=w().getInt32(p+4,!0),m=w().getInt32(p+8,!0),s=w().getInt32(p+12,!0),c=l,g=u;if(s)throw c=0,g=0,B(m);return i=c,a=g,z(c,g)}finally{d.__wbindgen_add_to_stack_pointer(16),d.__wbindgen_export3(i,a,1)}}constructor(){const n=d.testengine_new();return this.__wbg_ptr=n,Yn.register(this,this.__wbg_ptr,this),this}get now(){return d.testengine_now(this.__wbg_ptr)}reset(){d.testengine_reset(this.__wbg_ptr)}resolveIncident(n){let t,r;try{const c=d.__wbindgen_add_to_stack_pointer(-16),g=S(n,d.__wbindgen_export,d.__wbindgen_export2),p=j;d.testengine_resolveIncident(c,this.__wbg_ptr,g,p);var i=w().getInt32(c+0,!0),a=w().getInt32(c+4,!0),l=w().getInt32(c+8,!0),u=w().getInt32(c+12,!0),m=i,s=a;if(u)throw m=0,s=0,B(l);return t=m,r=s,z(m,s)}finally{d.__wbindgen_add_to_stack_pointer(16),d.__wbindgen_export3(t,r,1)}}setVariables(n,t,r){let i,a;try{const p=d.__wbindgen_add_to_stack_pointer(-16),b=S(n,d.__wbindgen_export,d.__wbindgen_export2),f=j,_=S(t,d.__wbindgen_export,d.__wbindgen_export2),y=j;d.testengine_setVariables(p,this.__wbg_ptr,b,f,_,y,r);var l=w().getInt32(p+0,!0),u=w().getInt32(p+4,!0),m=w().getInt32(p+8,!0),s=w().getInt32(p+12,!0),c=l,g=u;if(s)throw c=0,g=0,B(m);return i=c,a=g,z(c,g)}finally{d.__wbindgen_add_to_stack_pointer(16),d.__wbindgen_export3(i,a,1)}}snapshot(){let n,t;try{const s=d.__wbindgen_add_to_stack_pointer(-16);d.testengine_snapshot(s,this.__wbg_ptr);var r=w().getInt32(s+0,!0),i=w().getInt32(s+4,!0),a=w().getInt32(s+8,!0),l=w().getInt32(s+12,!0),u=r,m=i;if(l)throw u=0,m=0,B(a);return n=u,t=m,z(u,m)}finally{d.__wbindgen_add_to_stack_pointer(16),d.__wbindgen_export3(n,t,1)}}throwError(n,t,r){let i,a;try{const p=d.__wbindgen_add_to_stack_pointer(-16),b=S(n,d.__wbindgen_export,d.__wbindgen_export2),f=j,_=S(t,d.__wbindgen_export,d.__wbindgen_export2),y=j,M=S(r,d.__wbindgen_export,d.__wbindgen_export2),k=j;d.testengine_throwError(p,this.__wbg_ptr,b,f,_,y,M,k);var l=w().getInt32(p+0,!0),u=w().getInt32(p+4,!0),m=w().getInt32(p+8,!0),s=w().getInt32(p+12,!0),c=l,g=u;if(s)throw c=0,g=0,B(m);return i=c,a=g,z(c,g)}finally{d.__wbindgen_add_to_stack_pointer(16),d.__wbindgen_export3(i,a,1)}}tickNow(n){let t,r;try{const c=d.__wbindgen_add_to_stack_pointer(-16);d.testengine_tickNow(c,this.__wbg_ptr,n);var i=w().getInt32(c+0,!0),a=w().getInt32(c+4,!0),l=w().getInt32(c+8,!0),u=w().getInt32(c+12,!0),m=i,s=a;if(u)throw m=0,s=0,B(l);return t=m,r=s,z(m,s)}finally{d.__wbindgen_add_to_stack_pointer(16),d.__wbindgen_export3(t,r,1)}}unassignUserTask(n){let t,r;try{const c=d.__wbindgen_add_to_stack_pointer(-16),g=S(n,d.__wbindgen_export,d.__wbindgen_export2),p=j;d.testengine_unassignUserTask(c,this.__wbg_ptr,g,p);var i=w().getInt32(c+0,!0),a=w().getInt32(c+4,!0),l=w().getInt32(c+8,!0),u=w().getInt32(c+12,!0),m=i,s=a;if(u)throw m=0,s=0,B(l);return t=m,r=s,z(m,s)}finally{d.__wbindgen_add_to_stack_pointer(16),d.__wbindgen_export3(t,r,1)}}updateRetries(n,t){let r,i;try{const g=d.__wbindgen_add_to_stack_pointer(-16),p=S(n,d.__wbindgen_export,d.__wbindgen_export2),b=j;d.testengine_updateRetries(g,this.__wbg_ptr,p,b,t);var a=w().getInt32(g+0,!0),l=w().getInt32(g+4,!0),u=w().getInt32(g+8,!0),m=w().getInt32(g+12,!0),s=a,c=l;if(m)throw s=0,c=0,B(u);return r=s,i=c,z(s,c)}finally{d.__wbindgen_add_to_stack_pointer(16),d.__wbindgen_export3(r,i,1)}}updateUserTask(n,t){let r,i;try{const g=d.__wbindgen_add_to_stack_pointer(-16),p=S(n,d.__wbindgen_export,d.__wbindgen_export2),b=j,f=S(t,d.__wbindgen_export,d.__wbindgen_export2),_=j;d.testengine_updateUserTask(g,this.__wbg_ptr,p,b,f,_);var a=w().getInt32(g+0,!0),l=w().getInt32(g+4,!0),u=w().getInt32(g+8,!0),m=w().getInt32(g+12,!0),s=a,c=l;if(m)throw s=0,c=0,B(u);return r=s,i=c,z(s,c)}finally{d.__wbindgen_add_to_stack_pointer(16),d.__wbindgen_export3(r,i,1)}}}Symbol.dispose&&(Nn.prototype[Symbol.dispose]=Nn.prototype.free);function zr(){return{__proto__:null,"./nanobpmn_engine_bg.js":{__proto__:null,__wbg___wbindgen_throw_bb96b2010945f0bc:function(n,t){throw new Error(z(n,t))},__wbindgen_cast_0000000000000001:function(n,t){const r=z(n,t);return Br(r)},__wbindgen_object_drop_ref:function(n){B(n)}}}}const Yn=typeof FinalizationRegistry>"u"?{register:()=>{},unregister:()=>{}}:new FinalizationRegistry(e=>d.__wbg_testengine_free(e,1));function Br(e){Qe===ve.length&&ve.push(ve.length+1);const n=Qe;return Qe=ve[n],ve[n]=e,n}function Or(e){e<1028||(ve[e]=Qe,Qe=e)}let Ce=null;function w(){return(Ce===null||Ce.buffer.detached===!0||Ce.buffer.detached===void 0&&Ce.buffer!==d.memory.buffer)&&(Ce=new DataView(d.memory.buffer)),Ce}function z(e,n){return Yr(e>>>0,n)}let Ve=null;function tn(){return(Ve===null||Ve.byteLength===0)&&(Ve=new Uint8Array(d.memory.buffer)),Ve}function Fr(e){return ve[e]}let ve=new Array(1024).fill(void 0);ve.push(void 0,null,!0,!1);let Qe=ve.length;function Ur(e){return e==null}function S(e,n,t){if(t===void 0){const u=Je.encode(e),m=n(u.length,1)>>>0;return tn().subarray(m,m+u.length).set(u),j=u.length,m}let r=e.length,i=n(r,1)>>>0;const a=tn();let l=0;for(;l<r;l++){const u=e.charCodeAt(l);if(u>127)break;a[i+l]=u}if(l!==r){l!==0&&(e=e.slice(l)),i=t(i,r,r=l+e.length*3,1)>>>0;const u=tn().subarray(i+l,i+r),m=Je.encodeInto(e,u);l+=m.written,i=t(i,r,l,1)>>>0}return j=l,i}function B(e){const n=Fr(e);return Or(e),n}let rn=new TextDecoder("utf-8",{ignoreBOM:!0,fatal:!0});rn.decode();const $r=2146435072;let un=0;function Yr(e,n){return un+=n,un>=$r&&(rn=new TextDecoder("utf-8",{ignoreBOM:!0,fatal:!0}),rn.decode(),un=n),rn.decode(tn().subarray(e,e+n))}const Je=new TextEncoder;"encodeInto"in Je||(Je.encodeInto=function(e,n){const t=Je.encode(e);return n.set(t),{read:e.length,written:t.length}});let j=0,d;function Gr(e,n){return d=e.exports,Ce=null,Ve=null,d}async function Vr(e,n){if(typeof Response=="function"&&e instanceof Response){if(!e.ok)throw new Error(`failed to fetch Wasm: ${e.status} ${e.statusText} fetching '${e.url}'`);if(typeof WebAssembly.instantiateStreaming=="function")try{return await WebAssembly.instantiateStreaming(e,n)}catch(i){if(t(e.type)&&e.headers.get("Content-Type")!=="application/wasm")console.warn("`WebAssembly.instantiateStreaming` failed because your server does not serve Wasm with `application/wasm` MIME type. Falling back to `WebAssembly.instantiate` which is slower. Original error:\n",i);else throw i}const r=await e.arrayBuffer();return await WebAssembly.instantiate(r,n)}else{const r=await WebAssembly.instantiate(e,n);return r instanceof WebAssembly.Instance?{instance:r,module:e}:r}function t(r){switch(r){case"basic":case"cors":case"default":return!0}return!1}}async function Qr(e){if(d!==void 0)return d;e!==void 0&&(Object.getPrototypeOf(e)===Object.prototype?{module_or_path:e}=e:console.warn("using deprecated parameters for the initialization function; pass a single object instead")),e===void 0&&(e=new URL("/pr-preview/pr-90/assets/nanobpmn_engine_bg-DRNrIVE8.wasm",import.meta.url));const n=zr();(typeof e=="string"||typeof Request=="function"&&e instanceof Request||typeof URL=="function"&&e instanceof URL)&&(e=fetch(e));const{instance:t,module:r}=await Vr(await e,n);return Gr(t)}let Xe=null;function Jr(e){return Xe||(Xe=Qr(void 0).then(()=>{}).catch(n=>{throw Xe=null,n})),Xe}function W(e){return JSON.parse(e)}class Hr{constructor(n){F(this,"engine");this.engine=n}deploy(n){return JSON.parse(this.engine.deploy(n))}createInstance(n,t){return W(this.engine.createInstance(n,t||"{}"))}activateJobs(n,t,r,i){return JSON.parse(this.engine.activateJobs(n,t,r,i))}completeJob(n,t){return W(this.engine.completeJob(n,t||"{}"))}completeAgentJob(n,t){const{variables:r,...i}=t??{};return W(this.engine.completeAgentJob(n,JSON.stringify(r??{}),JSON.stringify(i??{})))}failJob(n,t,r){return W(this.engine.failJob(n,t,r))}throwError(n,t,r){return W(this.engine.throwError(n,t,r))}updateRetries(n,t){return W(this.engine.updateRetries(n,t))}resolveIncident(n){return W(this.engine.resolveIncident(n))}setVariables(n,t,r){return W(this.engine.setVariables(n,t||"{}",r))}broadcastSignal(n,t){return W(this.engine.broadcastSignal(n,t||"{}"))}cancelInstance(n){return W(this.engine.cancelInstance(n))}modify(n,t,r){return W(this.engine.modify(n,JSON.stringify(t??[]),JSON.stringify(r??[])))}completeUserTask(n,t){return W(this.engine.completeUserTask(n,t||"{}"))}assignUserTask(n,t,r){return W(this.engine.assignUserTask(n,t,r))}unassignUserTask(n){return W(this.engine.unassignUserTask(n))}updateUserTask(n,t){return W(this.engine.updateUserTask(n,t||"{}"))}correlateMessage(n,t,r){return W(this.engine.correlateMessage(n,t,r||"{}"))}advanceTime(n){return W(this.engine.advanceTime(n))}reset(){this.engine.reset()}events(){return JSON.parse(this.engine.events())}snapshot(){return W(this.engine.snapshot())}free(){this.engine.free()}}async function Wr(e){return await Jr(),new Hr(new Nn)}class wt extends Error{constructor(t,r){super(t);F(this,"retries");this.name="JobFailure",this.retries=r==null?void 0:r.retries}}function Zr(e,n=[]){if(e.instances.filter(i=>!i.completed).length===0)return e.totalInstances>0?"completed":"idle";if(e.incidents.length>0)return"incidents";const r=new Set(n);return e.jobs.some(i=>!r.has(i.jobType))?"unhandledJobs":e.userTasks.some(i=>i.state==="Created")?"userTasks":e.timers.length>0?"timers":e.messageSubscriptions.length>0?"messages":e.signalSubscriptions.length>0?"signals":"idle"}function qr(e,n=[]){const t=new Set(n);return[...new Set(e.jobs.map(r=>r.jobType))].filter(r=>!t.has(r)).sort()}async function Kr(e,n,t){let r;try{const i=await n(t);r=JSON.stringify(i??{})}catch(i){const a=i instanceof wt&&i.retries!==void 0?i.retries:Math.max(0,t.retries-1),l=i instanceof Error?i.message:String(i);e.failJob(t.key,a,l);return}e.completeJob(t.key,r)}async function Xr(e,n,t){let r;try{r=await n(t),JSON.stringify(r)}catch(i){const a=i instanceof wt&&i.retries!==void 0?i.retries:Math.max(0,t.retries-1),l=i instanceof Error?i.message:String(i);e.failJob(t.key,a,l);return}e.completeAgentJob(t.key,r)}async function ei(e,n,t={}){const r=t.maxJobsPerActivation??10,i=t.lockTimeoutMs??3e4,a=t.worker??"bojtos",l=t.agents??{};for(const p of Object.keys(l))if(p in n)throw new Error(`dispatchRound: job type "${p}" is registered as both a worker and an agent — register it as exactly one`);const u=[];for(const[p,b]of Object.entries(n))for(const f of e.activateJobs(p,r,i,a))u.push({handler:b,job:f});const m=[];for(const[p,b]of Object.entries(l))for(const f of e.activateJobs(p,r,i,a))m.push({handler:b,job:f});for(const{handler:p,job:b}of u)await Kr(e,p,b);for(const{handler:p,job:b}of m)await Xr(e,p,b);const s=e.snapshot(),c=u.length+m.length;if(c>0)return{snapshot:s,handled:c};const g=[...Object.keys(n),...Object.keys(l)];return{snapshot:s,handled:c,reason:Zr(s,g),unhandled:qr(s,g)}}function ni({bpmn:e}){const n=h.useRef(null),[t,r]=h.useState("loading"),[i,a]=h.useState(null),[l,u]=h.useState([]),[m,s]=h.useState(null),c=h.useRef(e),g=h.useRef(0),p=h.useRef(new Map),b=h.useCallback((E,N)=>{p.current.set(E,N)},[]),f=h.useCallback(E=>p.current.get(E),[]),_=h.useCallback((E,N)=>{const A=E.deploy(N);return c.current=N,p.current.clear(),u(A.processIds),s(null),a(null),A.processIds},[]);h.useEffect(()=>{let E=!1;return r("loading"),u([]),s(null),a(null),Wr().then(N=>{if(E){N.free();return}try{_(N,e)}catch(A){N.free(),a(String(A)),r("error");return}n.current=N,r("ready")}).catch(N=>{E||(a(String(N)),r("error"))}),()=>{var N;E=!0,(N=n.current)==null||N.free(),n.current=null,p.current.clear()}},[e]);const y=h.useCallback(E=>{const N=n.current;if(!N)return null;try{const A=E(N);return s(A),a(null),A}catch(A){return a(String(A)),null}},[]),M=h.useCallback((E,N)=>y(A=>A.createInstance(E,N)),[y]),k=h.useCallback((E,N)=>y(A=>A.completeUserTask(E,N)),[y]),D=h.useCallback(E=>y(N=>N.advanceTime(E)),[y]);function G(E,N){const[A]=E.activateJobs(N,1,3e4,"manual-control");if(!A)throw new Error(`No waiting job of type "${N}" to resolve.`);return A}const Z=h.useCallback((E,N)=>y(A=>{const H=G(A,E);return A.completeJob(H.key,N)}),[y]),se=h.useCallback((E,N,A)=>y(H=>{const C=G(H,E);return H.throwError(C.key,N,A)}),[y]),q=h.useCallback(async(E,N)=>{const A=n.current;if(!A)return null;const H=g.current;try{const C=await ei(A,E,N);return n.current!==A||g.current!==H?null:(s(C.snapshot),a(null),C)}catch(C){return n.current!==A||g.current!==H||(s(A.snapshot()),a(String(C))),null}},[]),te=h.useCallback(()=>{const E=n.current;if(E){g.current++;try{E.reset(),_(E,c.current)}catch(N){a(String(N))}}},[_]),U=h.useCallback(E=>{const N=n.current;if(!N)return null;g.current++;try{return N.reset(),_(N,E)}catch(A){return a(String(A)),null}},[_]);return{phase:t,error:i,processIds:l,snapshot:m,createInstance:M,stepWorkers:q,completeUserTask:k,advanceTime:D,completeJobManually:Z,throwJobError:se,reset:te,redeploy:U,setRunImage:b,getRunImage:f}}function ti(e,n){return e.slice(n)}function ri(e,n,t,r){const i=e.snapshot,a="⏸ waiting for a human — complete the task below to continue",l=i.userTasks.some(u=>u.state==="Created");if(e.handled>0){const u=i.activeElementIds.map(t),m=n.length?` via ${n.map(s=>`${t(s.from)} → ${t(s.to)}`).join(", ")}`:"";return i.completedInstances>=1?{kind:"done",text:`⏭ round handled ${e.handled} job${e.handled===1?"":"s"}${m} — ✅ process instance completed`}:l?{kind:"human",text:`⏭ round handled ${e.handled} job${e.handled===1?"":"s"}${m} — ${a}`}:{kind:"step",text:`⏭ round handled ${e.handled} job${e.handled===1?"":"s"}${m} — now at ${u.length?u.join(", "):"—"}`}}switch(e.reason){case"completed":return{kind:"done",text:"✅ process instance completed"};case"userTasks":return{kind:"human",text:a};case"timers":return{kind:"step",text:"⏱ waiting on a timer — advance the clock to continue"};case"messages":return{kind:"step",text:"✉ waiting on a message — correlate it to continue"};case"signals":return{kind:"step",text:"📶 waiting on a signal — broadcast it to continue"};case"incidents":return{kind:"error",text:"A job failed — incident on the diagram"};case"unhandledJobs":{const u=e.unhandled??[];return r&&u.length>0&&u.every(m=>r.has(m))?{kind:"human",text:a}:{kind:"error",text:`⏭ waiting on job type(s) with no worker registered: ${u.join(", ")}`}}case"idle":return{kind:"step",text:"Nothing to step — no instance is running."};default:return{kind:"step",text:e.reason?`Step blocked on an unrecognized reason: ${e.reason}`:"Nothing to step — no instance is running."}}}const ii="the Scripted or Endpoint brain";async function oi(){return await We()===null}async function We(e=ii){const n=navigator.gpu;if(!n)return`This browser doesn't expose WebGPU at all. Use a recent Chrome, Edge, or Safari 17+ with hardware acceleration on, or pick ${e}.`;let t;try{t=await n.requestAdapter()}catch(r){return`WebGPU adapter request failed (${r instanceof Error?r.message:String(r)}). Try ${e} instead.`}return t?null:`This browser supports the WebGPU API, but no GPU adapter is available — hardware acceleration may be off, or this device/VM has no usable GPU. Pick ${e} instead.`}const si=[{id:"Qwen2.5-1.5B-Instruct-q4f16_1-MLC",label:"Qwen2.5 1.5B",downloadLabel:"~1.0 GB"},{id:"SmolLM2-1.7B-Instruct-q4f16_1-MLC",label:"SmolLM2 1.7B",downloadLabel:"~1.1 GB"},{id:"Llama-3.2-1B-Instruct-q4f16_1-MLC",label:"Llama 3.2 1B",downloadLabel:"~0.7 GB"},{id:"gemma-2-2b-it-q4f16_1-MLC",label:"Gemma 2 2B",downloadLabel:"~1.5 GB"},{id:"Llama-3.2-1B-Instruct-q4f32_1-MLC",label:"Llama 3.2 1B (f32, wider GPU support)",downloadLabel:"~1.1 GB"},{id:"SmolLM2-360M-Instruct-q4f32_1-MLC",label:"SmolLM2 360M (tiny, f32)",downloadLabel:"~0.6 GB"},{id:"SmolLM2-360M-Instruct-q4f16_1-MLC",label:"SmolLM2 360M (tiny)",downloadLabel:"~0.3 GB"}];function _t(e){return In.get(e)??{}}const In=new Map;async function ai(){if(In.size>0)return;const{prebuiltAppConfig:e}=await pe(async()=>{const{prebuiltAppConfig:n}=await import("./vendor-webllm-DT0Ab8E6.js");return{prebuiltAppConfig:n}},[]);for(const n of e.model_list)In.set(n.model_id,{vramRequiredMB:n.vram_required_MB,requiredFeatures:n.required_features})}const an=si.map(e=>({id:e.id,label:`${e.label} (${e.downloadLabel})`,downloadLabel:e.downloadLabel,..._t(e.id)})),Mt=an[0].id;async function li(){return await ai(),an.map(e=>({...e,..._t(e.id)}))}function vt(){const e=navigator.deviceMemory;return typeof e=="number"?e*1024:null}function ci(e,n=vt()){return n==null||e.vramRequiredMB==null||n>=e.vramRequiredMB?null:`${e.label} needs roughly ${Math.round(e.vramRequiredMB)} MB of GPU memory; this device looks like it has about ${Math.round(n)} MB available. It may still work, but expect it to fail or fall back to slow shared memory — try a smaller model (e.g. SmolLM2 360M) if it doesn't load.`}async function di(e){try{const{hasModelInCache:n}=await pe(async()=>{const{hasModelInCache:t}=await import("./vendor-webllm-DT0Ab8E6.js");return{hasModelInCache:t}},[]);return await n(e)}catch{return!1}}function on(e){return/device (was )?lost|device_hung|device_removed|already been disposed|gpudevicelostinfo/i.test(e)}function Gn(){return"The GPU device was lost — the driver reset while the model was loading or running. This is a browser/driver-level failure, not a problem with the model: fully quit and reopen the browser (a lost device usually persists for the life of the GPU process), check chrome://gpu still reports hardware acceleration, and update your GPU driver if it recurs. The Scripted and Endpoint brains don't use the GPU at all."}class en{constructor(){F(this,"kind","browser");F(this,"model",null);F(this,"engine",null);F(this,"worker",null);F(this,"generation",0);F(this,"chat",async(n,t=512,r)=>{var a,l;const i=this.engine;if(!i||!this.model)throw new Error("BrowserBrain.chat called before connect()");try{const u=await i.chat.completions.create({messages:n,temperature:0,max_tokens:t,stream:!0});let m="";for await(const s of u){const c=((l=(a=s.choices[0])==null?void 0:a.delta)==null?void 0:l.content)??"";c&&(m+=c,r==null||r(c))}return m}catch(u){const m=u instanceof Error?u.message:String(u);throw on(m)?(this.teardown(),new Error(`The in-browser model stopped: ${Gn()}`)):u}})}async connect(n=Mt,t){var m,s;const r=await We();if(r)throw new Error(r);if(this.engine&&this.model===n)return n;const i=++this.generation,a=c=>{i===this.generation&&(t==null||t({progress:c.progress??0,text:c.text??""}))};this.teardown();let l,u;try{const{CreateWebWorkerMLCEngine:c}=await pe(async()=>{const{CreateWebWorkerMLCEngine:g}=await import("./vendor-webllm-DT0Ab8E6.js");return{CreateWebWorkerMLCEngine:g}},[]);u=new Worker(new URL("/pr-preview/pr-90/assets/webllm.worker-Dc1cCqhL.js",import.meta.url),{type:"module"}),l=await c(u,n,{initProgressCallback:a})}catch(c){if(u==null||u.terminate(),i!==this.generation)throw new Error("cancelled");const g=c instanceof Error?c.message:String(c);if(on(g))throw new Error(`Couldn't load ${n} in the browser (${g}). ${Gn()}`);const p=(s=(m=an.find(b=>b.id===n))==null?void 0:m.requiredFeatures)==null?void 0:s.includes("shader-f16");throw new Error(`Couldn't load ${n} in the browser (${g}). `+(p?"This model needs WebGPU with shader-f16; try one of the f32 models in the list, or the endpoint brain.":"Try a smaller model, check your connection, or use the endpoint brain instead."))}if(i!==this.generation)throw l.unload().catch(()=>{}),u==null||u.terminate(),new Error("cancelled");return this.engine=l,this.worker=u??null,this.model=n,n}teardown(){const{engine:n,worker:t}=this;this.engine=null,this.worker=null,this.model=null,n==null||n.unload().catch(()=>{}),t==null||t.terminate()}cancelConnect(){this.generation++}dispose(){this.generation++,this.teardown()}}const xt="http://localhost:11434/v1";function Nt(){var n;const e=((n=globalThis.location)==null?void 0:n.hostname)??"";return e==="localhost"||e==="127.0.0.1"||e==="[::1]"||e==="::1"}function sn(e,n={hostname:(t=>(t=globalThis.location)==null?void 0:t.hostname)()??"",origin:(r=>(r=globalThis.location)==null?void 0:r.origin)()??""}){let i;try{i=new URL(It(e)).hostname}catch{return null}const a=l=>l==="localhost"||l==="127.0.0.1"||l==="::1"||l==="[::1]";return!a(i)||a(n.hostname)?null:`This page is served from ${n.origin||"a non-local origin"}, so it can't reach ${e}. A local model server only accepts requests from a page on localhost. Open this page at http://localhost instead, or use the Scripted or In-browser brain.`}function It(e){let n=e.trim().replace(/\/+$/,"");return n.endsWith("/chat/completions")&&(n=n.slice(0,-17)),/\/v\d+$/.test(n)||(n=`${n}/v1`),n}class Vn extends Error{constructor(n,t){super(n),this.status=t,this.name="HttpError"}}class Qn{constructor(n=xt,t="",r=""){F(this,"kind","endpoint");F(this,"baseUrl");F(this,"model",null);F(this,"models",[]);F(this,"apiKey");F(this,"requestedModel");F(this,"chat",async(n,t=512,r)=>{var s,c,g;if(!this.model)throw new Error("EndpointBrain.chat called before connect()");const i=await fetch(`${this.baseUrl}/chat/completions`,{method:"POST",headers:this.headers(),body:JSON.stringify({model:this.model,messages:n,temperature:0,max_tokens:t,stream:!0})});if(!i.ok||!i.body){const p=await i.text().catch(()=>"");throw new Error(`chat/completions HTTP ${i.status} ${i.statusText}${p?` — ${p.slice(0,300)}`:""}`)}const a=i.body.getReader(),l=new TextDecoder;let u="",m="";for(;;){const{value:p,done:b}=await a.read();if(b)break;u+=l.decode(p,{stream:!0});let f;for(;(f=u.indexOf(`
`))>=0;){const _=u.slice(0,f).trim();if(u=u.slice(f+1),!_.startsWith("data:"))continue;const y=_.slice(5).trim();if(y==="[DONE]")continue;let M;try{M=JSON.parse(y)}catch{continue}M.model&&(this.model=M.model);const k=(s=M.choices)==null?void 0:s[0],D=((c=k==null?void 0:k.delta)==null?void 0:c.content)??((g=k==null?void 0:k.message)==null?void 0:g.content)??"";D&&(m+=D,r==null||r(D))}}return m});this.baseUrl=It(n),this.apiKey=t.trim(),this.requestedModel=r.trim()}headers(){const n={"Content-Type":"application/json"};return this.apiKey&&(n.Authorization=`Bearer ${this.apiKey}`),n}async listModels(){let n;try{n=await fetch(`${this.baseUrl}/models`,{headers:this.headers()})}catch(r){const i=sn(this.baseUrl);throw new Error(i??`Can't reach ${this.baseUrl} (${r instanceof Error?r.message:String(r)}). Is the server running? For Ollama, check the app is up — and if this page is served from another origin, allow it with OLLAMA_ORIGINS.`)}if(!n.ok)throw new Vn(`${this.baseUrl}/models returned HTTP ${n.status} ${n.statusText}`,n.status);const t=await n.json();return this.models=(t.data??[]).map(r=>r.id).filter(r=>!!r),this.models}async connect(){try{const n=await this.listModels(),t=this.requestedModel||n[0];if(!t)throw new Error(`No models available at ${this.baseUrl}. Pull one first — e.g. \`ollama pull llama3.2:3b\` — or name one explicitly.`);this.model=t}catch(n){const t=n instanceof Vn&&[404,405,501].includes(n.status);if(!this.requestedModel||!t)throw n;this.models=[],this.model=this.requestedModel}return await this.validate(),this.model}async validate(){const n=await fetch(`${this.baseUrl}/chat/completions`,{method:"POST",headers:this.headers(),body:JSON.stringify({model:this.model,messages:[{role:"user",content:"Reply with ok."}],temperature:0,max_tokens:1,stream:!1})}).catch(r=>{throw new Error(`Can't reach ${this.baseUrl}/chat/completions (${r instanceof Error?r.message:String(r)}). Check the endpoint URL, API key, model name, and any local CORS settings.`)});if(!n.ok){const r=await n.text().catch(()=>"");throw new Error(`chat/completions HTTP ${n.status} ${n.statusText}${r?` — ${r.slice(0,300)}`:""}`)}const t=await n.json().catch(()=>({}));t.model&&(this.model=t.model)}dispose(){}}const ui=[{id:"onnx-community/Florence-2-base-ft",label:"Florence-2 base",downloadLabel:"~0.4 GB"},{id:"onnx-community/Florence-2-large-ft",label:"Florence-2 large (higher quality)",downloadLabel:"~1.6 GB"}],kt=ui.map(e=>({...e,label:`${e.label} (${e.downloadLabel})`})),Et=kt[0].id,mi="<OCR>",Jn="UNKNOWN (scripted brain — connect the in-browser model to read a photo)";function pi(e,n){if(e)return typeof e=="function"?e(n):e[n]}class gi{constructor(n){F(this,"kind","scripted-vision");F(this,"model",null);F(this,"read",async(n,t,r)=>{const i=typeof n=="string"?pi(this.lookup,n)??Jn:Jn;return r==null||r(i),i});this.lookup=n}dispose(){}}function hi(e){return new gi(e)}class Hn{constructor(){F(this,"kind","browser-vision");F(this,"model",null);F(this,"modelHandle",null);F(this,"processor",null);F(this,"loadImage",null);F(this,"generation",0);F(this,"read",async(n,t,r)=>{const i=this.modelHandle,a=this.processor,l=this.loadImage;if(!i||!a||!l||!this.model)throw new Error("BrowserVisionBrain.read called before connect()");const u=t&&t.startsWith("<")?t:mi,m=await l(n),s=a.construct_prompts(u),c=await a(m,s),g=await i.generate({...c,max_new_tokens:512,num_beams:1,do_sample:!1}),p=a.batch_decode(g,{skip_special_tokens:!1})[0],b=a.post_process_generation(p,u,m.size),f=bi(b,u);return r==null||r(f),f})}async connect(n=Et,t){var u,m;const r=await We("the scripted-vision fallback");if(r)throw new Error(r);if(this.modelHandle&&this.model===n)return n;const i=++this.generation,a=s=>{i===this.generation&&(t==null||t({progress:(s.progress??0)/100,text:s.file?`${s.status??"loading"} ${s.file}`:s.status??""}))};this.teardown();let l;try{const{Florence2ForConditionalGeneration:s,AutoProcessor:c,load_image:g}=await pe(async()=>{const{Florence2ForConditionalGeneration:f,AutoProcessor:_,load_image:y}=await import("./transformers.web-BJcCZOS3.js");return{Florence2ForConditionalGeneration:f,AutoProcessor:_,load_image:y}},[]),p=await s.from_pretrained(n,{dtype:"fp32",device:"webgpu",progress_callback:a}),b=await c.from_pretrained(n);l={model:p,processor:b,loadImage:g}}catch(s){if(i!==this.generation)throw new Error("cancelled");const c=s instanceof Error?s.message:String(s);throw new Error(`Couldn't load ${n} in the browser (${c}). Try the smaller Florence-2 base model, check your connection, or use the scripted-vision fallback.`)}if(i!==this.generation)throw Promise.resolve((m=(u=l.model).dispose)==null?void 0:m.call(u)).catch(()=>{}),new Error("cancelled");return this.modelHandle=l.model,this.processor=l.processor,this.loadImage=l.loadImage,this.model=n,n}teardown(){var t;const n=this.modelHandle;this.modelHandle=null,this.processor=null,this.loadImage=null,this.model=null,Promise.resolve((t=n==null?void 0:n.dispose)==null?void 0:t.call(n)).catch(()=>{})}cancelConnect(){this.generation++}dispose(){this.generation++,this.teardown()}}function bi(e,n){const t=e[n];if(typeof t=="string")return t.trim();if(t&&typeof t=="object"){const r=t.labels;return Array.isArray(r)?r.join(" ").trim():JSON.stringify(t)}return""}async function fi(){return await oi()?"browser":Nt()?"endpoint":"scripted"}function yi(){const[e,n]=h.useState("scripted"),t=h.useRef(!1),[r,i]=h.useState("idle"),[a,l]=h.useState(null),[u,m]=h.useState(null),[s,c]=h.useState(null),[g,p]=h.useState(null),[b,f]=h.useState(null),[_,y]=h.useState(null),[M,k]=h.useState(Mt),[D,G]=h.useState(xt),[Z,se]=h.useState(""),[q,te]=h.useState([]),[U,E]=h.useState("idle"),[N,A]=h.useState(null),[H,C]=h.useState(""),[ge,K]=h.useState(null),X=h.useRef(null),[Ue,Ne]=h.useState("scripted-vision"),[De,ye]=h.useState("idle"),[ln,Ie]=h.useState(null),[ke,ue]=h.useState(Et),[Ee,Te]=h.useState(null),[$e,we]=h.useState(null),[Le,Ye]=h.useState(null),[$,re]=h.useState(null),Y=h.useRef(null),he=h.useRef(!1),Pe=h.useCallback(I=>async(...L)=>{try{return await I.chat(...L)}catch(P){const me=P instanceof Error?P.message:String(P);throw I instanceof en&&on(me)&&(K(null),m(null),i("error"),l(me)),P}},[]),ae=h.useCallback(I=>async(...L)=>{try{return await I.read(...L)}catch(P){const me=P instanceof Error?P.message:String(P);throw on(me)&&(re(null),Te(null),ye("error"),Ie(me)),P}},[]);h.useEffect(()=>{We().then(I=>{f(I),p(I===null),t.current||(t.current=!0,fi().then(n))}),We("the scripted-vision fallback").then(I=>{Ye(I),he.current||(he.current=!0,Ne(I===null?"browser-vision":"scripted-vision"))})},[]),h.useEffect(()=>{let I=!1;return y(null),di(M).then(L=>{I||y(L)}),()=>{I=!0}},[M]),h.useEffect(()=>()=>{var I;return(I=X.current)==null?void 0:I.dispose()},[]),h.useEffect(()=>()=>{var I;return(I=Y.current)==null?void 0:I.dispose()},[]);const Re=h.useCallback(I=>{n(I),i("idle"),l(null),m(null),c(null),K(null)},[]),ze=h.useCallback(I=>{var L,P;he.current=!0,(L=Y.current)==null||L.cancelConnect(),(P=Y.current)==null||P.dispose(),Y.current=null,Ne(I),ye("idle"),Ie(null),Te(null),we(null),re(null)},[]),je=h.useCallback(()=>{var I;(I=X.current)==null||I.dispose(),X.current=null,K(null),m(null)},[]),Be=h.useCallback(()=>{X.current instanceof en&&X.current.cancelConnect(),je(),i("idle"),c(null),l(null)},[je]),Se=h.useCallback(async()=>{const I=sn(D);if(I){te([]),E("error"),A(I);return}E("loading"),A(null);const L=new Qn(D,H);try{const P=await L.listModels();te(P),E("ready"),se(me=>me&&P.includes(me)?me:P[0]??"")}catch(P){te([]),se(""),E("error"),A(P instanceof Error?P.message:String(P))}finally{L.dispose()}},[D,H]),Ze=h.useCallback(async()=>{var I;if(e==="scripted"){K(null),i("ready");return}if(e==="endpoint"){const L=sn(D);if(L){je(),l(L),i("error");return}}i("connecting"),l(null),c(null);try{if(e==="browser"){const L=X.current instanceof en?X.current:new en;X.current&&X.current!==L&&X.current.dispose(),X.current=L;const P=await L.connect(M,c);m(P),K(()=>Pe(L)),y(!0)}else{(I=X.current)==null||I.dispose();const L=new Qn(D,H,Z);X.current=L;const P=await L.connect();m(P),K(()=>Pe(L))}i("ready")}catch(L){const P=L instanceof Error?L.message:String(L);if(P==="cancelled")return;l(P),i("error"),K(null)}finally{c(null)}},[e,M,D,Z,H,je,Pe]),Oe=h.useCallback(()=>{var I;(I=Y.current)==null||I.dispose(),Y.current=null,re(null),Te(null)},[]),cn=h.useCallback(()=>{var I;(I=Y.current)==null||I.cancelConnect(),Oe(),ye("idle"),we(null),Ie(null)},[Oe]),dn=h.useCallback(async()=>{if(Ue==="scripted-vision"){Oe(),ye("ready"),Ie(null);return}ye("connecting"),Ie(null),we(null);try{const I=Y.current instanceof Hn?Y.current:new Hn;Y.current&&Y.current!==I&&Y.current.dispose(),Y.current=I;const L=await I.connect(ke,we);Te(L),re(()=>ae(I)),ye("ready")}catch(I){const L=I instanceof Error?I.message:String(I);if(L==="cancelled")return;Ie(L),ye("error"),re(null),Te(null)}finally{we(null)}},[Ue,ke,Oe,ae]);return{kind:e,setKind:Re,status:r,error:a,modelInUse:u,progress:s,webgpu:g,webgpuReason:b,browserModelCached:_,cancelConnect:Be,browserModel:M,setBrowserModel:k,endpointUrl:D,setEndpointUrl:G,endpointModel:Z,setEndpointModel:se,endpointModels:q,endpointModelsStatus:U,endpointModelsError:N,listEndpointModels:Se,apiKey:H,setApiKey:C,connect:Ze,chat:ge,visionKind:Ue,setVisionKind:ze,visionStatus:De,visionError:ln,visionModel:ke,setVisionModel:ue,visionModelInUse:Ee,visionProgress:$e,visionWebgpuReason:Le,connectVision:dn,cancelVisionConnect:cn,vision:$}}const kn="#s=",wi=["scripted","browser","endpoint"];function _i(e){return typeof e=="string"&&wi.includes(e)}function Mi(e){try{const n=JSON.parse(e);if(n&&typeof n=="object"){const t=n,r={};return _i(t.brain)&&(r.brain=t.brain),r}}catch{}return{}}function Tt(e=location.hash){if(!e.startsWith(kn))return{};let n;try{n=decodeURIComponent(e.slice(kn.length))}catch{return{}}return Mi(n)}function vi(e){const n=Object.entries(e).filter(([,t])=>t!==void 0);return n.length===0?"":kn+encodeURIComponent(JSON.stringify(Object.fromEntries(n)))}function xi(e){const n={...Tt(),...e},t=vi(n),r=new URL(location.href);r.hash=t,history.replaceState(history.state,"",r)}const Wn=[{kind:"scripted",label:"Scripted",hint:"No model. The example's stand-in decides — deterministic and offline."},{kind:"browser",label:"In-browser (WebGPU)",hint:"A small quantised model on your GPU. First run downloads weights."},{kind:"endpoint",label:"API endpoint",hint:"Any OpenAI-compatible server. Ollama by default. Local pages only."}],Zn=[{kind:"scripted-vision",label:"Scripted",hint:"No model. The example's known plate is returned — deterministic and offline."},{kind:"browser-vision",label:"In-browser (WebGPU)",hint:"Reads the photo with a vision model on your GPU. First run downloads weights."}];function Ni({brain:e,showText:n=!0,showVision:t=!1}){return o.jsxs("div",{className:"brain",children:[n&&o.jsx(Ii,{brain:e}),n&&t&&o.jsx("hr",{className:"brain-divider"}),t&&o.jsx(ki,{brain:e})]})}function Ii({brain:e}){const n=Wn.find(b=>b.kind===e.kind),t=sn(e.endpointUrl),r=Nt(),[i,a]=h.useState(an);h.useEffect(()=>{li().then(a)},[]);const{kind:l,endpointUrl:u,apiKey:m,listEndpointModels:s}=e;h.useEffect(()=>{if(l!=="endpoint"||t)return;const b=setTimeout(()=>void s(),400);return()=>clearTimeout(b)},[l,u,m,t,s]);const c=i.find(b=>b.id===e.browserModel),g=c?ci(c,vt()):null,p=e.webgpu===!0?"browser":r&&e.webgpu===!1?"endpoint":null;return o.jsxs("div",{className:"brain-section",children:[o.jsxs("div",{className:"brain-kinds",children:[Wn.map(b=>o.jsxs(Q,{size:"sm",variant:e.kind===b.kind?"default":"secondary",onClick:()=>e.setKind(b.kind),children:[b.label,b.kind===p&&o.jsx(J,{variant:"info",className:"brain-recommended-badge",children:"recommended"})]},b.kind)),e.status==="ready"&&e.kind!=="scripted"&&o.jsx(J,{variant:"success",children:e.modelInUse??"connected"}),e.status==="connecting"&&o.jsx(J,{variant:"info",children:"connecting…"}),e.status==="error"&&o.jsx(J,{variant:"danger",children:"not connected"})]}),o.jsx("p",{className:"field-hint",children:n.hint}),e.kind==="browser"&&o.jsxs("div",{className:"brain-config",children:[o.jsxs("div",{className:"field",children:[o.jsx(Fe,{htmlFor:"browser-model",children:"Model"}),o.jsxs(fn,{value:e.browserModel,onValueChange:e.setBrowserModel,disabled:e.status==="connecting",children:[o.jsx(yn,{id:"browser-model",children:o.jsx(wn,{})}),o.jsx(_n,{children:i.map(b=>o.jsx(Mn,{value:b.id,children:b.label},b.id))})]}),e.browserModelCached===!0&&o.jsx("p",{className:"field-hint",children:"Already downloaded in this browser — connecting will be fast."}),e.browserModelCached===!1&&o.jsx("p",{className:"field-hint",children:"Not downloaded yet — connecting fetches the weights once, then caches them for next time."})]}),e.webgpu===!1&&e.webgpuReason&&o.jsxs(le,{variant:"destructive",children:[o.jsx(ce,{children:"No WebGPU in this browser"}),o.jsx(de,{children:e.webgpuReason})]}),e.webgpu!==!1&&g&&o.jsxs(le,{variant:"destructive",children:[o.jsx(ce,{children:"This model may not fit in GPU memory"}),o.jsx(de,{children:g})]})]}),e.kind==="endpoint"&&o.jsxs("div",{className:"brain-config",children:[o.jsxs("div",{className:"field",children:[o.jsx(Fe,{htmlFor:"endpoint-url",children:"Endpoint"}),o.jsx(Pn,{id:"endpoint-url",value:e.endpointUrl,onChange:b=>e.setEndpointUrl(b.target.value),disabled:e.status==="connecting"}),o.jsxs("p",{className:"field-hint",children:["Ollama allows ",o.jsx("code",{children:"localhost"})," origins out of the box; set"," ",o.jsx("code",{children:"OLLAMA_ORIGINS"})," only when serving this page from another host. Best for local development — a hosted copy of this page can't reach a server on your machine at all."]}),t&&o.jsxs(le,{variant:"destructive",children:[o.jsx(ce,{children:"A local server won't work from this URL"}),o.jsx(de,{children:t})]})]}),o.jsxs("div",{className:"field",children:[o.jsx(Fe,{htmlFor:"endpoint-model",children:"Model"}),o.jsxs("div",{className:"endpoint-model-row",children:[o.jsxs(fn,{value:e.endpointModel,onValueChange:e.setEndpointModel,disabled:e.status==="connecting"||e.endpointModelsStatus==="loading"||e.endpointModels.length===0,children:[o.jsx(yn,{id:"endpoint-model",className:"endpoint-model-select",children:o.jsx(wn,{placeholder:e.endpointModelsStatus==="loading"?"Loading models…":e.endpointModelsStatus==="error"?"No models — check the endpoint":e.endpointModels.length===0?"No models served":"Select a model"})}),o.jsx(_n,{children:e.endpointModels.map(b=>o.jsx(Mn,{value:b,children:b},b))})]}),o.jsx(Q,{size:"sm",variant:"secondary",onClick:()=>void e.listEndpointModels(),disabled:e.status==="connecting"||e.endpointModelsStatus==="loading"||t!==null,children:e.endpointModelsStatus==="loading"?"Refreshing…":"Refresh"})]}),o.jsxs("p",{className:"field-hint",children:["Fetched from the endpoint's ",o.jsx("code",{children:"/models"}),". Tiny models (e.g. SmolLM2) usually can't follow the tool-calling format — prefer ",o.jsx("code",{children:"llama3.2:3b"}),", ",o.jsx("code",{children:"qwen2.5"})," or larger."]}),e.endpointModelsStatus==="error"&&!t&&o.jsxs(le,{variant:"destructive",children:[o.jsx(ce,{children:"Couldn't list models"}),o.jsx(de,{children:e.endpointModelsError})]})]}),o.jsxs("div",{className:"field",children:[o.jsx(Fe,{htmlFor:"endpoint-key",children:"API key (optional)"}),o.jsx(Pn,{id:"endpoint-key",type:"password",value:e.apiKey,onChange:b=>e.setApiKey(b.target.value),disabled:e.status==="connecting"})]})]}),e.kind!=="scripted"&&o.jsxs("div",{className:"brain-actions",children:[o.jsx(Q,{size:"sm",onClick:()=>void e.connect(),disabled:e.status==="connecting"||e.kind==="endpoint"&&e.endpointModel==="",children:e.status==="ready"?"Reconnect":"Connect"}),e.status==="connecting"&&e.kind==="browser"&&o.jsx(Q,{size:"sm",variant:"secondary",onClick:e.cancelConnect,children:"Cancel"}),e.progress&&o.jsxs("span",{className:"field-hint",children:[Math.round(e.progress.progress*100),"% —"," ",e.progress.text]})]}),e.error&&o.jsxs(le,{variant:"destructive",children:[o.jsx(ce,{children:"Couldn't connect"}),o.jsx(de,{children:e.error})]})]})}function ki({brain:e}){const n=Zn.find(r=>r.kind===e.visionKind),t=e.webgpu===!0?"browser-vision":null;return o.jsxs("div",{className:"brain-section brain-vision",children:[o.jsx(Fe,{children:"Vision (reads the image)"}),o.jsxs("div",{className:"brain-kinds",children:[Zn.map(r=>o.jsxs(Q,{size:"sm",variant:e.visionKind===r.kind?"default":"secondary",onClick:()=>e.setVisionKind(r.kind),children:[r.label,r.kind===t&&o.jsx(J,{variant:"info",className:"brain-recommended-badge",children:"recommended"})]},r.kind)),e.visionStatus==="ready"&&e.visionKind==="browser-vision"&&o.jsx(J,{variant:"success",children:e.visionModelInUse??"connected"}),e.visionStatus==="connecting"&&o.jsx(J,{variant:"info",children:"connecting…"}),e.visionStatus==="error"&&o.jsx(J,{variant:"danger",children:"not connected"})]}),o.jsx("p",{className:"field-hint",children:n.hint}),e.visionKind==="scripted-vision"&&e.webgpu===!1&&e.visionWebgpuReason&&o.jsxs(le,{variant:"destructive",children:[o.jsx(ce,{children:"No WebGPU in this browser"}),o.jsx(de,{children:e.visionWebgpuReason})]}),e.visionKind==="browser-vision"&&o.jsxs("div",{className:"brain-config",children:[o.jsxs("div",{className:"field",children:[o.jsx(Fe,{htmlFor:"vision-model",children:"Model"}),o.jsxs(fn,{value:e.visionModel,onValueChange:e.setVisionModel,disabled:e.visionStatus==="connecting",children:[o.jsx(yn,{id:"vision-model",children:o.jsx(wn,{})}),o.jsx(_n,{children:kt.map(r=>o.jsx(Mn,{value:r.id,children:r.label},r.id))})]}),o.jsx("p",{className:"field-hint",children:"Connecting downloads the weights once (size shown above), then caches them — every token is read on your GPU, no server."})]}),e.webgpu===!1&&e.visionWebgpuReason&&o.jsxs(le,{variant:"destructive",children:[o.jsx(ce,{children:"No WebGPU in this browser"}),o.jsx(de,{children:e.visionWebgpuReason})]})]}),e.visionKind==="browser-vision"&&o.jsxs("div",{className:"brain-actions",children:[o.jsx(Q,{size:"sm",onClick:()=>void e.connectVision(),disabled:e.visionStatus==="connecting",children:e.visionStatus==="ready"?"Reconnect":"Connect"}),e.visionStatus==="connecting"&&o.jsx(Q,{size:"sm",variant:"secondary",onClick:e.cancelVisionConnect,children:"Cancel"}),e.visionProgress&&o.jsxs("span",{className:"field-hint",children:[Math.round(e.visionProgress.progress*100),"% —"," ",e.visionProgress.text]})]}),e.visionError&&o.jsxs(le,{variant:"destructive",children:[o.jsx(ce,{children:"Couldn't connect the vision brain"}),o.jsx(de,{children:e.visionError})]})]})}function Ei({imageInput:e,value:n,onSelect:t,disabled:r=!1}){const[i,a]=h.useState(null),[l,u]=h.useState(!1),m=h.useRef(null),s=h.useId(),c=h.useId(),g=h.useCallback(f=>{a(URL.createObjectURL(f)),t({imageName:f.name,pixels:f})},[t]);h.useEffect(()=>{if(i)return()=>URL.revokeObjectURL(i)},[i]);const p=h.useCallback(f=>{const _=f==null?void 0:f[0];_&&_.type.startsWith("image/")&&g(_)},[g]),b=(n==null?void 0:n.imageId)!=null?e.seedImages.find(f=>f.id===n.imageId):void 0;return o.jsxs("div",{className:"image-input",children:[e.label&&o.jsx("p",{className:"field-hint",children:e.label}),o.jsx("p",{className:"image-input-label",id:s,children:"Seed photos"}),o.jsx("div",{className:"image-gallery",role:"group","aria-labelledby":s,children:e.seedImages.map(f=>{const _=(n==null?void 0:n.imageId)===f.id;return o.jsxs("button",{type:"button","aria-pressed":_,className:`image-thumb${_?" image-thumb--selected":""}`,disabled:r,title:f.label??f.id,onClick:()=>{a(null),m.current&&(m.current.value=""),t({imageId:f.id,pixels:f.file})},children:[o.jsx("img",{src:f.thumb??f.file,alt:f.label??f.id}),f.label&&o.jsx("span",{children:f.label})]},f.id)})}),o.jsx("label",{className:"image-input-label",htmlFor:c,children:"Or upload your own photo"}),o.jsxs("div",{className:`image-drop${l?" image-drop--over":""}`,onDragOver:f=>{f.preventDefault(),r||u(!0)},onDragLeave:()=>u(!1),onDrop:f=>{f.preventDefault(),u(!1),r||p(f.dataTransfer.files)},children:[o.jsx("input",{ref:m,id:c,type:"file",accept:"image/*",disabled:r,onChange:f=>p(f.target.files)}),o.jsx("p",{className:"field-hint",children:"Drag a photo here, or pick one. Uploading a photo the model has never seen is the proof this runs for real — nothing leaves your browser."})]}),(i||b)&&o.jsxs("div",{className:"image-preview",children:[o.jsx("img",{src:i??(b==null?void 0:b.file),alt:i?(n==null?void 0:n.imageName)??"uploaded photo":(b==null?void 0:b.label)??(b==null?void 0:b.id)??"selected photo"}),o.jsx("span",{className:"field-hint",children:i?`Uploaded: ${(n==null?void 0:n.imageName)??"your photo"}`:`Selected: ${(b==null?void 0:b.label)??(b==null?void 0:b.id)}`}),o.jsx("button",{type:"button",className:"image-clear-btn",disabled:r,onClick:()=>{a(null),m.current&&(m.current.value=""),t(null)},children:"Clear"})]})]})}function jt(e){return typeof e=="object"&&e!==null}function fa(e){const n=new Set,t=r=>{jt(r)&&(typeof r.key=="string"&&n.add(r.key),Array.isArray(r.components)&&r.components.forEach(t))};return t(e),n}function Ti(e){const n={},t=r=>{jt(r)&&(typeof r.key=="string"&&"defaultValue"in r&&(n[r.key]=r.defaultValue??""),Array.isArray(r.components)&&r.components.forEach(t))};return t(e),n}const ji="wdf:section:";function St(e){return ji+e}function qn(e){try{const n=window.localStorage.getItem(St(e));return n==="1"?!0:n==="0"?!1:void 0}catch{return}}function Si(e,n){try{window.localStorage.setItem(St(e),n?"1":"0")}catch{}}function Ai(e,n=!0){const[t,r]=h.useState(()=>qn(e)??n);h.useEffect(()=>{r(qn(e)??n)},[e,n]);const i=h.useCallback(a=>{r(a),Si(e,a)},[e]);return[t,i]}function Me({sectionId:e,title:n,description:t,defaultOpen:r=!0,className:i,children:a,...l}){const[u,m]=Ai(e,r);return o.jsx(zt,{className:["panel",i].filter(Boolean).join(" "),"data-tour":l["data-tour"],children:o.jsxs(Bt,{open:u,onOpenChange:m,children:[o.jsxs(Ot,{className:"panel-trigger",children:[o.jsxs("span",{className:"panel-trigger-text",children:[o.jsx("span",{className:"panel-title",children:n}),t!=null&&o.jsx("span",{className:"panel-desc",children:t})]}),o.jsx(Ft,{className:"panel-chevron","aria-hidden":!0})]}),o.jsx(Ut,{children:o.jsx($t,{children:a})})]})})}function Ci(e){return e.entries!==void 0}function Di(e){const n=[];let t=null;for(const r of e)r.turn!==void 0?t&&t.turn===r.turn?t.entries.push(r):(t={turn:r.turn,entries:[r]},n.push(t)):(t=null,n.push(r));return n}function Kn(e){if(e===void 0)return"undefined";try{return JSON.stringify(e)}catch{return"[unserializable value]"}}function Li({activation:e,result:n,labelFor:t}){const r=e.elementId??"";return o.jsxs("div",{className:"timeline-tool",children:[o.jsxs("div",{className:"timeline-tool-head",children:[o.jsx(J,{variant:"info",children:"tool"}),o.jsx("strong",{children:t(r)||r}),o.jsx("code",{children:r})]}),e.args!==void 0&&Object.keys(e.args).length>0&&o.jsxs("div",{className:"timeline-kv",children:[o.jsx("span",{className:"timeline-kv-label",children:"arguments"}),o.jsx("code",{children:Kn(e.args)})]}),o.jsxs("div",{className:"timeline-kv",children:[o.jsx("span",{className:"timeline-kv-label",children:"returned"}),o.jsx("code",{children:n?Kn(n.result):"— waiting for the job to complete —"})]})]})}function Pi({group:e,labelFor:n}){const t=e.entries.find(s=>s.kind==="llm"),r=e.entries.filter(s=>s.kind==="agent"&&s.elementId),i=e.entries.filter(s=>s.kind==="vars"&&s.elementId),a=e.entries.filter(s=>s.kind==="agent"&&!s.elementId),l=e.entries.filter(s=>s.kind==="error"),u=new Set(r.map(s=>s.elementId)),m=e.entries.filter(s=>s.kind==="tool"||s.kind==="vars"&&s.elementId&&!u.has(s.elementId)).sort((s,c)=>s.id-c.id);return o.jsxs("div",{className:"timeline-turn",children:[o.jsxs("div",{className:"timeline-turn-head",children:[o.jsxs(J,{variant:t!=null&&t.pending?"warning":"neutral",children:["Turn ",e.turn]}),(t==null?void 0:t.pending)&&o.jsx("span",{className:"timeline-pending",children:"thinking…"})]}),t&&o.jsx("blockquote",{className:"timeline-reply",children:t.text}),a.map(s=>o.jsx("div",{className:"timeline-note",children:s.text},s.id)),r.map(s=>o.jsx(Li,{activation:s,result:i.find(c=>c.elementId===s.elementId),labelFor:n},s.id)),m.map(s=>o.jsxs("div",{className:`log-line log-${s.kind}`,children:[s.pending?"⏳ ":"",s.text]},s.id)),l.map(s=>o.jsxs("div",{className:"timeline-error",children:["⚠ ",s.text]},s.id))]})}function Ri({log:e,elementStats:n=[],incidents:t=[],labelFor:r=i=>i}){const i=h.useMemo(()=>Di(e),[e]),[a,l]=h.useState(!1),u=h.useRef(null);h.useEffect(()=>{const s=u.current;s&&(s.scrollTop=s.scrollHeight)},[i]);const m=()=>{var g;const s={log:e.map(({id:p,...b})=>b),elementStats:n,incidents:t},c=JSON.stringify(s,null,2);(g=navigator.clipboard)!=null&&g.writeText&&navigator.clipboard.writeText(c).then(()=>{l(!0),setTimeout(()=>l(!1),1500)}).catch(()=>{})};return o.jsxs(Me,{sectionId:"activity",className:"grow",title:"Activity",description:"Agent turns, model replies, and tool calls — read top to bottom as a story.",children:[o.jsx("div",{className:"timeline-toolbar",children:o.jsx(Q,{variant:"secondary",size:"sm",onClick:m,children:a?"Copied!":"Copy run as JSON"})}),o.jsx("div",{className:"timeline",ref:u,children:i.length===0?o.jsx("div",{className:"log-empty",children:"Press Run or Step to start."}):i.map(s=>Ci(s)?o.jsx(Pi,{group:s,labelFor:r},`turn-${s.turn}-${s.entries[0].id}`):o.jsxs("div",{className:`log-line log-${s.kind}`,children:[s.pending?"⏳ ":"",s.text]},s.id))}),(n.length>0||t.length>0)&&o.jsxs("div",{className:"timeline-engine-view",children:[n.length>0&&o.jsxs("div",{className:"timeline-stats",children:[o.jsx("span",{className:"timeline-kv-label",children:"Element completion"}),o.jsx("ul",{children:n.filter(s=>s.completed>0||(s.active??0)>0).map(s=>o.jsxs("li",{children:[o.jsx("code",{children:r(s.elementId)||s.elementId})," ","completed ",s.completed,s.active?`, ${s.active} active`:""]},s.elementId))})]}),t.length>0&&o.jsxs("div",{className:"timeline-incidents",children:[o.jsx("span",{className:"timeline-kv-label",children:"Incidents"}),o.jsx("ul",{children:t.map((s,c)=>o.jsxs("li",{children:[o.jsx("code",{children:r(s.elementId)||s.elementId})," —"," ",s.reason]},`${s.elementId}-${c}`))})]})]})]})}const _e={diagram:"diagram",runButton:"run-button",variablesPanel:"variables-panel",codePanel:"code-panel",brainPanel:"brain-panel"};function Xn(e){return`[data-tour="${e}"]`}function zi(e=location.search){return new URLSearchParams(e).get("tour")}function Bi(e,n){var t;return((t=e.elementStats.find(r=>r.elementId===n))==null?void 0:t.completed)??0}function Oi(e,n){return!e||e.kind==="click"||!n?!1:e.kind==="activeElement"?n.activeElementIds.includes(e.elementId):Bi(n,e.elementId)>=(e.atLeast??1)}function Fi(e){return"anchor"in e?Xn(e.anchor):`${Xn(_e.diagram)} [data-element-id="${Ui(e.elementId)}"]`}function Ui(e){return typeof CSS<"u"&&typeof CSS.escape=="function"?CSS.escape(e):e.replace(/[^a-zA-Z0-9_-]/g,n=>`\\${n}`)}function $i(e){return e.map(n=>{const t=!!n.waitFor&&n.waitFor.kind!=="click";return{element:Fi(n.target),popover:{title:n.title,description:t?`${n.description} (continues automatically once you reach that point — or use Next to skip ahead)`:n.description,showButtons:["next","previous","close"]},disableActiveInteraction:!1,skipMissingElement:n.skipMissingElement??!0}})}async function Yi(e,n={}){var a;const[{driver:t}]=await Promise.all([pe(()=>import("./driver.js-bj_ppY-Q.js"),[]),pe(()=>Promise.resolve({}),__vite__mapDeps([0]))]),r=$i(e),i=t({steps:r,showProgress:!0,allowClose:!0,skipMissingElement:!0,onHighlighted:(l,u,{index:m})=>{var s;m!==void 0&&((s=n.onIndexChange)==null||s.call(n,m))},onDestroyed:()=>{var l;(l=n.onDestroyed)==null||l.call(n)}});return i.drive(),(a=n.onIndexChange)==null||a.call(n,i.getActiveIndex()??0),{moveNext:()=>i.moveNext(),activeIndex:()=>i.getActiveIndex()??-1,destroy:()=>i.destroy()}}const Gi=300;function Vi(e,n){const[t,r]=h.useState(!1),i=h.useRef(null),a=h.useRef(0),l=h.useRef(-1),u=h.useRef(null),m=h.useRef(n);h.useEffect(()=>{m.current=n},[n]);const s=h.useCallback(()=>{u.current!==null&&(clearInterval(u.current),u.current=null)},[]),c=h.useRef(0),g=h.useCallback(()=>{var b;c.current+=1,s(),(b=i.current)==null||b.destroy(),i.current=null,r(!1)},[s]),p=h.useCallback(()=>{if(!e||e.steps.length===0||i.current)return;const b=c.current+=1;Yi(e.steps,{onIndexChange:f=>{a.current=f},onDestroyed:()=>{s(),i.current=null,r(!1)}}).then(f=>{if(b!==c.current){f.destroy();return}i.current=f,r(!0),u.current=setInterval(()=>{const _=a.current;if(_===l.current)return;const y=e.steps[_];y&&Oi(y.waitFor,m.current())&&(l.current=_,f.moveNext())},Gi)})},[e,s]);return h.useEffect(()=>g,[g]),{active:t,start:p,stop:g}}const mn=650,pn="__agent__",et="__model__",nt="__template__:",Qi=h.lazy(async()=>{await Promise.all([pe(()=>Promise.resolve({}),__vite__mapDeps([1])),pe(()=>Promise.resolve({}),__vite__mapDeps([2]))]);const{RuntimeDiagram:e}=await pe(async()=>{const{RuntimeDiagram:n}=await import("./RuntimeDiagram-B2IYfHo7.js");return{RuntimeDiagram:n}},__vite__mapDeps([3,4,5]));return{default:e}}),gn=h.lazy(()=>pe(()=>import("./MonacoEditor-8UugpDpm.js").then(e=>e.M),__vite__mapDeps([6,4,7]))),Ji=h.lazy(()=>pe(()=>import("./vendor-modeler-BlMG6Goy.js"),__vite__mapDeps([8,4,5,9,10,11,12,1,2]))),tt=h.lazy(async()=>{const{FormRenderer:e}=await pe(async()=>{const{FormRenderer:n}=await import("./FormRenderer-Cjy4CRy1.js");return{FormRenderer:n}},__vite__mapDeps([13,4,11,9,10,14]));return{default:e}});function hn(e,n){try{return JSON.stringify(e??{},null,n)}catch{return"[unserializable value]"}}function Hi({example:e,initialBrainKind:n,initialTourId:t}){var P,me,jn,Sn,An,Cn,Dn,Ln;const[r,i]=h.useState(e.bpmn),a=yi(),[l,u]=h.useState(null);h.useEffect(()=>{n&&n!==a.kind&&a.setKind(n)},[]),h.useEffect(()=>{xi({brain:a.kind})},[a.kind]);const[m,s]=h.useState(()=>Object.fromEntries(e.handlers.map(v=>[v.elementId,v.source]))),[c,g]=h.useState(e.scriptedAgent??""),[p,b]=h.useState(()=>He(e.templates)),f=h.useMemo(()=>Er(e,m,r,p),[e,m,r,p]),_=f.model,y=ni({bpmn:f.resolvedBpmn}),M=Vi(e.tour,()=>y.snapshot);h.useEffect(()=>{var v;t&&((v=e.tour)==null?void 0:v.id)===t&&M.start()},[]);const k=_.startFormId?((P=e.forms)==null?void 0:P[_.startFormId])??null:null,[D,G]=h.useState(()=>({...e.seed,...k?Ti(k):{}})),[Z,se]=h.useState(_.agent?pn:((me=e.handlers[0])==null?void 0:me.elementId)??""),[q,te]=h.useState(!1),[U,E]=h.useState(!1),[N,A]=h.useState(null),[H,C]=h.useState([]),[ge,K]=h.useState({}),[X,Ue]=h.useState(!1),Ne=h.useRef(null),[De,ye]=h.useState({}),[ln,Ie]=h.useState(!1),ke=h.useRef(null),ue=h.useRef(!1),Ee=h.useRef(0),Te=h.useRef(0),$e=h.useRef({current:void 0}),we=h.useRef({}),Le=h.useRef({}),Ye=h.useMemo(()=>{const v=new Map;for(const x of _.processes){for(const T of x.tasks)v.set(T.elementId,T.label);for(const T of x.agents){v.set(T.elementId,T.label);for(const R of T.tools)v.set(R.elementId,R.label)}for(const T of x.userTasks)v.set(T.elementId,T.label)}return x=>v.get(x)??x},[_]),$=h.useCallback(v=>{C(x=>{if(v.key){const T=x.findIndex(R=>R.key===v.key);if(T>=0){const R=[...x];return R[T]={...R[T],...v},R}}return[...x,{...v,id:Te.current++}].slice(-80)})},[]),re=h.useMemo(()=>{var v;return((v=y.snapshot)==null?void 0:v.userTasks.find(x=>x.state==="Created"))??null},[y.snapshot]),Y=h.useMemo(()=>{const v=_.processes.flatMap(T=>T.tasks),x=new Map;for(const T of e.handlers){if(!T.manualControl)continue;const R=v.find(O=>O.elementId===T.elementId);R&&x.set(R.jobType,{...T.manualControl,elementId:T.elementId})}return x},[e.handlers,_]),he=h.useMemo(()=>{if(!y.snapshot)return null;for(const v of y.snapshot.jobs){const x=Y.get(v.jobType);if(x&&v.state==="Created")return{job:v,control:x}}return null},[y.snapshot,Y]),Pe=h.useMemo(()=>{if(!_.agent||!y.snapshot)return[];const v=new Map(y.snapshot.elementStats.map(x=>[x.elementId,x.completed]));return _.agent.tools.filter(x=>(v.get(x.elementId)??0)===0)},[_.agent,y.snapshot]),ae=re?_.userTasks.find(v=>v.elementId===re.elementId):void 0,Re=ae!=null&&ae.formId?((jn=e.forms)==null?void 0:jn[ae.formId])??null:null,ze=h.useCallback(async(v,x,T,R)=>{var be;let O=T,ee=0;for(;Ee.current===R&&O&&O.completedInstances<1&&ee++<80;){const V=await y.stepWorkers(v,{agents:x});if(Ee.current!==R)return O;O=(V==null?void 0:V.snapshot)??O;const ne=(be=O.instances[0])==null?void 0:be.variables;if(ne&&K({...ne}),O.userTasks.some(ie=>ie.state==="Created")){$({kind:"human",text:"⏸ waiting for a human — complete the task below to continue"});break}if(!V){$({kind:"error",text:"▶ run stopped — no dispatch round was returned"});break}if(V.handled===0)break;await new Promise(ie=>setTimeout(ie,mn))}return O&&O.completedInstances>=1?$({kind:"done",text:"✅ process instance completed"}):O&&O.incidentElementIds.length>0&&$({kind:"error",text:"A job failed — incident on the diagram"}),O},[y,$]),je=h.useCallback(async v=>{var O,ee,be;if(!he||ue.current)return;const{job:x,control:T}=he,R=++Ee.current;ue.current=!0,te(!0);try{let V,ne;if(v==="complete")V=y.completeJobManually(x.jobType,"{}"),ne="  ↳ completed normally";else if(T.action.kind==="timer"){const ie=((ee=(O=y.snapshot)==null?void 0:O.timers[0])==null?void 0:ee.dueInMs)??0;V=y.advanceTime(Math.max(ie,0)+1),ne="  ↳ advanced the clock — timer fired"}else{const{errorCode:ie,message:oe}=T.action;V=y.throwJobError(x.jobType,ie,oe),ne=`  ↳ threw BPMN error ${ie}: ${oe}`}if(V){$({kind:"vars",text:ne,elementId:x.elementId});const ie=(be=V.instances[0])==null?void 0:be.variables;ie&&K({...ie}),await new Promise(oe=>setTimeout(oe,mn)),await ze(we.current,Le.current,V,R)}else $({kind:"error",text:"  ↳ failed to resolve the manual job",elementId:x.elementId})}finally{ue.current=!1,te(!1)}},[he,y,$,ze]),Be=h.useCallback(async()=>{var ie;let v=null;try{_.agent&&c.trim()&&(v=br(c))}catch(oe){return A(oe instanceof Error?oe.message:String(oe)),null}$e.current={current:void 0};let x;if(e.imageInput){const oe=a.vision;x={read:oe??hi(e.scriptedVision).read,live:!!oe,resolve:fe=>y.getRunImage(fe)}}const T=wr(_,f.handlers,$,$e.current,x);for(const oe of Y.keys())delete T[oe];const R={};if(_.agents.length>0){if(a.kind!=="scripted"&&a.chat){const Ae=new Map;for(const fe of _.agents)Ae.set(fe.jobType,[...Ae.get(fe.jobType)??[],fe]);for(const[fe,Ge]of Ae)R[fe]=Rr(Ge,a.chat,$,{turnRef:$e.current,requiredTools:e.requiredTools})}else if(v&&_.agent){const Ae=_.agent.elementId;R[_.agent.jobType]=async fe=>{if(fe.elementId!==Ae)throw new Error(`No scripted agent handler for "${fe.elementId}" — only "${Ae}" (the primary process's first agent host) is driven by the scripted brain. Use a live brain to exercise more than one host.`);const Ge=await v(fe),Ct=(Ge.activateElements??[]).map(Dt=>Dt.elementId).join(", ");return $({kind:"agent",text:Ge.completionConditionFulfilled?"🤖 scripted agent: done":`🤖 scripted agent: calling ${Ct||"(nothing)"}`}),Ge}}}C([]),ye({});const O={...e.seed,...D,...lr(e.imageInput?l:null)};K(O),we.current=T,Le.current=R;const ee=y.redeploy(r),be=(ee==null?void 0:ee[0])??_.processId;$({kind:"start",text:`Starting "${be}" — ${_.agent?a.kind==="scripted"||!a.chat?"scripted brain":`live brain (${a.modelInUse??a.kind})`:"no agent in this model"}`});const V=y.createInstance(be,JSON.stringify(O)),ne=(ie=V==null?void 0:V.instances[0])==null?void 0:ie.key;return e.imageInput&&l&&ne&&y.setRunImage(ne,l),{workers:T,agents:R,snap:V}},[y,e,f,r,c,D,l,_,a,$,Y]),Se=!!y.snapshot&&y.snapshot.completedInstances<1,Ze=!Se&&!!k&&!X,Oe=h.useCallback(async()=>{if(!(y.phase!=="ready"||ue.current||U||f.hasErrors)){ue.current=!0,te(!0);try{let v=we.current,x=Le.current,T=y.snapshot;const R=++Ee.current;if(!Se){if(Ne.current&&!Ne.current.validate())return;A(null);const O=await Be();if(!O)return;v=O.workers,x=O.agents,T=O.snap,await new Promise(ee=>setTimeout(ee,mn))}await ze(v,x,T,R)}finally{ue.current=!1,te(!1)}}},[y,U,f.hasErrors,Se,Be,ze]),cn=h.useCallback(async()=>{var v;if(!(y.phase!=="ready"||ue.current||U||f.hasErrors)){ue.current=!0,E(!0);try{let x=we.current,T=Le.current,R=y.snapshot;if(!Se){if(Ne.current&&!Ne.current.validate())return;A(null);const ne=await Be();if(!ne)return;x=ne.workers,T=ne.agents,R=ne.snap}if(!R||R.completedInstances>=1)return;const O=R.takenSequenceFlows.length,ee=await y.stepWorkers(x,{agents:T});if(!ee){$({kind:"error",text:"⏭ step failed — no dispatch round was returned"});return}const be=(v=ee.snapshot.instances[0])==null?void 0:v.variables;be&&K({...be});const V=ti(ee.snapshot.takenSequenceFlows,O);$(ri(ee,V,Ye,Y))}finally{ue.current=!1,E(!1)}}},[y,U,f.hasErrors,Se,Be,$,Ye,Y]),dn=h.useCallback(()=>{ue.current=!1,Ee.current++,te(!1),E(!1),y.reset(),C([]),K({})},[y]),I=h.useCallback(()=>{if(!re||ke.current&&!ke.current.validate())return;const v=y.completeUserTask(re.key,JSON.stringify(De));$({kind:"human",text:`👤 ${hn(De)}`}),v&&v.completedInstances>=1&&$({kind:"done",text:"✅ process instance completed"})},[re,De,y,$]),L=h.useMemo(()=>{var v,x;return y.phase==="loading"?o.jsx(J,{variant:"neutral",children:"Booting engine…"}):y.phase==="error"?o.jsx(J,{variant:"danger",children:"Engine error"}):q?o.jsx(J,{variant:"info",children:"Running…"}):U?o.jsx(J,{variant:"info",children:"Stepping…"}):(((v=y.snapshot)==null?void 0:v.incidentElementIds.length)??0)>0?o.jsx(J,{variant:"danger",children:"Incident"}):re?o.jsx(J,{variant:"warning",children:"Waiting for a human"}):(((x=y.snapshot)==null?void 0:x.completedInstances)??0)>=1?o.jsx(J,{variant:"success",children:"Completed"}):y.snapshot?o.jsx(J,{variant:"warning",children:"Paused"}):o.jsx(J,{variant:"neutral",children:"Ready"})},[y.phase,y.snapshot,q,U,re]);return o.jsxs("div",{className:"runner",children:[o.jsxs("section",{className:"intro",children:[o.jsx("h1",{children:e.title}),o.jsx("p",{children:e.blurb}),o.jsxs("div",{className:"controls",children:[o.jsx(Q,{"data-tour":_e.runButton,onClick:()=>void Oe(),disabled:y.phase!=="ready"||q||U||f.hasErrors||Ze,children:"▶ Run"}),o.jsx(Q,{variant:"secondary",onClick:()=>void cn(),disabled:y.phase!=="ready"||q||U||f.hasErrors||Ze||(((Sn=y.snapshot)==null?void 0:Sn.completedInstances)??0)>=1,children:"⏭ Step"}),o.jsx(Q,{variant:"secondary",onClick:dn,disabled:y.phase!=="ready"||U,children:"↺ Reset"}),e.tour&&o.jsx(Q,{variant:"secondary",onClick:M.start,disabled:M.active,children:M.active?"Touring…":`🧭 ${e.tour.label}`}),L]}),y.phase==="error"&&o.jsxs(le,{variant:"destructive",children:[o.jsx(ce,{children:"Engine error"}),o.jsx(de,{children:y.error})]}),N&&o.jsxs(le,{variant:"destructive",children:[o.jsx(ce,{children:"Code didn't compile"}),o.jsx(de,{children:N})]}),f.hasErrors&&o.jsxs(le,{variant:"destructive",children:[o.jsx(ce,{children:"Run is disabled — the diagram has unresolved references"}),o.jsx(de,{children:o.jsx("ul",{className:"diagnostics",children:f.diagnostics.filter(v=>v.severity==="error").map((v,x)=>o.jsx("li",{children:v.message},x))})})]}),!f.hasErrors&&f.diagnostics.length>0&&o.jsxs(le,{children:[o.jsx(ce,{children:"Heads up"}),o.jsx(de,{children:o.jsx("ul",{className:"diagnostics",children:f.diagnostics.map((v,x)=>o.jsx("li",{children:v.message},x))})})]})]}),o.jsxs("div",{className:"grid",children:[o.jsxs("div",{className:"col",children:[o.jsx(Me,{sectionId:"process","data-tour":_e.diagram,title:"Process",description:`${_.processName} — live token (green), incidents (red).`,children:o.jsx(h.Suspense,{fallback:o.jsx("div",{className:"diagram-fallback",children:y.phase==="loading"?"Booting the engine…":"Loading diagram…"}),children:o.jsx(Qi,{xml:f.resolvedBpmn,activeIds:((An=y.snapshot)==null?void 0:An.activeElementIds)??[],incidentIds:((Cn=y.snapshot)==null?void 0:Cn.incidentElementIds)??[],className:"diagram"})})}),re&&o.jsxs(Me,{sectionId:"human-task",title:(ae==null?void 0:ae.label)??"Human task",description:Re?`Rendered from the model's form "${ae==null?void 0:ae.formId}".`:"This task has no linked form — complete it with no variables.",children:[Pe.length>0&&o.jsxs(le,{variant:"destructive",children:[o.jsx(ce,{children:"The agent didn't finish its checks"}),o.jsxs(de,{children:["It completed without running"," ",Pe.map(v=>v.label||v.elementId).join(", "),". The process took the default path to this task, so the findings below have no value to report."]})]}),Re&&o.jsx(h.Suspense,{fallback:o.jsx("div",{className:"form-fallback",children:"Loading form…"}),children:o.jsx(tt,{ref:ke,schema:Re,values:De,onChange:(v,x)=>ye(T=>({...T,[v]:x})),context:ge,onValidityChange:Ie})}),o.jsx(Q,{onClick:I,disabled:!!Re&&!ln,children:"Complete task"})]}),he&&o.jsx(Me,{sectionId:"manual-job",title:he.control.label,description:"This job is held here on purpose — pick how it resolves.",children:o.jsxs("div",{className:"controls",children:[o.jsx(Q,{onClick:()=>void je("complete"),disabled:q||U,children:he.control.completeLabel??"✅ Complete normally"}),o.jsx(Q,{variant:"secondary",onClick:()=>void je("action"),disabled:q||U,children:he.control.action.label})]})}),o.jsxs("div",{className:"row",children:[o.jsx(Me,{sectionId:"variables",className:"grow","data-tour":_e.variablesPanel,title:"Variables",description:"The instance payload, live.",children:o.jsx("pre",{className:"vars",children:hn(ge,2)})}),o.jsx(Ri,{log:H,elementStats:(Dn=y.snapshot)==null?void 0:Dn.elementStats,incidents:(Ln=y.snapshot)==null?void 0:Ln.incidents,labelFor:Ye})]})]}),o.jsxs("div",{className:"col",children:[(_.agent||e.imageInput)&&o.jsx(Me,{sectionId:"brain","data-tour":_e.brainPanel,title:"Brain",description:_.agent?`What drives “${_.agent.label}”. The model recommends; the process governs.`:"What reads the image. The model recommends; the process governs.",children:o.jsx(Ni,{brain:a,showText:!!_.agent,showVision:!!e.imageInput})}),o.jsxs(Me,{sectionId:"start",title:"Start",description:_.startFormId?`The model's start form "${_.startFormId}".`:e.imageInput?"Pick a seed photo or upload your own to read.":"The starting payload.",children:[e.imageInput&&o.jsx(Ei,{imageInput:e.imageInput,value:l,onSelect:u,disabled:q}),e.scenarios&&o.jsx("div",{className:"scenarios",children:e.scenarios.map(v=>o.jsx(Q,{size:"sm",variant:"secondary",disabled:q,onClick:()=>G(x=>({...x,...v.variables})),children:v.label},v.label))}),k?o.jsx(h.Suspense,{fallback:o.jsx("div",{className:"form-fallback",children:"Loading form…"}),children:o.jsx(tt,{ref:Ne,schema:k,values:D,onChange:(v,x)=>G(T=>({...T,[v]:x})),disabled:q,onValidityChange:Ue})}):o.jsx("pre",{className:"vars",children:hn(D,2)})]}),o.jsx(Me,{sectionId:"code",className:"editors","data-tour":_e.codePanel,title:"Code",description:"One handler per BPMN element. Return variables to merge, or throw to fail the job.",children:o.jsx(h.Suspense,{fallback:o.jsx("div",{className:"editor-fallback",children:"Loading editor…"}),children:o.jsxs(Yt,{value:Z,onValueChange:se,children:[o.jsxs(Gt,{children:[o.jsx(qe,{value:et,children:"model"}),_.agent&&o.jsx(qe,{value:pn,children:"agent (scripted)"}),e.handlers.map(v=>{var x;return o.jsx(qe,{value:v.elementId,children:((x=_.tasks.find(T=>T.elementId===v.elementId))==null?void 0:x.label)??v.elementId},v.elementId)}),Object.keys(p).map(v=>o.jsx(qe,{value:nt+v,children:v},v))]}),o.jsxs(Ke,{value:et,children:[o.jsxs("div",{className:"editor-meta",children:[o.jsx("strong",{children:"Model"}),o.jsx("code",{children:"edit the diagram visually — Run re-checks it below"}),o.jsx(Q,{variant:"secondary",size:"sm",onClick:()=>i(e.bpmn),disabled:r===e.bpmn,children:"Revert to original"})]}),o.jsx(Ji,{value:r,onChange:i})]}),_.agent&&o.jsxs(Ke,{value:pn,children:[o.jsxs("div",{className:"editor-meta",children:[o.jsx("strong",{children:_.agent.label}),o.jsx("code",{children:a.kind==="scripted"||!a.chat?"in use":"unused — a live brain is connected"})]}),o.jsx("div",{className:"editor-wrap",children:o.jsx(gn,{height:"360px",defaultLanguage:"javascript",value:c,onChange:v=>g(v??""),options:bn})})]}),e.handlers.map(v=>{var x;return o.jsxs(Ke,{value:v.elementId,children:[o.jsxs("div",{className:"editor-meta",children:[o.jsx("strong",{children:((x=_.tasks.find(T=>T.elementId===v.elementId))==null?void 0:x.label)??v.elementId}),o.jsx("code",{children:v.standsInFor??v.elementId})]}),o.jsx("div",{className:"editor-wrap",children:o.jsx(gn,{height:"360px",defaultLanguage:"javascript",value:m[v.elementId],onChange:T=>s(R=>({...R,[v.elementId]:T??""})),options:bn})})]},v.elementId)}),Object.keys(p).map(v=>o.jsxs(Ke,{value:nt+v,children:[o.jsxs("div",{className:"editor-meta",children:[o.jsx("strong",{children:v}),o.jsxs("code",{children:["prompt / template text — substitutes"," ","{{"+v+"}}"]})]}),o.jsx("div",{className:"editor-wrap",children:o.jsx(gn,{height:"360px",defaultLanguage:"markdown",value:p[v],onChange:x=>b(T=>He(T,{[v]:x??""})),options:bn})})]},v))]})})}),_.agent&&o.jsx(Me,{sectionId:"tools",title:"Tools, as the model sees them",description:o.jsxs(o.Fragment,{children:["Read from the diagram — element name, documentation, and every",o.jsx("code",{children:" fromAi(…)"})," argument."]}),children:o.jsx("ul",{className:"tool-list",children:_.agent.tools.map(v=>o.jsxs("li",{children:[o.jsx("code",{children:v.elementId}),o.jsxs("span",{children:[" — ",v.documentation||v.label]}),v.args.length>0&&o.jsx("ul",{children:v.args.map(x=>o.jsxs("li",{children:[o.jsxs("code",{children:[x.name,": ",x.type]})," ","— ",x.description]},x.name))})]},v.elementId))})})]})]})]})}const bn={minimap:{enabled:!1},fontSize:13,scrollBeyondLastLine:!1,tabSize:2,automaticLayout:!0},Wi=`You are a demo workflow assistant for fictional compliance checks.
...
`,qi={id:"compliance-walkthrough",label:"Take the tour",steps:[{title:"Start a run",description:"Press Run to send a shipment through the compliance agent.",target:{anchor:_e.runButton}},{title:"The agent picks its own tools",description:"This AI Agent reads the shipment notes and decides, turn by turn, which of the tools below it to call — nothing here is hard-coded into a fixed sequence.",target:{elementId:"ComplianceCheckAgent"}},{title:"Watch the token move",description:"The agent's first move is to look up the genetic marker mentioned in the notes.",target:{elementId:"VerifyGeneticMarker"},waitFor:{kind:"activeElement",elementId:"VerifyGeneticMarker"}},{title:"A cleared shipment notifies the export team",description:"Once the compliance score comes back clean, the process notifies the export team automatically — no human review needed for this scenario.",target:{elementId:"NotifyExportTeam"},waitFor:{kind:"elementCompleted",elementId:"NotifyExportTeam"}},{title:"Everything the run recorded",description:"The variables panel shows the marker record, the country lookup, the compliance score, and the final decision — exactly what each tool and the agent wrote along the way.",target:{anchor:_e.variablesPanel}}],successEvent:{kind:"instanceCompleted"}},Ki=`<?xml version="1.0" encoding="UTF-8"?>
...
}`,Io={id:"seed-export-compliance",title:"Seed export compliance agent",blurb:"An AI agent picks its own tools to check a shipment, then a gateway routes on its decision — cleared shipments notify the export team, flagged ones go to a human. The LLM recommends; the BPMN process governs.",docsUrl:"https://camunda.com/blog/agentic-ai/",bpmn:Ki,forms:{"seed-export-shipment-ready":so,"seed-export-compliance-review":ho},seed:{scenario:rt,shipmentNotes:""},scenarios:[{label:"Likely cleared (TP53 → Brazil)",variables:{scenario:rt,shipmentNotes:""}},{label:"Likely flagged (BRCA1 → Germany)",variables:{scenario:yo,shipmentNotes:""}}],scriptedAgent:wo,templates:fo,tour:qi,requiredTools:["RecordComplianceDecision"],handlers:[{elementId:"VerifyGeneticMarker",standsInFor:"JDBC connector — UCSC hg38",source:_o},{elementId:"CheckDestinationCountry",standsInFor:"GraphQL connector — countries API",source:Mo},{elementId:"ComputeComplianceScore",standsInFor:"REST connector — api.mathjs.org",source:vo},{elementId:"RecordComplianceDecision",standsInFor:"Script task — FEEL",source:xo},{elementId:"NotifyExportTeam",standsInFor:"REST connector — httpbin.io",source:No}]},ko=`You are a loan origination assistant at a retail bank. Your job is to gather everything a senior loan officer needs to decide an application — you do **not** decide it yourself.
...
`,Eo="Gather this loan case for the senior officer: look up the customer, pull their credit bureau report, run the underwriting assessment, and set the application status to `under-review`. Then stop — the officer makes the decision.\n",To={id:"loan-origination-walkthrough",label:"Take the tour",steps:[{title:"Start a run",description:"Press Run to send a loan application through the origination agent.",target:{anchor:_e.runButton}},{title:"The agent picks its own tools",description:"This AI Agent reads the application and decides, turn by turn, which tools to call — look up the customer, pull a credit bureau report, run the underwriting policy, update the status. Nothing here is a fixed sequence.",target:{elementId:"LoanOriginationAgent"}},{title:"Policy, not opinion",description:"The assessment computes the debt-to-income ratio, a risk band and a recommendation from the verified figures — the deterministic policy the senior officer's review leans on.",target:{elementId:"AssessApplication"},waitFor:{kind:"elementCompleted",elementId:"AssessApplication"}},{title:"Every application meets a human",description:"Whatever the agent recommended, the token now waits here: no offer and no decline is reachable without a senior officer first signing off. Open the task to record the decision — the gateway routes on it.",target:{elementId:"SeniorOfficerReview"},waitFor:{kind:"activeElement",elementId:"SeniorOfficerReview"}},{title:"Everything the run recorded",description:"The variables panel shows the customer profile, the bureau report, the debt-to-income and risk band, and the recommendation — exactly what each tool wrote for the officer to weigh.",target:{anchor:_e.variablesPanel}}],successEvent:{kind:"elementCompleted",elementId:"AssessApplication"}},jo=`<?xml version="1.0" encoding="UTF-8"?>
...
}`,qo=`async (job, { text, num, sleep, trace }) => {
...
}`,ts={id:"loan-origination",title:"Loan origination agent",blurb:"An AI agent gathers a loan case with its own tools — customer lookup, credit bureau, an underwriting policy, a status update — then every application passes through a mandatory senior-officer review before a gateway routes it to an offer or a decline. The agent advises; the process governs.",docsUrl:"https://camunda.com/orchestrate/agents/",bpmn:jo,forms:{"loan-application":zo,"loan-senior-officer-review":Vo},seed:it,scenarios:[{label:"Strong applicant (policy recommends approve)",variables:it},{label:"Marginal applicant (policy recommends decline)",variables:Ho}],scriptedAgent:Wo,templates:Jo,tour:To,requiredTools:["AssessApplication","UpdateApplicationStatus"],handlers:[{elementId:"QueryCustomer",standsInFor:"CRM connector — customer lookup",source:Zo},{elementId:"CreditBureauLookup",standsInFor:"REST connector — credit bureau",source:qo},{elementId:"AssessApplication",standsInFor:"Script task — underwriting policy (FEEL)",source:Ko},{elementId:"UpdateApplicationStatus",standsInFor:"REST connector — origination system",source:Xo},{elementId:"IssueLoanOffer",standsInFor:"REST connector — offer/booking system",source:es},{elementId:"SendDeclineNotice",standsInFor:"REST connector — notifications",source:ns}]},rs=`<?xml version="1.0" encoding="UTF-8"?>
...
}`,as={id:"order-process",title:"Order process with service workers",blurb:"The getting-started order process: check inventory, charge payment, ship. No agent and no human step — the same runner, driven entirely by what's in the diagram.",docsUrl:"https://docs.camunda.io/docs/next/guides/getting-started-orchestration-cluster/",bpmn:rs,seed:{item:"camunda-t-shirt",quantity:3},handlers:[{elementId:"Activity_0tw2fu0",standsInFor:"job worker — check-inventory",source:is},{elementId:"Activity_1ppsbgi",standsInFor:"job worker — charge-payment",source:os},{elementId:"Activity_08pg6im",standsInFor:"job worker — ship-items",source:ss}]},ls=`<?xml version="1.0" encoding="UTF-8"?>\r
...
}`,ra={id:"plate-recognition",title:"Read a number plate from a photo",blurb:"Pick the plate's country, then a photo goes into the run, an in-browser vision model reads the number plate on the reader's own GPU, and a human confirms or corrects it before the process records the result. The vision model recommends; the BPMN process governs. No server, no API key — with no model connected it falls back to a deterministic scripted reading.",docsUrl:"https://docs.camunda.io/docs/components/modeler/forms/camunda-forms-reference/",bpmn:ks,forms:{"plate-recognition-country":Zs,"plate-recognition-confirm":Ls,"plate-recognition-manual":$s},seed:{country:"auto"},imageInput:{label:"Pick a seed photo (its plate is known, so the scripted reader works offline) or upload your own — a live in-browser model reads a photo it has never seen.",seedImages:Xs},scriptedVision:ea,handlers:[{elementId:"ExtractPlate",standsInFor:"Vision model — Florence-2 <OCR> on WebGPU (in-browser)",source:na},{elementId:"RecordResult",standsInFor:"Script task — records the governed outcome",source:ta}]},nn=[ds,Io,ts,as,hs,ra];function Tn(){return"/pr-preview/pr-90/"}function ia(e){const n=Tn();return e.startsWith(n)?"/"+e.slice(n.length):e}function oa(e=location.pathname){const t=ia(e).match(/^\/examples\/([^/]+)\/?$/);if(t)try{return{kind:"example",id:decodeURIComponent(t[1])}}catch{return{kind:"gallery"}}return{kind:"gallery"}}function sa(e=location.search){return new URLSearchParams(e).get("embed")==="1"}function aa(){return Tn()}function st(e){return`${Tn()}examples/${encodeURIComponent(e)}`}function at(e,n={}){const t=new URL(location.href);t.pathname=e,t.search=n.search??t.search,n.hash!==void 0&&(t.hash=n.hash),n.replace?history.replaceState(history.state,"",t):history.pushState(history.state,"",t),window.dispatchEvent(new PopStateEvent("popstate"))}function lt(){return{route:oa(),embed:sa()}}function la(){const[e,n]=h.useState(lt);return h.useEffect(()=>{const t=()=>n(lt());return window.addEventListener("popstate",t),()=>window.removeEventListener("popstate",t)},[]),e}const ca="web-demo-framework:height",da="web-demo-framework:request-height";function ua(e){return{type:ca,height:Math.ceil(e)}}const ct="embed-height-auto";function ma(e){h.useEffect(()=>{if(!e||typeof window>"u"||window.parent===window)return;const n=document.documentElement;n.classList.add(ct);let t=-1;const r=(l=!1)=>{const u=document.documentElement.scrollHeight;!l&&Math.abs(u-t)<2||(t=u,window.parent.postMessage(ua(u),"*"))},i=l=>{if(l.source!==window.parent)return;const u=l.data;!u||u.type!==da||r(!0)};window.addEventListener("message",i),r();const a=new ResizeObserver(()=>r());return a.observe(n),()=>{a.disconnect(),window.removeEventListener("message",i),n.classList.remove(ct)}},[e])}function pa(){const{route:e,embed:n}=la(),t=Tt().brain,r=zi();ma(n);const i=e.kind==="example"?e.id:nn[0].id,a=nn.find(m=>m.id===i)??nn[0],l=m=>{at(st(m),{hash:location.hash})},u=o.jsxs(o.Fragment,{children:[!n&&e.kind==="gallery"&&o.jsx("nav",{className:"example-picker",children:nn.map(m=>o.jsx(Q,{size:"sm",variant:m.id===a.id?"default":"secondary",onClick:()=>l(m.id),children:m.title},m.id))}),!n&&e.kind==="example"&&o.jsx("div",{className:"example-nav",children:o.jsx(Q,{size:"sm",variant:"secondary",onClick:()=>at(aa()),children:"← All examples"})}),o.jsxs("div",{className:"example-meta",children:[a.docsUrl&&o.jsx("a",{className:"docs-link",href:a.docsUrl,target:"_blank",rel:"noreferrer noopener",children:"View on camunda.com ↗"}),n&&o.jsx("a",{className:"open-full-page",href:st(a.id)+(location.hash||""),target:"_top",rel:"noreferrer",children:"Open full page ↗"})]}),o.jsx(Hi,{example:a,initialBrainKind:t,initialTourId:r},a.id)]});return n?o.jsx("div",{className:"c4-ui app-shell app-embed",children:o.jsx("main",{id:"main",className:"layout layout-embed",children:u})}):o.jsxs("div",{className:"c4-ui app-shell",children:[o.jsx(Vt,{appName:"Runnable Camunda examples",trailing:o.jsx("span",{className:"app-subtitle",children:"model + code + optional LLM, in your browser"})}),o.jsx("main",{id:"main",className:"layout",children:u})]})}Rt.createRoot(document.getElementById("root")).render(o.jsx(h.StrictMode,{children:o.jsx(Qt,{children:o.jsx(pa,{})})}));export{pe as _,fa as c};
