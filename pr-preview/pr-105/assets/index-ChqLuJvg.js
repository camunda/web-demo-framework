const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/driver-CTZuBZOi.css","assets/diagram-js-DAKGYcfb.css","assets/bpmn-js-BEOU0ddW.css","assets/bpmn-embedded-DDF-VDAc.css","assets/RuntimeDiagram-87ZJgWtH.js","assets/vendor-react-9Ma26nY1.js","assets/Viewer-D_7S4Gwm.js","assets/MonacoEditor-q8zfgMAr.js","assets/MonacoEditor-ClxJV_rb.css","assets/vendor-modeler-BWp2F2i1.js","assets/vendor-design-system-BzucwDAG.js","assets/vendor-design-system-DRbtsu0j.css","assets/parser-DkgAe_kI.js","assets/ModelEditor-Dwlgp6JA.css","assets/FormRenderer-BaorHIqa.js","assets/FormRenderer-D1JIHOW6.css"])))=>i.map(i=>d[i]);
var Pt=Object.defineProperty;var Rt=(e,n,t)=>n in e?Pt(e,n,{enumerable:!0,configurable:!0,writable:!0,value:t}):e[n]=t;var O=(e,n,t)=>Rt(e,typeof n!="symbol"?n+"":n,t);import{r as h,j as i,i as zt}from"./vendor-react-9Ma26nY1.js";import{B as Q,a as J,L as Fe,S as Mn,b as vn,c as xn,d as Nn,e as In,A as le,f as ce,g as de,I as Pn,C as Bt,h as Ot,i as Ft,j as Ut,k as $t,l as Yt,T as Gt,m as Vt,n as Xe,o as en,p as Qt,q as Jt}from"./vendor-design-system-BzucwDAG.js";(function(){const n=document.createElement("link").relList;if(n&&n.supports&&n.supports("modulepreload"))return;for(const o of document.querySelectorAll('link[rel="modulepreload"]'))r(o);new MutationObserver(o=>{for(const a of o)if(a.type==="childList")for(const l of a.addedNodes)l.tagName==="LINK"&&l.rel==="modulepreload"&&r(l)}).observe(document,{childList:!0,subtree:!0});function t(o){const a={};return o.integrity&&(a.integrity=o.integrity),o.referrerPolicy&&(a.referrerPolicy=o.referrerPolicy),o.crossOrigin==="use-credentials"?a.credentials="include":o.crossOrigin==="anonymous"?a.credentials="omit":a.credentials="same-origin",a}function r(o){if(o.ep)return;o.ep=!0;const a=t(o);fetch(o.href,a)}})();const Ht="modulepreload",Wt=function(e){return"/pr-preview/pr-105/"+e},Rn={},ue=function(n,t,r){let o=Promise.resolve();if(t&&t.length>0){let l=function(s){return Promise.all(s.map(c=>Promise.resolve(c).then(g=>({status:"fulfilled",value:g}),g=>({status:"rejected",reason:g}))))};document.getElementsByTagName("link");const u=document.querySelector("meta[property=csp-nonce]"),m=(u==null?void 0:u.nonce)||(u==null?void 0:u.getAttribute("nonce"));o=l(t.map(s=>{if(s=Wt(s),s in Rn)return;Rn[s]=!0;const c=s.endsWith(".css"),g=c?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${s}"]${g}`))return;const p=document.createElement("link");if(p.rel=c?"stylesheet":Ht,c||(p.as="script"),p.crossOrigin="",p.href=s,m&&p.setAttribute("nonce",m),document.head.appendChild(p),c)return new Promise((b,f)=>{p.addEventListener("load",b),p.addEventListener("error",()=>f(new Error(`Unable to preload CSS for ${s}`)))})}))}function a(l){const u=new Event("vite:preloadError",{cancelable:!0});if(u.payload=l,window.dispatchEvent(u),!u.defaultPrevented)throw l}return o.then(l=>{for(const u of l||[])u.status==="rejected"&&a(u.reason);return n().catch(a)})},Zt="io.camunda.agenticai:aiagent",Ie="http://www.omg.org/spec/BPMN/20100524/MODEL",qt="http://camunda.org/schema/zeebe/1.0";function kn(e,n){return Array.from(e.getElementsByTagNameNS(qt,n))}function ut(e,n){return kn(e,n).filter(t=>Kt(t)===e)}function Kt(e){let n=e.parentElement;for(;n;){if(n.namespaceURI===Ie&&n.localName!=="extensionElements")return n;n=n.parentElement}return null}function An(e){const n=ut(e,"taskDefinition")[0],t=n==null?void 0:n.getAttribute("type");return t||(e.localName==="scriptTask"?e.getAttribute("id")??null:null)}function zn(e){const n=Array.from(e.children).find(t=>t.namespaceURI===Ie&&t.localName==="documentation");return((n==null?void 0:n.textContent)??"").trim()}function Bn(e){if(!e)return"";const n=e.startsWith("=")?e.slice(1):e,t=n.match(/"((?:[^"\\]|\\.)*)"/g);return t?t.map(r=>r.slice(1,-1).replace(/\\n/g,`
`).replace(/\\t/g,"	").replace(/\\"/g,'"').replace(/\\\\/g,"\\")).join("").trim():n.trim()}function mt(e){const n=[],t=r=>{for(const o of Array.from(r.attributes))n.push(o.value);for(const o of Array.from(r.children))t(o)};return t(e),n.join(`
`)}function Xt(e){return pt(mt(e))}function er(e){const n=Array.from(e.children).find(t=>t.namespaceURI===Ie&&t.localName==="extensionElements");return n?pt(mt(n)):[]}function pt(e){const n=/fromAi\(\s*toolCall\.([A-Za-z_$][\w$]*)\s*,\s*"((?:[^"\\]|\\.)*)"\s*(?:,\s*"(\w+)")?/g,t=[],r=new Set;for(const o of e.matchAll(n)){const a=o[1];r.has(a)||(r.add(a),t.push({name:a,description:(o[2]??"").replace(/&#10;/g,`
`).replace(/\\"/g,'"').replace(/&quot;/g,'"').replace(/&#39;/g,"'").trim(),type:o[3]??"string"}))}return t}function nr(e){const n={};for(const t of ut(e,"input")){const r=t.getAttribute("target");r&&(n[r]=t.getAttribute("source")??"")}return n}function tr(e){return Array.from(e.getElementsByTagNameNS(Ie,"adHocSubProcess")).filter(n=>(An(n)??"").startsWith(Zt))}const rr=new Set(["subProcess","adHocSubProcess","callActivity"]),or=new Set(["adHocSubProcess","subProcess","transaction"]);function ir(e){let n=e.parentElement;for(;n;){if(n.namespaceURI===Ie&&or.has(n.localName))return n;n=n.parentElement}return null}function sr(e,n){const t=nr(e),r=Number((t["data.limits.maxModelCalls"]??"").replace(/^=/,""));return{elementId:e.getAttribute("id")??"agent",label:e.getAttribute("name")??"Agent",jobType:An(e),systemPrompt:Bn(t["data.systemPrompt.prompt"]),userPrompt:Bn(t["data.userPrompt.prompt"]),maxModelCalls:Number.isFinite(r)&&r>0?r:10,tools:n}}function ar(e,n){var g;const t=e.getAttribute("id")??"",r=e.getAttribute("name")??t,o=tr(e);o.length>1&&n.push({severity:"warning",elementId:o.map(p=>p.getAttribute("id")).join(", "),message:`Process "${r}" hosts ${o.length} AI Agent sub-processes (${o.map(p=>p.getAttribute("id")).join(", ")}). Each gets its own independent agent state (turn counter, called tools) — the run itself is shared across hosts, but each host's agent state within it is not.`});const a=[],l=new Map(o.map(p=>[p,[]]));for(const p of Array.from(e.getElementsByTagName("*"))){if(p.namespaceURI!==Ie||o.includes(p))continue;const b=p.getAttribute("id");if(!b)continue;const f=ir(p),_=f&&o.includes(f)?f:null;if(_&&rr.has(p.localName)){const I=p.getAttribute("name")??b,D=zn(p);a.push({elementId:b,label:I,jobType:"",documentation:D,isTool:!0,compound:!0}),l.get(_).push({elementId:b,label:I,jobType:"",documentation:D,args:er(p),compound:!0});continue}const y=An(p);if(!y)continue;const M={elementId:b,label:p.getAttribute("name")??b,jobType:y,documentation:zn(p),isTool:_!=null};a.push(M),_&&l.get(_).push({elementId:b,label:M.label,jobType:y,documentation:M.documentation,args:Xt(p)})}const u=o.map(p=>sr(p,l.get(p))),m=Array.from(e.getElementsByTagNameNS(Ie,"userTask")).map(p=>{var b;return{elementId:p.getAttribute("id")??"",label:p.getAttribute("name")??p.getAttribute("id")??"",formId:((b=kn(p,"formDefinition")[0])==null?void 0:b.getAttribute("formId"))??void 0}}),s=e.getElementsByTagNameNS(Ie,"startEvent")[0],c=s?((g=kn(s,"formDefinition")[0])==null?void 0:g.getAttribute("formId"))??void 0:void 0;return{processId:t,processName:r,tasks:a,agents:u,userTasks:m,startFormId:c}}function lr(e,n={}){const t=new DOMParser().parseFromString(e,"application/xml"),r=t.getElementsByTagName("parsererror")[0];if(r)throw new Error(`Invalid BPMN XML: ${r.textContent}`);const o=Array.from(t.getElementsByTagNameNS(Ie,"process"));if(o.length===0)throw new Error("No <bpmn:process> in the diagram.");const a=[],l=o.map(m=>ar(m,a));let u=n.processId?l.find(m=>m.processId===n.processId):void 0;return n.processId&&!u&&a.push({severity:"warning",message:`Requested process "${n.processId}" not found — falling back to "${l[0].processId}".`}),u??(u=l[0]),l.length>1&&a.push({severity:"warning",message:`Diagram has ${l.length} <bpmn:process> elements (${l.map(m=>m.processId).join(", ")}); using "${u.processId}" as the active process. Pass a processId to parseModel to target another.`}),{processes:l,diagnostics:a,processId:u.processId,processName:u.processName,tasks:u.tasks,agent:u.agents[0]??null,agents:l.flatMap(m=>m.agents),userTasks:u.userTasks,startFormId:u.startFormId}}function cr(e){return e?e.imageId?{imageId:e.imageId}:e.imageName?{imageName:e.imageName}:{}:{}}function gt(e,n){return n?e.pixels:e.imageId??e.pixels}const dr="No image selected — pick or upload a photo to read.";function On(){return dr}function ur(e,n){return async t=>{const r=e.resolve(n);if(!r)return On();const o=gt(r,e.live);if(o===void 0)return On();try{return await e.read(o,t)}catch(a){return`Couldn't read the image (${a instanceof Error?a.message:String(a)}).`}}}function mr(e,n){return async()=>{const t=e.resolve(n);if(t)return gt(t,e.live)}}function pr(){return`<!doctype html><html><head><meta charset="utf-8"></head><body><script>
    "use strict";
    ...
    post({ kind: "ready" });
  <\/script></body></html>`}function ht(e,n={}){const{timeoutMs:t=5e3,onTrace:r,onVision:o,onImage:a}=n,l=`${Date.now()}-${Math.random().toString(36).slice(2)}`;return new Promise((u,m)=>{const s=document.createElement("iframe");s.setAttribute("sandbox","allow-scripts"),s.style.display="none",s.setAttribute("aria-hidden","true");let c=!1,g;const p=()=>{g&&clearTimeout(g),window.removeEventListener("message",f),s.remove()},b=y=>{c||(c=!0,p(),y())};function f(y){var I;if(y.source!==s.contentWindow)return;const M=y.data;if(!(!M||typeof M!="object")){if(M.kind==="ready"){const D=e.job,G=e.kind==="run-handler"?{kind:"run-handler",id:l,source:e.source,job:D,hasVision:e.hasVision}:{kind:"run-agent",id:l,source:e.source,job:D};(I=s.contentWindow)==null||I.postMessage(G,"*");return}"id"in M&&M.id!==l||(M.kind==="trace"?r==null||r(M.text):M.kind==="vision-request"?_(M.callId,o,"vision",M.prompt):M.kind==="image-request"?_(M.callId,a,"image"):M.kind==="result"?b(()=>u(M.value)):M.kind==="error"&&b(()=>m(new Error(M.message))))}}function _(y,M,I,...D){const G=Z=>{var ae;return(ae=s.contentWindow)==null?void 0:ae.postMessage(Z,"*")};if(!M){G({kind:"helper-error",id:l,callId:y,message:`${I} helper is not available.`});return}Promise.resolve().then(()=>M(...D)).then(Z=>G({kind:"helper-result",id:l,callId:y,value:Z}),Z=>G({kind:"helper-error",id:l,callId:y,message:Z instanceof Error?Z.message:String(Z)}))}window.addEventListener("message",f),g=setTimeout(()=>{b(()=>m(new Error(`Handler timed out after ${t}ms — the sandboxed run was terminated.`)))},t),s.srcdoc=pr(),document.body.appendChild(s)})}function bt(e){return{key:e.key,type:e.type,elementId:e.elementId,instanceKey:e.instanceKey,variables:e.variables??{}}}function gr(e,n,t){const r=typeof t.vision=="function";return ht({kind:"run-handler",source:e,job:bt(n),hasVision:r},{onTrace:t.trace,onVision:t.vision?o=>t.vision(o):void 0,onImage:t.image?()=>t.image():void 0})}function hr(e,n){return ht({kind:"run-agent",source:e,job:bt(n)})}function ft(e,n){try{new Function(`"use strict"; return (${e});`)}catch{throw new Error(`${n} has a syntax error.`)}}function br(e){return ft(e,"Handler code"),(n,t)=>gr(e,n,t)}function fr(e){return ft(e,"Agent code"),n=>hr(e,n)}function yr(e,n,t,r){return{sleep:o=>new Promise(a=>setTimeout(a,o)),trace:o=>n({kind:"tool",text:`   ${o}`,elementId:e.elementId,turn:t}),text:(o,a="")=>{const l=e.variables[o];return typeof l=="string"?l:l==null?a:String(l)},num:(o,a=0)=>{const l=e.variables[o],u=typeof l=="number"?l:Number(l);return Number.isFinite(u)?u:a},...r?{vision:ur(r,e.instanceKey),image:mr(r,e.instanceKey)}:{}}}function wr(e){if(e===void 0)return"undefined";try{return JSON.stringify(e)}catch{return"[unserializable value]"}}function _r(e,n,t,r,o){const a={},l=e.processes.flatMap(m=>m.tasks),u=new Map(l.map(m=>[m.elementId,m.label]));for(const m of l)m.compound||a[m.jobType]||(a[m.jobType]=async s=>{const c=n[s.elementId];if(!c)throw new Error(`No handler registered for ${s.elementId} (job type ${s.type})`);const g=u.get(s.elementId)??s.elementId,p=r==null?void 0:r.current;t({kind:"tool",text:`▶ ${g}`,elementId:s.elementId,turn:p});const b=await c(s,yr(s,t,p,o));return t({kind:"vars",text:`  ↳ ${wr(b)}`,elementId:s.elementId,result:b,turn:p}),b});return a}const Mr=/\{\{\s*([A-Za-z][A-Za-z0-9_-]*)\s*\}\}/g;function We(...e){const n=Object.create(null);for(const t of e)if(t)for(const r of Object.keys(t))n[r]=t[r];return n}function yt(e){return(e.split("/").pop()??e).replace(/\.[^./]+$/,"")}function wt(e){return e.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;")}function vr(e){return wt(e).replace(/"/g,"&quot;").replace(/\n/g,"&#10;").replace(/\t/g,"&#9;")}function xr(e){return e.replace(/\\/g,"\\\\").replace(/&/g,"&amp;").replace(/"/g,"\\&#34;").replace(/\n/g,"&#10;").replace(/\t/g,"&#9;").replace(/</g,"&lt;").replace(/>/g,"&gt;")}function Nr(e){return JSON.stringify(e).slice(1,-1)}function Ir(e,n){const t=e.lastIndexOf("<",n),r=e.lastIndexOf(">",n);if(t<=r)return"text";const o=e.slice(t,n);if((o.match(/"/g)??[]).length%2===0)return"text";const l=o.lastIndexOf('"');return(o.slice(l+1).match(/&#34;|&quot;/g)??[]).length%2===1?"feel-literal":"attribute"}function kr(e,n,t="xml"){const r=[],o=new Set;return{result:e.replace(Mr,(l,u,m)=>{const s=u.trim();if(!Object.prototype.hasOwnProperty.call(n,s))return o.has(s)||(o.add(s),r.push(s)),l;const c=n[s];if(t==="json")return Nr(c);const g=Ir(e,m);return g==="feel-literal"?xr(c):g==="attribute"?vr(c):wt(c)}),unresolved:r}}function Er(){return{processes:[],diagnostics:[],processId:"",processName:"",tasks:[],agent:null,agents:[],userTasks:[],startFormId:void 0}}function Tr(e,n={},t=e.bpmn,r={}){const o=[],a=We(e.templates,r),{result:l,unresolved:u}=kr(t,a,"xml");for(const M of u)o.push({severity:"warning",message:`Template placeholder "{{${M}}}" has no matching prompt/template content — left in the model as-is, not substituted.`});let m;try{m=lr(l)}catch(M){return o.push({severity:"error",message:M instanceof Error?M.message:String(M)}),{resolvedBpmn:l,model:Er(),handlers:{},forms:{},diagnostics:o,hasErrors:!0}}o.push(...m.diagnostics);const s=m.processes.flatMap(M=>M.tasks),c=new Map(e.handlers.map(M=>[M.elementId,M.source])),g={};for(const M of s){if(M.compound)continue;const I=n[M.elementId]??c.get(M.elementId);if(I===void 0){o.push({severity:"error",elementId:M.elementId,jobType:M.jobType,message:`No handler for "${M.label}" (${M.elementId}, job type "${M.jobType}"). Add a handler for this element, or remove it from the diagram.`});continue}try{g[M.elementId]=br(I)}catch(D){o.push({severity:"error",elementId:M.elementId,jobType:M.jobType,message:`"${M.label}" (${M.elementId}): handler code didn't compile — ${D instanceof Error?D.message:String(D)}`})}}const p=new Set(s.map(M=>M.elementId)),b=new Set([...c.keys(),...Object.keys(n)]);for(const M of b)p.has(M)||o.push({severity:"error",elementId:M,message:`Handler "${M}" doesn't match any element in the current diagram — likely orphaned by a rename. Rename it back, or remove the handler.`});const f={},_=e.forms??{},y=(M,I)=>{if(!M)return;const D=_[M];D?f[M]=D:o.push({severity:"error",formId:M,message:`${I} references form "${M}", which has no matching schema.`})};for(const M of m.processes){y(M.startFormId,`The start event of process "${M.processName}"`);for(const I of M.userTasks)y(I.formId,`User task "${I.label}" (${I.elementId})`)}return{resolvedBpmn:l,model:m,handlers:g,forms:f,diagnostics:o,hasErrors:o.some(M=>M.severity==="error")}}function jr(e){const n=e.indexOf("{");if(n<0)return null;let t=0;for(let r=n;r<e.length;r++)if(e[r]==="{")t++;else if(e[r]==="}"&&(t--,t===0))try{const o=JSON.parse(e.slice(n,r+1));return typeof o=="object"&&o!==null&&!Array.isArray(o)?o:null}catch{return null}return null}function En(e,n=220){const t=e.replace(/\s+/g," ").trim();return t.length>n?`${t.slice(0,n-1)}…`:t}function Fn(e){const n=e.arguments??e.args??e.parameters??e.input;return n&&typeof n=="object"&&!Array.isArray(n)?n:{}}function Un(e){if(!e)return[];const n=e.tool??e.name??e.action;if(typeof n=="string"&&n.trim())return[{name:n.trim(),args:Fn(e)}];const t=e.tools??e.tool_calls??e.toolset??e.actions,r=Array.isArray(t)?t:Object.values(e).find(a=>Array.isArray(a))??[],o=[];for(const a of r)if(typeof a=="string")a.trim()&&o.push({name:a.trim(),args:{}});else if(a&&typeof a=="object"){const l=a,u=l.name??l.tool??l.id??l.function;typeof u=="string"&&u.trim()&&o.push({name:u.trim(),args:Fn(l)})}return o}function Sr(e){if(!e)return!1;const n=e.done??e.finished??e.complete;return typeof n=="boolean"?n:typeof n=="string"?n.toLowerCase()==="true":!1}function $n(e){const n=e.args.length?e.args.map(r=>`      ${r.name} (${r.type}) — ${r.description}`).join(`
`):"      (none)",t=e.documentation||e.label;return`${e.elementId}
    purpose: ${t}
    arguments:
${n}`}function Ar(e,n,t){const r=e.systemPrompt||"You are an agent driving a business process. Use the tools available to you.",o=t[0]??e.tools[0];if(t.length===0)return`${r}
...
character, with nothing added. When your work is finished, reply exactly
{"done": true} and no tool.`}function Cr(e,n,t,r,o=[],a=[],l=!1){const u=e.userPrompt||"Carry out your task.",m=Object.entries(n).filter(([,c])=>typeof c=="string"&&c.trim().length>0).map(([c,g])=>`  ${c}: ${String(g)}`),s=[u,m.length?`Case data:
${m.join(`
...
}`,oa={id:"plate-recognition",title:"Read a number plate from a photo",blurb:"Pick the plate's country, then a photo goes into the run, an in-browser vision model reads the number plate on the reader's own GPU, and a human confirms or corrects it before the process records the result. The vision model recommends; the BPMN process governs. No server, no API key — with no model connected it falls back to a deterministic scripted reading.",docsUrl:"https://docs.camunda.io/docs/components/modeler/forms/camunda-forms-reference/",bpmn:Es,forms:{"plate-recognition-country":qs,"plate-recognition-confirm":Ps,"plate-recognition-manual":Ys},seed:{country:"auto"},imageInput:{label:"Pick a seed photo (its plate is known, so the scripted reader works offline) or upload your own — a live in-browser model reads a photo it has never seen.",seedImages:ea},scriptedVision:na,handlers:[{elementId:"ExtractPlate",standsInFor:"Vision model — Florence-2 <OCR> on WebGPU (in-browser)",source:ta},{elementId:"RecordResult",standsInFor:"Script task — records the governed outcome",source:ra}]},rn=[us,ki,rs,ls,bs,oa];function dn(){return"/pr-preview/pr-105/"}function ia(e){const n=dn();return e.startsWith(n)?"/"+e.slice(n.length):e}function sa(e=location.pathname){const t=ia(e).match(/^\/examples\/([^/]+)\/?$/);if(t)try{return{kind:"example",id:decodeURIComponent(t[1])}}catch{return{kind:"gallery"}}return{kind:"gallery"}}function aa(e=location.search){return new URLSearchParams(e).get("embed")==="1"}function la(){return dn()}function st(e){return`${dn()}examples/${encodeURIComponent(e)}`}const at="p";function ca(){const e=new URLSearchParams(location.search),n=e.get(at);if(!n)return!1;const t=n.replace(/[\t\n\r]/g,"");if(!t.startsWith("/")||t.startsWith("//")||t.startsWith("/\\"))return!1;e.delete(at);try{const r=new URL(dn(),location.href),o=new URL(t.slice(1),r);return o.origin!==location.origin?!1:(o.search=e.toString(),o.hash=location.hash,history.replaceState(null,"",o),!0)}catch{return!1}}function lt(e,n={}){const t=new URL(location.href);t.pathname=e,t.search=n.search??t.search,n.hash!==void 0&&(t.hash=n.hash),n.replace?history.replaceState(history.state,"",t):history.pushState(history.state,"",t),window.dispatchEvent(new PopStateEvent("popstate"))}function ct(){return{route:sa(),embed:aa()}}function da(){const[e,n]=h.useState(ct);return h.useEffect(()=>{const t=()=>n(ct());return window.addEventListener("popstate",t),()=>window.removeEventListener("popstate",t)},[]),e}const ua="web-demo-framework:height",ma="web-demo-framework:request-height";function pa(e){return{type:ua,height:Math.ceil(e)}}const dt="embed-height-auto";function ga(e){h.useEffect(()=>{if(!e||typeof window>"u"||window.parent===window)return;const n=document.documentElement;n.classList.add(dt);let t=-1;const r=(l=!1)=>{const u=document.documentElement.scrollHeight;!l&&Math.abs(u-t)<2||(t=u,window.parent.postMessage(pa(u),"*"))},o=l=>{if(l.source!==window.parent)return;const u=l.data;!u||u.type!==ma||r(!0)};window.addEventListener("message",o),r();const a=new ResizeObserver(()=>r());return a.observe(n),()=>{a.disconnect(),window.removeEventListener("message",o),n.classList.remove(dt)}},[e])}function ha(){const{route:e,embed:n}=da(),t=jt().brain,r=Oo();ga(n);const o=e.kind==="example"?e.id:rn[0].id,a=rn.find(m=>m.id===o)??rn[0],l=m=>{lt(st(m),{hash:location.hash})},u=i.jsxs(i.Fragment,{children:[!n&&e.kind==="gallery"&&i.jsx("nav",{className:"example-picker",children:rn.map(m=>i.jsx(Q,{size:"sm",variant:m.id===a.id?"default":"secondary",onClick:()=>l(m.id),children:m.title},m.id))}),!n&&e.kind==="example"&&i.jsx("div",{className:"example-nav",children:i.jsx(Q,{size:"sm",variant:"secondary",onClick:()=>lt(la()),children:"← All examples"})}),i.jsxs("div",{className:"example-meta",children:[a.docsUrl&&i.jsx("a",{className:"docs-link",href:a.docsUrl,target:"_blank",rel:"noreferrer noopener",children:"View on camunda.com ↗"}),n&&i.jsx("a",{className:"open-full-page",href:st(a.id)+(location.hash||""),target:"_top",rel:"noreferrer",children:"Open full page ↗"})]}),i.jsx(Zo,{example:a,initialBrainKind:t,initialTourId:r},a.id)]});return n?i.jsx("div",{className:"c4-ui app-shell app-embed",children:i.jsx("main",{id:"main",className:"layout layout-embed",children:u})}):i.jsxs("div",{className:"c4-ui app-shell",children:[i.jsx(Qt,{appName:"Runnable Camunda examples",trailing:i.jsx("span",{className:"app-subtitle",children:"model + code + optional LLM, in your browser"})}),i.jsx("main",{id:"main",className:"layout",children:u})]})}ca();zt.createRoot(document.getElementById("root")).render(i.jsx(h.StrictMode,{children:i.jsx(Jt,{children:i.jsx(ha,{})})}));export{ue as _,wa as c};
