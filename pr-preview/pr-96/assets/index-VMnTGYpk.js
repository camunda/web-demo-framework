const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/driver-CTZuBZOi.css","assets/diagram-js-DAKGYcfb.css","assets/bpmn-embedded-CuGmHMCm.css","assets/RuntimeDiagram-B2IYfHo7.js","assets/vendor-react-9Ma26nY1.js","assets/Viewer-D_7S4Gwm.js","assets/MonacoEditor-CCmQHQ5C.js","assets/MonacoEditor-MXtAqGtx.css","assets/vendor-modeler-DiOUSqPF.js","assets/vendor-design-system-BEvMeYeY.js","assets/vendor-design-system-DPqzB6vO.css","assets/parser-DkgAe_kI.js","assets/ModelEditor-Dwlgp6JA.css","assets/FormRenderer-54sFnlnK.js","assets/FormRenderer-D1JIHOW6.css"])))=>i.map(i=>d[i]);
var Ct=Object.defineProperty;var Pt=(e,n,t)=>n in e?Ct(e,n,{enumerable:!0,configurable:!0,writable:!0,value:t}):e[n]=t;var O=(e,n,t)=>Pt(e,typeof n!="symbol"?n+"":n,t);import{r as h,j as a,i as Lt}from"./vendor-react-9Ma26nY1.js";import{B as Q,a as J,L as Be,S as Xn,b as et,c as nt,d as tt,e as rt,A as se,f as ce,g as le,I as rn,C as Bt,h as Rt,i as zt,j as Ot,k as Ft,l as Ut,T as $t,m as Gt,n as Je,o as He,p as Vt,q as Yt}from"./vendor-design-system-BEvMeYeY.js";(function(){const n=document.createElement("link").relList;if(n&&n.supports&&n.supports("modulepreload"))return;for(const i of document.querySelectorAll('link[rel="modulepreload"]'))r(i);new MutationObserver(i=>{for(const s of i)if(s.type==="childList")for(const l of s.addedNodes)l.tagName==="LINK"&&l.rel==="modulepreload"&&r(l)}).observe(document,{childList:!0,subtree:!0});function t(i){const s={};return i.integrity&&(s.integrity=i.integrity),i.referrerPolicy&&(s.referrerPolicy=i.referrerPolicy),i.crossOrigin==="use-credentials"?s.credentials="include":i.crossOrigin==="anonymous"?s.credentials="omit":s.credentials="same-origin",s}function r(i){if(i.ep)return;i.ep=!0;const s=t(i);fetch(i.href,s)}})();const Qt="modulepreload",Jt=function(e){return"/pr-preview/pr-96/"+e},kn={},de=function(n,t,r){let i=Promise.resolve();if(t&&t.length>0){let l=function(o){return Promise.all(o.map(c=>Promise.resolve(c).then(g=>({status:"fulfilled",value:g}),g=>({status:"rejected",reason:g}))))};document.getElementsByTagName("link");const u=document.querySelector("meta[property=csp-nonce]"),m=(u==null?void 0:u.nonce)||(u==null?void 0:u.getAttribute("nonce"));i=l(t.map(o=>{if(o=Jt(o),o in kn)return;kn[o]=!0;const c=o.endsWith(".css"),g=c?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${o}"]${g}`))return;const p=document.createElement("link");if(p.rel=c?"stylesheet":Qt,c||(p.as="script"),p.crossOrigin="",p.href=o,m&&p.setAttribute("nonce",m),document.head.appendChild(p),c)return new Promise((_,b)=>{p.addEventListener("load",_),p.addEventListener("error",()=>b(new Error(`Unable to preload CSS for ${o}`)))})}))}function s(l){const u=new Event("vite:preloadError",{cancelable:!0});if(u.payload=l,window.dispatchEvent(u),!u.defaultPrevented)throw l}return i.then(l=>{for(const u of l||[])u.status==="rejected"&&s(u.reason);return n().catch(s)})},Ht="io.camunda.agenticai:aiagent",Me="http://www.omg.org/spec/BPMN/20100524/MODEL",qt="http://camunda.org/schema/zeebe/1.0";function dn(e,n){return Array.from(e.getElementsByTagNameNS(qt,n))}function it(e,n){return dn(e,n).filter(t=>Wt(t)===e)}function Wt(e){let n=e.parentElement;for(;n;){if(n.namespaceURI===Me&&n.localName!=="extensionElements")return n;n=n.parentElement}return null}function hn(e){const n=it(e,"taskDefinition")[0],t=n==null?void 0:n.getAttribute("type");return t||(e.localName==="scriptTask"?e.getAttribute("id")??null:null)}function En(e){const n=Array.from(e.children).find(t=>t.namespaceURI===Me&&t.localName==="documentation");return((n==null?void 0:n.textContent)??"").trim()}function Tn(e){if(!e)return"";const n=e.startsWith("=")?e.slice(1):e,t=n.match(/"((?:[^"\\]|\\.)*)"/g);return t?t.map(r=>r.slice(1,-1).replace(/\\n/g,`
...
`)}async function Ar(e,n,t,r,i,s){let l="";n({kind:"llm",text:"LLM thinking…",key:t,pending:!0,turn:s});const u=await e(r,i,m=>{l+=m,n({kind:"llm",text:`${un(l)} ▍`,key:t,pending:!0,turn:s})});return n({kind:"llm",text:un(u||l)||"(empty reply)",key:t,pending:!1,turn:s}),u}function Dr(e,n){switch(e){case"number":return typeof n=="number"&&Number.isFinite(n)?{ok:!0,value:n}:typeof n=="string"&&n.trim()!==""&&Number.isFinite(Number(n))?{ok:!0,value:Number(n)}:{ok:!1};case"boolean":return typeof n=="boolean"?{ok:!0,value:n}:typeof n=="string"&&/^(true|false)$/i.test(n.trim())?{ok:!0,value:n.trim().toLowerCase()==="true"}:{ok:!1};default:return typeof n=="object"?{ok:!1}:{ok:!0,value:String(n)}}}function Cr(e,n,t){const r={},i=new Map,s=new Map;for(const{tool:l,args:u}of e){const m={};for(const o of l.args){const c=u[o.name];if(!(c!=null&&c!=="")){n({kind:"error",text:`🤖 ${l.elementId}: model supplied no value for "${o.name}"`,turn:t,elementId:l.elementId});continue}const p=i.get(o.name);if(p!==void 0&&p!==l.elementId){n({kind:"error",text:`🤖 argument name collision on "${o.name}": both ${p} and ${l.elementId} declare it — ${p} already claimed it this turn, ${l.elementId}'s value is dropped`,turn:t,elementId:l.elementId});continue}const _=Dr(o.type,c);if(!_.ok){n({kind:"error",text:`🤖 ${l.elementId}: "${o.name}" is declared as ${o.type} but the model supplied ${JSON.stringify(c)} — rejected, not passed through`,turn:t,elementId:l.elementId});continue}r[o.name]=_.value,m[o.name]=_.value,i.set(o.name,l.elementId)}s.set(l.elementId,m)}return{variablesOut:r,forHistory:s}}function Pr(e,n,t,r={}){const{maxNewTokens:i=384,allowRepeats:s=!1,allowMultiToolTurns:l=!1,turnRef:u,requiredTools:m=[],maxEarlyDoneNudges:o=1}=r;let c=0;const g=new Set,p=[];let _=0,b=[],y=[];return async f=>{const M=f.variables,k=M.toolCallResult;for(k!==void 0&&p.length&&(p[p.length-1]=`${p[p.length-1]} → ${un(JSON.stringify(k),160)}`);;){const V=await P();if(V)return V}async function P(){if(c+=1,u&&(u.current=c),c>e.maxModelCalls)return t({kind:"error",text:`Turn budget spent (maxModelCalls=${e.maxModelCalls}) — completing the agent.`,turn:c}),{completionConditionFulfilled:!0};const V=s?e.tools:e.tools.filter(D=>!g.has(D.elementId)),q=[{role:"system",content:jr(e,l,V)},{role:"user",content:Sr(e,M,p,V,b,y,s)}];b=[],y=[];let ue;try{ue=await Ar(n,t,`llm-turn-${c}`,q,i,c)}catch(D){return t({kind:"error",text:`LLM call failed: ${D instanceof Error?D.message:String(D)} — completing the agent.`,turn:c}),{completionConditionFulfilled:!0}}const Y=Er(ue);if(Tr(Y)&&An(Y).length===0){const D=m.filter(W=>!g.has(W));return D.length&&_<o?(_+=1,b=D,t({kind:"agent",text:`🤖 model says it is done, but ${D.join(", ")} hasn't run — asking once more`,turn:c}),null):(t({kind:"agent",text:"🤖 model says it is done",turn:c}),{completionConditionFulfilled:!0})}const oe=An(Y);if(oe.length===0)return t({kind:"error",text:"🤖 model named no tool (and didn't say it was done) — asking again",turn:c}),y=['it named no tool and did not say it was done — reply with {"tool": "...", "arguments": {...}} or {"done": true}'],null;const U=[],I=[],N=[];for(const D of oe){const W=e.tools.find(fe=>fe.elementId===D.name);if(!W){I.push(D.name);continue}if(!s&&g.has(W.elementId)){N.push(W.elementId);continue}U.push({tool:W,args:D.args})}if(I.length&&t({kind:"error",text:`🤖 model named a tool that doesn't exist: ${I.join(", ")} — nothing activated`,turn:c}),N.length&&t({kind:"error",text:`🤖 model asked to re-run ${N.join(", ")} — skipped (already run)`,turn:c}),U.length===0)return t({kind:"agent",text:"🤖 nothing activated — asking again",turn:c}),y=[...I.length?[`${I.join(", ")} ${I.length===1?"is":"are"} not a real tool`]:[],...N.length?[`${N.join(", ")} has already run and will never run again — pick a different tool, or reply {"done": true} if nothing is left to do`]:[]],null;const{variablesOut:A,forHistory:ee}=Cr(U,t,c);for(const{tool:D}of U)g.add(D.elementId),p.push(`- ${D.elementId}(${JSON.stringify(ee.get(D.elementId))})`);for(const{tool:D}of U)t({kind:"agent",text:`🤖 calling ${D.elementId}`,turn:c,elementId:D.elementId,args:ee.get(D.elementId)??{}});return{activateElements:U.map(D=>({elementId:D.tool.elementId})),variables:A}}}}function Lr(e,n,t,r={}){const i=new Map(e.map(s=>[s.elementId,Pr(s,n,t,r)]));return async s=>{const l=i.get(s.elementId);if(!l)throw new Error(`No agent host registered for "${s.elementId}"`);return l(s)}}class mn{__destroy_into_raw(){const n=this.__wbg_ptr;return this.__wbg_ptr=0,Cn.unregister(this),n}free(){const n=this.__destroy_into_raw();d.__wbg_testengine_free(n,0)}activateJobs(n,t,r,i){let s,l;try{const _=d.__wbindgen_add_to_stack_pointer(-16),b=S(n,d.__wbindgen_export,d.__wbindgen_export2),y=j,f=S(i,d.__wbindgen_export,d.__wbindgen_export2),M=j;d.testengine_activateJobs(_,this.__wbg_ptr,b,y,t,r,f,M);var u=w().getInt32(_+0,!0),m=w().getInt32(_+4,!0),o=w().getInt32(_+8,!0),c=w().getInt32(_+12,!0),g=u,p=m;if(c)throw g=0,p=0,z(o);return s=g,l=p,B(g,p)}finally{d.__wbindgen_add_to_stack_pointer(16),d.__wbindgen_export3(s,l,1)}}advanceTime(n){let t,r;try{const c=d.__wbindgen_add_to_stack_pointer(-16);d.testengine_advanceTime(c,this.__wbg_ptr,n);var i=w().getInt32(c+0,!0),s=w().getInt32(c+4,!0),l=w().getInt32(c+8,!0),u=w().getInt32(c+12,!0),m=i,o=s;if(u)throw m=0,o=0,z(l);return t=m,r=o,B(m,o)}finally{d.__wbindgen_add_to_stack_pointer(16),d.__wbindgen_export3(t,r,1)}}assignUserTask(n,t,r){let i,s;try{const p=d.__wbindgen_add_to_stack_pointer(-16),_=S(n,d.__wbindgen_export,d.__wbindgen_export2),b=j,y=S(t,d.__wbindgen_export,d.__wbindgen_export2),f=j;d.testengine_assignUserTask(p,this.__wbg_ptr,_,b,y,f,r);var l=w().getInt32(p+0,!0),u=w().getInt32(p+4,!0),m=w().getInt32(p+8,!0),o=w().getInt32(p+12,!0),c=l,g=u;if(o)throw c=0,g=0,z(m);return i=c,s=g,B(c,g)}finally{d.__wbindgen_add_to_stack_pointer(16),d.__wbindgen_export3(i,s,1)}}broadcastSignal(n,t){let r,i;try{const g=d.__wbindgen_add_to_stack_pointer(-16),p=S(n,d.__wbindgen_export,d.__wbindgen_export2),_=j,b=S(t,d.__wbindgen_export,d.__wbindgen_export2),y=j;d.testengine_broadcastSignal(g,this.__wbg_ptr,p,_,b,y);var s=w().getInt32(g+0,!0),l=w().getInt32(g+4,!0),u=w().getInt32(g+8,!0),m=w().getInt32(g+12,!0),o=s,c=l;if(m)throw o=0,c=0,z(u);return r=o,i=c,B(o,c)}finally{d.__wbindgen_add_to_stack_pointer(16),d.__wbindgen_export3(r,i,1)}}cancelInstance(n){let t,r;try{const c=d.__wbindgen_add_to_stack_pointer(-16),g=S(n,d.__wbindgen_export,d.__wbindgen_export2),p=j;d.testengine_cancelInstance(c,this.__wbg_ptr,g,p);var i=w().getInt32(c+0,!0),s=w().getInt32(c+4,!0),l=w().getInt32(c+8,!0),u=w().getInt32(c+12,!0),m=i,o=s;if(u)throw m=0,o=0,z(l);return t=m,r=o,B(m,o)}finally{d.__wbindgen_add_to_stack_pointer(16),d.__wbindgen_export3(t,r,1)}}completeAgentJob(n,t,r){let i,s;try{const p=d.__wbindgen_add_to_stack_pointer(-16),_=S(n,d.__wbindgen_export,d.__wbindgen_export2),b=j,y=S(t,d.__wbindgen_export,d.__wbindgen_export2),f=j,M=S(r,d.__wbindgen_export,d.__wbindgen_export2),k=j;d.testengine_completeAgentJob(p,this.__wbg_ptr,_,b,y,f,M,k);var l=w().getInt32(p+0,!0),u=w().getInt32(p+4,!0),m=w().getInt32(p+8,!0),o=w().getInt32(p+12,!0),c=l,g=u;if(o)throw c=0,g=0,z(m);return i=c,s=g,B(c,g)}finally{d.__wbindgen_add_to_stack_pointer(16),d.__wbindgen_export3(i,s,1)}}completeJob(n,t){let r,i;try{const g=d.__wbindgen_add_to_stack_pointer(-16),p=S(n,d.__wbindgen_export,d.__wbindgen_export2),_=j,b=S(t,d.__wbindgen_export,d.__wbindgen_export2),y=j;d.testengine_completeJob(g,this.__wbg_ptr,p,_,b,y);var s=w().getInt32(g+0,!0),l=w().getInt32(g+4,!0),u=w().getInt32(g+8,!0),m=w().getInt32(g+12,!0),o=s,c=l;if(m)throw o=0,c=0,z(u);return r=o,i=c,B(o,c)}finally{d.__wbindgen_add_to_stack_pointer(16),d.__wbindgen_export3(r,i,1)}}completeUserTask(n,t){let r,i;try{const g=d.__wbindgen_add_to_stack_pointer(-16),p=S(n,d.__wbindgen_export,d.__wbindgen_export2),_=j,b=S(t,d.__wbindgen_export,d.__wbindgen_export2),y=j;d.testengine_completeUserTask(g,this.__wbg_ptr,p,_,b,y);var s=w().getInt32(g+0,!0),l=w().getInt32(g+4,!0),u=w().getInt32(g+8,!0),m=w().getInt32(g+12,!0),o=s,c=l;if(m)throw o=0,c=0,z(u);return r=o,i=c,B(o,c)}finally{d.__wbindgen_add_to_stack_pointer(16),d.__wbindgen_export3(r,i,1)}}correlateMessage(n,t,r){let i,s;try{const p=d.__wbindgen_add_to_stack_pointer(-16),_=S(n,d.__wbindgen_export,d.__wbindgen_export2),b=j,y=S(t,d.__wbindgen_export,d.__wbindgen_export2),f=j,M=S(r,d.__wbindgen_export,d.__wbindgen_export2),k=j;d.testengine_correlateMessage(p,this.__wbg_ptr,_,b,y,f,M,k);var l=w().getInt32(p+0,!0),u=w().getInt32(p+4,!0),m=w().getInt32(p+8,!0),o=w().getInt32(p+12,!0),c=l,g=u;if(o)throw c=0,g=0,z(m);return i=c,s=g,B(c,g)}finally{d.__wbindgen_add_to_stack_pointer(16),d.__wbindgen_export3(i,s,1)}}createInstance(n,t,r){let i,s;try{const p=d.__wbindgen_add_to_stack_pointer(-16),_=S(n,d.__wbindgen_export,d.__wbindgen_export2),b=j,y=S(t,d.__wbindgen_export,d.__wbindgen_export2),f=j;d.testengine_createInstance(p,this.__wbg_ptr,_,b,y,f,Fr(r)?Number.MAX_SAFE_INTEGER:r>>0);var l=w().getInt32(p+0,!0),u=w().getInt32(p+4,!0),m=w().getInt32(p+8,!0),o=w().getInt32(p+12,!0),c=l,g=u;if(o)throw c=0,g=0,z(m);return i=c,s=g,B(c,g)}finally{d.__wbindgen_add_to_stack_pointer(16),d.__wbindgen_export3(i,s,1)}}debugClear(){d.testengine_debugClear(this.__wbg_ptr)}debugCreateInstance(n,t,r){let i,s;try{const p=d.__wbindgen_add_to_stack_pointer(-16),_=S(n,d.__wbindgen_export,d.__wbindgen_export2),b=j,y=S(t,d.__wbindgen_export,d.__wbindgen_export2),f=j,M=S(r,d.__wbindgen_export,d.__wbindgen_export2),k=j;d.testengine_debugCreateInstance(p,this.__wbg_ptr,_,b,y,f,M,k);var l=w().getInt32(p+0,!0),u=w().getInt32(p+4,!0),m=w().getInt32(p+8,!0),o=w().getInt32(p+12,!0),c=l,g=u;if(o)throw c=0,g=0,z(m);return i=c,s=g,B(c,g)}finally{d.__wbindgen_add_to_stack_pointer(16),d.__wbindgen_export3(i,s,1)}}get debugIsPaused(){return d.testengine_debugIsPaused(this.__wbg_ptr)!==0}debugResume(){let n,t;try{const o=d.__wbindgen_add_to_stack_pointer(-16);d.testengine_debugResume(o,this.__wbg_ptr);var r=w().getInt32(o+0,!0),i=w().getInt32(o+4,!0),s=w().getInt32(o+8,!0),l=w().getInt32(o+12,!0),u=r,m=i;if(l)throw u=0,m=0,z(s);return n=u,t=m,B(u,m)}finally{d.__wbindgen_add_to_stack_pointer(16),d.__wbindgen_export3(n,t,1)}}debugStep(){let n,t;try{const o=d.__wbindgen_add_to_stack_pointer(-16);d.testengine_debugStep(o,this.__wbg_ptr);var r=w().getInt32(o+0,!0),i=w().getInt32(o+4,!0),s=w().getInt32(o+8,!0),l=w().getInt32(o+12,!0),u=r,m=i;if(l)throw u=0,m=0,z(s);return n=u,t=m,B(u,m)}finally{d.__wbindgen_add_to_stack_pointer(16),d.__wbindgen_export3(n,t,1)}}deploy(n){let t,r;try{const c=d.__wbindgen_add_to_stack_pointer(-16),g=S(n,d.__wbindgen_export,d.__wbindgen_export2),p=j;d.testengine_deploy(c,this.__wbg_ptr,g,p);var i=w().getInt32(c+0,!0),s=w().getInt32(c+4,!0),l=w().getInt32(c+8,!0),u=w().getInt32(c+12,!0),m=i,o=s;if(u)throw m=0,o=0,z(l);return t=m,r=o,B(m,o)}finally{d.__wbindgen_add_to_stack_pointer(16),d.__wbindgen_export3(t,r,1)}}deployForm(n){let t,r;try{const c=d.__wbindgen_add_to_stack_pointer(-16),g=S(n,d.__wbindgen_export,d.__wbindgen_export2),p=j;d.testengine_deployForm(c,this.__wbg_ptr,g,p);var i=w().getInt32(c+0,!0),s=w().getInt32(c+4,!0),l=w().getInt32(c+8,!0),u=w().getInt32(c+12,!0),m=i,o=s;if(u)throw m=0,o=0,z(l);return t=m,r=o,B(m,o)}finally{d.__wbindgen_add_to_stack_pointer(16),d.__wbindgen_export3(t,r,1)}}deployResource(n,t){let r,i;try{const g=d.__wbindgen_add_to_stack_pointer(-16),p=S(n,d.__wbindgen_export,d.__wbindgen_export2),_=j,b=S(t,d.__wbindgen_export,d.__wbindgen_export2),y=j;d.testengine_deployResource(g,this.__wbg_ptr,p,_,b,y);var s=w().getInt32(g+0,!0),l=w().getInt32(g+4,!0),u=w().getInt32(g+8,!0),m=w().getInt32(g+12,!0),o=s,c=l;if(m)throw o=0,c=0,z(u);return r=o,i=c,B(o,c)}finally{d.__wbindgen_add_to_stack_pointer(16),d.__wbindgen_export3(r,i,1)}}events(){let n,t;try{const o=d.__wbindgen_add_to_stack_pointer(-16);d.testengine_events(o,this.__wbg_ptr);var r=w().getInt32(o+0,!0),i=w().getInt32(o+4,!0),s=w().getInt32(o+8,!0),l=w().getInt32(o+12,!0),u=r,m=i;if(l)throw u=0,m=0,z(s);return n=u,t=m,B(u,m)}finally{d.__wbindgen_add_to_stack_pointer(16),d.__wbindgen_export3(n,t,1)}}failJob(n,t,r){let i,s;try{const p=d.__wbindgen_add_to_stack_pointer(-16),_=S(n,d.__wbindgen_export,d.__wbindgen_export2),b=j,y=S(r,d.__wbindgen_export,d.__wbindgen_export2),f=j;d.testengine_failJob(p,this.__wbg_ptr,_,b,t,y,f);var l=w().getInt32(p+0,!0),u=w().getInt32(p+4,!0),m=w().getInt32(p+8,!0),o=w().getInt32(p+12,!0),c=l,g=u;if(o)throw c=0,g=0,z(m);return i=c,s=g,B(c,g)}finally{d.__wbindgen_add_to_stack_pointer(16),d.__wbindgen_export3(i,s,1)}}migrate(n,t,r){let i,s;try{const p=d.__wbindgen_add_to_stack_pointer(-16),_=S(n,d.__wbindgen_export,d.__wbindgen_export2),b=j,y=S(t,d.__wbindgen_export,d.__wbindgen_export2),f=j,M=S(r,d.__wbindgen_export,d.__wbindgen_export2),k=j;d.testengine_migrate(p,this.__wbg_ptr,_,b,y,f,M,k);var l=w().getInt32(p+0,!0),u=w().getInt32(p+4,!0),m=w().getInt32(p+8,!0),o=w().getInt32(p+12,!0),c=l,g=u;if(o)throw c=0,g=0,z(m);return i=c,s=g,B(c,g)}finally{d.__wbindgen_add_to_stack_pointer(16),d.__wbindgen_export3(i,s,1)}}modify(n,t,r){let i,s;try{const p=d.__wbindgen_add_to_stack_pointer(-16),_=S(n,d.__wbindgen_export,d.__wbindgen_export2),b=j,y=S(t,d.__wbindgen_export,d.__wbindgen_export2),f=j,M=S(r,d.__wbindgen_export,d.__wbindgen_export2),k=j;d.testengine_modify(p,this.__wbg_ptr,_,b,y,f,M,k);var l=w().getInt32(p+0,!0),u=w().getInt32(p+4,!0),m=w().getInt32(p+8,!0),o=w().getInt32(p+12,!0),c=l,g=u;if(o)throw c=0,g=0,z(m);return i=c,s=g,B(c,g)}finally{d.__wbindgen_add_to_stack_pointer(16),d.__wbindgen_export3(i,s,1)}}constructor(){const n=d.testengine_new();return this.__wbg_ptr=n,Cn.register(this,this.__wbg_ptr,this),this}get now(){return d.testengine_now(this.__wbg_ptr)}reset(){d.testengine_reset(this.__wbg_ptr)}resolveIncident(n){let t,r;try{const c=d.__wbindgen_add_to_stack_pointer(-16),g=S(n,d.__wbindgen_export,d.__wbindgen_export2),p=j;d.testengine_resolveIncident(c,this.__wbg_ptr,g,p);var i=w().getInt32(c+0,!0),s=w().getInt32(c+4,!0),l=w().getInt32(c+8,!0),u=w().getInt32(c+12,!0),m=i,o=s;if(u)throw m=0,o=0,z(l);return t=m,r=o,B(m,o)}finally{d.__wbindgen_add_to_stack_pointer(16),d.__wbindgen_export3(t,r,1)}}setVariables(n,t,r){let i,s;try{const p=d.__wbindgen_add_to_stack_pointer(-16),_=S(n,d.__wbindgen_export,d.__wbindgen_export2),b=j,y=S(t,d.__wbindgen_export,d.__wbindgen_export2),f=j;d.testengine_setVariables(p,this.__wbg_ptr,_,b,y,f,r);var l=w().getInt32(p+0,!0),u=w().getInt32(p+4,!0),m=w().getInt32(p+8,!0),o=w().getInt32(p+12,!0),c=l,g=u;if(o)throw c=0,g=0,z(m);return i=c,s=g,B(c,g)}finally{d.__wbindgen_add_to_stack_pointer(16),d.__wbindgen_export3(i,s,1)}}snapshot(){let n,t;try{const o=d.__wbindgen_add_to_stack_pointer(-16);d.testengine_snapshot(o,this.__wbg_ptr);var r=w().getInt32(o+0,!0),i=w().getInt32(o+4,!0),s=w().getInt32(o+8,!0),l=w().getInt32(o+12,!0),u=r,m=i;if(l)throw u=0,m=0,z(s);return n=u,t=m,B(u,m)}finally{d.__wbindgen_add_to_stack_pointer(16),d.__wbindgen_export3(n,t,1)}}throwError(n,t,r){let i,s;try{const p=d.__wbindgen_add_to_stack_pointer(-16),_=S(n,d.__wbindgen_export,d.__wbindgen_export2),b=j,y=S(t,d.__wbindgen_export,d.__wbindgen_export2),f=j,M=S(r,d.__wbindgen_export,d.__wbindgen_export2),k=j;d.testengine_throwError(p,this.__wbg_ptr,_,b,y,f,M,k);var l=w().getInt32(p+0,!0),u=w().getInt32(p+4,!0),m=w().getInt32(p+8,!0),o=w().getInt32(p+12,!0),c=l,g=u;if(o)throw c=0,g=0,z(m);return i=c,s=g,B(c,g)}finally{d.__wbindgen_add_to_stack_pointer(16),d.__wbindgen_export3(i,s,1)}}tickNow(n){let t,r;try{const c=d.__wbindgen_add_to_stack_pointer(-16);d.testengine_tickNow(c,this.__wbg_ptr,n);var i=w().getInt32(c+0,!0),s=w().getInt32(c+4,!0),l=w().getInt32(c+8,!0),u=w().getInt32(c+12,!0),m=i,o=s;if(u)throw m=0,o=0,z(l);return t=m,r=o,B(m,o)}finally{d.__wbindgen_add_to_stack_pointer(16),d.__wbindgen_export3(t,r,1)}}unassignUserTask(n){let t,r;try{const c=d.__wbindgen_add_to_stack_pointer(-16),g=S(n,d.__wbindgen_export,d.__wbindgen_export2),p=j;d.testengine_unassignUserTask(c,this.__wbg_ptr,g,p);var i=w().getInt32(c+0,!0),s=w().getInt32(c+4,!0),l=w().getInt32(c+8,!0),u=w().getInt32(c+12,!0),m=i,o=s;if(u)throw m=0,o=0,z(l);return t=m,r=o,B(m,o)}finally{d.__wbindgen_add_to_stack_pointer(16),d.__wbindgen_export3(t,r,1)}}updateRetries(n,t){let r,i;try{const g=d.__wbindgen_add_to_stack_pointer(-16),p=S(n,d.__wbindgen_export,d.__wbindgen_export2),_=j;d.testengine_updateRetries(g,this.__wbg_ptr,p,_,t);var s=w().getInt32(g+0,!0),l=w().getInt32(g+4,!0),u=w().getInt32(g+8,!0),m=w().getInt32(g+12,!0),o=s,c=l;if(m)throw o=0,c=0,z(u);return r=o,i=c,B(o,c)}finally{d.__wbindgen_add_to_stack_pointer(16),d.__wbindgen_export3(r,i,1)}}updateUserTask(n,t){let r,i;try{const g=d.__wbindgen_add_to_stack_pointer(-16),p=S(n,d.__wbindgen_export,d.__wbindgen_export2),_=j,b=S(t,d.__wbindgen_export,d.__wbindgen_export2),y=j;d.testengine_updateUserTask(g,this.__wbg_ptr,p,_,b,y);var s=w().getInt32(g+0,!0),l=w().getInt32(g+4,!0),u=w().getInt32(g+8,!0),m=w().getInt32(g+12,!0),o=s,c=l;if(m)throw o=0,c=0,z(u);return r=o,i=c,B(o,c)}finally{d.__wbindgen_add_to_stack_pointer(16),d.__wbindgen_export3(r,i,1)}}}Symbol.dispose&&(mn.prototype[Symbol.dispose]=mn.prototype.free);function Br(){return{__proto__:null,"./nanobpmn_engine_bg.js":{__proto__:null,__wbg___wbindgen_throw_bb96b2010945f0bc:function(n,t){throw new Error(B(n,t))},__wbindgen_cast_0000000000000001:function(n,t){const r=B(n,t);return Rr(r)},__wbindgen_object_drop_ref:function(n){z(n)}}}}const Cn=typeof FinalizationRegistry>"u"?{register:()=>{},unregister:()=>{}}:new FinalizationRegistry(e=>d.__wbg_testengine_free(e,1));function Rr(e){$e===ye.length&&ye.push(ye.length+1);const n=$e;return $e=ye[n],ye[n]=e,n}function zr(e){e<1028||(ye[e]=$e,$e=e)}let Ae=null;function w(){return(Ae===null||Ae.buffer.detached===!0||Ae.buffer.detached===void 0&&Ae.buffer!==d.memory.buffer)&&(Ae=new DataView(d.memory.buffer)),Ae}function B(e,n){return $r(e>>>0,n)}let Ue=null;function Ke(){return(Ue===null||Ue.byteLength===0)&&(Ue=new Uint8Array(d.memory.buffer)),Ue}function Or(e){return ye[e]}let ye=new Array(1024).fill(void 0);ye.push(void 0,null,!0,!1);let $e=ye.length;function Fr(e){return e==null}function S(e,n,t){if(t===void 0){const u=Ge.encode(e),m=n(u.length,1)>>>0;return Ke().subarray(m,m+u.length).set(u),j=u.length,m}let r=e.length,i=n(r,1)>>>0;const s=Ke();let l=0;for(;l<r;l++){const u=e.charCodeAt(l);if(u>127)break;s[i+l]=u}if(l!==r){l!==0&&(e=e.slice(l)),i=t(i,r,r=l+e.length*3,1)>>>0;const u=Ke().subarray(i+l,i+r),m=Ge.encodeInto(e,u);l+=m.written,i=t(i,r,l,1)>>>0}return j=l,i}function z(e){const n=Or(e);return zr(e),n}let Xe=new TextDecoder("utf-8",{ignoreBOM:!0,fatal:!0});Xe.decode();const Ur=2146435072;let on=0;function $r(e,n){return on+=n,on>=Ur&&(Xe=new TextDecoder("utf-8",{ignoreBOM:!0,fatal:!0}),Xe.decode(),on=n),Xe.decode(Ke().subarray(e,e+n))}const Ge=new TextEncoder;"encodeInto"in Ge||(Ge.encodeInto=function(e,n){const t=Ge.encode(e);return n.set(t),{read:e.length,written:t.length}});let j=0,d;function Gr(e,n){return d=e.exports,Ae=null,Ue=null,d}async function Vr(e,n){if(typeof Response=="function"&&e instanceof Response){if(!e.ok)throw new Error(`failed to fetch Wasm: ${e.status} ${e.statusText} fetching '${e.url}'`);if(typeof WebAssembly.instantiateStreaming=="function")try{return await WebAssembly.instantiateStreaming(e,n)}catch(i){if(t(e.type)&&e.headers.get("Content-Type")!=="application/wasm")console.warn("`WebAssembly.instantiateStreaming` failed because your server does not serve Wasm with `application/wasm` MIME type. Falling back to `WebAssembly.instantiate` which is slower. Original error:\n",i);else throw i}const r=await e.arrayBuffer();return await WebAssembly.instantiate(r,n)}else{const r=await WebAssembly.instantiate(e,n);return r instanceof WebAssembly.Instance?{instance:r,module:e}:r}function t(r){switch(r){case"basic":case"cors":case"default":return!0}return!1}}async function Yr(e){if(d!==void 0)return d;e!==void 0&&(Object.getPrototypeOf(e)===Object.prototype?{module_or_path:e}=e:console.warn("using deprecated parameters for the initialization function; pass a single object instead")),e===void 0&&(e=new URL("/pr-preview/pr-96/assets/nanobpmn_engine_bg-DRNrIVE8.wasm",import.meta.url));const n=Br();(typeof e=="string"||typeof Request=="function"&&e instanceof Request||typeof URL=="function"&&e instanceof URL)&&(e=fetch(e));const{instance:t,module:r}=await Vr(await e,n);return Gr(t)}let qe=null;function Qr(e){return qe||(qe=Yr(void 0).then(()=>{}).catch(n=>{throw qe=null,n})),qe}function H(e){return JSON.parse(e)}class Jr{constructor(n){O(this,"engine");this.engine=n}deploy(n){return JSON.parse(this.engine.deploy(n))}createInstance(n,t){return H(this.engine.createInstance(n,t||"{}"))}activateJobs(n,t,r,i){return JSON.parse(this.engine.activateJobs(n,t,r,i))}completeJob(n,t){return H(this.engine.completeJob(n,t||"{}"))}completeAgentJob(n,t){const{variables:r,...i}=t??{};return H(this.engine.completeAgentJob(n,JSON.stringify(r??{}),JSON.stringify(i??{})))}failJob(n,t,r){return H(this.engine.failJob(n,t,r))}throwError(n,t,r){return H(this.engine.throwError(n,t,r))}updateRetries(n,t){return H(this.engine.updateRetries(n,t))}resolveIncident(n){return H(this.engine.resolveIncident(n))}setVariables(n,t,r){return H(this.engine.setVariables(n,t||"{}",r))}broadcastSignal(n,t){return H(this.engine.broadcastSignal(n,t||"{}"))}cancelInstance(n){return H(this.engine.cancelInstance(n))}modify(n,t,r){return H(this.engine.modify(n,JSON.stringify(t??[]),JSON.stringify(r??[])))}completeUserTask(n,t){return H(this.engine.completeUserTask(n,t||"{}"))}assignUserTask(n,t,r){return H(this.engine.assignUserTask(n,t,r))}unassignUserTask(n){return H(this.engine.unassignUserTask(n))}updateUserTask(n,t){return H(this.engine.updateUserTask(n,t||"{}"))}correlateMessage(n,t,r){return H(this.engine.correlateMessage(n,t,r||"{}"))}advanceTime(n){return H(this.engine.advanceTime(n))}reset(){this.engine.reset()}events(){return JSON.parse(this.engine.events())}snapshot(){return H(this.engine.snapshot())}free(){this.engine.free()}}async function Hr(e){return await Qr(),new Jr(new mn)}class pt extends Error{constructor(t,r){super(t);O(this,"retries");this.name="JobFailure",this.retries=r==null?void 0:r.retries}}function qr(e,n=[]){if(e.instances.filter(i=>!i.completed).length===0)return e.totalInstances>0?"completed":"idle";if(e.incidents.length>0)return"incidents";const r=new Set(n);return e.jobs.some(i=>!r.has(i.jobType))?"unhandledJobs":e.userTasks.some(i=>i.state==="Created")?"userTasks":e.timers.length>0?"timers":e.messageSubscriptions.length>0?"messages":e.signalSubscriptions.length>0?"signals":"idle"}function Wr(e,n=[]){const t=new Set(n);return[...new Set(e.jobs.map(r=>r.jobType))].filter(r=>!t.has(r)).sort()}async function Zr(e,n,t){let r;try{const i=await n(t);r=JSON.stringify(i??{})}catch(i){const s=i instanceof pt&&i.retries!==void 0?i.retries:Math.max(0,t.retries-1),l=i instanceof Error?i.message:String(i);e.failJob(t.key,s,l);return}e.completeJob(t.key,r)}async function Kr(e,n,t){let r;try{r=await n(t),JSON.stringify(r)}catch(i){const s=i instanceof pt&&i.retries!==void 0?i.retries:Math.max(0,t.retries-1),l=i instanceof Error?i.message:String(i);e.failJob(t.key,s,l);return}e.completeAgentJob(t.key,r)}async function Xr(e,n,t={}){const r=t.maxJobsPerActivation??10,i=t.lockTimeoutMs??3e4,s=t.worker??"bojtos",l=t.agents??{};for(const p of Object.keys(l))if(p in n)throw new Error(`dispatchRound: job type "${p}" is registered as both a worker and an agent — register it as exactly one`);const u=[];for(const[p,_]of Object.entries(n))for(const b of e.activateJobs(p,r,i,s))u.push({handler:_,job:b});const m=[];for(const[p,_]of Object.entries(l))for(const b of e.activateJobs(p,r,i,s))m.push({handler:_,job:b});for(const{handler:p,job:_}of u)await Zr(e,p,_);for(const{handler:p,job:_}of m)await Kr(e,p,_);const o=e.snapshot(),c=u.length+m.length;if(c>0)return{snapshot:o,handled:c};const g=[...Object.keys(n),...Object.keys(l)];return{snapshot:o,handled:c,reason:qr(o,g),unhandled:Wr(o,g)}}function ei({bpmn:e}){const n=h.useRef(null),[t,r]=h.useState("loading"),[i,s]=h.useState(null),[l,u]=h.useState([]),[m,o]=h.useState(null),c=h.useRef(e),g=h.useRef(0),p=h.useRef(new Map),_=h.useCallback((I,N)=>{p.current.set(I,N)},[]),b=h.useCallback(I=>p.current.get(I),[]),y=h.useCallback((I,N)=>{const A=I.deploy(N);return c.current=N,p.current.clear(),u(A.processIds),o(null),s(null),A.processIds},[]);h.useEffect(()=>{let I=!1;return r("loading"),u([]),o(null),s(null),Hr().then(N=>{if(I){N.free();return}try{y(N,e)}catch(A){N.free(),s(String(A)),r("error");return}n.current=N,r("ready")}).catch(N=>{I||(s(String(N)),r("error"))}),()=>{var N;I=!0,(N=n.current)==null||N.free(),n.current=null,p.current.clear()}},[e]);const f=h.useCallback(I=>{const N=n.current;if(!N)return null;try{const A=I(N);return o(A),s(null),A}catch(A){return s(String(A)),null}},[]),M=h.useCallback((I,N)=>f(A=>A.createInstance(I,N)),[f]),k=h.useCallback((I,N)=>f(A=>A.completeUserTask(I,N)),[f]),P=h.useCallback(I=>f(N=>N.advanceTime(I)),[f]);function V(I,N){const[A]=I.activateJobs(N,1,3e4,"manual-control");if(!A)throw new Error(`No waiting job of type "${N}" to resolve.`);return A}const q=h.useCallback((I,N)=>f(A=>{const ee=V(A,I);return A.completeJob(ee.key,N)}),[f]),ue=h.useCallback((I,N,A)=>f(ee=>{const D=V(ee,I);return ee.throwError(D.key,N,A)}),[f]),Y=h.useCallback(async(I,N)=>{const A=n.current;if(!A)return null;const ee=g.current;try{const D=await Xr(A,I,N);return n.current!==A||g.current!==ee?null:(o(D.snapshot),s(null),D)}catch(D){return n.current!==A||g.current!==ee||(o(A.snapshot()),s(String(D))),null}},[]),oe=h.useCallback(()=>{const I=n.current;if(I){g.current++;try{I.reset(),y(I,c.current)}catch(N){s(String(N))}}},[y]),U=h.useCallback(I=>{const N=n.current;if(!N)return null;g.current++;try{return N.reset(),y(N,I)}catch(A){return s(String(A)),null}},[y]);return{phase:t,error:i,processIds:l,snapshot:m,createInstance:M,stepWorkers:Y,completeUserTask:k,advanceTime:P,completeJobManually:q,throwJobError:ue,reset:oe,redeploy:U,setRunImage:_,getRunImage:b}}function ni(e,n){return e.slice(n)}function ti(e,n,t,r){const i=e.snapshot,s="⏸ waiting for a human — complete the task below to continue",l=i.userTasks.some(u=>u.state==="Created");if(e.handled>0){const u=i.activeElementIds.map(t),m=n.length?` via ${n.map(o=>`${t(o.from)} → ${t(o.to)}`).join(", ")}`:"";return i.completedInstances>=1?{kind:"done",text:`⏭ round handled ${e.handled} job${e.handled===1?"":"s"}${m} — ✅ process instance completed`}:l?{kind:"human",text:`⏭ round handled ${e.handled} job${e.handled===1?"":"s"}${m} — ${s}`}:{kind:"step",text:`⏭ round handled ${e.handled} job${e.handled===1?"":"s"}${m} — now at ${u.length?u.join(", "):"—"}`}}switch(e.reason){case"completed":return{kind:"done",text:"✅ process instance completed"};case"userTasks":return{kind:"human",text:s};case"timers":return{kind:"step",text:"⏱ waiting on a timer — advance the clock to continue"};case"messages":return{kind:"step",text:"✉ waiting on a message — correlate it to continue"};case"signals":return{kind:"step",text:"📶 waiting on a signal — broadcast it to continue"};case"incidents":return{kind:"error",text:"A job failed — incident on the diagram"};case"unhandledJobs":{const u=e.unhandled??[];return r&&u.length>0&&u.every(m=>r.has(m))?{kind:"human",text:s}:{kind:"error",text:`⏭ waiting on job type(s) with no worker registered: ${u.join(", ")}`}}case"idle":return{kind:"step",text:"Nothing to step — no instance is running."};default:return{kind:"step",text:e.reason?`Step blocked on an unrecognized reason: ${e.reason}`:"Nothing to step — no instance is running."}}}const ri="the Scripted or Endpoint brain";async function ii(){return await Ye()===null}async function Ye(e=ri){const n=navigator.gpu;if(!n)return`This browser doesn't expose WebGPU at all. Use a recent Chrome, Edge, or Safari 17+ with hardware acceleration on, or pick ${e}.`;let t;try{t=await n.requestAdapter()}catch(r){return`WebGPU adapter request failed (${r instanceof Error?r.message:String(r)}). Try ${e} instead.`}return t?null:`This browser supports the WebGPU API, but no GPU adapter is available — hardware acceleration may be off, or this device/VM has no usable GPU. Pick ${e} instead.`}const oi=[{id:"Qwen2.5-1.5B-Instruct-q4f16_1-MLC",label:"Qwen2.5 1.5B",downloadLabel:"~1.0 GB"},{id:"SmolLM2-1.7B-Instruct-q4f16_1-MLC",label:"SmolLM2 1.7B",downloadLabel:"~1.1 GB"},{id:"Llama-3.2-1B-Instruct-q4f16_1-MLC",label:"Llama 3.2 1B",downloadLabel:"~0.7 GB"},{id:"gemma-2-2b-it-q4f16_1-MLC",label:"Gemma 2 2B",downloadLabel:"~1.5 GB"},{id:"Llama-3.2-1B-Instruct-q4f32_1-MLC",label:"Llama 3.2 1B (f32, wider GPU support)",downloadLabel:"~1.1 GB"},{id:"SmolLM2-360M-Instruct-q4f32_1-MLC",label:"SmolLM2 360M (tiny, f32)",downloadLabel:"~0.6 GB"},{id:"SmolLM2-360M-Instruct-q4f16_1-MLC",label:"SmolLM2 360M (tiny)",downloadLabel:"~0.3 GB"}];function gt(e){return pn.get(e)??{}}const pn=new Map;async function ai(){if(pn.size>0)return;const{prebuiltAppConfig:e}=await de(async()=>{const{prebuiltAppConfig:n}=await import("./vendor-webllm-DT0Ab8E6.js");return{prebuiltAppConfig:n}},[]);for(const n of e.model_list)pn.set(n.model_id,{vramRequiredMB:n.vram_required_MB,requiredFeatures:n.required_features})}const nn=oi.map(e=>({id:e.id,label:`${e.label} (${e.downloadLabel})`,downloadLabel:e.downloadLabel,...gt(e.id)})),ht=nn[0].id;async function si(){return await ai(),nn.map(e=>({...e,...gt(e.id)}))}function bt(){const e=navigator.deviceMemory;return typeof e=="number"?e*1024:null}function ci(e,n=bt()){return n==null||e.vramRequiredMB==null||n>=e.vramRequiredMB?null:`${e.label} needs roughly ${Math.round(e.vramRequiredMB)} MB of GPU memory; this device looks like it has about ${Math.round(n)} MB available. It may still work, but expect it to fail or fall back to slow shared memory — try a smaller model (e.g. SmolLM2 360M) if it doesn't load.`}async function li(e){try{const{hasModelInCache:n}=await de(async()=>{const{hasModelInCache:t}=await import("./vendor-webllm-DT0Ab8E6.js");return{hasModelInCache:t}},[]);return await n(e)}catch{return!1}}function en(e){return/device (was )?lost|device_hung|device_removed|already been disposed|gpudevicelostinfo/i.test(e)}function Pn(){return"The GPU device was lost — the driver reset while the model was loading or running. This is a browser/driver-level failure, not a problem with the model: fully quit and reopen the browser (a lost device usually persists for the life of the GPU process), check chrome://gpu still reports hardware acceleration, and update your GPU driver if it recurs. The Scripted and Endpoint brains don't use the GPU at all."}class We{constructor(){O(this,"kind","browser");O(this,"model",null);O(this,"engine",null);O(this,"worker",null);O(this,"generation",0);O(this,"chat",async(n,t=512,r)=>{var s,l;const i=this.engine;if(!i||!this.model)throw new Error("BrowserBrain.chat called before connect()");try{const u=await i.chat.completions.create({messages:n,temperature:0,max_tokens:t,stream:!0});let m="";for await(const o of u){const c=((l=(s=o.choices[0])==null?void 0:s.delta)==null?void 0:l.content)??"";c&&(m+=c,r==null||r(c))}return m}catch(u){const m=u instanceof Error?u.message:String(u);throw en(m)?(this.teardown(),new Error(`The in-browser model stopped: ${Pn()}`)):u}})}async connect(n=ht,t){var m,o;const r=await Ye();if(r)throw new Error(r);if(this.engine&&this.model===n)return n;const i=++this.generation,s=c=>{i===this.generation&&(t==null||t({progress:c.progress??0,text:c.text??""}))};this.teardown();let l,u;try{const{CreateWebWorkerMLCEngine:c}=await de(async()=>{const{CreateWebWorkerMLCEngine:g}=await import("./vendor-webllm-DT0Ab8E6.js");return{CreateWebWorkerMLCEngine:g}},[]);u=new Worker(new URL("/pr-preview/pr-96/assets/webllm.worker-Dc1cCqhL.js",import.meta.url),{type:"module"}),l=await c(u,n,{initProgressCallback:s})}catch(c){if(u==null||u.terminate(),i!==this.generation)throw new Error("cancelled");const g=c instanceof Error?c.message:String(c);if(en(g))throw new Error(`Couldn't load ${n} in the browser (${g}). ${Pn()}`);const p=(o=(m=nn.find(_=>_.id===n))==null?void 0:m.requiredFeatures)==null?void 0:o.includes("shader-f16");throw new Error(`Couldn't load ${n} in the browser (${g}). `+(p?"This model needs WebGPU with shader-f16; try one of the f32 models in the list, or the endpoint brain.":"Try a smaller model, check your connection, or use the endpoint brain instead."))}if(i!==this.generation)throw l.unload().catch(()=>{}),u==null||u.terminate(),new Error("cancelled");return this.engine=l,this.worker=u??null,this.model=n,n}teardown(){const{engine:n,worker:t}=this;this.engine=null,this.worker=null,this.model=null,n==null||n.unload().catch(()=>{}),t==null||t.terminate()}cancelConnect(){this.generation++}dispose(){this.generation++,this.teardown()}}const ft="http://localhost:11434/v1";function _t(){var n;const e=((n=globalThis.location)==null?void 0:n.hostname)??"";return e==="localhost"||e==="127.0.0.1"||e==="[::1]"||e==="::1"}function bn(e,n={hostname:(t=>(t=globalThis.location)==null?void 0:t.hostname)()??"",origin:(r=>(r=globalThis.location)==null?void 0:r.origin)()??""}){let i;try{i=new URL(wt(e)).hostname}catch{return null}const s=l=>l==="localhost"||l==="127.0.0.1"||l==="::1"||l==="[::1]";return!s(i)||s(n.hostname)?null:`This page is served from ${n.origin||"a non-local origin"}, so it can't reach ${e}. A local model server only accepts requests from a page on localhost. Open this page at http://localhost instead, or use the Scripted or In-browser brain.`}function wt(e){let n=e.trim().replace(/\/+$/,"");return n.endsWith("/chat/completions")&&(n=n.slice(0,-17)),/\/v\d+$/.test(n)||(n=`${n}/v1`),n}class Ln extends Error{constructor(n,t){super(n),this.status=t,this.name="HttpError"}}class di{constructor(n=ft,t="",r=""){O(this,"kind","endpoint");O(this,"baseUrl");O(this,"model",null);O(this,"models",[]);O(this,"apiKey");O(this,"requestedModel");O(this,"chat",async(n,t=512,r)=>{var o,c,g;if(!this.model)throw new Error("EndpointBrain.chat called before connect()");const i=await fetch(`${this.baseUrl}/chat/completions`,{method:"POST",headers:this.headers(),body:JSON.stringify({model:this.model,messages:n,temperature:0,max_tokens:t,stream:!0})});if(!i.ok||!i.body){const p=await i.text().catch(()=>"");throw new Error(`chat/completions HTTP ${i.status} ${i.statusText}${p?` — ${p.slice(0,300)}`:""}`)}const s=i.body.getReader(),l=new TextDecoder;let u="",m="";for(;;){const{value:p,done:_}=await s.read();if(_)break;u+=l.decode(p,{stream:!0});let b;for(;(b=u.indexOf(`
`))>=0;){const y=u.slice(0,b).trim();if(u=u.slice(b+1),!y.startsWith("data:"))continue;const f=y.slice(5).trim();if(f==="[DONE]")continue;let M;try{M=JSON.parse(f)}catch{continue}M.model&&(this.model=M.model);const k=(o=M.choices)==null?void 0:o[0],P=((c=k==null?void 0:k.delta)==null?void 0:c.content)??((g=k==null?void 0:k.message)==null?void 0:g.content)??"";P&&(m+=P,r==null||r(P))}}return m});this.baseUrl=wt(n),this.apiKey=t.trim(),this.requestedModel=r.trim()}headers(){const n={"Content-Type":"application/json"};return this.apiKey&&(n.Authorization=`Bearer ${this.apiKey}`),n}async listModels(){let n;try{n=await fetch(`${this.baseUrl}/models`,{headers:this.headers()})}catch(r){const i=bn(this.baseUrl);throw new Error(i??`Can't reach ${this.baseUrl} (${r instanceof Error?r.message:String(r)}). Is the server running? For Ollama, check the app is up — and if this page is served from another origin, allow it with OLLAMA_ORIGINS.`)}if(!n.ok)throw new Ln(`${this.baseUrl}/models returned HTTP ${n.status} ${n.statusText}`,n.status);const t=await n.json();return this.models=(t.data??[]).map(r=>r.id).filter(r=>!!r),this.models}async connect(){try{const n=await this.listModels(),t=this.requestedModel||n[0];if(!t)throw new Error(`No models available at ${this.baseUrl}. Pull one first — e.g. \`ollama pull llama3.2:3b\` — or name one explicitly.`);this.model=t}catch(n){const t=n instanceof Ln&&[404,405,501].includes(n.status);if(!this.requestedModel||!t)throw n;this.models=[],this.model=this.requestedModel}return await this.validate(),this.model}async validate(){const n=await fetch(`${this.baseUrl}/chat/completions`,{method:"POST",headers:this.headers(),body:JSON.stringify({model:this.model,messages:[{role:"user",content:"Reply with ok."}],temperature:0,max_tokens:1,stream:!1})}).catch(r=>{throw new Error(`Can't reach ${this.baseUrl}/chat/completions (${r instanceof Error?r.message:String(r)}). Check the endpoint URL, API key, model name, and any local CORS settings.`)});if(!n.ok){const r=await n.text().catch(()=>"");throw new Error(`chat/completions HTTP ${n.status} ${n.statusText}${r?` — ${r.slice(0,300)}`:""}`)}const t=await n.json().catch(()=>({}));t.model&&(this.model=t.model)}dispose(){}}const ui=[{id:"onnx-community/Florence-2-base-ft",label:"Florence-2 base",downloadLabel:"~0.4 GB"},{id:"onnx-community/Florence-2-large-ft",label:"Florence-2 large (higher quality)",downloadLabel:"~1.6 GB"}],yt=ui.map(e=>({...e,label:`${e.label} (${e.downloadLabel})`})),Mt=yt[0].id,mi="<OCR>",Bn="UNKNOWN (scripted brain — connect the in-browser model to read a photo)";function pi(e,n){if(e)return typeof e=="function"?e(n):e[n]}class gi{constructor(n){O(this,"kind","scripted-vision");O(this,"model",null);O(this,"read",async(n,t,r)=>{const i=typeof n=="string"?pi(this.lookup,n)??Bn:Bn;return r==null||r(i),i});this.lookup=n}dispose(){}}function hi(e){return new gi(e)}class Rn{constructor(){O(this,"kind","browser-vision");O(this,"model",null);O(this,"modelHandle",null);O(this,"processor",null);O(this,"loadImage",null);O(this,"generation",0);O(this,"read",async(n,t,r)=>{const i=this.modelHandle,s=this.processor,l=this.loadImage;if(!i||!s||!l||!this.model)throw new Error("BrowserVisionBrain.read called before connect()");const u=t&&t.startsWith("<")?t:mi,m=await l(n),o=s.construct_prompts(u),c=await s(m,o),g=await i.generate({...c,max_new_tokens:512,num_beams:1,do_sample:!1}),p=s.batch_decode(g,{skip_special_tokens:!1})[0],_=s.post_process_generation(p,u,m.size),b=bi(_,u);return r==null||r(b),b})}async connect(n=Mt,t){var u,m;const r=await Ye("the scripted-vision fallback");if(r)throw new Error(r);if(this.modelHandle&&this.model===n)return n;const i=++this.generation,s=o=>{i===this.generation&&(t==null||t({progress:(o.progress??0)/100,text:o.file?`${o.status??"loading"} ${o.file}`:o.status??""}))};this.teardown();let l;try{const{Florence2ForConditionalGeneration:o,AutoProcessor:c,load_image:g}=await de(async()=>{const{Florence2ForConditionalGeneration:b,AutoProcessor:y,load_image:f}=await import("./transformers.web-_2QgpR12.js");return{Florence2ForConditionalGeneration:b,AutoProcessor:y,load_image:f}},[]),p=await o.from_pretrained(n,{dtype:"fp32",device:"webgpu",progress_callback:s}),_=await c.from_pretrained(n);l={model:p,processor:_,loadImage:g}}catch(o){if(i!==this.generation)throw new Error("cancelled");const c=o instanceof Error?o.message:String(o);throw new Error(`Couldn't load ${n} in the browser (${c}). Try the smaller Florence-2 base model, check your connection, or use the scripted-vision fallback.`)}if(i!==this.generation)throw Promise.resolve((m=(u=l.model).dispose)==null?void 0:m.call(u)).catch(()=>{}),new Error("cancelled");return this.modelHandle=l.model,this.processor=l.processor,this.loadImage=l.loadImage,this.model=n,n}teardown(){var t;const n=this.modelHandle;this.modelHandle=null,this.processor=null,this.loadImage=null,this.model=null,Promise.resolve((t=n==null?void 0:n.dispose)==null?void 0:t.call(n)).catch(()=>{})}cancelConnect(){this.generation++}dispose(){this.generation++,this.teardown()}}function bi(e,n){const t=e[n];if(typeof t=="string")return t.trim();if(t&&typeof t=="object"){const r=t.labels;return Array.isArray(r)?r.join(" ").trim():JSON.stringify(t)}return""}async function fi(){return await ii()?"browser":_t()?"endpoint":"scripted"}function _i(){const[e,n]=h.useState("scripted"),t=h.useRef(!1),[r,i]=h.useState("idle"),[s,l]=h.useState(null),[u,m]=h.useState(null),[o,c]=h.useState(null),[g,p]=h.useState(null),[_,b]=h.useState(null),[y,f]=h.useState(null),[M,k]=h.useState(ht),[P,V]=h.useState(ft),[q,ue]=h.useState(""),[Y,oe]=h.useState(""),[U,I]=h.useState(null),N=h.useRef(null),[A,ee]=h.useState("scripted-vision"),[D,W]=h.useState("idle"),[fe,ve]=h.useState(null),[Re,Ee]=h.useState(Mt),[De,xe]=h.useState(null),[tn,Te]=h.useState(null),[ze,ae]=h.useState(null),[je,Se]=h.useState(null),Z=h.useRef(null),Ne=h.useRef(!1),Ie=h.useCallback(E=>async(...C)=>{try{return await E.chat(...C)}catch(F){const ke=F instanceof Error?F.message:String(F);throw E instanceof We&&en(ke)&&(I(null),m(null),i("error"),l(ke)),F}},[]),Ce=h.useCallback(E=>async(...C)=>{try{return await E.read(...C)}catch(F){const ke=F instanceof Error?F.message:String(F);throw en(ke)&&(Se(null),xe(null),W("error"),ve(ke)),F}},[]);h.useEffect(()=>{Ye().then(E=>{b(E),p(E===null),t.current||(t.current=!0,fi().then(n))}),Ye("the scripted-vision fallback").then(E=>{ae(E),Ne.current||(Ne.current=!0,ee(E===null?"browser-vision":"scripted-vision"))})},[]),h.useEffect(()=>{let E=!1;return f(null),li(M).then(C=>{E||f(C)}),()=>{E=!0}},[M]),h.useEffect(()=>()=>{var E;return(E=N.current)==null?void 0:E.dispose()},[]),h.useEffect(()=>()=>{var E;return(E=Z.current)==null?void 0:E.dispose()},[]);const $=h.useCallback(E=>{n(E),i("idle"),l(null),m(null),c(null),I(null)},[]),he=h.useCallback(E=>{var C,F;Ne.current=!0,(C=Z.current)==null||C.cancelConnect(),(F=Z.current)==null||F.dispose(),Z.current=null,ee(E),W("idle"),ve(null),xe(null),Te(null),Se(null)},[]),me=h.useCallback(()=>{var E;(E=N.current)==null||E.dispose(),N.current=null,I(null),m(null)},[]),_e=h.useCallback(()=>{N.current instanceof We&&N.current.cancelConnect(),me(),i("idle"),c(null),l(null)},[me]),Qe=h.useCallback(async()=>{var E;if(e==="scripted"){I(null),i("ready");return}if(e==="endpoint"){const C=bn(P);if(C){me(),l(C),i("error");return}}i("connecting"),l(null),c(null);try{if(e==="browser"){const C=N.current instanceof We?N.current:new We;N.current&&N.current!==C&&N.current.dispose(),N.current=C;const F=await C.connect(M,c);m(F),I(()=>Ie(C)),f(!0)}else{(E=N.current)==null||E.dispose();const C=new di(P,Y,q);N.current=C;const F=await C.connect();m(F),I(()=>Ie(C))}i("ready")}catch(C){const F=C instanceof Error?C.message:String(C);if(F==="cancelled")return;l(F),i("error"),I(null)}finally{c(null)}},[e,M,P,q,Y,me,Ie]),ne=h.useCallback(()=>{var E;(E=Z.current)==null||E.dispose(),Z.current=null,Se(null),xe(null)},[]),Pe=h.useCallback(()=>{var E;(E=Z.current)==null||E.cancelConnect(),ne(),W("idle"),Te(null),ve(null)},[ne]),Le=h.useCallback(async()=>{if(A==="scripted-vision"){ne(),W("ready"),ve(null);return}W("connecting"),ve(null),Te(null);try{const E=Z.current instanceof Rn?Z.current:new Rn;Z.current&&Z.current!==E&&Z.current.dispose(),Z.current=E;const C=await E.connect(Re,Te);xe(C),Se(()=>Ce(E)),W("ready")}catch(E){const C=E instanceof Error?E.message:String(E);if(C==="cancelled")return;ve(C),W("error"),Se(null),xe(null)}finally{Te(null)}},[A,Re,ne,Ce]);return{kind:e,setKind:$,status:r,error:s,modelInUse:u,progress:o,webgpu:g,webgpuReason:_,browserModelCached:y,cancelConnect:_e,browserModel:M,setBrowserModel:k,endpointUrl:P,setEndpointUrl:V,endpointModel:q,setEndpointModel:ue,apiKey:Y,setApiKey:oe,connect:Qe,chat:U,visionKind:A,setVisionKind:he,visionStatus:D,visionError:fe,visionModel:Re,setVisionModel:Ee,visionModelInUse:De,visionProgress:tn,visionWebgpuReason:ze,connectVision:Le,cancelVisionConnect:Pe,vision:je}}const gn="#s=",wi=["scripted","browser","endpoint"];function yi(e){return typeof e=="string"&&wi.includes(e)}function Mi(e){try{const n=JSON.parse(e);if(n&&typeof n=="object"){const t=n,r={};return yi(t.brain)&&(r.brain=t.brain),r}}catch{}return{}}function vt(e=location.hash){if(!e.startsWith(gn))return{};let n;try{n=decodeURIComponent(e.slice(gn.length))}catch{return{}}return Mi(n)}function vi(e){const n=Object.entries(e).filter(([,t])=>t!==void 0);return n.length===0?"":gn+encodeURIComponent(JSON.stringify(Object.fromEntries(n)))}function xi(e){const n={...vt(),...e},t=vi(n),r=new URL(location.href);r.hash=t,history.replaceState(history.state,"",r)}const zn=[{kind:"scripted",label:"Scripted",hint:"No model. The example's stand-in decides — deterministic and offline."},{kind:"browser",label:"In-browser (WebGPU)",hint:"A small quantised model on your GPU. First run downloads weights."},{kind:"endpoint",label:"API endpoint",hint:"Any OpenAI-compatible server. Ollama by default. Local pages only."}],On=[{kind:"scripted-vision",label:"Scripted",hint:"No model. The example's known plate is returned — deterministic and offline."},{kind:"browser-vision",label:"In-browser (WebGPU)",hint:"Reads the photo with a vision model on your GPU. First run downloads weights."}];function Ni({brain:e,showText:n=!0,showVision:t=!1}){return a.jsxs("div",{className:"brain",children:[n&&a.jsx(Ii,{brain:e}),n&&t&&a.jsx("hr",{className:"brain-divider"}),t&&a.jsx(ki,{brain:e})]})}function Ii({brain:e}){const n=zn.find(o=>o.kind===e.kind),t=bn(e.endpointUrl),r=_t(),[i,s]=h.useState(nn);h.useEffect(()=>{si().then(s)},[]);const l=i.find(o=>o.id===e.browserModel),u=l?ci(l,bt()):null,m=e.webgpu===!0?"browser":r&&e.webgpu===!1?"endpoint":null;return a.jsxs("div",{className:"brain-section",children:[a.jsxs("div",{className:"brain-kinds",children:[zn.map(o=>a.jsxs(Q,{size:"sm",variant:e.kind===o.kind?"default":"secondary",onClick:()=>e.setKind(o.kind),children:[o.label,o.kind===m&&a.jsx(J,{variant:"info",className:"brain-recommended-badge",children:"recommended"})]},o.kind)),e.status==="ready"&&e.kind!=="scripted"&&a.jsx(J,{variant:"success",children:e.modelInUse??"connected"}),e.status==="connecting"&&a.jsx(J,{variant:"info",children:"connecting…"}),e.status==="error"&&a.jsx(J,{variant:"danger",children:"not connected"})]}),a.jsx("p",{className:"field-hint",children:n.hint}),e.kind==="browser"&&a.jsxs("div",{className:"brain-config",children:[a.jsxs("div",{className:"field",children:[a.jsx(Be,{htmlFor:"browser-model",children:"Model"}),a.jsxs(Xn,{value:e.browserModel,onValueChange:e.setBrowserModel,disabled:e.status==="connecting",children:[a.jsx(et,{id:"browser-model",children:a.jsx(nt,{})}),a.jsx(tt,{children:i.map(o=>a.jsx(rt,{value:o.id,children:o.label},o.id))})]}),e.browserModelCached===!0&&a.jsx("p",{className:"field-hint",children:"Already downloaded in this browser — connecting will be fast."}),e.browserModelCached===!1&&a.jsx("p",{className:"field-hint",children:"Not downloaded yet — connecting fetches the weights once, then caches them for next time."})]}),e.webgpu===!1&&e.webgpuReason&&a.jsxs(se,{variant:"destructive",children:[a.jsx(ce,{children:"No WebGPU in this browser"}),a.jsx(le,{children:e.webgpuReason})]}),e.webgpu!==!1&&u&&a.jsxs(se,{variant:"destructive",children:[a.jsx(ce,{children:"This model may not fit in GPU memory"}),a.jsx(le,{children:u})]})]}),e.kind==="endpoint"&&a.jsxs("div",{className:"brain-config",children:[a.jsxs("div",{className:"field",children:[a.jsx(Be,{htmlFor:"endpoint-url",children:"Endpoint"}),a.jsx(rn,{id:"endpoint-url",value:e.endpointUrl,onChange:o=>e.setEndpointUrl(o.target.value),disabled:e.status==="connecting"}),a.jsxs("p",{className:"field-hint",children:["Ollama allows ",a.jsx("code",{children:"localhost"})," origins out of the box; set"," ",a.jsx("code",{children:"OLLAMA_ORIGINS"})," only when serving this page from another host. Best for local development — a hosted copy of this page can't reach a server on your machine at all."]}),t&&a.jsxs(se,{variant:"destructive",children:[a.jsx(ce,{children:"A local server won't work from this URL"}),a.jsx(le,{children:t})]})]}),a.jsxs("div",{className:"field",children:[a.jsx(Be,{htmlFor:"endpoint-model",children:"Model (blank = first served)"}),a.jsx(rn,{id:"endpoint-model",placeholder:"llama3.2:3b",value:e.endpointModel,onChange:o=>e.setEndpointModel(o.target.value),disabled:e.status==="connecting"})]}),a.jsxs("div",{className:"field",children:[a.jsx(Be,{htmlFor:"endpoint-key",children:"API key (optional)"}),a.jsx(rn,{id:"endpoint-key",type:"password",value:e.apiKey,onChange:o=>e.setApiKey(o.target.value),disabled:e.status==="connecting"})]})]}),e.kind!=="scripted"&&a.jsxs("div",{className:"brain-actions",children:[a.jsx(Q,{size:"sm",onClick:()=>void e.connect(),disabled:e.status==="connecting",children:e.status==="ready"?"Reconnect":"Connect"}),e.status==="connecting"&&e.kind==="browser"&&a.jsx(Q,{size:"sm",variant:"secondary",onClick:e.cancelConnect,children:"Cancel"}),e.progress&&a.jsxs("span",{className:"field-hint",children:[Math.round(e.progress.progress*100),"% —"," ",e.progress.text]})]}),e.error&&a.jsxs(se,{variant:"destructive",children:[a.jsx(ce,{children:"Couldn't connect"}),a.jsx(le,{children:e.error})]})]})}function ki({brain:e}){const n=On.find(r=>r.kind===e.visionKind),t=e.webgpu===!0?"browser-vision":null;return a.jsxs("div",{className:"brain-section brain-vision",children:[a.jsx(Be,{children:"Vision (reads the image)"}),a.jsxs("div",{className:"brain-kinds",children:[On.map(r=>a.jsxs(Q,{size:"sm",variant:e.visionKind===r.kind?"default":"secondary",onClick:()=>e.setVisionKind(r.kind),children:[r.label,r.kind===t&&a.jsx(J,{variant:"info",className:"brain-recommended-badge",children:"recommended"})]},r.kind)),e.visionStatus==="ready"&&e.visionKind==="browser-vision"&&a.jsx(J,{variant:"success",children:e.visionModelInUse??"connected"}),e.visionStatus==="connecting"&&a.jsx(J,{variant:"info",children:"connecting…"}),e.visionStatus==="error"&&a.jsx(J,{variant:"danger",children:"not connected"})]}),a.jsx("p",{className:"field-hint",children:n.hint}),e.visionKind==="scripted-vision"&&e.webgpu===!1&&e.visionWebgpuReason&&a.jsxs(se,{variant:"destructive",children:[a.jsx(ce,{children:"No WebGPU in this browser"}),a.jsx(le,{children:e.visionWebgpuReason})]}),e.visionKind==="browser-vision"&&a.jsxs("div",{className:"brain-config",children:[a.jsxs("div",{className:"field",children:[a.jsx(Be,{htmlFor:"vision-model",children:"Model"}),a.jsxs(Xn,{value:e.visionModel,onValueChange:e.setVisionModel,disabled:e.visionStatus==="connecting",children:[a.jsx(et,{id:"vision-model",children:a.jsx(nt,{})}),a.jsx(tt,{children:yt.map(r=>a.jsx(rt,{value:r.id,children:r.label},r.id))})]}),a.jsx("p",{className:"field-hint",children:"Connecting downloads the weights once (size shown above), then caches them — every token is read on your GPU, no server."})]}),e.webgpu===!1&&e.visionWebgpuReason&&a.jsxs(se,{variant:"destructive",children:[a.jsx(ce,{children:"No WebGPU in this browser"}),a.jsx(le,{children:e.visionWebgpuReason})]})]}),e.visionKind==="browser-vision"&&a.jsxs("div",{className:"brain-actions",children:[a.jsx(Q,{size:"sm",onClick:()=>void e.connectVision(),disabled:e.visionStatus==="connecting",children:e.visionStatus==="ready"?"Reconnect":"Connect"}),e.visionStatus==="connecting"&&a.jsx(Q,{size:"sm",variant:"secondary",onClick:e.cancelVisionConnect,children:"Cancel"}),e.visionProgress&&a.jsxs("span",{className:"field-hint",children:[Math.round(e.visionProgress.progress*100),"% —"," ",e.visionProgress.text]})]}),e.visionError&&a.jsxs(se,{variant:"destructive",children:[a.jsx(ce,{children:"Couldn't connect the vision brain"}),a.jsx(le,{children:e.visionError})]})]})}function Ei({imageInput:e,value:n,onSelect:t,disabled:r=!1}){const[i,s]=h.useState(null),[l,u]=h.useState(!1),m=h.useRef(null),o=h.useId(),c=h.useId(),g=h.useCallback(b=>{s(URL.createObjectURL(b)),t({imageName:b.name,pixels:b})},[t]);h.useEffect(()=>{if(i)return()=>URL.revokeObjectURL(i)},[i]);const p=h.useCallback(b=>{const y=b==null?void 0:b[0];y&&y.type.startsWith("image/")&&g(y)},[g]),_=(n==null?void 0:n.imageId)!=null?e.seedImages.find(b=>b.id===n.imageId):void 0;return a.jsxs("div",{className:"image-input",children:[e.label&&a.jsx("p",{className:"field-hint",children:e.label}),a.jsx("p",{className:"image-input-label",id:o,children:"Seed photos"}),a.jsx("div",{className:"image-gallery",role:"group","aria-labelledby":o,children:e.seedImages.map(b=>{const y=(n==null?void 0:n.imageId)===b.id;return a.jsxs("button",{type:"button","aria-pressed":y,className:`image-thumb${y?" image-thumb--selected":""}`,disabled:r,title:b.label??b.id,onClick:()=>{s(null),m.current&&(m.current.value=""),t({imageId:b.id,pixels:b.file})},children:[a.jsx("img",{src:b.thumb??b.file,alt:b.label??b.id}),b.label&&a.jsx("span",{children:b.label})]},b.id)})}),a.jsx("label",{className:"image-input-label",htmlFor:c,children:"Or upload your own photo"}),a.jsxs("div",{className:`image-drop${l?" image-drop--over":""}`,onDragOver:b=>{b.preventDefault(),r||u(!0)},onDragLeave:()=>u(!1),onDrop:b=>{b.preventDefault(),u(!1),r||p(b.dataTransfer.files)},children:[a.jsx("input",{ref:m,id:c,type:"file",accept:"image/*",disabled:r,onChange:b=>p(b.target.files)}),a.jsx("p",{className:"field-hint",children:"Drag a photo here, or pick one. Uploading a photo the model has never seen is the proof this runs for real — nothing leaves your browser."})]}),(i||_)&&a.jsxs("div",{className:"image-preview",children:[a.jsx("img",{src:i??(_==null?void 0:_.file),alt:i?(n==null?void 0:n.imageName)??"uploaded photo":(_==null?void 0:_.label)??(_==null?void 0:_.id)??"selected photo"}),a.jsx("span",{className:"field-hint",children:i?`Uploaded: ${(n==null?void 0:n.imageName)??"your photo"}`:`Selected: ${(_==null?void 0:_.label)??(_==null?void 0:_.id)}`}),a.jsx("button",{type:"button",className:"image-clear-btn",disabled:r,onClick:()=>{s(null),m.current&&(m.current.value=""),t(null)},children:"Clear"})]})]})}function xt(e){return typeof e=="object"&&e!==null}function js(e){const n=new Set,t=r=>{xt(r)&&(typeof r.key=="string"&&n.add(r.key),Array.isArray(r.components)&&r.components.forEach(t))};return t(e),n}function Ti(e){const n={},t=r=>{xt(r)&&(typeof r.key=="string"&&"defaultValue"in r&&(n[r.key]=r.defaultValue??""),Array.isArray(r.components)&&r.components.forEach(t))};return t(e),n}const ji="wdf:section:";function Nt(e){return ji+e}function Fn(e){try{const n=window.localStorage.getItem(Nt(e));return n==="1"?!0:n==="0"?!1:void 0}catch{return}}function Si(e,n){try{window.localStorage.setItem(Nt(e),n?"1":"0")}catch{}}function Ai(e,n=!0){const[t,r]=h.useState(()=>Fn(e)??n);h.useEffect(()=>{r(Fn(e)??n)},[e,n]);const i=h.useCallback(s=>{r(s),Si(e,s)},[e]);return[t,i]}function we({sectionId:e,title:n,description:t,defaultOpen:r=!0,className:i,children:s,...l}){const[u,m]=Ai(e,r);return a.jsx(Bt,{className:["panel",i].filter(Boolean).join(" "),"data-tour":l["data-tour"],children:a.jsxs(Rt,{open:u,onOpenChange:m,children:[a.jsxs(zt,{className:"panel-trigger",children:[a.jsxs("span",{className:"panel-trigger-text",children:[a.jsx("span",{className:"panel-title",children:n}),t!=null&&a.jsx("span",{className:"panel-desc",children:t})]}),a.jsx(Ot,{className:"panel-chevron","aria-hidden":!0})]}),a.jsx(Ft,{children:a.jsx(Ut,{children:s})})]})})}function Di(e){return e.entries!==void 0}function Ci(e){const n=[];let t=null;for(const r of e)r.turn!==void 0?t&&t.turn===r.turn?t.entries.push(r):(t={turn:r.turn,entries:[r]},n.push(t)):(t=null,n.push(r));return n}function Un(e){if(e===void 0)return"undefined";try{return JSON.stringify(e)}catch{return"[unserializable value]"}}function Pi({activation:e,result:n,labelFor:t}){const r=e.elementId??"";return a.jsxs("div",{className:"timeline-tool",children:[a.jsxs("div",{className:"timeline-tool-head",children:[a.jsx(J,{variant:"info",children:"tool"}),a.jsx("strong",{children:t(r)||r}),a.jsx("code",{children:r})]}),e.args!==void 0&&Object.keys(e.args).length>0&&a.jsxs("div",{className:"timeline-kv",children:[a.jsx("span",{className:"timeline-kv-label",children:"arguments"}),a.jsx("code",{children:Un(e.args)})]}),a.jsxs("div",{className:"timeline-kv",children:[a.jsx("span",{className:"timeline-kv-label",children:"returned"}),a.jsx("code",{children:n?Un(n.result):"— waiting for the job to complete —"})]})]})}function Li({group:e,labelFor:n}){const t=e.entries.find(o=>o.kind==="llm"),r=e.entries.filter(o=>o.kind==="agent"&&o.elementId),i=e.entries.filter(o=>o.kind==="vars"&&o.elementId),s=e.entries.filter(o=>o.kind==="agent"&&!o.elementId),l=e.entries.filter(o=>o.kind==="error"),u=new Set(r.map(o=>o.elementId)),m=e.entries.filter(o=>o.kind==="tool"||o.kind==="vars"&&o.elementId&&!u.has(o.elementId)).sort((o,c)=>o.id-c.id);return a.jsxs("div",{className:"timeline-turn",children:[a.jsxs("div",{className:"timeline-turn-head",children:[a.jsxs(J,{variant:t!=null&&t.pending?"warning":"neutral",children:["Turn ",e.turn]}),(t==null?void 0:t.pending)&&a.jsx("span",{className:"timeline-pending",children:"thinking…"})]}),t&&a.jsx("blockquote",{className:"timeline-reply",children:t.text}),s.map(o=>a.jsx("div",{className:"timeline-note",children:o.text},o.id)),r.map(o=>a.jsx(Pi,{activation:o,result:i.find(c=>c.elementId===o.elementId),labelFor:n},o.id)),m.map(o=>a.jsxs("div",{className:`log-line log-${o.kind}`,children:[o.pending?"⏳ ":"",o.text]},o.id)),l.map(o=>a.jsxs("div",{className:"timeline-error",children:["⚠ ",o.text]},o.id))]})}function Bi({log:e,elementStats:n=[],incidents:t=[],labelFor:r=i=>i}){const i=h.useMemo(()=>Ci(e),[e]),[s,l]=h.useState(!1),u=h.useRef(null);h.useEffect(()=>{const o=u.current;o&&(o.scrollTop=o.scrollHeight)},[i]);const m=()=>{var g;const o={log:e.map(({id:p,..._})=>_),elementStats:n,incidents:t},c=JSON.stringify(o,null,2);(g=navigator.clipboard)!=null&&g.writeText&&navigator.clipboard.writeText(c).then(()=>{l(!0),setTimeout(()=>l(!1),1500)}).catch(()=>{})};return a.jsxs(we,{sectionId:"activity",className:"grow",title:"Activity",description:"Agent turns, model replies, and tool calls — read top to bottom as a story.",children:[a.jsx("div",{className:"timeline-toolbar",children:a.jsx(Q,{variant:"secondary",size:"sm",onClick:m,children:s?"Copied!":"Copy run as JSON"})}),a.jsx("div",{className:"timeline",ref:u,children:i.length===0?a.jsx("div",{className:"log-empty",children:"Press Run or Step to start."}):i.map(o=>Di(o)?a.jsx(Li,{group:o,labelFor:r},`turn-${o.turn}-${o.entries[0].id}`):a.jsxs("div",{className:`log-line log-${o.kind}`,children:[o.pending?"⏳ ":"",o.text]},o.id))}),(n.length>0||t.length>0)&&a.jsxs("div",{className:"timeline-engine-view",children:[n.length>0&&a.jsxs("div",{className:"timeline-stats",children:[a.jsx("span",{className:"timeline-kv-label",children:"Element completion"}),a.jsx("ul",{children:n.filter(o=>o.completed>0||(o.active??0)>0).map(o=>a.jsxs("li",{children:[a.jsx("code",{children:r(o.elementId)||o.elementId})," ","completed ",o.completed,o.active?`, ${o.active} active`:""]},o.elementId))})]}),t.length>0&&a.jsxs("div",{className:"timeline-incidents",children:[a.jsx("span",{className:"timeline-kv-label",children:"Incidents"}),a.jsx("ul",{children:t.map((o,c)=>a.jsxs("li",{children:[a.jsx("code",{children:r(o.elementId)||o.elementId})," —"," ",o.reason]},`${o.elementId}-${c}`))})]})]})]})}const be={diagram:"diagram",runButton:"run-button",variablesPanel:"variables-panel",codePanel:"code-panel",brainPanel:"brain-panel"};function $n(e){return`[data-tour="${e}"]`}function Ri(e=location.search){return new URLSearchParams(e).get("tour")}function zi(e,n){var t;return((t=e.elementStats.find(r=>r.elementId===n))==null?void 0:t.completed)??0}function Oi(e,n){return!e||e.kind==="click"||!n?!1:e.kind==="activeElement"?n.activeElementIds.includes(e.elementId):zi(n,e.elementId)>=(e.atLeast??1)}function Fi(e){return"anchor"in e?$n(e.anchor):`${$n(be.diagram)} [data-element-id="${Ui(e.elementId)}"]`}function Ui(e){return typeof CSS<"u"&&typeof CSS.escape=="function"?CSS.escape(e):e.replace(/[^a-zA-Z0-9_-]/g,n=>`\\${n}`)}function $i(e){return e.map(n=>{const t=!!n.waitFor&&n.waitFor.kind!=="click";return{element:Fi(n.target),popover:{title:n.title,description:t?`${n.description} (continues automatically once you reach that point — or use Next to skip ahead)`:n.description,showButtons:["next","previous","close"]},disableActiveInteraction:!1,skipMissingElement:n.skipMissingElement??!0}})}async function Gi(e,n={}){var s;const[{driver:t}]=await Promise.all([de(()=>import("./driver.js-bj_ppY-Q.js"),[]),de(()=>Promise.resolve({}),__vite__mapDeps([0]))]),r=$i(e),i=t({steps:r,showProgress:!0,allowClose:!0,skipMissingElement:!0,onHighlighted:(l,u,{index:m})=>{var o;m!==void 0&&((o=n.onIndexChange)==null||o.call(n,m))},onDestroyed:()=>{var l;(l=n.onDestroyed)==null||l.call(n)}});return i.drive(),(s=n.onIndexChange)==null||s.call(n,i.getActiveIndex()??0),{moveNext:()=>i.moveNext(),activeIndex:()=>i.getActiveIndex()??-1,destroy:()=>i.destroy()}}const Vi=300;function Yi(e,n){const[t,r]=h.useState(!1),i=h.useRef(null),s=h.useRef(0),l=h.useRef(-1),u=h.useRef(null),m=h.useRef(n);h.useEffect(()=>{m.current=n},[n]);const o=h.useCallback(()=>{u.current!==null&&(clearInterval(u.current),u.current=null)},[]),c=h.useRef(0),g=h.useCallback(()=>{var _;c.current+=1,o(),(_=i.current)==null||_.destroy(),i.current=null,r(!1)},[o]),p=h.useCallback(()=>{if(!e||e.steps.length===0||i.current)return;const _=c.current+=1;Gi(e.steps,{onIndexChange:b=>{s.current=b},onDestroyed:()=>{o(),i.current=null,r(!1)}}).then(b=>{if(_!==c.current){b.destroy();return}i.current=b,r(!0),u.current=setInterval(()=>{const y=s.current;if(y===l.current)return;const f=e.steps[y];f&&Oi(f.waitFor,m.current())&&(l.current=y,b.moveNext())},Vi)})},[e,o]);return h.useEffect(()=>g,[g]),{active:t,start:p,stop:g}}const Ze=650,an="__agent__",Gn="__model__",Vn="__template__:",Qi=h.lazy(async()=>{await Promise.all([de(()=>Promise.resolve({}),__vite__mapDeps([1])),de(()=>Promise.resolve({}),__vite__mapDeps([2]))]);const{RuntimeDiagram:e}=await de(async()=>{const{RuntimeDiagram:n}=await import("./RuntimeDiagram-B2IYfHo7.js");return{RuntimeDiagram:n}},__vite__mapDeps([3,4,5]));return{default:e}}),sn=h.lazy(()=>de(()=>import("./MonacoEditor-CCmQHQ5C.js").then(e=>e.M),__vite__mapDeps([6,4,7]))),Ji=h.lazy(()=>de(()=>import("./vendor-modeler-DiOUSqPF.js"),__vite__mapDeps([8,4,5,9,10,11,12,1,2]))),Yn=h.lazy(async()=>{const{FormRenderer:e}=await de(async()=>{const{FormRenderer:n}=await import("./FormRenderer-54sFnlnK.js");return{FormRenderer:n}},__vite__mapDeps([13,4,11,9,10,14]));return{default:e}});function cn(e,n){try{return JSON.stringify(e??{},null,n)}catch{return"[unserializable value]"}}function Hi({example:e,initialBrainKind:n,initialTourId:t}){var _n,wn,yn,Mn,vn,xn,Nn,In;const[r,i]=h.useState(e.bpmn),s=_i(),[l,u]=h.useState(null);h.useEffect(()=>{n&&n!==s.kind&&s.setKind(n)},[]),h.useEffect(()=>{xi({brain:s.kind})},[s.kind]);const[m,o]=h.useState(()=>Object.fromEntries(e.handlers.map(v=>[v.elementId,v.source]))),[c,g]=h.useState(e.scriptedAgent??""),[p,_]=h.useState(()=>Ve(e.templates)),b=h.useMemo(()=>kr(e,m,r,p),[e,m,r,p]),y=b.model,f=ei({bpmn:b.resolvedBpmn}),M=Yi(e.tour,()=>f.snapshot);h.useEffect(()=>{var v;t&&((v=e.tour)==null?void 0:v.id)===t&&M.start()},[]);const k=y.startFormId?((_n=e.forms)==null?void 0:_n[y.startFormId])??null:null,[P,V]=h.useState(()=>({...e.seed,...k?Ti(k):{}})),[q,ue]=h.useState(y.agent?an:((wn=e.handlers[0])==null?void 0:wn.elementId)??""),[Y,oe]=h.useState(!1),[U,I]=h.useState(!1),[N,A]=h.useState(null),[ee,D]=h.useState([]),[W,fe]=h.useState({}),[ve,Re]=h.useState(!1),Ee=h.useRef(null),[De,xe]=h.useState({}),[tn,Te]=h.useState(!1),ze=h.useRef(null),ae=h.useRef(!1),je=h.useRef(0),Se=h.useRef(0),Z=h.useRef({current:void 0}),Ne=h.useRef({}),Ie=h.useRef({}),Ce=h.useMemo(()=>{const v=new Map;for(const x of y.processes){for(const T of x.tasks)v.set(T.elementId,T.label);for(const T of x.agents){v.set(T.elementId,T.label);for(const L of T.tools)v.set(L.elementId,L.label)}for(const T of x.userTasks)v.set(T.elementId,T.label)}return x=>v.get(x)??x},[y]),$=h.useCallback(v=>{D(x=>{if(v.key){const T=x.findIndex(L=>L.key===v.key);if(T>=0){const L=[...x];return L[T]={...L[T],...v},L}}return[...x,{...v,id:Se.current++}].slice(-80)})},[]),he=h.useMemo(()=>{var v;return((v=f.snapshot)==null?void 0:v.userTasks.find(x=>x.state==="Created"))??null},[f.snapshot]),me=h.useMemo(()=>{const v=y.processes.flatMap(T=>T.tasks),x=new Map;for(const T of e.handlers){if(!T.manualControl)continue;const L=v.find(R=>R.elementId===T.elementId);L&&x.set(L.jobType,{...T.manualControl,elementId:T.elementId})}return x},[e.handlers,y]),_e=h.useMemo(()=>{if(!f.snapshot)return null;for(const v of f.snapshot.jobs){const x=me.get(v.jobType);if(x&&v.state==="Created")return{job:v,control:x}}return null},[f.snapshot,me]),Qe=h.useMemo(()=>{if(!y.agent||!f.snapshot)return[];const v=new Map(f.snapshot.elementStats.map(x=>[x.elementId,x.completed]));return y.agent.tools.filter(x=>(v.get(x.elementId)??0)===0)},[y.agent,f.snapshot]),ne=he?y.userTasks.find(v=>v.elementId===he.elementId):void 0,Pe=ne!=null&&ne.formId?((yn=e.forms)==null?void 0:yn[ne.formId])??null:null,Le=h.useCallback(async(v,x,T,L)=>{var pe;let R=T,te=0;for(;je.current===L&&R&&R.completedInstances<1&&te++<80;){const G=await f.stepWorkers(v,{agents:x});if(je.current!==L)return R;R=(G==null?void 0:G.snapshot)??R;const re=(pe=R.instances[0])==null?void 0:pe.variables;if(re&&fe({...re}),R.userTasks.some(K=>K.state==="Created")){$({kind:"human",text:"⏸ waiting for a human — complete the task below to continue"});break}if(!G){$({kind:"error",text:"▶ run stopped — no dispatch round was returned"});break}if(G.handled===0&&G.reason==="timers"){const K=R.timers.reduce((ge,ie)=>Math.min(ge,ie.dueInMs),1/0);if(!Number.isFinite(K))break;const X=f.advanceTime(Math.max(K,0)+1);if(!X)break;R=X,$({kind:"step",text:"🕐 the clock advanced — timer fired"}),await new Promise(ge=>setTimeout(ge,Ze));continue}if(G.handled===0)break;await new Promise(K=>setTimeout(K,Ze))}return R&&R.completedInstances>=1?$({kind:"done",text:"✅ process instance completed"}):R&&R.incidentElementIds.length>0&&$({kind:"error",text:"A job failed — incident on the diagram"}),R},[f,$]),E=h.useCallback(async v=>{var R,te,pe;if(!_e||ae.current)return;const{job:x,control:T}=_e,L=++je.current;ae.current=!0,oe(!0);try{let G,re;if(v==="complete")G=f.completeJobManually(x.jobType,"{}"),re="  ↳ completed normally";else if(T.action.kind==="timer"){const K=((te=(R=f.snapshot)==null?void 0:R.timers[0])==null?void 0:te.dueInMs)??0;G=f.advanceTime(Math.max(K,0)+1),re="  ↳ advanced the clock — timer fired"}else{const{errorCode:K,message:X}=T.action;G=f.throwJobError(x.jobType,K,X),re=`  ↳ threw BPMN error ${K}: ${X}`}if(G){$({kind:"vars",text:re,elementId:x.elementId});const K=(pe=G.instances[0])==null?void 0:pe.variables;K&&fe({...K}),await new Promise(X=>setTimeout(X,Ze)),await Le(Ne.current,Ie.current,G,L)}else $({kind:"error",text:"  ↳ failed to resolve the manual job",elementId:x.elementId})}finally{ae.current=!1,oe(!1)}},[_e,f,$,Le]),C=h.useCallback(async()=>{var K;let v=null;try{y.agent&&c.trim()&&(v=hr(c))}catch(X){return A(X instanceof Error?X.message:String(X)),null}Z.current={current:void 0};let x;if(e.imageInput){const X=s.vision;x={read:X??hi(e.scriptedVision).read,live:!!X,resolve:ie=>f.getRunImage(ie)}}const T=_r(y,b.handlers,$,Z.current,x);for(const X of me.keys())delete T[X];const L={};if(y.agents.length>0){if(s.kind!=="scripted"&&s.chat){const ge=new Map;for(const ie of y.agents)ge.set(ie.jobType,[...ge.get(ie.jobType)??[],ie]);for(const[ie,Oe]of ge)L[ie]=Lr(Oe,s.chat,$,{turnRef:Z.current,requiredTools:e.requiredTools})}else if(v&&y.agent){const ge=y.agent.elementId;L[y.agent.jobType]=async ie=>{if(ie.elementId!==ge)throw new Error(`No scripted agent handler for "${ie.elementId}" — only "${ge}" (the primary process's first agent host) is driven by the scripted brain. Use a live brain to exercise more than one host.`);const Oe=await v(ie),At=(Oe.activateElements??[]).map(Dt=>Dt.elementId).join(", ");return $({kind:"agent",text:Oe.completionConditionFulfilled?"🤖 scripted agent: done":`🤖 scripted agent: calling ${At||"(nothing)"}`}),Oe}}}D([]),xe({});const R={...e.seed,...P,...sr(e.imageInput?l:null)};fe(R),Ne.current=T,Ie.current=L;const te=f.redeploy(r),pe=(te==null?void 0:te[0])??y.processId;$({kind:"start",text:`Starting "${pe}" — ${y.agent?s.kind==="scripted"||!s.chat?"scripted brain":`live brain (${s.modelInUse??s.kind})`:"no agent in this model"}`});const G=f.createInstance(pe,JSON.stringify(R)),re=(K=G==null?void 0:G.instances[0])==null?void 0:K.key;return e.imageInput&&l&&re&&f.setRunImage(re,l),{workers:T,agents:L,snap:G}},[f,e,b,r,c,P,l,y,s,$,me]),F=!!f.snapshot&&f.snapshot.completedInstances<1,ke=!F&&!!k&&!ve,kt=h.useCallback(async()=>{if(!(f.phase!=="ready"||ae.current||U||b.hasErrors)){ae.current=!0,oe(!0);try{let v=Ne.current,x=Ie.current,T=f.snapshot;const L=++je.current;if(!F){if(Ee.current&&!Ee.current.validate())return;A(null);const R=await C();if(!R)return;v=R.workers,x=R.agents,T=R.snap,await new Promise(te=>setTimeout(te,Ze))}await Le(v,x,T,L)}finally{ae.current=!1,oe(!1)}}},[f,U,b.hasErrors,F,C,Le]),Et=h.useCallback(async()=>{var v;if(!(f.phase!=="ready"||ae.current||U||b.hasErrors)){ae.current=!0,I(!0);try{let x=Ne.current,T=Ie.current,L=f.snapshot;if(!F){if(Ee.current&&!Ee.current.validate())return;A(null);const re=await C();if(!re)return;x=re.workers,T=re.agents,L=re.snap}if(!L||L.completedInstances>=1)return;const R=L.takenSequenceFlows.length,te=await f.stepWorkers(x,{agents:T});if(!te){$({kind:"error",text:"⏭ step failed — no dispatch round was returned"});return}const pe=(v=te.snapshot.instances[0])==null?void 0:v.variables;pe&&fe({...pe});const G=ni(te.snapshot.takenSequenceFlows,R);$(ti(te,G,Ce,me))}finally{ae.current=!1,I(!1)}}},[f,U,b.hasErrors,F,C,$,Ce,me]),Tt=h.useCallback(()=>{ae.current=!1,je.current++,oe(!1),I(!1),f.reset(),D([]),fe({})},[f]),jt=h.useCallback(()=>{if(!he||ze.current&&!ze.current.validate())return;const v=f.completeUserTask(he.key,JSON.stringify(De));$({kind:"human",text:`👤 ${cn(De)}`}),v&&v.completedInstances>=1&&$({kind:"done",text:"✅ process instance completed"})},[he,De,f,$]),St=h.useMemo(()=>{var v,x;return f.phase==="loading"?a.jsx(J,{variant:"neutral",children:"Booting engine…"}):f.phase==="error"?a.jsx(J,{variant:"danger",children:"Engine error"}):Y?a.jsx(J,{variant:"info",children:"Running…"}):U?a.jsx(J,{variant:"info",children:"Stepping…"}):(((v=f.snapshot)==null?void 0:v.incidentElementIds.length)??0)>0?a.jsx(J,{variant:"danger",children:"Incident"}):he?a.jsx(J,{variant:"warning",children:"Waiting for a human"}):(((x=f.snapshot)==null?void 0:x.completedInstances)??0)>=1?a.jsx(J,{variant:"success",children:"Completed"}):f.snapshot?a.jsx(J,{variant:"warning",children:"Paused"}):a.jsx(J,{variant:"neutral",children:"Ready"})},[f.phase,f.snapshot,Y,U,he]);return a.jsxs("div",{className:"runner",children:[a.jsxs("section",{className:"intro",children:[a.jsx("h1",{children:e.title}),a.jsx("p",{children:e.blurb}),a.jsxs("div",{className:"controls",children:[a.jsx(Q,{"data-tour":be.runButton,onClick:()=>void kt(),disabled:f.phase!=="ready"||Y||U||b.hasErrors||ke,children:"▶ Run"}),a.jsx(Q,{variant:"secondary",onClick:()=>void Et(),disabled:f.phase!=="ready"||Y||U||b.hasErrors||ke||(((Mn=f.snapshot)==null?void 0:Mn.completedInstances)??0)>=1,children:"⏭ Step"}),a.jsx(Q,{variant:"secondary",onClick:Tt,disabled:f.phase!=="ready"||U,children:"↺ Reset"}),e.tour&&a.jsx(Q,{variant:"secondary",onClick:M.start,disabled:M.active,children:M.active?"Touring…":`🧭 ${e.tour.label}`}),St]}),f.phase==="error"&&a.jsxs(se,{variant:"destructive",children:[a.jsx(ce,{children:"Engine error"}),a.jsx(le,{children:f.error})]}),N&&a.jsxs(se,{variant:"destructive",children:[a.jsx(ce,{children:"Code didn't compile"}),a.jsx(le,{children:N})]}),b.hasErrors&&a.jsxs(se,{variant:"destructive",children:[a.jsx(ce,{children:"Run is disabled — the diagram has unresolved references"}),a.jsx(le,{children:a.jsx("ul",{className:"diagnostics",children:b.diagnostics.filter(v=>v.severity==="error").map((v,x)=>a.jsx("li",{children:v.message},x))})})]}),!b.hasErrors&&b.diagnostics.length>0&&a.jsxs(se,{children:[a.jsx(ce,{children:"Heads up"}),a.jsx(le,{children:a.jsx("ul",{className:"diagnostics",children:b.diagnostics.map((v,x)=>a.jsx("li",{children:v.message},x))})})]})]}),a.jsxs("div",{className:"grid",children:[a.jsxs("div",{className:"col",children:[a.jsx(we,{sectionId:"process","data-tour":be.diagram,title:"Process",description:`${y.processName} — live token (green), incidents (red).`,children:a.jsx(h.Suspense,{fallback:a.jsx("div",{className:"diagram-fallback",children:f.phase==="loading"?"Booting the engine…":"Loading diagram…"}),children:a.jsx(Qi,{xml:b.resolvedBpmn,activeIds:((vn=f.snapshot)==null?void 0:vn.activeElementIds)??[],incidentIds:((xn=f.snapshot)==null?void 0:xn.incidentElementIds)??[],className:"diagram"})})}),he&&a.jsxs(we,{sectionId:"human-task",title:(ne==null?void 0:ne.label)??"Human task",description:Pe?`Rendered from the model's form "${ne==null?void 0:ne.formId}".`:"This task has no linked form — complete it with no variables.",children:[Qe.length>0&&a.jsxs(se,{variant:"destructive",children:[a.jsx(ce,{children:"The agent didn't finish its checks"}),a.jsxs(le,{children:["It completed without running"," ",Qe.map(v=>v.label||v.elementId).join(", "),". The process took the default path to this task, so the findings below have no value to report."]})]}),Pe&&a.jsx(h.Suspense,{fallback:a.jsx("div",{className:"form-fallback",children:"Loading form…"}),children:a.jsx(Yn,{ref:ze,schema:Pe,values:De,onChange:(v,x)=>xe(T=>({...T,[v]:x})),context:W,onValidityChange:Te})}),a.jsx(Q,{onClick:jt,disabled:!!Pe&&!tn,children:"Complete task"})]}),_e&&a.jsx(we,{sectionId:"manual-job",title:_e.control.label,description:"This job is held here on purpose — pick how it resolves.",children:a.jsxs("div",{className:"controls",children:[a.jsx(Q,{onClick:()=>void E("complete"),disabled:Y||U,children:_e.control.completeLabel??"✅ Complete normally"}),a.jsx(Q,{variant:"secondary",onClick:()=>void E("action"),disabled:Y||U,children:_e.control.action.label})]})}),a.jsxs("div",{className:"row",children:[a.jsx(we,{sectionId:"variables",className:"grow","data-tour":be.variablesPanel,title:"Variables",description:"The instance payload, live.",children:a.jsx("pre",{className:"vars",children:cn(W,2)})}),a.jsx(Bi,{log:ee,elementStats:(Nn=f.snapshot)==null?void 0:Nn.elementStats,incidents:(In=f.snapshot)==null?void 0:In.incidents,labelFor:Ce})]})]}),a.jsxs("div",{className:"col",children:[(y.agent||e.imageInput)&&a.jsx(we,{sectionId:"brain","data-tour":be.brainPanel,title:"Brain",description:y.agent?`What drives “${y.agent.label}”. The model recommends; the process governs.`:"What reads the image. The model recommends; the process governs.",children:a.jsx(Ni,{brain:s,showText:!!y.agent,showVision:!!e.imageInput})}),a.jsxs(we,{sectionId:"start",title:"Start",description:y.startFormId?`The model's start form "${y.startFormId}".`:e.imageInput?"Pick a seed photo or upload your own to read.":"The starting payload.",children:[e.imageInput&&a.jsx(Ei,{imageInput:e.imageInput,value:l,onSelect:u,disabled:Y}),e.scenarios&&a.jsx("div",{className:"scenarios",children:e.scenarios.map(v=>a.jsx(Q,{size:"sm",variant:"secondary",disabled:Y,onClick:()=>V(x=>({...x,...v.variables})),children:v.label},v.label))}),k?a.jsx(h.Suspense,{fallback:a.jsx("div",{className:"form-fallback",children:"Loading form…"}),children:a.jsx(Yn,{ref:Ee,schema:k,values:P,onChange:(v,x)=>V(T=>({...T,[v]:x})),disabled:Y,onValidityChange:Re})}):a.jsx("pre",{className:"vars",children:cn(P,2)})]}),a.jsx(we,{sectionId:"code",className:"editors","data-tour":be.codePanel,title:"Code",description:"One handler per BPMN element. Return variables to merge, or throw to fail the job.",children:a.jsx(h.Suspense,{fallback:a.jsx("div",{className:"editor-fallback",children:"Loading editor…"}),children:a.jsxs($t,{value:q,onValueChange:ue,children:[a.jsxs(Gt,{children:[a.jsx(Je,{value:Gn,children:"model"}),y.agent&&a.jsx(Je,{value:an,children:"agent (scripted)"}),e.handlers.map(v=>{var x;return a.jsx(Je,{value:v.elementId,children:((x=y.tasks.find(T=>T.elementId===v.elementId))==null?void 0:x.label)??v.elementId},v.elementId)}),Object.keys(p).map(v=>a.jsx(Je,{value:Vn+v,children:v},v))]}),a.jsxs(He,{value:Gn,children:[a.jsxs("div",{className:"editor-meta",children:[a.jsx("strong",{children:"Model"}),a.jsx("code",{children:"edit the diagram visually — Run re-checks it below"}),a.jsx(Q,{variant:"secondary",size:"sm",onClick:()=>i(e.bpmn),disabled:r===e.bpmn,children:"Revert to original"})]}),a.jsx(Ji,{value:r,onChange:i})]}),y.agent&&a.jsxs(He,{value:an,children:[a.jsxs("div",{className:"editor-meta",children:[a.jsx("strong",{children:y.agent.label}),a.jsx("code",{children:s.kind==="scripted"||!s.chat?"in use":"unused — a live brain is connected"})]}),a.jsx("div",{className:"editor-wrap",children:a.jsx(sn,{height:"360px",defaultLanguage:"javascript",value:c,onChange:v=>g(v??""),options:ln})})]}),e.handlers.map(v=>{var x;return a.jsxs(He,{value:v.elementId,children:[a.jsxs("div",{className:"editor-meta",children:[a.jsx("strong",{children:((x=y.tasks.find(T=>T.elementId===v.elementId))==null?void 0:x.label)??v.elementId}),a.jsx("code",{children:v.standsInFor??v.elementId})]}),a.jsx("div",{className:"editor-wrap",children:a.jsx(sn,{height:"360px",defaultLanguage:"javascript",value:m[v.elementId],onChange:T=>o(L=>({...L,[v.elementId]:T??""})),options:ln})})]},v.elementId)}),Object.keys(p).map(v=>a.jsxs(He,{value:Vn+v,children:[a.jsxs("div",{className:"editor-meta",children:[a.jsx("strong",{children:v}),a.jsxs("code",{children:["prompt / template text — substitutes"," ","{{"+v+"}}"]})]}),a.jsx("div",{className:"editor-wrap",children:a.jsx(sn,{height:"360px",defaultLanguage:"markdown",value:p[v],onChange:x=>_(T=>Ve(T,{[v]:x??""})),options:ln})})]},v))]})})}),y.agent&&a.jsx(we,{sectionId:"tools",title:"Tools, as the model sees them",description:a.jsxs(a.Fragment,{children:["Read from the diagram — element name, documentation, and every",a.jsx("code",{children:" fromAi(…)"})," argument."]}),children:a.jsx("ul",{className:"tool-list",children:y.agent.tools.map(v=>a.jsxs("li",{children:[a.jsx("code",{children:v.elementId}),a.jsxs("span",{children:[" — ",v.documentation||v.label]}),v.args.length>0&&a.jsx("ul",{children:v.args.map(x=>a.jsxs("li",{children:[a.jsxs("code",{children:[x.name,": ",x.type]})," ","— ",x.description]},x.name))})]},v.elementId))})})]})]})]})}const ln={minimap:{enabled:!1},fontSize:13,scrollBeyondLastLine:!1,tabSize:2,automaticLayout:!0},qi=`<?xml version="1.0" encoding="UTF-8"?>\r
...
`,ao={id:"compliance-walkthrough",label:"Take the tour",steps:[{title:"Start a run",description:"Press Run to send a shipment through the compliance agent.",target:{anchor:be.runButton}},{title:"The agent picks its own tools",description:"This AI Agent reads the shipment notes and decides, turn by turn, which of the tools below it to call — nothing here is hard-coded into a fixed sequence.",target:{elementId:"ComplianceCheckAgent"}},{title:"Watch the token move",description:"The agent's first move is to look up the genetic marker mentioned in the notes.",target:{elementId:"VerifyGeneticMarker"},waitFor:{kind:"activeElement",elementId:"VerifyGeneticMarker"}},{title:"A cleared shipment notifies the export team",description:"Once the compliance score comes back clean, the process notifies the export team automatically — no human review needed for this scenario.",target:{elementId:"NotifyExportTeam"},waitFor:{kind:"elementCompleted",elementId:"NotifyExportTeam"}},{title:"Everything the run recorded",description:"The variables panel shows the marker record, the country lookup, the compliance score, and the final decision — exactly what each tool and the agent wrote along the way.",target:{anchor:be.variablesPanel}}],successEvent:{kind:"instanceCompleted"}},so=`<?xml version="1.0" encoding="UTF-8"?>
