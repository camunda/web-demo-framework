const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/driver-CTZuBZOi.css","assets/diagram-js-DAKGYcfb.css","assets/bpmn-embedded-D2YZNlHu.css","assets/RuntimeDiagram-B2IYfHo7.js","assets/vendor-react-9Ma26nY1.js","assets/Viewer-D_7S4Gwm.js","assets/MonacoEditor-CupzgRKw.js","assets/MonacoEditor-BvcAXSsK.css","assets/vendor-modeler-r_JgyEaj.js","assets/vendor-design-system-CLZSavB3.js","assets/vendor-design-system-Cv2l9lDz.css","assets/parser-DkgAe_kI.js","assets/ModelEditor-Dwlgp6JA.css","assets/FormRenderer-C0Po0kRB.js","assets/FormRenderer-D1JIHOW6.css"])))=>i.map(i=>d[i]);
var At=Object.defineProperty;var Ct=(e,n,t)=>n in e?At(e,n,{enumerable:!0,configurable:!0,writable:!0,value:t}):e[n]=t;var B=(e,n,t)=>Ct(e,typeof n!="symbol"?n+"":n,t);import{r as h,j as s,i as Dt}from"./vendor-react-9Ma26nY1.js";import{B as Z,a as J,L as ze,S as Kn,b as Xn,c as et,d as nt,e as tt,A as se,f as ae,g as ce,I as tn,C as Lt,h as Pt,i as zt,j as Rt,k as Ot,l as Bt,T as Ft,m as Ut,n as Qe,o as Je,p as $t,q as Yt}from"./vendor-design-system-CLZSavB3.js";(function(){const n=document.createElement("link").relList;if(n&&n.supports&&n.supports("modulepreload"))return;for(const i of document.querySelectorAll('link[rel="modulepreload"]'))r(i);new MutationObserver(i=>{for(const a of i)if(a.type==="childList")for(const c of a.addedNodes)c.tagName==="LINK"&&c.rel==="modulepreload"&&r(c)}).observe(document,{childList:!0,subtree:!0});function t(i){const a={};return i.integrity&&(a.integrity=i.integrity),i.referrerPolicy&&(a.referrerPolicy=i.referrerPolicy),i.crossOrigin==="use-credentials"?a.credentials="include":i.crossOrigin==="anonymous"?a.credentials="omit":a.credentials="same-origin",a}function r(i){if(i.ep)return;i.ep=!0;const a=t(i);fetch(i.href,a)}})();const Gt="modulepreload",Qt=function(e){return"/pr-preview/pr-82/"+e},kn={},le=function(n,t,r){let i=Promise.resolve();if(t&&t.length>0){let c=function(o){return Promise.all(o.map(l=>Promise.resolve(l).then(g=>({status:"fulfilled",value:g}),g=>({status:"rejected",reason:g}))))};document.getElementsByTagName("link");const u=document.querySelector("meta[property=csp-nonce]"),m=(u==null?void 0:u.nonce)||(u==null?void 0:u.getAttribute("nonce"));i=c(t.map(o=>{if(o=Qt(o),o in kn)return;kn[o]=!0;const l=o.endsWith(".css"),g=l?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${o}"]${g}`))return;const p=document.createElement("link");if(p.rel=l?"stylesheet":Gt,l||(p.as="script"),p.crossOrigin="",p.href=o,m&&p.setAttribute("nonce",m),document.head.appendChild(p),l)return new Promise((y,b)=>{p.addEventListener("load",y),p.addEventListener("error",()=>b(new Error(`Unable to preload CSS for ${o}`)))})}))}function a(c){const u=new Event("vite:preloadError",{cancelable:!0});if(u.payload=c,window.dispatchEvent(u),!u.defaultPrevented)throw c}return i.then(c=>{for(const u of c||[])u.status==="rejected"&&a(u.reason);return n().catch(a)})},Jt="io.camunda.agenticai:aiagent",_e="http://www.omg.org/spec/BPMN/20100524/MODEL",Vt="http://camunda.org/schema/zeebe/1.0";function dn(e,n){return Array.from(e.getElementsByTagNameNS(Vt,n))}function rt(e,n){return dn(e,n).filter(t=>Zt(t)===e)}function Zt(e){let n=e.parentElement;for(;n;){if(n.namespaceURI===_e&&n.localName!=="extensionElements")return n;n=n.parentElement}return null}function hn(e){const n=rt(e,"taskDefinition")[0],t=n==null?void 0:n.getAttribute("type");return t||(e.localName==="scriptTask"?e.getAttribute("id")??null:null)}function En(e){const n=Array.from(e.children).find(t=>t.namespaceURI===_e&&t.localName==="documentation");return((n==null?void 0:n.textContent)??"").trim()}function Tn(e){if(!e)return"";const n=e.startsWith("=")?e.slice(1):e,t=n.match(/"((?:[^"\\]|\\.)*)"/g);return t?t.map(r=>r.slice(1,-1).replace(/\\n/g,`
...
`)}function Ht(e){return ot(it(e))}function Wt(e){const n=Array.from(e.children).find(t=>t.namespaceURI===_e&&t.localName==="extensionElements");return n?ot(it(n)):[]}function ot(e){const n=/fromAi\(\s*toolCall\.([A-Za-z_$][\w$]*)\s*,\s*"((?:[^"\\]|\\.)*)"\s*(?:,\s*"(\w+)")?/g,t=[],r=new Set;for(const i of e.matchAll(n)){const a=i[1];r.has(a)||(r.add(a),t.push({name:a,description:(i[2]??"").replace(/&#10;/g,`
`).replace(/\\"/g,'"').replace(/&quot;/g,'"').replace(/&#39;/g,"'").trim(),type:i[3]??"string"}))}return t}function qt(e){const n={};for(const t of rt(e,"input")){const r=t.getAttribute("target");r&&(n[r]=t.getAttribute("source")??"")}return n}function Kt(e){return Array.from(e.getElementsByTagNameNS(_e,"adHocSubProcess")).filter(n=>(hn(n)??"").startsWith(Jt))}const Xt=new Set(["subProcess","adHocSubProcess","callActivity"]),er=new Set(["adHocSubProcess","subProcess","transaction"]);function nr(e){let n=e.parentElement;for(;n;){if(n.namespaceURI===_e&&er.has(n.localName))return n;n=n.parentElement}return null}function tr(e,n){const t=qt(e),r=Number((t["data.limits.maxModelCalls"]??"").replace(/^=/,""));return{elementId:e.getAttribute("id")??"agent",label:e.getAttribute("name")??"Agent",jobType:hn(e),systemPrompt:Tn(t["data.systemPrompt.prompt"]),userPrompt:Tn(t["data.userPrompt.prompt"]),maxModelCalls:Number.isFinite(r)&&r>0?r:10,tools:n}}function rr(e,n){var g;const t=e.getAttribute("id")??"",r=e.getAttribute("name")??t,i=Kt(e);i.length>1&&n.push({severity:"warning",elementId:i.map(p=>p.getAttribute("id")).join(", "),message:`Process "${r}" hosts ${i.length} AI Agent sub-processes (${i.map(p=>p.getAttribute("id")).join(", ")}). Each gets its own independent agent state (turn counter, called tools) — the run itself is shared across hosts, but each host's agent state within it is not.`});const a=[],c=new Map(i.map(p=>[p,[]]));for(const p of Array.from(e.getElementsByTagName("*"))){if(p.namespaceURI!==_e||i.includes(p))continue;const y=p.getAttribute("id");if(!y)continue;const b=nr(p),w=b&&i.includes(b)?b:null;if(w&&Xt.has(p.localName)){const k=p.getAttribute("name")??y,L=En(p);a.push({elementId:y,label:k,jobType:"",documentation:L,isTool:!0,compound:!0}),c.get(w).push({elementId:y,label:k,jobType:"",documentation:L,args:Wt(p),compound:!0});continue}const f=hn(p);if(!f)continue;const M={elementId:y,label:p.getAttribute("name")??y,jobType:f,documentation:En(p),isTool:w!=null};a.push(M),w&&c.get(w).push({elementId:y,label:M.label,jobType:f,documentation:M.documentation,args:Ht(p)})}const u=i.map(p=>tr(p,c.get(p))),m=Array.from(e.getElementsByTagNameNS(_e,"userTask")).map(p=>{var y;return{elementId:p.getAttribute("id")??"",label:p.getAttribute("name")??p.getAttribute("id")??"",formId:((y=dn(p,"formDefinition")[0])==null?void 0:y.getAttribute("formId"))??void 0}}),o=e.getElementsByTagNameNS(_e,"startEvent")[0],l=o?((g=dn(o,"formDefinition")[0])==null?void 0:g.getAttribute("formId"))??void 0:void 0;return{processId:t,processName:r,tasks:a,agents:u,userTasks:m,startFormId:l}}function ir(e,n={}){const t=new DOMParser().parseFromString(e,"application/xml"),r=t.getElementsByTagName("parsererror")[0];if(r)throw new Error(`Invalid BPMN XML: ${r.textContent}`);const i=Array.from(t.getElementsByTagNameNS(_e,"process"));if(i.length===0)throw new Error("No <bpmn:process> in the diagram.");const a=[],c=i.map(m=>rr(m,a));let u=n.processId?c.find(m=>m.processId===n.processId):void 0;return n.processId&&!u&&a.push({severity:"warning",message:`Requested process "${n.processId}" not found — falling back to "${c[0].processId}".`}),u??(u=c[0]),c.length>1&&a.push({severity:"warning",message:`Diagram has ${c.length} <bpmn:process> elements (${c.map(m=>m.processId).join(", ")}); using "${u.processId}" as the active process. Pass a processId to parseModel to target another.`}),{processes:c,diagnostics:a,processId:u.processId,processName:u.processName,tasks:u.tasks,agent:u.agents[0]??null,agents:c.flatMap(m=>m.agents),userTasks:u.userTasks,startFormId:u.startFormId}}function or(e){return e?e.imageId?{imageId:e.imageId}:e.imageName?{imageName:e.imageName}:{}:{}}function st(e,n){return n?e.pixels:e.imageId??e.pixels}const sr="No image selected — pick or upload a photo to read.";function jn(){return sr}function ar(e,n){return async t=>{const r=e.resolve(n);if(!r)return jn();const i=st(r,e.live);if(i===void 0)return jn();try{return await e.read(i,t)}catch(a){return`Couldn't read the image (${a instanceof Error?a.message:String(a)}).`}}}function cr(e,n){return async()=>{const t=e.resolve(n);if(t)return st(t,e.live)}}function lr(){return`<!doctype html><html><head><meta charset="utf-8"></head><body><script>
    "use strict";
    ...
    post({ kind: "ready" });
  <\/script></body></html>`}function at(e,n={}){const{timeoutMs:t=5e3,onTrace:r,onVision:i,onImage:a}=n,c=`${Date.now()}-${Math.random().toString(36).slice(2)}`;return new Promise((u,m)=>{const o=document.createElement("iframe");o.setAttribute("sandbox","allow-scripts"),o.style.display="none",o.setAttribute("aria-hidden","true");let l=!1,g;const p=()=>{g&&clearTimeout(g),window.removeEventListener("message",b),o.remove()},y=f=>{l||(l=!0,p(),f())};function b(f){var k;if(f.source!==o.contentWindow)return;const M=f.data;if(!(!M||typeof M!="object")){if(M.kind==="ready"){const L=e.job,Y=e.kind==="run-handler"?{kind:"run-handler",id:c,source:e.source,job:L,hasVision:e.hasVision}:{kind:"run-agent",id:c,source:e.source,job:L};(k=o.contentWindow)==null||k.postMessage(Y,"*");return}"id"in M&&M.id!==c||(M.kind==="trace"?r==null||r(M.text):M.kind==="vision-request"?w(M.callId,i,"vision",M.prompt):M.kind==="image-request"?w(M.callId,a,"image"):M.kind==="result"?y(()=>u(M.value)):M.kind==="error"&&y(()=>m(new Error(M.message))))}}function w(f,M,k,...L){const Y=H=>{var de;return(de=o.contentWindow)==null?void 0:de.postMessage(H,"*")};if(!M){Y({kind:"helper-error",id:c,callId:f,message:`${k} helper is not available.`});return}Promise.resolve().then(()=>M(...L)).then(H=>Y({kind:"helper-result",id:c,callId:f,value:H}),H=>Y({kind:"helper-error",id:c,callId:f,message:H instanceof Error?H.message:String(H)}))}window.addEventListener("message",b),g=setTimeout(()=>{y(()=>m(new Error(`Handler timed out after ${t}ms — the sandboxed run was terminated.`)))},t),o.srcdoc=lr(),document.body.appendChild(o)})}function ct(e){return{key:e.key,type:e.type,elementId:e.elementId,instanceKey:e.instanceKey,variables:e.variables??{}}}function dr(e,n,t){const r=typeof t.vision=="function";return at({kind:"run-handler",source:e,job:ct(n),hasVision:r},{onTrace:t.trace,onVision:t.vision?i=>t.vision(i):void 0,onImage:t.image?()=>t.image():void 0})}function ur(e,n){return at({kind:"run-agent",source:e,job:ct(n)})}function lt(e,n){try{new Function(`"use strict"; return (${e});`)}catch{throw new Error(`${n} has a syntax error.`)}}function mr(e){return lt(e,"Handler code"),(n,t)=>dr(e,n,t)}function pr(e){return lt(e,"Agent code"),n=>ur(e,n)}function gr(e,n,t,r){return{sleep:i=>new Promise(a=>setTimeout(a,i)),trace:i=>n({kind:"tool",text:`   ${i}`,elementId:e.elementId,turn:t}),text:(i,a="")=>{const c=e.variables[i];return typeof c=="string"?c:c==null?a:String(c)},num:(i,a=0)=>{const c=e.variables[i],u=typeof c=="number"?c:Number(c);return Number.isFinite(u)?u:a},...r?{vision:ar(r,e.instanceKey),image:cr(r,e.instanceKey)}:{}}}function hr(e){if(e===void 0)return"undefined";try{return JSON.stringify(e)}catch{return"[unserializable value]"}}function br(e,n,t,r,i){const a={},c=e.processes.flatMap(m=>m.tasks),u=new Map(c.map(m=>[m.elementId,m.label]));for(const m of c)m.compound||a[m.jobType]||(a[m.jobType]=async o=>{const l=n[o.elementId];if(!l)throw new Error(`No handler registered for ${o.elementId} (job type ${o.type})`);const g=u.get(o.elementId)??o.elementId,p=r==null?void 0:r.current;t({kind:"tool",text:`▶ ${g}`,elementId:o.elementId,turn:p});const y=await l(o,gr(o,t,p,i));return t({kind:"vars",text:`  ↳ ${hr(y)}`,elementId:o.elementId,result:y,turn:p}),y});return a}const fr=/\{\{\s*([A-Za-z][A-Za-z0-9_-]*)\s*\}\}/g;function Ke(...e){const n=Object.create(null);for(const t of e)if(t)for(const r of Object.keys(t))n[r]=t[r];return n}function yr(e){return(e.split("/").pop()??e).replace(/\.[^./]+$/,"")}function dt(e){return e.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;")}function _r(e){return dt(e).replace(/"/g,"&quot;").replace(/\n/g,"&#10;").replace(/\t/g,"&#9;")}function wr(e){return e.replace(/\\/g,"\\\\").replace(/&/g,"&amp;").replace(/"/g,"\\&#34;").replace(/\n/g,"&#10;").replace(/\t/g,"&#9;").replace(/</g,"&lt;").replace(/>/g,"&gt;")}function Mr(e){return JSON.stringify(e).slice(1,-1)}function xr(e,n){const t=e.lastIndexOf("<",n),r=e.lastIndexOf(">",n);if(t<=r)return"text";const i=e.slice(t,n);if((i.match(/"/g)??[]).length%2===0)return"text";const c=i.lastIndexOf('"');return(i.slice(c+1).match(/&#34;|&quot;/g)??[]).length%2===1?"feel-literal":"attribute"}function vr(e,n,t="xml"){const r=[],i=new Set;return{result:e.replace(fr,(c,u,m)=>{const o=u.trim();if(!Object.prototype.hasOwnProperty.call(n,o))return i.has(o)||(i.add(o),r.push(o)),c;const l=n[o];if(t==="json")return Mr(l);const g=xr(e,m);return g==="feel-literal"?wr(l):g==="attribute"?_r(l):dt(l)}),unresolved:r}}function Nr(){return{processes:[],diagnostics:[],processId:"",processName:"",tasks:[],agent:null,agents:[],userTasks:[],startFormId:void 0}}function Ir(e,n={},t=e.bpmn,r={}){const i=[],a=Ke(e.templates,r),{result:c,unresolved:u}=vr(t,a,"xml");for(const M of u)i.push({severity:"warning",message:`Template placeholder "{{${M}}}" has no matching prompt/template content — left in the model as-is, not substituted.`});let m;try{m=ir(c)}catch(M){return i.push({severity:"error",message:M instanceof Error?M.message:String(M)}),{resolvedBpmn:c,model:Nr(),handlers:{},forms:{},diagnostics:i,hasErrors:!0}}i.push(...m.diagnostics);const o=m.processes.flatMap(M=>M.tasks),l=new Map(e.handlers.map(M=>[M.elementId,M.source])),g={};for(const M of o){if(M.compound)continue;const k=n[M.elementId]??l.get(M.elementId);if(k===void 0){i.push({severity:"error",elementId:M.elementId,jobType:M.jobType,message:`No handler for "${M.label}" (${M.elementId}, job type "${M.jobType}"). Add a handler for this element, or remove it from the diagram.`});continue}try{g[M.elementId]=mr(k)}catch(L){i.push({severity:"error",elementId:M.elementId,jobType:M.jobType,message:`"${M.label}" (${M.elementId}): handler code didn't compile — ${L instanceof Error?L.message:String(L)}`})}}const p=new Set(o.map(M=>M.elementId)),y=new Set([...l.keys(),...Object.keys(n)]);for(const M of y)p.has(M)||i.push({severity:"error",elementId:M,message:`Handler "${M}" doesn't match any element in the current diagram — likely orphaned by a rename. Rename it back, or remove the handler.`});const b={},w=e.forms??{},f=(M,k)=>{if(!M)return;const L=w[M];L?b[M]=L:i.push({severity:"error",formId:M,message:`${k} references form "${M}", which has no matching schema.`})};for(const M of m.processes){f(M.startFormId,`The start event of process "${M.processName}"`);for(const k of M.userTasks)f(k.formId,`User task "${k.label}" (${k.elementId})`)}return{resolvedBpmn:c,model:m,handlers:g,forms:b,diagnostics:i,hasErrors:i.some(M=>M.severity==="error")}}function kr(e){const n=e.indexOf("{");if(n<0)return null;let t=0;for(let r=n;r<e.length;r++)if(e[r]==="{")t++;else if(e[r]==="}"&&(t--,t===0))try{const i=JSON.parse(e.slice(n,r+1));return typeof i=="object"&&i!==null&&!Array.isArray(i)?i:null}catch{return null}return null}function un(e,n=220){const t=e.replace(/\s+/g," ").trim();return t.length>n?`${t.slice(0,n-1)}…`:t}function Sn(e){const n=e.arguments??e.args??e.parameters??e.input;return n&&typeof n=="object"&&!Array.isArray(n)?n:{}}function An(e){if(!e)return[];const n=e.tool??e.name??e.action;if(typeof n=="string"&&n.trim())return[{name:n.trim(),args:Sn(e)}];const t=e.tools??e.tool_calls??e.toolset??e.actions,r=Array.isArray(t)?t:Object.values(e).find(a=>Array.isArray(a))??[],i=[];for(const a of r)if(typeof a=="string")a.trim()&&i.push({name:a.trim(),args:{}});else if(a&&typeof a=="object"){const c=a,u=c.name??c.tool??c.id??c.function;typeof u=="string"&&u.trim()&&i.push({name:u.trim(),args:Sn(c)})}return i}function Er(e){if(!e)return!1;const n=e.done??e.finished??e.complete;return typeof n=="boolean"?n:typeof n=="string"?n.toLowerCase()==="true":!1}function Cn(e){const n=e.args.length?e.args.map(r=>`      ${r.name} (${r.type}) — ${r.description}`).join(`
...
character, with nothing added. When your work is finished, reply exactly
{"done": true} and no tool.`}function jr(e,n,t,r,i=[],a=[],c=!1){const u=e.userPrompt||"Carry out your task.",m=Object.entries(n).filter(([,l])=>typeof l=="string"&&l.trim().length>0).map(([l,g])=>`  ${l}: ${String(g)}`),o=[u,m.length?`Case data:
${m.join(`
...
`)}async function Sr(e,n,t,r,i,a){let c="";n({kind:"llm",text:"LLM thinking…",key:t,pending:!0,turn:a});const u=await e(r,i,m=>{c+=m,n({kind:"llm",text:`${un(c)} ▍`,key:t,pending:!0,turn:a})});return n({kind:"llm",text:un(u||c)||"(empty reply)",key:t,pending:!1,turn:a}),u}function Ar(e,n){switch(e){case"number":return typeof n=="number"&&Number.isFinite(n)?{ok:!0,value:n}:typeof n=="string"&&n.trim()!==""&&Number.isFinite(Number(n))?{ok:!0,value:Number(n)}:{ok:!1};case"boolean":return typeof n=="boolean"?{ok:!0,value:n}:typeof n=="string"&&/^(true|false)$/i.test(n.trim())?{ok:!0,value:n.trim().toLowerCase()==="true"}:{ok:!1};default:return typeof n=="object"?{ok:!1}:{ok:!0,value:String(n)}}}function Cr(e,n,t){const r={},i=new Map,a=new Map;for(const{tool:c,args:u}of e){const m={};for(const o of c.args){const l=u[o.name];if(!(l!=null&&l!=="")){n({kind:"error",text:`🤖 ${c.elementId}: model supplied no value for "${o.name}"`,turn:t,elementId:c.elementId});continue}const p=i.get(o.name);if(p!==void 0&&p!==c.elementId){n({kind:"error",text:`🤖 argument name collision on "${o.name}": both ${p} and ${c.elementId} declare it — ${p} already claimed it this turn, ${c.elementId}'s value is dropped`,turn:t,elementId:c.elementId});continue}const y=Ar(o.type,l);if(!y.ok){n({kind:"error",text:`🤖 ${c.elementId}: "${o.name}" is declared as ${o.type} but the model supplied ${JSON.stringify(l)} — rejected, not passed through`,turn:t,elementId:c.elementId});continue}r[o.name]=y.value,m[o.name]=y.value,i.set(o.name,c.elementId)}a.set(c.elementId,m)}return{variablesOut:r,forHistory:a}}function Dr(e,n,t,r={}){const{maxNewTokens:i=384,allowRepeats:a=!1,allowMultiToolTurns:c=!1,turnRef:u,requiredTools:m=[],maxEarlyDoneNudges:o=1}=r;let l=0;const g=new Set,p=[];let y=0,b=[],w=[];return async f=>{const M=f.variables,k=M.toolCallResult;for(k!==void 0&&p.length&&(p[p.length-1]=`${p[p.length-1]} → ${un(JSON.stringify(k),160)}`);;){const Y=await L();if(Y)return Y}async function L(){if(l+=1,u&&(u.current=l),l>e.maxModelCalls)return t({kind:"error",text:`Turn budget spent (maxModelCalls=${e.maxModelCalls}) — completing the agent.`,turn:l}),{completionConditionFulfilled:!0};const Y=a?e.tools:e.tools.filter(C=>!g.has(C.elementId)),H=[{role:"system",content:Tr(e,c,Y)},{role:"user",content:jr(e,M,p,Y,b,w,a)}];b=[],w=[];let de;try{de=await Sr(n,t,`llm-turn-${l}`,H,i,l)}catch(C){return t({kind:"error",text:`LLM call failed: ${C instanceof Error?C.message:String(C)} — completing the agent.`,turn:l}),{completionConditionFulfilled:!0}}const G=kr(de);if(Er(G)&&An(G).length===0){const C=m.filter(W=>!g.has(W));return C.length&&y<o?(y+=1,b=C,t({kind:"agent",text:`🤖 model says it is done, but ${C.join(", ")} hasn't run — asking once more`,turn:l}),null):(t({kind:"agent",text:"🤖 model says it is done",turn:l}),{completionConditionFulfilled:!0})}const ie=An(G);if(ie.length===0)return t({kind:"error",text:"🤖 model named no tool (and didn't say it was done) — asking again",turn:l}),w=['it named no tool and did not say it was done — reply with {"tool": "...", "arguments": {...}} or {"done": true}'],null;const U=[],I=[],N=[];for(const C of ie){const W=e.tools.find(he=>he.elementId===C.name);if(!W){I.push(C.name);continue}if(!a&&g.has(W.elementId)){N.push(W.elementId);continue}U.push({tool:W,args:C.args})}if(I.length&&t({kind:"error",text:`🤖 model named a tool that doesn't exist: ${I.join(", ")} — nothing activated`,turn:l}),N.length&&t({kind:"error",text:`🤖 model asked to re-run ${N.join(", ")} — skipped (already run)`,turn:l}),U.length===0)return t({kind:"agent",text:"🤖 nothing activated — asking again",turn:l}),w=[...I.length?[`${I.join(", ")} ${I.length===1?"is":"are"} not a real tool`]:[],...N.length?[`${N.join(", ")} has already run and will never run again — pick a different tool, or reply {"done": true} if nothing is left to do`]:[]],null;const{variablesOut:A,forHistory:K}=Cr(U,t,l);for(const{tool:C}of U)g.add(C.elementId),p.push(`- ${C.elementId}(${JSON.stringify(K.get(C.elementId))})`);for(const{tool:C}of U)t({kind:"agent",text:`🤖 calling ${C.elementId}`,turn:l,elementId:C.elementId,args:K.get(C.elementId)??{}});return{activateElements:U.map(C=>({elementId:C.tool.elementId})),variables:A}}}}function Lr(e,n,t,r={}){const i=new Map(e.map(a=>[a.elementId,Dr(a,n,t,r)]));return async a=>{const c=i.get(a.elementId);if(!c)throw new Error(`No agent host registered for "${a.elementId}"`);return c(a)}}class mn{__destroy_into_raw(){const n=this.__wbg_ptr;return this.__wbg_ptr=0,Dn.unregister(this),n}free(){const n=this.__destroy_into_raw();d.__wbg_testengine_free(n,0)}activateJobs(n,t,r,i){let a,c;try{const y=d.__wbindgen_add_to_stack_pointer(-16),b=S(n,d.__wbindgen_export,d.__wbindgen_export2),w=j,f=S(i,d.__wbindgen_export,d.__wbindgen_export2),M=j;d.testengine_activateJobs(y,this.__wbg_ptr,b,w,t,r,f,M);var u=_().getInt32(y+0,!0),m=_().getInt32(y+4,!0),o=_().getInt32(y+8,!0),l=_().getInt32(y+12,!0),g=u,p=m;if(l)throw g=0,p=0,R(o);return a=g,c=p,z(g,p)}finally{d.__wbindgen_add_to_stack_pointer(16),d.__wbindgen_export3(a,c,1)}}advanceTime(n){let t,r;try{const l=d.__wbindgen_add_to_stack_pointer(-16);d.testengine_advanceTime(l,this.__wbg_ptr,n);var i=_().getInt32(l+0,!0),a=_().getInt32(l+4,!0),c=_().getInt32(l+8,!0),u=_().getInt32(l+12,!0),m=i,o=a;if(u)throw m=0,o=0,R(c);return t=m,r=o,z(m,o)}finally{d.__wbindgen_add_to_stack_pointer(16),d.__wbindgen_export3(t,r,1)}}assignUserTask(n,t,r){let i,a;try{const p=d.__wbindgen_add_to_stack_pointer(-16),y=S(n,d.__wbindgen_export,d.__wbindgen_export2),b=j,w=S(t,d.__wbindgen_export,d.__wbindgen_export2),f=j;d.testengine_assignUserTask(p,this.__wbg_ptr,y,b,w,f,r);var c=_().getInt32(p+0,!0),u=_().getInt32(p+4,!0),m=_().getInt32(p+8,!0),o=_().getInt32(p+12,!0),l=c,g=u;if(o)throw l=0,g=0,R(m);return i=l,a=g,z(l,g)}finally{d.__wbindgen_add_to_stack_pointer(16),d.__wbindgen_export3(i,a,1)}}broadcastSignal(n,t){let r,i;try{const g=d.__wbindgen_add_to_stack_pointer(-16),p=S(n,d.__wbindgen_export,d.__wbindgen_export2),y=j,b=S(t,d.__wbindgen_export,d.__wbindgen_export2),w=j;d.testengine_broadcastSignal(g,this.__wbg_ptr,p,y,b,w);var a=_().getInt32(g+0,!0),c=_().getInt32(g+4,!0),u=_().getInt32(g+8,!0),m=_().getInt32(g+12,!0),o=a,l=c;if(m)throw o=0,l=0,R(u);return r=o,i=l,z(o,l)}finally{d.__wbindgen_add_to_stack_pointer(16),d.__wbindgen_export3(r,i,1)}}cancelInstance(n){let t,r;try{const l=d.__wbindgen_add_to_stack_pointer(-16),g=S(n,d.__wbindgen_export,d.__wbindgen_export2),p=j;d.testengine_cancelInstance(l,this.__wbg_ptr,g,p);var i=_().getInt32(l+0,!0),a=_().getInt32(l+4,!0),c=_().getInt32(l+8,!0),u=_().getInt32(l+12,!0),m=i,o=a;if(u)throw m=0,o=0,R(c);return t=m,r=o,z(m,o)}finally{d.__wbindgen_add_to_stack_pointer(16),d.__wbindgen_export3(t,r,1)}}completeAgentJob(n,t,r){let i,a;try{const p=d.__wbindgen_add_to_stack_pointer(-16),y=S(n,d.__wbindgen_export,d.__wbindgen_export2),b=j,w=S(t,d.__wbindgen_export,d.__wbindgen_export2),f=j,M=S(r,d.__wbindgen_export,d.__wbindgen_export2),k=j;d.testengine_completeAgentJob(p,this.__wbg_ptr,y,b,w,f,M,k);var c=_().getInt32(p+0,!0),u=_().getInt32(p+4,!0),m=_().getInt32(p+8,!0),o=_().getInt32(p+12,!0),l=c,g=u;if(o)throw l=0,g=0,R(m);return i=l,a=g,z(l,g)}finally{d.__wbindgen_add_to_stack_pointer(16),d.__wbindgen_export3(i,a,1)}}completeJob(n,t){let r,i;try{const g=d.__wbindgen_add_to_stack_pointer(-16),p=S(n,d.__wbindgen_export,d.__wbindgen_export2),y=j,b=S(t,d.__wbindgen_export,d.__wbindgen_export2),w=j;d.testengine_completeJob(g,this.__wbg_ptr,p,y,b,w);var a=_().getInt32(g+0,!0),c=_().getInt32(g+4,!0),u=_().getInt32(g+8,!0),m=_().getInt32(g+12,!0),o=a,l=c;if(m)throw o=0,l=0,R(u);return r=o,i=l,z(o,l)}finally{d.__wbindgen_add_to_stack_pointer(16),d.__wbindgen_export3(r,i,1)}}completeUserTask(n,t){let r,i;try{const g=d.__wbindgen_add_to_stack_pointer(-16),p=S(n,d.__wbindgen_export,d.__wbindgen_export2),y=j,b=S(t,d.__wbindgen_export,d.__wbindgen_export2),w=j;d.testengine_completeUserTask(g,this.__wbg_ptr,p,y,b,w);var a=_().getInt32(g+0,!0),c=_().getInt32(g+4,!0),u=_().getInt32(g+8,!0),m=_().getInt32(g+12,!0),o=a,l=c;if(m)throw o=0,l=0,R(u);return r=o,i=l,z(o,l)}finally{d.__wbindgen_add_to_stack_pointer(16),d.__wbindgen_export3(r,i,1)}}correlateMessage(n,t,r){let i,a;try{const p=d.__wbindgen_add_to_stack_pointer(-16),y=S(n,d.__wbindgen_export,d.__wbindgen_export2),b=j,w=S(t,d.__wbindgen_export,d.__wbindgen_export2),f=j,M=S(r,d.__wbindgen_export,d.__wbindgen_export2),k=j;d.testengine_correlateMessage(p,this.__wbg_ptr,y,b,w,f,M,k);var c=_().getInt32(p+0,!0),u=_().getInt32(p+4,!0),m=_().getInt32(p+8,!0),o=_().getInt32(p+12,!0),l=c,g=u;if(o)throw l=0,g=0,R(m);return i=l,a=g,z(l,g)}finally{d.__wbindgen_add_to_stack_pointer(16),d.__wbindgen_export3(i,a,1)}}createInstance(n,t,r){let i,a;try{const p=d.__wbindgen_add_to_stack_pointer(-16),y=S(n,d.__wbindgen_export,d.__wbindgen_export2),b=j,w=S(t,d.__wbindgen_export,d.__wbindgen_export2),f=j;d.testengine_createInstance(p,this.__wbg_ptr,y,b,w,f,Br(r)?Number.MAX_SAFE_INTEGER:r>>0);var c=_().getInt32(p+0,!0),u=_().getInt32(p+4,!0),m=_().getInt32(p+8,!0),o=_().getInt32(p+12,!0),l=c,g=u;if(o)throw l=0,g=0,R(m);return i=l,a=g,z(l,g)}finally{d.__wbindgen_add_to_stack_pointer(16),d.__wbindgen_export3(i,a,1)}}debugClear(){d.testengine_debugClear(this.__wbg_ptr)}debugCreateInstance(n,t,r){let i,a;try{const p=d.__wbindgen_add_to_stack_pointer(-16),y=S(n,d.__wbindgen_export,d.__wbindgen_export2),b=j,w=S(t,d.__wbindgen_export,d.__wbindgen_export2),f=j,M=S(r,d.__wbindgen_export,d.__wbindgen_export2),k=j;d.testengine_debugCreateInstance(p,this.__wbg_ptr,y,b,w,f,M,k);var c=_().getInt32(p+0,!0),u=_().getInt32(p+4,!0),m=_().getInt32(p+8,!0),o=_().getInt32(p+12,!0),l=c,g=u;if(o)throw l=0,g=0,R(m);return i=l,a=g,z(l,g)}finally{d.__wbindgen_add_to_stack_pointer(16),d.__wbindgen_export3(i,a,1)}}get debugIsPaused(){return d.testengine_debugIsPaused(this.__wbg_ptr)!==0}debugResume(){let n,t;try{const o=d.__wbindgen_add_to_stack_pointer(-16);d.testengine_debugResume(o,this.__wbg_ptr);var r=_().getInt32(o+0,!0),i=_().getInt32(o+4,!0),a=_().getInt32(o+8,!0),c=_().getInt32(o+12,!0),u=r,m=i;if(c)throw u=0,m=0,R(a);return n=u,t=m,z(u,m)}finally{d.__wbindgen_add_to_stack_pointer(16),d.__wbindgen_export3(n,t,1)}}debugStep(){let n,t;try{const o=d.__wbindgen_add_to_stack_pointer(-16);d.testengine_debugStep(o,this.__wbg_ptr);var r=_().getInt32(o+0,!0),i=_().getInt32(o+4,!0),a=_().getInt32(o+8,!0),c=_().getInt32(o+12,!0),u=r,m=i;if(c)throw u=0,m=0,R(a);return n=u,t=m,z(u,m)}finally{d.__wbindgen_add_to_stack_pointer(16),d.__wbindgen_export3(n,t,1)}}deploy(n){let t,r;try{const l=d.__wbindgen_add_to_stack_pointer(-16),g=S(n,d.__wbindgen_export,d.__wbindgen_export2),p=j;d.testengine_deploy(l,this.__wbg_ptr,g,p);var i=_().getInt32(l+0,!0),a=_().getInt32(l+4,!0),c=_().getInt32(l+8,!0),u=_().getInt32(l+12,!0),m=i,o=a;if(u)throw m=0,o=0,R(c);return t=m,r=o,z(m,o)}finally{d.__wbindgen_add_to_stack_pointer(16),d.__wbindgen_export3(t,r,1)}}deployForm(n){let t,r;try{const l=d.__wbindgen_add_to_stack_pointer(-16),g=S(n,d.__wbindgen_export,d.__wbindgen_export2),p=j;d.testengine_deployForm(l,this.__wbg_ptr,g,p);var i=_().getInt32(l+0,!0),a=_().getInt32(l+4,!0),c=_().getInt32(l+8,!0),u=_().getInt32(l+12,!0),m=i,o=a;if(u)throw m=0,o=0,R(c);return t=m,r=o,z(m,o)}finally{d.__wbindgen_add_to_stack_pointer(16),d.__wbindgen_export3(t,r,1)}}deployResource(n,t){let r,i;try{const g=d.__wbindgen_add_to_stack_pointer(-16),p=S(n,d.__wbindgen_export,d.__wbindgen_export2),y=j,b=S(t,d.__wbindgen_export,d.__wbindgen_export2),w=j;d.testengine_deployResource(g,this.__wbg_ptr,p,y,b,w);var a=_().getInt32(g+0,!0),c=_().getInt32(g+4,!0),u=_().getInt32(g+8,!0),m=_().getInt32(g+12,!0),o=a,l=c;if(m)throw o=0,l=0,R(u);return r=o,i=l,z(o,l)}finally{d.__wbindgen_add_to_stack_pointer(16),d.__wbindgen_export3(r,i,1)}}events(){let n,t;try{const o=d.__wbindgen_add_to_stack_pointer(-16);d.testengine_events(o,this.__wbg_ptr);var r=_().getInt32(o+0,!0),i=_().getInt32(o+4,!0),a=_().getInt32(o+8,!0),c=_().getInt32(o+12,!0),u=r,m=i;if(c)throw u=0,m=0,R(a);return n=u,t=m,z(u,m)}finally{d.__wbindgen_add_to_stack_pointer(16),d.__wbindgen_export3(n,t,1)}}failJob(n,t,r){let i,a;try{const p=d.__wbindgen_add_to_stack_pointer(-16),y=S(n,d.__wbindgen_export,d.__wbindgen_export2),b=j,w=S(r,d.__wbindgen_export,d.__wbindgen_export2),f=j;d.testengine_failJob(p,this.__wbg_ptr,y,b,t,w,f);var c=_().getInt32(p+0,!0),u=_().getInt32(p+4,!0),m=_().getInt32(p+8,!0),o=_().getInt32(p+12,!0),l=c,g=u;if(o)throw l=0,g=0,R(m);return i=l,a=g,z(l,g)}finally{d.__wbindgen_add_to_stack_pointer(16),d.__wbindgen_export3(i,a,1)}}migrate(n,t,r){let i,a;try{const p=d.__wbindgen_add_to_stack_pointer(-16),y=S(n,d.__wbindgen_export,d.__wbindgen_export2),b=j,w=S(t,d.__wbindgen_export,d.__wbindgen_export2),f=j,M=S(r,d.__wbindgen_export,d.__wbindgen_export2),k=j;d.testengine_migrate(p,this.__wbg_ptr,y,b,w,f,M,k);var c=_().getInt32(p+0,!0),u=_().getInt32(p+4,!0),m=_().getInt32(p+8,!0),o=_().getInt32(p+12,!0),l=c,g=u;if(o)throw l=0,g=0,R(m);return i=l,a=g,z(l,g)}finally{d.__wbindgen_add_to_stack_pointer(16),d.__wbindgen_export3(i,a,1)}}modify(n,t,r){let i,a;try{const p=d.__wbindgen_add_to_stack_pointer(-16),y=S(n,d.__wbindgen_export,d.__wbindgen_export2),b=j,w=S(t,d.__wbindgen_export,d.__wbindgen_export2),f=j,M=S(r,d.__wbindgen_export,d.__wbindgen_export2),k=j;d.testengine_modify(p,this.__wbg_ptr,y,b,w,f,M,k);var c=_().getInt32(p+0,!0),u=_().getInt32(p+4,!0),m=_().getInt32(p+8,!0),o=_().getInt32(p+12,!0),l=c,g=u;if(o)throw l=0,g=0,R(m);return i=l,a=g,z(l,g)}finally{d.__wbindgen_add_to_stack_pointer(16),d.__wbindgen_export3(i,a,1)}}constructor(){const n=d.testengine_new();return this.__wbg_ptr=n,Dn.register(this,this.__wbg_ptr,this),this}get now(){return d.testengine_now(this.__wbg_ptr)}reset(){d.testengine_reset(this.__wbg_ptr)}resolveIncident(n){let t,r;try{const l=d.__wbindgen_add_to_stack_pointer(-16),g=S(n,d.__wbindgen_export,d.__wbindgen_export2),p=j;d.testengine_resolveIncident(l,this.__wbg_ptr,g,p);var i=_().getInt32(l+0,!0),a=_().getInt32(l+4,!0),c=_().getInt32(l+8,!0),u=_().getInt32(l+12,!0),m=i,o=a;if(u)throw m=0,o=0,R(c);return t=m,r=o,z(m,o)}finally{d.__wbindgen_add_to_stack_pointer(16),d.__wbindgen_export3(t,r,1)}}setVariables(n,t,r){let i,a;try{const p=d.__wbindgen_add_to_stack_pointer(-16),y=S(n,d.__wbindgen_export,d.__wbindgen_export2),b=j,w=S(t,d.__wbindgen_export,d.__wbindgen_export2),f=j;d.testengine_setVariables(p,this.__wbg_ptr,y,b,w,f,r);var c=_().getInt32(p+0,!0),u=_().getInt32(p+4,!0),m=_().getInt32(p+8,!0),o=_().getInt32(p+12,!0),l=c,g=u;if(o)throw l=0,g=0,R(m);return i=l,a=g,z(l,g)}finally{d.__wbindgen_add_to_stack_pointer(16),d.__wbindgen_export3(i,a,1)}}snapshot(){let n,t;try{const o=d.__wbindgen_add_to_stack_pointer(-16);d.testengine_snapshot(o,this.__wbg_ptr);var r=_().getInt32(o+0,!0),i=_().getInt32(o+4,!0),a=_().getInt32(o+8,!0),c=_().getInt32(o+12,!0),u=r,m=i;if(c)throw u=0,m=0,R(a);return n=u,t=m,z(u,m)}finally{d.__wbindgen_add_to_stack_pointer(16),d.__wbindgen_export3(n,t,1)}}throwError(n,t,r){let i,a;try{const p=d.__wbindgen_add_to_stack_pointer(-16),y=S(n,d.__wbindgen_export,d.__wbindgen_export2),b=j,w=S(t,d.__wbindgen_export,d.__wbindgen_export2),f=j,M=S(r,d.__wbindgen_export,d.__wbindgen_export2),k=j;d.testengine_throwError(p,this.__wbg_ptr,y,b,w,f,M,k);var c=_().getInt32(p+0,!0),u=_().getInt32(p+4,!0),m=_().getInt32(p+8,!0),o=_().getInt32(p+12,!0),l=c,g=u;if(o)throw l=0,g=0,R(m);return i=l,a=g,z(l,g)}finally{d.__wbindgen_add_to_stack_pointer(16),d.__wbindgen_export3(i,a,1)}}tickNow(n){let t,r;try{const l=d.__wbindgen_add_to_stack_pointer(-16);d.testengine_tickNow(l,this.__wbg_ptr,n);var i=_().getInt32(l+0,!0),a=_().getInt32(l+4,!0),c=_().getInt32(l+8,!0),u=_().getInt32(l+12,!0),m=i,o=a;if(u)throw m=0,o=0,R(c);return t=m,r=o,z(m,o)}finally{d.__wbindgen_add_to_stack_pointer(16),d.__wbindgen_export3(t,r,1)}}unassignUserTask(n){let t,r;try{const l=d.__wbindgen_add_to_stack_pointer(-16),g=S(n,d.__wbindgen_export,d.__wbindgen_export2),p=j;d.testengine_unassignUserTask(l,this.__wbg_ptr,g,p);var i=_().getInt32(l+0,!0),a=_().getInt32(l+4,!0),c=_().getInt32(l+8,!0),u=_().getInt32(l+12,!0),m=i,o=a;if(u)throw m=0,o=0,R(c);return t=m,r=o,z(m,o)}finally{d.__wbindgen_add_to_stack_pointer(16),d.__wbindgen_export3(t,r,1)}}updateRetries(n,t){let r,i;try{const g=d.__wbindgen_add_to_stack_pointer(-16),p=S(n,d.__wbindgen_export,d.__wbindgen_export2),y=j;d.testengine_updateRetries(g,this.__wbg_ptr,p,y,t);var a=_().getInt32(g+0,!0),c=_().getInt32(g+4,!0),u=_().getInt32(g+8,!0),m=_().getInt32(g+12,!0),o=a,l=c;if(m)throw o=0,l=0,R(u);return r=o,i=l,z(o,l)}finally{d.__wbindgen_add_to_stack_pointer(16),d.__wbindgen_export3(r,i,1)}}updateUserTask(n,t){let r,i;try{const g=d.__wbindgen_add_to_stack_pointer(-16),p=S(n,d.__wbindgen_export,d.__wbindgen_export2),y=j,b=S(t,d.__wbindgen_export,d.__wbindgen_export2),w=j;d.testengine_updateUserTask(g,this.__wbg_ptr,p,y,b,w);var a=_().getInt32(g+0,!0),c=_().getInt32(g+4,!0),u=_().getInt32(g+8,!0),m=_().getInt32(g+12,!0),o=a,l=c;if(m)throw o=0,l=0,R(u);return r=o,i=l,z(o,l)}finally{d.__wbindgen_add_to_stack_pointer(16),d.__wbindgen_export3(r,i,1)}}}Symbol.dispose&&(mn.prototype[Symbol.dispose]=mn.prototype.free);function Pr(){return{__proto__:null,"./nanobpmn_engine_bg.js":{__proto__:null,__wbg___wbindgen_throw_bb96b2010945f0bc:function(n,t){throw new Error(z(n,t))},__wbindgen_cast_0000000000000001:function(n,t){const r=z(n,t);return zr(r)},__wbindgen_object_drop_ref:function(n){R(n)}}}}const Dn=typeof FinalizationRegistry>"u"?{register:()=>{},unregister:()=>{}}:new FinalizationRegistry(e=>d.__wbg_testengine_free(e,1));function zr(e){Ue===ye.length&&ye.push(ye.length+1);const n=Ue;return Ue=ye[n],ye[n]=e,n}function Rr(e){e<1028||(ye[e]=Ue,Ue=e)}let Ae=null;function _(){return(Ae===null||Ae.buffer.detached===!0||Ae.buffer.detached===void 0&&Ae.buffer!==d.memory.buffer)&&(Ae=new DataView(d.memory.buffer)),Ae}function z(e,n){return Ur(e>>>0,n)}let Fe=null;function We(){return(Fe===null||Fe.byteLength===0)&&(Fe=new Uint8Array(d.memory.buffer)),Fe}function Or(e){return ye[e]}let ye=new Array(1024).fill(void 0);ye.push(void 0,null,!0,!1);let Ue=ye.length;function Br(e){return e==null}function S(e,n,t){if(t===void 0){const u=$e.encode(e),m=n(u.length,1)>>>0;return We().subarray(m,m+u.length).set(u),j=u.length,m}let r=e.length,i=n(r,1)>>>0;const a=We();let c=0;for(;c<r;c++){const u=e.charCodeAt(c);if(u>127)break;a[i+c]=u}if(c!==r){c!==0&&(e=e.slice(c)),i=t(i,r,r=c+e.length*3,1)>>>0;const u=We().subarray(i+c,i+r),m=$e.encodeInto(e,u);c+=m.written,i=t(i,r,c,1)>>>0}return j=c,i}function R(e){const n=Or(e);return Rr(e),n}let qe=new TextDecoder("utf-8",{ignoreBOM:!0,fatal:!0});qe.decode();const Fr=2146435072;let rn=0;function Ur(e,n){return rn+=n,rn>=Fr&&(qe=new TextDecoder("utf-8",{ignoreBOM:!0,fatal:!0}),qe.decode(),rn=n),qe.decode(We().subarray(e,e+n))}const $e=new TextEncoder;"encodeInto"in $e||($e.encodeInto=function(e,n){const t=$e.encode(e);return n.set(t),{read:e.length,written:t.length}});let j=0,d;function $r(e,n){return d=e.exports,Ae=null,Fe=null,d}async function Yr(e,n){if(typeof Response=="function"&&e instanceof Response){if(!e.ok)throw new Error(`failed to fetch Wasm: ${e.status} ${e.statusText} fetching '${e.url}'`);if(typeof WebAssembly.instantiateStreaming=="function")try{return await WebAssembly.instantiateStreaming(e,n)}catch(i){if(t(e.type)&&e.headers.get("Content-Type")!=="application/wasm")console.warn("`WebAssembly.instantiateStreaming` failed because your server does not serve Wasm with `application/wasm` MIME type. Falling back to `WebAssembly.instantiate` which is slower. Original error:\n",i);else throw i}const r=await e.arrayBuffer();return await WebAssembly.instantiate(r,n)}else{const r=await WebAssembly.instantiate(e,n);return r instanceof WebAssembly.Instance?{instance:r,module:e}:r}function t(r){switch(r){case"basic":case"cors":case"default":return!0}return!1}}async function Gr(e){if(d!==void 0)return d;e!==void 0&&(Object.getPrototypeOf(e)===Object.prototype?{module_or_path:e}=e:console.warn("using deprecated parameters for the initialization function; pass a single object instead")),e===void 0&&(e=new URL("/pr-preview/pr-82/assets/nanobpmn_engine_bg-DRNrIVE8.wasm",import.meta.url));const n=Pr();(typeof e=="string"||typeof Request=="function"&&e instanceof Request||typeof URL=="function"&&e instanceof URL)&&(e=fetch(e));const{instance:t,module:r}=await Yr(await e,n);return $r(t)}let Ve=null;function Qr(e){return Ve||(Ve=Gr(void 0).then(()=>{}).catch(n=>{throw Ve=null,n})),Ve}function V(e){return JSON.parse(e)}class Jr{constructor(n){B(this,"engine");this.engine=n}deploy(n){return JSON.parse(this.engine.deploy(n))}createInstance(n,t){return V(this.engine.createInstance(n,t||"{}"))}activateJobs(n,t,r,i){return JSON.parse(this.engine.activateJobs(n,t,r,i))}completeJob(n,t){return V(this.engine.completeJob(n,t||"{}"))}completeAgentJob(n,t){const{variables:r,...i}=t??{};return V(this.engine.completeAgentJob(n,JSON.stringify(r??{}),JSON.stringify(i??{})))}failJob(n,t,r){return V(this.engine.failJob(n,t,r))}throwError(n,t,r){return V(this.engine.throwError(n,t,r))}updateRetries(n,t){return V(this.engine.updateRetries(n,t))}resolveIncident(n){return V(this.engine.resolveIncident(n))}setVariables(n,t,r){return V(this.engine.setVariables(n,t||"{}",r))}broadcastSignal(n,t){return V(this.engine.broadcastSignal(n,t||"{}"))}cancelInstance(n){return V(this.engine.cancelInstance(n))}modify(n,t,r){return V(this.engine.modify(n,JSON.stringify(t??[]),JSON.stringify(r??[])))}completeUserTask(n,t){return V(this.engine.completeUserTask(n,t||"{}"))}assignUserTask(n,t,r){return V(this.engine.assignUserTask(n,t,r))}unassignUserTask(n){return V(this.engine.unassignUserTask(n))}updateUserTask(n,t){return V(this.engine.updateUserTask(n,t||"{}"))}correlateMessage(n,t,r){return V(this.engine.correlateMessage(n,t,r||"{}"))}advanceTime(n){return V(this.engine.advanceTime(n))}reset(){this.engine.reset()}events(){return JSON.parse(this.engine.events())}snapshot(){return V(this.engine.snapshot())}free(){this.engine.free()}}async function Vr(e){return await Qr(),new Jr(new mn)}class ut extends Error{constructor(t,r){super(t);B(this,"retries");this.name="JobFailure",this.retries=r==null?void 0:r.retries}}function Zr(e,n=[]){if(e.instances.filter(i=>!i.completed).length===0)return e.totalInstances>0?"completed":"idle";if(e.incidents.length>0)return"incidents";const r=new Set(n);return e.jobs.some(i=>!r.has(i.jobType))?"unhandledJobs":e.userTasks.some(i=>i.state==="Created")?"userTasks":e.timers.length>0?"timers":e.messageSubscriptions.length>0?"messages":e.signalSubscriptions.length>0?"signals":"idle"}function Hr(e,n=[]){const t=new Set(n);return[...new Set(e.jobs.map(r=>r.jobType))].filter(r=>!t.has(r)).sort()}async function Wr(e,n,t){let r;try{const i=await n(t);r=JSON.stringify(i??{})}catch(i){const a=i instanceof ut&&i.retries!==void 0?i.retries:Math.max(0,t.retries-1),c=i instanceof Error?i.message:String(i);e.failJob(t.key,a,c);return}e.completeJob(t.key,r)}async function qr(e,n,t){let r;try{r=await n(t),JSON.stringify(r)}catch(i){const a=i instanceof ut&&i.retries!==void 0?i.retries:Math.max(0,t.retries-1),c=i instanceof Error?i.message:String(i);e.failJob(t.key,a,c);return}e.completeAgentJob(t.key,r)}async function Kr(e,n,t={}){const r=t.maxJobsPerActivation??10,i=t.lockTimeoutMs??3e4,a=t.worker??"bojtos",c=t.agents??{};for(const p of Object.keys(c))if(p in n)throw new Error(`dispatchRound: job type "${p}" is registered as both a worker and an agent — register it as exactly one`);const u=[];for(const[p,y]of Object.entries(n))for(const b of e.activateJobs(p,r,i,a))u.push({handler:y,job:b});const m=[];for(const[p,y]of Object.entries(c))for(const b of e.activateJobs(p,r,i,a))m.push({handler:y,job:b});for(const{handler:p,job:y}of u)await Wr(e,p,y);for(const{handler:p,job:y}of m)await qr(e,p,y);const o=e.snapshot(),l=u.length+m.length;if(l>0)return{snapshot:o,handled:l};const g=[...Object.keys(n),...Object.keys(c)];return{snapshot:o,handled:l,reason:Zr(o,g),unhandled:Hr(o,g)}}function Xr({bpmn:e}){const n=h.useRef(null),[t,r]=h.useState("loading"),[i,a]=h.useState(null),[c,u]=h.useState([]),[m,o]=h.useState(null),l=h.useRef(e),g=h.useRef(0),p=h.useRef(new Map),y=h.useCallback((I,N)=>{p.current.set(I,N)},[]),b=h.useCallback(I=>p.current.get(I),[]),w=h.useCallback((I,N)=>{const A=I.deploy(N);return l.current=N,p.current.clear(),u(A.processIds),o(null),a(null),A.processIds},[]);h.useEffect(()=>{let I=!1;return r("loading"),u([]),o(null),a(null),Vr().then(N=>{if(I){N.free();return}try{w(N,e)}catch(A){N.free(),a(String(A)),r("error");return}n.current=N,r("ready")}).catch(N=>{I||(a(String(N)),r("error"))}),()=>{var N;I=!0,(N=n.current)==null||N.free(),n.current=null,p.current.clear()}},[e]);const f=h.useCallback(I=>{const N=n.current;if(!N)return null;try{const A=I(N);return o(A),a(null),A}catch(A){return a(String(A)),null}},[]),M=h.useCallback((I,N)=>f(A=>A.createInstance(I,N)),[f]),k=h.useCallback((I,N)=>f(A=>A.completeUserTask(I,N)),[f]),L=h.useCallback(I=>f(N=>N.advanceTime(I)),[f]);function Y(I,N){const[A]=I.activateJobs(N,1,3e4,"manual-control");if(!A)throw new Error(`No waiting job of type "${N}" to resolve.`);return A}const H=h.useCallback((I,N)=>f(A=>{const K=Y(A,I);return A.completeJob(K.key,N)}),[f]),de=h.useCallback((I,N,A)=>f(K=>{const C=Y(K,I);return K.throwError(C.key,N,A)}),[f]),G=h.useCallback(async(I,N)=>{const A=n.current;if(!A)return null;const K=g.current;try{const C=await Kr(A,I,N);return n.current!==A||g.current!==K?null:(o(C.snapshot),a(null),C)}catch(C){return n.current!==A||g.current!==K||(o(A.snapshot()),a(String(C))),null}},[]),ie=h.useCallback(()=>{const I=n.current;if(I){g.current++;try{I.reset(),w(I,l.current)}catch(N){a(String(N))}}},[w]),U=h.useCallback(I=>{const N=n.current;if(!N)return null;g.current++;try{return N.reset(),w(N,I)}catch(A){return a(String(A)),null}},[w]);return{phase:t,error:i,processIds:c,snapshot:m,createInstance:M,stepWorkers:G,completeUserTask:k,advanceTime:L,completeJobManually:H,throwJobError:de,reset:ie,redeploy:U,setRunImage:y,getRunImage:b}}function ei(e,n){return e.slice(n)}function ni(e,n,t,r){const i=e.snapshot,a="⏸ waiting for a human — complete the task below to continue",c=i.userTasks.some(u=>u.state==="Created");if(e.handled>0){const u=i.activeElementIds.map(t),m=n.length?` via ${n.map(o=>`${t(o.from)} → ${t(o.to)}`).join(", ")}`:"";return i.completedInstances>=1?{kind:"done",text:`⏭ round handled ${e.handled} job${e.handled===1?"":"s"}${m} — ✅ process instance completed`}:c?{kind:"human",text:`⏭ round handled ${e.handled} job${e.handled===1?"":"s"}${m} — ${a}`}:{kind:"step",text:`⏭ round handled ${e.handled} job${e.handled===1?"":"s"}${m} — now at ${u.length?u.join(", "):"—"}`}}switch(e.reason){case"completed":return{kind:"done",text:"✅ process instance completed"};case"userTasks":return{kind:"human",text:a};case"timers":return{kind:"step",text:"⏱ waiting on a timer — advance the clock to continue"};case"messages":return{kind:"step",text:"✉ waiting on a message — correlate it to continue"};case"signals":return{kind:"step",text:"📶 waiting on a signal — broadcast it to continue"};case"incidents":return{kind:"error",text:"A job failed — incident on the diagram"};case"unhandledJobs":{const u=e.unhandled??[];return r&&u.length>0&&u.every(m=>r.has(m))?{kind:"human",text:a}:{kind:"error",text:`⏭ waiting on job type(s) with no worker registered: ${u.join(", ")}`}}case"idle":return{kind:"step",text:"Nothing to step — no instance is running."};default:return{kind:"step",text:e.reason?`Step blocked on an unrecognized reason: ${e.reason}`:"Nothing to step — no instance is running."}}}const ti="the Scripted or Endpoint brain";async function ri(){return await Ye()===null}async function Ye(e=ti){const n=navigator.gpu;if(!n)return`This browser doesn't expose WebGPU at all. Use a recent Chrome, Edge, or Safari 17+ with hardware acceleration on, or pick ${e}.`;let t;try{t=await n.requestAdapter()}catch(r){return`WebGPU adapter request failed (${r instanceof Error?r.message:String(r)}). Try ${e} instead.`}return t?null:`This browser supports the WebGPU API, but no GPU adapter is available — hardware acceleration may be off, or this device/VM has no usable GPU. Pick ${e} instead.`}const ii=[{id:"Qwen2.5-1.5B-Instruct-q4f16_1-MLC",label:"Qwen2.5 1.5B",downloadLabel:"~1.0 GB"},{id:"SmolLM2-1.7B-Instruct-q4f16_1-MLC",label:"SmolLM2 1.7B",downloadLabel:"~1.1 GB"},{id:"Llama-3.2-1B-Instruct-q4f16_1-MLC",label:"Llama 3.2 1B",downloadLabel:"~0.7 GB"},{id:"gemma-2-2b-it-q4f16_1-MLC",label:"Gemma 2 2B",downloadLabel:"~1.5 GB"},{id:"Llama-3.2-1B-Instruct-q4f32_1-MLC",label:"Llama 3.2 1B (f32, wider GPU support)",downloadLabel:"~1.1 GB"},{id:"SmolLM2-360M-Instruct-q4f32_1-MLC",label:"SmolLM2 360M (tiny, f32)",downloadLabel:"~0.6 GB"},{id:"SmolLM2-360M-Instruct-q4f16_1-MLC",label:"SmolLM2 360M (tiny)",downloadLabel:"~0.3 GB"}];function mt(e){return pn.get(e)??{}}const pn=new Map;async function oi(){if(pn.size>0)return;const{prebuiltAppConfig:e}=await le(async()=>{const{prebuiltAppConfig:n}=await import("./vendor-webllm-DT0Ab8E6.js");return{prebuiltAppConfig:n}},[]);for(const n of e.model_list)pn.set(n.model_id,{vramRequiredMB:n.vram_required_MB,requiredFeatures:n.required_features})}const en=ii.map(e=>({id:e.id,label:`${e.label} (${e.downloadLabel})`,downloadLabel:e.downloadLabel,...mt(e.id)})),pt=en[0].id;async function si(){return await oi(),en.map(e=>({...e,...mt(e.id)}))}function gt(){const e=navigator.deviceMemory;return typeof e=="number"?e*1024:null}function ai(e,n=gt()){return n==null||e.vramRequiredMB==null||n>=e.vramRequiredMB?null:`${e.label} needs roughly ${Math.round(e.vramRequiredMB)} MB of GPU memory; this device looks like it has about ${Math.round(n)} MB available. It may still work, but expect it to fail or fall back to slow shared memory — try a smaller model (e.g. SmolLM2 360M) if it doesn't load.`}async function ci(e){try{const{hasModelInCache:n}=await le(async()=>{const{hasModelInCache:t}=await import("./vendor-webllm-DT0Ab8E6.js");return{hasModelInCache:t}},[]);return await n(e)}catch{return!1}}function Xe(e){return/device (was )?lost|device_hung|device_removed|already been disposed|gpudevicelostinfo/i.test(e)}function Ln(){return"The GPU device was lost — the driver reset while the model was loading or running. This is a browser/driver-level failure, not a problem with the model: fully quit and reopen the browser (a lost device usually persists for the life of the GPU process), check chrome://gpu still reports hardware acceleration, and update your GPU driver if it recurs. The Scripted and Endpoint brains don't use the GPU at all."}class Ze{constructor(){B(this,"kind","browser");B(this,"model",null);B(this,"engine",null);B(this,"worker",null);B(this,"generation",0);B(this,"chat",async(n,t=512,r)=>{var a,c;const i=this.engine;if(!i||!this.model)throw new Error("BrowserBrain.chat called before connect()");try{const u=await i.chat.completions.create({messages:n,temperature:0,max_tokens:t,stream:!0});let m="";for await(const o of u){const l=((c=(a=o.choices[0])==null?void 0:a.delta)==null?void 0:c.content)??"";l&&(m+=l,r==null||r(l))}return m}catch(u){const m=u instanceof Error?u.message:String(u);throw Xe(m)?(this.teardown(),new Error(`The in-browser model stopped: ${Ln()}`)):u}})}async connect(n=pt,t){var m,o;const r=await Ye();if(r)throw new Error(r);if(this.engine&&this.model===n)return n;const i=++this.generation,a=l=>{i===this.generation&&(t==null||t({progress:l.progress??0,text:l.text??""}))};this.teardown();let c,u;try{const{CreateWebWorkerMLCEngine:l}=await le(async()=>{const{CreateWebWorkerMLCEngine:g}=await import("./vendor-webllm-DT0Ab8E6.js");return{CreateWebWorkerMLCEngine:g}},[]);u=new Worker(new URL("/pr-preview/pr-82/assets/webllm.worker-Dc1cCqhL.js",import.meta.url),{type:"module"}),c=await l(u,n,{initProgressCallback:a})}catch(l){if(u==null||u.terminate(),i!==this.generation)throw new Error("cancelled");const g=l instanceof Error?l.message:String(l);if(Xe(g))throw new Error(`Couldn't load ${n} in the browser (${g}). ${Ln()}`);const p=(o=(m=en.find(y=>y.id===n))==null?void 0:m.requiredFeatures)==null?void 0:o.includes("shader-f16");throw new Error(`Couldn't load ${n} in the browser (${g}). `+(p?"This model needs WebGPU with shader-f16; try one of the f32 models in the list, or the endpoint brain.":"Try a smaller model, check your connection, or use the endpoint brain instead."))}if(i!==this.generation)throw c.unload().catch(()=>{}),u==null||u.terminate(),new Error("cancelled");return this.engine=c,this.worker=u??null,this.model=n,n}teardown(){const{engine:n,worker:t}=this;this.engine=null,this.worker=null,this.model=null,n==null||n.unload().catch(()=>{}),t==null||t.terminate()}cancelConnect(){this.generation++}dispose(){this.generation++,this.teardown()}}const ht="http://localhost:11434/v1";function bt(){var n;const e=((n=globalThis.location)==null?void 0:n.hostname)??"";return e==="localhost"||e==="127.0.0.1"||e==="[::1]"||e==="::1"}function bn(e,n={hostname:(t=>(t=globalThis.location)==null?void 0:t.hostname)()??"",origin:(r=>(r=globalThis.location)==null?void 0:r.origin)()??""}){let i;try{i=new URL(ft(e)).hostname}catch{return null}const a=c=>c==="localhost"||c==="127.0.0.1"||c==="::1"||c==="[::1]";return!a(i)||a(n.hostname)?null:`This page is served from ${n.origin||"a non-local origin"}, so it can't reach ${e}. A local model server only accepts requests from a page on localhost. Open this page at http://localhost instead, or use the Scripted or In-browser brain.`}function ft(e){let n=e.trim().replace(/\/+$/,"");return n.endsWith("/chat/completions")&&(n=n.slice(0,-17)),/\/v\d+$/.test(n)||(n=`${n}/v1`),n}class Pn extends Error{constructor(n,t){super(n),this.status=t,this.name="HttpError"}}class li{constructor(n=ht,t="",r=""){B(this,"kind","endpoint");B(this,"baseUrl");B(this,"model",null);B(this,"models",[]);B(this,"apiKey");B(this,"requestedModel");B(this,"chat",async(n,t=512,r)=>{var o,l,g;if(!this.model)throw new Error("EndpointBrain.chat called before connect()");const i=await fetch(`${this.baseUrl}/chat/completions`,{method:"POST",headers:this.headers(),body:JSON.stringify({model:this.model,messages:n,temperature:0,max_tokens:t,stream:!0})});if(!i.ok||!i.body){const p=await i.text().catch(()=>"");throw new Error(`chat/completions HTTP ${i.status} ${i.statusText}${p?` — ${p.slice(0,300)}`:""}`)}const a=i.body.getReader(),c=new TextDecoder;let u="",m="";for(;;){const{value:p,done:y}=await a.read();if(y)break;u+=c.decode(p,{stream:!0});let b;for(;(b=u.indexOf(`
`))>=0;){const w=u.slice(0,b).trim();if(u=u.slice(b+1),!w.startsWith("data:"))continue;const f=w.slice(5).trim();if(f==="[DONE]")continue;let M;try{M=JSON.parse(f)}catch{continue}M.model&&(this.model=M.model);const k=(o=M.choices)==null?void 0:o[0],L=((l=k==null?void 0:k.delta)==null?void 0:l.content)??((g=k==null?void 0:k.message)==null?void 0:g.content)??"";L&&(m+=L,r==null||r(L))}}return m});this.baseUrl=ft(n),this.apiKey=t.trim(),this.requestedModel=r.trim()}headers(){const n={"Content-Type":"application/json"};return this.apiKey&&(n.Authorization=`Bearer ${this.apiKey}`),n}async listModels(){let n;try{n=await fetch(`${this.baseUrl}/models`,{headers:this.headers()})}catch(r){const i=bn(this.baseUrl);throw new Error(i??`Can't reach ${this.baseUrl} (${r instanceof Error?r.message:String(r)}). Is the server running? For Ollama, check the app is up — and if this page is served from another origin, allow it with OLLAMA_ORIGINS.`)}if(!n.ok)throw new Pn(`${this.baseUrl}/models returned HTTP ${n.status} ${n.statusText}`,n.status);const t=await n.json();return this.models=(t.data??[]).map(r=>r.id).filter(r=>!!r),this.models}async connect(){try{const n=await this.listModels(),t=this.requestedModel||n[0];if(!t)throw new Error(`No models available at ${this.baseUrl}. Pull one first — e.g. \`ollama pull llama3.2:3b\` — or name one explicitly.`);this.model=t}catch(n){const t=n instanceof Pn&&[404,405,501].includes(n.status);if(!this.requestedModel||!t)throw n;this.models=[],this.model=this.requestedModel}return await this.validate(),this.model}async validate(){const n=await fetch(`${this.baseUrl}/chat/completions`,{method:"POST",headers:this.headers(),body:JSON.stringify({model:this.model,messages:[{role:"user",content:"Reply with ok."}],temperature:0,max_tokens:1,stream:!1})}).catch(r=>{throw new Error(`Can't reach ${this.baseUrl}/chat/completions (${r instanceof Error?r.message:String(r)}). Check the endpoint URL, API key, model name, and any local CORS settings.`)});if(!n.ok){const r=await n.text().catch(()=>"");throw new Error(`chat/completions HTTP ${n.status} ${n.statusText}${r?` — ${r.slice(0,300)}`:""}`)}const t=await n.json().catch(()=>({}));t.model&&(this.model=t.model)}dispose(){}}const di=[{id:"onnx-community/Florence-2-base-ft",label:"Florence-2 base",downloadLabel:"~0.4 GB"},{id:"onnx-community/Florence-2-large-ft",label:"Florence-2 large (higher quality)",downloadLabel:"~1.6 GB"}],yt=di.map(e=>({...e,label:`${e.label} (${e.downloadLabel})`})),_t=yt[0].id,ui="<OCR>",zn="UNKNOWN (scripted brain — connect the in-browser model to read a photo)";function mi(e,n){if(e)return typeof e=="function"?e(n):e[n]}class pi{constructor(n){B(this,"kind","scripted-vision");B(this,"model",null);B(this,"read",async(n,t,r)=>{const i=typeof n=="string"?mi(this.lookup,n)??zn:zn;return r==null||r(i),i});this.lookup=n}dispose(){}}function gi(e){return new pi(e)}class Rn{constructor(){B(this,"kind","browser-vision");B(this,"model",null);B(this,"modelHandle",null);B(this,"processor",null);B(this,"loadImage",null);B(this,"generation",0);B(this,"read",async(n,t,r)=>{const i=this.modelHandle,a=this.processor,c=this.loadImage;if(!i||!a||!c||!this.model)throw new Error("BrowserVisionBrain.read called before connect()");const u=t&&t.startsWith("<")?t:ui,m=await c(n),o=a.construct_prompts(u),l=await a(m,o),g=await i.generate({...l,max_new_tokens:512,num_beams:1,do_sample:!1}),p=a.batch_decode(g,{skip_special_tokens:!1})[0],y=a.post_process_generation(p,u,m.size),b=hi(y,u);return r==null||r(b),b})}async connect(n=_t,t){var u,m;const r=await Ye("the scripted-vision fallback");if(r)throw new Error(r);if(this.modelHandle&&this.model===n)return n;const i=++this.generation,a=o=>{i===this.generation&&(t==null||t({progress:(o.progress??0)/100,text:o.file?`${o.status??"loading"} ${o.file}`:o.status??""}))};this.teardown();let c;try{const{Florence2ForConditionalGeneration:o,AutoProcessor:l,load_image:g}=await le(async()=>{const{Florence2ForConditionalGeneration:b,AutoProcessor:w,load_image:f}=await import("./transformers.web-B0mST8BW.js");return{Florence2ForConditionalGeneration:b,AutoProcessor:w,load_image:f}},[]),p=await o.from_pretrained(n,{dtype:"fp32",device:"webgpu",progress_callback:a}),y=await l.from_pretrained(n);c={model:p,processor:y,loadImage:g}}catch(o){if(i!==this.generation)throw new Error("cancelled");const l=o instanceof Error?o.message:String(o);throw new Error(`Couldn't load ${n} in the browser (${l}). Try the smaller Florence-2 base model, check your connection, or use the scripted-vision fallback.`)}if(i!==this.generation)throw Promise.resolve((m=(u=c.model).dispose)==null?void 0:m.call(u)).catch(()=>{}),new Error("cancelled");return this.modelHandle=c.model,this.processor=c.processor,this.loadImage=c.loadImage,this.model=n,n}teardown(){var t;const n=this.modelHandle;this.modelHandle=null,this.processor=null,this.loadImage=null,this.model=null,Promise.resolve((t=n==null?void 0:n.dispose)==null?void 0:t.call(n)).catch(()=>{})}cancelConnect(){this.generation++}dispose(){this.generation++,this.teardown()}}function hi(e,n){const t=e[n];if(typeof t=="string")return t.trim();if(t&&typeof t=="object"){const r=t.labels;return Array.isArray(r)?r.join(" ").trim():JSON.stringify(t)}return""}async function bi(){return await ri()?"browser":bt()?"endpoint":"scripted"}function fi(){const[e,n]=h.useState("scripted"),t=h.useRef(!1),[r,i]=h.useState("idle"),[a,c]=h.useState(null),[u,m]=h.useState(null),[o,l]=h.useState(null),[g,p]=h.useState(null),[y,b]=h.useState(null),[w,f]=h.useState(null),[M,k]=h.useState(pt),[L,Y]=h.useState(ht),[H,de]=h.useState(""),[G,ie]=h.useState(""),[U,I]=h.useState(null),N=h.useRef(null),[A,K]=h.useState("scripted-vision"),[C,W]=h.useState("idle"),[he,we]=h.useState(null),[Re,ke]=h.useState(_t),[Ce,Me]=h.useState(null),[nn,Ee]=h.useState(null),[Oe,oe]=h.useState(null),[Te,je]=h.useState(null),q=h.useRef(null),xe=h.useRef(!1),ve=h.useCallback(E=>async(...D)=>{try{return await E.chat(...D)}catch(F){const Ne=F instanceof Error?F.message:String(F);throw E instanceof Ze&&Xe(Ne)&&(I(null),m(null),i("error"),c(Ne)),F}},[]),De=h.useCallback(E=>async(...D)=>{try{return await E.read(...D)}catch(F){const Ne=F instanceof Error?F.message:String(F);throw Xe(Ne)&&(je(null),Me(null),W("error"),we(Ne)),F}},[]);h.useEffect(()=>{Ye().then(E=>{b(E),p(E===null),t.current||(t.current=!0,bi().then(n))}),Ye("the scripted-vision fallback").then(E=>{oe(E),xe.current||(xe.current=!0,K(E===null?"browser-vision":"scripted-vision"))})},[]),h.useEffect(()=>{let E=!1;return f(null),ci(M).then(D=>{E||f(D)}),()=>{E=!0}},[M]),h.useEffect(()=>()=>{var E;return(E=N.current)==null?void 0:E.dispose()},[]),h.useEffect(()=>()=>{var E;return(E=q.current)==null?void 0:E.dispose()},[]);const $=h.useCallback(E=>{n(E),i("idle"),c(null),m(null),l(null),I(null)},[]),ge=h.useCallback(E=>{var D,F;xe.current=!0,(D=q.current)==null||D.cancelConnect(),(F=q.current)==null||F.dispose(),q.current=null,K(E),W("idle"),we(null),Me(null),Ee(null),je(null)},[]),ue=h.useCallback(()=>{var E;(E=N.current)==null||E.dispose(),N.current=null,I(null),m(null)},[]),be=h.useCallback(()=>{N.current instanceof Ze&&N.current.cancelConnect(),ue(),i("idle"),l(null),c(null)},[ue]),Ge=h.useCallback(async()=>{var E;if(e==="scripted"){I(null),i("ready");return}if(e==="endpoint"){const D=bn(L);if(D){ue(),c(D),i("error");return}}i("connecting"),c(null),l(null);try{if(e==="browser"){const D=N.current instanceof Ze?N.current:new Ze;N.current&&N.current!==D&&N.current.dispose(),N.current=D;const F=await D.connect(M,l);m(F),I(()=>ve(D)),f(!0)}else{(E=N.current)==null||E.dispose();const D=new li(L,G,H);N.current=D;const F=await D.connect();m(F),I(()=>ve(D))}i("ready")}catch(D){const F=D instanceof Error?D.message:String(D);if(F==="cancelled")return;c(F),i("error"),I(null)}finally{l(null)}},[e,M,L,H,G,ue,ve]),X=h.useCallback(()=>{var E;(E=q.current)==null||E.dispose(),q.current=null,je(null),Me(null)},[]),Le=h.useCallback(()=>{var E;(E=q.current)==null||E.cancelConnect(),X(),W("idle"),Ee(null),we(null)},[X]),Pe=h.useCallback(async()=>{if(A==="scripted-vision"){X(),W("ready"),we(null);return}W("connecting"),we(null),Ee(null);try{const E=q.current instanceof Rn?q.current:new Rn;q.current&&q.current!==E&&q.current.dispose(),q.current=E;const D=await E.connect(Re,Ee);Me(D),je(()=>De(E)),W("ready")}catch(E){const D=E instanceof Error?E.message:String(E);if(D==="cancelled")return;we(D),W("error"),je(null),Me(null)}finally{Ee(null)}},[A,Re,X,De]);return{kind:e,setKind:$,status:r,error:a,modelInUse:u,progress:o,webgpu:g,webgpuReason:y,browserModelCached:w,cancelConnect:be,browserModel:M,setBrowserModel:k,endpointUrl:L,setEndpointUrl:Y,endpointModel:H,setEndpointModel:de,apiKey:G,setApiKey:ie,connect:Ge,chat:U,visionKind:A,setVisionKind:ge,visionStatus:C,visionError:he,visionModel:Re,setVisionModel:ke,visionModelInUse:Ce,visionProgress:nn,visionWebgpuReason:Oe,connectVision:Pe,cancelVisionConnect:Le,vision:Te}}const gn="#s=",yi=["scripted","browser","endpoint"];function _i(e){return typeof e=="string"&&yi.includes(e)}function wi(e){try{const n=JSON.parse(e);if(n&&typeof n=="object"){const t=n,r={};return _i(t.brain)&&(r.brain=t.brain),r}}catch{}return{}}function wt(e=location.hash){if(!e.startsWith(gn))return{};let n;try{n=decodeURIComponent(e.slice(gn.length))}catch{return{}}return wi(n)}function Mi(e){const n=Object.entries(e).filter(([,t])=>t!==void 0);return n.length===0?"":gn+encodeURIComponent(JSON.stringify(Object.fromEntries(n)))}function xi(e){const n={...wt(),...e},t=Mi(n),r=new URL(location.href);r.hash=t,history.replaceState(history.state,"",r)}const On=[{kind:"scripted",label:"Scripted",hint:"No model. The example's stand-in decides — deterministic and offline."},{kind:"browser",label:"In-browser (WebGPU)",hint:"A small quantised model on your GPU. First run downloads weights."},{kind:"endpoint",label:"API endpoint",hint:"Any OpenAI-compatible server. Ollama by default. Local pages only."}],Bn=[{kind:"scripted-vision",label:"Scripted",hint:"No model. The example's known plate is returned — deterministic and offline."},{kind:"browser-vision",label:"In-browser (WebGPU)",hint:"Reads the photo with a vision model on your GPU. First run downloads weights."}];function vi({brain:e,showText:n=!0,showVision:t=!1}){return s.jsxs("div",{className:"brain",children:[n&&s.jsx(Ni,{brain:e}),n&&t&&s.jsx("hr",{className:"brain-divider"}),t&&s.jsx(Ii,{brain:e})]})}function Ni({brain:e}){const n=On.find(o=>o.kind===e.kind),t=bn(e.endpointUrl),r=bt(),[i,a]=h.useState(en);h.useEffect(()=>{si().then(a)},[]);const c=i.find(o=>o.id===e.browserModel),u=c?ai(c,gt()):null,m=e.webgpu===!0?"browser":r&&e.webgpu===!1?"endpoint":null;return s.jsxs("div",{className:"brain-section",children:[s.jsxs("div",{className:"brain-kinds",children:[On.map(o=>s.jsxs(Z,{size:"sm",variant:e.kind===o.kind?"default":"secondary",onClick:()=>e.setKind(o.kind),children:[o.label,o.kind===m&&s.jsx(J,{variant:"info",className:"brain-recommended-badge",children:"recommended"})]},o.kind)),e.status==="ready"&&e.kind!=="scripted"&&s.jsx(J,{variant:"success",children:e.modelInUse??"connected"}),e.status==="connecting"&&s.jsx(J,{variant:"info",children:"connecting…"}),e.status==="error"&&s.jsx(J,{variant:"danger",children:"not connected"})]}),s.jsx("p",{className:"field-hint",children:n.hint}),e.kind==="browser"&&s.jsxs("div",{className:"brain-config",children:[s.jsxs("div",{className:"field",children:[s.jsx(ze,{htmlFor:"browser-model",children:"Model"}),s.jsxs(Kn,{value:e.browserModel,onValueChange:e.setBrowserModel,disabled:e.status==="connecting",children:[s.jsx(Xn,{id:"browser-model",children:s.jsx(et,{})}),s.jsx(nt,{children:i.map(o=>s.jsx(tt,{value:o.id,children:o.label},o.id))})]}),e.browserModelCached===!0&&s.jsx("p",{className:"field-hint",children:"Already downloaded in this browser — connecting will be fast."}),e.browserModelCached===!1&&s.jsx("p",{className:"field-hint",children:"Not downloaded yet — connecting fetches the weights once, then caches them for next time."})]}),e.webgpu===!1&&e.webgpuReason&&s.jsxs(se,{variant:"destructive",children:[s.jsx(ae,{children:"No WebGPU in this browser"}),s.jsx(ce,{children:e.webgpuReason})]}),e.webgpu!==!1&&u&&s.jsxs(se,{variant:"destructive",children:[s.jsx(ae,{children:"This model may not fit in GPU memory"}),s.jsx(ce,{children:u})]})]}),e.kind==="endpoint"&&s.jsxs("div",{className:"brain-config",children:[s.jsxs("div",{className:"field",children:[s.jsx(ze,{htmlFor:"endpoint-url",children:"Endpoint"}),s.jsx(tn,{id:"endpoint-url",value:e.endpointUrl,onChange:o=>e.setEndpointUrl(o.target.value),disabled:e.status==="connecting"}),s.jsxs("p",{className:"field-hint",children:["Ollama allows ",s.jsx("code",{children:"localhost"})," origins out of the box; set"," ",s.jsx("code",{children:"OLLAMA_ORIGINS"})," only when serving this page from another host. Best for local development — a hosted copy of this page can't reach a server on your machine at all."]}),t&&s.jsxs(se,{variant:"destructive",children:[s.jsx(ae,{children:"A local server won't work from this URL"}),s.jsx(ce,{children:t})]})]}),s.jsxs("div",{className:"field",children:[s.jsx(ze,{htmlFor:"endpoint-model",children:"Model (blank = first served)"}),s.jsx(tn,{id:"endpoint-model",placeholder:"llama3.2:3b",value:e.endpointModel,onChange:o=>e.setEndpointModel(o.target.value),disabled:e.status==="connecting"})]}),s.jsxs("div",{className:"field",children:[s.jsx(ze,{htmlFor:"endpoint-key",children:"API key (optional)"}),s.jsx(tn,{id:"endpoint-key",type:"password",value:e.apiKey,onChange:o=>e.setApiKey(o.target.value),disabled:e.status==="connecting"})]})]}),e.kind!=="scripted"&&s.jsxs("div",{className:"brain-actions",children:[s.jsx(Z,{size:"sm",onClick:()=>void e.connect(),disabled:e.status==="connecting",children:e.status==="ready"?"Reconnect":"Connect"}),e.status==="connecting"&&e.kind==="browser"&&s.jsx(Z,{size:"sm",variant:"secondary",onClick:e.cancelConnect,children:"Cancel"}),e.progress&&s.jsxs("span",{className:"field-hint",children:[Math.round(e.progress.progress*100),"% —"," ",e.progress.text]})]}),e.error&&s.jsxs(se,{variant:"destructive",children:[s.jsx(ae,{children:"Couldn't connect"}),s.jsx(ce,{children:e.error})]})]})}function Ii({brain:e}){const n=Bn.find(r=>r.kind===e.visionKind),t=e.webgpu===!0?"browser-vision":null;return s.jsxs("div",{className:"brain-section brain-vision",children:[s.jsx(ze,{children:"Vision (reads the image)"}),s.jsxs("div",{className:"brain-kinds",children:[Bn.map(r=>s.jsxs(Z,{size:"sm",variant:e.visionKind===r.kind?"default":"secondary",onClick:()=>e.setVisionKind(r.kind),children:[r.label,r.kind===t&&s.jsx(J,{variant:"info",className:"brain-recommended-badge",children:"recommended"})]},r.kind)),e.visionStatus==="ready"&&e.visionKind==="browser-vision"&&s.jsx(J,{variant:"success",children:e.visionModelInUse??"connected"}),e.visionStatus==="connecting"&&s.jsx(J,{variant:"info",children:"connecting…"}),e.visionStatus==="error"&&s.jsx(J,{variant:"danger",children:"not connected"})]}),s.jsx("p",{className:"field-hint",children:n.hint}),e.visionKind==="scripted-vision"&&e.webgpu===!1&&e.visionWebgpuReason&&s.jsxs(se,{variant:"destructive",children:[s.jsx(ae,{children:"No WebGPU in this browser"}),s.jsx(ce,{children:e.visionWebgpuReason})]}),e.visionKind==="browser-vision"&&s.jsxs("div",{className:"brain-config",children:[s.jsxs("div",{className:"field",children:[s.jsx(ze,{htmlFor:"vision-model",children:"Model"}),s.jsxs(Kn,{value:e.visionModel,onValueChange:e.setVisionModel,disabled:e.visionStatus==="connecting",children:[s.jsx(Xn,{id:"vision-model",children:s.jsx(et,{})}),s.jsx(nt,{children:yt.map(r=>s.jsx(tt,{value:r.id,children:r.label},r.id))})]}),s.jsx("p",{className:"field-hint",children:"Connecting downloads the weights once (size shown above), then caches them — every token is read on your GPU, no server."})]}),e.webgpu===!1&&e.visionWebgpuReason&&s.jsxs(se,{variant:"destructive",children:[s.jsx(ae,{children:"No WebGPU in this browser"}),s.jsx(ce,{children:e.visionWebgpuReason})]})]}),e.visionKind==="browser-vision"&&s.jsxs("div",{className:"brain-actions",children:[s.jsx(Z,{size:"sm",onClick:()=>void e.connectVision(),disabled:e.visionStatus==="connecting",children:e.visionStatus==="ready"?"Reconnect":"Connect"}),e.visionStatus==="connecting"&&s.jsx(Z,{size:"sm",variant:"secondary",onClick:e.cancelVisionConnect,children:"Cancel"}),e.visionProgress&&s.jsxs("span",{className:"field-hint",children:[Math.round(e.visionProgress.progress*100),"% —"," ",e.visionProgress.text]})]}),e.visionError&&s.jsxs(se,{variant:"destructive",children:[s.jsx(ae,{children:"Couldn't connect the vision brain"}),s.jsx(ce,{children:e.visionError})]})]})}function ki({imageInput:e,value:n,onSelect:t,disabled:r=!1}){const[i,a]=h.useState(null),[c,u]=h.useState(!1),m=h.useRef(null),o=h.useId(),l=h.useId(),g=h.useCallback(b=>{a(URL.createObjectURL(b)),t({imageName:b.name,pixels:b})},[t]);h.useEffect(()=>{if(i)return()=>URL.revokeObjectURL(i)},[i]);const p=h.useCallback(b=>{const w=b==null?void 0:b[0];w&&w.type.startsWith("image/")&&g(w)},[g]),y=(n==null?void 0:n.imageId)!=null?e.seedImages.find(b=>b.id===n.imageId):void 0;return s.jsxs("div",{className:"image-input",children:[e.label&&s.jsx("p",{className:"field-hint",children:e.label}),s.jsx("p",{className:"image-input-label",id:o,children:"Seed photos"}),s.jsx("div",{className:"image-gallery",role:"group","aria-labelledby":o,children:e.seedImages.map(b=>{const w=(n==null?void 0:n.imageId)===b.id;return s.jsxs("button",{type:"button","aria-pressed":w,className:`image-thumb${w?" image-thumb--selected":""}`,disabled:r,title:b.label??b.id,onClick:()=>{a(null),m.current&&(m.current.value=""),t({imageId:b.id,pixels:b.file})},children:[s.jsx("img",{src:b.thumb??b.file,alt:b.label??b.id}),b.label&&s.jsx("span",{children:b.label})]},b.id)})}),s.jsx("label",{className:"image-input-label",htmlFor:l,children:"Or upload your own photo"}),s.jsxs("div",{className:`image-drop${c?" image-drop--over":""}`,onDragOver:b=>{b.preventDefault(),r||u(!0)},onDragLeave:()=>u(!1),onDrop:b=>{b.preventDefault(),u(!1),r||p(b.dataTransfer.files)},children:[s.jsx("input",{ref:m,id:l,type:"file",accept:"image/*",disabled:r,onChange:b=>p(b.target.files)}),s.jsx("p",{className:"field-hint",children:"Drag a photo here, or pick one. Uploading a photo the model has never seen is the proof this runs for real — nothing leaves your browser."})]}),(i||y)&&s.jsxs("div",{className:"image-preview",children:[s.jsx("img",{src:i??(y==null?void 0:y.file),alt:i?(n==null?void 0:n.imageName)??"uploaded photo":(y==null?void 0:y.label)??(y==null?void 0:y.id)??"selected photo"}),s.jsx("span",{className:"field-hint",children:i?`Uploaded: ${(n==null?void 0:n.imageName)??"your photo"}`:`Selected: ${(y==null?void 0:y.label)??(y==null?void 0:y.id)}`}),s.jsx("button",{type:"button",className:"image-clear-btn",disabled:r,onClick:()=>{a(null),m.current&&(m.current.value=""),t(null)},children:"Clear"})]})]})}function Mt(e){return typeof e=="object"&&e!==null}function Bs(e){const n=new Set,t=r=>{Mt(r)&&(typeof r.key=="string"&&n.add(r.key),Array.isArray(r.components)&&r.components.forEach(t))};return t(e),n}function Ei(e){const n={},t=r=>{Mt(r)&&(typeof r.key=="string"&&"defaultValue"in r&&(n[r.key]=r.defaultValue??""),Array.isArray(r.components)&&r.components.forEach(t))};return t(e),n}const Ti="wdf:section:";function xt(e){return Ti+e}function Fn(e){try{const n=window.localStorage.getItem(xt(e));return n==="1"?!0:n==="0"?!1:void 0}catch{return}}function ji(e,n){try{window.localStorage.setItem(xt(e),n?"1":"0")}catch{}}function Si(e,n=!0){const[t,r]=h.useState(()=>Fn(e)??n);h.useEffect(()=>{r(Fn(e)??n)},[e,n]);const i=h.useCallback(a=>{r(a),ji(e,a)},[e]);return[t,i]}function fe({sectionId:e,title:n,description:t,defaultOpen:r=!0,className:i,children:a,...c}){const[u,m]=Si(e,r);return s.jsx(Lt,{className:["panel",i].filter(Boolean).join(" "),"data-tour":c["data-tour"],children:s.jsxs(Pt,{open:u,onOpenChange:m,children:[s.jsxs(zt,{className:"panel-trigger",children:[s.jsxs("span",{className:"panel-trigger-text",children:[s.jsx("span",{className:"panel-title",children:n}),t!=null&&s.jsx("span",{className:"panel-desc",children:t})]}),s.jsx(Rt,{className:"panel-chevron","aria-hidden":!0})]}),s.jsx(Ot,{children:s.jsx(Bt,{children:a})})]})})}function Ai(e){return e.entries!==void 0}function Ci(e){const n=[];let t=null;for(const r of e)r.turn!==void 0?t&&t.turn===r.turn?t.entries.push(r):(t={turn:r.turn,entries:[r]},n.push(t)):(t=null,n.push(r));return n}function Un(e){if(e===void 0)return"undefined";try{return JSON.stringify(e)}catch{return"[unserializable value]"}}function Di({activation:e,result:n,labelFor:t}){const r=e.elementId??"";return s.jsxs("div",{className:"timeline-tool",children:[s.jsxs("div",{className:"timeline-tool-head",children:[s.jsx(J,{variant:"info",children:"tool"}),s.jsx("strong",{children:t(r)||r}),s.jsx("code",{children:r})]}),e.args!==void 0&&Object.keys(e.args).length>0&&s.jsxs("div",{className:"timeline-kv",children:[s.jsx("span",{className:"timeline-kv-label",children:"arguments"}),s.jsx("code",{children:Un(e.args)})]}),s.jsxs("div",{className:"timeline-kv",children:[s.jsx("span",{className:"timeline-kv-label",children:"returned"}),s.jsx("code",{children:n?Un(n.result):"— waiting for the job to complete —"})]})]})}function Li({group:e,labelFor:n}){const t=e.entries.find(o=>o.kind==="llm"),r=e.entries.filter(o=>o.kind==="agent"&&o.elementId),i=e.entries.filter(o=>o.kind==="vars"&&o.elementId),a=e.entries.filter(o=>o.kind==="agent"&&!o.elementId),c=e.entries.filter(o=>o.kind==="error"),u=new Set(r.map(o=>o.elementId)),m=e.entries.filter(o=>o.kind==="tool"||o.kind==="vars"&&o.elementId&&!u.has(o.elementId)).sort((o,l)=>o.id-l.id);return s.jsxs("div",{className:"timeline-turn",children:[s.jsxs("div",{className:"timeline-turn-head",children:[s.jsxs(J,{variant:t!=null&&t.pending?"warning":"neutral",children:["Turn ",e.turn]}),(t==null?void 0:t.pending)&&s.jsx("span",{className:"timeline-pending",children:"thinking…"})]}),t&&s.jsx("blockquote",{className:"timeline-reply",children:t.text}),a.map(o=>s.jsx("div",{className:"timeline-note",children:o.text},o.id)),r.map(o=>s.jsx(Di,{activation:o,result:i.find(l=>l.elementId===o.elementId),labelFor:n},o.id)),m.map(o=>s.jsxs("div",{className:`log-line log-${o.kind}`,children:[o.pending?"⏳ ":"",o.text]},o.id)),c.map(o=>s.jsxs("div",{className:"timeline-error",children:["⚠ ",o.text]},o.id))]})}function Pi({log:e,elementStats:n=[],incidents:t=[],labelFor:r=i=>i}){const i=h.useMemo(()=>Ci(e),[e]),[a,c]=h.useState(!1),u=h.useRef(null);h.useEffect(()=>{const o=u.current;o&&(o.scrollTop=o.scrollHeight)},[i]);const m=()=>{var g;const o={log:e.map(({id:p,...y})=>y),elementStats:n,incidents:t},l=JSON.stringify(o,null,2);(g=navigator.clipboard)!=null&&g.writeText&&navigator.clipboard.writeText(l).then(()=>{c(!0),setTimeout(()=>c(!1),1500)}).catch(()=>{})};return s.jsxs(fe,{sectionId:"activity",className:"grow",title:"Activity",description:"Agent turns, model replies, and tool calls — read top to bottom as a story.",children:[s.jsx("div",{className:"timeline-toolbar",children:s.jsx(Z,{variant:"secondary",size:"sm",onClick:m,children:a?"Copied!":"Copy run as JSON"})}),s.jsx("div",{className:"timeline",ref:u,children:i.length===0?s.jsx("div",{className:"log-empty",children:"Press Run or Step to start."}):i.map(o=>Ai(o)?s.jsx(Li,{group:o,labelFor:r},`turn-${o.turn}-${o.entries[0].id}`):s.jsxs("div",{className:`log-line log-${o.kind}`,children:[o.pending?"⏳ ":"",o.text]},o.id))}),(n.length>0||t.length>0)&&s.jsxs("div",{className:"timeline-engine-view",children:[n.length>0&&s.jsxs("div",{className:"timeline-stats",children:[s.jsx("span",{className:"timeline-kv-label",children:"Element completion"}),s.jsx("ul",{children:n.filter(o=>o.completed>0||(o.active??0)>0).map(o=>s.jsxs("li",{children:[s.jsx("code",{children:r(o.elementId)||o.elementId})," ","completed ",o.completed,o.active?`, ${o.active} active`:""]},o.elementId))})]}),t.length>0&&s.jsxs("div",{className:"timeline-incidents",children:[s.jsx("span",{className:"timeline-kv-label",children:"Incidents"}),s.jsx("ul",{children:t.map((o,l)=>s.jsxs("li",{children:[s.jsx("code",{children:r(o.elementId)||o.elementId})," —"," ",o.reason]},`${o.elementId}-${l}`))})]})]})]})}const Ie={diagram:"diagram",runButton:"run-button",variablesPanel:"variables-panel",codePanel:"code-panel",brainPanel:"brain-panel"};function $n(e){return`[data-tour="${e}"]`}function zi(e=location.search){return new URLSearchParams(e).get("tour")}function Ri(e,n){var t;return((t=e.elementStats.find(r=>r.elementId===n))==null?void 0:t.completed)??0}function Oi(e,n){return!e||e.kind==="click"||!n?!1:e.kind==="activeElement"?n.activeElementIds.includes(e.elementId):Ri(n,e.elementId)>=(e.atLeast??1)}function Bi(e){return"anchor"in e?$n(e.anchor):`${$n(Ie.diagram)} [data-element-id="${Fi(e.elementId)}"]`}function Fi(e){return typeof CSS<"u"&&typeof CSS.escape=="function"?CSS.escape(e):e.replace(/[^a-zA-Z0-9_-]/g,n=>`\\${n}`)}function Ui(e){return e.map(n=>{const t=!!n.waitFor&&n.waitFor.kind!=="click";return{element:Bi(n.target),popover:{title:n.title,description:t?`${n.description} (continues automatically once you reach that point — or use Next to skip ahead)`:n.description,showButtons:["next","previous","close"]},disableActiveInteraction:!1,skipMissingElement:n.skipMissingElement??!0}})}async function $i(e,n={}){var a;const[{driver:t}]=await Promise.all([le(()=>import("./driver.js-bj_ppY-Q.js"),[]),le(()=>Promise.resolve({}),__vite__mapDeps([0]))]),r=Ui(e),i=t({steps:r,showProgress:!0,allowClose:!0,skipMissingElement:!0,onHighlighted:(c,u,{index:m})=>{var o;m!==void 0&&((o=n.onIndexChange)==null||o.call(n,m))},onDestroyed:()=>{var c;(c=n.onDestroyed)==null||c.call(n)}});return i.drive(),(a=n.onIndexChange)==null||a.call(n,i.getActiveIndex()??0),{moveNext:()=>i.moveNext(),activeIndex:()=>i.getActiveIndex()??-1,destroy:()=>i.destroy()}}const Yi=300;function Gi(e,n){const[t,r]=h.useState(!1),i=h.useRef(null),a=h.useRef(0),c=h.useRef(-1),u=h.useRef(null),m=h.useRef(n);h.useEffect(()=>{m.current=n},[n]);const o=h.useCallback(()=>{u.current!==null&&(clearInterval(u.current),u.current=null)},[]),l=h.useRef(0),g=h.useCallback(()=>{var y;l.current+=1,o(),(y=i.current)==null||y.destroy(),i.current=null,r(!1)},[o]),p=h.useCallback(()=>{if(!e||e.steps.length===0||i.current)return;const y=l.current+=1;$i(e.steps,{onIndexChange:b=>{a.current=b},onDestroyed:()=>{o(),i.current=null,r(!1)}}).then(b=>{if(y!==l.current){b.destroy();return}i.current=b,r(!0),u.current=setInterval(()=>{const w=a.current;if(w===c.current)return;const f=e.steps[w];f&&Oi(f.waitFor,m.current())&&(c.current=w,b.moveNext())},Yi)})},[e,o]);return h.useEffect(()=>g,[g]),{active:t,start:p,stop:g}}const on=650,sn="__agent__",Yn="__model__",Gn="__template__:",Qi=h.lazy(async()=>{await Promise.all([le(()=>Promise.resolve({}),__vite__mapDeps([1])),le(()=>Promise.resolve({}),__vite__mapDeps([2]))]);const{RuntimeDiagram:e}=await le(async()=>{const{RuntimeDiagram:n}=await import("./RuntimeDiagram-B2IYfHo7.js");return{RuntimeDiagram:n}},__vite__mapDeps([3,4,5]));return{default:e}}),an=h.lazy(()=>le(()=>import("./MonacoEditor-CupzgRKw.js").then(e=>e.M),__vite__mapDeps([6,4,7]))),Ji=h.lazy(()=>le(()=>import("./vendor-modeler-r_JgyEaj.js"),__vite__mapDeps([8,4,5,9,10,11,12,1,2]))),Qn=h.lazy(async()=>{const{FormRenderer:e}=await le(async()=>{const{FormRenderer:n}=await import("./FormRenderer-C0Po0kRB.js");return{FormRenderer:n}},__vite__mapDeps([13,4,11,9,10,14]));return{default:e}});function cn(e,n){try{return JSON.stringify(e??{},null,n)}catch{return"[unserializable value]"}}function Vi({example:e,initialBrainKind:n,initialTourId:t}){var yn,_n,wn,Mn,xn,vn,Nn,In;const[r,i]=h.useState(e.bpmn),a=fi(),[c,u]=h.useState(null);h.useEffect(()=>{n&&n!==a.kind&&a.setKind(n)},[]),h.useEffect(()=>{xi({brain:a.kind})},[a.kind]);const[m,o]=h.useState(()=>Object.fromEntries(e.handlers.map(x=>[x.elementId,x.source]))),[l,g]=h.useState(e.scriptedAgent??""),[p,y]=h.useState(()=>Ke(e.templates)),b=h.useMemo(()=>Ir(e,m,r,p),[e,m,r,p]),w=b.model,f=Xr({bpmn:b.resolvedBpmn}),M=Gi(e.tour,()=>f.snapshot);h.useEffect(()=>{var x;t&&((x=e.tour)==null?void 0:x.id)===t&&M.start()},[]);const k=w.startFormId?((yn=e.forms)==null?void 0:yn[w.startFormId])??null:null,[L,Y]=h.useState(()=>({...e.seed,...k?Ei(k):{}})),[H,de]=h.useState(w.agent?sn:((_n=e.handlers[0])==null?void 0:_n.elementId)??""),[G,ie]=h.useState(!1),[U,I]=h.useState(!1),[N,A]=h.useState(null),[K,C]=h.useState([]),[W,he]=h.useState({}),[we,Re]=h.useState(!1),ke=h.useRef(null),[Ce,Me]=h.useState({}),[nn,Ee]=h.useState(!1),Oe=h.useRef(null),oe=h.useRef(!1),Te=h.useRef(0),je=h.useRef(0),q=h.useRef({current:void 0}),xe=h.useRef({}),ve=h.useRef({}),De=h.useMemo(()=>{const x=new Map;for(const v of w.processes){for(const T of v.tasks)x.set(T.elementId,T.label);for(const T of v.agents){x.set(T.elementId,T.label);for(const P of T.tools)x.set(P.elementId,P.label)}for(const T of v.userTasks)x.set(T.elementId,T.label)}return v=>x.get(v)??v},[w]),$=h.useCallback(x=>{C(v=>{if(x.key){const T=v.findIndex(P=>P.key===x.key);if(T>=0){const P=[...v];return P[T]={...P[T],...x},P}}return[...v,{...x,id:je.current++}].slice(-80)})},[]),ge=h.useMemo(()=>{var x;return((x=f.snapshot)==null?void 0:x.userTasks.find(v=>v.state==="Created"))??null},[f.snapshot]),ue=h.useMemo(()=>{const x=w.processes.flatMap(T=>T.tasks),v=new Map;for(const T of e.handlers){if(!T.manualControl)continue;const P=x.find(O=>O.elementId===T.elementId);P&&v.set(P.jobType,{...T.manualControl,elementId:T.elementId})}return v},[e.handlers,w]),be=h.useMemo(()=>{if(!f.snapshot)return null;for(const x of f.snapshot.jobs){const v=ue.get(x.jobType);if(v&&x.state==="Created")return{job:x,control:v}}return null},[f.snapshot,ue]),Ge=h.useMemo(()=>{if(!w.agent||!f.snapshot)return[];const x=new Map(f.snapshot.elementStats.map(v=>[v.elementId,v.completed]));return w.agent.tools.filter(v=>(x.get(v.elementId)??0)===0)},[w.agent,f.snapshot]),X=ge?w.userTasks.find(x=>x.elementId===ge.elementId):void 0,Le=X!=null&&X.formId?((wn=e.forms)==null?void 0:wn[X.formId])??null:null,Pe=h.useCallback(async(x,v,T,P)=>{var me;let O=T,ee=0;for(;Te.current===P&&O&&O.completedInstances<1&&ee++<80;){const Q=await f.stepWorkers(x,{agents:v});if(Te.current!==P)return O;O=(Q==null?void 0:Q.snapshot)??O;const ne=(me=O.instances[0])==null?void 0:me.variables;if(ne&&he({...ne}),O.userTasks.some(te=>te.state==="Created")){$({kind:"human",text:"⏸ waiting for a human — complete the task below to continue"});break}if(!Q){$({kind:"error",text:"▶ run stopped — no dispatch round was returned"});break}if(Q.handled===0)break;await new Promise(te=>setTimeout(te,on))}return O&&O.completedInstances>=1?$({kind:"done",text:"✅ process instance completed"}):O&&O.incidentElementIds.length>0&&$({kind:"error",text:"A job failed — incident on the diagram"}),O},[f,$]),E=h.useCallback(async x=>{var O,ee,me;if(!be||oe.current)return;const{job:v,control:T}=be,P=++Te.current;oe.current=!0,ie(!0);try{let Q,ne;if(x==="complete")Q=f.completeJobManually(v.jobType,"{}"),ne="  ↳ completed normally";else if(T.action.kind==="timer"){const te=((ee=(O=f.snapshot)==null?void 0:O.timers[0])==null?void 0:ee.dueInMs)??0;Q=f.advanceTime(Math.max(te,0)+1),ne="  ↳ advanced the clock — timer fired"}else{const{errorCode:te,message:re}=T.action;Q=f.throwJobError(v.jobType,te,re),ne=`  ↳ threw BPMN error ${te}: ${re}`}if(Q){$({kind:"vars",text:ne,elementId:v.elementId});const te=(me=Q.instances[0])==null?void 0:me.variables;te&&he({...te}),await new Promise(re=>setTimeout(re,on)),await Pe(xe.current,ve.current,Q,P)}else $({kind:"error",text:"  ↳ failed to resolve the manual job",elementId:v.elementId})}finally{oe.current=!1,ie(!1)}},[be,f,$,Pe]),D=h.useCallback(async()=>{var te;let x=null;try{w.agent&&l.trim()&&(x=pr(l))}catch(re){return A(re instanceof Error?re.message:String(re)),null}q.current={current:void 0};let v;if(e.imageInput){const re=a.vision;v={read:re??gi(e.scriptedVision).read,live:!!re,resolve:pe=>f.getRunImage(pe)}}const T=br(w,b.handlers,$,q.current,v);for(const re of ue.keys())delete T[re];const P={};if(w.agents.length>0){if(a.kind!=="scripted"&&a.chat){const Se=new Map;for(const pe of w.agents)Se.set(pe.jobType,[...Se.get(pe.jobType)??[],pe]);for(const[pe,Be]of Se)P[pe]=Lr(Be,a.chat,$,{turnRef:q.current,requiredTools:e.requiredTools})}else if(x&&w.agent){const Se=w.agent.elementId;P[w.agent.jobType]=async pe=>{if(pe.elementId!==Se)throw new Error(`No scripted agent handler for "${pe.elementId}" — only "${Se}" (the primary process's first agent host) is driven by the scripted brain. Use a live brain to exercise more than one host.`);const Be=await x(pe),jt=(Be.activateElements??[]).map(St=>St.elementId).join(", ");return $({kind:"agent",text:Be.completionConditionFulfilled?"🤖 scripted agent: done":`🤖 scripted agent: calling ${jt||"(nothing)"}`}),Be}}}C([]),Me({});const O={...e.seed,...L,...or(e.imageInput?c:null)};he(O),xe.current=T,ve.current=P;const ee=f.redeploy(r),me=(ee==null?void 0:ee[0])??w.processId;$({kind:"start",text:`Starting "${me}" — ${w.agent?a.kind==="scripted"||!a.chat?"scripted brain":`live brain (${a.modelInUse??a.kind})`:"no agent in this model"}`});const Q=f.createInstance(me,JSON.stringify(O)),ne=(te=Q==null?void 0:Q.instances[0])==null?void 0:te.key;return e.imageInput&&c&&ne&&f.setRunImage(ne,c),{workers:T,agents:P,snap:Q}},[f,e,b,r,l,L,c,w,a,$,ue]),F=!!f.snapshot&&f.snapshot.completedInstances<1,Ne=!F&&!!k&&!we,Nt=h.useCallback(async()=>{if(!(f.phase!=="ready"||oe.current||U||b.hasErrors)){oe.current=!0,ie(!0);try{let x=xe.current,v=ve.current,T=f.snapshot;const P=++Te.current;if(!F){if(ke.current&&!ke.current.validate())return;A(null);const O=await D();if(!O)return;x=O.workers,v=O.agents,T=O.snap,await new Promise(ee=>setTimeout(ee,on))}await Pe(x,v,T,P)}finally{oe.current=!1,ie(!1)}}},[f,U,b.hasErrors,F,D,Pe]),It=h.useCallback(async()=>{var x;if(!(f.phase!=="ready"||oe.current||U||b.hasErrors)){oe.current=!0,I(!0);try{let v=xe.current,T=ve.current,P=f.snapshot;if(!F){if(ke.current&&!ke.current.validate())return;A(null);const ne=await D();if(!ne)return;v=ne.workers,T=ne.agents,P=ne.snap}if(!P||P.completedInstances>=1)return;const O=P.takenSequenceFlows.length,ee=await f.stepWorkers(v,{agents:T});if(!ee){$({kind:"error",text:"⏭ step failed — no dispatch round was returned"});return}const me=(x=ee.snapshot.instances[0])==null?void 0:x.variables;me&&he({...me});const Q=ei(ee.snapshot.takenSequenceFlows,O);$(ni(ee,Q,De,ue))}finally{oe.current=!1,I(!1)}}},[f,U,b.hasErrors,F,D,$,De,ue]),kt=h.useCallback(()=>{oe.current=!1,Te.current++,ie(!1),I(!1),f.reset(),C([]),he({})},[f]),Et=h.useCallback(()=>{if(!ge||Oe.current&&!Oe.current.validate())return;const x=f.completeUserTask(ge.key,JSON.stringify(Ce));$({kind:"human",text:`👤 ${cn(Ce)}`}),x&&x.completedInstances>=1&&$({kind:"done",text:"✅ process instance completed"})},[ge,Ce,f,$]),Tt=h.useMemo(()=>{var x,v;return f.phase==="loading"?s.jsx(J,{variant:"neutral",children:"Booting engine…"}):f.phase==="error"?s.jsx(J,{variant:"danger",children:"Engine error"}):G?s.jsx(J,{variant:"info",children:"Running…"}):U?s.jsx(J,{variant:"info",children:"Stepping…"}):(((x=f.snapshot)==null?void 0:x.incidentElementIds.length)??0)>0?s.jsx(J,{variant:"danger",children:"Incident"}):ge?s.jsx(J,{variant:"warning",children:"Waiting for a human"}):(((v=f.snapshot)==null?void 0:v.completedInstances)??0)>=1?s.jsx(J,{variant:"success",children:"Completed"}):f.snapshot?s.jsx(J,{variant:"warning",children:"Paused"}):s.jsx(J,{variant:"neutral",children:"Ready"})},[f.phase,f.snapshot,G,U,ge]);return s.jsxs("div",{className:"runner",children:[s.jsxs("section",{className:"intro",children:[s.jsx("h1",{children:e.title}),s.jsx("p",{children:e.blurb}),s.jsxs("div",{className:"controls",children:[s.jsx(Z,{"data-tour":Ie.runButton,onClick:()=>void Nt(),disabled:f.phase!=="ready"||G||U||b.hasErrors||Ne,children:"▶ Run"}),s.jsx(Z,{variant:"secondary",onClick:()=>void It(),disabled:f.phase!=="ready"||G||U||b.hasErrors||Ne||(((Mn=f.snapshot)==null?void 0:Mn.completedInstances)??0)>=1,children:"⏭ Step"}),s.jsx(Z,{variant:"secondary",onClick:kt,disabled:f.phase!=="ready"||U,children:"↺ Reset"}),e.tour&&s.jsx(Z,{variant:"secondary",onClick:M.start,disabled:M.active,children:M.active?"Touring…":`🧭 ${e.tour.label}`}),Tt]}),f.phase==="error"&&s.jsxs(se,{variant:"destructive",children:[s.jsx(ae,{children:"Engine error"}),s.jsx(ce,{children:f.error})]}),N&&s.jsxs(se,{variant:"destructive",children:[s.jsx(ae,{children:"Code didn't compile"}),s.jsx(ce,{children:N})]}),b.hasErrors&&s.jsxs(se,{variant:"destructive",children:[s.jsx(ae,{children:"Run is disabled — the diagram has unresolved references"}),s.jsx(ce,{children:s.jsx("ul",{className:"diagnostics",children:b.diagnostics.filter(x=>x.severity==="error").map((x,v)=>s.jsx("li",{children:x.message},v))})})]}),!b.hasErrors&&b.diagnostics.length>0&&s.jsxs(se,{children:[s.jsx(ae,{children:"Heads up"}),s.jsx(ce,{children:s.jsx("ul",{className:"diagnostics",children:b.diagnostics.map((x,v)=>s.jsx("li",{children:x.message},v))})})]})]}),s.jsxs("div",{className:"grid",children:[s.jsxs("div",{className:"col",children:[s.jsx(fe,{sectionId:"process","data-tour":Ie.diagram,title:"Process",description:`${w.processName} — live token (green), incidents (red).`,children:s.jsx(h.Suspense,{fallback:s.jsx("div",{className:"diagram-fallback",children:f.phase==="loading"?"Booting the engine…":"Loading diagram…"}),children:s.jsx(Qi,{xml:b.resolvedBpmn,activeIds:((xn=f.snapshot)==null?void 0:xn.activeElementIds)??[],incidentIds:((vn=f.snapshot)==null?void 0:vn.incidentElementIds)??[],className:"diagram"})})}),ge&&s.jsxs(fe,{sectionId:"human-task",title:(X==null?void 0:X.label)??"Human task",description:Le?`Rendered from the model's form "${X==null?void 0:X.formId}".`:"This task has no linked form — complete it with no variables.",children:[Ge.length>0&&s.jsxs(se,{variant:"destructive",children:[s.jsx(ae,{children:"The agent didn't finish its checks"}),s.jsxs(ce,{children:["It completed without running"," ",Ge.map(x=>x.label||x.elementId).join(", "),". The process took the default path to this task, so the findings below have no value to report."]})]}),Le&&s.jsx(h.Suspense,{fallback:s.jsx("div",{className:"form-fallback",children:"Loading form…"}),children:s.jsx(Qn,{ref:Oe,schema:Le,values:Ce,onChange:(x,v)=>Me(T=>({...T,[x]:v})),context:W,onValidityChange:Ee})}),s.jsx(Z,{onClick:Et,disabled:!!Le&&!nn,children:"Complete task"})]}),be&&s.jsx(fe,{sectionId:"manual-job",title:be.control.label,description:"This job is held here on purpose — pick how it resolves.",children:s.jsxs("div",{className:"controls",children:[s.jsx(Z,{onClick:()=>void E("complete"),disabled:G||U,children:be.control.completeLabel??"✅ Complete normally"}),s.jsx(Z,{variant:"secondary",onClick:()=>void E("action"),disabled:G||U,children:be.control.action.label})]})}),s.jsxs("div",{className:"row",children:[s.jsx(fe,{sectionId:"variables",className:"grow","data-tour":Ie.variablesPanel,title:"Variables",description:"The instance payload, live.",children:s.jsx("pre",{className:"vars",children:cn(W,2)})}),s.jsx(Pi,{log:K,elementStats:(Nn=f.snapshot)==null?void 0:Nn.elementStats,incidents:(In=f.snapshot)==null?void 0:In.incidents,labelFor:De})]})]}),s.jsxs("div",{className:"col",children:[(w.agent||e.imageInput)&&s.jsx(fe,{sectionId:"brain","data-tour":Ie.brainPanel,title:"Brain",description:w.agent?`What drives “${w.agent.label}”. The model recommends; the process governs.`:"What reads the image. The model recommends; the process governs.",children:s.jsx(vi,{brain:a,showText:!!w.agent,showVision:!!e.imageInput})}),s.jsxs(fe,{sectionId:"start",title:"Start",description:w.startFormId?`The model's start form "${w.startFormId}".`:e.imageInput?"Pick a seed photo or upload your own to read.":"The starting payload.",children:[e.imageInput&&s.jsx(ki,{imageInput:e.imageInput,value:c,onSelect:u,disabled:G}),e.scenarios&&s.jsx("div",{className:"scenarios",children:e.scenarios.map(x=>s.jsx(Z,{size:"sm",variant:"secondary",disabled:G,onClick:()=>Y(v=>({...v,...x.variables})),children:x.label},x.label))}),k?s.jsx(h.Suspense,{fallback:s.jsx("div",{className:"form-fallback",children:"Loading form…"}),children:s.jsx(Qn,{ref:ke,schema:k,values:L,onChange:(x,v)=>Y(T=>({...T,[x]:v})),disabled:G,onValidityChange:Re})}):s.jsx("pre",{className:"vars",children:cn(L,2)})]}),s.jsx(fe,{sectionId:"code",className:"editors","data-tour":Ie.codePanel,title:"Code",description:"One handler per BPMN element. Return variables to merge, or throw to fail the job.",children:s.jsx(h.Suspense,{fallback:s.jsx("div",{className:"editor-fallback",children:"Loading editor…"}),children:s.jsxs(Ft,{value:H,onValueChange:de,children:[s.jsxs(Ut,{children:[s.jsx(Qe,{value:Yn,children:"model"}),w.agent&&s.jsx(Qe,{value:sn,children:"agent (scripted)"}),e.handlers.map(x=>{var v;return s.jsx(Qe,{value:x.elementId,children:((v=w.tasks.find(T=>T.elementId===x.elementId))==null?void 0:v.label)??x.elementId},x.elementId)}),Object.keys(p).map(x=>s.jsx(Qe,{value:Gn+x,children:x},x))]}),s.jsxs(Je,{value:Yn,children:[s.jsxs("div",{className:"editor-meta",children:[s.jsx("strong",{children:"Model"}),s.jsx("code",{children:"edit the diagram visually — Run re-checks it below"}),s.jsx(Z,{variant:"secondary",size:"sm",onClick:()=>i(e.bpmn),disabled:r===e.bpmn,children:"Revert to original"})]}),s.jsx(Ji,{value:r,onChange:i})]}),w.agent&&s.jsxs(Je,{value:sn,children:[s.jsxs("div",{className:"editor-meta",children:[s.jsx("strong",{children:w.agent.label}),s.jsx("code",{children:a.kind==="scripted"||!a.chat?"in use":"unused — a live brain is connected"})]}),s.jsx("div",{className:"editor-wrap",children:s.jsx(an,{height:"360px",defaultLanguage:"javascript",value:l,onChange:x=>g(x??""),options:ln})})]}),e.handlers.map(x=>{var v;return s.jsxs(Je,{value:x.elementId,children:[s.jsxs("div",{className:"editor-meta",children:[s.jsx("strong",{children:((v=w.tasks.find(T=>T.elementId===x.elementId))==null?void 0:v.label)??x.elementId}),s.jsx("code",{children:x.standsInFor??x.elementId})]}),s.jsx("div",{className:"editor-wrap",children:s.jsx(an,{height:"360px",defaultLanguage:"javascript",value:m[x.elementId],onChange:T=>o(P=>({...P,[x.elementId]:T??""})),options:ln})})]},x.elementId)}),Object.keys(p).map(x=>s.jsxs(Je,{value:Gn+x,children:[s.jsxs("div",{className:"editor-meta",children:[s.jsx("strong",{children:x}),s.jsxs("code",{children:["prompt / template text — substitutes"," ","{{"+x+"}}"]})]}),s.jsx("div",{className:"editor-wrap",children:s.jsx(an,{height:"360px",defaultLanguage:"markdown",value:p[x],onChange:v=>y(T=>Ke(T,{[x]:v??""})),options:ln})})]},x))]})})}),w.agent&&s.jsx(fe,{sectionId:"tools",title:"Tools, as the model sees them",description:s.jsxs(s.Fragment,{children:["Read from the diagram — element name, documentation, and every",s.jsx("code",{children:" fromAi(…)"})," argument."]}),children:s.jsx("ul",{className:"tool-list",children:w.agent.tools.map(x=>s.jsxs("li",{children:[s.jsx("code",{children:x.elementId}),s.jsxs("span",{children:[" — ",x.documentation||x.label]}),x.args.length>0&&s.jsx("ul",{children:x.args.map(v=>s.jsxs("li",{children:[s.jsxs("code",{children:[v.name,": ",v.type]})," ","— ",v.description]},v.name))})]},x.elementId))})})]})]})]})}const ln={minimap:{enabled:!1},fontSize:13,scrollBeyondLastLine:!1,tabSize:2,automaticLayout:!0},Zi=`You are a demo workflow assistant for fictional compliance checks.
...
`,Hi=`Please verify export compliance for this shipment and notify the team of your decision.\r
`,Wi={id:"compliance-walkthrough",label:"Take the tour",steps:[{title:"Start a run",description:"Press Run to send a shipment through the compliance agent.",target:{anchor:Ie.runButton}},{title:"The agent picks its own tools",description:"This AI Agent reads the shipment notes and decides, turn by turn, which of the tools below it to call — nothing here is hard-coded into a fixed sequence.",target:{elementId:"ComplianceCheckAgent"}},{title:"Watch the token move",description:"The agent's first move is to look up the genetic marker mentioned in the notes.",target:{elementId:"VerifyGeneticMarker"},waitFor:{kind:"activeElement",elementId:"VerifyGeneticMarker"}},{title:"A cleared shipment notifies the export team",description:"Once the compliance score comes back clean, the process notifies the export team automatically — no human review needed for this scenario.",target:{elementId:"NotifyExportTeam"},waitFor:{kind:"elementCompleted",elementId:"NotifyExportTeam"}},{title:"Everything the run recorded",description:"The variables panel shows the marker record, the country lookup, the compliance score, and the final decision — exactly what each tool and the agent wrote along the way.",target:{anchor:Ie.variablesPanel}}],successEvent:{kind:"instanceCompleted"}},qi=`<?xml version="1.0" encoding="UTF-8"?>
...
}`,No={id:"seed-export-compliance",title:"Seed export compliance agent",blurb:"An AI agent picks its own tools to check a shipment, then a gateway routes on its decision — cleared shipments notify the export team, flagged ones go to a human. The LLM recommends; the BPMN process governs.",docsUrl:"https://camunda.com/blog/agentic-ai/",bpmn:qi,forms:{"seed-export-shipment-ready":oo,"seed-export-compliance-review":go},seed:{scenario:Jn,shipmentNotes:""},scenarios:[{label:"Likely cleared (TP53 → Brazil)",variables:{scenario:Jn,shipmentNotes:""}},{label:"Likely flagged (BRCA1 → Germany)",variables:{scenario:fo,shipmentNotes:""}}],scriptedAgent:yo,templates:bo,tour:Wi,requiredTools:["RecordComplianceDecision"],handlers:[{elementId:"VerifyGeneticMarker",standsInFor:"JDBC connector — UCSC hg38",source:_o},{elementId:"CheckDestinationCountry",standsInFor:"GraphQL connector — countries API",source:wo},{elementId:"ComputeComplianceScore",standsInFor:"REST connector — api.mathjs.org",source:Mo},{elementId:"RecordComplianceDecision",standsInFor:"Script task — FEEL",source:xo},{elementId:"NotifyExportTeam",standsInFor:"REST connector — httpbin.io",source:vo}]},Io=`<?xml version="1.0" encoding="UTF-8"?>
...
}`,jo={id:"order-process",title:"Order process with service workers",blurb:"The getting-started order process: check inventory, charge payment, ship. No agent and no human step — the same runner, driven entirely by what's in the diagram.",docsUrl:"https://docs.camunda.io/docs/next/guides/getting-started-orchestration-cluster/",bpmn:Io,seed:{item:"camunda-t-shirt",quantity:3},handlers:[{elementId:"Activity_0tw2fu0",standsInFor:"job worker — check-inventory",source:ko},{elementId:"Activity_1ppsbgi",standsInFor:"job worker — charge-payment",source:Eo},{elementId:"Activity_08pg6im",standsInFor:"job worker — ship-items",source:To}]},So=`<?xml version="1.0" encoding="UTF-8"?>\r
...
`,Ao=`async (job, { text, num, sleep, trace }) => {
  // The starting variables arrive on 'job.variables'.
...
}`,Co={id:"rocket-launch",title:"Rocket launch",blurb:"The getting-started rocket launch, boiled down to one service task: launch. The smallest possible example, and the smallest possible test of the framework's extensibility.",bpmn:So,seed:{missionName:"Apollo 11",destination:"the Moon",fuelLevel:100},scenarios:[{label:"Full tanks — launch succeeds",variables:{missionName:"Apollo 11",destination:"the Moon",fuelLevel:100}},{label:"Low fuel — mission scrubbed",variables:{missionName:"Apollo 13",destination:"the Moon",fuelLevel:30}}],handlers:[{elementId:"Activity_LaunchRocket",standsInFor:"job worker — launch-rocket",source:Ao}]},Do=`<?xml version="1.0" encoding="UTF-8"?>\r
...
`,Lo=`async (job, { text, sleep }) => {
  ...
  return { shipped: true, tracking: "1Z" + Math.floor(Math.random() * 1e9) };
}`,Ro={id:"order-process-boundary-events",title:"Order process with boundary events",blurb:"The getting-started order process, extended with a timer and an error boundary event: charge payment can be declined, and a delayed shipment can escalate — both fired by hand from the runner rather than by chance.",docsUrl:"https://github.com/camunda/camunda-8-get-started/tree/main/2-order-process-with-service-workers",bpmn:Do,seed:{item:"camunda-t-shirt",quantity:3},handlers:[{elementId:"Activity_0tw2fu0",standsInFor:"job worker — check-inventory",source:Lo},{elementId:"Activity_1ppsbgi",standsInFor:"job worker — charge-payment",source:Po,manualControl:{label:"Charge payment method",completeLabel:"✅ Complete normally",action:{kind:"error",errorCode:"CHARGE_DECLINED",message:"The card issuer declined the charge.",label:"❌ Simulate: card declined"}}},{elementId:"Activity_08pg6im",standsInFor:"job worker — ship-items",source:zo,manualControl:{label:"Ship items",completeLabel:"✅ Ship it",action:{kind:"timer",label:"🕐 Fire the shipping-delayed timer"}}}]},Oo="/pr-preview/pr-82/assets/de-bmw-mini-JBSk7QcF.jpg",Bo="/pr-preview/pr-82/assets/de-bmw-mini.thumb-CUUmJrRO.jpg",Fo="/pr-preview/pr-82/assets/uk-d651-rnb-XGipy2QN.jpg",Uo="/pr-preview/pr-82/assets/uk-d651-rnb.thumb-mjEcbhUf.jpg",$o="/pr-preview/pr-82/assets/uk-mk70-orj-Cn6O3Xfm.jpg",Yo="/pr-preview/pr-82/assets/uk-mk70-orj.thumb-CaeZ2vqU.jpg",Go="/pr-preview/pr-82/assets/uk-ni-ijz-8992-YXV44tgk.jpg",Qo="/pr-preview/pr-82/assets/uk-ni-ijz-8992.thumb-DYwok8jV.jpg",Jo="/pr-preview/pr-82/assets/us-hyundai-genesis-gGpAIEpi.jpg",Vo="/pr-preview/pr-82/assets/us-hyundai-genesis.thumb-DEEt19Mw.jpg",Zo=`<?xml version="1.0" encoding="UTF-8"?>
...
}`,Is={id:"plate-recognition",title:"Read a number plate from a photo",blurb:"Pick the plate's country, then a photo goes into the run, an in-browser vision model reads the number plate on the reader's own GPU, and a human confirms or corrects it before the process records the result. The vision model recommends; the BPMN process governs. No server, no API key — with no model connected it falls back to a deterministic scripted reading.",docsUrl:"https://docs.camunda.io/docs/components/modeler/forms/camunda-forms-reference/",bpmn:Zo,forms:{"plate-recognition-country":ys,"plate-recognition-confirm":ts,"plate-recognition-manual":ds},seed:{country:"auto"},imageInput:{label:"Pick a seed photo (its plate is known, so the scripted reader works offline) or upload your own — a live in-browser model reads a photo it has never seen.",seedImages:Ms},scriptedVision:xs,handlers:[{elementId:"ExtractPlate",standsInFor:"Vision model — Florence-2 <OCR> on WebGPU (in-browser)",source:vs},{elementId:"RecordResult",standsInFor:"Script task — records the governed outcome",source:Ns}]},He=[Co,No,jo,Ro,Is];function fn(){return"/pr-preview/pr-82/"}function ks(e){const n=fn();return e.startsWith(n)?"/"+e.slice(n.length):e}function Es(e=location.pathname){const t=ks(e).match(/^\/examples\/([^/]+)\/?$/);if(t)try{return{kind:"example",id:decodeURIComponent(t[1])}}catch{return{kind:"gallery"}}return{kind:"gallery"}}function Ts(e=location.search){return new URLSearchParams(e).get("embed")==="1"}function js(){return fn()}function Zn(e){return`${fn()}examples/${encodeURIComponent(e)}`}function Hn(e,n={}){const t=new URL(location.href);t.pathname=e,t.search=n.search??t.search,n.hash!==void 0&&(t.hash=n.hash),n.replace?history.replaceState(history.state,"",t):history.pushState(history.state,"",t),window.dispatchEvent(new PopStateEvent("popstate"))}function Wn(){return{route:Es(),embed:Ts()}}function Ss(){const[e,n]=h.useState(Wn);return h.useEffect(()=>{const t=()=>n(Wn());return window.addEventListener("popstate",t),()=>window.removeEventListener("popstate",t)},[]),e}const As="web-demo-framework:height",Cs="web-demo-framework:request-height";function Ds(e){return{type:As,height:Math.ceil(e)}}const qn="embed-height-auto";function Ls(e){h.useEffect(()=>{if(!e||typeof window>"u"||window.parent===window)return;const n=document.documentElement;n.classList.add(qn);let t=-1;const r=(c=!1)=>{const u=document.documentElement.scrollHeight;!c&&Math.abs(u-t)<2||(t=u,window.parent.postMessage(Ds(u),"*"))},i=c=>{if(c.source!==window.parent)return;const u=c.data;!u||u.type!==Cs||r(!0)};window.addEventListener("message",i),r();const a=new ResizeObserver(()=>r());return a.observe(n),()=>{a.disconnect(),window.removeEventListener("message",i),n.classList.remove(qn)}},[e])}function Ps(){const{route:e,embed:n}=Ss(),t=wt().brain,r=zi();Ls(n);const i=e.kind==="example"?e.id:He[0].id,a=He.find(m=>m.id===i)??He[0],c=m=>{Hn(Zn(m),{hash:location.hash})},u=s.jsxs(s.Fragment,{children:[!n&&e.kind==="gallery"&&s.jsx("nav",{className:"example-picker",children:He.map(m=>s.jsx(Z,{size:"sm",variant:m.id===a.id?"default":"secondary",onClick:()=>c(m.id),children:m.title},m.id))}),!n&&e.kind==="example"&&s.jsx("div",{className:"example-nav",children:s.jsx(Z,{size:"sm",variant:"secondary",onClick:()=>Hn(js()),children:"← All examples"})}),s.jsxs("div",{className:"example-meta",children:[a.docsUrl&&s.jsx("a",{className:"docs-link",href:a.docsUrl,target:"_blank",rel:"noreferrer noopener",children:"View on camunda.com ↗"}),n&&s.jsx("a",{className:"open-full-page",href:Zn(a.id)+(location.hash||""),target:"_top",rel:"noreferrer",children:"Open full page ↗"})]}),s.jsx(Vi,{example:a,initialBrainKind:t,initialTourId:r},a.id)]});return n?s.jsx("div",{className:"c4-ui app-shell app-embed",children:s.jsx("main",{id:"main",className:"layout layout-embed",children:u})}):s.jsxs("div",{className:"c4-ui app-shell",children:[s.jsx($t,{appName:"Runnable Camunda examples",trailing:s.jsx("span",{className:"app-subtitle",children:"model + code + optional LLM, in your browser"})}),s.jsx("main",{id:"main",className:"layout",children:u})]})}Dt.createRoot(document.getElementById("root")).render(s.jsx(h.StrictMode,{children:s.jsx(Yt,{children:s.jsx(Ps,{})})}));export{le as _,Bs as c};
