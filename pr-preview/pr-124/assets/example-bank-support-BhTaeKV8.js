import{m as n}from"./index-CFy5eP5R.js";import"./vendor-react-9Ma26nY1.js";import"./vendor-design-system-CVQVAuC4.js";const t=`<?xml version="1.0" encoding="UTF-8"?>
<!--
...
}`,T={...n,bpmn:t,forms:{"bank-support-request":l,"bank-support-review":g},seed:{customerRequest:e},scenariosLabel:"Customer request",scenarios:[{label:"Loan question — one specialist",variables:{customerRequest:e}},{label:"Loan + account — two specialists at once",variables:{customerRequest:y}},{label:"Account question — fails validation, needs review",variables:{customerRequest:w}},{label:"Card question — one specialist",variables:{customerRequest:f}}],scriptedAgent:v,handlers:[{elementId:"CalculateLoanPayment",standsInFor:"HTTP connector — api.mathjs.org expression evaluator",source:E},{elementId:"ValidateIban",standsInFor:"HTTP connector — openiban.com IBAN validation",source:A},{elementId:"LookupCardBin",standsInFor:"HTTP connector — lookup.binlist.net BIN lookup",source:_},{elementId:"PrepareCaseSummary",standsInFor:"script task — combine every specialist's resolution",source:x},{elementId:"RecordLoanResolution",standsInFor:"script task — the specialist's structured answer",source:C},{elementId:"RecordAccountResolution",standsInFor:"script task — the specialist's structured answer",source:R},{elementId:"RecordCardResolution",standsInFor:"script task — the specialist's structured answer",source:P},{elementId:"NotifyCustomer",standsInFor:"HTTP connector — customer notification",source:B}]};export{T as bankSupport};
