const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/driver-CTZuBZOi.css","assets/diagram-js-DAKGYcfb.css","assets/bpmn-embedded-DFDc6PA6.css","assets/RuntimeDiagram-Dp98hqau.js","assets/vendor-react-WnIiAG2f.js","assets/Viewer-R8mIPiBT.js","assets/MonacoEditor-D2A0Or02.js","assets/MonacoEditor-BBCLDbYy.css","assets/vendor-modeler-BOzTHoAD.js","assets/vendor-design-system-BK6zPaL4.js","assets/vendor-design-system-Ck4lDh0h.css","assets/parser-Cn7g5BiQ.js","assets/ModelEditor-Dwlgp6JA.css","assets/FormRenderer-CqNAgZyB.js","assets/FormRenderer-D1JIHOW6.css"])))=>i.map(i=>d[i]);
var ut=Object.defineProperty;var mt=(e,n,t)=>n in e?ut(e,n,{enumerable:!0,configurable:!0,writable:!0,value:t}):e[n]=t;var H=(e,n,t)=>mt(e,typeof n!="symbol"?n+"":n,t);import{r as f,j as o,i as pt}from"./vendor-react-WnIiAG2f.js";import{B as V,a as Z,L as ze,S as gt,b as ht,c as bt,d as ft,e as yt,A as me,f as pe,g as ge,I as Ve,C as ae,h as ce,i as le,j as de,k as ue,l as Mt,T as wt,m as _t,n as Pe,o as Oe,p as xt,q as Nt}from"./vendor-design-system-BK6zPaL4.js";(function(){const n=document.createElement("link").relList;if(n&&n.supports&&n.supports("modulepreload"))return;for(const i of document.querySelectorAll('link[rel="modulepreload"]'))r(i);new MutationObserver(i=>{for(const a of i)if(a.type==="childList")for(const c of a.addedNodes)c.tagName==="LINK"&&c.rel==="modulepreload"&&r(c)}).observe(document,{childList:!0,subtree:!0});function t(i){const a={};return i.integrity&&(a.integrity=i.integrity),i.referrerPolicy&&(a.referrerPolicy=i.referrerPolicy),i.crossOrigin==="use-credentials"?a.credentials="include":i.crossOrigin==="anonymous"?a.credentials="omit":a.credentials="same-origin",a}function r(i){if(i.ep)return;i.ep=!0;const a=t(i);fetch(i.href,a)}})();const vt="modulepreload",It=function(e){return"/pr-preview/pr-68/"+e},Nn={},ee=function(n,t,r){let i=Promise.resolve();if(t&&t.length>0){let c=function(s){return Promise.all(s.map(d=>Promise.resolve(d).then(g=>({status:"fulfilled",value:g}),g=>({status:"rejected",reason:g}))))};document.getElementsByTagName("link");const l=document.querySelector("meta[property=csp-nonce]"),m=(l==null?void 0:l.nonce)||(l==null?void 0:l.getAttribute("nonce"));i=c(t.map(s=>{if(s=It(s),s in Nn)return;Nn[s]=!0;const d=s.endsWith(".css"),g=d?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${s}"]${g}`))return;const p=document.createElement("link");if(p.rel=d?"stylesheet":vt,d||(p.as="script"),p.crossOrigin="",p.href=s,m&&p.setAttribute("nonce",m),document.head.appendChild(p),d)return new Promise((h,b)=>{p.addEventListener("load",h),p.addEventListener("error",()=>b(new Error(`Unable to preload CSS for ${s}`)))})}))}function a(c){const l=new Event("vite:preloadError",{cancelable:!0});if(l.payload=c,window.dispatchEvent(l),!l.defaultPrevented)throw c}return i.then(c=>{for(const l of c||[])l.status==="rejected"&&a(l.reason);return n().catch(a)})},Tt="io.camunda.agenticai:aiagent",_e="http://www.omg.org/spec/BPMN/20100524/MODEL",jt="http://camunda.org/schema/zeebe/1.0";function nn(e,n){return Array.from(e.getElementsByTagNameNS(jt,n))}function Yn(e,n){return nn(e,n).filter(t=>kt(t)===e)}function kt(e){let n=e.parentElement;for(;n;){if(n.namespaceURI===_e&&n.localName!=="extensionElements")return n;n=n.parentElement}return null}function cn(e){const n=Yn(e,"taskDefinition")[0],t=n==null?void 0:n.getAttribute("type");return t||(e.localName==="scriptTask"?e.getAttribute("id")??null:null)}function Et(e){const n=Array.from(e.children).find(t=>t.namespaceURI===_e&&t.localName==="documentation");return((n==null?void 0:n.textContent)??"").trim()}function vn(e){if(!e)return"";const n=e.startsWith("=")?e.slice(1):e,t=n.match(/"((?:[^"\\]|\\.)*)"/g);return t?t.map(r=>r.slice(1,-1).replace(/\\n/g,`
...
`,di=`Please verify export compliance for this shipment and notify the team of your decision.\r
`,ui={id:"compliance-walkthrough",label:"Take the tour",steps:[{title:"Start a run",description:"Press Run to send a shipment through the compliance agent.",target:{anchor:fe.runButton}},{title:"The agent picks its own tools",description:"This AI Agent reads the shipment notes and decides, turn by turn, which of the tools below it to call — nothing here is hard-coded into a fixed sequence.",target:{elementId:"ComplianceCheckAgent"}},{title:"Watch the token move",description:"The agent's first move is to look up the genetic marker mentioned in the notes.",target:{elementId:"VerifyGeneticMarker"},waitFor:{kind:"activeElement",elementId:"VerifyGeneticMarker"}},{title:"A cleared shipment notifies the export team",description:"Once the compliance score comes back clean, the process notifies the export team automatically — no human review needed for this scenario.",target:{elementId:"NotifyExportTeam"},waitFor:{kind:"elementCompleted",elementId:"NotifyExportTeam"}},{title:"Everything the run recorded",description:"The variables panel shows the marker record, the country lookup, the compliance score, and the final decision — exactly what each tool and the agent wrote along the way.",target:{anchor:fe.variablesPanel}}],successEvent:{kind:"instanceCompleted"}},mi=`<?xml version="1.0" encoding="UTF-8"?>
...
}`,Bi={id:"seed-export-compliance",title:"Seed export compliance agent",blurb:"An AI agent picks its own tools to check a shipment, then a gateway routes on its decision — cleared shipments notify the export team, flagged ones go to a human. The LLM recommends; the BPMN process governs.",docsUrl:"https://camunda.com/blog/agentic-ai/",bpmn:mi,forms:{"seed-export-shipment-ready":wi,"seed-export-compliance-review":ki},seed:{scenario:On,shipmentNotes:""},scenarios:[{label:"Likely cleared (TP53 → Brazil)",variables:{scenario:On,shipmentNotes:""}},{label:"Likely flagged (BRCA1 → Germany)",variables:{scenario:Si,shipmentNotes:""}}],scriptedAgent:Ai,templates:Di,tour:ui,requiredTools:["RecordComplianceDecision"],handlers:[{elementId:"VerifyGeneticMarker",standsInFor:"JDBC connector — UCSC hg38",source:Li},{elementId:"CheckDestinationCountry",standsInFor:"GraphQL connector — countries API",source:Ci},{elementId:"ComputeComplianceScore",standsInFor:"REST connector — api.mathjs.org",source:zi},{elementId:"RecordComplianceDecision",standsInFor:"Script task — FEEL",source:Pi},{elementId:"NotifyExportTeam",standsInFor:"REST connector — httpbin.io",source:Oi}]},Ri=`<?xml version="1.0" encoding="UTF-8"?>
...
}`,Qi={id:"order-process",title:"Order process with service workers",blurb:"The getting-started order process: check inventory, charge payment, ship. No agent and no human step — the same runner, driven entirely by what's in the diagram.",docsUrl:"https://docs.camunda.io/docs/next/guides/getting-started-orchestration-cluster/",bpmn:Ri,seed:{item:"camunda-t-shirt",quantity:3},handlers:[{elementId:"Activity_0tw2fu0",standsInFor:"job worker — check-inventory",source:Ui},{elementId:"Activity_1ppsbgi",standsInFor:"job worker — charge-payment",source:Fi},{elementId:"Activity_08pg6im",standsInFor:"job worker — ship-items",source:Yi}]},$i=`<?xml version="1.0" encoding="UTF-8"?>\r
...
`,Gi=`async (job, { text, num, sleep, trace }) => {
  // The starting variables arrive on 'job.variables'.
...
}`,Ji={id:"rocket-launch",title:"Rocket launch",blurb:"The getting-started rocket launch, boiled down to one service task: launch. The smallest possible example, and the smallest possible test of the framework's extensibility.",bpmn:$i,seed:{missionName:"Apollo 11",destination:"the Moon",fuelLevel:100},scenarios:[{label:"Full tanks — launch succeeds",variables:{missionName:"Apollo 11",destination:"the Moon",fuelLevel:100}},{label:"Low fuel — mission scrubbed",variables:{missionName:"Apollo 13",destination:"the Moon",fuelLevel:30}}],handlers:[{elementId:"Activity_LaunchRocket",standsInFor:"job worker — launch-rocket",source:Gi}]},Hi=`<?xml version="1.0" encoding="UTF-8"?>\r
...
`,Vi=`async (job, { text, sleep }) => {
  ...
  return { shipped: true, tracking: "1Z" + Math.floor(Math.random() * 1e9) };
}`,Wi={id:"order-process-boundary-events",title:"Order process with boundary events",blurb:"The getting-started order process, extended with a timer and an error boundary event: charge payment can be declined, and a delayed shipment can escalate — both fired by hand from the runner rather than by chance.",docsUrl:"https://github.com/camunda/camunda-8-get-started/tree/main/2-order-process-with-service-workers",bpmn:Hi,seed:{item:"camunda-t-shirt",quantity:3},handlers:[{elementId:"Activity_0tw2fu0",standsInFor:"job worker — check-inventory",source:Vi},{elementId:"Activity_1ppsbgi",standsInFor:"job worker — charge-payment",source:Zi,manualControl:{label:"Charge payment method",completeLabel:"✅ Complete normally",action:{kind:"error",errorCode:"CHARGE_DECLINED",message:"The card issuer declined the charge.",label:"❌ Simulate: card declined"}}},{elementId:"Activity_08pg6im",standsInFor:"job worker — ship-items",source:qi,manualControl:{label:"Ship items",completeLabel:"✅ Ship it",action:{kind:"timer",label:"🕐 Fire the shipping-delayed timer"}}}]},Ue=[Ji,Bi,Qi,Wi];function un(){return"/pr-preview/pr-68/"}function Ki(e){const n=un();return e.startsWith(n)?"/"+e.slice(n.length):e}function Xi(e=location.pathname){const t=Ki(e).match(/^\/examples\/([^/]+)\/?$/);if(t)try{return{kind:"example",id:decodeURIComponent(t[1])}}catch{return{kind:"gallery"}}return{kind:"gallery"}}function eo(e=location.search){return new URLSearchParams(e).get("embed")==="1"}function no(){return un()}function Bn(e){return`${un()}examples/${encodeURIComponent(e)}`}function Rn(e,n={}){const t=new URL(location.href);t.pathname=e,t.search=n.search??t.search,n.hash!==void 0&&(t.hash=n.hash),n.replace?history.replaceState(history.state,"",t):history.pushState(history.state,"",t),window.dispatchEvent(new PopStateEvent("popstate"))}function Un(){return{route:Xi(),embed:eo()}}function to(){const[e,n]=f.useState(Un);return f.useEffect(()=>{const t=()=>n(Un());return window.addEventListener("popstate",t),()=>window.removeEventListener("popstate",t)},[]),e}const ro="web-demo-framework:height",io="web-demo-framework:request-height";function oo(e){return{type:ro,height:Math.ceil(e)}}const Fn="embed-height-auto";function so(e){f.useEffect(()=>{if(!e||typeof window>"u"||window.parent===window)return;const n=document.documentElement;n.classList.add(Fn);let t=-1;const r=(c=!1)=>{const l=document.documentElement.scrollHeight;!c&&Math.abs(l-t)<2||(t=l,window.parent.postMessage(oo(l),"*"))},i=c=>{if(c.source!==window.parent)return;const l=c.data;!l||l.type!==io||r(!0)};window.addEventListener("message",i),r();const a=new ResizeObserver(()=>r());return a.observe(n),()=>{a.disconnect(),window.removeEventListener("message",i),n.classList.remove(Fn)}},[e])}function ao(){const{route:e,embed:n}=to(),t=et().brain,r=Wr();so(n);const i=e.kind==="example"?e.id:Ue[0].id,a=Ue.find(m=>m.id===i)??Ue[0],c=m=>{Rn(Bn(m),{hash:location.hash})},l=o.jsxs(o.Fragment,{children:[!n&&e.kind==="gallery"&&o.jsx("nav",{className:"example-picker",children:Ue.map(m=>o.jsx(V,{size:"sm",variant:m.id===a.id?"default":"secondary",onClick:()=>c(m.id),children:m.title},m.id))}),!n&&e.kind==="example"&&o.jsx("div",{className:"example-nav",children:o.jsx(V,{size:"sm",variant:"secondary",onClick:()=>Rn(no()),children:"← All examples"})}),o.jsxs("div",{className:"example-meta",children:[a.docsUrl&&o.jsx("a",{className:"docs-link",href:a.docsUrl,target:"_blank",rel:"noreferrer noopener",children:"View on camunda.com ↗"}),n&&o.jsx("a",{className:"open-full-page",href:Bn(a.id)+(location.hash||""),target:"_top",rel:"noreferrer",children:"Open full page ↗"})]}),o.jsx(ci,{example:a,initialBrainKind:t,initialTourId:r},a.id)]});return n?o.jsx("div",{className:"c4-ui app-shell app-embed",children:o.jsx("main",{id:"main",className:"layout layout-embed",children:l})}):o.jsxs("div",{className:"c4-ui app-shell",children:[o.jsx(xt,{appName:"Runnable Camunda examples",trailing:o.jsx("span",{className:"app-subtitle",children:"model + code + optional LLM, in your browser"})}),o.jsx("main",{id:"main",className:"layout",children:l})]})}pt.createRoot(document.getElementById("root")).render(o.jsx(f.StrictMode,{children:o.jsx(Nt,{children:o.jsx(ao,{})})}));export{ee as _,mo as c};
