import{m as n}from"./index-C_0IUx1h.js";import"./vendor-react-9Ma26nY1.js";import"./vendor-design-system-LhsW1xfK.js";const t=`<?xml version="1.0" encoding="UTF-8"?>
<!--
    ...
    <bpmn:adHocSubProcess id="LoanSupportAgent" name="Loan Support Agent" zeebe:modelerTemplate="io.camunda.connectors.agenticai.aiagent.jobworker.v1" zeebe:modelerTemplateVersion="10">
      ...
      <bpmn:serviceTask id="CalculateLoanPayment" name="Calculate loan payment">
        ...
        <bpmn:extensionElements>
          ...
          <zeebe:ioMapping>
            <zeebe:input source="=fromAi(toolCall.loanAmount, &#34;The loan principal the customer asked about, as a plain number with no currency symbol and no thousands separators&#34;, &#34;number&#34;)" target="loanAmount" />
            <zeebe:input source="=fromAi(toolCall.annualInterestRatePercent, &#34;The annual interest rate as the customer stated it, as a percentage figure rather than a fraction — the percent number itself, not that number divided by a hundred&#34;, &#34;number&#34;)" target="annualInterestRatePercent" />
