const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/driver-CTZuBZOi.css","assets/diagram-js-DAKGYcfb.css","assets/bpmn-embedded-DQCERAo3.css","assets/RuntimeDiagram-B2IYfHo7.js","assets/vendor-react-9Ma26nY1.js","assets/Viewer-D_7S4Gwm.js","assets/MonacoEditor-Cd5eGghw.js","assets/MonacoEditor-C1fzfYRh.css","assets/vendor-modeler-uSbT8_ZI.js","assets/vendor-design-system-Cx-7FgMU.js","assets/vendor-design-system-Dusvwuyj.css","assets/parser-DkgAe_kI.js","assets/ModelEditor-Dwlgp6JA.css","assets/FormRenderer-2nAeOhHG.js","assets/FormRenderer-D1JIHOW6.css"])))=>i.map(i=>d[i]);
var Dt=Object.defineProperty;var Pt=(e,n,t)=>n in e?Dt(e,n,{enumerable:!0,configurable:!0,writable:!0,value:t}):e[n]=t;var O=(e,n,t)=>Pt(e,typeof n!="symbol"?n+"":n,t);import{r as h,j as a,i as Lt}from"./vendor-react-9Ma26nY1.js";import{B as Q,a as J,L as Be,S as Xn,b as et,c as nt,d as tt,e as rt,A as ae,f as se,g as de,I as tn,C as Bt,h as Rt,i as zt,j as Ot,k as Ft,l as Ut,T as $t,m as Gt,n as Je,o as He,p as Vt,q as Yt}from"./vendor-design-system-Cx-7FgMU.js";(function(){const n=document.createElement("link").relList;if(n&&n.supports&&n.supports("modulepreload"))return;for(const i of document.querySelectorAll('link[rel="modulepreload"]'))r(i);new MutationObserver(i=>{for(const s of i)if(s.type==="childList")for(const c of s.addedNodes)c.tagName==="LINK"&&c.rel==="modulepreload"&&r(c)}).observe(document,{childList:!0,subtree:!0});function t(i){const s={};return i.integrity&&(s.integrity=i.integrity),i.referrerPolicy&&(s.referrerPolicy=i.referrerPolicy),i.crossOrigin==="use-credentials"?s.credentials="include":i.crossOrigin==="anonymous"?s.credentials="omit":s.credentials="same-origin",s}function r(i){if(i.ep)return;i.ep=!0;const s=t(i);fetch(i.href,s)}})();const Qt="modulepreload",Jt=function(e){return"/pr-preview/pr-92/"+e},kn={},ce=function(n,t,r){let i=Promise.resolve();if(t&&t.length>0){let c=function(o){return Promise.all(o.map(d=>Promise.resolve(d).then(g=>({status:"fulfilled",value:g}),g=>({status:"rejected",reason:g}))))};document.getElementsByTagName("link");const u=document.querySelector("meta[property=csp-nonce]"),m=(u==null?void 0:u.nonce)||(u==null?void 0:u.getAttribute("nonce"));i=c(t.map(o=>{if(o=Jt(o),o in kn)return;kn[o]=!0;const d=o.endsWith(".css"),g=d?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${o}"]${g}`))return;const p=document.createElement("link");if(p.rel=d?"stylesheet":Qt,d||(p.as="script"),p.crossOrigin="",p.href=o,m&&p.setAttribute("nonce",m),document.head.appendChild(p),d)return new Promise((_,b)=>{p.addEventListener("load",_),p.addEventListener("error",()=>b(new Error(`Unable to preload CSS for ${o}`)))})}))}function s(c){const u=new Event("vite:preloadError",{cancelable:!0});if(u.payload=c,window.dispatchEvent(u),!u.defaultPrevented)throw c}return i.then(c=>{for(const u of c||[])u.status==="rejected"&&s(u.reason);return n().catch(s)})},Ht="io.camunda.agenticai:aiagent",we="http://www.omg.org/spec/BPMN/20100524/MODEL",qt="http://camunda.org/schema/zeebe/1.0";function ln(e,n){return Array.from(e.getElementsByTagNameNS(qt,n))}function it(e,n){return ln(e,n).filter(t=>Wt(t)===e)}function Wt(e){let n=e.parentElement;for(;n;){if(n.namespaceURI===we&&n.localName!=="extensionElements")return n;n=n.parentElement}return null}function hn(e){const n=it(e,"taskDefinition")[0],t=n==null?void 0:n.getAttribute("type");return t||(e.localName==="scriptTask"?e.getAttribute("id")??null:null)}function In(e){const n=Array.from(e.children).find(t=>t.namespaceURI===we&&t.localName==="documentation");return((n==null?void 0:n.textContent)??"").trim()}function Tn(e){if(!e)return"";const n=e.startsWith("=")?e.slice(1):e,t=n.match(/"((?:[^"\\]|\\.)*)"/g);return t?t.map(r=>r.slice(1,-1).replace(/\\n/g,`
...
}`,lo={id:"learn-service-task",title:"Service task + sequence flow",group:"learn-bpmn",blurb:"A service task is a unit of work a worker (not a human) performs; a sequence flow is the arrow that hands the token from one to the next once its task completes. Run this and watch each task activate, run its handler, and complete in order — Prepare package, then Dispatch courier — before the process reaches its end event. Miss the zeebe:taskDefinition type on a service task and the model still deploys fine, but no worker is ever listening for that job type, so the run stalls forever waiting on a job nothing services — see the note below for how that looks.",docsUrl:"https://docs.camunda.io/docs/components/modeler/bpmn/service-tasks/",bpmn:ao,seed:{item:"camunda-t-shirt"},handlers:[{elementId:"Activity_prepare",standsInFor:"job worker — prepare-package",source:so},{elementId:"Activity_dispatch",standsInFor:"job worker — dispatch-courier",source:co}]},uo=Object.freeze(Object.defineProperty({__proto__:null,default:lo},Symbol.toStringTag,{value:"Module"})),mo=`You are a demo workflow assistant for fictional compliance checks.
...
}`,_a={id:"loan-origination",title:"Loan origination agent",blurb:"An AI agent gathers a loan case with its own tools — customer lookup, credit bureau, an underwriting policy, a status update — then every application passes through a mandatory senior-officer review before a gateway routes it to an offer or a decline. The agent advises; the process governs.",docsUrl:"https://camunda.com/orchestrate/agents/",bpmn:Yo,forms:{"loan-application":Xo,"loan-senior-officer-review":sa},seed:Jn,scenarios:[{label:"Strong applicant (policy recommends approve)",variables:Jn},{label:"Marginal applicant (policy recommends decline)",variables:la}],scriptedAgent:ua,templates:ca,tour:Vo,requiredTools:["AssessApplication"],handlers:[{elementId:"QueryCustomer",standsInFor:"CRM connector — customer lookup",source:ma},{elementId:"CreditBureauLookup",standsInFor:"REST connector — credit bureau",source:pa},{elementId:"AssessApplication",standsInFor:"Script task — underwriting policy (FEEL)",source:ga},{elementId:"UpdateApplicationStatus",standsInFor:"REST connector — origination system",source:ha},{elementId:"IssueLoanOffer",standsInFor:"REST connector — offer/booking system",source:ba},{elementId:"SendDeclineNotice",standsInFor:"REST connector — notifications",source:fa}]},ya=`<?xml version="1.0" encoding="UTF-8"?>
...
`,wa=`async (job, { text, sleep }) => {
  ...
  return { shipped: true, tracking: "1Z" + Math.floor(Math.random() * 1e9) };
}`,xa={id:"order-process",title:"Order process with service workers",blurb:"The getting-started order process: check inventory, charge payment, ship. No agent and no human step — the same runner, driven entirely by what's in the diagram.",docsUrl:"https://docs.camunda.io/docs/next/guides/getting-started-orchestration-cluster/",bpmn:ya,seed:{item:"camunda-t-shirt",quantity:3},handlers:[{elementId:"Activity_0tw2fu0",standsInFor:"job worker — check-inventory",source:wa},{elementId:"Activity_1ppsbgi",standsInFor:"job worker — charge-payment",source:Ma},{elementId:"Activity_08pg6im",standsInFor:"job worker — ship-items",source:va}]},Na=`<?xml version="1.0" encoding="UTF-8"?>\r
...
`,Ea=`async (job, { text, num, sleep, trace }) => {
  // The starting variables arrive on 'job.variables'.
...
}`,ka={id:"rocket-launch",title:"Rocket launch",blurb:"The getting-started rocket launch, boiled down to one service task: launch. The smallest possible example, and the smallest possible test of the framework's extensibility.",bpmn:Na,seed:{missionName:"Apollo 11",destination:"the Moon",fuelLevel:100},scenarios:[{label:"Full tanks — launch succeeds",variables:{missionName:"Apollo 11",destination:"the Moon",fuelLevel:100}},{label:"Low fuel — mission scrubbed",variables:{missionName:"Apollo 13",destination:"the Moon",fuelLevel:30}}],handlers:[{elementId:"Activity_LaunchRocket",standsInFor:"job worker — launch-rocket",source:Ea}]},Ia=`<?xml version="1.0" encoding="UTF-8"?>\r
...
`,Ta=`async (job, { text, sleep }) => {
  ...
  return { shipped: true, tracking: "1Z" + Math.floor(Math.random() * 1e9) };
}`,Aa={id:"order-process-boundary-events",title:"Order process with boundary events",blurb:"The getting-started order process, extended with a timer and an error boundary event: charge payment can be declined, and a delayed shipment can escalate — both fired by hand from the runner rather than by chance.",docsUrl:"https://github.com/camunda/camunda-8-get-started/tree/main/2-order-process-with-service-workers",bpmn:Ia,seed:{item:"camunda-t-shirt",quantity:3},handlers:[{elementId:"Activity_0tw2fu0",standsInFor:"job worker — check-inventory",source:Ta},{elementId:"Activity_1ppsbgi",standsInFor:"job worker — charge-payment",source:ja,manualControl:{label:"Charge payment method",completeLabel:"✅ Complete normally",action:{kind:"error",errorCode:"CHARGE_DECLINED",message:"The card issuer declined the charge.",label:"❌ Simulate: card declined"}}},{elementId:"Activity_08pg6im",standsInFor:"job worker — ship-items",source:Sa,manualControl:{label:"Ship items",completeLabel:"✅ Ship it",action:{kind:"timer",label:"🕐 Fire the shipping-delayed timer"}}}]},Ca="/pr-preview/pr-92/assets/de-bmw-mini-JBSk7QcF.jpg",Da="/pr-preview/pr-92/assets/de-bmw-mini.thumb-CUUmJrRO.jpg",Pa="/pr-preview/pr-92/assets/uk-d651-rnb-XGipy2QN.jpg",La="/pr-preview/pr-92/assets/uk-d651-rnb.thumb-mjEcbhUf.jpg",Ba="/pr-preview/pr-92/assets/uk-mk70-orj-Cn6O3Xfm.jpg",Ra="/pr-preview/pr-92/assets/uk-mk70-orj.thumb-CaeZ2vqU.jpg",za="/pr-preview/pr-92/assets/uk-ni-ijz-8992-YXV44tgk.jpg",Oa="/pr-preview/pr-92/assets/uk-ni-ijz-8992.thumb-DYwok8jV.jpg",Fa="/pr-preview/pr-92/assets/us-hyundai-genesis-gGpAIEpi.jpg",Ua="/pr-preview/pr-92/assets/us-hyundai-genesis.thumb-DEEt19Mw.jpg",$a=`<?xml version="1.0" encoding="UTF-8"?>
...
}`,ys={id:"plate-recognition",title:"Read a number plate from a photo",blurb:"Pick the plate's country, then a photo goes into the run, an in-browser vision model reads the number plate on the reader's own GPU, and a human confirms or corrects it before the process records the result. The vision model recommends; the BPMN process governs. No server, no API key — with no model connected it falls back to a deterministic scripted reading.",docsUrl:"https://docs.camunda.io/docs/components/modeler/forms/camunda-forms-reference/",bpmn:$a,forms:{"plate-recognition-country":ms,"plate-recognition-confirm":Wa,"plate-recognition-manual":is},seed:{country:"auto"},imageInput:{label:"Pick a seed photo (its plate is known, so the scripted reader works offline) or upload your own — a live in-browser model reads a photo it has never seen.",seedImages:hs},scriptedVision:bs,handlers:[{elementId:"ExtractPlate",standsInFor:"Vision model — Florence-2 <OCR> on WebGPU (in-browser)",source:fs},{elementId:"RecordResult",standsInFor:"Script task — records the governed outcome",source:_s}]},ws=[ka,Uo,_a,xa,Aa,ys],Ms=Object.assign({"./learn-error-boundary/index.ts":Xi,"./learn-exclusive-gateway/index.ts":oo,"./learn-service-task/index.ts":uo}),vs=Object.values(Ms).map(e=>e.default).sort((e,n)=>e.id.localeCompare(n.id)),Fe=[...ws,...vs];function fn(){return"/pr-preview/pr-92/"}function xs(e){const n=fn();return e.startsWith(n)?"/"+e.slice(n.length):e}function Ns(e=location.pathname){const t=xs(e).match(/^\/examples\/([^/]+)\/?$/);if(t)try{return{kind:"example",id:decodeURIComponent(t[1])}}catch{return{kind:"gallery"}}return{kind:"gallery"}}function Es(e=location.search){return new URLSearchParams(e).get("embed")==="1"}function ks(){return fn()}function qn(e){return`${fn()}examples/${encodeURIComponent(e)}`}function Wn(e,n={}){const t=new URL(location.href);t.pathname=e,t.search=n.search??t.search,n.hash!==void 0&&(t.hash=n.hash),n.replace?history.replaceState(history.state,"",t):history.pushState(history.state,"",t),window.dispatchEvent(new PopStateEvent("popstate"))}function Zn(){return{route:Ns(),embed:Es()}}function Is(){const[e,n]=h.useState(Zn);return h.useEffect(()=>{const t=()=>n(Zn());return window.addEventListener("popstate",t),()=>window.removeEventListener("popstate",t)},[]),e}const Ts="web-demo-framework:height",js="web-demo-framework:request-height";function Ss(e){return{type:Ts,height:Math.ceil(e)}}const Kn="embed-height-auto";function As(e){h.useEffect(()=>{if(!e||typeof window>"u"||window.parent===window)return;const n=document.documentElement;n.classList.add(Kn);let t=-1;const r=(c=!1)=>{const u=document.documentElement.scrollHeight;!c&&Math.abs(u-t)<2||(t=u,window.parent.postMessage(Ss(u),"*"))},i=c=>{if(c.source!==window.parent)return;const u=c.data;!u||u.type!==js||r(!0)};window.addEventListener("message",i),r();const s=new ResizeObserver(()=>r());return s.observe(n),()=>{s.disconnect(),window.removeEventListener("message",i),n.classList.remove(Kn)}},[e])}function Cs(){const{route:e,embed:n}=Is(),t=vt().brain,r=Ri();As(n);const i=e.kind==="example"?e.id:Fe[0].id,s=Fe.find(d=>d.id===i)??Fe[0],c=Fe.filter(d=>d.group!=="learn-bpmn"),u=Fe.filter(d=>d.group==="learn-bpmn"),m=d=>{Wn(qn(d),{hash:location.hash})},o=a.jsxs(a.Fragment,{children:[!n&&e.kind==="gallery"&&a.jsxs(a.Fragment,{children:[a.jsx("nav",{className:"example-picker",children:c.map(d=>a.jsx(Q,{size:"sm",variant:d.id===s.id?"default":"secondary",onClick:()=>m(d.id),children:d.title},d.id))}),u.length>0&&a.jsxs(a.Fragment,{children:[a.jsx("h2",{className:"example-group-heading",children:"Learn BPMN"}),a.jsx("nav",{className:"example-picker",children:u.map(d=>a.jsx(Q,{size:"sm",variant:d.id===s.id?"default":"secondary",onClick:()=>m(d.id),children:d.title},d.id))})]})]}),!n&&e.kind==="example"&&a.jsx("div",{className:"example-nav",children:a.jsx(Q,{size:"sm",variant:"secondary",onClick:()=>Wn(ks()),children:"← All examples"})}),a.jsxs("div",{className:"example-meta",children:[s.docsUrl&&a.jsx("a",{className:"docs-link",href:s.docsUrl,target:"_blank",rel:"noreferrer noopener",children:"View on camunda.com ↗"}),n&&a.jsx("a",{className:"open-full-page",href:qn(s.id)+(location.hash||""),target:"_top",rel:"noreferrer",children:"Open full page ↗"})]}),a.jsx(Hi,{example:s,initialBrainKind:t,initialTourId:r},s.id)]});return n?a.jsx("div",{className:"c4-ui app-shell app-embed",children:a.jsx("main",{id:"main",className:"layout layout-embed",children:o})}):a.jsxs("div",{className:"c4-ui app-shell",children:[a.jsx(Vt,{appName:"Runnable Camunda examples",trailing:a.jsx("span",{className:"app-subtitle",children:"model + code + optional LLM, in your browser"})}),a.jsx("main",{id:"main",className:"layout",children:o})]})}Lt.createRoot(document.getElementById("root")).render(a.jsx(h.StrictMode,{children:a.jsx(Yt,{children:a.jsx(Cs,{})})}));export{ce as _,Bs as c};
