const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/driver-CTZuBZOi.css","assets/diagram-js-DAKGYcfb.css","assets/bpmn-embedded-D2-fZhxL.css","assets/RuntimeDiagram-B2IYfHo7.js","assets/vendor-react-9Ma26nY1.js","assets/Viewer-D_7S4Gwm.js","assets/MonacoEditor-LA9d1w5j.js","assets/MonacoEditor-gN9IbDQF.css","assets/vendor-modeler-CIAOEjvU.js","assets/vendor-design-system-BLo2__O7.js","assets/vendor-design-system-JTuzLf99.css","assets/parser-DkgAe_kI.js","assets/ModelEditor-Dwlgp6JA.css","assets/FormRenderer-B7fhfl0b.js","assets/FormRenderer-D1JIHOW6.css"])))=>i.map(i=>d[i]);
var Pt=Object.defineProperty;var Ct=(e,n,t)=>n in e?Pt(e,n,{enumerable:!0,configurable:!0,writable:!0,value:t}):e[n]=t;var O=(e,n,t)=>Ct(e,typeof n!="symbol"?n+"":n,t);import{r as h,j as a,i as Lt}from"./vendor-react-9Ma26nY1.js";import{B as Q,a as J,L as Be,S as Xn,b as et,c as nt,d as tt,e as rt,A as ae,f as se,g as de,I as tn,C as Bt,h as Rt,i as zt,j as Ot,k as Ft,l as Ut,T as $t,m as Gt,n as Je,o as qe,p as Vt,q as Yt}from"./vendor-design-system-BLo2__O7.js";(function(){const n=document.createElement("link").relList;if(n&&n.supports&&n.supports("modulepreload"))return;for(const i of document.querySelectorAll('link[rel="modulepreload"]'))r(i);new MutationObserver(i=>{for(const s of i)if(s.type==="childList")for(const l of s.addedNodes)l.tagName==="LINK"&&l.rel==="modulepreload"&&r(l)}).observe(document,{childList:!0,subtree:!0});function t(i){const s={};return i.integrity&&(s.integrity=i.integrity),i.referrerPolicy&&(s.referrerPolicy=i.referrerPolicy),i.crossOrigin==="use-credentials"?s.credentials="include":i.crossOrigin==="anonymous"?s.credentials="omit":s.credentials="same-origin",s}function r(i){if(i.ep)return;i.ep=!0;const s=t(i);fetch(i.href,s)}})();const Qt="modulepreload",Jt=function(e){return"/pr-preview/pr-91/"+e},En={},le=function(n,t,r){let i=Promise.resolve();if(t&&t.length>0){let l=function(o){return Promise.all(o.map(d=>Promise.resolve(d).then(g=>({status:"fulfilled",value:g}),g=>({status:"rejected",reason:g}))))};document.getElementsByTagName("link");const m=document.querySelector("meta[property=csp-nonce]"),u=(m==null?void 0:m.nonce)||(m==null?void 0:m.getAttribute("nonce"));i=l(t.map(o=>{if(o=Jt(o),o in En)return;En[o]=!0;const d=o.endsWith(".css"),g=d?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${o}"]${g}`))return;const p=document.createElement("link");if(p.rel=d?"stylesheet":Qt,d||(p.as="script"),p.crossOrigin="",p.href=o,u&&p.setAttribute("nonce",u),document.head.appendChild(p),d)return new Promise((_,b)=>{p.addEventListener("load",_),p.addEventListener("error",()=>b(new Error(`Unable to preload CSS for ${o}`)))})}))}function s(l){const m=new Event("vite:preloadError",{cancelable:!0});if(m.payload=l,window.dispatchEvent(m),!m.defaultPrevented)throw l}return i.then(l=>{for(const m of l||[])m.status==="rejected"&&s(m.reason);return n().catch(s)})},qt="io.camunda.agenticai:aiagent",ye="http://www.omg.org/spec/BPMN/20100524/MODEL",Ht="http://camunda.org/schema/zeebe/1.0";function cn(e,n){return Array.from(e.getElementsByTagNameNS(Ht,n))}function it(e,n){return cn(e,n).filter(t=>Wt(t)===e)}function Wt(e){let n=e.parentElement;for(;n;){if(n.namespaceURI===ye&&n.localName!=="extensionElements")return n;n=n.parentElement}return null}function hn(e){const n=it(e,"taskDefinition")[0],t=n==null?void 0:n.getAttribute("type");return t||(e.localName==="scriptTask"?e.getAttribute("id")??null:null)}function In(e){const n=Array.from(e.children).find(t=>t.namespaceURI===ye&&t.localName==="documentation");return((n==null?void 0:n.textContent)??"").trim()}function Tn(e){if(!e)return"";const n=e.startsWith("=")?e.slice(1):e,t=n.match(/"((?:[^"\\]|\\.)*)"/g);return t?t.map(r=>r.slice(1,-1).replace(/\\n/g,`
...
`,so="Camunda Cloud",lo="8.10.0",co={name:"Camunda Web Modeler",version:"9b5d5ef"},mo=19,uo="learn-user-task-form-review",po=[{text:`# Review request
...
**Details:** {{details}}`,type:"text",layout:{row:"Row_details",columns:null},id:"Field_ReviewDetails"},{label:"Decision",values:[{label:"Approve",value:"approved"},{label:"Reject",value:"rejected"}],type:"radio",layout:{row:"Row_decision",columns:null},id:"Field_ReviewDecision",key:"decision",validate:{required:!0}},{label:"Comments",description:"Optional note recorded alongside your decision.",type:"textarea",layout:{row:"Row_comments",columns:null},id:"Field_ReviewComments",key:"comments"}],go="default",ho={executionPlatform:so,executionPlatformVersion:lo,exporter:co,schemaVersion:mo,id:uo,components:po,type:go},bo={id:"learn-user-task-form",title:"User task + form",group:"learn-bpmn",blurb:"A user task is a step a human completes, not a worker — the token parks at the task until someone submits its form, then moves on. Run this and watch the process reach 'Review request' and wait; fill in the decision form and submit it to see the token resume and the process reach its end event. A user task with no zeebe:formDefinition binding still deploys and still parks the token, but the runner has no form to render for it, so it offers a bare Complete button that finishes the task with no variables.",docsUrl:"https://docs.camunda.io/docs/components/modeler/bpmn/user-tasks/",bpmn:ao,forms:{"learn-user-task-form-review":ho},seed:{requester:"Priya Shah",details:"Approve access to the shared design-review workspace."},handlers:[]},fo=Object.freeze(Object.defineProperty({__proto__:null,default:bo},Symbol.toStringTag,{value:"Module"})),_o=`You are a demo workflow assistant for fictional compliance checks.
...
`,wo=`Please verify export compliance for this shipment and notify the team of your decision.\r
`,yo={id:"compliance-walkthrough",label:"Take the tour",steps:[{title:"Start a run",description:"Press Run to send a shipment through the compliance agent.",target:{anchor:he.runButton}},{title:"The agent picks its own tools",description:"This AI Agent reads the shipment notes and decides, turn by turn, which of the tools below it to call — nothing here is hard-coded into a fixed sequence.",target:{elementId:"ComplianceCheckAgent"}},{title:"Watch the token move",description:"The agent's first move is to look up the genetic marker mentioned in the notes.",target:{elementId:"VerifyGeneticMarker"},waitFor:{kind:"activeElement",elementId:"VerifyGeneticMarker"}},{title:"A cleared shipment notifies the export team",description:"Once the compliance score comes back clean, the process notifies the export team automatically — no human review needed for this scenario.",target:{elementId:"NotifyExportTeam"},waitFor:{kind:"elementCompleted",elementId:"NotifyExportTeam"}},{title:"Everything the run recorded",description:"The variables panel shows the marker record, the country lookup, the compliance score, and the final decision — exactly what each tool and the agent wrote along the way.",target:{anchor:he.variablesPanel}}],successEvent:{kind:"instanceCompleted"}},Mo=`<?xml version="1.0" encoding="UTF-8"?>
...
}`,Jo={id:"seed-export-compliance",title:"Seed export compliance agent",blurb:"An AI agent picks its own tools to check a shipment, then a gateway routes on its decision — cleared shipments notify the export team, flagged ones go to a human. The LLM recommends; the BPMN process governs.",docsUrl:"https://camunda.com/blog/agentic-ai/",bpmn:Mo,forms:{"seed-export-shipment-ready":jo,"seed-export-compliance-review":Ro},seed:{scenario:Qn,shipmentNotes:""},scenarios:[{label:"Likely cleared (TP53 → Brazil)",variables:{scenario:Qn,shipmentNotes:""}},{label:"Likely flagged (BRCA1 → Germany)",variables:{scenario:Fo,shipmentNotes:""}}],scriptedAgent:Uo,templates:Oo,tour:yo,requiredTools:["RecordComplianceDecision"],handlers:[{elementId:"VerifyGeneticMarker",standsInFor:"JDBC connector — UCSC hg38",source:$o},{elementId:"CheckDestinationCountry",standsInFor:"GraphQL connector — countries API",source:Go},{elementId:"ComputeComplianceScore",standsInFor:"REST connector — api.mathjs.org",source:Vo},{elementId:"RecordComplianceDecision",standsInFor:"Script task — FEEL",source:Yo},{elementId:"NotifyExportTeam",standsInFor:"REST connector — httpbin.io",source:Qo}]},qo=`You are a loan origination assistant at a retail bank. Your job is to gather everything a senior loan officer needs to decide an application — you do **not** decide it yourself.
...
}`,wa=`async (job, { text, num, sleep, trace }) => {
...
}`,Na={id:"loan-origination",title:"Loan origination agent",blurb:"An AI agent gathers a loan case with its own tools — customer lookup, credit bureau, an underwriting policy, a status update — then every application passes through a mandatory senior-officer review before a gateway routes it to an offer or a decline. The agent advises; the process governs.",docsUrl:"https://camunda.com/orchestrate/agents/",bpmn:Zo,forms:{"loan-application":oa,"loan-senior-officer-review":pa},seed:Jn,scenarios:[{label:"Strong applicant (policy recommends approve)",variables:Jn},{label:"Marginal applicant (policy recommends decline)",variables:ba}],scriptedAgent:fa,templates:ha,tour:Wo,requiredTools:["AssessApplication"],handlers:[{elementId:"QueryCustomer",standsInFor:"CRM connector — customer lookup",source:_a},{elementId:"CreditBureauLookup",standsInFor:"REST connector — credit bureau",source:wa},{elementId:"AssessApplication",standsInFor:"Script task — underwriting policy (FEEL)",source:ya},{elementId:"UpdateApplicationStatus",standsInFor:"REST connector — origination system",source:Ma},{elementId:"IssueLoanOffer",standsInFor:"REST connector — offer/booking system",source:va},{elementId:"SendDeclineNotice",standsInFor:"REST connector — notifications",source:xa}]},ka=`<?xml version="1.0" encoding="UTF-8"?>
...
}`,ja={id:"order-process",title:"Order process with service workers",blurb:"The getting-started order process: check inventory, charge payment, ship. No agent and no human step — the same runner, driven entirely by what's in the diagram.",docsUrl:"https://docs.camunda.io/docs/next/guides/getting-started-orchestration-cluster/",bpmn:ka,seed:{item:"camunda-t-shirt",quantity:3},handlers:[{elementId:"Activity_0tw2fu0",standsInFor:"job worker — check-inventory",source:Ea},{elementId:"Activity_1ppsbgi",standsInFor:"job worker — charge-payment",source:Ia},{elementId:"Activity_08pg6im",standsInFor:"job worker — ship-items",source:Ta}]},Sa=`<?xml version="1.0" encoding="UTF-8"?>\r
...
}`,Da={id:"rocket-launch",title:"Rocket launch",blurb:"The getting-started rocket launch, boiled down to one service task: launch. The smallest possible example, and the smallest possible test of the framework's extensibility.",bpmn:Sa,seed:{missionName:"Apollo 11",destination:"the Moon",fuelLevel:100},scenarios:[{label:"Full tanks — launch succeeds",variables:{missionName:"Apollo 11",destination:"the Moon",fuelLevel:100}},{label:"Low fuel — mission scrubbed",variables:{missionName:"Apollo 13",destination:"the Moon",fuelLevel:30}}],handlers:[{elementId:"Activity_LaunchRocket",standsInFor:"job worker — launch-rocket",source:Aa}]},Pa=`<?xml version="1.0" encoding="UTF-8"?>\r
...
`,Ca=`async (job, { text, sleep }) => {
  ...
  return { shipped: true, tracking: "1Z" + Math.floor(Math.random() * 1e9) };
}`,Ra={id:"order-process-boundary-events",title:"Order process with boundary events",blurb:"The getting-started order process, extended with a timer and an error boundary event: charge payment can be declined, and a delayed shipment can escalate — both fired by hand from the runner rather than by chance.",docsUrl:"https://github.com/camunda/camunda-8-get-started/tree/main/2-order-process-with-service-workers",bpmn:Pa,seed:{item:"camunda-t-shirt",quantity:3},handlers:[{elementId:"Activity_0tw2fu0",standsInFor:"job worker — check-inventory",source:Ca},{elementId:"Activity_1ppsbgi",standsInFor:"job worker — charge-payment",source:La,manualControl:{label:"Charge payment method",completeLabel:"✅ Complete normally",action:{kind:"error",errorCode:"CHARGE_DECLINED",message:"The card issuer declined the charge.",label:"❌ Simulate: card declined"}}},{elementId:"Activity_08pg6im",standsInFor:"job worker — ship-items",source:Ba,manualControl:{label:"Ship items",completeLabel:"✅ Ship it",action:{kind:"timer",label:"🕐 Fire the shipping-delayed timer"}}}]},za="/pr-preview/pr-91/assets/de-bmw-mini-JBSk7QcF.jpg",Oa="/pr-preview/pr-91/assets/de-bmw-mini.thumb-CUUmJrRO.jpg",Fa="/pr-preview/pr-91/assets/uk-d651-rnb-XGipy2QN.jpg",Ua="/pr-preview/pr-91/assets/uk-d651-rnb.thumb-mjEcbhUf.jpg",$a="/pr-preview/pr-91/assets/uk-mk70-orj-Cn6O3Xfm.jpg",Ga="/pr-preview/pr-91/assets/uk-mk70-orj.thumb-CaeZ2vqU.jpg",Va="/pr-preview/pr-91/assets/uk-ni-ijz-8992-YXV44tgk.jpg",Ya="/pr-preview/pr-91/assets/uk-ni-ijz-8992.thumb-DYwok8jV.jpg",Qa="/pr-preview/pr-91/assets/us-hyundai-genesis-gGpAIEpi.jpg",Ja="/pr-preview/pr-91/assets/us-hyundai-genesis.thumb-DEEt19Mw.jpg",qa=`<?xml version="1.0" encoding="UTF-8"?>
...
}`,ks={id:"plate-recognition",title:"Read a number plate from a photo",blurb:"Pick the plate's country, then a photo goes into the run, an in-browser vision model reads the number plate on the reader's own GPU, and a human confirms or corrects it before the process records the result. The vision model recommends; the BPMN process governs. No server, no API key — with no model connected it falls back to a deterministic scripted reading.",docsUrl:"https://docs.camunda.io/docs/components/modeler/forms/camunda-forms-reference/",bpmn:qa,forms:{"plate-recognition-country":_s,"plate-recognition-confirm":ts,"plate-recognition-manual":cs},seed:{country:"auto"},imageInput:{label:"Pick a seed photo (its plate is known, so the scripted reader works offline) or upload your own — a live in-browser model reads a photo it has never seen.",seedImages:Ms},scriptedVision:vs,handlers:[{elementId:"ExtractPlate",standsInFor:"Vision model — Florence-2 <OCR> on WebGPU (in-browser)",source:xs},{elementId:"RecordResult",standsInFor:"Script task — records the governed outcome",source:Ns}]},Es=[Da,Jo,Na,ja,Ra,ks],Is=Object.assign({"./learn-exclusive-gateway/index.ts":eo,"./learn-service-task/index.ts":oo,"./learn-user-task-form/index.ts":fo}),Ts=Object.values(Is).map(e=>e.default).sort((e,n)=>e.id.localeCompare(n.id)),Fe=[...Es,...Ts];function fn(){return"/pr-preview/pr-91/"}function js(e){const n=fn();return e.startsWith(n)?"/"+e.slice(n.length):e}function Ss(e=location.pathname){const t=js(e).match(/^\/examples\/([^/]+)\/?$/);if(t)try{return{kind:"example",id:decodeURIComponent(t[1])}}catch{return{kind:"gallery"}}return{kind:"gallery"}}function As(e=location.search){return new URLSearchParams(e).get("embed")==="1"}function Ds(){return fn()}function Hn(e){return`${fn()}examples/${encodeURIComponent(e)}`}function Wn(e,n={}){const t=new URL(location.href);t.pathname=e,t.search=n.search??t.search,n.hash!==void 0&&(t.hash=n.hash),n.replace?history.replaceState(history.state,"",t):history.pushState(history.state,"",t),window.dispatchEvent(new PopStateEvent("popstate"))}function Zn(){return{route:Ss(),embed:As()}}function Ps(){const[e,n]=h.useState(Zn);return h.useEffect(()=>{const t=()=>n(Zn());return window.addEventListener("popstate",t),()=>window.removeEventListener("popstate",t)},[]),e}const Cs="web-demo-framework:height",Ls="web-demo-framework:request-height";function Bs(e){return{type:Cs,height:Math.ceil(e)}}const Kn="embed-height-auto";function Rs(e){h.useEffect(()=>{if(!e||typeof window>"u"||window.parent===window)return;const n=document.documentElement;n.classList.add(Kn);let t=-1;const r=(l=!1)=>{const m=document.documentElement.scrollHeight;!l&&Math.abs(m-t)<2||(t=m,window.parent.postMessage(Bs(m),"*"))},i=l=>{if(l.source!==window.parent)return;const m=l.data;!m||m.type!==Ls||r(!0)};window.addEventListener("message",i),r();const s=new ResizeObserver(()=>r());return s.observe(n),()=>{s.disconnect(),window.removeEventListener("message",i),n.classList.remove(Kn)}},[e])}function zs(){const{route:e,embed:n}=Ps(),t=vt().brain,r=Ri();Rs(n);const i=e.kind==="example"?e.id:Fe[0].id,s=Fe.find(d=>d.id===i)??Fe[0],l=Fe.filter(d=>d.group!=="learn-bpmn"),m=Fe.filter(d=>d.group==="learn-bpmn"),u=d=>{Wn(Hn(d),{hash:location.hash})},o=a.jsxs(a.Fragment,{children:[!n&&e.kind==="gallery"&&a.jsxs(a.Fragment,{children:[a.jsx("nav",{className:"example-picker",children:l.map(d=>a.jsx(Q,{size:"sm",variant:d.id===s.id?"default":"secondary",onClick:()=>u(d.id),children:d.title},d.id))}),m.length>0&&a.jsxs(a.Fragment,{children:[a.jsx("h2",{className:"example-group-heading",children:"Learn BPMN"}),a.jsx("nav",{className:"example-picker",children:m.map(d=>a.jsx(Q,{size:"sm",variant:d.id===s.id?"default":"secondary",onClick:()=>u(d.id),children:d.title},d.id))})]})]}),!n&&e.kind==="example"&&a.jsx("div",{className:"example-nav",children:a.jsx(Q,{size:"sm",variant:"secondary",onClick:()=>Wn(Ds()),children:"← All examples"})}),a.jsxs("div",{className:"example-meta",children:[s.docsUrl&&a.jsx("a",{className:"docs-link",href:s.docsUrl,target:"_blank",rel:"noreferrer noopener",children:"View on camunda.com ↗"}),n&&a.jsx("a",{className:"open-full-page",href:Hn(s.id)+(location.hash||""),target:"_top",rel:"noreferrer",children:"Open full page ↗"})]}),a.jsx(qi,{example:s,initialBrainKind:t,initialTourId:r},s.id)]});return n?a.jsx("div",{className:"c4-ui app-shell app-embed",children:a.jsx("main",{id:"main",className:"layout layout-embed",children:o})}):a.jsxs("div",{className:"c4-ui app-shell",children:[a.jsx(Vt,{appName:"Runnable Camunda examples",trailing:a.jsx("span",{className:"app-subtitle",children:"model + code + optional LLM, in your browser"})}),a.jsx("main",{id:"main",className:"layout",children:o})]})}Lt.createRoot(document.getElementById("root")).render(a.jsx(h.StrictMode,{children:a.jsx(Yt,{children:a.jsx(zs,{})})}));export{le as _,$s as c};
