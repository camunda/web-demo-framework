const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/driver-CTZuBZOi.css","assets/diagram-js-DAKGYcfb.css","assets/bpmn-embedded-CxxwVM79.css","assets/vendor-bpmn-BcmhqIZQ.js","assets/vendor-react-WnIiAG2f.js","assets/NavigatedViewer-CmIohCIa.js","assets/vendor-design-system-CEXqimSF.js","assets/vendor-design-system-Dc2PGMq8.css","assets/MonacoEditor-dS2hfTmK.js","assets/MonacoEditor-CyV2ms1L.css","assets/vendor-modeler-BXeRxtyZ.js","assets/parser-Cn7g5BiQ.js","assets/ModelEditor-Dwlgp6JA.css","assets/FormRenderer-qa0JKhGZ.js","assets/FormRenderer-D1JIHOW6.css"])))=>i.map(i=>d[i]);
var et=Object.defineProperty;var nt=(e,n,t)=>n in e?et(e,n,{enumerable:!0,configurable:!0,writable:!0,value:t}):e[n]=t;var G=(e,n,t)=>nt(e,typeof n!="symbol"?n+"":n,t);import{r as h,j as s,i as tt}from"./vendor-react-WnIiAG2f.js";import{B as Z,a as K,L as Ee,S as rt,b as it,c as ot,d as st,e as at,A as le,f as de,g as ue,I as Ue,C as ie,h as oe,i as se,j as ae,k as ce,l as ct,T as lt,m as dt,n as De,o as Ae,p as ut,q as mt}from"./vendor-design-system-CEXqimSF.js";(function(){const n=document.createElement("link").relList;if(n&&n.supports&&n.supports("modulepreload"))return;for(const i of document.querySelectorAll('link[rel="modulepreload"]'))r(i);new MutationObserver(i=>{for(const a of i)if(a.type==="childList")for(const c of a.addedNodes)c.tagName==="LINK"&&c.rel==="modulepreload"&&r(c)}).observe(document,{childList:!0,subtree:!0});function t(i){const a={};return i.integrity&&(a.integrity=i.integrity),i.referrerPolicy&&(a.referrerPolicy=i.referrerPolicy),i.crossOrigin==="use-credentials"?a.credentials="include":i.crossOrigin==="anonymous"?a.credentials="omit":a.credentials="same-origin",a}function r(i){if(i.ep)return;i.ep=!0;const a=t(i);fetch(i.href,a)}})();const pt="modulepreload",gt=function(e){return"/pr-preview/pr-61/"+e},hn={},ne=function(n,t,r){let i=Promise.resolve();if(t&&t.length>0){let c=function(o){return Promise.all(o.map(l=>Promise.resolve(l).then(g=>({status:"fulfilled",value:g}),g=>({status:"rejected",reason:g}))))};document.getElementsByTagName("link");const d=document.querySelector("meta[property=csp-nonce]"),m=(d==null?void 0:d.nonce)||(d==null?void 0:d.getAttribute("nonce"));i=c(t.map(o=>{if(o=gt(o),o in hn)return;hn[o]=!0;const l=o.endsWith(".css"),g=l?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${o}"]${g}`))return;const p=document.createElement("link");if(p.rel=l?"stylesheet":pt,l||(p.as="script"),p.crossOrigin="",p.href=o,m&&p.setAttribute("nonce",m),document.head.appendChild(p),l)return new Promise((f,b)=>{p.addEventListener("load",f),p.addEventListener("error",()=>b(new Error(`Unable to preload CSS for ${o}`)))})}))}function a(c){const d=new Event("vite:preloadError",{cancelable:!0});if(d.payload=c,window.dispatchEvent(d),!d.defaultPrevented)throw c}return i.then(c=>{for(const d of c||[])d.status==="rejected"&&a(d.reason);return n().catch(a)})},ht="io.camunda.agenticai:aiagent",Me="http://www.omg.org/spec/BPMN/20100524/MODEL",bt="http://camunda.org/schema/zeebe/1.0";function Ve(e,n){return Array.from(e.getElementsByTagNameNS(bt,n))}function Cn(e,n){return Ve(e,n).filter(t=>ft(t)===e)}function ft(e){let n=e.parentElement;for(;n;){if(n.namespaceURI===Me&&n.localName!=="extensionElements")return n;n=n.parentElement}return null}function Xe(e){const n=Cn(e,"taskDefinition")[0],t=n==null?void 0:n.getAttribute("type");return t||(e.localName==="scriptTask"?e.getAttribute("id")??null:null)}function yt(e){const n=Array.from(e.children).find(t=>t.namespaceURI===Me&&t.localName==="documentation");return((n==null?void 0:n.textContent)??"").trim()}function bn(e){if(!e)return"";const n=e.startsWith("=")?e.slice(1):e,t=n.match(/"((?:[^"\\]|\\.)*)"/g);return t?t.map(r=>r.slice(1,-1).replace(/\\n/g,`
...
`).replace(/\\"/g,'"').replace(/&quot;/g,'"').replace(/&#39;/g,"'").trim(),type:a[3]??"string"}))}return r}function _t(e){const n={};for(const t of Cn(e,"input")){const r=t.getAttribute("target");r&&(n[r]=t.getAttribute("source")??"")}return n}function Nt(e){return Array.from(e.getElementsByTagNameNS(Me,"adHocSubProcess")).filter(n=>(Xe(n)??"").startsWith(ht))}function xt(e,n){const t=_t(e),r=Number((t["data.limits.maxModelCalls"]??"").replace(/^=/,""));return{elementId:e.getAttribute("id")??"agent",label:e.getAttribute("name")??"Agent",jobType:Xe(e),systemPrompt:bn(t["data.systemPrompt.prompt"]),userPrompt:bn(t["data.userPrompt.prompt"]),maxModelCalls:Number.isFinite(r)&&r>0?r:10,tools:n}}function vt(e,n){var g;const t=e.getAttribute("id")??"",r=e.getAttribute("name")??t,i=Nt(e);i.length>1&&n.push({severity:"warning",elementId:i.map(p=>p.getAttribute("id")).join(", "),message:`Process "${r}" hosts ${i.length} AI Agent sub-processes (${i.map(p=>p.getAttribute("id")).join(", ")}). Each gets its own independent agent state (turn counter, called tools) — the run itself is shared across hosts, but each host's agent state within it is not.`});const a=[],c=new Map(i.map(p=>[p,[]]));for(const p of Array.from(e.getElementsByTagName("*"))){if(p.namespaceURI!==Me||i.includes(p))continue;const f=Xe(p),b=p.getAttribute("id");if(!f||!b)continue;const N=i.filter(T=>T.contains(p)),v=N.find(T=>N.every(L=>L===T||L.contains(T))),w={elementId:b,label:p.getAttribute("name")??b,jobType:f,documentation:yt(p),isTool:v!=null};a.push(w),v&&c.get(v).push({elementId:b,label:w.label,jobType:f,documentation:w.documentation,args:wt(p)})}const d=i.map(p=>xt(p,c.get(p))),m=Array.from(e.getElementsByTagNameNS(Me,"userTask")).map(p=>{var f;return{elementId:p.getAttribute("id")??"",label:p.getAttribute("name")??p.getAttribute("id")??"",formId:((f=Ve(p,"formDefinition")[0])==null?void 0:f.getAttribute("formId"))??void 0}}),o=e.getElementsByTagNameNS(Me,"startEvent")[0],l=o?((g=Ve(o,"formDefinition")[0])==null?void 0:g.getAttribute("formId"))??void 0:void 0;return{processId:t,processName:r,tasks:a,agents:d,userTasks:m,startFormId:l}}function It(e,n={}){const t=new DOMParser().parseFromString(e,"application/xml"),r=t.getElementsByTagName("parsererror")[0];if(r)throw new Error(`Invalid BPMN XML: ${r.textContent}`);const i=Array.from(t.getElementsByTagNameNS(Me,"process"));if(i.length===0)throw new Error("No <bpmn:process> in the diagram.");const a=[],c=i.map(m=>vt(m,a));let d=n.processId?c.find(m=>m.processId===n.processId):void 0;return n.processId&&!d&&a.push({severity:"warning",message:`Requested process "${n.processId}" not found — falling back to "${c[0].processId}".`}),d??(d=c[0]),c.length>1&&a.push({severity:"warning",message:`Diagram has ${c.length} <bpmn:process> elements (${c.map(m=>m.processId).join(", ")}); using "${d.processId}" as the active process. Pass a processId to parseModel to target another.`}),{processes:c,diagnostics:a,processId:d.processId,processName:d.processName,tasks:d.tasks,agent:d.agents[0]??null,agents:c.flatMap(m=>m.agents),userTasks:d.userTasks,startFormId:d.startFormId}}function Tt(){return`<!doctype html><html><head><meta charset="utf-8"></head><body><script>
    ...
    post({ kind: "ready" });
  <\/script></body></html>`}function zn(e,n={}){const{timeoutMs:t=5e3,onTrace:r}=n,i=`${Date.now()}-${Math.random().toString(36).slice(2)}`;return new Promise((a,c)=>{const d=document.createElement("iframe");d.setAttribute("sandbox","allow-scripts"),d.style.display="none",d.setAttribute("aria-hidden","true");let m=!1,o;const l=()=>{o&&clearTimeout(o),window.removeEventListener("message",p),d.remove()},g=f=>{m||(m=!0,l(),f())};function p(f){var N;if(f.source!==d.contentWindow)return;const b=f.data;if(!(!b||typeof b!="object")){if(b.kind==="ready"){const v=e.job,w=e.kind==="run-handler"?{kind:"run-handler",id:i,source:e.source,job:v}:{kind:"run-agent",id:i,source:e.source,job:v};(N=d.contentWindow)==null||N.postMessage(w,"*");return}"id"in b&&b.id!==i||(b.kind==="trace"?r==null||r(b.text):b.kind==="result"?g(()=>a(b.value)):b.kind==="error"&&g(()=>c(new Error(b.message))))}}window.addEventListener("message",p),o=setTimeout(()=>{g(()=>c(new Error(`Handler timed out after ${t}ms — the sandboxed run was terminated.`)))},t),d.srcdoc=Tt(),document.body.appendChild(d)})}function Pn(e){return{key:e.key,type:e.type,elementId:e.elementId,instanceKey:e.instanceKey,variables:e.variables??{}}}function jt(e,n,t){return zn({kind:"run-handler",source:e,job:Pn(n)},{onTrace:t.trace})}function kt(e,n){return zn({kind:"run-agent",source:e,job:Pn(n)})}function On(e,n){try{new Function(`"use strict"; return (${e});`)}catch{throw new Error(`${n} has a syntax error.`)}}function Et(e){return On(e,"Handler code"),(n,t)=>jt(e,n,t)}function Dt(e){return On(e,"Agent code"),n=>kt(e,n)}function At(e,n,t){return{sleep:r=>new Promise(i=>setTimeout(i,r)),trace:r=>n({kind:"tool",text:`   ${r}`,elementId:e.elementId,turn:t}),text:(r,i="")=>{const a=e.variables[r];return typeof a=="string"?a:a==null?i:String(a)},num:(r,i=0)=>{const a=e.variables[r],c=typeof a=="number"?a:Number(a);return Number.isFinite(c)?c:i}}}function St(e){if(e===void 0)return"undefined";try{return JSON.stringify(e)}catch{return"[unserializable value]"}}function Lt(e,n,t,r){const i={},a=e.processes.flatMap(d=>d.tasks),c=new Map(a.map(d=>[d.elementId,d.label]));for(const d of a)i[d.jobType]||(i[d.jobType]=async m=>{const o=n[m.elementId];if(!o)throw new Error(`No handler registered for ${m.elementId} (job type ${m.type})`);const l=c.get(m.elementId)??m.elementId,g=r==null?void 0:r.current;t({kind:"tool",text:`▶ ${l}`,elementId:m.elementId,turn:g});const p=await o(m,At(m,t,g));return t({kind:"vars",text:`  ↳ ${St(p)}`,elementId:m.elementId,result:p,turn:g}),p});return i}const Ct=/\{\{\s*([A-Za-z][A-Za-z0-9_-]*)\s*\}\}/g;function Oe(...e){const n=Object.create(null);for(const t of e)if(t)for(const r of Object.keys(t))n[r]=t[r];return n}function zt(e){return(e.split("/").pop()??e).replace(/\.[^./]+$/,"")}function Bn(e){return e.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;")}function Pt(e){return Bn(e).replace(/"/g,"&quot;").replace(/\n/g,"&#10;").replace(/\t/g,"&#9;")}function Ot(e){return e.replace(/\\/g,"\\\\").replace(/&/g,"&amp;").replace(/"/g,"\\&#34;").replace(/\n/g,"&#10;").replace(/\t/g,"&#9;").replace(/</g,"&lt;").replace(/>/g,"&gt;")}function Bt(e){return JSON.stringify(e).slice(1,-1)}function Rt(e,n){const t=e.lastIndexOf("<",n),r=e.lastIndexOf(">",n);if(t<=r)return"text";const i=e.slice(t,n);if((i.match(/"/g)??[]).length%2===0)return"text";const c=i.lastIndexOf('"');return(i.slice(c+1).match(/&#34;|&quot;/g)??[]).length%2===1?"feel-literal":"attribute"}function Ut(e,n,t="xml"){const r=[],i=new Set;return{result:e.replace(Ct,(c,d,m)=>{const o=d.trim();if(!Object.prototype.hasOwnProperty.call(n,o))return i.has(o)||(i.add(o),r.push(o)),c;const l=n[o];if(t==="json")return Bt(l);const g=Rt(e,m);return g==="feel-literal"?Ot(l):g==="attribute"?Pt(l):Bn(l)}),unresolved:r}}function Ft(){return{processes:[],diagnostics:[],processId:"",processName:"",tasks:[],agent:null,agents:[],userTasks:[],startFormId:void 0}}function Yt(e,n={},t=e.bpmn,r={}){const i=[],a=Oe(e.templates,r),{result:c,unresolved:d}=Ut(t,a,"xml");for(const w of d)i.push({severity:"warning",message:`Template placeholder "{{${w}}}" has no matching prompt/template content — left in the model as-is, not substituted.`});let m;try{m=It(c)}catch(w){return i.push({severity:"error",message:w instanceof Error?w.message:String(w)}),{resolvedBpmn:c,model:Ft(),handlers:{},forms:{},diagnostics:i,hasErrors:!0}}i.push(...m.diagnostics);const o=m.processes.flatMap(w=>w.tasks),l=new Map(e.handlers.map(w=>[w.elementId,w.source])),g={};for(const w of o){const T=n[w.elementId]??l.get(w.elementId);if(T===void 0){i.push({severity:"error",elementId:w.elementId,jobType:w.jobType,message:`No handler for "${w.label}" (${w.elementId}, job type "${w.jobType}"). Add a handler for this element, or remove it from the diagram.`});continue}try{g[w.elementId]=Et(T)}catch(L){i.push({severity:"error",elementId:w.elementId,jobType:w.jobType,message:`"${w.label}" (${w.elementId}): handler code didn't compile — ${L instanceof Error?L.message:String(L)}`})}}const p=new Set(o.map(w=>w.elementId)),f=new Set([...l.keys(),...Object.keys(n)]);for(const w of f)p.has(w)||i.push({severity:"error",elementId:w,message:`Handler "${w}" doesn't match any element in the current diagram — likely orphaned by a rename. Rename it back, or remove the handler.`});const b={},N=e.forms??{},v=(w,T)=>{if(!w)return;const L=N[w];L?b[w]=L:i.push({severity:"error",formId:w,message:`${T} references form "${w}", which has no matching schema.`})};for(const w of m.processes){v(w.startFormId,`The start event of process "${w.processName}"`);for(const T of w.userTasks)v(T.formId,`User task "${T.label}" (${T.elementId})`)}return{resolvedBpmn:c,model:m,handlers:g,forms:b,diagnostics:i,hasErrors:i.some(w=>w.severity==="error")}}function Qt(e){const n=e.indexOf("{");if(n<0)return null;let t=0;for(let r=n;r<e.length;r++)if(e[r]==="{")t++;else if(e[r]==="}"&&(t--,t===0))try{const i=JSON.parse(e.slice(n,r+1));return typeof i=="object"&&i!==null&&!Array.isArray(i)?i:null}catch{return null}return null}function He(e,n=220){const t=e.replace(/\s+/g," ").trim();return t.length>n?`${t.slice(0,n-1)}…`:t}function fn(e){const n=e.arguments??e.args??e.parameters??e.input;return n&&typeof n=="object"&&!Array.isArray(n)?n:{}}function yn(e){if(!e)return[];const n=e.tool??e.name??e.action;if(typeof n=="string"&&n.trim())return[{name:n.trim(),args:fn(e)}];const t=e.tools??e.tool_calls??e.toolset??e.actions,r=Array.isArray(t)?t:Object.values(e).find(a=>Array.isArray(a))??[],i=[];for(const a of r)if(typeof a=="string")a.trim()&&i.push({name:a.trim(),args:{}});else if(a&&typeof a=="object"){const c=a,d=c.name??c.tool??c.id??c.function;typeof d=="string"&&d.trim()&&i.push({name:d.trim(),args:fn(c)})}return i}function $t(e){if(!e)return!1;const n=e.done??e.finished??e.complete;return typeof n=="boolean"?n:typeof n=="string"?n.toLowerCase()==="true":!1}function Mn(e){const n=e.args.length?e.args.map(r=>`      ${r.name} (${r.type}) — ${r.description}`).join(`
