const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/driver-CTZuBZOi.css","assets/diagram-js-DAKGYcfb.css","assets/bpmn-embedded-CwEfBsME.css","assets/RuntimeDiagram-TkhX9hgj.js","assets/vendor-react-9Ma26nY1.js","assets/Viewer-C9mDhiH1.js","assets/MonacoEditor-Dg0fT75B.js","assets/MonacoEditor-BRcOEFf8.css","assets/vendor-modeler-A-iMHHCr.js","assets/vendor-design-system-CNbe2PY3.js","assets/vendor-design-system-Ckk03-Xm.css","assets/parser-DkgAe_kI.js","assets/ModelEditor-Dwlgp6JA.css","assets/FormRenderer-NxSOHgJ4.js","assets/FormRenderer-D1JIHOW6.css"])))=>i.map(i=>d[i]);
var Lt=Object.defineProperty;var Pt=(e,n,t)=>n in e?Lt(e,n,{enumerable:!0,configurable:!0,writable:!0,value:t}):e[n]=t;var O=(e,n,t)=>Pt(e,typeof n!="symbol"?n+"":n,t);import{r as b,j as i,i as Rt}from"./vendor-react-9Ma26nY1.js";import{B as H,a as q,L as Fe,S as _n,b as Mn,c as vn,d as xn,e as Nn,A as le,f as ce,g as de,I as Rn,C as zt,h as Bt,i as Ot,j as Ft,k as Ut,l as $t,T as Yt,m as Gt,n as Xe,o as en,p as Vt,q as Qt}from"./vendor-design-system-CNbe2PY3.js";(function(){const n=document.createElement("link").relList;if(n&&n.supports&&n.supports("modulepreload"))return;for(const o of document.querySelectorAll('link[rel="modulepreload"]'))r(o);new MutationObserver(o=>{for(const a of o)if(a.type==="childList")for(const l of a.addedNodes)l.tagName==="LINK"&&l.rel==="modulepreload"&&r(l)}).observe(document,{childList:!0,subtree:!0});function t(o){const a={};return o.integrity&&(a.integrity=o.integrity),o.referrerPolicy&&(a.referrerPolicy=o.referrerPolicy),o.crossOrigin==="use-credentials"?a.credentials="include":o.crossOrigin==="anonymous"?a.credentials="omit":a.credentials="same-origin",a}function r(o){if(o.ep)return;o.ep=!0;const a=t(o);fetch(o.href,a)}})();const Jt="modulepreload",Ht=function(e){return"/pr-preview/pr-62/"+e},zn={},me=function(n,t,r){let o=Promise.resolve();if(t&&t.length>0){let l=function(s){return Promise.all(s.map(c=>Promise.resolve(c).then(h=>({status:"fulfilled",value:h}),h=>({status:"rejected",reason:h}))))};document.getElementsByTagName("link");const u=document.querySelector("meta[property=csp-nonce]"),m=(u==null?void 0:u.nonce)||(u==null?void 0:u.getAttribute("nonce"));o=l(t.map(s=>{if(s=Ht(s),s in zn)return;zn[s]=!0;const c=s.endsWith(".css"),h=c?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${s}"]${h}`))return;const p=document.createElement("link");if(p.rel=c?"stylesheet":Jt,c||(p.as="script"),p.crossOrigin="",p.href=s,m&&p.setAttribute("nonce",m),document.head.appendChild(p),c)return new Promise((g,f)=>{p.addEventListener("load",g),p.addEventListener("error",()=>f(new Error(`Unable to preload CSS for ${s}`)))})}))}function a(l){const u=new Event("vite:preloadError",{cancelable:!0});if(u.payload=l,window.dispatchEvent(u),!u.defaultPrevented)throw l}return o.then(l=>{for(const u of l||[])u.status==="rejected"&&a(u.reason);return n().catch(a)})},Wt="io.camunda.agenticai:aiagent",Ie="http://www.omg.org/spec/BPMN/20100524/MODEL",Zt="http://camunda.org/schema/zeebe/1.0";function In(e,n){return Array.from(e.getElementsByTagNameNS(Zt,n))}function dt(e,n){return In(e,n).filter(t=>qt(t)===e)}function qt(e){let n=e.parentElement;for(;n;){if(n.namespaceURI===Ie&&n.localName!=="extensionElements")return n;n=n.parentElement}return null}function An(e){const n=dt(e,"taskDefinition")[0],t=n==null?void 0:n.getAttribute("type");return t||(e.localName==="scriptTask"?e.getAttribute("id")??null:null)}function Bn(e){const n=Array.from(e.children).find(t=>t.namespaceURI===Ie&&t.localName==="documentation");return((n==null?void 0:n.textContent)??"").trim()}function On(e){if(!e)return"";const n=e.startsWith("=")?e.slice(1):e,t=n.match(/"((?:[^"\\]|\\.)*)"/g);return t?t.map(r=>r.slice(1,-1).replace(/\\n/g,`
...
character, with nothing added. When your work is finished, reply exactly
{"done": true} and no tool.`}function Ar(e,n,t,r,o=[],a=[],l=!1){const u=e.userPrompt||"Carry out your task.",m=Object.entries(n).filter(([,c])=>typeof c=="string"&&c.trim().length>0).map(([c,h])=>`  ${c}: ${String(h)}`),s=[u,m.length?`Case data:
${m.join(`
...
`)}async function Cr(e,n,t,r,o,a){let l="";n({kind:"llm",text:"LLM thinking…",key:t,pending:!0,turn:a});const u=await e(r,o,m=>{l+=m,n({kind:"llm",text:`${kn(l)} ▍`,key:t,pending:!0,turn:a})});return n({kind:"llm",text:kn(u||l)||"(empty reply)",key:t,pending:!1,turn:a}),u}function Dr(e,n){switch(e){case"number":return typeof n=="number"&&Number.isFinite(n)?{ok:!0,value:n}:typeof n=="string"&&n.trim()!==""&&Number.isFinite(Number(n))?{ok:!0,value:Number(n)}:{ok:!1};case"boolean":return typeof n=="boolean"?{ok:!0,value:n}:typeof n=="string"&&/^(true|false)$/i.test(n.trim())?{ok:!0,value:n.trim().toLowerCase()==="true"}:{ok:!1};default:return typeof n=="object"?{ok:!1}:{ok:!0,value:String(n)}}}function Lr(e,n,t){const r={},o=new Map,a=new Map;for(const{tool:l,args:u}of e){const m={};for(const s of l.args){const c=u[s.name];if(!(c!=null&&c!=="")){n({kind:"error",text:`🤖 ${l.elementId}: model supplied no value for "${s.name}"`,turn:t,elementId:l.elementId});continue}const p=o.get(s.name);if(p!==void 0&&p!==l.elementId){n({kind:"error",text:`🤖 argument name collision on "${s.name}": both ${p} and ${l.elementId} declare it — ${p} already claimed it this turn, ${l.elementId}'s value is dropped`,turn:t,elementId:l.elementId});continue}const g=Dr(s.type,c);if(!g.ok){n({kind:"error",text:`🤖 ${l.elementId}: "${s.name}" is declared as ${s.type} but the model supplied ${JSON.stringify(c)} — rejected, not passed through`,turn:t,elementId:l.elementId});continue}r[s.name]=g.value,m[s.name]=g.value,o.set(s.name,l.elementId)}a.set(l.elementId,m)}return{variablesOut:r,forHistory:a}}function Pr(e,n,t,r={}){const{maxNewTokens:o=384,allowRepeats:a=!1,allowMultiToolTurns:l=!1,turnRef:u,requiredTools:m=[],maxEarlyDoneNudges:s=1}=r;let c=0;const h=new Set,p=[];let g=0,f=[],_=[];return async y=>{const M=y.variables,I=M.toolCallResult;for(I!==void 0&&p.length&&(p[p.length-1]=`${p[p.length-1]} → ${kn(JSON.stringify(I),160)}`);;){const G=await D();if(G)return G}async function D(){if(c+=1,u&&(u.current=c),c>e.maxModelCalls)return t({kind:"error",text:`Turn budget spent (maxModelCalls=${e.maxModelCalls}) — completing the agent.`,turn:c}),{completionConditionFulfilled:!0};const G=a?e.tools:e.tools.filter(C=>!h.has(C.elementId)),W=[{role:"system",content:Sr(e,l,G)},{role:"user",content:Ar(e,M,p,G,f,_,a)}];f=[],_=[];let ae;try{ae=await Cr(n,t,`llm-turn-${c}`,W,o,c)}catch(C){return t({kind:"error",text:`LLM call failed: ${C instanceof Error?C.message:String(C)} — completing the agent.`,turn:c}),{completionConditionFulfilled:!0}}const Z=Tr(ae);if(jr(Z)&&$n(Z).length===0){const C=m.filter(pe=>!h.has(pe));return C.length&&g<s?(g+=1,f=C,t({kind:"agent",text:`🤖 model says it is done, but ${C.join(", ")} hasn't run — asking once more`,turn:c}),null):(t({kind:"agent",text:"🤖 model says it is done",turn:c}),{completionConditionFulfilled:!0})}const te=$n(Z);if(te.length===0)return t({kind:"error",text:"🤖 model named no tool (and didn't say it was done) — asking again",turn:c}),_=['it named no tool and did not say it was done — reply with {"tool": "...", "arguments": {...}} or {"done": true}'],null;const U=[],E=[],N=[];for(const C of te){const pe=e.tools.find(K=>K.elementId===C.name);if(!pe){E.push(C.name);continue}if(!a&&h.has(pe.elementId)){N.push(pe.elementId);continue}U.push({tool:pe,args:C.args})}if(E.length&&t({kind:"error",text:`🤖 model named a tool that doesn't exist: ${E.join(", ")} — nothing activated`,turn:c}),N.length&&t({kind:"error",text:`🤖 model asked to re-run ${N.join(", ")} — skipped (already run)`,turn:c}),U.length===0)return t({kind:"agent",text:"🤖 nothing activated — asking again",turn:c}),_=[...E.length?[`${E.join(", ")} ${E.length===1?"is":"are"} not a real tool`]:[],...N.length?[`${N.join(", ")} has already run and will never run again — pick a different tool, or reply {"done": true} if nothing is left to do`]:[]],null;const{variablesOut:A,forHistory:Q}=Lr(U,t,c);for(const{tool:C}of U)h.add(C.elementId),p.push(`- ${C.elementId}(${JSON.stringify(Q.get(C.elementId))})`);for(const{tool:C}of U)t({kind:"agent",text:`🤖 calling ${C.elementId}`,turn:c,elementId:C.elementId,args:Q.get(C.elementId)??{}});return{activateElements:U.map(C=>({elementId:C.tool.elementId})),variables:A}}}}function Rr(e,n,t,r={}){const o=new Map(e.map(a=>[a.elementId,Pr(a,n,t,r)]));return async a=>{const l=o.get(a.elementId);if(!l)throw new Error(`No agent host registered for "${a.elementId}"`);return l(a)}}class En{__destroy_into_raw(){const n=this.__wbg_ptr;return this.__wbg_ptr=0,Gn.unregister(this),n}free(){const n=this.__destroy_into_raw();d.__wbg_testengine_free(n,0)}activateJobs(n,t,r,o){let a,l;try{const g=d.__wbindgen_add_to_stack_pointer(-16),f=S(n,d.__wbindgen_export,d.__wbindgen_export2),_=j,y=S(o,d.__wbindgen_export,d.__wbindgen_export2),M=j;d.testengine_activateJobs(g,this.__wbg_ptr,f,_,t,r,y,M);var u=w().getInt32(g+0,!0),m=w().getInt32(g+4,!0),s=w().getInt32(g+8,!0),c=w().getInt32(g+12,!0),h=u,p=m;if(c)throw h=0,p=0,z(s);return a=h,l=p,R(h,p)}finally{d.__wbindgen_add_to_stack_pointer(16),d.__wbindgen_export3(a,l,1)}}advanceTime(n){let t,r;try{const c=d.__wbindgen_add_to_stack_pointer(-16);d.testengine_advanceTime(c,this.__wbg_ptr,n);var o=w().getInt32(c+0,!0),a=w().getInt32(c+4,!0),l=w().getInt32(c+8,!0),u=w().getInt32(c+12,!0),m=o,s=a;if(u)throw m=0,s=0,z(l);return t=m,r=s,R(m,s)}finally{d.__wbindgen_add_to_stack_pointer(16),d.__wbindgen_export3(t,r,1)}}assignUserTask(n,t,r){let o,a;try{const p=d.__wbindgen_add_to_stack_pointer(-16),g=S(n,d.__wbindgen_export,d.__wbindgen_export2),f=j,_=S(t,d.__wbindgen_export,d.__wbindgen_export2),y=j;d.testengine_assignUserTask(p,this.__wbg_ptr,g,f,_,y,r);var l=w().getInt32(p+0,!0),u=w().getInt32(p+4,!0),m=w().getInt32(p+8,!0),s=w().getInt32(p+12,!0),c=l,h=u;if(s)throw c=0,h=0,z(m);return o=c,a=h,R(c,h)}finally{d.__wbindgen_add_to_stack_pointer(16),d.__wbindgen_export3(o,a,1)}}broadcastSignal(n,t){let r,o;try{const h=d.__wbindgen_add_to_stack_pointer(-16),p=S(n,d.__wbindgen_export,d.__wbindgen_export2),g=j,f=S(t,d.__wbindgen_export,d.__wbindgen_export2),_=j;d.testengine_broadcastSignal(h,this.__wbg_ptr,p,g,f,_);var a=w().getInt32(h+0,!0),l=w().getInt32(h+4,!0),u=w().getInt32(h+8,!0),m=w().getInt32(h+12,!0),s=a,c=l;if(m)throw s=0,c=0,z(u);return r=s,o=c,R(s,c)}finally{d.__wbindgen_add_to_stack_pointer(16),d.__wbindgen_export3(r,o,1)}}cancelInstance(n){let t,r;try{const c=d.__wbindgen_add_to_stack_pointer(-16),h=S(n,d.__wbindgen_export,d.__wbindgen_export2),p=j;d.testengine_cancelInstance(c,this.__wbg_ptr,h,p);var o=w().getInt32(c+0,!0),a=w().getInt32(c+4,!0),l=w().getInt32(c+8,!0),u=w().getInt32(c+12,!0),m=o,s=a;if(u)throw m=0,s=0,z(l);return t=m,r=s,R(m,s)}finally{d.__wbindgen_add_to_stack_pointer(16),d.__wbindgen_export3(t,r,1)}}completeAgentJob(n,t,r){let o,a;try{const p=d.__wbindgen_add_to_stack_pointer(-16),g=S(n,d.__wbindgen_export,d.__wbindgen_export2),f=j,_=S(t,d.__wbindgen_export,d.__wbindgen_export2),y=j,M=S(r,d.__wbindgen_export,d.__wbindgen_export2),I=j;d.testengine_completeAgentJob(p,this.__wbg_ptr,g,f,_,y,M,I);var l=w().getInt32(p+0,!0),u=w().getInt32(p+4,!0),m=w().getInt32(p+8,!0),s=w().getInt32(p+12,!0),c=l,h=u;if(s)throw c=0,h=0,z(m);return o=c,a=h,R(c,h)}finally{d.__wbindgen_add_to_stack_pointer(16),d.__wbindgen_export3(o,a,1)}}completeJob(n,t){let r,o;try{const h=d.__wbindgen_add_to_stack_pointer(-16),p=S(n,d.__wbindgen_export,d.__wbindgen_export2),g=j,f=S(t,d.__wbindgen_export,d.__wbindgen_export2),_=j;d.testengine_completeJob(h,this.__wbg_ptr,p,g,f,_);var a=w().getInt32(h+0,!0),l=w().getInt32(h+4,!0),u=w().getInt32(h+8,!0),m=w().getInt32(h+12,!0),s=a,c=l;if(m)throw s=0,c=0,z(u);return r=s,o=c,R(s,c)}finally{d.__wbindgen_add_to_stack_pointer(16),d.__wbindgen_export3(r,o,1)}}completeUserTask(n,t){let r,o;try{const h=d.__wbindgen_add_to_stack_pointer(-16),p=S(n,d.__wbindgen_export,d.__wbindgen_export2),g=j,f=S(t,d.__wbindgen_export,d.__wbindgen_export2),_=j;d.testengine_completeUserTask(h,this.__wbg_ptr,p,g,f,_);var a=w().getInt32(h+0,!0),l=w().getInt32(h+4,!0),u=w().getInt32(h+8,!0),m=w().getInt32(h+12,!0),s=a,c=l;if(m)throw s=0,c=0,z(u);return r=s,o=c,R(s,c)}finally{d.__wbindgen_add_to_stack_pointer(16),d.__wbindgen_export3(r,o,1)}}correlateMessage(n,t,r){let o,a;try{const p=d.__wbindgen_add_to_stack_pointer(-16),g=S(n,d.__wbindgen_export,d.__wbindgen_export2),f=j,_=S(t,d.__wbindgen_export,d.__wbindgen_export2),y=j,M=S(r,d.__wbindgen_export,d.__wbindgen_export2),I=j;d.testengine_correlateMessage(p,this.__wbg_ptr,g,f,_,y,M,I);var l=w().getInt32(p+0,!0),u=w().getInt32(p+4,!0),m=w().getInt32(p+8,!0),s=w().getInt32(p+12,!0),c=l,h=u;if(s)throw c=0,h=0,z(m);return o=c,a=h,R(c,h)}finally{d.__wbindgen_add_to_stack_pointer(16),d.__wbindgen_export3(o,a,1)}}createInstance(n,t,r){let o,a;try{const p=d.__wbindgen_add_to_stack_pointer(-16),g=S(n,d.__wbindgen_export,d.__wbindgen_export2),f=j,_=S(t,d.__wbindgen_export,d.__wbindgen_export2),y=j;d.testengine_createInstance(p,this.__wbg_ptr,g,f,_,y,Ur(r)?Number.MAX_SAFE_INTEGER:r>>0);var l=w().getInt32(p+0,!0),u=w().getInt32(p+4,!0),m=w().getInt32(p+8,!0),s=w().getInt32(p+12,!0),c=l,h=u;if(s)throw c=0,h=0,z(m);return o=c,a=h,R(c,h)}finally{d.__wbindgen_add_to_stack_pointer(16),d.__wbindgen_export3(o,a,1)}}debugClear(){d.testengine_debugClear(this.__wbg_ptr)}debugCreateInstance(n,t,r){let o,a;try{const p=d.__wbindgen_add_to_stack_pointer(-16),g=S(n,d.__wbindgen_export,d.__wbindgen_export2),f=j,_=S(t,d.__wbindgen_export,d.__wbindgen_export2),y=j,M=S(r,d.__wbindgen_export,d.__wbindgen_export2),I=j;d.testengine_debugCreateInstance(p,this.__wbg_ptr,g,f,_,y,M,I);var l=w().getInt32(p+0,!0),u=w().getInt32(p+4,!0),m=w().getInt32(p+8,!0),s=w().getInt32(p+12,!0),c=l,h=u;if(s)throw c=0,h=0,z(m);return o=c,a=h,R(c,h)}finally{d.__wbindgen_add_to_stack_pointer(16),d.__wbindgen_export3(o,a,1)}}get debugIsPaused(){return d.testengine_debugIsPaused(this.__wbg_ptr)!==0}debugResume(){let n,t;try{const s=d.__wbindgen_add_to_stack_pointer(-16);d.testengine_debugResume(s,this.__wbg_ptr);var r=w().getInt32(s+0,!0),o=w().getInt32(s+4,!0),a=w().getInt32(s+8,!0),l=w().getInt32(s+12,!0),u=r,m=o;if(l)throw u=0,m=0,z(a);return n=u,t=m,R(u,m)}finally{d.__wbindgen_add_to_stack_pointer(16),d.__wbindgen_export3(n,t,1)}}debugStep(){let n,t;try{const s=d.__wbindgen_add_to_stack_pointer(-16);d.testengine_debugStep(s,this.__wbg_ptr);var r=w().getInt32(s+0,!0),o=w().getInt32(s+4,!0),a=w().getInt32(s+8,!0),l=w().getInt32(s+12,!0),u=r,m=o;if(l)throw u=0,m=0,z(a);return n=u,t=m,R(u,m)}finally{d.__wbindgen_add_to_stack_pointer(16),d.__wbindgen_export3(n,t,1)}}deploy(n){let t,r;try{const c=d.__wbindgen_add_to_stack_pointer(-16),h=S(n,d.__wbindgen_export,d.__wbindgen_export2),p=j;d.testengine_deploy(c,this.__wbg_ptr,h,p);var o=w().getInt32(c+0,!0),a=w().getInt32(c+4,!0),l=w().getInt32(c+8,!0),u=w().getInt32(c+12,!0),m=o,s=a;if(u)throw m=0,s=0,z(l);return t=m,r=s,R(m,s)}finally{d.__wbindgen_add_to_stack_pointer(16),d.__wbindgen_export3(t,r,1)}}deployForm(n){let t,r;try{const c=d.__wbindgen_add_to_stack_pointer(-16),h=S(n,d.__wbindgen_export,d.__wbindgen_export2),p=j;d.testengine_deployForm(c,this.__wbg_ptr,h,p);var o=w().getInt32(c+0,!0),a=w().getInt32(c+4,!0),l=w().getInt32(c+8,!0),u=w().getInt32(c+12,!0),m=o,s=a;if(u)throw m=0,s=0,z(l);return t=m,r=s,R(m,s)}finally{d.__wbindgen_add_to_stack_pointer(16),d.__wbindgen_export3(t,r,1)}}deployResource(n,t){let r,o;try{const h=d.__wbindgen_add_to_stack_pointer(-16),p=S(n,d.__wbindgen_export,d.__wbindgen_export2),g=j,f=S(t,d.__wbindgen_export,d.__wbindgen_export2),_=j;d.testengine_deployResource(h,this.__wbg_ptr,p,g,f,_);var a=w().getInt32(h+0,!0),l=w().getInt32(h+4,!0),u=w().getInt32(h+8,!0),m=w().getInt32(h+12,!0),s=a,c=l;if(m)throw s=0,c=0,z(u);return r=s,o=c,R(s,c)}finally{d.__wbindgen_add_to_stack_pointer(16),d.__wbindgen_export3(r,o,1)}}events(){let n,t;try{const s=d.__wbindgen_add_to_stack_pointer(-16);d.testengine_events(s,this.__wbg_ptr);var r=w().getInt32(s+0,!0),o=w().getInt32(s+4,!0),a=w().getInt32(s+8,!0),l=w().getInt32(s+12,!0),u=r,m=o;if(l)throw u=0,m=0,z(a);return n=u,t=m,R(u,m)}finally{d.__wbindgen_add_to_stack_pointer(16),d.__wbindgen_export3(n,t,1)}}failJob(n,t,r){let o,a;try{const p=d.__wbindgen_add_to_stack_pointer(-16),g=S(n,d.__wbindgen_export,d.__wbindgen_export2),f=j,_=S(r,d.__wbindgen_export,d.__wbindgen_export2),y=j;d.testengine_failJob(p,this.__wbg_ptr,g,f,t,_,y);var l=w().getInt32(p+0,!0),u=w().getInt32(p+4,!0),m=w().getInt32(p+8,!0),s=w().getInt32(p+12,!0),c=l,h=u;if(s)throw c=0,h=0,z(m);return o=c,a=h,R(c,h)}finally{d.__wbindgen_add_to_stack_pointer(16),d.__wbindgen_export3(o,a,1)}}migrate(n,t,r){let o,a;try{const p=d.__wbindgen_add_to_stack_pointer(-16),g=S(n,d.__wbindgen_export,d.__wbindgen_export2),f=j,_=S(t,d.__wbindgen_export,d.__wbindgen_export2),y=j,M=S(r,d.__wbindgen_export,d.__wbindgen_export2),I=j;d.testengine_migrate(p,this.__wbg_ptr,g,f,_,y,M,I);var l=w().getInt32(p+0,!0),u=w().getInt32(p+4,!0),m=w().getInt32(p+8,!0),s=w().getInt32(p+12,!0),c=l,h=u;if(s)throw c=0,h=0,z(m);return o=c,a=h,R(c,h)}finally{d.__wbindgen_add_to_stack_pointer(16),d.__wbindgen_export3(o,a,1)}}modify(n,t,r){let o,a;try{const p=d.__wbindgen_add_to_stack_pointer(-16),g=S(n,d.__wbindgen_export,d.__wbindgen_export2),f=j,_=S(t,d.__wbindgen_export,d.__wbindgen_export2),y=j,M=S(r,d.__wbindgen_export,d.__wbindgen_export2),I=j;d.testengine_modify(p,this.__wbg_ptr,g,f,_,y,M,I);var l=w().getInt32(p+0,!0),u=w().getInt32(p+4,!0),m=w().getInt32(p+8,!0),s=w().getInt32(p+12,!0),c=l,h=u;if(s)throw c=0,h=0,z(m);return o=c,a=h,R(c,h)}finally{d.__wbindgen_add_to_stack_pointer(16),d.__wbindgen_export3(o,a,1)}}constructor(){const n=d.testengine_new();return this.__wbg_ptr=n,Gn.register(this,this.__wbg_ptr,this),this}get now(){return d.testengine_now(this.__wbg_ptr)}reset(){d.testengine_reset(this.__wbg_ptr)}resolveIncident(n){let t,r;try{const c=d.__wbindgen_add_to_stack_pointer(-16),h=S(n,d.__wbindgen_export,d.__wbindgen_export2),p=j;d.testengine_resolveIncident(c,this.__wbg_ptr,h,p);var o=w().getInt32(c+0,!0),a=w().getInt32(c+4,!0),l=w().getInt32(c+8,!0),u=w().getInt32(c+12,!0),m=o,s=a;if(u)throw m=0,s=0,z(l);return t=m,r=s,R(m,s)}finally{d.__wbindgen_add_to_stack_pointer(16),d.__wbindgen_export3(t,r,1)}}setVariables(n,t,r){let o,a;try{const p=d.__wbindgen_add_to_stack_pointer(-16),g=S(n,d.__wbindgen_export,d.__wbindgen_export2),f=j,_=S(t,d.__wbindgen_export,d.__wbindgen_export2),y=j;d.testengine_setVariables(p,this.__wbg_ptr,g,f,_,y,r);var l=w().getInt32(p+0,!0),u=w().getInt32(p+4,!0),m=w().getInt32(p+8,!0),s=w().getInt32(p+12,!0),c=l,h=u;if(s)throw c=0,h=0,z(m);return o=c,a=h,R(c,h)}finally{d.__wbindgen_add_to_stack_pointer(16),d.__wbindgen_export3(o,a,1)}}snapshot(){let n,t;try{const s=d.__wbindgen_add_to_stack_pointer(-16);d.testengine_snapshot(s,this.__wbg_ptr);var r=w().getInt32(s+0,!0),o=w().getInt32(s+4,!0),a=w().getInt32(s+8,!0),l=w().getInt32(s+12,!0),u=r,m=o;if(l)throw u=0,m=0,z(a);return n=u,t=m,R(u,m)}finally{d.__wbindgen_add_to_stack_pointer(16),d.__wbindgen_export3(n,t,1)}}throwError(n,t,r){let o,a;try{const p=d.__wbindgen_add_to_stack_pointer(-16),g=S(n,d.__wbindgen_export,d.__wbindgen_export2),f=j,_=S(t,d.__wbindgen_export,d.__wbindgen_export2),y=j,M=S(r,d.__wbindgen_export,d.__wbindgen_export2),I=j;d.testengine_throwError(p,this.__wbg_ptr,g,f,_,y,M,I);var l=w().getInt32(p+0,!0),u=w().getInt32(p+4,!0),m=w().getInt32(p+8,!0),s=w().getInt32(p+12,!0),c=l,h=u;if(s)throw c=0,h=0,z(m);return o=c,a=h,R(c,h)}finally{d.__wbindgen_add_to_stack_pointer(16),d.__wbindgen_export3(o,a,1)}}tickNow(n){let t,r;try{const c=d.__wbindgen_add_to_stack_pointer(-16);d.testengine_tickNow(c,this.__wbg_ptr,n);var o=w().getInt32(c+0,!0),a=w().getInt32(c+4,!0),l=w().getInt32(c+8,!0),u=w().getInt32(c+12,!0),m=o,s=a;if(u)throw m=0,s=0,z(l);return t=m,r=s,R(m,s)}finally{d.__wbindgen_add_to_stack_pointer(16),d.__wbindgen_export3(t,r,1)}}unassignUserTask(n){let t,r;try{const c=d.__wbindgen_add_to_stack_pointer(-16),h=S(n,d.__wbindgen_export,d.__wbindgen_export2),p=j;d.testengine_unassignUserTask(c,this.__wbg_ptr,h,p);var o=w().getInt32(c+0,!0),a=w().getInt32(c+4,!0),l=w().getInt32(c+8,!0),u=w().getInt32(c+12,!0),m=o,s=a;if(u)throw m=0,s=0,z(l);return t=m,r=s,R(m,s)}finally{d.__wbindgen_add_to_stack_pointer(16),d.__wbindgen_export3(t,r,1)}}updateRetries(n,t){let r,o;try{const h=d.__wbindgen_add_to_stack_pointer(-16),p=S(n,d.__wbindgen_export,d.__wbindgen_export2),g=j;d.testengine_updateRetries(h,this.__wbg_ptr,p,g,t);var a=w().getInt32(h+0,!0),l=w().getInt32(h+4,!0),u=w().getInt32(h+8,!0),m=w().getInt32(h+12,!0),s=a,c=l;if(m)throw s=0,c=0,z(u);return r=s,o=c,R(s,c)}finally{d.__wbindgen_add_to_stack_pointer(16),d.__wbindgen_export3(r,o,1)}}updateUserTask(n,t){let r,o;try{const h=d.__wbindgen_add_to_stack_pointer(-16),p=S(n,d.__wbindgen_export,d.__wbindgen_export2),g=j,f=S(t,d.__wbindgen_export,d.__wbindgen_export2),_=j;d.testengine_updateUserTask(h,this.__wbg_ptr,p,g,f,_);var a=w().getInt32(h+0,!0),l=w().getInt32(h+4,!0),u=w().getInt32(h+8,!0),m=w().getInt32(h+12,!0),s=a,c=l;if(m)throw s=0,c=0,z(u);return r=s,o=c,R(s,c)}finally{d.__wbindgen_add_to_stack_pointer(16),d.__wbindgen_export3(r,o,1)}}}Symbol.dispose&&(En.prototype[Symbol.dispose]=En.prototype.free);function zr(){return{__proto__:null,"./nanobpmn_engine_bg.js":{__proto__:null,__wbg___wbindgen_throw_bb96b2010945f0bc:function(n,t){throw new Error(R(n,t))},__wbindgen_cast_0000000000000001:function(n,t){const r=R(n,t);return Br(r)},__wbindgen_object_drop_ref:function(n){z(n)}}}}const Gn=typeof FinalizationRegistry>"u"?{register:()=>{},unregister:()=>{}}:new FinalizationRegistry(e=>d.__wbg_testengine_free(e,1));function Br(e){Je===Ne.length&&Ne.push(Ne.length+1);const n=Je;return Je=Ne[n],Ne[n]=e,n}function Or(e){e<1028||(Ne[e]=Je,Je=e)}let Le=null;function w(){return(Le===null||Le.buffer.detached===!0||Le.buffer.detached===void 0&&Le.buffer!==d.memory.buffer)&&(Le=new DataView(d.memory.buffer)),Le}function R(e,n){return Yr(e>>>0,n)}let Qe=null;function on(){return(Qe===null||Qe.byteLength===0)&&(Qe=new Uint8Array(d.memory.buffer)),Qe}function Fr(e){return Ne[e]}let Ne=new Array(1024).fill(void 0);Ne.push(void 0,null,!0,!1);let Je=Ne.length;function Ur(e){return e==null}function S(e,n,t){if(t===void 0){const u=He.encode(e),m=n(u.length,1)>>>0;return on().subarray(m,m+u.length).set(u),j=u.length,m}let r=e.length,o=n(r,1)>>>0;const a=on();let l=0;for(;l<r;l++){const u=e.charCodeAt(l);if(u>127)break;a[o+l]=u}if(l!==r){l!==0&&(e=e.slice(l)),o=t(o,r,r=l+e.length*3,1)>>>0;const u=on().subarray(o+l,o+r),m=He.encodeInto(e,u);l+=m.written,o=t(o,r,l,1)>>>0}return j=l,o}function z(e){const n=Fr(e);return Or(e),n}let sn=new TextDecoder("utf-8",{ignoreBOM:!0,fatal:!0});sn.decode();const $r=2146435072;let gn=0;function Yr(e,n){return gn+=n,gn>=$r&&(sn=new TextDecoder("utf-8",{ignoreBOM:!0,fatal:!0}),sn.decode(),gn=n),sn.decode(on().subarray(e,e+n))}const He=new TextEncoder;"encodeInto"in He||(He.encodeInto=function(e,n){const t=He.encode(e);return n.set(t),{read:e.length,written:t.length}});let j=0,d;function Gr(e,n){return d=e.exports,Le=null,Qe=null,d}async function Vr(e,n){if(typeof Response=="function"&&e instanceof Response){if(!e.ok)throw new Error(`failed to fetch Wasm: ${e.status} ${e.statusText} fetching '${e.url}'`);if(typeof WebAssembly.instantiateStreaming=="function")try{return await WebAssembly.instantiateStreaming(e,n)}catch(o){if(t(e.type)&&e.headers.get("Content-Type")!=="application/wasm")console.warn("`WebAssembly.instantiateStreaming` failed because your server does not serve Wasm with `application/wasm` MIME type. Falling back to `WebAssembly.instantiate` which is slower. Original error:\n",o);else throw o}const r=await e.arrayBuffer();return await WebAssembly.instantiate(r,n)}else{const r=await WebAssembly.instantiate(e,n);return r instanceof WebAssembly.Instance?{instance:r,module:e}:r}function t(r){switch(r){case"basic":case"cors":case"default":return!0}return!1}}async function Qr(e){if(d!==void 0)return d;e!==void 0&&(Object.getPrototypeOf(e)===Object.prototype?{module_or_path:e}=e:console.warn("using deprecated parameters for the initialization function; pass a single object instead")),e===void 0&&(e=new URL("/pr-preview/pr-62/assets/nanobpmn_engine_bg-DRNrIVE8.wasm",import.meta.url));const n=zr();(typeof e=="string"||typeof Request=="function"&&e instanceof Request||typeof URL=="function"&&e instanceof URL)&&(e=fetch(e));const{instance:t,module:r}=await Vr(await e,n);return Gr(t)}let nn=null;function Jr(e){return nn||(nn=Qr(void 0).then(()=>{}).catch(n=>{throw nn=null,n})),nn}function J(e){return JSON.parse(e)}class Hr{constructor(n){O(this,"engine");this.engine=n}deploy(n){return JSON.parse(this.engine.deploy(n))}createInstance(n,t){return J(this.engine.createInstance(n,t||"{}"))}activateJobs(n,t,r,o){return JSON.parse(this.engine.activateJobs(n,t,r,o))}completeJob(n,t){return J(this.engine.completeJob(n,t||"{}"))}completeAgentJob(n,t){const{variables:r,...o}=t??{};return J(this.engine.completeAgentJob(n,JSON.stringify(r??{}),JSON.stringify(o??{})))}failJob(n,t,r){return J(this.engine.failJob(n,t,r))}throwError(n,t,r){return J(this.engine.throwError(n,t,r))}updateRetries(n,t){return J(this.engine.updateRetries(n,t))}resolveIncident(n){return J(this.engine.resolveIncident(n))}setVariables(n,t,r){return J(this.engine.setVariables(n,t||"{}",r))}broadcastSignal(n,t){return J(this.engine.broadcastSignal(n,t||"{}"))}cancelInstance(n){return J(this.engine.cancelInstance(n))}modify(n,t,r){return J(this.engine.modify(n,JSON.stringify(t??[]),JSON.stringify(r??[])))}completeUserTask(n,t){return J(this.engine.completeUserTask(n,t||"{}"))}assignUserTask(n,t,r){return J(this.engine.assignUserTask(n,t,r))}unassignUserTask(n){return J(this.engine.unassignUserTask(n))}updateUserTask(n,t){return J(this.engine.updateUserTask(n,t||"{}"))}correlateMessage(n,t,r){return J(this.engine.correlateMessage(n,t,r||"{}"))}advanceTime(n){return J(this.engine.advanceTime(n))}reset(){this.engine.reset()}events(){return JSON.parse(this.engine.events())}snapshot(){return J(this.engine.snapshot())}free(){this.engine.free()}}async function Wr(e){return await Jr(),new Hr(new En)}class wt extends Error{constructor(t,r){super(t);O(this,"retries");this.name="JobFailure",this.retries=r==null?void 0:r.retries}}function Zr(e,n=[]){if(e.instances.filter(o=>!o.completed).length===0)return e.totalInstances>0?"completed":"idle";if(e.incidents.length>0)return"incidents";const r=new Set(n);return e.jobs.some(o=>!r.has(o.jobType))?"unhandledJobs":e.userTasks.some(o=>o.state==="Created")?"userTasks":e.timers.length>0?"timers":e.messageSubscriptions.length>0?"messages":e.signalSubscriptions.length>0?"signals":"idle"}function qr(e,n=[]){const t=new Set(n);return[...new Set(e.jobs.map(r=>r.jobType))].filter(r=>!t.has(r)).sort()}async function Kr(e,n,t){let r;try{const o=await n(t);r=JSON.stringify(o??{})}catch(o){const a=o instanceof wt&&o.retries!==void 0?o.retries:Math.max(0,t.retries-1),l=o instanceof Error?o.message:String(o);e.failJob(t.key,a,l);return}e.completeJob(t.key,r)}async function Xr(e,n,t){let r;try{r=await n(t),JSON.stringify(r)}catch(o){const a=o instanceof wt&&o.retries!==void 0?o.retries:Math.max(0,t.retries-1),l=o instanceof Error?o.message:String(o);e.failJob(t.key,a,l);return}e.completeAgentJob(t.key,r)}async function eo(e,n,t={}){const r=t.maxJobsPerActivation??10,o=t.lockTimeoutMs??3e4,a=t.worker??"bojtos",l=t.agents??{};for(const p of Object.keys(l))if(p in n)throw new Error(`dispatchRound: job type "${p}" is registered as both a worker and an agent — register it as exactly one`);const u=[];for(const[p,g]of Object.entries(n))for(const f of e.activateJobs(p,r,o,a))u.push({handler:g,job:f});const m=[];for(const[p,g]of Object.entries(l))for(const f of e.activateJobs(p,r,o,a))m.push({handler:g,job:f});for(const{handler:p,job:g}of u)await Kr(e,p,g);for(const{handler:p,job:g}of m)await Xr(e,p,g);const s=e.snapshot(),c=u.length+m.length;if(c>0)return{snapshot:s,handled:c};const h=[...Object.keys(n),...Object.keys(l)];return{snapshot:s,handled:c,reason:Zr(s,h),unhandled:qr(s,h)}}function no(e){return e.rows!==void 0}function to(e){const n=[];let t=null;for(const r of e)r.turn!==void 0?t&&t.turn===r.turn?t.rows.push(r):(t={turn:r.turn,rows:[r]},n.push(t)):(t=null,n.push(r));return n}function ro(e){return e.map((n,t)=>({...n,id:t}))}function oo({bpmn:e}){const n=b.useRef(null),[t,r]=b.useState("loading"),[o,a]=b.useState(null),[l,u]=b.useState([]),[m,s]=b.useState(null),c=b.useRef(e),h=b.useRef(0),p=b.useRef(new Map),g=b.useCallback((E,N)=>{p.current.set(E,N)},[]),f=b.useCallback(E=>p.current.get(E),[]),_=b.useCallback((E,N)=>{const A=E.deploy(N);return c.current=N,p.current.clear(),u(A.processIds),s(null),a(null),A.processIds},[]);b.useEffect(()=>{let E=!1;return r("loading"),u([]),s(null),a(null),Wr().then(N=>{if(E){N.free();return}try{_(N,e)}catch(A){N.free(),a(String(A)),r("error");return}n.current=N,r("ready")}).catch(N=>{E||(a(String(N)),r("error"))}),()=>{var N;E=!0,(N=n.current)==null||N.free(),n.current=null,p.current.clear()}},[e]);const y=b.useCallback(E=>{const N=n.current;if(!N)return null;try{const A=E(N);return s(A),a(null),A}catch(A){return a(String(A)),null}},[]),M=b.useCallback((E,N)=>y(A=>A.createInstance(E,N)),[y]),I=b.useCallback((E,N)=>y(A=>A.completeUserTask(E,N)),[y]),D=b.useCallback(E=>y(N=>N.advanceTime(E)),[y]);function G(E,N){const[A]=E.activateJobs(N,1,3e4,"manual-control");if(!A)throw new Error(`No waiting job of type "${N}" to resolve.`);return A}const W=b.useCallback((E,N)=>y(A=>{const Q=G(A,E);return A.completeJob(Q.key,N)}),[y]),ae=b.useCallback((E,N,A)=>y(Q=>{const C=G(Q,E);return Q.throwError(C.key,N,A)}),[y]),Z=b.useCallback(async(E,N)=>{const A=n.current;if(!A)return null;const Q=h.current;try{const C=await eo(A,E,N);return n.current!==A||h.current!==Q?null:(s(C.snapshot),a(null),C)}catch(C){return n.current!==A||h.current!==Q||(s(A.snapshot()),a(String(C))),null}},[]),te=b.useCallback(()=>{const E=n.current;if(E){h.current++;try{E.reset(),_(E,c.current)}catch(N){a(String(N))}}},[_]),U=b.useCallback(E=>{const N=n.current;if(!N)return null;h.current++;try{return N.reset(),_(N,E)}catch(A){return a(String(A)),null}},[_]);return{phase:t,error:o,processIds:l,snapshot:m,createInstance:M,stepWorkers:Z,completeUserTask:I,advanceTime:D,completeJobManually:W,throwJobError:ae,reset:te,redeploy:U,setRunImage:g,getRunImage:f}}function io(e,n){return e.slice(n)}function so(e,n,t,r){const o=e.snapshot,a="⏸ waiting for a human — complete the task below to continue",l=o.userTasks.some(u=>u.state==="Created");if(e.handled>0){const u=o.activeElementIds.map(t),m=n.length?` via ${n.map(s=>`${t(s.from)} → ${t(s.to)}`).join(", ")}`:"";return o.completedInstances>=1?{kind:"done",text:`⏭ round handled ${e.handled} job${e.handled===1?"":"s"}${m} — ✅ process instance completed`}:l?{kind:"human",text:`⏭ round handled ${e.handled} job${e.handled===1?"":"s"}${m} — ${a}`}:{kind:"step",text:`⏭ round handled ${e.handled} job${e.handled===1?"":"s"}${m} — now at ${u.length?u.join(", "):"—"}`}}switch(e.reason){case"completed":return{kind:"done",text:"✅ process instance completed"};case"userTasks":return{kind:"human",text:a};case"timers":return{kind:"step",text:"⏱ waiting on a timer — advance the clock to continue"};case"messages":return{kind:"step",text:"✉ waiting on a message — correlate it to continue"};case"signals":return{kind:"step",text:"📶 waiting on a signal — broadcast it to continue"};case"incidents":return{kind:"error",text:"A job failed — incident on the diagram"};case"unhandledJobs":{const u=e.unhandled??[];return r&&u.length>0&&u.every(m=>r.has(m))?{kind:"human",text:a}:{kind:"error",text:`⏭ waiting on job type(s) with no worker registered: ${u.join(", ")}`}}case"idle":return{kind:"step",text:"Nothing to step — no instance is running."};default:return{kind:"step",text:e.reason?`Step blocked on an unrecognized reason: ${e.reason}`:"Nothing to step — no instance is running."}}}const ao="the Scripted or Endpoint brain";async function lo(){return await Ze()===null}async function Ze(e=ao){const n=navigator.gpu;if(!n)return`This browser doesn't expose WebGPU at all. Use a recent Chrome, Edge, or Safari 17+ with hardware acceleration on, or pick ${e}.`;let t;try{t=await n.requestAdapter()}catch(r){return`WebGPU adapter request failed (${r instanceof Error?r.message:String(r)}). Try ${e} instead.`}return t?null:`This browser supports the WebGPU API, but no GPU adapter is available — hardware acceleration may be off, or this device/VM has no usable GPU. Pick ${e} instead.`}const co=[{id:"Qwen2.5-1.5B-Instruct-q4f16_1-MLC",label:"Qwen2.5 1.5B",downloadLabel:"~1.0 GB"},{id:"SmolLM2-1.7B-Instruct-q4f16_1-MLC",label:"SmolLM2 1.7B",downloadLabel:"~1.1 GB"},{id:"Llama-3.2-1B-Instruct-q4f16_1-MLC",label:"Llama 3.2 1B",downloadLabel:"~0.7 GB"},{id:"gemma-2-2b-it-q4f16_1-MLC",label:"Gemma 2 2B",downloadLabel:"~1.5 GB"},{id:"Llama-3.2-1B-Instruct-q4f32_1-MLC",label:"Llama 3.2 1B (f32, wider GPU support)",downloadLabel:"~1.1 GB"},{id:"SmolLM2-360M-Instruct-q4f32_1-MLC",label:"SmolLM2 360M (tiny, f32)",downloadLabel:"~0.6 GB"},{id:"SmolLM2-360M-Instruct-q4f16_1-MLC",label:"SmolLM2 360M (tiny)",downloadLabel:"~0.3 GB"}];function _t(e){return Tn.get(e)??{}}const Tn=new Map;async function uo(){if(Tn.size>0)return;const{prebuiltAppConfig:e}=await me(async()=>{const{prebuiltAppConfig:n}=await import("./vendor-webllm-DT0Ab8E6.js");return{prebuiltAppConfig:n}},[]);for(const n of e.model_list)Tn.set(n.model_id,{vramRequiredMB:n.vram_required_MB,requiredFeatures:n.required_features})}const cn=co.map(e=>({id:e.id,label:`${e.label} (${e.downloadLabel})`,downloadLabel:e.downloadLabel,..._t(e.id)})),Mt=cn[0].id;async function mo(){return await uo(),cn.map(e=>({...e,..._t(e.id)}))}function vt(){const e=navigator.deviceMemory;return typeof e=="number"?e*1024:null}function po(e,n=vt()){return n==null||e.vramRequiredMB==null||n>=e.vramRequiredMB?null:`${e.label} needs roughly ${Math.round(e.vramRequiredMB)} MB of GPU memory; this device looks like it has about ${Math.round(n)} MB available. It may still work, but expect it to fail or fall back to slow shared memory — try a smaller model (e.g. SmolLM2 360M) if it doesn't load.`}async function go(e){try{const{hasModelInCache:n}=await me(async()=>{const{hasModelInCache:t}=await import("./vendor-webllm-DT0Ab8E6.js");return{hasModelInCache:t}},[]);return await n(e)}catch{return!1}}function an(e){return/device (was )?lost|device_hung|device_removed|already been disposed|gpudevicelostinfo/i.test(e)}function Vn(){return"The GPU device was lost — the driver reset while the model was loading or running. This is a browser/driver-level failure, not a problem with the model: fully quit and reopen the browser (a lost device usually persists for the life of the GPU process), check chrome://gpu still reports hardware acceleration, and update your GPU driver if it recurs. The Scripted and Endpoint brains don't use the GPU at all."}class tn{constructor(){O(this,"kind","browser");O(this,"model",null);O(this,"engine",null);O(this,"worker",null);O(this,"generation",0);O(this,"chat",async(n,t=512,r)=>{var a,l;const o=this.engine;if(!o||!this.model)throw new Error("BrowserBrain.chat called before connect()");try{const u=await o.chat.completions.create({messages:n,temperature:0,max_tokens:t,stream:!0});let m="";for await(const s of u){const c=((l=(a=s.choices[0])==null?void 0:a.delta)==null?void 0:l.content)??"";c&&(m+=c,r==null||r(c))}return m}catch(u){const m=u instanceof Error?u.message:String(u);throw an(m)?(this.teardown(),new Error(`The in-browser model stopped: ${Vn()}`)):u}})}async connect(n=Mt,t){var m,s;const r=await Ze();if(r)throw new Error(r);if(this.engine&&this.model===n)return n;const o=++this.generation,a=c=>{o===this.generation&&(t==null||t({progress:c.progress??0,text:c.text??""}))};this.teardown();let l,u;try{const{CreateWebWorkerMLCEngine:c}=await me(async()=>{const{CreateWebWorkerMLCEngine:h}=await import("./vendor-webllm-DT0Ab8E6.js");return{CreateWebWorkerMLCEngine:h}},[]);u=new Worker(new URL("/pr-preview/pr-62/assets/webllm.worker-Dc1cCqhL.js",import.meta.url),{type:"module"}),l=await c(u,n,{initProgressCallback:a})}catch(c){if(u==null||u.terminate(),o!==this.generation)throw new Error("cancelled");const h=c instanceof Error?c.message:String(c);if(an(h))throw new Error(`Couldn't load ${n} in the browser (${h}). ${Vn()}`);const p=(s=(m=cn.find(g=>g.id===n))==null?void 0:m.requiredFeatures)==null?void 0:s.includes("shader-f16");throw new Error(`Couldn't load ${n} in the browser (${h}). `+(p?"This model needs WebGPU with shader-f16; try one of the f32 models in the list, or the endpoint brain.":"Try a smaller model, check your connection, or use the endpoint brain instead."))}if(o!==this.generation)throw l.unload().catch(()=>{}),u==null||u.terminate(),new Error("cancelled");return this.engine=l,this.worker=u??null,this.model=n,n}teardown(){const{engine:n,worker:t}=this;this.engine=null,this.worker=null,this.model=null,n==null||n.unload().catch(()=>{}),t==null||t.terminate()}cancelConnect(){this.generation++}dispose(){this.generation++,this.teardown()}}const xt="http://localhost:11434/v1";function Nt(){var n;const e=((n=globalThis.location)==null?void 0:n.hostname)??"";return e==="localhost"||e==="127.0.0.1"||e==="[::1]"||e==="::1"}function ln(e,n={hostname:(t=>(t=globalThis.location)==null?void 0:t.hostname)()??"",origin:(r=>(r=globalThis.location)==null?void 0:r.origin)()??""}){let o;try{o=new URL(It(e)).hostname}catch{return null}const a=l=>l==="localhost"||l==="127.0.0.1"||l==="::1"||l==="[::1]";return!a(o)||a(n.hostname)?null:`This page is served from ${n.origin||"a non-local origin"}, so it can't reach ${e}. A local model server only accepts requests from a page on localhost. Open this page at http://localhost instead, or use the Scripted or In-browser brain.`}function It(e){let n=e.trim().replace(/\/+$/,"");return n.endsWith("/chat/completions")&&(n=n.slice(0,-17)),/\/v\d+$/.test(n)||(n=`${n}/v1`),n}class Qn extends Error{constructor(n,t){super(n),this.status=t,this.name="HttpError"}}class Jn{constructor(n=xt,t="",r=""){O(this,"kind","endpoint");O(this,"baseUrl");O(this,"model",null);O(this,"models",[]);O(this,"apiKey");O(this,"requestedModel");O(this,"chat",async(n,t=512,r)=>{var s,c,h;if(!this.model)throw new Error("EndpointBrain.chat called before connect()");const o=await fetch(`${this.baseUrl}/chat/completions`,{method:"POST",headers:this.headers(),body:JSON.stringify({model:this.model,messages:n,temperature:0,max_tokens:t,stream:!0})});if(!o.ok||!o.body){const p=await o.text().catch(()=>"");throw new Error(`chat/completions HTTP ${o.status} ${o.statusText}${p?` — ${p.slice(0,300)}`:""}`)}const a=o.body.getReader(),l=new TextDecoder;let u="",m="";for(;;){const{value:p,done:g}=await a.read();if(g)break;u+=l.decode(p,{stream:!0});let f;for(;(f=u.indexOf(`
`))>=0;){const _=u.slice(0,f).trim();if(u=u.slice(f+1),!_.startsWith("data:"))continue;const y=_.slice(5).trim();if(y==="[DONE]")continue;let M;try{M=JSON.parse(y)}catch{continue}M.model&&(this.model=M.model);const I=(s=M.choices)==null?void 0:s[0],D=((c=I==null?void 0:I.delta)==null?void 0:c.content)??((h=I==null?void 0:I.message)==null?void 0:h.content)??"";D&&(m+=D,r==null||r(D))}}return m});this.baseUrl=It(n),this.apiKey=t.trim(),this.requestedModel=r.trim()}headers(){const n={"Content-Type":"application/json"};return this.apiKey&&(n.Authorization=`Bearer ${this.apiKey}`),n}async listModels(){let n;try{n=await fetch(`${this.baseUrl}/models`,{headers:this.headers()})}catch(r){const o=ln(this.baseUrl);throw new Error(o??`Can't reach ${this.baseUrl} (${r instanceof Error?r.message:String(r)}). Is the server running? For Ollama, check the app is up — and if this page is served from another origin, allow it with OLLAMA_ORIGINS.`)}if(!n.ok)throw new Qn(`${this.baseUrl}/models returned HTTP ${n.status} ${n.statusText}`,n.status);const t=await n.json();return this.models=(t.data??[]).map(r=>r.id).filter(r=>!!r),this.models}async connect(){try{const n=await this.listModels(),t=this.requestedModel||n[0];if(!t)throw new Error(`No models available at ${this.baseUrl}. Pull one first — e.g. \`ollama pull llama3.2:3b\` — or name one explicitly.`);this.model=t}catch(n){const t=n instanceof Qn&&[404,405,501].includes(n.status);if(!this.requestedModel||!t)throw n;this.models=[],this.model=this.requestedModel}return await this.validate(),this.model}async validate(){const n=await fetch(`${this.baseUrl}/chat/completions`,{method:"POST",headers:this.headers(),body:JSON.stringify({model:this.model,messages:[{role:"user",content:"Reply with ok."}],temperature:0,max_tokens:1,stream:!1})}).catch(r=>{throw new Error(`Can't reach ${this.baseUrl}/chat/completions (${r instanceof Error?r.message:String(r)}). Check the endpoint URL, API key, model name, and any local CORS settings.`)});if(!n.ok){const r=await n.text().catch(()=>"");throw new Error(`chat/completions HTTP ${n.status} ${n.statusText}${r?` — ${r.slice(0,300)}`:""}`)}const t=await n.json().catch(()=>({}));t.model&&(this.model=t.model)}dispose(){}}const ho=[{id:"onnx-community/Florence-2-base-ft",label:"Florence-2 base",downloadLabel:"~0.4 GB"},{id:"onnx-community/Florence-2-large-ft",label:"Florence-2 large (higher quality)",downloadLabel:"~1.6 GB"}],kt=ho.map(e=>({...e,label:`${e.label} (${e.downloadLabel})`})),Et=kt[0].id,bo="<OCR>",Hn="UNKNOWN (scripted brain — connect the in-browser model to read a photo)";function fo(e,n){if(e)return typeof e=="function"?e(n):e[n]}class yo{constructor(n){O(this,"kind","scripted-vision");O(this,"model",null);O(this,"read",async(n,t,r)=>{const o=typeof n=="string"?fo(this.lookup,n)??Hn:Hn;return r==null||r(o),o});this.lookup=n}dispose(){}}function wo(e){return new yo(e)}class Wn{constructor(){O(this,"kind","browser-vision");O(this,"model",null);O(this,"modelHandle",null);O(this,"processor",null);O(this,"loadImage",null);O(this,"generation",0);O(this,"read",async(n,t,r)=>{const o=this.modelHandle,a=this.processor,l=this.loadImage;if(!o||!a||!l||!this.model)throw new Error("BrowserVisionBrain.read called before connect()");const u=t&&t.startsWith("<")?t:bo,m=await l(n),s=a.construct_prompts(u),c=await a(m,s),h=await o.generate({...c,max_new_tokens:512,num_beams:1,do_sample:!1}),p=a.batch_decode(h,{skip_special_tokens:!1})[0],g=a.post_process_generation(p,u,m.size),f=_o(g,u);return r==null||r(f),f})}async connect(n=Et,t){var u,m;const r=await Ze("the scripted-vision fallback");if(r)throw new Error(r);if(this.modelHandle&&this.model===n)return n;const o=++this.generation,a=s=>{o===this.generation&&(t==null||t({progress:(s.progress??0)/100,text:s.file?`${s.status??"loading"} ${s.file}`:s.status??""}))};this.teardown();let l;try{const{Florence2ForConditionalGeneration:s,AutoProcessor:c,load_image:h}=await me(async()=>{const{Florence2ForConditionalGeneration:f,AutoProcessor:_,load_image:y}=await import("./transformers.web-qIocxbRK.js");return{Florence2ForConditionalGeneration:f,AutoProcessor:_,load_image:y}},[]),p=await s.from_pretrained(n,{dtype:"fp32",device:"webgpu",progress_callback:a}),g=await c.from_pretrained(n);l={model:p,processor:g,loadImage:h}}catch(s){if(o!==this.generation)throw new Error("cancelled");const c=s instanceof Error?s.message:String(s);throw new Error(`Couldn't load ${n} in the browser (${c}). Try the smaller Florence-2 base model, check your connection, or use the scripted-vision fallback.`)}if(o!==this.generation)throw Promise.resolve((m=(u=l.model).dispose)==null?void 0:m.call(u)).catch(()=>{}),new Error("cancelled");return this.modelHandle=l.model,this.processor=l.processor,this.loadImage=l.loadImage,this.model=n,n}teardown(){var t;const n=this.modelHandle;this.modelHandle=null,this.processor=null,this.loadImage=null,this.model=null,Promise.resolve((t=n==null?void 0:n.dispose)==null?void 0:t.call(n)).catch(()=>{})}cancelConnect(){this.generation++}dispose(){this.generation++,this.teardown()}}function _o(e,n){const t=e[n];if(typeof t=="string")return t.trim();if(t&&typeof t=="object"){const r=t.labels;return Array.isArray(r)?r.join(" ").trim():JSON.stringify(t)}return""}async function Mo(){return await lo()?"browser":Nt()?"endpoint":"scripted"}function vo(){const[e,n]=b.useState("scripted"),t=b.useRef(!1),[r,o]=b.useState("idle"),[a,l]=b.useState(null),[u,m]=b.useState(null),[s,c]=b.useState(null),[h,p]=b.useState(null),[g,f]=b.useState(null),[_,y]=b.useState(null),[M,I]=b.useState(Mt),[D,G]=b.useState(xt),[W,ae]=b.useState(""),[Z,te]=b.useState([]),[U,E]=b.useState("idle"),[N,A]=b.useState(null),[Q,C]=b.useState(""),[pe,K]=b.useState(null),X=b.useRef(null),[Ue,ke]=b.useState("scripted-vision"),[Pe,ye]=b.useState("idle"),[dn,Ee]=b.useState(null),[Te,ue]=b.useState(Et),[je,Se]=b.useState(null),[$e,we]=b.useState(null),[Re,Ye]=b.useState(null),[$,re]=b.useState(null),Y=b.useRef(null),ge=b.useRef(!1),Ge=b.useRef(0),oe=b.useCallback(k=>async(...L)=>{try{return await k.chat(...L)}catch(F){const he=F instanceof Error?F.message:String(F);throw k instanceof tn&&an(he)&&(K(null),m(null),o("error"),l(he)),F}},[]),Ae=b.useCallback(k=>async(...L)=>{try{return await k.read(...L)}catch(F){const he=F instanceof Error?F.message:String(F);throw an(he)&&(re(null),Se(null),ye("error"),Ee(he)),F}},[]);b.useEffect(()=>{Ze().then(k=>{f(k),p(k===null),t.current||(t.current=!0,Mo().then(n))}),Ze("the scripted-vision fallback").then(k=>{Ye(k),ge.current||(ge.current=!0,ke(k===null?"browser-vision":"scripted-vision"))})},[]),b.useEffect(()=>{let k=!1;return y(null),go(M).then(L=>{k||y(L)}),()=>{k=!0}},[M]),b.useEffect(()=>()=>{var k;return(k=X.current)==null?void 0:k.dispose()},[]),b.useEffect(()=>()=>{var k;return(k=Y.current)==null?void 0:k.dispose()},[]);const ze=b.useCallback(k=>{n(k),o("idle"),l(null),m(null),c(null),K(null)},[]),qe=b.useCallback(k=>{var L,F;ge.current=!0,(L=Y.current)==null||L.cancelConnect(),(F=Y.current)==null||F.dispose(),Y.current=null,ke(k),ye("idle"),Ee(null),Se(null),we(null),re(null)},[]),ve=b.useCallback(()=>{var k;(k=X.current)==null||k.dispose(),X.current=null,K(null),m(null)},[]),Ce=b.useCallback(()=>{X.current instanceof tn&&X.current.cancelConnect(),ve(),o("idle"),c(null),l(null)},[ve]),Ke=b.useCallback(async()=>{const k=++Ge.current,L=()=>k!==Ge.current,F=ln(D);if(F){te([]),E("error"),A(F);return}E("loading"),A(null);const he=new Jn(D,Q);try{const _e=await he.listModels();if(L())return;te(_e),E("ready"),ae(Oe=>Oe&&_e.includes(Oe)?Oe:_e[0]??"")}catch(_e){if(L())return;te([]),ae(""),E("error"),A(_e instanceof Error?_e.message:String(_e))}finally{he.dispose()}},[D,Q]),un=b.useCallback(async()=>{var k;if(e==="scripted"){K(null),o("ready");return}if(e==="endpoint"){const L=ln(D);if(L){ve(),l(L),o("error");return}}o("connecting"),l(null),c(null);try{if(e==="browser"){const L=X.current instanceof tn?X.current:new tn;X.current&&X.current!==L&&X.current.dispose(),X.current=L;const F=await L.connect(M,c);m(F),K(()=>oe(L)),y(!0)}else{(k=X.current)==null||k.dispose();const L=new Jn(D,Q,W);X.current=L;const F=await L.connect();m(F),K(()=>oe(L))}o("ready")}catch(L){const F=L instanceof Error?L.message:String(L);if(F==="cancelled")return;l(F),o("error"),K(null)}finally{c(null)}},[e,M,D,W,Q,ve,oe]),Be=b.useCallback(()=>{var k;(k=Y.current)==null||k.dispose(),Y.current=null,re(null),Se(null)},[]),mn=b.useCallback(()=>{var k;(k=Y.current)==null||k.cancelConnect(),Be(),ye("idle"),we(null),Ee(null)},[Be]),pn=b.useCallback(async()=>{if(Ue==="scripted-vision"){Be(),ye("ready"),Ee(null);return}ye("connecting"),Ee(null),we(null);try{const k=Y.current instanceof Wn?Y.current:new Wn;Y.current&&Y.current!==k&&Y.current.dispose(),Y.current=k;const L=await k.connect(Te,we);Se(L),re(()=>Ae(k)),ye("ready")}catch(k){const L=k instanceof Error?k.message:String(k);if(L==="cancelled")return;Ee(L),ye("error"),re(null),Se(null)}finally{we(null)}},[Ue,Te,Be,Ae]);return{kind:e,setKind:ze,status:r,error:a,modelInUse:u,progress:s,webgpu:h,webgpuReason:g,browserModelCached:_,cancelConnect:Ce,browserModel:M,setBrowserModel:I,endpointUrl:D,setEndpointUrl:G,endpointModel:W,setEndpointModel:ae,endpointModels:Z,endpointModelsStatus:U,endpointModelsError:N,listEndpointModels:Ke,apiKey:Q,setApiKey:C,connect:un,chat:pe,visionKind:Ue,setVisionKind:qe,visionStatus:Pe,visionError:dn,visionModel:Te,setVisionModel:ue,visionModelInUse:je,visionProgress:$e,visionWebgpuReason:Re,connectVision:pn,cancelVisionConnect:mn,vision:$}}const jn="#s=",xo=["scripted","browser","endpoint"];function No(e){return typeof e=="string"&&xo.includes(e)}function Io(e){try{const n=JSON.parse(e);if(n&&typeof n=="object"){const t=n,r={};return No(t.brain)&&(r.brain=t.brain),r}}catch{}return{}}function Tt(e=location.hash){if(!e.startsWith(jn))return{};let n;try{n=decodeURIComponent(e.slice(jn.length))}catch{return{}}return Io(n)}function ko(e){const n=Object.entries(e).filter(([,t])=>t!==void 0);return n.length===0?"":jn+encodeURIComponent(JSON.stringify(Object.fromEntries(n)))}function Eo(e){const n={...Tt(),...e},t=ko(n),r=new URL(location.href);r.hash=t,history.replaceState(history.state,"",r)}const Zn=[{kind:"scripted",label:"Scripted",hint:"No model. The example's stand-in decides — deterministic and offline."},{kind:"browser",label:"In-browser (WebGPU)",hint:"A small quantised model on your GPU. First run downloads weights."},{kind:"endpoint",label:"API endpoint",hint:"Any OpenAI-compatible server. Ollama by default. Local pages only."}],qn=[{kind:"scripted-vision",label:"Scripted",hint:"No model. The example's known plate is returned — deterministic and offline."},{kind:"browser-vision",label:"In-browser (WebGPU)",hint:"Reads the photo with a vision model on your GPU. First run downloads weights."}];function To({brain:e,showText:n=!0,showVision:t=!1}){return i.jsxs("div",{className:"brain",children:[n&&i.jsx(jo,{brain:e}),n&&t&&i.jsx("hr",{className:"brain-divider"}),t&&i.jsx(So,{brain:e})]})}function jo({brain:e}){const n=Zn.find(g=>g.kind===e.kind),t=ln(e.endpointUrl),r=Nt(),[o,a]=b.useState(cn);b.useEffect(()=>{mo().then(a)},[]);const{kind:l,endpointUrl:u,apiKey:m,listEndpointModels:s}=e;b.useEffect(()=>{if(l!=="endpoint"||t)return;const g=setTimeout(()=>void s(),400);return()=>clearTimeout(g)},[l,u,m,t,s]);const c=o.find(g=>g.id===e.browserModel),h=c?po(c,vt()):null,p=e.webgpu===!0?"browser":r&&e.webgpu===!1?"endpoint":null;return i.jsxs("div",{className:"brain-section",children:[i.jsxs("div",{className:"brain-kinds",children:[Zn.map(g=>i.jsxs(H,{size:"sm",variant:e.kind===g.kind?"default":"secondary",onClick:()=>e.setKind(g.kind),children:[g.label,g.kind===p&&i.jsx(q,{variant:"info",className:"brain-recommended-badge",children:"recommended"})]},g.kind)),e.status==="ready"&&e.kind!=="scripted"&&i.jsx(q,{variant:"success",children:e.modelInUse??"connected"}),e.status==="connecting"&&i.jsx(q,{variant:"info",children:"connecting…"}),e.status==="error"&&i.jsx(q,{variant:"danger",children:"not connected"})]}),i.jsx("p",{className:"field-hint",children:n.hint}),e.kind==="browser"&&i.jsxs("div",{className:"brain-config",children:[i.jsxs("div",{className:"field",children:[i.jsx(Fe,{htmlFor:"browser-model",children:"Model"}),i.jsxs(_n,{value:e.browserModel,onValueChange:e.setBrowserModel,disabled:e.status==="connecting",children:[i.jsx(Mn,{id:"browser-model",children:i.jsx(vn,{})}),i.jsx(xn,{children:o.map(g=>i.jsx(Nn,{value:g.id,children:g.label},g.id))})]}),e.browserModelCached===!0&&i.jsx("p",{className:"field-hint",children:"Already downloaded in this browser — connecting will be fast."}),e.browserModelCached===!1&&i.jsx("p",{className:"field-hint",children:"Not downloaded yet — connecting fetches the weights once, then caches them for next time."})]}),e.webgpu===!1&&e.webgpuReason&&i.jsxs(le,{variant:"destructive",children:[i.jsx(ce,{children:"No WebGPU in this browser"}),i.jsx(de,{children:e.webgpuReason})]}),e.webgpu!==!1&&h&&i.jsxs(le,{variant:"destructive",children:[i.jsx(ce,{children:"This model may not fit in GPU memory"}),i.jsx(de,{children:h})]})]}),e.kind==="endpoint"&&i.jsxs("div",{className:"brain-config",children:[i.jsxs("div",{className:"field",children:[i.jsx(Fe,{htmlFor:"endpoint-url",children:"Endpoint"}),i.jsx(Rn,{id:"endpoint-url",value:e.endpointUrl,onChange:g=>e.setEndpointUrl(g.target.value),disabled:e.status==="connecting"}),i.jsxs("p",{className:"field-hint",children:["Ollama allows ",i.jsx("code",{children:"localhost"})," origins out of the box; set"," ",i.jsx("code",{children:"OLLAMA_ORIGINS"})," only when serving this page from another host. Best for local development — a hosted copy of this page can't reach a server on your machine at all."]}),t&&i.jsxs(le,{variant:"destructive",children:[i.jsx(ce,{children:"A local server won't work from this URL"}),i.jsx(de,{children:t})]})]}),i.jsxs("div",{className:"field",children:[i.jsx(Fe,{htmlFor:"endpoint-model",children:"Model"}),i.jsxs("div",{className:"endpoint-model-row",children:[i.jsxs(_n,{value:e.endpointModel,onValueChange:e.setEndpointModel,disabled:e.status==="connecting"||e.endpointModelsStatus==="loading"||e.endpointModels.length===0,children:[i.jsx(Mn,{id:"endpoint-model",className:"endpoint-model-select",children:i.jsx(vn,{placeholder:e.endpointModelsStatus==="loading"?"Loading models…":e.endpointModelsStatus==="idle"?"Enter an endpoint above":e.endpointModelsStatus==="error"?"No models — check the endpoint":e.endpointModels.length===0?"No models served":"Select a model"})}),i.jsx(xn,{children:e.endpointModels.map(g=>i.jsx(Nn,{value:g,children:g},g))})]}),i.jsx(H,{size:"sm",variant:"secondary",onClick:()=>void e.listEndpointModels(),disabled:e.status==="connecting"||e.endpointModelsStatus==="loading"||t!==null,children:e.endpointModelsStatus==="loading"?"Refreshing…":"Refresh"})]}),i.jsxs("p",{className:"field-hint",children:["Fetched from the endpoint's ",i.jsx("code",{children:"/models"}),". Tiny models (e.g. SmolLM2) usually can't follow the tool-calling format — prefer ",i.jsx("code",{children:"llama3.2:3b"}),", ",i.jsx("code",{children:"qwen2.5"})," or larger."]}),e.endpointModelsStatus==="error"&&!t&&i.jsxs(le,{variant:"destructive",children:[i.jsx(ce,{children:"Couldn't list models"}),i.jsx(de,{children:e.endpointModelsError})]})]}),i.jsxs("div",{className:"field",children:[i.jsx(Fe,{htmlFor:"endpoint-key",children:"API key (optional)"}),i.jsx(Rn,{id:"endpoint-key",type:"password",value:e.apiKey,onChange:g=>e.setApiKey(g.target.value),disabled:e.status==="connecting"})]})]}),e.kind!=="scripted"&&i.jsxs("div",{className:"brain-actions",children:[i.jsx(H,{size:"sm",onClick:()=>void e.connect(),disabled:e.status==="connecting"||e.kind==="endpoint"&&(e.endpointModel===""||e.endpointModelsStatus==="loading"||t!==null),children:e.status==="ready"?"Reconnect":"Connect"}),e.status==="connecting"&&e.kind==="browser"&&i.jsx(H,{size:"sm",variant:"secondary",onClick:e.cancelConnect,children:"Cancel"}),e.progress&&i.jsxs("span",{className:"field-hint",children:[Math.round(e.progress.progress*100),"% —"," ",e.progress.text]})]}),e.error&&i.jsxs(le,{variant:"destructive",children:[i.jsx(ce,{children:"Couldn't connect"}),i.jsx(de,{children:e.error})]})]})}function So({brain:e}){const n=qn.find(r=>r.kind===e.visionKind),t=e.webgpu===!0?"browser-vision":null;return i.jsxs("div",{className:"brain-section brain-vision",children:[i.jsx(Fe,{children:"Vision (reads the image)"}),i.jsxs("div",{className:"brain-kinds",children:[qn.map(r=>i.jsxs(H,{size:"sm",variant:e.visionKind===r.kind?"default":"secondary",onClick:()=>e.setVisionKind(r.kind),children:[r.label,r.kind===t&&i.jsx(q,{variant:"info",className:"brain-recommended-badge",children:"recommended"})]},r.kind)),e.visionStatus==="ready"&&e.visionKind==="browser-vision"&&i.jsx(q,{variant:"success",children:e.visionModelInUse??"connected"}),e.visionStatus==="connecting"&&i.jsx(q,{variant:"info",children:"connecting…"}),e.visionStatus==="error"&&i.jsx(q,{variant:"danger",children:"not connected"})]}),i.jsx("p",{className:"field-hint",children:n.hint}),e.visionKind==="scripted-vision"&&e.webgpu===!1&&e.visionWebgpuReason&&i.jsxs(le,{variant:"destructive",children:[i.jsx(ce,{children:"No WebGPU in this browser"}),i.jsx(de,{children:e.visionWebgpuReason})]}),e.visionKind==="browser-vision"&&i.jsxs("div",{className:"brain-config",children:[i.jsxs("div",{className:"field",children:[i.jsx(Fe,{htmlFor:"vision-model",children:"Model"}),i.jsxs(_n,{value:e.visionModel,onValueChange:e.setVisionModel,disabled:e.visionStatus==="connecting",children:[i.jsx(Mn,{id:"vision-model",children:i.jsx(vn,{})}),i.jsx(xn,{children:kt.map(r=>i.jsx(Nn,{value:r.id,children:r.label},r.id))})]}),i.jsx("p",{className:"field-hint",children:"Connecting downloads the weights once (size shown above), then caches them — every token is read on your GPU, no server."})]}),e.webgpu===!1&&e.visionWebgpuReason&&i.jsxs(le,{variant:"destructive",children:[i.jsx(ce,{children:"No WebGPU in this browser"}),i.jsx(de,{children:e.visionWebgpuReason})]})]}),e.visionKind==="browser-vision"&&i.jsxs("div",{className:"brain-actions",children:[i.jsx(H,{size:"sm",onClick:()=>void e.connectVision(),disabled:e.visionStatus==="connecting",children:e.visionStatus==="ready"?"Reconnect":"Connect"}),e.visionStatus==="connecting"&&i.jsx(H,{size:"sm",variant:"secondary",onClick:e.cancelVisionConnect,children:"Cancel"}),e.visionProgress&&i.jsxs("span",{className:"field-hint",children:[Math.round(e.visionProgress.progress*100),"% —"," ",e.visionProgress.text]})]}),e.visionError&&i.jsxs(le,{variant:"destructive",children:[i.jsx(ce,{children:"Couldn't connect the vision brain"}),i.jsx(de,{children:e.visionError})]})]})}function Ao({imageInput:e,value:n,onSelect:t,disabled:r=!1}){const[o,a]=b.useState(null),[l,u]=b.useState(!1),m=b.useRef(null),s=b.useId(),c=b.useId(),h=b.useCallback(f=>{a(URL.createObjectURL(f)),t({imageName:f.name,pixels:f})},[t]);b.useEffect(()=>{if(o)return()=>URL.revokeObjectURL(o)},[o]);const p=b.useCallback(f=>{const _=f==null?void 0:f[0];_&&_.type.startsWith("image/")&&h(_)},[h]),g=(n==null?void 0:n.imageId)!=null?e.seedImages.find(f=>f.id===n.imageId):void 0;return i.jsxs("div",{className:"image-input",children:[e.label&&i.jsx("p",{className:"field-hint",children:e.label}),i.jsx("p",{className:"image-input-label",id:s,children:"Seed photos"}),i.jsx("div",{className:"image-gallery",role:"group","aria-labelledby":s,children:e.seedImages.map(f=>{const _=(n==null?void 0:n.imageId)===f.id;return i.jsxs("button",{type:"button","aria-pressed":_,className:`image-thumb${_?" image-thumb--selected":""}`,disabled:r,title:f.label??f.id,onClick:()=>{a(null),m.current&&(m.current.value=""),t({imageId:f.id,pixels:f.file})},children:[i.jsx("img",{src:f.thumb??f.file,alt:f.label??f.id}),f.label&&i.jsx("span",{children:f.label})]},f.id)})}),i.jsx("label",{className:"image-input-label",htmlFor:c,children:"Or upload your own photo"}),i.jsxs("div",{className:`image-drop${l?" image-drop--over":""}`,onDragOver:f=>{f.preventDefault(),r||u(!0)},onDragLeave:()=>u(!1),onDrop:f=>{f.preventDefault(),u(!1),r||p(f.dataTransfer.files)},children:[i.jsx("input",{ref:m,id:c,type:"file",accept:"image/*",disabled:r,onChange:f=>p(f.target.files)}),i.jsx("p",{className:"field-hint",children:"Drag a photo here, or pick one. Uploading a photo the model has never seen is the proof this runs for real — nothing leaves your browser."})]}),(o||g)&&i.jsxs("div",{className:"image-preview",children:[i.jsx("img",{src:o??(g==null?void 0:g.file),alt:o?(n==null?void 0:n.imageName)??"uploaded photo":(g==null?void 0:g.label)??(g==null?void 0:g.id)??"selected photo"}),i.jsx("span",{className:"field-hint",children:o?`Uploaded: ${(n==null?void 0:n.imageName)??"your photo"}`:`Selected: ${(g==null?void 0:g.label)??(g==null?void 0:g.id)}`}),i.jsx("button",{type:"button",className:"image-clear-btn",disabled:r,onClick:()=>{a(null),m.current&&(m.current.value=""),t(null)},children:"Clear"})]})]})}function jt(e){return typeof e=="object"&&e!==null}function ya(e){const n=new Set,t=r=>{jt(r)&&(typeof r.key=="string"&&n.add(r.key),Array.isArray(r.components)&&r.components.forEach(t))};return t(e),n}function Co(e){const n={},t=r=>{jt(r)&&(typeof r.key=="string"&&"defaultValue"in r&&(n[r.key]=r.defaultValue??""),Array.isArray(r.components)&&r.components.forEach(t))};return t(e),n}function Sn(e,n){if(e===void 0)return"undefined";try{return JSON.stringify(e,(t,r)=>typeof r=="bigint"?r.toString():r,n)}catch{return"[unserializable value]"}}function Do({activation:e,result:n,labelFor:t}){const r=e.elementId??"";return i.jsxs("div",{className:"timeline-tool",children:[i.jsxs("div",{className:"timeline-tool-head",children:[i.jsx("span",{className:"timeline-badge timeline-badge-info",children:"tool"}),i.jsx("strong",{children:t(r)||r}),i.jsx("code",{children:r})]}),e.args!==void 0&&Object.keys(e.args).length>0&&i.jsxs("div",{className:"timeline-kv",children:[i.jsx("span",{className:"timeline-kv-label",children:"arguments"}),i.jsx("code",{children:Sn(e.args)})]}),i.jsxs("div",{className:"timeline-kv",children:[i.jsx("span",{className:"timeline-kv-label",children:"returned"}),i.jsx("code",{children:n?Sn(n.result):"— waiting for the job to complete —"})]})]})}function Lo({group:e,labelFor:n}){const t=e.rows.find(s=>s.kind==="llm"),r=e.rows.filter(s=>s.kind==="agent"&&s.elementId),o=e.rows.filter(s=>s.kind==="vars"&&s.elementId),a=e.rows.filter(s=>s.kind==="agent"&&!s.elementId),l=e.rows.filter(s=>s.kind==="error"),u=new Set(r.map(s=>s.elementId)),m=e.rows.filter(s=>s.kind==="tool"||s.kind==="vars"&&s.elementId&&!u.has(s.elementId)).sort((s,c)=>s.id-c.id);return i.jsxs("div",{className:"timeline-turn",children:[i.jsxs("div",{className:"timeline-turn-head",children:[i.jsxs("span",{className:`timeline-badge ${t!=null&&t.pending?"timeline-badge-warning":"timeline-badge-neutral"}`,children:["Turn ",e.turn]}),(t==null?void 0:t.pending)&&i.jsx("span",{className:"timeline-pending",children:"thinking…"})]}),t&&i.jsx("blockquote",{className:"timeline-reply",children:t.text}),a.map(s=>i.jsx("div",{className:"timeline-note",children:s.text},s.key??s.id)),r.map(s=>i.jsx(Do,{activation:s,result:o.find(c=>c.elementId===s.elementId),labelFor:n},s.key??s.id)),m.map(s=>i.jsxs("div",{className:`log-line log-${s.kind}`,children:[s.pending?"⏳ ":"",s.text]},s.key??s.id)),l.map(s=>i.jsxs("div",{className:"timeline-error",children:["⚠ ",s.text]},s.id))]})}function Po({rows:e,elementStats:n=[],incidents:t=[],labelFor:r=m=>m,title:o="Activity",description:a="Agent turns, model replies, and tool calls — read top to bottom as a story.",emptyText:l="Press Run to start.",className:u}){const m=b.useMemo(()=>to(e),[e]),[s,c]=b.useState(!1),h=b.useRef(null);b.useEffect(()=>{const g=h.current;g&&(g.scrollTop=g.scrollHeight)},[m]);const p=()=>{var _;const g={log:e.map(({id:y,...M})=>M),elementStats:n,incidents:t},f=Sn(g,2);typeof navigator<"u"&&((_=navigator.clipboard)!=null&&_.writeText)&&navigator.clipboard.writeText(f).then(()=>{c(!0),setTimeout(()=>c(!1),1500)}).catch(()=>{})};return i.jsxs("div",{className:u?`timeline-panel ${u}`:"timeline-panel",children:[i.jsxs("div",{className:"timeline-header",children:[i.jsx("div",{className:"timeline-title",children:o}),a&&i.jsx("div",{className:"timeline-description",children:a})]}),i.jsx("div",{className:"timeline-toolbar",children:i.jsx("button",{type:"button",onClick:p,children:s?"Copied!":"Copy run as JSON"})}),i.jsx("div",{className:"timeline",ref:h,children:m.length===0?i.jsx("div",{className:"log-empty",children:l}):m.map(g=>no(g)?i.jsx(Lo,{group:g,labelFor:r},`turn-${g.turn}-${g.rows[0].key??g.rows[0].id}`):i.jsxs("div",{className:`log-line log-${g.kind}`,children:[g.pending?"⏳ ":"",g.text]},g.key??g.id))}),(n.length>0||t.length>0)&&i.jsxs("div",{className:"timeline-engine-view",children:[n.length>0&&i.jsxs("div",{className:"timeline-stats",children:[i.jsx("span",{className:"timeline-kv-label",children:"Element completion"}),i.jsx("ul",{children:n.filter(g=>g.completed>0||(g.active??0)>0).map(g=>i.jsxs("li",{children:[i.jsx("code",{children:r(g.elementId)||g.elementId})," ","completed ",g.completed,g.active?`, ${g.active} active`:""]},g.elementId))})]}),t.length>0&&i.jsxs("div",{className:"timeline-incidents",children:[i.jsx("span",{className:"timeline-kv-label",children:"Incidents"}),i.jsx("ul",{children:t.map((g,f)=>i.jsxs("li",{children:[i.jsx("code",{children:r(g.elementId)||g.elementId})," —"," ",g.reason]},`${g.elementId}-${f}`))})]})]})]})}const Ro="wdf:section:";function St(e){return Ro+e}function Kn(e){try{const n=window.localStorage.getItem(St(e));return n==="1"?!0:n==="0"?!1:void 0}catch{return}}function zo(e,n){try{window.localStorage.setItem(St(e),n?"1":"0")}catch{}}function Bo(e,n=!0){const[t,r]=b.useState(()=>Kn(e)??n);b.useEffect(()=>{r(Kn(e)??n)},[e,n]);const o=b.useCallback(a=>{r(a),zo(e,a)},[e]);return[t,o]}function xe({sectionId:e,title:n,description:t,defaultOpen:r=!0,className:o,children:a,...l}){const[u,m]=Bo(e,r);return i.jsx(zt,{className:["panel",o].filter(Boolean).join(" "),"data-tour":l["data-tour"],children:i.jsxs(Bt,{open:u,onOpenChange:m,children:[i.jsxs(Ot,{className:"panel-trigger",children:[i.jsxs("span",{className:"panel-trigger-text",children:[i.jsx("span",{className:"panel-title",children:n}),t!=null&&i.jsx("span",{className:"panel-desc",children:t})]}),i.jsx(Ft,{className:"panel-chevron","aria-hidden":!0})]}),i.jsx(Ut,{children:i.jsx($t,{children:a})})]})})}const Me={diagram:"diagram",runButton:"run-button",variablesPanel:"variables-panel",codePanel:"code-panel",brainPanel:"brain-panel"};function Xn(e){return`[data-tour="${e}"]`}function Oo(e=location.search){return new URLSearchParams(e).get("tour")}function Fo(e,n){var t;return((t=e.elementStats.find(r=>r.elementId===n))==null?void 0:t.completed)??0}function Uo(e,n){return!e||e.kind==="click"||!n?!1:e.kind==="activeElement"?n.activeElementIds.includes(e.elementId):Fo(n,e.elementId)>=(e.atLeast??1)}function $o(e){return"anchor"in e?Xn(e.anchor):`${Xn(Me.diagram)} [data-element-id="${Yo(e.elementId)}"]`}function Yo(e){return typeof CSS<"u"&&typeof CSS.escape=="function"?CSS.escape(e):e.replace(/[^a-zA-Z0-9_-]/g,n=>`\\${n}`)}function Go(e){return e.map(n=>{const t=!!n.waitFor&&n.waitFor.kind!=="click";return{element:$o(n.target),popover:{title:n.title,description:t?`${n.description} (continues automatically once you reach that point — or use Next to skip ahead)`:n.description,showButtons:["next","previous","close"]},disableActiveInteraction:!1,skipMissingElement:n.skipMissingElement??!0}})}async function Vo(e,n={}){var a;const[{driver:t}]=await Promise.all([me(()=>import("./driver.js-bj_ppY-Q.js"),[]),me(()=>Promise.resolve({}),__vite__mapDeps([0]))]),r=Go(e),o=t({steps:r,showProgress:!0,allowClose:!0,skipMissingElement:!0,onHighlighted:(l,u,{index:m})=>{var s;m!==void 0&&((s=n.onIndexChange)==null||s.call(n,m))},onDestroyed:()=>{var l;(l=n.onDestroyed)==null||l.call(n)}});return o.drive(),(a=n.onIndexChange)==null||a.call(n,o.getActiveIndex()??0),{moveNext:()=>o.moveNext(),activeIndex:()=>o.getActiveIndex()??-1,destroy:()=>o.destroy()}}const Qo=300;function Jo(e,n){const[t,r]=b.useState(!1),o=b.useRef(null),a=b.useRef(0),l=b.useRef(-1),u=b.useRef(null),m=b.useRef(n);b.useEffect(()=>{m.current=n},[n]);const s=b.useCallback(()=>{u.current!==null&&(clearInterval(u.current),u.current=null)},[]),c=b.useRef(0),h=b.useCallback(()=>{var g;c.current+=1,s(),(g=o.current)==null||g.destroy(),o.current=null,r(!1)},[s]),p=b.useCallback(()=>{if(!e||e.steps.length===0||o.current)return;const g=c.current+=1;Vo(e.steps,{onIndexChange:f=>{a.current=f},onDestroyed:()=>{s(),o.current=null,r(!1)}}).then(f=>{if(g!==c.current){f.destroy();return}o.current=f,r(!0),u.current=setInterval(()=>{const _=a.current;if(_===l.current)return;const y=e.steps[_];y&&Uo(y.waitFor,m.current())&&(l.current=_,f.moveNext())},Qo)})},[e,s]);return b.useEffect(()=>h,[h]),{active:t,start:p,stop:h}}const hn=650,bn="__agent__",et="__model__",nt="__template__:",Ho=b.lazy(async()=>{await Promise.all([me(()=>Promise.resolve({}),__vite__mapDeps([1])),me(()=>Promise.resolve({}),__vite__mapDeps([2]))]);const{RuntimeDiagram:e}=await me(async()=>{const{RuntimeDiagram:n}=await import("./RuntimeDiagram-TkhX9hgj.js");return{RuntimeDiagram:n}},__vite__mapDeps([3,4,5]));return{default:e}}),fn=b.lazy(()=>me(()=>import("./MonacoEditor-Dg0fT75B.js").then(e=>e.M),__vite__mapDeps([6,4,7]))),Wo=b.lazy(()=>me(()=>import("./vendor-modeler-A-iMHHCr.js"),__vite__mapDeps([8,4,5,9,10,11,12,1,2]))),tt=b.lazy(async()=>{const{FormRenderer:e}=await me(async()=>{const{FormRenderer:n}=await import("./FormRenderer-NxSOHgJ4.js");return{FormRenderer:n}},__vite__mapDeps([13,4,11,9,10,14]));return{default:e}});function yn(e,n){try{return JSON.stringify(e??{},null,n)}catch{return"[unserializable value]"}}function Zo({example:e,initialBrainKind:n,initialTourId:t}){var L,F,he,_e,Oe,Dn,Ln,Pn;const[r,o]=b.useState(e.bpmn),a=vo(),[l,u]=b.useState(null);b.useEffect(()=>{n&&n!==a.kind&&a.setKind(n)},[]),b.useEffect(()=>{Eo({brain:a.kind})},[a.kind]);const[m,s]=b.useState(()=>Object.fromEntries(e.handlers.map(v=>[v.elementId,v.source]))),[c,h]=b.useState(e.scriptedAgent??""),[p,g]=b.useState(()=>We(e.templates)),f=b.useMemo(()=>Er(e,m,r,p),[e,m,r,p]),_=f.model,y=oo({bpmn:f.resolvedBpmn}),M=Jo(e.tour,()=>y.snapshot);b.useEffect(()=>{var v;t&&((v=e.tour)==null?void 0:v.id)===t&&M.start()},[]);const I=_.startFormId?((L=e.forms)==null?void 0:L[_.startFormId])??null:null,[D,G]=b.useState(()=>({...e.seed,...I?Co(I):{}})),[W,ae]=b.useState(_.agent?bn:((F=e.handlers[0])==null?void 0:F.elementId)??""),[Z,te]=b.useState(!1),[U,E]=b.useState(!1),[N,A]=b.useState(null),[Q,C]=b.useState([]),[pe,K]=b.useState({}),[X,Ue]=b.useState(!1),ke=b.useRef(null),[Pe,ye]=b.useState({}),[dn,Ee]=b.useState(!1),Te=b.useRef(null),ue=b.useRef(!1),je=b.useRef(0),Se=b.useRef(0),$e=b.useRef({current:void 0}),we=b.useRef({}),Re=b.useRef({}),Ye=b.useMemo(()=>{const v=new Map;for(const x of _.processes){for(const T of x.tasks)v.set(T.elementId,T.label);for(const T of x.agents){v.set(T.elementId,T.label);for(const P of T.tools)v.set(P.elementId,P.label)}for(const T of x.userTasks)v.set(T.elementId,T.label)}return x=>v.get(x)??x},[_]),$=b.useCallback(v=>{C(x=>{if(v.key){const T=x.findIndex(P=>P.key===v.key);if(T>=0){const P=[...x];return P[T]={...P[T],...v},P}}return[...x,{...v,id:Se.current++}].slice(-80)})},[]),re=b.useMemo(()=>{var v;return((v=y.snapshot)==null?void 0:v.userTasks.find(x=>x.state==="Created"))??null},[y.snapshot]),Y=b.useMemo(()=>{const v=_.processes.flatMap(T=>T.tasks),x=new Map;for(const T of e.handlers){if(!T.manualControl)continue;const P=v.find(B=>B.elementId===T.elementId);P&&x.set(P.jobType,{...T.manualControl,elementId:T.elementId})}return x},[e.handlers,_]),ge=b.useMemo(()=>{if(!y.snapshot)return null;for(const v of y.snapshot.jobs){const x=Y.get(v.jobType);if(x&&v.state==="Created")return{job:v,control:x}}return null},[y.snapshot,Y]),Ge=b.useMemo(()=>{if(!_.agent||!y.snapshot)return[];const v=new Map(y.snapshot.elementStats.map(x=>[x.elementId,x.completed]));return _.agent.tools.filter(x=>(v.get(x.elementId)??0)===0)},[_.agent,y.snapshot]),oe=re?_.userTasks.find(v=>v.elementId===re.elementId):void 0,Ae=oe!=null&&oe.formId?((he=e.forms)==null?void 0:he[oe.formId])??null:null,ze=b.useCallback(async(v,x,T,P)=>{var be;let B=T,ee=0;for(;je.current===P&&B&&B.completedInstances<1&&ee++<80;){const V=await y.stepWorkers(v,{agents:x});if(je.current!==P)return B;B=(V==null?void 0:V.snapshot)??B;const ne=(be=B.instances[0])==null?void 0:be.variables;if(ne&&K({...ne}),B.userTasks.some(ie=>ie.state==="Created")){$({kind:"human",text:"⏸ waiting for a human — complete the task below to continue"});break}if(!V){$({kind:"error",text:"▶ run stopped — no dispatch round was returned"});break}if(V.handled===0)break;await new Promise(ie=>setTimeout(ie,hn))}return B&&B.completedInstances>=1?$({kind:"done",text:"✅ process instance completed"}):B&&B.incidentElementIds.length>0&&$({kind:"error",text:"A job failed — incident on the diagram"}),B},[y,$]),qe=b.useCallback(async v=>{var B,ee,be;if(!ge||ue.current)return;const{job:x,control:T}=ge,P=++je.current;ue.current=!0,te(!0);try{let V,ne;if(v==="complete")V=y.completeJobManually(x.jobType,"{}"),ne="  ↳ completed normally";else if(T.action.kind==="timer"){const ie=((ee=(B=y.snapshot)==null?void 0:B.timers[0])==null?void 0:ee.dueInMs)??0;V=y.advanceTime(Math.max(ie,0)+1),ne="  ↳ advanced the clock — timer fired"}else{const{errorCode:ie,message:se}=T.action;V=y.throwJobError(x.jobType,ie,se),ne=`  ↳ threw BPMN error ${ie}: ${se}`}if(V){$({kind:"vars",text:ne,elementId:x.elementId});const ie=(be=V.instances[0])==null?void 0:be.variables;ie&&K({...ie}),await new Promise(se=>setTimeout(se,hn)),await ze(we.current,Re.current,V,P)}else $({kind:"error",text:"  ↳ failed to resolve the manual job",elementId:x.elementId})}finally{ue.current=!1,te(!1)}},[ge,y,$,ze]),ve=b.useCallback(async()=>{var ie;let v=null;try{_.agent&&c.trim()&&(v=br(c))}catch(se){return A(se instanceof Error?se.message:String(se)),null}$e.current={current:void 0};let x;if(e.imageInput){const se=a.vision;x={read:se??wo(e.scriptedVision).read,live:!!se,resolve:fe=>y.getRunImage(fe)}}const T=wr(_,f.handlers,$,$e.current,x);for(const se of Y.keys())delete T[se];const P={};if(_.agents.length>0){if(a.kind!=="scripted"&&a.chat){const De=new Map;for(const fe of _.agents)De.set(fe.jobType,[...De.get(fe.jobType)??[],fe]);for(const[fe,Ve]of De)P[fe]=Rr(Ve,a.chat,$,{turnRef:$e.current,requiredTools:e.requiredTools})}else if(v&&_.agent){const De=_.agent.elementId;P[_.agent.jobType]=async fe=>{if(fe.elementId!==De)throw new Error(`No scripted agent handler for "${fe.elementId}" — only "${De}" (the primary process's first agent host) is driven by the scripted brain. Use a live brain to exercise more than one host.`);const Ve=await v(fe),Ct=(Ve.activateElements??[]).map(Dt=>Dt.elementId).join(", ");return $({kind:"agent",text:Ve.completionConditionFulfilled?"🤖 scripted agent: done":`🤖 scripted agent: calling ${Ct||"(nothing)"}`}),Ve}}}C([]),ye({});const B={...e.seed,...D,...lr(e.imageInput?l:null)};K(B),we.current=T,Re.current=P;const ee=y.redeploy(r),be=(ee==null?void 0:ee[0])??_.processId;$({kind:"start",text:`Starting "${be}" — ${_.agent?a.kind==="scripted"||!a.chat?"scripted brain":`live brain (${a.modelInUse??a.kind})`:"no agent in this model"}`});const V=y.createInstance(be,JSON.stringify(B)),ne=(ie=V==null?void 0:V.instances[0])==null?void 0:ie.key;return e.imageInput&&l&&ne&&y.setRunImage(ne,l),{workers:T,agents:P,snap:V}},[y,e,f,r,c,D,l,_,a,$,Y]),Ce=!!y.snapshot&&y.snapshot.completedInstances<1,Ke=!Ce&&!!I&&!X,un=b.useCallback(async()=>{if(!(y.phase!=="ready"||ue.current||U||f.hasErrors)){ue.current=!0,te(!0);try{let v=we.current,x=Re.current,T=y.snapshot;const P=++je.current;if(!Ce){if(ke.current&&!ke.current.validate())return;A(null);const B=await ve();if(!B)return;v=B.workers,x=B.agents,T=B.snap,await new Promise(ee=>setTimeout(ee,hn))}await ze(v,x,T,P)}finally{ue.current=!1,te(!1)}}},[y,U,f.hasErrors,Ce,ve,ze]),Be=b.useCallback(async()=>{var v;if(!(y.phase!=="ready"||ue.current||U||f.hasErrors)){ue.current=!0,E(!0);try{let x=we.current,T=Re.current,P=y.snapshot;if(!Ce){if(ke.current&&!ke.current.validate())return;A(null);const ne=await ve();if(!ne)return;x=ne.workers,T=ne.agents,P=ne.snap}if(!P||P.completedInstances>=1)return;const B=P.takenSequenceFlows.length,ee=await y.stepWorkers(x,{agents:T});if(!ee){$({kind:"error",text:"⏭ step failed — no dispatch round was returned"});return}const be=(v=ee.snapshot.instances[0])==null?void 0:v.variables;be&&K({...be});const V=io(ee.snapshot.takenSequenceFlows,B);$(so(ee,V,Ye,Y))}finally{ue.current=!1,E(!1)}}},[y,U,f.hasErrors,Ce,ve,$,Ye,Y]),mn=b.useCallback(()=>{ue.current=!1,je.current++,te(!1),E(!1),y.reset(),C([]),K({})},[y]),pn=b.useCallback(()=>{if(!re||Te.current&&!Te.current.validate())return;const v=y.completeUserTask(re.key,JSON.stringify(Pe));$({kind:"human",text:`👤 ${yn(Pe)}`}),v&&v.completedInstances>=1&&$({kind:"done",text:"✅ process instance completed"})},[re,Pe,y,$]),k=b.useMemo(()=>{var v,x;return y.phase==="loading"?i.jsx(q,{variant:"neutral",children:"Booting engine…"}):y.phase==="error"?i.jsx(q,{variant:"danger",children:"Engine error"}):Z?i.jsx(q,{variant:"info",children:"Running…"}):U?i.jsx(q,{variant:"info",children:"Stepping…"}):(((v=y.snapshot)==null?void 0:v.incidentElementIds.length)??0)>0?i.jsx(q,{variant:"danger",children:"Incident"}):re?i.jsx(q,{variant:"warning",children:"Waiting for a human"}):(((x=y.snapshot)==null?void 0:x.completedInstances)??0)>=1?i.jsx(q,{variant:"success",children:"Completed"}):y.snapshot?i.jsx(q,{variant:"warning",children:"Paused"}):i.jsx(q,{variant:"neutral",children:"Ready"})},[y.phase,y.snapshot,Z,U,re]);return i.jsxs("div",{className:"runner",children:[i.jsxs("section",{className:"intro",children:[i.jsx("h1",{children:e.title}),i.jsx("p",{children:e.blurb}),i.jsxs("div",{className:"controls",children:[i.jsx(H,{"data-tour":Me.runButton,onClick:()=>void un(),disabled:y.phase!=="ready"||Z||U||f.hasErrors||Ke,children:"▶ Run"}),i.jsx(H,{variant:"secondary",onClick:()=>void Be(),disabled:y.phase!=="ready"||Z||U||f.hasErrors||Ke||(((_e=y.snapshot)==null?void 0:_e.completedInstances)??0)>=1,children:"⏭ Step"}),i.jsx(H,{variant:"secondary",onClick:mn,disabled:y.phase!=="ready"||U,children:"↺ Reset"}),e.tour&&i.jsx(H,{variant:"secondary",onClick:M.start,disabled:M.active,children:M.active?"Touring…":`🧭 ${e.tour.label}`}),k]}),y.phase==="error"&&i.jsxs(le,{variant:"destructive",children:[i.jsx(ce,{children:"Engine error"}),i.jsx(de,{children:y.error})]}),N&&i.jsxs(le,{variant:"destructive",children:[i.jsx(ce,{children:"Code didn't compile"}),i.jsx(de,{children:N})]}),f.hasErrors&&i.jsxs(le,{variant:"destructive",children:[i.jsx(ce,{children:"Run is disabled — the diagram has unresolved references"}),i.jsx(de,{children:i.jsx("ul",{className:"diagnostics",children:f.diagnostics.filter(v=>v.severity==="error").map((v,x)=>i.jsx("li",{children:v.message},x))})})]}),!f.hasErrors&&f.diagnostics.length>0&&i.jsxs(le,{children:[i.jsx(ce,{children:"Heads up"}),i.jsx(de,{children:i.jsx("ul",{className:"diagnostics",children:f.diagnostics.map((v,x)=>i.jsx("li",{children:v.message},x))})})]})]}),i.jsxs("div",{className:"grid",children:[i.jsxs("div",{className:"col",children:[i.jsx(xe,{sectionId:"process","data-tour":Me.diagram,title:"Process",description:`${_.processName} — live token (green), incidents (red).`,children:i.jsx(b.Suspense,{fallback:i.jsx("div",{className:"diagram-fallback",children:y.phase==="loading"?"Booting the engine…":"Loading diagram…"}),children:i.jsx(Ho,{xml:f.resolvedBpmn,activeIds:((Oe=y.snapshot)==null?void 0:Oe.activeElementIds)??[],incidentIds:((Dn=y.snapshot)==null?void 0:Dn.incidentElementIds)??[],className:"diagram"})})}),re&&i.jsxs(xe,{sectionId:"human-task",title:(oe==null?void 0:oe.label)??"Human task",description:Ae?`Rendered from the model's form "${oe==null?void 0:oe.formId}".`:"This task has no linked form — complete it with no variables.",children:[Ge.length>0&&i.jsxs(le,{variant:"destructive",children:[i.jsx(ce,{children:"The agent didn't finish its checks"}),i.jsxs(de,{children:["It completed without running"," ",Ge.map(v=>v.label||v.elementId).join(", "),". The process took the default path to this task, so the findings below have no value to report."]})]}),Ae&&i.jsx(b.Suspense,{fallback:i.jsx("div",{className:"form-fallback",children:"Loading form…"}),children:i.jsx(tt,{ref:Te,schema:Ae,values:Pe,onChange:(v,x)=>ye(T=>({...T,[v]:x})),context:pe,onValidityChange:Ee})}),i.jsx(H,{onClick:pn,disabled:!!Ae&&!dn,children:"Complete task"})]}),ge&&i.jsx(xe,{sectionId:"manual-job",title:ge.control.label,description:"This job is held here on purpose — pick how it resolves.",children:i.jsxs("div",{className:"controls",children:[i.jsx(H,{onClick:()=>void qe("complete"),disabled:Z||U,children:ge.control.completeLabel??"✅ Complete normally"}),i.jsx(H,{variant:"secondary",onClick:()=>void qe("action"),disabled:Z||U,children:ge.control.action.label})]})}),i.jsxs("div",{className:"row",children:[i.jsx(xe,{sectionId:"variables",className:"grow","data-tour":Me.variablesPanel,title:"Variables",description:"The instance payload, live.",children:i.jsx("pre",{className:"vars",children:yn(pe,2)})}),i.jsx(xe,{sectionId:"activity",className:"grow",title:"Activity",description:"Agent turns, model replies, and tool calls — read top to bottom as a story.",children:i.jsx(Po,{rows:ro(Q),elementStats:(Ln=y.snapshot)==null?void 0:Ln.elementStats,incidents:(Pn=y.snapshot)==null?void 0:Pn.incidents,labelFor:Ye})})]})]}),i.jsxs("div",{className:"col",children:[(_.agent||e.imageInput)&&i.jsx(xe,{sectionId:"brain","data-tour":Me.brainPanel,title:"Brain",description:_.agent?`What drives “${_.agent.label}”. The model recommends; the process governs.`:"What reads the image. The model recommends; the process governs.",children:i.jsx(To,{brain:a,showText:!!_.agent,showVision:!!e.imageInput})}),i.jsxs(xe,{sectionId:"start",title:"Start",description:_.startFormId?`The model's start form "${_.startFormId}".`:e.imageInput?"Pick a seed photo or upload your own to read.":"The starting payload.",children:[e.imageInput&&i.jsx(Ao,{imageInput:e.imageInput,value:l,onSelect:u,disabled:Z}),e.scenarios&&i.jsx("div",{className:"scenarios",children:e.scenarios.map(v=>i.jsx(H,{size:"sm",variant:"secondary",disabled:Z,onClick:()=>G(x=>({...x,...v.variables})),children:v.label},v.label))}),I?i.jsx(b.Suspense,{fallback:i.jsx("div",{className:"form-fallback",children:"Loading form…"}),children:i.jsx(tt,{ref:ke,schema:I,values:D,onChange:(v,x)=>G(T=>({...T,[v]:x})),disabled:Z,onValidityChange:Ue})}):i.jsx("pre",{className:"vars",children:yn(D,2)})]}),i.jsx(xe,{sectionId:"code",className:"editors","data-tour":Me.codePanel,title:"Code",description:"One handler per BPMN element. Return variables to merge, or throw to fail the job.",children:i.jsx(b.Suspense,{fallback:i.jsx("div",{className:"editor-fallback",children:"Loading editor…"}),children:i.jsxs(Yt,{value:W,onValueChange:ae,children:[i.jsxs(Gt,{children:[i.jsx(Xe,{value:et,children:"model"}),_.agent&&i.jsx(Xe,{value:bn,children:"agent (scripted)"}),e.handlers.map(v=>{var x;return i.jsx(Xe,{value:v.elementId,children:((x=_.tasks.find(T=>T.elementId===v.elementId))==null?void 0:x.label)??v.elementId},v.elementId)}),Object.keys(p).map(v=>i.jsx(Xe,{value:nt+v,children:v},v))]}),i.jsxs(en,{value:et,children:[i.jsxs("div",{className:"editor-meta",children:[i.jsx("strong",{children:"Model"}),i.jsx("code",{children:"edit the diagram visually — Run re-checks it below"}),i.jsx(H,{variant:"secondary",size:"sm",onClick:()=>o(e.bpmn),disabled:r===e.bpmn,children:"Revert to original"})]}),i.jsx(Wo,{value:r,onChange:o})]}),_.agent&&i.jsxs(en,{value:bn,children:[i.jsxs("div",{className:"editor-meta",children:[i.jsx("strong",{children:_.agent.label}),i.jsx("code",{children:a.kind==="scripted"||!a.chat?"in use":"unused — a live brain is connected"})]}),i.jsx("div",{className:"editor-wrap",children:i.jsx(fn,{height:"360px",defaultLanguage:"javascript",value:c,onChange:v=>h(v??""),options:wn})})]}),e.handlers.map(v=>{var x;return i.jsxs(en,{value:v.elementId,children:[i.jsxs("div",{className:"editor-meta",children:[i.jsx("strong",{children:((x=_.tasks.find(T=>T.elementId===v.elementId))==null?void 0:x.label)??v.elementId}),i.jsx("code",{children:v.standsInFor??v.elementId})]}),i.jsx("div",{className:"editor-wrap",children:i.jsx(fn,{height:"360px",defaultLanguage:"javascript",value:m[v.elementId],onChange:T=>s(P=>({...P,[v.elementId]:T??""})),options:wn})})]},v.elementId)}),Object.keys(p).map(v=>i.jsxs(en,{value:nt+v,children:[i.jsxs("div",{className:"editor-meta",children:[i.jsx("strong",{children:v}),i.jsxs("code",{children:["prompt / template text — substitutes"," ","{{"+v+"}}"]})]}),i.jsx("div",{className:"editor-wrap",children:i.jsx(fn,{height:"360px",defaultLanguage:"markdown",value:p[v],onChange:x=>g(T=>We(T,{[v]:x??""})),options:wn})})]},v))]})})}),_.agent&&i.jsx(xe,{sectionId:"tools",title:"Tools, as the model sees them",description:i.jsxs(i.Fragment,{children:["Read from the diagram — element name, documentation, and every",i.jsx("code",{children:" fromAi(…)"})," argument."]}),children:i.jsx("ul",{className:"tool-list",children:_.agent.tools.map(v=>i.jsxs("li",{children:[i.jsx("code",{children:v.elementId}),i.jsxs("span",{children:[" — ",v.documentation||v.label]}),v.args.length>0&&i.jsx("ul",{children:v.args.map(x=>i.jsxs("li",{children:[i.jsxs("code",{children:[x.name,": ",x.type]})," ","— ",x.description]},x.name))})]},v.elementId))})})]})]})]})}const wn={minimap:{enabled:!1},fontSize:13,scrollBeyondLastLine:!1,tabSize:2,automaticLayout:!0},qo=`You are a demo workflow assistant for fictional compliance checks.
...
}`,rs={id:"loan-origination",title:"Loan origination agent",blurb:"An AI agent gathers a loan case with its own tools — customer lookup, credit bureau, an underwriting policy, a status update — then every application passes through a mandatory senior-officer review before a gateway routes it to an offer or a decline. The agent advises; the process governs.",docsUrl:"https://camunda.com/orchestrate/agents/",bpmn:Si,forms:{"loan-application":Bi,"loan-senior-officer-review":Qi},seed:ot,scenarios:[{label:"Strong applicant (policy recommends approve)",variables:ot},{label:"Marginal applicant (policy recommends decline)",variables:Wi}],scriptedAgent:Zi,templates:Hi,tour:ji,requiredTools:["AssessApplication","UpdateApplicationStatus"],handlers:[{elementId:"QueryCustomer",standsInFor:"CRM connector — customer lookup",source:qi},{elementId:"CreditBureauLookup",standsInFor:"REST connector — credit bureau",source:Ki},{elementId:"AssessApplication",standsInFor:"Script task — underwriting policy (FEEL)",source:Xi},{elementId:"UpdateApplicationStatus",standsInFor:"REST connector — origination system",source:es},{elementId:"IssueLoanOffer",standsInFor:"REST connector — offer/booking system",source:ns},{elementId:"SendDeclineNotice",standsInFor:"REST connector — notifications",source:ts}]},os=`<?xml version="1.0" encoding="UTF-8"?>
...
}`,ls={id:"order-process",title:"Order process with service workers",blurb:"The getting-started order process: check inventory, charge payment, ship. No agent and no human step — the same runner, driven entirely by what's in the diagram.",docsUrl:"https://docs.camunda.io/docs/next/guides/getting-started-orchestration-cluster/",bpmn:os,seed:{item:"camunda-t-shirt",quantity:3},handlers:[{elementId:"Activity_0tw2fu0",standsInFor:"job worker — check-inventory",source:is},{elementId:"Activity_1ppsbgi",standsInFor:"job worker — charge-payment",source:ss},{elementId:"Activity_08pg6im",standsInFor:"job worker — ship-items",source:as}]},cs=`<?xml version="1.0" encoding="UTF-8"?>\r
...
}`,oa={id:"plate-recognition",title:"Read a number plate from a photo",blurb:"Pick the plate's country, then a photo goes into the run, an in-browser vision model reads the number plate on the reader's own GPU, and a human confirms or corrects it before the process records the result. The vision model recommends; the BPMN process governs. No server, no API key — with no model connected it falls back to a deterministic scripted reading.",docsUrl:"https://docs.camunda.io/docs/components/modeler/forms/camunda-forms-reference/",bpmn:Es,forms:{"plate-recognition-country":qs,"plate-recognition-confirm":Ps,"plate-recognition-manual":Ys},seed:{country:"auto"},imageInput:{label:"Pick a seed photo (its plate is known, so the scripted reader works offline) or upload your own — a live in-browser model reads a photo it has never seen.",seedImages:ea},scriptedVision:na,handlers:[{elementId:"ExtractPlate",standsInFor:"Vision model — Florence-2 <OCR> on WebGPU (in-browser)",source:ta},{elementId:"RecordResult",standsInFor:"Script task — records the governed outcome",source:ra}]},rn=[us,ki,rs,ls,bs,oa];function Cn(){return"/pr-preview/pr-62/"}function ia(e){const n=Cn();return e.startsWith(n)?"/"+e.slice(n.length):e}function sa(e=location.pathname){const t=ia(e).match(/^\/examples\/([^/]+)\/?$/);if(t)try{return{kind:"example",id:decodeURIComponent(t[1])}}catch{return{kind:"gallery"}}return{kind:"gallery"}}function aa(e=location.search){return new URLSearchParams(e).get("embed")==="1"}function la(){return Cn()}function st(e){return`${Cn()}examples/${encodeURIComponent(e)}`}function at(e,n={}){const t=new URL(location.href);t.pathname=e,t.search=n.search??t.search,n.hash!==void 0&&(t.hash=n.hash),n.replace?history.replaceState(history.state,"",t):history.pushState(history.state,"",t),window.dispatchEvent(new PopStateEvent("popstate"))}function lt(){return{route:sa(),embed:aa()}}function ca(){const[e,n]=b.useState(lt);return b.useEffect(()=>{const t=()=>n(lt());return window.addEventListener("popstate",t),()=>window.removeEventListener("popstate",t)},[]),e}const da="web-demo-framework:height",ua="web-demo-framework:request-height";function ma(e){return{type:da,height:Math.ceil(e)}}const ct="embed-height-auto";function pa(e){b.useEffect(()=>{if(!e||typeof window>"u"||window.parent===window)return;const n=document.documentElement;n.classList.add(ct);let t=-1;const r=(l=!1)=>{const u=document.documentElement.scrollHeight;!l&&Math.abs(u-t)<2||(t=u,window.parent.postMessage(ma(u),"*"))},o=l=>{if(l.source!==window.parent)return;const u=l.data;!u||u.type!==ua||r(!0)};window.addEventListener("message",o),r();const a=new ResizeObserver(()=>r());return a.observe(n),()=>{a.disconnect(),window.removeEventListener("message",o),n.classList.remove(ct)}},[e])}function ga(){const{route:e,embed:n}=ca(),t=Tt().brain,r=Oo();pa(n);const o=e.kind==="example"?e.id:rn[0].id,a=rn.find(m=>m.id===o)??rn[0],l=m=>{at(st(m),{hash:location.hash})},u=i.jsxs(i.Fragment,{children:[!n&&e.kind==="gallery"&&i.jsx("nav",{className:"example-picker",children:rn.map(m=>i.jsx(H,{size:"sm",variant:m.id===a.id?"default":"secondary",onClick:()=>l(m.id),children:m.title},m.id))}),!n&&e.kind==="example"&&i.jsx("div",{className:"example-nav",children:i.jsx(H,{size:"sm",variant:"secondary",onClick:()=>at(la()),children:"← All examples"})}),i.jsxs("div",{className:"example-meta",children:[a.docsUrl&&i.jsx("a",{className:"docs-link",href:a.docsUrl,target:"_blank",rel:"noreferrer noopener",children:"View on camunda.com ↗"}),n&&i.jsx("a",{className:"open-full-page",href:st(a.id)+(location.hash||""),target:"_top",rel:"noreferrer",children:"Open full page ↗"})]}),i.jsx(Zo,{example:a,initialBrainKind:t,initialTourId:r},a.id)]});return n?i.jsx("div",{className:"c4-ui app-shell app-embed",children:i.jsx("main",{id:"main",className:"layout layout-embed",children:u})}):i.jsxs("div",{className:"c4-ui app-shell",children:[i.jsx(Vt,{appName:"Runnable Camunda examples",trailing:i.jsx("span",{className:"app-subtitle",children:"model + code + optional LLM, in your browser"})}),i.jsx("main",{id:"main",className:"layout",children:u})]})}Rt.createRoot(document.getElementById("root")).render(i.jsx(b.StrictMode,{children:i.jsx(Qt,{children:i.jsx(ga,{})})}));export{me as _,ya as c};
