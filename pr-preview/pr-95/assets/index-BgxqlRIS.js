const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/driver-CTZuBZOi.css","assets/diagram-js-DAKGYcfb.css","assets/bpmn-embedded-D9kK2cZm.css","assets/RuntimeDiagram-B2IYfHo7.js","assets/vendor-react-9Ma26nY1.js","assets/Viewer-D_7S4Gwm.js","assets/MonacoEditor-DTrlhpcf.js","assets/MonacoEditor-CSys-Ydm.css","assets/vendor-modeler-CkziDt-P.js","assets/vendor-design-system-CHFiGyYU.js","assets/vendor-design-system-Bb2tjC2Z.css","assets/parser-DkgAe_kI.js","assets/ModelEditor-Dwlgp6JA.css","assets/FormRenderer-gjNQXlwV.js","assets/FormRenderer-D1JIHOW6.css"])))=>i.map(i=>d[i]);
var Dt=Object.defineProperty;var Ct=(e,n,t)=>n in e?Dt(e,n,{enumerable:!0,configurable:!0,writable:!0,value:t}):e[n]=t;var O=(e,n,t)=>Ct(e,typeof n!="symbol"?n+"":n,t);import{r as h,j as a,i as Bt}from"./vendor-react-9Ma26nY1.js";import{B as J,a as H,L as ze,S as nt,b as tt,c as rt,d as it,e as ot,A as le,f as ce,g as me,I as an,C as Lt,h as Rt,i as zt,j as Ot,k as Ft,l as Ut,T as $t,m as Vt,n as He,o as We,p as Gt,q as Yt}from"./vendor-design-system-CHFiGyYU.js";(function(){const n=document.createElement("link").relList;if(n&&n.supports&&n.supports("modulepreload"))return;for(const i of document.querySelectorAll('link[rel="modulepreload"]'))r(i);new MutationObserver(i=>{for(const s of i)if(s.type==="childList")for(const l of s.addedNodes)l.tagName==="LINK"&&l.rel==="modulepreload"&&r(l)}).observe(document,{childList:!0,subtree:!0});function t(i){const s={};return i.integrity&&(s.integrity=i.integrity),i.referrerPolicy&&(s.referrerPolicy=i.referrerPolicy),i.crossOrigin==="use-credentials"?s.credentials="include":i.crossOrigin==="anonymous"?s.credentials="omit":s.credentials="same-origin",s}function r(i){if(i.ep)return;i.ep=!0;const s=t(i);fetch(i.href,s)}})();const Qt="modulepreload",qt=function(e){return"/pr-preview/pr-95/"+e},Tn={},pe=function(n,t,r){let i=Promise.resolve();if(t&&t.length>0){let l=function(o){return Promise.all(o.map(d=>Promise.resolve(d).then(g=>({status:"fulfilled",value:g}),g=>({status:"rejected",reason:g}))))};document.getElementsByTagName("link");const m=document.querySelector("meta[property=csp-nonce]"),p=(m==null?void 0:m.nonce)||(m==null?void 0:m.getAttribute("nonce"));i=l(t.map(o=>{if(o=qt(o),o in Tn)return;Tn[o]=!0;const d=o.endsWith(".css"),g=d?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${o}"]${g}`))return;const u=document.createElement("link");if(u.rel=d?"stylesheet":Qt,d||(u.as="script"),u.crossOrigin="",u.href=o,p&&u.setAttribute("nonce",p),document.head.appendChild(u),d)return new Promise((f,_)=>{u.addEventListener("load",f),u.addEventListener("error",()=>_(new Error(`Unable to preload CSS for ${o}`)))})}))}function s(l){const m=new Event("vite:preloadError",{cancelable:!0});if(m.payload=l,window.dispatchEvent(m),!m.defaultPrevented)throw l}return i.then(l=>{for(const m of l||[])m.status==="rejected"&&s(m.reason);return n().catch(s)})},Jt="io.camunda.agenticai:aiagent",Me="http://www.omg.org/spec/BPMN/20100524/MODEL",Ht="http://camunda.org/schema/zeebe/1.0";function pn(e,n){return Array.from(e.getElementsByTagNameNS(Ht,n))}function at(e,n){return pn(e,n).filter(t=>Wt(t)===e)}function Wt(e){let n=e.parentElement;for(;n;){if(n.namespaceURI===Me&&n.localName!=="extensionElements")return n;n=n.parentElement}return null}function _n(e){const n=at(e,"taskDefinition")[0],t=n==null?void 0:n.getAttribute("type");return t||(e.localName==="scriptTask"?e.getAttribute("id")??null:null)}function jn(e){const n=Array.from(e.children).find(t=>t.namespaceURI===Me&&t.localName==="documentation");return((n==null?void 0:n.textContent)??"").trim()}function Sn(e){if(!e)return"";const n=e.startsWith("=")?e.slice(1):e,t=n.match(/"((?:[^"\\]|\\.)*)"/g);return t?t.map(r=>r.slice(1,-1).replace(/\\n/g,`
...
`)}async function Pr(e,n,t,r,i,s){let l="";n({kind:"llm",text:"LLM thinking…",key:t,pending:!0,turn:s});const m=await e(r,i,p=>{l+=p,n({kind:"llm",text:`${un(l)} ▍`,key:t,pending:!0,turn:s})});return n({kind:"llm",text:un(m||l)||"(empty reply)",key:t,pending:!1,turn:s}),m}function Ar(e,n){switch(e){case"number":return typeof n=="number"&&Number.isFinite(n)?{ok:!0,value:n}:typeof n=="string"&&n.trim()!==""&&Number.isFinite(Number(n))?{ok:!0,value:Number(n)}:{ok:!1};case"boolean":return typeof n=="boolean"?{ok:!0,value:n}:typeof n=="string"&&/^(true|false)$/i.test(n.trim())?{ok:!0,value:n.trim().toLowerCase()==="true"}:{ok:!1};default:return typeof n=="object"?{ok:!1}:{ok:!0,value:String(n)}}}function Dr(e,n,t){const r={},i=new Map,s=new Map;for(const{tool:l,args:m}of e){const p={};for(const o of l.args){const d=m[o.name];if(!(d!=null&&d!=="")){n({kind:"error",text:`🤖 ${l.elementId}: model supplied no value for "${o.name}"`,turn:t,elementId:l.elementId});continue}const u=i.get(o.name);if(u!==void 0&&u!==l.elementId){n({kind:"error",text:`🤖 argument name collision on "${o.name}": both ${u} and ${l.elementId} declare it — ${u} already claimed it this turn, ${l.elementId}'s value is dropped`,turn:t,elementId:l.elementId});continue}const f=Ar(o.type,d);if(!f.ok){n({kind:"error",text:`🤖 ${l.elementId}: "${o.name}" is declared as ${o.type} but the model supplied ${JSON.stringify(d)} — rejected, not passed through`,turn:t,elementId:l.elementId});continue}r[o.name]=f.value,p[o.name]=f.value,i.set(o.name,l.elementId)}s.set(l.elementId,p)}return{variablesOut:r,forHistory:s}}function Cr(e,n,t,r={}){const{maxNewTokens:i=384,allowRepeats:s=!1,allowMultiToolTurns:l=!1,turnRef:m,requiredTools:p=[],maxEarlyDoneNudges:o=1}=r;let d=0;const g=new Set,u=[];let f=0,_=[],y=[];return async b=>{const v=b.variables,k=v.toolCallResult;for(k!==void 0&&u.length&&(u[u.length-1]=`${u[u.length-1]} → ${un(JSON.stringify(k),160)}`);;){const W=await C();if(W)return W}async function C(){if(d+=1,m&&(m.current=d),d>e.maxModelCalls)return t({kind:"error",text:`Turn budget spent (maxModelCalls=${e.maxModelCalls}) — completing the agent.`,turn:d}),{completionConditionFulfilled:!0};const W=s?e.tools:e.tools.filter(N=>!g.has(N.elementId)),Z=[{role:"system",content:jr(e,l,W)},{role:"user",content:Sr(e,v,u,W,_,y,s)}];_=[],y=[];let ue;try{ue=await Pr(n,t,`llm-turn-${d}`,Z,i,d)}catch(N){return t({kind:"error",text:`LLM call failed: ${N instanceof Error?N.message:String(N)} — completing the agent.`,turn:d}),{completionConditionFulfilled:!0}}const q=Ir(ue);if(Tr(q)&&Dn(q).length===0){const N=p.filter(z=>!g.has(z));return N.length&&f<o?(f+=1,_=N,t({kind:"agent",text:`🤖 model says it is done, but ${N.join(", ")} hasn't run — asking once more`,turn:d}),null):(t({kind:"agent",text:"🤖 model says it is done",turn:d}),{completionConditionFulfilled:!0})}const se=Dn(q);if(se.length===0)return t({kind:"error",text:"🤖 model named no tool (and didn't say it was done) — asking again",turn:d}),y=['it named no tool and did not say it was done — reply with {"tool": "...", "arguments": {...}} or {"done": true}'],null;const V=[],Y=[],$=[];for(const N of se){const z=e.tools.find(K=>K.elementId===N.name);if(!z){Y.push(N.name);continue}if(!s&&g.has(z.elementId)){$.push(z.elementId);continue}V.push({tool:z,args:N.args})}if(Y.length&&t({kind:"error",text:`🤖 model named a tool that doesn't exist: ${Y.join(", ")} — nothing activated`,turn:d}),$.length&&t({kind:"error",text:`🤖 model asked to re-run ${$.join(", ")} — skipped (already run)`,turn:d}),V.length===0)return t({kind:"agent",text:"🤖 nothing activated — asking again",turn:d}),y=[...Y.length?[`${Y.join(", ")} ${Y.length===1?"is":"are"} not a real tool`]:[],...$.length?[`${$.join(", ")} has already run and will never run again — pick a different tool, or reply {"done": true} if nothing is left to do`]:[]],null;const{variablesOut:S,forHistory:E}=Dr(V,t,d);for(const{tool:N}of V)g.add(N.elementId),u.push(`- ${N.elementId}(${JSON.stringify(E.get(N.elementId))})`);for(const{tool:N}of V)t({kind:"agent",text:`🤖 calling ${N.elementId}`,turn:d,elementId:N.elementId,args:E.get(N.elementId)??{}});return{activateElements:V.map(N=>({elementId:N.tool.elementId})),variables:S}}}}function Br(e,n,t,r={}){const i=new Map(e.map(s=>[s.elementId,Cr(s,n,t,r)]));return async s=>{const l=i.get(s.elementId);if(!l)throw new Error(`No agent host registered for "${s.elementId}"`);return l(s)}}class gn{__destroy_into_raw(){const n=this.__wbg_ptr;return this.__wbg_ptr=0,Bn.unregister(this),n}free(){const n=this.__destroy_into_raw();c.__wbg_testengine_free(n,0)}activateJobs(n,t,r,i){let s,l;try{const f=c.__wbindgen_add_to_stack_pointer(-16),_=P(n,c.__wbindgen_export,c.__wbindgen_export2),y=j,b=P(i,c.__wbindgen_export,c.__wbindgen_export2),v=j;c.testengine_activateJobs(f,this.__wbg_ptr,_,y,t,r,b,v);var m=w().getInt32(f+0,!0),p=w().getInt32(f+4,!0),o=w().getInt32(f+8,!0),d=w().getInt32(f+12,!0),g=m,u=p;if(d)throw g=0,u=0,R(o);return s=g,l=u,L(g,u)}finally{c.__wbindgen_add_to_stack_pointer(16),c.__wbindgen_export3(s,l,1)}}advanceTime(n){let t,r;try{const d=c.__wbindgen_add_to_stack_pointer(-16);c.testengine_advanceTime(d,this.__wbg_ptr,n);var i=w().getInt32(d+0,!0),s=w().getInt32(d+4,!0),l=w().getInt32(d+8,!0),m=w().getInt32(d+12,!0),p=i,o=s;if(m)throw p=0,o=0,R(l);return t=p,r=o,L(p,o)}finally{c.__wbindgen_add_to_stack_pointer(16),c.__wbindgen_export3(t,r,1)}}assignUserTask(n,t,r){let i,s;try{const u=c.__wbindgen_add_to_stack_pointer(-16),f=P(n,c.__wbindgen_export,c.__wbindgen_export2),_=j,y=P(t,c.__wbindgen_export,c.__wbindgen_export2),b=j;c.testengine_assignUserTask(u,this.__wbg_ptr,f,_,y,b,r);var l=w().getInt32(u+0,!0),m=w().getInt32(u+4,!0),p=w().getInt32(u+8,!0),o=w().getInt32(u+12,!0),d=l,g=m;if(o)throw d=0,g=0,R(p);return i=d,s=g,L(d,g)}finally{c.__wbindgen_add_to_stack_pointer(16),c.__wbindgen_export3(i,s,1)}}broadcastSignal(n,t){let r,i;try{const g=c.__wbindgen_add_to_stack_pointer(-16),u=P(n,c.__wbindgen_export,c.__wbindgen_export2),f=j,_=P(t,c.__wbindgen_export,c.__wbindgen_export2),y=j;c.testengine_broadcastSignal(g,this.__wbg_ptr,u,f,_,y);var s=w().getInt32(g+0,!0),l=w().getInt32(g+4,!0),m=w().getInt32(g+8,!0),p=w().getInt32(g+12,!0),o=s,d=l;if(p)throw o=0,d=0,R(m);return r=o,i=d,L(o,d)}finally{c.__wbindgen_add_to_stack_pointer(16),c.__wbindgen_export3(r,i,1)}}cancelInstance(n){let t,r;try{const d=c.__wbindgen_add_to_stack_pointer(-16),g=P(n,c.__wbindgen_export,c.__wbindgen_export2),u=j;c.testengine_cancelInstance(d,this.__wbg_ptr,g,u);var i=w().getInt32(d+0,!0),s=w().getInt32(d+4,!0),l=w().getInt32(d+8,!0),m=w().getInt32(d+12,!0),p=i,o=s;if(m)throw p=0,o=0,R(l);return t=p,r=o,L(p,o)}finally{c.__wbindgen_add_to_stack_pointer(16),c.__wbindgen_export3(t,r,1)}}completeAgentJob(n,t,r){let i,s;try{const u=c.__wbindgen_add_to_stack_pointer(-16),f=P(n,c.__wbindgen_export,c.__wbindgen_export2),_=j,y=P(t,c.__wbindgen_export,c.__wbindgen_export2),b=j,v=P(r,c.__wbindgen_export,c.__wbindgen_export2),k=j;c.testengine_completeAgentJob(u,this.__wbg_ptr,f,_,y,b,v,k);var l=w().getInt32(u+0,!0),m=w().getInt32(u+4,!0),p=w().getInt32(u+8,!0),o=w().getInt32(u+12,!0),d=l,g=m;if(o)throw d=0,g=0,R(p);return i=d,s=g,L(d,g)}finally{c.__wbindgen_add_to_stack_pointer(16),c.__wbindgen_export3(i,s,1)}}completeJob(n,t){let r,i;try{const g=c.__wbindgen_add_to_stack_pointer(-16),u=P(n,c.__wbindgen_export,c.__wbindgen_export2),f=j,_=P(t,c.__wbindgen_export,c.__wbindgen_export2),y=j;c.testengine_completeJob(g,this.__wbg_ptr,u,f,_,y);var s=w().getInt32(g+0,!0),l=w().getInt32(g+4,!0),m=w().getInt32(g+8,!0),p=w().getInt32(g+12,!0),o=s,d=l;if(p)throw o=0,d=0,R(m);return r=o,i=d,L(o,d)}finally{c.__wbindgen_add_to_stack_pointer(16),c.__wbindgen_export3(r,i,1)}}completeUserTask(n,t){let r,i;try{const g=c.__wbindgen_add_to_stack_pointer(-16),u=P(n,c.__wbindgen_export,c.__wbindgen_export2),f=j,_=P(t,c.__wbindgen_export,c.__wbindgen_export2),y=j;c.testengine_completeUserTask(g,this.__wbg_ptr,u,f,_,y);var s=w().getInt32(g+0,!0),l=w().getInt32(g+4,!0),m=w().getInt32(g+8,!0),p=w().getInt32(g+12,!0),o=s,d=l;if(p)throw o=0,d=0,R(m);return r=o,i=d,L(o,d)}finally{c.__wbindgen_add_to_stack_pointer(16),c.__wbindgen_export3(r,i,1)}}correlateMessage(n,t,r){let i,s;try{const u=c.__wbindgen_add_to_stack_pointer(-16),f=P(n,c.__wbindgen_export,c.__wbindgen_export2),_=j,y=P(t,c.__wbindgen_export,c.__wbindgen_export2),b=j,v=P(r,c.__wbindgen_export,c.__wbindgen_export2),k=j;c.testengine_correlateMessage(u,this.__wbg_ptr,f,_,y,b,v,k);var l=w().getInt32(u+0,!0),m=w().getInt32(u+4,!0),p=w().getInt32(u+8,!0),o=w().getInt32(u+12,!0),d=l,g=m;if(o)throw d=0,g=0,R(p);return i=d,s=g,L(d,g)}finally{c.__wbindgen_add_to_stack_pointer(16),c.__wbindgen_export3(i,s,1)}}createInstance(n,t,r){let i,s;try{const u=c.__wbindgen_add_to_stack_pointer(-16),f=P(n,c.__wbindgen_export,c.__wbindgen_export2),_=j,y=P(t,c.__wbindgen_export,c.__wbindgen_export2),b=j;c.testengine_createInstance(u,this.__wbg_ptr,f,_,y,b,Fr(r)?Number.MAX_SAFE_INTEGER:r>>0);var l=w().getInt32(u+0,!0),m=w().getInt32(u+4,!0),p=w().getInt32(u+8,!0),o=w().getInt32(u+12,!0),d=l,g=m;if(o)throw d=0,g=0,R(p);return i=d,s=g,L(d,g)}finally{c.__wbindgen_add_to_stack_pointer(16),c.__wbindgen_export3(i,s,1)}}debugClear(){c.testengine_debugClear(this.__wbg_ptr)}debugCreateInstance(n,t,r){let i,s;try{const u=c.__wbindgen_add_to_stack_pointer(-16),f=P(n,c.__wbindgen_export,c.__wbindgen_export2),_=j,y=P(t,c.__wbindgen_export,c.__wbindgen_export2),b=j,v=P(r,c.__wbindgen_export,c.__wbindgen_export2),k=j;c.testengine_debugCreateInstance(u,this.__wbg_ptr,f,_,y,b,v,k);var l=w().getInt32(u+0,!0),m=w().getInt32(u+4,!0),p=w().getInt32(u+8,!0),o=w().getInt32(u+12,!0),d=l,g=m;if(o)throw d=0,g=0,R(p);return i=d,s=g,L(d,g)}finally{c.__wbindgen_add_to_stack_pointer(16),c.__wbindgen_export3(i,s,1)}}get debugIsPaused(){return c.testengine_debugIsPaused(this.__wbg_ptr)!==0}debugResume(){let n,t;try{const o=c.__wbindgen_add_to_stack_pointer(-16);c.testengine_debugResume(o,this.__wbg_ptr);var r=w().getInt32(o+0,!0),i=w().getInt32(o+4,!0),s=w().getInt32(o+8,!0),l=w().getInt32(o+12,!0),m=r,p=i;if(l)throw m=0,p=0,R(s);return n=m,t=p,L(m,p)}finally{c.__wbindgen_add_to_stack_pointer(16),c.__wbindgen_export3(n,t,1)}}debugStep(){let n,t;try{const o=c.__wbindgen_add_to_stack_pointer(-16);c.testengine_debugStep(o,this.__wbg_ptr);var r=w().getInt32(o+0,!0),i=w().getInt32(o+4,!0),s=w().getInt32(o+8,!0),l=w().getInt32(o+12,!0),m=r,p=i;if(l)throw m=0,p=0,R(s);return n=m,t=p,L(m,p)}finally{c.__wbindgen_add_to_stack_pointer(16),c.__wbindgen_export3(n,t,1)}}deploy(n){let t,r;try{const d=c.__wbindgen_add_to_stack_pointer(-16),g=P(n,c.__wbindgen_export,c.__wbindgen_export2),u=j;c.testengine_deploy(d,this.__wbg_ptr,g,u);var i=w().getInt32(d+0,!0),s=w().getInt32(d+4,!0),l=w().getInt32(d+8,!0),m=w().getInt32(d+12,!0),p=i,o=s;if(m)throw p=0,o=0,R(l);return t=p,r=o,L(p,o)}finally{c.__wbindgen_add_to_stack_pointer(16),c.__wbindgen_export3(t,r,1)}}deployForm(n){let t,r;try{const d=c.__wbindgen_add_to_stack_pointer(-16),g=P(n,c.__wbindgen_export,c.__wbindgen_export2),u=j;c.testengine_deployForm(d,this.__wbg_ptr,g,u);var i=w().getInt32(d+0,!0),s=w().getInt32(d+4,!0),l=w().getInt32(d+8,!0),m=w().getInt32(d+12,!0),p=i,o=s;if(m)throw p=0,o=0,R(l);return t=p,r=o,L(p,o)}finally{c.__wbindgen_add_to_stack_pointer(16),c.__wbindgen_export3(t,r,1)}}deployResource(n,t){let r,i;try{const g=c.__wbindgen_add_to_stack_pointer(-16),u=P(n,c.__wbindgen_export,c.__wbindgen_export2),f=j,_=P(t,c.__wbindgen_export,c.__wbindgen_export2),y=j;c.testengine_deployResource(g,this.__wbg_ptr,u,f,_,y);var s=w().getInt32(g+0,!0),l=w().getInt32(g+4,!0),m=w().getInt32(g+8,!0),p=w().getInt32(g+12,!0),o=s,d=l;if(p)throw o=0,d=0,R(m);return r=o,i=d,L(o,d)}finally{c.__wbindgen_add_to_stack_pointer(16),c.__wbindgen_export3(r,i,1)}}events(){let n,t;try{const o=c.__wbindgen_add_to_stack_pointer(-16);c.testengine_events(o,this.__wbg_ptr);var r=w().getInt32(o+0,!0),i=w().getInt32(o+4,!0),s=w().getInt32(o+8,!0),l=w().getInt32(o+12,!0),m=r,p=i;if(l)throw m=0,p=0,R(s);return n=m,t=p,L(m,p)}finally{c.__wbindgen_add_to_stack_pointer(16),c.__wbindgen_export3(n,t,1)}}failJob(n,t,r){let i,s;try{const u=c.__wbindgen_add_to_stack_pointer(-16),f=P(n,c.__wbindgen_export,c.__wbindgen_export2),_=j,y=P(r,c.__wbindgen_export,c.__wbindgen_export2),b=j;c.testengine_failJob(u,this.__wbg_ptr,f,_,t,y,b);var l=w().getInt32(u+0,!0),m=w().getInt32(u+4,!0),p=w().getInt32(u+8,!0),o=w().getInt32(u+12,!0),d=l,g=m;if(o)throw d=0,g=0,R(p);return i=d,s=g,L(d,g)}finally{c.__wbindgen_add_to_stack_pointer(16),c.__wbindgen_export3(i,s,1)}}migrate(n,t,r){let i,s;try{const u=c.__wbindgen_add_to_stack_pointer(-16),f=P(n,c.__wbindgen_export,c.__wbindgen_export2),_=j,y=P(t,c.__wbindgen_export,c.__wbindgen_export2),b=j,v=P(r,c.__wbindgen_export,c.__wbindgen_export2),k=j;c.testengine_migrate(u,this.__wbg_ptr,f,_,y,b,v,k);var l=w().getInt32(u+0,!0),m=w().getInt32(u+4,!0),p=w().getInt32(u+8,!0),o=w().getInt32(u+12,!0),d=l,g=m;if(o)throw d=0,g=0,R(p);return i=d,s=g,L(d,g)}finally{c.__wbindgen_add_to_stack_pointer(16),c.__wbindgen_export3(i,s,1)}}modify(n,t,r){let i,s;try{const u=c.__wbindgen_add_to_stack_pointer(-16),f=P(n,c.__wbindgen_export,c.__wbindgen_export2),_=j,y=P(t,c.__wbindgen_export,c.__wbindgen_export2),b=j,v=P(r,c.__wbindgen_export,c.__wbindgen_export2),k=j;c.testengine_modify(u,this.__wbg_ptr,f,_,y,b,v,k);var l=w().getInt32(u+0,!0),m=w().getInt32(u+4,!0),p=w().getInt32(u+8,!0),o=w().getInt32(u+12,!0),d=l,g=m;if(o)throw d=0,g=0,R(p);return i=d,s=g,L(d,g)}finally{c.__wbindgen_add_to_stack_pointer(16),c.__wbindgen_export3(i,s,1)}}constructor(){const n=c.testengine_new();return this.__wbg_ptr=n,Bn.register(this,this.__wbg_ptr,this),this}get now(){return c.testengine_now(this.__wbg_ptr)}reset(){c.testengine_reset(this.__wbg_ptr)}resolveIncident(n){let t,r;try{const d=c.__wbindgen_add_to_stack_pointer(-16),g=P(n,c.__wbindgen_export,c.__wbindgen_export2),u=j;c.testengine_resolveIncident(d,this.__wbg_ptr,g,u);var i=w().getInt32(d+0,!0),s=w().getInt32(d+4,!0),l=w().getInt32(d+8,!0),m=w().getInt32(d+12,!0),p=i,o=s;if(m)throw p=0,o=0,R(l);return t=p,r=o,L(p,o)}finally{c.__wbindgen_add_to_stack_pointer(16),c.__wbindgen_export3(t,r,1)}}setVariables(n,t,r){let i,s;try{const u=c.__wbindgen_add_to_stack_pointer(-16),f=P(n,c.__wbindgen_export,c.__wbindgen_export2),_=j,y=P(t,c.__wbindgen_export,c.__wbindgen_export2),b=j;c.testengine_setVariables(u,this.__wbg_ptr,f,_,y,b,r);var l=w().getInt32(u+0,!0),m=w().getInt32(u+4,!0),p=w().getInt32(u+8,!0),o=w().getInt32(u+12,!0),d=l,g=m;if(o)throw d=0,g=0,R(p);return i=d,s=g,L(d,g)}finally{c.__wbindgen_add_to_stack_pointer(16),c.__wbindgen_export3(i,s,1)}}snapshot(){let n,t;try{const o=c.__wbindgen_add_to_stack_pointer(-16);c.testengine_snapshot(o,this.__wbg_ptr);var r=w().getInt32(o+0,!0),i=w().getInt32(o+4,!0),s=w().getInt32(o+8,!0),l=w().getInt32(o+12,!0),m=r,p=i;if(l)throw m=0,p=0,R(s);return n=m,t=p,L(m,p)}finally{c.__wbindgen_add_to_stack_pointer(16),c.__wbindgen_export3(n,t,1)}}throwError(n,t,r){let i,s;try{const u=c.__wbindgen_add_to_stack_pointer(-16),f=P(n,c.__wbindgen_export,c.__wbindgen_export2),_=j,y=P(t,c.__wbindgen_export,c.__wbindgen_export2),b=j,v=P(r,c.__wbindgen_export,c.__wbindgen_export2),k=j;c.testengine_throwError(u,this.__wbg_ptr,f,_,y,b,v,k);var l=w().getInt32(u+0,!0),m=w().getInt32(u+4,!0),p=w().getInt32(u+8,!0),o=w().getInt32(u+12,!0),d=l,g=m;if(o)throw d=0,g=0,R(p);return i=d,s=g,L(d,g)}finally{c.__wbindgen_add_to_stack_pointer(16),c.__wbindgen_export3(i,s,1)}}tickNow(n){let t,r;try{const d=c.__wbindgen_add_to_stack_pointer(-16);c.testengine_tickNow(d,this.__wbg_ptr,n);var i=w().getInt32(d+0,!0),s=w().getInt32(d+4,!0),l=w().getInt32(d+8,!0),m=w().getInt32(d+12,!0),p=i,o=s;if(m)throw p=0,o=0,R(l);return t=p,r=o,L(p,o)}finally{c.__wbindgen_add_to_stack_pointer(16),c.__wbindgen_export3(t,r,1)}}unassignUserTask(n){let t,r;try{const d=c.__wbindgen_add_to_stack_pointer(-16),g=P(n,c.__wbindgen_export,c.__wbindgen_export2),u=j;c.testengine_unassignUserTask(d,this.__wbg_ptr,g,u);var i=w().getInt32(d+0,!0),s=w().getInt32(d+4,!0),l=w().getInt32(d+8,!0),m=w().getInt32(d+12,!0),p=i,o=s;if(m)throw p=0,o=0,R(l);return t=p,r=o,L(p,o)}finally{c.__wbindgen_add_to_stack_pointer(16),c.__wbindgen_export3(t,r,1)}}updateRetries(n,t){let r,i;try{const g=c.__wbindgen_add_to_stack_pointer(-16),u=P(n,c.__wbindgen_export,c.__wbindgen_export2),f=j;c.testengine_updateRetries(g,this.__wbg_ptr,u,f,t);var s=w().getInt32(g+0,!0),l=w().getInt32(g+4,!0),m=w().getInt32(g+8,!0),p=w().getInt32(g+12,!0),o=s,d=l;if(p)throw o=0,d=0,R(m);return r=o,i=d,L(o,d)}finally{c.__wbindgen_add_to_stack_pointer(16),c.__wbindgen_export3(r,i,1)}}updateUserTask(n,t){let r,i;try{const g=c.__wbindgen_add_to_stack_pointer(-16),u=P(n,c.__wbindgen_export,c.__wbindgen_export2),f=j,_=P(t,c.__wbindgen_export,c.__wbindgen_export2),y=j;c.testengine_updateUserTask(g,this.__wbg_ptr,u,f,_,y);var s=w().getInt32(g+0,!0),l=w().getInt32(g+4,!0),m=w().getInt32(g+8,!0),p=w().getInt32(g+12,!0),o=s,d=l;if(p)throw o=0,d=0,R(m);return r=o,i=d,L(o,d)}finally{c.__wbindgen_add_to_stack_pointer(16),c.__wbindgen_export3(r,i,1)}}}Symbol.dispose&&(gn.prototype[Symbol.dispose]=gn.prototype.free);function Lr(){return{__proto__:null,"./nanobpmn_engine_bg.js":{__proto__:null,__wbg___wbindgen_throw_bb96b2010945f0bc:function(n,t){throw new Error(L(n,t))},__wbindgen_cast_0000000000000001:function(n,t){const r=L(n,t);return Rr(r)},__wbindgen_object_drop_ref:function(n){R(n)}}}}const Bn=typeof FinalizationRegistry>"u"?{register:()=>{},unregister:()=>{}}:new FinalizationRegistry(e=>c.__wbg_testengine_free(e,1));function Rr(e){Ge===ve.length&&ve.push(ve.length+1);const n=Ge;return Ge=ve[n],ve[n]=e,n}function zr(e){e<1028||(ve[e]=Ge,Ge=e)}let Ae=null;function w(){return(Ae===null||Ae.buffer.detached===!0||Ae.buffer.detached===void 0&&Ae.buffer!==c.memory.buffer)&&(Ae=new DataView(c.memory.buffer)),Ae}function L(e,n){return $r(e>>>0,n)}let Ve=null;function Xe(){return(Ve===null||Ve.byteLength===0)&&(Ve=new Uint8Array(c.memory.buffer)),Ve}function Or(e){return ve[e]}let ve=new Array(1024).fill(void 0);ve.push(void 0,null,!0,!1);let Ge=ve.length;function Fr(e){return e==null}function P(e,n,t){if(t===void 0){const m=Ye.encode(e),p=n(m.length,1)>>>0;return Xe().subarray(p,p+m.length).set(m),j=m.length,p}let r=e.length,i=n(r,1)>>>0;const s=Xe();let l=0;for(;l<r;l++){const m=e.charCodeAt(l);if(m>127)break;s[i+l]=m}if(l!==r){l!==0&&(e=e.slice(l)),i=t(i,r,r=l+e.length*3,1)>>>0;const m=Xe().subarray(i+l,i+r),p=Ye.encodeInto(e,m);l+=p.written,i=t(i,r,l,1)>>>0}return j=l,i}function R(e){const n=Or(e);return zr(e),n}let en=new TextDecoder("utf-8",{ignoreBOM:!0,fatal:!0});en.decode();const Ur=2146435072;let sn=0;function $r(e,n){return sn+=n,sn>=Ur&&(en=new TextDecoder("utf-8",{ignoreBOM:!0,fatal:!0}),en.decode(),sn=n),en.decode(Xe().subarray(e,e+n))}const Ye=new TextEncoder;"encodeInto"in Ye||(Ye.encodeInto=function(e,n){const t=Ye.encode(e);return n.set(t),{read:e.length,written:t.length}});let j=0,c;function Vr(e,n){return c=e.exports,Ae=null,Ve=null,c}async function Gr(e,n){if(typeof Response=="function"&&e instanceof Response){if(!e.ok)throw new Error(`failed to fetch Wasm: ${e.status} ${e.statusText} fetching '${e.url}'`);if(typeof WebAssembly.instantiateStreaming=="function")try{return await WebAssembly.instantiateStreaming(e,n)}catch(i){if(t(e.type)&&e.headers.get("Content-Type")!=="application/wasm")console.warn("`WebAssembly.instantiateStreaming` failed because your server does not serve Wasm with `application/wasm` MIME type. Falling back to `WebAssembly.instantiate` which is slower. Original error:\n",i);else throw i}const r=await e.arrayBuffer();return await WebAssembly.instantiate(r,n)}else{const r=await WebAssembly.instantiate(e,n);return r instanceof WebAssembly.Instance?{instance:r,module:e}:r}function t(r){switch(r){case"basic":case"cors":case"default":return!0}return!1}}async function Yr(e){if(c!==void 0)return c;e!==void 0&&(Object.getPrototypeOf(e)===Object.prototype?{module_or_path:e}=e:console.warn("using deprecated parameters for the initialization function; pass a single object instead")),e===void 0&&(e=new URL("/pr-preview/pr-95/assets/nanobpmn_engine_bg-DRNrIVE8.wasm",import.meta.url));const n=Lr();(typeof e=="string"||typeof Request=="function"&&e instanceof Request||typeof URL=="function"&&e instanceof URL)&&(e=fetch(e));const{instance:t,module:r}=await Gr(await e,n);return Vr(t)}let Ze=null;function Qr(e){return Ze||(Ze=Yr(void 0).then(()=>{}).catch(n=>{throw Ze=null,n})),Ze}function ee(e){return JSON.parse(e)}class qr{constructor(n){O(this,"engine");this.engine=n}deploy(n){return JSON.parse(this.engine.deploy(n))}createInstance(n,t){return ee(this.engine.createInstance(n,t||"{}"))}activateJobs(n,t,r,i){return JSON.parse(this.engine.activateJobs(n,t,r,i))}completeJob(n,t){return ee(this.engine.completeJob(n,t||"{}"))}completeAgentJob(n,t){const{variables:r,...i}=t??{};return ee(this.engine.completeAgentJob(n,JSON.stringify(r??{}),JSON.stringify(i??{})))}failJob(n,t,r){return ee(this.engine.failJob(n,t,r))}throwError(n,t,r){return ee(this.engine.throwError(n,t,r))}updateRetries(n,t){return ee(this.engine.updateRetries(n,t))}resolveIncident(n){return ee(this.engine.resolveIncident(n))}setVariables(n,t,r){return ee(this.engine.setVariables(n,t||"{}",r))}broadcastSignal(n,t){return ee(this.engine.broadcastSignal(n,t||"{}"))}cancelInstance(n){return ee(this.engine.cancelInstance(n))}modify(n,t,r){return ee(this.engine.modify(n,JSON.stringify(t??[]),JSON.stringify(r??[])))}completeUserTask(n,t){return ee(this.engine.completeUserTask(n,t||"{}"))}assignUserTask(n,t,r){return ee(this.engine.assignUserTask(n,t,r))}unassignUserTask(n){return ee(this.engine.unassignUserTask(n))}updateUserTask(n,t){return ee(this.engine.updateUserTask(n,t||"{}"))}correlateMessage(n,t,r){return ee(this.engine.correlateMessage(n,t,r||"{}"))}advanceTime(n){return ee(this.engine.advanceTime(n))}reset(){this.engine.reset()}events(){return JSON.parse(this.engine.events())}snapshot(){return ee(this.engine.snapshot())}free(){this.engine.free()}}async function Jr(e){return await Qr(),new qr(new gn)}class ht extends Error{constructor(t,r){super(t);O(this,"retries");this.name="JobFailure",this.retries=r==null?void 0:r.retries}}function Hr(e,n=[]){if(e.instances.filter(i=>!i.completed).length===0)return e.totalInstances>0?"completed":"idle";if(e.incidents.length>0)return"incidents";const r=new Set(n);return e.jobs.some(i=>!r.has(i.jobType))?"unhandledJobs":e.userTasks.some(i=>i.state==="Created")?"userTasks":e.timers.length>0?"timers":e.messageSubscriptions.length>0?"messages":e.signalSubscriptions.length>0?"signals":"idle"}function Wr(e,n=[]){const t=new Set(n);return[...new Set(e.jobs.map(r=>r.jobType))].filter(r=>!t.has(r)).sort()}async function Zr(e,n,t){let r;try{const i=await n(t);r=JSON.stringify(i??{})}catch(i){const s=i instanceof ht&&i.retries!==void 0?i.retries:Math.max(0,t.retries-1),l=i instanceof Error?i.message:String(i);e.failJob(t.key,s,l);return}e.completeJob(t.key,r)}async function Kr(e,n,t){let r;try{r=await n(t),JSON.stringify(r)}catch(i){const s=i instanceof ht&&i.retries!==void 0?i.retries:Math.max(0,t.retries-1),l=i instanceof Error?i.message:String(i);e.failJob(t.key,s,l);return}e.completeAgentJob(t.key,r)}async function Xr(e,n,t={}){const r=t.maxJobsPerActivation??10,i=t.lockTimeoutMs??3e4,s=t.worker??"bojtos",l=t.agents??{};for(const u of Object.keys(l))if(u in n)throw new Error(`dispatchRound: job type "${u}" is registered as both a worker and an agent — register it as exactly one`);const m=[];for(const[u,f]of Object.entries(n))for(const _ of e.activateJobs(u,r,i,s))m.push({handler:f,job:_});const p=[];for(const[u,f]of Object.entries(l))for(const _ of e.activateJobs(u,r,i,s))p.push({handler:f,job:_});for(const{handler:u,job:f}of m)await Zr(e,u,f);for(const{handler:u,job:f}of p)await Kr(e,u,f);const o=e.snapshot(),d=m.length+p.length;if(d>0)return{snapshot:o,handled:d};const g=[...Object.keys(n),...Object.keys(l)];return{snapshot:o,handled:d,reason:Hr(o,g),unhandled:Wr(o,g)}}function ei({bpmn:e}){const n=h.useRef(null),[t,r]=h.useState("loading"),[i,s]=h.useState(null),[l,m]=h.useState([]),[p,o]=h.useState(null),d=h.useRef(e),g=h.useRef(0),u=h.useRef(new Map),f=h.useCallback((S,E)=>{u.current.set(S,E)},[]),_=h.useCallback(S=>u.current.get(S),[]),y=h.useCallback((S,E)=>{const N=S.deploy(E);return d.current=E,u.current.clear(),m(N.processIds),o(null),s(null),N.processIds},[]);h.useEffect(()=>{let S=!1;return r("loading"),m([]),o(null),s(null),Jr().then(E=>{if(S){E.free();return}try{y(E,e)}catch(N){E.free(),s(String(N)),r("error");return}n.current=E,r("ready")}).catch(E=>{S||(s(String(E)),r("error"))}),()=>{var E;S=!0,(E=n.current)==null||E.free(),n.current=null,u.current.clear()}},[e]);const b=h.useCallback(S=>{const E=n.current;if(!E)return null;try{const N=S(E);return o(N),s(null),N}catch(N){return s(String(N)),null}},[]),v=h.useCallback((S,E)=>b(N=>N.createInstance(S,E)),[b]),k=h.useCallback((S,E)=>b(N=>N.completeUserTask(S,E)),[b]),C=h.useCallback(S=>b(E=>E.advanceTime(S)),[b]),W=h.useCallback((S,E)=>b(N=>N.broadcastSignal(S,E)),[b]);function Z(S,E){const[N]=S.activateJobs(E,1,3e4,"manual-control");if(!N)throw new Error(`No waiting job of type "${E}" to resolve.`);return N}const ue=h.useCallback((S,E)=>b(N=>{const z=Z(N,S);return N.completeJob(z.key,E)}),[b]),q=h.useCallback((S,E,N)=>b(z=>{const K=Z(z,S);return z.throwError(K.key,E,N)}),[b]),se=h.useCallback((S,E,N)=>b(z=>z.correlateMessage(S,E,N)),[b]),V=h.useCallback(async(S,E)=>{const N=n.current;if(!N)return null;const z=g.current;try{const K=await Xr(N,S,E);return n.current!==N||g.current!==z?null:(o(K.snapshot),s(null),K)}catch(K){return n.current!==N||g.current!==z||(o(N.snapshot()),s(String(K))),null}},[]),Y=h.useCallback(()=>{const S=n.current;if(S){g.current++;try{S.reset(),y(S,d.current)}catch(E){s(String(E))}}},[y]),$=h.useCallback(S=>{const E=n.current;if(!E)return null;g.current++;try{return E.reset(),y(E,S)}catch(N){return s(String(N)),null}},[y]);return{phase:t,error:i,processIds:l,snapshot:p,createInstance:v,stepWorkers:V,completeUserTask:k,advanceTime:C,broadcastSignal:W,completeJobManually:ue,throwJobError:q,correlateMessage:se,reset:Y,redeploy:$,setRunImage:f,getRunImage:_}}function ni(e,n){return e.slice(n)}function ti(e,n,t,r){const i=e.snapshot,s="⏸ waiting for a human — complete the task below to continue",l=i.userTasks.some(m=>m.state==="Created");if(e.handled>0){const m=i.activeElementIds.map(t),p=n.length?` via ${n.map(o=>`${t(o.from)} → ${t(o.to)}`).join(", ")}`:"";return i.completedInstances>=1?{kind:"done",text:`⏭ round handled ${e.handled} job${e.handled===1?"":"s"}${p} — ✅ process instance completed`}:l?{kind:"human",text:`⏭ round handled ${e.handled} job${e.handled===1?"":"s"}${p} — ${s}`}:{kind:"step",text:`⏭ round handled ${e.handled} job${e.handled===1?"":"s"}${p} — now at ${m.length?m.join(", "):"—"}`}}switch(e.reason){case"completed":return{kind:"done",text:"✅ process instance completed"};case"userTasks":return{kind:"human",text:s};case"timers":return{kind:"step",text:"⏱ waiting on a timer — advance the clock to continue"};case"messages":return{kind:"step",text:"✉ waiting on a message — correlate it to continue"};case"signals":return{kind:"step",text:"📶 waiting on a signal — broadcast it to continue"};case"incidents":return{kind:"error",text:"A job failed — incident on the diagram"};case"unhandledJobs":{const m=e.unhandled??[];return r&&m.length>0&&m.every(p=>r.has(p))?{kind:"human",text:s}:{kind:"error",text:`⏭ waiting on job type(s) with no worker registered: ${m.join(", ")}`}}case"idle":return{kind:"step",text:"Nothing to step — no instance is running."};default:return{kind:"step",text:e.reason?`Step blocked on an unrecognized reason: ${e.reason}`:"Nothing to step — no instance is running."}}}const ri="the Scripted or Endpoint brain";async function ii(){return await qe()===null}async function qe(e=ri){const n=navigator.gpu;if(!n)return`This browser doesn't expose WebGPU at all. Use a recent Chrome, Edge, or Safari 17+ with hardware acceleration on, or pick ${e}.`;let t;try{t=await n.requestAdapter()}catch(r){return`WebGPU adapter request failed (${r instanceof Error?r.message:String(r)}). Try ${e} instead.`}return t?null:`This browser supports the WebGPU API, but no GPU adapter is available — hardware acceleration may be off, or this device/VM has no usable GPU. Pick ${e} instead.`}const oi=[{id:"Qwen2.5-1.5B-Instruct-q4f16_1-MLC",label:"Qwen2.5 1.5B",downloadLabel:"~1.0 GB"},{id:"SmolLM2-1.7B-Instruct-q4f16_1-MLC",label:"SmolLM2 1.7B",downloadLabel:"~1.1 GB"},{id:"Llama-3.2-1B-Instruct-q4f16_1-MLC",label:"Llama 3.2 1B",downloadLabel:"~0.7 GB"},{id:"gemma-2-2b-it-q4f16_1-MLC",label:"Gemma 2 2B",downloadLabel:"~1.5 GB"},{id:"Llama-3.2-1B-Instruct-q4f32_1-MLC",label:"Llama 3.2 1B (f32, wider GPU support)",downloadLabel:"~1.1 GB"},{id:"SmolLM2-360M-Instruct-q4f32_1-MLC",label:"SmolLM2 360M (tiny, f32)",downloadLabel:"~0.6 GB"},{id:"SmolLM2-360M-Instruct-q4f16_1-MLC",label:"SmolLM2 360M (tiny)",downloadLabel:"~0.3 GB"}];function bt(e){return hn.get(e)??{}}const hn=new Map;async function ai(){if(hn.size>0)return;const{prebuiltAppConfig:e}=await pe(async()=>{const{prebuiltAppConfig:n}=await import("./vendor-webllm-DT0Ab8E6.js");return{prebuiltAppConfig:n}},[]);for(const n of e.model_list)hn.set(n.model_id,{vramRequiredMB:n.vram_required_MB,requiredFeatures:n.required_features})}const tn=oi.map(e=>({id:e.id,label:`${e.label} (${e.downloadLabel})`,downloadLabel:e.downloadLabel,...bt(e.id)})),_t=tn[0].id;async function si(){return await ai(),tn.map(e=>({...e,...bt(e.id)}))}function ft(){const e=navigator.deviceMemory;return typeof e=="number"?e*1024:null}function di(e,n=ft()){return n==null||e.vramRequiredMB==null||n>=e.vramRequiredMB?null:`${e.label} needs roughly ${Math.round(e.vramRequiredMB)} MB of GPU memory; this device looks like it has about ${Math.round(n)} MB available. It may still work, but expect it to fail or fall back to slow shared memory — try a smaller model (e.g. SmolLM2 360M) if it doesn't load.`}async function li(e){try{const{hasModelInCache:n}=await pe(async()=>{const{hasModelInCache:t}=await import("./vendor-webllm-DT0Ab8E6.js");return{hasModelInCache:t}},[]);return await n(e)}catch{return!1}}function nn(e){return/device (was )?lost|device_hung|device_removed|already been disposed|gpudevicelostinfo/i.test(e)}function Ln(){return"The GPU device was lost — the driver reset while the model was loading or running. This is a browser/driver-level failure, not a problem with the model: fully quit and reopen the browser (a lost device usually persists for the life of the GPU process), check chrome://gpu still reports hardware acceleration, and update your GPU driver if it recurs. The Scripted and Endpoint brains don't use the GPU at all."}class Ke{constructor(){O(this,"kind","browser");O(this,"model",null);O(this,"engine",null);O(this,"worker",null);O(this,"generation",0);O(this,"chat",async(n,t=512,r)=>{var s,l;const i=this.engine;if(!i||!this.model)throw new Error("BrowserBrain.chat called before connect()");try{const m=await i.chat.completions.create({messages:n,temperature:0,max_tokens:t,stream:!0});let p="";for await(const o of m){const d=((l=(s=o.choices[0])==null?void 0:s.delta)==null?void 0:l.content)??"";d&&(p+=d,r==null||r(d))}return p}catch(m){const p=m instanceof Error?m.message:String(m);throw nn(p)?(this.teardown(),new Error(`The in-browser model stopped: ${Ln()}`)):m}})}async connect(n=_t,t){var p,o;const r=await qe();if(r)throw new Error(r);if(this.engine&&this.model===n)return n;const i=++this.generation,s=d=>{i===this.generation&&(t==null||t({progress:d.progress??0,text:d.text??""}))};this.teardown();let l,m;try{const{CreateWebWorkerMLCEngine:d}=await pe(async()=>{const{CreateWebWorkerMLCEngine:g}=await import("./vendor-webllm-DT0Ab8E6.js");return{CreateWebWorkerMLCEngine:g}},[]);m=new Worker(new URL("/pr-preview/pr-95/assets/webllm.worker-Dc1cCqhL.js",import.meta.url),{type:"module"}),l=await d(m,n,{initProgressCallback:s})}catch(d){if(m==null||m.terminate(),i!==this.generation)throw new Error("cancelled");const g=d instanceof Error?d.message:String(d);if(nn(g))throw new Error(`Couldn't load ${n} in the browser (${g}). ${Ln()}`);const u=(o=(p=tn.find(f=>f.id===n))==null?void 0:p.requiredFeatures)==null?void 0:o.includes("shader-f16");throw new Error(`Couldn't load ${n} in the browser (${g}). `+(u?"This model needs WebGPU with shader-f16; try one of the f32 models in the list, or the endpoint brain.":"Try a smaller model, check your connection, or use the endpoint brain instead."))}if(i!==this.generation)throw l.unload().catch(()=>{}),m==null||m.terminate(),new Error("cancelled");return this.engine=l,this.worker=m??null,this.model=n,n}teardown(){const{engine:n,worker:t}=this;this.engine=null,this.worker=null,this.model=null,n==null||n.unload().catch(()=>{}),t==null||t.terminate()}cancelConnect(){this.generation++}dispose(){this.generation++,this.teardown()}}const wt="http://localhost:11434/v1";function yt(){var n;const e=((n=globalThis.location)==null?void 0:n.hostname)??"";return e==="localhost"||e==="127.0.0.1"||e==="[::1]"||e==="::1"}function fn(e,n={hostname:(t=>(t=globalThis.location)==null?void 0:t.hostname)()??"",origin:(r=>(r=globalThis.location)==null?void 0:r.origin)()??""}){let i;try{i=new URL(vt(e)).hostname}catch{return null}const s=l=>l==="localhost"||l==="127.0.0.1"||l==="::1"||l==="[::1]";return!s(i)||s(n.hostname)?null:`This page is served from ${n.origin||"a non-local origin"}, so it can't reach ${e}. A local model server only accepts requests from a page on localhost. Open this page at http://localhost instead, or use the Scripted or In-browser brain.`}function vt(e){let n=e.trim().replace(/\/+$/,"");return n.endsWith("/chat/completions")&&(n=n.slice(0,-17)),/\/v\d+$/.test(n)||(n=`${n}/v1`),n}class Rn extends Error{constructor(n,t){super(n),this.status=t,this.name="HttpError"}}class ci{constructor(n=wt,t="",r=""){O(this,"kind","endpoint");O(this,"baseUrl");O(this,"model",null);O(this,"models",[]);O(this,"apiKey");O(this,"requestedModel");O(this,"chat",async(n,t=512,r)=>{var o,d,g;if(!this.model)throw new Error("EndpointBrain.chat called before connect()");const i=await fetch(`${this.baseUrl}/chat/completions`,{method:"POST",headers:this.headers(),body:JSON.stringify({model:this.model,messages:n,temperature:0,max_tokens:t,stream:!0})});if(!i.ok||!i.body){const u=await i.text().catch(()=>"");throw new Error(`chat/completions HTTP ${i.status} ${i.statusText}${u?` — ${u.slice(0,300)}`:""}`)}const s=i.body.getReader(),l=new TextDecoder;let m="",p="";for(;;){const{value:u,done:f}=await s.read();if(f)break;m+=l.decode(u,{stream:!0});let _;for(;(_=m.indexOf(`
`))>=0;){const y=m.slice(0,_).trim();if(m=m.slice(_+1),!y.startsWith("data:"))continue;const b=y.slice(5).trim();if(b==="[DONE]")continue;let v;try{v=JSON.parse(b)}catch{continue}v.model&&(this.model=v.model);const k=(o=v.choices)==null?void 0:o[0],C=((d=k==null?void 0:k.delta)==null?void 0:d.content)??((g=k==null?void 0:k.message)==null?void 0:g.content)??"";C&&(p+=C,r==null||r(C))}}return p});this.baseUrl=vt(n),this.apiKey=t.trim(),this.requestedModel=r.trim()}headers(){const n={"Content-Type":"application/json"};return this.apiKey&&(n.Authorization=`Bearer ${this.apiKey}`),n}async listModels(){let n;try{n=await fetch(`${this.baseUrl}/models`,{headers:this.headers()})}catch(r){const i=fn(this.baseUrl);throw new Error(i??`Can't reach ${this.baseUrl} (${r instanceof Error?r.message:String(r)}). Is the server running? For Ollama, check the app is up — and if this page is served from another origin, allow it with OLLAMA_ORIGINS.`)}if(!n.ok)throw new Rn(`${this.baseUrl}/models returned HTTP ${n.status} ${n.statusText}`,n.status);const t=await n.json();return this.models=(t.data??[]).map(r=>r.id).filter(r=>!!r),this.models}async connect(){try{const n=await this.listModels(),t=this.requestedModel||n[0];if(!t)throw new Error(`No models available at ${this.baseUrl}. Pull one first — e.g. \`ollama pull llama3.2:3b\` — or name one explicitly.`);this.model=t}catch(n){const t=n instanceof Rn&&[404,405,501].includes(n.status);if(!this.requestedModel||!t)throw n;this.models=[],this.model=this.requestedModel}return await this.validate(),this.model}async validate(){const n=await fetch(`${this.baseUrl}/chat/completions`,{method:"POST",headers:this.headers(),body:JSON.stringify({model:this.model,messages:[{role:"user",content:"Reply with ok."}],temperature:0,max_tokens:1,stream:!1})}).catch(r=>{throw new Error(`Can't reach ${this.baseUrl}/chat/completions (${r instanceof Error?r.message:String(r)}). Check the endpoint URL, API key, model name, and any local CORS settings.`)});if(!n.ok){const r=await n.text().catch(()=>"");throw new Error(`chat/completions HTTP ${n.status} ${n.statusText}${r?` — ${r.slice(0,300)}`:""}`)}const t=await n.json().catch(()=>({}));t.model&&(this.model=t.model)}dispose(){}}const mi=[{id:"onnx-community/Florence-2-base-ft",label:"Florence-2 base",downloadLabel:"~0.4 GB"},{id:"onnx-community/Florence-2-large-ft",label:"Florence-2 large (higher quality)",downloadLabel:"~1.6 GB"}],Mt=mi.map(e=>({...e,label:`${e.label} (${e.downloadLabel})`})),xt=Mt[0].id,pi="<OCR>",zn="UNKNOWN (scripted brain — connect the in-browser model to read a photo)";function ui(e,n){if(e)return typeof e=="function"?e(n):e[n]}class gi{constructor(n){O(this,"kind","scripted-vision");O(this,"model",null);O(this,"read",async(n,t,r)=>{const i=typeof n=="string"?ui(this.lookup,n)??zn:zn;return r==null||r(i),i});this.lookup=n}dispose(){}}function hi(e){return new gi(e)}class On{constructor(){O(this,"kind","browser-vision");O(this,"model",null);O(this,"modelHandle",null);O(this,"processor",null);O(this,"loadImage",null);O(this,"generation",0);O(this,"read",async(n,t,r)=>{const i=this.modelHandle,s=this.processor,l=this.loadImage;if(!i||!s||!l||!this.model)throw new Error("BrowserVisionBrain.read called before connect()");const m=t&&t.startsWith("<")?t:pi,p=await l(n),o=s.construct_prompts(m),d=await s(p,o),g=await i.generate({...d,max_new_tokens:512,num_beams:1,do_sample:!1}),u=s.batch_decode(g,{skip_special_tokens:!1})[0],f=s.post_process_generation(u,m,p.size),_=bi(f,m);return r==null||r(_),_})}async connect(n=xt,t){var m,p;const r=await qe("the scripted-vision fallback");if(r)throw new Error(r);if(this.modelHandle&&this.model===n)return n;const i=++this.generation,s=o=>{i===this.generation&&(t==null||t({progress:(o.progress??0)/100,text:o.file?`${o.status??"loading"} ${o.file}`:o.status??""}))};this.teardown();let l;try{const{Florence2ForConditionalGeneration:o,AutoProcessor:d,load_image:g}=await pe(async()=>{const{Florence2ForConditionalGeneration:_,AutoProcessor:y,load_image:b}=await import("./transformers.web-CHuVuBL5.js");return{Florence2ForConditionalGeneration:_,AutoProcessor:y,load_image:b}},[]),u=await o.from_pretrained(n,{dtype:"fp32",device:"webgpu",progress_callback:s}),f=await d.from_pretrained(n);l={model:u,processor:f,loadImage:g}}catch(o){if(i!==this.generation)throw new Error("cancelled");const d=o instanceof Error?o.message:String(o);throw new Error(`Couldn't load ${n} in the browser (${d}). Try the smaller Florence-2 base model, check your connection, or use the scripted-vision fallback.`)}if(i!==this.generation)throw Promise.resolve((p=(m=l.model).dispose)==null?void 0:p.call(m)).catch(()=>{}),new Error("cancelled");return this.modelHandle=l.model,this.processor=l.processor,this.loadImage=l.loadImage,this.model=n,n}teardown(){var t;const n=this.modelHandle;this.modelHandle=null,this.processor=null,this.loadImage=null,this.model=null,Promise.resolve((t=n==null?void 0:n.dispose)==null?void 0:t.call(n)).catch(()=>{})}cancelConnect(){this.generation++}dispose(){this.generation++,this.teardown()}}function bi(e,n){const t=e[n];if(typeof t=="string")return t.trim();if(t&&typeof t=="object"){const r=t.labels;return Array.isArray(r)?r.join(" ").trim():JSON.stringify(t)}return""}async function _i(){return await ii()?"browser":yt()?"endpoint":"scripted"}function fi(){const[e,n]=h.useState("scripted"),t=h.useRef(!1),[r,i]=h.useState("idle"),[s,l]=h.useState(null),[m,p]=h.useState(null),[o,d]=h.useState(null),[g,u]=h.useState(null),[f,_]=h.useState(null),[y,b]=h.useState(null),[v,k]=h.useState(_t),[C,W]=h.useState(wt),[Z,ue]=h.useState(""),[q,se]=h.useState(""),[V,Y]=h.useState(null),$=h.useRef(null),[S,E]=h.useState("scripted-vision"),[N,z]=h.useState("idle"),[K,xe]=h.useState(null),[Oe,Te]=h.useState(xt),[De,Ne]=h.useState(null),[rn,je]=h.useState(null),[Fe,de]=h.useState(null),[Se,Pe]=h.useState(null),ne=h.useRef(null),Ee=h.useRef(!1),ke=h.useCallback(I=>async(...A)=>{try{return await I.chat(...A)}catch(U){const Ie=U instanceof Error?U.message:String(U);throw I instanceof Ke&&nn(Ie)&&(Y(null),p(null),i("error"),l(Ie)),U}},[]),Ce=h.useCallback(I=>async(...A)=>{try{return await I.read(...A)}catch(U){const Ie=U instanceof Error?U.message:String(U);throw nn(Ie)&&(Pe(null),Ne(null),z("error"),xe(Ie)),U}},[]);h.useEffect(()=>{qe().then(I=>{_(I),u(I===null),t.current||(t.current=!0,_i().then(n))}),qe("the scripted-vision fallback").then(I=>{de(I),Ee.current||(Ee.current=!0,E(I===null?"browser-vision":"scripted-vision"))})},[]),h.useEffect(()=>{let I=!1;return b(null),li(v).then(A=>{I||b(A)}),()=>{I=!0}},[v]),h.useEffect(()=>()=>{var I;return(I=$.current)==null?void 0:I.dispose()},[]),h.useEffect(()=>()=>{var I;return(I=ne.current)==null?void 0:I.dispose()},[]);const F=h.useCallback(I=>{n(I),i("idle"),l(null),p(null),d(null),Y(null)},[]),_e=h.useCallback(I=>{var A,U;Ee.current=!0,(A=ne.current)==null||A.cancelConnect(),(U=ne.current)==null||U.dispose(),ne.current=null,E(I),z("idle"),xe(null),Ne(null),je(null),Pe(null)},[]),ge=h.useCallback(()=>{var I;(I=$.current)==null||I.dispose(),$.current=null,Y(null),p(null)},[]),we=h.useCallback(()=>{$.current instanceof Ke&&$.current.cancelConnect(),ge(),i("idle"),d(null),l(null)},[ge]),Je=h.useCallback(async()=>{var I;if(e==="scripted"){Y(null),i("ready");return}if(e==="endpoint"){const A=fn(C);if(A){ge(),l(A),i("error");return}}i("connecting"),l(null),d(null);try{if(e==="browser"){const A=$.current instanceof Ke?$.current:new Ke;$.current&&$.current!==A&&$.current.dispose(),$.current=A;const U=await A.connect(v,d);p(U),Y(()=>ke(A)),b(!0)}else{(I=$.current)==null||I.dispose();const A=new ci(C,q,Z);$.current=A;const U=await A.connect();p(U),Y(()=>ke(A))}i("ready")}catch(A){const U=A instanceof Error?A.message:String(A);if(U==="cancelled")return;l(U),i("error"),Y(null)}finally{d(null)}},[e,v,C,Z,q,ge,ke]),ie=h.useCallback(()=>{var I;(I=ne.current)==null||I.dispose(),ne.current=null,Pe(null),Ne(null)},[]),Be=h.useCallback(()=>{var I;(I=ne.current)==null||I.cancelConnect(),ie(),z("idle"),je(null),xe(null)},[ie]),Le=h.useCallback(async()=>{if(S==="scripted-vision"){ie(),z("ready"),xe(null);return}z("connecting"),xe(null),je(null);try{const I=ne.current instanceof On?ne.current:new On;ne.current&&ne.current!==I&&ne.current.dispose(),ne.current=I;const A=await I.connect(Oe,je);Ne(A),Pe(()=>Ce(I)),z("ready")}catch(I){const A=I instanceof Error?I.message:String(I);if(A==="cancelled")return;xe(A),z("error"),Pe(null),Ne(null)}finally{je(null)}},[S,Oe,ie,Ce]);return{kind:e,setKind:F,status:r,error:s,modelInUse:m,progress:o,webgpu:g,webgpuReason:f,browserModelCached:y,cancelConnect:we,browserModel:v,setBrowserModel:k,endpointUrl:C,setEndpointUrl:W,endpointModel:Z,setEndpointModel:ue,apiKey:q,setApiKey:se,connect:Je,chat:V,visionKind:S,setVisionKind:_e,visionStatus:N,visionError:K,visionModel:Oe,setVisionModel:Te,visionModelInUse:De,visionProgress:rn,visionWebgpuReason:Fe,connectVision:Le,cancelVisionConnect:Be,vision:Se}}const bn="#s=",wi=["scripted","browser","endpoint"];function yi(e){return typeof e=="string"&&wi.includes(e)}function vi(e){try{const n=JSON.parse(e);if(n&&typeof n=="object"){const t=n,r={};return yi(t.brain)&&(r.brain=t.brain),r}}catch{}return{}}function Nt(e=location.hash){if(!e.startsWith(bn))return{};let n;try{n=decodeURIComponent(e.slice(bn.length))}catch{return{}}return vi(n)}function Mi(e){const n=Object.entries(e).filter(([,t])=>t!==void 0);return n.length===0?"":bn+encodeURIComponent(JSON.stringify(Object.fromEntries(n)))}function xi(e){const n={...Nt(),...e},t=Mi(n),r=new URL(location.href);r.hash=t,history.replaceState(history.state,"",r)}const Fn=[{kind:"scripted",label:"Scripted",hint:"No model. The example's stand-in decides — deterministic and offline."},{kind:"browser",label:"In-browser (WebGPU)",hint:"A small quantised model on your GPU. First run downloads weights."},{kind:"endpoint",label:"API endpoint",hint:"Any OpenAI-compatible server. Ollama by default. Local pages only."}],Un=[{kind:"scripted-vision",label:"Scripted",hint:"No model. The example's known plate is returned — deterministic and offline."},{kind:"browser-vision",label:"In-browser (WebGPU)",hint:"Reads the photo with a vision model on your GPU. First run downloads weights."}];function Ni({brain:e,showText:n=!0,showVision:t=!1}){return a.jsxs("div",{className:"brain",children:[n&&a.jsx(Ei,{brain:e}),n&&t&&a.jsx("hr",{className:"brain-divider"}),t&&a.jsx(ki,{brain:e})]})}function Ei({brain:e}){const n=Fn.find(o=>o.kind===e.kind),t=fn(e.endpointUrl),r=yt(),[i,s]=h.useState(tn);h.useEffect(()=>{si().then(s)},[]);const l=i.find(o=>o.id===e.browserModel),m=l?di(l,ft()):null,p=e.webgpu===!0?"browser":r&&e.webgpu===!1?"endpoint":null;return a.jsxs("div",{className:"brain-section",children:[a.jsxs("div",{className:"brain-kinds",children:[Fn.map(o=>a.jsxs(J,{size:"sm",variant:e.kind===o.kind?"default":"secondary",onClick:()=>e.setKind(o.kind),children:[o.label,o.kind===p&&a.jsx(H,{variant:"info",className:"brain-recommended-badge",children:"recommended"})]},o.kind)),e.status==="ready"&&e.kind!=="scripted"&&a.jsx(H,{variant:"success",children:e.modelInUse??"connected"}),e.status==="connecting"&&a.jsx(H,{variant:"info",children:"connecting…"}),e.status==="error"&&a.jsx(H,{variant:"danger",children:"not connected"})]}),a.jsx("p",{className:"field-hint",children:n.hint}),e.kind==="browser"&&a.jsxs("div",{className:"brain-config",children:[a.jsxs("div",{className:"field",children:[a.jsx(ze,{htmlFor:"browser-model",children:"Model"}),a.jsxs(nt,{value:e.browserModel,onValueChange:e.setBrowserModel,disabled:e.status==="connecting",children:[a.jsx(tt,{id:"browser-model",children:a.jsx(rt,{})}),a.jsx(it,{children:i.map(o=>a.jsx(ot,{value:o.id,children:o.label},o.id))})]}),e.browserModelCached===!0&&a.jsx("p",{className:"field-hint",children:"Already downloaded in this browser — connecting will be fast."}),e.browserModelCached===!1&&a.jsx("p",{className:"field-hint",children:"Not downloaded yet — connecting fetches the weights once, then caches them for next time."})]}),e.webgpu===!1&&e.webgpuReason&&a.jsxs(le,{variant:"destructive",children:[a.jsx(ce,{children:"No WebGPU in this browser"}),a.jsx(me,{children:e.webgpuReason})]}),e.webgpu!==!1&&m&&a.jsxs(le,{variant:"destructive",children:[a.jsx(ce,{children:"This model may not fit in GPU memory"}),a.jsx(me,{children:m})]})]}),e.kind==="endpoint"&&a.jsxs("div",{className:"brain-config",children:[a.jsxs("div",{className:"field",children:[a.jsx(ze,{htmlFor:"endpoint-url",children:"Endpoint"}),a.jsx(an,{id:"endpoint-url",value:e.endpointUrl,onChange:o=>e.setEndpointUrl(o.target.value),disabled:e.status==="connecting"}),a.jsxs("p",{className:"field-hint",children:["Ollama allows ",a.jsx("code",{children:"localhost"})," origins out of the box; set"," ",a.jsx("code",{children:"OLLAMA_ORIGINS"})," only when serving this page from another host. Best for local development — a hosted copy of this page can't reach a server on your machine at all."]}),t&&a.jsxs(le,{variant:"destructive",children:[a.jsx(ce,{children:"A local server won't work from this URL"}),a.jsx(me,{children:t})]})]}),a.jsxs("div",{className:"field",children:[a.jsx(ze,{htmlFor:"endpoint-model",children:"Model (blank = first served)"}),a.jsx(an,{id:"endpoint-model",placeholder:"llama3.2:3b",value:e.endpointModel,onChange:o=>e.setEndpointModel(o.target.value),disabled:e.status==="connecting"})]}),a.jsxs("div",{className:"field",children:[a.jsx(ze,{htmlFor:"endpoint-key",children:"API key (optional)"}),a.jsx(an,{id:"endpoint-key",type:"password",value:e.apiKey,onChange:o=>e.setApiKey(o.target.value),disabled:e.status==="connecting"})]})]}),e.kind!=="scripted"&&a.jsxs("div",{className:"brain-actions",children:[a.jsx(J,{size:"sm",onClick:()=>void e.connect(),disabled:e.status==="connecting",children:e.status==="ready"?"Reconnect":"Connect"}),e.status==="connecting"&&e.kind==="browser"&&a.jsx(J,{size:"sm",variant:"secondary",onClick:e.cancelConnect,children:"Cancel"}),e.progress&&a.jsxs("span",{className:"field-hint",children:[Math.round(e.progress.progress*100),"% —"," ",e.progress.text]})]}),e.error&&a.jsxs(le,{variant:"destructive",children:[a.jsx(ce,{children:"Couldn't connect"}),a.jsx(me,{children:e.error})]})]})}function ki({brain:e}){const n=Un.find(r=>r.kind===e.visionKind),t=e.webgpu===!0?"browser-vision":null;return a.jsxs("div",{className:"brain-section brain-vision",children:[a.jsx(ze,{children:"Vision (reads the image)"}),a.jsxs("div",{className:"brain-kinds",children:[Un.map(r=>a.jsxs(J,{size:"sm",variant:e.visionKind===r.kind?"default":"secondary",onClick:()=>e.setVisionKind(r.kind),children:[r.label,r.kind===t&&a.jsx(H,{variant:"info",className:"brain-recommended-badge",children:"recommended"})]},r.kind)),e.visionStatus==="ready"&&e.visionKind==="browser-vision"&&a.jsx(H,{variant:"success",children:e.visionModelInUse??"connected"}),e.visionStatus==="connecting"&&a.jsx(H,{variant:"info",children:"connecting…"}),e.visionStatus==="error"&&a.jsx(H,{variant:"danger",children:"not connected"})]}),a.jsx("p",{className:"field-hint",children:n.hint}),e.visionKind==="scripted-vision"&&e.webgpu===!1&&e.visionWebgpuReason&&a.jsxs(le,{variant:"destructive",children:[a.jsx(ce,{children:"No WebGPU in this browser"}),a.jsx(me,{children:e.visionWebgpuReason})]}),e.visionKind==="browser-vision"&&a.jsxs("div",{className:"brain-config",children:[a.jsxs("div",{className:"field",children:[a.jsx(ze,{htmlFor:"vision-model",children:"Model"}),a.jsxs(nt,{value:e.visionModel,onValueChange:e.setVisionModel,disabled:e.visionStatus==="connecting",children:[a.jsx(tt,{id:"vision-model",children:a.jsx(rt,{})}),a.jsx(it,{children:Mt.map(r=>a.jsx(ot,{value:r.id,children:r.label},r.id))})]}),a.jsx("p",{className:"field-hint",children:"Connecting downloads the weights once (size shown above), then caches them — every token is read on your GPU, no server."})]}),e.webgpu===!1&&e.visionWebgpuReason&&a.jsxs(le,{variant:"destructive",children:[a.jsx(ce,{children:"No WebGPU in this browser"}),a.jsx(me,{children:e.visionWebgpuReason})]})]}),e.visionKind==="browser-vision"&&a.jsxs("div",{className:"brain-actions",children:[a.jsx(J,{size:"sm",onClick:()=>void e.connectVision(),disabled:e.visionStatus==="connecting",children:e.visionStatus==="ready"?"Reconnect":"Connect"}),e.visionStatus==="connecting"&&a.jsx(J,{size:"sm",variant:"secondary",onClick:e.cancelVisionConnect,children:"Cancel"}),e.visionProgress&&a.jsxs("span",{className:"field-hint",children:[Math.round(e.visionProgress.progress*100),"% —"," ",e.visionProgress.text]})]}),e.visionError&&a.jsxs(le,{variant:"destructive",children:[a.jsx(ce,{children:"Couldn't connect the vision brain"}),a.jsx(me,{children:e.visionError})]})]})}function Ii({imageInput:e,value:n,onSelect:t,disabled:r=!1}){const[i,s]=h.useState(null),[l,m]=h.useState(!1),p=h.useRef(null),o=h.useId(),d=h.useId(),g=h.useCallback(_=>{s(URL.createObjectURL(_)),t({imageName:_.name,pixels:_})},[t]);h.useEffect(()=>{if(i)return()=>URL.revokeObjectURL(i)},[i]);const u=h.useCallback(_=>{const y=_==null?void 0:_[0];y&&y.type.startsWith("image/")&&g(y)},[g]),f=(n==null?void 0:n.imageId)!=null?e.seedImages.find(_=>_.id===n.imageId):void 0;return a.jsxs("div",{className:"image-input",children:[e.label&&a.jsx("p",{className:"field-hint",children:e.label}),a.jsx("p",{className:"image-input-label",id:o,children:"Seed photos"}),a.jsx("div",{className:"image-gallery",role:"group","aria-labelledby":o,children:e.seedImages.map(_=>{const y=(n==null?void 0:n.imageId)===_.id;return a.jsxs("button",{type:"button","aria-pressed":y,className:`image-thumb${y?" image-thumb--selected":""}`,disabled:r,title:_.label??_.id,onClick:()=>{s(null),p.current&&(p.current.value=""),t({imageId:_.id,pixels:_.file})},children:[a.jsx("img",{src:_.thumb??_.file,alt:_.label??_.id}),_.label&&a.jsx("span",{children:_.label})]},_.id)})}),a.jsx("label",{className:"image-input-label",htmlFor:d,children:"Or upload your own photo"}),a.jsxs("div",{className:`image-drop${l?" image-drop--over":""}`,onDragOver:_=>{_.preventDefault(),r||m(!0)},onDragLeave:()=>m(!1),onDrop:_=>{_.preventDefault(),m(!1),r||u(_.dataTransfer.files)},children:[a.jsx("input",{ref:p,id:d,type:"file",accept:"image/*",disabled:r,onChange:_=>u(_.target.files)}),a.jsx("p",{className:"field-hint",children:"Drag a photo here, or pick one. Uploading a photo the model has never seen is the proof this runs for real — nothing leaves your browser."})]}),(i||f)&&a.jsxs("div",{className:"image-preview",children:[a.jsx("img",{src:i??(f==null?void 0:f.file),alt:i?(n==null?void 0:n.imageName)??"uploaded photo":(f==null?void 0:f.label)??(f==null?void 0:f.id)??"selected photo"}),a.jsx("span",{className:"field-hint",children:i?`Uploaded: ${(n==null?void 0:n.imageName)??"your photo"}`:`Selected: ${(f==null?void 0:f.label)??(f==null?void 0:f.id)}`}),a.jsx("button",{type:"button",className:"image-clear-btn",disabled:r,onClick:()=>{s(null),p.current&&(p.current.value=""),t(null)},children:"Clear"})]})]})}function Et(e){return typeof e=="object"&&e!==null}function od(e){const n=new Set,t=r=>{Et(r)&&(typeof r.key=="string"&&n.add(r.key),Array.isArray(r.components)&&r.components.forEach(t))};return t(e),n}function Ti(e){const n={},t=r=>{Et(r)&&(typeof r.key=="string"&&"defaultValue"in r&&(n[r.key]=r.defaultValue??""),Array.isArray(r.components)&&r.components.forEach(t))};return t(e),n}const ji="wdf:section:";function kt(e){return ji+e}function $n(e){try{const n=window.localStorage.getItem(kt(e));return n==="1"?!0:n==="0"?!1:void 0}catch{return}}function Si(e,n){try{window.localStorage.setItem(kt(e),n?"1":"0")}catch{}}function Pi(e,n=!0){const[t,r]=h.useState(()=>$n(e)??n);h.useEffect(()=>{r($n(e)??n)},[e,n]);const i=h.useCallback(s=>{r(s),Si(e,s)},[e]);return[t,i]}function ye({sectionId:e,title:n,description:t,defaultOpen:r=!0,className:i,children:s,...l}){const[m,p]=Pi(e,r);return a.jsx(Lt,{className:["panel",i].filter(Boolean).join(" "),"data-tour":l["data-tour"],children:a.jsxs(Rt,{open:m,onOpenChange:p,children:[a.jsxs(zt,{className:"panel-trigger",children:[a.jsxs("span",{className:"panel-trigger-text",children:[a.jsx("span",{className:"panel-title",children:n}),t!=null&&a.jsx("span",{className:"panel-desc",children:t})]}),a.jsx(Ot,{className:"panel-chevron","aria-hidden":!0})]}),a.jsx(Ft,{children:a.jsx(Ut,{children:s})})]})})}function Ai(e){return e.entries!==void 0}function Di(e){const n=[];let t=null;for(const r of e)r.turn!==void 0?t&&t.turn===r.turn?t.entries.push(r):(t={turn:r.turn,entries:[r]},n.push(t)):(t=null,n.push(r));return n}function Vn(e){if(e===void 0)return"undefined";try{return JSON.stringify(e)}catch{return"[unserializable value]"}}function Ci({activation:e,result:n,labelFor:t}){const r=e.elementId??"";return a.jsxs("div",{className:"timeline-tool",children:[a.jsxs("div",{className:"timeline-tool-head",children:[a.jsx(H,{variant:"info",children:"tool"}),a.jsx("strong",{children:t(r)||r}),a.jsx("code",{children:r})]}),e.args!==void 0&&Object.keys(e.args).length>0&&a.jsxs("div",{className:"timeline-kv",children:[a.jsx("span",{className:"timeline-kv-label",children:"arguments"}),a.jsx("code",{children:Vn(e.args)})]}),a.jsxs("div",{className:"timeline-kv",children:[a.jsx("span",{className:"timeline-kv-label",children:"returned"}),a.jsx("code",{children:n?Vn(n.result):"— waiting for the job to complete —"})]})]})}function Bi({group:e,labelFor:n}){const t=e.entries.find(o=>o.kind==="llm"),r=e.entries.filter(o=>o.kind==="agent"&&o.elementId),i=e.entries.filter(o=>o.kind==="vars"&&o.elementId),s=e.entries.filter(o=>o.kind==="agent"&&!o.elementId),l=e.entries.filter(o=>o.kind==="error"),m=new Set(r.map(o=>o.elementId)),p=e.entries.filter(o=>o.kind==="tool"||o.kind==="vars"&&o.elementId&&!m.has(o.elementId)).sort((o,d)=>o.id-d.id);return a.jsxs("div",{className:"timeline-turn",children:[a.jsxs("div",{className:"timeline-turn-head",children:[a.jsxs(H,{variant:t!=null&&t.pending?"warning":"neutral",children:["Turn ",e.turn]}),(t==null?void 0:t.pending)&&a.jsx("span",{className:"timeline-pending",children:"thinking…"})]}),t&&a.jsx("blockquote",{className:"timeline-reply",children:t.text}),s.map(o=>a.jsx("div",{className:"timeline-note",children:o.text},o.id)),r.map(o=>a.jsx(Ci,{activation:o,result:i.find(d=>d.elementId===o.elementId),labelFor:n},o.id)),p.map(o=>a.jsxs("div",{className:`log-line log-${o.kind}`,children:[o.pending?"⏳ ":"",o.text]},o.id)),l.map(o=>a.jsxs("div",{className:"timeline-error",children:["⚠ ",o.text]},o.id))]})}function Li({log:e,elementStats:n=[],incidents:t=[],labelFor:r=i=>i}){const i=h.useMemo(()=>Di(e),[e]),[s,l]=h.useState(!1),m=h.useRef(null);h.useEffect(()=>{const o=m.current;o&&(o.scrollTop=o.scrollHeight)},[i]);const p=()=>{var g;const o={log:e.map(({id:u,...f})=>f),elementStats:n,incidents:t},d=JSON.stringify(o,null,2);(g=navigator.clipboard)!=null&&g.writeText&&navigator.clipboard.writeText(d).then(()=>{l(!0),setTimeout(()=>l(!1),1500)}).catch(()=>{})};return a.jsxs(ye,{sectionId:"activity",className:"grow",title:"Activity",description:"Agent turns, model replies, and tool calls — read top to bottom as a story.",children:[a.jsx("div",{className:"timeline-toolbar",children:a.jsx(J,{variant:"secondary",size:"sm",onClick:p,children:s?"Copied!":"Copy run as JSON"})}),a.jsx("div",{className:"timeline",ref:m,children:i.length===0?a.jsx("div",{className:"log-empty",children:"Press Run or Step to start."}):i.map(o=>Ai(o)?a.jsx(Bi,{group:o,labelFor:r},`turn-${o.turn}-${o.entries[0].id}`):a.jsxs("div",{className:`log-line log-${o.kind}`,children:[o.pending?"⏳ ":"",o.text]},o.id))}),(n.length>0||t.length>0)&&a.jsxs("div",{className:"timeline-engine-view",children:[n.length>0&&a.jsxs("div",{className:"timeline-stats",children:[a.jsx("span",{className:"timeline-kv-label",children:"Element completion"}),a.jsx("ul",{children:n.filter(o=>o.completed>0||(o.active??0)>0).map(o=>a.jsxs("li",{children:[a.jsx("code",{children:r(o.elementId)||o.elementId})," ","completed ",o.completed,o.active?`, ${o.active} active`:""]},o.elementId))})]}),t.length>0&&a.jsxs("div",{className:"timeline-incidents",children:[a.jsx("span",{className:"timeline-kv-label",children:"Incidents"}),a.jsx("ul",{children:t.map((o,d)=>a.jsxs("li",{children:[a.jsx("code",{children:r(o.elementId)||o.elementId})," —"," ",o.reason]},`${o.elementId}-${d}`))})]})]})]})}const fe={diagram:"diagram",runButton:"run-button",variablesPanel:"variables-panel",codePanel:"code-panel",brainPanel:"brain-panel"};function Gn(e){return`[data-tour="${e}"]`}function Ri(e=location.search){return new URLSearchParams(e).get("tour")}function zi(e,n){var t;return((t=e.elementStats.find(r=>r.elementId===n))==null?void 0:t.completed)??0}function Oi(e,n){return!e||e.kind==="click"||!n?!1:e.kind==="activeElement"?n.activeElementIds.includes(e.elementId):zi(n,e.elementId)>=(e.atLeast??1)}function Fi(e){return"anchor"in e?Gn(e.anchor):`${Gn(fe.diagram)} [data-element-id="${Ui(e.elementId)}"]`}function Ui(e){return typeof CSS<"u"&&typeof CSS.escape=="function"?CSS.escape(e):e.replace(/[^a-zA-Z0-9_-]/g,n=>`\\${n}`)}function $i(e){return e.map(n=>{const t=!!n.waitFor&&n.waitFor.kind!=="click";return{element:Fi(n.target),popover:{title:n.title,description:t?`${n.description} (continues automatically once you reach that point — or use Next to skip ahead)`:n.description,showButtons:["next","previous","close"]},disableActiveInteraction:!1,skipMissingElement:n.skipMissingElement??!0}})}async function Vi(e,n={}){var s;const[{driver:t}]=await Promise.all([pe(()=>import("./driver.js-bj_ppY-Q.js"),[]),pe(()=>Promise.resolve({}),__vite__mapDeps([0]))]),r=$i(e),i=t({steps:r,showProgress:!0,allowClose:!0,skipMissingElement:!0,onHighlighted:(l,m,{index:p})=>{var o;p!==void 0&&((o=n.onIndexChange)==null||o.call(n,p))},onDestroyed:()=>{var l;(l=n.onDestroyed)==null||l.call(n)}});return i.drive(),(s=n.onIndexChange)==null||s.call(n,i.getActiveIndex()??0),{moveNext:()=>i.moveNext(),activeIndex:()=>i.getActiveIndex()??-1,destroy:()=>i.destroy()}}const Gi=300;function Yi(e,n){const[t,r]=h.useState(!1),i=h.useRef(null),s=h.useRef(0),l=h.useRef(-1),m=h.useRef(null),p=h.useRef(n);h.useEffect(()=>{p.current=n},[n]);const o=h.useCallback(()=>{m.current!==null&&(clearInterval(m.current),m.current=null)},[]),d=h.useRef(0),g=h.useCallback(()=>{var f;d.current+=1,o(),(f=i.current)==null||f.destroy(),i.current=null,r(!1)},[o]),u=h.useCallback(()=>{if(!e||e.steps.length===0||i.current)return;const f=d.current+=1;Vi(e.steps,{onIndexChange:_=>{s.current=_},onDestroyed:()=>{o(),i.current=null,r(!1)}}).then(_=>{if(f!==d.current){_.destroy();return}i.current=_,r(!0),m.current=setInterval(()=>{const y=s.current;if(y===l.current)return;const b=e.steps[y];b&&Oi(b.waitFor,p.current())&&(l.current=y,_.moveNext())},Gi)})},[e,o]);return h.useEffect(()=>g,[g]),{active:t,start:u,stop:g}}const Ue=650,dn="__agent__",Yn="__model__",Qn="__template__:",Qi=h.lazy(async()=>{await Promise.all([pe(()=>Promise.resolve({}),__vite__mapDeps([1])),pe(()=>Promise.resolve({}),__vite__mapDeps([2]))]);const{RuntimeDiagram:e}=await pe(async()=>{const{RuntimeDiagram:n}=await import("./RuntimeDiagram-B2IYfHo7.js");return{RuntimeDiagram:n}},__vite__mapDeps([3,4,5]));return{default:e}}),ln=h.lazy(()=>pe(()=>import("./MonacoEditor-DTrlhpcf.js").then(e=>e.M),__vite__mapDeps([6,4,7]))),qi=h.lazy(()=>pe(()=>import("./vendor-modeler-CkziDt-P.js"),__vite__mapDeps([8,4,5,9,10,11,12,1,2]))),qn=h.lazy(async()=>{const{FormRenderer:e}=await pe(async()=>{const{FormRenderer:n}=await import("./FormRenderer-gjNQXlwV.js");return{FormRenderer:n}},__vite__mapDeps([13,4,11,9,10,14]));return{default:e}});function cn(e,n){try{return JSON.stringify(e??{},null,n)}catch{return"[unserializable value]"}}function Ji({example:e,initialBrainKind:n,initialTourId:t}){var yn,vn,Mn,xn,Nn,En,kn,In;const[r,i]=h.useState(e.bpmn),s=fi(),[l,m]=h.useState(null);h.useEffect(()=>{n&&n!==s.kind&&s.setKind(n)},[]),h.useEffect(()=>{xi({brain:s.kind})},[s.kind]);const[p,o]=h.useState(()=>Object.fromEntries(e.handlers.map(M=>[M.elementId,M.source]))),[d,g]=h.useState(e.scriptedAgent??""),[u,f]=h.useState(()=>Qe(e.templates)),_=h.useMemo(()=>kr(e,p,r,u),[e,p,r,u]),y=_.model,b=ei({bpmn:_.resolvedBpmn}),v=Yi(e.tour,()=>b.snapshot);h.useEffect(()=>{var M;t&&((M=e.tour)==null?void 0:M.id)===t&&v.start()},[]);const k=y.startFormId?((yn=e.forms)==null?void 0:yn[y.startFormId])??null:null,[C,W]=h.useState(()=>({...e.seed,...k?Ti(k):{}})),[Z,ue]=h.useState(y.agent?dn:((vn=e.handlers[0])==null?void 0:vn.elementId)??""),[q,se]=h.useState(!1),[V,Y]=h.useState(!1),[$,S]=h.useState(null),[E,N]=h.useState([]),[z,K]=h.useState({}),[xe,Oe]=h.useState(!1),Te=h.useRef(null),[De,Ne]=h.useState({}),[rn,je]=h.useState(!1),Fe=h.useRef(null),de=h.useRef(!1),Se=h.useRef(0),Pe=h.useRef(0),ne=h.useRef({current:void 0}),Ee=h.useRef({}),ke=h.useRef({}),Ce=h.useMemo(()=>{const M=new Map;for(const x of y.processes){for(const T of x.tasks)M.set(T.elementId,T.label);for(const T of x.agents){M.set(T.elementId,T.label);for(const B of T.tools)M.set(B.elementId,B.label)}for(const T of x.userTasks)M.set(T.elementId,T.label)}return x=>M.get(x)??x},[y]),F=h.useCallback(M=>{N(x=>{if(M.key){const T=x.findIndex(B=>B.key===M.key);if(T>=0){const B=[...x];return B[T]={...B[T],...M},B}}return[...x,{...M,id:Pe.current++}].slice(-80)})},[]),_e=h.useMemo(()=>{var M;return((M=b.snapshot)==null?void 0:M.userTasks.find(x=>x.state==="Created"))??null},[b.snapshot]),ge=h.useMemo(()=>{const M=y.processes.flatMap(T=>T.tasks),x=new Map;for(const T of e.handlers){if(!T.manualControl)continue;const B=M.find(D=>D.elementId===T.elementId);B&&x.set(B.jobType,{...T.manualControl,elementId:T.elementId})}return x},[e.handlers,y]),we=h.useMemo(()=>{if(!b.snapshot)return null;for(const M of b.snapshot.jobs){const x=ge.get(M.jobType);if(x&&M.state==="Created")return{job:M,control:x}}return null},[b.snapshot,ge]),Je=h.useMemo(()=>{if(!y.agent||!b.snapshot)return[];const M=new Map(b.snapshot.elementStats.map(x=>[x.elementId,x.completed]));return y.agent.tools.filter(x=>(M.get(x.elementId)??0)===0)},[y.agent,b.snapshot]),ie=_e?y.userTasks.find(M=>M.elementId===_e.elementId):void 0,Be=ie!=null&&ie.formId?((Mn=e.forms)==null?void 0:Mn[ie.formId])??null:null,Le=h.useCallback(async(M,x,T,B)=>{var he,re,ae;let D=T,oe=0;for(;Se.current===B&&D&&D.completedInstances<1&&oe++<80;){const X=await b.stepWorkers(M,{agents:x});if(Se.current!==B)return D;D=(X==null?void 0:X.snapshot)??D;const te=(he=D.instances[0])==null?void 0:he.variables;if(te&&K({...te}),D.userTasks.some(G=>G.state==="Created")){F({kind:"human",text:"⏸ waiting for a human — complete the task below to continue"});break}if(!X){F({kind:"error",text:"▶ run stopped — no dispatch round was returned"});break}if(X.handled===0){const G=D.messageSubscriptions[0];if(X.reason==="messages"&&G){F({kind:"vars",text:`📨 correlating message "${G.messageName}" (key: ${G.correlationKey})`,elementId:G.elementId});const Q=b.correlateMessage(G.messageName,G.correlationKey,"{}");if(Q){D=Q;const be=(re=D.instances[0])==null?void 0:re.variables;be&&K({...be}),await new Promise(Re=>setTimeout(Re,Ue));continue}F({kind:"error",text:`▶ run stopped — correlating "${G.messageName}" (key: ${G.correlationKey}) failed`,elementId:G.elementId})}if(X.reason==="signals"&&D.signalSubscriptions.length>0){const Q=D.signalSubscriptions[0],be=b.broadcastSignal(Q.signalName,"{}");if(be){D=be,F({kind:"vars",text:`📡 broadcasting signal "${Q.signalName}" — every waiting subscription unblocks`,elementId:Q.elementId});const Re=(ae=D.instances[0])==null?void 0:ae.variables;Re&&K({...Re}),await new Promise(on=>setTimeout(on,Ue));continue}F({kind:"error",text:`▶ run stopped — broadcasting signal "${Q.signalName}" failed`,elementId:Q.elementId})}break}await new Promise(G=>setTimeout(G,Ue))}return D&&D.completedInstances>=1?F({kind:"done",text:"✅ process instance completed"}):D&&D.incidentElementIds.length>0&&F({kind:"error",text:"A job failed — incident on the diagram"}),D},[b,F]),I=h.useCallback(async M=>{var D,oe,he;if(!we||de.current)return;const{job:x,control:T}=we,B=++Se.current;de.current=!0,se(!0);try{let re,ae;if(M==="complete")re=b.completeJobManually(x.jobType,"{}"),ae="  ↳ completed normally";else if(T.action.kind==="timer"){const X=((oe=(D=b.snapshot)==null?void 0:D.timers[0])==null?void 0:oe.dueInMs)??0;re=b.advanceTime(Math.max(X,0)+1),ae="  ↳ advanced the clock — timer fired"}else{const{errorCode:X,message:te}=T.action;re=b.throwJobError(x.jobType,X,te),ae=`  ↳ threw BPMN error ${X}: ${te}`}if(re){F({kind:"vars",text:ae,elementId:x.elementId});const X=(he=re.instances[0])==null?void 0:he.variables;X&&K({...X}),await new Promise(te=>setTimeout(te,Ue)),await Le(Ee.current,ke.current,re,B)}else F({kind:"error",text:"  ↳ failed to resolve the manual job",elementId:x.elementId})}finally{de.current=!1,se(!1)}},[we,b,F,Le]),A=h.useCallback(async()=>{var X;let M=null;try{y.agent&&d.trim()&&(M=hr(d))}catch(te){return S(te instanceof Error?te.message:String(te)),null}ne.current={current:void 0};let x;if(e.imageInput){const te=s.vision;x={read:te??hi(e.scriptedVision).read,live:!!te,resolve:Q=>b.getRunImage(Q)}}const T=fr(y,_.handlers,F,ne.current,x);for(const te of ge.keys())delete T[te];const B={};if(y.agents.length>0){if(s.kind!=="scripted"&&s.chat){const G=new Map;for(const Q of y.agents)G.set(Q.jobType,[...G.get(Q.jobType)??[],Q]);for(const[Q,be]of G)B[Q]=Br(be,s.chat,F,{turnRef:ne.current,requiredTools:e.requiredTools})}else if(M&&y.agent){const G=y.agent.elementId;B[y.agent.jobType]=async Q=>{if(Q.elementId!==G)throw new Error(`No scripted agent handler for "${Q.elementId}" — only "${G}" (the primary process's first agent host) is driven by the scripted brain. Use a live brain to exercise more than one host.`);const be=await M(Q),Re=(be.activateElements??[]).map(on=>on.elementId).join(", ");return F({kind:"agent",text:be.completionConditionFulfilled?"🤖 scripted agent: done":`🤖 scripted agent: calling ${Re||"(nothing)"}`}),be}}}N([]),Ne({});const D={...e.seed,...C,...sr(e.imageInput?l:null)};K(D),Ee.current=T,ke.current=B;const oe=b.redeploy(r),he=(oe==null?void 0:oe[0])??y.processId;F({kind:"start",text:`Starting "${he}" — ${y.agent?s.kind==="scripted"||!s.chat?"scripted brain":`live brain (${s.modelInUse??s.kind})`:"no agent in this model"}`});const re=b.createInstance(he,JSON.stringify(D)),ae=(X=re==null?void 0:re.instances[0])==null?void 0:X.key;return e.imageInput&&l&&ae&&b.setRunImage(ae,l),{workers:T,agents:B,snap:re}},[b,e,_,r,d,C,l,y,s,F,ge]),U=!!b.snapshot&&b.snapshot.completedInstances<1,Ie=!U&&!!k&&!xe,Tt=h.useCallback(async()=>{if(!(b.phase!=="ready"||de.current||V||_.hasErrors)){de.current=!0,se(!0);try{let M=Ee.current,x=ke.current,T=b.snapshot;const B=++Se.current;if(!U){if(Te.current&&!Te.current.validate())return;S(null);const D=await A();if(!D)return;M=D.workers,x=D.agents,T=D.snap,await new Promise(oe=>setTimeout(oe,Ue))}await Le(M,x,T,B)}finally{de.current=!1,se(!1)}}},[b,V,_.hasErrors,U,A,Le]),jt=h.useCallback(async()=>{var M;if(!(b.phase!=="ready"||de.current||V||_.hasErrors)){de.current=!0,Y(!0);try{let x=Ee.current,T=ke.current,B=b.snapshot;if(!U){if(Te.current&&!Te.current.validate())return;S(null);const ae=await A();if(!ae)return;x=ae.workers,T=ae.agents,B=ae.snap}if(!B||B.completedInstances>=1)return;const D=B.takenSequenceFlows.length,oe=await b.stepWorkers(x,{agents:T});if(!oe){F({kind:"error",text:"⏭ step failed — no dispatch round was returned"});return}const he=(M=oe.snapshot.instances[0])==null?void 0:M.variables;he&&K({...he});const re=ni(oe.snapshot.takenSequenceFlows,D);F(ti(oe,re,Ce,ge))}finally{de.current=!1,Y(!1)}}},[b,V,_.hasErrors,U,A,F,Ce,ge]),St=h.useCallback(()=>{de.current=!1,Se.current++,se(!1),Y(!1),b.reset(),N([]),K({})},[b]),Pt=h.useCallback(()=>{if(!_e||Fe.current&&!Fe.current.validate())return;const M=b.completeUserTask(_e.key,JSON.stringify(De));F({kind:"human",text:`👤 ${cn(De)}`}),M&&M.completedInstances>=1&&F({kind:"done",text:"✅ process instance completed"})},[_e,De,b,F]),At=h.useMemo(()=>{var M,x;return b.phase==="loading"?a.jsx(H,{variant:"neutral",children:"Booting engine…"}):b.phase==="error"?a.jsx(H,{variant:"danger",children:"Engine error"}):q?a.jsx(H,{variant:"info",children:"Running…"}):V?a.jsx(H,{variant:"info",children:"Stepping…"}):(((M=b.snapshot)==null?void 0:M.incidentElementIds.length)??0)>0?a.jsx(H,{variant:"danger",children:"Incident"}):_e?a.jsx(H,{variant:"warning",children:"Waiting for a human"}):(((x=b.snapshot)==null?void 0:x.completedInstances)??0)>=1?a.jsx(H,{variant:"success",children:"Completed"}):b.snapshot?a.jsx(H,{variant:"warning",children:"Paused"}):a.jsx(H,{variant:"neutral",children:"Ready"})},[b.phase,b.snapshot,q,V,_e]);return a.jsxs("div",{className:"runner",children:[a.jsxs("section",{className:"intro",children:[a.jsx("h1",{children:e.title}),a.jsx("p",{children:e.blurb}),a.jsxs("div",{className:"controls",children:[a.jsx(J,{"data-tour":fe.runButton,onClick:()=>void Tt(),disabled:b.phase!=="ready"||q||V||_.hasErrors||Ie,children:"▶ Run"}),a.jsx(J,{variant:"secondary",onClick:()=>void jt(),disabled:b.phase!=="ready"||q||V||_.hasErrors||Ie||(((xn=b.snapshot)==null?void 0:xn.completedInstances)??0)>=1,children:"⏭ Step"}),a.jsx(J,{variant:"secondary",onClick:St,disabled:b.phase!=="ready"||V,children:"↺ Reset"}),e.tour&&a.jsx(J,{variant:"secondary",onClick:v.start,disabled:v.active,children:v.active?"Touring…":`🧭 ${e.tour.label}`}),At]}),b.phase==="error"&&a.jsxs(le,{variant:"destructive",children:[a.jsx(ce,{children:"Engine error"}),a.jsx(me,{children:b.error})]}),$&&a.jsxs(le,{variant:"destructive",children:[a.jsx(ce,{children:"Code didn't compile"}),a.jsx(me,{children:$})]}),_.hasErrors&&a.jsxs(le,{variant:"destructive",children:[a.jsx(ce,{children:"Run is disabled — the diagram has unresolved references"}),a.jsx(me,{children:a.jsx("ul",{className:"diagnostics",children:_.diagnostics.filter(M=>M.severity==="error").map((M,x)=>a.jsx("li",{children:M.message},x))})})]}),!_.hasErrors&&_.diagnostics.length>0&&a.jsxs(le,{children:[a.jsx(ce,{children:"Heads up"}),a.jsx(me,{children:a.jsx("ul",{className:"diagnostics",children:_.diagnostics.map((M,x)=>a.jsx("li",{children:M.message},x))})})]})]}),a.jsxs("div",{className:"grid",children:[a.jsxs("div",{className:"col",children:[a.jsx(ye,{sectionId:"process","data-tour":fe.diagram,title:"Process",description:`${y.processName} — live token (green), incidents (red).`,children:a.jsx(h.Suspense,{fallback:a.jsx("div",{className:"diagram-fallback",children:b.phase==="loading"?"Booting the engine…":"Loading diagram…"}),children:a.jsx(Qi,{xml:_.resolvedBpmn,activeIds:((Nn=b.snapshot)==null?void 0:Nn.activeElementIds)??[],incidentIds:((En=b.snapshot)==null?void 0:En.incidentElementIds)??[],className:"diagram"})})}),_e&&a.jsxs(ye,{sectionId:"human-task",title:(ie==null?void 0:ie.label)??"Human task",description:Be?`Rendered from the model's form "${ie==null?void 0:ie.formId}".`:"This task has no linked form — complete it with no variables.",children:[Je.length>0&&a.jsxs(le,{variant:"destructive",children:[a.jsx(ce,{children:"The agent didn't finish its checks"}),a.jsxs(me,{children:["It completed without running"," ",Je.map(M=>M.label||M.elementId).join(", "),". The process took the default path to this task, so the findings below have no value to report."]})]}),Be&&a.jsx(h.Suspense,{fallback:a.jsx("div",{className:"form-fallback",children:"Loading form…"}),children:a.jsx(qn,{ref:Fe,schema:Be,values:De,onChange:(M,x)=>Ne(T=>({...T,[M]:x})),context:z,onValidityChange:je})}),a.jsx(J,{onClick:Pt,disabled:!!Be&&!rn,children:"Complete task"})]}),we&&a.jsx(ye,{sectionId:"manual-job",title:we.control.label,description:"This job is held here on purpose — pick how it resolves.",children:a.jsxs("div",{className:"controls",children:[a.jsx(J,{onClick:()=>void I("complete"),disabled:q||V,children:we.control.completeLabel??"✅ Complete normally"}),a.jsx(J,{variant:"secondary",onClick:()=>void I("action"),disabled:q||V,children:we.control.action.label})]})}),a.jsxs("div",{className:"row",children:[a.jsx(ye,{sectionId:"variables",className:"grow","data-tour":fe.variablesPanel,title:"Variables",description:"The instance payload, live.",children:a.jsx("pre",{className:"vars",children:cn(z,2)})}),a.jsx(Li,{log:E,elementStats:(kn=b.snapshot)==null?void 0:kn.elementStats,incidents:(In=b.snapshot)==null?void 0:In.incidents,labelFor:Ce})]})]}),a.jsxs("div",{className:"col",children:[(y.agent||e.imageInput)&&a.jsx(ye,{sectionId:"brain","data-tour":fe.brainPanel,title:"Brain",description:y.agent?`What drives “${y.agent.label}”. The model recommends; the process governs.`:"What reads the image. The model recommends; the process governs.",children:a.jsx(Ni,{brain:s,showText:!!y.agent,showVision:!!e.imageInput})}),a.jsxs(ye,{sectionId:"start",title:"Start",description:y.startFormId?`The model's start form "${y.startFormId}".`:e.imageInput?"Pick a seed photo or upload your own to read.":"The starting payload.",children:[e.imageInput&&a.jsx(Ii,{imageInput:e.imageInput,value:l,onSelect:m,disabled:q}),e.scenarios&&a.jsx("div",{className:"scenarios",children:e.scenarios.map(M=>a.jsx(J,{size:"sm",variant:"secondary",disabled:q,onClick:()=>W(x=>({...x,...M.variables})),children:M.label},M.label))}),k?a.jsx(h.Suspense,{fallback:a.jsx("div",{className:"form-fallback",children:"Loading form…"}),children:a.jsx(qn,{ref:Te,schema:k,values:C,onChange:(M,x)=>W(T=>({...T,[M]:x})),disabled:q,onValidityChange:Oe})}):a.jsx("pre",{className:"vars",children:cn(C,2)})]}),a.jsx(ye,{sectionId:"code",className:"editors","data-tour":fe.codePanel,title:"Code",description:"One handler per BPMN element. Return variables to merge, or throw to fail the job.",children:a.jsx(h.Suspense,{fallback:a.jsx("div",{className:"editor-fallback",children:"Loading editor…"}),children:a.jsxs($t,{value:Z,onValueChange:ue,children:[a.jsxs(Vt,{children:[a.jsx(He,{value:Yn,children:"model"}),y.agent&&a.jsx(He,{value:dn,children:"agent (scripted)"}),e.handlers.map(M=>{var x;return a.jsx(He,{value:M.elementId,children:((x=y.tasks.find(T=>T.elementId===M.elementId))==null?void 0:x.label)??M.elementId},M.elementId)}),Object.keys(u).map(M=>a.jsx(He,{value:Qn+M,children:M},M))]}),a.jsxs(We,{value:Yn,children:[a.jsxs("div",{className:"editor-meta",children:[a.jsx("strong",{children:"Model"}),a.jsx("code",{children:"edit the diagram visually — Run re-checks it below"}),a.jsx(J,{variant:"secondary",size:"sm",onClick:()=>i(e.bpmn),disabled:r===e.bpmn,children:"Revert to original"})]}),a.jsx(qi,{value:r,onChange:i})]}),y.agent&&a.jsxs(We,{value:dn,children:[a.jsxs("div",{className:"editor-meta",children:[a.jsx("strong",{children:y.agent.label}),a.jsx("code",{children:s.kind==="scripted"||!s.chat?"in use":"unused — a live brain is connected"})]}),a.jsx("div",{className:"editor-wrap",children:a.jsx(ln,{height:"360px",defaultLanguage:"javascript",value:d,onChange:M=>g(M??""),options:mn})})]}),e.handlers.map(M=>{var x;return a.jsxs(We,{value:M.elementId,children:[a.jsxs("div",{className:"editor-meta",children:[a.jsx("strong",{children:((x=y.tasks.find(T=>T.elementId===M.elementId))==null?void 0:x.label)??M.elementId}),a.jsx("code",{children:M.standsInFor??M.elementId})]}),a.jsx("div",{className:"editor-wrap",children:a.jsx(ln,{height:"360px",defaultLanguage:"javascript",value:p[M.elementId],onChange:T=>o(B=>({...B,[M.elementId]:T??""})),options:mn})})]},M.elementId)}),Object.keys(u).map(M=>a.jsxs(We,{value:Qn+M,children:[a.jsxs("div",{className:"editor-meta",children:[a.jsx("strong",{children:M}),a.jsxs("code",{children:["prompt / template text — substitutes"," ","{{"+M+"}}"]})]}),a.jsx("div",{className:"editor-wrap",children:a.jsx(ln,{height:"360px",defaultLanguage:"markdown",value:u[M],onChange:x=>f(T=>Qe(T,{[M]:x??""})),options:mn})})]},M))]})})}),y.agent&&a.jsx(ye,{sectionId:"tools",title:"Tools, as the model sees them",description:a.jsxs(a.Fragment,{children:["Read from the diagram — element name, documentation, and every",a.jsx("code",{children:" fromAi(…)"})," argument."]}),children:a.jsx("ul",{className:"tool-list",children:y.agent.tools.map(M=>a.jsxs("li",{children:[a.jsx("code",{children:M.elementId}),a.jsxs("span",{children:[" — ",M.documentation||M.label]}),M.args.length>0&&a.jsx("ul",{children:M.args.map(x=>a.jsxs("li",{children:[a.jsxs("code",{children:[x.name,": ",x.type]})," ","— ",x.description]},x.name))})]},M.elementId))})})]})]})]})}const mn={minimap:{enabled:!1},fontSize:13,scrollBeyondLastLine:!1,tabSize:2,automaticLayout:!0},Hi=`<?xml version="1.0" encoding="UTF-8"?>\r
...
}`,Ua={id:"loan-origination",title:"Loan origination agent",blurb:"An AI agent gathers a loan case with its own tools — customer lookup, credit bureau, an underwriting policy, a status update — then every application passes through a mandatory senior-officer review before a gateway routes it to an offer or a decline. The agent advises; the process governs.",docsUrl:"https://camunda.com/orchestrate/agents/",bpmn:ga,forms:{"loan-application":Ma,"loan-senior-officer-review":Sa},seed:Hn,scenarios:[{label:"Strong applicant (policy recommends approve)",variables:Hn},{label:"Marginal applicant (policy recommends decline)",variables:Da}],scriptedAgent:Ca,templates:Aa,tour:ua,requiredTools:["AssessApplication"],handlers:[{elementId:"QueryCustomer",standsInFor:"CRM connector — customer lookup",source:Ba},{elementId:"CreditBureauLookup",standsInFor:"REST connector — credit bureau",source:La},{elementId:"AssessApplication",standsInFor:"Script task — underwriting policy (FEEL)",source:Ra},{elementId:"UpdateApplicationStatus",standsInFor:"REST connector — origination system",source:za},{elementId:"IssueLoanOffer",standsInFor:"REST connector — offer/booking system",source:Oa},{elementId:"SendDeclineNotice",standsInFor:"REST connector — notifications",source:Fa}]},$a=`<?xml version="1.0" encoding="UTF-8"?>
...
}`,$s={id:"plate-recognition",title:"Read a number plate from a photo",blurb:"Pick the plate's country, then a photo goes into the run, an in-browser vision model reads the number plate on the reader's own GPU, and a human confirms or corrects it before the process records the result. The vision model recommends; the BPMN process governs. No server, no API key — with no model connected it falls back to a deterministic scripted reading.",docsUrl:"https://docs.camunda.io/docs/components/modeler/forms/camunda-forms-reference/",bpmn:ms,forms:{"plate-recognition-country":Bs,"plate-recognition-confirm":ws,"plate-recognition-manual":Is},seed:{country:"auto"},imageInput:{label:"Pick a seed photo (its plate is known, so the scripted reader works offline) or upload your own — a live in-browser model reads a photo it has never seen.",seedImages:zs},scriptedVision:Os,handlers:[{elementId:"ExtractPlate",standsInFor:"Vision model — Florence-2 <OCR> on WebGPU (in-browser)",source:Fs},{elementId:"RecordResult",standsInFor:"Script task — records the governed outcome",source:Us}]},Vs=[Ha,ca,Ua,Qa,es,$s],Gs=Object.assign({"./learn-error-boundary/index.ts":Xi,"./learn-exclusive-gateway/index.ts":oo,"./learn-message-correlation/index.ts":co,"./learn-multi-instance-parallel/index.ts":go,"./learn-service-task/index.ts":wo,"./learn-signal-broadcast/index.ts":xo,"./learn-user-task-form/index.ts":Co}),Ys=Object.values(Gs).map(e=>e.default).sort((e,n)=>e.id.localeCompare(n.id)),$e=[...Vs,...Ys];function wn(){return"/pr-preview/pr-95/"}function Qs(e){const n=wn();return e.startsWith(n)?"/"+e.slice(n.length):e}function qs(e=location.pathname){const t=Qs(e).match(/^\/examples\/([^/]+)\/?$/);if(t)try{return{kind:"example",id:decodeURIComponent(t[1])}}catch{return{kind:"gallery"}}return{kind:"gallery"}}function Js(e=location.search){return new URLSearchParams(e).get("embed")==="1"}function Hs(){return wn()}function Zn(e){return`${wn()}examples/${encodeURIComponent(e)}`}function Kn(e,n={}){const t=new URL(location.href);t.pathname=e,t.search=n.search??t.search,n.hash!==void 0&&(t.hash=n.hash),n.replace?history.replaceState(history.state,"",t):history.pushState(history.state,"",t),window.dispatchEvent(new PopStateEvent("popstate"))}function Xn(){return{route:qs(),embed:Js()}}function Ws(){const[e,n]=h.useState(Xn);return h.useEffect(()=>{const t=()=>n(Xn());return window.addEventListener("popstate",t),()=>window.removeEventListener("popstate",t)},[]),e}const Zs="web-demo-framework:height",Ks="web-demo-framework:request-height";function Xs(e){return{type:Zs,height:Math.ceil(e)}}const et="embed-height-auto";function ed(e){h.useEffect(()=>{if(!e||typeof window>"u"||window.parent===window)return;const n=document.documentElement;n.classList.add(et);let t=-1;const r=(l=!1)=>{const m=document.documentElement.scrollHeight;!l&&Math.abs(m-t)<2||(t=m,window.parent.postMessage(Xs(m),"*"))},i=l=>{if(l.source!==window.parent)return;const m=l.data;!m||m.type!==Ks||r(!0)};window.addEventListener("message",i),r();const s=new ResizeObserver(()=>r());return s.observe(n),()=>{s.disconnect(),window.removeEventListener("message",i),n.classList.remove(et)}},[e])}function nd(){const{route:e,embed:n}=Ws(),t=Nt().brain,r=Ri();ed(n);const i=e.kind==="example"?e.id:$e[0].id,s=$e.find(d=>d.id===i)??$e[0],l=$e.filter(d=>d.group!=="learn-bpmn"),m=$e.filter(d=>d.group==="learn-bpmn"),p=d=>{Kn(Zn(d),{hash:location.hash})},o=a.jsxs(a.Fragment,{children:[!n&&e.kind==="gallery"&&a.jsxs(a.Fragment,{children:[a.jsx("nav",{className:"example-picker",children:l.map(d=>a.jsx(J,{size:"sm",variant:d.id===s.id?"default":"secondary",onClick:()=>p(d.id),children:d.title},d.id))}),m.length>0&&a.jsxs(a.Fragment,{children:[a.jsx("h2",{className:"example-group-heading",children:"Learn BPMN"}),a.jsx("nav",{className:"example-picker",children:m.map(d=>a.jsx(J,{size:"sm",variant:d.id===s.id?"default":"secondary",onClick:()=>p(d.id),children:d.title},d.id))})]})]}),!n&&e.kind==="example"&&a.jsx("div",{className:"example-nav",children:a.jsx(J,{size:"sm",variant:"secondary",onClick:()=>Kn(Hs()),children:"← All examples"})}),a.jsxs("div",{className:"example-meta",children:[s.docsUrl&&a.jsx("a",{className:"docs-link",href:s.docsUrl,target:"_blank",rel:"noreferrer noopener",children:"View on camunda.com ↗"}),n&&a.jsx("a",{className:"open-full-page",href:Zn(s.id)+(location.hash||""),target:"_top",rel:"noreferrer",children:"Open full page ↗"})]}),a.jsx(Ji,{example:s,initialBrainKind:t,initialTourId:r},s.id)]});return n?a.jsx("div",{className:"c4-ui app-shell app-embed",children:a.jsx("main",{id:"main",className:"layout layout-embed",children:o})}):a.jsxs("div",{className:"c4-ui app-shell",children:[a.jsx(Gt,{appName:"Runnable Camunda examples",trailing:a.jsx("span",{className:"app-subtitle",children:"model + code + optional LLM, in your browser"})}),a.jsx("main",{id:"main",className:"layout",children:o})]})}Bt.createRoot(document.getElementById("root")).render(a.jsx(h.StrictMode,{children:a.jsx(Yt,{children:a.jsx(nd,{})})}));export{pe as _,od as c};
