const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/driver-CTZuBZOi.css","assets/diagram-js-DAKGYcfb.css","assets/bpmn-js-BEOU0ddW.css","assets/bpmn-embedded-BLtIBJZA.css","assets/RuntimeDiagram-DTnJz5cT.js","assets/vendor-react-9Ma26nY1.js","assets/Viewer-D_7S4Gwm.js","assets/MonacoEditor-D55BKqgU.js","assets/MonacoEditor-DLdAiiGF.css","assets/vendor-modeler-6MWkCP0R.js","assets/vendor-design-system-CCrwz1yJ.js","assets/vendor-design-system-CDj0moSE.css","assets/parser-DkgAe_kI.js","assets/ModelEditor-Dwlgp6JA.css","assets/FormRenderer-UXR1JVq-.js","assets/FormRenderer-D1JIHOW6.css"])))=>i.map(i=>d[i]);
var Zt=Object.defineProperty;var Kt=(e,n,t)=>n in e?Zt(e,n,{enumerable:!0,configurable:!0,writable:!0,value:t}):e[n]=t;var L=(e,n,t)=>Kt(e,typeof n!="symbol"?n+"":n,t);import{r as b,j as i,i as Xt}from"./vendor-react-9Ma26nY1.js";import{B as H,a as re,L as qe,S as Nn,b as En,c as kn,d as In,e as Tn,A as de,f as le,g as ce,I as Yn,C as er,h as nr,i as tr,j as rr,k as ir,l as or,T as ar,m as sr,n as sn,o as dn,p as dr,q as lr}from"./vendor-design-system-CCrwz1yJ.js";(function(){const n=document.createElement("link").relList;if(n&&n.supports&&n.supports("modulepreload"))return;for(const o of document.querySelectorAll('link[rel="modulepreload"]'))r(o);new MutationObserver(o=>{for(const s of o)if(s.type==="childList")for(const l of s.addedNodes)l.tagName==="LINK"&&l.rel==="modulepreload"&&r(l)}).observe(document,{childList:!0,subtree:!0});function t(o){const s={};return o.integrity&&(s.integrity=o.integrity),o.referrerPolicy&&(s.referrerPolicy=o.referrerPolicy),o.crossOrigin==="use-credentials"?s.credentials="include":o.crossOrigin==="anonymous"?s.credentials="omit":s.credentials="same-origin",s}function r(o){if(o.ep)return;o.ep=!0;const s=t(o);fetch(o.href,s)}})();const cr="modulepreload",mr=function(e){return"/pr-preview/pr-110/"+e},Qn={},ue=function(n,t,r){let o=Promise.resolve();if(t&&t.length>0){let l=function(a){return Promise.all(a.map(p=>Promise.resolve(p).then(h=>({status:"fulfilled",value:h}),h=>({status:"rejected",reason:h}))))};document.getElementsByTagName("link");const c=document.querySelector("meta[property=csp-nonce]"),u=(c==null?void 0:c.nonce)||(c==null?void 0:c.getAttribute("nonce"));o=l(t.map(a=>{if(a=mr(a),a in Qn)return;Qn[a]=!0;const p=a.endsWith(".css"),h=p?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${a}"]${h}`))return;const d=document.createElement("link");if(d.rel=p?"stylesheet":cr,p||(d.as="script"),d.crossOrigin="",d.href=a,u&&d.setAttribute("nonce",u),document.head.appendChild(d),p)return new Promise((_,y)=>{d.addEventListener("load",_),d.addEventListener("error",()=>y(new Error(`Unable to preload CSS for ${a}`)))})}))}function s(l){const c=new Event("vite:preloadError",{cancelable:!0});if(c.payload=l,window.dispatchEvent(c),!c.defaultPrevented)throw l}return o.then(l=>{for(const c of l||[])c.status==="rejected"&&s(c.reason);return n().catch(s)})},pr="io.camunda.agenticai:aiagent",Se="http://www.omg.org/spec/BPMN/20100524/MODEL",ur="http://camunda.org/schema/zeebe/1.0";function jn(e,n){return Array.from(e.getElementsByTagNameNS(ur,n))}function xt(e,n){return jn(e,n).filter(t=>hr(t)===e)}function hr(e){let n=e.parentElement;for(;n;){if(n.namespaceURI===Se&&n.localName!=="extensionElements")return n;n=n.parentElement}return null}function Dn(e){const n=xt(e,"taskDefinition")[0],t=n==null?void 0:n.getAttribute("type");return t||(e.localName==="scriptTask"?e.getAttribute("id")??null:null)}function qn(e){const n=Array.from(e.children).find(t=>t.namespaceURI===Se&&t.localName==="documentation");return((n==null?void 0:n.textContent)??"").trim()}function Jn(e){if(!e)return"";const n=e.startsWith("=")?e.slice(1):e,t=n.match(/"((?:[^"\\]|\\.)*)"/g);return t?t.map(r=>r.slice(1,-1).replace(/\\n/g,`
...
`)}function gr(e){return Et(Nt(e))}function br(e){const n=Array.from(e.children).find(t=>t.namespaceURI===Se&&t.localName==="extensionElements");return n?Et(Nt(n)):[]}function Et(e){const n=/fromAi\(\s*toolCall\.([A-Za-z_$][\w$]*)\s*,\s*"((?:[^"\\]|\\.)*)"\s*(?:,\s*"(\w+)")?/g,t=[],r=new Set;for(const o of e.matchAll(n)){const s=o[1];r.has(s)||(r.add(s),t.push({name:s,description:(o[2]??"").replace(/&#10;/g,`
`).replace(/\\"/g,'"').replace(/&quot;/g,'"').replace(/&#39;/g,"'").trim(),type:o[3]??"string"}))}return t}function _r(e){const n={};for(const t of xt(e,"input")){const r=t.getAttribute("target");r&&(n[r]=t.getAttribute("source")??"")}return n}function fr(e){return Array.from(e.getElementsByTagNameNS(Se,"adHocSubProcess")).filter(n=>(Dn(n)??"").startsWith(pr))}const wr=new Set(["subProcess","adHocSubProcess","callActivity"]),yr=new Set(["adHocSubProcess","subProcess","transaction"]);function vr(e){let n=e.parentElement;for(;n;){if(n.namespaceURI===Se&&yr.has(n.localName))return n;n=n.parentElement}return null}function Mr(e,n){const t=_r(e),r=Number((t["data.limits.maxModelCalls"]??"").replace(/^=/,""));return{elementId:e.getAttribute("id")??"agent",label:e.getAttribute("name")??"Agent",jobType:Dn(e),systemPrompt:Jn(t["data.systemPrompt.prompt"]),userPrompt:Jn(t["data.userPrompt.prompt"]),maxModelCalls:Number.isFinite(r)&&r>0?r:10,tools:n}}function xr(e,n){var h;const t=e.getAttribute("id")??"",r=e.getAttribute("name")??t,o=fr(e);o.length>1&&n.push({severity:"warning",elementId:o.map(d=>d.getAttribute("id")).join(", "),message:`Process "${r}" hosts ${o.length} AI Agent sub-processes (${o.map(d=>d.getAttribute("id")).join(", ")}). Each gets its own independent agent state (turn counter, called tools) — the run itself is shared across hosts, but each host's agent state within it is not.`});const s=[],l=new Map(o.map(d=>[d,[]]));for(const d of Array.from(e.getElementsByTagName("*"))){if(d.namespaceURI!==Se||o.includes(d))continue;const _=d.getAttribute("id");if(!_)continue;const y=vr(d),M=y&&o.includes(y)?y:null;if(M&&wr.has(d.localName)){const j=d.getAttribute("name")??_,B=qn(d);s.push({elementId:_,label:j,jobType:"",documentation:B,isTool:!0,compound:!0}),l.get(M).push({elementId:_,label:j,jobType:"",documentation:B,args:br(d),compound:!0});continue}const v=Dn(d);if(!v)continue;const g={elementId:_,label:d.getAttribute("name")??_,jobType:v,documentation:qn(d),isTool:M!=null};s.push(g),M&&l.get(M).push({elementId:_,label:g.label,jobType:v,documentation:g.documentation,args:gr(d)})}const c=o.map(d=>Mr(d,l.get(d))),u=Array.from(e.getElementsByTagNameNS(Se,"userTask")).map(d=>{var _;return{elementId:d.getAttribute("id")??"",label:d.getAttribute("name")??d.getAttribute("id")??"",formId:((_=jn(d,"formDefinition")[0])==null?void 0:_.getAttribute("formId"))??void 0}}),a=e.getElementsByTagNameNS(Se,"startEvent")[0],p=a?((h=jn(a,"formDefinition")[0])==null?void 0:h.getAttribute("formId"))??void 0:void 0;return{processId:t,processName:r,tasks:s,agents:c,userTasks:u,startFormId:p}}function Nr(e,n={}){const t=new DOMParser().parseFromString(e,"application/xml"),r=t.getElementsByTagName("parsererror")[0];if(r)throw new Error(`Invalid BPMN XML: ${r.textContent}`);const o=Array.from(t.getElementsByTagNameNS(Se,"process"));if(o.length===0)throw new Error("No <bpmn:process> in the diagram.");const s=[],l=o.map(u=>xr(u,s));let c=n.processId?l.find(u=>u.processId===n.processId):void 0;return n.processId&&!c&&s.push({severity:"warning",message:`Requested process "${n.processId}" not found — falling back to "${l[0].processId}".`}),c??(c=l[0]),l.length>1&&s.push({severity:"warning",message:`Diagram has ${l.length} <bpmn:process> elements (${l.map(u=>u.processId).join(", ")}); using "${c.processId}" as the active process. Pass a processId to parseModel to target another.`}),{processes:l,diagnostics:s,processId:c.processId,processName:c.processName,tasks:c.tasks,agent:c.agents[0]??null,agents:l.flatMap(u=>u.agents),userTasks:c.userTasks,startFormId:c.startFormId}}function Er(e){return e?e.imageId?{imageId:e.imageId}:e.imageName?{imageName:e.imageName}:{}:{}}function kt(e,n){return n?e.pixels:e.imageId??e.pixels}const kr="No image selected — pick or upload a photo to read.";function Hn(){return kr}function Ir(e,n){return async t=>{const r=e.resolve(n);if(!r)return Hn();const o=kt(r,e.live);if(o===void 0)return Hn();try{return await e.read(o,t)}catch(s){return`Couldn't read the image (${s instanceof Error?s.message:String(s)}).`}}}function Tr(e,n){return async()=>{const t=e.resolve(n);if(t)return kt(t,e.live)}}function jr(){return`<!doctype html><html><head><meta charset="utf-8"></head><body><script>
    "use strict";
    ...
    post({ kind: "ready" });
  <\/script></body></html>`}function It(e,n={}){const{timeoutMs:t=5e3,onTrace:r,onVision:o,onImage:s}=n,l=`${Date.now()}-${Math.random().toString(36).slice(2)}`;return new Promise((c,u)=>{const a=document.createElement("iframe");a.setAttribute("sandbox","allow-scripts"),a.style.display="none",a.setAttribute("aria-hidden","true");let p=!1,h;const d=()=>{h&&clearTimeout(h),window.removeEventListener("message",y),a.remove()},_=v=>{p||(p=!0,d(),v())};function y(v){var j;if(v.source!==a.contentWindow)return;const g=v.data;if(!(!g||typeof g!="object")){if(g.kind==="ready"){const B=e.job,O=e.kind==="run-handler"?{kind:"run-handler",id:l,source:e.source,job:B,hasVision:e.hasVision}:{kind:"run-agent",id:l,source:e.source,job:B};(j=a.contentWindow)==null||j.postMessage(O,"*");return}"id"in g&&g.id!==l||(g.kind==="trace"?r==null||r(g.text):g.kind==="vision-request"?M(g.callId,o,"vision",g.prompt):g.kind==="image-request"?M(g.callId,s,"image"):g.kind==="result"?_(()=>c(g.value)):g.kind==="error"&&_(()=>u(new Error(g.message))))}}function M(v,g,j,...B){const O=ie=>{var W;return(W=a.contentWindow)==null?void 0:W.postMessage(ie,"*")};if(!g){O({kind:"helper-error",id:l,callId:v,message:`${j} helper is not available.`});return}Promise.resolve().then(()=>g(...B)).then(ie=>O({kind:"helper-result",id:l,callId:v,value:ie}),ie=>O({kind:"helper-error",id:l,callId:v,message:ie instanceof Error?ie.message:String(ie)}))}window.addEventListener("message",y),h=setTimeout(()=>{_(()=>u(new Error(`Handler timed out after ${t}ms — the sandboxed run was terminated.`)))},t),a.srcdoc=jr(),document.body.appendChild(a)})}function Tt(e){return{key:e.key,type:e.type,elementId:e.elementId,instanceKey:e.instanceKey,variables:e.variables??{}}}function Sr(e,n,t){const r=typeof t.vision=="function";return It({kind:"run-handler",source:e,job:Tt(n),hasVision:r},{onTrace:t.trace,onVision:t.vision?o=>t.vision(o):void 0,onImage:t.image?()=>t.image():void 0})}function Pr(e,n){return It({kind:"run-agent",source:e,job:Tt(n)})}function jt(e,n){try{new Function(`"use strict"; return (${e});`)}catch{throw new Error(`${n} has a syntax error.`)}}function Ar(e){return jt(e,"Handler code"),(n,t)=>Sr(e,n,t)}function Cr(e){return jt(e,"Agent code"),n=>Pr(e,n)}function Dr(e,n,t,r){return{sleep:o=>new Promise(s=>setTimeout(s,o)),trace:o=>n({kind:"tool",text:`   ${o}`,elementId:e.elementId,turn:t}),text:(o,s="")=>{const l=e.variables[o];return typeof l=="string"?l:l==null?s:String(l)},num:(o,s=0)=>{const l=e.variables[o],c=typeof l=="number"?l:Number(l);return Number.isFinite(c)?c:s},...r?{vision:Ir(r,e.instanceKey),image:Tr(r,e.instanceKey)}:{}}}function Br(e){if(e===void 0)return"undefined";try{return JSON.stringify(e)}catch{return"[unserializable value]"}}function Lr(e,n,t,r,o){const s={},l=e.processes.flatMap(u=>u.tasks),c=new Map(l.map(u=>[u.elementId,u.label]));for(const u of l)u.compound||s[u.jobType]||(s[u.jobType]=async a=>{const p=n[a.elementId];if(!p)throw new Error(`No handler registered for ${a.elementId} (job type ${a.type})`);const h=c.get(a.elementId)??a.elementId,d=r==null?void 0:r.current;t({kind:"tool",text:`▶ ${h}`,elementId:a.elementId,turn:d});const _=await p(a,Dr(a,t,d,o));return t({kind:"vars",text:`  ↳ ${Br(_)}`,elementId:a.elementId,result:_,turn:d}),_});return s}const Rr=/\{\{\s*([A-Za-z][A-Za-z0-9_-]*)\s*\}\}/g;function rn(...e){const n=Object.create(null);for(const t of e)if(t)for(const r of Object.keys(t))n[r]=t[r];return n}function St(e){return(e.split("/").pop()??e).replace(/\.[^./]+$/,"")}function Pt(e){return e.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;")}function Fr(e){return Pt(e).replace(/"/g,"&quot;").replace(/\n/g,"&#10;").replace(/\t/g,"&#9;")}function zr(e){return e.replace(/\\/g,"\\\\").replace(/&/g,"&amp;").replace(/"/g,"\\&#34;").replace(/\n/g,"&#10;").replace(/\t/g,"&#9;").replace(/</g,"&lt;").replace(/>/g,"&gt;")}function Or(e){return JSON.stringify(e).slice(1,-1)}function Ur(e,n){const t=e.lastIndexOf("<",n),r=e.lastIndexOf(">",n);if(t<=r)return"text";const o=e.slice(t,n);if((o.match(/"/g)??[]).length%2===0)return"text";const l=o.lastIndexOf('"');return(o.slice(l+1).match(/&#34;|&quot;/g)??[]).length%2===1?"feel-literal":"attribute"}function $r(e,n,t="xml"){const r=[],o=new Set;return{result:e.replace(Rr,(l,c,u)=>{const a=c.trim();if(!Object.prototype.hasOwnProperty.call(n,a))return o.has(a)||(o.add(a),r.push(a)),l;const p=n[a];if(t==="json")return Or(p);const h=Ur(e,u);return h==="feel-literal"?zr(p):h==="attribute"?Fr(p):Pt(p)}),unresolved:r}}function Gr(){return{processes:[],diagnostics:[],processId:"",processName:"",tasks:[],agent:null,agents:[],userTasks:[],startFormId:void 0}}function Vr(e,n={},t=e.bpmn,r={}){const o=[],s=rn(e.templates,r),{result:l,unresolved:c}=$r(t,s,"xml");for(const g of c)o.push({severity:"warning",message:`Template placeholder "{{${g}}}" has no matching prompt/template content — left in the model as-is, not substituted.`});let u;try{u=Nr(l)}catch(g){return o.push({severity:"error",message:g instanceof Error?g.message:String(g)}),{resolvedBpmn:l,model:Gr(),handlers:{},forms:{},diagnostics:o,hasErrors:!0}}o.push(...u.diagnostics);const a=u.processes.flatMap(g=>g.tasks),p=new Map(e.handlers.map(g=>[g.elementId,g.source])),h={};for(const g of a){if(g.compound)continue;const j=n[g.elementId]??p.get(g.elementId);if(j===void 0){o.push({severity:"error",elementId:g.elementId,jobType:g.jobType,message:`No handler for "${g.label}" (${g.elementId}, job type "${g.jobType}"). Add a handler for this element, or remove it from the diagram.`});continue}try{h[g.elementId]=Ar(j)}catch(B){o.push({severity:"error",elementId:g.elementId,jobType:g.jobType,message:`"${g.label}" (${g.elementId}): handler code didn't compile — ${B instanceof Error?B.message:String(B)}`})}}const d=new Set(a.map(g=>g.elementId)),_=new Set([...p.keys(),...Object.keys(n)]);for(const g of _)d.has(g)||o.push({severity:"error",elementId:g,message:`Handler "${g}" doesn't match any element in the current diagram — likely orphaned by a rename. Rename it back, or remove the handler.`});const y={},M=e.forms??{},v=(g,j)=>{if(!g)return;const B=M[g];B?y[g]=B:o.push({severity:"error",formId:g,message:`${j} references form "${g}", which has no matching schema.`})};for(const g of u.processes){v(g.startFormId,`The start event of process "${g.processName}"`);for(const j of g.userTasks)v(j.formId,`User task "${j.label}" (${j.elementId})`)}return{resolvedBpmn:l,model:u,handlers:h,forms:y,diagnostics:o,hasErrors:o.some(g=>g.severity==="error")}}function Yr(e){const n=e.indexOf("{");if(n<0)return null;let t=0;for(let r=n;r<e.length;r++)if(e[r]==="{")t++;else if(e[r]==="}"&&(t--,t===0))try{const o=JSON.parse(e.slice(n,r+1));return typeof o=="object"&&o!==null&&!Array.isArray(o)?o:null}catch{return null}return null}function Sn(e,n=220){const t=e.replace(/\s+/g," ").trim();return t.length>n?`${t.slice(0,n-1)}…`:t}function Wn(e){const n=e.arguments??e.args??e.parameters??e.input;return n&&typeof n=="object"&&!Array.isArray(n)?n:{}}function Zn(e){if(!e)return[];const n=e.tool??e.name??e.action;if(typeof n=="string"&&n.trim())return[{name:n.trim(),args:Wn(e)}];const t=e.tools??e.tool_calls??e.toolset??e.actions,r=Array.isArray(t)?t:Object.values(e).find(s=>Array.isArray(s))??[],o=[];for(const s of r)if(typeof s=="string")s.trim()&&o.push({name:s.trim(),args:{}});else if(s&&typeof s=="object"){const l=s,c=l.name??l.tool??l.id??l.function;typeof c=="string"&&c.trim()&&o.push({name:c.trim(),args:Wn(l)})}return o}function Qr(e){if(!e)return!1;const n=e.done??e.finished??e.complete;return typeof n=="boolean"?n:typeof n=="string"?n.toLowerCase()==="true":!1}function Kn(e){const n=e.args.length?e.args.map(r=>`      ${r.name} (${r.type}) — ${r.description}`).join(`
`):"      (none)",t=e.documentation||e.label;return`${e.elementId}
    purpose: ${t}
    arguments:
${n}`}function qr(e,n,t){const r=e.systemPrompt||"You are an agent driving a business process. Use the tools available to you.",o=t[0]??e.tools[0],s=o!=null&&o.args.length?`{${o.args.map(l=>`"${l.name}": "…"`).join(", ")}}`:"{}";return n?`${r}
...
character, with nothing added. When your work is finished, reply exactly
{"done": true} and no tool.`}function Jr(e,n,t,r,o=[],s=[],l=!1){const c=e.userPrompt||"Carry out your task.",u=Object.entries(n).filter(([,p])=>typeof p=="string"&&p.trim().length>0).map(([p,h])=>`  ${p}: ${String(h)}`),a=[c,u.length?`Case data:
${u.join(`
...
`)}async function Hr(e,n,t,r,o,s){let l="";n({kind:"llm",text:"LLM thinking…",key:t,pending:!0,turn:s});const c=await e(r,o,u=>{l+=u,n({kind:"llm",text:`${Sn(l)} ▍`,key:t,pending:!0,turn:s})});return n({kind:"llm",text:Sn(c||l)||"(empty reply)",key:t,pending:!1,turn:s}),c}function Wr(e,n){switch(e){case"number":return typeof n=="number"&&Number.isFinite(n)?{ok:!0,value:n}:typeof n=="string"&&n.trim()!==""&&Number.isFinite(Number(n))?{ok:!0,value:Number(n)}:{ok:!1};case"boolean":return typeof n=="boolean"?{ok:!0,value:n}:typeof n=="string"&&/^(true|false)$/i.test(n.trim())?{ok:!0,value:n.trim().toLowerCase()==="true"}:{ok:!1};default:return typeof n=="object"?{ok:!1}:{ok:!0,value:String(n)}}}function Zr(e,n,t){const r={},o=new Map,s=new Map;for(const{tool:l,args:c}of e){const u={};for(const a of l.args){const p=c[a.name];if(!(p!=null&&p!=="")){n({kind:"error",text:`🤖 ${l.elementId}: model supplied no value for "${a.name}"`,turn:t,elementId:l.elementId});continue}const d=o.get(a.name);if(d!==void 0&&d!==l.elementId){n({kind:"error",text:`🤖 argument name collision on "${a.name}": both ${d} and ${l.elementId} declare it — ${d} already claimed it this turn, ${l.elementId}'s value is dropped`,turn:t,elementId:l.elementId});continue}const _=Wr(a.type,p);if(!_.ok){n({kind:"error",text:`🤖 ${l.elementId}: "${a.name}" is declared as ${a.type} but the model supplied ${JSON.stringify(p)} — rejected, not passed through`,turn:t,elementId:l.elementId});continue}r[a.name]=_.value,u[a.name]=_.value,o.set(a.name,l.elementId)}s.set(l.elementId,u)}return{variablesOut:r,forHistory:s}}function Kr(e,n,t,r={}){const{maxNewTokens:o=384,allowRepeats:s=!1,allowMultiToolTurns:l=!1,turnRef:c,requiredTools:u=[],maxEarlyDoneNudges:a=1,maxUnproductiveTurns:p=3}=r;let h=0;const d=new Set,_=[];let y=0,M=[],v=[];return async g=>{const j=g.variables,B=j.toolCallResult;B!==void 0&&_.length&&(_[_.length-1]=`${_[_.length-1]} → ${Sn(JSON.stringify(B),160)}`);let O=0;for(;;){const W=await ie();if(W)return W;if(O+=1,O>=p)return t({kind:"error",text:`🤖 ${O} turns in a row activated nothing — completing the agent. The model has lost the reply format; whatever it has already run stands.`,turn:h}),{completionConditionFulfilled:!0}}async function ie(){if(h+=1,c&&(c.current=h),h>e.maxModelCalls)return t({kind:"error",text:`Turn budget spent (maxModelCalls=${e.maxModelCalls}) — completing the agent.`,turn:h}),{completionConditionFulfilled:!0};const W=s?e.tools:e.tools.filter(N=>!d.has(N.elementId));if(W.length===0)return t({kind:"agent",text:"🤖 every tool has run — completing the agent",turn:h}),{completionConditionFulfilled:!0};const Ne=[{role:"system",content:qr(e,l,W)},{role:"user",content:Jr(e,j,_,W,M,v,s)}];M=[],v=[];let Ee;try{Ee=await Hr(n,t,`llm-turn-${h}`,Ne,o,h)}catch(N){return t({kind:"error",text:`LLM call failed: ${N instanceof Error?N.message:String(N)} — completing the agent.`,turn:h}),{completionConditionFulfilled:!0}}const we=Yr(Ee);if(Qr(we)&&Zn(we).length===0){const N=u.filter(U=>!d.has(U));return N.length&&y<a?(y+=1,M=N,t({kind:"agent",text:`🤖 model says it is done, but ${N.join(", ")} hasn't run — asking once more`,turn:h}),null):(t({kind:"agent",text:"🤖 model says it is done",turn:h}),{completionConditionFulfilled:!0})}const Pe=Zn(we);if(Pe.length===0)return t({kind:"error",text:"🤖 model named no tool (and didn't say it was done) — asking again",turn:h}),v=['it named no tool and did not say it was done — reply with {"tool": "...", "arguments": {...}} or {"done": true}'],null;const Z=[],me=[],q=[];for(const N of Pe){const U=e.tools.find($=>$.elementId===N.name);if(!U){me.push(N.name);continue}if(!s&&d.has(U.elementId)){q.push(U.elementId);continue}Z.push({tool:U,args:N.args})}if(me.length&&t({kind:"error",text:`🤖 model named a tool that doesn't exist: ${me.join(", ")} — nothing activated`,turn:h}),q.length&&t({kind:"error",text:`🤖 model asked to re-run ${q.join(", ")} — skipped (already run)`,turn:h}),Z.length===0)return t({kind:"agent",text:"🤖 nothing activated — asking again",turn:h}),v=[...me.length?[`${me.join(", ")} ${me.length===1?"is":"are"} not a real tool`]:[],...q.length?[`${q.join(", ")} has already run and will never run again — pick a different tool, or reply {"done": true} if nothing is left to do`]:[]],null;const{variablesOut:T,forHistory:E}=Zr(Z,t,h);for(const{tool:N}of Z)d.add(N.elementId),_.push(`- ${N.elementId}(${JSON.stringify(E.get(N.elementId))})`);for(const{tool:N}of Z)t({kind:"agent",text:`🤖 calling ${N.elementId}`,turn:h,elementId:N.elementId,args:E.get(N.elementId)??{}});return{activateElements:Z.map(N=>({elementId:N.tool.elementId})),variables:T}}}}function Xr(e,n,t,r={}){const o=new Map(e.map(s=>[s.elementId,Kr(s,n,t,r)]));return async s=>{const l=o.get(s.elementId);if(!l)throw new Error(`No agent host registered for "${s.elementId}"`);return l(s)}}class Pn{__destroy_into_raw(){const n=this.__wbg_ptr;return this.__wbg_ptr=0,Xn.unregister(this),n}free(){const n=this.__destroy_into_raw();m.__wbg_testengine_free(n,0)}activateJobs(n,t,r,o){let s,l;try{const _=m.__wbindgen_add_to_stack_pointer(-16),y=A(n,m.__wbindgen_export,m.__wbindgen_export2),M=S,v=A(o,m.__wbindgen_export,m.__wbindgen_export2),g=S;m.testengine_activateJobs(_,this.__wbg_ptr,y,M,t,r,v,g);var c=w().getInt32(_+0,!0),u=w().getInt32(_+4,!0),a=w().getInt32(_+8,!0),p=w().getInt32(_+12,!0),h=c,d=u;if(p)throw h=0,d=0,z(a);return s=h,l=d,F(h,d)}finally{m.__wbindgen_add_to_stack_pointer(16),m.__wbindgen_export3(s,l,1)}}advanceTime(n){let t,r;try{const p=m.__wbindgen_add_to_stack_pointer(-16);m.testengine_advanceTime(p,this.__wbg_ptr,n);var o=w().getInt32(p+0,!0),s=w().getInt32(p+4,!0),l=w().getInt32(p+8,!0),c=w().getInt32(p+12,!0),u=o,a=s;if(c)throw u=0,a=0,z(l);return t=u,r=a,F(u,a)}finally{m.__wbindgen_add_to_stack_pointer(16),m.__wbindgen_export3(t,r,1)}}assignUserTask(n,t,r){let o,s;try{const d=m.__wbindgen_add_to_stack_pointer(-16),_=A(n,m.__wbindgen_export,m.__wbindgen_export2),y=S,M=A(t,m.__wbindgen_export,m.__wbindgen_export2),v=S;m.testengine_assignUserTask(d,this.__wbg_ptr,_,y,M,v,r);var l=w().getInt32(d+0,!0),c=w().getInt32(d+4,!0),u=w().getInt32(d+8,!0),a=w().getInt32(d+12,!0),p=l,h=c;if(a)throw p=0,h=0,z(u);return o=p,s=h,F(p,h)}finally{m.__wbindgen_add_to_stack_pointer(16),m.__wbindgen_export3(o,s,1)}}broadcastSignal(n,t){let r,o;try{const h=m.__wbindgen_add_to_stack_pointer(-16),d=A(n,m.__wbindgen_export,m.__wbindgen_export2),_=S,y=A(t,m.__wbindgen_export,m.__wbindgen_export2),M=S;m.testengine_broadcastSignal(h,this.__wbg_ptr,d,_,y,M);var s=w().getInt32(h+0,!0),l=w().getInt32(h+4,!0),c=w().getInt32(h+8,!0),u=w().getInt32(h+12,!0),a=s,p=l;if(u)throw a=0,p=0,z(c);return r=a,o=p,F(a,p)}finally{m.__wbindgen_add_to_stack_pointer(16),m.__wbindgen_export3(r,o,1)}}cancelInstance(n){let t,r;try{const p=m.__wbindgen_add_to_stack_pointer(-16),h=A(n,m.__wbindgen_export,m.__wbindgen_export2),d=S;m.testengine_cancelInstance(p,this.__wbg_ptr,h,d);var o=w().getInt32(p+0,!0),s=w().getInt32(p+4,!0),l=w().getInt32(p+8,!0),c=w().getInt32(p+12,!0),u=o,a=s;if(c)throw u=0,a=0,z(l);return t=u,r=a,F(u,a)}finally{m.__wbindgen_add_to_stack_pointer(16),m.__wbindgen_export3(t,r,1)}}completeAgentJob(n,t,r){let o,s;try{const d=m.__wbindgen_add_to_stack_pointer(-16),_=A(n,m.__wbindgen_export,m.__wbindgen_export2),y=S,M=A(t,m.__wbindgen_export,m.__wbindgen_export2),v=S,g=A(r,m.__wbindgen_export,m.__wbindgen_export2),j=S;m.testengine_completeAgentJob(d,this.__wbg_ptr,_,y,M,v,g,j);var l=w().getInt32(d+0,!0),c=w().getInt32(d+4,!0),u=w().getInt32(d+8,!0),a=w().getInt32(d+12,!0),p=l,h=c;if(a)throw p=0,h=0,z(u);return o=p,s=h,F(p,h)}finally{m.__wbindgen_add_to_stack_pointer(16),m.__wbindgen_export3(o,s,1)}}completeJob(n,t){let r,o;try{const h=m.__wbindgen_add_to_stack_pointer(-16),d=A(n,m.__wbindgen_export,m.__wbindgen_export2),_=S,y=A(t,m.__wbindgen_export,m.__wbindgen_export2),M=S;m.testengine_completeJob(h,this.__wbg_ptr,d,_,y,M);var s=w().getInt32(h+0,!0),l=w().getInt32(h+4,!0),c=w().getInt32(h+8,!0),u=w().getInt32(h+12,!0),a=s,p=l;if(u)throw a=0,p=0,z(c);return r=a,o=p,F(a,p)}finally{m.__wbindgen_add_to_stack_pointer(16),m.__wbindgen_export3(r,o,1)}}completeUserTask(n,t){let r,o;try{const h=m.__wbindgen_add_to_stack_pointer(-16),d=A(n,m.__wbindgen_export,m.__wbindgen_export2),_=S,y=A(t,m.__wbindgen_export,m.__wbindgen_export2),M=S;m.testengine_completeUserTask(h,this.__wbg_ptr,d,_,y,M);var s=w().getInt32(h+0,!0),l=w().getInt32(h+4,!0),c=w().getInt32(h+8,!0),u=w().getInt32(h+12,!0),a=s,p=l;if(u)throw a=0,p=0,z(c);return r=a,o=p,F(a,p)}finally{m.__wbindgen_add_to_stack_pointer(16),m.__wbindgen_export3(r,o,1)}}correlateMessage(n,t,r){let o,s;try{const d=m.__wbindgen_add_to_stack_pointer(-16),_=A(n,m.__wbindgen_export,m.__wbindgen_export2),y=S,M=A(t,m.__wbindgen_export,m.__wbindgen_export2),v=S,g=A(r,m.__wbindgen_export,m.__wbindgen_export2),j=S;m.testengine_correlateMessage(d,this.__wbg_ptr,_,y,M,v,g,j);var l=w().getInt32(d+0,!0),c=w().getInt32(d+4,!0),u=w().getInt32(d+8,!0),a=w().getInt32(d+12,!0),p=l,h=c;if(a)throw p=0,h=0,z(u);return o=p,s=h,F(p,h)}finally{m.__wbindgen_add_to_stack_pointer(16),m.__wbindgen_export3(o,s,1)}}createInstance(n,t,r){let o,s;try{const d=m.__wbindgen_add_to_stack_pointer(-16),_=A(n,m.__wbindgen_export,m.__wbindgen_export2),y=S,M=A(t,m.__wbindgen_export,m.__wbindgen_export2),v=S;m.testengine_createInstance(d,this.__wbg_ptr,_,y,M,v,ii(r)?Number.MAX_SAFE_INTEGER:r>>0);var l=w().getInt32(d+0,!0),c=w().getInt32(d+4,!0),u=w().getInt32(d+8,!0),a=w().getInt32(d+12,!0),p=l,h=c;if(a)throw p=0,h=0,z(u);return o=p,s=h,F(p,h)}finally{m.__wbindgen_add_to_stack_pointer(16),m.__wbindgen_export3(o,s,1)}}debugClear(){m.testengine_debugClear(this.__wbg_ptr)}debugCreateInstance(n,t,r){let o,s;try{const d=m.__wbindgen_add_to_stack_pointer(-16),_=A(n,m.__wbindgen_export,m.__wbindgen_export2),y=S,M=A(t,m.__wbindgen_export,m.__wbindgen_export2),v=S,g=A(r,m.__wbindgen_export,m.__wbindgen_export2),j=S;m.testengine_debugCreateInstance(d,this.__wbg_ptr,_,y,M,v,g,j);var l=w().getInt32(d+0,!0),c=w().getInt32(d+4,!0),u=w().getInt32(d+8,!0),a=w().getInt32(d+12,!0),p=l,h=c;if(a)throw p=0,h=0,z(u);return o=p,s=h,F(p,h)}finally{m.__wbindgen_add_to_stack_pointer(16),m.__wbindgen_export3(o,s,1)}}get debugIsPaused(){return m.testengine_debugIsPaused(this.__wbg_ptr)!==0}debugResume(){let n,t;try{const a=m.__wbindgen_add_to_stack_pointer(-16);m.testengine_debugResume(a,this.__wbg_ptr);var r=w().getInt32(a+0,!0),o=w().getInt32(a+4,!0),s=w().getInt32(a+8,!0),l=w().getInt32(a+12,!0),c=r,u=o;if(l)throw c=0,u=0,z(s);return n=c,t=u,F(c,u)}finally{m.__wbindgen_add_to_stack_pointer(16),m.__wbindgen_export3(n,t,1)}}debugStep(){let n,t;try{const a=m.__wbindgen_add_to_stack_pointer(-16);m.testengine_debugStep(a,this.__wbg_ptr);var r=w().getInt32(a+0,!0),o=w().getInt32(a+4,!0),s=w().getInt32(a+8,!0),l=w().getInt32(a+12,!0),c=r,u=o;if(l)throw c=0,u=0,z(s);return n=c,t=u,F(c,u)}finally{m.__wbindgen_add_to_stack_pointer(16),m.__wbindgen_export3(n,t,1)}}deploy(n){let t,r;try{const p=m.__wbindgen_add_to_stack_pointer(-16),h=A(n,m.__wbindgen_export,m.__wbindgen_export2),d=S;m.testengine_deploy(p,this.__wbg_ptr,h,d);var o=w().getInt32(p+0,!0),s=w().getInt32(p+4,!0),l=w().getInt32(p+8,!0),c=w().getInt32(p+12,!0),u=o,a=s;if(c)throw u=0,a=0,z(l);return t=u,r=a,F(u,a)}finally{m.__wbindgen_add_to_stack_pointer(16),m.__wbindgen_export3(t,r,1)}}deployForm(n){let t,r;try{const p=m.__wbindgen_add_to_stack_pointer(-16),h=A(n,m.__wbindgen_export,m.__wbindgen_export2),d=S;m.testengine_deployForm(p,this.__wbg_ptr,h,d);var o=w().getInt32(p+0,!0),s=w().getInt32(p+4,!0),l=w().getInt32(p+8,!0),c=w().getInt32(p+12,!0),u=o,a=s;if(c)throw u=0,a=0,z(l);return t=u,r=a,F(u,a)}finally{m.__wbindgen_add_to_stack_pointer(16),m.__wbindgen_export3(t,r,1)}}deployResource(n,t){let r,o;try{const h=m.__wbindgen_add_to_stack_pointer(-16),d=A(n,m.__wbindgen_export,m.__wbindgen_export2),_=S,y=A(t,m.__wbindgen_export,m.__wbindgen_export2),M=S;m.testengine_deployResource(h,this.__wbg_ptr,d,_,y,M);var s=w().getInt32(h+0,!0),l=w().getInt32(h+4,!0),c=w().getInt32(h+8,!0),u=w().getInt32(h+12,!0),a=s,p=l;if(u)throw a=0,p=0,z(c);return r=a,o=p,F(a,p)}finally{m.__wbindgen_add_to_stack_pointer(16),m.__wbindgen_export3(r,o,1)}}events(){let n,t;try{const a=m.__wbindgen_add_to_stack_pointer(-16);m.testengine_events(a,this.__wbg_ptr);var r=w().getInt32(a+0,!0),o=w().getInt32(a+4,!0),s=w().getInt32(a+8,!0),l=w().getInt32(a+12,!0),c=r,u=o;if(l)throw c=0,u=0,z(s);return n=c,t=u,F(c,u)}finally{m.__wbindgen_add_to_stack_pointer(16),m.__wbindgen_export3(n,t,1)}}failJob(n,t,r){let o,s;try{const d=m.__wbindgen_add_to_stack_pointer(-16),_=A(n,m.__wbindgen_export,m.__wbindgen_export2),y=S,M=A(r,m.__wbindgen_export,m.__wbindgen_export2),v=S;m.testengine_failJob(d,this.__wbg_ptr,_,y,t,M,v);var l=w().getInt32(d+0,!0),c=w().getInt32(d+4,!0),u=w().getInt32(d+8,!0),a=w().getInt32(d+12,!0),p=l,h=c;if(a)throw p=0,h=0,z(u);return o=p,s=h,F(p,h)}finally{m.__wbindgen_add_to_stack_pointer(16),m.__wbindgen_export3(o,s,1)}}migrate(n,t,r){let o,s;try{const d=m.__wbindgen_add_to_stack_pointer(-16),_=A(n,m.__wbindgen_export,m.__wbindgen_export2),y=S,M=A(t,m.__wbindgen_export,m.__wbindgen_export2),v=S,g=A(r,m.__wbindgen_export,m.__wbindgen_export2),j=S;m.testengine_migrate(d,this.__wbg_ptr,_,y,M,v,g,j);var l=w().getInt32(d+0,!0),c=w().getInt32(d+4,!0),u=w().getInt32(d+8,!0),a=w().getInt32(d+12,!0),p=l,h=c;if(a)throw p=0,h=0,z(u);return o=p,s=h,F(p,h)}finally{m.__wbindgen_add_to_stack_pointer(16),m.__wbindgen_export3(o,s,1)}}modify(n,t,r){let o,s;try{const d=m.__wbindgen_add_to_stack_pointer(-16),_=A(n,m.__wbindgen_export,m.__wbindgen_export2),y=S,M=A(t,m.__wbindgen_export,m.__wbindgen_export2),v=S,g=A(r,m.__wbindgen_export,m.__wbindgen_export2),j=S;m.testengine_modify(d,this.__wbg_ptr,_,y,M,v,g,j);var l=w().getInt32(d+0,!0),c=w().getInt32(d+4,!0),u=w().getInt32(d+8,!0),a=w().getInt32(d+12,!0),p=l,h=c;if(a)throw p=0,h=0,z(u);return o=p,s=h,F(p,h)}finally{m.__wbindgen_add_to_stack_pointer(16),m.__wbindgen_export3(o,s,1)}}constructor(){const n=m.testengine_new();return this.__wbg_ptr=n,Xn.register(this,this.__wbg_ptr,this),this}get now(){return m.testengine_now(this.__wbg_ptr)}reset(){m.testengine_reset(this.__wbg_ptr)}resolveIncident(n){let t,r;try{const p=m.__wbindgen_add_to_stack_pointer(-16),h=A(n,m.__wbindgen_export,m.__wbindgen_export2),d=S;m.testengine_resolveIncident(p,this.__wbg_ptr,h,d);var o=w().getInt32(p+0,!0),s=w().getInt32(p+4,!0),l=w().getInt32(p+8,!0),c=w().getInt32(p+12,!0),u=o,a=s;if(c)throw u=0,a=0,z(l);return t=u,r=a,F(u,a)}finally{m.__wbindgen_add_to_stack_pointer(16),m.__wbindgen_export3(t,r,1)}}setVariables(n,t,r){let o,s;try{const d=m.__wbindgen_add_to_stack_pointer(-16),_=A(n,m.__wbindgen_export,m.__wbindgen_export2),y=S,M=A(t,m.__wbindgen_export,m.__wbindgen_export2),v=S;m.testengine_setVariables(d,this.__wbg_ptr,_,y,M,v,r);var l=w().getInt32(d+0,!0),c=w().getInt32(d+4,!0),u=w().getInt32(d+8,!0),a=w().getInt32(d+12,!0),p=l,h=c;if(a)throw p=0,h=0,z(u);return o=p,s=h,F(p,h)}finally{m.__wbindgen_add_to_stack_pointer(16),m.__wbindgen_export3(o,s,1)}}snapshot(){let n,t;try{const a=m.__wbindgen_add_to_stack_pointer(-16);m.testengine_snapshot(a,this.__wbg_ptr);var r=w().getInt32(a+0,!0),o=w().getInt32(a+4,!0),s=w().getInt32(a+8,!0),l=w().getInt32(a+12,!0),c=r,u=o;if(l)throw c=0,u=0,z(s);return n=c,t=u,F(c,u)}finally{m.__wbindgen_add_to_stack_pointer(16),m.__wbindgen_export3(n,t,1)}}throwError(n,t,r){let o,s;try{const d=m.__wbindgen_add_to_stack_pointer(-16),_=A(n,m.__wbindgen_export,m.__wbindgen_export2),y=S,M=A(t,m.__wbindgen_export,m.__wbindgen_export2),v=S,g=A(r,m.__wbindgen_export,m.__wbindgen_export2),j=S;m.testengine_throwError(d,this.__wbg_ptr,_,y,M,v,g,j);var l=w().getInt32(d+0,!0),c=w().getInt32(d+4,!0),u=w().getInt32(d+8,!0),a=w().getInt32(d+12,!0),p=l,h=c;if(a)throw p=0,h=0,z(u);return o=p,s=h,F(p,h)}finally{m.__wbindgen_add_to_stack_pointer(16),m.__wbindgen_export3(o,s,1)}}tickNow(n){let t,r;try{const p=m.__wbindgen_add_to_stack_pointer(-16);m.testengine_tickNow(p,this.__wbg_ptr,n);var o=w().getInt32(p+0,!0),s=w().getInt32(p+4,!0),l=w().getInt32(p+8,!0),c=w().getInt32(p+12,!0),u=o,a=s;if(c)throw u=0,a=0,z(l);return t=u,r=a,F(u,a)}finally{m.__wbindgen_add_to_stack_pointer(16),m.__wbindgen_export3(t,r,1)}}unassignUserTask(n){let t,r;try{const p=m.__wbindgen_add_to_stack_pointer(-16),h=A(n,m.__wbindgen_export,m.__wbindgen_export2),d=S;m.testengine_unassignUserTask(p,this.__wbg_ptr,h,d);var o=w().getInt32(p+0,!0),s=w().getInt32(p+4,!0),l=w().getInt32(p+8,!0),c=w().getInt32(p+12,!0),u=o,a=s;if(c)throw u=0,a=0,z(l);return t=u,r=a,F(u,a)}finally{m.__wbindgen_add_to_stack_pointer(16),m.__wbindgen_export3(t,r,1)}}updateRetries(n,t){let r,o;try{const h=m.__wbindgen_add_to_stack_pointer(-16),d=A(n,m.__wbindgen_export,m.__wbindgen_export2),_=S;m.testengine_updateRetries(h,this.__wbg_ptr,d,_,t);var s=w().getInt32(h+0,!0),l=w().getInt32(h+4,!0),c=w().getInt32(h+8,!0),u=w().getInt32(h+12,!0),a=s,p=l;if(u)throw a=0,p=0,z(c);return r=a,o=p,F(a,p)}finally{m.__wbindgen_add_to_stack_pointer(16),m.__wbindgen_export3(r,o,1)}}updateUserTask(n,t){let r,o;try{const h=m.__wbindgen_add_to_stack_pointer(-16),d=A(n,m.__wbindgen_export,m.__wbindgen_export2),_=S,y=A(t,m.__wbindgen_export,m.__wbindgen_export2),M=S;m.testengine_updateUserTask(h,this.__wbg_ptr,d,_,y,M);var s=w().getInt32(h+0,!0),l=w().getInt32(h+4,!0),c=w().getInt32(h+8,!0),u=w().getInt32(h+12,!0),a=s,p=l;if(u)throw a=0,p=0,z(c);return r=a,o=p,F(a,p)}finally{m.__wbindgen_add_to_stack_pointer(16),m.__wbindgen_export3(r,o,1)}}}Symbol.dispose&&(Pn.prototype[Symbol.dispose]=Pn.prototype.free);function ei(){return{__proto__:null,"./nanobpmn_engine_bg.js":{__proto__:null,__wbg___wbindgen_throw_bb96b2010945f0bc:function(n,t){throw new Error(F(n,t))},__wbindgen_cast_0000000000000001:function(n,t){const r=F(n,t);return ni(r)},__wbindgen_object_drop_ref:function(n){z(n)}}}}const Xn=typeof FinalizationRegistry>"u"?{register:()=>{},unregister:()=>{}}:new FinalizationRegistry(e=>m.__wbg_testengine_free(e,1));function ni(e){nn===je.length&&je.push(je.length+1);const n=nn;return nn=je[n],je[n]=e,n}function ti(e){e<1028||(je[e]=nn,nn=e)}let Ue=null;function w(){return(Ue===null||Ue.buffer.detached===!0||Ue.buffer.detached===void 0&&Ue.buffer!==m.memory.buffer)&&(Ue=new DataView(m.memory.buffer)),Ue}function F(e,n){return ai(e>>>0,n)}let en=null;function mn(){return(en===null||en.byteLength===0)&&(en=new Uint8Array(m.memory.buffer)),en}function ri(e){return je[e]}let je=new Array(1024).fill(void 0);je.push(void 0,null,!0,!1);let nn=je.length;function ii(e){return e==null}function A(e,n,t){if(t===void 0){const c=tn.encode(e),u=n(c.length,1)>>>0;return mn().subarray(u,u+c.length).set(c),S=c.length,u}let r=e.length,o=n(r,1)>>>0;const s=mn();let l=0;for(;l<r;l++){const c=e.charCodeAt(l);if(c>127)break;s[o+l]=c}if(l!==r){l!==0&&(e=e.slice(l)),o=t(o,r,r=l+e.length*3,1)>>>0;const c=mn().subarray(o+l,o+r),u=tn.encodeInto(e,c);l+=u.written,o=t(o,r,l,1)>>>0}return S=l,o}function z(e){const n=ri(e);return ti(e),n}let pn=new TextDecoder("utf-8",{ignoreBOM:!0,fatal:!0});pn.decode();const oi=2146435072;let yn=0;function ai(e,n){return yn+=n,yn>=oi&&(pn=new TextDecoder("utf-8",{ignoreBOM:!0,fatal:!0}),pn.decode(),yn=n),pn.decode(mn().subarray(e,e+n))}const tn=new TextEncoder;"encodeInto"in tn||(tn.encodeInto=function(e,n){const t=tn.encode(e);return n.set(t),{read:e.length,written:t.length}});let S=0,m;function si(e,n){return m=e.exports,Ue=null,en=null,m}async function di(e,n){if(typeof Response=="function"&&e instanceof Response){if(!e.ok)throw new Error(`failed to fetch Wasm: ${e.status} ${e.statusText} fetching '${e.url}'`);if(typeof WebAssembly.instantiateStreaming=="function")try{return await WebAssembly.instantiateStreaming(e,n)}catch(o){if(t(e.type)&&e.headers.get("Content-Type")!=="application/wasm")console.warn("`WebAssembly.instantiateStreaming` failed because your server does not serve Wasm with `application/wasm` MIME type. Falling back to `WebAssembly.instantiate` which is slower. Original error:\n",o);else throw o}const r=await e.arrayBuffer();return await WebAssembly.instantiate(r,n)}else{const r=await WebAssembly.instantiate(e,n);return r instanceof WebAssembly.Instance?{instance:r,module:e}:r}function t(r){switch(r){case"basic":case"cors":case"default":return!0}return!1}}async function li(e){if(m!==void 0)return m;e!==void 0&&(Object.getPrototypeOf(e)===Object.prototype?{module_or_path:e}=e:console.warn("using deprecated parameters for the initialization function; pass a single object instead")),e===void 0&&(e=new URL("/pr-preview/pr-110/assets/nanobpmn_engine_bg-DRNrIVE8.wasm",import.meta.url));const n=ei();(typeof e=="string"||typeof Request=="function"&&e instanceof Request||typeof URL=="function"&&e instanceof URL)&&(e=fetch(e));const{instance:t,module:r}=await di(await e,n);return si(t)}let ln=null;function ci(e){return ln||(ln=li(void 0).then(()=>{}).catch(n=>{throw ln=null,n})),ln}function X(e){return JSON.parse(e)}class mi{constructor(n){L(this,"engine");this.engine=n}deploy(n){return JSON.parse(this.engine.deploy(n))}createInstance(n,t){return X(this.engine.createInstance(n,t||"{}"))}activateJobs(n,t,r,o){return JSON.parse(this.engine.activateJobs(n,t,r,o))}completeJob(n,t){return X(this.engine.completeJob(n,t||"{}"))}completeAgentJob(n,t){const{variables:r,...o}=t??{};return X(this.engine.completeAgentJob(n,JSON.stringify(r??{}),JSON.stringify(o??{})))}failJob(n,t,r){return X(this.engine.failJob(n,t,r))}throwError(n,t,r){return X(this.engine.throwError(n,t,r))}updateRetries(n,t){return X(this.engine.updateRetries(n,t))}resolveIncident(n){return X(this.engine.resolveIncident(n))}setVariables(n,t,r){return X(this.engine.setVariables(n,t||"{}",r))}broadcastSignal(n,t){return X(this.engine.broadcastSignal(n,t||"{}"))}cancelInstance(n){return X(this.engine.cancelInstance(n))}modify(n,t,r){return X(this.engine.modify(n,JSON.stringify(t??[]),JSON.stringify(r??[])))}completeUserTask(n,t){return X(this.engine.completeUserTask(n,t||"{}"))}assignUserTask(n,t,r){return X(this.engine.assignUserTask(n,t,r))}unassignUserTask(n){return X(this.engine.unassignUserTask(n))}updateUserTask(n,t){return X(this.engine.updateUserTask(n,t||"{}"))}correlateMessage(n,t,r){return X(this.engine.correlateMessage(n,t,r||"{}"))}advanceTime(n){return X(this.engine.advanceTime(n))}reset(){this.engine.reset()}events(){return JSON.parse(this.engine.events())}snapshot(){return X(this.engine.snapshot())}free(){this.engine.free()}}async function pi(e){return await ci(),new mi(new Pn)}class At extends Error{constructor(t,r){super(t);L(this,"retries");this.name="JobFailure",this.retries=r==null?void 0:r.retries}}function ui(e,n=[]){if(e.instances.filter(o=>!o.completed).length===0)return e.totalInstances>0?"completed":"idle";if(e.incidents.length>0)return"incidents";const r=new Set(n);return e.jobs.some(o=>!r.has(o.jobType))?"unhandledJobs":e.userTasks.some(o=>o.state==="Created")?"userTasks":e.timers.length>0?"timers":e.messageSubscriptions.length>0?"messages":e.signalSubscriptions.length>0?"signals":"idle"}function hi(e,n=[]){const t=new Set(n);return[...new Set(e.jobs.map(r=>r.jobType))].filter(r=>!t.has(r)).sort()}async function gi(e,n,t){let r;try{const o=await n(t);r=JSON.stringify(o??{})}catch(o){const s=o instanceof At&&o.retries!==void 0?o.retries:Math.max(0,t.retries-1),l=o instanceof Error?o.message:String(o);e.failJob(t.key,s,l);return}e.completeJob(t.key,r)}async function bi(e,n,t){let r;try{r=await n(t),JSON.stringify(r)}catch(o){const s=o instanceof At&&o.retries!==void 0?o.retries:Math.max(0,t.retries-1),l=o instanceof Error?o.message:String(o);e.failJob(t.key,s,l);return}e.completeAgentJob(t.key,r)}async function _i(e,n,t={}){const r=t.maxJobsPerActivation??10,o=t.lockTimeoutMs??3e4,s=t.worker??"bojtos",l=t.agents??{};for(const d of Object.keys(l))if(d in n)throw new Error(`dispatchRound: job type "${d}" is registered as both a worker and an agent — register it as exactly one`);const c=[];for(const[d,_]of Object.entries(n))for(const y of e.activateJobs(d,r,o,s))c.push({handler:_,job:y});const u=[];for(const[d,_]of Object.entries(l))for(const y of e.activateJobs(d,r,o,s))u.push({handler:_,job:y});for(const{handler:d,job:_}of c)await gi(e,d,_);for(const{handler:d,job:_}of u)await bi(e,d,_);const a=e.snapshot(),p=c.length+u.length;if(p>0)return{snapshot:a,handled:p};const h=[...Object.keys(n),...Object.keys(l)];return{snapshot:a,handled:p,reason:ui(a,h),unhandled:hi(a,h)}}function fi({bpmn:e}){const n=b.useRef(null),[t,r]=b.useState("loading"),[o,s]=b.useState(null),[l,c]=b.useState([]),[u,a]=b.useState(null),p=b.useRef(e),h=b.useRef(0),d=b.useRef(null),_=b.useRef(new Map),y=b.useCallback((T,E)=>{_.current.set(T,E)},[]),M=b.useCallback(T=>_.current.get(T),[]),v=b.useCallback((T,E)=>{const N=T.deploy(E);return p.current=E,_.current.clear(),c(N.processIds),a(null),s(null),N.processIds},[]);b.useEffect(()=>{let T=!1;return r("loading"),c([]),a(null),s(null),pi().then(E=>{if(T){E.free();return}try{v(E,e)}catch(N){E.free(),s(String(N)),r("error");return}n.current=E,r("ready")}).catch(E=>{T||(s(String(E)),r("error"))}),()=>{var E;T=!0,(E=n.current)==null||E.free(),n.current=null,_.current.clear()}},[e]);const g=b.useCallback(T=>{const E=n.current;if(!E)return null;try{const N=T(E);return a(N),s(null),N}catch(N){return s(String(N)),null}},[]),j=b.useCallback((T,E)=>g(N=>N.createInstance(T,E)),[g]),B=b.useCallback((T,E)=>g(N=>N.completeUserTask(T,E)),[g]),O=b.useCallback(T=>g(E=>E.advanceTime(T)),[g]),ie=b.useCallback((T,E)=>g(N=>N.broadcastSignal(T,E)),[g]);function W(T,E){const[N]=T.activateJobs(E,1,3e4,"manual-control");if(!N)throw new Error(`No waiting job of type "${E}" to resolve.`);return N}const Ne=b.useCallback((T,E)=>g(N=>{const U=W(N,T);return N.completeJob(U.key,E)}),[g]),Ee=b.useCallback((T,E,N)=>g(U=>{const $=W(U,T);return U.throwError($.key,E,N)}),[g]),we=b.useCallback((T,E,N)=>g(U=>U.correlateMessage(T,E,N)),[g]),Pe=b.useCallback(async(T,E)=>{const N=n.current;if(!N)return null;const U=h.current,$=_i(N,T,E);d.current=$;try{const ye=await $;return n.current!==N||h.current!==U?null:(a(ye.snapshot),s(null),ye)}catch(ye){return n.current!==N||h.current!==U||(a(N.snapshot()),s(String(ye))),null}finally{d.current===$&&(d.current=null)}},[]),Z=b.useCallback(async()=>{var T;await((T=d.current)==null?void 0:T.catch(()=>{}))},[]),me=b.useCallback(async()=>{await Z();const T=n.current;if(T){h.current++;try{T.reset(),v(T,p.current)}catch(E){s(String(E))}}},[v,Z]),q=b.useCallback(async T=>{await Z();const E=n.current;if(!E)return null;h.current++;try{return E.reset(),v(E,T)}catch(N){return s(String(N)),null}},[v,Z]);return{phase:t,error:o,processIds:l,snapshot:u,createInstance:j,stepWorkers:Pe,completeUserTask:B,advanceTime:O,broadcastSignal:ie,completeJobManually:Ne,throwJobError:Ee,correlateMessage:we,reset:me,redeploy:q,setRunImage:y,getRunImage:M}}function wi(e,n){return e.slice(n)}function yi(e,n,t,r){const o=e.snapshot,s="⏸ waiting for a human — complete the task below to continue",l=o.userTasks.some(c=>c.state==="Created");if(e.handled>0){const c=o.activeElementIds.map(t),u=n.length?` via ${n.map(a=>`${t(a.from)} → ${t(a.to)}`).join(", ")}`:"";return o.completedInstances>=1?{kind:"done",text:`⏭ round handled ${e.handled} job${e.handled===1?"":"s"}${u} — ✅ process instance completed`}:l?{kind:"human",text:`⏭ round handled ${e.handled} job${e.handled===1?"":"s"}${u} — ${s}`}:{kind:"step",text:`⏭ round handled ${e.handled} job${e.handled===1?"":"s"}${u} — now at ${c.length?c.join(", "):"—"}`}}switch(e.reason){case"completed":return{kind:"done",text:"✅ process instance completed"};case"userTasks":return{kind:"human",text:s};case"timers":return{kind:"step",text:"⏱ waiting on a timer — advance the clock to continue"};case"messages":return{kind:"step",text:"✉ waiting on a message — correlate it to continue"};case"signals":return{kind:"step",text:"📶 waiting on a signal — broadcast it to continue"};case"incidents":return{kind:"error",text:"A job failed — incident on the diagram"};case"unhandledJobs":{const c=e.unhandled??[];return r&&c.length>0&&c.every(u=>r.has(u))?{kind:"human",text:s}:{kind:"error",text:`⏭ waiting on job type(s) with no worker registered: ${c.join(", ")}`}}case"idle":return{kind:"step",text:"Nothing to step — no instance is running."};default:return{kind:"step",text:e.reason?`Step blocked on an unrecognized reason: ${e.reason}`:"Nothing to step — no instance is running."}}}const vi="the Scripted or Endpoint brain";async function hn(e=vi){const n=navigator.gpu;if(!n)return`This browser doesn't expose WebGPU at all. Use a recent Chrome, Edge, or Safari 17+ with hardware acceleration on, or pick ${e}.`;let t;try{t=await n.requestAdapter()}catch(r){return`WebGPU adapter request failed (${r instanceof Error?r.message:String(r)}). Try ${e} instead.`}return t?null:`This browser supports the WebGPU API, but no GPU adapter is available — hardware acceleration may be off, or this device/VM has no usable GPU. Pick ${e} instead.`}const Mi=[{id:"Qwen2.5-1.5B-Instruct-q4f16_1-MLC",label:"Qwen2.5 1.5B",downloadLabel:"~1.0 GB"},{id:"SmolLM2-1.7B-Instruct-q4f16_1-MLC",label:"SmolLM2 1.7B",downloadLabel:"~1.1 GB"},{id:"Llama-3.2-1B-Instruct-q4f16_1-MLC",label:"Llama 3.2 1B",downloadLabel:"~0.7 GB"},{id:"gemma-2-2b-it-q4f16_1-MLC",label:"Gemma 2 2B",downloadLabel:"~1.5 GB"},{id:"Llama-3.2-1B-Instruct-q4f32_1-MLC",label:"Llama 3.2 1B (f32, wider GPU support)",downloadLabel:"~1.1 GB"},{id:"SmolLM2-360M-Instruct-q4f32_1-MLC",label:"SmolLM2 360M (tiny, f32)",downloadLabel:"~0.6 GB"},{id:"SmolLM2-360M-Instruct-q4f16_1-MLC",label:"SmolLM2 360M (tiny)",downloadLabel:"~0.3 GB"}];function Ct(e){return An.get(e)??{}}const An=new Map;async function xi(){if(An.size>0)return;const{prebuiltAppConfig:e}=await ue(async()=>{const{prebuiltAppConfig:n}=await import("./vendor-webllm-DT0Ab8E6.js");return{prebuiltAppConfig:n}},[]);for(const n of e.model_list)An.set(n.model_id,{vramRequiredMB:n.vram_required_MB,requiredFeatures:n.required_features})}const fn=Mi.map(e=>({id:e.id,label:`${e.label} (${e.downloadLabel})`,downloadLabel:e.downloadLabel,...Ct(e.id)})),Dt=fn[0].id;async function Ni(){return await xi(),fn.map(e=>({...e,...Ct(e.id)}))}function Bt(){const e=navigator.deviceMemory;return typeof e=="number"?e*1024:null}function Ei(e,n=Bt()){return n==null||e.vramRequiredMB==null||n>=e.vramRequiredMB?null:`${e.label} needs roughly ${Math.round(e.vramRequiredMB)} MB of GPU memory; this device looks like it has about ${Math.round(n)} MB available. It may still work, but expect it to fail or fall back to slow shared memory — try a smaller model (e.g. SmolLM2 360M) if it doesn't load.`}async function ki(e){try{const{hasModelInCache:n}=await ue(async()=>{const{hasModelInCache:t}=await import("./vendor-webllm-DT0Ab8E6.js");return{hasModelInCache:t}},[]);return await n(e)}catch{return!1}}function gn(e){return/device (was )?lost|device_hung|device_removed|already been disposed|gpudevicelostinfo/i.test(e)}function et(){return"The GPU device was lost — the driver reset while the model was loading or running. This is a browser/driver-level failure, not a problem with the model: fully quit and reopen the browser (a lost device usually persists for the life of the GPU process), check chrome://gpu still reports hardware acceleration, and update your GPU driver if it recurs. The Scripted and Endpoint brains don't use the GPU at all."}class cn{constructor(){L(this,"kind","browser");L(this,"model",null);L(this,"engine",null);L(this,"worker",null);L(this,"generation",0);L(this,"chat",async(n,t=512,r)=>{var s,l;const o=this.engine;if(!o||!this.model)throw new Error("BrowserBrain.chat called before connect()");try{const c=await o.chat.completions.create({messages:n,temperature:0,max_tokens:t,stream:!0});let u="";for await(const a of c){const p=((l=(s=a.choices[0])==null?void 0:s.delta)==null?void 0:l.content)??"";p&&(u+=p,r==null||r(p))}return u}catch(c){const u=c instanceof Error?c.message:String(c);throw gn(u)?(this.teardown(),new Error(`The in-browser model stopped: ${et()}`)):c}})}async connect(n=Dt,t){var u,a;const r=await hn();if(r)throw new Error(r);if(this.engine&&this.model===n)return n;const o=++this.generation,s=p=>{o===this.generation&&(t==null||t({progress:p.progress??0,text:p.text??""}))};this.teardown();let l,c;try{const{CreateWebWorkerMLCEngine:p}=await ue(async()=>{const{CreateWebWorkerMLCEngine:h}=await import("./vendor-webllm-DT0Ab8E6.js");return{CreateWebWorkerMLCEngine:h}},[]);c=new Worker(new URL("/pr-preview/pr-110/assets/webllm.worker-Dc1cCqhL.js",import.meta.url),{type:"module"}),l=await p(c,n,{initProgressCallback:s})}catch(p){if(c==null||c.terminate(),o!==this.generation)throw new Error("cancelled");const h=p instanceof Error?p.message:String(p);if(gn(h))throw new Error(`Couldn't load ${n} in the browser (${h}). ${et()}`);const d=(a=(u=fn.find(_=>_.id===n))==null?void 0:u.requiredFeatures)==null?void 0:a.includes("shader-f16");throw new Error(`Couldn't load ${n} in the browser (${h}). `+(d?"This model needs WebGPU with shader-f16; try one of the f32 models in the list, or the endpoint brain.":"Try a smaller model, check your connection, or use the endpoint brain instead."))}if(o!==this.generation)throw l.unload().catch(()=>{}),c==null||c.terminate(),new Error("cancelled");return this.engine=l,this.worker=c??null,this.model=n,n}teardown(){const{engine:n,worker:t}=this;this.engine=null,this.worker=null,this.model=null,n==null||n.unload().catch(()=>{}),t==null||t.terminate()}cancelConnect(){this.generation++}dispose(){this.generation++,this.teardown()}}const Lt="http://localhost:11434/v1";function bn(e,n={hostname:(t=>(t=globalThis.location)==null?void 0:t.hostname)()??"",origin:(r=>(r=globalThis.location)==null?void 0:r.origin)()??""}){let o;try{o=new URL(Rt(e)).hostname}catch{return null}const s=l=>l==="localhost"||l==="127.0.0.1"||l==="::1"||l==="[::1]";return!s(o)||s(n.hostname)?null:`This page is served from ${n.origin||"a non-local origin"}, so it can't reach ${e}. A local model server only accepts requests from a page on localhost. Open this page at http://localhost instead, or use the Scripted or In-browser brain.`}function Rt(e){let n=e.trim().replace(/\/+$/,"");return n.endsWith("/chat/completions")&&(n=n.slice(0,-17)),/\/v\d+$/.test(n)||(n=`${n}/v1`),n}class nt extends Error{constructor(n,t){super(n),this.status=t,this.name="HttpError"}}class tt{constructor(n=Lt,t="",r=""){L(this,"kind","endpoint");L(this,"baseUrl");L(this,"model",null);L(this,"models",[]);L(this,"apiKey");L(this,"requestedModel");L(this,"chat",async(n,t=512,r)=>{var a,p,h;if(!this.model)throw new Error("EndpointBrain.chat called before connect()");const o=await fetch(`${this.baseUrl}/chat/completions`,{method:"POST",headers:this.headers(),body:JSON.stringify({model:this.model,messages:n,temperature:0,max_tokens:t,stream:!0})});if(!o.ok||!o.body){const d=await o.text().catch(()=>"");throw new Error(`chat/completions HTTP ${o.status} ${o.statusText}${d?` — ${d.slice(0,300)}`:""}`)}const s=o.body.getReader(),l=new TextDecoder;let c="",u="";for(;;){const{value:d,done:_}=await s.read();if(_)break;c+=l.decode(d,{stream:!0});let y;for(;(y=c.indexOf(`
`))>=0;){const M=c.slice(0,y).trim();if(c=c.slice(y+1),!M.startsWith("data:"))continue;const v=M.slice(5).trim();if(v==="[DONE]")continue;let g;try{g=JSON.parse(v)}catch{continue}g.model&&(this.model=g.model);const j=(a=g.choices)==null?void 0:a[0],B=((p=j==null?void 0:j.delta)==null?void 0:p.content)??((h=j==null?void 0:j.message)==null?void 0:h.content)??"";B&&(u+=B,r==null||r(B))}}return u});this.baseUrl=Rt(n),this.apiKey=t.trim(),this.requestedModel=r.trim()}headers(){const n={"Content-Type":"application/json"};return this.apiKey&&(n.Authorization=`Bearer ${this.apiKey}`),n}async listModels(){let n;try{n=await fetch(`${this.baseUrl}/models`,{headers:this.headers()})}catch(r){const o=bn(this.baseUrl);throw new Error(o??`Can't reach ${this.baseUrl} (${r instanceof Error?r.message:String(r)}). Is the server running? For Ollama, check the app is up — and if this page is served from another origin, allow it with OLLAMA_ORIGINS.`)}if(!n.ok)throw new nt(`${this.baseUrl}/models returned HTTP ${n.status} ${n.statusText}`,n.status);const t=await n.json();return this.models=(t.data??[]).map(r=>r.id).filter(r=>!!r),this.models}async connect(){try{const n=await this.listModels(),t=this.requestedModel||n[0];if(!t)throw new Error(`No models available at ${this.baseUrl}. Pull one first — e.g. \`ollama pull llama3.2:3b\` — or name one explicitly.`);this.model=t}catch(n){const t=n instanceof nt&&[404,405,501].includes(n.status);if(!this.requestedModel||!t)throw n;this.models=[],this.model=this.requestedModel}return await this.validate(),this.model}async validate(){const n=await fetch(`${this.baseUrl}/chat/completions`,{method:"POST",headers:this.headers(),body:JSON.stringify({model:this.model,messages:[{role:"user",content:"Reply with ok."}],temperature:0,max_tokens:1,stream:!1})}).catch(r=>{throw new Error(`Can't reach ${this.baseUrl}/chat/completions (${r instanceof Error?r.message:String(r)}). Check the endpoint URL, API key, model name, and any local CORS settings.`)});if(!n.ok){const r=await n.text().catch(()=>"");throw new Error(`chat/completions HTTP ${n.status} ${n.statusText}${r?` — ${r.slice(0,300)}`:""}`)}const t=await n.json().catch(()=>({}));t.model&&(this.model=t.model)}dispose(){}}const rt="gemini-nano";function _n(){const e=globalThis.LanguageModel;return typeof(e==null?void 0:e.create)=="function"&&typeof e.availability=="function"?e:null}function Ii(){return _n()!==null}async function Ft(){const e=_n();if(!e)return"This browser has no built-in AI model. Chrome's Prompt API (Gemini Nano) needs Chrome 138+ on desktop Windows 10/11, macOS 13+, Linux or a Chromebook Plus. Use the Scripted, In-browser (WebGPU) or API endpoint brain instead.";let n;try{n=await e.availability()}catch(t){return`Chrome couldn't report on its built-in model (${t instanceof Error?t.message:String(t)}).`}return n==="unavailable"?"Chrome exposes the built-in AI API here, but Gemini Nano can't run on this device. Chrome requires ~22 GB free on the volume holding your Chrome profile, and either a GPU with more than 4 GB of VRAM or 16 GB of RAM with 4+ CPU cores. Check chrome://on-device-internals for the details.":null}class it{constructor(){L(this,"kind","chrome");L(this,"model",null);L(this,"warm",null);L(this,"connecting",null);L(this,"chat",async(n,t,r)=>{if(!this.model)throw new Error("ChromeBrain.chat called before connect()");const o=_n();if(!o)throw new Error("Chrome's built-in AI API went away.");const s=n.filter(u=>u.role==="system"),l=n.filter(u=>u.role!=="system"),c=await o.create(s.length?{initialPrompts:s}:void 0);try{const u=c.promptStreaming(l).getReader();let a="";for(;;){const{done:p,value:h}=await u.read();if(p)break;h&&(a+=h,r==null||r(h))}return a}finally{c.destroy()}})}async connect(n){const t=await Ft();if(t)throw new Error(t);const r=_n();this.dispose();const o=new AbortController;this.connecting=o;try{this.warm=await r.create({signal:o.signal,monitor:s=>{s.addEventListener("downloadprogress",l=>{n==null||n({progress:l.loaded,text:"Downloading Gemini Nano"})})}})}catch(s){if(o.signal.aborted)throw new Error("cancelled");const l=s instanceof Error?s.message:String(s);throw new Error(`Chrome couldn't start its built-in model (${l}). The first run downloads Gemini Nano and must be triggered by a click — press Connect again, and check chrome://on-device-internals if it keeps failing.`)}finally{this.connecting=null}return this.model=rt,rt}cancelConnect(){var n;(n=this.connecting)==null||n.abort()}dispose(){var n,t;(n=this.connecting)==null||n.abort(),this.connecting=null,(t=this.warm)==null||t.destroy(),this.warm=null,this.model=null}}const Ti=[{id:"onnx-community/Florence-2-base-ft",label:"Florence-2 base",downloadLabel:"~0.4 GB"},{id:"onnx-community/Florence-2-large-ft",label:"Florence-2 large (higher quality)",downloadLabel:"~1.6 GB"}],zt=Ti.map(e=>({...e,label:`${e.label} (${e.downloadLabel})`})),Ot=zt[0].id,ji="<OCR>",ot="UNKNOWN (scripted brain — connect the in-browser model to read a photo)";function Si(e,n){if(e)return typeof e=="function"?e(n):e[n]}class Pi{constructor(n){L(this,"kind","scripted-vision");L(this,"model",null);L(this,"read",async(n,t,r)=>{const o=typeof n=="string"?Si(this.lookup,n)??ot:ot;return r==null||r(o),o});this.lookup=n}dispose(){}}function Ai(e){return new Pi(e)}class at{constructor(){L(this,"kind","browser-vision");L(this,"model",null);L(this,"modelHandle",null);L(this,"processor",null);L(this,"loadImage",null);L(this,"generation",0);L(this,"read",async(n,t,r)=>{const o=this.modelHandle,s=this.processor,l=this.loadImage;if(!o||!s||!l||!this.model)throw new Error("BrowserVisionBrain.read called before connect()");const c=t&&t.startsWith("<")?t:ji,u=await l(n),a=s.construct_prompts(c),p=await s(u,a),h=await o.generate({...p,max_new_tokens:512,num_beams:1,do_sample:!1}),d=s.batch_decode(h,{skip_special_tokens:!1})[0],_=s.post_process_generation(d,c,u.size),y=Ci(_,c);return r==null||r(y),y})}async connect(n=Ot,t){var c,u;const r=await hn("the scripted-vision fallback");if(r)throw new Error(r);if(this.modelHandle&&this.model===n)return n;const o=++this.generation,s=a=>{o===this.generation&&(t==null||t({progress:(a.progress??0)/100,text:a.file?`${a.status??"loading"} ${a.file}`:a.status??""}))};this.teardown();let l;try{const{Florence2ForConditionalGeneration:a,AutoProcessor:p,load_image:h}=await ue(async()=>{const{Florence2ForConditionalGeneration:y,AutoProcessor:M,load_image:v}=await import("./transformers.web-v_nn8DyV.js");return{Florence2ForConditionalGeneration:y,AutoProcessor:M,load_image:v}},[]),d=await a.from_pretrained(n,{dtype:"fp32",device:"webgpu",progress_callback:s}),_=await p.from_pretrained(n);l={model:d,processor:_,loadImage:h}}catch(a){if(o!==this.generation)throw new Error("cancelled");const p=a instanceof Error?a.message:String(a);throw new Error(`Couldn't load ${n} in the browser (${p}). Try the smaller Florence-2 base model, check your connection, or use the scripted-vision fallback.`)}if(o!==this.generation)throw Promise.resolve((u=(c=l.model).dispose)==null?void 0:u.call(c)).catch(()=>{}),new Error("cancelled");return this.modelHandle=l.model,this.processor=l.processor,this.loadImage=l.loadImage,this.model=n,n}teardown(){var t;const n=this.modelHandle;this.modelHandle=null,this.processor=null,this.loadImage=null,this.model=null,Promise.resolve((t=n==null?void 0:n.dispose)==null?void 0:t.call(n)).catch(()=>{})}cancelConnect(){this.generation++}dispose(){this.generation++,this.teardown()}}function Ci(e,n){const t=e[n];if(typeof t=="string")return t.trim();if(t&&typeof t=="object"){const r=t.labels;return Array.isArray(r)?r.join(" ").trim():JSON.stringify(t)}return""}function Di(){const[e,n]=b.useState("scripted"),[t,r]=b.useState("idle"),[o,s]=b.useState(null),[l,c]=b.useState(null),[u,a]=b.useState(null),[p,h]=b.useState(null),[d,_]=b.useState(null),[y,M]=b.useState(null),[v,g]=b.useState(null),[j,B]=b.useState(Dt),[O,ie]=b.useState(Lt),[W,Ne]=b.useState(""),[Ee,we]=b.useState([]),[Pe,Z]=b.useState("idle"),[me,q]=b.useState(null),[T,E]=b.useState(""),[N,U]=b.useState(null),$=b.useRef(null),[ye,Ge]=b.useState("scripted-vision"),[Je,oe]=b.useState("idle"),[He,ke]=b.useState(null),[We,Le]=b.useState(Ot),[Re,Ae]=b.useState(null),[wn,Fe]=b.useState(null),[Ze,se]=b.useState(null),[ae,ze]=b.useState(null),ee=b.useRef(null),Ce=b.useRef(!1),Oe=b.useRef(0),De=b.useCallback(k=>async(...Y)=>{try{return await k.chat(...Y)}catch(C){const J=C instanceof Error?C.message:String(C);throw k instanceof cn&&gn(J)&&(U(null),c(null),r("error"),s(J)),C}},[]),R=b.useCallback(k=>async(...Y)=>{try{return await k.read(...Y)}catch(C){const J=C instanceof Error?C.message:String(C);throw gn(J)&&(ze(null),Ae(null),oe("error"),ke(J)),C}},[]);b.useEffect(()=>{hn().then(k=>{_(k),h(k===null)}),Ft().then(g),hn("the scripted-vision fallback").then(k=>{se(k),Ce.current||(Ce.current=!0,Ge(k===null?"browser-vision":"scripted-vision"))})},[]),b.useEffect(()=>{let k=!1;return M(null),ki(j).then(Y=>{k||M(Y)}),()=>{k=!0}},[j]),b.useEffect(()=>()=>{var k;return(k=$.current)==null?void 0:k.dispose()},[]),b.useEffect(()=>()=>{var k;return(k=ee.current)==null?void 0:k.dispose()},[]);const ve=b.useCallback(k=>{n(k),r("idle"),s(null),c(null),a(null),U(null)},[]),Be=b.useCallback(k=>{var Y,C;Ce.current=!0,(Y=ee.current)==null||Y.cancelConnect(),(C=ee.current)==null||C.dispose(),ee.current=null,Ge(k),oe("idle"),ke(null),Ae(null),Fe(null),ze(null)},[]),he=b.useCallback(()=>{var k;(k=$.current)==null||k.dispose(),$.current=null,U(null),c(null)},[]),on=b.useCallback(()=>{const k=$.current;(k instanceof cn||k instanceof it)&&k.cancelConnect(),he(),r("idle"),a(null),s(null)},[he]),ge=b.useCallback(async()=>{const k=++Oe.current,Y=()=>k!==Oe.current,C=bn(O);if(C){we([]),Z("error"),q(C);return}Z("loading"),q(null);const J=new tt(O,T);try{const Me=await J.listModels();if(Y())return;we(Me),Z("ready"),Ne(Ke=>Ke&&Me.includes(Ke)?Ke:Me[0]??"")}catch(Me){if(Y())return;we([]),Ne(""),Z("error"),q(Me instanceof Error?Me.message:String(Me))}finally{J.dispose()}},[O,T]),Ve=b.useCallback(async()=>{var k,Y;if(e==="scripted"){U(null),r("ready");return}if(e==="endpoint"){const C=bn(O);if(C){he(),s(C),r("error");return}}r("connecting"),s(null),a(null);try{if(e==="browser"){const C=$.current instanceof cn?$.current:new cn;$.current&&$.current!==C&&$.current.dispose(),$.current=C;const J=await C.connect(j,a);c(J),U(()=>De(C)),M(!0)}else if(e==="chrome"){(k=$.current)==null||k.dispose();const C=new it;$.current=C;const J=await C.connect(a);g(null),c(J),U(()=>De(C))}else{(Y=$.current)==null||Y.dispose();const C=new tt(O,T,W);$.current=C;const J=await C.connect();c(J),U(()=>De(C))}r("ready")}catch(C){const J=C instanceof Error?C.message:String(C);if(J==="cancelled")return;s(J),r("error"),U(null)}finally{a(null)}},[e,j,O,W,T,he,De]),Ie=b.useCallback(()=>{var k;(k=ee.current)==null||k.dispose(),ee.current=null,ze(null),Ae(null)},[]),an=b.useCallback(()=>{var k;(k=ee.current)==null||k.cancelConnect(),Ie(),oe("idle"),Fe(null),ke(null)},[Ie]),Ye=b.useCallback(async()=>{if(ye==="scripted-vision"){Ie(),oe("ready"),ke(null);return}oe("connecting"),ke(null),Fe(null);try{const k=ee.current instanceof at?ee.current:new at;ee.current&&ee.current!==k&&ee.current.dispose(),ee.current=k;const Y=await k.connect(We,Fe);Ae(Y),ze(()=>R(k)),oe("ready")}catch(k){const Y=k instanceof Error?k.message:String(k);if(Y==="cancelled")return;ke(Y),oe("error"),ze(null),Ae(null)}finally{Fe(null)}},[ye,We,Ie,R]);return{kind:e,setKind:ve,status:t,error:o,modelInUse:l,progress:u,webgpu:p,webgpuReason:d,browserModelCached:y,chromeAiReason:v,cancelConnect:on,browserModel:j,setBrowserModel:B,endpointUrl:O,setEndpointUrl:ie,endpointModel:W,setEndpointModel:Ne,endpointModels:Ee,endpointModelsStatus:Pe,endpointModelsError:me,listEndpointModels:ge,apiKey:T,setApiKey:E,connect:Ve,chat:N,visionKind:ye,setVisionKind:Be,visionStatus:Je,visionError:He,visionModel:We,setVisionModel:Le,visionModelInUse:Re,visionProgress:wn,visionWebgpuReason:Ze,connectVision:Ye,cancelVisionConnect:an,vision:ae}}const Cn="#s=",Bi=["scripted","browser","chrome","endpoint"];function Li(e){return typeof e=="string"&&Bi.includes(e)}function Ri(e){try{const n=JSON.parse(e);if(n&&typeof n=="object"){const t=n,r={};return Li(t.brain)&&(r.brain=t.brain),r}}catch{}return{}}function Ut(e=location.hash){if(!e.startsWith(Cn))return{};let n;try{n=decodeURIComponent(e.slice(Cn.length))}catch{return{}}return Ri(n)}function Fi(e){const n=Object.entries(e).filter(([,t])=>t!==void 0);return n.length===0?"":Cn+encodeURIComponent(JSON.stringify(Object.fromEntries(n)))}function zi(e){const n={...Ut(),...e},t=Fi(n),r=new URL(location.href);r.hash=t,history.replaceState(history.state,"",r)}const st=[{kind:"scripted",label:"Scripted",hint:"No model. The example's stand-in decides — deterministic and offline."},{kind:"browser",label:"In-browser (WebGPU)",hint:"A small quantised model on your GPU. First run downloads weights."},{kind:"chrome",label:"Chrome built-in",hint:"Gemini Nano, built into Chrome. Chrome owns the weights — no download from this page, no API key."},{kind:"endpoint",label:"API endpoint",hint:"Any OpenAI-compatible server. Ollama by default. Local pages only."}],dt=[{kind:"scripted-vision",label:"Scripted",hint:"No model. The example's known plate is returned — deterministic and offline."},{kind:"browser-vision",label:"In-browser (WebGPU)",hint:"Reads the photo with a vision model on your GPU. First run downloads weights."}];function Oi({brain:e,showText:n=!0,showVision:t=!1}){return i.jsxs("div",{className:"brain",children:[n&&i.jsx(Ui,{brain:e}),n&&t&&i.jsx("hr",{className:"brain-divider"}),t&&i.jsx($i,{brain:e})]})}function Ui({brain:e}){const n=st.find(d=>d.kind===e.kind),t=st.filter(d=>d.kind!=="chrome"||Ii()),r=bn(e.endpointUrl),[o,s]=b.useState(fn);b.useEffect(()=>{Ni().then(s)},[]);const{kind:l,endpointUrl:c,apiKey:u,listEndpointModels:a}=e;b.useEffect(()=>{if(l!=="endpoint"||r)return;const d=setTimeout(()=>void a(),400);return()=>clearTimeout(d)},[l,c,u,r,a]);const p=o.find(d=>d.id===e.browserModel),h=p?Ei(p,Bt()):null;return i.jsxs("div",{className:"brain-section",children:[i.jsxs("div",{className:"brain-modes",children:[i.jsx("div",{className:"brain-kinds",role:"group","aria-label":"Agent brain",children:t.map(d=>i.jsx(H,{size:"sm",variant:e.kind===d.kind?"default":"secondary","aria-pressed":e.kind===d.kind,onClick:()=>e.setKind(d.kind),children:d.label},d.kind))}),i.jsxs("div",{className:"brain-status",children:[e.status==="ready"&&e.kind!=="scripted"&&i.jsx(re,{variant:"success",className:"brain-status-badge",children:e.modelInUse??"connected"}),e.status==="connecting"&&i.jsx(re,{variant:"info",className:"brain-status-badge",children:"connecting…"}),e.status==="error"&&i.jsx(re,{variant:"danger",className:"brain-status-badge",children:"not connected"})]})]}),i.jsx("p",{className:"field-hint",children:n.hint}),e.kind==="browser"&&i.jsxs("div",{className:"brain-config",children:[i.jsxs("div",{className:"field",children:[i.jsx(qe,{htmlFor:"browser-model",children:"Model"}),i.jsxs(Nn,{value:e.browserModel,onValueChange:e.setBrowserModel,disabled:e.status==="connecting",children:[i.jsx(En,{id:"browser-model",children:i.jsx(kn,{})}),i.jsx(In,{children:o.map(d=>i.jsx(Tn,{value:d.id,children:d.label},d.id))})]}),e.browserModelCached===!0&&i.jsx("p",{className:"field-hint",children:"Already downloaded in this browser — connecting will be fast."}),e.browserModelCached===!1&&i.jsx("p",{className:"field-hint",children:"Not downloaded yet — connecting fetches the weights once, then caches them for next time."})]}),e.webgpu===!1&&e.webgpuReason&&i.jsxs(de,{variant:"destructive",children:[i.jsx(le,{children:"No WebGPU in this browser"}),i.jsx(ce,{children:e.webgpuReason})]}),e.webgpu!==!1&&h&&i.jsxs(de,{variant:"destructive",children:[i.jsx(le,{children:"This model may not fit in GPU memory"}),i.jsx(ce,{children:h})]})]}),e.kind==="chrome"&&i.jsxs("div",{className:"brain-config",children:[i.jsx("p",{className:"field-hint",children:"Nothing to configure: Chrome downloads and manages Gemini Nano itself, so the first Connect may fetch it once and later visits reuse it. Prompts never leave your machine. It's a very small model — expect it to follow the tool-calling format less reliably than an endpoint model."}),e.chromeAiReason&&i.jsxs(de,{variant:"destructive",children:[i.jsx(le,{children:"Chrome's built-in model isn't available here"}),i.jsx(ce,{children:e.chromeAiReason})]})]}),e.kind==="endpoint"&&i.jsxs("div",{className:"brain-config",children:[i.jsxs("div",{className:"field",children:[i.jsx(qe,{htmlFor:"endpoint-url",children:"Endpoint"}),i.jsx(Yn,{id:"endpoint-url",value:e.endpointUrl,onChange:d=>e.setEndpointUrl(d.target.value),disabled:e.status==="connecting"}),i.jsxs("p",{className:"field-hint",children:["Ollama allows ",i.jsx("code",{children:"localhost"})," origins out of the box; set"," ",i.jsx("code",{children:"OLLAMA_ORIGINS"})," only when serving this page from another host. Best for local development — a hosted copy of this page can't reach a server on your machine at all."]}),r&&i.jsxs(de,{variant:"destructive",children:[i.jsx(le,{children:"A local server won't work from this URL"}),i.jsx(ce,{children:r})]})]}),i.jsxs("div",{className:"field",children:[i.jsx(qe,{htmlFor:"endpoint-model",children:"Model"}),i.jsxs("div",{className:"endpoint-model-row",children:[i.jsxs(Nn,{value:e.endpointModel,onValueChange:e.setEndpointModel,disabled:e.status==="connecting"||e.endpointModelsStatus==="loading"||e.endpointModels.length===0,children:[i.jsx(En,{id:"endpoint-model",className:"endpoint-model-select",children:i.jsx(kn,{placeholder:e.endpointModelsStatus==="loading"?"Loading models…":e.endpointModelsStatus==="idle"?"Enter an endpoint above":e.endpointModelsStatus==="error"?"No models — check the endpoint":e.endpointModels.length===0?"No models served":"Select a model"})}),i.jsx(In,{children:e.endpointModels.map(d=>i.jsx(Tn,{value:d,children:d},d))})]}),i.jsx(H,{size:"sm",variant:"secondary",onClick:()=>void e.listEndpointModels(),disabled:e.status==="connecting"||e.endpointModelsStatus==="loading"||r!==null,children:e.endpointModelsStatus==="loading"?"Refreshing…":"Refresh"})]}),i.jsxs("p",{className:"field-hint",children:["Fetched from the endpoint's ",i.jsx("code",{children:"/models"}),". Tiny models (e.g. SmolLM2) usually can't follow the tool-calling format — prefer ",i.jsx("code",{children:"llama3.2:3b"}),", ",i.jsx("code",{children:"qwen2.5"})," or larger."]}),e.endpointModelsStatus==="error"&&!r&&i.jsxs(de,{variant:"destructive",children:[i.jsx(le,{children:"Couldn't list models"}),i.jsx(ce,{children:e.endpointModelsError})]})]}),i.jsxs("div",{className:"field",children:[i.jsx(qe,{htmlFor:"endpoint-key",children:"API key (optional)"}),i.jsx(Yn,{id:"endpoint-key",type:"password",value:e.apiKey,onChange:d=>e.setApiKey(d.target.value),disabled:e.status==="connecting"})]})]}),e.kind!=="scripted"&&i.jsxs("div",{className:"brain-actions",children:[i.jsx(H,{size:"sm",onClick:()=>void e.connect(),disabled:e.status==="connecting"||e.kind==="chrome"&&e.chromeAiReason!==null||e.kind==="endpoint"&&(e.endpointModel===""||e.endpointModelsStatus==="loading"||r!==null),children:e.status==="ready"?"Reconnect":"Connect"}),e.status==="connecting"&&(e.kind==="browser"||e.kind==="chrome")&&i.jsx(H,{size:"sm",variant:"secondary",onClick:e.cancelConnect,children:"Cancel"}),e.progress&&i.jsxs("span",{className:"field-hint",children:[Math.round(e.progress.progress*100),"% —"," ",e.progress.text]})]}),e.progress&&i.jsx("div",{className:"brain-progress",role:"progressbar","aria-valuenow":Math.round(e.progress.progress*100),"aria-valuemin":0,"aria-valuemax":100,children:i.jsx("div",{className:"brain-progress-bar",style:{width:`${Math.round(e.progress.progress*100)}%`}})}),e.error&&i.jsxs(de,{variant:"destructive",children:[i.jsx(le,{children:"Couldn't connect"}),i.jsx(ce,{children:e.error})]})]})}function $i({brain:e}){const n=dt.find(t=>t.kind===e.visionKind);return i.jsxs("div",{className:"brain-section brain-vision",children:[i.jsx(qe,{children:"Vision (reads the image)"}),i.jsxs("div",{className:"brain-modes",children:[i.jsx("div",{className:"brain-kinds",role:"group","aria-label":"Vision brain",children:dt.map(t=>i.jsx(H,{size:"sm",variant:e.visionKind===t.kind?"default":"secondary","aria-pressed":e.visionKind===t.kind,onClick:()=>e.setVisionKind(t.kind),children:t.label},t.kind))}),i.jsxs("div",{className:"brain-status",children:[e.visionStatus==="ready"&&e.visionKind==="browser-vision"&&i.jsx(re,{variant:"success",className:"brain-status-badge",children:e.visionModelInUse??"connected"}),e.visionStatus==="connecting"&&i.jsx(re,{variant:"info",className:"brain-status-badge",children:"connecting…"}),e.visionStatus==="error"&&i.jsx(re,{variant:"danger",className:"brain-status-badge",children:"not connected"})]})]}),i.jsx("p",{className:"field-hint",children:n.hint}),e.visionKind==="scripted-vision"&&e.webgpu===!1&&e.visionWebgpuReason&&i.jsxs(de,{variant:"destructive",children:[i.jsx(le,{children:"No WebGPU in this browser"}),i.jsx(ce,{children:e.visionWebgpuReason})]}),e.visionKind==="browser-vision"&&i.jsxs("div",{className:"brain-config",children:[i.jsxs("div",{className:"field",children:[i.jsx(qe,{htmlFor:"vision-model",children:"Model"}),i.jsxs(Nn,{value:e.visionModel,onValueChange:e.setVisionModel,disabled:e.visionStatus==="connecting",children:[i.jsx(En,{id:"vision-model",children:i.jsx(kn,{})}),i.jsx(In,{children:zt.map(t=>i.jsx(Tn,{value:t.id,children:t.label},t.id))})]}),i.jsx("p",{className:"field-hint",children:"Connecting downloads the weights once (size shown above), then caches them — every token is read on your GPU, no server."})]}),e.webgpu===!1&&e.visionWebgpuReason&&i.jsxs(de,{variant:"destructive",children:[i.jsx(le,{children:"No WebGPU in this browser"}),i.jsx(ce,{children:e.visionWebgpuReason})]})]}),e.visionKind==="browser-vision"&&i.jsxs("div",{className:"brain-actions",children:[i.jsx(H,{size:"sm",onClick:()=>void e.connectVision(),disabled:e.visionStatus==="connecting",children:e.visionStatus==="ready"?"Reconnect":"Connect"}),e.visionStatus==="connecting"&&i.jsx(H,{size:"sm",variant:"secondary",onClick:e.cancelVisionConnect,children:"Cancel"}),e.visionProgress&&i.jsxs("span",{className:"field-hint",children:[Math.round(e.visionProgress.progress*100),"% —"," ",e.visionProgress.text]})]}),e.visionError&&i.jsxs(de,{variant:"destructive",children:[i.jsx(le,{children:"Couldn't connect the vision brain"}),i.jsx(ce,{children:e.visionError})]})]})}function Gi({imageInput:e,value:n,onSelect:t,disabled:r=!1}){const[o,s]=b.useState(null),[l,c]=b.useState(!1),u=b.useRef(null),a=b.useId(),p=b.useId(),h=b.useCallback(y=>{s(URL.createObjectURL(y)),t({imageName:y.name,pixels:y})},[t]);b.useEffect(()=>{if(o)return()=>URL.revokeObjectURL(o)},[o]);const d=b.useCallback(y=>{const M=y==null?void 0:y[0];M&&M.type.startsWith("image/")&&h(M)},[h]),_=(n==null?void 0:n.imageId)!=null?e.seedImages.find(y=>y.id===n.imageId):void 0;return i.jsxs("div",{className:"image-input",children:[e.label&&i.jsx("p",{className:"field-hint",children:e.label}),i.jsx("p",{className:"image-input-label",id:a,children:"Seed photos"}),i.jsx("div",{className:"image-gallery",role:"group","aria-labelledby":a,children:e.seedImages.map(y=>{const M=(n==null?void 0:n.imageId)===y.id;return i.jsxs("button",{type:"button","aria-pressed":M,className:`image-thumb${M?" image-thumb--selected":""}`,disabled:r,title:y.label??y.id,onClick:()=>{s(null),u.current&&(u.current.value=""),t({imageId:y.id,pixels:y.file})},children:[i.jsx("img",{src:y.thumb??y.file,alt:y.label??y.id}),y.label&&i.jsx("span",{children:y.label})]},y.id)})}),i.jsx("label",{className:"image-input-label",htmlFor:p,children:"Or upload your own photo"}),i.jsxs("div",{className:`image-drop${l?" image-drop--over":""}`,onDragOver:y=>{y.preventDefault(),r||c(!0)},onDragLeave:()=>c(!1),onDrop:y=>{y.preventDefault(),c(!1),r||d(y.dataTransfer.files)},children:[i.jsx("input",{ref:u,id:p,type:"file",accept:"image/*",disabled:r,onChange:y=>d(y.target.files)}),i.jsx("p",{className:"field-hint",children:"Drag a photo here, or pick one. Uploading a photo the model has never seen is the proof this runs for real — nothing leaves your browser."})]}),(o||_)&&i.jsxs("div",{className:"image-preview",children:[i.jsx("img",{src:o??(_==null?void 0:_.file),alt:o?(n==null?void 0:n.imageName)??"uploaded photo":(_==null?void 0:_.label)??(_==null?void 0:_.id)??"selected photo"}),i.jsx("span",{className:"field-hint",children:o?`Uploaded: ${(n==null?void 0:n.imageName)??"your photo"}`:`Selected: ${(_==null?void 0:_.label)??(_==null?void 0:_.id)}`}),i.jsx("button",{type:"button",className:"image-clear-btn",disabled:r,onClick:()=>{s(null),u.current&&(u.current.value=""),t(null)},children:"Clear"})]})]})}function $t(e){return typeof e=="object"&&e!==null}function Sd(e){const n=new Set,t=r=>{$t(r)&&(typeof r.key=="string"&&n.add(r.key),Array.isArray(r.components)&&r.components.forEach(t))};return t(e),n}function Vi(e){const n={},t=r=>{$t(r)&&(typeof r.key=="string"&&"defaultValue"in r&&(n[r.key]=r.defaultValue??""),Array.isArray(r.components)&&r.components.forEach(t))};return t(e),n}const Yi="wdf:section:v2:";function Gt(e){return Yi+e}function lt(e){try{const n=window.localStorage.getItem(Gt(e));return n==="1"?!0:n==="0"?!1:void 0}catch{return}}function Qi(e,n){try{window.localStorage.setItem(Gt(e),n?"1":"0")}catch{}}function Bn(e,n=!0){const[t,r]=b.useState(()=>lt(e)??n);b.useEffect(()=>{r(lt(e)??n)},[e,n]);const o=b.useCallback(s=>{r(s),Qi(e,s)},[e]);return[t,o]}function $e({sectionId:e,title:n,description:t,defaultOpen:r=!0,className:o,children:s,...l}){const[c,u]=Bn(e,r);return i.jsx(er,{className:["panel",o].filter(Boolean).join(" "),"data-tour":l["data-tour"],children:i.jsxs(nr,{open:c,onOpenChange:u,children:[i.jsxs(tr,{className:"panel-trigger",children:[i.jsxs("span",{className:"panel-trigger-text",children:[i.jsx("span",{className:"panel-title",children:n}),t!=null&&i.jsx("span",{className:"panel-desc",children:t})]}),i.jsx(rr,{className:"panel-chevron","aria-hidden":!0})]}),i.jsx(ir,{children:i.jsx(or,{children:s})})]})})}function qi(e){return e.entries!==void 0}function Ji(e){const n=[];let t=null;for(const r of e)r.turn!==void 0?t&&t.turn===r.turn?t.entries.push(r):(t={turn:r.turn,entries:[r]},n.push(t)):(t=null,n.push(r));return n}function ct(e){if(e===void 0)return"undefined";try{return JSON.stringify(e)}catch{return"[unserializable value]"}}function Hi({activation:e,result:n,labelFor:t}){const r=e.elementId??"";return i.jsxs("div",{className:"timeline-tool",children:[i.jsxs("div",{className:"timeline-tool-head",children:[i.jsx(re,{variant:"info",children:"tool"}),i.jsx("strong",{children:t(r)||r}),i.jsx("code",{children:r})]}),e.args!==void 0&&Object.keys(e.args).length>0&&i.jsxs("div",{className:"timeline-kv",children:[i.jsx("span",{className:"timeline-kv-label",children:"arguments"}),i.jsx("code",{children:ct(e.args)})]}),i.jsxs("div",{className:"timeline-kv",children:[i.jsx("span",{className:"timeline-kv-label",children:"returned"}),i.jsx("code",{children:n?ct(n.result):"— waiting for the job to complete —"})]})]})}function Wi({group:e,labelFor:n}){const t=e.entries.find(a=>a.kind==="llm"),r=e.entries.filter(a=>a.kind==="agent"&&a.elementId),o=e.entries.filter(a=>a.kind==="vars"&&a.elementId),s=e.entries.filter(a=>a.kind==="agent"&&!a.elementId),l=e.entries.filter(a=>a.kind==="error"),c=new Set(r.map(a=>a.elementId)),u=e.entries.filter(a=>a.kind==="tool"||a.kind==="vars"&&a.elementId&&!c.has(a.elementId)).sort((a,p)=>a.id-p.id);return i.jsxs("div",{className:"timeline-turn",children:[i.jsxs("div",{className:"timeline-turn-head",children:[i.jsxs(re,{variant:t!=null&&t.pending?"warning":"neutral",children:["Turn ",e.turn]}),(t==null?void 0:t.pending)&&i.jsx("span",{className:"timeline-pending",children:"thinking…"})]}),t&&i.jsx("blockquote",{className:"timeline-reply",children:t.text}),s.map(a=>i.jsx("div",{className:"timeline-note",children:a.text},a.id)),r.map(a=>i.jsx(Hi,{activation:a,result:o.find(p=>p.elementId===a.elementId),labelFor:n},a.id)),u.map(a=>i.jsxs("div",{className:`log-line log-${a.kind}`,children:[a.pending?"⏳ ":"",a.text]},a.id)),l.map(a=>i.jsxs("div",{className:"timeline-error",children:["⚠ ",a.text]},a.id))]})}function Zi({log:e,elementStats:n=[],incidents:t=[],labelFor:r=s=>s,variables:o}){const s=b.useMemo(()=>Ji(e),[e]),[l,c]=b.useState(!1),[u,a]=Bn("engine-view",!1),p=b.useRef(null);b.useEffect(()=>{const d=p.current;d&&(d.scrollTop=d.scrollHeight)},[s]);const h=()=>{var y;const d={log:e.map(({id:M,...v})=>v),elementStats:n,incidents:t},_=JSON.stringify(d,null,2);(y=navigator.clipboard)!=null&&y.writeText&&navigator.clipboard.writeText(_).then(()=>{c(!0),setTimeout(()=>c(!1),1500)}).catch(()=>{})};return i.jsxs($e,{sectionId:"activity",className:"grow activity-card",title:"Agent activity",description:"Agent turns, model replies, and tool calls — read top to bottom as a story.",children:[i.jsx("div",{className:"timeline-toolbar",children:i.jsx(H,{variant:"secondary",size:"sm",onClick:h,children:l?"Copied!":"Copy run as JSON"})}),i.jsx("div",{className:"timeline",ref:p,children:s.length===0?i.jsx("div",{className:"log-empty",children:"Press Run or Step to start."}):s.map(d=>qi(d)?i.jsx(Wi,{group:d,labelFor:r},`turn-${d.turn}-${d.entries[0].id}`):i.jsxs("div",{className:`log-line log-${d.kind}`,children:[d.pending?"⏳ ":"",d.text]},d.id))}),o,(n.length>0||t.length>0)&&i.jsxs("details",{className:"engine-view",open:u,onToggle:d=>a(d.currentTarget.open),children:[i.jsxs("summary",{children:["Element completion",t.length>0&&` · ${t.length} incident${t.length===1?"":"s"}`]}),i.jsxs("div",{className:"timeline-engine-view",children:[n.length>0&&i.jsxs("div",{className:"timeline-stats",children:[i.jsx("span",{className:"timeline-kv-label",children:"Element completion"}),i.jsx("ul",{children:n.filter(d=>d.completed>0||(d.active??0)>0).map(d=>i.jsxs("li",{children:[i.jsx("code",{children:r(d.elementId)||d.elementId})," ","completed ",d.completed,d.active?`, ${d.active} active`:""]},d.elementId))})]}),t.length>0&&i.jsxs("div",{className:"timeline-incidents",children:[i.jsx("span",{className:"timeline-kv-label",children:"Incidents"}),i.jsx("ul",{children:t.map((d,_)=>i.jsxs("li",{children:[i.jsx("code",{children:r(d.elementId)||d.elementId})," —"," ",d.reason]},`${d.elementId}-${_}`))})]})]})]})]})}const xe={diagram:"diagram",runButton:"run-button",variablesPanel:"variables-panel",codePanel:"code-panel",brainPanel:"brain-panel"};function mt(e){return`[data-tour="${e}"]`}function Ki(e=location.search){return new URLSearchParams(e).get("tour")}function Xi(e,n){var t;return((t=e.elementStats.find(r=>r.elementId===n))==null?void 0:t.completed)??0}function eo(e,n){return!e||e.kind==="click"||!n?!1:e.kind==="activeElement"?n.activeElementIds.includes(e.elementId):Xi(n,e.elementId)>=(e.atLeast??1)}function no(e){return"anchor"in e?mt(e.anchor):`${mt(xe.diagram)} [data-element-id="${to(e.elementId)}"]`}function to(e){return typeof CSS<"u"&&typeof CSS.escape=="function"?CSS.escape(e):e.replace(/[^a-zA-Z0-9_-]/g,n=>`\\${n}`)}function ro(e){return e.map(n=>{const t=!!n.waitFor&&n.waitFor.kind!=="click";return{element:no(n.target),popover:{title:n.title,description:t?`${n.description} (continues automatically once you reach that point — or use Next to skip ahead)`:n.description,showButtons:["next","previous","close"]},disableActiveInteraction:!1,skipMissingElement:n.skipMissingElement??!0}})}async function io(e,n={}){var s;const[{driver:t}]=await Promise.all([ue(()=>import("./driver.js-bj_ppY-Q.js"),[]),ue(()=>Promise.resolve({}),__vite__mapDeps([0]))]),r=ro(e),o=t({steps:r,showProgress:!0,allowClose:!0,skipMissingElement:!0,onHighlighted:(l,c,{index:u})=>{var a;u!==void 0&&((a=n.onIndexChange)==null||a.call(n,u))}});return o.drive(),(s=n.onIndexChange)==null||s.call(n,o.getActiveIndex()??0),{moveNext:()=>o.moveNext(),activeIndex:()=>o.getActiveIndex()??-1,isActive:()=>o.isActive(),destroy:()=>o.destroy()}}const oo=300;function ao(e,n){const[t,r]=b.useState(!1),o=b.useRef(null),s=b.useRef(0),l=b.useRef(-1),c=b.useRef(null),u=b.useRef(n);b.useEffect(()=>{u.current=n},[n]);const a=b.useCallback(()=>{c.current!==null&&(clearInterval(c.current),c.current=null)},[]),p=b.useRef(0),h=b.useCallback(()=>{var _;p.current+=1,a(),(_=o.current)==null||_.destroy(),o.current=null,r(!1)},[a]),d=b.useCallback(()=>{if(!e||e.steps.length===0||o.current)return;const _=p.current+=1;s.current=0,l.current=-1,io(e.steps,{onIndexChange:y=>{s.current=y}}).then(y=>{if(_!==p.current||!y.isActive()){y.destroy();return}o.current=y,r(!0),c.current=setInterval(()=>{if(!y.isActive()){a(),o.current=null,r(!1);return}const M=s.current;if(M===l.current)return;const v=e.steps[M];v&&eo(v.waitFor,u.current())&&(l.current=M,y.moveNext())},oo)})},[e,a]);return b.useEffect(()=>h,[h]),{active:t,start:d,stop:h}}const Te=650,vn="__agent__",pt="__model__",ut="__template__:",so=b.lazy(async()=>{await Promise.all([ue(()=>Promise.resolve({}),__vite__mapDeps([1])),ue(()=>Promise.resolve({}),__vite__mapDeps([2])),ue(()=>Promise.resolve({}),__vite__mapDeps([3]))]);const{RuntimeDiagram:e}=await ue(async()=>{const{RuntimeDiagram:n}=await import("./RuntimeDiagram-DTnJz5cT.js");return{RuntimeDiagram:n}},__vite__mapDeps([4,5,6]));return{default:e}}),Mn=b.lazy(()=>ue(()=>import("./MonacoEditor-D55BKqgU.js").then(e=>e.M),__vite__mapDeps([7,5,8]))),lo=b.lazy(()=>ue(()=>import("./vendor-modeler-6MWkCP0R.js"),__vite__mapDeps([9,5,6,10,11,12,13,1,2,3]))),ht=b.lazy(async()=>{const{FormRenderer:e}=await ue(async()=>{const{FormRenderer:n}=await import("./FormRenderer-UXR1JVq-.js");return{FormRenderer:n}},__vite__mapDeps([14,5,12,10,11,15]));return{default:e}});function un(e,n){try{return JSON.stringify(e??{},null,n)}catch{return"[unserializable value]"}}function co(e){const n=un(e).replace(/\s+/g," ");return n.length>78?`${n.slice(0,78)}…`:n}function mo({example:e,compact:n=!1,initialBrainKind:t,initialTourId:r}){var Rn,Fn,zn,On,Un,$n,Gn,Vn;const[o,s]=b.useState(e.bpmn),l=Di(),[c,u]=b.useState(null);b.useEffect(()=>{t&&t!==l.kind&&l.setKind(t)},[]),b.useEffect(()=>{zi({brain:l.kind})},[l.kind]);const[a,p]=b.useState(()=>Object.fromEntries(e.handlers.map(f=>[f.elementId,f.source]))),[h,d]=b.useState(e.scriptedAgent??""),[_,y]=b.useState(()=>rn(e.templates)),M=b.useMemo(()=>Vr(e,a,o,_),[e,a,o,_]),v=M.model,g=fi({bpmn:M.resolvedBpmn}),j=ao(e.tour,()=>g.snapshot);b.useEffect(()=>{var f;r&&((f=e.tour)==null?void 0:f.id)===r&&j.start()},[]);const B=v.startFormId?((Rn=e.forms)==null?void 0:Rn[v.startFormId])??null:null,[O,ie]=b.useState(()=>({...e.seed,...B?Vi(B):{}})),[W,Ne]=b.useState(v.agent?vn:((Fn=e.handlers[0])==null?void 0:Fn.elementId)??""),Ee=b.useMemo(()=>{const f=(e.scenarios??[]).findIndex(x=>Object.entries(x.variables).every(([I,D])=>JSON.stringify(O[I])===JSON.stringify(D)));return f===-1?null:f},[e.scenarios,O]),[we,Pe]=Bn(n?"start-compact":"start",n?!1:!!B),[Z,me]=b.useState(!1),[q,T]=b.useState(!1),[E,N]=b.useState(!1),[U,$]=b.useState(null),[ye,Ge]=b.useState([]),[Je,oe]=b.useState({}),He=b.useMemo(()=>({...e.seed,...O,...Er(e.imageInput?c:null)}),[e.seed,e.imageInput,O,c]),[ke,We]=b.useState(null),Le=b.useRef(null),[Re,Ae]=b.useState({}),[wn,Fe]=b.useState(!1),Ze=b.useRef(null),se=b.useRef(!1),ae=b.useRef(0),ze=b.useRef(0),ee=b.useRef({current:void 0}),Ce=b.useRef({}),Oe=b.useRef({}),De=b.useMemo(()=>{const f=new Map;for(const x of v.processes){for(const I of x.tasks)f.set(I.elementId,I.label);for(const I of x.agents){f.set(I.elementId,I.label);for(const D of I.tools)f.set(D.elementId,D.label)}for(const I of x.userTasks)f.set(I.elementId,I.label)}return x=>f.get(x)??x},[v]),R=b.useCallback(f=>{Ge(x=>{if(f.key){const I=x.findIndex(D=>D.key===f.key);if(I>=0){const D=[...x];return D[I]={...D[I],...f},D}}return[...x,{...f,id:ze.current++}].slice(-80)})},[]),ve=b.useMemo(()=>{var f;return((f=g.snapshot)==null?void 0:f.userTasks.find(x=>x.state==="Created"))??null},[g.snapshot]),Be=b.useMemo(()=>{const f=v.processes.flatMap(I=>I.tasks),x=new Map;for(const I of e.handlers){if(!I.manualControl)continue;const D=f.find(P=>P.elementId===I.elementId);D&&x.set(D.jobType,{...I.manualControl,elementId:I.elementId})}return x},[e.handlers,v]),he=b.useMemo(()=>{if(!g.snapshot)return null;for(const f of g.snapshot.jobs){const x=Be.get(f.jobType);if(x&&f.state==="Created")return{job:f,control:x}}return null},[g.snapshot,Be]),on=b.useMemo(()=>{if(!v.agent||!g.snapshot)return[];const f=new Map(g.snapshot.elementStats.map(x=>[x.elementId,x.completed]));return v.agent.tools.filter(x=>(f.get(x.elementId)??0)===0)},[v.agent,g.snapshot]),ge=ve?v.userTasks.find(f=>f.elementId===ve.elementId):void 0,Ve=ge!=null&&ge.formId?((zn=e.forms)==null?void 0:zn[ge.formId])??null:null,Ie=b.useCallback(async(f,x,I,D)=>{var pe,ne,_e;let P=I,be=0;for(;ae.current===D&&P&&P.completedInstances<1&&be++<80;){const V=await g.stepWorkers(f,{agents:x});if(ae.current!==D)return P;P=(V==null?void 0:V.snapshot)??P;const te=(pe=P.instances[0])==null?void 0:pe.variables;if(te&&oe({...te}),P.userTasks.some(Q=>Q.state==="Created")){R({kind:"human",text:"⏸ waiting for a human — complete the task below to continue"});break}if(!V){R({kind:"error",text:"▶ run stopped — no dispatch round was returned"});break}if(V.handled===0){const Q=P.messageSubscriptions[0];if(V.reason==="messages"&&Q){if(R({kind:"step",text:`⏳ parked on a message catch event — waiting for "${Q.messageName}"`,elementId:Q.elementId}),await new Promise(K=>setTimeout(K,Te)),ae.current!==D)return P;R({kind:"vars",text:`📨 correlating message "${Q.messageName}" (key: ${Q.correlationKey})`,elementId:Q.elementId});const G=g.correlateMessage(Q.messageName,Q.correlationKey,"{}");if(G){P=G;const K=(ne=P.instances[0])==null?void 0:ne.variables;K&&oe({...K}),await new Promise(fe=>setTimeout(fe,Te));continue}R({kind:"error",text:`▶ run stopped — correlating "${Q.messageName}" (key: ${Q.correlationKey}) failed`,elementId:Q.elementId})}if(V.reason==="signals"&&P.signalSubscriptions.length>0){const G=P.signalSubscriptions[0],K=P.signalSubscriptions.length;if(R({kind:"step",text:`⏳ parked on ${K} open signal subscription${K===1?"":"s"} — waiting for "${G.signalName}"`,elementId:G.elementId}),await new Promise(Qe=>setTimeout(Qe,Te)),ae.current!==D)return P;const fe=g.broadcastSignal(G.signalName,"{}");if(fe){P=fe,R({kind:"vars",text:`📡 broadcasting signal "${G.signalName}" — every waiting subscription unblocks`,elementId:G.elementId});const Qe=(_e=P.instances[0])==null?void 0:_e.variables;Qe&&oe({...Qe}),await new Promise(Wt=>setTimeout(Wt,Te));continue}R({kind:"error",text:`▶ run stopped — broadcasting signal "${G.signalName}" failed`,elementId:G.elementId})}if(V.reason==="timers"){const G=P.timers.reduce((K,fe)=>Math.min(K,fe.dueInMs),1/0);if(Number.isFinite(G)){if(R({kind:"step",text:`⏳ parked on a timer — ${(Math.max(G,0)/1e3).toFixed(1)}s left on the clock`}),await new Promise(fe=>setTimeout(fe,Te)),ae.current!==D)return P;const K=g.advanceTime(Math.max(G,0)+1);if(K){P=K,R({kind:"step",text:"🕐 the clock advanced — timer fired"}),await new Promise(fe=>setTimeout(fe,Te));continue}}}break}await new Promise(Q=>setTimeout(Q,Te))}return ae.current!==D||(P&&P.completedInstances>=1?R({kind:"done",text:"✅ process instance completed"}):P&&P.incidentElementIds.length>0&&R({kind:"error",text:"A job failed — incident on the diagram"})),P},[g,R]),an=b.useCallback(async f=>{var P,be,pe;if(!he||se.current)return;const{job:x,control:I}=he,D=++ae.current;se.current=!0,T(!0);try{let ne,_e;if(f==="complete")ne=g.completeJobManually(x.jobType,"{}"),_e="  ↳ completed normally";else if(I.action.kind==="timer"){const V=((be=(P=g.snapshot)==null?void 0:P.timers[0])==null?void 0:be.dueInMs)??0;ne=g.advanceTime(Math.max(V,0)+1),_e="  ↳ advanced the clock — timer fired"}else{const{errorCode:V,message:te}=I.action;ne=g.throwJobError(x.jobType,V,te),_e=`  ↳ threw BPMN error ${V}: ${te}`}if(ne){R({kind:"vars",text:_e,elementId:x.elementId});const V=(pe=ne.instances[0])==null?void 0:pe.variables;V&&oe({...V}),await new Promise(te=>setTimeout(te,Te)),await Ie(Ce.current,Oe.current,ne,D)}else R({kind:"error",text:"  ↳ failed to resolve the manual job",elementId:x.elementId})}finally{ae.current===D&&(se.current=!1,T(!1))}},[he,g,R,Ie]),Ye=b.useCallback(async()=>{var V;let f=null;try{v.agent&&h.trim()&&(f=Cr(h))}catch(te){return $(te instanceof Error?te.message:String(te)),null}ee.current={current:void 0};let x;if(e.imageInput){const te=l.vision;x={read:te??Ai(e.scriptedVision).read,live:!!te,resolve:G=>g.getRunImage(G)}}const I=Lr(v,M.handlers,R,ee.current,x);for(const te of Be.keys())delete I[te];const D={};if(v.agents.length>0){if(l.kind!=="scripted"&&l.chat){const Q=new Map;for(const G of v.agents)Q.set(G.jobType,[...Q.get(G.jobType)??[],G]);for(const[G,K]of Q)D[G]=Xr(K,l.chat,R,{turnRef:ee.current,requiredTools:e.requiredTools})}else if(f&&v.agent){const Q=v.agent.elementId;D[v.agent.jobType]=async G=>{if(G.elementId!==Q)throw new Error(`No scripted agent handler for "${G.elementId}" — only "${Q}" (the primary process's first agent host) is driven by the scripted brain. Use a live brain to exercise more than one host.`);const K=await f(G),fe=(K.activateElements??[]).map(Qe=>Qe.elementId).join(", ");return R({kind:"agent",text:K.completionConditionFulfilled?"🤖 scripted agent: done":`🤖 scripted agent: calling ${fe||"(nothing)"}`}),K}}}Ge([]),Ae({});const P=He;oe(P),Ce.current=I,Oe.current=D;const be=await g.redeploy(o),pe=(be==null?void 0:be[0])??v.processId;R({kind:"start",text:`Starting "${pe}" — ${v.agent?l.kind==="scripted"||!l.chat?"scripted brain":`live brain (${l.modelInUse??l.kind})`:"no agent in this model"}`});const ne=g.createInstance(pe,JSON.stringify(P)),_e=(V=ne==null?void 0:ne.instances[0])==null?void 0:V.key;return e.imageInput&&c&&_e&&g.setRunImage(_e,c),{workers:I,agents:D,snap:ne}},[g,e,M,o,h,O,c,He,v,l,R,Be]),k=!!g.snapshot&&g.snapshot.completedInstances<1,Y=!k&&!!B&&ke!==!0,C=!k&&!!B&&ke===!1,J=we||Z;b.useEffect(()=>{n&&C&&me(!0)},[n,C]);const Me=f=>{Pe(f),f||me(!1)},Ke=b.useCallback(async()=>{if(g.phase!=="ready"||se.current||E||M.hasErrors)return;se.current=!0,T(!0);const f=++ae.current;try{let x=Ce.current,I=Oe.current,D=g.snapshot;if(!k){if(Le.current&&!Le.current.validate())return;$(null);const P=await Ye();if(!P)return;x=P.workers,I=P.agents,D=P.snap,await new Promise(be=>setTimeout(be,Te))}await Ie(x,I,D,f)}finally{ae.current===f&&(se.current=!1,T(!1))}},[g,E,M.hasErrors,k,Ye,Ie]),Yt=b.useCallback(async()=>{var x;if(g.phase!=="ready"||se.current||E||M.hasErrors)return;se.current=!0,N(!0);const f=++ae.current;try{let I=Ce.current,D=Oe.current,P=g.snapshot;if(!k){if(Le.current&&!Le.current.validate())return;$(null);const V=await Ye();if(!V)return;I=V.workers,D=V.agents,P=V.snap}if(!P||P.completedInstances>=1)return;const be=P.takenSequenceFlows.length,pe=await g.stepWorkers(I,{agents:D});if(!pe){R({kind:"error",text:"⏭ step failed — no dispatch round was returned"});return}const ne=(x=pe.snapshot.instances[0])==null?void 0:x.variables;ne&&oe({...ne});const _e=wi(pe.snapshot.takenSequenceFlows,be);R(yi(pe,_e,De,Be))}finally{ae.current===f&&(se.current=!1,N(!1))}},[g,E,M.hasErrors,k,Ye,R,De,Be]),Qt=b.useCallback(async()=>{se.current=!1,ae.current++,T(!1),N(!1),se.current=!0;try{await g.reset()}finally{se.current=!1}Ge([]),oe({})},[g]),qt=b.useCallback(()=>{var I;if(!ve||Ze.current&&!Ze.current.validate())return;const f=g.completeUserTask(ve.key,JSON.stringify(Re));R({kind:"human",text:`👤 ${un(Re)}`});const x=(I=f==null?void 0:f.instances[0])==null?void 0:I.variables;oe(D=>({...D,...Re,...x??{}})),f&&f.completedInstances>=1&&R({kind:"done",text:"✅ process instance completed"})},[ve,Re,g,R]),Jt=b.useMemo(()=>{var f,x;return g.phase==="loading"?i.jsx(re,{variant:"neutral",children:"Booting engine…"}):g.phase==="error"?i.jsx(re,{variant:"danger",children:"Engine error"}):q?i.jsx(re,{variant:"info",children:"Running…"}):E?i.jsx(re,{variant:"info",children:"Stepping…"}):(((f=g.snapshot)==null?void 0:f.incidentElementIds.length)??0)>0?i.jsx(re,{variant:"danger",children:"Incident"}):ve?i.jsx(re,{variant:"warning",children:"Waiting for a human"}):(((x=g.snapshot)==null?void 0:x.completedInstances)??0)>=1?i.jsx(re,{variant:"success",children:"Completed"}):g.snapshot?i.jsx(re,{variant:"warning",children:"Paused"}):i.jsx(re,{variant:"neutral",children:"Ready"})},[g.phase,g.snapshot,q,E,ve]),Ht=b.useMemo(()=>e.blurb.split(/\n\s*\n/).map(f=>f.trim()).filter(Boolean),[e.blurb]);return i.jsxs("div",{className:"runner",children:[n?i.jsx("h1",{className:"visually-hidden",children:e.title}):i.jsxs("section",{className:"intro",children:[i.jsx("h1",{children:e.title}),Ht.map(f=>i.jsx("p",{children:f},f))]}),e.imageInput&&i.jsx(Gi,{imageInput:e.imageInput,value:c,onSelect:u,disabled:q}),i.jsxs("div",{className:"scenario",children:[i.jsx("span",{className:"scenario-label",id:"scenario-label",children:e.scenariosLabel??"Example input"}),e.scenarios&&i.jsx("div",{className:"scenario-toggle",role:"group","aria-labelledby":"scenario-label",children:e.scenarios.map((f,x)=>i.jsx(H,{size:"sm",variant:x===Ee?"default":"secondary","aria-pressed":x===Ee,disabled:q,onClick:()=>ie(I=>({...I,...f.variables})),children:f.label},f.label))}),i.jsxs("button",{type:"button",className:"scenario-input-button",onClick:()=>Me(!J),"aria-expanded":J,"aria-controls":"start-input-editor",title:"Edit the starting payload",children:[i.jsx("span",{className:"scenario-edit-icon","aria-hidden":!0,children:"✎"})," ","input: ",i.jsx("code",{children:co(O)})]}),Y&&i.jsx("span",{className:"scenario-hint",children:"Fill in the input to enable Run"})]}),i.jsxs("div",{className:"inline-input-editor",id:"start-input-editor",hidden:!J,children:[i.jsxs("div",{className:"inline-input-editor-head",children:[i.jsxs("div",{children:[i.jsx("div",{className:"inline-input-editor-title",children:v.startFormId?"Start form":"Start payload"}),i.jsx("div",{className:"inline-input-editor-copy",children:v.startFormId?`Rendered from the model's start form "${v.startFormId}".`:"The variables the instance starts with."})]}),i.jsx(H,{size:"sm",variant:"secondary",onClick:()=>Me(!1),children:"Done"})]}),B?i.jsx(b.Suspense,{fallback:i.jsx("div",{className:"form-fallback",children:"Loading form…"}),children:i.jsx(ht,{ref:Le,schema:B,values:O,onChange:(f,x)=>ie(I=>({...I,[f]:x})),disabled:q,onValidityChange:We})}):i.jsx("pre",{className:"vars",children:un(O,2)})]}),!n&&(v.agent||e.imageInput)&&i.jsx($e,{sectionId:"brain",className:"brain-card","data-tour":xe.brainPanel,title:"Agent brain",description:v.agent?`What drives “${v.agent.label}”. The model recommends; the process governs.`:"What reads the image. The model recommends; the process governs.",children:i.jsx(Oi,{brain:l,showText:!!v.agent,showVision:!!e.imageInput})}),i.jsxs("div",{className:"controls",children:[i.jsx(H,{"data-tour":xe.runButton,onClick:()=>void Ke(),disabled:g.phase!=="ready"||q||E||M.hasErrors||Y,children:"▶ Run"}),i.jsx(H,{variant:"secondary",onClick:()=>void Yt(),disabled:g.phase!=="ready"||q||E||M.hasErrors||Y||(((On=g.snapshot)==null?void 0:On.completedInstances)??0)>=1,children:"⏭ Step"}),i.jsx(H,{variant:"secondary",onClick:()=>void Qt(),disabled:g.phase!=="ready"||E,children:"↺ Reset"}),e.tour&&i.jsx(H,{variant:"secondary",onClick:j.start,disabled:j.active,children:j.active?"Touring…":`🧭 ${e.tour.label}`}),Jt]}),g.phase==="error"&&i.jsxs(de,{variant:"destructive",children:[i.jsx(le,{children:"Engine error"}),i.jsx(ce,{children:g.error})]}),U&&i.jsxs(de,{variant:"destructive",children:[i.jsx(le,{children:"Code didn't compile"}),i.jsx(ce,{children:U})]}),M.hasErrors&&i.jsxs(de,{variant:"destructive",children:[i.jsx(le,{children:"Run is disabled — the diagram has unresolved references"}),i.jsx(ce,{children:i.jsx("ul",{className:"diagnostics",children:M.diagnostics.filter(f=>f.severity==="error").map((f,x)=>i.jsx("li",{children:f.message},x))})})]}),!M.hasErrors&&M.diagnostics.length>0&&i.jsxs(de,{children:[i.jsx(le,{children:"Heads up"}),i.jsx(ce,{children:i.jsx("ul",{className:"diagnostics",children:M.diagnostics.map((f,x)=>i.jsx("li",{children:f.message},x))})})]}),i.jsxs("div",{className:"grid",children:[i.jsxs("div",{className:"col",children:[i.jsx($e,{sectionId:"process","data-tour":xe.diagram,title:"Process",description:`${v.processName} — live token (green), incidents (red).`,children:i.jsx(b.Suspense,{fallback:i.jsx("div",{className:"diagram-fallback",children:g.phase==="loading"?"Booting the engine…":"Loading diagram…"}),children:i.jsx(so,{xml:M.resolvedBpmn,activeIds:((Un=g.snapshot)==null?void 0:Un.activeElementIds)??[],incidentIds:(($n=g.snapshot)==null?void 0:$n.incidentElementIds)??[],className:"diagram"})})}),ve&&i.jsxs($e,{sectionId:"human-task",title:(ge==null?void 0:ge.label)??"Human task",description:Ve?`Rendered from the model's form "${ge==null?void 0:ge.formId}".`:"This task has no linked form — complete it with no variables.",children:[on.length>0&&i.jsxs(de,{variant:"destructive",children:[i.jsx(le,{children:"The agent didn't finish its checks"}),i.jsxs(ce,{children:["It completed without running"," ",on.map(f=>f.label||f.elementId).join(", "),". The process took the default path to this task, so the findings below have no value to report."]})]}),Ve&&i.jsx(b.Suspense,{fallback:i.jsx("div",{className:"form-fallback",children:"Loading form…"}),children:i.jsx(ht,{ref:Ze,schema:Ve,values:Re,onChange:(f,x)=>Ae(I=>({...I,[f]:x})),context:Je,onValidityChange:Fe})}),i.jsx(H,{onClick:qt,disabled:!!Ve&&!wn,children:"Complete task"})]}),he&&i.jsx($e,{sectionId:"manual-job",title:he.control.label,description:"This job is held here on purpose — pick how it resolves.",children:i.jsxs("div",{className:"controls",children:[i.jsx(H,{onClick:()=>void an("complete"),disabled:q||E,children:he.control.completeLabel??"✅ Complete normally"}),i.jsx(H,{variant:"secondary",onClick:()=>void an("action"),disabled:q||E,children:he.control.action.label})]})})]}),i.jsx("div",{className:"col",children:i.jsx(Zi,{log:ye,elementStats:(Gn=g.snapshot)==null?void 0:Gn.elementStats,incidents:(Vn=g.snapshot)==null?void 0:Vn.incidents,labelFor:De,variables:i.jsxs("div",{className:"vars-block","data-tour":xe.variablesPanel,children:[i.jsx("div",{className:"vars-head",children:"Instance variables"}),i.jsx("pre",{className:"vars",children:un(Object.keys(Je).length>0?Je:He,2)})]})})})]}),!n&&i.jsxs("div",{className:"runner-secondary",children:[i.jsx($e,{sectionId:"code",className:"editors","data-tour":xe.codePanel,defaultOpen:!1,title:"Code",description:"One handler per BPMN element, plus a model tab holding the editable diagram — select an element there to edit its properties. Return variables to merge, or throw to fail the job.",children:i.jsx(b.Suspense,{fallback:i.jsx("div",{className:"editor-fallback",children:"Loading editor…"}),children:i.jsxs(ar,{value:W,onValueChange:Ne,children:[i.jsxs(sr,{children:[i.jsx(sn,{value:pt,children:"model"}),v.agent&&i.jsx(sn,{value:vn,children:"agent (scripted)"}),e.handlers.map(f=>{var x;return i.jsx(sn,{value:f.elementId,children:((x=v.tasks.find(I=>I.elementId===f.elementId))==null?void 0:x.label)??f.elementId},f.elementId)}),Object.keys(_).map(f=>i.jsx(sn,{value:ut+f,children:f},f))]}),i.jsxs(dn,{value:pt,children:[i.jsxs("div",{className:"editor-meta",children:[i.jsx("strong",{children:"Model"}),i.jsx("code",{children:"click an element to edit its properties on the right — Run re-reads whatever you leave here"}),i.jsx(H,{variant:"secondary",size:"sm",onClick:()=>s(e.bpmn),disabled:o===e.bpmn,children:"Revert to original"})]}),i.jsx(lo,{value:o,onChange:s})]}),v.agent&&i.jsxs(dn,{value:vn,children:[i.jsxs("div",{className:"editor-meta",children:[i.jsx("strong",{children:v.agent.label}),i.jsx("code",{children:l.kind==="scripted"||!l.chat?"in use":"unused — a live brain is connected"})]}),i.jsx("div",{className:"editor-wrap",children:i.jsx(Mn,{height:"360px",defaultLanguage:"javascript",value:h,onChange:f=>d(f??""),options:xn})})]}),e.handlers.map(f=>{var x;return i.jsxs(dn,{value:f.elementId,children:[i.jsxs("div",{className:"editor-meta",children:[i.jsx("strong",{children:((x=v.tasks.find(I=>I.elementId===f.elementId))==null?void 0:x.label)??f.elementId}),i.jsx("code",{children:f.standsInFor??f.elementId})]}),i.jsx("div",{className:"editor-wrap",children:i.jsx(Mn,{height:"360px",defaultLanguage:"javascript",value:a[f.elementId],onChange:I=>p(D=>({...D,[f.elementId]:I??""})),options:xn})})]},f.elementId)}),Object.keys(_).map(f=>i.jsxs(dn,{value:ut+f,children:[i.jsxs("div",{className:"editor-meta",children:[i.jsx("strong",{children:f}),i.jsxs("code",{children:["prompt / template text — substitutes"," ","{{"+f+"}}"]})]}),i.jsx("div",{className:"editor-wrap",children:i.jsx(Mn,{height:"360px",defaultLanguage:"markdown",value:_[f],onChange:x=>y(I=>rn(I,{[f]:x??""})),options:xn})})]},f))]})})}),v.agent&&i.jsx($e,{sectionId:"tools",defaultOpen:!1,title:"Tools, as the model sees them",description:i.jsxs(i.Fragment,{children:["Read from the diagram — element name, documentation, and every",i.jsx("code",{children:" fromAi(…)"})," argument."]}),children:i.jsx("ul",{className:"tool-list",children:v.agent.tools.map(f=>i.jsxs("li",{children:[i.jsx("code",{children:f.elementId}),i.jsxs("span",{children:[" — ",f.documentation||f.label]}),f.args.length>0&&i.jsx("ul",{children:f.args.map(x=>i.jsxs("li",{children:[i.jsxs("code",{children:[x.name,": ",x.type]})," ","— ",x.description]},x.name))})]},f.elementId))})})]})]})}const xn={minimap:{enabled:!1},fontSize:13,scrollBeyondLastLine:!1,tabSize:2,automaticLayout:!0},po=`<?xml version="1.0" encoding="UTF-8"?>\r
...
}`,rs=`async (job, { text, num, sleep, trace }) => {
...
}`,ld={id:"plate-recognition",title:"Read a number plate from a photo",blurb:"Pick the plate's country, then a photo goes into the run, an in-browser vision model reads the number plate on the reader's own GPU, and a human confirms or corrects it before the process records the result. The vision model recommends; the BPMN process governs. No server, no API key — with no model connected it falls back to a deterministic scripted reading.",docsUrl:"https://docs.camunda.io/docs/components/modeler/forms/camunda-forms-reference/",bpmn:As,forms:{"plate-recognition-country":td,"plate-recognition-confirm":Os,"plate-recognition-manual":Js},seed:{country:"auto"},imageInput:{label:"Pick a seed photo (its plate is known, so the scripted reader works offline) or upload your own — a live in-browser model reads a photo it has never seen.",seedImages:od},scriptedVision:ad,handlers:[{elementId:"ExtractPlate",standsInFor:"Vision model — Florence-2 <OCR> on WebGPU (in-browser)",source:sd},{elementId:"RecordResult",standsInFor:"Script task — records the governed outcome",source:dd}]},cd=[bs,Pa,ds,us,vs,ld],md=Object.assign({"./learn-error-boundary/index.ts":bo,"./learn-exclusive-gateway/index.ts":Mo,"./learn-message-correlation/index.ts":ko,"./learn-multi-instance-parallel/index.ts":So,"./learn-service-task/index.ts":Bo,"./learn-signal-broadcast/index.ts":Oo,"./learn-timer-catch-event/index.ts":Vo,"./learn-user-task-form/index.ts":na}),pd=Object.values(md).map(e=>e.default).sort((e,n)=>e.id.localeCompare(n.id)),Xe=[...cd,...pd];function Ln(){return"/pr-preview/pr-110/"}function ud(e){const n=Ln();return e.startsWith(n)?"/"+e.slice(n.length):e}function hd(e=location.pathname){const t=ud(e).match(/^\/examples\/([^/]+)\/?$/);if(t)try{return{kind:"example",id:decodeURIComponent(t[1])}}catch{return{kind:"gallery"}}return{kind:"gallery"}}function gd(e=location.search){return new URLSearchParams(e).get("embed")==="1"}function bd(e=location.search){return new URLSearchParams(e).get("view")==="compact"?"compact":"full"}function ft(e){return`${Ln()}examples/${encodeURIComponent(e)}`}const wt="p";function _d(){const e=new URLSearchParams(location.search),n=e.get(wt);if(!n)return!1;const t=n.replace(/[\t\n\r]/g,"");if(!t.startsWith("/")||t.startsWith("//")||t.startsWith("/\\"))return!1;e.delete(wt);try{const r=new URL(Ln(),location.href),o=new URL(t.slice(1),r);return o.origin!==location.origin?!1:(o.search=e.toString(),o.hash=location.hash,history.replaceState(null,"",o),!0)}catch{return!1}}function fd(e,n={}){const t=new URL(location.href);t.pathname=e,t.search=n.search??t.search,n.hash!==void 0&&(t.hash=n.hash),n.replace?history.replaceState(history.state,"",t):history.pushState(history.state,"",t),window.dispatchEvent(new PopStateEvent("popstate"))}function yt(){return{route:hd(),embed:gd(),view:bd()}}function wd(){const[e,n]=b.useState(yt);return b.useEffect(()=>{const t=()=>n(yt());return window.addEventListener("popstate",t),()=>window.removeEventListener("popstate",t)},[]),e}const yd="web-demo-framework:height",vd="web-demo-framework:request-height";function Md(e){return{type:yd,height:Math.ceil(e)}}const vt="embed-height-auto";function xd(e=document){return Math.max(e.documentElement.offsetHeight,e.body.scrollHeight)}function Nd(e){b.useEffect(()=>{if(!e||typeof window>"u"||window.parent===window)return;const n=document.documentElement;n.classList.add(vt);let t=-1;const r=(l=!1)=>{const c=xd();!l&&Math.abs(c-t)<2||(t=c,window.parent.postMessage(Md(c),"*"))},o=l=>{if(l.source!==window.parent)return;const c=l.data;!c||c.type!==vd||r(!0)};window.addEventListener("message",o),r();const s=new ResizeObserver(()=>r());return s.observe(n),()=>{s.disconnect(),window.removeEventListener("message",o),n.classList.remove(vt)}},[e])}const Mt={headline:"The model *runs*. The code is *yours* to edit.",lede:"Every example on this page is a real BPMN process executing in your browser on the nano WebAssembly engine — edit the model, edit the handlers, swap the LLM, and run it again.",tagline:"Runnable Camunda examples"};function Ed({text:e}){return i.jsx(i.Fragment,{children:e.split(/\*([^*]+)\*/g).map((n,t)=>t%2===1?i.jsx("em",{children:n},t):i.jsx(b.Fragment,{children:n},t))})}function kd(){const{route:e,embed:n,view:t}=wd(),r=n&&t==="compact",o=Ut().brain,s=Ki();Nd(n);const l=e.kind==="example"?e.id:Xe[0].id,c=Xe.find(_=>_.id===l)??Xe[0],u=Xe.filter(_=>_.group!=="learn-bpmn"),a=Xe.filter(_=>_.group==="learn-bpmn"),p=_=>{fd(ft(_),{hash:location.hash})},h=c.hero??Mt,d=i.jsxs(i.Fragment,{children:[!n&&i.jsxs(i.Fragment,{children:[i.jsxs("section",{className:"hero",children:[i.jsx("h1",{children:i.jsx(Ed,{text:h.headline})}),h.lede&&i.jsx("p",{children:h.lede})]}),i.jsx("nav",{className:"example-picker","aria-label":"Scenario examples",children:u.map(_=>i.jsx(H,{size:"sm",variant:_.id===c.id?"default":"secondary","aria-current":_.id===c.id?"page":void 0,onClick:()=>p(_.id),children:_.title},_.id))}),a.length>0&&i.jsxs(i.Fragment,{children:[i.jsx("h2",{className:"example-group-heading",id:"learn-bpmn-heading",children:"Learn BPMN"}),i.jsx("nav",{className:"example-picker","aria-labelledby":"learn-bpmn-heading",children:a.map(_=>i.jsx(H,{size:"sm",variant:_.id===c.id?"default":"secondary","aria-current":_.id===c.id?"page":void 0,onClick:()=>p(_.id),children:_.title},_.id))})]})]}),i.jsxs("div",{className:"example-meta",children:[c.docsUrl&&i.jsx("a",{className:"docs-link",href:c.docsUrl,target:"_blank",rel:"noreferrer noopener",children:"View on camunda.com ↗"}),n&&i.jsx("a",{className:"open-full-page",href:ft(c.id)+(location.hash||""),target:"_top",rel:"noreferrer",children:r?"Open the editable version ↗":"Open full page ↗"})]}),i.jsx(mo,{example:c,compact:r,initialBrainKind:o,initialTourId:s},c.id)]});return n?i.jsx("div",{className:`c4-ui app-shell app-embed${r?" app-compact":""}`,children:i.jsx("main",{id:"main",className:`layout layout-embed${r?" layout-compact":""}`,children:d})}):i.jsxs("div",{className:"c4-ui app-shell",children:[i.jsx(dr,{className:"topbar",logo:i.jsx("span",{className:"brand-dot","aria-hidden":!0}),appName:"Runnable Camunda examples",trailing:i.jsx("span",{className:"app-subtitle",children:h.tagline??Mt.tagline})}),i.jsx("main",{id:"main",className:"layout",children:d}),i.jsx("footer",{className:"footer",children:"Running locally in your browser on the nano WebAssembly BPMN engine — no cluster, no server, no data leaving the page."})]})}_d();Xt.createRoot(document.getElementById("root")).render(i.jsx(b.StrictMode,{children:i.jsx(lr,{children:i.jsx(kd,{})})}));export{ue as _,Sd as c};
