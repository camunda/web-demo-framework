const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/driver-CTZuBZOi.css","assets/diagram-js-DAKGYcfb.css","assets/bpmn-js-BEOU0ddW.css","assets/bpmn-embedded-Q3LEJpyp.css","assets/RuntimeDiagram-DTnJz5cT.js","assets/vendor-react-9Ma26nY1.js","assets/Viewer-D_7S4Gwm.js","assets/MonacoEditor-CeODeFC3.js","assets/MonacoEditor-Bv-kiMXs.css","assets/vendor-modeler-DQ1vMPs1.js","assets/vendor-design-system-DorhwciB.js","assets/vendor-design-system-jw_c7Zai.css","assets/parser-DkgAe_kI.js","assets/ModelEditor-Dwlgp6JA.css","assets/FormRenderer-DHyrrehf.js","assets/FormRenderer-D1JIHOW6.css"])))=>i.map(i=>d[i]);
var er=Object.defineProperty;var nr=(e,n,t)=>n in e?er(e,n,{enumerable:!0,configurable:!0,writable:!0,value:t}):e[n]=t;var R=(e,n,t)=>nr(e,typeof n!="symbol"?n+"":n,t);import{r as g,j as i,i as tr}from"./vendor-react-9Ma26nY1.js";import{B as Z,a as ie,L as Ye,S as Nn,b as En,c as kn,d as In,e as Tn,A as se,f as de,g as le,I as Jn,C as rr,h as ir,i as or,j as ar,k as sr,l as dr,T as lr,m as cr,n as rn,o as on,p as mr,q as pr}from"./vendor-design-system-DorhwciB.js";(function(){const n=document.createElement("link").relList;if(n&&n.supports&&n.supports("modulepreload"))return;for(const o of document.querySelectorAll('link[rel="modulepreload"]'))r(o);new MutationObserver(o=>{for(const s of o)if(s.type==="childList")for(const l of s.addedNodes)l.tagName==="LINK"&&l.rel==="modulepreload"&&r(l)}).observe(document,{childList:!0,subtree:!0});function t(o){const s={};return o.integrity&&(s.integrity=o.integrity),o.referrerPolicy&&(s.referrerPolicy=o.referrerPolicy),o.crossOrigin==="use-credentials"?s.credentials="include":o.crossOrigin==="anonymous"?s.credentials="omit":s.credentials="same-origin",s}function r(o){if(o.ep)return;o.ep=!0;const s=t(o);fetch(o.href,s)}})();const ur="modulepreload",hr=function(e){return"/web-demo-framework/pr-preview/pr-113/"+e},Hn={},ue=function(n,t,r){let o=Promise.resolve();if(t&&t.length>0){let l=function(a){return Promise.all(a.map(u=>Promise.resolve(u).then(h=>({status:"fulfilled",value:h}),h=>({status:"rejected",reason:h}))))};document.getElementsByTagName("link");const c=document.querySelector("meta[property=csp-nonce]"),m=(c==null?void 0:c.nonce)||(c==null?void 0:c.getAttribute("nonce"));o=l(t.map(a=>{if(a=hr(a),a in Hn)return;Hn[a]=!0;const u=a.endsWith(".css"),h=u?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${a}"]${h}`))return;const d=document.createElement("link");if(d.rel=u?"stylesheet":ur,u||(d.as="script"),d.crossOrigin="",d.href=a,m&&d.setAttribute("nonce",m),document.head.appendChild(d),u)return new Promise((b,f)=>{d.addEventListener("load",b),d.addEventListener("error",()=>f(new Error(`Unable to preload CSS for ${a}`)))})}))}function s(l){const c=new Event("vite:preloadError",{cancelable:!0});if(c.payload=l,window.dispatchEvent(c),!c.defaultPrevented)throw l}return o.then(l=>{for(const c of l||[])c.status==="rejected"&&s(c.reason);return n().catch(s)})},gr="io.camunda.agenticai:aiagent",Se="http://www.omg.org/spec/BPMN/20100524/MODEL",br="http://camunda.org/schema/zeebe/1.0";function jn(e,n){return Array.from(e.getElementsByTagNameNS(br,n))}function kt(e,n){return jn(e,n).filter(t=>fr(t)===e)}function fr(e){let n=e.parentElement;for(;n;){if(n.namespaceURI===Se&&n.localName!=="extensionElements")return n;n=n.parentElement}return null}function Dn(e){const n=kt(e,"taskDefinition")[0],t=n==null?void 0:n.getAttribute("type");return t||(e.localName==="scriptTask"?e.getAttribute("id")??null:null)}function Wn(e){const n=Array.from(e.children).find(t=>t.namespaceURI===Se&&t.localName==="documentation");return((n==null?void 0:n.textContent)??"").trim()}function Zn(e){if(!e)return"";const n=e.startsWith("=")?e.slice(1):e,t=n.match(/"((?:[^"\\]|\\.)*)"/g);return t?t.map(r=>r.slice(1,-1).replace(/\\n/g,`
...
character, with nothing added. When your work is finished, reply exactly
{"done": true} and no tool.`}function Zr(e,n,t,r,o=[],s=[],l=!1){const c=e.userPrompt||"Carry out your task.",m=Object.entries(n).filter(([,u])=>typeof u=="string"&&u.trim().length>0).map(([u,h])=>`  ${u}: ${String(h)}`),a=[c,m.length?`Case data:
${m.join(`
...
}`,Do={id:"learn-multi-instance-parallel",title:"Parallel multi-instance",group:"learn-bpmn",blurb:["A multi-instance activity runs its task once per element of a collection, spawning that many job instances of the same element in parallel, and only lets the token move on once every one of them completes.",`Run this and watch three 'Process item' jobs activate together for apple, banana, cherry, and complete (in any order) before the process reaches its end event. Nothing about the diagram says "three" — that comes from the collection, so use the buttons in the Start panel on the right to swap between one, three, and six items and hit Run again; the Activity panel logs one 'Process item' line per element, so the fan-out is right there to count.`,'The property tying the two together is in the Code panel: open the model tab, click "Process item", and expand Multi-instance in the properties panel on the right — Input collection holds `items`, the FEEL expression naming the variable to fan out over. Drop it entirely and the activity silently degenerates to a single ordinary instance, with no error to tell you it happened. Revert to original puts it back.'].join(`

`),docsUrl:"https://docs.camunda.io/docs/components/modeler/bpmn/multi-instance/",bpmn:Ao,seed:{items:["apple","banana","cherry"]},scenarios:[{label:"One item — a single instance",variables:{items:["apple"]}},{label:"Three items — fans out to three",variables:{items:["apple","banana","cherry"]}},{label:"Six items — fans out to six",variables:{items:["apple","banana","cherry","damson","elderberry","fig"]}}],handlers:[{elementId:"Activity_process",standsInFor:"job worker — process-item",source:Co}]},Bo=Object.freeze(Object.defineProperty({__proto__:null,default:Do},Symbol.toStringTag,{value:"Module"})),Lo=`<?xml version="1.0" encoding="UTF-8"?>\r
...
}`,zo={id:"learn-service-task",title:"Service task + sequence flow",group:"learn-bpmn",blurb:["A service task is a unit of work a worker (not a human) performs; a sequence flow is the arrow that hands the token from one to the next once its task completes.","Run this and watch each task activate, run its handler, and complete in order — Prepare package, then Dispatch courier — before the process reaches its end event.",`The link between the two halves is the job type: in the Code panel, open the model tab, click "Prepare package", and expand Task definition in the properties panel on the right — Job type is the name a worker has to subscribe to in order to be handed this task's work.`,"(This page wires its own handlers up from whatever the model declares, so renaming it here keeps working; on a real cluster the worker is a separate process started with a job type of its own, and a mismatch means nobody ever activates the job, so the run stalls forever.)"].join(`

`),docsUrl:"https://docs.camunda.io/docs/components/modeler/bpmn/service-tasks/",bpmn:Lo,seed:{item:"camunda-t-shirt"},handlers:[{elementId:"Activity_prepare",standsInFor:"job worker — prepare-package",source:Ro},{elementId:"Activity_dispatch",standsInFor:"job worker — dispatch-courier",source:Fo}]},Oo=Object.freeze(Object.defineProperty({__proto__:null,default:zo},Symbol.toStringTag,{value:"Module"})),Uo=`<?xml version="1.0" encoding="UTF-8"?>\r
...
`),docsUrl:"https://docs.camunda.io/docs/components/modeler/bpmn/timer-events/timer-event-type/",bpmn:Qo,seed:{},handlers:[{elementId:"Activity_after_timer",standsInFor:"job worker — send-reminder",source:qo}]},Ho=Object.freeze(Object.defineProperty({__proto__:null,default:Jo},Symbol.toStringTag,{value:"Module"})),Wo=`<?xml version="1.0" encoding="UTF-8"?>\r
...
`,Zo="Camunda Cloud",Ko="8.10.0",Xo={name:"Camunda Web Modeler",version:"9b5d5ef"},ea=19,na="learn-user-task-form-review",ta=[{text:`# Review request
...
`,da=`Please verify export compliance for this shipment and notify the team of your decision.\r
`,la={id:"compliance-walkthrough",label:"Take the tour",steps:[{title:"Start a run",description:"Press Run to send a shipment through the compliance agent.",target:{anchor:Ne.runButton}},{title:"The agent picks its own tools",description:"This AI Agent reads the shipment notes and decides, turn by turn, which of the tools below it to call — nothing here is hard-coded into a fixed sequence.",target:{elementId:"ComplianceCheckAgent"}},{title:"Watch the token move",description:"The agent's first move is to look up the genetic marker mentioned in the notes.",target:{elementId:"VerifyGeneticMarker"},waitFor:{kind:"activeElement",elementId:"VerifyGeneticMarker"}},{title:"A cleared shipment notifies the export team",description:"Once the compliance score comes back clean, the process notifies the export team automatically — no human review needed for this scenario.",target:{elementId:"NotifyExportTeam"},waitFor:{kind:"elementCompleted",elementId:"NotifyExportTeam"}},{title:"Everything the run recorded",description:"The variables panel shows the marker record, the country lookup, the compliance score, and the final decision — exactly what each tool and the agent wrote along the way.",target:{anchor:Ne.variablesPanel}}],successEvent:{kind:"instanceCompleted"}},ca=`<?xml version="1.0" encoding="UTF-8"?>
...
}`,La={id:"seed-export-compliance",title:"Seed export compliance agent",blurb:"An AI agent picks its own tools to check a shipment, then a gateway routes on its decision — cleared shipments notify the export team, flagged ones go to a human. The LLM recommends; the BPMN process governs.",hero:{headline:"The LLM *recommends*. The process *governs*.",lede:"An agentic ad-hoc sub-process chooses its own compliance checks, but the gateway after it — not the model — decides whether a shipment ships or goes to a human.",tagline:"Anatomy of an enterprise agent"},docsUrl:"https://camunda.com/blog/agentic-ai/",bpmn:ca,forms:{"seed-export-shipment-ready":_a,"seed-export-compliance-review":ka},seed:{scenario:_t,shipmentNotes:""},scenariosLabel:"Example shipment",scenarios:[{label:"Likely cleared (TP53 → Brazil)",variables:{scenario:_t,shipmentNotes:""}},{label:"Likely flagged (BRCA1 → Germany)",variables:{scenario:ja,shipmentNotes:""}}],scriptedAgent:Sa,templates:Ta,tour:la,requiredTools:["RecordComplianceDecision"],handlers:[{elementId:"VerifyGeneticMarker",standsInFor:"JDBC connector — UCSC hg38",source:Pa},{elementId:"CheckDestinationCountry",standsInFor:"GraphQL connector — countries API",source:Aa},{elementId:"ComputeComplianceScore",standsInFor:"REST connector — api.mathjs.org",source:Ca},{elementId:"RecordComplianceDecision",standsInFor:"Script task — FEEL",source:Da},{elementId:"NotifyExportTeam",standsInFor:"REST connector — httpbin.io",source:Ba}]},Ra=`You are a loan origination assistant at a retail bank. Your job is to gather everything a senior loan officer needs to decide an application — you do **not** decide it yourself.
...
}`,us={id:"loan-origination",title:"Loan origination agent",blurb:"An AI agent gathers a loan case with its own tools — customer lookup, credit bureau, an underwriting policy, a status update — then every application passes through a mandatory senior-officer review before a gateway routes it to an offer or a decline. The agent advises; the process governs.",docsUrl:"https://camunda.com/orchestrate/agents/",bpmn:Oa,forms:{"loan-application":Ja,"loan-senior-officer-review":ts},seed:wt,scenarios:[{label:"Strong applicant (policy recommends approve)",variables:wt},{label:"Marginal applicant (policy recommends decline)",variables:os}],scriptedAgent:as,templates:is,tour:za,requiredTools:["AssessApplication","UpdateApplicationStatus"],handlers:[{elementId:"QueryCustomer",standsInFor:"CRM connector — customer lookup",source:ss},{elementId:"CreditBureauLookup",standsInFor:"REST connector — credit bureau",source:ds},{elementId:"AssessApplication",standsInFor:"Script task — underwriting policy (FEEL)",source:ls},{elementId:"UpdateApplicationStatus",standsInFor:"REST connector — origination system",source:cs},{elementId:"IssueLoanOffer",standsInFor:"REST connector — offer/booking system",source:ms},{elementId:"SendDeclineNotice",standsInFor:"REST connector — notifications",source:ps}]},hs=`<?xml version="1.0" encoding="UTF-8"?>
...
}`,fs=`async (job, { sleep, trace }) => {
  await sleep(400);
  trace("handing over to the carrier");

  // Throw to fail the job and raise an incident on the diagram — try it.
  return { shipped: true, tracking: "1Z" + Math.floor(Math.random() * 1e9) };
}`,_s={id:"order-process",title:"Order process with service workers",blurb:"The getting-started order process: check inventory, charge payment, ship. No agent and no human step — the same runner, driven entirely by what's in the diagram.",docsUrl:"https://docs.camunda.io/docs/next/guides/getting-started-orchestration-cluster/",bpmn:hs,seed:{item:"camunda-t-shirt",quantity:3},handlers:[{elementId:"Activity_0tw2fu0",standsInFor:"job worker — check-inventory",source:gs},{elementId:"Activity_1ppsbgi",standsInFor:"job worker — charge-payment",source:bs},{elementId:"Activity_08pg6im",standsInFor:"job worker — ship-items",source:fs}]},ws=`<?xml version="1.0" encoding="UTF-8"?>\r
...
`,ys=`async (job, { text, num, sleep, trace }) => {
  // The starting variables arrive on 'job.variables'.
...
}`,vs={id:"rocket-launch",title:"Rocket launch",blurb:"The getting-started rocket launch, boiled down to one service task: launch. The smallest possible example, and the smallest possible test of the framework's extensibility.",bpmn:ws,seed:{missionName:"Apollo 11",destination:"the Moon",fuelLevel:100},scenarios:[{label:"Full tanks — launch succeeds",variables:{missionName:"Apollo 11",destination:"the Moon",fuelLevel:100}},{label:"Low fuel — mission scrubbed",variables:{missionName:"Apollo 13",destination:"the Moon",fuelLevel:30}}],handlers:[{elementId:"Activity_LaunchRocket",standsInFor:"job worker — launch-rocket",source:ys}]},Ms=`<?xml version="1.0" encoding="UTF-8"?>\r
...
`,xs=`async (job, { text, sleep }) => {
  ...
  return { shipped: true, tracking: "1Z" + Math.floor(Math.random() * 1e9) };
}`,ks={id:"order-process-boundary-events",title:"Order process with boundary events",blurb:"The getting-started order process, extended with a timer and an error boundary event: charge payment can be declined, and a delayed shipment can escalate — both fired by hand from the runner rather than by chance.",docsUrl:"https://github.com/camunda/camunda-8-get-started/tree/main/2-order-process-with-service-workers",bpmn:Ms,seed:{item:"camunda-t-shirt",quantity:3},handlers:[{elementId:"Activity_0tw2fu0",standsInFor:"job worker — check-inventory",source:xs},{elementId:"Activity_1ppsbgi",standsInFor:"job worker — charge-payment",source:Ns,manualControl:{label:"Charge payment method",completeLabel:"✅ Complete normally",action:{kind:"error",errorCode:"CHARGE_DECLINED",message:"The card issuer declined the charge.",label:"❌ Simulate: card declined"}}},{elementId:"Activity_08pg6im",standsInFor:"job worker — ship-items",source:Es,manualControl:{label:"Ship items",completeLabel:"✅ Ship it",action:{kind:"timer",label:"🕐 Fire the shipping-delayed timer"}}}]},Is="/web-demo-framework/pr-preview/pr-113/assets/de-bmw-mini-JBSk7QcF.jpg",Ts="/web-demo-framework/pr-preview/pr-113/assets/de-bmw-mini.thumb-CUUmJrRO.jpg",js="/web-demo-framework/pr-preview/pr-113/assets/uk-d651-rnb-XGipy2QN.jpg",Ss="/web-demo-framework/pr-preview/pr-113/assets/uk-d651-rnb.thumb-mjEcbhUf.jpg",Ps="/web-demo-framework/pr-preview/pr-113/assets/uk-mk70-orj-Cn6O3Xfm.jpg",As="/web-demo-framework/pr-preview/pr-113/assets/uk-mk70-orj.thumb-CaeZ2vqU.jpg",Cs="/web-demo-framework/pr-preview/pr-113/assets/uk-ni-ijz-8992-YXV44tgk.jpg",Ds="/web-demo-framework/pr-preview/pr-113/assets/uk-ni-ijz-8992.thumb-DYwok8jV.jpg",Bs="/web-demo-framework/pr-preview/pr-113/assets/us-hyundai-genesis-gGpAIEpi.jpg",Ls="/web-demo-framework/pr-preview/pr-113/assets/us-hyundai-genesis.thumb-DEEt19Mw.jpg",Rs=`<?xml version="1.0" encoding="UTF-8"?>
...
}`,hd={id:"plate-recognition",title:"Read a number plate from a photo",blurb:"Pick the plate's country, then a photo goes into the run, an in-browser vision model reads the number plate on the reader's own GPU, and a human confirms or corrects it before the process records the result. The vision model recommends; the BPMN process governs. No server, no API key — with no model connected it falls back to a deterministic scripted reading.",docsUrl:"https://docs.camunda.io/docs/components/modeler/forms/camunda-forms-reference/",bpmn:Rs,forms:{"plate-recognition-country":sd,"plate-recognition-confirm":Ys,"plate-recognition-manual":Xs},seed:{country:"auto"},imageInput:{label:"Pick a seed photo (its plate is known, so the scripted reader works offline) or upload your own — a live in-browser model reads a photo it has never seen.",seedImages:cd},scriptedVision:md,handlers:[{elementId:"ExtractPlate",standsInFor:"Vision model — Florence-2 <OCR> on WebGPU (in-browser)",source:pd},{elementId:"RecordResult",standsInFor:"Script task — records the governed outcome",source:ud}]},gd=[vs,La,us,_s,ks,hd],bd=Object.assign({"./learn-error-boundary/index.ts":vo,"./learn-exclusive-gateway/index.ts":Io,"./learn-message-correlation/index.ts":Po,"./learn-multi-instance-parallel/index.ts":Bo,"./learn-service-task/index.ts":Oo,"./learn-signal-broadcast/index.ts":Yo,"./learn-timer-catch-event/index.ts":Ho,"./learn-user-task-form/index.ts":aa}),fd=Object.values(bd).map(e=>e.default).sort((e,n)=>e.id.localeCompare(n.id)),We=[...gd,...fd];function Ln(){return"/web-demo-framework/pr-preview/pr-113/"}function _d(e){const n=Ln();return e.startsWith(n)?"/"+e.slice(n.length):e}function wd(e=location.pathname){const t=_d(e).match(/^\/examples\/([^/]+)\/?$/);if(t)try{return{kind:"example",id:decodeURIComponent(t[1])}}catch{return{kind:"gallery"}}return{kind:"gallery"}}function yd(e=location.search){return new URLSearchParams(e).get("embed")==="1"}function vd(e=location.search){return new URLSearchParams(e).get("view")==="compact"?"compact":"full"}function Md(e=location.search){return new URLSearchParams(e).get("autostart")==="1"}function vt(e){return`${Ln()}examples/${encodeURIComponent(e)}`}const Mt="p";function xd(){const e=new URLSearchParams(location.search),n=e.get(Mt);if(!n)return!1;const t=n.replace(/[\t\n\r]/g,"");if(!t.startsWith("/")||t.startsWith("//")||t.startsWith("/\\"))return!1;e.delete(Mt);try{const r=new URL(Ln(),location.href),o=new URL(t.slice(1),r);return o.origin!==location.origin?!1:(o.search=e.toString(),o.hash=location.hash,history.replaceState(null,"",o),!0)}catch{return!1}}function Nd(e,n={}){const t=new URL(location.href);t.pathname=e,t.search=n.search??t.search,n.hash!==void 0&&(t.hash=n.hash),n.replace?history.replaceState(history.state,"",t):history.pushState(history.state,"",t),window.dispatchEvent(new PopStateEvent("popstate"))}function xt(){return{route:wd(),embed:yd(),view:vd(),autostart:Md()}}function Ed(){const[e,n]=g.useState(xt);return g.useEffect(()=>{const t=()=>n(xt());return window.addEventListener("popstate",t),()=>window.removeEventListener("popstate",t)},[]),e}const kd="web-demo-framework:height",Id="web-demo-framework:request-height";function Td(e){return{type:kd,height:Math.ceil(e)}}const Nt="embed-height-auto";function jd(e=document){return Math.max(e.documentElement.offsetHeight,e.body.scrollHeight)}function Sd(e){g.useEffect(()=>{if(!e||typeof window>"u"||window.parent===window)return;const n=document.documentElement;n.classList.add(Nt);let t=-1;const r=(l=!1)=>{const c=jd();!l&&Math.abs(c-t)<2||(t=c,window.parent.postMessage(Td(c),"*"))},o=l=>{if(l.source!==window.parent)return;const c=l.data;!c||c.type!==Id||r(!0)};window.addEventListener("message",o),r();const s=new ResizeObserver(()=>r());return s.observe(n),()=>{s.disconnect(),window.removeEventListener("message",o),n.classList.remove(Nt)}},[e])}const Et={headline:"The model *runs*. The code is *yours* to edit.",lede:"Every example on this page is a real BPMN process executing in your browser on the nano WebAssembly engine — edit the model, edit the handlers, swap the LLM, and run it again.",tagline:"Runnable Camunda examples"};function Pd({text:e}){return i.jsx(i.Fragment,{children:e.split(/\*([^*]+)\*/g).map((n,t)=>t%2===1?i.jsx("em",{children:n},t):i.jsx(g.Fragment,{children:n},t))})}function Ad(){const{route:e,embed:n,view:t,autostart:r}=Ed(),o=n&&t==="compact",s=Vt().brain,l=no();Sd(n);const c=e.kind==="example"?e.id:We[0].id,m=We.find(f=>f.id===c)??We[0],a=We.filter(f=>f.group!=="learn-bpmn"),u=We.filter(f=>f.group==="learn-bpmn"),h=f=>{Nd(vt(f),{hash:location.hash})},d=m.hero??Et,b=i.jsxs(i.Fragment,{children:[!n&&i.jsxs(i.Fragment,{children:[i.jsxs("section",{className:"hero",children:[i.jsx("h1",{children:i.jsx(Pd,{text:d.headline})}),d.lede&&i.jsx("p",{children:d.lede})]}),i.jsx("nav",{className:"example-picker","aria-label":"Scenario examples",children:a.map(f=>i.jsx(Z,{size:"sm",variant:f.id===m.id?"default":"secondary","aria-current":f.id===m.id?"page":void 0,onClick:()=>h(f.id),children:f.title},f.id))}),u.length>0&&i.jsxs(i.Fragment,{children:[i.jsx("h2",{className:"example-group-heading",id:"learn-bpmn-heading",children:"Learn BPMN"}),i.jsx("nav",{className:"example-picker","aria-labelledby":"learn-bpmn-heading",children:u.map(f=>i.jsx(Z,{size:"sm",variant:f.id===m.id?"default":"secondary","aria-current":f.id===m.id?"page":void 0,onClick:()=>h(f.id),children:f.title},f.id))})]})]}),i.jsxs("div",{className:"example-meta",children:[m.docsUrl&&i.jsx("a",{className:"docs-link",href:m.docsUrl,target:"_blank",rel:"noreferrer noopener",children:"View on camunda.com ↗"}),n&&i.jsx("a",{className:"open-full-page",href:vt(m.id)+(location.hash||""),target:"_top",rel:"noreferrer",children:o?"Open the editable version ↗":"Open full page ↗"})]}),i.jsx(bo,{example:m,compact:o,autostart:r,initialBrainKind:s,initialTourId:l},m.id)]});return n?i.jsx("div",{className:`c4-ui app-shell app-embed${o?" app-compact":""}`,children:i.jsx("main",{id:"main",className:`layout layout-embed${o?" layout-compact":""}`,children:b})}):i.jsxs("div",{className:"c4-ui app-shell",children:[i.jsx(mr,{className:"topbar",logo:i.jsx("span",{className:"brand-dot","aria-hidden":!0}),appName:"Runnable Camunda examples",trailing:i.jsx("span",{className:"app-subtitle",children:d.tagline??Et.tagline})}),i.jsx("main",{id:"main",className:"layout",children:b}),i.jsx("footer",{className:"footer",children:"Running locally in your browser on the nano WebAssembly BPMN engine — no cluster, no server, no data leaving the page."})]})}xd();tr.createRoot(document.getElementById("root")).render(i.jsx(g.StrictMode,{children:i.jsx(pr,{children:i.jsx(Ad,{})})}));export{ue as _,Ld as c};
