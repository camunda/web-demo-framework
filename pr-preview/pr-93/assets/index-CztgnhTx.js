const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/driver-CTZuBZOi.css","assets/diagram-js-DAKGYcfb.css","assets/bpmn-embedded-C-STiDmY.css","assets/RuntimeDiagram-B2IYfHo7.js","assets/vendor-react-9Ma26nY1.js","assets/Viewer-D_7S4Gwm.js","assets/MonacoEditor-CS0hIYDw.js","assets/MonacoEditor-Cj32qFSX.css","assets/vendor-modeler-xJyI6UeY.js","assets/vendor-design-system-CK3ahGCn.js","assets/vendor-design-system-BIaPg_SC.css","assets/parser-DkgAe_kI.js","assets/ModelEditor-Dwlgp6JA.css","assets/FormRenderer-BV0E1Vc9.js","assets/FormRenderer-D1JIHOW6.css"])))=>i.map(i=>d[i]);
var Ct=Object.defineProperty;var Pt=(e,n,t)=>n in e?Ct(e,n,{enumerable:!0,configurable:!0,writable:!0,value:t}):e[n]=t;var O=(e,n,t)=>Pt(e,typeof n!="symbol"?n+"":n,t);import{r as h,j as a,i as Lt}from"./vendor-react-9Ma26nY1.js";import{B as Q,a as J,L as Be,S as Xn,b as et,c as nt,d as tt,e as rt,A as ae,f as se,g as ce,I as tn,C as Bt,h as Rt,i as zt,j as Ot,k as Ft,l as Ut,T as $t,m as Gt,n as Je,o as qe,p as Vt,q as Yt}from"./vendor-design-system-CK3ahGCn.js";(function(){const n=document.createElement("link").relList;if(n&&n.supports&&n.supports("modulepreload"))return;for(const i of document.querySelectorAll('link[rel="modulepreload"]'))r(i);new MutationObserver(i=>{for(const s of i)if(s.type==="childList")for(const d of s.addedNodes)d.tagName==="LINK"&&d.rel==="modulepreload"&&r(d)}).observe(document,{childList:!0,subtree:!0});function t(i){const s={};return i.integrity&&(s.integrity=i.integrity),i.referrerPolicy&&(s.referrerPolicy=i.referrerPolicy),i.crossOrigin==="use-credentials"?s.credentials="include":i.crossOrigin==="anonymous"?s.credentials="omit":s.credentials="same-origin",s}function r(i){if(i.ep)return;i.ep=!0;const s=t(i);fetch(i.href,s)}})();const Qt="modulepreload",Jt=function(e){return"/pr-preview/pr-93/"+e},In={},de=function(n,t,r){let i=Promise.resolve();if(t&&t.length>0){let d=function(o){return Promise.all(o.map(c=>Promise.resolve(c).then(g=>({status:"fulfilled",value:g}),g=>({status:"rejected",reason:g}))))};document.getElementsByTagName("link");const u=document.querySelector("meta[property=csp-nonce]"),m=(u==null?void 0:u.nonce)||(u==null?void 0:u.getAttribute("nonce"));i=d(t.map(o=>{if(o=Jt(o),o in In)return;In[o]=!0;const c=o.endsWith(".css"),g=c?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${o}"]${g}`))return;const p=document.createElement("link");if(p.rel=c?"stylesheet":Qt,c||(p.as="script"),p.crossOrigin="",p.href=o,m&&p.setAttribute("nonce",m),document.head.appendChild(p),c)return new Promise((_,b)=>{p.addEventListener("load",_),p.addEventListener("error",()=>b(new Error(`Unable to preload CSS for ${o}`)))})}))}function s(d){const u=new Event("vite:preloadError",{cancelable:!0});if(u.payload=d,window.dispatchEvent(u),!u.defaultPrevented)throw d}return i.then(d=>{for(const u of d||[])u.status==="rejected"&&s(u.reason);return n().catch(s)})},qt="io.camunda.agenticai:aiagent",ye="http://www.omg.org/spec/BPMN/20100524/MODEL",Ht="http://camunda.org/schema/zeebe/1.0";function ln(e,n){return Array.from(e.getElementsByTagNameNS(Ht,n))}function it(e,n){return ln(e,n).filter(t=>Wt(t)===e)}function Wt(e){let n=e.parentElement;for(;n;){if(n.namespaceURI===ye&&n.localName!=="extensionElements")return n;n=n.parentElement}return null}function hn(e){const n=it(e,"taskDefinition")[0],t=n==null?void 0:n.getAttribute("type");return t||(e.localName==="scriptTask"?e.getAttribute("id")??null:null)}function En(e){const n=Array.from(e.children).find(t=>t.namespaceURI===ye&&t.localName==="documentation");return((n==null?void 0:n.textContent)??"").trim()}function Tn(e){if(!e)return"";const n=e.startsWith("=")?e.slice(1):e,t=n.match(/"((?:[^"\\]|\\.)*)"/g);return t?t.map(r=>r.slice(1,-1).replace(/\\n/g,`
...
`)}function Zt(e){return at(ot(e))}function Kt(e){const n=Array.from(e.children).find(t=>t.namespaceURI===ye&&t.localName==="extensionElements");return n?at(ot(n)):[]}function at(e){const n=/fromAi\(\s*toolCall\.([A-Za-z_$][\w$]*)\s*,\s*"((?:[^"\\]|\\.)*)"\s*(?:,\s*"(\w+)")?/g,t=[],r=new Set;for(const i of e.matchAll(n)){const s=i[1];r.has(s)||(r.add(s),t.push({name:s,description:(i[2]??"").replace(/&#10;/g,`
`).replace(/\\"/g,'"').replace(/&quot;/g,'"').replace(/&#39;/g,"'").trim(),type:i[3]??"string"}))}return t}function Xt(e){const n={};for(const t of it(e,"input")){const r=t.getAttribute("target");r&&(n[r]=t.getAttribute("source")??"")}return n}function er(e){return Array.from(e.getElementsByTagNameNS(ye,"adHocSubProcess")).filter(n=>(hn(n)??"").startsWith(qt))}const nr=new Set(["subProcess","adHocSubProcess","callActivity"]),tr=new Set(["adHocSubProcess","subProcess","transaction"]);function rr(e){let n=e.parentElement;for(;n;){if(n.namespaceURI===ye&&tr.has(n.localName))return n;n=n.parentElement}return null}function ir(e,n){const t=Xt(e),r=Number((t["data.limits.maxModelCalls"]??"").replace(/^=/,""));return{elementId:e.getAttribute("id")??"agent",label:e.getAttribute("name")??"Agent",jobType:hn(e),systemPrompt:Tn(t["data.systemPrompt.prompt"]),userPrompt:Tn(t["data.userPrompt.prompt"]),maxModelCalls:Number.isFinite(r)&&r>0?r:10,tools:n}}function or(e,n){var g;const t=e.getAttribute("id")??"",r=e.getAttribute("name")??t,i=er(e);i.length>1&&n.push({severity:"warning",elementId:i.map(p=>p.getAttribute("id")).join(", "),message:`Process "${r}" hosts ${i.length} AI Agent sub-processes (${i.map(p=>p.getAttribute("id")).join(", ")}). Each gets its own independent agent state (turn counter, called tools) — the run itself is shared across hosts, but each host's agent state within it is not.`});const s=[],d=new Map(i.map(p=>[p,[]]));for(const p of Array.from(e.getElementsByTagName("*"))){if(p.namespaceURI!==ye||i.includes(p))continue;const _=p.getAttribute("id");if(!_)continue;const b=rr(p),y=b&&i.includes(b)?b:null;if(y&&nr.has(p.localName)){const I=p.getAttribute("name")??_,P=En(p);s.push({elementId:_,label:I,jobType:"",documentation:P,isTool:!0,compound:!0}),d.get(y).push({elementId:_,label:I,jobType:"",documentation:P,args:Kt(p),compound:!0});continue}const f=hn(p);if(!f)continue;const M={elementId:_,label:p.getAttribute("name")??_,jobType:f,documentation:En(p),isTool:y!=null};s.push(M),y&&d.get(y).push({elementId:_,label:M.label,jobType:f,documentation:M.documentation,args:Zt(p)})}const u=i.map(p=>ir(p,d.get(p))),m=Array.from(e.getElementsByTagNameNS(ye,"userTask")).map(p=>{var _;return{elementId:p.getAttribute("id")??"",label:p.getAttribute("name")??p.getAttribute("id")??"",formId:((_=ln(p,"formDefinition")[0])==null?void 0:_.getAttribute("formId"))??void 0}}),o=e.getElementsByTagNameNS(ye,"startEvent")[0],c=o?((g=ln(o,"formDefinition")[0])==null?void 0:g.getAttribute("formId"))??void 0:void 0;return{processId:t,processName:r,tasks:s,agents:u,userTasks:m,startFormId:c}}function ar(e,n={}){const t=new DOMParser().parseFromString(e,"application/xml"),r=t.getElementsByTagName("parsererror")[0];if(r)throw new Error(`Invalid BPMN XML: ${r.textContent}`);const i=Array.from(t.getElementsByTagNameNS(ye,"process"));if(i.length===0)throw new Error("No <bpmn:process> in the diagram.");const s=[],d=i.map(m=>or(m,s));let u=n.processId?d.find(m=>m.processId===n.processId):void 0;return n.processId&&!u&&s.push({severity:"warning",message:`Requested process "${n.processId}" not found — falling back to "${d[0].processId}".`}),u??(u=d[0]),d.length>1&&s.push({severity:"warning",message:`Diagram has ${d.length} <bpmn:process> elements (${d.map(m=>m.processId).join(", ")}); using "${u.processId}" as the active process. Pass a processId to parseModel to target another.`}),{processes:d,diagnostics:s,processId:u.processId,processName:u.processName,tasks:u.tasks,agent:u.agents[0]??null,agents:d.flatMap(m=>m.agents),userTasks:u.userTasks,startFormId:u.startFormId}}function sr(e){return e?e.imageId?{imageId:e.imageId}:e.imageName?{imageName:e.imageName}:{}:{}}function st(e,n){return n?e.pixels:e.imageId??e.pixels}const cr="No image selected — pick or upload a photo to read.";function jn(){return cr}function dr(e,n){return async t=>{const r=e.resolve(n);if(!r)return jn();const i=st(r,e.live);if(i===void 0)return jn();try{return await e.read(i,t)}catch(s){return`Couldn't read the image (${s instanceof Error?s.message:String(s)}).`}}}function lr(e,n){return async()=>{const t=e.resolve(n);if(t)return st(t,e.live)}}function ur(){return`<!doctype html><html><head><meta charset="utf-8"></head><body><script>
    "use strict";
    ...
    post({ kind: "ready" });
  <\/script></body></html>`}function ct(e,n={}){const{timeoutMs:t=5e3,onTrace:r,onVision:i,onImage:s}=n,d=`${Date.now()}-${Math.random().toString(36).slice(2)}`;return new Promise((u,m)=>{const o=document.createElement("iframe");o.setAttribute("sandbox","allow-scripts"),o.style.display="none",o.setAttribute("aria-hidden","true");let c=!1,g;const p=()=>{g&&clearTimeout(g),window.removeEventListener("message",b),o.remove()},_=f=>{c||(c=!0,p(),f())};function b(f){var I;if(f.source!==o.contentWindow)return;const M=f.data;if(!(!M||typeof M!="object")){if(M.kind==="ready"){const P=e.job,G=e.kind==="run-handler"?{kind:"run-handler",id:d,source:e.source,job:P,hasVision:e.hasVision}:{kind:"run-agent",id:d,source:e.source,job:P};(I=o.contentWindow)==null||I.postMessage(G,"*");return}"id"in M&&M.id!==d||(M.kind==="trace"?r==null||r(M.text):M.kind==="vision-request"?y(M.callId,i,"vision",M.prompt):M.kind==="image-request"?y(M.callId,s,"image"):M.kind==="result"?_(()=>u(M.value)):M.kind==="error"&&_(()=>m(new Error(M.message))))}}function y(f,M,I,...P){const G=H=>{var le;return(le=o.contentWindow)==null?void 0:le.postMessage(H,"*")};if(!M){G({kind:"helper-error",id:d,callId:f,message:`${I} helper is not available.`});return}Promise.resolve().then(()=>M(...P)).then(H=>G({kind:"helper-result",id:d,callId:f,value:H}),H=>G({kind:"helper-error",id:d,callId:f,message:H instanceof Error?H.message:String(H)}))}window.addEventListener("message",b),g=setTimeout(()=>{_(()=>m(new Error(`Handler timed out after ${t}ms — the sandboxed run was terminated.`)))},t),o.srcdoc=ur(),document.body.appendChild(o)})}function dt(e){return{key:e.key,type:e.type,elementId:e.elementId,instanceKey:e.instanceKey,variables:e.variables??{}}}function mr(e,n,t){const r=typeof t.vision=="function";return ct({kind:"run-handler",source:e,job:dt(n),hasVision:r},{onTrace:t.trace,onVision:t.vision?i=>t.vision(i):void 0,onImage:t.image?()=>t.image():void 0})}function pr(e,n){return ct({kind:"run-agent",source:e,job:dt(n)})}function lt(e,n){try{new Function(`"use strict"; return (${e});`)}catch{throw new Error(`${n} has a syntax error.`)}}function gr(e){return lt(e,"Handler code"),(n,t)=>mr(e,n,t)}function hr(e){return lt(e,"Agent code"),n=>pr(e,n)}function br(e,n,t,r){return{sleep:i=>new Promise(s=>setTimeout(s,i)),trace:i=>n({kind:"tool",text:`   ${i}`,elementId:e.elementId,turn:t}),text:(i,s="")=>{const d=e.variables[i];return typeof d=="string"?d:d==null?s:String(d)},num:(i,s=0)=>{const d=e.variables[i],u=typeof d=="number"?d:Number(d);return Number.isFinite(u)?u:s},...r?{vision:dr(r,e.instanceKey),image:lr(r,e.instanceKey)}:{}}}function fr(e){if(e===void 0)return"undefined";try{return JSON.stringify(e)}catch{return"[unserializable value]"}}function _r(e,n,t,r,i){const s={},d=e.processes.flatMap(m=>m.tasks),u=new Map(d.map(m=>[m.elementId,m.label]));for(const m of d)m.compound||s[m.jobType]||(s[m.jobType]=async o=>{const c=n[o.elementId];if(!c)throw new Error(`No handler registered for ${o.elementId} (job type ${o.type})`);const g=u.get(o.elementId)??o.elementId,p=r==null?void 0:r.current;t({kind:"tool",text:`▶ ${g}`,elementId:o.elementId,turn:p});const _=await c(o,br(o,t,p,i));return t({kind:"vars",text:`  ↳ ${fr(_)}`,elementId:o.elementId,result:_,turn:p}),_});return s}const wr=/\{\{\s*([A-Za-z][A-Za-z0-9_-]*)\s*\}\}/g;function Ve(...e){const n=Object.create(null);for(const t of e)if(t)for(const r of Object.keys(t))n[r]=t[r];return n}function ut(e){return(e.split("/").pop()??e).replace(/\.[^./]+$/,"")}function mt(e){return e.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;")}function yr(e){return mt(e).replace(/"/g,"&quot;").replace(/\n/g,"&#10;").replace(/\t/g,"&#9;")}function Mr(e){return e.replace(/\\/g,"\\\\").replace(/&/g,"&amp;").replace(/"/g,"\\&#34;").replace(/\n/g,"&#10;").replace(/\t/g,"&#9;").replace(/</g,"&lt;").replace(/>/g,"&gt;")}function vr(e){return JSON.stringify(e).slice(1,-1)}function xr(e,n){const t=e.lastIndexOf("<",n),r=e.lastIndexOf(">",n);if(t<=r)return"text";const i=e.slice(t,n);if((i.match(/"/g)??[]).length%2===0)return"text";const d=i.lastIndexOf('"');return(i.slice(d+1).match(/&#34;|&quot;/g)??[]).length%2===1?"feel-literal":"attribute"}function Nr(e,n,t="xml"){const r=[],i=new Set;return{result:e.replace(wr,(d,u,m)=>{const o=u.trim();if(!Object.prototype.hasOwnProperty.call(n,o))return i.has(o)||(i.add(o),r.push(o)),d;const c=n[o];if(t==="json")return vr(c);const g=xr(e,m);return g==="feel-literal"?Mr(c):g==="attribute"?yr(c):mt(c)}),unresolved:r}}function kr(){return{processes:[],diagnostics:[],processId:"",processName:"",tasks:[],agent:null,agents:[],userTasks:[],startFormId:void 0}}function Ir(e,n={},t=e.bpmn,r={}){const i=[],s=Ve(e.templates,r),{result:d,unresolved:u}=Nr(t,s,"xml");for(const M of u)i.push({severity:"warning",message:`Template placeholder "{{${M}}}" has no matching prompt/template content — left in the model as-is, not substituted.`});let m;try{m=ar(d)}catch(M){return i.push({severity:"error",message:M instanceof Error?M.message:String(M)}),{resolvedBpmn:d,model:kr(),handlers:{},forms:{},diagnostics:i,hasErrors:!0}}i.push(...m.diagnostics);const o=m.processes.flatMap(M=>M.tasks),c=new Map(e.handlers.map(M=>[M.elementId,M.source])),g={};for(const M of o){if(M.compound)continue;const I=n[M.elementId]??c.get(M.elementId);if(I===void 0){i.push({severity:"error",elementId:M.elementId,jobType:M.jobType,message:`No handler for "${M.label}" (${M.elementId}, job type "${M.jobType}"). Add a handler for this element, or remove it from the diagram.`});continue}try{g[M.elementId]=gr(I)}catch(P){i.push({severity:"error",elementId:M.elementId,jobType:M.jobType,message:`"${M.label}" (${M.elementId}): handler code didn't compile — ${P instanceof Error?P.message:String(P)}`})}}const p=new Set(o.map(M=>M.elementId)),_=new Set([...c.keys(),...Object.keys(n)]);for(const M of _)p.has(M)||i.push({severity:"error",elementId:M,message:`Handler "${M}" doesn't match any element in the current diagram — likely orphaned by a rename. Rename it back, or remove the handler.`});const b={},y=e.forms??{},f=(M,I)=>{if(!M)return;const P=y[M];P?b[M]=P:i.push({severity:"error",formId:M,message:`${I} references form "${M}", which has no matching schema.`})};for(const M of m.processes){f(M.startFormId,`The start event of process "${M.processName}"`);for(const I of M.userTasks)f(I.formId,`User task "${I.label}" (${I.elementId})`)}return{resolvedBpmn:d,model:m,handlers:g,forms:b,diagnostics:i,hasErrors:i.some(M=>M.severity==="error")}}function Er(e){const n=e.indexOf("{");if(n<0)return null;let t=0;for(let r=n;r<e.length;r++)if(e[r]==="{")t++;else if(e[r]==="}"&&(t--,t===0))try{const i=JSON.parse(e.slice(n,r+1));return typeof i=="object"&&i!==null&&!Array.isArray(i)?i:null}catch{return null}return null}function un(e,n=220){const t=e.replace(/\s+/g," ").trim();return t.length>n?`${t.slice(0,n-1)}…`:t}function Sn(e){const n=e.arguments??e.args??e.parameters??e.input;return n&&typeof n=="object"&&!Array.isArray(n)?n:{}}function An(e){if(!e)return[];const n=e.tool??e.name??e.action;if(typeof n=="string"&&n.trim())return[{name:n.trim(),args:Sn(e)}];const t=e.tools??e.tool_calls??e.toolset??e.actions,r=Array.isArray(t)?t:Object.values(e).find(s=>Array.isArray(s))??[],i=[];for(const s of r)if(typeof s=="string")s.trim()&&i.push({name:s.trim(),args:{}});else if(s&&typeof s=="object"){const d=s,u=d.name??d.tool??d.id??d.function;typeof u=="string"&&u.trim()&&i.push({name:u.trim(),args:Sn(d)})}return i}function Tr(e){if(!e)return!1;const n=e.done??e.finished??e.complete;return typeof n=="boolean"?n:typeof n=="string"?n.toLowerCase()==="true":!1}function Dn(e){const n=e.args.length?e.args.map(r=>`      ${r.name} (${r.type}) — ${r.description}`).join(`
...
{"done": true}`;const s=i!=null&&i.args.length?`{${i.args.map(d=>`"${d.name}": "…"`).join(", ")}}`:"{}";return n?`${r}
...
character, with nothing added. When your work is finished, reply exactly
{"done": true} and no tool.`}function Sr(e,n,t,r,i=[],s=[],d=!1){const u=e.userPrompt||"Carry out your task.",m=Object.entries(n).filter(([,c])=>typeof c=="string"&&c.trim().length>0).map(([c,g])=>`  ${c}: ${String(g)}`),o=[u,m.length?`Case data:
${m.join(`
`)}`:"",`All current process variables:
${JSON.stringify(n,null,2)}`].filter(Boolean);return o.push(t.length?`${d?"Tools you have already run (you may call one again if it is genuinely needed):":"Tools you have already run — do NOT call these again:"}
${t.join(`
...
`)}async function Ar(e,n,t,r,i,s){let d="";n({kind:"llm",text:"LLM thinking…",key:t,pending:!0,turn:s});const u=await e(r,i,m=>{d+=m,n({kind:"llm",text:`${un(d)} ▍`,key:t,pending:!0,turn:s})});return n({kind:"llm",text:un(u||d)||"(empty reply)",key:t,pending:!1,turn:s}),u}function Dr(e,n){switch(e){case"number":return typeof n=="number"&&Number.isFinite(n)?{ok:!0,value:n}:typeof n=="string"&&n.trim()!==""&&Number.isFinite(Number(n))?{ok:!0,value:Number(n)}:{ok:!1};case"boolean":return typeof n=="boolean"?{ok:!0,value:n}:typeof n=="string"&&/^(true|false)$/i.test(n.trim())?{ok:!0,value:n.trim().toLowerCase()==="true"}:{ok:!1};default:return typeof n=="object"?{ok:!1}:{ok:!0,value:String(n)}}}function Cr(e,n,t){const r={},i=new Map,s=new Map;for(const{tool:d,args:u}of e){const m={};for(const o of d.args){const c=u[o.name];if(!(c!=null&&c!=="")){n({kind:"error",text:`🤖 ${d.elementId}: model supplied no value for "${o.name}"`,turn:t,elementId:d.elementId});continue}const p=i.get(o.name);if(p!==void 0&&p!==d.elementId){n({kind:"error",text:`🤖 argument name collision on "${o.name}": both ${p} and ${d.elementId} declare it — ${p} already claimed it this turn, ${d.elementId}'s value is dropped`,turn:t,elementId:d.elementId});continue}const _=Dr(o.type,c);if(!_.ok){n({kind:"error",text:`🤖 ${d.elementId}: "${o.name}" is declared as ${o.type} but the model supplied ${JSON.stringify(c)} — rejected, not passed through`,turn:t,elementId:d.elementId});continue}r[o.name]=_.value,m[o.name]=_.value,i.set(o.name,d.elementId)}s.set(d.elementId,m)}return{variablesOut:r,forHistory:s}}function Pr(e,n,t,r={}){const{maxNewTokens:i=384,allowRepeats:s=!1,allowMultiToolTurns:d=!1,turnRef:u,requiredTools:m=[],maxEarlyDoneNudges:o=1}=r;let c=0;const g=new Set,p=[];let _=0,b=[],y=[];return async f=>{const M=f.variables,I=M.toolCallResult;for(I!==void 0&&p.length&&(p[p.length-1]=`${p[p.length-1]} → ${un(JSON.stringify(I),160)}`);;){const G=await P();if(G)return G}async function P(){if(c+=1,u&&(u.current=c),c>e.maxModelCalls)return t({kind:"error",text:`Turn budget spent (maxModelCalls=${e.maxModelCalls}) — completing the agent.`,turn:c}),{completionConditionFulfilled:!0};const G=s?e.tools:e.tools.filter(D=>!g.has(D.elementId)),H=[{role:"system",content:jr(e,d,G)},{role:"user",content:Sr(e,M,p,G,b,y,s)}];b=[],y=[];let le;try{le=await Ar(n,t,`llm-turn-${c}`,H,i,c)}catch(D){return t({kind:"error",text:`LLM call failed: ${D instanceof Error?D.message:String(D)} — completing the agent.`,turn:c}),{completionConditionFulfilled:!0}}const V=Er(le);if(Tr(V)&&An(V).length===0){const D=m.filter(W=>!g.has(W));return D.length&&_<o?(_+=1,b=D,t({kind:"agent",text:`🤖 model says it is done, but ${D.join(", ")} hasn't run — asking once more`,turn:c}),null):(t({kind:"agent",text:"🤖 model says it is done",turn:c}),{completionConditionFulfilled:!0})}const ie=An(V);if(ie.length===0)return t({kind:"error",text:"🤖 model named no tool (and didn't say it was done) — asking again",turn:c}),y=['it named no tool and did not say it was done — reply with {"tool": "...", "arguments": {...}} or {"done": true}'],null;const U=[],k=[],N=[];for(const D of ie){const W=e.tools.find(be=>be.elementId===D.name);if(!W){k.push(D.name);continue}if(!s&&g.has(W.elementId)){N.push(W.elementId);continue}U.push({tool:W,args:D.args})}if(k.length&&t({kind:"error",text:`🤖 model named a tool that doesn't exist: ${k.join(", ")} — nothing activated`,turn:c}),N.length&&t({kind:"error",text:`🤖 model asked to re-run ${N.join(", ")} — skipped (already run)`,turn:c}),U.length===0)return t({kind:"agent",text:"🤖 nothing activated — asking again",turn:c}),y=[...k.length?[`${k.join(", ")} ${k.length===1?"is":"are"} not a real tool`]:[],...N.length?[`${N.join(", ")} has already run and will never run again — pick a different tool, or reply {"done": true} if nothing is left to do`]:[]],null;const{variablesOut:A,forHistory:K}=Cr(U,t,c);for(const{tool:D}of U)g.add(D.elementId),p.push(`- ${D.elementId}(${JSON.stringify(K.get(D.elementId))})`);for(const{tool:D}of U)t({kind:"agent",text:`🤖 calling ${D.elementId}`,turn:c,elementId:D.elementId,args:K.get(D.elementId)??{}});return{activateElements:U.map(D=>({elementId:D.tool.elementId})),variables:A}}}}function Lr(e,n,t,r={}){const i=new Map(e.map(s=>[s.elementId,Pr(s,n,t,r)]));return async s=>{const d=i.get(s.elementId);if(!d)throw new Error(`No agent host registered for "${s.elementId}"`);return d(s)}}class mn{__destroy_into_raw(){const n=this.__wbg_ptr;return this.__wbg_ptr=0,Cn.unregister(this),n}free(){const n=this.__destroy_into_raw();l.__wbg_testengine_free(n,0)}activateJobs(n,t,r,i){let s,d;try{const _=l.__wbindgen_add_to_stack_pointer(-16),b=S(n,l.__wbindgen_export,l.__wbindgen_export2),y=j,f=S(i,l.__wbindgen_export,l.__wbindgen_export2),M=j;l.testengine_activateJobs(_,this.__wbg_ptr,b,y,t,r,f,M);var u=w().getInt32(_+0,!0),m=w().getInt32(_+4,!0),o=w().getInt32(_+8,!0),c=w().getInt32(_+12,!0),g=u,p=m;if(c)throw g=0,p=0,R(o);return s=g,d=p,B(g,p)}finally{l.__wbindgen_add_to_stack_pointer(16),l.__wbindgen_export3(s,d,1)}}advanceTime(n){let t,r;try{const c=l.__wbindgen_add_to_stack_pointer(-16);l.testengine_advanceTime(c,this.__wbg_ptr,n);var i=w().getInt32(c+0,!0),s=w().getInt32(c+4,!0),d=w().getInt32(c+8,!0),u=w().getInt32(c+12,!0),m=i,o=s;if(u)throw m=0,o=0,R(d);return t=m,r=o,B(m,o)}finally{l.__wbindgen_add_to_stack_pointer(16),l.__wbindgen_export3(t,r,1)}}assignUserTask(n,t,r){let i,s;try{const p=l.__wbindgen_add_to_stack_pointer(-16),_=S(n,l.__wbindgen_export,l.__wbindgen_export2),b=j,y=S(t,l.__wbindgen_export,l.__wbindgen_export2),f=j;l.testengine_assignUserTask(p,this.__wbg_ptr,_,b,y,f,r);var d=w().getInt32(p+0,!0),u=w().getInt32(p+4,!0),m=w().getInt32(p+8,!0),o=w().getInt32(p+12,!0),c=d,g=u;if(o)throw c=0,g=0,R(m);return i=c,s=g,B(c,g)}finally{l.__wbindgen_add_to_stack_pointer(16),l.__wbindgen_export3(i,s,1)}}broadcastSignal(n,t){let r,i;try{const g=l.__wbindgen_add_to_stack_pointer(-16),p=S(n,l.__wbindgen_export,l.__wbindgen_export2),_=j,b=S(t,l.__wbindgen_export,l.__wbindgen_export2),y=j;l.testengine_broadcastSignal(g,this.__wbg_ptr,p,_,b,y);var s=w().getInt32(g+0,!0),d=w().getInt32(g+4,!0),u=w().getInt32(g+8,!0),m=w().getInt32(g+12,!0),o=s,c=d;if(m)throw o=0,c=0,R(u);return r=o,i=c,B(o,c)}finally{l.__wbindgen_add_to_stack_pointer(16),l.__wbindgen_export3(r,i,1)}}cancelInstance(n){let t,r;try{const c=l.__wbindgen_add_to_stack_pointer(-16),g=S(n,l.__wbindgen_export,l.__wbindgen_export2),p=j;l.testengine_cancelInstance(c,this.__wbg_ptr,g,p);var i=w().getInt32(c+0,!0),s=w().getInt32(c+4,!0),d=w().getInt32(c+8,!0),u=w().getInt32(c+12,!0),m=i,o=s;if(u)throw m=0,o=0,R(d);return t=m,r=o,B(m,o)}finally{l.__wbindgen_add_to_stack_pointer(16),l.__wbindgen_export3(t,r,1)}}completeAgentJob(n,t,r){let i,s;try{const p=l.__wbindgen_add_to_stack_pointer(-16),_=S(n,l.__wbindgen_export,l.__wbindgen_export2),b=j,y=S(t,l.__wbindgen_export,l.__wbindgen_export2),f=j,M=S(r,l.__wbindgen_export,l.__wbindgen_export2),I=j;l.testengine_completeAgentJob(p,this.__wbg_ptr,_,b,y,f,M,I);var d=w().getInt32(p+0,!0),u=w().getInt32(p+4,!0),m=w().getInt32(p+8,!0),o=w().getInt32(p+12,!0),c=d,g=u;if(o)throw c=0,g=0,R(m);return i=c,s=g,B(c,g)}finally{l.__wbindgen_add_to_stack_pointer(16),l.__wbindgen_export3(i,s,1)}}completeJob(n,t){let r,i;try{const g=l.__wbindgen_add_to_stack_pointer(-16),p=S(n,l.__wbindgen_export,l.__wbindgen_export2),_=j,b=S(t,l.__wbindgen_export,l.__wbindgen_export2),y=j;l.testengine_completeJob(g,this.__wbg_ptr,p,_,b,y);var s=w().getInt32(g+0,!0),d=w().getInt32(g+4,!0),u=w().getInt32(g+8,!0),m=w().getInt32(g+12,!0),o=s,c=d;if(m)throw o=0,c=0,R(u);return r=o,i=c,B(o,c)}finally{l.__wbindgen_add_to_stack_pointer(16),l.__wbindgen_export3(r,i,1)}}completeUserTask(n,t){let r,i;try{const g=l.__wbindgen_add_to_stack_pointer(-16),p=S(n,l.__wbindgen_export,l.__wbindgen_export2),_=j,b=S(t,l.__wbindgen_export,l.__wbindgen_export2),y=j;l.testengine_completeUserTask(g,this.__wbg_ptr,p,_,b,y);var s=w().getInt32(g+0,!0),d=w().getInt32(g+4,!0),u=w().getInt32(g+8,!0),m=w().getInt32(g+12,!0),o=s,c=d;if(m)throw o=0,c=0,R(u);return r=o,i=c,B(o,c)}finally{l.__wbindgen_add_to_stack_pointer(16),l.__wbindgen_export3(r,i,1)}}correlateMessage(n,t,r){let i,s;try{const p=l.__wbindgen_add_to_stack_pointer(-16),_=S(n,l.__wbindgen_export,l.__wbindgen_export2),b=j,y=S(t,l.__wbindgen_export,l.__wbindgen_export2),f=j,M=S(r,l.__wbindgen_export,l.__wbindgen_export2),I=j;l.testengine_correlateMessage(p,this.__wbg_ptr,_,b,y,f,M,I);var d=w().getInt32(p+0,!0),u=w().getInt32(p+4,!0),m=w().getInt32(p+8,!0),o=w().getInt32(p+12,!0),c=d,g=u;if(o)throw c=0,g=0,R(m);return i=c,s=g,B(c,g)}finally{l.__wbindgen_add_to_stack_pointer(16),l.__wbindgen_export3(i,s,1)}}createInstance(n,t,r){let i,s;try{const p=l.__wbindgen_add_to_stack_pointer(-16),_=S(n,l.__wbindgen_export,l.__wbindgen_export2),b=j,y=S(t,l.__wbindgen_export,l.__wbindgen_export2),f=j;l.testengine_createInstance(p,this.__wbg_ptr,_,b,y,f,Fr(r)?Number.MAX_SAFE_INTEGER:r>>0);var d=w().getInt32(p+0,!0),u=w().getInt32(p+4,!0),m=w().getInt32(p+8,!0),o=w().getInt32(p+12,!0),c=d,g=u;if(o)throw c=0,g=0,R(m);return i=c,s=g,B(c,g)}finally{l.__wbindgen_add_to_stack_pointer(16),l.__wbindgen_export3(i,s,1)}}debugClear(){l.testengine_debugClear(this.__wbg_ptr)}debugCreateInstance(n,t,r){let i,s;try{const p=l.__wbindgen_add_to_stack_pointer(-16),_=S(n,l.__wbindgen_export,l.__wbindgen_export2),b=j,y=S(t,l.__wbindgen_export,l.__wbindgen_export2),f=j,M=S(r,l.__wbindgen_export,l.__wbindgen_export2),I=j;l.testengine_debugCreateInstance(p,this.__wbg_ptr,_,b,y,f,M,I);var d=w().getInt32(p+0,!0),u=w().getInt32(p+4,!0),m=w().getInt32(p+8,!0),o=w().getInt32(p+12,!0),c=d,g=u;if(o)throw c=0,g=0,R(m);return i=c,s=g,B(c,g)}finally{l.__wbindgen_add_to_stack_pointer(16),l.__wbindgen_export3(i,s,1)}}get debugIsPaused(){return l.testengine_debugIsPaused(this.__wbg_ptr)!==0}debugResume(){let n,t;try{const o=l.__wbindgen_add_to_stack_pointer(-16);l.testengine_debugResume(o,this.__wbg_ptr);var r=w().getInt32(o+0,!0),i=w().getInt32(o+4,!0),s=w().getInt32(o+8,!0),d=w().getInt32(o+12,!0),u=r,m=i;if(d)throw u=0,m=0,R(s);return n=u,t=m,B(u,m)}finally{l.__wbindgen_add_to_stack_pointer(16),l.__wbindgen_export3(n,t,1)}}debugStep(){let n,t;try{const o=l.__wbindgen_add_to_stack_pointer(-16);l.testengine_debugStep(o,this.__wbg_ptr);var r=w().getInt32(o+0,!0),i=w().getInt32(o+4,!0),s=w().getInt32(o+8,!0),d=w().getInt32(o+12,!0),u=r,m=i;if(d)throw u=0,m=0,R(s);return n=u,t=m,B(u,m)}finally{l.__wbindgen_add_to_stack_pointer(16),l.__wbindgen_export3(n,t,1)}}deploy(n){let t,r;try{const c=l.__wbindgen_add_to_stack_pointer(-16),g=S(n,l.__wbindgen_export,l.__wbindgen_export2),p=j;l.testengine_deploy(c,this.__wbg_ptr,g,p);var i=w().getInt32(c+0,!0),s=w().getInt32(c+4,!0),d=w().getInt32(c+8,!0),u=w().getInt32(c+12,!0),m=i,o=s;if(u)throw m=0,o=0,R(d);return t=m,r=o,B(m,o)}finally{l.__wbindgen_add_to_stack_pointer(16),l.__wbindgen_export3(t,r,1)}}deployForm(n){let t,r;try{const c=l.__wbindgen_add_to_stack_pointer(-16),g=S(n,l.__wbindgen_export,l.__wbindgen_export2),p=j;l.testengine_deployForm(c,this.__wbg_ptr,g,p);var i=w().getInt32(c+0,!0),s=w().getInt32(c+4,!0),d=w().getInt32(c+8,!0),u=w().getInt32(c+12,!0),m=i,o=s;if(u)throw m=0,o=0,R(d);return t=m,r=o,B(m,o)}finally{l.__wbindgen_add_to_stack_pointer(16),l.__wbindgen_export3(t,r,1)}}deployResource(n,t){let r,i;try{const g=l.__wbindgen_add_to_stack_pointer(-16),p=S(n,l.__wbindgen_export,l.__wbindgen_export2),_=j,b=S(t,l.__wbindgen_export,l.__wbindgen_export2),y=j;l.testengine_deployResource(g,this.__wbg_ptr,p,_,b,y);var s=w().getInt32(g+0,!0),d=w().getInt32(g+4,!0),u=w().getInt32(g+8,!0),m=w().getInt32(g+12,!0),o=s,c=d;if(m)throw o=0,c=0,R(u);return r=o,i=c,B(o,c)}finally{l.__wbindgen_add_to_stack_pointer(16),l.__wbindgen_export3(r,i,1)}}events(){let n,t;try{const o=l.__wbindgen_add_to_stack_pointer(-16);l.testengine_events(o,this.__wbg_ptr);var r=w().getInt32(o+0,!0),i=w().getInt32(o+4,!0),s=w().getInt32(o+8,!0),d=w().getInt32(o+12,!0),u=r,m=i;if(d)throw u=0,m=0,R(s);return n=u,t=m,B(u,m)}finally{l.__wbindgen_add_to_stack_pointer(16),l.__wbindgen_export3(n,t,1)}}failJob(n,t,r){let i,s;try{const p=l.__wbindgen_add_to_stack_pointer(-16),_=S(n,l.__wbindgen_export,l.__wbindgen_export2),b=j,y=S(r,l.__wbindgen_export,l.__wbindgen_export2),f=j;l.testengine_failJob(p,this.__wbg_ptr,_,b,t,y,f);var d=w().getInt32(p+0,!0),u=w().getInt32(p+4,!0),m=w().getInt32(p+8,!0),o=w().getInt32(p+12,!0),c=d,g=u;if(o)throw c=0,g=0,R(m);return i=c,s=g,B(c,g)}finally{l.__wbindgen_add_to_stack_pointer(16),l.__wbindgen_export3(i,s,1)}}migrate(n,t,r){let i,s;try{const p=l.__wbindgen_add_to_stack_pointer(-16),_=S(n,l.__wbindgen_export,l.__wbindgen_export2),b=j,y=S(t,l.__wbindgen_export,l.__wbindgen_export2),f=j,M=S(r,l.__wbindgen_export,l.__wbindgen_export2),I=j;l.testengine_migrate(p,this.__wbg_ptr,_,b,y,f,M,I);var d=w().getInt32(p+0,!0),u=w().getInt32(p+4,!0),m=w().getInt32(p+8,!0),o=w().getInt32(p+12,!0),c=d,g=u;if(o)throw c=0,g=0,R(m);return i=c,s=g,B(c,g)}finally{l.__wbindgen_add_to_stack_pointer(16),l.__wbindgen_export3(i,s,1)}}modify(n,t,r){let i,s;try{const p=l.__wbindgen_add_to_stack_pointer(-16),_=S(n,l.__wbindgen_export,l.__wbindgen_export2),b=j,y=S(t,l.__wbindgen_export,l.__wbindgen_export2),f=j,M=S(r,l.__wbindgen_export,l.__wbindgen_export2),I=j;l.testengine_modify(p,this.__wbg_ptr,_,b,y,f,M,I);var d=w().getInt32(p+0,!0),u=w().getInt32(p+4,!0),m=w().getInt32(p+8,!0),o=w().getInt32(p+12,!0),c=d,g=u;if(o)throw c=0,g=0,R(m);return i=c,s=g,B(c,g)}finally{l.__wbindgen_add_to_stack_pointer(16),l.__wbindgen_export3(i,s,1)}}constructor(){const n=l.testengine_new();return this.__wbg_ptr=n,Cn.register(this,this.__wbg_ptr,this),this}get now(){return l.testengine_now(this.__wbg_ptr)}reset(){l.testengine_reset(this.__wbg_ptr)}resolveIncident(n){let t,r;try{const c=l.__wbindgen_add_to_stack_pointer(-16),g=S(n,l.__wbindgen_export,l.__wbindgen_export2),p=j;l.testengine_resolveIncident(c,this.__wbg_ptr,g,p);var i=w().getInt32(c+0,!0),s=w().getInt32(c+4,!0),d=w().getInt32(c+8,!0),u=w().getInt32(c+12,!0),m=i,o=s;if(u)throw m=0,o=0,R(d);return t=m,r=o,B(m,o)}finally{l.__wbindgen_add_to_stack_pointer(16),l.__wbindgen_export3(t,r,1)}}setVariables(n,t,r){let i,s;try{const p=l.__wbindgen_add_to_stack_pointer(-16),_=S(n,l.__wbindgen_export,l.__wbindgen_export2),b=j,y=S(t,l.__wbindgen_export,l.__wbindgen_export2),f=j;l.testengine_setVariables(p,this.__wbg_ptr,_,b,y,f,r);var d=w().getInt32(p+0,!0),u=w().getInt32(p+4,!0),m=w().getInt32(p+8,!0),o=w().getInt32(p+12,!0),c=d,g=u;if(o)throw c=0,g=0,R(m);return i=c,s=g,B(c,g)}finally{l.__wbindgen_add_to_stack_pointer(16),l.__wbindgen_export3(i,s,1)}}snapshot(){let n,t;try{const o=l.__wbindgen_add_to_stack_pointer(-16);l.testengine_snapshot(o,this.__wbg_ptr);var r=w().getInt32(o+0,!0),i=w().getInt32(o+4,!0),s=w().getInt32(o+8,!0),d=w().getInt32(o+12,!0),u=r,m=i;if(d)throw u=0,m=0,R(s);return n=u,t=m,B(u,m)}finally{l.__wbindgen_add_to_stack_pointer(16),l.__wbindgen_export3(n,t,1)}}throwError(n,t,r){let i,s;try{const p=l.__wbindgen_add_to_stack_pointer(-16),_=S(n,l.__wbindgen_export,l.__wbindgen_export2),b=j,y=S(t,l.__wbindgen_export,l.__wbindgen_export2),f=j,M=S(r,l.__wbindgen_export,l.__wbindgen_export2),I=j;l.testengine_throwError(p,this.__wbg_ptr,_,b,y,f,M,I);var d=w().getInt32(p+0,!0),u=w().getInt32(p+4,!0),m=w().getInt32(p+8,!0),o=w().getInt32(p+12,!0),c=d,g=u;if(o)throw c=0,g=0,R(m);return i=c,s=g,B(c,g)}finally{l.__wbindgen_add_to_stack_pointer(16),l.__wbindgen_export3(i,s,1)}}tickNow(n){let t,r;try{const c=l.__wbindgen_add_to_stack_pointer(-16);l.testengine_tickNow(c,this.__wbg_ptr,n);var i=w().getInt32(c+0,!0),s=w().getInt32(c+4,!0),d=w().getInt32(c+8,!0),u=w().getInt32(c+12,!0),m=i,o=s;if(u)throw m=0,o=0,R(d);return t=m,r=o,B(m,o)}finally{l.__wbindgen_add_to_stack_pointer(16),l.__wbindgen_export3(t,r,1)}}unassignUserTask(n){let t,r;try{const c=l.__wbindgen_add_to_stack_pointer(-16),g=S(n,l.__wbindgen_export,l.__wbindgen_export2),p=j;l.testengine_unassignUserTask(c,this.__wbg_ptr,g,p);var i=w().getInt32(c+0,!0),s=w().getInt32(c+4,!0),d=w().getInt32(c+8,!0),u=w().getInt32(c+12,!0),m=i,o=s;if(u)throw m=0,o=0,R(d);return t=m,r=o,B(m,o)}finally{l.__wbindgen_add_to_stack_pointer(16),l.__wbindgen_export3(t,r,1)}}updateRetries(n,t){let r,i;try{const g=l.__wbindgen_add_to_stack_pointer(-16),p=S(n,l.__wbindgen_export,l.__wbindgen_export2),_=j;l.testengine_updateRetries(g,this.__wbg_ptr,p,_,t);var s=w().getInt32(g+0,!0),d=w().getInt32(g+4,!0),u=w().getInt32(g+8,!0),m=w().getInt32(g+12,!0),o=s,c=d;if(m)throw o=0,c=0,R(u);return r=o,i=c,B(o,c)}finally{l.__wbindgen_add_to_stack_pointer(16),l.__wbindgen_export3(r,i,1)}}updateUserTask(n,t){let r,i;try{const g=l.__wbindgen_add_to_stack_pointer(-16),p=S(n,l.__wbindgen_export,l.__wbindgen_export2),_=j,b=S(t,l.__wbindgen_export,l.__wbindgen_export2),y=j;l.testengine_updateUserTask(g,this.__wbg_ptr,p,_,b,y);var s=w().getInt32(g+0,!0),d=w().getInt32(g+4,!0),u=w().getInt32(g+8,!0),m=w().getInt32(g+12,!0),o=s,c=d;if(m)throw o=0,c=0,R(u);return r=o,i=c,B(o,c)}finally{l.__wbindgen_add_to_stack_pointer(16),l.__wbindgen_export3(r,i,1)}}}Symbol.dispose&&(mn.prototype[Symbol.dispose]=mn.prototype.free);function Br(){return{__proto__:null,"./nanobpmn_engine_bg.js":{__proto__:null,__wbg___wbindgen_throw_bb96b2010945f0bc:function(n,t){throw new Error(B(n,t))},__wbindgen_cast_0000000000000001:function(n,t){const r=B(n,t);return Rr(r)},__wbindgen_object_drop_ref:function(n){R(n)}}}}const Cn=typeof FinalizationRegistry>"u"?{register:()=>{},unregister:()=>{}}:new FinalizationRegistry(e=>l.__wbg_testengine_free(e,1));function Rr(e){$e===we.length&&we.push(we.length+1);const n=$e;return $e=we[n],we[n]=e,n}function zr(e){e<1028||(we[e]=$e,$e=e)}let Ae=null;function w(){return(Ae===null||Ae.buffer.detached===!0||Ae.buffer.detached===void 0&&Ae.buffer!==l.memory.buffer)&&(Ae=new DataView(l.memory.buffer)),Ae}function B(e,n){return $r(e>>>0,n)}let Ue=null;function Ze(){return(Ue===null||Ue.byteLength===0)&&(Ue=new Uint8Array(l.memory.buffer)),Ue}function Or(e){return we[e]}let we=new Array(1024).fill(void 0);we.push(void 0,null,!0,!1);let $e=we.length;function Fr(e){return e==null}function S(e,n,t){if(t===void 0){const u=Ge.encode(e),m=n(u.length,1)>>>0;return Ze().subarray(m,m+u.length).set(u),j=u.length,m}let r=e.length,i=n(r,1)>>>0;const s=Ze();let d=0;for(;d<r;d++){const u=e.charCodeAt(d);if(u>127)break;s[i+d]=u}if(d!==r){d!==0&&(e=e.slice(d)),i=t(i,r,r=d+e.length*3,1)>>>0;const u=Ze().subarray(i+d,i+r),m=Ge.encodeInto(e,u);d+=m.written,i=t(i,r,d,1)>>>0}return j=d,i}function R(e){const n=Or(e);return zr(e),n}let Ke=new TextDecoder("utf-8",{ignoreBOM:!0,fatal:!0});Ke.decode();const Ur=2146435072;let rn=0;function $r(e,n){return rn+=n,rn>=Ur&&(Ke=new TextDecoder("utf-8",{ignoreBOM:!0,fatal:!0}),Ke.decode(),rn=n),Ke.decode(Ze().subarray(e,e+n))}const Ge=new TextEncoder;"encodeInto"in Ge||(Ge.encodeInto=function(e,n){const t=Ge.encode(e);return n.set(t),{read:e.length,written:t.length}});let j=0,l;function Gr(e,n){return l=e.exports,Ae=null,Ue=null,l}async function Vr(e,n){if(typeof Response=="function"&&e instanceof Response){if(!e.ok)throw new Error(`failed to fetch Wasm: ${e.status} ${e.statusText} fetching '${e.url}'`);if(typeof WebAssembly.instantiateStreaming=="function")try{return await WebAssembly.instantiateStreaming(e,n)}catch(i){if(t(e.type)&&e.headers.get("Content-Type")!=="application/wasm")console.warn("`WebAssembly.instantiateStreaming` failed because your server does not serve Wasm with `application/wasm` MIME type. Falling back to `WebAssembly.instantiate` which is slower. Original error:\n",i);else throw i}const r=await e.arrayBuffer();return await WebAssembly.instantiate(r,n)}else{const r=await WebAssembly.instantiate(e,n);return r instanceof WebAssembly.Instance?{instance:r,module:e}:r}function t(r){switch(r){case"basic":case"cors":case"default":return!0}return!1}}async function Yr(e){if(l!==void 0)return l;e!==void 0&&(Object.getPrototypeOf(e)===Object.prototype?{module_or_path:e}=e:console.warn("using deprecated parameters for the initialization function; pass a single object instead")),e===void 0&&(e=new URL("/pr-preview/pr-93/assets/nanobpmn_engine_bg-DRNrIVE8.wasm",import.meta.url));const n=Br();(typeof e=="string"||typeof Request=="function"&&e instanceof Request||typeof URL=="function"&&e instanceof URL)&&(e=fetch(e));const{instance:t,module:r}=await Vr(await e,n);return Gr(t)}let He=null;function Qr(e){return He||(He=Yr(void 0).then(()=>{}).catch(n=>{throw He=null,n})),He}function q(e){return JSON.parse(e)}class Jr{constructor(n){O(this,"engine");this.engine=n}deploy(n){return JSON.parse(this.engine.deploy(n))}createInstance(n,t){return q(this.engine.createInstance(n,t||"{}"))}activateJobs(n,t,r,i){return JSON.parse(this.engine.activateJobs(n,t,r,i))}completeJob(n,t){return q(this.engine.completeJob(n,t||"{}"))}completeAgentJob(n,t){const{variables:r,...i}=t??{};return q(this.engine.completeAgentJob(n,JSON.stringify(r??{}),JSON.stringify(i??{})))}failJob(n,t,r){return q(this.engine.failJob(n,t,r))}throwError(n,t,r){return q(this.engine.throwError(n,t,r))}updateRetries(n,t){return q(this.engine.updateRetries(n,t))}resolveIncident(n){return q(this.engine.resolveIncident(n))}setVariables(n,t,r){return q(this.engine.setVariables(n,t||"{}",r))}broadcastSignal(n,t){return q(this.engine.broadcastSignal(n,t||"{}"))}cancelInstance(n){return q(this.engine.cancelInstance(n))}modify(n,t,r){return q(this.engine.modify(n,JSON.stringify(t??[]),JSON.stringify(r??[])))}completeUserTask(n,t){return q(this.engine.completeUserTask(n,t||"{}"))}assignUserTask(n,t,r){return q(this.engine.assignUserTask(n,t,r))}unassignUserTask(n){return q(this.engine.unassignUserTask(n))}updateUserTask(n,t){return q(this.engine.updateUserTask(n,t||"{}"))}correlateMessage(n,t,r){return q(this.engine.correlateMessage(n,t,r||"{}"))}advanceTime(n){return q(this.engine.advanceTime(n))}reset(){this.engine.reset()}events(){return JSON.parse(this.engine.events())}snapshot(){return q(this.engine.snapshot())}free(){this.engine.free()}}async function qr(e){return await Qr(),new Jr(new mn)}class pt extends Error{constructor(t,r){super(t);O(this,"retries");this.name="JobFailure",this.retries=r==null?void 0:r.retries}}function Hr(e,n=[]){if(e.instances.filter(i=>!i.completed).length===0)return e.totalInstances>0?"completed":"idle";if(e.incidents.length>0)return"incidents";const r=new Set(n);return e.jobs.some(i=>!r.has(i.jobType))?"unhandledJobs":e.userTasks.some(i=>i.state==="Created")?"userTasks":e.timers.length>0?"timers":e.messageSubscriptions.length>0?"messages":e.signalSubscriptions.length>0?"signals":"idle"}function Wr(e,n=[]){const t=new Set(n);return[...new Set(e.jobs.map(r=>r.jobType))].filter(r=>!t.has(r)).sort()}async function Zr(e,n,t){let r;try{const i=await n(t);r=JSON.stringify(i??{})}catch(i){const s=i instanceof pt&&i.retries!==void 0?i.retries:Math.max(0,t.retries-1),d=i instanceof Error?i.message:String(i);e.failJob(t.key,s,d);return}e.completeJob(t.key,r)}async function Kr(e,n,t){let r;try{r=await n(t),JSON.stringify(r)}catch(i){const s=i instanceof pt&&i.retries!==void 0?i.retries:Math.max(0,t.retries-1),d=i instanceof Error?i.message:String(i);e.failJob(t.key,s,d);return}e.completeAgentJob(t.key,r)}async function Xr(e,n,t={}){const r=t.maxJobsPerActivation??10,i=t.lockTimeoutMs??3e4,s=t.worker??"bojtos",d=t.agents??{};for(const p of Object.keys(d))if(p in n)throw new Error(`dispatchRound: job type "${p}" is registered as both a worker and an agent — register it as exactly one`);const u=[];for(const[p,_]of Object.entries(n))for(const b of e.activateJobs(p,r,i,s))u.push({handler:_,job:b});const m=[];for(const[p,_]of Object.entries(d))for(const b of e.activateJobs(p,r,i,s))m.push({handler:_,job:b});for(const{handler:p,job:_}of u)await Zr(e,p,_);for(const{handler:p,job:_}of m)await Kr(e,p,_);const o=e.snapshot(),c=u.length+m.length;if(c>0)return{snapshot:o,handled:c};const g=[...Object.keys(n),...Object.keys(d)];return{snapshot:o,handled:c,reason:Hr(o,g),unhandled:Wr(o,g)}}function ei({bpmn:e}){const n=h.useRef(null),[t,r]=h.useState("loading"),[i,s]=h.useState(null),[d,u]=h.useState([]),[m,o]=h.useState(null),c=h.useRef(e),g=h.useRef(0),p=h.useRef(new Map),_=h.useCallback((k,N)=>{p.current.set(k,N)},[]),b=h.useCallback(k=>p.current.get(k),[]),y=h.useCallback((k,N)=>{const A=k.deploy(N);return c.current=N,p.current.clear(),u(A.processIds),o(null),s(null),A.processIds},[]);h.useEffect(()=>{let k=!1;return r("loading"),u([]),o(null),s(null),qr().then(N=>{if(k){N.free();return}try{y(N,e)}catch(A){N.free(),s(String(A)),r("error");return}n.current=N,r("ready")}).catch(N=>{k||(s(String(N)),r("error"))}),()=>{var N;k=!0,(N=n.current)==null||N.free(),n.current=null,p.current.clear()}},[e]);const f=h.useCallback(k=>{const N=n.current;if(!N)return null;try{const A=k(N);return o(A),s(null),A}catch(A){return s(String(A)),null}},[]),M=h.useCallback((k,N)=>f(A=>A.createInstance(k,N)),[f]),I=h.useCallback((k,N)=>f(A=>A.completeUserTask(k,N)),[f]),P=h.useCallback(k=>f(N=>N.advanceTime(k)),[f]);function G(k,N){const[A]=k.activateJobs(N,1,3e4,"manual-control");if(!A)throw new Error(`No waiting job of type "${N}" to resolve.`);return A}const H=h.useCallback((k,N)=>f(A=>{const K=G(A,k);return A.completeJob(K.key,N)}),[f]),le=h.useCallback((k,N,A)=>f(K=>{const D=G(K,k);return K.throwError(D.key,N,A)}),[f]),V=h.useCallback(async(k,N)=>{const A=n.current;if(!A)return null;const K=g.current;try{const D=await Xr(A,k,N);return n.current!==A||g.current!==K?null:(o(D.snapshot),s(null),D)}catch(D){return n.current!==A||g.current!==K||(o(A.snapshot()),s(String(D))),null}},[]),ie=h.useCallback(()=>{const k=n.current;if(k){g.current++;try{k.reset(),y(k,c.current)}catch(N){s(String(N))}}},[y]),U=h.useCallback(k=>{const N=n.current;if(!N)return null;g.current++;try{return N.reset(),y(N,k)}catch(A){return s(String(A)),null}},[y]);return{phase:t,error:i,processIds:d,snapshot:m,createInstance:M,stepWorkers:V,completeUserTask:I,advanceTime:P,completeJobManually:H,throwJobError:le,reset:ie,redeploy:U,setRunImage:_,getRunImage:b}}function ni(e,n){return e.slice(n)}function ti(e,n,t,r){const i=e.snapshot,s="⏸ waiting for a human — complete the task below to continue",d=i.userTasks.some(u=>u.state==="Created");if(e.handled>0){const u=i.activeElementIds.map(t),m=n.length?` via ${n.map(o=>`${t(o.from)} → ${t(o.to)}`).join(", ")}`:"";return i.completedInstances>=1?{kind:"done",text:`⏭ round handled ${e.handled} job${e.handled===1?"":"s"}${m} — ✅ process instance completed`}:d?{kind:"human",text:`⏭ round handled ${e.handled} job${e.handled===1?"":"s"}${m} — ${s}`}:{kind:"step",text:`⏭ round handled ${e.handled} job${e.handled===1?"":"s"}${m} — now at ${u.length?u.join(", "):"—"}`}}switch(e.reason){case"completed":return{kind:"done",text:"✅ process instance completed"};case"userTasks":return{kind:"human",text:s};case"timers":return{kind:"step",text:"⏱ waiting on a timer — advance the clock to continue"};case"messages":return{kind:"step",text:"✉ waiting on a message — correlate it to continue"};case"signals":return{kind:"step",text:"📶 waiting on a signal — broadcast it to continue"};case"incidents":return{kind:"error",text:"A job failed — incident on the diagram"};case"unhandledJobs":{const u=e.unhandled??[];return r&&u.length>0&&u.every(m=>r.has(m))?{kind:"human",text:s}:{kind:"error",text:`⏭ waiting on job type(s) with no worker registered: ${u.join(", ")}`}}case"idle":return{kind:"step",text:"Nothing to step — no instance is running."};default:return{kind:"step",text:e.reason?`Step blocked on an unrecognized reason: ${e.reason}`:"Nothing to step — no instance is running."}}}const ri="the Scripted or Endpoint brain";async function ii(){return await Ye()===null}async function Ye(e=ri){const n=navigator.gpu;if(!n)return`This browser doesn't expose WebGPU at all. Use a recent Chrome, Edge, or Safari 17+ with hardware acceleration on, or pick ${e}.`;let t;try{t=await n.requestAdapter()}catch(r){return`WebGPU adapter request failed (${r instanceof Error?r.message:String(r)}). Try ${e} instead.`}return t?null:`This browser supports the WebGPU API, but no GPU adapter is available — hardware acceleration may be off, or this device/VM has no usable GPU. Pick ${e} instead.`}const oi=[{id:"Qwen2.5-1.5B-Instruct-q4f16_1-MLC",label:"Qwen2.5 1.5B",downloadLabel:"~1.0 GB"},{id:"SmolLM2-1.7B-Instruct-q4f16_1-MLC",label:"SmolLM2 1.7B",downloadLabel:"~1.1 GB"},{id:"Llama-3.2-1B-Instruct-q4f16_1-MLC",label:"Llama 3.2 1B",downloadLabel:"~0.7 GB"},{id:"gemma-2-2b-it-q4f16_1-MLC",label:"Gemma 2 2B",downloadLabel:"~1.5 GB"},{id:"Llama-3.2-1B-Instruct-q4f32_1-MLC",label:"Llama 3.2 1B (f32, wider GPU support)",downloadLabel:"~1.1 GB"},{id:"SmolLM2-360M-Instruct-q4f32_1-MLC",label:"SmolLM2 360M (tiny, f32)",downloadLabel:"~0.6 GB"},{id:"SmolLM2-360M-Instruct-q4f16_1-MLC",label:"SmolLM2 360M (tiny)",downloadLabel:"~0.3 GB"}];function gt(e){return pn.get(e)??{}}const pn=new Map;async function ai(){if(pn.size>0)return;const{prebuiltAppConfig:e}=await de(async()=>{const{prebuiltAppConfig:n}=await import("./vendor-webllm-DT0Ab8E6.js");return{prebuiltAppConfig:n}},[]);for(const n of e.model_list)pn.set(n.model_id,{vramRequiredMB:n.vram_required_MB,requiredFeatures:n.required_features})}const en=oi.map(e=>({id:e.id,label:`${e.label} (${e.downloadLabel})`,downloadLabel:e.downloadLabel,...gt(e.id)})),ht=en[0].id;async function si(){return await ai(),en.map(e=>({...e,...gt(e.id)}))}function bt(){const e=navigator.deviceMemory;return typeof e=="number"?e*1024:null}function ci(e,n=bt()){return n==null||e.vramRequiredMB==null||n>=e.vramRequiredMB?null:`${e.label} needs roughly ${Math.round(e.vramRequiredMB)} MB of GPU memory; this device looks like it has about ${Math.round(n)} MB available. It may still work, but expect it to fail or fall back to slow shared memory — try a smaller model (e.g. SmolLM2 360M) if it doesn't load.`}async function di(e){try{const{hasModelInCache:n}=await de(async()=>{const{hasModelInCache:t}=await import("./vendor-webllm-DT0Ab8E6.js");return{hasModelInCache:t}},[]);return await n(e)}catch{return!1}}function Xe(e){return/device (was )?lost|device_hung|device_removed|already been disposed|gpudevicelostinfo/i.test(e)}function Pn(){return"The GPU device was lost — the driver reset while the model was loading or running. This is a browser/driver-level failure, not a problem with the model: fully quit and reopen the browser (a lost device usually persists for the life of the GPU process), check chrome://gpu still reports hardware acceleration, and update your GPU driver if it recurs. The Scripted and Endpoint brains don't use the GPU at all."}class We{constructor(){O(this,"kind","browser");O(this,"model",null);O(this,"engine",null);O(this,"worker",null);O(this,"generation",0);O(this,"chat",async(n,t=512,r)=>{var s,d;const i=this.engine;if(!i||!this.model)throw new Error("BrowserBrain.chat called before connect()");try{const u=await i.chat.completions.create({messages:n,temperature:0,max_tokens:t,stream:!0});let m="";for await(const o of u){const c=((d=(s=o.choices[0])==null?void 0:s.delta)==null?void 0:d.content)??"";c&&(m+=c,r==null||r(c))}return m}catch(u){const m=u instanceof Error?u.message:String(u);throw Xe(m)?(this.teardown(),new Error(`The in-browser model stopped: ${Pn()}`)):u}})}async connect(n=ht,t){var m,o;const r=await Ye();if(r)throw new Error(r);if(this.engine&&this.model===n)return n;const i=++this.generation,s=c=>{i===this.generation&&(t==null||t({progress:c.progress??0,text:c.text??""}))};this.teardown();let d,u;try{const{CreateWebWorkerMLCEngine:c}=await de(async()=>{const{CreateWebWorkerMLCEngine:g}=await import("./vendor-webllm-DT0Ab8E6.js");return{CreateWebWorkerMLCEngine:g}},[]);u=new Worker(new URL("/pr-preview/pr-93/assets/webllm.worker-Dc1cCqhL.js",import.meta.url),{type:"module"}),d=await c(u,n,{initProgressCallback:s})}catch(c){if(u==null||u.terminate(),i!==this.generation)throw new Error("cancelled");const g=c instanceof Error?c.message:String(c);if(Xe(g))throw new Error(`Couldn't load ${n} in the browser (${g}). ${Pn()}`);const p=(o=(m=en.find(_=>_.id===n))==null?void 0:m.requiredFeatures)==null?void 0:o.includes("shader-f16");throw new Error(`Couldn't load ${n} in the browser (${g}). `+(p?"This model needs WebGPU with shader-f16; try one of the f32 models in the list, or the endpoint brain.":"Try a smaller model, check your connection, or use the endpoint brain instead."))}if(i!==this.generation)throw d.unload().catch(()=>{}),u==null||u.terminate(),new Error("cancelled");return this.engine=d,this.worker=u??null,this.model=n,n}teardown(){const{engine:n,worker:t}=this;this.engine=null,this.worker=null,this.model=null,n==null||n.unload().catch(()=>{}),t==null||t.terminate()}cancelConnect(){this.generation++}dispose(){this.generation++,this.teardown()}}const ft="http://localhost:11434/v1";function _t(){var n;const e=((n=globalThis.location)==null?void 0:n.hostname)??"";return e==="localhost"||e==="127.0.0.1"||e==="[::1]"||e==="::1"}function bn(e,n={hostname:(t=>(t=globalThis.location)==null?void 0:t.hostname)()??"",origin:(r=>(r=globalThis.location)==null?void 0:r.origin)()??""}){let i;try{i=new URL(wt(e)).hostname}catch{return null}const s=d=>d==="localhost"||d==="127.0.0.1"||d==="::1"||d==="[::1]";return!s(i)||s(n.hostname)?null:`This page is served from ${n.origin||"a non-local origin"}, so it can't reach ${e}. A local model server only accepts requests from a page on localhost. Open this page at http://localhost instead, or use the Scripted or In-browser brain.`}function wt(e){let n=e.trim().replace(/\/+$/,"");return n.endsWith("/chat/completions")&&(n=n.slice(0,-17)),/\/v\d+$/.test(n)||(n=`${n}/v1`),n}class Ln extends Error{constructor(n,t){super(n),this.status=t,this.name="HttpError"}}class li{constructor(n=ft,t="",r=""){O(this,"kind","endpoint");O(this,"baseUrl");O(this,"model",null);O(this,"models",[]);O(this,"apiKey");O(this,"requestedModel");O(this,"chat",async(n,t=512,r)=>{var o,c,g;if(!this.model)throw new Error("EndpointBrain.chat called before connect()");const i=await fetch(`${this.baseUrl}/chat/completions`,{method:"POST",headers:this.headers(),body:JSON.stringify({model:this.model,messages:n,temperature:0,max_tokens:t,stream:!0})});if(!i.ok||!i.body){const p=await i.text().catch(()=>"");throw new Error(`chat/completions HTTP ${i.status} ${i.statusText}${p?` — ${p.slice(0,300)}`:""}`)}const s=i.body.getReader(),d=new TextDecoder;let u="",m="";for(;;){const{value:p,done:_}=await s.read();if(_)break;u+=d.decode(p,{stream:!0});let b;for(;(b=u.indexOf(`
`))>=0;){const y=u.slice(0,b).trim();if(u=u.slice(b+1),!y.startsWith("data:"))continue;const f=y.slice(5).trim();if(f==="[DONE]")continue;let M;try{M=JSON.parse(f)}catch{continue}M.model&&(this.model=M.model);const I=(o=M.choices)==null?void 0:o[0],P=((c=I==null?void 0:I.delta)==null?void 0:c.content)??((g=I==null?void 0:I.message)==null?void 0:g.content)??"";P&&(m+=P,r==null||r(P))}}return m});this.baseUrl=wt(n),this.apiKey=t.trim(),this.requestedModel=r.trim()}headers(){const n={"Content-Type":"application/json"};return this.apiKey&&(n.Authorization=`Bearer ${this.apiKey}`),n}async listModels(){let n;try{n=await fetch(`${this.baseUrl}/models`,{headers:this.headers()})}catch(r){const i=bn(this.baseUrl);throw new Error(i??`Can't reach ${this.baseUrl} (${r instanceof Error?r.message:String(r)}). Is the server running? For Ollama, check the app is up — and if this page is served from another origin, allow it with OLLAMA_ORIGINS.`)}if(!n.ok)throw new Ln(`${this.baseUrl}/models returned HTTP ${n.status} ${n.statusText}`,n.status);const t=await n.json();return this.models=(t.data??[]).map(r=>r.id).filter(r=>!!r),this.models}async connect(){try{const n=await this.listModels(),t=this.requestedModel||n[0];if(!t)throw new Error(`No models available at ${this.baseUrl}. Pull one first — e.g. \`ollama pull llama3.2:3b\` — or name one explicitly.`);this.model=t}catch(n){const t=n instanceof Ln&&[404,405,501].includes(n.status);if(!this.requestedModel||!t)throw n;this.models=[],this.model=this.requestedModel}return await this.validate(),this.model}async validate(){const n=await fetch(`${this.baseUrl}/chat/completions`,{method:"POST",headers:this.headers(),body:JSON.stringify({model:this.model,messages:[{role:"user",content:"Reply with ok."}],temperature:0,max_tokens:1,stream:!1})}).catch(r=>{throw new Error(`Can't reach ${this.baseUrl}/chat/completions (${r instanceof Error?r.message:String(r)}). Check the endpoint URL, API key, model name, and any local CORS settings.`)});if(!n.ok){const r=await n.text().catch(()=>"");throw new Error(`chat/completions HTTP ${n.status} ${n.statusText}${r?` — ${r.slice(0,300)}`:""}`)}const t=await n.json().catch(()=>({}));t.model&&(this.model=t.model)}dispose(){}}const ui=[{id:"onnx-community/Florence-2-base-ft",label:"Florence-2 base",downloadLabel:"~0.4 GB"},{id:"onnx-community/Florence-2-large-ft",label:"Florence-2 large (higher quality)",downloadLabel:"~1.6 GB"}],yt=ui.map(e=>({...e,label:`${e.label} (${e.downloadLabel})`})),Mt=yt[0].id,mi="<OCR>",Bn="UNKNOWN (scripted brain — connect the in-browser model to read a photo)";function pi(e,n){if(e)return typeof e=="function"?e(n):e[n]}class gi{constructor(n){O(this,"kind","scripted-vision");O(this,"model",null);O(this,"read",async(n,t,r)=>{const i=typeof n=="string"?pi(this.lookup,n)??Bn:Bn;return r==null||r(i),i});this.lookup=n}dispose(){}}function hi(e){return new gi(e)}class Rn{constructor(){O(this,"kind","browser-vision");O(this,"model",null);O(this,"modelHandle",null);O(this,"processor",null);O(this,"loadImage",null);O(this,"generation",0);O(this,"read",async(n,t,r)=>{const i=this.modelHandle,s=this.processor,d=this.loadImage;if(!i||!s||!d||!this.model)throw new Error("BrowserVisionBrain.read called before connect()");const u=t&&t.startsWith("<")?t:mi,m=await d(n),o=s.construct_prompts(u),c=await s(m,o),g=await i.generate({...c,max_new_tokens:512,num_beams:1,do_sample:!1}),p=s.batch_decode(g,{skip_special_tokens:!1})[0],_=s.post_process_generation(p,u,m.size),b=bi(_,u);return r==null||r(b),b})}async connect(n=Mt,t){var u,m;const r=await Ye("the scripted-vision fallback");if(r)throw new Error(r);if(this.modelHandle&&this.model===n)return n;const i=++this.generation,s=o=>{i===this.generation&&(t==null||t({progress:(o.progress??0)/100,text:o.file?`${o.status??"loading"} ${o.file}`:o.status??""}))};this.teardown();let d;try{const{Florence2ForConditionalGeneration:o,AutoProcessor:c,load_image:g}=await de(async()=>{const{Florence2ForConditionalGeneration:b,AutoProcessor:y,load_image:f}=await import("./transformers.web-Bt4ZVKUS.js");return{Florence2ForConditionalGeneration:b,AutoProcessor:y,load_image:f}},[]),p=await o.from_pretrained(n,{dtype:"fp32",device:"webgpu",progress_callback:s}),_=await c.from_pretrained(n);d={model:p,processor:_,loadImage:g}}catch(o){if(i!==this.generation)throw new Error("cancelled");const c=o instanceof Error?o.message:String(o);throw new Error(`Couldn't load ${n} in the browser (${c}). Try the smaller Florence-2 base model, check your connection, or use the scripted-vision fallback.`)}if(i!==this.generation)throw Promise.resolve((m=(u=d.model).dispose)==null?void 0:m.call(u)).catch(()=>{}),new Error("cancelled");return this.modelHandle=d.model,this.processor=d.processor,this.loadImage=d.loadImage,this.model=n,n}teardown(){var t;const n=this.modelHandle;this.modelHandle=null,this.processor=null,this.loadImage=null,this.model=null,Promise.resolve((t=n==null?void 0:n.dispose)==null?void 0:t.call(n)).catch(()=>{})}cancelConnect(){this.generation++}dispose(){this.generation++,this.teardown()}}function bi(e,n){const t=e[n];if(typeof t=="string")return t.trim();if(t&&typeof t=="object"){const r=t.labels;return Array.isArray(r)?r.join(" ").trim():JSON.stringify(t)}return""}async function fi(){return await ii()?"browser":_t()?"endpoint":"scripted"}function _i(){const[e,n]=h.useState("scripted"),t=h.useRef(!1),[r,i]=h.useState("idle"),[s,d]=h.useState(null),[u,m]=h.useState(null),[o,c]=h.useState(null),[g,p]=h.useState(null),[_,b]=h.useState(null),[y,f]=h.useState(null),[M,I]=h.useState(ht),[P,G]=h.useState(ft),[H,le]=h.useState(""),[V,ie]=h.useState(""),[U,k]=h.useState(null),N=h.useRef(null),[A,K]=h.useState("scripted-vision"),[D,W]=h.useState("idle"),[be,Me]=h.useState(null),[Re,Ie]=h.useState(Mt),[De,ve]=h.useState(null),[nn,Ee]=h.useState(null),[ze,oe]=h.useState(null),[Te,je]=h.useState(null),Z=h.useRef(null),xe=h.useRef(!1),Ne=h.useCallback(E=>async(...C)=>{try{return await E.chat(...C)}catch(F){const ke=F instanceof Error?F.message:String(F);throw E instanceof We&&Xe(ke)&&(k(null),m(null),i("error"),d(ke)),F}},[]),Ce=h.useCallback(E=>async(...C)=>{try{return await E.read(...C)}catch(F){const ke=F instanceof Error?F.message:String(F);throw Xe(ke)&&(je(null),ve(null),W("error"),Me(ke)),F}},[]);h.useEffect(()=>{Ye().then(E=>{b(E),p(E===null),t.current||(t.current=!0,fi().then(n))}),Ye("the scripted-vision fallback").then(E=>{oe(E),xe.current||(xe.current=!0,K(E===null?"browser-vision":"scripted-vision"))})},[]),h.useEffect(()=>{let E=!1;return f(null),di(M).then(C=>{E||f(C)}),()=>{E=!0}},[M]),h.useEffect(()=>()=>{var E;return(E=N.current)==null?void 0:E.dispose()},[]),h.useEffect(()=>()=>{var E;return(E=Z.current)==null?void 0:E.dispose()},[]);const $=h.useCallback(E=>{n(E),i("idle"),d(null),m(null),c(null),k(null)},[]),ge=h.useCallback(E=>{var C,F;xe.current=!0,(C=Z.current)==null||C.cancelConnect(),(F=Z.current)==null||F.dispose(),Z.current=null,K(E),W("idle"),Me(null),ve(null),Ee(null),je(null)},[]),ue=h.useCallback(()=>{var E;(E=N.current)==null||E.dispose(),N.current=null,k(null),m(null)},[]),fe=h.useCallback(()=>{N.current instanceof We&&N.current.cancelConnect(),ue(),i("idle"),c(null),d(null)},[ue]),Qe=h.useCallback(async()=>{var E;if(e==="scripted"){k(null),i("ready");return}if(e==="endpoint"){const C=bn(P);if(C){ue(),d(C),i("error");return}}i("connecting"),d(null),c(null);try{if(e==="browser"){const C=N.current instanceof We?N.current:new We;N.current&&N.current!==C&&N.current.dispose(),N.current=C;const F=await C.connect(M,c);m(F),k(()=>Ne(C)),f(!0)}else{(E=N.current)==null||E.dispose();const C=new li(P,V,H);N.current=C;const F=await C.connect();m(F),k(()=>Ne(C))}i("ready")}catch(C){const F=C instanceof Error?C.message:String(C);if(F==="cancelled")return;d(F),i("error"),k(null)}finally{c(null)}},[e,M,P,H,V,ue,Ne]),X=h.useCallback(()=>{var E;(E=Z.current)==null||E.dispose(),Z.current=null,je(null),ve(null)},[]),Pe=h.useCallback(()=>{var E;(E=Z.current)==null||E.cancelConnect(),X(),W("idle"),Ee(null),Me(null)},[X]),Le=h.useCallback(async()=>{if(A==="scripted-vision"){X(),W("ready"),Me(null);return}W("connecting"),Me(null),Ee(null);try{const E=Z.current instanceof Rn?Z.current:new Rn;Z.current&&Z.current!==E&&Z.current.dispose(),Z.current=E;const C=await E.connect(Re,Ee);ve(C),je(()=>Ce(E)),W("ready")}catch(E){const C=E instanceof Error?E.message:String(E);if(C==="cancelled")return;Me(C),W("error"),je(null),ve(null)}finally{Ee(null)}},[A,Re,X,Ce]);return{kind:e,setKind:$,status:r,error:s,modelInUse:u,progress:o,webgpu:g,webgpuReason:_,browserModelCached:y,cancelConnect:fe,browserModel:M,setBrowserModel:I,endpointUrl:P,setEndpointUrl:G,endpointModel:H,setEndpointModel:le,apiKey:V,setApiKey:ie,connect:Qe,chat:U,visionKind:A,setVisionKind:ge,visionStatus:D,visionError:be,visionModel:Re,setVisionModel:Ie,visionModelInUse:De,visionProgress:nn,visionWebgpuReason:ze,connectVision:Le,cancelVisionConnect:Pe,vision:Te}}const gn="#s=",wi=["scripted","browser","endpoint"];function yi(e){return typeof e=="string"&&wi.includes(e)}function Mi(e){try{const n=JSON.parse(e);if(n&&typeof n=="object"){const t=n,r={};return yi(t.brain)&&(r.brain=t.brain),r}}catch{}return{}}function vt(e=location.hash){if(!e.startsWith(gn))return{};let n;try{n=decodeURIComponent(e.slice(gn.length))}catch{return{}}return Mi(n)}function vi(e){const n=Object.entries(e).filter(([,t])=>t!==void 0);return n.length===0?"":gn+encodeURIComponent(JSON.stringify(Object.fromEntries(n)))}function xi(e){const n={...vt(),...e},t=vi(n),r=new URL(location.href);r.hash=t,history.replaceState(history.state,"",r)}const zn=[{kind:"scripted",label:"Scripted",hint:"No model. The example's stand-in decides — deterministic and offline."},{kind:"browser",label:"In-browser (WebGPU)",hint:"A small quantised model on your GPU. First run downloads weights."},{kind:"endpoint",label:"API endpoint",hint:"Any OpenAI-compatible server. Ollama by default. Local pages only."}],On=[{kind:"scripted-vision",label:"Scripted",hint:"No model. The example's known plate is returned — deterministic and offline."},{kind:"browser-vision",label:"In-browser (WebGPU)",hint:"Reads the photo with a vision model on your GPU. First run downloads weights."}];function Ni({brain:e,showText:n=!0,showVision:t=!1}){return a.jsxs("div",{className:"brain",children:[n&&a.jsx(ki,{brain:e}),n&&t&&a.jsx("hr",{className:"brain-divider"}),t&&a.jsx(Ii,{brain:e})]})}function ki({brain:e}){const n=zn.find(o=>o.kind===e.kind),t=bn(e.endpointUrl),r=_t(),[i,s]=h.useState(en);h.useEffect(()=>{si().then(s)},[]);const d=i.find(o=>o.id===e.browserModel),u=d?ci(d,bt()):null,m=e.webgpu===!0?"browser":r&&e.webgpu===!1?"endpoint":null;return a.jsxs("div",{className:"brain-section",children:[a.jsxs("div",{className:"brain-kinds",children:[zn.map(o=>a.jsxs(Q,{size:"sm",variant:e.kind===o.kind?"default":"secondary",onClick:()=>e.setKind(o.kind),children:[o.label,o.kind===m&&a.jsx(J,{variant:"info",className:"brain-recommended-badge",children:"recommended"})]},o.kind)),e.status==="ready"&&e.kind!=="scripted"&&a.jsx(J,{variant:"success",children:e.modelInUse??"connected"}),e.status==="connecting"&&a.jsx(J,{variant:"info",children:"connecting…"}),e.status==="error"&&a.jsx(J,{variant:"danger",children:"not connected"})]}),a.jsx("p",{className:"field-hint",children:n.hint}),e.kind==="browser"&&a.jsxs("div",{className:"brain-config",children:[a.jsxs("div",{className:"field",children:[a.jsx(Be,{htmlFor:"browser-model",children:"Model"}),a.jsxs(Xn,{value:e.browserModel,onValueChange:e.setBrowserModel,disabled:e.status==="connecting",children:[a.jsx(et,{id:"browser-model",children:a.jsx(nt,{})}),a.jsx(tt,{children:i.map(o=>a.jsx(rt,{value:o.id,children:o.label},o.id))})]}),e.browserModelCached===!0&&a.jsx("p",{className:"field-hint",children:"Already downloaded in this browser — connecting will be fast."}),e.browserModelCached===!1&&a.jsx("p",{className:"field-hint",children:"Not downloaded yet — connecting fetches the weights once, then caches them for next time."})]}),e.webgpu===!1&&e.webgpuReason&&a.jsxs(ae,{variant:"destructive",children:[a.jsx(se,{children:"No WebGPU in this browser"}),a.jsx(ce,{children:e.webgpuReason})]}),e.webgpu!==!1&&u&&a.jsxs(ae,{variant:"destructive",children:[a.jsx(se,{children:"This model may not fit in GPU memory"}),a.jsx(ce,{children:u})]})]}),e.kind==="endpoint"&&a.jsxs("div",{className:"brain-config",children:[a.jsxs("div",{className:"field",children:[a.jsx(Be,{htmlFor:"endpoint-url",children:"Endpoint"}),a.jsx(tn,{id:"endpoint-url",value:e.endpointUrl,onChange:o=>e.setEndpointUrl(o.target.value),disabled:e.status==="connecting"}),a.jsxs("p",{className:"field-hint",children:["Ollama allows ",a.jsx("code",{children:"localhost"})," origins out of the box; set"," ",a.jsx("code",{children:"OLLAMA_ORIGINS"})," only when serving this page from another host. Best for local development — a hosted copy of this page can't reach a server on your machine at all."]}),t&&a.jsxs(ae,{variant:"destructive",children:[a.jsx(se,{children:"A local server won't work from this URL"}),a.jsx(ce,{children:t})]})]}),a.jsxs("div",{className:"field",children:[a.jsx(Be,{htmlFor:"endpoint-model",children:"Model (blank = first served)"}),a.jsx(tn,{id:"endpoint-model",placeholder:"llama3.2:3b",value:e.endpointModel,onChange:o=>e.setEndpointModel(o.target.value),disabled:e.status==="connecting"})]}),a.jsxs("div",{className:"field",children:[a.jsx(Be,{htmlFor:"endpoint-key",children:"API key (optional)"}),a.jsx(tn,{id:"endpoint-key",type:"password",value:e.apiKey,onChange:o=>e.setApiKey(o.target.value),disabled:e.status==="connecting"})]})]}),e.kind!=="scripted"&&a.jsxs("div",{className:"brain-actions",children:[a.jsx(Q,{size:"sm",onClick:()=>void e.connect(),disabled:e.status==="connecting",children:e.status==="ready"?"Reconnect":"Connect"}),e.status==="connecting"&&e.kind==="browser"&&a.jsx(Q,{size:"sm",variant:"secondary",onClick:e.cancelConnect,children:"Cancel"}),e.progress&&a.jsxs("span",{className:"field-hint",children:[Math.round(e.progress.progress*100),"% —"," ",e.progress.text]})]}),e.error&&a.jsxs(ae,{variant:"destructive",children:[a.jsx(se,{children:"Couldn't connect"}),a.jsx(ce,{children:e.error})]})]})}function Ii({brain:e}){const n=On.find(r=>r.kind===e.visionKind),t=e.webgpu===!0?"browser-vision":null;return a.jsxs("div",{className:"brain-section brain-vision",children:[a.jsx(Be,{children:"Vision (reads the image)"}),a.jsxs("div",{className:"brain-kinds",children:[On.map(r=>a.jsxs(Q,{size:"sm",variant:e.visionKind===r.kind?"default":"secondary",onClick:()=>e.setVisionKind(r.kind),children:[r.label,r.kind===t&&a.jsx(J,{variant:"info",className:"brain-recommended-badge",children:"recommended"})]},r.kind)),e.visionStatus==="ready"&&e.visionKind==="browser-vision"&&a.jsx(J,{variant:"success",children:e.visionModelInUse??"connected"}),e.visionStatus==="connecting"&&a.jsx(J,{variant:"info",children:"connecting…"}),e.visionStatus==="error"&&a.jsx(J,{variant:"danger",children:"not connected"})]}),a.jsx("p",{className:"field-hint",children:n.hint}),e.visionKind==="scripted-vision"&&e.webgpu===!1&&e.visionWebgpuReason&&a.jsxs(ae,{variant:"destructive",children:[a.jsx(se,{children:"No WebGPU in this browser"}),a.jsx(ce,{children:e.visionWebgpuReason})]}),e.visionKind==="browser-vision"&&a.jsxs("div",{className:"brain-config",children:[a.jsxs("div",{className:"field",children:[a.jsx(Be,{htmlFor:"vision-model",children:"Model"}),a.jsxs(Xn,{value:e.visionModel,onValueChange:e.setVisionModel,disabled:e.visionStatus==="connecting",children:[a.jsx(et,{id:"vision-model",children:a.jsx(nt,{})}),a.jsx(tt,{children:yt.map(r=>a.jsx(rt,{value:r.id,children:r.label},r.id))})]}),a.jsx("p",{className:"field-hint",children:"Connecting downloads the weights once (size shown above), then caches them — every token is read on your GPU, no server."})]}),e.webgpu===!1&&e.visionWebgpuReason&&a.jsxs(ae,{variant:"destructive",children:[a.jsx(se,{children:"No WebGPU in this browser"}),a.jsx(ce,{children:e.visionWebgpuReason})]})]}),e.visionKind==="browser-vision"&&a.jsxs("div",{className:"brain-actions",children:[a.jsx(Q,{size:"sm",onClick:()=>void e.connectVision(),disabled:e.visionStatus==="connecting",children:e.visionStatus==="ready"?"Reconnect":"Connect"}),e.visionStatus==="connecting"&&a.jsx(Q,{size:"sm",variant:"secondary",onClick:e.cancelVisionConnect,children:"Cancel"}),e.visionProgress&&a.jsxs("span",{className:"field-hint",children:[Math.round(e.visionProgress.progress*100),"% —"," ",e.visionProgress.text]})]}),e.visionError&&a.jsxs(ae,{variant:"destructive",children:[a.jsx(se,{children:"Couldn't connect the vision brain"}),a.jsx(ce,{children:e.visionError})]})]})}function Ei({imageInput:e,value:n,onSelect:t,disabled:r=!1}){const[i,s]=h.useState(null),[d,u]=h.useState(!1),m=h.useRef(null),o=h.useId(),c=h.useId(),g=h.useCallback(b=>{s(URL.createObjectURL(b)),t({imageName:b.name,pixels:b})},[t]);h.useEffect(()=>{if(i)return()=>URL.revokeObjectURL(i)},[i]);const p=h.useCallback(b=>{const y=b==null?void 0:b[0];y&&y.type.startsWith("image/")&&g(y)},[g]),_=(n==null?void 0:n.imageId)!=null?e.seedImages.find(b=>b.id===n.imageId):void 0;return a.jsxs("div",{className:"image-input",children:[e.label&&a.jsx("p",{className:"field-hint",children:e.label}),a.jsx("p",{className:"image-input-label",id:o,children:"Seed photos"}),a.jsx("div",{className:"image-gallery",role:"group","aria-labelledby":o,children:e.seedImages.map(b=>{const y=(n==null?void 0:n.imageId)===b.id;return a.jsxs("button",{type:"button","aria-pressed":y,className:`image-thumb${y?" image-thumb--selected":""}`,disabled:r,title:b.label??b.id,onClick:()=>{s(null),m.current&&(m.current.value=""),t({imageId:b.id,pixels:b.file})},children:[a.jsx("img",{src:b.thumb??b.file,alt:b.label??b.id}),b.label&&a.jsx("span",{children:b.label})]},b.id)})}),a.jsx("label",{className:"image-input-label",htmlFor:c,children:"Or upload your own photo"}),a.jsxs("div",{className:`image-drop${d?" image-drop--over":""}`,onDragOver:b=>{b.preventDefault(),r||u(!0)},onDragLeave:()=>u(!1),onDrop:b=>{b.preventDefault(),u(!1),r||p(b.dataTransfer.files)},children:[a.jsx("input",{ref:m,id:c,type:"file",accept:"image/*",disabled:r,onChange:b=>p(b.target.files)}),a.jsx("p",{className:"field-hint",children:"Drag a photo here, or pick one. Uploading a photo the model has never seen is the proof this runs for real — nothing leaves your browser."})]}),(i||_)&&a.jsxs("div",{className:"image-preview",children:[a.jsx("img",{src:i??(_==null?void 0:_.file),alt:i?(n==null?void 0:n.imageName)??"uploaded photo":(_==null?void 0:_.label)??(_==null?void 0:_.id)??"selected photo"}),a.jsx("span",{className:"field-hint",children:i?`Uploaded: ${(n==null?void 0:n.imageName)??"your photo"}`:`Selected: ${(_==null?void 0:_.label)??(_==null?void 0:_.id)}`}),a.jsx("button",{type:"button",className:"image-clear-btn",disabled:r,onClick:()=>{s(null),m.current&&(m.current.value=""),t(null)},children:"Clear"})]})]})}function xt(e){return typeof e=="object"&&e!==null}function As(e){const n=new Set,t=r=>{xt(r)&&(typeof r.key=="string"&&n.add(r.key),Array.isArray(r.components)&&r.components.forEach(t))};return t(e),n}function Ti(e){const n={},t=r=>{xt(r)&&(typeof r.key=="string"&&"defaultValue"in r&&(n[r.key]=r.defaultValue??""),Array.isArray(r.components)&&r.components.forEach(t))};return t(e),n}const ji="wdf:section:";function Nt(e){return ji+e}function Fn(e){try{const n=window.localStorage.getItem(Nt(e));return n==="1"?!0:n==="0"?!1:void 0}catch{return}}function Si(e,n){try{window.localStorage.setItem(Nt(e),n?"1":"0")}catch{}}function Ai(e,n=!0){const[t,r]=h.useState(()=>Fn(e)??n);h.useEffect(()=>{r(Fn(e)??n)},[e,n]);const i=h.useCallback(s=>{r(s),Si(e,s)},[e]);return[t,i]}function _e({sectionId:e,title:n,description:t,defaultOpen:r=!0,className:i,children:s,...d}){const[u,m]=Ai(e,r);return a.jsx(Bt,{className:["panel",i].filter(Boolean).join(" "),"data-tour":d["data-tour"],children:a.jsxs(Rt,{open:u,onOpenChange:m,children:[a.jsxs(zt,{className:"panel-trigger",children:[a.jsxs("span",{className:"panel-trigger-text",children:[a.jsx("span",{className:"panel-title",children:n}),t!=null&&a.jsx("span",{className:"panel-desc",children:t})]}),a.jsx(Ot,{className:"panel-chevron","aria-hidden":!0})]}),a.jsx(Ft,{children:a.jsx(Ut,{children:s})})]})})}function Di(e){return e.entries!==void 0}function Ci(e){const n=[];let t=null;for(const r of e)r.turn!==void 0?t&&t.turn===r.turn?t.entries.push(r):(t={turn:r.turn,entries:[r]},n.push(t)):(t=null,n.push(r));return n}function Un(e){if(e===void 0)return"undefined";try{return JSON.stringify(e)}catch{return"[unserializable value]"}}function Pi({activation:e,result:n,labelFor:t}){const r=e.elementId??"";return a.jsxs("div",{className:"timeline-tool",children:[a.jsxs("div",{className:"timeline-tool-head",children:[a.jsx(J,{variant:"info",children:"tool"}),a.jsx("strong",{children:t(r)||r}),a.jsx("code",{children:r})]}),e.args!==void 0&&Object.keys(e.args).length>0&&a.jsxs("div",{className:"timeline-kv",children:[a.jsx("span",{className:"timeline-kv-label",children:"arguments"}),a.jsx("code",{children:Un(e.args)})]}),a.jsxs("div",{className:"timeline-kv",children:[a.jsx("span",{className:"timeline-kv-label",children:"returned"}),a.jsx("code",{children:n?Un(n.result):"— waiting for the job to complete —"})]})]})}function Li({group:e,labelFor:n}){const t=e.entries.find(o=>o.kind==="llm"),r=e.entries.filter(o=>o.kind==="agent"&&o.elementId),i=e.entries.filter(o=>o.kind==="vars"&&o.elementId),s=e.entries.filter(o=>o.kind==="agent"&&!o.elementId),d=e.entries.filter(o=>o.kind==="error"),u=new Set(r.map(o=>o.elementId)),m=e.entries.filter(o=>o.kind==="tool"||o.kind==="vars"&&o.elementId&&!u.has(o.elementId)).sort((o,c)=>o.id-c.id);return a.jsxs("div",{className:"timeline-turn",children:[a.jsxs("div",{className:"timeline-turn-head",children:[a.jsxs(J,{variant:t!=null&&t.pending?"warning":"neutral",children:["Turn ",e.turn]}),(t==null?void 0:t.pending)&&a.jsx("span",{className:"timeline-pending",children:"thinking…"})]}),t&&a.jsx("blockquote",{className:"timeline-reply",children:t.text}),s.map(o=>a.jsx("div",{className:"timeline-note",children:o.text},o.id)),r.map(o=>a.jsx(Pi,{activation:o,result:i.find(c=>c.elementId===o.elementId),labelFor:n},o.id)),m.map(o=>a.jsxs("div",{className:`log-line log-${o.kind}`,children:[o.pending?"⏳ ":"",o.text]},o.id)),d.map(o=>a.jsxs("div",{className:"timeline-error",children:["⚠ ",o.text]},o.id))]})}function Bi({log:e,elementStats:n=[],incidents:t=[],labelFor:r=i=>i}){const i=h.useMemo(()=>Ci(e),[e]),[s,d]=h.useState(!1),u=h.useRef(null);h.useEffect(()=>{const o=u.current;o&&(o.scrollTop=o.scrollHeight)},[i]);const m=()=>{var g;const o={log:e.map(({id:p,..._})=>_),elementStats:n,incidents:t},c=JSON.stringify(o,null,2);(g=navigator.clipboard)!=null&&g.writeText&&navigator.clipboard.writeText(c).then(()=>{d(!0),setTimeout(()=>d(!1),1500)}).catch(()=>{})};return a.jsxs(_e,{sectionId:"activity",className:"grow",title:"Activity",description:"Agent turns, model replies, and tool calls — read top to bottom as a story.",children:[a.jsx("div",{className:"timeline-toolbar",children:a.jsx(Q,{variant:"secondary",size:"sm",onClick:m,children:s?"Copied!":"Copy run as JSON"})}),a.jsx("div",{className:"timeline",ref:u,children:i.length===0?a.jsx("div",{className:"log-empty",children:"Press Run or Step to start."}):i.map(o=>Di(o)?a.jsx(Li,{group:o,labelFor:r},`turn-${o.turn}-${o.entries[0].id}`):a.jsxs("div",{className:`log-line log-${o.kind}`,children:[o.pending?"⏳ ":"",o.text]},o.id))}),(n.length>0||t.length>0)&&a.jsxs("div",{className:"timeline-engine-view",children:[n.length>0&&a.jsxs("div",{className:"timeline-stats",children:[a.jsx("span",{className:"timeline-kv-label",children:"Element completion"}),a.jsx("ul",{children:n.filter(o=>o.completed>0||(o.active??0)>0).map(o=>a.jsxs("li",{children:[a.jsx("code",{children:r(o.elementId)||o.elementId})," ","completed ",o.completed,o.active?`, ${o.active} active`:""]},o.elementId))})]}),t.length>0&&a.jsxs("div",{className:"timeline-incidents",children:[a.jsx("span",{className:"timeline-kv-label",children:"Incidents"}),a.jsx("ul",{children:t.map((o,c)=>a.jsxs("li",{children:[a.jsx("code",{children:r(o.elementId)||o.elementId})," —"," ",o.reason]},`${o.elementId}-${c}`))})]})]})]})}const he={diagram:"diagram",runButton:"run-button",variablesPanel:"variables-panel",codePanel:"code-panel",brainPanel:"brain-panel"};function $n(e){return`[data-tour="${e}"]`}function Ri(e=location.search){return new URLSearchParams(e).get("tour")}function zi(e,n){var t;return((t=e.elementStats.find(r=>r.elementId===n))==null?void 0:t.completed)??0}function Oi(e,n){return!e||e.kind==="click"||!n?!1:e.kind==="activeElement"?n.activeElementIds.includes(e.elementId):zi(n,e.elementId)>=(e.atLeast??1)}function Fi(e){return"anchor"in e?$n(e.anchor):`${$n(he.diagram)} [data-element-id="${Ui(e.elementId)}"]`}function Ui(e){return typeof CSS<"u"&&typeof CSS.escape=="function"?CSS.escape(e):e.replace(/[^a-zA-Z0-9_-]/g,n=>`\\${n}`)}function $i(e){return e.map(n=>{const t=!!n.waitFor&&n.waitFor.kind!=="click";return{element:Fi(n.target),popover:{title:n.title,description:t?`${n.description} (continues automatically once you reach that point — or use Next to skip ahead)`:n.description,showButtons:["next","previous","close"]},disableActiveInteraction:!1,skipMissingElement:n.skipMissingElement??!0}})}async function Gi(e,n={}){var s;const[{driver:t}]=await Promise.all([de(()=>import("./driver.js-bj_ppY-Q.js"),[]),de(()=>Promise.resolve({}),__vite__mapDeps([0]))]),r=$i(e),i=t({steps:r,showProgress:!0,allowClose:!0,skipMissingElement:!0,onHighlighted:(d,u,{index:m})=>{var o;m!==void 0&&((o=n.onIndexChange)==null||o.call(n,m))},onDestroyed:()=>{var d;(d=n.onDestroyed)==null||d.call(n)}});return i.drive(),(s=n.onIndexChange)==null||s.call(n,i.getActiveIndex()??0),{moveNext:()=>i.moveNext(),activeIndex:()=>i.getActiveIndex()??-1,destroy:()=>i.destroy()}}const Vi=300;function Yi(e,n){const[t,r]=h.useState(!1),i=h.useRef(null),s=h.useRef(0),d=h.useRef(-1),u=h.useRef(null),m=h.useRef(n);h.useEffect(()=>{m.current=n},[n]);const o=h.useCallback(()=>{u.current!==null&&(clearInterval(u.current),u.current=null)},[]),c=h.useRef(0),g=h.useCallback(()=>{var _;c.current+=1,o(),(_=i.current)==null||_.destroy(),i.current=null,r(!1)},[o]),p=h.useCallback(()=>{if(!e||e.steps.length===0||i.current)return;const _=c.current+=1;Gi(e.steps,{onIndexChange:b=>{s.current=b},onDestroyed:()=>{o(),i.current=null,r(!1)}}).then(b=>{if(_!==c.current){b.destroy();return}i.current=b,r(!0),u.current=setInterval(()=>{const y=s.current;if(y===d.current)return;const f=e.steps[y];f&&Oi(f.waitFor,m.current())&&(d.current=y,b.moveNext())},Vi)})},[e,o]);return h.useEffect(()=>g,[g]),{active:t,start:p,stop:g}}const on=650,an="__agent__",Gn="__model__",Vn="__template__:",Qi=h.lazy(async()=>{await Promise.all([de(()=>Promise.resolve({}),__vite__mapDeps([1])),de(()=>Promise.resolve({}),__vite__mapDeps([2]))]);const{RuntimeDiagram:e}=await de(async()=>{const{RuntimeDiagram:n}=await import("./RuntimeDiagram-B2IYfHo7.js");return{RuntimeDiagram:n}},__vite__mapDeps([3,4,5]));return{default:e}}),sn=h.lazy(()=>de(()=>import("./MonacoEditor-CS0hIYDw.js").then(e=>e.M),__vite__mapDeps([6,4,7]))),Ji=h.lazy(()=>de(()=>import("./vendor-modeler-xJyI6UeY.js"),__vite__mapDeps([8,4,5,9,10,11,12,1,2]))),Yn=h.lazy(async()=>{const{FormRenderer:e}=await de(async()=>{const{FormRenderer:n}=await import("./FormRenderer-BV0E1Vc9.js");return{FormRenderer:n}},__vite__mapDeps([13,4,11,9,10,14]));return{default:e}});function cn(e,n){try{return JSON.stringify(e??{},null,n)}catch{return"[unserializable value]"}}function qi({example:e,initialBrainKind:n,initialTourId:t}){var _n,wn,yn,Mn,vn,xn,Nn,kn;const[r,i]=h.useState(e.bpmn),s=_i(),[d,u]=h.useState(null);h.useEffect(()=>{n&&n!==s.kind&&s.setKind(n)},[]),h.useEffect(()=>{xi({brain:s.kind})},[s.kind]);const[m,o]=h.useState(()=>Object.fromEntries(e.handlers.map(v=>[v.elementId,v.source]))),[c,g]=h.useState(e.scriptedAgent??""),[p,_]=h.useState(()=>Ve(e.templates)),b=h.useMemo(()=>Ir(e,m,r,p),[e,m,r,p]),y=b.model,f=ei({bpmn:b.resolvedBpmn}),M=Yi(e.tour,()=>f.snapshot);h.useEffect(()=>{var v;t&&((v=e.tour)==null?void 0:v.id)===t&&M.start()},[]);const I=y.startFormId?((_n=e.forms)==null?void 0:_n[y.startFormId])??null:null,[P,G]=h.useState(()=>({...e.seed,...I?Ti(I):{}})),[H,le]=h.useState(y.agent?an:((wn=e.handlers[0])==null?void 0:wn.elementId)??""),[V,ie]=h.useState(!1),[U,k]=h.useState(!1),[N,A]=h.useState(null),[K,D]=h.useState([]),[W,be]=h.useState({}),[Me,Re]=h.useState(!1),Ie=h.useRef(null),[De,ve]=h.useState({}),[nn,Ee]=h.useState(!1),ze=h.useRef(null),oe=h.useRef(!1),Te=h.useRef(0),je=h.useRef(0),Z=h.useRef({current:void 0}),xe=h.useRef({}),Ne=h.useRef({}),Ce=h.useMemo(()=>{const v=new Map;for(const x of y.processes){for(const T of x.tasks)v.set(T.elementId,T.label);for(const T of x.agents){v.set(T.elementId,T.label);for(const L of T.tools)v.set(L.elementId,L.label)}for(const T of x.userTasks)v.set(T.elementId,T.label)}return x=>v.get(x)??x},[y]),$=h.useCallback(v=>{D(x=>{if(v.key){const T=x.findIndex(L=>L.key===v.key);if(T>=0){const L=[...x];return L[T]={...L[T],...v},L}}return[...x,{...v,id:je.current++}].slice(-80)})},[]),ge=h.useMemo(()=>{var v;return((v=f.snapshot)==null?void 0:v.userTasks.find(x=>x.state==="Created"))??null},[f.snapshot]),ue=h.useMemo(()=>{const v=y.processes.flatMap(T=>T.tasks),x=new Map;for(const T of e.handlers){if(!T.manualControl)continue;const L=v.find(z=>z.elementId===T.elementId);L&&x.set(L.jobType,{...T.manualControl,elementId:T.elementId})}return x},[e.handlers,y]),fe=h.useMemo(()=>{if(!f.snapshot)return null;for(const v of f.snapshot.jobs){const x=ue.get(v.jobType);if(x&&v.state==="Created")return{job:v,control:x}}return null},[f.snapshot,ue]),Qe=h.useMemo(()=>{if(!y.agent||!f.snapshot)return[];const v=new Map(f.snapshot.elementStats.map(x=>[x.elementId,x.completed]));return y.agent.tools.filter(x=>(v.get(x.elementId)??0)===0)},[y.agent,f.snapshot]),X=ge?y.userTasks.find(v=>v.elementId===ge.elementId):void 0,Pe=X!=null&&X.formId?((yn=e.forms)==null?void 0:yn[X.formId])??null:null,Le=h.useCallback(async(v,x,T,L)=>{var me;let z=T,ee=0;for(;Te.current===L&&z&&z.completedInstances<1&&ee++<80;){const Y=await f.stepWorkers(v,{agents:x});if(Te.current!==L)return z;z=(Y==null?void 0:Y.snapshot)??z;const ne=(me=z.instances[0])==null?void 0:me.variables;if(ne&&be({...ne}),z.userTasks.some(te=>te.state==="Created")){$({kind:"human",text:"⏸ waiting for a human — complete the task below to continue"});break}if(!Y){$({kind:"error",text:"▶ run stopped — no dispatch round was returned"});break}if(Y.handled===0)break;await new Promise(te=>setTimeout(te,on))}return z&&z.completedInstances>=1?$({kind:"done",text:"✅ process instance completed"}):z&&z.incidentElementIds.length>0&&$({kind:"error",text:"A job failed — incident on the diagram"}),z},[f,$]),E=h.useCallback(async v=>{var z,ee,me;if(!fe||oe.current)return;const{job:x,control:T}=fe,L=++Te.current;oe.current=!0,ie(!0);try{let Y,ne;if(v==="complete")Y=f.completeJobManually(x.jobType,"{}"),ne="  ↳ completed normally";else if(T.action.kind==="timer"){const te=((ee=(z=f.snapshot)==null?void 0:z.timers[0])==null?void 0:ee.dueInMs)??0;Y=f.advanceTime(Math.max(te,0)+1),ne="  ↳ advanced the clock — timer fired"}else{const{errorCode:te,message:re}=T.action;Y=f.throwJobError(x.jobType,te,re),ne=`  ↳ threw BPMN error ${te}: ${re}`}if(Y){$({kind:"vars",text:ne,elementId:x.elementId});const te=(me=Y.instances[0])==null?void 0:me.variables;te&&be({...te}),await new Promise(re=>setTimeout(re,on)),await Le(xe.current,Ne.current,Y,L)}else $({kind:"error",text:"  ↳ failed to resolve the manual job",elementId:x.elementId})}finally{oe.current=!1,ie(!1)}},[fe,f,$,Le]),C=h.useCallback(async()=>{var te;let v=null;try{y.agent&&c.trim()&&(v=hr(c))}catch(re){return A(re instanceof Error?re.message:String(re)),null}Z.current={current:void 0};let x;if(e.imageInput){const re=s.vision;x={read:re??hi(e.scriptedVision).read,live:!!re,resolve:pe=>f.getRunImage(pe)}}const T=_r(y,b.handlers,$,Z.current,x);for(const re of ue.keys())delete T[re];const L={};if(y.agents.length>0){if(s.kind!=="scripted"&&s.chat){const Se=new Map;for(const pe of y.agents)Se.set(pe.jobType,[...Se.get(pe.jobType)??[],pe]);for(const[pe,Oe]of Se)L[pe]=Lr(Oe,s.chat,$,{turnRef:Z.current,requiredTools:e.requiredTools})}else if(v&&y.agent){const Se=y.agent.elementId;L[y.agent.jobType]=async pe=>{if(pe.elementId!==Se)throw new Error(`No scripted agent handler for "${pe.elementId}" — only "${Se}" (the primary process's first agent host) is driven by the scripted brain. Use a live brain to exercise more than one host.`);const Oe=await v(pe),At=(Oe.activateElements??[]).map(Dt=>Dt.elementId).join(", ");return $({kind:"agent",text:Oe.completionConditionFulfilled?"🤖 scripted agent: done":`🤖 scripted agent: calling ${At||"(nothing)"}`}),Oe}}}D([]),ve({});const z={...e.seed,...P,...sr(e.imageInput?d:null)};be(z),xe.current=T,Ne.current=L;const ee=f.redeploy(r),me=(ee==null?void 0:ee[0])??y.processId;$({kind:"start",text:`Starting "${me}" — ${y.agent?s.kind==="scripted"||!s.chat?"scripted brain":`live brain (${s.modelInUse??s.kind})`:"no agent in this model"}`});const Y=f.createInstance(me,JSON.stringify(z)),ne=(te=Y==null?void 0:Y.instances[0])==null?void 0:te.key;return e.imageInput&&d&&ne&&f.setRunImage(ne,d),{workers:T,agents:L,snap:Y}},[f,e,b,r,c,P,d,y,s,$,ue]),F=!!f.snapshot&&f.snapshot.completedInstances<1,ke=!F&&!!I&&!Me,It=h.useCallback(async()=>{if(!(f.phase!=="ready"||oe.current||U||b.hasErrors)){oe.current=!0,ie(!0);try{let v=xe.current,x=Ne.current,T=f.snapshot;const L=++Te.current;if(!F){if(Ie.current&&!Ie.current.validate())return;A(null);const z=await C();if(!z)return;v=z.workers,x=z.agents,T=z.snap,await new Promise(ee=>setTimeout(ee,on))}await Le(v,x,T,L)}finally{oe.current=!1,ie(!1)}}},[f,U,b.hasErrors,F,C,Le]),Et=h.useCallback(async()=>{var v;if(!(f.phase!=="ready"||oe.current||U||b.hasErrors)){oe.current=!0,k(!0);try{let x=xe.current,T=Ne.current,L=f.snapshot;if(!F){if(Ie.current&&!Ie.current.validate())return;A(null);const ne=await C();if(!ne)return;x=ne.workers,T=ne.agents,L=ne.snap}if(!L||L.completedInstances>=1)return;const z=L.takenSequenceFlows.length,ee=await f.stepWorkers(x,{agents:T});if(!ee){$({kind:"error",text:"⏭ step failed — no dispatch round was returned"});return}const me=(v=ee.snapshot.instances[0])==null?void 0:v.variables;me&&be({...me});const Y=ni(ee.snapshot.takenSequenceFlows,z);$(ti(ee,Y,Ce,ue))}finally{oe.current=!1,k(!1)}}},[f,U,b.hasErrors,F,C,$,Ce,ue]),Tt=h.useCallback(()=>{oe.current=!1,Te.current++,ie(!1),k(!1),f.reset(),D([]),be({})},[f]),jt=h.useCallback(()=>{if(!ge||ze.current&&!ze.current.validate())return;const v=f.completeUserTask(ge.key,JSON.stringify(De));$({kind:"human",text:`👤 ${cn(De)}`}),v&&v.completedInstances>=1&&$({kind:"done",text:"✅ process instance completed"})},[ge,De,f,$]),St=h.useMemo(()=>{var v,x;return f.phase==="loading"?a.jsx(J,{variant:"neutral",children:"Booting engine…"}):f.phase==="error"?a.jsx(J,{variant:"danger",children:"Engine error"}):V?a.jsx(J,{variant:"info",children:"Running…"}):U?a.jsx(J,{variant:"info",children:"Stepping…"}):(((v=f.snapshot)==null?void 0:v.incidentElementIds.length)??0)>0?a.jsx(J,{variant:"danger",children:"Incident"}):ge?a.jsx(J,{variant:"warning",children:"Waiting for a human"}):(((x=f.snapshot)==null?void 0:x.completedInstances)??0)>=1?a.jsx(J,{variant:"success",children:"Completed"}):f.snapshot?a.jsx(J,{variant:"warning",children:"Paused"}):a.jsx(J,{variant:"neutral",children:"Ready"})},[f.phase,f.snapshot,V,U,ge]);return a.jsxs("div",{className:"runner",children:[a.jsxs("section",{className:"intro",children:[a.jsx("h1",{children:e.title}),a.jsx("p",{children:e.blurb}),a.jsxs("div",{className:"controls",children:[a.jsx(Q,{"data-tour":he.runButton,onClick:()=>void It(),disabled:f.phase!=="ready"||V||U||b.hasErrors||ke,children:"▶ Run"}),a.jsx(Q,{variant:"secondary",onClick:()=>void Et(),disabled:f.phase!=="ready"||V||U||b.hasErrors||ke||(((Mn=f.snapshot)==null?void 0:Mn.completedInstances)??0)>=1,children:"⏭ Step"}),a.jsx(Q,{variant:"secondary",onClick:Tt,disabled:f.phase!=="ready"||U,children:"↺ Reset"}),e.tour&&a.jsx(Q,{variant:"secondary",onClick:M.start,disabled:M.active,children:M.active?"Touring…":`🧭 ${e.tour.label}`}),St]}),f.phase==="error"&&a.jsxs(ae,{variant:"destructive",children:[a.jsx(se,{children:"Engine error"}),a.jsx(ce,{children:f.error})]}),N&&a.jsxs(ae,{variant:"destructive",children:[a.jsx(se,{children:"Code didn't compile"}),a.jsx(ce,{children:N})]}),b.hasErrors&&a.jsxs(ae,{variant:"destructive",children:[a.jsx(se,{children:"Run is disabled — the diagram has unresolved references"}),a.jsx(ce,{children:a.jsx("ul",{className:"diagnostics",children:b.diagnostics.filter(v=>v.severity==="error").map((v,x)=>a.jsx("li",{children:v.message},x))})})]}),!b.hasErrors&&b.diagnostics.length>0&&a.jsxs(ae,{children:[a.jsx(se,{children:"Heads up"}),a.jsx(ce,{children:a.jsx("ul",{className:"diagnostics",children:b.diagnostics.map((v,x)=>a.jsx("li",{children:v.message},x))})})]})]}),a.jsxs("div",{className:"grid",children:[a.jsxs("div",{className:"col",children:[a.jsx(_e,{sectionId:"process","data-tour":he.diagram,title:"Process",description:`${y.processName} — live token (green), incidents (red).`,children:a.jsx(h.Suspense,{fallback:a.jsx("div",{className:"diagram-fallback",children:f.phase==="loading"?"Booting the engine…":"Loading diagram…"}),children:a.jsx(Qi,{xml:b.resolvedBpmn,activeIds:((vn=f.snapshot)==null?void 0:vn.activeElementIds)??[],incidentIds:((xn=f.snapshot)==null?void 0:xn.incidentElementIds)??[],className:"diagram"})})}),ge&&a.jsxs(_e,{sectionId:"human-task",title:(X==null?void 0:X.label)??"Human task",description:Pe?`Rendered from the model's form "${X==null?void 0:X.formId}".`:"This task has no linked form — complete it with no variables.",children:[Qe.length>0&&a.jsxs(ae,{variant:"destructive",children:[a.jsx(se,{children:"The agent didn't finish its checks"}),a.jsxs(ce,{children:["It completed without running"," ",Qe.map(v=>v.label||v.elementId).join(", "),". The process took the default path to this task, so the findings below have no value to report."]})]}),Pe&&a.jsx(h.Suspense,{fallback:a.jsx("div",{className:"form-fallback",children:"Loading form…"}),children:a.jsx(Yn,{ref:ze,schema:Pe,values:De,onChange:(v,x)=>ve(T=>({...T,[v]:x})),context:W,onValidityChange:Ee})}),a.jsx(Q,{onClick:jt,disabled:!!Pe&&!nn,children:"Complete task"})]}),fe&&a.jsx(_e,{sectionId:"manual-job",title:fe.control.label,description:"This job is held here on purpose — pick how it resolves.",children:a.jsxs("div",{className:"controls",children:[a.jsx(Q,{onClick:()=>void E("complete"),disabled:V||U,children:fe.control.completeLabel??"✅ Complete normally"}),a.jsx(Q,{variant:"secondary",onClick:()=>void E("action"),disabled:V||U,children:fe.control.action.label})]})}),a.jsxs("div",{className:"row",children:[a.jsx(_e,{sectionId:"variables",className:"grow","data-tour":he.variablesPanel,title:"Variables",description:"The instance payload, live.",children:a.jsx("pre",{className:"vars",children:cn(W,2)})}),a.jsx(Bi,{log:K,elementStats:(Nn=f.snapshot)==null?void 0:Nn.elementStats,incidents:(kn=f.snapshot)==null?void 0:kn.incidents,labelFor:Ce})]})]}),a.jsxs("div",{className:"col",children:[(y.agent||e.imageInput)&&a.jsx(_e,{sectionId:"brain","data-tour":he.brainPanel,title:"Brain",description:y.agent?`What drives “${y.agent.label}”. The model recommends; the process governs.`:"What reads the image. The model recommends; the process governs.",children:a.jsx(Ni,{brain:s,showText:!!y.agent,showVision:!!e.imageInput})}),a.jsxs(_e,{sectionId:"start",title:"Start",description:y.startFormId?`The model's start form "${y.startFormId}".`:e.imageInput?"Pick a seed photo or upload your own to read.":"The starting payload.",children:[e.imageInput&&a.jsx(Ei,{imageInput:e.imageInput,value:d,onSelect:u,disabled:V}),e.scenarios&&a.jsx("div",{className:"scenarios",children:e.scenarios.map(v=>a.jsx(Q,{size:"sm",variant:"secondary",disabled:V,onClick:()=>G(x=>({...x,...v.variables})),children:v.label},v.label))}),I?a.jsx(h.Suspense,{fallback:a.jsx("div",{className:"form-fallback",children:"Loading form…"}),children:a.jsx(Yn,{ref:Ie,schema:I,values:P,onChange:(v,x)=>G(T=>({...T,[v]:x})),disabled:V,onValidityChange:Re})}):a.jsx("pre",{className:"vars",children:cn(P,2)})]}),a.jsx(_e,{sectionId:"code",className:"editors","data-tour":he.codePanel,title:"Code",description:"One handler per BPMN element. Return variables to merge, or throw to fail the job.",children:a.jsx(h.Suspense,{fallback:a.jsx("div",{className:"editor-fallback",children:"Loading editor…"}),children:a.jsxs($t,{value:H,onValueChange:le,children:[a.jsxs(Gt,{children:[a.jsx(Je,{value:Gn,children:"model"}),y.agent&&a.jsx(Je,{value:an,children:"agent (scripted)"}),e.handlers.map(v=>{var x;return a.jsx(Je,{value:v.elementId,children:((x=y.tasks.find(T=>T.elementId===v.elementId))==null?void 0:x.label)??v.elementId},v.elementId)}),Object.keys(p).map(v=>a.jsx(Je,{value:Vn+v,children:v},v))]}),a.jsxs(qe,{value:Gn,children:[a.jsxs("div",{className:"editor-meta",children:[a.jsx("strong",{children:"Model"}),a.jsx("code",{children:"edit the diagram visually — Run re-checks it below"}),a.jsx(Q,{variant:"secondary",size:"sm",onClick:()=>i(e.bpmn),disabled:r===e.bpmn,children:"Revert to original"})]}),a.jsx(Ji,{value:r,onChange:i})]}),y.agent&&a.jsxs(qe,{value:an,children:[a.jsxs("div",{className:"editor-meta",children:[a.jsx("strong",{children:y.agent.label}),a.jsx("code",{children:s.kind==="scripted"||!s.chat?"in use":"unused — a live brain is connected"})]}),a.jsx("div",{className:"editor-wrap",children:a.jsx(sn,{height:"360px",defaultLanguage:"javascript",value:c,onChange:v=>g(v??""),options:dn})})]}),e.handlers.map(v=>{var x;return a.jsxs(qe,{value:v.elementId,children:[a.jsxs("div",{className:"editor-meta",children:[a.jsx("strong",{children:((x=y.tasks.find(T=>T.elementId===v.elementId))==null?void 0:x.label)??v.elementId}),a.jsx("code",{children:v.standsInFor??v.elementId})]}),a.jsx("div",{className:"editor-wrap",children:a.jsx(sn,{height:"360px",defaultLanguage:"javascript",value:m[v.elementId],onChange:T=>o(L=>({...L,[v.elementId]:T??""})),options:dn})})]},v.elementId)}),Object.keys(p).map(v=>a.jsxs(qe,{value:Vn+v,children:[a.jsxs("div",{className:"editor-meta",children:[a.jsx("strong",{children:v}),a.jsxs("code",{children:["prompt / template text — substitutes"," ","{{"+v+"}}"]})]}),a.jsx("div",{className:"editor-wrap",children:a.jsx(sn,{height:"360px",defaultLanguage:"markdown",value:p[v],onChange:x=>_(T=>Ve(T,{[v]:x??""})),options:dn})})]},v))]})})}),y.agent&&a.jsx(_e,{sectionId:"tools",title:"Tools, as the model sees them",description:a.jsxs(a.Fragment,{children:["Read from the diagram — element name, documentation, and every",a.jsx("code",{children:" fromAi(…)"})," argument."]}),children:a.jsx("ul",{className:"tool-list",children:y.agent.tools.map(v=>a.jsxs("li",{children:[a.jsx("code",{children:v.elementId}),a.jsxs("span",{children:[" — ",v.documentation||v.label]}),v.args.length>0&&a.jsx("ul",{children:v.args.map(x=>a.jsxs("li",{children:[a.jsxs("code",{children:[x.name,": ",x.type]})," ","— ",x.description]},x.name))})]},v.elementId))})})]})]})]})}const dn={minimap:{enabled:!1},fontSize:13,scrollBeyondLastLine:!1,tabSize:2,automaticLayout:!0},Hi=`<?xml version="1.0" encoding="UTF-8"?>\r
...
`,so=`Please verify export compliance for this shipment and notify the team of your decision.\r
`,co={id:"compliance-walkthrough",label:"Take the tour",steps:[{title:"Start a run",description:"Press Run to send a shipment through the compliance agent.",target:{anchor:he.runButton}},{title:"The agent picks its own tools",description:"This AI Agent reads the shipment notes and decides, turn by turn, which of the tools below it to call — nothing here is hard-coded into a fixed sequence.",target:{elementId:"ComplianceCheckAgent"}},{title:"Watch the token move",description:"The agent's first move is to look up the genetic marker mentioned in the notes.",target:{elementId:"VerifyGeneticMarker"},waitFor:{kind:"activeElement",elementId:"VerifyGeneticMarker"}},{title:"A cleared shipment notifies the export team",description:"Once the compliance score comes back clean, the process notifies the export team automatically — no human review needed for this scenario.",target:{elementId:"NotifyExportTeam"},waitFor:{kind:"elementCompleted",elementId:"NotifyExportTeam"}},{title:"Everything the run recorded",description:"The variables panel shows the marker record, the country lookup, the compliance score, and the final decision — exactly what each tool and the agent wrote along the way.",target:{anchor:he.variablesPanel}}],successEvent:{kind:"instanceCompleted"}},lo=`<?xml version="1.0" encoding="UTF-8"?>
...
}`,Bo={id:"seed-export-compliance",title:"Seed export compliance agent",blurb:"An AI agent picks its own tools to check a shipment, then a gateway routes on its decision — cleared shipments notify the export team, flagged ones go to a human. The LLM recommends; the BPMN process governs.",docsUrl:"https://camunda.com/blog/agentic-ai/",bpmn:lo,forms:{"seed-export-shipment-ready":_o,"seed-export-compliance-review":Io},seed:{scenario:Qn,shipmentNotes:""},scenarios:[{label:"Likely cleared (TP53 → Brazil)",variables:{scenario:Qn,shipmentNotes:""}},{label:"Likely flagged (BRCA1 → Germany)",variables:{scenario:jo,shipmentNotes:""}}],scriptedAgent:So,templates:To,tour:co,requiredTools:["RecordComplianceDecision"],handlers:[{elementId:"VerifyGeneticMarker",standsInFor:"JDBC connector — UCSC hg38",source:Ao},{elementId:"CheckDestinationCountry",standsInFor:"GraphQL connector — countries API",source:Do},{elementId:"ComputeComplianceScore",standsInFor:"REST connector — api.mathjs.org",source:Co},{elementId:"RecordComplianceDecision",standsInFor:"Script task — FEEL",source:Po},{elementId:"NotifyExportTeam",standsInFor:"REST connector — httpbin.io",source:Lo}]},Ro=`You are a loan origination assistant at a retail bank. Your job is to gather everything a senior loan officer needs to decide an application — you do **not** decide it yourself.
...
}`,ca=`async (job, { text, num, sleep, trace }) => {
...
}`,pa={id:"loan-origination",title:"Loan origination agent",blurb:"An AI agent gathers a loan case with its own tools — customer lookup, credit bureau, an underwriting policy, a status update — then every application passes through a mandatory senior-officer review before a gateway routes it to an offer or a decline. The agent advises; the process governs.",docsUrl:"https://camunda.com/orchestrate/agents/",bpmn:Fo,forms:{"loan-application":qo,"loan-senior-officer-review":ta},seed:Jn,scenarios:[{label:"Strong applicant (policy recommends approve)",variables:Jn},{label:"Marginal applicant (policy recommends decline)",variables:oa}],scriptedAgent:aa,templates:ia,tour:Oo,requiredTools:["AssessApplication"],handlers:[{elementId:"QueryCustomer",standsInFor:"CRM connector — customer lookup",source:sa},{elementId:"CreditBureauLookup",standsInFor:"REST connector — credit bureau",source:ca},{elementId:"AssessApplication",standsInFor:"Script task — underwriting policy (FEEL)",source:da},{elementId:"UpdateApplicationStatus",standsInFor:"REST connector — origination system",source:la},{elementId:"IssueLoanOffer",standsInFor:"REST connector — offer/booking system",source:ua},{elementId:"SendDeclineNotice",standsInFor:"REST connector — notifications",source:ma}]},ga=`<?xml version="1.0" encoding="UTF-8"?>
...
}`,_a={id:"order-process",title:"Order process with service workers",blurb:"The getting-started order process: check inventory, charge payment, ship. No agent and no human step — the same runner, driven entirely by what's in the diagram.",docsUrl:"https://docs.camunda.io/docs/next/guides/getting-started-orchestration-cluster/",bpmn:ga,seed:{item:"camunda-t-shirt",quantity:3},handlers:[{elementId:"Activity_0tw2fu0",standsInFor:"job worker — check-inventory",source:ha},{elementId:"Activity_1ppsbgi",standsInFor:"job worker — charge-payment",source:ba},{elementId:"Activity_08pg6im",standsInFor:"job worker — ship-items",source:fa}]},wa=`<?xml version="1.0" encoding="UTF-8"?>\r
...
`,ya=`async (job, { text, num, sleep, trace }) => {
  // The starting variables arrive on 'job.variables'.
...
}`,Ma={id:"rocket-launch",title:"Rocket launch",blurb:"The getting-started rocket launch, boiled down to one service task: launch. The smallest possible example, and the smallest possible test of the framework's extensibility.",bpmn:wa,seed:{missionName:"Apollo 11",destination:"the Moon",fuelLevel:100},scenarios:[{label:"Full tanks — launch succeeds",variables:{missionName:"Apollo 11",destination:"the Moon",fuelLevel:100}},{label:"Low fuel — mission scrubbed",variables:{missionName:"Apollo 13",destination:"the Moon",fuelLevel:30}}],handlers:[{elementId:"Activity_LaunchRocket",standsInFor:"job worker — launch-rocket",source:ya}]},va=`<?xml version="1.0" encoding="UTF-8"?>\r
...
`,xa=`async (job, { text, sleep }) => {
  ...
  return { shipped: true, tracking: "1Z" + Math.floor(Math.random() * 1e9) };
}`,Ia={id:"order-process-boundary-events",title:"Order process with boundary events",blurb:"The getting-started order process, extended with a timer and an error boundary event: charge payment can be declined, and a delayed shipment can escalate — both fired by hand from the runner rather than by chance.",docsUrl:"https://github.com/camunda/camunda-8-get-started/tree/main/2-order-process-with-service-workers",bpmn:va,seed:{item:"camunda-t-shirt",quantity:3},handlers:[{elementId:"Activity_0tw2fu0",standsInFor:"job worker — check-inventory",source:xa},{elementId:"Activity_1ppsbgi",standsInFor:"job worker — charge-payment",source:Na,manualControl:{label:"Charge payment method",completeLabel:"✅ Complete normally",action:{kind:"error",errorCode:"CHARGE_DECLINED",message:"The card issuer declined the charge.",label:"❌ Simulate: card declined"}}},{elementId:"Activity_08pg6im",standsInFor:"job worker — ship-items",source:ka,manualControl:{label:"Ship items",completeLabel:"✅ Ship it",action:{kind:"timer",label:"🕐 Fire the shipping-delayed timer"}}}]},Ea="/pr-preview/pr-93/assets/de-bmw-mini-JBSk7QcF.jpg",Ta="/pr-preview/pr-93/assets/de-bmw-mini.thumb-CUUmJrRO.jpg",ja="/pr-preview/pr-93/assets/uk-d651-rnb-XGipy2QN.jpg",Sa="/pr-preview/pr-93/assets/uk-d651-rnb.thumb-mjEcbhUf.jpg",Aa="/pr-preview/pr-93/assets/uk-mk70-orj-Cn6O3Xfm.jpg",Da="/pr-preview/pr-93/assets/uk-mk70-orj.thumb-CaeZ2vqU.jpg",Ca="/pr-preview/pr-93/assets/uk-ni-ijz-8992-YXV44tgk.jpg",Pa="/pr-preview/pr-93/assets/uk-ni-ijz-8992.thumb-DYwok8jV.jpg",La="/pr-preview/pr-93/assets/us-hyundai-genesis-gGpAIEpi.jpg",Ba="/pr-preview/pr-93/assets/us-hyundai-genesis.thumb-DEEt19Mw.jpg",Ra=`<?xml version="1.0" encoding="UTF-8"?>
...
}`,gs={id:"plate-recognition",title:"Read a number plate from a photo",blurb:"Pick the plate's country, then a photo goes into the run, an in-browser vision model reads the number plate on the reader's own GPU, and a human confirms or corrects it before the process records the result. The vision model recommends; the BPMN process governs. No server, no API key — with no model connected it falls back to a deterministic scripted reading.",docsUrl:"https://docs.camunda.io/docs/components/modeler/forms/camunda-forms-reference/",bpmn:Ra,forms:{"plate-recognition-country":ss,"plate-recognition-confirm":Ya,"plate-recognition-manual":Xa},seed:{country:"auto"},imageInput:{label:"Pick a seed photo (its plate is known, so the scripted reader works offline) or upload your own — a live in-browser model reads a photo it has never seen.",seedImages:ls},scriptedVision:us,handlers:[{elementId:"ExtractPlate",standsInFor:"Vision model — Florence-2 <OCR> on WebGPU (in-browser)",source:ms},{elementId:"RecordResult",standsInFor:"Script task — records the governed outcome",source:ps}]},hs=[Ma,Bo,pa,_a,Ia,gs],bs=Object.assign({"./learn-exclusive-gateway/index.ts":eo,"./learn-service-task/index.ts":oo}),fs=Object.values(bs).map(e=>e.default).sort((e,n)=>e.id.localeCompare(n.id)),Fe=[...hs,...fs];function fn(){return"/pr-preview/pr-93/"}function _s(e){const n=fn();return e.startsWith(n)?"/"+e.slice(n.length):e}function ws(e=location.pathname){const t=_s(e).match(/^\/examples\/([^/]+)\/?$/);if(t)try{return{kind:"example",id:decodeURIComponent(t[1])}}catch{return{kind:"gallery"}}return{kind:"gallery"}}function ys(e=location.search){return new URLSearchParams(e).get("embed")==="1"}function Ms(){return fn()}function Hn(e){return`${fn()}examples/${encodeURIComponent(e)}`}function Wn(e,n={}){const t=new URL(location.href);t.pathname=e,t.search=n.search??t.search,n.hash!==void 0&&(t.hash=n.hash),n.replace?history.replaceState(history.state,"",t):history.pushState(history.state,"",t),window.dispatchEvent(new PopStateEvent("popstate"))}function Zn(){return{route:ws(),embed:ys()}}function vs(){const[e,n]=h.useState(Zn);return h.useEffect(()=>{const t=()=>n(Zn());return window.addEventListener("popstate",t),()=>window.removeEventListener("popstate",t)},[]),e}const xs="web-demo-framework:height",Ns="web-demo-framework:request-height";function ks(e){return{type:xs,height:Math.ceil(e)}}const Kn="embed-height-auto";function Is(e){h.useEffect(()=>{if(!e||typeof window>"u"||window.parent===window)return;const n=document.documentElement;n.classList.add(Kn);let t=-1;const r=(d=!1)=>{const u=document.documentElement.scrollHeight;!d&&Math.abs(u-t)<2||(t=u,window.parent.postMessage(ks(u),"*"))},i=d=>{if(d.source!==window.parent)return;const u=d.data;!u||u.type!==Ns||r(!0)};window.addEventListener("message",i),r();const s=new ResizeObserver(()=>r());return s.observe(n),()=>{s.disconnect(),window.removeEventListener("message",i),n.classList.remove(Kn)}},[e])}function Es(){const{route:e,embed:n}=vs(),t=vt().brain,r=Ri();Is(n);const i=e.kind==="example"?e.id:Fe[0].id,s=Fe.find(c=>c.id===i)??Fe[0],d=Fe.filter(c=>c.group!=="learn-bpmn"),u=Fe.filter(c=>c.group==="learn-bpmn"),m=c=>{Wn(Hn(c),{hash:location.hash})},o=a.jsxs(a.Fragment,{children:[!n&&e.kind==="gallery"&&a.jsxs(a.Fragment,{children:[a.jsx("nav",{className:"example-picker",children:d.map(c=>a.jsx(Q,{size:"sm",variant:c.id===s.id?"default":"secondary",onClick:()=>m(c.id),children:c.title},c.id))}),u.length>0&&a.jsxs(a.Fragment,{children:[a.jsx("h2",{className:"example-group-heading",children:"Learn BPMN"}),a.jsx("nav",{className:"example-picker",children:u.map(c=>a.jsx(Q,{size:"sm",variant:c.id===s.id?"default":"secondary",onClick:()=>m(c.id),children:c.title},c.id))})]})]}),!n&&e.kind==="example"&&a.jsx("div",{className:"example-nav",children:a.jsx(Q,{size:"sm",variant:"secondary",onClick:()=>Wn(Ms()),children:"← All examples"})}),a.jsxs("div",{className:"example-meta",children:[s.docsUrl&&a.jsx("a",{className:"docs-link",href:s.docsUrl,target:"_blank",rel:"noreferrer noopener",children:"View on camunda.com ↗"}),n&&a.jsx("a",{className:"open-full-page",href:Hn(s.id)+(location.hash||""),target:"_top",rel:"noreferrer",children:"Open full page ↗"})]}),a.jsx(qi,{example:s,initialBrainKind:t,initialTourId:r},s.id)]});return n?a.jsx("div",{className:"c4-ui app-shell app-embed",children:a.jsx("main",{id:"main",className:"layout layout-embed",children:o})}):a.jsxs("div",{className:"c4-ui app-shell",children:[a.jsx(Vt,{appName:"Runnable Camunda examples",trailing:a.jsx("span",{className:"app-subtitle",children:"model + code + optional LLM, in your browser"})}),a.jsx("main",{id:"main",className:"layout",children:o})]})}Lt.createRoot(document.getElementById("root")).render(a.jsx(h.StrictMode,{children:a.jsx(Yt,{children:a.jsx(Es,{})})}));export{de as _,As as c};
