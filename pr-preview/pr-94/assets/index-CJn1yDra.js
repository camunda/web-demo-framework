const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/driver-CTZuBZOi.css","assets/diagram-js-DAKGYcfb.css","assets/bpmn-embedded-kioroQVC.css","assets/RuntimeDiagram-B2IYfHo7.js","assets/vendor-react-9Ma26nY1.js","assets/Viewer-D_7S4Gwm.js","assets/MonacoEditor-BBwK9Sqw.js","assets/MonacoEditor-DemDONLW.css","assets/vendor-modeler-6PGV0JBl.js","assets/vendor-design-system-CQWFjU5c.js","assets/vendor-design-system-EWC7Bi2z.css","assets/parser-DkgAe_kI.js","assets/ModelEditor-Dwlgp6JA.css","assets/FormRenderer-Xq-ACddp.js","assets/FormRenderer-D1JIHOW6.css"])))=>i.map(i=>d[i]);
var Pt=Object.defineProperty;var Ct=(e,n,t)=>n in e?Pt(e,n,{enumerable:!0,configurable:!0,writable:!0,value:t}):e[n]=t;var F=(e,n,t)=>Ct(e,typeof n!="symbol"?n+"":n,t);import{r as h,j as a,i as Lt}from"./vendor-react-9Ma26nY1.js";import{B as H,a as W,L as Re,S as Xn,b as et,c as nt,d as tt,e as rt,A as se,f as de,g as ce,I as rn,C as Bt,h as Rt,i as zt,j as Ot,k as Ft,l as Ut,T as $t,m as Gt,n as Je,o as qe,p as Vt,q as Yt}from"./vendor-design-system-CQWFjU5c.js";(function(){const n=document.createElement("link").relList;if(n&&n.supports&&n.supports("modulepreload"))return;for(const i of document.querySelectorAll('link[rel="modulepreload"]'))r(i);new MutationObserver(i=>{for(const s of i)if(s.type==="childList")for(const c of s.addedNodes)c.tagName==="LINK"&&c.rel==="modulepreload"&&r(c)}).observe(document,{childList:!0,subtree:!0});function t(i){const s={};return i.integrity&&(s.integrity=i.integrity),i.referrerPolicy&&(s.referrerPolicy=i.referrerPolicy),i.crossOrigin==="use-credentials"?s.credentials="include":i.crossOrigin==="anonymous"?s.credentials="omit":s.credentials="same-origin",s}function r(i){if(i.ep)return;i.ep=!0;const s=t(i);fetch(i.href,s)}})();const Qt="modulepreload",Jt=function(e){return"/pr-preview/pr-94/"+e},kn={},le=function(n,t,r){let i=Promise.resolve();if(t&&t.length>0){let c=function(o){return Promise.all(o.map(d=>Promise.resolve(d).then(g=>({status:"fulfilled",value:g}),g=>({status:"rejected",reason:g}))))};document.getElementsByTagName("link");const m=document.querySelector("meta[property=csp-nonce]"),p=(m==null?void 0:m.nonce)||(m==null?void 0:m.getAttribute("nonce"));i=c(t.map(o=>{if(o=Jt(o),o in kn)return;kn[o]=!0;const d=o.endsWith(".css"),g=d?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${o}"]${g}`))return;const u=document.createElement("link");if(u.rel=d?"stylesheet":Qt,d||(u.as="script"),u.crossOrigin="",u.href=o,p&&u.setAttribute("nonce",p),document.head.appendChild(u),d)return new Promise((_,f)=>{u.addEventListener("load",_),u.addEventListener("error",()=>f(new Error(`Unable to preload CSS for ${o}`)))})}))}function s(c){const m=new Event("vite:preloadError",{cancelable:!0});if(m.payload=c,window.dispatchEvent(m),!m.defaultPrevented)throw c}return i.then(c=>{for(const m of c||[])m.status==="rejected"&&s(m.reason);return n().catch(s)})},qt="io.camunda.agenticai:aiagent",Me="http://www.omg.org/spec/BPMN/20100524/MODEL",Ht="http://camunda.org/schema/zeebe/1.0";function ln(e,n){return Array.from(e.getElementsByTagNameNS(Ht,n))}function it(e,n){return ln(e,n).filter(t=>Wt(t)===e)}function Wt(e){let n=e.parentElement;for(;n;){if(n.namespaceURI===Me&&n.localName!=="extensionElements")return n;n=n.parentElement}return null}function hn(e){const n=it(e,"taskDefinition")[0],t=n==null?void 0:n.getAttribute("type");return t||(e.localName==="scriptTask"?e.getAttribute("id")??null:null)}function In(e){const n=Array.from(e.children).find(t=>t.namespaceURI===Me&&t.localName==="documentation");return((n==null?void 0:n.textContent)??"").trim()}function Tn(e){if(!e)return"";const n=e.startsWith("=")?e.slice(1):e,t=n.match(/"((?:[^"\\]|\\.)*)"/g);return t?t.map(r=>r.slice(1,-1).replace(/\\n/g,`
...
`).replace(/\\"/g,'"').replace(/&quot;/g,'"').replace(/&#39;/g,"'").trim(),type:i[3]??"string"}))}return t}function Xt(e){const n={};for(const t of it(e,"input")){const r=t.getAttribute("target");r&&(n[r]=t.getAttribute("source")??"")}return n}function er(e){return Array.from(e.getElementsByTagNameNS(Me,"adHocSubProcess")).filter(n=>(hn(n)??"").startsWith(qt))}const nr=new Set(["subProcess","adHocSubProcess","callActivity"]),tr=new Set(["adHocSubProcess","subProcess","transaction"]);function rr(e){let n=e.parentElement;for(;n;){if(n.namespaceURI===Me&&tr.has(n.localName))return n;n=n.parentElement}return null}function ir(e,n){const t=Xt(e),r=Number((t["data.limits.maxModelCalls"]??"").replace(/^=/,""));return{elementId:e.getAttribute("id")??"agent",label:e.getAttribute("name")??"Agent",jobType:hn(e),systemPrompt:Tn(t["data.systemPrompt.prompt"]),userPrompt:Tn(t["data.userPrompt.prompt"]),maxModelCalls:Number.isFinite(r)&&r>0?r:10,tools:n}}function or(e,n){var g;const t=e.getAttribute("id")??"",r=e.getAttribute("name")??t,i=er(e);i.length>1&&n.push({severity:"warning",elementId:i.map(u=>u.getAttribute("id")).join(", "),message:`Process "${r}" hosts ${i.length} AI Agent sub-processes (${i.map(u=>u.getAttribute("id")).join(", ")}). Each gets its own independent agent state (turn counter, called tools) — the run itself is shared across hosts, but each host's agent state within it is not.`});const s=[],c=new Map(i.map(u=>[u,[]]));for(const u of Array.from(e.getElementsByTagName("*"))){if(u.namespaceURI!==Me||i.includes(u))continue;const _=u.getAttribute("id");if(!_)continue;const f=rr(u),y=f&&i.includes(f)?f:null;if(y&&nr.has(u.localName)){const k=u.getAttribute("name")??_,C=In(u);s.push({elementId:_,label:k,jobType:"",documentation:C,isTool:!0,compound:!0}),c.get(y).push({elementId:_,label:k,jobType:"",documentation:C,args:Kt(u),compound:!0});continue}const b=hn(u);if(!b)continue;const M={elementId:_,label:u.getAttribute("name")??_,jobType:b,documentation:In(u),isTool:y!=null};s.push(M),y&&c.get(y).push({elementId:_,label:M.label,jobType:b,documentation:M.documentation,args:Zt(u)})}const m=i.map(u=>ir(u,c.get(u))),p=Array.from(e.getElementsByTagNameNS(Me,"userTask")).map(u=>{var _;return{elementId:u.getAttribute("id")??"",label:u.getAttribute("name")??u.getAttribute("id")??"",formId:((_=ln(u,"formDefinition")[0])==null?void 0:_.getAttribute("formId"))??void 0}}),o=e.getElementsByTagNameNS(Me,"startEvent")[0],d=o?((g=ln(o,"formDefinition")[0])==null?void 0:g.getAttribute("formId"))??void 0:void 0;return{processId:t,processName:r,tasks:s,agents:m,userTasks:p,startFormId:d}}function ar(e,n={}){const t=new DOMParser().parseFromString(e,"application/xml"),r=t.getElementsByTagName("parsererror")[0];if(r)throw new Error(`Invalid BPMN XML: ${r.textContent}`);const i=Array.from(t.getElementsByTagNameNS(Me,"process"));if(i.length===0)throw new Error("No <bpmn:process> in the diagram.");const s=[],c=i.map(p=>or(p,s));let m=n.processId?c.find(p=>p.processId===n.processId):void 0;return n.processId&&!m&&s.push({severity:"warning",message:`Requested process "${n.processId}" not found — falling back to "${c[0].processId}".`}),m??(m=c[0]),c.length>1&&s.push({severity:"warning",message:`Diagram has ${c.length} <bpmn:process> elements (${c.map(p=>p.processId).join(", ")}); using "${m.processId}" as the active process. Pass a processId to parseModel to target another.`}),{processes:c,diagnostics:s,processId:m.processId,processName:m.processName,tasks:m.tasks,agent:m.agents[0]??null,agents:c.flatMap(p=>p.agents),userTasks:m.userTasks,startFormId:m.startFormId}}function sr(e){return e?e.imageId?{imageId:e.imageId}:e.imageName?{imageName:e.imageName}:{}:{}}function st(e,n){return n?e.pixels:e.imageId??e.pixels}const dr="No image selected — pick or upload a photo to read.";function jn(){return dr}function cr(e,n){return async t=>{const r=e.resolve(n);if(!r)return jn();const i=st(r,e.live);if(i===void 0)return jn();try{return await e.read(i,t)}catch(s){return`Couldn't read the image (${s instanceof Error?s.message:String(s)}).`}}}function lr(e,n){return async()=>{const t=e.resolve(n);if(t)return st(t,e.live)}}function mr(){return`<!doctype html><html><head><meta charset="utf-8"></head><body><script>
    ...
    post({ kind: "ready" });
  <\/script></body></html>`}function dt(e,n={}){const{timeoutMs:t=5e3,onTrace:r,onVision:i,onImage:s}=n,c=`${Date.now()}-${Math.random().toString(36).slice(2)}`;return new Promise((m,p)=>{const o=document.createElement("iframe");o.setAttribute("sandbox","allow-scripts"),o.style.display="none",o.setAttribute("aria-hidden","true");let d=!1,g;const u=()=>{g&&clearTimeout(g),window.removeEventListener("message",f),o.remove()},_=b=>{d||(d=!0,u(),b())};function f(b){var k;if(b.source!==o.contentWindow)return;const M=b.data;if(!(!M||typeof M!="object")){if(M.kind==="ready"){const C=e.job,Q=e.kind==="run-handler"?{kind:"run-handler",id:c,source:e.source,job:C,hasVision:e.hasVision}:{kind:"run-agent",id:c,source:e.source,job:C};(k=o.contentWindow)==null||k.postMessage(Q,"*");return}"id"in M&&M.id!==c||(M.kind==="trace"?r==null||r(M.text):M.kind==="vision-request"?y(M.callId,i,"vision",M.prompt):M.kind==="image-request"?y(M.callId,s,"image"):M.kind==="result"?_(()=>m(M.value)):M.kind==="error"&&_(()=>p(new Error(M.message))))}}function y(b,M,k,...C){const Q=K=>{var me;return(me=o.contentWindow)==null?void 0:me.postMessage(K,"*")};if(!M){Q({kind:"helper-error",id:c,callId:b,message:`${k} helper is not available.`});return}Promise.resolve().then(()=>M(...C)).then(K=>Q({kind:"helper-result",id:c,callId:b,value:K}),K=>Q({kind:"helper-error",id:c,callId:b,message:K instanceof Error?K.message:String(K)}))}window.addEventListener("message",f),g=setTimeout(()=>{_(()=>p(new Error(`Handler timed out after ${t}ms — the sandboxed run was terminated.`)))},t),o.srcdoc=mr(),document.body.appendChild(o)})}function ct(e){return{key:e.key,type:e.type,elementId:e.elementId,instanceKey:e.instanceKey,variables:e.variables??{}}}function pr(e,n,t){const r=typeof t.vision=="function";return dt({kind:"run-handler",source:e,job:ct(n),hasVision:r},{onTrace:t.trace,onVision:t.vision?i=>t.vision(i):void 0,onImage:t.image?()=>t.image():void 0})}function ur(e,n){return dt({kind:"run-agent",source:e,job:ct(n)})}function lt(e,n){try{new Function(`"use strict"; return (${e});`)}catch{throw new Error(`${n} has a syntax error.`)}}function gr(e){return lt(e,"Handler code"),(n,t)=>pr(e,n,t)}function hr(e){return lt(e,"Agent code"),n=>ur(e,n)}function br(e,n,t,r){return{sleep:i=>new Promise(s=>setTimeout(s,i)),trace:i=>n({kind:"tool",text:`   ${i}`,elementId:e.elementId,turn:t}),text:(i,s="")=>{const c=e.variables[i];return typeof c=="string"?c:c==null?s:String(c)},num:(i,s=0)=>{const c=e.variables[i],m=typeof c=="number"?c:Number(c);return Number.isFinite(m)?m:s},...r?{vision:cr(r,e.instanceKey),image:lr(r,e.instanceKey)}:{}}}function fr(e){if(e===void 0)return"undefined";try{return JSON.stringify(e)}catch{return"[unserializable value]"}}function _r(e,n,t,r,i){const s={},c=e.processes.flatMap(p=>p.tasks),m=new Map(c.map(p=>[p.elementId,p.label]));for(const p of c)p.compound||s[p.jobType]||(s[p.jobType]=async o=>{const d=n[o.elementId];if(!d)throw new Error(`No handler registered for ${o.elementId} (job type ${o.type})`);const g=m.get(o.elementId)??o.elementId,u=r==null?void 0:r.current;t({kind:"tool",text:`▶ ${g}`,elementId:o.elementId,turn:u});const _=await d(o,br(o,t,u,i));return t({kind:"vars",text:`  ↳ ${fr(_)}`,elementId:o.elementId,result:_,turn:u}),_});return s}const wr=/\{\{\s*([A-Za-z][A-Za-z0-9_-]*)\s*\}\}/g;function Ve(...e){const n=Object.create(null);for(const t of e)if(t)for(const r of Object.keys(t))n[r]=t[r];return n}function mt(e){return(e.split("/").pop()??e).replace(/\.[^./]+$/,"")}function pt(e){return e.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;")}function yr(e){return pt(e).replace(/"/g,"&quot;").replace(/\n/g,"&#10;").replace(/\t/g,"&#9;")}function Mr(e){return e.replace(/\\/g,"\\\\").replace(/&/g,"&amp;").replace(/"/g,"\\&#34;").replace(/\n/g,"&#10;").replace(/\t/g,"&#9;").replace(/</g,"&lt;").replace(/>/g,"&gt;")}function vr(e){return JSON.stringify(e).slice(1,-1)}function xr(e,n){const t=e.lastIndexOf("<",n),r=e.lastIndexOf(">",n);if(t<=r)return"text";const i=e.slice(t,n);if((i.match(/"/g)??[]).length%2===0)return"text";const c=i.lastIndexOf('"');return(i.slice(c+1).match(/&#34;|&quot;/g)??[]).length%2===1?"feel-literal":"attribute"}function Nr(e,n,t="xml"){const r=[],i=new Set;return{result:e.replace(wr,(c,m,p)=>{const o=m.trim();if(!Object.prototype.hasOwnProperty.call(n,o))return i.has(o)||(i.add(o),r.push(o)),c;const d=n[o];if(t==="json")return vr(d);const g=xr(e,p);return g==="feel-literal"?Mr(d):g==="attribute"?yr(d):pt(d)}),unresolved:r}}function Er(){return{processes:[],diagnostics:[],processId:"",processName:"",tasks:[],agent:null,agents:[],userTasks:[],startFormId:void 0}}function kr(e,n={},t=e.bpmn,r={}){const i=[],s=Ve(e.templates,r),{result:c,unresolved:m}=Nr(t,s,"xml");for(const M of m)i.push({severity:"warning",message:`Template placeholder "{{${M}}}" has no matching prompt/template content — left in the model as-is, not substituted.`});let p;try{p=ar(c)}catch(M){return i.push({severity:"error",message:M instanceof Error?M.message:String(M)}),{resolvedBpmn:c,model:Er(),handlers:{},forms:{},diagnostics:i,hasErrors:!0}}i.push(...p.diagnostics);const o=p.processes.flatMap(M=>M.tasks),d=new Map(e.handlers.map(M=>[M.elementId,M.source])),g={};for(const M of o){if(M.compound)continue;const k=n[M.elementId]??d.get(M.elementId);if(k===void 0){i.push({severity:"error",elementId:M.elementId,jobType:M.jobType,message:`No handler for "${M.label}" (${M.elementId}, job type "${M.jobType}"). Add a handler for this element, or remove it from the diagram.`});continue}try{g[M.elementId]=gr(k)}catch(C){i.push({severity:"error",elementId:M.elementId,jobType:M.jobType,message:`"${M.label}" (${M.elementId}): handler code didn't compile — ${C instanceof Error?C.message:String(C)}`})}}const u=new Set(o.map(M=>M.elementId)),_=new Set([...d.keys(),...Object.keys(n)]);for(const M of _)u.has(M)||i.push({severity:"error",elementId:M,message:`Handler "${M}" doesn't match any element in the current diagram — likely orphaned by a rename. Rename it back, or remove the handler.`});const f={},y=e.forms??{},b=(M,k)=>{if(!M)return;const C=y[M];C?f[M]=C:i.push({severity:"error",formId:M,message:`${k} references form "${M}", which has no matching schema.`})};for(const M of p.processes){b(M.startFormId,`The start event of process "${M.processName}"`);for(const k of M.userTasks)b(k.formId,`User task "${k.label}" (${k.elementId})`)}return{resolvedBpmn:c,model:p,handlers:g,forms:f,diagnostics:i,hasErrors:i.some(M=>M.severity==="error")}}function Ir(e){const n=e.indexOf("{");if(n<0)return null;let t=0;for(let r=n;r<e.length;r++)if(e[r]==="{")t++;else if(e[r]==="}"&&(t--,t===0))try{const i=JSON.parse(e.slice(n,r+1));return typeof i=="object"&&i!==null&&!Array.isArray(i)?i:null}catch{return null}return null}function mn(e,n=220){const t=e.replace(/\s+/g," ").trim();return t.length>n?`${t.slice(0,n-1)}…`:t}function Sn(e){const n=e.arguments??e.args??e.parameters??e.input;return n&&typeof n=="object"&&!Array.isArray(n)?n:{}}function An(e){if(!e)return[];const n=e.tool??e.name??e.action;if(typeof n=="string"&&n.trim())return[{name:n.trim(),args:Sn(e)}];const t=e.tools??e.tool_calls??e.toolset??e.actions,r=Array.isArray(t)?t:Object.values(e).find(s=>Array.isArray(s))??[],i=[];for(const s of r)if(typeof s=="string")s.trim()&&i.push({name:s.trim(),args:{}});else if(s&&typeof s=="object"){const c=s,m=c.name??c.tool??c.id??c.function;typeof m=="string"&&m.trim()&&i.push({name:m.trim(),args:Sn(c)})}return i}function Tr(e){if(!e)return!1;const n=e.done??e.finished??e.complete;return typeof n=="boolean"?n:typeof n=="string"?n.toLowerCase()==="true":!1}function Dn(e){const n=e.args.length?e.args.map(r=>`      ${r.name} (${r.type}) — ${r.description}`).join(`
...
character, with nothing added. When your work is finished, reply exactly
{"done": true} and no tool.`}function Sr(e,n,t,r,i=[],s=[],c=!1){const m=e.userPrompt||"Carry out your task.",p=Object.entries(n).filter(([,d])=>typeof d=="string"&&d.trim().length>0).map(([d,g])=>`  ${d}: ${String(g)}`),o=[m,p.length?`Case data:
${p.join(`
...
`)}async function Ar(e,n,t,r,i,s){let c="";n({kind:"llm",text:"LLM thinking…",key:t,pending:!0,turn:s});const m=await e(r,i,p=>{c+=p,n({kind:"llm",text:`${mn(c)} ▍`,key:t,pending:!0,turn:s})});return n({kind:"llm",text:mn(m||c)||"(empty reply)",key:t,pending:!1,turn:s}),m}function Dr(e,n){switch(e){case"number":return typeof n=="number"&&Number.isFinite(n)?{ok:!0,value:n}:typeof n=="string"&&n.trim()!==""&&Number.isFinite(Number(n))?{ok:!0,value:Number(n)}:{ok:!1};case"boolean":return typeof n=="boolean"?{ok:!0,value:n}:typeof n=="string"&&/^(true|false)$/i.test(n.trim())?{ok:!0,value:n.trim().toLowerCase()==="true"}:{ok:!1};default:return typeof n=="object"?{ok:!1}:{ok:!0,value:String(n)}}}function Pr(e,n,t){const r={},i=new Map,s=new Map;for(const{tool:c,args:m}of e){const p={};for(const o of c.args){const d=m[o.name];if(!(d!=null&&d!=="")){n({kind:"error",text:`🤖 ${c.elementId}: model supplied no value for "${o.name}"`,turn:t,elementId:c.elementId});continue}const u=i.get(o.name);if(u!==void 0&&u!==c.elementId){n({kind:"error",text:`🤖 argument name collision on "${o.name}": both ${u} and ${c.elementId} declare it — ${u} already claimed it this turn, ${c.elementId}'s value is dropped`,turn:t,elementId:c.elementId});continue}const _=Dr(o.type,d);if(!_.ok){n({kind:"error",text:`🤖 ${c.elementId}: "${o.name}" is declared as ${o.type} but the model supplied ${JSON.stringify(d)} — rejected, not passed through`,turn:t,elementId:c.elementId});continue}r[o.name]=_.value,p[o.name]=_.value,i.set(o.name,c.elementId)}s.set(c.elementId,p)}return{variablesOut:r,forHistory:s}}function Cr(e,n,t,r={}){const{maxNewTokens:i=384,allowRepeats:s=!1,allowMultiToolTurns:c=!1,turnRef:m,requiredTools:p=[],maxEarlyDoneNudges:o=1}=r;let d=0;const g=new Set,u=[];let _=0,f=[],y=[];return async b=>{const M=b.variables,k=M.toolCallResult;for(k!==void 0&&u.length&&(u[u.length-1]=`${u[u.length-1]} → ${mn(JSON.stringify(k),160)}`);;){const Q=await C();if(Q)return Q}async function C(){if(d+=1,m&&(m.current=d),d>e.maxModelCalls)return t({kind:"error",text:`Turn budget spent (maxModelCalls=${e.maxModelCalls}) — completing the agent.`,turn:d}),{completionConditionFulfilled:!0};const Q=s?e.tools:e.tools.filter(D=>!g.has(D.elementId)),K=[{role:"system",content:jr(e,c,Q)},{role:"user",content:Sr(e,M,u,Q,f,y,s)}];f=[],y=[];let me;try{me=await Ar(n,t,`llm-turn-${d}`,K,i,d)}catch(D){return t({kind:"error",text:`LLM call failed: ${D instanceof Error?D.message:String(D)} — completing the agent.`,turn:d}),{completionConditionFulfilled:!0}}const J=Ir(me);if(Tr(J)&&An(J).length===0){const D=p.filter($=>!g.has($));return D.length&&_<o?(_+=1,f=D,t({kind:"agent",text:`🤖 model says it is done, but ${D.join(", ")} hasn't run — asking once more`,turn:d}),null):(t({kind:"agent",text:"🤖 model says it is done",turn:d}),{completionConditionFulfilled:!0})}const oe=An(J);if(oe.length===0)return t({kind:"error",text:"🤖 model named no tool (and didn't say it was done) — asking again",turn:d}),y=['it named no tool and did not say it was done — reply with {"tool": "...", "arguments": {...}} or {"done": true}'],null;const V=[],Y=[],N=[];for(const D of oe){const $=e.tools.find(ge=>ge.elementId===D.name);if(!$){Y.push(D.name);continue}if(!s&&g.has($.elementId)){N.push($.elementId);continue}V.push({tool:$,args:D.args})}if(Y.length&&t({kind:"error",text:`🤖 model named a tool that doesn't exist: ${Y.join(", ")} — nothing activated`,turn:d}),N.length&&t({kind:"error",text:`🤖 model asked to re-run ${N.join(", ")} — skipped (already run)`,turn:d}),V.length===0)return t({kind:"agent",text:"🤖 nothing activated — asking again",turn:d}),y=[...Y.length?[`${Y.join(", ")} ${Y.length===1?"is":"are"} not a real tool`]:[],...N.length?[`${N.join(", ")} has already run and will never run again — pick a different tool, or reply {"done": true} if nothing is left to do`]:[]],null;const{variablesOut:E,forHistory:A}=Pr(V,t,d);for(const{tool:D}of V)g.add(D.elementId),u.push(`- ${D.elementId}(${JSON.stringify(A.get(D.elementId))})`);for(const{tool:D}of V)t({kind:"agent",text:`🤖 calling ${D.elementId}`,turn:d,elementId:D.elementId,args:A.get(D.elementId)??{}});return{activateElements:V.map(D=>({elementId:D.tool.elementId})),variables:E}}}}function Lr(e,n,t,r={}){const i=new Map(e.map(s=>[s.elementId,Cr(s,n,t,r)]));return async s=>{const c=i.get(s.elementId);if(!c)throw new Error(`No agent host registered for "${s.elementId}"`);return c(s)}}class pn{__destroy_into_raw(){const n=this.__wbg_ptr;return this.__wbg_ptr=0,Pn.unregister(this),n}free(){const n=this.__destroy_into_raw();l.__wbg_testengine_free(n,0)}activateJobs(n,t,r,i){let s,c;try{const _=l.__wbindgen_add_to_stack_pointer(-16),f=S(n,l.__wbindgen_export,l.__wbindgen_export2),y=j,b=S(i,l.__wbindgen_export,l.__wbindgen_export2),M=j;l.testengine_activateJobs(_,this.__wbg_ptr,f,y,t,r,b,M);var m=w().getInt32(_+0,!0),p=w().getInt32(_+4,!0),o=w().getInt32(_+8,!0),d=w().getInt32(_+12,!0),g=m,u=p;if(d)throw g=0,u=0,z(o);return s=g,c=u,R(g,u)}finally{l.__wbindgen_add_to_stack_pointer(16),l.__wbindgen_export3(s,c,1)}}advanceTime(n){let t,r;try{const d=l.__wbindgen_add_to_stack_pointer(-16);l.testengine_advanceTime(d,this.__wbg_ptr,n);var i=w().getInt32(d+0,!0),s=w().getInt32(d+4,!0),c=w().getInt32(d+8,!0),m=w().getInt32(d+12,!0),p=i,o=s;if(m)throw p=0,o=0,z(c);return t=p,r=o,R(p,o)}finally{l.__wbindgen_add_to_stack_pointer(16),l.__wbindgen_export3(t,r,1)}}assignUserTask(n,t,r){let i,s;try{const u=l.__wbindgen_add_to_stack_pointer(-16),_=S(n,l.__wbindgen_export,l.__wbindgen_export2),f=j,y=S(t,l.__wbindgen_export,l.__wbindgen_export2),b=j;l.testengine_assignUserTask(u,this.__wbg_ptr,_,f,y,b,r);var c=w().getInt32(u+0,!0),m=w().getInt32(u+4,!0),p=w().getInt32(u+8,!0),o=w().getInt32(u+12,!0),d=c,g=m;if(o)throw d=0,g=0,z(p);return i=d,s=g,R(d,g)}finally{l.__wbindgen_add_to_stack_pointer(16),l.__wbindgen_export3(i,s,1)}}broadcastSignal(n,t){let r,i;try{const g=l.__wbindgen_add_to_stack_pointer(-16),u=S(n,l.__wbindgen_export,l.__wbindgen_export2),_=j,f=S(t,l.__wbindgen_export,l.__wbindgen_export2),y=j;l.testengine_broadcastSignal(g,this.__wbg_ptr,u,_,f,y);var s=w().getInt32(g+0,!0),c=w().getInt32(g+4,!0),m=w().getInt32(g+8,!0),p=w().getInt32(g+12,!0),o=s,d=c;if(p)throw o=0,d=0,z(m);return r=o,i=d,R(o,d)}finally{l.__wbindgen_add_to_stack_pointer(16),l.__wbindgen_export3(r,i,1)}}cancelInstance(n){let t,r;try{const d=l.__wbindgen_add_to_stack_pointer(-16),g=S(n,l.__wbindgen_export,l.__wbindgen_export2),u=j;l.testengine_cancelInstance(d,this.__wbg_ptr,g,u);var i=w().getInt32(d+0,!0),s=w().getInt32(d+4,!0),c=w().getInt32(d+8,!0),m=w().getInt32(d+12,!0),p=i,o=s;if(m)throw p=0,o=0,z(c);return t=p,r=o,R(p,o)}finally{l.__wbindgen_add_to_stack_pointer(16),l.__wbindgen_export3(t,r,1)}}completeAgentJob(n,t,r){let i,s;try{const u=l.__wbindgen_add_to_stack_pointer(-16),_=S(n,l.__wbindgen_export,l.__wbindgen_export2),f=j,y=S(t,l.__wbindgen_export,l.__wbindgen_export2),b=j,M=S(r,l.__wbindgen_export,l.__wbindgen_export2),k=j;l.testengine_completeAgentJob(u,this.__wbg_ptr,_,f,y,b,M,k);var c=w().getInt32(u+0,!0),m=w().getInt32(u+4,!0),p=w().getInt32(u+8,!0),o=w().getInt32(u+12,!0),d=c,g=m;if(o)throw d=0,g=0,z(p);return i=d,s=g,R(d,g)}finally{l.__wbindgen_add_to_stack_pointer(16),l.__wbindgen_export3(i,s,1)}}completeJob(n,t){let r,i;try{const g=l.__wbindgen_add_to_stack_pointer(-16),u=S(n,l.__wbindgen_export,l.__wbindgen_export2),_=j,f=S(t,l.__wbindgen_export,l.__wbindgen_export2),y=j;l.testengine_completeJob(g,this.__wbg_ptr,u,_,f,y);var s=w().getInt32(g+0,!0),c=w().getInt32(g+4,!0),m=w().getInt32(g+8,!0),p=w().getInt32(g+12,!0),o=s,d=c;if(p)throw o=0,d=0,z(m);return r=o,i=d,R(o,d)}finally{l.__wbindgen_add_to_stack_pointer(16),l.__wbindgen_export3(r,i,1)}}completeUserTask(n,t){let r,i;try{const g=l.__wbindgen_add_to_stack_pointer(-16),u=S(n,l.__wbindgen_export,l.__wbindgen_export2),_=j,f=S(t,l.__wbindgen_export,l.__wbindgen_export2),y=j;l.testengine_completeUserTask(g,this.__wbg_ptr,u,_,f,y);var s=w().getInt32(g+0,!0),c=w().getInt32(g+4,!0),m=w().getInt32(g+8,!0),p=w().getInt32(g+12,!0),o=s,d=c;if(p)throw o=0,d=0,z(m);return r=o,i=d,R(o,d)}finally{l.__wbindgen_add_to_stack_pointer(16),l.__wbindgen_export3(r,i,1)}}correlateMessage(n,t,r){let i,s;try{const u=l.__wbindgen_add_to_stack_pointer(-16),_=S(n,l.__wbindgen_export,l.__wbindgen_export2),f=j,y=S(t,l.__wbindgen_export,l.__wbindgen_export2),b=j,M=S(r,l.__wbindgen_export,l.__wbindgen_export2),k=j;l.testengine_correlateMessage(u,this.__wbg_ptr,_,f,y,b,M,k);var c=w().getInt32(u+0,!0),m=w().getInt32(u+4,!0),p=w().getInt32(u+8,!0),o=w().getInt32(u+12,!0),d=c,g=m;if(o)throw d=0,g=0,z(p);return i=d,s=g,R(d,g)}finally{l.__wbindgen_add_to_stack_pointer(16),l.__wbindgen_export3(i,s,1)}}createInstance(n,t,r){let i,s;try{const u=l.__wbindgen_add_to_stack_pointer(-16),_=S(n,l.__wbindgen_export,l.__wbindgen_export2),f=j,y=S(t,l.__wbindgen_export,l.__wbindgen_export2),b=j;l.testengine_createInstance(u,this.__wbg_ptr,_,f,y,b,Fr(r)?Number.MAX_SAFE_INTEGER:r>>0);var c=w().getInt32(u+0,!0),m=w().getInt32(u+4,!0),p=w().getInt32(u+8,!0),o=w().getInt32(u+12,!0),d=c,g=m;if(o)throw d=0,g=0,z(p);return i=d,s=g,R(d,g)}finally{l.__wbindgen_add_to_stack_pointer(16),l.__wbindgen_export3(i,s,1)}}debugClear(){l.testengine_debugClear(this.__wbg_ptr)}debugCreateInstance(n,t,r){let i,s;try{const u=l.__wbindgen_add_to_stack_pointer(-16),_=S(n,l.__wbindgen_export,l.__wbindgen_export2),f=j,y=S(t,l.__wbindgen_export,l.__wbindgen_export2),b=j,M=S(r,l.__wbindgen_export,l.__wbindgen_export2),k=j;l.testengine_debugCreateInstance(u,this.__wbg_ptr,_,f,y,b,M,k);var c=w().getInt32(u+0,!0),m=w().getInt32(u+4,!0),p=w().getInt32(u+8,!0),o=w().getInt32(u+12,!0),d=c,g=m;if(o)throw d=0,g=0,z(p);return i=d,s=g,R(d,g)}finally{l.__wbindgen_add_to_stack_pointer(16),l.__wbindgen_export3(i,s,1)}}get debugIsPaused(){return l.testengine_debugIsPaused(this.__wbg_ptr)!==0}debugResume(){let n,t;try{const o=l.__wbindgen_add_to_stack_pointer(-16);l.testengine_debugResume(o,this.__wbg_ptr);var r=w().getInt32(o+0,!0),i=w().getInt32(o+4,!0),s=w().getInt32(o+8,!0),c=w().getInt32(o+12,!0),m=r,p=i;if(c)throw m=0,p=0,z(s);return n=m,t=p,R(m,p)}finally{l.__wbindgen_add_to_stack_pointer(16),l.__wbindgen_export3(n,t,1)}}debugStep(){let n,t;try{const o=l.__wbindgen_add_to_stack_pointer(-16);l.testengine_debugStep(o,this.__wbg_ptr);var r=w().getInt32(o+0,!0),i=w().getInt32(o+4,!0),s=w().getInt32(o+8,!0),c=w().getInt32(o+12,!0),m=r,p=i;if(c)throw m=0,p=0,z(s);return n=m,t=p,R(m,p)}finally{l.__wbindgen_add_to_stack_pointer(16),l.__wbindgen_export3(n,t,1)}}deploy(n){let t,r;try{const d=l.__wbindgen_add_to_stack_pointer(-16),g=S(n,l.__wbindgen_export,l.__wbindgen_export2),u=j;l.testengine_deploy(d,this.__wbg_ptr,g,u);var i=w().getInt32(d+0,!0),s=w().getInt32(d+4,!0),c=w().getInt32(d+8,!0),m=w().getInt32(d+12,!0),p=i,o=s;if(m)throw p=0,o=0,z(c);return t=p,r=o,R(p,o)}finally{l.__wbindgen_add_to_stack_pointer(16),l.__wbindgen_export3(t,r,1)}}deployForm(n){let t,r;try{const d=l.__wbindgen_add_to_stack_pointer(-16),g=S(n,l.__wbindgen_export,l.__wbindgen_export2),u=j;l.testengine_deployForm(d,this.__wbg_ptr,g,u);var i=w().getInt32(d+0,!0),s=w().getInt32(d+4,!0),c=w().getInt32(d+8,!0),m=w().getInt32(d+12,!0),p=i,o=s;if(m)throw p=0,o=0,z(c);return t=p,r=o,R(p,o)}finally{l.__wbindgen_add_to_stack_pointer(16),l.__wbindgen_export3(t,r,1)}}deployResource(n,t){let r,i;try{const g=l.__wbindgen_add_to_stack_pointer(-16),u=S(n,l.__wbindgen_export,l.__wbindgen_export2),_=j,f=S(t,l.__wbindgen_export,l.__wbindgen_export2),y=j;l.testengine_deployResource(g,this.__wbg_ptr,u,_,f,y);var s=w().getInt32(g+0,!0),c=w().getInt32(g+4,!0),m=w().getInt32(g+8,!0),p=w().getInt32(g+12,!0),o=s,d=c;if(p)throw o=0,d=0,z(m);return r=o,i=d,R(o,d)}finally{l.__wbindgen_add_to_stack_pointer(16),l.__wbindgen_export3(r,i,1)}}events(){let n,t;try{const o=l.__wbindgen_add_to_stack_pointer(-16);l.testengine_events(o,this.__wbg_ptr);var r=w().getInt32(o+0,!0),i=w().getInt32(o+4,!0),s=w().getInt32(o+8,!0),c=w().getInt32(o+12,!0),m=r,p=i;if(c)throw m=0,p=0,z(s);return n=m,t=p,R(m,p)}finally{l.__wbindgen_add_to_stack_pointer(16),l.__wbindgen_export3(n,t,1)}}failJob(n,t,r){let i,s;try{const u=l.__wbindgen_add_to_stack_pointer(-16),_=S(n,l.__wbindgen_export,l.__wbindgen_export2),f=j,y=S(r,l.__wbindgen_export,l.__wbindgen_export2),b=j;l.testengine_failJob(u,this.__wbg_ptr,_,f,t,y,b);var c=w().getInt32(u+0,!0),m=w().getInt32(u+4,!0),p=w().getInt32(u+8,!0),o=w().getInt32(u+12,!0),d=c,g=m;if(o)throw d=0,g=0,z(p);return i=d,s=g,R(d,g)}finally{l.__wbindgen_add_to_stack_pointer(16),l.__wbindgen_export3(i,s,1)}}migrate(n,t,r){let i,s;try{const u=l.__wbindgen_add_to_stack_pointer(-16),_=S(n,l.__wbindgen_export,l.__wbindgen_export2),f=j,y=S(t,l.__wbindgen_export,l.__wbindgen_export2),b=j,M=S(r,l.__wbindgen_export,l.__wbindgen_export2),k=j;l.testengine_migrate(u,this.__wbg_ptr,_,f,y,b,M,k);var c=w().getInt32(u+0,!0),m=w().getInt32(u+4,!0),p=w().getInt32(u+8,!0),o=w().getInt32(u+12,!0),d=c,g=m;if(o)throw d=0,g=0,z(p);return i=d,s=g,R(d,g)}finally{l.__wbindgen_add_to_stack_pointer(16),l.__wbindgen_export3(i,s,1)}}modify(n,t,r){let i,s;try{const u=l.__wbindgen_add_to_stack_pointer(-16),_=S(n,l.__wbindgen_export,l.__wbindgen_export2),f=j,y=S(t,l.__wbindgen_export,l.__wbindgen_export2),b=j,M=S(r,l.__wbindgen_export,l.__wbindgen_export2),k=j;l.testengine_modify(u,this.__wbg_ptr,_,f,y,b,M,k);var c=w().getInt32(u+0,!0),m=w().getInt32(u+4,!0),p=w().getInt32(u+8,!0),o=w().getInt32(u+12,!0),d=c,g=m;if(o)throw d=0,g=0,z(p);return i=d,s=g,R(d,g)}finally{l.__wbindgen_add_to_stack_pointer(16),l.__wbindgen_export3(i,s,1)}}constructor(){const n=l.testengine_new();return this.__wbg_ptr=n,Pn.register(this,this.__wbg_ptr,this),this}get now(){return l.testengine_now(this.__wbg_ptr)}reset(){l.testengine_reset(this.__wbg_ptr)}resolveIncident(n){let t,r;try{const d=l.__wbindgen_add_to_stack_pointer(-16),g=S(n,l.__wbindgen_export,l.__wbindgen_export2),u=j;l.testengine_resolveIncident(d,this.__wbg_ptr,g,u);var i=w().getInt32(d+0,!0),s=w().getInt32(d+4,!0),c=w().getInt32(d+8,!0),m=w().getInt32(d+12,!0),p=i,o=s;if(m)throw p=0,o=0,z(c);return t=p,r=o,R(p,o)}finally{l.__wbindgen_add_to_stack_pointer(16),l.__wbindgen_export3(t,r,1)}}setVariables(n,t,r){let i,s;try{const u=l.__wbindgen_add_to_stack_pointer(-16),_=S(n,l.__wbindgen_export,l.__wbindgen_export2),f=j,y=S(t,l.__wbindgen_export,l.__wbindgen_export2),b=j;l.testengine_setVariables(u,this.__wbg_ptr,_,f,y,b,r);var c=w().getInt32(u+0,!0),m=w().getInt32(u+4,!0),p=w().getInt32(u+8,!0),o=w().getInt32(u+12,!0),d=c,g=m;if(o)throw d=0,g=0,z(p);return i=d,s=g,R(d,g)}finally{l.__wbindgen_add_to_stack_pointer(16),l.__wbindgen_export3(i,s,1)}}snapshot(){let n,t;try{const o=l.__wbindgen_add_to_stack_pointer(-16);l.testengine_snapshot(o,this.__wbg_ptr);var r=w().getInt32(o+0,!0),i=w().getInt32(o+4,!0),s=w().getInt32(o+8,!0),c=w().getInt32(o+12,!0),m=r,p=i;if(c)throw m=0,p=0,z(s);return n=m,t=p,R(m,p)}finally{l.__wbindgen_add_to_stack_pointer(16),l.__wbindgen_export3(n,t,1)}}throwError(n,t,r){let i,s;try{const u=l.__wbindgen_add_to_stack_pointer(-16),_=S(n,l.__wbindgen_export,l.__wbindgen_export2),f=j,y=S(t,l.__wbindgen_export,l.__wbindgen_export2),b=j,M=S(r,l.__wbindgen_export,l.__wbindgen_export2),k=j;l.testengine_throwError(u,this.__wbg_ptr,_,f,y,b,M,k);var c=w().getInt32(u+0,!0),m=w().getInt32(u+4,!0),p=w().getInt32(u+8,!0),o=w().getInt32(u+12,!0),d=c,g=m;if(o)throw d=0,g=0,z(p);return i=d,s=g,R(d,g)}finally{l.__wbindgen_add_to_stack_pointer(16),l.__wbindgen_export3(i,s,1)}}tickNow(n){let t,r;try{const d=l.__wbindgen_add_to_stack_pointer(-16);l.testengine_tickNow(d,this.__wbg_ptr,n);var i=w().getInt32(d+0,!0),s=w().getInt32(d+4,!0),c=w().getInt32(d+8,!0),m=w().getInt32(d+12,!0),p=i,o=s;if(m)throw p=0,o=0,z(c);return t=p,r=o,R(p,o)}finally{l.__wbindgen_add_to_stack_pointer(16),l.__wbindgen_export3(t,r,1)}}unassignUserTask(n){let t,r;try{const d=l.__wbindgen_add_to_stack_pointer(-16),g=S(n,l.__wbindgen_export,l.__wbindgen_export2),u=j;l.testengine_unassignUserTask(d,this.__wbg_ptr,g,u);var i=w().getInt32(d+0,!0),s=w().getInt32(d+4,!0),c=w().getInt32(d+8,!0),m=w().getInt32(d+12,!0),p=i,o=s;if(m)throw p=0,o=0,z(c);return t=p,r=o,R(p,o)}finally{l.__wbindgen_add_to_stack_pointer(16),l.__wbindgen_export3(t,r,1)}}updateRetries(n,t){let r,i;try{const g=l.__wbindgen_add_to_stack_pointer(-16),u=S(n,l.__wbindgen_export,l.__wbindgen_export2),_=j;l.testengine_updateRetries(g,this.__wbg_ptr,u,_,t);var s=w().getInt32(g+0,!0),c=w().getInt32(g+4,!0),m=w().getInt32(g+8,!0),p=w().getInt32(g+12,!0),o=s,d=c;if(p)throw o=0,d=0,z(m);return r=o,i=d,R(o,d)}finally{l.__wbindgen_add_to_stack_pointer(16),l.__wbindgen_export3(r,i,1)}}updateUserTask(n,t){let r,i;try{const g=l.__wbindgen_add_to_stack_pointer(-16),u=S(n,l.__wbindgen_export,l.__wbindgen_export2),_=j,f=S(t,l.__wbindgen_export,l.__wbindgen_export2),y=j;l.testengine_updateUserTask(g,this.__wbg_ptr,u,_,f,y);var s=w().getInt32(g+0,!0),c=w().getInt32(g+4,!0),m=w().getInt32(g+8,!0),p=w().getInt32(g+12,!0),o=s,d=c;if(p)throw o=0,d=0,z(m);return r=o,i=d,R(o,d)}finally{l.__wbindgen_add_to_stack_pointer(16),l.__wbindgen_export3(r,i,1)}}}Symbol.dispose&&(pn.prototype[Symbol.dispose]=pn.prototype.free);function Br(){return{__proto__:null,"./nanobpmn_engine_bg.js":{__proto__:null,__wbg___wbindgen_throw_bb96b2010945f0bc:function(n,t){throw new Error(R(n,t))},__wbindgen_cast_0000000000000001:function(n,t){const r=R(n,t);return Rr(r)},__wbindgen_object_drop_ref:function(n){z(n)}}}}const Pn=typeof FinalizationRegistry>"u"?{register:()=>{},unregister:()=>{}}:new FinalizationRegistry(e=>l.__wbg_testengine_free(e,1));function Rr(e){$e===ye.length&&ye.push(ye.length+1);const n=$e;return $e=ye[n],ye[n]=e,n}function zr(e){e<1028||(ye[e]=$e,$e=e)}let De=null;function w(){return(De===null||De.buffer.detached===!0||De.buffer.detached===void 0&&De.buffer!==l.memory.buffer)&&(De=new DataView(l.memory.buffer)),De}function R(e,n){return $r(e>>>0,n)}let Ue=null;function Ke(){return(Ue===null||Ue.byteLength===0)&&(Ue=new Uint8Array(l.memory.buffer)),Ue}function Or(e){return ye[e]}let ye=new Array(1024).fill(void 0);ye.push(void 0,null,!0,!1);let $e=ye.length;function Fr(e){return e==null}function S(e,n,t){if(t===void 0){const m=Ge.encode(e),p=n(m.length,1)>>>0;return Ke().subarray(p,p+m.length).set(m),j=m.length,p}let r=e.length,i=n(r,1)>>>0;const s=Ke();let c=0;for(;c<r;c++){const m=e.charCodeAt(c);if(m>127)break;s[i+c]=m}if(c!==r){c!==0&&(e=e.slice(c)),i=t(i,r,r=c+e.length*3,1)>>>0;const m=Ke().subarray(i+c,i+r),p=Ge.encodeInto(e,m);c+=p.written,i=t(i,r,c,1)>>>0}return j=c,i}function z(e){const n=Or(e);return zr(e),n}let Xe=new TextDecoder("utf-8",{ignoreBOM:!0,fatal:!0});Xe.decode();const Ur=2146435072;let on=0;function $r(e,n){return on+=n,on>=Ur&&(Xe=new TextDecoder("utf-8",{ignoreBOM:!0,fatal:!0}),Xe.decode(),on=n),Xe.decode(Ke().subarray(e,e+n))}const Ge=new TextEncoder;"encodeInto"in Ge||(Ge.encodeInto=function(e,n){const t=Ge.encode(e);return n.set(t),{read:e.length,written:t.length}});let j=0,l;function Gr(e,n){return l=e.exports,De=null,Ue=null,l}async function Vr(e,n){if(typeof Response=="function"&&e instanceof Response){if(!e.ok)throw new Error(`failed to fetch Wasm: ${e.status} ${e.statusText} fetching '${e.url}'`);if(typeof WebAssembly.instantiateStreaming=="function")try{return await WebAssembly.instantiateStreaming(e,n)}catch(i){if(t(e.type)&&e.headers.get("Content-Type")!=="application/wasm")console.warn("`WebAssembly.instantiateStreaming` failed because your server does not serve Wasm with `application/wasm` MIME type. Falling back to `WebAssembly.instantiate` which is slower. Original error:\n",i);else throw i}const r=await e.arrayBuffer();return await WebAssembly.instantiate(r,n)}else{const r=await WebAssembly.instantiate(e,n);return r instanceof WebAssembly.Instance?{instance:r,module:e}:r}function t(r){switch(r){case"basic":case"cors":case"default":return!0}return!1}}async function Yr(e){if(l!==void 0)return l;e!==void 0&&(Object.getPrototypeOf(e)===Object.prototype?{module_or_path:e}=e:console.warn("using deprecated parameters for the initialization function; pass a single object instead")),e===void 0&&(e=new URL("/pr-preview/pr-94/assets/nanobpmn_engine_bg-DRNrIVE8.wasm",import.meta.url));const n=Br();(typeof e=="string"||typeof Request=="function"&&e instanceof Request||typeof URL=="function"&&e instanceof URL)&&(e=fetch(e));const{instance:t,module:r}=await Vr(await e,n);return Gr(t)}let He=null;function Qr(e){return He||(He=Yr(void 0).then(()=>{}).catch(n=>{throw He=null,n})),He}function Z(e){return JSON.parse(e)}class Jr{constructor(n){F(this,"engine");this.engine=n}deploy(n){return JSON.parse(this.engine.deploy(n))}createInstance(n,t){return Z(this.engine.createInstance(n,t||"{}"))}activateJobs(n,t,r,i){return JSON.parse(this.engine.activateJobs(n,t,r,i))}completeJob(n,t){return Z(this.engine.completeJob(n,t||"{}"))}completeAgentJob(n,t){const{variables:r,...i}=t??{};return Z(this.engine.completeAgentJob(n,JSON.stringify(r??{}),JSON.stringify(i??{})))}failJob(n,t,r){return Z(this.engine.failJob(n,t,r))}throwError(n,t,r){return Z(this.engine.throwError(n,t,r))}updateRetries(n,t){return Z(this.engine.updateRetries(n,t))}resolveIncident(n){return Z(this.engine.resolveIncident(n))}setVariables(n,t,r){return Z(this.engine.setVariables(n,t||"{}",r))}broadcastSignal(n,t){return Z(this.engine.broadcastSignal(n,t||"{}"))}cancelInstance(n){return Z(this.engine.cancelInstance(n))}modify(n,t,r){return Z(this.engine.modify(n,JSON.stringify(t??[]),JSON.stringify(r??[])))}completeUserTask(n,t){return Z(this.engine.completeUserTask(n,t||"{}"))}assignUserTask(n,t,r){return Z(this.engine.assignUserTask(n,t,r))}unassignUserTask(n){return Z(this.engine.unassignUserTask(n))}updateUserTask(n,t){return Z(this.engine.updateUserTask(n,t||"{}"))}correlateMessage(n,t,r){return Z(this.engine.correlateMessage(n,t,r||"{}"))}advanceTime(n){return Z(this.engine.advanceTime(n))}reset(){this.engine.reset()}events(){return JSON.parse(this.engine.events())}snapshot(){return Z(this.engine.snapshot())}free(){this.engine.free()}}async function qr(e){return await Qr(),new Jr(new pn)}class ut extends Error{constructor(t,r){super(t);F(this,"retries");this.name="JobFailure",this.retries=r==null?void 0:r.retries}}function Hr(e,n=[]){if(e.instances.filter(i=>!i.completed).length===0)return e.totalInstances>0?"completed":"idle";if(e.incidents.length>0)return"incidents";const r=new Set(n);return e.jobs.some(i=>!r.has(i.jobType))?"unhandledJobs":e.userTasks.some(i=>i.state==="Created")?"userTasks":e.timers.length>0?"timers":e.messageSubscriptions.length>0?"messages":e.signalSubscriptions.length>0?"signals":"idle"}function Wr(e,n=[]){const t=new Set(n);return[...new Set(e.jobs.map(r=>r.jobType))].filter(r=>!t.has(r)).sort()}async function Zr(e,n,t){let r;try{const i=await n(t);r=JSON.stringify(i??{})}catch(i){const s=i instanceof ut&&i.retries!==void 0?i.retries:Math.max(0,t.retries-1),c=i instanceof Error?i.message:String(i);e.failJob(t.key,s,c);return}e.completeJob(t.key,r)}async function Kr(e,n,t){let r;try{r=await n(t),JSON.stringify(r)}catch(i){const s=i instanceof ut&&i.retries!==void 0?i.retries:Math.max(0,t.retries-1),c=i instanceof Error?i.message:String(i);e.failJob(t.key,s,c);return}e.completeAgentJob(t.key,r)}async function Xr(e,n,t={}){const r=t.maxJobsPerActivation??10,i=t.lockTimeoutMs??3e4,s=t.worker??"bojtos",c=t.agents??{};for(const u of Object.keys(c))if(u in n)throw new Error(`dispatchRound: job type "${u}" is registered as both a worker and an agent — register it as exactly one`);const m=[];for(const[u,_]of Object.entries(n))for(const f of e.activateJobs(u,r,i,s))m.push({handler:_,job:f});const p=[];for(const[u,_]of Object.entries(c))for(const f of e.activateJobs(u,r,i,s))p.push({handler:_,job:f});for(const{handler:u,job:_}of m)await Zr(e,u,_);for(const{handler:u,job:_}of p)await Kr(e,u,_);const o=e.snapshot(),d=m.length+p.length;if(d>0)return{snapshot:o,handled:d};const g=[...Object.keys(n),...Object.keys(c)];return{snapshot:o,handled:d,reason:Hr(o,g),unhandled:Wr(o,g)}}function ei({bpmn:e}){const n=h.useRef(null),[t,r]=h.useState("loading"),[i,s]=h.useState(null),[c,m]=h.useState([]),[p,o]=h.useState(null),d=h.useRef(e),g=h.useRef(0),u=h.useRef(new Map),_=h.useCallback((N,E)=>{u.current.set(N,E)},[]),f=h.useCallback(N=>u.current.get(N),[]),y=h.useCallback((N,E)=>{const A=N.deploy(E);return d.current=E,u.current.clear(),m(A.processIds),o(null),s(null),A.processIds},[]);h.useEffect(()=>{let N=!1;return r("loading"),m([]),o(null),s(null),qr().then(E=>{if(N){E.free();return}try{y(E,e)}catch(A){E.free(),s(String(A)),r("error");return}n.current=E,r("ready")}).catch(E=>{N||(s(String(E)),r("error"))}),()=>{var E;N=!0,(E=n.current)==null||E.free(),n.current=null,u.current.clear()}},[e]);const b=h.useCallback(N=>{const E=n.current;if(!E)return null;try{const A=N(E);return o(A),s(null),A}catch(A){return s(String(A)),null}},[]),M=h.useCallback((N,E)=>b(A=>A.createInstance(N,E)),[b]),k=h.useCallback((N,E)=>b(A=>A.completeUserTask(N,E)),[b]),C=h.useCallback(N=>b(E=>E.advanceTime(N)),[b]);function Q(N,E){const[A]=N.activateJobs(E,1,3e4,"manual-control");if(!A)throw new Error(`No waiting job of type "${E}" to resolve.`);return A}const K=h.useCallback((N,E)=>b(A=>{const D=Q(A,N);return A.completeJob(D.key,E)}),[b]),me=h.useCallback((N,E,A)=>b(D=>{const $=Q(D,N);return D.throwError($.key,E,A)}),[b]),J=h.useCallback((N,E,A)=>b(D=>D.correlateMessage(N,E,A)),[b]),oe=h.useCallback(async(N,E)=>{const A=n.current;if(!A)return null;const D=g.current;try{const $=await Xr(A,N,E);return n.current!==A||g.current!==D?null:(o($.snapshot),s(null),$)}catch($){return n.current!==A||g.current!==D||(o(A.snapshot()),s(String($))),null}},[]),V=h.useCallback(()=>{const N=n.current;if(N){g.current++;try{N.reset(),y(N,d.current)}catch(E){s(String(E))}}},[y]),Y=h.useCallback(N=>{const E=n.current;if(!E)return null;g.current++;try{return E.reset(),y(E,N)}catch(A){return s(String(A)),null}},[y]);return{phase:t,error:i,processIds:c,snapshot:p,createInstance:M,stepWorkers:oe,completeUserTask:k,advanceTime:C,completeJobManually:K,throwJobError:me,correlateMessage:J,reset:V,redeploy:Y,setRunImage:_,getRunImage:f}}function ni(e,n){return e.slice(n)}function ti(e,n,t,r){const i=e.snapshot,s="⏸ waiting for a human — complete the task below to continue",c=i.userTasks.some(m=>m.state==="Created");if(e.handled>0){const m=i.activeElementIds.map(t),p=n.length?` via ${n.map(o=>`${t(o.from)} → ${t(o.to)}`).join(", ")}`:"";return i.completedInstances>=1?{kind:"done",text:`⏭ round handled ${e.handled} job${e.handled===1?"":"s"}${p} — ✅ process instance completed`}:c?{kind:"human",text:`⏭ round handled ${e.handled} job${e.handled===1?"":"s"}${p} — ${s}`}:{kind:"step",text:`⏭ round handled ${e.handled} job${e.handled===1?"":"s"}${p} — now at ${m.length?m.join(", "):"—"}`}}switch(e.reason){case"completed":return{kind:"done",text:"✅ process instance completed"};case"userTasks":return{kind:"human",text:s};case"timers":return{kind:"step",text:"⏱ waiting on a timer — advance the clock to continue"};case"messages":return{kind:"step",text:"✉ waiting on a message — correlate it to continue"};case"signals":return{kind:"step",text:"📶 waiting on a signal — broadcast it to continue"};case"incidents":return{kind:"error",text:"A job failed — incident on the diagram"};case"unhandledJobs":{const m=e.unhandled??[];return r&&m.length>0&&m.every(p=>r.has(p))?{kind:"human",text:s}:{kind:"error",text:`⏭ waiting on job type(s) with no worker registered: ${m.join(", ")}`}}case"idle":return{kind:"step",text:"Nothing to step — no instance is running."};default:return{kind:"step",text:e.reason?`Step blocked on an unrecognized reason: ${e.reason}`:"Nothing to step — no instance is running."}}}const ri="the Scripted or Endpoint brain";async function ii(){return await Ye()===null}async function Ye(e=ri){const n=navigator.gpu;if(!n)return`This browser doesn't expose WebGPU at all. Use a recent Chrome, Edge, or Safari 17+ with hardware acceleration on, or pick ${e}.`;let t;try{t=await n.requestAdapter()}catch(r){return`WebGPU adapter request failed (${r instanceof Error?r.message:String(r)}). Try ${e} instead.`}return t?null:`This browser supports the WebGPU API, but no GPU adapter is available — hardware acceleration may be off, or this device/VM has no usable GPU. Pick ${e} instead.`}const oi=[{id:"Qwen2.5-1.5B-Instruct-q4f16_1-MLC",label:"Qwen2.5 1.5B",downloadLabel:"~1.0 GB"},{id:"SmolLM2-1.7B-Instruct-q4f16_1-MLC",label:"SmolLM2 1.7B",downloadLabel:"~1.1 GB"},{id:"Llama-3.2-1B-Instruct-q4f16_1-MLC",label:"Llama 3.2 1B",downloadLabel:"~0.7 GB"},{id:"gemma-2-2b-it-q4f16_1-MLC",label:"Gemma 2 2B",downloadLabel:"~1.5 GB"},{id:"Llama-3.2-1B-Instruct-q4f32_1-MLC",label:"Llama 3.2 1B (f32, wider GPU support)",downloadLabel:"~1.1 GB"},{id:"SmolLM2-360M-Instruct-q4f32_1-MLC",label:"SmolLM2 360M (tiny, f32)",downloadLabel:"~0.6 GB"},{id:"SmolLM2-360M-Instruct-q4f16_1-MLC",label:"SmolLM2 360M (tiny)",downloadLabel:"~0.3 GB"}];function gt(e){return un.get(e)??{}}const un=new Map;async function ai(){if(un.size>0)return;const{prebuiltAppConfig:e}=await le(async()=>{const{prebuiltAppConfig:n}=await import("./vendor-webllm-DT0Ab8E6.js");return{prebuiltAppConfig:n}},[]);for(const n of e.model_list)un.set(n.model_id,{vramRequiredMB:n.vram_required_MB,requiredFeatures:n.required_features})}const nn=oi.map(e=>({id:e.id,label:`${e.label} (${e.downloadLabel})`,downloadLabel:e.downloadLabel,...gt(e.id)})),ht=nn[0].id;async function si(){return await ai(),nn.map(e=>({...e,...gt(e.id)}))}function bt(){const e=navigator.deviceMemory;return typeof e=="number"?e*1024:null}function di(e,n=bt()){return n==null||e.vramRequiredMB==null||n>=e.vramRequiredMB?null:`${e.label} needs roughly ${Math.round(e.vramRequiredMB)} MB of GPU memory; this device looks like it has about ${Math.round(n)} MB available. It may still work, but expect it to fail or fall back to slow shared memory — try a smaller model (e.g. SmolLM2 360M) if it doesn't load.`}async function ci(e){try{const{hasModelInCache:n}=await le(async()=>{const{hasModelInCache:t}=await import("./vendor-webllm-DT0Ab8E6.js");return{hasModelInCache:t}},[]);return await n(e)}catch{return!1}}function en(e){return/device (was )?lost|device_hung|device_removed|already been disposed|gpudevicelostinfo/i.test(e)}function Cn(){return"The GPU device was lost — the driver reset while the model was loading or running. This is a browser/driver-level failure, not a problem with the model: fully quit and reopen the browser (a lost device usually persists for the life of the GPU process), check chrome://gpu still reports hardware acceleration, and update your GPU driver if it recurs. The Scripted and Endpoint brains don't use the GPU at all."}class We{constructor(){F(this,"kind","browser");F(this,"model",null);F(this,"engine",null);F(this,"worker",null);F(this,"generation",0);F(this,"chat",async(n,t=512,r)=>{var s,c;const i=this.engine;if(!i||!this.model)throw new Error("BrowserBrain.chat called before connect()");try{const m=await i.chat.completions.create({messages:n,temperature:0,max_tokens:t,stream:!0});let p="";for await(const o of m){const d=((c=(s=o.choices[0])==null?void 0:s.delta)==null?void 0:c.content)??"";d&&(p+=d,r==null||r(d))}return p}catch(m){const p=m instanceof Error?m.message:String(m);throw en(p)?(this.teardown(),new Error(`The in-browser model stopped: ${Cn()}`)):m}})}async connect(n=ht,t){var p,o;const r=await Ye();if(r)throw new Error(r);if(this.engine&&this.model===n)return n;const i=++this.generation,s=d=>{i===this.generation&&(t==null||t({progress:d.progress??0,text:d.text??""}))};this.teardown();let c,m;try{const{CreateWebWorkerMLCEngine:d}=await le(async()=>{const{CreateWebWorkerMLCEngine:g}=await import("./vendor-webllm-DT0Ab8E6.js");return{CreateWebWorkerMLCEngine:g}},[]);m=new Worker(new URL("/pr-preview/pr-94/assets/webllm.worker-Dc1cCqhL.js",import.meta.url),{type:"module"}),c=await d(m,n,{initProgressCallback:s})}catch(d){if(m==null||m.terminate(),i!==this.generation)throw new Error("cancelled");const g=d instanceof Error?d.message:String(d);if(en(g))throw new Error(`Couldn't load ${n} in the browser (${g}). ${Cn()}`);const u=(o=(p=nn.find(_=>_.id===n))==null?void 0:p.requiredFeatures)==null?void 0:o.includes("shader-f16");throw new Error(`Couldn't load ${n} in the browser (${g}). `+(u?"This model needs WebGPU with shader-f16; try one of the f32 models in the list, or the endpoint brain.":"Try a smaller model, check your connection, or use the endpoint brain instead."))}if(i!==this.generation)throw c.unload().catch(()=>{}),m==null||m.terminate(),new Error("cancelled");return this.engine=c,this.worker=m??null,this.model=n,n}teardown(){const{engine:n,worker:t}=this;this.engine=null,this.worker=null,this.model=null,n==null||n.unload().catch(()=>{}),t==null||t.terminate()}cancelConnect(){this.generation++}dispose(){this.generation++,this.teardown()}}const ft="http://localhost:11434/v1";function _t(){var n;const e=((n=globalThis.location)==null?void 0:n.hostname)??"";return e==="localhost"||e==="127.0.0.1"||e==="[::1]"||e==="::1"}function bn(e,n={hostname:(t=>(t=globalThis.location)==null?void 0:t.hostname)()??"",origin:(r=>(r=globalThis.location)==null?void 0:r.origin)()??""}){let i;try{i=new URL(wt(e)).hostname}catch{return null}const s=c=>c==="localhost"||c==="127.0.0.1"||c==="::1"||c==="[::1]";return!s(i)||s(n.hostname)?null:`This page is served from ${n.origin||"a non-local origin"}, so it can't reach ${e}. A local model server only accepts requests from a page on localhost. Open this page at http://localhost instead, or use the Scripted or In-browser brain.`}function wt(e){let n=e.trim().replace(/\/+$/,"");return n.endsWith("/chat/completions")&&(n=n.slice(0,-17)),/\/v\d+$/.test(n)||(n=`${n}/v1`),n}class Ln extends Error{constructor(n,t){super(n),this.status=t,this.name="HttpError"}}class li{constructor(n=ft,t="",r=""){F(this,"kind","endpoint");F(this,"baseUrl");F(this,"model",null);F(this,"models",[]);F(this,"apiKey");F(this,"requestedModel");F(this,"chat",async(n,t=512,r)=>{var o,d,g;if(!this.model)throw new Error("EndpointBrain.chat called before connect()");const i=await fetch(`${this.baseUrl}/chat/completions`,{method:"POST",headers:this.headers(),body:JSON.stringify({model:this.model,messages:n,temperature:0,max_tokens:t,stream:!0})});if(!i.ok||!i.body){const u=await i.text().catch(()=>"");throw new Error(`chat/completions HTTP ${i.status} ${i.statusText}${u?` — ${u.slice(0,300)}`:""}`)}const s=i.body.getReader(),c=new TextDecoder;let m="",p="";for(;;){const{value:u,done:_}=await s.read();if(_)break;m+=c.decode(u,{stream:!0});let f;for(;(f=m.indexOf(`
`))>=0;){const y=m.slice(0,f).trim();if(m=m.slice(f+1),!y.startsWith("data:"))continue;const b=y.slice(5).trim();if(b==="[DONE]")continue;let M;try{M=JSON.parse(b)}catch{continue}M.model&&(this.model=M.model);const k=(o=M.choices)==null?void 0:o[0],C=((d=k==null?void 0:k.delta)==null?void 0:d.content)??((g=k==null?void 0:k.message)==null?void 0:g.content)??"";C&&(p+=C,r==null||r(C))}}return p});this.baseUrl=wt(n),this.apiKey=t.trim(),this.requestedModel=r.trim()}headers(){const n={"Content-Type":"application/json"};return this.apiKey&&(n.Authorization=`Bearer ${this.apiKey}`),n}async listModels(){let n;try{n=await fetch(`${this.baseUrl}/models`,{headers:this.headers()})}catch(r){const i=bn(this.baseUrl);throw new Error(i??`Can't reach ${this.baseUrl} (${r instanceof Error?r.message:String(r)}). Is the server running? For Ollama, check the app is up — and if this page is served from another origin, allow it with OLLAMA_ORIGINS.`)}if(!n.ok)throw new Ln(`${this.baseUrl}/models returned HTTP ${n.status} ${n.statusText}`,n.status);const t=await n.json();return this.models=(t.data??[]).map(r=>r.id).filter(r=>!!r),this.models}async connect(){try{const n=await this.listModels(),t=this.requestedModel||n[0];if(!t)throw new Error(`No models available at ${this.baseUrl}. Pull one first — e.g. \`ollama pull llama3.2:3b\` — or name one explicitly.`);this.model=t}catch(n){const t=n instanceof Ln&&[404,405,501].includes(n.status);if(!this.requestedModel||!t)throw n;this.models=[],this.model=this.requestedModel}return await this.validate(),this.model}async validate(){const n=await fetch(`${this.baseUrl}/chat/completions`,{method:"POST",headers:this.headers(),body:JSON.stringify({model:this.model,messages:[{role:"user",content:"Reply with ok."}],temperature:0,max_tokens:1,stream:!1})}).catch(r=>{throw new Error(`Can't reach ${this.baseUrl}/chat/completions (${r instanceof Error?r.message:String(r)}). Check the endpoint URL, API key, model name, and any local CORS settings.`)});if(!n.ok){const r=await n.text().catch(()=>"");throw new Error(`chat/completions HTTP ${n.status} ${n.statusText}${r?` — ${r.slice(0,300)}`:""}`)}const t=await n.json().catch(()=>({}));t.model&&(this.model=t.model)}dispose(){}}const mi=[{id:"onnx-community/Florence-2-base-ft",label:"Florence-2 base",downloadLabel:"~0.4 GB"},{id:"onnx-community/Florence-2-large-ft",label:"Florence-2 large (higher quality)",downloadLabel:"~1.6 GB"}],yt=mi.map(e=>({...e,label:`${e.label} (${e.downloadLabel})`})),Mt=yt[0].id,pi="<OCR>",Bn="UNKNOWN (scripted brain — connect the in-browser model to read a photo)";function ui(e,n){if(e)return typeof e=="function"?e(n):e[n]}class gi{constructor(n){F(this,"kind","scripted-vision");F(this,"model",null);F(this,"read",async(n,t,r)=>{const i=typeof n=="string"?ui(this.lookup,n)??Bn:Bn;return r==null||r(i),i});this.lookup=n}dispose(){}}function hi(e){return new gi(e)}class Rn{constructor(){F(this,"kind","browser-vision");F(this,"model",null);F(this,"modelHandle",null);F(this,"processor",null);F(this,"loadImage",null);F(this,"generation",0);F(this,"read",async(n,t,r)=>{const i=this.modelHandle,s=this.processor,c=this.loadImage;if(!i||!s||!c||!this.model)throw new Error("BrowserVisionBrain.read called before connect()");const m=t&&t.startsWith("<")?t:pi,p=await c(n),o=s.construct_prompts(m),d=await s(p,o),g=await i.generate({...d,max_new_tokens:512,num_beams:1,do_sample:!1}),u=s.batch_decode(g,{skip_special_tokens:!1})[0],_=s.post_process_generation(u,m,p.size),f=bi(_,m);return r==null||r(f),f})}async connect(n=Mt,t){var m,p;const r=await Ye("the scripted-vision fallback");if(r)throw new Error(r);if(this.modelHandle&&this.model===n)return n;const i=++this.generation,s=o=>{i===this.generation&&(t==null||t({progress:(o.progress??0)/100,text:o.file?`${o.status??"loading"} ${o.file}`:o.status??""}))};this.teardown();let c;try{const{Florence2ForConditionalGeneration:o,AutoProcessor:d,load_image:g}=await le(async()=>{const{Florence2ForConditionalGeneration:f,AutoProcessor:y,load_image:b}=await import("./transformers.web-kkmmoKU8.js");return{Florence2ForConditionalGeneration:f,AutoProcessor:y,load_image:b}},[]),u=await o.from_pretrained(n,{dtype:"fp32",device:"webgpu",progress_callback:s}),_=await d.from_pretrained(n);c={model:u,processor:_,loadImage:g}}catch(o){if(i!==this.generation)throw new Error("cancelled");const d=o instanceof Error?o.message:String(o);throw new Error(`Couldn't load ${n} in the browser (${d}). Try the smaller Florence-2 base model, check your connection, or use the scripted-vision fallback.`)}if(i!==this.generation)throw Promise.resolve((p=(m=c.model).dispose)==null?void 0:p.call(m)).catch(()=>{}),new Error("cancelled");return this.modelHandle=c.model,this.processor=c.processor,this.loadImage=c.loadImage,this.model=n,n}teardown(){var t;const n=this.modelHandle;this.modelHandle=null,this.processor=null,this.loadImage=null,this.model=null,Promise.resolve((t=n==null?void 0:n.dispose)==null?void 0:t.call(n)).catch(()=>{})}cancelConnect(){this.generation++}dispose(){this.generation++,this.teardown()}}function bi(e,n){const t=e[n];if(typeof t=="string")return t.trim();if(t&&typeof t=="object"){const r=t.labels;return Array.isArray(r)?r.join(" ").trim():JSON.stringify(t)}return""}async function fi(){return await ii()?"browser":_t()?"endpoint":"scripted"}function _i(){const[e,n]=h.useState("scripted"),t=h.useRef(!1),[r,i]=h.useState("idle"),[s,c]=h.useState(null),[m,p]=h.useState(null),[o,d]=h.useState(null),[g,u]=h.useState(null),[_,f]=h.useState(null),[y,b]=h.useState(null),[M,k]=h.useState(ht),[C,Q]=h.useState(ft),[K,me]=h.useState(""),[J,oe]=h.useState(""),[V,Y]=h.useState(null),N=h.useRef(null),[E,A]=h.useState("scripted-vision"),[D,$]=h.useState("idle"),[ge,ve]=h.useState(null),[ze,Ie]=h.useState(Mt),[Pe,xe]=h.useState(null),[tn,Te]=h.useState(null),[Oe,ae]=h.useState(null),[je,Se]=h.useState(null),X=h.useRef(null),Ne=h.useRef(!1),Ee=h.useCallback(I=>async(...P)=>{try{return await I.chat(...P)}catch(U){const ke=U instanceof Error?U.message:String(U);throw I instanceof We&&en(ke)&&(Y(null),p(null),i("error"),c(ke)),U}},[]),Ce=h.useCallback(I=>async(...P)=>{try{return await I.read(...P)}catch(U){const ke=U instanceof Error?U.message:String(U);throw en(ke)&&(Se(null),xe(null),$("error"),ve(ke)),U}},[]);h.useEffect(()=>{Ye().then(I=>{f(I),u(I===null),t.current||(t.current=!0,fi().then(n))}),Ye("the scripted-vision fallback").then(I=>{ae(I),Ne.current||(Ne.current=!0,A(I===null?"browser-vision":"scripted-vision"))})},[]),h.useEffect(()=>{let I=!1;return b(null),ci(M).then(P=>{I||b(P)}),()=>{I=!0}},[M]),h.useEffect(()=>()=>{var I;return(I=N.current)==null?void 0:I.dispose()},[]),h.useEffect(()=>()=>{var I;return(I=X.current)==null?void 0:I.dispose()},[]);const G=h.useCallback(I=>{n(I),i("idle"),c(null),p(null),d(null),Y(null)},[]),he=h.useCallback(I=>{var P,U;Ne.current=!0,(P=X.current)==null||P.cancelConnect(),(U=X.current)==null||U.dispose(),X.current=null,A(I),$("idle"),ve(null),xe(null),Te(null),Se(null)},[]),pe=h.useCallback(()=>{var I;(I=N.current)==null||I.dispose(),N.current=null,Y(null),p(null)},[]),_e=h.useCallback(()=>{N.current instanceof We&&N.current.cancelConnect(),pe(),i("idle"),d(null),c(null)},[pe]),Qe=h.useCallback(async()=>{var I;if(e==="scripted"){Y(null),i("ready");return}if(e==="endpoint"){const P=bn(C);if(P){pe(),c(P),i("error");return}}i("connecting"),c(null),d(null);try{if(e==="browser"){const P=N.current instanceof We?N.current:new We;N.current&&N.current!==P&&N.current.dispose(),N.current=P;const U=await P.connect(M,d);p(U),Y(()=>Ee(P)),b(!0)}else{(I=N.current)==null||I.dispose();const P=new li(C,J,K);N.current=P;const U=await P.connect();p(U),Y(()=>Ee(P))}i("ready")}catch(P){const U=P instanceof Error?P.message:String(P);if(U==="cancelled")return;c(U),i("error"),Y(null)}finally{d(null)}},[e,M,C,K,J,pe,Ee]),ne=h.useCallback(()=>{var I;(I=X.current)==null||I.dispose(),X.current=null,Se(null),xe(null)},[]),Le=h.useCallback(()=>{var I;(I=X.current)==null||I.cancelConnect(),ne(),$("idle"),Te(null),ve(null)},[ne]),Be=h.useCallback(async()=>{if(E==="scripted-vision"){ne(),$("ready"),ve(null);return}$("connecting"),ve(null),Te(null);try{const I=X.current instanceof Rn?X.current:new Rn;X.current&&X.current!==I&&X.current.dispose(),X.current=I;const P=await I.connect(ze,Te);xe(P),Se(()=>Ce(I)),$("ready")}catch(I){const P=I instanceof Error?I.message:String(I);if(P==="cancelled")return;ve(P),$("error"),Se(null),xe(null)}finally{Te(null)}},[E,ze,ne,Ce]);return{kind:e,setKind:G,status:r,error:s,modelInUse:m,progress:o,webgpu:g,webgpuReason:_,browserModelCached:y,cancelConnect:_e,browserModel:M,setBrowserModel:k,endpointUrl:C,setEndpointUrl:Q,endpointModel:K,setEndpointModel:me,apiKey:J,setApiKey:oe,connect:Qe,chat:V,visionKind:E,setVisionKind:he,visionStatus:D,visionError:ge,visionModel:ze,setVisionModel:Ie,visionModelInUse:Pe,visionProgress:tn,visionWebgpuReason:Oe,connectVision:Be,cancelVisionConnect:Le,vision:je}}const gn="#s=",wi=["scripted","browser","endpoint"];function yi(e){return typeof e=="string"&&wi.includes(e)}function Mi(e){try{const n=JSON.parse(e);if(n&&typeof n=="object"){const t=n,r={};return yi(t.brain)&&(r.brain=t.brain),r}}catch{}return{}}function vt(e=location.hash){if(!e.startsWith(gn))return{};let n;try{n=decodeURIComponent(e.slice(gn.length))}catch{return{}}return Mi(n)}function vi(e){const n=Object.entries(e).filter(([,t])=>t!==void 0);return n.length===0?"":gn+encodeURIComponent(JSON.stringify(Object.fromEntries(n)))}function xi(e){const n={...vt(),...e},t=vi(n),r=new URL(location.href);r.hash=t,history.replaceState(history.state,"",r)}const zn=[{kind:"scripted",label:"Scripted",hint:"No model. The example's stand-in decides — deterministic and offline."},{kind:"browser",label:"In-browser (WebGPU)",hint:"A small quantised model on your GPU. First run downloads weights."},{kind:"endpoint",label:"API endpoint",hint:"Any OpenAI-compatible server. Ollama by default. Local pages only."}],On=[{kind:"scripted-vision",label:"Scripted",hint:"No model. The example's known plate is returned — deterministic and offline."},{kind:"browser-vision",label:"In-browser (WebGPU)",hint:"Reads the photo with a vision model on your GPU. First run downloads weights."}];function Ni({brain:e,showText:n=!0,showVision:t=!1}){return a.jsxs("div",{className:"brain",children:[n&&a.jsx(Ei,{brain:e}),n&&t&&a.jsx("hr",{className:"brain-divider"}),t&&a.jsx(ki,{brain:e})]})}function Ei({brain:e}){const n=zn.find(o=>o.kind===e.kind),t=bn(e.endpointUrl),r=_t(),[i,s]=h.useState(nn);h.useEffect(()=>{si().then(s)},[]);const c=i.find(o=>o.id===e.browserModel),m=c?di(c,bt()):null,p=e.webgpu===!0?"browser":r&&e.webgpu===!1?"endpoint":null;return a.jsxs("div",{className:"brain-section",children:[a.jsxs("div",{className:"brain-kinds",children:[zn.map(o=>a.jsxs(H,{size:"sm",variant:e.kind===o.kind?"default":"secondary",onClick:()=>e.setKind(o.kind),children:[o.label,o.kind===p&&a.jsx(W,{variant:"info",className:"brain-recommended-badge",children:"recommended"})]},o.kind)),e.status==="ready"&&e.kind!=="scripted"&&a.jsx(W,{variant:"success",children:e.modelInUse??"connected"}),e.status==="connecting"&&a.jsx(W,{variant:"info",children:"connecting…"}),e.status==="error"&&a.jsx(W,{variant:"danger",children:"not connected"})]}),a.jsx("p",{className:"field-hint",children:n.hint}),e.kind==="browser"&&a.jsxs("div",{className:"brain-config",children:[a.jsxs("div",{className:"field",children:[a.jsx(Re,{htmlFor:"browser-model",children:"Model"}),a.jsxs(Xn,{value:e.browserModel,onValueChange:e.setBrowserModel,disabled:e.status==="connecting",children:[a.jsx(et,{id:"browser-model",children:a.jsx(nt,{})}),a.jsx(tt,{children:i.map(o=>a.jsx(rt,{value:o.id,children:o.label},o.id))})]}),e.browserModelCached===!0&&a.jsx("p",{className:"field-hint",children:"Already downloaded in this browser — connecting will be fast."}),e.browserModelCached===!1&&a.jsx("p",{className:"field-hint",children:"Not downloaded yet — connecting fetches the weights once, then caches them for next time."})]}),e.webgpu===!1&&e.webgpuReason&&a.jsxs(se,{variant:"destructive",children:[a.jsx(de,{children:"No WebGPU in this browser"}),a.jsx(ce,{children:e.webgpuReason})]}),e.webgpu!==!1&&m&&a.jsxs(se,{variant:"destructive",children:[a.jsx(de,{children:"This model may not fit in GPU memory"}),a.jsx(ce,{children:m})]})]}),e.kind==="endpoint"&&a.jsxs("div",{className:"brain-config",children:[a.jsxs("div",{className:"field",children:[a.jsx(Re,{htmlFor:"endpoint-url",children:"Endpoint"}),a.jsx(rn,{id:"endpoint-url",value:e.endpointUrl,onChange:o=>e.setEndpointUrl(o.target.value),disabled:e.status==="connecting"}),a.jsxs("p",{className:"field-hint",children:["Ollama allows ",a.jsx("code",{children:"localhost"})," origins out of the box; set"," ",a.jsx("code",{children:"OLLAMA_ORIGINS"})," only when serving this page from another host. Best for local development — a hosted copy of this page can't reach a server on your machine at all."]}),t&&a.jsxs(se,{variant:"destructive",children:[a.jsx(de,{children:"A local server won't work from this URL"}),a.jsx(ce,{children:t})]})]}),a.jsxs("div",{className:"field",children:[a.jsx(Re,{htmlFor:"endpoint-model",children:"Model (blank = first served)"}),a.jsx(rn,{id:"endpoint-model",placeholder:"llama3.2:3b",value:e.endpointModel,onChange:o=>e.setEndpointModel(o.target.value),disabled:e.status==="connecting"})]}),a.jsxs("div",{className:"field",children:[a.jsx(Re,{htmlFor:"endpoint-key",children:"API key (optional)"}),a.jsx(rn,{id:"endpoint-key",type:"password",value:e.apiKey,onChange:o=>e.setApiKey(o.target.value),disabled:e.status==="connecting"})]})]}),e.kind!=="scripted"&&a.jsxs("div",{className:"brain-actions",children:[a.jsx(H,{size:"sm",onClick:()=>void e.connect(),disabled:e.status==="connecting",children:e.status==="ready"?"Reconnect":"Connect"}),e.status==="connecting"&&e.kind==="browser"&&a.jsx(H,{size:"sm",variant:"secondary",onClick:e.cancelConnect,children:"Cancel"}),e.progress&&a.jsxs("span",{className:"field-hint",children:[Math.round(e.progress.progress*100),"% —"," ",e.progress.text]})]}),e.error&&a.jsxs(se,{variant:"destructive",children:[a.jsx(de,{children:"Couldn't connect"}),a.jsx(ce,{children:e.error})]})]})}function ki({brain:e}){const n=On.find(r=>r.kind===e.visionKind),t=e.webgpu===!0?"browser-vision":null;return a.jsxs("div",{className:"brain-section brain-vision",children:[a.jsx(Re,{children:"Vision (reads the image)"}),a.jsxs("div",{className:"brain-kinds",children:[On.map(r=>a.jsxs(H,{size:"sm",variant:e.visionKind===r.kind?"default":"secondary",onClick:()=>e.setVisionKind(r.kind),children:[r.label,r.kind===t&&a.jsx(W,{variant:"info",className:"brain-recommended-badge",children:"recommended"})]},r.kind)),e.visionStatus==="ready"&&e.visionKind==="browser-vision"&&a.jsx(W,{variant:"success",children:e.visionModelInUse??"connected"}),e.visionStatus==="connecting"&&a.jsx(W,{variant:"info",children:"connecting…"}),e.visionStatus==="error"&&a.jsx(W,{variant:"danger",children:"not connected"})]}),a.jsx("p",{className:"field-hint",children:n.hint}),e.visionKind==="scripted-vision"&&e.webgpu===!1&&e.visionWebgpuReason&&a.jsxs(se,{variant:"destructive",children:[a.jsx(de,{children:"No WebGPU in this browser"}),a.jsx(ce,{children:e.visionWebgpuReason})]}),e.visionKind==="browser-vision"&&a.jsxs("div",{className:"brain-config",children:[a.jsxs("div",{className:"field",children:[a.jsx(Re,{htmlFor:"vision-model",children:"Model"}),a.jsxs(Xn,{value:e.visionModel,onValueChange:e.setVisionModel,disabled:e.visionStatus==="connecting",children:[a.jsx(et,{id:"vision-model",children:a.jsx(nt,{})}),a.jsx(tt,{children:yt.map(r=>a.jsx(rt,{value:r.id,children:r.label},r.id))})]}),a.jsx("p",{className:"field-hint",children:"Connecting downloads the weights once (size shown above), then caches them — every token is read on your GPU, no server."})]}),e.webgpu===!1&&e.visionWebgpuReason&&a.jsxs(se,{variant:"destructive",children:[a.jsx(de,{children:"No WebGPU in this browser"}),a.jsx(ce,{children:e.visionWebgpuReason})]})]}),e.visionKind==="browser-vision"&&a.jsxs("div",{className:"brain-actions",children:[a.jsx(H,{size:"sm",onClick:()=>void e.connectVision(),disabled:e.visionStatus==="connecting",children:e.visionStatus==="ready"?"Reconnect":"Connect"}),e.visionStatus==="connecting"&&a.jsx(H,{size:"sm",variant:"secondary",onClick:e.cancelVisionConnect,children:"Cancel"}),e.visionProgress&&a.jsxs("span",{className:"field-hint",children:[Math.round(e.visionProgress.progress*100),"% —"," ",e.visionProgress.text]})]}),e.visionError&&a.jsxs(se,{variant:"destructive",children:[a.jsx(de,{children:"Couldn't connect the vision brain"}),a.jsx(ce,{children:e.visionError})]})]})}function Ii({imageInput:e,value:n,onSelect:t,disabled:r=!1}){const[i,s]=h.useState(null),[c,m]=h.useState(!1),p=h.useRef(null),o=h.useId(),d=h.useId(),g=h.useCallback(f=>{s(URL.createObjectURL(f)),t({imageName:f.name,pixels:f})},[t]);h.useEffect(()=>{if(i)return()=>URL.revokeObjectURL(i)},[i]);const u=h.useCallback(f=>{const y=f==null?void 0:f[0];y&&y.type.startsWith("image/")&&g(y)},[g]),_=(n==null?void 0:n.imageId)!=null?e.seedImages.find(f=>f.id===n.imageId):void 0;return a.jsxs("div",{className:"image-input",children:[e.label&&a.jsx("p",{className:"field-hint",children:e.label}),a.jsx("p",{className:"image-input-label",id:o,children:"Seed photos"}),a.jsx("div",{className:"image-gallery",role:"group","aria-labelledby":o,children:e.seedImages.map(f=>{const y=(n==null?void 0:n.imageId)===f.id;return a.jsxs("button",{type:"button","aria-pressed":y,className:`image-thumb${y?" image-thumb--selected":""}`,disabled:r,title:f.label??f.id,onClick:()=>{s(null),p.current&&(p.current.value=""),t({imageId:f.id,pixels:f.file})},children:[a.jsx("img",{src:f.thumb??f.file,alt:f.label??f.id}),f.label&&a.jsx("span",{children:f.label})]},f.id)})}),a.jsx("label",{className:"image-input-label",htmlFor:d,children:"Or upload your own photo"}),a.jsxs("div",{className:`image-drop${c?" image-drop--over":""}`,onDragOver:f=>{f.preventDefault(),r||m(!0)},onDragLeave:()=>m(!1),onDrop:f=>{f.preventDefault(),m(!1),r||u(f.dataTransfer.files)},children:[a.jsx("input",{ref:p,id:d,type:"file",accept:"image/*",disabled:r,onChange:f=>u(f.target.files)}),a.jsx("p",{className:"field-hint",children:"Drag a photo here, or pick one. Uploading a photo the model has never seen is the proof this runs for real — nothing leaves your browser."})]}),(i||_)&&a.jsxs("div",{className:"image-preview",children:[a.jsx("img",{src:i??(_==null?void 0:_.file),alt:i?(n==null?void 0:n.imageName)??"uploaded photo":(_==null?void 0:_.label)??(_==null?void 0:_.id)??"selected photo"}),a.jsx("span",{className:"field-hint",children:i?`Uploaded: ${(n==null?void 0:n.imageName)??"your photo"}`:`Selected: ${(_==null?void 0:_.label)??(_==null?void 0:_.id)}`}),a.jsx("button",{type:"button",className:"image-clear-btn",disabled:r,onClick:()=>{s(null),p.current&&(p.current.value=""),t(null)},children:"Clear"})]})]})}function xt(e){return typeof e=="object"&&e!==null}function Ls(e){const n=new Set,t=r=>{xt(r)&&(typeof r.key=="string"&&n.add(r.key),Array.isArray(r.components)&&r.components.forEach(t))};return t(e),n}function Ti(e){const n={},t=r=>{xt(r)&&(typeof r.key=="string"&&"defaultValue"in r&&(n[r.key]=r.defaultValue??""),Array.isArray(r.components)&&r.components.forEach(t))};return t(e),n}const ji="wdf:section:";function Nt(e){return ji+e}function Fn(e){try{const n=window.localStorage.getItem(Nt(e));return n==="1"?!0:n==="0"?!1:void 0}catch{return}}function Si(e,n){try{window.localStorage.setItem(Nt(e),n?"1":"0")}catch{}}function Ai(e,n=!0){const[t,r]=h.useState(()=>Fn(e)??n);h.useEffect(()=>{r(Fn(e)??n)},[e,n]);const i=h.useCallback(s=>{r(s),Si(e,s)},[e]);return[t,i]}function we({sectionId:e,title:n,description:t,defaultOpen:r=!0,className:i,children:s,...c}){const[m,p]=Ai(e,r);return a.jsx(Bt,{className:["panel",i].filter(Boolean).join(" "),"data-tour":c["data-tour"],children:a.jsxs(Rt,{open:m,onOpenChange:p,children:[a.jsxs(zt,{className:"panel-trigger",children:[a.jsxs("span",{className:"panel-trigger-text",children:[a.jsx("span",{className:"panel-title",children:n}),t!=null&&a.jsx("span",{className:"panel-desc",children:t})]}),a.jsx(Ot,{className:"panel-chevron","aria-hidden":!0})]}),a.jsx(Ft,{children:a.jsx(Ut,{children:s})})]})})}function Di(e){return e.entries!==void 0}function Pi(e){const n=[];let t=null;for(const r of e)r.turn!==void 0?t&&t.turn===r.turn?t.entries.push(r):(t={turn:r.turn,entries:[r]},n.push(t)):(t=null,n.push(r));return n}function Un(e){if(e===void 0)return"undefined";try{return JSON.stringify(e)}catch{return"[unserializable value]"}}function Ci({activation:e,result:n,labelFor:t}){const r=e.elementId??"";return a.jsxs("div",{className:"timeline-tool",children:[a.jsxs("div",{className:"timeline-tool-head",children:[a.jsx(W,{variant:"info",children:"tool"}),a.jsx("strong",{children:t(r)||r}),a.jsx("code",{children:r})]}),e.args!==void 0&&Object.keys(e.args).length>0&&a.jsxs("div",{className:"timeline-kv",children:[a.jsx("span",{className:"timeline-kv-label",children:"arguments"}),a.jsx("code",{children:Un(e.args)})]}),a.jsxs("div",{className:"timeline-kv",children:[a.jsx("span",{className:"timeline-kv-label",children:"returned"}),a.jsx("code",{children:n?Un(n.result):"— waiting for the job to complete —"})]})]})}function Li({group:e,labelFor:n}){const t=e.entries.find(o=>o.kind==="llm"),r=e.entries.filter(o=>o.kind==="agent"&&o.elementId),i=e.entries.filter(o=>o.kind==="vars"&&o.elementId),s=e.entries.filter(o=>o.kind==="agent"&&!o.elementId),c=e.entries.filter(o=>o.kind==="error"),m=new Set(r.map(o=>o.elementId)),p=e.entries.filter(o=>o.kind==="tool"||o.kind==="vars"&&o.elementId&&!m.has(o.elementId)).sort((o,d)=>o.id-d.id);return a.jsxs("div",{className:"timeline-turn",children:[a.jsxs("div",{className:"timeline-turn-head",children:[a.jsxs(W,{variant:t!=null&&t.pending?"warning":"neutral",children:["Turn ",e.turn]}),(t==null?void 0:t.pending)&&a.jsx("span",{className:"timeline-pending",children:"thinking…"})]}),t&&a.jsx("blockquote",{className:"timeline-reply",children:t.text}),s.map(o=>a.jsx("div",{className:"timeline-note",children:o.text},o.id)),r.map(o=>a.jsx(Ci,{activation:o,result:i.find(d=>d.elementId===o.elementId),labelFor:n},o.id)),p.map(o=>a.jsxs("div",{className:`log-line log-${o.kind}`,children:[o.pending?"⏳ ":"",o.text]},o.id)),c.map(o=>a.jsxs("div",{className:"timeline-error",children:["⚠ ",o.text]},o.id))]})}function Bi({log:e,elementStats:n=[],incidents:t=[],labelFor:r=i=>i}){const i=h.useMemo(()=>Pi(e),[e]),[s,c]=h.useState(!1),m=h.useRef(null);h.useEffect(()=>{const o=m.current;o&&(o.scrollTop=o.scrollHeight)},[i]);const p=()=>{var g;const o={log:e.map(({id:u,..._})=>_),elementStats:n,incidents:t},d=JSON.stringify(o,null,2);(g=navigator.clipboard)!=null&&g.writeText&&navigator.clipboard.writeText(d).then(()=>{c(!0),setTimeout(()=>c(!1),1500)}).catch(()=>{})};return a.jsxs(we,{sectionId:"activity",className:"grow",title:"Activity",description:"Agent turns, model replies, and tool calls — read top to bottom as a story.",children:[a.jsx("div",{className:"timeline-toolbar",children:a.jsx(H,{variant:"secondary",size:"sm",onClick:p,children:s?"Copied!":"Copy run as JSON"})}),a.jsx("div",{className:"timeline",ref:m,children:i.length===0?a.jsx("div",{className:"log-empty",children:"Press Run or Step to start."}):i.map(o=>Di(o)?a.jsx(Li,{group:o,labelFor:r},`turn-${o.turn}-${o.entries[0].id}`):a.jsxs("div",{className:`log-line log-${o.kind}`,children:[o.pending?"⏳ ":"",o.text]},o.id))}),(n.length>0||t.length>0)&&a.jsxs("div",{className:"timeline-engine-view",children:[n.length>0&&a.jsxs("div",{className:"timeline-stats",children:[a.jsx("span",{className:"timeline-kv-label",children:"Element completion"}),a.jsx("ul",{children:n.filter(o=>o.completed>0||(o.active??0)>0).map(o=>a.jsxs("li",{children:[a.jsx("code",{children:r(o.elementId)||o.elementId})," ","completed ",o.completed,o.active?`, ${o.active} active`:""]},o.elementId))})]}),t.length>0&&a.jsxs("div",{className:"timeline-incidents",children:[a.jsx("span",{className:"timeline-kv-label",children:"Incidents"}),a.jsx("ul",{children:t.map((o,d)=>a.jsxs("li",{children:[a.jsx("code",{children:r(o.elementId)||o.elementId})," —"," ",o.reason]},`${o.elementId}-${d}`))})]})]})]})}const fe={diagram:"diagram",runButton:"run-button",variablesPanel:"variables-panel",codePanel:"code-panel",brainPanel:"brain-panel"};function $n(e){return`[data-tour="${e}"]`}function Ri(e=location.search){return new URLSearchParams(e).get("tour")}function zi(e,n){var t;return((t=e.elementStats.find(r=>r.elementId===n))==null?void 0:t.completed)??0}function Oi(e,n){return!e||e.kind==="click"||!n?!1:e.kind==="activeElement"?n.activeElementIds.includes(e.elementId):zi(n,e.elementId)>=(e.atLeast??1)}function Fi(e){return"anchor"in e?$n(e.anchor):`${$n(fe.diagram)} [data-element-id="${Ui(e.elementId)}"]`}function Ui(e){return typeof CSS<"u"&&typeof CSS.escape=="function"?CSS.escape(e):e.replace(/[^a-zA-Z0-9_-]/g,n=>`\\${n}`)}function $i(e){return e.map(n=>{const t=!!n.waitFor&&n.waitFor.kind!=="click";return{element:Fi(n.target),popover:{title:n.title,description:t?`${n.description} (continues automatically once you reach that point — or use Next to skip ahead)`:n.description,showButtons:["next","previous","close"]},disableActiveInteraction:!1,skipMissingElement:n.skipMissingElement??!0}})}async function Gi(e,n={}){var s;const[{driver:t}]=await Promise.all([le(()=>import("./driver.js-bj_ppY-Q.js"),[]),le(()=>Promise.resolve({}),__vite__mapDeps([0]))]),r=$i(e),i=t({steps:r,showProgress:!0,allowClose:!0,skipMissingElement:!0,onHighlighted:(c,m,{index:p})=>{var o;p!==void 0&&((o=n.onIndexChange)==null||o.call(n,p))},onDestroyed:()=>{var c;(c=n.onDestroyed)==null||c.call(n)}});return i.drive(),(s=n.onIndexChange)==null||s.call(n,i.getActiveIndex()??0),{moveNext:()=>i.moveNext(),activeIndex:()=>i.getActiveIndex()??-1,destroy:()=>i.destroy()}}const Vi=300;function Yi(e,n){const[t,r]=h.useState(!1),i=h.useRef(null),s=h.useRef(0),c=h.useRef(-1),m=h.useRef(null),p=h.useRef(n);h.useEffect(()=>{p.current=n},[n]);const o=h.useCallback(()=>{m.current!==null&&(clearInterval(m.current),m.current=null)},[]),d=h.useRef(0),g=h.useCallback(()=>{var _;d.current+=1,o(),(_=i.current)==null||_.destroy(),i.current=null,r(!1)},[o]),u=h.useCallback(()=>{if(!e||e.steps.length===0||i.current)return;const _=d.current+=1;Gi(e.steps,{onIndexChange:f=>{s.current=f},onDestroyed:()=>{o(),i.current=null,r(!1)}}).then(f=>{if(_!==d.current){f.destroy();return}i.current=f,r(!0),m.current=setInterval(()=>{const y=s.current;if(y===c.current)return;const b=e.steps[y];b&&Oi(b.waitFor,p.current())&&(c.current=y,f.moveNext())},Vi)})},[e,o]);return h.useEffect(()=>g,[g]),{active:t,start:u,stop:g}}const Ze=650,an="__agent__",Gn="__model__",Vn="__template__:",Qi=h.lazy(async()=>{await Promise.all([le(()=>Promise.resolve({}),__vite__mapDeps([1])),le(()=>Promise.resolve({}),__vite__mapDeps([2]))]);const{RuntimeDiagram:e}=await le(async()=>{const{RuntimeDiagram:n}=await import("./RuntimeDiagram-B2IYfHo7.js");return{RuntimeDiagram:n}},__vite__mapDeps([3,4,5]));return{default:e}}),sn=h.lazy(()=>le(()=>import("./MonacoEditor-BBwK9Sqw.js").then(e=>e.M),__vite__mapDeps([6,4,7]))),Ji=h.lazy(()=>le(()=>import("./vendor-modeler-6PGV0JBl.js"),__vite__mapDeps([8,4,5,9,10,11,12,1,2]))),Yn=h.lazy(async()=>{const{FormRenderer:e}=await le(async()=>{const{FormRenderer:n}=await import("./FormRenderer-Xq-ACddp.js");return{FormRenderer:n}},__vite__mapDeps([13,4,11,9,10,14]));return{default:e}});function dn(e,n){try{return JSON.stringify(e??{},null,n)}catch{return"[unserializable value]"}}function qi({example:e,initialBrainKind:n,initialTourId:t}){var _n,wn,yn,Mn,vn,xn,Nn,En;const[r,i]=h.useState(e.bpmn),s=_i(),[c,m]=h.useState(null);h.useEffect(()=>{n&&n!==s.kind&&s.setKind(n)},[]),h.useEffect(()=>{xi({brain:s.kind})},[s.kind]);const[p,o]=h.useState(()=>Object.fromEntries(e.handlers.map(v=>[v.elementId,v.source]))),[d,g]=h.useState(e.scriptedAgent??""),[u,_]=h.useState(()=>Ve(e.templates)),f=h.useMemo(()=>kr(e,p,r,u),[e,p,r,u]),y=f.model,b=ei({bpmn:f.resolvedBpmn}),M=Yi(e.tour,()=>b.snapshot);h.useEffect(()=>{var v;t&&((v=e.tour)==null?void 0:v.id)===t&&M.start()},[]);const k=y.startFormId?((_n=e.forms)==null?void 0:_n[y.startFormId])??null:null,[C,Q]=h.useState(()=>({...e.seed,...k?Ti(k):{}})),[K,me]=h.useState(y.agent?an:((wn=e.handlers[0])==null?void 0:wn.elementId)??""),[J,oe]=h.useState(!1),[V,Y]=h.useState(!1),[N,E]=h.useState(null),[A,D]=h.useState([]),[$,ge]=h.useState({}),[ve,ze]=h.useState(!1),Ie=h.useRef(null),[Pe,xe]=h.useState({}),[tn,Te]=h.useState(!1),Oe=h.useRef(null),ae=h.useRef(!1),je=h.useRef(0),Se=h.useRef(0),X=h.useRef({current:void 0}),Ne=h.useRef({}),Ee=h.useRef({}),Ce=h.useMemo(()=>{const v=new Map;for(const x of y.processes){for(const T of x.tasks)v.set(T.elementId,T.label);for(const T of x.agents){v.set(T.elementId,T.label);for(const L of T.tools)v.set(L.elementId,L.label)}for(const T of x.userTasks)v.set(T.elementId,T.label)}return x=>v.get(x)??x},[y]),G=h.useCallback(v=>{D(x=>{if(v.key){const T=x.findIndex(L=>L.key===v.key);if(T>=0){const L=[...x];return L[T]={...L[T],...v},L}}return[...x,{...v,id:Se.current++}].slice(-80)})},[]),he=h.useMemo(()=>{var v;return((v=b.snapshot)==null?void 0:v.userTasks.find(x=>x.state==="Created"))??null},[b.snapshot]),pe=h.useMemo(()=>{const v=y.processes.flatMap(T=>T.tasks),x=new Map;for(const T of e.handlers){if(!T.manualControl)continue;const L=v.find(B=>B.elementId===T.elementId);L&&x.set(L.jobType,{...T.manualControl,elementId:T.elementId})}return x},[e.handlers,y]),_e=h.useMemo(()=>{if(!b.snapshot)return null;for(const v of b.snapshot.jobs){const x=pe.get(v.jobType);if(x&&v.state==="Created")return{job:v,control:x}}return null},[b.snapshot,pe]),Qe=h.useMemo(()=>{if(!y.agent||!b.snapshot)return[];const v=new Map(b.snapshot.elementStats.map(x=>[x.elementId,x.completed]));return y.agent.tools.filter(x=>(v.get(x.elementId)??0)===0)},[y.agent,b.snapshot]),ne=he?y.userTasks.find(v=>v.elementId===he.elementId):void 0,Le=ne!=null&&ne.formId?((yn=e.forms)==null?void 0:yn[ne.formId])??null:null,Be=h.useCallback(async(v,x,T,L)=>{var ue,ee;let B=T,te=0;for(;je.current===L&&B&&B.completedInstances<1&&te++<80;){const q=await b.stepWorkers(v,{agents:x});if(je.current!==L)return B;B=(q==null?void 0:q.snapshot)??B;const ie=(ue=B.instances[0])==null?void 0:ue.variables;if(ie&&ge({...ie}),B.userTasks.some(O=>O.state==="Created")){G({kind:"human",text:"⏸ waiting for a human — complete the task below to continue"});break}if(!q){G({kind:"error",text:"▶ run stopped — no dispatch round was returned"});break}if(q.handled===0){const O=B.messageSubscriptions[0];if(q.reason==="messages"&&O){G({kind:"vars",text:`📨 correlating message "${O.messageName}" (key: ${O.correlationKey})`,elementId:O.elementId});const be=b.correlateMessage(O.messageName,O.correlationKey,"{}");if(be){B=be;const re=(ee=B.instances[0])==null?void 0:ee.variables;re&&ge({...re}),await new Promise(Ae=>setTimeout(Ae,Ze));continue}G({kind:"error",text:`▶ run stopped — correlating "${O.messageName}" (key: ${O.correlationKey}) failed`,elementId:O.elementId})}break}await new Promise(O=>setTimeout(O,Ze))}return B&&B.completedInstances>=1?G({kind:"done",text:"✅ process instance completed"}):B&&B.incidentElementIds.length>0&&G({kind:"error",text:"A job failed — incident on the diagram"}),B},[b,G]),I=h.useCallback(async v=>{var B,te,ue;if(!_e||ae.current)return;const{job:x,control:T}=_e,L=++je.current;ae.current=!0,oe(!0);try{let ee,q;if(v==="complete")ee=b.completeJobManually(x.jobType,"{}"),q="  ↳ completed normally";else if(T.action.kind==="timer"){const ie=((te=(B=b.snapshot)==null?void 0:B.timers[0])==null?void 0:te.dueInMs)??0;ee=b.advanceTime(Math.max(ie,0)+1),q="  ↳ advanced the clock — timer fired"}else{const{errorCode:ie,message:O}=T.action;ee=b.throwJobError(x.jobType,ie,O),q=`  ↳ threw BPMN error ${ie}: ${O}`}if(ee){G({kind:"vars",text:q,elementId:x.elementId});const ie=(ue=ee.instances[0])==null?void 0:ue.variables;ie&&ge({...ie}),await new Promise(O=>setTimeout(O,Ze)),await Be(Ne.current,Ee.current,ee,L)}else G({kind:"error",text:"  ↳ failed to resolve the manual job",elementId:x.elementId})}finally{ae.current=!1,oe(!1)}},[_e,b,G,Be]),P=h.useCallback(async()=>{var ie;let v=null;try{y.agent&&d.trim()&&(v=hr(d))}catch(O){return E(O instanceof Error?O.message:String(O)),null}X.current={current:void 0};let x;if(e.imageInput){const O=s.vision;x={read:O??hi(e.scriptedVision).read,live:!!O,resolve:re=>b.getRunImage(re)}}const T=_r(y,f.handlers,G,X.current,x);for(const O of pe.keys())delete T[O];const L={};if(y.agents.length>0){if(s.kind!=="scripted"&&s.chat){const be=new Map;for(const re of y.agents)be.set(re.jobType,[...be.get(re.jobType)??[],re]);for(const[re,Ae]of be)L[re]=Lr(Ae,s.chat,G,{turnRef:X.current,requiredTools:e.requiredTools})}else if(v&&y.agent){const be=y.agent.elementId;L[y.agent.jobType]=async re=>{if(re.elementId!==be)throw new Error(`No scripted agent handler for "${re.elementId}" — only "${be}" (the primary process's first agent host) is driven by the scripted brain. Use a live brain to exercise more than one host.`);const Ae=await v(re),At=(Ae.activateElements??[]).map(Dt=>Dt.elementId).join(", ");return G({kind:"agent",text:Ae.completionConditionFulfilled?"🤖 scripted agent: done":`🤖 scripted agent: calling ${At||"(nothing)"}`}),Ae}}}D([]),xe({});const B={...e.seed,...C,...sr(e.imageInput?c:null)};ge(B),Ne.current=T,Ee.current=L;const te=b.redeploy(r),ue=(te==null?void 0:te[0])??y.processId;G({kind:"start",text:`Starting "${ue}" — ${y.agent?s.kind==="scripted"||!s.chat?"scripted brain":`live brain (${s.modelInUse??s.kind})`:"no agent in this model"}`});const ee=b.createInstance(ue,JSON.stringify(B)),q=(ie=ee==null?void 0:ee.instances[0])==null?void 0:ie.key;return e.imageInput&&c&&q&&b.setRunImage(q,c),{workers:T,agents:L,snap:ee}},[b,e,f,r,d,C,c,y,s,G,pe]),U=!!b.snapshot&&b.snapshot.completedInstances<1,ke=!U&&!!k&&!ve,kt=h.useCallback(async()=>{if(!(b.phase!=="ready"||ae.current||V||f.hasErrors)){ae.current=!0,oe(!0);try{let v=Ne.current,x=Ee.current,T=b.snapshot;const L=++je.current;if(!U){if(Ie.current&&!Ie.current.validate())return;E(null);const B=await P();if(!B)return;v=B.workers,x=B.agents,T=B.snap,await new Promise(te=>setTimeout(te,Ze))}await Be(v,x,T,L)}finally{ae.current=!1,oe(!1)}}},[b,V,f.hasErrors,U,P,Be]),It=h.useCallback(async()=>{var v;if(!(b.phase!=="ready"||ae.current||V||f.hasErrors)){ae.current=!0,Y(!0);try{let x=Ne.current,T=Ee.current,L=b.snapshot;if(!U){if(Ie.current&&!Ie.current.validate())return;E(null);const q=await P();if(!q)return;x=q.workers,T=q.agents,L=q.snap}if(!L||L.completedInstances>=1)return;const B=L.takenSequenceFlows.length,te=await b.stepWorkers(x,{agents:T});if(!te){G({kind:"error",text:"⏭ step failed — no dispatch round was returned"});return}const ue=(v=te.snapshot.instances[0])==null?void 0:v.variables;ue&&ge({...ue});const ee=ni(te.snapshot.takenSequenceFlows,B);G(ti(te,ee,Ce,pe))}finally{ae.current=!1,Y(!1)}}},[b,V,f.hasErrors,U,P,G,Ce,pe]),Tt=h.useCallback(()=>{ae.current=!1,je.current++,oe(!1),Y(!1),b.reset(),D([]),ge({})},[b]),jt=h.useCallback(()=>{if(!he||Oe.current&&!Oe.current.validate())return;const v=b.completeUserTask(he.key,JSON.stringify(Pe));G({kind:"human",text:`👤 ${dn(Pe)}`}),v&&v.completedInstances>=1&&G({kind:"done",text:"✅ process instance completed"})},[he,Pe,b,G]),St=h.useMemo(()=>{var v,x;return b.phase==="loading"?a.jsx(W,{variant:"neutral",children:"Booting engine…"}):b.phase==="error"?a.jsx(W,{variant:"danger",children:"Engine error"}):J?a.jsx(W,{variant:"info",children:"Running…"}):V?a.jsx(W,{variant:"info",children:"Stepping…"}):(((v=b.snapshot)==null?void 0:v.incidentElementIds.length)??0)>0?a.jsx(W,{variant:"danger",children:"Incident"}):he?a.jsx(W,{variant:"warning",children:"Waiting for a human"}):(((x=b.snapshot)==null?void 0:x.completedInstances)??0)>=1?a.jsx(W,{variant:"success",children:"Completed"}):b.snapshot?a.jsx(W,{variant:"warning",children:"Paused"}):a.jsx(W,{variant:"neutral",children:"Ready"})},[b.phase,b.snapshot,J,V,he]);return a.jsxs("div",{className:"runner",children:[a.jsxs("section",{className:"intro",children:[a.jsx("h1",{children:e.title}),a.jsx("p",{children:e.blurb}),a.jsxs("div",{className:"controls",children:[a.jsx(H,{"data-tour":fe.runButton,onClick:()=>void kt(),disabled:b.phase!=="ready"||J||V||f.hasErrors||ke,children:"▶ Run"}),a.jsx(H,{variant:"secondary",onClick:()=>void It(),disabled:b.phase!=="ready"||J||V||f.hasErrors||ke||(((Mn=b.snapshot)==null?void 0:Mn.completedInstances)??0)>=1,children:"⏭ Step"}),a.jsx(H,{variant:"secondary",onClick:Tt,disabled:b.phase!=="ready"||V,children:"↺ Reset"}),e.tour&&a.jsx(H,{variant:"secondary",onClick:M.start,disabled:M.active,children:M.active?"Touring…":`🧭 ${e.tour.label}`}),St]}),b.phase==="error"&&a.jsxs(se,{variant:"destructive",children:[a.jsx(de,{children:"Engine error"}),a.jsx(ce,{children:b.error})]}),N&&a.jsxs(se,{variant:"destructive",children:[a.jsx(de,{children:"Code didn't compile"}),a.jsx(ce,{children:N})]}),f.hasErrors&&a.jsxs(se,{variant:"destructive",children:[a.jsx(de,{children:"Run is disabled — the diagram has unresolved references"}),a.jsx(ce,{children:a.jsx("ul",{className:"diagnostics",children:f.diagnostics.filter(v=>v.severity==="error").map((v,x)=>a.jsx("li",{children:v.message},x))})})]}),!f.hasErrors&&f.diagnostics.length>0&&a.jsxs(se,{children:[a.jsx(de,{children:"Heads up"}),a.jsx(ce,{children:a.jsx("ul",{className:"diagnostics",children:f.diagnostics.map((v,x)=>a.jsx("li",{children:v.message},x))})})]})]}),a.jsxs("div",{className:"grid",children:[a.jsxs("div",{className:"col",children:[a.jsx(we,{sectionId:"process","data-tour":fe.diagram,title:"Process",description:`${y.processName} — live token (green), incidents (red).`,children:a.jsx(h.Suspense,{fallback:a.jsx("div",{className:"diagram-fallback",children:b.phase==="loading"?"Booting the engine…":"Loading diagram…"}),children:a.jsx(Qi,{xml:f.resolvedBpmn,activeIds:((vn=b.snapshot)==null?void 0:vn.activeElementIds)??[],incidentIds:((xn=b.snapshot)==null?void 0:xn.incidentElementIds)??[],className:"diagram"})})}),he&&a.jsxs(we,{sectionId:"human-task",title:(ne==null?void 0:ne.label)??"Human task",description:Le?`Rendered from the model's form "${ne==null?void 0:ne.formId}".`:"This task has no linked form — complete it with no variables.",children:[Qe.length>0&&a.jsxs(se,{variant:"destructive",children:[a.jsx(de,{children:"The agent didn't finish its checks"}),a.jsxs(ce,{children:["It completed without running"," ",Qe.map(v=>v.label||v.elementId).join(", "),". The process took the default path to this task, so the findings below have no value to report."]})]}),Le&&a.jsx(h.Suspense,{fallback:a.jsx("div",{className:"form-fallback",children:"Loading form…"}),children:a.jsx(Yn,{ref:Oe,schema:Le,values:Pe,onChange:(v,x)=>xe(T=>({...T,[v]:x})),context:$,onValidityChange:Te})}),a.jsx(H,{onClick:jt,disabled:!!Le&&!tn,children:"Complete task"})]}),_e&&a.jsx(we,{sectionId:"manual-job",title:_e.control.label,description:"This job is held here on purpose — pick how it resolves.",children:a.jsxs("div",{className:"controls",children:[a.jsx(H,{onClick:()=>void I("complete"),disabled:J||V,children:_e.control.completeLabel??"✅ Complete normally"}),a.jsx(H,{variant:"secondary",onClick:()=>void I("action"),disabled:J||V,children:_e.control.action.label})]})}),a.jsxs("div",{className:"row",children:[a.jsx(we,{sectionId:"variables",className:"grow","data-tour":fe.variablesPanel,title:"Variables",description:"The instance payload, live.",children:a.jsx("pre",{className:"vars",children:dn($,2)})}),a.jsx(Bi,{log:A,elementStats:(Nn=b.snapshot)==null?void 0:Nn.elementStats,incidents:(En=b.snapshot)==null?void 0:En.incidents,labelFor:Ce})]})]}),a.jsxs("div",{className:"col",children:[(y.agent||e.imageInput)&&a.jsx(we,{sectionId:"brain","data-tour":fe.brainPanel,title:"Brain",description:y.agent?`What drives “${y.agent.label}”. The model recommends; the process governs.`:"What reads the image. The model recommends; the process governs.",children:a.jsx(Ni,{brain:s,showText:!!y.agent,showVision:!!e.imageInput})}),a.jsxs(we,{sectionId:"start",title:"Start",description:y.startFormId?`The model's start form "${y.startFormId}".`:e.imageInput?"Pick a seed photo or upload your own to read.":"The starting payload.",children:[e.imageInput&&a.jsx(Ii,{imageInput:e.imageInput,value:c,onSelect:m,disabled:J}),e.scenarios&&a.jsx("div",{className:"scenarios",children:e.scenarios.map(v=>a.jsx(H,{size:"sm",variant:"secondary",disabled:J,onClick:()=>Q(x=>({...x,...v.variables})),children:v.label},v.label))}),k?a.jsx(h.Suspense,{fallback:a.jsx("div",{className:"form-fallback",children:"Loading form…"}),children:a.jsx(Yn,{ref:Ie,schema:k,values:C,onChange:(v,x)=>Q(T=>({...T,[v]:x})),disabled:J,onValidityChange:ze})}):a.jsx("pre",{className:"vars",children:dn(C,2)})]}),a.jsx(we,{sectionId:"code",className:"editors","data-tour":fe.codePanel,title:"Code",description:"One handler per BPMN element. Return variables to merge, or throw to fail the job.",children:a.jsx(h.Suspense,{fallback:a.jsx("div",{className:"editor-fallback",children:"Loading editor…"}),children:a.jsxs($t,{value:K,onValueChange:me,children:[a.jsxs(Gt,{children:[a.jsx(Je,{value:Gn,children:"model"}),y.agent&&a.jsx(Je,{value:an,children:"agent (scripted)"}),e.handlers.map(v=>{var x;return a.jsx(Je,{value:v.elementId,children:((x=y.tasks.find(T=>T.elementId===v.elementId))==null?void 0:x.label)??v.elementId},v.elementId)}),Object.keys(u).map(v=>a.jsx(Je,{value:Vn+v,children:v},v))]}),a.jsxs(qe,{value:Gn,children:[a.jsxs("div",{className:"editor-meta",children:[a.jsx("strong",{children:"Model"}),a.jsx("code",{children:"edit the diagram visually — Run re-checks it below"}),a.jsx(H,{variant:"secondary",size:"sm",onClick:()=>i(e.bpmn),disabled:r===e.bpmn,children:"Revert to original"})]}),a.jsx(Ji,{value:r,onChange:i})]}),y.agent&&a.jsxs(qe,{value:an,children:[a.jsxs("div",{className:"editor-meta",children:[a.jsx("strong",{children:y.agent.label}),a.jsx("code",{children:s.kind==="scripted"||!s.chat?"in use":"unused — a live brain is connected"})]}),a.jsx("div",{className:"editor-wrap",children:a.jsx(sn,{height:"360px",defaultLanguage:"javascript",value:d,onChange:v=>g(v??""),options:cn})})]}),e.handlers.map(v=>{var x;return a.jsxs(qe,{value:v.elementId,children:[a.jsxs("div",{className:"editor-meta",children:[a.jsx("strong",{children:((x=y.tasks.find(T=>T.elementId===v.elementId))==null?void 0:x.label)??v.elementId}),a.jsx("code",{children:v.standsInFor??v.elementId})]}),a.jsx("div",{className:"editor-wrap",children:a.jsx(sn,{height:"360px",defaultLanguage:"javascript",value:p[v.elementId],onChange:T=>o(L=>({...L,[v.elementId]:T??""})),options:cn})})]},v.elementId)}),Object.keys(u).map(v=>a.jsxs(qe,{value:Vn+v,children:[a.jsxs("div",{className:"editor-meta",children:[a.jsx("strong",{children:v}),a.jsxs("code",{children:["prompt / template text — substitutes"," ","{{"+v+"}}"]})]}),a.jsx("div",{className:"editor-wrap",children:a.jsx(sn,{height:"360px",defaultLanguage:"markdown",value:u[v],onChange:x=>_(T=>Ve(T,{[v]:x??""})),options:cn})})]},v))]})})}),y.agent&&a.jsx(we,{sectionId:"tools",title:"Tools, as the model sees them",description:a.jsxs(a.Fragment,{children:["Read from the diagram — element name, documentation, and every",a.jsx("code",{children:" fromAi(…)"})," argument."]}),children:a.jsx("ul",{className:"tool-list",children:y.agent.tools.map(v=>a.jsxs("li",{children:[a.jsx("code",{children:v.elementId}),a.jsxs("span",{children:[" — ",v.documentation||v.label]}),v.args.length>0&&a.jsx("ul",{children:v.args.map(x=>a.jsxs("li",{children:[a.jsxs("code",{children:[x.name,": ",x.type]})," ","— ",x.description]},x.name))})]},v.elementId))})})]})]})]})}const cn={minimap:{enabled:!1},fontSize:13,scrollBeyondLastLine:!1,tabSize:2,automaticLayout:!0},Hi=`<?xml version="1.0" encoding="UTF-8"?>\r
...
}`,co={id:"learn-service-task",title:"Service task + sequence flow",group:"learn-bpmn",blurb:"A service task is a unit of work a worker (not a human) performs; a sequence flow is the arrow that hands the token from one to the next once its task completes. Run this and watch each task activate, run its handler, and complete in order — Prepare package, then Dispatch courier — before the process reaches its end event. Miss the zeebe:taskDefinition type on a service task and the model still deploys fine, but no worker is ever listening for that job type, so the run stalls forever waiting on a job nothing services — see the note below for how that looks.",docsUrl:"https://docs.camunda.io/docs/components/modeler/bpmn/service-tasks/",bpmn:oo,seed:{item:"camunda-t-shirt"},handlers:[{elementId:"Activity_prepare",standsInFor:"job worker — prepare-package",source:ao},{elementId:"Activity_dispatch",standsInFor:"job worker — dispatch-courier",source:so}]},lo=Object.freeze(Object.defineProperty({__proto__:null,default:co},Symbol.toStringTag,{value:"Module"})),mo=`You are a demo workflow assistant for fictional compliance checks.
...
}`,_s={id:"plate-recognition",title:"Read a number plate from a photo",blurb:"Pick the plate's country, then a photo goes into the run, an in-browser vision model reads the number plate on the reader's own GPU, and a human confirms or corrects it before the process records the result. The vision model recommends; the BPMN process governs. No server, no API key — with no model connected it falls back to a deterministic scripted reading.",docsUrl:"https://docs.camunda.io/docs/components/modeler/forms/camunda-forms-reference/",bpmn:Ua,forms:{"plate-recognition-country":ms,"plate-recognition-confirm":Ha,"plate-recognition-manual":rs},seed:{country:"auto"},imageInput:{label:"Pick a seed photo (its plate is known, so the scripted reader works offline) or upload your own — a live in-browser model reads a photo it has never seen.",seedImages:gs},scriptedVision:hs,handlers:[{elementId:"ExtractPlate",standsInFor:"Vision model — Florence-2 <OCR> on WebGPU (in-browser)",source:bs},{elementId:"RecordResult",standsInFor:"Script task — records the governed outcome",source:fs}]},ws=[Ea,Fo,fa,va,Sa,_s],ys=Object.assign({"./learn-exclusive-gateway/index.ts":eo,"./learn-message-correlation/index.ts":io,"./learn-service-task/index.ts":lo}),Ms=Object.values(ys).map(e=>e.default).sort((e,n)=>e.id.localeCompare(n.id)),Fe=[...ws,...Ms];function fn(){return"/pr-preview/pr-94/"}function vs(e){const n=fn();return e.startsWith(n)?"/"+e.slice(n.length):e}function xs(e=location.pathname){const t=vs(e).match(/^\/examples\/([^/]+)\/?$/);if(t)try{return{kind:"example",id:decodeURIComponent(t[1])}}catch{return{kind:"gallery"}}return{kind:"gallery"}}function Ns(e=location.search){return new URLSearchParams(e).get("embed")==="1"}function Es(){return fn()}function Hn(e){return`${fn()}examples/${encodeURIComponent(e)}`}function Wn(e,n={}){const t=new URL(location.href);t.pathname=e,t.search=n.search??t.search,n.hash!==void 0&&(t.hash=n.hash),n.replace?history.replaceState(history.state,"",t):history.pushState(history.state,"",t),window.dispatchEvent(new PopStateEvent("popstate"))}function Zn(){return{route:xs(),embed:Ns()}}function ks(){const[e,n]=h.useState(Zn);return h.useEffect(()=>{const t=()=>n(Zn());return window.addEventListener("popstate",t),()=>window.removeEventListener("popstate",t)},[]),e}const Is="web-demo-framework:height",Ts="web-demo-framework:request-height";function js(e){return{type:Is,height:Math.ceil(e)}}const Kn="embed-height-auto";function Ss(e){h.useEffect(()=>{if(!e||typeof window>"u"||window.parent===window)return;const n=document.documentElement;n.classList.add(Kn);let t=-1;const r=(c=!1)=>{const m=document.documentElement.scrollHeight;!c&&Math.abs(m-t)<2||(t=m,window.parent.postMessage(js(m),"*"))},i=c=>{if(c.source!==window.parent)return;const m=c.data;!m||m.type!==Ts||r(!0)};window.addEventListener("message",i),r();const s=new ResizeObserver(()=>r());return s.observe(n),()=>{s.disconnect(),window.removeEventListener("message",i),n.classList.remove(Kn)}},[e])}function As(){const{route:e,embed:n}=ks(),t=vt().brain,r=Ri();Ss(n);const i=e.kind==="example"?e.id:Fe[0].id,s=Fe.find(d=>d.id===i)??Fe[0],c=Fe.filter(d=>d.group!=="learn-bpmn"),m=Fe.filter(d=>d.group==="learn-bpmn"),p=d=>{Wn(Hn(d),{hash:location.hash})},o=a.jsxs(a.Fragment,{children:[!n&&e.kind==="gallery"&&a.jsxs(a.Fragment,{children:[a.jsx("nav",{className:"example-picker",children:c.map(d=>a.jsx(H,{size:"sm",variant:d.id===s.id?"default":"secondary",onClick:()=>p(d.id),children:d.title},d.id))}),m.length>0&&a.jsxs(a.Fragment,{children:[a.jsx("h2",{className:"example-group-heading",children:"Learn BPMN"}),a.jsx("nav",{className:"example-picker",children:m.map(d=>a.jsx(H,{size:"sm",variant:d.id===s.id?"default":"secondary",onClick:()=>p(d.id),children:d.title},d.id))})]})]}),!n&&e.kind==="example"&&a.jsx("div",{className:"example-nav",children:a.jsx(H,{size:"sm",variant:"secondary",onClick:()=>Wn(Es()),children:"← All examples"})}),a.jsxs("div",{className:"example-meta",children:[s.docsUrl&&a.jsx("a",{className:"docs-link",href:s.docsUrl,target:"_blank",rel:"noreferrer noopener",children:"View on camunda.com ↗"}),n&&a.jsx("a",{className:"open-full-page",href:Hn(s.id)+(location.hash||""),target:"_top",rel:"noreferrer",children:"Open full page ↗"})]}),a.jsx(qi,{example:s,initialBrainKind:t,initialTourId:r},s.id)]});return n?a.jsx("div",{className:"c4-ui app-shell app-embed",children:a.jsx("main",{id:"main",className:"layout layout-embed",children:o})}):a.jsxs("div",{className:"c4-ui app-shell",children:[a.jsx(Vt,{appName:"Runnable Camunda examples",trailing:a.jsx("span",{className:"app-subtitle",children:"model + code + optional LLM, in your browser"})}),a.jsx("main",{id:"main",className:"layout",children:o})]})}Lt.createRoot(document.getElementById("root")).render(a.jsx(h.StrictMode,{children:a.jsx(Yt,{children:a.jsx(As,{})})}));export{le as _,Ls as c};
