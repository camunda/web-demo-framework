const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/driver-CTZuBZOi.css","assets/diagram-js-DAKGYcfb.css","assets/bpmn-js-BEOU0ddW.css","assets/bpmn-embedded-DQB-nOWT.css","assets/RuntimeDiagram-DTnJz5cT.js","assets/vendor-react-9Ma26nY1.js","assets/Viewer-D_7S4Gwm.js","assets/MonacoEditor-uG4ItxXx.js","assets/MonacoEditor-DP9HDNPt.css","assets/vendor-modeler-Df7L48VE.js","assets/vendor-design-system-AiNYD9BX.js","assets/vendor-design-system-CFmq7CK2.css","assets/parser-DkgAe_kI.js","assets/ModelEditor-Dwlgp6JA.css","assets/FormRenderer-D_ACP7uT.js","assets/FormRenderer-D1JIHOW6.css"])))=>i.map(i=>d[i]);
var qt=Object.defineProperty;var Jt=(e,n,t)=>n in e?qt(e,n,{enumerable:!0,configurable:!0,writable:!0,value:t}):e[n]=t;var L=(e,n,t)=>Jt(e,typeof n!="symbol"?n+"":n,t);import{r as b,j as i,i as Ht}from"./vendor-react-9Ma26nY1.js";import{B as H,a as ie,L as Ye,S as Nn,b as En,c as kn,d as In,e as Tn,A as le,f as ce,g as me,I as Yn,C as Wt,h as Zt,i as Kt,j as Xt,k as er,l as nr,T as tr,m as rr,n as on,o as an,p as ir,q as or}from"./vendor-design-system-AiNYD9BX.js";(function(){const n=document.createElement("link").relList;if(n&&n.supports&&n.supports("modulepreload"))return;for(const o of document.querySelectorAll('link[rel="modulepreload"]'))r(o);new MutationObserver(o=>{for(const s of o)if(s.type==="childList")for(const d of s.addedNodes)d.tagName==="LINK"&&d.rel==="modulepreload"&&r(d)}).observe(document,{childList:!0,subtree:!0});function t(o){const s={};return o.integrity&&(s.integrity=o.integrity),o.referrerPolicy&&(s.referrerPolicy=o.referrerPolicy),o.crossOrigin==="use-credentials"?s.credentials="include":o.crossOrigin==="anonymous"?s.credentials="omit":s.credentials="same-origin",s}function r(o){if(o.ep)return;o.ep=!0;const s=t(o);fetch(o.href,s)}})();const ar="modulepreload",sr=function(e){return"/pr-preview/pr-108/"+e},Qn={},he=function(n,t,r){let o=Promise.resolve();if(t&&t.length>0){let d=function(a){return Promise.all(a.map(p=>Promise.resolve(p).then(h=>({status:"fulfilled",value:h}),h=>({status:"rejected",reason:h}))))};document.getElementsByTagName("link");const c=document.querySelector("meta[property=csp-nonce]"),u=(c==null?void 0:c.nonce)||(c==null?void 0:c.getAttribute("nonce"));o=d(t.map(a=>{if(a=sr(a),a in Qn)return;Qn[a]=!0;const p=a.endsWith(".css"),h=p?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${a}"]${h}`))return;const l=document.createElement("link");if(l.rel=p?"stylesheet":ar,p||(l.as="script"),l.crossOrigin="",l.href=a,u&&l.setAttribute("nonce",u),document.head.appendChild(l),p)return new Promise((_,y)=>{l.addEventListener("load",_),l.addEventListener("error",()=>y(new Error(`Unable to preload CSS for ${a}`)))})}))}function s(d){const c=new Event("vite:preloadError",{cancelable:!0});if(c.payload=d,window.dispatchEvent(c),!c.defaultPrevented)throw d}return o.then(d=>{for(const c of d||[])c.status==="rejected"&&s(c.reason);return n().catch(s)})},dr="io.camunda.agenticai:aiagent",Be="http://www.omg.org/spec/BPMN/20100524/MODEL",lr="http://camunda.org/schema/zeebe/1.0";function jn(e,n){return Array.from(e.getElementsByTagNameNS(lr,n))}function xt(e,n){return jn(e,n).filter(t=>cr(t)===e)}function cr(e){let n=e.parentElement;for(;n;){if(n.namespaceURI===Be&&n.localName!=="extensionElements")return n;n=n.parentElement}return null}function Dn(e){const n=xt(e,"taskDefinition")[0],t=n==null?void 0:n.getAttribute("type");return t||(e.localName==="scriptTask"?e.getAttribute("id")??null:null)}function qn(e){const n=Array.from(e.children).find(t=>t.namespaceURI===Be&&t.localName==="documentation");return((n==null?void 0:n.textContent)??"").trim()}function Jn(e){if(!e)return"";const n=e.startsWith("=")?e.slice(1):e,t=n.match(/"((?:[^"\\]|\\.)*)"/g);return t?t.map(r=>r.slice(1,-1).replace(/\\n/g,`
...
`)}function mr(e){return Et(Nt(e))}function pr(e){const n=Array.from(e.children).find(t=>t.namespaceURI===Be&&t.localName==="extensionElements");return n?Et(Nt(n)):[]}function Et(e){const n=/fromAi\(\s*toolCall\.([A-Za-z_$][\w$]*)\s*,\s*"((?:[^"\\]|\\.)*)"\s*(?:,\s*"(\w+)")?/g,t=[],r=new Set;for(const o of e.matchAll(n)){const s=o[1];r.has(s)||(r.add(s),t.push({name:s,description:(o[2]??"").replace(/&#10;/g,`
`).replace(/\\"/g,'"').replace(/&quot;/g,'"').replace(/&#39;/g,"'").trim(),type:o[3]??"string"}))}return t}function ur(e){const n={};for(const t of xt(e,"input")){const r=t.getAttribute("target");r&&(n[r]=t.getAttribute("source")??"")}return n}function hr(e){return Array.from(e.getElementsByTagNameNS(Be,"adHocSubProcess")).filter(n=>(Dn(n)??"").startsWith(dr))}const gr=new Set(["subProcess","adHocSubProcess","callActivity"]),br=new Set(["adHocSubProcess","subProcess","transaction"]);function _r(e){let n=e.parentElement;for(;n;){if(n.namespaceURI===Be&&br.has(n.localName))return n;n=n.parentElement}return null}function fr(e,n){const t=ur(e),r=Number((t["data.limits.maxModelCalls"]??"").replace(/^=/,""));return{elementId:e.getAttribute("id")??"agent",label:e.getAttribute("name")??"Agent",jobType:Dn(e),systemPrompt:Jn(t["data.systemPrompt.prompt"]),userPrompt:Jn(t["data.userPrompt.prompt"]),maxModelCalls:Number.isFinite(r)&&r>0?r:10,tools:n}}function wr(e,n){var h;const t=e.getAttribute("id")??"",r=e.getAttribute("name")??t,o=hr(e);o.length>1&&n.push({severity:"warning",elementId:o.map(l=>l.getAttribute("id")).join(", "),message:`Process "${r}" hosts ${o.length} AI Agent sub-processes (${o.map(l=>l.getAttribute("id")).join(", ")}). Each gets its own independent agent state (turn counter, called tools) — the run itself is shared across hosts, but each host's agent state within it is not.`});const s=[],d=new Map(o.map(l=>[l,[]]));for(const l of Array.from(e.getElementsByTagName("*"))){if(l.namespaceURI!==Be||o.includes(l))continue;const _=l.getAttribute("id");if(!_)continue;const y=_r(l),M=y&&o.includes(y)?y:null;if(M&&gr.has(l.localName)){const I=l.getAttribute("name")??_,B=qn(l);s.push({elementId:_,label:I,jobType:"",documentation:B,isTool:!0,compound:!0}),d.get(M).push({elementId:_,label:I,jobType:"",documentation:B,args:pr(l),compound:!0});continue}const v=Dn(l);if(!v)continue;const g={elementId:_,label:l.getAttribute("name")??_,jobType:v,documentation:qn(l),isTool:M!=null};s.push(g),M&&d.get(M).push({elementId:_,label:g.label,jobType:v,documentation:g.documentation,args:mr(l)})}const c=o.map(l=>fr(l,d.get(l))),u=Array.from(e.getElementsByTagNameNS(Be,"userTask")).map(l=>{var _;return{elementId:l.getAttribute("id")??"",label:l.getAttribute("name")??l.getAttribute("id")??"",formId:((_=jn(l,"formDefinition")[0])==null?void 0:_.getAttribute("formId"))??void 0}}),a=e.getElementsByTagNameNS(Be,"startEvent")[0],p=a?((h=jn(a,"formDefinition")[0])==null?void 0:h.getAttribute("formId"))??void 0:void 0;return{processId:t,processName:r,tasks:s,agents:c,userTasks:u,startFormId:p}}function yr(e,n={}){const t=new DOMParser().parseFromString(e,"application/xml"),r=t.getElementsByTagName("parsererror")[0];if(r)throw new Error(`Invalid BPMN XML: ${r.textContent}`);const o=Array.from(t.getElementsByTagNameNS(Be,"process"));if(o.length===0)throw new Error("No <bpmn:process> in the diagram.");const s=[],d=o.map(u=>wr(u,s));let c=n.processId?d.find(u=>u.processId===n.processId):void 0;return n.processId&&!c&&s.push({severity:"warning",message:`Requested process "${n.processId}" not found — falling back to "${d[0].processId}".`}),c??(c=d[0]),d.length>1&&s.push({severity:"warning",message:`Diagram has ${d.length} <bpmn:process> elements (${d.map(u=>u.processId).join(", ")}); using "${c.processId}" as the active process. Pass a processId to parseModel to target another.`}),{processes:d,diagnostics:s,processId:c.processId,processName:c.processName,tasks:c.tasks,agent:c.agents[0]??null,agents:d.flatMap(u=>u.agents),userTasks:c.userTasks,startFormId:c.startFormId}}function vr(e){return e?e.imageId?{imageId:e.imageId}:e.imageName?{imageName:e.imageName}:{}:{}}function kt(e,n){return n?e.pixels:e.imageId??e.pixels}const Mr="No image selected — pick or upload a photo to read.";function Hn(){return Mr}function xr(e,n){return async t=>{const r=e.resolve(n);if(!r)return Hn();const o=kt(r,e.live);if(o===void 0)return Hn();try{return await e.read(o,t)}catch(s){return`Couldn't read the image (${s instanceof Error?s.message:String(s)}).`}}}function Nr(e,n){return async()=>{const t=e.resolve(n);if(t)return kt(t,e.live)}}function Er(){return`<!doctype html><html><head><meta charset="utf-8"></head><body><script>
    "use strict";
    ...
    post({ kind: "ready" });
  <\/script></body></html>`}function It(e,n={}){const{timeoutMs:t=5e3,onTrace:r,onVision:o,onImage:s}=n,d=`${Date.now()}-${Math.random().toString(36).slice(2)}`;return new Promise((c,u)=>{const a=document.createElement("iframe");a.setAttribute("sandbox","allow-scripts"),a.style.display="none",a.setAttribute("aria-hidden","true");let p=!1,h;const l=()=>{h&&clearTimeout(h),window.removeEventListener("message",y),a.remove()},_=v=>{p||(p=!0,l(),v())};function y(v){var I;if(v.source!==a.contentWindow)return;const g=v.data;if(!(!g||typeof g!="object")){if(g.kind==="ready"){const B=e.job,O=e.kind==="run-handler"?{kind:"run-handler",id:d,source:e.source,job:B,hasVision:e.hasVision}:{kind:"run-agent",id:d,source:e.source,job:B};(I=a.contentWindow)==null||I.postMessage(O,"*");return}"id"in g&&g.id!==d||(g.kind==="trace"?r==null||r(g.text):g.kind==="vision-request"?M(g.callId,o,"vision",g.prompt):g.kind==="image-request"?M(g.callId,s,"image"):g.kind==="result"?_(()=>c(g.value)):g.kind==="error"&&_(()=>u(new Error(g.message))))}}function M(v,g,I,...B){const O=oe=>{var Z;return(Z=a.contentWindow)==null?void 0:Z.postMessage(oe,"*")};if(!g){O({kind:"helper-error",id:d,callId:v,message:`${I} helper is not available.`});return}Promise.resolve().then(()=>g(...B)).then(oe=>O({kind:"helper-result",id:d,callId:v,value:oe}),oe=>O({kind:"helper-error",id:d,callId:v,message:oe instanceof Error?oe.message:String(oe)}))}window.addEventListener("message",y),h=setTimeout(()=>{_(()=>u(new Error(`Handler timed out after ${t}ms — the sandboxed run was terminated.`)))},t),a.srcdoc=Er(),document.body.appendChild(a)})}function Tt(e){return{key:e.key,type:e.type,elementId:e.elementId,instanceKey:e.instanceKey,variables:e.variables??{}}}function kr(e,n,t){const r=typeof t.vision=="function";return It({kind:"run-handler",source:e,job:Tt(n),hasVision:r},{onTrace:t.trace,onVision:t.vision?o=>t.vision(o):void 0,onImage:t.image?()=>t.image():void 0})}function Ir(e,n){return It({kind:"run-agent",source:e,job:Tt(n)})}function jt(e,n){try{new Function(`"use strict"; return (${e});`)}catch{throw new Error(`${n} has a syntax error.`)}}function Tr(e){return jt(e,"Handler code"),(n,t)=>kr(e,n,t)}function jr(e){return jt(e,"Agent code"),n=>Ir(e,n)}function Sr(e,n,t,r){return{sleep:o=>new Promise(s=>setTimeout(s,o)),trace:o=>n({kind:"tool",text:`   ${o}`,elementId:e.elementId,turn:t}),text:(o,s="")=>{const d=e.variables[o];return typeof d=="string"?d:d==null?s:String(d)},num:(o,s=0)=>{const d=e.variables[o],c=typeof d=="number"?d:Number(d);return Number.isFinite(c)?c:s},...r?{vision:xr(r,e.instanceKey),image:Nr(r,e.instanceKey)}:{}}}function Pr(e){if(e===void 0)return"undefined";try{return JSON.stringify(e)}catch{return"[unserializable value]"}}function Ar(e,n,t,r,o){const s={},d=e.processes.flatMap(u=>u.tasks),c=new Map(d.map(u=>[u.elementId,u.label]));for(const u of d)u.compound||s[u.jobType]||(s[u.jobType]=async a=>{const p=n[a.elementId];if(!p)throw new Error(`No handler registered for ${a.elementId} (job type ${a.type})`);const h=c.get(a.elementId)??a.elementId,l=r==null?void 0:r.current;t({kind:"tool",text:`▶ ${h}`,elementId:a.elementId,turn:l});const _=await p(a,Sr(a,t,l,o));return t({kind:"vars",text:`  ↳ ${Pr(_)}`,elementId:a.elementId,result:_,turn:l}),_});return s}const Cr=/\{\{\s*([A-Za-z][A-Za-z0-9_-]*)\s*\}\}/g;function en(...e){const n=Object.create(null);for(const t of e)if(t)for(const r of Object.keys(t))n[r]=t[r];return n}function St(e){return(e.split("/").pop()??e).replace(/\.[^./]+$/,"")}function Pt(e){return e.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;")}function Dr(e){return Pt(e).replace(/"/g,"&quot;").replace(/\n/g,"&#10;").replace(/\t/g,"&#9;")}function Br(e){return e.replace(/\\/g,"\\\\").replace(/&/g,"&amp;").replace(/"/g,"\\&#34;").replace(/\n/g,"&#10;").replace(/\t/g,"&#9;").replace(/</g,"&lt;").replace(/>/g,"&gt;")}function Lr(e){return JSON.stringify(e).slice(1,-1)}function Rr(e,n){const t=e.lastIndexOf("<",n),r=e.lastIndexOf(">",n);if(t<=r)return"text";const o=e.slice(t,n);if((o.match(/"/g)??[]).length%2===0)return"text";const d=o.lastIndexOf('"');return(o.slice(d+1).match(/&#34;|&quot;/g)??[]).length%2===1?"feel-literal":"attribute"}function Fr(e,n,t="xml"){const r=[],o=new Set;return{result:e.replace(Cr,(d,c,u)=>{const a=c.trim();if(!Object.prototype.hasOwnProperty.call(n,a))return o.has(a)||(o.add(a),r.push(a)),d;const p=n[a];if(t==="json")return Lr(p);const h=Rr(e,u);return h==="feel-literal"?Br(p):h==="attribute"?Dr(p):Pt(p)}),unresolved:r}}function zr(){return{processes:[],diagnostics:[],processId:"",processName:"",tasks:[],agent:null,agents:[],userTasks:[],startFormId:void 0}}function Or(e,n={},t=e.bpmn,r={}){const o=[],s=en(e.templates,r),{result:d,unresolved:c}=Fr(t,s,"xml");for(const g of c)o.push({severity:"warning",message:`Template placeholder "{{${g}}}" has no matching prompt/template content — left in the model as-is, not substituted.`});let u;try{u=yr(d)}catch(g){return o.push({severity:"error",message:g instanceof Error?g.message:String(g)}),{resolvedBpmn:d,model:zr(),handlers:{},forms:{},diagnostics:o,hasErrors:!0}}o.push(...u.diagnostics);const a=u.processes.flatMap(g=>g.tasks),p=new Map(e.handlers.map(g=>[g.elementId,g.source])),h={};for(const g of a){if(g.compound)continue;const I=n[g.elementId]??p.get(g.elementId);if(I===void 0){o.push({severity:"error",elementId:g.elementId,jobType:g.jobType,message:`No handler for "${g.label}" (${g.elementId}, job type "${g.jobType}"). Add a handler for this element, or remove it from the diagram.`});continue}try{h[g.elementId]=Tr(I)}catch(B){o.push({severity:"error",elementId:g.elementId,jobType:g.jobType,message:`"${g.label}" (${g.elementId}): handler code didn't compile — ${B instanceof Error?B.message:String(B)}`})}}const l=new Set(a.map(g=>g.elementId)),_=new Set([...p.keys(),...Object.keys(n)]);for(const g of _)l.has(g)||o.push({severity:"error",elementId:g,message:`Handler "${g}" doesn't match any element in the current diagram — likely orphaned by a rename. Rename it back, or remove the handler.`});const y={},M=e.forms??{},v=(g,I)=>{if(!g)return;const B=M[g];B?y[g]=B:o.push({severity:"error",formId:g,message:`${I} references form "${g}", which has no matching schema.`})};for(const g of u.processes){v(g.startFormId,`The start event of process "${g.processName}"`);for(const I of g.userTasks)v(I.formId,`User task "${I.label}" (${I.elementId})`)}return{resolvedBpmn:d,model:u,handlers:h,forms:y,diagnostics:o,hasErrors:o.some(g=>g.severity==="error")}}function Ur(e){const n=e.indexOf("{");if(n<0)return null;let t=0;for(let r=n;r<e.length;r++)if(e[r]==="{")t++;else if(e[r]==="}"&&(t--,t===0))try{const o=JSON.parse(e.slice(n,r+1));return typeof o=="object"&&o!==null&&!Array.isArray(o)?o:null}catch{return null}return null}function Sn(e,n=220){const t=e.replace(/\s+/g," ").trim();return t.length>n?`${t.slice(0,n-1)}…`:t}function Wn(e){const n=e.arguments??e.args??e.parameters??e.input;return n&&typeof n=="object"&&!Array.isArray(n)?n:{}}function Zn(e){if(!e)return[];const n=e.tool??e.name??e.action;if(typeof n=="string"&&n.trim())return[{name:n.trim(),args:Wn(e)}];const t=e.tools??e.tool_calls??e.toolset??e.actions,r=Array.isArray(t)?t:Object.values(e).find(s=>Array.isArray(s))??[],o=[];for(const s of r)if(typeof s=="string")s.trim()&&o.push({name:s.trim(),args:{}});else if(s&&typeof s=="object"){const d=s,c=d.name??d.tool??d.id??d.function;typeof c=="string"&&c.trim()&&o.push({name:c.trim(),args:Wn(d)})}return o}function $r(e){if(!e)return!1;const n=e.done??e.finished??e.complete;return typeof n=="boolean"?n:typeof n=="string"?n.toLowerCase()==="true":!1}function Kn(e){const n=e.args.length?e.args.map(r=>`      ${r.name} (${r.type}) — ${r.description}`).join(`
`):"      (none)",t=e.documentation||e.label;return`${e.elementId}
    purpose: ${t}
    arguments:
${n}`}function Gr(e,n,t){const r=e.systemPrompt||"You are an agent driving a business process. Use the tools available to you.",o=t[0]??e.tools[0],s=o!=null&&o.args.length?`{${o.args.map(d=>`"${d.name}": "…"`).join(", ")}}`:"{}";return n?`${r}
...
character, with nothing added. When your work is finished, reply exactly
{"done": true} and no tool.`}function Vr(e,n,t,r,o=[],s=[],d=!1){const c=e.userPrompt||"Carry out your task.",u=Object.entries(n).filter(([,p])=>typeof p=="string"&&p.trim().length>0).map(([p,h])=>`  ${p}: ${String(h)}`),a=[c,u.length?`Case data:
${u.join(`
...
`)}async function Yr(e,n,t,r,o,s){let d="";n({kind:"llm",text:"LLM thinking…",key:t,pending:!0,turn:s});const c=await e(r,o,u=>{d+=u,n({kind:"llm",text:`${Sn(d)} ▍`,key:t,pending:!0,turn:s})});return n({kind:"llm",text:Sn(c||d)||"(empty reply)",key:t,pending:!1,turn:s}),c}function Qr(e,n){switch(e){case"number":return typeof n=="number"&&Number.isFinite(n)?{ok:!0,value:n}:typeof n=="string"&&n.trim()!==""&&Number.isFinite(Number(n))?{ok:!0,value:Number(n)}:{ok:!1};case"boolean":return typeof n=="boolean"?{ok:!0,value:n}:typeof n=="string"&&/^(true|false)$/i.test(n.trim())?{ok:!0,value:n.trim().toLowerCase()==="true"}:{ok:!1};default:return typeof n=="object"?{ok:!1}:{ok:!0,value:String(n)}}}function qr(e,n,t){const r={},o=new Map,s=new Map;for(const{tool:d,args:c}of e){const u={};for(const a of d.args){const p=c[a.name];if(!(p!=null&&p!=="")){n({kind:"error",text:`🤖 ${d.elementId}: model supplied no value for "${a.name}"`,turn:t,elementId:d.elementId});continue}const l=o.get(a.name);if(l!==void 0&&l!==d.elementId){n({kind:"error",text:`🤖 argument name collision on "${a.name}": both ${l} and ${d.elementId} declare it — ${l} already claimed it this turn, ${d.elementId}'s value is dropped`,turn:t,elementId:d.elementId});continue}const _=Qr(a.type,p);if(!_.ok){n({kind:"error",text:`🤖 ${d.elementId}: "${a.name}" is declared as ${a.type} but the model supplied ${JSON.stringify(p)} — rejected, not passed through`,turn:t,elementId:d.elementId});continue}r[a.name]=_.value,u[a.name]=_.value,o.set(a.name,d.elementId)}s.set(d.elementId,u)}return{variablesOut:r,forHistory:s}}function Jr(e,n,t,r={}){const{maxNewTokens:o=384,allowRepeats:s=!1,allowMultiToolTurns:d=!1,turnRef:c,requiredTools:u=[],maxEarlyDoneNudges:a=1,maxUnproductiveTurns:p=3}=r;let h=0;const l=new Set,_=[];let y=0,M=[],v=[];return async g=>{const I=g.variables,B=I.toolCallResult;B!==void 0&&_.length&&(_[_.length-1]=`${_[_.length-1]} → ${Sn(JSON.stringify(B),160)}`);let O=0;for(;;){const Z=await oe();if(Z)return Z;if(O+=1,O>=p)return t({kind:"error",text:`🤖 ${O} turns in a row activated nothing — completing the agent. The model has lost the reply format; whatever it has already run stands.`,turn:h}),{completionConditionFulfilled:!0}}async function oe(){if(h+=1,c&&(c.current=h),h>e.maxModelCalls)return t({kind:"error",text:`Turn budget spent (maxModelCalls=${e.maxModelCalls}) — completing the agent.`,turn:h}),{completionConditionFulfilled:!0};const Z=s?e.tools:e.tools.filter(N=>!l.has(N.elementId));if(Z.length===0)return t({kind:"agent",text:"🤖 every tool has run — completing the agent",turn:h}),{completionConditionFulfilled:!0};const Ne=[{role:"system",content:Gr(e,d,Z)},{role:"user",content:Vr(e,I,_,Z,M,v,s)}];M=[],v=[];let Ee;try{Ee=await Yr(n,t,`llm-turn-${h}`,Ne,o,h)}catch(N){return t({kind:"error",text:`LLM call failed: ${N instanceof Error?N.message:String(N)} — completing the agent.`,turn:h}),{completionConditionFulfilled:!0}}const ye=Ur(Ee);if($r(ye)&&Zn(ye).length===0){const N=u.filter(U=>!l.has(U));return N.length&&y<a?(y+=1,M=N,t({kind:"agent",text:`🤖 model says it is done, but ${N.join(", ")} hasn't run — asking once more`,turn:h}),null):(t({kind:"agent",text:"🤖 model says it is done",turn:h}),{completionConditionFulfilled:!0})}const ke=Zn(ye);if(ke.length===0)return t({kind:"error",text:"🤖 model named no tool (and didn't say it was done) — asking again",turn:h}),v=['it named no tool and did not say it was done — reply with {"tool": "...", "arguments": {...}} or {"done": true}'],null;const $=[],ae=[],Q=[];for(const N of ke){const U=e.tools.find(G=>G.elementId===N.name);if(!U){ae.push(N.name);continue}if(!s&&l.has(U.elementId)){Q.push(U.elementId);continue}$.push({tool:U,args:N.args})}if(ae.length&&t({kind:"error",text:`🤖 model named a tool that doesn't exist: ${ae.join(", ")} — nothing activated`,turn:h}),Q.length&&t({kind:"error",text:`🤖 model asked to re-run ${Q.join(", ")} — skipped (already run)`,turn:h}),$.length===0)return t({kind:"agent",text:"🤖 nothing activated — asking again",turn:h}),v=[...ae.length?[`${ae.join(", ")} ${ae.length===1?"is":"are"} not a real tool`]:[],...Q.length?[`${Q.join(", ")} has already run and will never run again — pick a different tool, or reply {"done": true} if nothing is left to do`]:[]],null;const{variablesOut:T,forHistory:j}=qr($,t,h);for(const{tool:N}of $)l.add(N.elementId),_.push(`- ${N.elementId}(${JSON.stringify(j.get(N.elementId))})`);for(const{tool:N}of $)t({kind:"agent",text:`🤖 calling ${N.elementId}`,turn:h,elementId:N.elementId,args:j.get(N.elementId)??{}});return{activateElements:$.map(N=>({elementId:N.tool.elementId})),variables:T}}}}function Hr(e,n,t,r={}){const o=new Map(e.map(s=>[s.elementId,Jr(s,n,t,r)]));return async s=>{const d=o.get(s.elementId);if(!d)throw new Error(`No agent host registered for "${s.elementId}"`);return d(s)}}class Pn{__destroy_into_raw(){const n=this.__wbg_ptr;return this.__wbg_ptr=0,Xn.unregister(this),n}free(){const n=this.__destroy_into_raw();m.__wbg_testengine_free(n,0)}activateJobs(n,t,r,o){let s,d;try{const _=m.__wbindgen_add_to_stack_pointer(-16),y=A(n,m.__wbindgen_export,m.__wbindgen_export2),M=S,v=A(o,m.__wbindgen_export,m.__wbindgen_export2),g=S;m.testengine_activateJobs(_,this.__wbg_ptr,y,M,t,r,v,g);var c=f().getInt32(_+0,!0),u=f().getInt32(_+4,!0),a=f().getInt32(_+8,!0),p=f().getInt32(_+12,!0),h=c,l=u;if(p)throw h=0,l=0,z(a);return s=h,d=l,F(h,l)}finally{m.__wbindgen_add_to_stack_pointer(16),m.__wbindgen_export3(s,d,1)}}advanceTime(n){let t,r;try{const p=m.__wbindgen_add_to_stack_pointer(-16);m.testengine_advanceTime(p,this.__wbg_ptr,n);var o=f().getInt32(p+0,!0),s=f().getInt32(p+4,!0),d=f().getInt32(p+8,!0),c=f().getInt32(p+12,!0),u=o,a=s;if(c)throw u=0,a=0,z(d);return t=u,r=a,F(u,a)}finally{m.__wbindgen_add_to_stack_pointer(16),m.__wbindgen_export3(t,r,1)}}assignUserTask(n,t,r){let o,s;try{const l=m.__wbindgen_add_to_stack_pointer(-16),_=A(n,m.__wbindgen_export,m.__wbindgen_export2),y=S,M=A(t,m.__wbindgen_export,m.__wbindgen_export2),v=S;m.testengine_assignUserTask(l,this.__wbg_ptr,_,y,M,v,r);var d=f().getInt32(l+0,!0),c=f().getInt32(l+4,!0),u=f().getInt32(l+8,!0),a=f().getInt32(l+12,!0),p=d,h=c;if(a)throw p=0,h=0,z(u);return o=p,s=h,F(p,h)}finally{m.__wbindgen_add_to_stack_pointer(16),m.__wbindgen_export3(o,s,1)}}broadcastSignal(n,t){let r,o;try{const h=m.__wbindgen_add_to_stack_pointer(-16),l=A(n,m.__wbindgen_export,m.__wbindgen_export2),_=S,y=A(t,m.__wbindgen_export,m.__wbindgen_export2),M=S;m.testengine_broadcastSignal(h,this.__wbg_ptr,l,_,y,M);var s=f().getInt32(h+0,!0),d=f().getInt32(h+4,!0),c=f().getInt32(h+8,!0),u=f().getInt32(h+12,!0),a=s,p=d;if(u)throw a=0,p=0,z(c);return r=a,o=p,F(a,p)}finally{m.__wbindgen_add_to_stack_pointer(16),m.__wbindgen_export3(r,o,1)}}cancelInstance(n){let t,r;try{const p=m.__wbindgen_add_to_stack_pointer(-16),h=A(n,m.__wbindgen_export,m.__wbindgen_export2),l=S;m.testengine_cancelInstance(p,this.__wbg_ptr,h,l);var o=f().getInt32(p+0,!0),s=f().getInt32(p+4,!0),d=f().getInt32(p+8,!0),c=f().getInt32(p+12,!0),u=o,a=s;if(c)throw u=0,a=0,z(d);return t=u,r=a,F(u,a)}finally{m.__wbindgen_add_to_stack_pointer(16),m.__wbindgen_export3(t,r,1)}}completeAgentJob(n,t,r){let o,s;try{const l=m.__wbindgen_add_to_stack_pointer(-16),_=A(n,m.__wbindgen_export,m.__wbindgen_export2),y=S,M=A(t,m.__wbindgen_export,m.__wbindgen_export2),v=S,g=A(r,m.__wbindgen_export,m.__wbindgen_export2),I=S;m.testengine_completeAgentJob(l,this.__wbg_ptr,_,y,M,v,g,I);var d=f().getInt32(l+0,!0),c=f().getInt32(l+4,!0),u=f().getInt32(l+8,!0),a=f().getInt32(l+12,!0),p=d,h=c;if(a)throw p=0,h=0,z(u);return o=p,s=h,F(p,h)}finally{m.__wbindgen_add_to_stack_pointer(16),m.__wbindgen_export3(o,s,1)}}completeJob(n,t){let r,o;try{const h=m.__wbindgen_add_to_stack_pointer(-16),l=A(n,m.__wbindgen_export,m.__wbindgen_export2),_=S,y=A(t,m.__wbindgen_export,m.__wbindgen_export2),M=S;m.testengine_completeJob(h,this.__wbg_ptr,l,_,y,M);var s=f().getInt32(h+0,!0),d=f().getInt32(h+4,!0),c=f().getInt32(h+8,!0),u=f().getInt32(h+12,!0),a=s,p=d;if(u)throw a=0,p=0,z(c);return r=a,o=p,F(a,p)}finally{m.__wbindgen_add_to_stack_pointer(16),m.__wbindgen_export3(r,o,1)}}completeUserTask(n,t){let r,o;try{const h=m.__wbindgen_add_to_stack_pointer(-16),l=A(n,m.__wbindgen_export,m.__wbindgen_export2),_=S,y=A(t,m.__wbindgen_export,m.__wbindgen_export2),M=S;m.testengine_completeUserTask(h,this.__wbg_ptr,l,_,y,M);var s=f().getInt32(h+0,!0),d=f().getInt32(h+4,!0),c=f().getInt32(h+8,!0),u=f().getInt32(h+12,!0),a=s,p=d;if(u)throw a=0,p=0,z(c);return r=a,o=p,F(a,p)}finally{m.__wbindgen_add_to_stack_pointer(16),m.__wbindgen_export3(r,o,1)}}correlateMessage(n,t,r){let o,s;try{const l=m.__wbindgen_add_to_stack_pointer(-16),_=A(n,m.__wbindgen_export,m.__wbindgen_export2),y=S,M=A(t,m.__wbindgen_export,m.__wbindgen_export2),v=S,g=A(r,m.__wbindgen_export,m.__wbindgen_export2),I=S;m.testengine_correlateMessage(l,this.__wbg_ptr,_,y,M,v,g,I);var d=f().getInt32(l+0,!0),c=f().getInt32(l+4,!0),u=f().getInt32(l+8,!0),a=f().getInt32(l+12,!0),p=d,h=c;if(a)throw p=0,h=0,z(u);return o=p,s=h,F(p,h)}finally{m.__wbindgen_add_to_stack_pointer(16),m.__wbindgen_export3(o,s,1)}}createInstance(n,t,r){let o,s;try{const l=m.__wbindgen_add_to_stack_pointer(-16),_=A(n,m.__wbindgen_export,m.__wbindgen_export2),y=S,M=A(t,m.__wbindgen_export,m.__wbindgen_export2),v=S;m.testengine_createInstance(l,this.__wbg_ptr,_,y,M,v,ei(r)?Number.MAX_SAFE_INTEGER:r>>0);var d=f().getInt32(l+0,!0),c=f().getInt32(l+4,!0),u=f().getInt32(l+8,!0),a=f().getInt32(l+12,!0),p=d,h=c;if(a)throw p=0,h=0,z(u);return o=p,s=h,F(p,h)}finally{m.__wbindgen_add_to_stack_pointer(16),m.__wbindgen_export3(o,s,1)}}debugClear(){m.testengine_debugClear(this.__wbg_ptr)}debugCreateInstance(n,t,r){let o,s;try{const l=m.__wbindgen_add_to_stack_pointer(-16),_=A(n,m.__wbindgen_export,m.__wbindgen_export2),y=S,M=A(t,m.__wbindgen_export,m.__wbindgen_export2),v=S,g=A(r,m.__wbindgen_export,m.__wbindgen_export2),I=S;m.testengine_debugCreateInstance(l,this.__wbg_ptr,_,y,M,v,g,I);var d=f().getInt32(l+0,!0),c=f().getInt32(l+4,!0),u=f().getInt32(l+8,!0),a=f().getInt32(l+12,!0),p=d,h=c;if(a)throw p=0,h=0,z(u);return o=p,s=h,F(p,h)}finally{m.__wbindgen_add_to_stack_pointer(16),m.__wbindgen_export3(o,s,1)}}get debugIsPaused(){return m.testengine_debugIsPaused(this.__wbg_ptr)!==0}debugResume(){let n,t;try{const a=m.__wbindgen_add_to_stack_pointer(-16);m.testengine_debugResume(a,this.__wbg_ptr);var r=f().getInt32(a+0,!0),o=f().getInt32(a+4,!0),s=f().getInt32(a+8,!0),d=f().getInt32(a+12,!0),c=r,u=o;if(d)throw c=0,u=0,z(s);return n=c,t=u,F(c,u)}finally{m.__wbindgen_add_to_stack_pointer(16),m.__wbindgen_export3(n,t,1)}}debugStep(){let n,t;try{const a=m.__wbindgen_add_to_stack_pointer(-16);m.testengine_debugStep(a,this.__wbg_ptr);var r=f().getInt32(a+0,!0),o=f().getInt32(a+4,!0),s=f().getInt32(a+8,!0),d=f().getInt32(a+12,!0),c=r,u=o;if(d)throw c=0,u=0,z(s);return n=c,t=u,F(c,u)}finally{m.__wbindgen_add_to_stack_pointer(16),m.__wbindgen_export3(n,t,1)}}deploy(n){let t,r;try{const p=m.__wbindgen_add_to_stack_pointer(-16),h=A(n,m.__wbindgen_export,m.__wbindgen_export2),l=S;m.testengine_deploy(p,this.__wbg_ptr,h,l);var o=f().getInt32(p+0,!0),s=f().getInt32(p+4,!0),d=f().getInt32(p+8,!0),c=f().getInt32(p+12,!0),u=o,a=s;if(c)throw u=0,a=0,z(d);return t=u,r=a,F(u,a)}finally{m.__wbindgen_add_to_stack_pointer(16),m.__wbindgen_export3(t,r,1)}}deployForm(n){let t,r;try{const p=m.__wbindgen_add_to_stack_pointer(-16),h=A(n,m.__wbindgen_export,m.__wbindgen_export2),l=S;m.testengine_deployForm(p,this.__wbg_ptr,h,l);var o=f().getInt32(p+0,!0),s=f().getInt32(p+4,!0),d=f().getInt32(p+8,!0),c=f().getInt32(p+12,!0),u=o,a=s;if(c)throw u=0,a=0,z(d);return t=u,r=a,F(u,a)}finally{m.__wbindgen_add_to_stack_pointer(16),m.__wbindgen_export3(t,r,1)}}deployResource(n,t){let r,o;try{const h=m.__wbindgen_add_to_stack_pointer(-16),l=A(n,m.__wbindgen_export,m.__wbindgen_export2),_=S,y=A(t,m.__wbindgen_export,m.__wbindgen_export2),M=S;m.testengine_deployResource(h,this.__wbg_ptr,l,_,y,M);var s=f().getInt32(h+0,!0),d=f().getInt32(h+4,!0),c=f().getInt32(h+8,!0),u=f().getInt32(h+12,!0),a=s,p=d;if(u)throw a=0,p=0,z(c);return r=a,o=p,F(a,p)}finally{m.__wbindgen_add_to_stack_pointer(16),m.__wbindgen_export3(r,o,1)}}events(){let n,t;try{const a=m.__wbindgen_add_to_stack_pointer(-16);m.testengine_events(a,this.__wbg_ptr);var r=f().getInt32(a+0,!0),o=f().getInt32(a+4,!0),s=f().getInt32(a+8,!0),d=f().getInt32(a+12,!0),c=r,u=o;if(d)throw c=0,u=0,z(s);return n=c,t=u,F(c,u)}finally{m.__wbindgen_add_to_stack_pointer(16),m.__wbindgen_export3(n,t,1)}}failJob(n,t,r){let o,s;try{const l=m.__wbindgen_add_to_stack_pointer(-16),_=A(n,m.__wbindgen_export,m.__wbindgen_export2),y=S,M=A(r,m.__wbindgen_export,m.__wbindgen_export2),v=S;m.testengine_failJob(l,this.__wbg_ptr,_,y,t,M,v);var d=f().getInt32(l+0,!0),c=f().getInt32(l+4,!0),u=f().getInt32(l+8,!0),a=f().getInt32(l+12,!0),p=d,h=c;if(a)throw p=0,h=0,z(u);return o=p,s=h,F(p,h)}finally{m.__wbindgen_add_to_stack_pointer(16),m.__wbindgen_export3(o,s,1)}}migrate(n,t,r){let o,s;try{const l=m.__wbindgen_add_to_stack_pointer(-16),_=A(n,m.__wbindgen_export,m.__wbindgen_export2),y=S,M=A(t,m.__wbindgen_export,m.__wbindgen_export2),v=S,g=A(r,m.__wbindgen_export,m.__wbindgen_export2),I=S;m.testengine_migrate(l,this.__wbg_ptr,_,y,M,v,g,I);var d=f().getInt32(l+0,!0),c=f().getInt32(l+4,!0),u=f().getInt32(l+8,!0),a=f().getInt32(l+12,!0),p=d,h=c;if(a)throw p=0,h=0,z(u);return o=p,s=h,F(p,h)}finally{m.__wbindgen_add_to_stack_pointer(16),m.__wbindgen_export3(o,s,1)}}modify(n,t,r){let o,s;try{const l=m.__wbindgen_add_to_stack_pointer(-16),_=A(n,m.__wbindgen_export,m.__wbindgen_export2),y=S,M=A(t,m.__wbindgen_export,m.__wbindgen_export2),v=S,g=A(r,m.__wbindgen_export,m.__wbindgen_export2),I=S;m.testengine_modify(l,this.__wbg_ptr,_,y,M,v,g,I);var d=f().getInt32(l+0,!0),c=f().getInt32(l+4,!0),u=f().getInt32(l+8,!0),a=f().getInt32(l+12,!0),p=d,h=c;if(a)throw p=0,h=0,z(u);return o=p,s=h,F(p,h)}finally{m.__wbindgen_add_to_stack_pointer(16),m.__wbindgen_export3(o,s,1)}}constructor(){const n=m.testengine_new();return this.__wbg_ptr=n,Xn.register(this,this.__wbg_ptr,this),this}get now(){return m.testengine_now(this.__wbg_ptr)}reset(){m.testengine_reset(this.__wbg_ptr)}resolveIncident(n){let t,r;try{const p=m.__wbindgen_add_to_stack_pointer(-16),h=A(n,m.__wbindgen_export,m.__wbindgen_export2),l=S;m.testengine_resolveIncident(p,this.__wbg_ptr,h,l);var o=f().getInt32(p+0,!0),s=f().getInt32(p+4,!0),d=f().getInt32(p+8,!0),c=f().getInt32(p+12,!0),u=o,a=s;if(c)throw u=0,a=0,z(d);return t=u,r=a,F(u,a)}finally{m.__wbindgen_add_to_stack_pointer(16),m.__wbindgen_export3(t,r,1)}}setVariables(n,t,r){let o,s;try{const l=m.__wbindgen_add_to_stack_pointer(-16),_=A(n,m.__wbindgen_export,m.__wbindgen_export2),y=S,M=A(t,m.__wbindgen_export,m.__wbindgen_export2),v=S;m.testengine_setVariables(l,this.__wbg_ptr,_,y,M,v,r);var d=f().getInt32(l+0,!0),c=f().getInt32(l+4,!0),u=f().getInt32(l+8,!0),a=f().getInt32(l+12,!0),p=d,h=c;if(a)throw p=0,h=0,z(u);return o=p,s=h,F(p,h)}finally{m.__wbindgen_add_to_stack_pointer(16),m.__wbindgen_export3(o,s,1)}}snapshot(){let n,t;try{const a=m.__wbindgen_add_to_stack_pointer(-16);m.testengine_snapshot(a,this.__wbg_ptr);var r=f().getInt32(a+0,!0),o=f().getInt32(a+4,!0),s=f().getInt32(a+8,!0),d=f().getInt32(a+12,!0),c=r,u=o;if(d)throw c=0,u=0,z(s);return n=c,t=u,F(c,u)}finally{m.__wbindgen_add_to_stack_pointer(16),m.__wbindgen_export3(n,t,1)}}throwError(n,t,r){let o,s;try{const l=m.__wbindgen_add_to_stack_pointer(-16),_=A(n,m.__wbindgen_export,m.__wbindgen_export2),y=S,M=A(t,m.__wbindgen_export,m.__wbindgen_export2),v=S,g=A(r,m.__wbindgen_export,m.__wbindgen_export2),I=S;m.testengine_throwError(l,this.__wbg_ptr,_,y,M,v,g,I);var d=f().getInt32(l+0,!0),c=f().getInt32(l+4,!0),u=f().getInt32(l+8,!0),a=f().getInt32(l+12,!0),p=d,h=c;if(a)throw p=0,h=0,z(u);return o=p,s=h,F(p,h)}finally{m.__wbindgen_add_to_stack_pointer(16),m.__wbindgen_export3(o,s,1)}}tickNow(n){let t,r;try{const p=m.__wbindgen_add_to_stack_pointer(-16);m.testengine_tickNow(p,this.__wbg_ptr,n);var o=f().getInt32(p+0,!0),s=f().getInt32(p+4,!0),d=f().getInt32(p+8,!0),c=f().getInt32(p+12,!0),u=o,a=s;if(c)throw u=0,a=0,z(d);return t=u,r=a,F(u,a)}finally{m.__wbindgen_add_to_stack_pointer(16),m.__wbindgen_export3(t,r,1)}}unassignUserTask(n){let t,r;try{const p=m.__wbindgen_add_to_stack_pointer(-16),h=A(n,m.__wbindgen_export,m.__wbindgen_export2),l=S;m.testengine_unassignUserTask(p,this.__wbg_ptr,h,l);var o=f().getInt32(p+0,!0),s=f().getInt32(p+4,!0),d=f().getInt32(p+8,!0),c=f().getInt32(p+12,!0),u=o,a=s;if(c)throw u=0,a=0,z(d);return t=u,r=a,F(u,a)}finally{m.__wbindgen_add_to_stack_pointer(16),m.__wbindgen_export3(t,r,1)}}updateRetries(n,t){let r,o;try{const h=m.__wbindgen_add_to_stack_pointer(-16),l=A(n,m.__wbindgen_export,m.__wbindgen_export2),_=S;m.testengine_updateRetries(h,this.__wbg_ptr,l,_,t);var s=f().getInt32(h+0,!0),d=f().getInt32(h+4,!0),c=f().getInt32(h+8,!0),u=f().getInt32(h+12,!0),a=s,p=d;if(u)throw a=0,p=0,z(c);return r=a,o=p,F(a,p)}finally{m.__wbindgen_add_to_stack_pointer(16),m.__wbindgen_export3(r,o,1)}}updateUserTask(n,t){let r,o;try{const h=m.__wbindgen_add_to_stack_pointer(-16),l=A(n,m.__wbindgen_export,m.__wbindgen_export2),_=S,y=A(t,m.__wbindgen_export,m.__wbindgen_export2),M=S;m.testengine_updateUserTask(h,this.__wbg_ptr,l,_,y,M);var s=f().getInt32(h+0,!0),d=f().getInt32(h+4,!0),c=f().getInt32(h+8,!0),u=f().getInt32(h+12,!0),a=s,p=d;if(u)throw a=0,p=0,z(c);return r=a,o=p,F(a,p)}finally{m.__wbindgen_add_to_stack_pointer(16),m.__wbindgen_export3(r,o,1)}}}Symbol.dispose&&(Pn.prototype[Symbol.dispose]=Pn.prototype.free);function Wr(){return{__proto__:null,"./nanobpmn_engine_bg.js":{__proto__:null,__wbg___wbindgen_throw_bb96b2010945f0bc:function(n,t){throw new Error(F(n,t))},__wbindgen_cast_0000000000000001:function(n,t){const r=F(n,t);return Zr(r)},__wbindgen_object_drop_ref:function(n){z(n)}}}}const Xn=typeof FinalizationRegistry>"u"?{register:()=>{},unregister:()=>{}}:new FinalizationRegistry(e=>m.__wbg_testengine_free(e,1));function Zr(e){Ke===De.length&&De.push(De.length+1);const n=Ke;return Ke=De[n],De[n]=e,n}function Kr(e){e<1028||(De[e]=Ke,Ke=e)}let ze=null;function f(){return(ze===null||ze.buffer.detached===!0||ze.buffer.detached===void 0&&ze.buffer!==m.memory.buffer)&&(ze=new DataView(m.memory.buffer)),ze}function F(e,n){return ti(e>>>0,n)}let Ze=null;function ln(){return(Ze===null||Ze.byteLength===0)&&(Ze=new Uint8Array(m.memory.buffer)),Ze}function Xr(e){return De[e]}let De=new Array(1024).fill(void 0);De.push(void 0,null,!0,!1);let Ke=De.length;function ei(e){return e==null}function A(e,n,t){if(t===void 0){const c=Xe.encode(e),u=n(c.length,1)>>>0;return ln().subarray(u,u+c.length).set(c),S=c.length,u}let r=e.length,o=n(r,1)>>>0;const s=ln();let d=0;for(;d<r;d++){const c=e.charCodeAt(d);if(c>127)break;s[o+d]=c}if(d!==r){d!==0&&(e=e.slice(d)),o=t(o,r,r=d+e.length*3,1)>>>0;const c=ln().subarray(o+d,o+r),u=Xe.encodeInto(e,c);d+=u.written,o=t(o,r,d,1)>>>0}return S=d,o}function z(e){const n=Xr(e);return Kr(e),n}let cn=new TextDecoder("utf-8",{ignoreBOM:!0,fatal:!0});cn.decode();const ni=2146435072;let yn=0;function ti(e,n){return yn+=n,yn>=ni&&(cn=new TextDecoder("utf-8",{ignoreBOM:!0,fatal:!0}),cn.decode(),yn=n),cn.decode(ln().subarray(e,e+n))}const Xe=new TextEncoder;"encodeInto"in Xe||(Xe.encodeInto=function(e,n){const t=Xe.encode(e);return n.set(t),{read:e.length,written:t.length}});let S=0,m;function ri(e,n){return m=e.exports,ze=null,Ze=null,m}async function ii(e,n){if(typeof Response=="function"&&e instanceof Response){if(!e.ok)throw new Error(`failed to fetch Wasm: ${e.status} ${e.statusText} fetching '${e.url}'`);if(typeof WebAssembly.instantiateStreaming=="function")try{return await WebAssembly.instantiateStreaming(e,n)}catch(o){if(t(e.type)&&e.headers.get("Content-Type")!=="application/wasm")console.warn("`WebAssembly.instantiateStreaming` failed because your server does not serve Wasm with `application/wasm` MIME type. Falling back to `WebAssembly.instantiate` which is slower. Original error:\n",o);else throw o}const r=await e.arrayBuffer();return await WebAssembly.instantiate(r,n)}else{const r=await WebAssembly.instantiate(e,n);return r instanceof WebAssembly.Instance?{instance:r,module:e}:r}function t(r){switch(r){case"basic":case"cors":case"default":return!0}return!1}}async function oi(e){if(m!==void 0)return m;e!==void 0&&(Object.getPrototypeOf(e)===Object.prototype?{module_or_path:e}=e:console.warn("using deprecated parameters for the initialization function; pass a single object instead")),e===void 0&&(e=new URL("/pr-preview/pr-108/assets/nanobpmn_engine_bg-DRNrIVE8.wasm",import.meta.url));const n=Wr();(typeof e=="string"||typeof Request=="function"&&e instanceof Request||typeof URL=="function"&&e instanceof URL)&&(e=fetch(e));const{instance:t,module:r}=await ii(await e,n);return ri(t)}let sn=null;function ai(e){return sn||(sn=oi(void 0).then(()=>{}).catch(n=>{throw sn=null,n})),sn}function ne(e){return JSON.parse(e)}class si{constructor(n){L(this,"engine");this.engine=n}deploy(n){return JSON.parse(this.engine.deploy(n))}createInstance(n,t){return ne(this.engine.createInstance(n,t||"{}"))}activateJobs(n,t,r,o){return JSON.parse(this.engine.activateJobs(n,t,r,o))}completeJob(n,t){return ne(this.engine.completeJob(n,t||"{}"))}completeAgentJob(n,t){const{variables:r,...o}=t??{};return ne(this.engine.completeAgentJob(n,JSON.stringify(r??{}),JSON.stringify(o??{})))}failJob(n,t,r){return ne(this.engine.failJob(n,t,r))}throwError(n,t,r){return ne(this.engine.throwError(n,t,r))}updateRetries(n,t){return ne(this.engine.updateRetries(n,t))}resolveIncident(n){return ne(this.engine.resolveIncident(n))}setVariables(n,t,r){return ne(this.engine.setVariables(n,t||"{}",r))}broadcastSignal(n,t){return ne(this.engine.broadcastSignal(n,t||"{}"))}cancelInstance(n){return ne(this.engine.cancelInstance(n))}modify(n,t,r){return ne(this.engine.modify(n,JSON.stringify(t??[]),JSON.stringify(r??[])))}completeUserTask(n,t){return ne(this.engine.completeUserTask(n,t||"{}"))}assignUserTask(n,t,r){return ne(this.engine.assignUserTask(n,t,r))}unassignUserTask(n){return ne(this.engine.unassignUserTask(n))}updateUserTask(n,t){return ne(this.engine.updateUserTask(n,t||"{}"))}correlateMessage(n,t,r){return ne(this.engine.correlateMessage(n,t,r||"{}"))}advanceTime(n){return ne(this.engine.advanceTime(n))}reset(){this.engine.reset()}events(){return JSON.parse(this.engine.events())}snapshot(){return ne(this.engine.snapshot())}free(){this.engine.free()}}async function di(e){return await ai(),new si(new Pn)}class At extends Error{constructor(t,r){super(t);L(this,"retries");this.name="JobFailure",this.retries=r==null?void 0:r.retries}}function li(e,n=[]){if(e.instances.filter(o=>!o.completed).length===0)return e.totalInstances>0?"completed":"idle";if(e.incidents.length>0)return"incidents";const r=new Set(n);return e.jobs.some(o=>!r.has(o.jobType))?"unhandledJobs":e.userTasks.some(o=>o.state==="Created")?"userTasks":e.timers.length>0?"timers":e.messageSubscriptions.length>0?"messages":e.signalSubscriptions.length>0?"signals":"idle"}function ci(e,n=[]){const t=new Set(n);return[...new Set(e.jobs.map(r=>r.jobType))].filter(r=>!t.has(r)).sort()}async function mi(e,n,t){let r;try{const o=await n(t);r=JSON.stringify(o??{})}catch(o){const s=o instanceof At&&o.retries!==void 0?o.retries:Math.max(0,t.retries-1),d=o instanceof Error?o.message:String(o);e.failJob(t.key,s,d);return}e.completeJob(t.key,r)}async function pi(e,n,t){let r;try{r=await n(t),JSON.stringify(r)}catch(o){const s=o instanceof At&&o.retries!==void 0?o.retries:Math.max(0,t.retries-1),d=o instanceof Error?o.message:String(o);e.failJob(t.key,s,d);return}e.completeAgentJob(t.key,r)}async function ui(e,n,t={}){const r=t.maxJobsPerActivation??10,o=t.lockTimeoutMs??3e4,s=t.worker??"bojtos",d=t.agents??{};for(const l of Object.keys(d))if(l in n)throw new Error(`dispatchRound: job type "${l}" is registered as both a worker and an agent — register it as exactly one`);const c=[];for(const[l,_]of Object.entries(n))for(const y of e.activateJobs(l,r,o,s))c.push({handler:_,job:y});const u=[];for(const[l,_]of Object.entries(d))for(const y of e.activateJobs(l,r,o,s))u.push({handler:_,job:y});for(const{handler:l,job:_}of c)await mi(e,l,_);for(const{handler:l,job:_}of u)await pi(e,l,_);const a=e.snapshot(),p=c.length+u.length;if(p>0)return{snapshot:a,handled:p};const h=[...Object.keys(n),...Object.keys(d)];return{snapshot:a,handled:p,reason:li(a,h),unhandled:ci(a,h)}}function hi({bpmn:e}){const n=b.useRef(null),[t,r]=b.useState("loading"),[o,s]=b.useState(null),[d,c]=b.useState([]),[u,a]=b.useState(null),p=b.useRef(e),h=b.useRef(0),l=b.useRef(null),_=b.useRef(new Map),y=b.useCallback((T,j)=>{_.current.set(T,j)},[]),M=b.useCallback(T=>_.current.get(T),[]),v=b.useCallback((T,j)=>{const N=T.deploy(j);return p.current=j,_.current.clear(),c(N.processIds),a(null),s(null),N.processIds},[]);b.useEffect(()=>{let T=!1;return r("loading"),c([]),a(null),s(null),di().then(j=>{if(T){j.free();return}try{v(j,e)}catch(N){j.free(),s(String(N)),r("error");return}n.current=j,r("ready")}).catch(j=>{T||(s(String(j)),r("error"))}),()=>{var j;T=!0,(j=n.current)==null||j.free(),n.current=null,_.current.clear()}},[e]);const g=b.useCallback(T=>{const j=n.current;if(!j)return null;try{const N=T(j);return a(N),s(null),N}catch(N){return s(String(N)),null}},[]),I=b.useCallback((T,j)=>g(N=>N.createInstance(T,j)),[g]),B=b.useCallback((T,j)=>g(N=>N.completeUserTask(T,j)),[g]),O=b.useCallback(T=>g(j=>j.advanceTime(T)),[g]),oe=b.useCallback((T,j)=>g(N=>N.broadcastSignal(T,j)),[g]);function Z(T,j){const[N]=T.activateJobs(j,1,3e4,"manual-control");if(!N)throw new Error(`No waiting job of type "${j}" to resolve.`);return N}const Ne=b.useCallback((T,j)=>g(N=>{const U=Z(N,T);return N.completeJob(U.key,j)}),[g]),Ee=b.useCallback((T,j,N)=>g(U=>{const G=Z(U,T);return U.throwError(G.key,j,N)}),[g]),ye=b.useCallback((T,j,N)=>g(U=>U.correlateMessage(T,j,N)),[g]),ke=b.useCallback(async(T,j)=>{const N=n.current;if(!N)return null;const U=h.current,G=ui(N,T,j);l.current=G;try{const ge=await G;return n.current!==N||h.current!==U?null:(a(ge.snapshot),s(null),ge)}catch(ge){return n.current!==N||h.current!==U||(a(N.snapshot()),s(String(ge))),null}finally{l.current===G&&(l.current=null)}},[]),$=b.useCallback(async()=>{var T;await((T=l.current)==null?void 0:T.catch(()=>{}))},[]),ae=b.useCallback(async()=>{await $();const T=n.current;if(T){h.current++;try{T.reset(),v(T,p.current)}catch(j){s(String(j))}}},[v,$]),Q=b.useCallback(async T=>{await $();const j=n.current;if(!j)return null;h.current++;try{return j.reset(),v(j,T)}catch(N){return s(String(N)),null}},[v,$]);return{phase:t,error:o,processIds:d,snapshot:u,createInstance:I,stepWorkers:ke,completeUserTask:B,advanceTime:O,broadcastSignal:oe,completeJobManually:Ne,throwJobError:Ee,correlateMessage:ye,reset:ae,redeploy:Q,setRunImage:y,getRunImage:M}}function gi(e,n){return e.slice(n)}function bi(e,n,t,r){const o=e.snapshot,s="⏸ waiting for a human — complete the task below to continue",d=o.userTasks.some(c=>c.state==="Created");if(e.handled>0){const c=o.activeElementIds.map(t),u=n.length?` via ${n.map(a=>`${t(a.from)} → ${t(a.to)}`).join(", ")}`:"";return o.completedInstances>=1?{kind:"done",text:`⏭ round handled ${e.handled} job${e.handled===1?"":"s"}${u} — ✅ process instance completed`}:d?{kind:"human",text:`⏭ round handled ${e.handled} job${e.handled===1?"":"s"}${u} — ${s}`}:{kind:"step",text:`⏭ round handled ${e.handled} job${e.handled===1?"":"s"}${u} — now at ${c.length?c.join(", "):"—"}`}}switch(e.reason){case"completed":return{kind:"done",text:"✅ process instance completed"};case"userTasks":return{kind:"human",text:s};case"timers":return{kind:"step",text:"⏱ waiting on a timer — advance the clock to continue"};case"messages":return{kind:"step",text:"✉ waiting on a message — correlate it to continue"};case"signals":return{kind:"step",text:"📶 waiting on a signal — broadcast it to continue"};case"incidents":return{kind:"error",text:"A job failed — incident on the diagram"};case"unhandledJobs":{const c=e.unhandled??[];return r&&c.length>0&&c.every(u=>r.has(u))?{kind:"human",text:s}:{kind:"error",text:`⏭ waiting on job type(s) with no worker registered: ${c.join(", ")}`}}case"idle":return{kind:"step",text:"Nothing to step — no instance is running."};default:return{kind:"step",text:e.reason?`Step blocked on an unrecognized reason: ${e.reason}`:"Nothing to step — no instance is running."}}}const _i="the Scripted or Endpoint brain";async function pn(e=_i){const n=navigator.gpu;if(!n)return`This browser doesn't expose WebGPU at all. Use a recent Chrome, Edge, or Safari 17+ with hardware acceleration on, or pick ${e}.`;let t;try{t=await n.requestAdapter()}catch(r){return`WebGPU adapter request failed (${r instanceof Error?r.message:String(r)}). Try ${e} instead.`}return t?null:`This browser supports the WebGPU API, but no GPU adapter is available — hardware acceleration may be off, or this device/VM has no usable GPU. Pick ${e} instead.`}const fi=[{id:"Qwen2.5-1.5B-Instruct-q4f16_1-MLC",label:"Qwen2.5 1.5B",downloadLabel:"~1.0 GB"},{id:"SmolLM2-1.7B-Instruct-q4f16_1-MLC",label:"SmolLM2 1.7B",downloadLabel:"~1.1 GB"},{id:"Llama-3.2-1B-Instruct-q4f16_1-MLC",label:"Llama 3.2 1B",downloadLabel:"~0.7 GB"},{id:"gemma-2-2b-it-q4f16_1-MLC",label:"Gemma 2 2B",downloadLabel:"~1.5 GB"},{id:"Llama-3.2-1B-Instruct-q4f32_1-MLC",label:"Llama 3.2 1B (f32, wider GPU support)",downloadLabel:"~1.1 GB"},{id:"SmolLM2-360M-Instruct-q4f32_1-MLC",label:"SmolLM2 360M (tiny, f32)",downloadLabel:"~0.6 GB"},{id:"SmolLM2-360M-Instruct-q4f16_1-MLC",label:"SmolLM2 360M (tiny)",downloadLabel:"~0.3 GB"}];function Ct(e){return An.get(e)??{}}const An=new Map;async function wi(){if(An.size>0)return;const{prebuiltAppConfig:e}=await he(async()=>{const{prebuiltAppConfig:n}=await import("./vendor-webllm-DT0Ab8E6.js");return{prebuiltAppConfig:n}},[]);for(const n of e.model_list)An.set(n.model_id,{vramRequiredMB:n.vram_required_MB,requiredFeatures:n.required_features})}const bn=fi.map(e=>({id:e.id,label:`${e.label} (${e.downloadLabel})`,downloadLabel:e.downloadLabel,...Ct(e.id)})),Dt=bn[0].id;async function yi(){return await wi(),bn.map(e=>({...e,...Ct(e.id)}))}function Bt(){const e=navigator.deviceMemory;return typeof e=="number"?e*1024:null}function vi(e,n=Bt()){return n==null||e.vramRequiredMB==null||n>=e.vramRequiredMB?null:`${e.label} needs roughly ${Math.round(e.vramRequiredMB)} MB of GPU memory; this device looks like it has about ${Math.round(n)} MB available. It may still work, but expect it to fail or fall back to slow shared memory — try a smaller model (e.g. SmolLM2 360M) if it doesn't load.`}async function Mi(e){try{const{hasModelInCache:n}=await he(async()=>{const{hasModelInCache:t}=await import("./vendor-webllm-DT0Ab8E6.js");return{hasModelInCache:t}},[]);return await n(e)}catch{return!1}}function un(e){return/device (was )?lost|device_hung|device_removed|already been disposed|gpudevicelostinfo/i.test(e)}function et(){return"The GPU device was lost — the driver reset while the model was loading or running. This is a browser/driver-level failure, not a problem with the model: fully quit and reopen the browser (a lost device usually persists for the life of the GPU process), check chrome://gpu still reports hardware acceleration, and update your GPU driver if it recurs. The Scripted and Endpoint brains don't use the GPU at all."}class dn{constructor(){L(this,"kind","browser");L(this,"model",null);L(this,"engine",null);L(this,"worker",null);L(this,"generation",0);L(this,"chat",async(n,t=512,r)=>{var s,d;const o=this.engine;if(!o||!this.model)throw new Error("BrowserBrain.chat called before connect()");try{const c=await o.chat.completions.create({messages:n,temperature:0,max_tokens:t,stream:!0});let u="";for await(const a of c){const p=((d=(s=a.choices[0])==null?void 0:s.delta)==null?void 0:d.content)??"";p&&(u+=p,r==null||r(p))}return u}catch(c){const u=c instanceof Error?c.message:String(c);throw un(u)?(this.teardown(),new Error(`The in-browser model stopped: ${et()}`)):c}})}async connect(n=Dt,t){var u,a;const r=await pn();if(r)throw new Error(r);if(this.engine&&this.model===n)return n;const o=++this.generation,s=p=>{o===this.generation&&(t==null||t({progress:p.progress??0,text:p.text??""}))};this.teardown();let d,c;try{const{CreateWebWorkerMLCEngine:p}=await he(async()=>{const{CreateWebWorkerMLCEngine:h}=await import("./vendor-webllm-DT0Ab8E6.js");return{CreateWebWorkerMLCEngine:h}},[]);c=new Worker(new URL("/pr-preview/pr-108/assets/webllm.worker-Dc1cCqhL.js",import.meta.url),{type:"module"}),d=await p(c,n,{initProgressCallback:s})}catch(p){if(c==null||c.terminate(),o!==this.generation)throw new Error("cancelled");const h=p instanceof Error?p.message:String(p);if(un(h))throw new Error(`Couldn't load ${n} in the browser (${h}). ${et()}`);const l=(a=(u=bn.find(_=>_.id===n))==null?void 0:u.requiredFeatures)==null?void 0:a.includes("shader-f16");throw new Error(`Couldn't load ${n} in the browser (${h}). `+(l?"This model needs WebGPU with shader-f16; try one of the f32 models in the list, or the endpoint brain.":"Try a smaller model, check your connection, or use the endpoint brain instead."))}if(o!==this.generation)throw d.unload().catch(()=>{}),c==null||c.terminate(),new Error("cancelled");return this.engine=d,this.worker=c??null,this.model=n,n}teardown(){const{engine:n,worker:t}=this;this.engine=null,this.worker=null,this.model=null,n==null||n.unload().catch(()=>{}),t==null||t.terminate()}cancelConnect(){this.generation++}dispose(){this.generation++,this.teardown()}}const Lt="http://localhost:11434/v1";function hn(e,n={hostname:(t=>(t=globalThis.location)==null?void 0:t.hostname)()??"",origin:(r=>(r=globalThis.location)==null?void 0:r.origin)()??""}){let o;try{o=new URL(Rt(e)).hostname}catch{return null}const s=d=>d==="localhost"||d==="127.0.0.1"||d==="::1"||d==="[::1]";return!s(o)||s(n.hostname)?null:`This page is served from ${n.origin||"a non-local origin"}, so it can't reach ${e}. A local model server only accepts requests from a page on localhost. Open this page at http://localhost instead, or use the Scripted or In-browser brain.`}function Rt(e){let n=e.trim().replace(/\/+$/,"");return n.endsWith("/chat/completions")&&(n=n.slice(0,-17)),/\/v\d+$/.test(n)||(n=`${n}/v1`),n}class nt extends Error{constructor(n,t){super(n),this.status=t,this.name="HttpError"}}class tt{constructor(n=Lt,t="",r=""){L(this,"kind","endpoint");L(this,"baseUrl");L(this,"model",null);L(this,"models",[]);L(this,"apiKey");L(this,"requestedModel");L(this,"chat",async(n,t=512,r)=>{var a,p,h;if(!this.model)throw new Error("EndpointBrain.chat called before connect()");const o=await fetch(`${this.baseUrl}/chat/completions`,{method:"POST",headers:this.headers(),body:JSON.stringify({model:this.model,messages:n,temperature:0,max_tokens:t,stream:!0})});if(!o.ok||!o.body){const l=await o.text().catch(()=>"");throw new Error(`chat/completions HTTP ${o.status} ${o.statusText}${l?` — ${l.slice(0,300)}`:""}`)}const s=o.body.getReader(),d=new TextDecoder;let c="",u="";for(;;){const{value:l,done:_}=await s.read();if(_)break;c+=d.decode(l,{stream:!0});let y;for(;(y=c.indexOf(`
`))>=0;){const M=c.slice(0,y).trim();if(c=c.slice(y+1),!M.startsWith("data:"))continue;const v=M.slice(5).trim();if(v==="[DONE]")continue;let g;try{g=JSON.parse(v)}catch{continue}g.model&&(this.model=g.model);const I=(a=g.choices)==null?void 0:a[0],B=((p=I==null?void 0:I.delta)==null?void 0:p.content)??((h=I==null?void 0:I.message)==null?void 0:h.content)??"";B&&(u+=B,r==null||r(B))}}return u});this.baseUrl=Rt(n),this.apiKey=t.trim(),this.requestedModel=r.trim()}headers(){const n={"Content-Type":"application/json"};return this.apiKey&&(n.Authorization=`Bearer ${this.apiKey}`),n}async listModels(){let n;try{n=await fetch(`${this.baseUrl}/models`,{headers:this.headers()})}catch(r){const o=hn(this.baseUrl);throw new Error(o??`Can't reach ${this.baseUrl} (${r instanceof Error?r.message:String(r)}). Is the server running? For Ollama, check the app is up — and if this page is served from another origin, allow it with OLLAMA_ORIGINS.`)}if(!n.ok)throw new nt(`${this.baseUrl}/models returned HTTP ${n.status} ${n.statusText}`,n.status);const t=await n.json();return this.models=(t.data??[]).map(r=>r.id).filter(r=>!!r),this.models}async connect(){try{const n=await this.listModels(),t=this.requestedModel||n[0];if(!t)throw new Error(`No models available at ${this.baseUrl}. Pull one first — e.g. \`ollama pull llama3.2:3b\` — or name one explicitly.`);this.model=t}catch(n){const t=n instanceof nt&&[404,405,501].includes(n.status);if(!this.requestedModel||!t)throw n;this.models=[],this.model=this.requestedModel}return await this.validate(),this.model}async validate(){const n=await fetch(`${this.baseUrl}/chat/completions`,{method:"POST",headers:this.headers(),body:JSON.stringify({model:this.model,messages:[{role:"user",content:"Reply with ok."}],temperature:0,max_tokens:1,stream:!1})}).catch(r=>{throw new Error(`Can't reach ${this.baseUrl}/chat/completions (${r instanceof Error?r.message:String(r)}). Check the endpoint URL, API key, model name, and any local CORS settings.`)});if(!n.ok){const r=await n.text().catch(()=>"");throw new Error(`chat/completions HTTP ${n.status} ${n.statusText}${r?` — ${r.slice(0,300)}`:""}`)}const t=await n.json().catch(()=>({}));t.model&&(this.model=t.model)}dispose(){}}const rt="gemini-nano";function gn(){const e=globalThis.LanguageModel;return typeof(e==null?void 0:e.create)=="function"&&typeof e.availability=="function"?e:null}function xi(){return gn()!==null}async function Ft(){const e=gn();if(!e)return"This browser has no built-in AI model. Chrome's Prompt API (Gemini Nano) needs Chrome 138+ on desktop Windows 10/11, macOS 13+, Linux or a Chromebook Plus. Use the Scripted, In-browser (WebGPU) or API endpoint brain instead.";let n;try{n=await e.availability()}catch(t){return`Chrome couldn't report on its built-in model (${t instanceof Error?t.message:String(t)}).`}return n==="unavailable"?"Chrome exposes the built-in AI API here, but Gemini Nano can't run on this device. Chrome requires ~22 GB free on the volume holding your Chrome profile, and either a GPU with more than 4 GB of VRAM or 16 GB of RAM with 4+ CPU cores. Check chrome://on-device-internals for the details.":null}class it{constructor(){L(this,"kind","chrome");L(this,"model",null);L(this,"warm",null);L(this,"connecting",null);L(this,"chat",async(n,t,r)=>{if(!this.model)throw new Error("ChromeBrain.chat called before connect()");const o=gn();if(!o)throw new Error("Chrome's built-in AI API went away.");const s=n.filter(u=>u.role==="system"),d=n.filter(u=>u.role!=="system"),c=await o.create(s.length?{initialPrompts:s}:void 0);try{const u=c.promptStreaming(d).getReader();let a="";for(;;){const{done:p,value:h}=await u.read();if(p)break;h&&(a+=h,r==null||r(h))}return a}finally{c.destroy()}})}async connect(n){const t=await Ft();if(t)throw new Error(t);const r=gn();this.dispose();const o=new AbortController;this.connecting=o;try{this.warm=await r.create({signal:o.signal,monitor:s=>{s.addEventListener("downloadprogress",d=>{n==null||n({progress:d.loaded,text:"Downloading Gemini Nano"})})}})}catch(s){if(o.signal.aborted)throw new Error("cancelled");const d=s instanceof Error?s.message:String(s);throw new Error(`Chrome couldn't start its built-in model (${d}). The first run downloads Gemini Nano and must be triggered by a click — press Connect again, and check chrome://on-device-internals if it keeps failing.`)}finally{this.connecting=null}return this.model=rt,rt}cancelConnect(){var n;(n=this.connecting)==null||n.abort()}dispose(){var n,t;(n=this.connecting)==null||n.abort(),this.connecting=null,(t=this.warm)==null||t.destroy(),this.warm=null,this.model=null}}const Ni=[{id:"onnx-community/Florence-2-base-ft",label:"Florence-2 base",downloadLabel:"~0.4 GB"},{id:"onnx-community/Florence-2-large-ft",label:"Florence-2 large (higher quality)",downloadLabel:"~1.6 GB"}],zt=Ni.map(e=>({...e,label:`${e.label} (${e.downloadLabel})`})),Ot=zt[0].id,Ei="<OCR>",ot="UNKNOWN (scripted brain — connect the in-browser model to read a photo)";function ki(e,n){if(e)return typeof e=="function"?e(n):e[n]}class Ii{constructor(n){L(this,"kind","scripted-vision");L(this,"model",null);L(this,"read",async(n,t,r)=>{const o=typeof n=="string"?ki(this.lookup,n)??ot:ot;return r==null||r(o),o});this.lookup=n}dispose(){}}function Ti(e){return new Ii(e)}class at{constructor(){L(this,"kind","browser-vision");L(this,"model",null);L(this,"modelHandle",null);L(this,"processor",null);L(this,"loadImage",null);L(this,"generation",0);L(this,"read",async(n,t,r)=>{const o=this.modelHandle,s=this.processor,d=this.loadImage;if(!o||!s||!d||!this.model)throw new Error("BrowserVisionBrain.read called before connect()");const c=t&&t.startsWith("<")?t:Ei,u=await d(n),a=s.construct_prompts(c),p=await s(u,a),h=await o.generate({...p,max_new_tokens:512,num_beams:1,do_sample:!1}),l=s.batch_decode(h,{skip_special_tokens:!1})[0],_=s.post_process_generation(l,c,u.size),y=ji(_,c);return r==null||r(y),y})}async connect(n=Ot,t){var c,u;const r=await pn("the scripted-vision fallback");if(r)throw new Error(r);if(this.modelHandle&&this.model===n)return n;const o=++this.generation,s=a=>{o===this.generation&&(t==null||t({progress:(a.progress??0)/100,text:a.file?`${a.status??"loading"} ${a.file}`:a.status??""}))};this.teardown();let d;try{const{Florence2ForConditionalGeneration:a,AutoProcessor:p,load_image:h}=await he(async()=>{const{Florence2ForConditionalGeneration:y,AutoProcessor:M,load_image:v}=await import("./transformers.web-B4WergNL.js");return{Florence2ForConditionalGeneration:y,AutoProcessor:M,load_image:v}},[]),l=await a.from_pretrained(n,{dtype:"fp32",device:"webgpu",progress_callback:s}),_=await p.from_pretrained(n);d={model:l,processor:_,loadImage:h}}catch(a){if(o!==this.generation)throw new Error("cancelled");const p=a instanceof Error?a.message:String(a);throw new Error(`Couldn't load ${n} in the browser (${p}). Try the smaller Florence-2 base model, check your connection, or use the scripted-vision fallback.`)}if(o!==this.generation)throw Promise.resolve((u=(c=d.model).dispose)==null?void 0:u.call(c)).catch(()=>{}),new Error("cancelled");return this.modelHandle=d.model,this.processor=d.processor,this.loadImage=d.loadImage,this.model=n,n}teardown(){var t;const n=this.modelHandle;this.modelHandle=null,this.processor=null,this.loadImage=null,this.model=null,Promise.resolve((t=n==null?void 0:n.dispose)==null?void 0:t.call(n)).catch(()=>{})}cancelConnect(){this.generation++}dispose(){this.generation++,this.teardown()}}function ji(e,n){const t=e[n];if(typeof t=="string")return t.trim();if(t&&typeof t=="object"){const r=t.labels;return Array.isArray(r)?r.join(" ").trim():JSON.stringify(t)}return""}function Si(){const[e,n]=b.useState("scripted"),[t,r]=b.useState("idle"),[o,s]=b.useState(null),[d,c]=b.useState(null),[u,a]=b.useState(null),[p,h]=b.useState(null),[l,_]=b.useState(null),[y,M]=b.useState(null),[v,g]=b.useState(null),[I,B]=b.useState(Dt),[O,oe]=b.useState(Lt),[Z,Ne]=b.useState(""),[Ee,ye]=b.useState([]),[ke,$]=b.useState("idle"),[ae,Q]=b.useState(null),[T,j]=b.useState(""),[N,U]=b.useState(null),G=b.useRef(null),[ge,ve]=b.useState("scripted-vision"),[Qe,Ie]=b.useState("idle"),[_n,be]=b.useState(null),[Te,nn]=b.useState(Ot),[fn,Le]=b.useState(null),[qe,K]=b.useState(null),[se,wn]=b.useState(null),[Je,Me]=b.useState(null),X=b.useRef(null),Re=b.useRef(!1),R=b.useRef(0),pe=b.useCallback(E=>async(...J)=>{try{return await E.chat(...J)}catch(D){const W=D instanceof Error?D.message:String(D);throw E instanceof dn&&un(W)&&(U(null),c(null),r("error"),s(W)),D}},[]),je=b.useCallback(E=>async(...J)=>{try{return await E.read(...J)}catch(D){const W=D instanceof Error?D.message:String(D);throw un(W)&&(Me(null),Le(null),Ie("error"),be(W)),D}},[]);b.useEffect(()=>{pn().then(E=>{_(E),h(E===null)}),Ft().then(g),pn("the scripted-vision fallback").then(E=>{wn(E),Re.current||(Re.current=!0,ve(E===null?"browser-vision":"scripted-vision"))})},[]),b.useEffect(()=>{let E=!1;return M(null),Mi(I).then(J=>{E||M(J)}),()=>{E=!0}},[I]),b.useEffect(()=>()=>{var E;return(E=G.current)==null?void 0:E.dispose()},[]),b.useEffect(()=>()=>{var E;return(E=X.current)==null?void 0:E.dispose()},[]);const Se=b.useCallback(E=>{n(E),r("idle"),s(null),c(null),a(null),U(null)},[]),tn=b.useCallback(E=>{var J,D;Re.current=!0,(J=X.current)==null||J.cancelConnect(),(D=X.current)==null||D.dispose(),X.current=null,ve(E),Ie("idle"),be(null),Le(null),K(null),Me(null)},[]),de=b.useCallback(()=>{var E;(E=G.current)==null||E.dispose(),G.current=null,U(null),c(null)},[]),Ue=b.useCallback(()=>{const E=G.current;(E instanceof dn||E instanceof it)&&E.cancelConnect(),de(),r("idle"),a(null),s(null)},[de]),$e=b.useCallback(async()=>{const E=++R.current,J=()=>E!==R.current,D=hn(O);if(D){ye([]),$("error"),Q(D);return}$("loading"),Q(null);const W=new tt(O,T);try{const Ae=await W.listModels();if(J())return;ye(Ae),$("ready"),Ne(He=>He&&Ae.includes(He)?He:Ae[0]??"")}catch(Ae){if(J())return;ye([]),Ne(""),$("error"),Q(Ae instanceof Error?Ae.message:String(Ae))}finally{W.dispose()}},[O,T]),rn=b.useCallback(async()=>{var E,J;if(e==="scripted"){U(null),r("ready");return}if(e==="endpoint"){const D=hn(O);if(D){de(),s(D),r("error");return}}r("connecting"),s(null),a(null);try{if(e==="browser"){const D=G.current instanceof dn?G.current:new dn;G.current&&G.current!==D&&G.current.dispose(),G.current=D;const W=await D.connect(I,a);c(W),U(()=>pe(D)),M(!0)}else if(e==="chrome"){(E=G.current)==null||E.dispose();const D=new it;G.current=D;const W=await D.connect(a);g(null),c(W),U(()=>pe(D))}else{(J=G.current)==null||J.dispose();const D=new tt(O,T,Z);G.current=D;const W=await D.connect();c(W),U(()=>pe(D))}r("ready")}catch(D){const W=D instanceof Error?D.message:String(D);if(W==="cancelled")return;s(W),r("error"),U(null)}finally{a(null)}},[e,I,O,Z,T,de,pe]),Pe=b.useCallback(()=>{var E;(E=X.current)==null||E.dispose(),X.current=null,Me(null),Le(null)},[]),Fe=b.useCallback(()=>{var E;(E=X.current)==null||E.cancelConnect(),Pe(),Ie("idle"),K(null),be(null)},[Pe]),Ge=b.useCallback(async()=>{if(ge==="scripted-vision"){Pe(),Ie("ready"),be(null);return}Ie("connecting"),be(null),K(null);try{const E=X.current instanceof at?X.current:new at;X.current&&X.current!==E&&X.current.dispose(),X.current=E;const J=await E.connect(Te,K);Le(J),Me(()=>je(E)),Ie("ready")}catch(E){const J=E instanceof Error?E.message:String(E);if(J==="cancelled")return;be(J),Ie("error"),Me(null),Le(null)}finally{K(null)}},[ge,Te,Pe,je]);return{kind:e,setKind:Se,status:t,error:o,modelInUse:d,progress:u,webgpu:p,webgpuReason:l,browserModelCached:y,chromeAiReason:v,cancelConnect:Ue,browserModel:I,setBrowserModel:B,endpointUrl:O,setEndpointUrl:oe,endpointModel:Z,setEndpointModel:Ne,endpointModels:Ee,endpointModelsStatus:ke,endpointModelsError:ae,listEndpointModels:$e,apiKey:T,setApiKey:j,connect:rn,chat:N,visionKind:ge,setVisionKind:tn,visionStatus:Qe,visionError:_n,visionModel:Te,setVisionModel:nn,visionModelInUse:fn,visionProgress:qe,visionWebgpuReason:se,connectVision:Ge,cancelVisionConnect:Fe,vision:Je}}const Cn="#s=",Pi=["scripted","browser","chrome","endpoint"];function Ai(e){return typeof e=="string"&&Pi.includes(e)}function Ci(e){try{const n=JSON.parse(e);if(n&&typeof n=="object"){const t=n,r={};return Ai(t.brain)&&(r.brain=t.brain),r}}catch{}return{}}function Ut(e=location.hash){if(!e.startsWith(Cn))return{};let n;try{n=decodeURIComponent(e.slice(Cn.length))}catch{return{}}return Ci(n)}function Di(e){const n=Object.entries(e).filter(([,t])=>t!==void 0);return n.length===0?"":Cn+encodeURIComponent(JSON.stringify(Object.fromEntries(n)))}function Bi(e){const n={...Ut(),...e},t=Di(n),r=new URL(location.href);r.hash=t,history.replaceState(history.state,"",r)}const st=[{kind:"scripted",label:"Scripted",hint:"No model. The example's stand-in decides — deterministic and offline."},{kind:"browser",label:"In-browser (WebGPU)",hint:"A small quantised model on your GPU. First run downloads weights."},{kind:"chrome",label:"Chrome built-in",hint:"Gemini Nano, built into Chrome. Chrome owns the weights — no download from this page, no API key."},{kind:"endpoint",label:"API endpoint",hint:"Any OpenAI-compatible server. Ollama by default. Local pages only."}],dt=[{kind:"scripted-vision",label:"Scripted",hint:"No model. The example's known plate is returned — deterministic and offline."},{kind:"browser-vision",label:"In-browser (WebGPU)",hint:"Reads the photo with a vision model on your GPU. First run downloads weights."}];function Li({brain:e,showText:n=!0,showVision:t=!1}){return i.jsxs("div",{className:"brain",children:[n&&i.jsx(Ri,{brain:e}),n&&t&&i.jsx("hr",{className:"brain-divider"}),t&&i.jsx(Fi,{brain:e})]})}function Ri({brain:e}){const n=st.find(l=>l.kind===e.kind),t=st.filter(l=>l.kind!=="chrome"||xi()),r=hn(e.endpointUrl),[o,s]=b.useState(bn);b.useEffect(()=>{yi().then(s)},[]);const{kind:d,endpointUrl:c,apiKey:u,listEndpointModels:a}=e;b.useEffect(()=>{if(d!=="endpoint"||r)return;const l=setTimeout(()=>void a(),400);return()=>clearTimeout(l)},[d,c,u,r,a]);const p=o.find(l=>l.id===e.browserModel),h=p?vi(p,Bt()):null;return i.jsxs("div",{className:"brain-section",children:[i.jsxs("div",{className:"brain-modes",children:[i.jsx("div",{className:"brain-kinds",role:"group","aria-label":"Agent brain",children:t.map(l=>i.jsx(H,{size:"sm",variant:e.kind===l.kind?"default":"secondary","aria-pressed":e.kind===l.kind,onClick:()=>e.setKind(l.kind),children:l.label},l.kind))}),i.jsxs("div",{className:"brain-status",children:[e.status==="ready"&&e.kind!=="scripted"&&i.jsx(ie,{variant:"success",className:"brain-status-badge",children:e.modelInUse??"connected"}),e.status==="connecting"&&i.jsx(ie,{variant:"info",className:"brain-status-badge",children:"connecting…"}),e.status==="error"&&i.jsx(ie,{variant:"danger",className:"brain-status-badge",children:"not connected"})]})]}),i.jsx("p",{className:"field-hint",children:n.hint}),e.kind==="browser"&&i.jsxs("div",{className:"brain-config",children:[i.jsxs("div",{className:"field",children:[i.jsx(Ye,{htmlFor:"browser-model",children:"Model"}),i.jsxs(Nn,{value:e.browserModel,onValueChange:e.setBrowserModel,disabled:e.status==="connecting",children:[i.jsx(En,{id:"browser-model",children:i.jsx(kn,{})}),i.jsx(In,{children:o.map(l=>i.jsx(Tn,{value:l.id,children:l.label},l.id))})]}),e.browserModelCached===!0&&i.jsx("p",{className:"field-hint",children:"Already downloaded in this browser — connecting will be fast."}),e.browserModelCached===!1&&i.jsx("p",{className:"field-hint",children:"Not downloaded yet — connecting fetches the weights once, then caches them for next time."})]}),e.webgpu===!1&&e.webgpuReason&&i.jsxs(le,{variant:"destructive",children:[i.jsx(ce,{children:"No WebGPU in this browser"}),i.jsx(me,{children:e.webgpuReason})]}),e.webgpu!==!1&&h&&i.jsxs(le,{variant:"destructive",children:[i.jsx(ce,{children:"This model may not fit in GPU memory"}),i.jsx(me,{children:h})]})]}),e.kind==="chrome"&&i.jsxs("div",{className:"brain-config",children:[i.jsx("p",{className:"field-hint",children:"Nothing to configure: Chrome downloads and manages Gemini Nano itself, so the first Connect may fetch it once and later visits reuse it. Prompts never leave your machine. It's a very small model — expect it to follow the tool-calling format less reliably than an endpoint model."}),e.chromeAiReason&&i.jsxs(le,{variant:"destructive",children:[i.jsx(ce,{children:"Chrome's built-in model isn't available here"}),i.jsx(me,{children:e.chromeAiReason})]})]}),e.kind==="endpoint"&&i.jsxs("div",{className:"brain-config",children:[i.jsxs("div",{className:"field",children:[i.jsx(Ye,{htmlFor:"endpoint-url",children:"Endpoint"}),i.jsx(Yn,{id:"endpoint-url",value:e.endpointUrl,onChange:l=>e.setEndpointUrl(l.target.value),disabled:e.status==="connecting"}),i.jsxs("p",{className:"field-hint",children:["Ollama allows ",i.jsx("code",{children:"localhost"})," origins out of the box; set"," ",i.jsx("code",{children:"OLLAMA_ORIGINS"})," only when serving this page from another host. Best for local development — a hosted copy of this page can't reach a server on your machine at all."]}),r&&i.jsxs(le,{variant:"destructive",children:[i.jsx(ce,{children:"A local server won't work from this URL"}),i.jsx(me,{children:r})]})]}),i.jsxs("div",{className:"field",children:[i.jsx(Ye,{htmlFor:"endpoint-model",children:"Model"}),i.jsxs("div",{className:"endpoint-model-row",children:[i.jsxs(Nn,{value:e.endpointModel,onValueChange:e.setEndpointModel,disabled:e.status==="connecting"||e.endpointModelsStatus==="loading"||e.endpointModels.length===0,children:[i.jsx(En,{id:"endpoint-model",className:"endpoint-model-select",children:i.jsx(kn,{placeholder:e.endpointModelsStatus==="loading"?"Loading models…":e.endpointModelsStatus==="idle"?"Enter an endpoint above":e.endpointModelsStatus==="error"?"No models — check the endpoint":e.endpointModels.length===0?"No models served":"Select a model"})}),i.jsx(In,{children:e.endpointModels.map(l=>i.jsx(Tn,{value:l,children:l},l))})]}),i.jsx(H,{size:"sm",variant:"secondary",onClick:()=>void e.listEndpointModels(),disabled:e.status==="connecting"||e.endpointModelsStatus==="loading"||r!==null,children:e.endpointModelsStatus==="loading"?"Refreshing…":"Refresh"})]}),i.jsxs("p",{className:"field-hint",children:["Fetched from the endpoint's ",i.jsx("code",{children:"/models"}),". Tiny models (e.g. SmolLM2) usually can't follow the tool-calling format — prefer ",i.jsx("code",{children:"llama3.2:3b"}),", ",i.jsx("code",{children:"qwen2.5"})," or larger."]}),e.endpointModelsStatus==="error"&&!r&&i.jsxs(le,{variant:"destructive",children:[i.jsx(ce,{children:"Couldn't list models"}),i.jsx(me,{children:e.endpointModelsError})]})]}),i.jsxs("div",{className:"field",children:[i.jsx(Ye,{htmlFor:"endpoint-key",children:"API key (optional)"}),i.jsx(Yn,{id:"endpoint-key",type:"password",value:e.apiKey,onChange:l=>e.setApiKey(l.target.value),disabled:e.status==="connecting"})]})]}),e.kind!=="scripted"&&i.jsxs("div",{className:"brain-actions",children:[i.jsx(H,{size:"sm",onClick:()=>void e.connect(),disabled:e.status==="connecting"||e.kind==="chrome"&&e.chromeAiReason!==null||e.kind==="endpoint"&&(e.endpointModel===""||e.endpointModelsStatus==="loading"||r!==null),children:e.status==="ready"?"Reconnect":"Connect"}),e.status==="connecting"&&(e.kind==="browser"||e.kind==="chrome")&&i.jsx(H,{size:"sm",variant:"secondary",onClick:e.cancelConnect,children:"Cancel"}),e.progress&&i.jsxs("span",{className:"field-hint",children:[Math.round(e.progress.progress*100),"% —"," ",e.progress.text]})]}),e.progress&&i.jsx("div",{className:"brain-progress",role:"progressbar","aria-valuenow":Math.round(e.progress.progress*100),"aria-valuemin":0,"aria-valuemax":100,children:i.jsx("div",{className:"brain-progress-bar",style:{width:`${Math.round(e.progress.progress*100)}%`}})}),e.error&&i.jsxs(le,{variant:"destructive",children:[i.jsx(ce,{children:"Couldn't connect"}),i.jsx(me,{children:e.error})]})]})}function Fi({brain:e}){const n=dt.find(t=>t.kind===e.visionKind);return i.jsxs("div",{className:"brain-section brain-vision",children:[i.jsx(Ye,{children:"Vision (reads the image)"}),i.jsxs("div",{className:"brain-modes",children:[i.jsx("div",{className:"brain-kinds",role:"group","aria-label":"Vision brain",children:dt.map(t=>i.jsx(H,{size:"sm",variant:e.visionKind===t.kind?"default":"secondary","aria-pressed":e.visionKind===t.kind,onClick:()=>e.setVisionKind(t.kind),children:t.label},t.kind))}),i.jsxs("div",{className:"brain-status",children:[e.visionStatus==="ready"&&e.visionKind==="browser-vision"&&i.jsx(ie,{variant:"success",className:"brain-status-badge",children:e.visionModelInUse??"connected"}),e.visionStatus==="connecting"&&i.jsx(ie,{variant:"info",className:"brain-status-badge",children:"connecting…"}),e.visionStatus==="error"&&i.jsx(ie,{variant:"danger",className:"brain-status-badge",children:"not connected"})]})]}),i.jsx("p",{className:"field-hint",children:n.hint}),e.visionKind==="scripted-vision"&&e.webgpu===!1&&e.visionWebgpuReason&&i.jsxs(le,{variant:"destructive",children:[i.jsx(ce,{children:"No WebGPU in this browser"}),i.jsx(me,{children:e.visionWebgpuReason})]}),e.visionKind==="browser-vision"&&i.jsxs("div",{className:"brain-config",children:[i.jsxs("div",{className:"field",children:[i.jsx(Ye,{htmlFor:"vision-model",children:"Model"}),i.jsxs(Nn,{value:e.visionModel,onValueChange:e.setVisionModel,disabled:e.visionStatus==="connecting",children:[i.jsx(En,{id:"vision-model",children:i.jsx(kn,{})}),i.jsx(In,{children:zt.map(t=>i.jsx(Tn,{value:t.id,children:t.label},t.id))})]}),i.jsx("p",{className:"field-hint",children:"Connecting downloads the weights once (size shown above), then caches them — every token is read on your GPU, no server."})]}),e.webgpu===!1&&e.visionWebgpuReason&&i.jsxs(le,{variant:"destructive",children:[i.jsx(ce,{children:"No WebGPU in this browser"}),i.jsx(me,{children:e.visionWebgpuReason})]})]}),e.visionKind==="browser-vision"&&i.jsxs("div",{className:"brain-actions",children:[i.jsx(H,{size:"sm",onClick:()=>void e.connectVision(),disabled:e.visionStatus==="connecting",children:e.visionStatus==="ready"?"Reconnect":"Connect"}),e.visionStatus==="connecting"&&i.jsx(H,{size:"sm",variant:"secondary",onClick:e.cancelVisionConnect,children:"Cancel"}),e.visionProgress&&i.jsxs("span",{className:"field-hint",children:[Math.round(e.visionProgress.progress*100),"% —"," ",e.visionProgress.text]})]}),e.visionError&&i.jsxs(le,{variant:"destructive",children:[i.jsx(ce,{children:"Couldn't connect the vision brain"}),i.jsx(me,{children:e.visionError})]})]})}function zi({imageInput:e,value:n,onSelect:t,disabled:r=!1}){const[o,s]=b.useState(null),[d,c]=b.useState(!1),u=b.useRef(null),a=b.useId(),p=b.useId(),h=b.useCallback(y=>{s(URL.createObjectURL(y)),t({imageName:y.name,pixels:y})},[t]);b.useEffect(()=>{if(o)return()=>URL.revokeObjectURL(o)},[o]);const l=b.useCallback(y=>{const M=y==null?void 0:y[0];M&&M.type.startsWith("image/")&&h(M)},[h]),_=(n==null?void 0:n.imageId)!=null?e.seedImages.find(y=>y.id===n.imageId):void 0;return i.jsxs("div",{className:"image-input",children:[e.label&&i.jsx("p",{className:"field-hint",children:e.label}),i.jsx("p",{className:"image-input-label",id:a,children:"Seed photos"}),i.jsx("div",{className:"image-gallery",role:"group","aria-labelledby":a,children:e.seedImages.map(y=>{const M=(n==null?void 0:n.imageId)===y.id;return i.jsxs("button",{type:"button","aria-pressed":M,className:`image-thumb${M?" image-thumb--selected":""}`,disabled:r,title:y.label??y.id,onClick:()=>{s(null),u.current&&(u.current.value=""),t({imageId:y.id,pixels:y.file})},children:[i.jsx("img",{src:y.thumb??y.file,alt:y.label??y.id}),y.label&&i.jsx("span",{children:y.label})]},y.id)})}),i.jsx("label",{className:"image-input-label",htmlFor:p,children:"Or upload your own photo"}),i.jsxs("div",{className:`image-drop${d?" image-drop--over":""}`,onDragOver:y=>{y.preventDefault(),r||c(!0)},onDragLeave:()=>c(!1),onDrop:y=>{y.preventDefault(),c(!1),r||l(y.dataTransfer.files)},children:[i.jsx("input",{ref:u,id:p,type:"file",accept:"image/*",disabled:r,onChange:y=>l(y.target.files)}),i.jsx("p",{className:"field-hint",children:"Drag a photo here, or pick one. Uploading a photo the model has never seen is the proof this runs for real — nothing leaves your browser."})]}),(o||_)&&i.jsxs("div",{className:"image-preview",children:[i.jsx("img",{src:o??(_==null?void 0:_.file),alt:o?(n==null?void 0:n.imageName)??"uploaded photo":(_==null?void 0:_.label)??(_==null?void 0:_.id)??"selected photo"}),i.jsx("span",{className:"field-hint",children:o?`Uploaded: ${(n==null?void 0:n.imageName)??"your photo"}`:`Selected: ${(_==null?void 0:_.label)??(_==null?void 0:_.id)}`}),i.jsx("button",{type:"button",className:"image-clear-btn",disabled:r,onClick:()=>{s(null),u.current&&(u.current.value=""),t(null)},children:"Clear"})]})]})}function $t(e){return typeof e=="object"&&e!==null}function Ed(e){const n=new Set,t=r=>{$t(r)&&(typeof r.key=="string"&&n.add(r.key),Array.isArray(r.components)&&r.components.forEach(t))};return t(e),n}function Oi(e){const n={},t=r=>{$t(r)&&(typeof r.key=="string"&&"defaultValue"in r&&(n[r.key]=r.defaultValue??""),Array.isArray(r.components)&&r.components.forEach(t))};return t(e),n}const Ui="wdf:section:v2:";function Gt(e){return Ui+e}function lt(e){try{const n=window.localStorage.getItem(Gt(e));return n==="1"?!0:n==="0"?!1:void 0}catch{return}}function $i(e,n){try{window.localStorage.setItem(Gt(e),n?"1":"0")}catch{}}function Bn(e,n=!0){const[t,r]=b.useState(()=>lt(e)??n);b.useEffect(()=>{r(lt(e)??n)},[e,n]);const o=b.useCallback(s=>{r(s),$i(e,s)},[e]);return[t,o]}function Oe({sectionId:e,title:n,description:t,defaultOpen:r=!0,className:o,children:s,...d}){const[c,u]=Bn(e,r);return i.jsx(Wt,{className:["panel",o].filter(Boolean).join(" "),"data-tour":d["data-tour"],children:i.jsxs(Zt,{open:c,onOpenChange:u,children:[i.jsxs(Kt,{className:"panel-trigger",children:[i.jsxs("span",{className:"panel-trigger-text",children:[i.jsx("span",{className:"panel-title",children:n}),t!=null&&i.jsx("span",{className:"panel-desc",children:t})]}),i.jsx(Xt,{className:"panel-chevron","aria-hidden":!0})]}),i.jsx(er,{children:i.jsx(nr,{children:s})})]})})}function Gi(e){return e.entries!==void 0}function Vi(e){const n=[];let t=null;for(const r of e)r.turn!==void 0?t&&t.turn===r.turn?t.entries.push(r):(t={turn:r.turn,entries:[r]},n.push(t)):(t=null,n.push(r));return n}function ct(e){if(e===void 0)return"undefined";try{return JSON.stringify(e)}catch{return"[unserializable value]"}}function Yi({activation:e,result:n,labelFor:t}){const r=e.elementId??"";return i.jsxs("div",{className:"timeline-tool",children:[i.jsxs("div",{className:"timeline-tool-head",children:[i.jsx(ie,{variant:"info",children:"tool"}),i.jsx("strong",{children:t(r)||r}),i.jsx("code",{children:r})]}),e.args!==void 0&&Object.keys(e.args).length>0&&i.jsxs("div",{className:"timeline-kv",children:[i.jsx("span",{className:"timeline-kv-label",children:"arguments"}),i.jsx("code",{children:ct(e.args)})]}),i.jsxs("div",{className:"timeline-kv",children:[i.jsx("span",{className:"timeline-kv-label",children:"returned"}),i.jsx("code",{children:n?ct(n.result):"— waiting for the job to complete —"})]})]})}function Qi({group:e,labelFor:n}){const t=e.entries.find(a=>a.kind==="llm"),r=e.entries.filter(a=>a.kind==="agent"&&a.elementId),o=e.entries.filter(a=>a.kind==="vars"&&a.elementId),s=e.entries.filter(a=>a.kind==="agent"&&!a.elementId),d=e.entries.filter(a=>a.kind==="error"),c=new Set(r.map(a=>a.elementId)),u=e.entries.filter(a=>a.kind==="tool"||a.kind==="vars"&&a.elementId&&!c.has(a.elementId)).sort((a,p)=>a.id-p.id);return i.jsxs("div",{className:"timeline-turn",children:[i.jsxs("div",{className:"timeline-turn-head",children:[i.jsxs(ie,{variant:t!=null&&t.pending?"warning":"neutral",children:["Turn ",e.turn]}),(t==null?void 0:t.pending)&&i.jsx("span",{className:"timeline-pending",children:"thinking…"})]}),t&&i.jsx("blockquote",{className:"timeline-reply",children:t.text}),s.map(a=>i.jsx("div",{className:"timeline-note",children:a.text},a.id)),r.map(a=>i.jsx(Yi,{activation:a,result:o.find(p=>p.elementId===a.elementId),labelFor:n},a.id)),u.map(a=>i.jsxs("div",{className:`log-line log-${a.kind}`,children:[a.pending?"⏳ ":"",a.text]},a.id)),d.map(a=>i.jsxs("div",{className:"timeline-error",children:["⚠ ",a.text]},a.id))]})}function qi({log:e,elementStats:n=[],incidents:t=[],labelFor:r=s=>s,variables:o}){const s=b.useMemo(()=>Vi(e),[e]),[d,c]=b.useState(!1),[u,a]=Bn("engine-view",!1),p=b.useRef(null);b.useEffect(()=>{const l=p.current;l&&(l.scrollTop=l.scrollHeight)},[s]);const h=()=>{var y;const l={log:e.map(({id:M,...v})=>v),elementStats:n,incidents:t},_=JSON.stringify(l,null,2);(y=navigator.clipboard)!=null&&y.writeText&&navigator.clipboard.writeText(_).then(()=>{c(!0),setTimeout(()=>c(!1),1500)}).catch(()=>{})};return i.jsxs(Oe,{sectionId:"activity",className:"grow activity-card",title:"Agent activity",description:"Agent turns, model replies, and tool calls — read top to bottom as a story.",children:[i.jsx("div",{className:"timeline-toolbar",children:i.jsx(H,{variant:"secondary",size:"sm",onClick:h,children:d?"Copied!":"Copy run as JSON"})}),i.jsx("div",{className:"timeline",ref:p,children:s.length===0?i.jsx("div",{className:"log-empty",children:"Press Run or Step to start."}):s.map(l=>Gi(l)?i.jsx(Qi,{group:l,labelFor:r},`turn-${l.turn}-${l.entries[0].id}`):i.jsxs("div",{className:`log-line log-${l.kind}`,children:[l.pending?"⏳ ":"",l.text]},l.id))}),o,(n.length>0||t.length>0)&&i.jsxs("details",{className:"engine-view",open:u,onToggle:l=>a(l.currentTarget.open),children:[i.jsxs("summary",{children:["Element completion",t.length>0&&` · ${t.length} incident${t.length===1?"":"s"}`]}),i.jsxs("div",{className:"timeline-engine-view",children:[n.length>0&&i.jsxs("div",{className:"timeline-stats",children:[i.jsx("span",{className:"timeline-kv-label",children:"Element completion"}),i.jsx("ul",{children:n.filter(l=>l.completed>0||(l.active??0)>0).map(l=>i.jsxs("li",{children:[i.jsx("code",{children:r(l.elementId)||l.elementId})," ","completed ",l.completed,l.active?`, ${l.active} active`:""]},l.elementId))})]}),t.length>0&&i.jsxs("div",{className:"timeline-incidents",children:[i.jsx("span",{className:"timeline-kv-label",children:"Incidents"}),i.jsx("ul",{children:t.map((l,_)=>i.jsxs("li",{children:[i.jsx("code",{children:r(l.elementId)||l.elementId})," —"," ",l.reason]},`${l.elementId}-${_}`))})]})]})]})]})}const xe={diagram:"diagram",runButton:"run-button",variablesPanel:"variables-panel",codePanel:"code-panel",brainPanel:"brain-panel"};function mt(e){return`[data-tour="${e}"]`}function Ji(e=location.search){return new URLSearchParams(e).get("tour")}function Hi(e,n){var t;return((t=e.elementStats.find(r=>r.elementId===n))==null?void 0:t.completed)??0}function Wi(e,n){return!e||e.kind==="click"||!n?!1:e.kind==="activeElement"?n.activeElementIds.includes(e.elementId):Hi(n,e.elementId)>=(e.atLeast??1)}function Zi(e){return"anchor"in e?mt(e.anchor):`${mt(xe.diagram)} [data-element-id="${Ki(e.elementId)}"]`}function Ki(e){return typeof CSS<"u"&&typeof CSS.escape=="function"?CSS.escape(e):e.replace(/[^a-zA-Z0-9_-]/g,n=>`\\${n}`)}function Xi(e){return e.map(n=>{const t=!!n.waitFor&&n.waitFor.kind!=="click";return{element:Zi(n.target),popover:{title:n.title,description:t?`${n.description} (continues automatically once you reach that point — or use Next to skip ahead)`:n.description,showButtons:["next","previous","close"]},disableActiveInteraction:!1,skipMissingElement:n.skipMissingElement??!0}})}async function eo(e,n={}){var s;const[{driver:t}]=await Promise.all([he(()=>import("./driver.js-bj_ppY-Q.js"),[]),he(()=>Promise.resolve({}),__vite__mapDeps([0]))]),r=Xi(e),o=t({steps:r,showProgress:!0,allowClose:!0,skipMissingElement:!0,onHighlighted:(d,c,{index:u})=>{var a;u!==void 0&&((a=n.onIndexChange)==null||a.call(n,u))},onDestroyed:()=>{var d;(d=n.onDestroyed)==null||d.call(n)}});return o.drive(),(s=n.onIndexChange)==null||s.call(n,o.getActiveIndex()??0),{moveNext:()=>o.moveNext(),activeIndex:()=>o.getActiveIndex()??-1,destroy:()=>o.destroy()}}const no=300;function to(e,n){const[t,r]=b.useState(!1),o=b.useRef(null),s=b.useRef(0),d=b.useRef(-1),c=b.useRef(null),u=b.useRef(n);b.useEffect(()=>{u.current=n},[n]);const a=b.useCallback(()=>{c.current!==null&&(clearInterval(c.current),c.current=null)},[]),p=b.useRef(0),h=b.useCallback(()=>{var _;p.current+=1,a(),(_=o.current)==null||_.destroy(),o.current=null,r(!1)},[a]),l=b.useCallback(()=>{if(!e||e.steps.length===0||o.current)return;const _=p.current+=1;eo(e.steps,{onIndexChange:y=>{s.current=y},onDestroyed:()=>{a(),o.current=null,r(!1)}}).then(y=>{if(_!==p.current){y.destroy();return}o.current=y,r(!0),c.current=setInterval(()=>{const M=s.current;if(M===d.current)return;const v=e.steps[M];v&&Wi(v.waitFor,u.current())&&(d.current=M,y.moveNext())},no)})},[e,a]);return b.useEffect(()=>h,[h]),{active:t,start:l,stop:h}}const Ce=650,vn="__agent__",pt="__model__",ut="__template__:",ro=b.lazy(async()=>{await Promise.all([he(()=>Promise.resolve({}),__vite__mapDeps([1])),he(()=>Promise.resolve({}),__vite__mapDeps([2])),he(()=>Promise.resolve({}),__vite__mapDeps([3]))]);const{RuntimeDiagram:e}=await he(async()=>{const{RuntimeDiagram:n}=await import("./RuntimeDiagram-DTnJz5cT.js");return{RuntimeDiagram:n}},__vite__mapDeps([4,5,6]));return{default:e}}),Mn=b.lazy(()=>he(()=>import("./MonacoEditor-uG4ItxXx.js").then(e=>e.M),__vite__mapDeps([7,5,8]))),io=b.lazy(()=>he(()=>import("./vendor-modeler-Df7L48VE.js"),__vite__mapDeps([9,5,6,10,11,12,13,1,2,3]))),ht=b.lazy(async()=>{const{FormRenderer:e}=await he(async()=>{const{FormRenderer:n}=await import("./FormRenderer-D_ACP7uT.js");return{FormRenderer:n}},__vite__mapDeps([14,5,12,10,11,15]));return{default:e}});function mn(e,n){try{return JSON.stringify(e??{},null,n)}catch{return"[unserializable value]"}}function oo(e){const n=mn(e).replace(/\s+/g," ");return n.length>78?`${n.slice(0,78)}…`:n}function ao({example:e,compact:n=!1,initialBrainKind:t,initialTourId:r}){var Rn,Fn,zn,On,Un,$n,Gn,Vn;const[o,s]=b.useState(e.bpmn),d=Si(),[c,u]=b.useState(null);b.useEffect(()=>{t&&t!==d.kind&&d.setKind(t)},[]),b.useEffect(()=>{Bi({brain:d.kind})},[d.kind]);const[a,p]=b.useState(()=>Object.fromEntries(e.handlers.map(w=>[w.elementId,w.source]))),[h,l]=b.useState(e.scriptedAgent??""),[_,y]=b.useState(()=>en(e.templates)),M=b.useMemo(()=>Or(e,a,o,_),[e,a,o,_]),v=M.model,g=hi({bpmn:M.resolvedBpmn}),I=to(e.tour,()=>g.snapshot);b.useEffect(()=>{var w;r&&((w=e.tour)==null?void 0:w.id)===r&&I.start()},[]);const B=v.startFormId?((Rn=e.forms)==null?void 0:Rn[v.startFormId])??null:null,[O,oe]=b.useState(()=>({...e.seed,...B?Oi(B):{}})),[Z,Ne]=b.useState(v.agent?vn:((Fn=e.handlers[0])==null?void 0:Fn.elementId)??""),Ee=b.useMemo(()=>{const w=(e.scenarios??[]).findIndex(x=>Object.entries(x.variables).every(([k,C])=>JSON.stringify(O[k])===JSON.stringify(C)));return w===-1?null:w},[e.scenarios,O]),[ye,ke]=Bn(n?"start-compact":"start",n?!1:!!B),[$,ae]=b.useState(!1),[Q,T]=b.useState(!1),[j,N]=b.useState(null),[U,G]=b.useState([]),[ge,ve]=b.useState({}),Qe=b.useMemo(()=>({...e.seed,...O,...vr(e.imageInput?c:null)}),[e.seed,e.imageInput,O,c]),[Ie,_n]=b.useState(!1),be=b.useRef(null),[Te,nn]=b.useState({}),[fn,Le]=b.useState(!1),qe=b.useRef(null),K=b.useRef(!1),se=b.useRef(0),wn=b.useRef(0),Je=b.useRef({current:void 0}),Me=b.useRef({}),X=b.useRef({}),Re=b.useMemo(()=>{const w=new Map;for(const x of v.processes){for(const k of x.tasks)w.set(k.elementId,k.label);for(const k of x.agents){w.set(k.elementId,k.label);for(const C of k.tools)w.set(C.elementId,C.label)}for(const k of x.userTasks)w.set(k.elementId,k.label)}return x=>w.get(x)??x},[v]),R=b.useCallback(w=>{G(x=>{if(w.key){const k=x.findIndex(C=>C.key===w.key);if(k>=0){const C=[...x];return C[k]={...C[k],...w},C}}return[...x,{...w,id:wn.current++}].slice(-80)})},[]),pe=b.useMemo(()=>{var w;return((w=g.snapshot)==null?void 0:w.userTasks.find(x=>x.state==="Created"))??null},[g.snapshot]),je=b.useMemo(()=>{const w=v.processes.flatMap(k=>k.tasks),x=new Map;for(const k of e.handlers){if(!k.manualControl)continue;const C=w.find(P=>P.elementId===k.elementId);C&&x.set(C.jobType,{...k.manualControl,elementId:k.elementId})}return x},[e.handlers,v]),Se=b.useMemo(()=>{if(!g.snapshot)return null;for(const w of g.snapshot.jobs){const x=je.get(w.jobType);if(x&&w.state==="Created")return{job:w,control:x}}return null},[g.snapshot,je]),tn=b.useMemo(()=>{if(!v.agent||!g.snapshot)return[];const w=new Map(g.snapshot.elementStats.map(x=>[x.elementId,x.completed]));return v.agent.tools.filter(x=>(w.get(x.elementId)??0)===0)},[v.agent,g.snapshot]),de=pe?v.userTasks.find(w=>w.elementId===pe.elementId):void 0,Ue=de!=null&&de.formId?((zn=e.forms)==null?void 0:zn[de.formId])??null:null,$e=b.useCallback(async(w,x,k,C)=>{var ue,te,fe;let P=k,_e=0;for(;se.current===C&&P&&P.completedInstances<1&&_e++<80;){const Y=await g.stepWorkers(w,{agents:x});if(se.current!==C)return P;P=(Y==null?void 0:Y.snapshot)??P;const re=(ue=P.instances[0])==null?void 0:ue.variables;if(re&&ve({...re}),P.userTasks.some(q=>q.state==="Created")){R({kind:"human",text:"⏸ waiting for a human — complete the task below to continue"});break}if(!Y){R({kind:"error",text:"▶ run stopped — no dispatch round was returned"});break}if(Y.handled===0){const q=P.messageSubscriptions[0];if(Y.reason==="messages"&&q){if(R({kind:"step",text:`⏳ parked on a message catch event — waiting for "${q.messageName}"`,elementId:q.elementId}),await new Promise(ee=>setTimeout(ee,Ce)),se.current!==C)return P;R({kind:"vars",text:`📨 correlating message "${q.messageName}" (key: ${q.correlationKey})`,elementId:q.elementId});const V=g.correlateMessage(q.messageName,q.correlationKey,"{}");if(V){P=V;const ee=(te=P.instances[0])==null?void 0:te.variables;ee&&ve({...ee}),await new Promise(we=>setTimeout(we,Ce));continue}R({kind:"error",text:`▶ run stopped — correlating "${q.messageName}" (key: ${q.correlationKey}) failed`,elementId:q.elementId})}if(Y.reason==="signals"&&P.signalSubscriptions.length>0){const V=P.signalSubscriptions[0],ee=P.signalSubscriptions.length;if(R({kind:"step",text:`⏳ parked on ${ee} open signal subscription${ee===1?"":"s"} — waiting for "${V.signalName}"`,elementId:V.elementId}),await new Promise(Ve=>setTimeout(Ve,Ce)),se.current!==C)return P;const we=g.broadcastSignal(V.signalName,"{}");if(we){P=we,R({kind:"vars",text:`📡 broadcasting signal "${V.signalName}" — every waiting subscription unblocks`,elementId:V.elementId});const Ve=(fe=P.instances[0])==null?void 0:fe.variables;Ve&&ve({...Ve}),await new Promise(Qt=>setTimeout(Qt,Ce));continue}R({kind:"error",text:`▶ run stopped — broadcasting signal "${V.signalName}" failed`,elementId:V.elementId})}if(Y.reason==="timers"){const V=P.timers.reduce((ee,we)=>Math.min(ee,we.dueInMs),1/0);if(Number.isFinite(V)){if(R({kind:"step",text:`⏳ parked on a timer — ${(Math.max(V,0)/1e3).toFixed(1)}s left on the clock`}),await new Promise(we=>setTimeout(we,Ce)),se.current!==C)return P;const ee=g.advanceTime(Math.max(V,0)+1);if(ee){P=ee,R({kind:"step",text:"🕐 the clock advanced — timer fired"}),await new Promise(we=>setTimeout(we,Ce));continue}}}break}await new Promise(q=>setTimeout(q,Ce))}return se.current!==C||(P&&P.completedInstances>=1?R({kind:"done",text:"✅ process instance completed"}):P&&P.incidentElementIds.length>0&&R({kind:"error",text:"A job failed — incident on the diagram"})),P},[g,R]),rn=b.useCallback(async w=>{var P,_e,ue;if(!Se||K.current)return;const{job:x,control:k}=Se,C=++se.current;K.current=!0,ae(!0);try{let te,fe;if(w==="complete")te=g.completeJobManually(x.jobType,"{}"),fe="  ↳ completed normally";else if(k.action.kind==="timer"){const Y=((_e=(P=g.snapshot)==null?void 0:P.timers[0])==null?void 0:_e.dueInMs)??0;te=g.advanceTime(Math.max(Y,0)+1),fe="  ↳ advanced the clock — timer fired"}else{const{errorCode:Y,message:re}=k.action;te=g.throwJobError(x.jobType,Y,re),fe=`  ↳ threw BPMN error ${Y}: ${re}`}if(te){R({kind:"vars",text:fe,elementId:x.elementId});const Y=(ue=te.instances[0])==null?void 0:ue.variables;Y&&ve({...Y}),await new Promise(re=>setTimeout(re,Ce)),await $e(Me.current,X.current,te,C)}else R({kind:"error",text:"  ↳ failed to resolve the manual job",elementId:x.elementId})}finally{se.current===C&&(K.current=!1,ae(!1))}},[Se,g,R,$e]),Pe=b.useCallback(async()=>{var Y;let w=null;try{v.agent&&h.trim()&&(w=jr(h))}catch(re){return N(re instanceof Error?re.message:String(re)),null}Je.current={current:void 0};let x;if(e.imageInput){const re=d.vision;x={read:re??Ti(e.scriptedVision).read,live:!!re,resolve:V=>g.getRunImage(V)}}const k=Ar(v,M.handlers,R,Je.current,x);for(const re of je.keys())delete k[re];const C={};if(v.agents.length>0){if(d.kind!=="scripted"&&d.chat){const q=new Map;for(const V of v.agents)q.set(V.jobType,[...q.get(V.jobType)??[],V]);for(const[V,ee]of q)C[V]=Hr(ee,d.chat,R,{turnRef:Je.current,requiredTools:e.requiredTools})}else if(w&&v.agent){const q=v.agent.elementId;C[v.agent.jobType]=async V=>{if(V.elementId!==q)throw new Error(`No scripted agent handler for "${V.elementId}" — only "${q}" (the primary process's first agent host) is driven by the scripted brain. Use a live brain to exercise more than one host.`);const ee=await w(V),we=(ee.activateElements??[]).map(Ve=>Ve.elementId).join(", ");return R({kind:"agent",text:ee.completionConditionFulfilled?"🤖 scripted agent: done":`🤖 scripted agent: calling ${we||"(nothing)"}`}),ee}}}G([]),nn({});const P=Qe;ve(P),Me.current=k,X.current=C;const _e=await g.redeploy(o),ue=(_e==null?void 0:_e[0])??v.processId;R({kind:"start",text:`Starting "${ue}" — ${v.agent?d.kind==="scripted"||!d.chat?"scripted brain":`live brain (${d.modelInUse??d.kind})`:"no agent in this model"}`});const te=g.createInstance(ue,JSON.stringify(P)),fe=(Y=te==null?void 0:te.instances[0])==null?void 0:Y.key;return e.imageInput&&c&&fe&&g.setRunImage(fe,c),{workers:k,agents:C,snap:te}},[g,e,M,o,h,O,c,Qe,v,d,R,je]),Fe=!!g.snapshot&&g.snapshot.completedInstances<1,Ge=!Fe&&!!B&&!Ie,E=ye||Ge,J=b.useCallback(async()=>{if(g.phase!=="ready"||K.current||Q||M.hasErrors)return;K.current=!0,ae(!0);const w=++se.current;try{let x=Me.current,k=X.current,C=g.snapshot;if(!Fe){if(be.current&&!be.current.validate())return;N(null);const P=await Pe();if(!P)return;x=P.workers,k=P.agents,C=P.snap,await new Promise(_e=>setTimeout(_e,Ce))}await $e(x,k,C,w)}finally{se.current===w&&(K.current=!1,ae(!1))}},[g,Q,M.hasErrors,Fe,Pe,$e]),D=b.useCallback(async()=>{var x;if(g.phase!=="ready"||K.current||Q||M.hasErrors)return;K.current=!0,T(!0);const w=++se.current;try{let k=Me.current,C=X.current,P=g.snapshot;if(!Fe){if(be.current&&!be.current.validate())return;N(null);const Y=await Pe();if(!Y)return;k=Y.workers,C=Y.agents,P=Y.snap}if(!P||P.completedInstances>=1)return;const _e=P.takenSequenceFlows.length,ue=await g.stepWorkers(k,{agents:C});if(!ue){R({kind:"error",text:"⏭ step failed — no dispatch round was returned"});return}const te=(x=ue.snapshot.instances[0])==null?void 0:x.variables;te&&ve({...te});const fe=gi(ue.snapshot.takenSequenceFlows,_e);R(bi(ue,fe,Re,je))}finally{se.current===w&&(K.current=!1,T(!1))}},[g,Q,M.hasErrors,Fe,Pe,R,Re,je]),W=b.useCallback(async()=>{K.current=!1,se.current++,ae(!1),T(!1),K.current=!0;try{await g.reset()}finally{K.current=!1}G([]),ve({})},[g]),Ae=b.useCallback(()=>{var k;if(!pe||qe.current&&!qe.current.validate())return;const w=g.completeUserTask(pe.key,JSON.stringify(Te));R({kind:"human",text:`👤 ${mn(Te)}`});const x=(k=w==null?void 0:w.instances[0])==null?void 0:k.variables;ve(C=>({...C,...Te,...x??{}})),w&&w.completedInstances>=1&&R({kind:"done",text:"✅ process instance completed"})},[pe,Te,g,R]),He=b.useMemo(()=>{var w,x;return g.phase==="loading"?i.jsx(ie,{variant:"neutral",children:"Booting engine…"}):g.phase==="error"?i.jsx(ie,{variant:"danger",children:"Engine error"}):$?i.jsx(ie,{variant:"info",children:"Running…"}):Q?i.jsx(ie,{variant:"info",children:"Stepping…"}):(((w=g.snapshot)==null?void 0:w.incidentElementIds.length)??0)>0?i.jsx(ie,{variant:"danger",children:"Incident"}):pe?i.jsx(ie,{variant:"warning",children:"Waiting for a human"}):(((x=g.snapshot)==null?void 0:x.completedInstances)??0)>=1?i.jsx(ie,{variant:"success",children:"Completed"}):g.snapshot?i.jsx(ie,{variant:"warning",children:"Paused"}):i.jsx(ie,{variant:"neutral",children:"Ready"})},[g.phase,g.snapshot,$,Q,pe]),Yt=b.useMemo(()=>e.blurb.split(/\n\s*\n/).map(w=>w.trim()).filter(Boolean),[e.blurb]);return i.jsxs("div",{className:"runner",children:[!n&&i.jsxs("section",{className:"intro",children:[i.jsx("h1",{children:e.title}),Yt.map(w=>i.jsx("p",{children:w},w))]}),e.imageInput&&i.jsx(zi,{imageInput:e.imageInput,value:c,onSelect:u,disabled:$}),i.jsxs("div",{className:"scenario",children:[i.jsx("span",{className:"scenario-label",id:"scenario-label",children:e.scenariosLabel??"Example input"}),e.scenarios&&i.jsx("div",{className:"scenario-toggle",role:"group","aria-labelledby":"scenario-label",children:e.scenarios.map((w,x)=>i.jsx(H,{size:"sm",variant:x===Ee?"default":"secondary","aria-pressed":x===Ee,disabled:$,onClick:()=>oe(k=>({...k,...w.variables})),children:w.label},w.label))}),i.jsxs("button",{type:"button",className:"scenario-input-button",onClick:()=>ke(!E),"aria-expanded":E,"aria-controls":"start-input-editor",title:"Edit the starting payload",children:[i.jsx("span",{className:"scenario-edit-icon","aria-hidden":!0,children:"✎"})," ","input: ",i.jsx("code",{children:oo(O)})]}),Ge&&i.jsx("span",{className:"scenario-hint",children:"Fill in the input to enable Run"})]}),i.jsxs("div",{className:"inline-input-editor",id:"start-input-editor",hidden:!E,children:[i.jsxs("div",{className:"inline-input-editor-head",children:[i.jsxs("div",{children:[i.jsx("div",{className:"inline-input-editor-title",children:v.startFormId?"Start form":"Start payload"}),i.jsx("div",{className:"inline-input-editor-copy",children:v.startFormId?`Rendered from the model's start form "${v.startFormId}".`:"The variables the instance starts with."})]}),i.jsx(H,{size:"sm",variant:"secondary",onClick:()=>ke(!1),children:"Done"})]}),B?i.jsx(b.Suspense,{fallback:i.jsx("div",{className:"form-fallback",children:"Loading form…"}),children:i.jsx(ht,{ref:be,schema:B,values:O,onChange:(w,x)=>oe(k=>({...k,[w]:x})),disabled:$,onValidityChange:_n})}):i.jsx("pre",{className:"vars",children:mn(O,2)})]}),!n&&(v.agent||e.imageInput)&&i.jsx(Oe,{sectionId:"brain",className:"brain-card","data-tour":xe.brainPanel,title:"Agent brain",description:v.agent?`What drives “${v.agent.label}”. The model recommends; the process governs.`:"What reads the image. The model recommends; the process governs.",children:i.jsx(Li,{brain:d,showText:!!v.agent,showVision:!!e.imageInput})}),i.jsxs("div",{className:"controls",children:[i.jsx(H,{"data-tour":xe.runButton,onClick:()=>void J(),disabled:g.phase!=="ready"||$||Q||M.hasErrors||Ge,children:"▶ Run"}),i.jsx(H,{variant:"secondary",onClick:()=>void D(),disabled:g.phase!=="ready"||$||Q||M.hasErrors||Ge||(((On=g.snapshot)==null?void 0:On.completedInstances)??0)>=1,children:"⏭ Step"}),i.jsx(H,{variant:"secondary",onClick:()=>void W(),disabled:g.phase!=="ready"||Q,children:"↺ Reset"}),e.tour&&i.jsx(H,{variant:"secondary",onClick:I.start,disabled:I.active,children:I.active?"Touring…":`🧭 ${e.tour.label}`}),He]}),g.phase==="error"&&i.jsxs(le,{variant:"destructive",children:[i.jsx(ce,{children:"Engine error"}),i.jsx(me,{children:g.error})]}),j&&i.jsxs(le,{variant:"destructive",children:[i.jsx(ce,{children:"Code didn't compile"}),i.jsx(me,{children:j})]}),M.hasErrors&&i.jsxs(le,{variant:"destructive",children:[i.jsx(ce,{children:"Run is disabled — the diagram has unresolved references"}),i.jsx(me,{children:i.jsx("ul",{className:"diagnostics",children:M.diagnostics.filter(w=>w.severity==="error").map((w,x)=>i.jsx("li",{children:w.message},x))})})]}),!M.hasErrors&&M.diagnostics.length>0&&i.jsxs(le,{children:[i.jsx(ce,{children:"Heads up"}),i.jsx(me,{children:i.jsx("ul",{className:"diagnostics",children:M.diagnostics.map((w,x)=>i.jsx("li",{children:w.message},x))})})]}),i.jsxs("div",{className:"grid",children:[i.jsxs("div",{className:"col",children:[i.jsx(Oe,{sectionId:"process","data-tour":xe.diagram,title:"Process",description:`${v.processName} — live token (green), incidents (red).`,children:i.jsx(b.Suspense,{fallback:i.jsx("div",{className:"diagram-fallback",children:g.phase==="loading"?"Booting the engine…":"Loading diagram…"}),children:i.jsx(ro,{xml:M.resolvedBpmn,activeIds:((Un=g.snapshot)==null?void 0:Un.activeElementIds)??[],incidentIds:(($n=g.snapshot)==null?void 0:$n.incidentElementIds)??[],className:"diagram"})})}),pe&&i.jsxs(Oe,{sectionId:"human-task",title:(de==null?void 0:de.label)??"Human task",description:Ue?`Rendered from the model's form "${de==null?void 0:de.formId}".`:"This task has no linked form — complete it with no variables.",children:[tn.length>0&&i.jsxs(le,{variant:"destructive",children:[i.jsx(ce,{children:"The agent didn't finish its checks"}),i.jsxs(me,{children:["It completed without running"," ",tn.map(w=>w.label||w.elementId).join(", "),". The process took the default path to this task, so the findings below have no value to report."]})]}),Ue&&i.jsx(b.Suspense,{fallback:i.jsx("div",{className:"form-fallback",children:"Loading form…"}),children:i.jsx(ht,{ref:qe,schema:Ue,values:Te,onChange:(w,x)=>nn(k=>({...k,[w]:x})),context:ge,onValidityChange:Le})}),i.jsx(H,{onClick:Ae,disabled:!!Ue&&!fn,children:"Complete task"})]}),Se&&i.jsx(Oe,{sectionId:"manual-job",title:Se.control.label,description:"This job is held here on purpose — pick how it resolves.",children:i.jsxs("div",{className:"controls",children:[i.jsx(H,{onClick:()=>void rn("complete"),disabled:$||Q,children:Se.control.completeLabel??"✅ Complete normally"}),i.jsx(H,{variant:"secondary",onClick:()=>void rn("action"),disabled:$||Q,children:Se.control.action.label})]})})]}),i.jsx("div",{className:"col",children:i.jsx(qi,{log:U,elementStats:(Gn=g.snapshot)==null?void 0:Gn.elementStats,incidents:(Vn=g.snapshot)==null?void 0:Vn.incidents,labelFor:Re,variables:i.jsxs("div",{className:"vars-block","data-tour":xe.variablesPanel,children:[i.jsx("div",{className:"vars-head",children:"Instance variables"}),i.jsx("pre",{className:"vars",children:mn(Object.keys(ge).length>0?ge:Qe,2)})]})})})]}),!n&&i.jsxs("div",{className:"runner-secondary",children:[i.jsx(Oe,{sectionId:"code",className:"editors","data-tour":xe.codePanel,defaultOpen:!1,title:"Code",description:"One handler per BPMN element, plus a model tab holding the editable diagram — select an element there to edit its properties. Return variables to merge, or throw to fail the job.",children:i.jsx(b.Suspense,{fallback:i.jsx("div",{className:"editor-fallback",children:"Loading editor…"}),children:i.jsxs(tr,{value:Z,onValueChange:Ne,children:[i.jsxs(rr,{children:[i.jsx(on,{value:pt,children:"model"}),v.agent&&i.jsx(on,{value:vn,children:"agent (scripted)"}),e.handlers.map(w=>{var x;return i.jsx(on,{value:w.elementId,children:((x=v.tasks.find(k=>k.elementId===w.elementId))==null?void 0:x.label)??w.elementId},w.elementId)}),Object.keys(_).map(w=>i.jsx(on,{value:ut+w,children:w},w))]}),i.jsxs(an,{value:pt,children:[i.jsxs("div",{className:"editor-meta",children:[i.jsx("strong",{children:"Model"}),i.jsx("code",{children:"click an element to edit its properties on the right — Run re-reads whatever you leave here"}),i.jsx(H,{variant:"secondary",size:"sm",onClick:()=>s(e.bpmn),disabled:o===e.bpmn,children:"Revert to original"})]}),i.jsx(io,{value:o,onChange:s})]}),v.agent&&i.jsxs(an,{value:vn,children:[i.jsxs("div",{className:"editor-meta",children:[i.jsx("strong",{children:v.agent.label}),i.jsx("code",{children:d.kind==="scripted"||!d.chat?"in use":"unused — a live brain is connected"})]}),i.jsx("div",{className:"editor-wrap",children:i.jsx(Mn,{height:"360px",defaultLanguage:"javascript",value:h,onChange:w=>l(w??""),options:xn})})]}),e.handlers.map(w=>{var x;return i.jsxs(an,{value:w.elementId,children:[i.jsxs("div",{className:"editor-meta",children:[i.jsx("strong",{children:((x=v.tasks.find(k=>k.elementId===w.elementId))==null?void 0:x.label)??w.elementId}),i.jsx("code",{children:w.standsInFor??w.elementId})]}),i.jsx("div",{className:"editor-wrap",children:i.jsx(Mn,{height:"360px",defaultLanguage:"javascript",value:a[w.elementId],onChange:k=>p(C=>({...C,[w.elementId]:k??""})),options:xn})})]},w.elementId)}),Object.keys(_).map(w=>i.jsxs(an,{value:ut+w,children:[i.jsxs("div",{className:"editor-meta",children:[i.jsx("strong",{children:w}),i.jsxs("code",{children:["prompt / template text — substitutes"," ","{{"+w+"}}"]})]}),i.jsx("div",{className:"editor-wrap",children:i.jsx(Mn,{height:"360px",defaultLanguage:"markdown",value:_[w],onChange:x=>y(k=>en(k,{[w]:x??""})),options:xn})})]},w))]})})}),v.agent&&i.jsx(Oe,{sectionId:"tools",defaultOpen:!1,title:"Tools, as the model sees them",description:i.jsxs(i.Fragment,{children:["Read from the diagram — element name, documentation, and every",i.jsx("code",{children:" fromAi(…)"})," argument."]}),children:i.jsx("ul",{className:"tool-list",children:v.agent.tools.map(w=>i.jsxs("li",{children:[i.jsx("code",{children:w.elementId}),i.jsxs("span",{children:[" — ",w.documentation||w.label]}),w.args.length>0&&i.jsx("ul",{children:w.args.map(x=>i.jsxs("li",{children:[i.jsxs("code",{children:[x.name,": ",x.type]})," ","— ",x.description]},x.name))})]},w.elementId))})})]})]})}const xn={minimap:{enabled:!1},fontSize:13,scrollBeyondLastLine:!1,tabSize:2,automaticLayout:!0},so=`<?xml version="1.0" encoding="UTF-8"?>\r
...
}`,Eo={id:"learn-multi-instance-parallel",title:"Parallel multi-instance",group:"learn-bpmn",blurb:["A multi-instance activity runs its task once per element of a collection, spawning that many job instances of the same element in parallel, and only lets the token move on once every one of them completes.",`Run this and watch three 'Process item' jobs activate together for apple, banana, cherry, and complete (in any order) before the process reaches its end event. Nothing about the diagram says "three" — that comes from the collection, so use the buttons in the Start panel on the right to swap between one, three, and six items and hit Run again; the Activity panel logs one 'Process item' line per element, so the fan-out is right there to count.`,'The property tying the two together is in the Code panel: open the model tab, click "Process item", and expand Multi-instance in the properties panel on the right — Input collection holds `items`, the FEEL expression naming the variable to fan out over. Drop it entirely and the activity silently degenerates to a single ordinary instance, with no error to tell you it happened. Revert to original puts it back.'].join(`

`),docsUrl:"https://docs.camunda.io/docs/components/modeler/bpmn/multi-instance/",bpmn:xo,seed:{items:["apple","banana","cherry"]},scenarios:[{label:"One item — a single instance",variables:{items:["apple"]}},{label:"Three items — fans out to three",variables:{items:["apple","banana","cherry"]}},{label:"Six items — fans out to six",variables:{items:["apple","banana","cherry","damson","elderberry","fig"]}}],handlers:[{elementId:"Activity_process",standsInFor:"job worker — process-item",source:No}]},ko=Object.freeze(Object.defineProperty({__proto__:null,default:Eo},Symbol.toStringTag,{value:"Module"})),Io=`<?xml version="1.0" encoding="UTF-8"?>\r
...
`,$o="Camunda Cloud",Go="8.10.0",Vo={name:"Camunda Web Modeler",version:"9b5d5ef"},Yo=19,Qo="learn-user-task-form-review",qo=[{text:`# Review request
...
`,Xo=`Please verify export compliance for this shipment and notify the team of your decision.\r
`,ea={id:"compliance-walkthrough",label:"Take the tour",steps:[{title:"Start a run",description:"Press Run to send a shipment through the compliance agent.",target:{anchor:xe.runButton}},{title:"The agent picks its own tools",description:"This AI Agent reads the shipment notes and decides, turn by turn, which of the tools below it to call — nothing here is hard-coded into a fixed sequence.",target:{elementId:"ComplianceCheckAgent"}},{title:"Watch the token move",description:"The agent's first move is to look up the genetic marker mentioned in the notes.",target:{elementId:"VerifyGeneticMarker"},waitFor:{kind:"activeElement",elementId:"VerifyGeneticMarker"}},{title:"A cleared shipment notifies the export team",description:"Once the compliance score comes back clean, the process notifies the export team automatically — no human review needed for this scenario.",target:{elementId:"NotifyExportTeam"},waitFor:{kind:"elementCompleted",elementId:"NotifyExportTeam"}},{title:"Everything the run recorded",description:"The variables panel shows the marker record, the country lookup, the compliance score, and the final decision — exactly what each tool and the agent wrote along the way.",target:{anchor:xe.variablesPanel}}],successEvent:{kind:"instanceCompleted"}},na=`<?xml version="1.0" encoding="UTF-8"?>
...
}`,Ia={id:"seed-export-compliance",title:"Seed export compliance agent",blurb:"An AI agent picks its own tools to check a shipment, then a gateway routes on its decision — cleared shipments notify the export team, flagged ones go to a human. The LLM recommends; the BPMN process governs.",hero:{headline:"The LLM *recommends*. The process *governs*.",lede:"An agentic ad-hoc sub-process chooses its own compliance checks, but the gateway after it — not the model — decides whether a shipment ships or goes to a human.",tagline:"Anatomy of an enterprise agent"},docsUrl:"https://camunda.com/blog/agentic-ai/",bpmn:na,forms:{"seed-export-shipment-ready":la,"seed-export-compliance-review":_a},seed:{scenario:gt,shipmentNotes:""},scenariosLabel:"Example shipment",scenarios:[{label:"Likely cleared (TP53 → Brazil)",variables:{scenario:gt,shipmentNotes:""}},{label:"Likely flagged (BRCA1 → Germany)",variables:{scenario:ya,shipmentNotes:""}}],scriptedAgent:va,templates:wa,tour:ea,requiredTools:["RecordComplianceDecision"],handlers:[{elementId:"VerifyGeneticMarker",standsInFor:"JDBC connector — UCSC hg38",source:Ma},{elementId:"CheckDestinationCountry",standsInFor:"GraphQL connector — countries API",source:xa},{elementId:"ComputeComplianceScore",standsInFor:"REST connector — api.mathjs.org",source:Na},{elementId:"RecordComplianceDecision",standsInFor:"Script task — FEEL",source:Ea},{elementId:"NotifyExportTeam",standsInFor:"REST connector — httpbin.io",source:ka}]},Ta=`You are a loan origination assistant at a retail bank. Your job is to gather everything a senior loan officer needs to decide an application — you do **not** decide it yourself.
...
}`,is={id:"loan-origination",title:"Loan origination agent",blurb:"An AI agent gathers a loan case with its own tools — customer lookup, credit bureau, an underwriting policy, a status update — then every application passes through a mandatory senior-officer review before a gateway routes it to an offer or a decline. The agent advises; the process governs.",docsUrl:"https://camunda.com/orchestrate/agents/",bpmn:Pa,forms:{"loan-application":za,"loan-senior-officer-review":qa},seed:bt,scenarios:[{label:"Strong applicant (policy recommends approve)",variables:bt},{label:"Marginal applicant (policy recommends decline)",variables:Wa}],scriptedAgent:Za,templates:Ha,tour:Sa,requiredTools:["AssessApplication","UpdateApplicationStatus"],handlers:[{elementId:"QueryCustomer",standsInFor:"CRM connector — customer lookup",source:Ka},{elementId:"CreditBureauLookup",standsInFor:"REST connector — credit bureau",source:Xa},{elementId:"AssessApplication",standsInFor:"Script task — underwriting policy (FEEL)",source:es},{elementId:"UpdateApplicationStatus",standsInFor:"REST connector — origination system",source:ns},{elementId:"IssueLoanOffer",standsInFor:"REST connector — offer/booking system",source:ts},{elementId:"SendDeclineNotice",standsInFor:"REST connector — notifications",source:rs}]},os=`<?xml version="1.0" encoding="UTF-8"?>
...
`,as=`async (job, { text, sleep }) => {
  ...
  return { shipped: true, tracking: "1Z" + Math.floor(Math.random() * 1e9) };
}`,ls={id:"order-process",title:"Order process with service workers",blurb:"The getting-started order process: check inventory, charge payment, ship. No agent and no human step — the same runner, driven entirely by what's in the diagram.",docsUrl:"https://docs.camunda.io/docs/next/guides/getting-started-orchestration-cluster/",bpmn:os,seed:{item:"camunda-t-shirt",quantity:3},handlers:[{elementId:"Activity_0tw2fu0",standsInFor:"job worker — check-inventory",source:as},{elementId:"Activity_1ppsbgi",standsInFor:"job worker — charge-payment",source:ss},{elementId:"Activity_08pg6im",standsInFor:"job worker — ship-items",source:ds}]},cs=`<?xml version="1.0" encoding="UTF-8"?>\r
...
}`,ps={id:"rocket-launch",title:"Rocket launch",blurb:"The getting-started rocket launch, boiled down to one service task: launch. The smallest possible example, and the smallest possible test of the framework's extensibility.",bpmn:cs,seed:{missionName:"Apollo 11",destination:"the Moon",fuelLevel:100},scenarios:[{label:"Full tanks — launch succeeds",variables:{missionName:"Apollo 11",destination:"the Moon",fuelLevel:100}},{label:"Low fuel — mission scrubbed",variables:{missionName:"Apollo 13",destination:"the Moon",fuelLevel:30}}],handlers:[{elementId:"Activity_LaunchRocket",standsInFor:"job worker — launch-rocket",source:ms}]},us=`<?xml version="1.0" encoding="UTF-8"?>\r
...
`,hs=`async (job, { text, sleep }) => {
  ...
  return { shipped: true, tracking: "1Z" + Math.floor(Math.random() * 1e9) };
}`,_s={id:"order-process-boundary-events",title:"Order process with boundary events",blurb:"The getting-started order process, extended with a timer and an error boundary event: charge payment can be declined, and a delayed shipment can escalate — both fired by hand from the runner rather than by chance.",docsUrl:"https://github.com/camunda/camunda-8-get-started/tree/main/2-order-process-with-service-workers",bpmn:us,seed:{item:"camunda-t-shirt",quantity:3},handlers:[{elementId:"Activity_0tw2fu0",standsInFor:"job worker — check-inventory",source:hs},{elementId:"Activity_1ppsbgi",standsInFor:"job worker — charge-payment",source:gs,manualControl:{label:"Charge payment method",completeLabel:"✅ Complete normally",action:{kind:"error",errorCode:"CHARGE_DECLINED",message:"The card issuer declined the charge.",label:"❌ Simulate: card declined"}}},{elementId:"Activity_08pg6im",standsInFor:"job worker — ship-items",source:bs,manualControl:{label:"Ship items",completeLabel:"✅ Ship it",action:{kind:"timer",label:"🕐 Fire the shipping-delayed timer"}}}]},fs="/pr-preview/pr-108/assets/de-bmw-mini-JBSk7QcF.jpg",ws="/pr-preview/pr-108/assets/de-bmw-mini.thumb-CUUmJrRO.jpg",ys="/pr-preview/pr-108/assets/uk-d651-rnb-XGipy2QN.jpg",vs="/pr-preview/pr-108/assets/uk-d651-rnb.thumb-mjEcbhUf.jpg",Ms="/pr-preview/pr-108/assets/uk-mk70-orj-Cn6O3Xfm.jpg",xs="/pr-preview/pr-108/assets/uk-mk70-orj.thumb-CaeZ2vqU.jpg",Ns="/pr-preview/pr-108/assets/uk-ni-ijz-8992-YXV44tgk.jpg",Es="/pr-preview/pr-108/assets/uk-ni-ijz-8992.thumb-DYwok8jV.jpg",ks="/pr-preview/pr-108/assets/us-hyundai-genesis-gGpAIEpi.jpg",Is="/pr-preview/pr-108/assets/us-hyundai-genesis.thumb-DEEt19Mw.jpg",Ts=`<?xml version="1.0" encoding="UTF-8"?>
...
}`,od={id:"plate-recognition",title:"Read a number plate from a photo",blurb:"Pick the plate's country, then a photo goes into the run, an in-browser vision model reads the number plate on the reader's own GPU, and a human confirms or corrects it before the process records the result. The vision model recommends; the BPMN process governs. No server, no API key — with no model connected it falls back to a deterministic scripted reading.",docsUrl:"https://docs.camunda.io/docs/components/modeler/forms/camunda-forms-reference/",bpmn:Ts,forms:{"plate-recognition-country":Ks,"plate-recognition-confirm":Ls,"plate-recognition-manual":Vs},seed:{country:"auto"},imageInput:{label:"Pick a seed photo (its plate is known, so the scripted reader works offline) or upload your own — a live in-browser model reads a photo it has never seen.",seedImages:nd},scriptedVision:td,handlers:[{elementId:"ExtractPlate",standsInFor:"Vision model — Florence-2 <OCR> on WebGPU (in-browser)",source:rd},{elementId:"RecordResult",standsInFor:"Script task — records the governed outcome",source:id}]},ad=[ps,Ia,is,ls,_s,od],sd=Object.assign({"./learn-error-boundary/index.ts":po,"./learn-exclusive-gateway/index.ts":fo,"./learn-message-correlation/index.ts":Mo,"./learn-multi-instance-parallel/index.ts":ko,"./learn-service-task/index.ts":Po,"./learn-signal-broadcast/index.ts":Lo,"./learn-timer-catch-event/index.ts":Oo,"./learn-user-task-form/index.ts":Zo}),dd=Object.values(sd).map(e=>e.default).sort((e,n)=>e.id.localeCompare(n.id)),We=[...ad,...dd];function Ln(){return"/pr-preview/pr-108/"}function ld(e){const n=Ln();return e.startsWith(n)?"/"+e.slice(n.length):e}function cd(e=location.pathname){const t=ld(e).match(/^\/examples\/([^/]+)\/?$/);if(t)try{return{kind:"example",id:decodeURIComponent(t[1])}}catch{return{kind:"gallery"}}return{kind:"gallery"}}function md(e=location.search){return new URLSearchParams(e).get("embed")==="1"}function pd(e=location.search){return new URLSearchParams(e).get("view")==="compact"?"compact":"full"}function ft(e){return`${Ln()}examples/${encodeURIComponent(e)}`}const wt="p";function ud(){const e=new URLSearchParams(location.search),n=e.get(wt);if(!n)return!1;const t=n.replace(/[\t\n\r]/g,"");if(!t.startsWith("/")||t.startsWith("//")||t.startsWith("/\\"))return!1;e.delete(wt);try{const r=new URL(Ln(),location.href),o=new URL(t.slice(1),r);return o.origin!==location.origin?!1:(o.search=e.toString(),o.hash=location.hash,history.replaceState(null,"",o),!0)}catch{return!1}}function hd(e,n={}){const t=new URL(location.href);t.pathname=e,t.search=n.search??t.search,n.hash!==void 0&&(t.hash=n.hash),n.replace?history.replaceState(history.state,"",t):history.pushState(history.state,"",t),window.dispatchEvent(new PopStateEvent("popstate"))}function yt(){return{route:cd(),embed:md(),view:pd()}}function gd(){const[e,n]=b.useState(yt);return b.useEffect(()=>{const t=()=>n(yt());return window.addEventListener("popstate",t),()=>window.removeEventListener("popstate",t)},[]),e}const bd="web-demo-framework:height",_d="web-demo-framework:request-height";function fd(e){return{type:bd,height:Math.ceil(e)}}const vt="embed-height-auto";function wd(e){b.useEffect(()=>{if(!e||typeof window>"u"||window.parent===window)return;const n=document.documentElement;n.classList.add(vt);let t=-1;const r=(d=!1)=>{const c=Math.max(document.documentElement.offsetHeight,document.body.scrollHeight);!d&&Math.abs(c-t)<2||(t=c,window.parent.postMessage(fd(c),"*"))},o=d=>{if(d.source!==window.parent)return;const c=d.data;!c||c.type!==_d||r(!0)};window.addEventListener("message",o),r();const s=new ResizeObserver(()=>r());return s.observe(n),()=>{s.disconnect(),window.removeEventListener("message",o),n.classList.remove(vt)}},[e])}const Mt={headline:"The model *runs*. The code is *yours* to edit.",lede:"Every example on this page is a real BPMN process executing in your browser on the nano WebAssembly engine — edit the model, edit the handlers, swap the LLM, and run it again.",tagline:"Runnable Camunda examples"};function yd({text:e}){return i.jsx(i.Fragment,{children:e.split(/\*([^*]+)\*/g).map((n,t)=>t%2===1?i.jsx("em",{children:n},t):i.jsx(b.Fragment,{children:n},t))})}function vd(){const{route:e,embed:n,view:t}=gd(),r=n&&t==="compact",o=Ut().brain,s=Ji();wd(n);const d=e.kind==="example"?e.id:We[0].id,c=We.find(_=>_.id===d)??We[0],u=We.filter(_=>_.group!=="learn-bpmn"),a=We.filter(_=>_.group==="learn-bpmn"),p=_=>{hd(ft(_),{hash:location.hash})},h=c.hero??Mt,l=i.jsxs(i.Fragment,{children:[!n&&i.jsxs(i.Fragment,{children:[i.jsxs("section",{className:"hero",children:[i.jsx("h1",{children:i.jsx(yd,{text:h.headline})}),h.lede&&i.jsx("p",{children:h.lede})]}),i.jsx("nav",{className:"example-picker","aria-label":"Scenario examples",children:u.map(_=>i.jsx(H,{size:"sm",variant:_.id===c.id?"default":"secondary","aria-current":_.id===c.id?"page":void 0,onClick:()=>p(_.id),children:_.title},_.id))}),a.length>0&&i.jsxs(i.Fragment,{children:[i.jsx("h2",{className:"example-group-heading",id:"learn-bpmn-heading",children:"Learn BPMN"}),i.jsx("nav",{className:"example-picker","aria-labelledby":"learn-bpmn-heading",children:a.map(_=>i.jsx(H,{size:"sm",variant:_.id===c.id?"default":"secondary","aria-current":_.id===c.id?"page":void 0,onClick:()=>p(_.id),children:_.title},_.id))})]})]}),i.jsxs("div",{className:"example-meta",children:[c.docsUrl&&i.jsx("a",{className:"docs-link",href:c.docsUrl,target:"_blank",rel:"noreferrer noopener",children:"View on camunda.com ↗"}),n&&i.jsx("a",{className:"open-full-page",href:ft(c.id)+(location.hash||""),target:"_top",rel:"noreferrer",children:r?"Open the editable version ↗":"Open full page ↗"})]}),i.jsx(ao,{example:c,compact:r,initialBrainKind:o,initialTourId:s},c.id)]});return n?i.jsx("div",{className:`c4-ui app-shell app-embed${r?" app-compact":""}`,children:i.jsx("main",{id:"main",className:`layout layout-embed${r?" layout-compact":""}`,children:l})}):i.jsxs("div",{className:"c4-ui app-shell",children:[i.jsx(ir,{className:"topbar",logo:i.jsx("span",{className:"brand-dot","aria-hidden":!0}),appName:"Runnable Camunda examples",trailing:i.jsx("span",{className:"app-subtitle",children:h.tagline??Mt.tagline})}),i.jsx("main",{id:"main",className:"layout",children:l}),i.jsx("footer",{className:"footer",children:"Running locally in your browser on the nano WebAssembly BPMN engine — no cluster, no server, no data leaving the page."})]})}ud();Ht.createRoot(document.getElementById("root")).render(i.jsx(b.StrictMode,{children:i.jsx(or,{children:i.jsx(vd,{})})}));export{he as _,Ed as c};
