const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/driver-CTZuBZOi.css","assets/diagram-js-DAKGYcfb.css","assets/bpmn-embedded-BLz2Dhj7.css","assets/RuntimeDiagram-B2IYfHo7.js","assets/vendor-react-9Ma26nY1.js","assets/Viewer-D_7S4Gwm.js","assets/MonacoEditor-Cbl5mXvC.js","assets/MonacoEditor-Dq4KoJiD.css","assets/vendor-modeler-qEE80MwB.js","assets/vendor-design-system-FHVb_HJ-.js","assets/vendor-design-system-Cp414jgt.css","assets/parser-DkgAe_kI.js","assets/ModelEditor-Dwlgp6JA.css","assets/FormRenderer-cKNdAcoU.js","assets/FormRenderer-D1JIHOW6.css"])))=>i.map(i=>d[i]);
var Ct=Object.defineProperty;var Bt=(e,n,t)=>n in e?Ct(e,n,{enumerable:!0,configurable:!0,writable:!0,value:t}):e[n]=t;var z=(e,n,t)=>Bt(e,typeof n!="symbol"?n+"":n,t);import{r as h,j as o,i as Lt}from"./vendor-react-9Ma26nY1.js";import{B as q,a as H,L as Ge,S as Mn,b as xn,c as Nn,d as En,e as kn,A as me,f as pe,g as ue,I as Rn,C as Rt,h as Ft,i as zt,j as Ot,k as Ut,l as $t,T as Gt,m as Vt,n as tn,o as rn,p as Yt,q as Qt}from"./vendor-design-system-FHVb_HJ-.js";(function(){const n=document.createElement("link").relList;if(n&&n.supports&&n.supports("modulepreload"))return;for(const i of document.querySelectorAll('link[rel="modulepreload"]'))r(i);new MutationObserver(i=>{for(const s of i)if(s.type==="childList")for(const l of s.addedNodes)l.tagName==="LINK"&&l.rel==="modulepreload"&&r(l)}).observe(document,{childList:!0,subtree:!0});function t(i){const s={};return i.integrity&&(s.integrity=i.integrity),i.referrerPolicy&&(s.referrerPolicy=i.referrerPolicy),i.crossOrigin==="use-credentials"?s.credentials="include":i.crossOrigin==="anonymous"?s.credentials="omit":s.credentials="same-origin",s}function r(i){if(i.ep)return;i.ep=!0;const s=t(i);fetch(i.href,s)}})();const qt="modulepreload",Jt=function(e){return"/pr-preview/pr-99/"+e},Fn={},be=function(n,t,r){let i=Promise.resolve();if(t&&t.length>0){let l=function(a){return Promise.all(a.map(d=>Promise.resolve(d).then(g=>({status:"fulfilled",value:g}),g=>({status:"rejected",reason:g}))))};document.getElementsByTagName("link");const m=document.querySelector("meta[property=csp-nonce]"),p=(m==null?void 0:m.nonce)||(m==null?void 0:m.getAttribute("nonce"));i=l(t.map(a=>{if(a=Jt(a),a in Fn)return;Fn[a]=!0;const d=a.endsWith(".css"),g=d?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${a}"]${g}`))return;const u=document.createElement("link");if(u.rel=d?"stylesheet":qt,d||(u.as="script"),u.crossOrigin="",u.href=a,p&&u.setAttribute("nonce",p),document.head.appendChild(u),d)return new Promise((b,w)=>{u.addEventListener("load",b),u.addEventListener("error",()=>w(new Error(`Unable to preload CSS for ${a}`)))})}))}function s(l){const m=new Event("vite:preloadError",{cancelable:!0});if(m.payload=l,window.dispatchEvent(m),!m.defaultPrevented)throw l}return i.then(l=>{for(const m of l||[])m.status==="rejected"&&s(m.reason);return n().catch(s)})},Ht="io.camunda.agenticai:aiagent",Te="http://www.omg.org/spec/BPMN/20100524/MODEL",Wt="http://camunda.org/schema/zeebe/1.0";function In(e,n){return Array.from(e.getElementsByTagNameNS(Wt,n))}function pt(e,n){return In(e,n).filter(t=>Zt(t)===e)}function Zt(e){let n=e.parentElement;for(;n;){if(n.namespaceURI===Te&&n.localName!=="extensionElements")return n;n=n.parentElement}return null}function An(e){const n=pt(e,"taskDefinition")[0],t=n==null?void 0:n.getAttribute("type");return t||(e.localName==="scriptTask"?e.getAttribute("id")??null:null)}function zn(e){const n=Array.from(e.children).find(t=>t.namespaceURI===Te&&t.localName==="documentation");return((n==null?void 0:n.textContent)??"").trim()}function On(e){if(!e)return"";const n=e.startsWith("=")?e.slice(1):e,t=n.match(/"((?:[^"\\]|\\.)*)"/g);return t?t.map(r=>r.slice(1,-1).replace(/\\n/g,`
...
`)}function Kt(e){return gt(ut(e))}function Xt(e){const n=Array.from(e.children).find(t=>t.namespaceURI===Te&&t.localName==="extensionElements");return n?gt(ut(n)):[]}function gt(e){const n=/fromAi\(\s*toolCall\.([A-Za-z_$][\w$]*)\s*,\s*"((?:[^"\\]|\\.)*)"\s*(?:,\s*"(\w+)")?/g,t=[],r=new Set;for(const i of e.matchAll(n)){const s=i[1];r.has(s)||(r.add(s),t.push({name:s,description:(i[2]??"").replace(/&#10;/g,`
`).replace(/\\"/g,'"').replace(/&quot;/g,'"').replace(/&#39;/g,"'").trim(),type:i[3]??"string"}))}return t}function er(e){const n={};for(const t of pt(e,"input")){const r=t.getAttribute("target");r&&(n[r]=t.getAttribute("source")??"")}return n}function nr(e){return Array.from(e.getElementsByTagNameNS(Te,"adHocSubProcess")).filter(n=>(An(n)??"").startsWith(Ht))}const tr=new Set(["subProcess","adHocSubProcess","callActivity"]),rr=new Set(["adHocSubProcess","subProcess","transaction"]);function ir(e){let n=e.parentElement;for(;n;){if(n.namespaceURI===Te&&rr.has(n.localName))return n;n=n.parentElement}return null}function or(e,n){const t=er(e),r=Number((t["data.limits.maxModelCalls"]??"").replace(/^=/,""));return{elementId:e.getAttribute("id")??"agent",label:e.getAttribute("name")??"Agent",jobType:An(e),systemPrompt:On(t["data.systemPrompt.prompt"]),userPrompt:On(t["data.userPrompt.prompt"]),maxModelCalls:Number.isFinite(r)&&r>0?r:10,tools:n}}function ar(e,n){var g;const t=e.getAttribute("id")??"",r=e.getAttribute("name")??t,i=nr(e);i.length>1&&n.push({severity:"warning",elementId:i.map(u=>u.getAttribute("id")).join(", "),message:`Process "${r}" hosts ${i.length} AI Agent sub-processes (${i.map(u=>u.getAttribute("id")).join(", ")}). Each gets its own independent agent state (turn counter, called tools) — the run itself is shared across hosts, but each host's agent state within it is not.`});const s=[],l=new Map(i.map(u=>[u,[]]));for(const u of Array.from(e.getElementsByTagName("*"))){if(u.namespaceURI!==Te||i.includes(u))continue;const b=u.getAttribute("id");if(!b)continue;const w=ir(u),y=w&&i.includes(w)?w:null;if(y&&tr.has(u.localName)){const k=u.getAttribute("name")??b,D=zn(u);s.push({elementId:b,label:k,jobType:"",documentation:D,isTool:!0,compound:!0}),l.get(y).push({elementId:b,label:k,jobType:"",documentation:D,args:Xt(u),compound:!0});continue}const _=An(u);if(!_)continue;const v={elementId:b,label:u.getAttribute("name")??b,jobType:_,documentation:zn(u),isTool:y!=null};s.push(v),y&&l.get(y).push({elementId:b,label:v.label,jobType:_,documentation:v.documentation,args:Kt(u)})}const m=i.map(u=>or(u,l.get(u))),p=Array.from(e.getElementsByTagNameNS(Te,"userTask")).map(u=>{var b;return{elementId:u.getAttribute("id")??"",label:u.getAttribute("name")??u.getAttribute("id")??"",formId:((b=In(u,"formDefinition")[0])==null?void 0:b.getAttribute("formId"))??void 0}}),a=e.getElementsByTagNameNS(Te,"startEvent")[0],d=a?((g=In(a,"formDefinition")[0])==null?void 0:g.getAttribute("formId"))??void 0:void 0;return{processId:t,processName:r,tasks:s,agents:m,userTasks:p,startFormId:d}}function sr(e,n={}){const t=new DOMParser().parseFromString(e,"application/xml"),r=t.getElementsByTagName("parsererror")[0];if(r)throw new Error(`Invalid BPMN XML: ${r.textContent}`);const i=Array.from(t.getElementsByTagNameNS(Te,"process"));if(i.length===0)throw new Error("No <bpmn:process> in the diagram.");const s=[],l=i.map(p=>ar(p,s));let m=n.processId?l.find(p=>p.processId===n.processId):void 0;return n.processId&&!m&&s.push({severity:"warning",message:`Requested process "${n.processId}" not found — falling back to "${l[0].processId}".`}),m??(m=l[0]),l.length>1&&s.push({severity:"warning",message:`Diagram has ${l.length} <bpmn:process> elements (${l.map(p=>p.processId).join(", ")}); using "${m.processId}" as the active process. Pass a processId to parseModel to target another.`}),{processes:l,diagnostics:s,processId:m.processId,processName:m.processName,tasks:m.tasks,agent:m.agents[0]??null,agents:l.flatMap(p=>p.agents),userTasks:m.userTasks,startFormId:m.startFormId}}function dr(e){return e?e.imageId?{imageId:e.imageId}:e.imageName?{imageName:e.imageName}:{}:{}}function ht(e,n){return n?e.pixels:e.imageId??e.pixels}const lr="No image selected — pick or upload a photo to read.";function Un(){return lr}function cr(e,n){return async t=>{const r=e.resolve(n);if(!r)return Un();const i=ht(r,e.live);if(i===void 0)return Un();try{return await e.read(i,t)}catch(s){return`Couldn't read the image (${s instanceof Error?s.message:String(s)}).`}}}function mr(e,n){return async()=>{const t=e.resolve(n);if(t)return ht(t,e.live)}}function pr(){return`<!doctype html><html><head><meta charset="utf-8"></head><body><script>
    "use strict";
    ...
    post({ kind: "ready" });
  <\/script></body></html>`}function bt(e,n={}){const{timeoutMs:t=5e3,onTrace:r,onVision:i,onImage:s}=n,l=`${Date.now()}-${Math.random().toString(36).slice(2)}`;return new Promise((m,p)=>{const a=document.createElement("iframe");a.setAttribute("sandbox","allow-scripts"),a.style.display="none",a.setAttribute("aria-hidden","true");let d=!1,g;const u=()=>{g&&clearTimeout(g),window.removeEventListener("message",w),a.remove()},b=_=>{d||(d=!0,u(),_())};function w(_){var k;if(_.source!==a.contentWindow)return;const v=_.data;if(!(!v||typeof v!="object")){if(v.kind==="ready"){const D=e.job,W=e.kind==="run-handler"?{kind:"run-handler",id:l,source:e.source,job:D,hasVision:e.hasVision}:{kind:"run-agent",id:l,source:e.source,job:D};(k=a.contentWindow)==null||k.postMessage(W,"*");return}"id"in v&&v.id!==l||(v.kind==="trace"?r==null||r(v.text):v.kind==="vision-request"?y(v.callId,i,"vision",v.prompt):v.kind==="image-request"?y(v.callId,s,"image"):v.kind==="result"?b(()=>m(v.value)):v.kind==="error"&&b(()=>p(new Error(v.message))))}}function y(_,v,k,...D){const W=Z=>{var ce;return(ce=a.contentWindow)==null?void 0:ce.postMessage(Z,"*")};if(!v){W({kind:"helper-error",id:l,callId:_,message:`${k} helper is not available.`});return}Promise.resolve().then(()=>v(...D)).then(Z=>W({kind:"helper-result",id:l,callId:_,value:Z}),Z=>W({kind:"helper-error",id:l,callId:_,message:Z instanceof Error?Z.message:String(Z)}))}window.addEventListener("message",w),g=setTimeout(()=>{b(()=>p(new Error(`Handler timed out after ${t}ms — the sandboxed run was terminated.`)))},t),a.srcdoc=pr(),document.body.appendChild(a)})}function _t(e){return{key:e.key,type:e.type,elementId:e.elementId,instanceKey:e.instanceKey,variables:e.variables??{}}}function ur(e,n,t){const r=typeof t.vision=="function";return bt({kind:"run-handler",source:e,job:_t(n),hasVision:r},{onTrace:t.trace,onVision:t.vision?i=>t.vision(i):void 0,onImage:t.image?()=>t.image():void 0})}function gr(e,n){return bt({kind:"run-agent",source:e,job:_t(n)})}function wt(e,n){try{new Function(`"use strict"; return (${e});`)}catch{throw new Error(`${n} has a syntax error.`)}}function hr(e){return wt(e,"Handler code"),(n,t)=>ur(e,n,t)}function br(e){return wt(e,"Agent code"),n=>gr(e,n)}function _r(e,n,t,r){return{sleep:i=>new Promise(s=>setTimeout(s,i)),trace:i=>n({kind:"tool",text:`   ${i}`,elementId:e.elementId,turn:t}),text:(i,s="")=>{const l=e.variables[i];return typeof l=="string"?l:l==null?s:String(l)},num:(i,s=0)=>{const l=e.variables[i],m=typeof l=="number"?l:Number(l);return Number.isFinite(m)?m:s},...r?{vision:cr(r,e.instanceKey),image:mr(r,e.instanceKey)}:{}}}function wr(e){if(e===void 0)return"undefined";try{return JSON.stringify(e)}catch{return"[unserializable value]"}}function fr(e,n,t,r,i){const s={},l=e.processes.flatMap(p=>p.tasks),m=new Map(l.map(p=>[p.elementId,p.label]));for(const p of l)p.compound||s[p.jobType]||(s[p.jobType]=async a=>{const d=n[a.elementId];if(!d)throw new Error(`No handler registered for ${a.elementId} (job type ${a.type})`);const g=m.get(a.elementId)??a.elementId,u=r==null?void 0:r.current;t({kind:"tool",text:`▶ ${g}`,elementId:a.elementId,turn:u});const b=await d(a,_r(a,t,u,i));return t({kind:"vars",text:`  ↳ ${wr(b)}`,elementId:a.elementId,result:b,turn:u}),b});return s}const yr=/\{\{\s*([A-Za-z][A-Za-z0-9_-]*)\s*\}\}/g;function Ke(...e){const n=Object.create(null);for(const t of e)if(t)for(const r of Object.keys(t))n[r]=t[r];return n}function ft(e){return(e.split("/").pop()??e).replace(/\.[^./]+$/,"")}function yt(e){return e.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;")}function vr(e){return yt(e).replace(/"/g,"&quot;").replace(/\n/g,"&#10;").replace(/\t/g,"&#9;")}function Mr(e){return e.replace(/\\/g,"\\\\").replace(/&/g,"&amp;").replace(/"/g,"\\&#34;").replace(/\n/g,"&#10;").replace(/\t/g,"&#9;").replace(/</g,"&lt;").replace(/>/g,"&gt;")}function xr(e){return JSON.stringify(e).slice(1,-1)}function Nr(e,n){const t=e.lastIndexOf("<",n),r=e.lastIndexOf(">",n);if(t<=r)return"text";const i=e.slice(t,n);if((i.match(/"/g)??[]).length%2===0)return"text";const l=i.lastIndexOf('"');return(i.slice(l+1).match(/&#34;|&quot;/g)??[]).length%2===1?"feel-literal":"attribute"}function Er(e,n,t="xml"){const r=[],i=new Set;return{result:e.replace(yr,(l,m,p)=>{const a=m.trim();if(!Object.prototype.hasOwnProperty.call(n,a))return i.has(a)||(i.add(a),r.push(a)),l;const d=n[a];if(t==="json")return xr(d);const g=Nr(e,p);return g==="feel-literal"?Mr(d):g==="attribute"?vr(d):yt(d)}),unresolved:r}}function kr(){return{processes:[],diagnostics:[],processId:"",processName:"",tasks:[],agent:null,agents:[],userTasks:[],startFormId:void 0}}function Ir(e,n={},t=e.bpmn,r={}){const i=[],s=Ke(e.templates,r),{result:l,unresolved:m}=Er(t,s,"xml");for(const v of m)i.push({severity:"warning",message:`Template placeholder "{{${v}}}" has no matching prompt/template content — left in the model as-is, not substituted.`});let p;try{p=sr(l)}catch(v){return i.push({severity:"error",message:v instanceof Error?v.message:String(v)}),{resolvedBpmn:l,model:kr(),handlers:{},forms:{},diagnostics:i,hasErrors:!0}}i.push(...p.diagnostics);const a=p.processes.flatMap(v=>v.tasks),d=new Map(e.handlers.map(v=>[v.elementId,v.source])),g={};for(const v of a){if(v.compound)continue;const k=n[v.elementId]??d.get(v.elementId);if(k===void 0){i.push({severity:"error",elementId:v.elementId,jobType:v.jobType,message:`No handler for "${v.label}" (${v.elementId}, job type "${v.jobType}"). Add a handler for this element, or remove it from the diagram.`});continue}try{g[v.elementId]=hr(k)}catch(D){i.push({severity:"error",elementId:v.elementId,jobType:v.jobType,message:`"${v.label}" (${v.elementId}): handler code didn't compile — ${D instanceof Error?D.message:String(D)}`})}}const u=new Set(a.map(v=>v.elementId)),b=new Set([...d.keys(),...Object.keys(n)]);for(const v of b)u.has(v)||i.push({severity:"error",elementId:v,message:`Handler "${v}" doesn't match any element in the current diagram — likely orphaned by a rename. Rename it back, or remove the handler.`});const w={},y=e.forms??{},_=(v,k)=>{if(!v)return;const D=y[v];D?w[v]=D:i.push({severity:"error",formId:v,message:`${k} references form "${v}", which has no matching schema.`})};for(const v of p.processes){_(v.startFormId,`The start event of process "${v.processName}"`);for(const k of v.userTasks)_(k.formId,`User task "${k.label}" (${k.elementId})`)}return{resolvedBpmn:l,model:p,handlers:g,forms:w,diagnostics:i,hasErrors:i.some(v=>v.severity==="error")}}function Tr(e){const n=e.indexOf("{");if(n<0)return null;let t=0;for(let r=n;r<e.length;r++)if(e[r]==="{")t++;else if(e[r]==="}"&&(t--,t===0))try{const i=JSON.parse(e.slice(n,r+1));return typeof i=="object"&&i!==null&&!Array.isArray(i)?i:null}catch{return null}return null}function Tn(e,n=220){const t=e.replace(/\s+/g," ").trim();return t.length>n?`${t.slice(0,n-1)}…`:t}function $n(e){const n=e.arguments??e.args??e.parameters??e.input;return n&&typeof n=="object"&&!Array.isArray(n)?n:{}}function Gn(e){if(!e)return[];const n=e.tool??e.name??e.action;if(typeof n=="string"&&n.trim())return[{name:n.trim(),args:$n(e)}];const t=e.tools??e.tool_calls??e.toolset??e.actions,r=Array.isArray(t)?t:Object.values(e).find(s=>Array.isArray(s))??[],i=[];for(const s of r)if(typeof s=="string")s.trim()&&i.push({name:s.trim(),args:{}});else if(s&&typeof s=="object"){const l=s,m=l.name??l.tool??l.id??l.function;typeof m=="string"&&m.trim()&&i.push({name:m.trim(),args:$n(l)})}return i}function jr(e){if(!e)return!1;const n=e.done??e.finished??e.complete;return typeof n=="boolean"?n:typeof n=="string"?n.toLowerCase()==="true":!1}function Vn(e){const n=e.args.length?e.args.map(r=>`      ${r.name} (${r.type}) — ${r.description}`).join(`
`):"      (none)",t=e.documentation||e.label;return`${e.elementId}
    purpose: ${t}
    arguments:
${n}`}function Sr(e,n,t){const r=e.systemPrompt||"You are an agent driving a business process. Use the tools available to you.",i=t[0]??e.tools[0];if(t.length===0)return`${r}
...
character, with nothing added. When your work is finished, reply exactly
{"done": true} and no tool.`}function Pr(e,n,t,r,i=[],s=[],l=!1){const m=e.userPrompt||"Carry out your task.",p=Object.entries(n).filter(([,d])=>typeof d=="string"&&d.trim().length>0).map(([d,g])=>`  ${d}: ${String(g)}`),a=[m,p.length?`Case data:
${p.join(`
...
`)}async function Ar(e,n,t,r,i,s){let l="";n({kind:"llm",text:"LLM thinking…",key:t,pending:!0,turn:s});const m=await e(r,i,p=>{l+=p,n({kind:"llm",text:`${Tn(l)} ▍`,key:t,pending:!0,turn:s})});return n({kind:"llm",text:Tn(m||l)||"(empty reply)",key:t,pending:!1,turn:s}),m}function Dr(e,n){switch(e){case"number":return typeof n=="number"&&Number.isFinite(n)?{ok:!0,value:n}:typeof n=="string"&&n.trim()!==""&&Number.isFinite(Number(n))?{ok:!0,value:Number(n)}:{ok:!1};case"boolean":return typeof n=="boolean"?{ok:!0,value:n}:typeof n=="string"&&/^(true|false)$/i.test(n.trim())?{ok:!0,value:n.trim().toLowerCase()==="true"}:{ok:!1};default:return typeof n=="object"?{ok:!1}:{ok:!0,value:String(n)}}}function Cr(e,n,t){const r={},i=new Map,s=new Map;for(const{tool:l,args:m}of e){const p={};for(const a of l.args){const d=m[a.name];if(!(d!=null&&d!=="")){n({kind:"error",text:`🤖 ${l.elementId}: model supplied no value for "${a.name}"`,turn:t,elementId:l.elementId});continue}const u=i.get(a.name);if(u!==void 0&&u!==l.elementId){n({kind:"error",text:`🤖 argument name collision on "${a.name}": both ${u} and ${l.elementId} declare it — ${u} already claimed it this turn, ${l.elementId}'s value is dropped`,turn:t,elementId:l.elementId});continue}const b=Dr(a.type,d);if(!b.ok){n({kind:"error",text:`🤖 ${l.elementId}: "${a.name}" is declared as ${a.type} but the model supplied ${JSON.stringify(d)} — rejected, not passed through`,turn:t,elementId:l.elementId});continue}r[a.name]=b.value,p[a.name]=b.value,i.set(a.name,l.elementId)}s.set(l.elementId,p)}return{variablesOut:r,forHistory:s}}function Br(e,n,t,r={}){const{maxNewTokens:i=384,allowRepeats:s=!1,allowMultiToolTurns:l=!1,turnRef:m,requiredTools:p=[],maxEarlyDoneNudges:a=1}=r;let d=0;const g=new Set,u=[];let b=0,w=[],y=[];return async _=>{const v=_.variables,k=v.toolCallResult;for(k!==void 0&&u.length&&(u[u.length-1]=`${u[u.length-1]} → ${Tn(JSON.stringify(k),160)}`);;){const W=await D();if(W)return W}async function D(){if(d+=1,m&&(m.current=d),d>e.maxModelCalls)return t({kind:"error",text:`Turn budget spent (maxModelCalls=${e.maxModelCalls}) — completing the agent.`,turn:d}),{completionConditionFulfilled:!0};const W=s?e.tools:e.tools.filter(N=>!g.has(N.elementId)),Z=[{role:"system",content:Sr(e,l,W)},{role:"user",content:Pr(e,v,u,W,w,y,s)}];w=[],y=[];let ce;try{ce=await Ar(n,t,`llm-turn-${d}`,Z,i,d)}catch(N){return t({kind:"error",text:`LLM call failed: ${N instanceof Error?N.message:String(N)} — completing the agent.`,turn:d}),{completionConditionFulfilled:!0}}const X=Tr(ce);if(jr(X)&&Gn(X).length===0){const N=p.filter(V=>!g.has(V));return N.length&&b<a?(b+=1,w=N,t({kind:"agent",text:`🤖 model says it is done, but ${N.join(", ")} hasn't run — asking once more`,turn:d}),null):(t({kind:"agent",text:"🤖 model says it is done",turn:d}),{completionConditionFulfilled:!0})}const se=Gn(X);if(se.length===0)return t({kind:"error",text:"🤖 model named no tool (and didn't say it was done) — asking again",turn:d}),y=['it named no tool and did not say it was done — reply with {"tool": "...", "arguments": {...}} or {"done": true}'],null;const G=[],ee=[],ge=[];for(const N of se){const V=e.tools.find(U=>U.elementId===N.name);if(!V){ee.push(N.name);continue}if(!s&&g.has(V.elementId)){ge.push(V.elementId);continue}G.push({tool:V,args:N.args})}if(ee.length&&t({kind:"error",text:`🤖 model named a tool that doesn't exist: ${ee.join(", ")} — nothing activated`,turn:d}),ge.length&&t({kind:"error",text:`🤖 model asked to re-run ${ge.join(", ")} — skipped (already run)`,turn:d}),G.length===0)return t({kind:"agent",text:"🤖 nothing activated — asking again",turn:d}),y=[...ee.length?[`${ee.join(", ")} ${ee.length===1?"is":"are"} not a real tool`]:[],...ge.length?[`${ge.join(", ")} has already run and will never run again — pick a different tool, or reply {"done": true} if nothing is left to do`]:[]],null;const{variablesOut:S,forHistory:E}=Cr(G,t,d);for(const{tool:N}of G)g.add(N.elementId),u.push(`- ${N.elementId}(${JSON.stringify(E.get(N.elementId))})`);for(const{tool:N}of G)t({kind:"agent",text:`🤖 calling ${N.elementId}`,turn:d,elementId:N.elementId,args:E.get(N.elementId)??{}});return{activateElements:G.map(N=>({elementId:N.tool.elementId})),variables:S}}}}function Lr(e,n,t,r={}){const i=new Map(e.map(s=>[s.elementId,Br(s,n,t,r)]));return async s=>{const l=i.get(s.elementId);if(!l)throw new Error(`No agent host registered for "${s.elementId}"`);return l(s)}}class jn{__destroy_into_raw(){const n=this.__wbg_ptr;return this.__wbg_ptr=0,Yn.unregister(this),n}free(){const n=this.__destroy_into_raw();c.__wbg_testengine_free(n,0)}activateJobs(n,t,r,i){let s,l;try{const b=c.__wbindgen_add_to_stack_pointer(-16),w=P(n,c.__wbindgen_export,c.__wbindgen_export2),y=j,_=P(i,c.__wbindgen_export,c.__wbindgen_export2),v=j;c.testengine_activateJobs(b,this.__wbg_ptr,w,y,t,r,_,v);var m=f().getInt32(b+0,!0),p=f().getInt32(b+4,!0),a=f().getInt32(b+8,!0),d=f().getInt32(b+12,!0),g=m,u=p;if(d)throw g=0,u=0,R(a);return s=g,l=u,L(g,u)}finally{c.__wbindgen_add_to_stack_pointer(16),c.__wbindgen_export3(s,l,1)}}advanceTime(n){let t,r;try{const d=c.__wbindgen_add_to_stack_pointer(-16);c.testengine_advanceTime(d,this.__wbg_ptr,n);var i=f().getInt32(d+0,!0),s=f().getInt32(d+4,!0),l=f().getInt32(d+8,!0),m=f().getInt32(d+12,!0),p=i,a=s;if(m)throw p=0,a=0,R(l);return t=p,r=a,L(p,a)}finally{c.__wbindgen_add_to_stack_pointer(16),c.__wbindgen_export3(t,r,1)}}assignUserTask(n,t,r){let i,s;try{const u=c.__wbindgen_add_to_stack_pointer(-16),b=P(n,c.__wbindgen_export,c.__wbindgen_export2),w=j,y=P(t,c.__wbindgen_export,c.__wbindgen_export2),_=j;c.testengine_assignUserTask(u,this.__wbg_ptr,b,w,y,_,r);var l=f().getInt32(u+0,!0),m=f().getInt32(u+4,!0),p=f().getInt32(u+8,!0),a=f().getInt32(u+12,!0),d=l,g=m;if(a)throw d=0,g=0,R(p);return i=d,s=g,L(d,g)}finally{c.__wbindgen_add_to_stack_pointer(16),c.__wbindgen_export3(i,s,1)}}broadcastSignal(n,t){let r,i;try{const g=c.__wbindgen_add_to_stack_pointer(-16),u=P(n,c.__wbindgen_export,c.__wbindgen_export2),b=j,w=P(t,c.__wbindgen_export,c.__wbindgen_export2),y=j;c.testengine_broadcastSignal(g,this.__wbg_ptr,u,b,w,y);var s=f().getInt32(g+0,!0),l=f().getInt32(g+4,!0),m=f().getInt32(g+8,!0),p=f().getInt32(g+12,!0),a=s,d=l;if(p)throw a=0,d=0,R(m);return r=a,i=d,L(a,d)}finally{c.__wbindgen_add_to_stack_pointer(16),c.__wbindgen_export3(r,i,1)}}cancelInstance(n){let t,r;try{const d=c.__wbindgen_add_to_stack_pointer(-16),g=P(n,c.__wbindgen_export,c.__wbindgen_export2),u=j;c.testengine_cancelInstance(d,this.__wbg_ptr,g,u);var i=f().getInt32(d+0,!0),s=f().getInt32(d+4,!0),l=f().getInt32(d+8,!0),m=f().getInt32(d+12,!0),p=i,a=s;if(m)throw p=0,a=0,R(l);return t=p,r=a,L(p,a)}finally{c.__wbindgen_add_to_stack_pointer(16),c.__wbindgen_export3(t,r,1)}}completeAgentJob(n,t,r){let i,s;try{const u=c.__wbindgen_add_to_stack_pointer(-16),b=P(n,c.__wbindgen_export,c.__wbindgen_export2),w=j,y=P(t,c.__wbindgen_export,c.__wbindgen_export2),_=j,v=P(r,c.__wbindgen_export,c.__wbindgen_export2),k=j;c.testengine_completeAgentJob(u,this.__wbg_ptr,b,w,y,_,v,k);var l=f().getInt32(u+0,!0),m=f().getInt32(u+4,!0),p=f().getInt32(u+8,!0),a=f().getInt32(u+12,!0),d=l,g=m;if(a)throw d=0,g=0,R(p);return i=d,s=g,L(d,g)}finally{c.__wbindgen_add_to_stack_pointer(16),c.__wbindgen_export3(i,s,1)}}completeJob(n,t){let r,i;try{const g=c.__wbindgen_add_to_stack_pointer(-16),u=P(n,c.__wbindgen_export,c.__wbindgen_export2),b=j,w=P(t,c.__wbindgen_export,c.__wbindgen_export2),y=j;c.testengine_completeJob(g,this.__wbg_ptr,u,b,w,y);var s=f().getInt32(g+0,!0),l=f().getInt32(g+4,!0),m=f().getInt32(g+8,!0),p=f().getInt32(g+12,!0),a=s,d=l;if(p)throw a=0,d=0,R(m);return r=a,i=d,L(a,d)}finally{c.__wbindgen_add_to_stack_pointer(16),c.__wbindgen_export3(r,i,1)}}completeUserTask(n,t){let r,i;try{const g=c.__wbindgen_add_to_stack_pointer(-16),u=P(n,c.__wbindgen_export,c.__wbindgen_export2),b=j,w=P(t,c.__wbindgen_export,c.__wbindgen_export2),y=j;c.testengine_completeUserTask(g,this.__wbg_ptr,u,b,w,y);var s=f().getInt32(g+0,!0),l=f().getInt32(g+4,!0),m=f().getInt32(g+8,!0),p=f().getInt32(g+12,!0),a=s,d=l;if(p)throw a=0,d=0,R(m);return r=a,i=d,L(a,d)}finally{c.__wbindgen_add_to_stack_pointer(16),c.__wbindgen_export3(r,i,1)}}correlateMessage(n,t,r){let i,s;try{const u=c.__wbindgen_add_to_stack_pointer(-16),b=P(n,c.__wbindgen_export,c.__wbindgen_export2),w=j,y=P(t,c.__wbindgen_export,c.__wbindgen_export2),_=j,v=P(r,c.__wbindgen_export,c.__wbindgen_export2),k=j;c.testengine_correlateMessage(u,this.__wbg_ptr,b,w,y,_,v,k);var l=f().getInt32(u+0,!0),m=f().getInt32(u+4,!0),p=f().getInt32(u+8,!0),a=f().getInt32(u+12,!0),d=l,g=m;if(a)throw d=0,g=0,R(p);return i=d,s=g,L(d,g)}finally{c.__wbindgen_add_to_stack_pointer(16),c.__wbindgen_export3(i,s,1)}}createInstance(n,t,r){let i,s;try{const u=c.__wbindgen_add_to_stack_pointer(-16),b=P(n,c.__wbindgen_export,c.__wbindgen_export2),w=j,y=P(t,c.__wbindgen_export,c.__wbindgen_export2),_=j;c.testengine_createInstance(u,this.__wbg_ptr,b,w,y,_,Ur(r)?Number.MAX_SAFE_INTEGER:r>>0);var l=f().getInt32(u+0,!0),m=f().getInt32(u+4,!0),p=f().getInt32(u+8,!0),a=f().getInt32(u+12,!0),d=l,g=m;if(a)throw d=0,g=0,R(p);return i=d,s=g,L(d,g)}finally{c.__wbindgen_add_to_stack_pointer(16),c.__wbindgen_export3(i,s,1)}}debugClear(){c.testengine_debugClear(this.__wbg_ptr)}debugCreateInstance(n,t,r){let i,s;try{const u=c.__wbindgen_add_to_stack_pointer(-16),b=P(n,c.__wbindgen_export,c.__wbindgen_export2),w=j,y=P(t,c.__wbindgen_export,c.__wbindgen_export2),_=j,v=P(r,c.__wbindgen_export,c.__wbindgen_export2),k=j;c.testengine_debugCreateInstance(u,this.__wbg_ptr,b,w,y,_,v,k);var l=f().getInt32(u+0,!0),m=f().getInt32(u+4,!0),p=f().getInt32(u+8,!0),a=f().getInt32(u+12,!0),d=l,g=m;if(a)throw d=0,g=0,R(p);return i=d,s=g,L(d,g)}finally{c.__wbindgen_add_to_stack_pointer(16),c.__wbindgen_export3(i,s,1)}}get debugIsPaused(){return c.testengine_debugIsPaused(this.__wbg_ptr)!==0}debugResume(){let n,t;try{const a=c.__wbindgen_add_to_stack_pointer(-16);c.testengine_debugResume(a,this.__wbg_ptr);var r=f().getInt32(a+0,!0),i=f().getInt32(a+4,!0),s=f().getInt32(a+8,!0),l=f().getInt32(a+12,!0),m=r,p=i;if(l)throw m=0,p=0,R(s);return n=m,t=p,L(m,p)}finally{c.__wbindgen_add_to_stack_pointer(16),c.__wbindgen_export3(n,t,1)}}debugStep(){let n,t;try{const a=c.__wbindgen_add_to_stack_pointer(-16);c.testengine_debugStep(a,this.__wbg_ptr);var r=f().getInt32(a+0,!0),i=f().getInt32(a+4,!0),s=f().getInt32(a+8,!0),l=f().getInt32(a+12,!0),m=r,p=i;if(l)throw m=0,p=0,R(s);return n=m,t=p,L(m,p)}finally{c.__wbindgen_add_to_stack_pointer(16),c.__wbindgen_export3(n,t,1)}}deploy(n){let t,r;try{const d=c.__wbindgen_add_to_stack_pointer(-16),g=P(n,c.__wbindgen_export,c.__wbindgen_export2),u=j;c.testengine_deploy(d,this.__wbg_ptr,g,u);var i=f().getInt32(d+0,!0),s=f().getInt32(d+4,!0),l=f().getInt32(d+8,!0),m=f().getInt32(d+12,!0),p=i,a=s;if(m)throw p=0,a=0,R(l);return t=p,r=a,L(p,a)}finally{c.__wbindgen_add_to_stack_pointer(16),c.__wbindgen_export3(t,r,1)}}deployForm(n){let t,r;try{const d=c.__wbindgen_add_to_stack_pointer(-16),g=P(n,c.__wbindgen_export,c.__wbindgen_export2),u=j;c.testengine_deployForm(d,this.__wbg_ptr,g,u);var i=f().getInt32(d+0,!0),s=f().getInt32(d+4,!0),l=f().getInt32(d+8,!0),m=f().getInt32(d+12,!0),p=i,a=s;if(m)throw p=0,a=0,R(l);return t=p,r=a,L(p,a)}finally{c.__wbindgen_add_to_stack_pointer(16),c.__wbindgen_export3(t,r,1)}}deployResource(n,t){let r,i;try{const g=c.__wbindgen_add_to_stack_pointer(-16),u=P(n,c.__wbindgen_export,c.__wbindgen_export2),b=j,w=P(t,c.__wbindgen_export,c.__wbindgen_export2),y=j;c.testengine_deployResource(g,this.__wbg_ptr,u,b,w,y);var s=f().getInt32(g+0,!0),l=f().getInt32(g+4,!0),m=f().getInt32(g+8,!0),p=f().getInt32(g+12,!0),a=s,d=l;if(p)throw a=0,d=0,R(m);return r=a,i=d,L(a,d)}finally{c.__wbindgen_add_to_stack_pointer(16),c.__wbindgen_export3(r,i,1)}}events(){let n,t;try{const a=c.__wbindgen_add_to_stack_pointer(-16);c.testengine_events(a,this.__wbg_ptr);var r=f().getInt32(a+0,!0),i=f().getInt32(a+4,!0),s=f().getInt32(a+8,!0),l=f().getInt32(a+12,!0),m=r,p=i;if(l)throw m=0,p=0,R(s);return n=m,t=p,L(m,p)}finally{c.__wbindgen_add_to_stack_pointer(16),c.__wbindgen_export3(n,t,1)}}failJob(n,t,r){let i,s;try{const u=c.__wbindgen_add_to_stack_pointer(-16),b=P(n,c.__wbindgen_export,c.__wbindgen_export2),w=j,y=P(r,c.__wbindgen_export,c.__wbindgen_export2),_=j;c.testengine_failJob(u,this.__wbg_ptr,b,w,t,y,_);var l=f().getInt32(u+0,!0),m=f().getInt32(u+4,!0),p=f().getInt32(u+8,!0),a=f().getInt32(u+12,!0),d=l,g=m;if(a)throw d=0,g=0,R(p);return i=d,s=g,L(d,g)}finally{c.__wbindgen_add_to_stack_pointer(16),c.__wbindgen_export3(i,s,1)}}migrate(n,t,r){let i,s;try{const u=c.__wbindgen_add_to_stack_pointer(-16),b=P(n,c.__wbindgen_export,c.__wbindgen_export2),w=j,y=P(t,c.__wbindgen_export,c.__wbindgen_export2),_=j,v=P(r,c.__wbindgen_export,c.__wbindgen_export2),k=j;c.testengine_migrate(u,this.__wbg_ptr,b,w,y,_,v,k);var l=f().getInt32(u+0,!0),m=f().getInt32(u+4,!0),p=f().getInt32(u+8,!0),a=f().getInt32(u+12,!0),d=l,g=m;if(a)throw d=0,g=0,R(p);return i=d,s=g,L(d,g)}finally{c.__wbindgen_add_to_stack_pointer(16),c.__wbindgen_export3(i,s,1)}}modify(n,t,r){let i,s;try{const u=c.__wbindgen_add_to_stack_pointer(-16),b=P(n,c.__wbindgen_export,c.__wbindgen_export2),w=j,y=P(t,c.__wbindgen_export,c.__wbindgen_export2),_=j,v=P(r,c.__wbindgen_export,c.__wbindgen_export2),k=j;c.testengine_modify(u,this.__wbg_ptr,b,w,y,_,v,k);var l=f().getInt32(u+0,!0),m=f().getInt32(u+4,!0),p=f().getInt32(u+8,!0),a=f().getInt32(u+12,!0),d=l,g=m;if(a)throw d=0,g=0,R(p);return i=d,s=g,L(d,g)}finally{c.__wbindgen_add_to_stack_pointer(16),c.__wbindgen_export3(i,s,1)}}constructor(){const n=c.testengine_new();return this.__wbg_ptr=n,Yn.register(this,this.__wbg_ptr,this),this}get now(){return c.testengine_now(this.__wbg_ptr)}reset(){c.testengine_reset(this.__wbg_ptr)}resolveIncident(n){let t,r;try{const d=c.__wbindgen_add_to_stack_pointer(-16),g=P(n,c.__wbindgen_export,c.__wbindgen_export2),u=j;c.testengine_resolveIncident(d,this.__wbg_ptr,g,u);var i=f().getInt32(d+0,!0),s=f().getInt32(d+4,!0),l=f().getInt32(d+8,!0),m=f().getInt32(d+12,!0),p=i,a=s;if(m)throw p=0,a=0,R(l);return t=p,r=a,L(p,a)}finally{c.__wbindgen_add_to_stack_pointer(16),c.__wbindgen_export3(t,r,1)}}setVariables(n,t,r){let i,s;try{const u=c.__wbindgen_add_to_stack_pointer(-16),b=P(n,c.__wbindgen_export,c.__wbindgen_export2),w=j,y=P(t,c.__wbindgen_export,c.__wbindgen_export2),_=j;c.testengine_setVariables(u,this.__wbg_ptr,b,w,y,_,r);var l=f().getInt32(u+0,!0),m=f().getInt32(u+4,!0),p=f().getInt32(u+8,!0),a=f().getInt32(u+12,!0),d=l,g=m;if(a)throw d=0,g=0,R(p);return i=d,s=g,L(d,g)}finally{c.__wbindgen_add_to_stack_pointer(16),c.__wbindgen_export3(i,s,1)}}snapshot(){let n,t;try{const a=c.__wbindgen_add_to_stack_pointer(-16);c.testengine_snapshot(a,this.__wbg_ptr);var r=f().getInt32(a+0,!0),i=f().getInt32(a+4,!0),s=f().getInt32(a+8,!0),l=f().getInt32(a+12,!0),m=r,p=i;if(l)throw m=0,p=0,R(s);return n=m,t=p,L(m,p)}finally{c.__wbindgen_add_to_stack_pointer(16),c.__wbindgen_export3(n,t,1)}}throwError(n,t,r){let i,s;try{const u=c.__wbindgen_add_to_stack_pointer(-16),b=P(n,c.__wbindgen_export,c.__wbindgen_export2),w=j,y=P(t,c.__wbindgen_export,c.__wbindgen_export2),_=j,v=P(r,c.__wbindgen_export,c.__wbindgen_export2),k=j;c.testengine_throwError(u,this.__wbg_ptr,b,w,y,_,v,k);var l=f().getInt32(u+0,!0),m=f().getInt32(u+4,!0),p=f().getInt32(u+8,!0),a=f().getInt32(u+12,!0),d=l,g=m;if(a)throw d=0,g=0,R(p);return i=d,s=g,L(d,g)}finally{c.__wbindgen_add_to_stack_pointer(16),c.__wbindgen_export3(i,s,1)}}tickNow(n){let t,r;try{const d=c.__wbindgen_add_to_stack_pointer(-16);c.testengine_tickNow(d,this.__wbg_ptr,n);var i=f().getInt32(d+0,!0),s=f().getInt32(d+4,!0),l=f().getInt32(d+8,!0),m=f().getInt32(d+12,!0),p=i,a=s;if(m)throw p=0,a=0,R(l);return t=p,r=a,L(p,a)}finally{c.__wbindgen_add_to_stack_pointer(16),c.__wbindgen_export3(t,r,1)}}unassignUserTask(n){let t,r;try{const d=c.__wbindgen_add_to_stack_pointer(-16),g=P(n,c.__wbindgen_export,c.__wbindgen_export2),u=j;c.testengine_unassignUserTask(d,this.__wbg_ptr,g,u);var i=f().getInt32(d+0,!0),s=f().getInt32(d+4,!0),l=f().getInt32(d+8,!0),m=f().getInt32(d+12,!0),p=i,a=s;if(m)throw p=0,a=0,R(l);return t=p,r=a,L(p,a)}finally{c.__wbindgen_add_to_stack_pointer(16),c.__wbindgen_export3(t,r,1)}}updateRetries(n,t){let r,i;try{const g=c.__wbindgen_add_to_stack_pointer(-16),u=P(n,c.__wbindgen_export,c.__wbindgen_export2),b=j;c.testengine_updateRetries(g,this.__wbg_ptr,u,b,t);var s=f().getInt32(g+0,!0),l=f().getInt32(g+4,!0),m=f().getInt32(g+8,!0),p=f().getInt32(g+12,!0),a=s,d=l;if(p)throw a=0,d=0,R(m);return r=a,i=d,L(a,d)}finally{c.__wbindgen_add_to_stack_pointer(16),c.__wbindgen_export3(r,i,1)}}updateUserTask(n,t){let r,i;try{const g=c.__wbindgen_add_to_stack_pointer(-16),u=P(n,c.__wbindgen_export,c.__wbindgen_export2),b=j,w=P(t,c.__wbindgen_export,c.__wbindgen_export2),y=j;c.testengine_updateUserTask(g,this.__wbg_ptr,u,b,w,y);var s=f().getInt32(g+0,!0),l=f().getInt32(g+4,!0),m=f().getInt32(g+8,!0),p=f().getInt32(g+12,!0),a=s,d=l;if(p)throw a=0,d=0,R(m);return r=a,i=d,L(a,d)}finally{c.__wbindgen_add_to_stack_pointer(16),c.__wbindgen_export3(r,i,1)}}}Symbol.dispose&&(jn.prototype[Symbol.dispose]=jn.prototype.free);function Rr(){return{__proto__:null,"./nanobpmn_engine_bg.js":{__proto__:null,__wbg___wbindgen_throw_bb96b2010945f0bc:function(n,t){throw new Error(L(n,t))},__wbindgen_cast_0000000000000001:function(n,t){const r=L(n,t);return Fr(r)},__wbindgen_object_drop_ref:function(n){R(n)}}}}const Yn=typeof FinalizationRegistry>"u"?{register:()=>{},unregister:()=>{}}:new FinalizationRegistry(e=>c.__wbg_testengine_free(e,1));function Fr(e){We===Ie.length&&Ie.push(Ie.length+1);const n=We;return We=Ie[n],Ie[n]=e,n}function zr(e){e<1028||(Ie[e]=We,We=e)}let Le=null;function f(){return(Le===null||Le.buffer.detached===!0||Le.buffer.detached===void 0&&Le.buffer!==c.memory.buffer)&&(Le=new DataView(c.memory.buffer)),Le}function L(e,n){return Gr(e>>>0,n)}let He=null;function sn(){return(He===null||He.byteLength===0)&&(He=new Uint8Array(c.memory.buffer)),He}function Or(e){return Ie[e]}let Ie=new Array(1024).fill(void 0);Ie.push(void 0,null,!0,!1);let We=Ie.length;function Ur(e){return e==null}function P(e,n,t){if(t===void 0){const m=Ze.encode(e),p=n(m.length,1)>>>0;return sn().subarray(p,p+m.length).set(m),j=m.length,p}let r=e.length,i=n(r,1)>>>0;const s=sn();let l=0;for(;l<r;l++){const m=e.charCodeAt(l);if(m>127)break;s[i+l]=m}if(l!==r){l!==0&&(e=e.slice(l)),i=t(i,r,r=l+e.length*3,1)>>>0;const m=sn().subarray(i+l,i+r),p=Ze.encodeInto(e,m);l+=p.written,i=t(i,r,l,1)>>>0}return j=l,i}function R(e){const n=Or(e);return zr(e),n}let dn=new TextDecoder("utf-8",{ignoreBOM:!0,fatal:!0});dn.decode();const $r=2146435072;let _n=0;function Gr(e,n){return _n+=n,_n>=$r&&(dn=new TextDecoder("utf-8",{ignoreBOM:!0,fatal:!0}),dn.decode(),_n=n),dn.decode(sn().subarray(e,e+n))}const Ze=new TextEncoder;"encodeInto"in Ze||(Ze.encodeInto=function(e,n){const t=Ze.encode(e);return n.set(t),{read:e.length,written:t.length}});let j=0,c;function Vr(e,n){return c=e.exports,Le=null,He=null,c}async function Yr(e,n){if(typeof Response=="function"&&e instanceof Response){if(!e.ok)throw new Error(`failed to fetch Wasm: ${e.status} ${e.statusText} fetching '${e.url}'`);if(typeof WebAssembly.instantiateStreaming=="function")try{return await WebAssembly.instantiateStreaming(e,n)}catch(i){if(t(e.type)&&e.headers.get("Content-Type")!=="application/wasm")console.warn("`WebAssembly.instantiateStreaming` failed because your server does not serve Wasm with `application/wasm` MIME type. Falling back to `WebAssembly.instantiate` which is slower. Original error:\n",i);else throw i}const r=await e.arrayBuffer();return await WebAssembly.instantiate(r,n)}else{const r=await WebAssembly.instantiate(e,n);return r instanceof WebAssembly.Instance?{instance:r,module:e}:r}function t(r){switch(r){case"basic":case"cors":case"default":return!0}return!1}}async function Qr(e){if(c!==void 0)return c;e!==void 0&&(Object.getPrototypeOf(e)===Object.prototype?{module_or_path:e}=e:console.warn("using deprecated parameters for the initialization function; pass a single object instead")),e===void 0&&(e=new URL("/pr-preview/pr-99/assets/nanobpmn_engine_bg-DRNrIVE8.wasm",import.meta.url));const n=Rr();(typeof e=="string"||typeof Request=="function"&&e instanceof Request||typeof URL=="function"&&e instanceof URL)&&(e=fetch(e));const{instance:t,module:r}=await Yr(await e,n);return Vr(t)}let on=null;function qr(e){return on||(on=Qr(void 0).then(()=>{}).catch(n=>{throw on=null,n})),on}function K(e){return JSON.parse(e)}class Jr{constructor(n){z(this,"engine");this.engine=n}deploy(n){return JSON.parse(this.engine.deploy(n))}createInstance(n,t){return K(this.engine.createInstance(n,t||"{}"))}activateJobs(n,t,r,i){return JSON.parse(this.engine.activateJobs(n,t,r,i))}completeJob(n,t){return K(this.engine.completeJob(n,t||"{}"))}completeAgentJob(n,t){const{variables:r,...i}=t??{};return K(this.engine.completeAgentJob(n,JSON.stringify(r??{}),JSON.stringify(i??{})))}failJob(n,t,r){return K(this.engine.failJob(n,t,r))}throwError(n,t,r){return K(this.engine.throwError(n,t,r))}updateRetries(n,t){return K(this.engine.updateRetries(n,t))}resolveIncident(n){return K(this.engine.resolveIncident(n))}setVariables(n,t,r){return K(this.engine.setVariables(n,t||"{}",r))}broadcastSignal(n,t){return K(this.engine.broadcastSignal(n,t||"{}"))}cancelInstance(n){return K(this.engine.cancelInstance(n))}modify(n,t,r){return K(this.engine.modify(n,JSON.stringify(t??[]),JSON.stringify(r??[])))}completeUserTask(n,t){return K(this.engine.completeUserTask(n,t||"{}"))}assignUserTask(n,t,r){return K(this.engine.assignUserTask(n,t,r))}unassignUserTask(n){return K(this.engine.unassignUserTask(n))}updateUserTask(n,t){return K(this.engine.updateUserTask(n,t||"{}"))}correlateMessage(n,t,r){return K(this.engine.correlateMessage(n,t,r||"{}"))}advanceTime(n){return K(this.engine.advanceTime(n))}reset(){this.engine.reset()}events(){return JSON.parse(this.engine.events())}snapshot(){return K(this.engine.snapshot())}free(){this.engine.free()}}async function Hr(e){return await qr(),new Jr(new jn)}class vt extends Error{constructor(t,r){super(t);z(this,"retries");this.name="JobFailure",this.retries=r==null?void 0:r.retries}}function Wr(e,n=[]){if(e.instances.filter(i=>!i.completed).length===0)return e.totalInstances>0?"completed":"idle";if(e.incidents.length>0)return"incidents";const r=new Set(n);return e.jobs.some(i=>!r.has(i.jobType))?"unhandledJobs":e.userTasks.some(i=>i.state==="Created")?"userTasks":e.timers.length>0?"timers":e.messageSubscriptions.length>0?"messages":e.signalSubscriptions.length>0?"signals":"idle"}function Zr(e,n=[]){const t=new Set(n);return[...new Set(e.jobs.map(r=>r.jobType))].filter(r=>!t.has(r)).sort()}async function Kr(e,n,t){let r;try{const i=await n(t);r=JSON.stringify(i??{})}catch(i){const s=i instanceof vt&&i.retries!==void 0?i.retries:Math.max(0,t.retries-1),l=i instanceof Error?i.message:String(i);e.failJob(t.key,s,l);return}e.completeJob(t.key,r)}async function Xr(e,n,t){let r;try{r=await n(t),JSON.stringify(r)}catch(i){const s=i instanceof vt&&i.retries!==void 0?i.retries:Math.max(0,t.retries-1),l=i instanceof Error?i.message:String(i);e.failJob(t.key,s,l);return}e.completeAgentJob(t.key,r)}async function ei(e,n,t={}){const r=t.maxJobsPerActivation??10,i=t.lockTimeoutMs??3e4,s=t.worker??"bojtos",l=t.agents??{};for(const u of Object.keys(l))if(u in n)throw new Error(`dispatchRound: job type "${u}" is registered as both a worker and an agent — register it as exactly one`);const m=[];for(const[u,b]of Object.entries(n))for(const w of e.activateJobs(u,r,i,s))m.push({handler:b,job:w});const p=[];for(const[u,b]of Object.entries(l))for(const w of e.activateJobs(u,r,i,s))p.push({handler:b,job:w});for(const{handler:u,job:b}of m)await Kr(e,u,b);for(const{handler:u,job:b}of p)await Xr(e,u,b);const a=e.snapshot(),d=m.length+p.length;if(d>0)return{snapshot:a,handled:d};const g=[...Object.keys(n),...Object.keys(l)];return{snapshot:a,handled:d,reason:Wr(a,g),unhandled:Zr(a,g)}}function ni({bpmn:e}){const n=h.useRef(null),[t,r]=h.useState("loading"),[i,s]=h.useState(null),[l,m]=h.useState([]),[p,a]=h.useState(null),d=h.useRef(e),g=h.useRef(0),u=h.useRef(new Map),b=h.useCallback((S,E)=>{u.current.set(S,E)},[]),w=h.useCallback(S=>u.current.get(S),[]),y=h.useCallback((S,E)=>{const N=S.deploy(E);return d.current=E,u.current.clear(),m(N.processIds),a(null),s(null),N.processIds},[]);h.useEffect(()=>{let S=!1;return r("loading"),m([]),a(null),s(null),Hr().then(E=>{if(S){E.free();return}try{y(E,e)}catch(N){E.free(),s(String(N)),r("error");return}n.current=E,r("ready")}).catch(E=>{S||(s(String(E)),r("error"))}),()=>{var E;S=!0,(E=n.current)==null||E.free(),n.current=null,u.current.clear()}},[e]);const _=h.useCallback(S=>{const E=n.current;if(!E)return null;try{const N=S(E);return a(N),s(null),N}catch(N){return s(String(N)),null}},[]),v=h.useCallback((S,E)=>_(N=>N.createInstance(S,E)),[_]),k=h.useCallback((S,E)=>_(N=>N.completeUserTask(S,E)),[_]),D=h.useCallback(S=>_(E=>E.advanceTime(S)),[_]),W=h.useCallback((S,E)=>_(N=>N.broadcastSignal(S,E)),[_]);function Z(S,E){const[N]=S.activateJobs(E,1,3e4,"manual-control");if(!N)throw new Error(`No waiting job of type "${E}" to resolve.`);return N}const ce=h.useCallback((S,E)=>_(N=>{const V=Z(N,S);return N.completeJob(V.key,E)}),[_]),X=h.useCallback((S,E,N)=>_(V=>{const U=Z(V,S);return V.throwError(U.key,E,N)}),[_]),se=h.useCallback((S,E,N)=>_(V=>V.correlateMessage(S,E,N)),[_]),G=h.useCallback(async(S,E)=>{const N=n.current;if(!N)return null;const V=g.current;try{const U=await ei(N,S,E);return n.current!==N||g.current!==V?null:(a(U.snapshot),s(null),U)}catch(U){return n.current!==N||g.current!==V||(a(N.snapshot()),s(String(U))),null}},[]),ee=h.useCallback(()=>{const S=n.current;if(S){g.current++;try{S.reset(),y(S,d.current)}catch(E){s(String(E))}}},[y]),ge=h.useCallback(S=>{const E=n.current;if(!E)return null;g.current++;try{return E.reset(),y(E,S)}catch(N){return s(String(N)),null}},[y]);return{phase:t,error:i,processIds:l,snapshot:p,createInstance:v,stepWorkers:G,completeUserTask:k,advanceTime:D,broadcastSignal:W,completeJobManually:ce,throwJobError:X,correlateMessage:se,reset:ee,redeploy:ge,setRunImage:b,getRunImage:w}}function ti(e,n){return e.slice(n)}function ri(e,n,t,r){const i=e.snapshot,s="⏸ waiting for a human — complete the task below to continue",l=i.userTasks.some(m=>m.state==="Created");if(e.handled>0){const m=i.activeElementIds.map(t),p=n.length?` via ${n.map(a=>`${t(a.from)} → ${t(a.to)}`).join(", ")}`:"";return i.completedInstances>=1?{kind:"done",text:`⏭ round handled ${e.handled} job${e.handled===1?"":"s"}${p} — ✅ process instance completed`}:l?{kind:"human",text:`⏭ round handled ${e.handled} job${e.handled===1?"":"s"}${p} — ${s}`}:{kind:"step",text:`⏭ round handled ${e.handled} job${e.handled===1?"":"s"}${p} — now at ${m.length?m.join(", "):"—"}`}}switch(e.reason){case"completed":return{kind:"done",text:"✅ process instance completed"};case"userTasks":return{kind:"human",text:s};case"timers":return{kind:"step",text:"⏱ waiting on a timer — advance the clock to continue"};case"messages":return{kind:"step",text:"✉ waiting on a message — correlate it to continue"};case"signals":return{kind:"step",text:"📶 waiting on a signal — broadcast it to continue"};case"incidents":return{kind:"error",text:"A job failed — incident on the diagram"};case"unhandledJobs":{const m=e.unhandled??[];return r&&m.length>0&&m.every(p=>r.has(p))?{kind:"human",text:s}:{kind:"error",text:`⏭ waiting on job type(s) with no worker registered: ${m.join(", ")}`}}case"idle":return{kind:"step",text:"Nothing to step — no instance is running."};default:return{kind:"step",text:e.reason?`Step blocked on an unrecognized reason: ${e.reason}`:"Nothing to step — no instance is running."}}}const ii="the Scripted or Endpoint brain";async function oi(){return await Xe()===null}async function Xe(e=ii){const n=navigator.gpu;if(!n)return`This browser doesn't expose WebGPU at all. Use a recent Chrome, Edge, or Safari 17+ with hardware acceleration on, or pick ${e}.`;let t;try{t=await n.requestAdapter()}catch(r){return`WebGPU adapter request failed (${r instanceof Error?r.message:String(r)}). Try ${e} instead.`}return t?null:`This browser supports the WebGPU API, but no GPU adapter is available — hardware acceleration may be off, or this device/VM has no usable GPU. Pick ${e} instead.`}const ai=[{id:"Qwen2.5-1.5B-Instruct-q4f16_1-MLC",label:"Qwen2.5 1.5B",downloadLabel:"~1.0 GB"},{id:"SmolLM2-1.7B-Instruct-q4f16_1-MLC",label:"SmolLM2 1.7B",downloadLabel:"~1.1 GB"},{id:"Llama-3.2-1B-Instruct-q4f16_1-MLC",label:"Llama 3.2 1B",downloadLabel:"~0.7 GB"},{id:"gemma-2-2b-it-q4f16_1-MLC",label:"Gemma 2 2B",downloadLabel:"~1.5 GB"},{id:"Llama-3.2-1B-Instruct-q4f32_1-MLC",label:"Llama 3.2 1B (f32, wider GPU support)",downloadLabel:"~1.1 GB"},{id:"SmolLM2-360M-Instruct-q4f32_1-MLC",label:"SmolLM2 360M (tiny, f32)",downloadLabel:"~0.6 GB"},{id:"SmolLM2-360M-Instruct-q4f16_1-MLC",label:"SmolLM2 360M (tiny)",downloadLabel:"~0.3 GB"}];function Mt(e){return Sn.get(e)??{}}const Sn=new Map;async function si(){if(Sn.size>0)return;const{prebuiltAppConfig:e}=await be(async()=>{const{prebuiltAppConfig:n}=await import("./vendor-webllm-DT0Ab8E6.js");return{prebuiltAppConfig:n}},[]);for(const n of e.model_list)Sn.set(n.model_id,{vramRequiredMB:n.vram_required_MB,requiredFeatures:n.required_features})}const mn=ai.map(e=>({id:e.id,label:`${e.label} (${e.downloadLabel})`,downloadLabel:e.downloadLabel,...Mt(e.id)})),xt=mn[0].id;async function di(){return await si(),mn.map(e=>({...e,...Mt(e.id)}))}function Nt(){const e=navigator.deviceMemory;return typeof e=="number"?e*1024:null}function li(e,n=Nt()){return n==null||e.vramRequiredMB==null||n>=e.vramRequiredMB?null:`${e.label} needs roughly ${Math.round(e.vramRequiredMB)} MB of GPU memory; this device looks like it has about ${Math.round(n)} MB available. It may still work, but expect it to fail or fall back to slow shared memory — try a smaller model (e.g. SmolLM2 360M) if it doesn't load.`}async function ci(e){try{const{hasModelInCache:n}=await be(async()=>{const{hasModelInCache:t}=await import("./vendor-webllm-DT0Ab8E6.js");return{hasModelInCache:t}},[]);return await n(e)}catch{return!1}}function ln(e){return/device (was )?lost|device_hung|device_removed|already been disposed|gpudevicelostinfo/i.test(e)}function Qn(){return"The GPU device was lost — the driver reset while the model was loading or running. This is a browser/driver-level failure, not a problem with the model: fully quit and reopen the browser (a lost device usually persists for the life of the GPU process), check chrome://gpu still reports hardware acceleration, and update your GPU driver if it recurs. The Scripted and Endpoint brains don't use the GPU at all."}class an{constructor(){z(this,"kind","browser");z(this,"model",null);z(this,"engine",null);z(this,"worker",null);z(this,"generation",0);z(this,"chat",async(n,t=512,r)=>{var s,l;const i=this.engine;if(!i||!this.model)throw new Error("BrowserBrain.chat called before connect()");try{const m=await i.chat.completions.create({messages:n,temperature:0,max_tokens:t,stream:!0});let p="";for await(const a of m){const d=((l=(s=a.choices[0])==null?void 0:s.delta)==null?void 0:l.content)??"";d&&(p+=d,r==null||r(d))}return p}catch(m){const p=m instanceof Error?m.message:String(m);throw ln(p)?(this.teardown(),new Error(`The in-browser model stopped: ${Qn()}`)):m}})}async connect(n=xt,t){var p,a;const r=await Xe();if(r)throw new Error(r);if(this.engine&&this.model===n)return n;const i=++this.generation,s=d=>{i===this.generation&&(t==null||t({progress:d.progress??0,text:d.text??""}))};this.teardown();let l,m;try{const{CreateWebWorkerMLCEngine:d}=await be(async()=>{const{CreateWebWorkerMLCEngine:g}=await import("./vendor-webllm-DT0Ab8E6.js");return{CreateWebWorkerMLCEngine:g}},[]);m=new Worker(new URL("/pr-preview/pr-99/assets/webllm.worker-Dc1cCqhL.js",import.meta.url),{type:"module"}),l=await d(m,n,{initProgressCallback:s})}catch(d){if(m==null||m.terminate(),i!==this.generation)throw new Error("cancelled");const g=d instanceof Error?d.message:String(d);if(ln(g))throw new Error(`Couldn't load ${n} in the browser (${g}). ${Qn()}`);const u=(a=(p=mn.find(b=>b.id===n))==null?void 0:p.requiredFeatures)==null?void 0:a.includes("shader-f16");throw new Error(`Couldn't load ${n} in the browser (${g}). `+(u?"This model needs WebGPU with shader-f16; try one of the f32 models in the list, or the endpoint brain.":"Try a smaller model, check your connection, or use the endpoint brain instead."))}if(i!==this.generation)throw l.unload().catch(()=>{}),m==null||m.terminate(),new Error("cancelled");return this.engine=l,this.worker=m??null,this.model=n,n}teardown(){const{engine:n,worker:t}=this;this.engine=null,this.worker=null,this.model=null,n==null||n.unload().catch(()=>{}),t==null||t.terminate()}cancelConnect(){this.generation++}dispose(){this.generation++,this.teardown()}}const Et="http://localhost:11434/v1";function kt(){var n;const e=((n=globalThis.location)==null?void 0:n.hostname)??"";return e==="localhost"||e==="127.0.0.1"||e==="[::1]"||e==="::1"}function cn(e,n={hostname:(t=>(t=globalThis.location)==null?void 0:t.hostname)()??"",origin:(r=>(r=globalThis.location)==null?void 0:r.origin)()??""}){let i;try{i=new URL(It(e)).hostname}catch{return null}const s=l=>l==="localhost"||l==="127.0.0.1"||l==="::1"||l==="[::1]";return!s(i)||s(n.hostname)?null:`This page is served from ${n.origin||"a non-local origin"}, so it can't reach ${e}. A local model server only accepts requests from a page on localhost. Open this page at http://localhost instead, or use the Scripted or In-browser brain.`}function It(e){let n=e.trim().replace(/\/+$/,"");return n.endsWith("/chat/completions")&&(n=n.slice(0,-17)),/\/v\d+$/.test(n)||(n=`${n}/v1`),n}class qn extends Error{constructor(n,t){super(n),this.status=t,this.name="HttpError"}}class Jn{constructor(n=Et,t="",r=""){z(this,"kind","endpoint");z(this,"baseUrl");z(this,"model",null);z(this,"models",[]);z(this,"apiKey");z(this,"requestedModel");z(this,"chat",async(n,t=512,r)=>{var a,d,g;if(!this.model)throw new Error("EndpointBrain.chat called before connect()");const i=await fetch(`${this.baseUrl}/chat/completions`,{method:"POST",headers:this.headers(),body:JSON.stringify({model:this.model,messages:n,temperature:0,max_tokens:t,stream:!0})});if(!i.ok||!i.body){const u=await i.text().catch(()=>"");throw new Error(`chat/completions HTTP ${i.status} ${i.statusText}${u?` — ${u.slice(0,300)}`:""}`)}const s=i.body.getReader(),l=new TextDecoder;let m="",p="";for(;;){const{value:u,done:b}=await s.read();if(b)break;m+=l.decode(u,{stream:!0});let w;for(;(w=m.indexOf(`
`))>=0;){const y=m.slice(0,w).trim();if(m=m.slice(w+1),!y.startsWith("data:"))continue;const _=y.slice(5).trim();if(_==="[DONE]")continue;let v;try{v=JSON.parse(_)}catch{continue}v.model&&(this.model=v.model);const k=(a=v.choices)==null?void 0:a[0],D=((d=k==null?void 0:k.delta)==null?void 0:d.content)??((g=k==null?void 0:k.message)==null?void 0:g.content)??"";D&&(p+=D,r==null||r(D))}}return p});this.baseUrl=It(n),this.apiKey=t.trim(),this.requestedModel=r.trim()}headers(){const n={"Content-Type":"application/json"};return this.apiKey&&(n.Authorization=`Bearer ${this.apiKey}`),n}async listModels(){let n;try{n=await fetch(`${this.baseUrl}/models`,{headers:this.headers()})}catch(r){const i=cn(this.baseUrl);throw new Error(i??`Can't reach ${this.baseUrl} (${r instanceof Error?r.message:String(r)}). Is the server running? For Ollama, check the app is up — and if this page is served from another origin, allow it with OLLAMA_ORIGINS.`)}if(!n.ok)throw new qn(`${this.baseUrl}/models returned HTTP ${n.status} ${n.statusText}`,n.status);const t=await n.json();return this.models=(t.data??[]).map(r=>r.id).filter(r=>!!r),this.models}async connect(){try{const n=await this.listModels(),t=this.requestedModel||n[0];if(!t)throw new Error(`No models available at ${this.baseUrl}. Pull one first — e.g. \`ollama pull llama3.2:3b\` — or name one explicitly.`);this.model=t}catch(n){const t=n instanceof qn&&[404,405,501].includes(n.status);if(!this.requestedModel||!t)throw n;this.models=[],this.model=this.requestedModel}return await this.validate(),this.model}async validate(){const n=await fetch(`${this.baseUrl}/chat/completions`,{method:"POST",headers:this.headers(),body:JSON.stringify({model:this.model,messages:[{role:"user",content:"Reply with ok."}],temperature:0,max_tokens:1,stream:!1})}).catch(r=>{throw new Error(`Can't reach ${this.baseUrl}/chat/completions (${r instanceof Error?r.message:String(r)}). Check the endpoint URL, API key, model name, and any local CORS settings.`)});if(!n.ok){const r=await n.text().catch(()=>"");throw new Error(`chat/completions HTTP ${n.status} ${n.statusText}${r?` — ${r.slice(0,300)}`:""}`)}const t=await n.json().catch(()=>({}));t.model&&(this.model=t.model)}dispose(){}}const mi=[{id:"onnx-community/Florence-2-base-ft",label:"Florence-2 base",downloadLabel:"~0.4 GB"},{id:"onnx-community/Florence-2-large-ft",label:"Florence-2 large (higher quality)",downloadLabel:"~1.6 GB"}],Tt=mi.map(e=>({...e,label:`${e.label} (${e.downloadLabel})`})),jt=Tt[0].id,pi="<OCR>",Hn="UNKNOWN (scripted brain — connect the in-browser model to read a photo)";function ui(e,n){if(e)return typeof e=="function"?e(n):e[n]}class gi{constructor(n){z(this,"kind","scripted-vision");z(this,"model",null);z(this,"read",async(n,t,r)=>{const i=typeof n=="string"?ui(this.lookup,n)??Hn:Hn;return r==null||r(i),i});this.lookup=n}dispose(){}}function hi(e){return new gi(e)}class Wn{constructor(){z(this,"kind","browser-vision");z(this,"model",null);z(this,"modelHandle",null);z(this,"processor",null);z(this,"loadImage",null);z(this,"generation",0);z(this,"read",async(n,t,r)=>{const i=this.modelHandle,s=this.processor,l=this.loadImage;if(!i||!s||!l||!this.model)throw new Error("BrowserVisionBrain.read called before connect()");const m=t&&t.startsWith("<")?t:pi,p=await l(n),a=s.construct_prompts(m),d=await s(p,a),g=await i.generate({...d,max_new_tokens:512,num_beams:1,do_sample:!1}),u=s.batch_decode(g,{skip_special_tokens:!1})[0],b=s.post_process_generation(u,m,p.size),w=bi(b,m);return r==null||r(w),w})}async connect(n=jt,t){var m,p;const r=await Xe("the scripted-vision fallback");if(r)throw new Error(r);if(this.modelHandle&&this.model===n)return n;const i=++this.generation,s=a=>{i===this.generation&&(t==null||t({progress:(a.progress??0)/100,text:a.file?`${a.status??"loading"} ${a.file}`:a.status??""}))};this.teardown();let l;try{const{Florence2ForConditionalGeneration:a,AutoProcessor:d,load_image:g}=await be(async()=>{const{Florence2ForConditionalGeneration:w,AutoProcessor:y,load_image:_}=await import("./transformers.web-ZZjRzBhq.js");return{Florence2ForConditionalGeneration:w,AutoProcessor:y,load_image:_}},[]),u=await a.from_pretrained(n,{dtype:"fp32",device:"webgpu",progress_callback:s}),b=await d.from_pretrained(n);l={model:u,processor:b,loadImage:g}}catch(a){if(i!==this.generation)throw new Error("cancelled");const d=a instanceof Error?a.message:String(a);throw new Error(`Couldn't load ${n} in the browser (${d}). Try the smaller Florence-2 base model, check your connection, or use the scripted-vision fallback.`)}if(i!==this.generation)throw Promise.resolve((p=(m=l.model).dispose)==null?void 0:p.call(m)).catch(()=>{}),new Error("cancelled");return this.modelHandle=l.model,this.processor=l.processor,this.loadImage=l.loadImage,this.model=n,n}teardown(){var t;const n=this.modelHandle;this.modelHandle=null,this.processor=null,this.loadImage=null,this.model=null,Promise.resolve((t=n==null?void 0:n.dispose)==null?void 0:t.call(n)).catch(()=>{})}cancelConnect(){this.generation++}dispose(){this.generation++,this.teardown()}}function bi(e,n){const t=e[n];if(typeof t=="string")return t.trim();if(t&&typeof t=="object"){const r=t.labels;return Array.isArray(r)?r.join(" ").trim():JSON.stringify(t)}return""}async function _i(){return await oi()?"browser":kt()?"endpoint":"scripted"}function wi(){const[e,n]=h.useState("scripted"),t=h.useRef(!1),[r,i]=h.useState("idle"),[s,l]=h.useState(null),[m,p]=h.useState(null),[a,d]=h.useState(null),[g,u]=h.useState(null),[b,w]=h.useState(null),[y,_]=h.useState(null),[v,k]=h.useState(xt),[D,W]=h.useState(Et),[Z,ce]=h.useState(""),[X,se]=h.useState([]),[G,ee]=h.useState("idle"),[ge,S]=h.useState(null),[E,N]=h.useState(""),[V,U]=h.useState(null),ie=h.useRef(null),[Ve,je]=h.useState("scripted-vision"),[Re,ye]=h.useState("idle"),[pn,Se]=h.useState(null),[Pe,he]=h.useState(jt),[Ae,De]=h.useState(null),[Ye,ve]=h.useState(null),[Fe,Qe]=h.useState(null),[F,de]=h.useState(null),Q=h.useRef(null),_e=h.useRef(!1),qe=h.useRef(0),le=h.useCallback(I=>async(...C)=>{try{return await I.chat(...C)}catch(O){const we=O instanceof Error?O.message:String(O);throw I instanceof an&&ln(we)&&(U(null),p(null),i("error"),l(we)),O}},[]),Ce=h.useCallback(I=>async(...C)=>{try{return await I.read(...C)}catch(O){const we=O instanceof Error?O.message:String(O);throw ln(we)&&(de(null),De(null),ye("error"),Se(we)),O}},[]);h.useEffect(()=>{Xe().then(I=>{w(I),u(I===null),t.current||(t.current=!0,_i().then(n))}),Xe("the scripted-vision fallback").then(I=>{Qe(I),_e.current||(_e.current=!0,je(I===null?"browser-vision":"scripted-vision"))})},[]),h.useEffect(()=>{let I=!1;return _(null),ci(v).then(C=>{I||_(C)}),()=>{I=!0}},[v]),h.useEffect(()=>()=>{var I;return(I=ie.current)==null?void 0:I.dispose()},[]),h.useEffect(()=>()=>{var I;return(I=Q.current)==null?void 0:I.dispose()},[]);const ze=h.useCallback(I=>{n(I),i("idle"),l(null),p(null),d(null),U(null)},[]),en=h.useCallback(I=>{var C,O;_e.current=!0,(C=Q.current)==null||C.cancelConnect(),(O=Q.current)==null||O.dispose(),Q.current=null,je(I),ye("idle"),Se(null),De(null),ve(null),de(null)},[]),Ee=h.useCallback(()=>{var I;(I=ie.current)==null||I.dispose(),ie.current=null,U(null),p(null)},[]),Be=h.useCallback(()=>{ie.current instanceof an&&ie.current.cancelConnect(),Ee(),i("idle"),d(null),l(null)},[Ee]),nn=h.useCallback(async()=>{const I=++qe.current,C=()=>I!==qe.current,O=cn(D);if(O){se([]),ee("error"),S(O);return}ee("loading"),S(null);const we=new Jn(D,E);try{const Me=await we.listModels();if(C())return;se(Me),ee("ready"),ce(Ue=>Ue&&Me.includes(Ue)?Ue:Me[0]??"")}catch(Me){if(C())return;se([]),ce(""),ee("error"),S(Me instanceof Error?Me.message:String(Me))}finally{we.dispose()}},[D,E]),un=h.useCallback(async()=>{var I;if(e==="scripted"){U(null),i("ready");return}if(e==="endpoint"){const C=cn(D);if(C){Ee(),l(C),i("error");return}}i("connecting"),l(null),d(null);try{if(e==="browser"){const C=ie.current instanceof an?ie.current:new an;ie.current&&ie.current!==C&&ie.current.dispose(),ie.current=C;const O=await C.connect(v,d);p(O),U(()=>le(C)),_(!0)}else{(I=ie.current)==null||I.dispose();const C=new Jn(D,E,Z);ie.current=C;const O=await C.connect();p(O),U(()=>le(C))}i("ready")}catch(C){const O=C instanceof Error?C.message:String(C);if(O==="cancelled")return;l(O),i("error"),U(null)}finally{d(null)}},[e,v,D,Z,E,Ee,le]),Oe=h.useCallback(()=>{var I;(I=Q.current)==null||I.dispose(),Q.current=null,de(null),De(null)},[]),gn=h.useCallback(()=>{var I;(I=Q.current)==null||I.cancelConnect(),Oe(),ye("idle"),ve(null),Se(null)},[Oe]),hn=h.useCallback(async()=>{if(Ve==="scripted-vision"){Oe(),ye("ready"),Se(null);return}ye("connecting"),Se(null),ve(null);try{const I=Q.current instanceof Wn?Q.current:new Wn;Q.current&&Q.current!==I&&Q.current.dispose(),Q.current=I;const C=await I.connect(Pe,ve);De(C),de(()=>Ce(I)),ye("ready")}catch(I){const C=I instanceof Error?I.message:String(I);if(C==="cancelled")return;Se(C),ye("error"),de(null),De(null)}finally{ve(null)}},[Ve,Pe,Oe,Ce]);return{kind:e,setKind:ze,status:r,error:s,modelInUse:m,progress:a,webgpu:g,webgpuReason:b,browserModelCached:y,cancelConnect:Be,browserModel:v,setBrowserModel:k,endpointUrl:D,setEndpointUrl:W,endpointModel:Z,setEndpointModel:ce,endpointModels:X,endpointModelsStatus:G,endpointModelsError:ge,listEndpointModels:nn,apiKey:E,setApiKey:N,connect:un,chat:V,visionKind:Ve,setVisionKind:en,visionStatus:Re,visionError:pn,visionModel:Pe,setVisionModel:he,visionModelInUse:Ae,visionProgress:Ye,visionWebgpuReason:Fe,connectVision:hn,cancelVisionConnect:gn,vision:F}}const Pn="#s=",fi=["scripted","browser","endpoint"];function yi(e){return typeof e=="string"&&fi.includes(e)}function vi(e){try{const n=JSON.parse(e);if(n&&typeof n=="object"){const t=n,r={};return yi(t.brain)&&(r.brain=t.brain),r}}catch{}return{}}function St(e=location.hash){if(!e.startsWith(Pn))return{};let n;try{n=decodeURIComponent(e.slice(Pn.length))}catch{return{}}return vi(n)}function Mi(e){const n=Object.entries(e).filter(([,t])=>t!==void 0);return n.length===0?"":Pn+encodeURIComponent(JSON.stringify(Object.fromEntries(n)))}function xi(e){const n={...St(),...e},t=Mi(n),r=new URL(location.href);r.hash=t,history.replaceState(history.state,"",r)}const Zn=[{kind:"scripted",label:"Scripted",hint:"No model. The example's stand-in decides — deterministic and offline."},{kind:"browser",label:"In-browser (WebGPU)",hint:"A small quantised model on your GPU. First run downloads weights."},{kind:"endpoint",label:"API endpoint",hint:"Any OpenAI-compatible server. Ollama by default. Local pages only."}],Kn=[{kind:"scripted-vision",label:"Scripted",hint:"No model. The example's known plate is returned — deterministic and offline."},{kind:"browser-vision",label:"In-browser (WebGPU)",hint:"Reads the photo with a vision model on your GPU. First run downloads weights."}];function Ni({brain:e,showText:n=!0,showVision:t=!1}){return o.jsxs("div",{className:"brain",children:[n&&o.jsx(Ei,{brain:e}),n&&t&&o.jsx("hr",{className:"brain-divider"}),t&&o.jsx(ki,{brain:e})]})}function Ei({brain:e}){const n=Zn.find(b=>b.kind===e.kind),t=cn(e.endpointUrl),r=kt(),[i,s]=h.useState(mn);h.useEffect(()=>{di().then(s)},[]);const{kind:l,endpointUrl:m,apiKey:p,listEndpointModels:a}=e;h.useEffect(()=>{if(l!=="endpoint"||t)return;const b=setTimeout(()=>void a(),400);return()=>clearTimeout(b)},[l,m,p,t,a]);const d=i.find(b=>b.id===e.browserModel),g=d?li(d,Nt()):null,u=e.webgpu===!0?"browser":r&&e.webgpu===!1?"endpoint":null;return o.jsxs("div",{className:"brain-section",children:[o.jsxs("div",{className:"brain-kinds",children:[Zn.map(b=>o.jsxs(q,{size:"sm",variant:e.kind===b.kind?"default":"secondary",onClick:()=>e.setKind(b.kind),children:[b.label,b.kind===u&&o.jsx(H,{variant:"info",className:"brain-recommended-badge",children:"recommended"})]},b.kind)),e.status==="ready"&&e.kind!=="scripted"&&o.jsx(H,{variant:"success",children:e.modelInUse??"connected"}),e.status==="connecting"&&o.jsx(H,{variant:"info",children:"connecting…"}),e.status==="error"&&o.jsx(H,{variant:"danger",children:"not connected"})]}),o.jsx("p",{className:"field-hint",children:n.hint}),e.kind==="browser"&&o.jsxs("div",{className:"brain-config",children:[o.jsxs("div",{className:"field",children:[o.jsx(Ge,{htmlFor:"browser-model",children:"Model"}),o.jsxs(Mn,{value:e.browserModel,onValueChange:e.setBrowserModel,disabled:e.status==="connecting",children:[o.jsx(xn,{id:"browser-model",children:o.jsx(Nn,{})}),o.jsx(En,{children:i.map(b=>o.jsx(kn,{value:b.id,children:b.label},b.id))})]}),e.browserModelCached===!0&&o.jsx("p",{className:"field-hint",children:"Already downloaded in this browser — connecting will be fast."}),e.browserModelCached===!1&&o.jsx("p",{className:"field-hint",children:"Not downloaded yet — connecting fetches the weights once, then caches them for next time."})]}),e.webgpu===!1&&e.webgpuReason&&o.jsxs(me,{variant:"destructive",children:[o.jsx(pe,{children:"No WebGPU in this browser"}),o.jsx(ue,{children:e.webgpuReason})]}),e.webgpu!==!1&&g&&o.jsxs(me,{variant:"destructive",children:[o.jsx(pe,{children:"This model may not fit in GPU memory"}),o.jsx(ue,{children:g})]})]}),e.kind==="endpoint"&&o.jsxs("div",{className:"brain-config",children:[o.jsxs("div",{className:"field",children:[o.jsx(Ge,{htmlFor:"endpoint-url",children:"Endpoint"}),o.jsx(Rn,{id:"endpoint-url",value:e.endpointUrl,onChange:b=>e.setEndpointUrl(b.target.value),disabled:e.status==="connecting"}),o.jsxs("p",{className:"field-hint",children:["Ollama allows ",o.jsx("code",{children:"localhost"})," origins out of the box; set"," ",o.jsx("code",{children:"OLLAMA_ORIGINS"})," only when serving this page from another host. Best for local development — a hosted copy of this page can't reach a server on your machine at all."]}),t&&o.jsxs(me,{variant:"destructive",children:[o.jsx(pe,{children:"A local server won't work from this URL"}),o.jsx(ue,{children:t})]})]}),o.jsxs("div",{className:"field",children:[o.jsx(Ge,{htmlFor:"endpoint-model",children:"Model"}),o.jsxs("div",{className:"endpoint-model-row",children:[o.jsxs(Mn,{value:e.endpointModel,onValueChange:e.setEndpointModel,disabled:e.status==="connecting"||e.endpointModelsStatus==="loading"||e.endpointModels.length===0,children:[o.jsx(xn,{id:"endpoint-model",className:"endpoint-model-select",children:o.jsx(Nn,{placeholder:e.endpointModelsStatus==="loading"?"Loading models…":e.endpointModelsStatus==="idle"?"Enter an endpoint above":e.endpointModelsStatus==="error"?"No models — check the endpoint":e.endpointModels.length===0?"No models served":"Select a model"})}),o.jsx(En,{children:e.endpointModels.map(b=>o.jsx(kn,{value:b,children:b},b))})]}),o.jsx(q,{size:"sm",variant:"secondary",onClick:()=>void e.listEndpointModels(),disabled:e.status==="connecting"||e.endpointModelsStatus==="loading"||t!==null,children:e.endpointModelsStatus==="loading"?"Refreshing…":"Refresh"})]}),o.jsxs("p",{className:"field-hint",children:["Fetched from the endpoint's ",o.jsx("code",{children:"/models"}),". Tiny models (e.g. SmolLM2) usually can't follow the tool-calling format — prefer ",o.jsx("code",{children:"llama3.2:3b"}),", ",o.jsx("code",{children:"qwen2.5"})," or larger."]}),e.endpointModelsStatus==="error"&&!t&&o.jsxs(me,{variant:"destructive",children:[o.jsx(pe,{children:"Couldn't list models"}),o.jsx(ue,{children:e.endpointModelsError})]})]}),o.jsxs("div",{className:"field",children:[o.jsx(Ge,{htmlFor:"endpoint-key",children:"API key (optional)"}),o.jsx(Rn,{id:"endpoint-key",type:"password",value:e.apiKey,onChange:b=>e.setApiKey(b.target.value),disabled:e.status==="connecting"})]})]}),e.kind!=="scripted"&&o.jsxs("div",{className:"brain-actions",children:[o.jsx(q,{size:"sm",onClick:()=>void e.connect(),disabled:e.status==="connecting"||e.kind==="endpoint"&&(e.endpointModel===""||e.endpointModelsStatus==="loading"||t!==null),children:e.status==="ready"?"Reconnect":"Connect"}),e.status==="connecting"&&e.kind==="browser"&&o.jsx(q,{size:"sm",variant:"secondary",onClick:e.cancelConnect,children:"Cancel"}),e.progress&&o.jsxs("span",{className:"field-hint",children:[Math.round(e.progress.progress*100),"% —"," ",e.progress.text]})]}),e.error&&o.jsxs(me,{variant:"destructive",children:[o.jsx(pe,{children:"Couldn't connect"}),o.jsx(ue,{children:e.error})]})]})}function ki({brain:e}){const n=Kn.find(r=>r.kind===e.visionKind),t=e.webgpu===!0?"browser-vision":null;return o.jsxs("div",{className:"brain-section brain-vision",children:[o.jsx(Ge,{children:"Vision (reads the image)"}),o.jsxs("div",{className:"brain-kinds",children:[Kn.map(r=>o.jsxs(q,{size:"sm",variant:e.visionKind===r.kind?"default":"secondary",onClick:()=>e.setVisionKind(r.kind),children:[r.label,r.kind===t&&o.jsx(H,{variant:"info",className:"brain-recommended-badge",children:"recommended"})]},r.kind)),e.visionStatus==="ready"&&e.visionKind==="browser-vision"&&o.jsx(H,{variant:"success",children:e.visionModelInUse??"connected"}),e.visionStatus==="connecting"&&o.jsx(H,{variant:"info",children:"connecting…"}),e.visionStatus==="error"&&o.jsx(H,{variant:"danger",children:"not connected"})]}),o.jsx("p",{className:"field-hint",children:n.hint}),e.visionKind==="scripted-vision"&&e.webgpu===!1&&e.visionWebgpuReason&&o.jsxs(me,{variant:"destructive",children:[o.jsx(pe,{children:"No WebGPU in this browser"}),o.jsx(ue,{children:e.visionWebgpuReason})]}),e.visionKind==="browser-vision"&&o.jsxs("div",{className:"brain-config",children:[o.jsxs("div",{className:"field",children:[o.jsx(Ge,{htmlFor:"vision-model",children:"Model"}),o.jsxs(Mn,{value:e.visionModel,onValueChange:e.setVisionModel,disabled:e.visionStatus==="connecting",children:[o.jsx(xn,{id:"vision-model",children:o.jsx(Nn,{})}),o.jsx(En,{children:Tt.map(r=>o.jsx(kn,{value:r.id,children:r.label},r.id))})]}),o.jsx("p",{className:"field-hint",children:"Connecting downloads the weights once (size shown above), then caches them — every token is read on your GPU, no server."})]}),e.webgpu===!1&&e.visionWebgpuReason&&o.jsxs(me,{variant:"destructive",children:[o.jsx(pe,{children:"No WebGPU in this browser"}),o.jsx(ue,{children:e.visionWebgpuReason})]})]}),e.visionKind==="browser-vision"&&o.jsxs("div",{className:"brain-actions",children:[o.jsx(q,{size:"sm",onClick:()=>void e.connectVision(),disabled:e.visionStatus==="connecting",children:e.visionStatus==="ready"?"Reconnect":"Connect"}),e.visionStatus==="connecting"&&o.jsx(q,{size:"sm",variant:"secondary",onClick:e.cancelVisionConnect,children:"Cancel"}),e.visionProgress&&o.jsxs("span",{className:"field-hint",children:[Math.round(e.visionProgress.progress*100),"% —"," ",e.visionProgress.text]})]}),e.visionError&&o.jsxs(me,{variant:"destructive",children:[o.jsx(pe,{children:"Couldn't connect the vision brain"}),o.jsx(ue,{children:e.visionError})]})]})}function Ii({imageInput:e,value:n,onSelect:t,disabled:r=!1}){const[i,s]=h.useState(null),[l,m]=h.useState(!1),p=h.useRef(null),a=h.useId(),d=h.useId(),g=h.useCallback(w=>{s(URL.createObjectURL(w)),t({imageName:w.name,pixels:w})},[t]);h.useEffect(()=>{if(i)return()=>URL.revokeObjectURL(i)},[i]);const u=h.useCallback(w=>{const y=w==null?void 0:w[0];y&&y.type.startsWith("image/")&&g(y)},[g]),b=(n==null?void 0:n.imageId)!=null?e.seedImages.find(w=>w.id===n.imageId):void 0;return o.jsxs("div",{className:"image-input",children:[e.label&&o.jsx("p",{className:"field-hint",children:e.label}),o.jsx("p",{className:"image-input-label",id:a,children:"Seed photos"}),o.jsx("div",{className:"image-gallery",role:"group","aria-labelledby":a,children:e.seedImages.map(w=>{const y=(n==null?void 0:n.imageId)===w.id;return o.jsxs("button",{type:"button","aria-pressed":y,className:`image-thumb${y?" image-thumb--selected":""}`,disabled:r,title:w.label??w.id,onClick:()=>{s(null),p.current&&(p.current.value=""),t({imageId:w.id,pixels:w.file})},children:[o.jsx("img",{src:w.thumb??w.file,alt:w.label??w.id}),w.label&&o.jsx("span",{children:w.label})]},w.id)})}),o.jsx("label",{className:"image-input-label",htmlFor:d,children:"Or upload your own photo"}),o.jsxs("div",{className:`image-drop${l?" image-drop--over":""}`,onDragOver:w=>{w.preventDefault(),r||m(!0)},onDragLeave:()=>m(!1),onDrop:w=>{w.preventDefault(),m(!1),r||u(w.dataTransfer.files)},children:[o.jsx("input",{ref:p,id:d,type:"file",accept:"image/*",disabled:r,onChange:w=>u(w.target.files)}),o.jsx("p",{className:"field-hint",children:"Drag a photo here, or pick one. Uploading a photo the model has never seen is the proof this runs for real — nothing leaves your browser."})]}),(i||b)&&o.jsxs("div",{className:"image-preview",children:[o.jsx("img",{src:i??(b==null?void 0:b.file),alt:i?(n==null?void 0:n.imageName)??"uploaded photo":(b==null?void 0:b.label)??(b==null?void 0:b.id)??"selected photo"}),o.jsx("span",{className:"field-hint",children:i?`Uploaded: ${(n==null?void 0:n.imageName)??"your photo"}`:`Selected: ${(b==null?void 0:b.label)??(b==null?void 0:b.id)}`}),o.jsx("button",{type:"button",className:"image-clear-btn",disabled:r,onClick:()=>{s(null),p.current&&(p.current.value=""),t(null)},children:"Clear"})]})]})}function Pt(e){return typeof e=="object"&&e!==null}function cd(e){const n=new Set,t=r=>{Pt(r)&&(typeof r.key=="string"&&n.add(r.key),Array.isArray(r.components)&&r.components.forEach(t))};return t(e),n}function Ti(e){const n={},t=r=>{Pt(r)&&(typeof r.key=="string"&&"defaultValue"in r&&(n[r.key]=r.defaultValue??""),Array.isArray(r.components)&&r.components.forEach(t))};return t(e),n}const ji="wdf:section:";function At(e){return ji+e}function Xn(e){try{const n=window.localStorage.getItem(At(e));return n==="1"?!0:n==="0"?!1:void 0}catch{return}}function Si(e,n){try{window.localStorage.setItem(At(e),n?"1":"0")}catch{}}function Pi(e,n=!0){const[t,r]=h.useState(()=>Xn(e)??n);h.useEffect(()=>{r(Xn(e)??n)},[e,n]);const i=h.useCallback(s=>{r(s),Si(e,s)},[e]);return[t,i]}function ke({sectionId:e,title:n,description:t,defaultOpen:r=!0,className:i,children:s,...l}){const[m,p]=Pi(e,r);return o.jsx(Rt,{className:["panel",i].filter(Boolean).join(" "),"data-tour":l["data-tour"],children:o.jsxs(Ft,{open:m,onOpenChange:p,children:[o.jsxs(zt,{className:"panel-trigger",children:[o.jsxs("span",{className:"panel-trigger-text",children:[o.jsx("span",{className:"panel-title",children:n}),t!=null&&o.jsx("span",{className:"panel-desc",children:t})]}),o.jsx(Ot,{className:"panel-chevron","aria-hidden":!0})]}),o.jsx(Ut,{children:o.jsx($t,{children:s})})]})})}function Ai(e){return e.entries!==void 0}function Di(e){const n=[];let t=null;for(const r of e)r.turn!==void 0?t&&t.turn===r.turn?t.entries.push(r):(t={turn:r.turn,entries:[r]},n.push(t)):(t=null,n.push(r));return n}function et(e){if(e===void 0)return"undefined";try{return JSON.stringify(e)}catch{return"[unserializable value]"}}function Ci({activation:e,result:n,labelFor:t}){const r=e.elementId??"";return o.jsxs("div",{className:"timeline-tool",children:[o.jsxs("div",{className:"timeline-tool-head",children:[o.jsx(H,{variant:"info",children:"tool"}),o.jsx("strong",{children:t(r)||r}),o.jsx("code",{children:r})]}),e.args!==void 0&&Object.keys(e.args).length>0&&o.jsxs("div",{className:"timeline-kv",children:[o.jsx("span",{className:"timeline-kv-label",children:"arguments"}),o.jsx("code",{children:et(e.args)})]}),o.jsxs("div",{className:"timeline-kv",children:[o.jsx("span",{className:"timeline-kv-label",children:"returned"}),o.jsx("code",{children:n?et(n.result):"— waiting for the job to complete —"})]})]})}function Bi({group:e,labelFor:n}){const t=e.entries.find(a=>a.kind==="llm"),r=e.entries.filter(a=>a.kind==="agent"&&a.elementId),i=e.entries.filter(a=>a.kind==="vars"&&a.elementId),s=e.entries.filter(a=>a.kind==="agent"&&!a.elementId),l=e.entries.filter(a=>a.kind==="error"),m=new Set(r.map(a=>a.elementId)),p=e.entries.filter(a=>a.kind==="tool"||a.kind==="vars"&&a.elementId&&!m.has(a.elementId)).sort((a,d)=>a.id-d.id);return o.jsxs("div",{className:"timeline-turn",children:[o.jsxs("div",{className:"timeline-turn-head",children:[o.jsxs(H,{variant:t!=null&&t.pending?"warning":"neutral",children:["Turn ",e.turn]}),(t==null?void 0:t.pending)&&o.jsx("span",{className:"timeline-pending",children:"thinking…"})]}),t&&o.jsx("blockquote",{className:"timeline-reply",children:t.text}),s.map(a=>o.jsx("div",{className:"timeline-note",children:a.text},a.id)),r.map(a=>o.jsx(Ci,{activation:a,result:i.find(d=>d.elementId===a.elementId),labelFor:n},a.id)),p.map(a=>o.jsxs("div",{className:`log-line log-${a.kind}`,children:[a.pending?"⏳ ":"",a.text]},a.id)),l.map(a=>o.jsxs("div",{className:"timeline-error",children:["⚠ ",a.text]},a.id))]})}function Li({log:e,elementStats:n=[],incidents:t=[],labelFor:r=i=>i}){const i=h.useMemo(()=>Di(e),[e]),[s,l]=h.useState(!1),m=h.useRef(null);h.useEffect(()=>{const a=m.current;a&&(a.scrollTop=a.scrollHeight)},[i]);const p=()=>{var g;const a={log:e.map(({id:u,...b})=>b),elementStats:n,incidents:t},d=JSON.stringify(a,null,2);(g=navigator.clipboard)!=null&&g.writeText&&navigator.clipboard.writeText(d).then(()=>{l(!0),setTimeout(()=>l(!1),1500)}).catch(()=>{})};return o.jsxs(ke,{sectionId:"activity",className:"grow",title:"Activity",description:"Agent turns, model replies, and tool calls — read top to bottom as a story.",children:[o.jsx("div",{className:"timeline-toolbar",children:o.jsx(q,{variant:"secondary",size:"sm",onClick:p,children:s?"Copied!":"Copy run as JSON"})}),o.jsx("div",{className:"timeline",ref:m,children:i.length===0?o.jsx("div",{className:"log-empty",children:"Press Run or Step to start."}):i.map(a=>Ai(a)?o.jsx(Bi,{group:a,labelFor:r},`turn-${a.turn}-${a.entries[0].id}`):o.jsxs("div",{className:`log-line log-${a.kind}`,children:[a.pending?"⏳ ":"",a.text]},a.id))}),(n.length>0||t.length>0)&&o.jsxs("div",{className:"timeline-engine-view",children:[n.length>0&&o.jsxs("div",{className:"timeline-stats",children:[o.jsx("span",{className:"timeline-kv-label",children:"Element completion"}),o.jsx("ul",{children:n.filter(a=>a.completed>0||(a.active??0)>0).map(a=>o.jsxs("li",{children:[o.jsx("code",{children:r(a.elementId)||a.elementId})," ","completed ",a.completed,a.active?`, ${a.active} active`:""]},a.elementId))})]}),t.length>0&&o.jsxs("div",{className:"timeline-incidents",children:[o.jsx("span",{className:"timeline-kv-label",children:"Incidents"}),o.jsx("ul",{children:t.map((a,d)=>o.jsxs("li",{children:[o.jsx("code",{children:r(a.elementId)||a.elementId})," —"," ",a.reason]},`${a.elementId}-${d}`))})]})]})]})}const Ne={diagram:"diagram",runButton:"run-button",variablesPanel:"variables-panel",codePanel:"code-panel",brainPanel:"brain-panel"};function nt(e){return`[data-tour="${e}"]`}function Ri(e=location.search){return new URLSearchParams(e).get("tour")}function Fi(e,n){var t;return((t=e.elementStats.find(r=>r.elementId===n))==null?void 0:t.completed)??0}function zi(e,n){return!e||e.kind==="click"||!n?!1:e.kind==="activeElement"?n.activeElementIds.includes(e.elementId):Fi(n,e.elementId)>=(e.atLeast??1)}function Oi(e){return"anchor"in e?nt(e.anchor):`${nt(Ne.diagram)} [data-element-id="${Ui(e.elementId)}"]`}function Ui(e){return typeof CSS<"u"&&typeof CSS.escape=="function"?CSS.escape(e):e.replace(/[^a-zA-Z0-9_-]/g,n=>`\\${n}`)}function $i(e){return e.map(n=>{const t=!!n.waitFor&&n.waitFor.kind!=="click";return{element:Oi(n.target),popover:{title:n.title,description:t?`${n.description} (continues automatically once you reach that point — or use Next to skip ahead)`:n.description,showButtons:["next","previous","close"]},disableActiveInteraction:!1,skipMissingElement:n.skipMissingElement??!0}})}async function Gi(e,n={}){var s;const[{driver:t}]=await Promise.all([be(()=>import("./driver.js-bj_ppY-Q.js"),[]),be(()=>Promise.resolve({}),__vite__mapDeps([0]))]),r=$i(e),i=t({steps:r,showProgress:!0,allowClose:!0,skipMissingElement:!0,onHighlighted:(l,m,{index:p})=>{var a;p!==void 0&&((a=n.onIndexChange)==null||a.call(n,p))},onDestroyed:()=>{var l;(l=n.onDestroyed)==null||l.call(n)}});return i.drive(),(s=n.onIndexChange)==null||s.call(n,i.getActiveIndex()??0),{moveNext:()=>i.moveNext(),activeIndex:()=>i.getActiveIndex()??-1,destroy:()=>i.destroy()}}const Vi=300;function Yi(e,n){const[t,r]=h.useState(!1),i=h.useRef(null),s=h.useRef(0),l=h.useRef(-1),m=h.useRef(null),p=h.useRef(n);h.useEffect(()=>{p.current=n},[n]);const a=h.useCallback(()=>{m.current!==null&&(clearInterval(m.current),m.current=null)},[]),d=h.useRef(0),g=h.useCallback(()=>{var b;d.current+=1,a(),(b=i.current)==null||b.destroy(),i.current=null,r(!1)},[a]),u=h.useCallback(()=>{if(!e||e.steps.length===0||i.current)return;const b=d.current+=1;Gi(e.steps,{onIndexChange:w=>{s.current=w},onDestroyed:()=>{a(),i.current=null,r(!1)}}).then(w=>{if(b!==d.current){w.destroy();return}i.current=w,r(!0),m.current=setInterval(()=>{const y=s.current;if(y===l.current)return;const _=e.steps[y];_&&zi(_.waitFor,p.current())&&(l.current=y,w.moveNext())},Vi)})},[e,a]);return h.useEffect(()=>g,[g]),{active:t,start:u,stop:g}}const $e=650,wn="__agent__",tt="__model__",rt="__template__:",Qi=h.lazy(async()=>{await Promise.all([be(()=>Promise.resolve({}),__vite__mapDeps([1])),be(()=>Promise.resolve({}),__vite__mapDeps([2]))]);const{RuntimeDiagram:e}=await be(async()=>{const{RuntimeDiagram:n}=await import("./RuntimeDiagram-B2IYfHo7.js");return{RuntimeDiagram:n}},__vite__mapDeps([3,4,5]));return{default:e}}),fn=h.lazy(()=>be(()=>import("./MonacoEditor-Cbl5mXvC.js").then(e=>e.M),__vite__mapDeps([6,4,7]))),qi=h.lazy(()=>be(()=>import("./vendor-modeler-qEE80MwB.js"),__vite__mapDeps([8,4,5,9,10,11,12,1,2]))),it=h.lazy(async()=>{const{FormRenderer:e}=await be(async()=>{const{FormRenderer:n}=await import("./FormRenderer-cKNdAcoU.js");return{FormRenderer:n}},__vite__mapDeps([13,4,11,9,10,14]));return{default:e}});function yn(e,n){try{return JSON.stringify(e??{},null,n)}catch{return"[unserializable value]"}}function Ji({example:e,initialBrainKind:n,initialTourId:t}){var C,O,we,Me,Ue,Cn,Bn,Ln;const[r,i]=h.useState(e.bpmn),s=wi(),[l,m]=h.useState(null);h.useEffect(()=>{n&&n!==s.kind&&s.setKind(n)},[]),h.useEffect(()=>{xi({brain:s.kind})},[s.kind]);const[p,a]=h.useState(()=>Object.fromEntries(e.handlers.map(M=>[M.elementId,M.source]))),[d,g]=h.useState(e.scriptedAgent??""),[u,b]=h.useState(()=>Ke(e.templates)),w=h.useMemo(()=>Ir(e,p,r,u),[e,p,r,u]),y=w.model,_=ni({bpmn:w.resolvedBpmn}),v=Yi(e.tour,()=>_.snapshot);h.useEffect(()=>{var M;t&&((M=e.tour)==null?void 0:M.id)===t&&v.start()},[]);const k=y.startFormId?((C=e.forms)==null?void 0:C[y.startFormId])??null:null,[D,W]=h.useState(()=>({...e.seed,...k?Ti(k):{}})),[Z,ce]=h.useState(y.agent?wn:((O=e.handlers[0])==null?void 0:O.elementId)??""),[X,se]=h.useState(!1),[G,ee]=h.useState(!1),[ge,S]=h.useState(null),[E,N]=h.useState([]),[V,U]=h.useState({}),[ie,Ve]=h.useState(!1),je=h.useRef(null),[Re,ye]=h.useState({}),[pn,Se]=h.useState(!1),Pe=h.useRef(null),he=h.useRef(!1),Ae=h.useRef(0),De=h.useRef(0),Ye=h.useRef({current:void 0}),ve=h.useRef({}),Fe=h.useRef({}),Qe=h.useMemo(()=>{const M=new Map;for(const x of y.processes){for(const T of x.tasks)M.set(T.elementId,T.label);for(const T of x.agents){M.set(T.elementId,T.label);for(const B of T.tools)M.set(B.elementId,B.label)}for(const T of x.userTasks)M.set(T.elementId,T.label)}return x=>M.get(x)??x},[y]),F=h.useCallback(M=>{N(x=>{if(M.key){const T=x.findIndex(B=>B.key===M.key);if(T>=0){const B=[...x];return B[T]={...B[T],...M},B}}return[...x,{...M,id:De.current++}].slice(-80)})},[]),de=h.useMemo(()=>{var M;return((M=_.snapshot)==null?void 0:M.userTasks.find(x=>x.state==="Created"))??null},[_.snapshot]),Q=h.useMemo(()=>{const M=y.processes.flatMap(T=>T.tasks),x=new Map;for(const T of e.handlers){if(!T.manualControl)continue;const B=M.find(A=>A.elementId===T.elementId);B&&x.set(B.jobType,{...T.manualControl,elementId:T.elementId})}return x},[e.handlers,y]),_e=h.useMemo(()=>{if(!_.snapshot)return null;for(const M of _.snapshot.jobs){const x=Q.get(M.jobType);if(x&&M.state==="Created")return{job:M,control:x}}return null},[_.snapshot,Q]),qe=h.useMemo(()=>{if(!y.agent||!_.snapshot)return[];const M=new Map(_.snapshot.elementStats.map(x=>[x.elementId,x.completed]));return y.agent.tools.filter(x=>(M.get(x.elementId)??0)===0)},[y.agent,_.snapshot]),le=de?y.userTasks.find(M=>M.elementId===de.elementId):void 0,Ce=le!=null&&le.formId?((we=e.forms)==null?void 0:we[le.formId])??null:null,ze=h.useCallback(async(M,x,T,B)=>{var fe,te,ae;let A=T,oe=0;for(;Ae.current===B&&A&&A.completedInstances<1&&oe++<80;){const J=await _.stepWorkers(M,{agents:x});if(Ae.current!==B)return A;A=(J==null?void 0:J.snapshot)??A;const ne=(fe=A.instances[0])==null?void 0:fe.variables;if(ne&&U({...ne}),A.userTasks.some(Y=>Y.state==="Created")){F({kind:"human",text:"⏸ waiting for a human — complete the task below to continue"});break}if(!J){F({kind:"error",text:"▶ run stopped — no dispatch round was returned"});break}if(J.handled===0){const Y=A.messageSubscriptions[0];if(J.reason==="messages"&&Y){F({kind:"vars",text:`📨 correlating message "${Y.messageName}" (key: ${Y.correlationKey})`,elementId:Y.elementId});const $=_.correlateMessage(Y.messageName,Y.correlationKey,"{}");if($){A=$;const re=(te=A.instances[0])==null?void 0:te.variables;re&&U({...re}),await new Promise(xe=>setTimeout(xe,$e));continue}F({kind:"error",text:`▶ run stopped — correlating "${Y.messageName}" (key: ${Y.correlationKey}) failed`,elementId:Y.elementId})}if(J.reason==="signals"&&A.signalSubscriptions.length>0){const $=A.signalSubscriptions[0],re=_.broadcastSignal($.signalName,"{}");if(re){A=re,F({kind:"vars",text:`📡 broadcasting signal "${$.signalName}" — every waiting subscription unblocks`,elementId:$.elementId});const xe=(ae=A.instances[0])==null?void 0:ae.variables;xe&&U({...xe}),await new Promise(bn=>setTimeout(bn,$e));continue}F({kind:"error",text:`▶ run stopped — broadcasting signal "${$.signalName}" failed`,elementId:$.elementId})}if(J.reason==="timers"){const $=A.timers.reduce((re,xe)=>Math.min(re,xe.dueInMs),1/0);if(Number.isFinite($)){const re=_.advanceTime(Math.max($,0)+1);if(re){A=re,F({kind:"step",text:"🕐 the clock advanced — timer fired"}),await new Promise(xe=>setTimeout(xe,$e));continue}}}break}await new Promise(Y=>setTimeout(Y,$e))}return A&&A.completedInstances>=1?F({kind:"done",text:"✅ process instance completed"}):A&&A.incidentElementIds.length>0&&F({kind:"error",text:"A job failed — incident on the diagram"}),A},[_,F]),en=h.useCallback(async M=>{var A,oe,fe;if(!_e||he.current)return;const{job:x,control:T}=_e,B=++Ae.current;he.current=!0,se(!0);try{let te,ae;if(M==="complete")te=_.completeJobManually(x.jobType,"{}"),ae="  ↳ completed normally";else if(T.action.kind==="timer"){const J=((oe=(A=_.snapshot)==null?void 0:A.timers[0])==null?void 0:oe.dueInMs)??0;te=_.advanceTime(Math.max(J,0)+1),ae="  ↳ advanced the clock — timer fired"}else{const{errorCode:J,message:ne}=T.action;te=_.throwJobError(x.jobType,J,ne),ae=`  ↳ threw BPMN error ${J}: ${ne}`}if(te){F({kind:"vars",text:ae,elementId:x.elementId});const J=(fe=te.instances[0])==null?void 0:fe.variables;J&&U({...J}),await new Promise(ne=>setTimeout(ne,$e)),await ze(ve.current,Fe.current,te,B)}else F({kind:"error",text:"  ↳ failed to resolve the manual job",elementId:x.elementId})}finally{he.current=!1,se(!1)}},[_e,_,F,ze]),Ee=h.useCallback(async()=>{var J;let M=null;try{y.agent&&d.trim()&&(M=br(d))}catch(ne){return S(ne instanceof Error?ne.message:String(ne)),null}Ye.current={current:void 0};let x;if(e.imageInput){const ne=s.vision;x={read:ne??hi(e.scriptedVision).read,live:!!ne,resolve:$=>_.getRunImage($)}}const T=fr(y,w.handlers,F,Ye.current,x);for(const ne of Q.keys())delete T[ne];const B={};if(y.agents.length>0){if(s.kind!=="scripted"&&s.chat){const Y=new Map;for(const $ of y.agents)Y.set($.jobType,[...Y.get($.jobType)??[],$]);for(const[$,re]of Y)B[$]=Lr(re,s.chat,F,{turnRef:Ye.current,requiredTools:e.requiredTools})}else if(M&&y.agent){const Y=y.agent.elementId;B[y.agent.jobType]=async $=>{if($.elementId!==Y)throw new Error(`No scripted agent handler for "${$.elementId}" — only "${Y}" (the primary process's first agent host) is driven by the scripted brain. Use a live brain to exercise more than one host.`);const re=await M($),xe=(re.activateElements??[]).map(bn=>bn.elementId).join(", ");return F({kind:"agent",text:re.completionConditionFulfilled?"🤖 scripted agent: done":`🤖 scripted agent: calling ${xe||"(nothing)"}`}),re}}}N([]),ye({});const A={...e.seed,...D,...dr(e.imageInput?l:null)};U(A),ve.current=T,Fe.current=B;const oe=_.redeploy(r),fe=(oe==null?void 0:oe[0])??y.processId;F({kind:"start",text:`Starting "${fe}" — ${y.agent?s.kind==="scripted"||!s.chat?"scripted brain":`live brain (${s.modelInUse??s.kind})`:"no agent in this model"}`});const te=_.createInstance(fe,JSON.stringify(A)),ae=(J=te==null?void 0:te.instances[0])==null?void 0:J.key;return e.imageInput&&l&&ae&&_.setRunImage(ae,l),{workers:T,agents:B,snap:te}},[_,e,w,r,d,D,l,y,s,F,Q]),Be=!!_.snapshot&&_.snapshot.completedInstances<1,nn=!Be&&!!k&&!ie,un=h.useCallback(async()=>{if(!(_.phase!=="ready"||he.current||G||w.hasErrors)){he.current=!0,se(!0);try{let M=ve.current,x=Fe.current,T=_.snapshot;const B=++Ae.current;if(!Be){if(je.current&&!je.current.validate())return;S(null);const A=await Ee();if(!A)return;M=A.workers,x=A.agents,T=A.snap,await new Promise(oe=>setTimeout(oe,$e))}await ze(M,x,T,B)}finally{he.current=!1,se(!1)}}},[_,G,w.hasErrors,Be,Ee,ze]),Oe=h.useCallback(async()=>{var M;if(!(_.phase!=="ready"||he.current||G||w.hasErrors)){he.current=!0,ee(!0);try{let x=ve.current,T=Fe.current,B=_.snapshot;if(!Be){if(je.current&&!je.current.validate())return;S(null);const ae=await Ee();if(!ae)return;x=ae.workers,T=ae.agents,B=ae.snap}if(!B||B.completedInstances>=1)return;const A=B.takenSequenceFlows.length,oe=await _.stepWorkers(x,{agents:T});if(!oe){F({kind:"error",text:"⏭ step failed — no dispatch round was returned"});return}const fe=(M=oe.snapshot.instances[0])==null?void 0:M.variables;fe&&U({...fe});const te=ti(oe.snapshot.takenSequenceFlows,A);F(ri(oe,te,Qe,Q))}finally{he.current=!1,ee(!1)}}},[_,G,w.hasErrors,Be,Ee,F,Qe,Q]),gn=h.useCallback(()=>{he.current=!1,Ae.current++,se(!1),ee(!1),_.reset(),N([]),U({})},[_]),hn=h.useCallback(()=>{if(!de||Pe.current&&!Pe.current.validate())return;const M=_.completeUserTask(de.key,JSON.stringify(Re));F({kind:"human",text:`👤 ${yn(Re)}`}),M&&M.completedInstances>=1&&F({kind:"done",text:"✅ process instance completed"})},[de,Re,_,F]),I=h.useMemo(()=>{var M,x;return _.phase==="loading"?o.jsx(H,{variant:"neutral",children:"Booting engine…"}):_.phase==="error"?o.jsx(H,{variant:"danger",children:"Engine error"}):X?o.jsx(H,{variant:"info",children:"Running…"}):G?o.jsx(H,{variant:"info",children:"Stepping…"}):(((M=_.snapshot)==null?void 0:M.incidentElementIds.length)??0)>0?o.jsx(H,{variant:"danger",children:"Incident"}):de?o.jsx(H,{variant:"warning",children:"Waiting for a human"}):(((x=_.snapshot)==null?void 0:x.completedInstances)??0)>=1?o.jsx(H,{variant:"success",children:"Completed"}):_.snapshot?o.jsx(H,{variant:"warning",children:"Paused"}):o.jsx(H,{variant:"neutral",children:"Ready"})},[_.phase,_.snapshot,X,G,de]);return o.jsxs("div",{className:"runner",children:[o.jsxs("section",{className:"intro",children:[o.jsx("h1",{children:e.title}),o.jsx("p",{children:e.blurb}),o.jsxs("div",{className:"controls",children:[o.jsx(q,{"data-tour":Ne.runButton,onClick:()=>void un(),disabled:_.phase!=="ready"||X||G||w.hasErrors||nn,children:"▶ Run"}),o.jsx(q,{variant:"secondary",onClick:()=>void Oe(),disabled:_.phase!=="ready"||X||G||w.hasErrors||nn||(((Me=_.snapshot)==null?void 0:Me.completedInstances)??0)>=1,children:"⏭ Step"}),o.jsx(q,{variant:"secondary",onClick:gn,disabled:_.phase!=="ready"||G,children:"↺ Reset"}),e.tour&&o.jsx(q,{variant:"secondary",onClick:v.start,disabled:v.active,children:v.active?"Touring…":`🧭 ${e.tour.label}`}),I]}),_.phase==="error"&&o.jsxs(me,{variant:"destructive",children:[o.jsx(pe,{children:"Engine error"}),o.jsx(ue,{children:_.error})]}),ge&&o.jsxs(me,{variant:"destructive",children:[o.jsx(pe,{children:"Code didn't compile"}),o.jsx(ue,{children:ge})]}),w.hasErrors&&o.jsxs(me,{variant:"destructive",children:[o.jsx(pe,{children:"Run is disabled — the diagram has unresolved references"}),o.jsx(ue,{children:o.jsx("ul",{className:"diagnostics",children:w.diagnostics.filter(M=>M.severity==="error").map((M,x)=>o.jsx("li",{children:M.message},x))})})]}),!w.hasErrors&&w.diagnostics.length>0&&o.jsxs(me,{children:[o.jsx(pe,{children:"Heads up"}),o.jsx(ue,{children:o.jsx("ul",{className:"diagnostics",children:w.diagnostics.map((M,x)=>o.jsx("li",{children:M.message},x))})})]})]}),o.jsxs("div",{className:"grid",children:[o.jsxs("div",{className:"col",children:[o.jsx(ke,{sectionId:"process","data-tour":Ne.diagram,title:"Process",description:`${y.processName} — live token (green), incidents (red).`,children:o.jsx(h.Suspense,{fallback:o.jsx("div",{className:"diagram-fallback",children:_.phase==="loading"?"Booting the engine…":"Loading diagram…"}),children:o.jsx(Qi,{xml:w.resolvedBpmn,activeIds:((Ue=_.snapshot)==null?void 0:Ue.activeElementIds)??[],incidentIds:((Cn=_.snapshot)==null?void 0:Cn.incidentElementIds)??[],className:"diagram"})})}),de&&o.jsxs(ke,{sectionId:"human-task",title:(le==null?void 0:le.label)??"Human task",description:Ce?`Rendered from the model's form "${le==null?void 0:le.formId}".`:"This task has no linked form — complete it with no variables.",children:[qe.length>0&&o.jsxs(me,{variant:"destructive",children:[o.jsx(pe,{children:"The agent didn't finish its checks"}),o.jsxs(ue,{children:["It completed without running"," ",qe.map(M=>M.label||M.elementId).join(", "),". The process took the default path to this task, so the findings below have no value to report."]})]}),Ce&&o.jsx(h.Suspense,{fallback:o.jsx("div",{className:"form-fallback",children:"Loading form…"}),children:o.jsx(it,{ref:Pe,schema:Ce,values:Re,onChange:(M,x)=>ye(T=>({...T,[M]:x})),context:V,onValidityChange:Se})}),o.jsx(q,{onClick:hn,disabled:!!Ce&&!pn,children:"Complete task"})]}),_e&&o.jsx(ke,{sectionId:"manual-job",title:_e.control.label,description:"This job is held here on purpose — pick how it resolves.",children:o.jsxs("div",{className:"controls",children:[o.jsx(q,{onClick:()=>void en("complete"),disabled:X||G,children:_e.control.completeLabel??"✅ Complete normally"}),o.jsx(q,{variant:"secondary",onClick:()=>void en("action"),disabled:X||G,children:_e.control.action.label})]})}),o.jsxs("div",{className:"row",children:[o.jsx(ke,{sectionId:"variables",className:"grow","data-tour":Ne.variablesPanel,title:"Variables",description:"The instance payload, live.",children:o.jsx("pre",{className:"vars",children:yn(V,2)})}),o.jsx(Li,{log:E,elementStats:(Bn=_.snapshot)==null?void 0:Bn.elementStats,incidents:(Ln=_.snapshot)==null?void 0:Ln.incidents,labelFor:Qe})]})]}),o.jsxs("div",{className:"col",children:[(y.agent||e.imageInput)&&o.jsx(ke,{sectionId:"brain","data-tour":Ne.brainPanel,title:"Brain",description:y.agent?`What drives “${y.agent.label}”. The model recommends; the process governs.`:"What reads the image. The model recommends; the process governs.",children:o.jsx(Ni,{brain:s,showText:!!y.agent,showVision:!!e.imageInput})}),o.jsxs(ke,{sectionId:"start",title:"Start",description:y.startFormId?`The model's start form "${y.startFormId}".`:e.imageInput?"Pick a seed photo or upload your own to read.":"The starting payload.",children:[e.imageInput&&o.jsx(Ii,{imageInput:e.imageInput,value:l,onSelect:m,disabled:X}),e.scenarios&&o.jsx("div",{className:"scenarios",children:e.scenarios.map(M=>o.jsx(q,{size:"sm",variant:"secondary",disabled:X,onClick:()=>W(x=>({...x,...M.variables})),children:M.label},M.label))}),k?o.jsx(h.Suspense,{fallback:o.jsx("div",{className:"form-fallback",children:"Loading form…"}),children:o.jsx(it,{ref:je,schema:k,values:D,onChange:(M,x)=>W(T=>({...T,[M]:x})),disabled:X,onValidityChange:Ve})}):o.jsx("pre",{className:"vars",children:yn(D,2)})]}),o.jsx(ke,{sectionId:"code",className:"editors","data-tour":Ne.codePanel,title:"Code",description:"One handler per BPMN element, plus a model tab holding the editable diagram — select an element there to edit its properties. Return variables to merge, or throw to fail the job.",children:o.jsx(h.Suspense,{fallback:o.jsx("div",{className:"editor-fallback",children:"Loading editor…"}),children:o.jsxs(Gt,{value:Z,onValueChange:ce,children:[o.jsxs(Vt,{children:[o.jsx(tn,{value:tt,children:"model"}),y.agent&&o.jsx(tn,{value:wn,children:"agent (scripted)"}),e.handlers.map(M=>{var x;return o.jsx(tn,{value:M.elementId,children:((x=y.tasks.find(T=>T.elementId===M.elementId))==null?void 0:x.label)??M.elementId},M.elementId)}),Object.keys(u).map(M=>o.jsx(tn,{value:rt+M,children:M},M))]}),o.jsxs(rn,{value:tt,children:[o.jsxs("div",{className:"editor-meta",children:[o.jsx("strong",{children:"Model"}),o.jsx("code",{children:"click an element to edit its properties on the right — Run re-reads whatever you leave here"}),o.jsx(q,{variant:"secondary",size:"sm",onClick:()=>i(e.bpmn),disabled:r===e.bpmn,children:"Revert to original"})]}),o.jsx(qi,{value:r,onChange:i})]}),y.agent&&o.jsxs(rn,{value:wn,children:[o.jsxs("div",{className:"editor-meta",children:[o.jsx("strong",{children:y.agent.label}),o.jsx("code",{children:s.kind==="scripted"||!s.chat?"in use":"unused — a live brain is connected"})]}),o.jsx("div",{className:"editor-wrap",children:o.jsx(fn,{height:"360px",defaultLanguage:"javascript",value:d,onChange:M=>g(M??""),options:vn})})]}),e.handlers.map(M=>{var x;return o.jsxs(rn,{value:M.elementId,children:[o.jsxs("div",{className:"editor-meta",children:[o.jsx("strong",{children:((x=y.tasks.find(T=>T.elementId===M.elementId))==null?void 0:x.label)??M.elementId}),o.jsx("code",{children:M.standsInFor??M.elementId})]}),o.jsx("div",{className:"editor-wrap",children:o.jsx(fn,{height:"360px",defaultLanguage:"javascript",value:p[M.elementId],onChange:T=>a(B=>({...B,[M.elementId]:T??""})),options:vn})})]},M.elementId)}),Object.keys(u).map(M=>o.jsxs(rn,{value:rt+M,children:[o.jsxs("div",{className:"editor-meta",children:[o.jsx("strong",{children:M}),o.jsxs("code",{children:["prompt / template text — substitutes"," ","{{"+M+"}}"]})]}),o.jsx("div",{className:"editor-wrap",children:o.jsx(fn,{height:"360px",defaultLanguage:"markdown",value:u[M],onChange:x=>b(T=>Ke(T,{[M]:x??""})),options:vn})})]},M))]})})}),y.agent&&o.jsx(ke,{sectionId:"tools",title:"Tools, as the model sees them",description:o.jsxs(o.Fragment,{children:["Read from the diagram — element name, documentation, and every",o.jsx("code",{children:" fromAi(…)"})," argument."]}),children:o.jsx("ul",{className:"tool-list",children:y.agent.tools.map(M=>o.jsxs("li",{children:[o.jsx("code",{children:M.elementId}),o.jsxs("span",{children:[" — ",M.documentation||M.label]}),M.args.length>0&&o.jsx("ul",{children:M.args.map(x=>o.jsxs("li",{children:[o.jsxs("code",{children:[x.name,": ",x.type]})," ","— ",x.description]},x.name))})]},M.elementId))})})]})]})]})}const vn={minimap:{enabled:!1},fontSize:13,scrollBeyondLastLine:!1,tabSize:2,automaticLayout:!0},Hi=`<?xml version="1.0" encoding="UTF-8"?>\r
...
`,So="Camunda Cloud",Po="8.10.0",Ao={name:"Camunda Web Modeler",version:"9b5d5ef"},Do=19,Co="learn-user-task-form-review",Bo=[{text:`# Review request
...
`,$o={id:"compliance-walkthrough",label:"Take the tour",steps:[{title:"Start a run",description:"Press Run to send a shipment through the compliance agent.",target:{anchor:Ne.runButton}},{title:"The agent picks its own tools",description:"This AI Agent reads the shipment notes and decides, turn by turn, which of the tools below it to call — nothing here is hard-coded into a fixed sequence.",target:{elementId:"ComplianceCheckAgent"}},{title:"Watch the token move",description:"The agent's first move is to look up the genetic marker mentioned in the notes.",target:{elementId:"VerifyGeneticMarker"},waitFor:{kind:"activeElement",elementId:"VerifyGeneticMarker"}},{title:"A cleared shipment notifies the export team",description:"Once the compliance score comes back clean, the process notifies the export team automatically — no human review needed for this scenario.",target:{elementId:"NotifyExportTeam"},waitFor:{kind:"elementCompleted",elementId:"NotifyExportTeam"}},{title:"Everything the run recorded",description:"The variables panel shows the marker record, the country lookup, the compliance score, and the final decision — exactly what each tool and the agent wrote along the way.",target:{anchor:Ne.variablesPanel}}],successEvent:{kind:"instanceCompleted"}},Go=`<?xml version="1.0" encoding="UTF-8"?>
...
}`,Qa={id:"loan-origination",title:"Loan origination agent",blurb:"An AI agent gathers a loan case with its own tools — customer lookup, credit bureau, an underwriting policy, a status update — then every application passes through a mandatory senior-officer review before a gateway routes it to an offer or a decline. The agent advises; the process governs.",docsUrl:"https://camunda.com/orchestrate/agents/",bpmn:fa,forms:{"loan-application":Ia,"loan-senior-officer-review":Ba},seed:at,scenarios:[{label:"Strong applicant (policy recommends approve)",variables:at},{label:"Marginal applicant (policy recommends decline)",variables:Fa}],scriptedAgent:za,templates:Ra,tour:wa,requiredTools:["AssessApplication","UpdateApplicationStatus"],handlers:[{elementId:"QueryCustomer",standsInFor:"CRM connector — customer lookup",source:Oa},{elementId:"CreditBureauLookup",standsInFor:"REST connector — credit bureau",source:Ua},{elementId:"AssessApplication",standsInFor:"Script task — underwriting policy (FEEL)",source:$a},{elementId:"UpdateApplicationStatus",standsInFor:"REST connector — origination system",source:Ga},{elementId:"IssueLoanOffer",standsInFor:"REST connector — offer/booking system",source:Va},{elementId:"SendDeclineNotice",standsInFor:"REST connector — notifications",source:Ya}]},qa=`<?xml version="1.0" encoding="UTF-8"?>
...
}`,qs={id:"plate-recognition",title:"Read a number plate from a photo",blurb:"Pick the plate's country, then a photo goes into the run, an in-browser vision model reads the number plate on the reader's own GPU, and a human confirms or corrects it before the process records the result. The vision model recommends; the BPMN process governs. No server, no API key — with no model connected it falls back to a deterministic scripted reading.",docsUrl:"https://docs.camunda.io/docs/components/modeler/forms/camunda-forms-reference/",bpmn:bs,forms:{"plate-recognition-country":Os,"plate-recognition-confirm":Ns,"plate-recognition-manual":As},seed:{country:"auto"},imageInput:{label:"Pick a seed photo (its plate is known, so the scripted reader works offline) or upload your own — a live in-browser model reads a photo it has never seen.",seedImages:Gs},scriptedVision:Vs,handlers:[{elementId:"ExtractPlate",standsInFor:"Vision model — Florence-2 <OCR> on WebGPU (in-browser)",source:Ys},{elementId:"RecordResult",standsInFor:"Script task — records the governed outcome",source:Qs}]},Js=[es,ha,Qa,Za,os,qs],Hs=Object.assign({"./learn-error-boundary/index.ts":Xi,"./learn-exclusive-gateway/index.ts":oo,"./learn-message-correlation/index.ts":co,"./learn-multi-instance-parallel/index.ts":go,"./learn-service-task/index.ts":fo,"./learn-signal-broadcast/index.ts":No,"./learn-timer-catch-event/index.ts":To,"./learn-user-task-form/index.ts":zo}),Ws=Object.values(Hs).map(e=>e.default).sort((e,n)=>e.id.localeCompare(n.id)),Je=[...Js,...Ws];function Dn(){return"/pr-preview/pr-99/"}function Zs(e){const n=Dn();return e.startsWith(n)?"/"+e.slice(n.length):e}function Ks(e=location.pathname){const t=Zs(e).match(/^\/examples\/([^/]+)\/?$/);if(t)try{return{kind:"example",id:decodeURIComponent(t[1])}}catch{return{kind:"gallery"}}return{kind:"gallery"}}function Xs(e=location.search){return new URLSearchParams(e).get("embed")==="1"}function ed(){return Dn()}function dt(e){return`${Dn()}examples/${encodeURIComponent(e)}`}function lt(e,n={}){const t=new URL(location.href);t.pathname=e,t.search=n.search??t.search,n.hash!==void 0&&(t.hash=n.hash),n.replace?history.replaceState(history.state,"",t):history.pushState(history.state,"",t),window.dispatchEvent(new PopStateEvent("popstate"))}function ct(){return{route:Ks(),embed:Xs()}}function nd(){const[e,n]=h.useState(ct);return h.useEffect(()=>{const t=()=>n(ct());return window.addEventListener("popstate",t),()=>window.removeEventListener("popstate",t)},[]),e}const td="web-demo-framework:height",rd="web-demo-framework:request-height";function id(e){return{type:td,height:Math.ceil(e)}}const mt="embed-height-auto";function od(e){h.useEffect(()=>{if(!e||typeof window>"u"||window.parent===window)return;const n=document.documentElement;n.classList.add(mt);let t=-1;const r=(l=!1)=>{const m=document.documentElement.scrollHeight;!l&&Math.abs(m-t)<2||(t=m,window.parent.postMessage(id(m),"*"))},i=l=>{if(l.source!==window.parent)return;const m=l.data;!m||m.type!==rd||r(!0)};window.addEventListener("message",i),r();const s=new ResizeObserver(()=>r());return s.observe(n),()=>{s.disconnect(),window.removeEventListener("message",i),n.classList.remove(mt)}},[e])}function ad(){const{route:e,embed:n}=nd(),t=St().brain,r=Ri();od(n);const i=e.kind==="example"?e.id:Je[0].id,s=Je.find(d=>d.id===i)??Je[0],l=Je.filter(d=>d.group!=="learn-bpmn"),m=Je.filter(d=>d.group==="learn-bpmn"),p=d=>{lt(dt(d),{hash:location.hash})},a=o.jsxs(o.Fragment,{children:[!n&&e.kind==="gallery"&&o.jsxs(o.Fragment,{children:[o.jsx("nav",{className:"example-picker",children:l.map(d=>o.jsx(q,{size:"sm",variant:d.id===s.id?"default":"secondary",onClick:()=>p(d.id),children:d.title},d.id))}),m.length>0&&o.jsxs(o.Fragment,{children:[o.jsx("h2",{className:"example-group-heading",children:"Learn BPMN"}),o.jsx("nav",{className:"example-picker",children:m.map(d=>o.jsx(q,{size:"sm",variant:d.id===s.id?"default":"secondary",onClick:()=>p(d.id),children:d.title},d.id))})]})]}),!n&&e.kind==="example"&&o.jsx("div",{className:"example-nav",children:o.jsx(q,{size:"sm",variant:"secondary",onClick:()=>lt(ed()),children:"← All examples"})}),o.jsxs("div",{className:"example-meta",children:[s.docsUrl&&o.jsx("a",{className:"docs-link",href:s.docsUrl,target:"_blank",rel:"noreferrer noopener",children:"View on camunda.com ↗"}),n&&o.jsx("a",{className:"open-full-page",href:dt(s.id)+(location.hash||""),target:"_top",rel:"noreferrer",children:"Open full page ↗"})]}),o.jsx(Ji,{example:s,initialBrainKind:t,initialTourId:r},s.id)]});return n?o.jsx("div",{className:"c4-ui app-shell app-embed",children:o.jsx("main",{id:"main",className:"layout layout-embed",children:a})}):o.jsxs("div",{className:"c4-ui app-shell",children:[o.jsx(Yt,{appName:"Runnable Camunda examples",trailing:o.jsx("span",{className:"app-subtitle",children:"model + code + optional LLM, in your browser"})}),o.jsx("main",{id:"main",className:"layout",children:a})]})}Lt.createRoot(document.getElementById("root")).render(o.jsx(h.StrictMode,{children:o.jsx(Qt,{children:o.jsx(ad,{})})}));export{be as _,cd as c};
