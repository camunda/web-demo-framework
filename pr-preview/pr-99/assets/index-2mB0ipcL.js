...
}`,Js={id:"plate-recognition",title:"Read a number plate from a photo",blurb:"Pick the plate's country, then a photo goes into the run, an in-browser vision model reads the number plate on the reader's own GPU, and a human confirms or corrects it before the process records the result. The vision model recommends; the BPMN process governs. No server, no API key — with no model connected it falls back to a deterministic scripted reading.",docsUrl:"https://docs.camunda.io/docs/components/modeler/forms/camunda-forms-reference/",bpmn:_s,forms:{"plate-recognition-country":Us,"plate-recognition-confirm":Es,"plate-recognition-manual":Ds},seed:{country:"auto"},imageInput:{label:"Pick a seed photo (its plate is known, so the scripted reader works offline) or upload your own — a live in-browser model reads a photo it has never seen.",seedImages:Vs},scriptedVision:Ys,handlers:[{elementId:"ExtractPlate",standsInFor:"Vision model — Florence-2 <OCR> on WebGPU (in-browser)",source:Qs},{elementId:"RecordResult",standsInFor:"Script task — records the governed outcome",source:qs}]},Hs=[ns,ba,qa,Ka,as,Js],Ws=Object.assign({"./learn-error-boundary/index.ts":eo,"./learn-exclusive-gateway/index.ts":ao,"./learn-message-correlation/index.ts":mo,"./learn-multi-instance-parallel/index.ts":ho,"./learn-service-task/index.ts":yo,"./learn-signal-broadcast/index.ts":Eo,"./learn-timer-catch-event/index.ts":jo,"./learn-user-task-form/index.ts":Oo}),Zs=Object.values(Ws).map(e=>e.default).sort((e,n)=>e.id.localeCompare(n.id)),He=[...Hs,...Zs];function Dt(){return"/pr-preview/pr-99/"}function Ks(e){const n=Dt();return e.startsWith(n)?"/"+e.slice(n.length):e}function Xs(e=location.pathname){const t=Ks(e).match(/^\/examples\/([^/]+)\/?$/);if(t)try{return{kind:"example",id:decodeURIComponent(t[1])}}catch{return{kind:"gallery"}}return{kind:"gallery"}}function ed(e=location.search){return new URLSearchParams(e).get("embed")==="1"}function dt(e){return`${Dt()}examples/${encodeURIComponent(e)}`}function nd(e,n={}){const t=new URL(location.href);t.pathname=e,t.search=n.search??t.search,n.hash!==void 0&&(t.hash=n.hash),n.replace?history.replaceState(history.state,"",t):history.pushState(history.state,"",t),window.dispatchEvent(new PopStateEvent("popstate"))}function lt(){return{route:Xs(),embed:ed()}}function td(){const[e,n]=h.useState(lt);return h.useEffect(()=>{const t=()=>n(lt());return window.addEventListener("popstate",t),()=>window.removeEventListener("popstate",t)},[]),e}const rd="web-demo-framework:height",id="web-demo-framework:request-height";function od(e){return{type:rd,height:Math.ceil(e)}}const ct="embed-height-auto";function ad(e){h.useEffect(()=>{if(!e||typeof window>"u"||window.parent===window)return;const n=document.documentElement;n.classList.add(ct);let t=-1;const r=(l=!1)=>{const m=document.documentElement.scrollHeight;!l&&Math.abs(m-t)<2||(t=m,window.parent.postMessage(od(m),"*"))},i=l=>{if(l.source!==window.parent)return;const m=l.data;!m||m.type!==id||r(!0)};window.addEventListener("message",i),r();const s=new ResizeObserver(()=>r());return s.observe(n),()=>{s.disconnect(),window.removeEventListener("message",i),n.classList.remove(ct)}},[e])}function sd(){const{route:e,embed:n}=td(),t=jt().brain,r=Fi();ad(n);const i=e.kind==="example"?e.id:He[0].id,s=He.find(d=>d.id===i)??He[0],l=He.filter(d=>d.group!=="learn-bpmn"),m=He.filter(d=>d.group==="learn-bpmn"),p=d=>{nd(dt(d),{hash:location.hash})},a=o.jsxs(o.Fragment,{children:[!n&&o.jsxs(o.Fragment,{children:[o.jsx("nav",{className:"example-picker","aria-label":"Scenario examples",children:l.map(d=>o.jsx(J,{size:"sm",variant:d.id===s.id?"default":"secondary","aria-current":d.id===s.id?"page":void 0,onClick:()=>p(d.id),children:d.title},d.id))}),m.length>0&&o.jsxs(o.Fragment,{children:[o.jsx("h2",{className:"example-group-heading",id:"learn-bpmn-heading",children:"Learn BPMN"}),o.jsx("nav",{className:"example-picker","aria-labelledby":"learn-bpmn-heading",children:m.map(d=>o.jsx(J,{size:"sm",variant:d.id===s.id?"default":"secondary","aria-current":d.id===s.id?"page":void 0,onClick:()=>p(d.id),children:d.title},d.id))})]})]}),o.jsxs("div",{className:"example-meta",children:[s.docsUrl&&o.jsx("a",{className:"docs-link",href:s.docsUrl,target:"_blank",rel:"noreferrer noopener",children:"View on camunda.com ↗"}),n&&o.jsx("a",{className:"open-full-page",href:dt(s.id)+(location.hash||""),target:"_top",rel:"noreferrer",children:"Open full page ↗"})]}),o.jsx(Hi,{example:s,initialBrainKind:t,initialTourId:r},s.id)]});return n?o.jsx("div",{className:"c4-ui app-shell app-embed",children:o.jsx("main",{id:"main",className:"layout layout-embed",children:a})}):o.jsxs("div",{className:"c4-ui app-shell",children:[o.jsx(Qt,{appName:"Runnable Camunda examples",trailing:o.jsx("span",{className:"app-subtitle",children:"model + code + optional LLM, in your browser"})}),o.jsx("main",{id:"main",className:"layout",children:a})]})}Rt.createRoot(document.getElementById("root")).render(o.jsx(h.StrictMode,{children:o.jsx(qt,{children:o.jsx(sd,{})})}));export{fe as _,md as c};
