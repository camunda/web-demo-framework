const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/driver-CTZuBZOi.css","assets/diagram-js-DAKGYcfb.css","assets/bpmn-embedded-BLz2Dhj7.css","assets/RuntimeDiagram-B2IYfHo7.js","assets/vendor-react-9Ma26nY1.js","assets/Viewer-D_7S4Gwm.js","assets/MonacoEditor-BWVwCA_S.js","assets/MonacoEditor-Dq4KoJiD.css","assets/vendor-modeler-BRi0wbco.js","assets/vendor-design-system-FHVb_HJ-.js","assets/vendor-design-system-Cp414jgt.css","assets/parser-DkgAe_kI.js","assets/ModelEditor-Dwlgp6JA.css","assets/FormRenderer-CEW7R2wZ.js","assets/FormRenderer-D1JIHOW6.css"])))=>i.map(i=>d[i]);
var Bt=Object.defineProperty;var Lt=(e,n,t)=>n in e?Bt(e,n,{enumerable:!0,configurable:!0,writable:!0,value:t}):e[n]=t;var O=(e,n,t)=>Lt(e,typeof n!="symbol"?n+"":n,t);import{r as h,j as o,i as Rt}from"./vendor-react-9Ma26nY1.js";import{B as q,a as H,L as Ve,S as Mn,b as xn,c as Nn,d as En,e as kn,A as me,f as pe,g as ue,I as Rn,C as Ft,h as zt,i as Ot,j as Ut,k as $t,l as Gt,T as Vt,m as Yt,n as rn,o as on,p as Qt,q as qt}from"./vendor-design-system-FHVb_HJ-.js";(function(){const n=document.createElement("link").relList;if(n&&n.supports&&n.supports("modulepreload"))return;for(const i of document.querySelectorAll('link[rel="modulepreload"]'))r(i);new MutationObserver(i=>{for(const s of i)if(s.type==="childList")for(const l of s.addedNodes)l.tagName==="LINK"&&l.rel==="modulepreload"&&r(l)}).observe(document,{childList:!0,subtree:!0});function t(i){const s={};return i.integrity&&(s.integrity=i.integrity),i.referrerPolicy&&(s.referrerPolicy=i.referrerPolicy),i.crossOrigin==="use-credentials"?s.credentials="include":i.crossOrigin==="anonymous"?s.credentials="omit":s.credentials="same-origin",s}function r(i){if(i.ep)return;i.ep=!0;const s=t(i);fetch(i.href,s)}})();const Jt="modulepreload",Ht=function(e){return"/pr-preview/pr-99/"+e},Fn={},_e=function(n,t,r){let i=Promise.resolve();if(t&&t.length>0){let l=function(a){return Promise.all(a.map(d=>Promise.resolve(d).then(g=>({status:"fulfilled",value:g}),g=>({status:"rejected",reason:g}))))};document.getElementsByTagName("link");const m=document.querySelector("meta[property=csp-nonce]"),p=(m==null?void 0:m.nonce)||(m==null?void 0:m.getAttribute("nonce"));i=l(t.map(a=>{if(a=Ht(a),a in Fn)return;Fn[a]=!0;const d=a.endsWith(".css"),g=d?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${a}"]${g}`))return;const u=document.createElement("link");if(u.rel=d?"stylesheet":Jt,d||(u.as="script"),u.crossOrigin="",u.href=a,p&&u.setAttribute("nonce",p),document.head.appendChild(u),d)return new Promise((b,w)=>{u.addEventListener("load",b),u.addEventListener("error",()=>w(new Error(`Unable to preload CSS for ${a}`)))})}))}function s(l){const m=new Event("vite:preloadError",{cancelable:!0});if(m.payload=l,window.dispatchEvent(m),!m.defaultPrevented)throw l}return i.then(l=>{for(const m of l||[])m.status==="rejected"&&s(m.reason);return n().catch(s)})},Wt="io.camunda.agenticai:aiagent",Se="http://www.omg.org/spec/BPMN/20100524/MODEL",Zt="http://camunda.org/schema/zeebe/1.0";function In(e,n){return Array.from(e.getElementsByTagNameNS(Zt,n))}function pt(e,n){return In(e,n).filter(t=>Kt(t)===e)}function Kt(e){let n=e.parentElement;for(;n;){if(n.namespaceURI===Se&&n.localName!=="extensionElements")return n;n=n.parentElement}return null}function An(e){const n=pt(e,"taskDefinition")[0],t=n==null?void 0:n.getAttribute("type");return t||(e.localName==="scriptTask"?e.getAttribute("id")??null:null)}function zn(e){const n=Array.from(e.children).find(t=>t.namespaceURI===Se&&t.localName==="documentation");return((n==null?void 0:n.textContent)??"").trim()}function On(e){if(!e)return"";const n=e.startsWith("=")?e.slice(1):e,t=n.match(/"((?:[^"\\]|\\.)*)"/g);return t?t.map(r=>r.slice(1,-1).replace(/\\n/g,`
...
`)}function Xt(e){return gt(ut(e))}function er(e){const n=Array.from(e.children).find(t=>t.namespaceURI===Se&&t.localName==="extensionElements");return n?gt(ut(n)):[]}function gt(e){const n=/fromAi\(\s*toolCall\.([A-Za-z_$][\w$]*)\s*,\s*"((?:[^"\\]|\\.)*)"\s*(?:,\s*"(\w+)")?/g,t=[],r=new Set;for(const i of e.matchAll(n)){const s=i[1];r.has(s)||(r.add(s),t.push({name:s,description:(i[2]??"").replace(/&#10;/g,`
`).replace(/\\"/g,'"').replace(/&quot;/g,'"').replace(/&#39;/g,"'").trim(),type:i[3]??"string"}))}return t}function nr(e){const n={};for(const t of pt(e,"input")){const r=t.getAttribute("target");r&&(n[r]=t.getAttribute("source")??"")}return n}function tr(e){return Array.from(e.getElementsByTagNameNS(Se,"adHocSubProcess")).filter(n=>(An(n)??"").startsWith(Wt))}const rr=new Set(["subProcess","adHocSubProcess","callActivity"]),ir=new Set(["adHocSubProcess","subProcess","transaction"]);function or(e){let n=e.parentElement;for(;n;){if(n.namespaceURI===Se&&ir.has(n.localName))return n;n=n.parentElement}return null}function ar(e,n){const t=nr(e),r=Number((t["data.limits.maxModelCalls"]??"").replace(/^=/,""));return{elementId:e.getAttribute("id")??"agent",label:e.getAttribute("name")??"Agent",jobType:An(e),systemPrompt:On(t["data.systemPrompt.prompt"]),userPrompt:On(t["data.userPrompt.prompt"]),maxModelCalls:Number.isFinite(r)&&r>0?r:10,tools:n}}function sr(e,n){var g;const t=e.getAttribute("id")??"",r=e.getAttribute("name")??t,i=tr(e);i.length>1&&n.push({severity:"warning",elementId:i.map(u=>u.getAttribute("id")).join(", "),message:`Process "${r}" hosts ${i.length} AI Agent sub-processes (${i.map(u=>u.getAttribute("id")).join(", ")}). Each gets its own independent agent state (turn counter, called tools) — the run itself is shared across hosts, but each host's agent state within it is not.`});const s=[],l=new Map(i.map(u=>[u,[]]));for(const u of Array.from(e.getElementsByTagName("*"))){if(u.namespaceURI!==Se||i.includes(u))continue;const b=u.getAttribute("id");if(!b)continue;const w=or(u),y=w&&i.includes(w)?w:null;if(y&&rr.has(u.localName)){const I=u.getAttribute("name")??b,C=zn(u);s.push({elementId:b,label:I,jobType:"",documentation:C,isTool:!0,compound:!0}),l.get(y).push({elementId:b,label:I,jobType:"",documentation:C,args:er(u),compound:!0});continue}const _=An(u);if(!_)continue;const M={elementId:b,label:u.getAttribute("name")??b,jobType:_,documentation:zn(u),isTool:y!=null};s.push(M),y&&l.get(y).push({elementId:b,label:M.label,jobType:_,documentation:M.documentation,args:Xt(u)})}const m=i.map(u=>ar(u,l.get(u))),p=Array.from(e.getElementsByTagNameNS(Se,"userTask")).map(u=>{var b;return{elementId:u.getAttribute("id")??"",label:u.getAttribute("name")??u.getAttribute("id")??"",formId:((b=In(u,"formDefinition")[0])==null?void 0:b.getAttribute("formId"))??void 0}}),a=e.getElementsByTagNameNS(Se,"startEvent")[0],d=a?((g=In(a,"formDefinition")[0])==null?void 0:g.getAttribute("formId"))??void 0:void 0;return{processId:t,processName:r,tasks:s,agents:m,userTasks:p,startFormId:d}}function dr(e,n={}){const t=new DOMParser().parseFromString(e,"application/xml"),r=t.getElementsByTagName("parsererror")[0];if(r)throw new Error(`Invalid BPMN XML: ${r.textContent}`);const i=Array.from(t.getElementsByTagNameNS(Se,"process"));if(i.length===0)throw new Error("No <bpmn:process> in the diagram.");const s=[],l=i.map(p=>sr(p,s));let m=n.processId?l.find(p=>p.processId===n.processId):void 0;return n.processId&&!m&&s.push({severity:"warning",message:`Requested process "${n.processId}" not found — falling back to "${l[0].processId}".`}),m??(m=l[0]),l.length>1&&s.push({severity:"warning",message:`Diagram has ${l.length} <bpmn:process> elements (${l.map(p=>p.processId).join(", ")}); using "${m.processId}" as the active process. Pass a processId to parseModel to target another.`}),{processes:l,diagnostics:s,processId:m.processId,processName:m.processName,tasks:m.tasks,agent:m.agents[0]??null,agents:l.flatMap(p=>p.agents),userTasks:m.userTasks,startFormId:m.startFormId}}function lr(e){return e?e.imageId?{imageId:e.imageId}:e.imageName?{imageName:e.imageName}:{}:{}}function ht(e,n){return n?e.pixels:e.imageId??e.pixels}const cr="No image selected — pick or upload a photo to read.";function Un(){return cr}function mr(e,n){return async t=>{const r=e.resolve(n);if(!r)return Un();const i=ht(r,e.live);if(i===void 0)return Un();try{return await e.read(i,t)}catch(s){return`Couldn't read the image (${s instanceof Error?s.message:String(s)}).`}}}function pr(e,n){return async()=>{const t=e.resolve(n);if(t)return ht(t,e.live)}}function ur(){return`<!doctype html><html><head><meta charset="utf-8"></head><body><script>
    "use strict";
    ...
    post({ kind: "ready" });
  <\/script></body></html>`}function bt(e,n={}){const{timeoutMs:t=5e3,onTrace:r,onVision:i,onImage:s}=n,l=`${Date.now()}-${Math.random().toString(36).slice(2)}`;return new Promise((m,p)=>{const a=document.createElement("iframe");a.setAttribute("sandbox","allow-scripts"),a.style.display="none",a.setAttribute("aria-hidden","true");let d=!1,g;const u=()=>{g&&clearTimeout(g),window.removeEventListener("message",w),a.remove()},b=_=>{d||(d=!0,u(),_())};function w(_){var I;if(_.source!==a.contentWindow)return;const M=_.data;if(!(!M||typeof M!="object")){if(M.kind==="ready"){const C=e.job,W=e.kind==="run-handler"?{kind:"run-handler",id:l,source:e.source,job:C,hasVision:e.hasVision}:{kind:"run-agent",id:l,source:e.source,job:C};(I=a.contentWindow)==null||I.postMessage(W,"*");return}"id"in M&&M.id!==l||(M.kind==="trace"?r==null||r(M.text):M.kind==="vision-request"?y(M.callId,i,"vision",M.prompt):M.kind==="image-request"?y(M.callId,s,"image"):M.kind==="result"?b(()=>m(M.value)):M.kind==="error"&&b(()=>p(new Error(M.message))))}}function y(_,M,I,...C){const W=Z=>{var ce;return(ce=a.contentWindow)==null?void 0:ce.postMessage(Z,"*")};if(!M){W({kind:"helper-error",id:l,callId:_,message:`${I} helper is not available.`});return}Promise.resolve().then(()=>M(...C)).then(Z=>W({kind:"helper-result",id:l,callId:_,value:Z}),Z=>W({kind:"helper-error",id:l,callId:_,message:Z instanceof Error?Z.message:String(Z)}))}window.addEventListener("message",w),g=setTimeout(()=>{b(()=>p(new Error(`Handler timed out after ${t}ms — the sandboxed run was terminated.`)))},t),a.srcdoc=ur(),document.body.appendChild(a)})}function _t(e){return{key:e.key,type:e.type,elementId:e.elementId,instanceKey:e.instanceKey,variables:e.variables??{}}}function gr(e,n,t){const r=typeof t.vision=="function";return bt({kind:"run-handler",source:e,job:_t(n),hasVision:r},{onTrace:t.trace,onVision:t.vision?i=>t.vision(i):void 0,onImage:t.image?()=>t.image():void 0})}function hr(e,n){return bt({kind:"run-agent",source:e,job:_t(n)})}function wt(e,n){try{new Function(`"use strict"; return (${e});`)}catch{throw new Error(`${n} has a syntax error.`)}}function br(e){return wt(e,"Handler code"),(n,t)=>gr(e,n,t)}function _r(e){return wt(e,"Agent code"),n=>hr(e,n)}function wr(e,n,t,r){return{sleep:i=>new Promise(s=>setTimeout(s,i)),trace:i=>n({kind:"tool",text:`   ${i}`,elementId:e.elementId,turn:t}),text:(i,s="")=>{const l=e.variables[i];return typeof l=="string"?l:l==null?s:String(l)},num:(i,s=0)=>{const l=e.variables[i],m=typeof l=="number"?l:Number(l);return Number.isFinite(m)?m:s},...r?{vision:mr(r,e.instanceKey),image:pr(r,e.instanceKey)}:{}}}function fr(e){if(e===void 0)return"undefined";try{return JSON.stringify(e)}catch{return"[unserializable value]"}}function yr(e,n,t,r,i){const s={},l=e.processes.flatMap(p=>p.tasks),m=new Map(l.map(p=>[p.elementId,p.label]));for(const p of l)p.compound||s[p.jobType]||(s[p.jobType]=async a=>{const d=n[a.elementId];if(!d)throw new Error(`No handler registered for ${a.elementId} (job type ${a.type})`);const g=m.get(a.elementId)??a.elementId,u=r==null?void 0:r.current;t({kind:"tool",text:`▶ ${g}`,elementId:a.elementId,turn:u});const b=await d(a,wr(a,t,u,i));return t({kind:"vars",text:`  ↳ ${fr(b)}`,elementId:a.elementId,result:b,turn:u}),b});return s}const vr=/\{\{\s*([A-Za-z][A-Za-z0-9_-]*)\s*\}\}/g;function Xe(...e){const n=Object.create(null);for(const t of e)if(t)for(const r of Object.keys(t))n[r]=t[r];return n}function ft(e){return(e.split("/").pop()??e).replace(/\.[^./]+$/,"")}function yt(e){return e.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;")}function Mr(e){return yt(e).replace(/"/g,"&quot;").replace(/\n/g,"&#10;").replace(/\t/g,"&#9;")}function xr(e){return e.replace(/\\/g,"\\\\").replace(/&/g,"&amp;").replace(/"/g,"\\&#34;").replace(/\n/g,"&#10;").replace(/\t/g,"&#9;").replace(/</g,"&lt;").replace(/>/g,"&gt;")}function Nr(e){return JSON.stringify(e).slice(1,-1)}function Er(e,n){const t=e.lastIndexOf("<",n),r=e.lastIndexOf(">",n);if(t<=r)return"text";const i=e.slice(t,n);if((i.match(/"/g)??[]).length%2===0)return"text";const l=i.lastIndexOf('"');return(i.slice(l+1).match(/&#34;|&quot;/g)??[]).length%2===1?"feel-literal":"attribute"}function kr(e,n,t="xml"){const r=[],i=new Set;return{result:e.replace(vr,(l,m,p)=>{const a=m.trim();if(!Object.prototype.hasOwnProperty.call(n,a))return i.has(a)||(i.add(a),r.push(a)),l;const d=n[a];if(t==="json")return Nr(d);const g=Er(e,p);return g==="feel-literal"?xr(d):g==="attribute"?Mr(d):yt(d)}),unresolved:r}}function Ir(){return{processes:[],diagnostics:[],processId:"",processName:"",tasks:[],agent:null,agents:[],userTasks:[],startFormId:void 0}}function Tr(e,n={},t=e.bpmn,r={}){const i=[],s=Xe(e.templates,r),{result:l,unresolved:m}=kr(t,s,"xml");for(const M of m)i.push({severity:"warning",message:`Template placeholder "{{${M}}}" has no matching prompt/template content — left in the model as-is, not substituted.`});let p;try{p=dr(l)}catch(M){return i.push({severity:"error",message:M instanceof Error?M.message:String(M)}),{resolvedBpmn:l,model:Ir(),handlers:{},forms:{},diagnostics:i,hasErrors:!0}}i.push(...p.diagnostics);const a=p.processes.flatMap(M=>M.tasks),d=new Map(e.handlers.map(M=>[M.elementId,M.source])),g={};for(const M of a){if(M.compound)continue;const I=n[M.elementId]??d.get(M.elementId);if(I===void 0){i.push({severity:"error",elementId:M.elementId,jobType:M.jobType,message:`No handler for "${M.label}" (${M.elementId}, job type "${M.jobType}"). Add a handler for this element, or remove it from the diagram.`});continue}try{g[M.elementId]=br(I)}catch(C){i.push({severity:"error",elementId:M.elementId,jobType:M.jobType,message:`"${M.label}" (${M.elementId}): handler code didn't compile — ${C instanceof Error?C.message:String(C)}`})}}const u=new Set(a.map(M=>M.elementId)),b=new Set([...d.keys(),...Object.keys(n)]);for(const M of b)u.has(M)||i.push({severity:"error",elementId:M,message:`Handler "${M}" doesn't match any element in the current diagram — likely orphaned by a rename. Rename it back, or remove the handler.`});const w={},y=e.forms??{},_=(M,I)=>{if(!M)return;const C=y[M];C?w[M]=C:i.push({severity:"error",formId:M,message:`${I} references form "${M}", which has no matching schema.`})};for(const M of p.processes){_(M.startFormId,`The start event of process "${M.processName}"`);for(const I of M.userTasks)_(I.formId,`User task "${I.label}" (${I.elementId})`)}return{resolvedBpmn:l,model:p,handlers:g,forms:w,diagnostics:i,hasErrors:i.some(M=>M.severity==="error")}}function jr(e){const n=e.indexOf("{");if(n<0)return null;let t=0;for(let r=n;r<e.length;r++)if(e[r]==="{")t++;else if(e[r]==="}"&&(t--,t===0))try{const i=JSON.parse(e.slice(n,r+1));return typeof i=="object"&&i!==null&&!Array.isArray(i)?i:null}catch{return null}return null}function Tn(e,n=220){const t=e.replace(/\s+/g," ").trim();return t.length>n?`${t.slice(0,n-1)}…`:t}function $n(e){const n=e.arguments??e.args??e.parameters??e.input;return n&&typeof n=="object"&&!Array.isArray(n)?n:{}}function Gn(e){if(!e)return[];const n=e.tool??e.name??e.action;if(typeof n=="string"&&n.trim())return[{name:n.trim(),args:$n(e)}];const t=e.tools??e.tool_calls??e.toolset??e.actions,r=Array.isArray(t)?t:Object.values(e).find(s=>Array.isArray(s))??[],i=[];for(const s of r)if(typeof s=="string")s.trim()&&i.push({name:s.trim(),args:{}});else if(s&&typeof s=="object"){const l=s,m=l.name??l.tool??l.id??l.function;typeof m=="string"&&m.trim()&&i.push({name:m.trim(),args:$n(l)})}return i}function Sr(e){if(!e)return!1;const n=e.done??e.finished??e.complete;return typeof n=="boolean"?n:typeof n=="string"?n.toLowerCase()==="true":!1}function Vn(e){const n=e.args.length?e.args.map(r=>`      ${r.name} (${r.type}) — ${r.description}`).join(`
`):"      (none)",t=e.documentation||e.label;return`${e.elementId}
    purpose: ${t}
    arguments:
${n}`}function Pr(e,n,t){const r=e.systemPrompt||"You are an agent driving a business process. Use the tools available to you.",i=t[0]??e.tools[0];if(t.length===0)return`${r}
...
character, with nothing added. When your work is finished, reply exactly
{"done": true} and no tool.`}function Ar(e,n,t,r,i=[],s=[],l=!1){const m=e.userPrompt||"Carry out your task.",p=Object.entries(n).filter(([,d])=>typeof d=="string"&&d.trim().length>0).map(([d,g])=>`  ${d}: ${String(g)}`),a=[m,p.length?`Case data:
${p.join(`
...
`)}async function Dr(e,n,t,r,i,s){let l="";n({kind:"llm",text:"LLM thinking…",key:t,pending:!0,turn:s});const m=await e(r,i,p=>{l+=p,n({kind:"llm",text:`${Tn(l)} ▍`,key:t,pending:!0,turn:s})});return n({kind:"llm",text:Tn(m||l)||"(empty reply)",key:t,pending:!1,turn:s}),m}function Cr(e,n){switch(e){case"number":return typeof n=="number"&&Number.isFinite(n)?{ok:!0,value:n}:typeof n=="string"&&n.trim()!==""&&Number.isFinite(Number(n))?{ok:!0,value:Number(n)}:{ok:!1};case"boolean":return typeof n=="boolean"?{ok:!0,value:n}:typeof n=="string"&&/^(true|false)$/i.test(n.trim())?{ok:!0,value:n.trim().toLowerCase()==="true"}:{ok:!1};default:return typeof n=="object"?{ok:!1}:{ok:!0,value:String(n)}}}function Br(e,n,t){const r={},i=new Map,s=new Map;for(const{tool:l,args:m}of e){const p={};for(const a of l.args){const d=m[a.name];if(!(d!=null&&d!=="")){n({kind:"error",text:`🤖 ${l.elementId}: model supplied no value for "${a.name}"`,turn:t,elementId:l.elementId});continue}const u=i.get(a.name);if(u!==void 0&&u!==l.elementId){n({kind:"error",text:`🤖 argument name collision on "${a.name}": both ${u} and ${l.elementId} declare it — ${u} already claimed it this turn, ${l.elementId}'s value is dropped`,turn:t,elementId:l.elementId});continue}const b=Cr(a.type,d);if(!b.ok){n({kind:"error",text:`🤖 ${l.elementId}: "${a.name}" is declared as ${a.type} but the model supplied ${JSON.stringify(d)} — rejected, not passed through`,turn:t,elementId:l.elementId});continue}r[a.name]=b.value,p[a.name]=b.value,i.set(a.name,l.elementId)}s.set(l.elementId,p)}return{variablesOut:r,forHistory:s}}function Lr(e,n,t,r={}){const{maxNewTokens:i=384,allowRepeats:s=!1,allowMultiToolTurns:l=!1,turnRef:m,requiredTools:p=[],maxEarlyDoneNudges:a=1}=r;let d=0;const g=new Set,u=[];let b=0,w=[],y=[];return async _=>{const M=_.variables,I=M.toolCallResult;for(I!==void 0&&u.length&&(u[u.length-1]=`${u[u.length-1]} → ${Tn(JSON.stringify(I),160)}`);;){const W=await C();if(W)return W}async function C(){if(d+=1,m&&(m.current=d),d>e.maxModelCalls)return t({kind:"error",text:`Turn budget spent (maxModelCalls=${e.maxModelCalls}) — completing the agent.`,turn:d}),{completionConditionFulfilled:!0};const W=s?e.tools:e.tools.filter(N=>!g.has(N.elementId)),Z=[{role:"system",content:Pr(e,l,W)},{role:"user",content:Ar(e,M,u,W,w,y,s)}];w=[],y=[];let ce;try{ce=await Dr(n,t,`llm-turn-${d}`,Z,i,d)}catch(N){return t({kind:"error",text:`LLM call failed: ${N instanceof Error?N.message:String(N)} — completing the agent.`,turn:d}),{completionConditionFulfilled:!0}}const ee=jr(ce);if(Sr(ee)&&Gn(ee).length===0){const N=p.filter(Y=>!g.has(Y));return N.length&&b<a?(b+=1,w=N,t({kind:"agent",text:`🤖 model says it is done, but ${N.join(", ")} hasn't run — asking once more`,turn:d}),null):(t({kind:"agent",text:"🤖 model says it is done",turn:d}),{completionConditionFulfilled:!0})}const se=Gn(ee);if(se.length===0)return t({kind:"error",text:"🤖 model named no tool (and didn't say it was done) — asking again",turn:d}),y=['it named no tool and did not say it was done — reply with {"tool": "...", "arguments": {...}} or {"done": true}'],null;const V=[],ne=[],ge=[];for(const N of se){const Y=e.tools.find(U=>U.elementId===N.name);if(!Y){ne.push(N.name);continue}if(!s&&g.has(Y.elementId)){ge.push(Y.elementId);continue}V.push({tool:Y,args:N.args})}if(ne.length&&t({kind:"error",text:`🤖 model named a tool that doesn't exist: ${ne.join(", ")} — nothing activated`,turn:d}),ge.length&&t({kind:"error",text:`🤖 model asked to re-run ${ge.join(", ")} — skipped (already run)`,turn:d}),V.length===0)return t({kind:"agent",text:"🤖 nothing activated — asking again",turn:d}),y=[...ne.length?[`${ne.join(", ")} ${ne.length===1?"is":"are"} not a real tool`]:[],...ge.length?[`${ge.join(", ")} has already run and will never run again — pick a different tool, or reply {"done": true} if nothing is left to do`]:[]],null;const{variablesOut:S,forHistory:E}=Br(V,t,d);for(const{tool:N}of V)g.add(N.elementId),u.push(`- ${N.elementId}(${JSON.stringify(E.get(N.elementId))})`);for(const{tool:N}of V)t({kind:"agent",text:`🤖 calling ${N.elementId}`,turn:d,elementId:N.elementId,args:E.get(N.elementId)??{}});return{activateElements:V.map(N=>({elementId:N.tool.elementId})),variables:S}}}}function Rr(e,n,t,r={}){const i=new Map(e.map(s=>[s.elementId,Lr(s,n,t,r)]));return async s=>{const l=i.get(s.elementId);if(!l)throw new Error(`No agent host registered for "${s.elementId}"`);return l(s)}}class jn{__destroy_into_raw(){const n=this.__wbg_ptr;return this.__wbg_ptr=0,Yn.unregister(this),n}free(){const n=this.__destroy_into_raw();c.__wbg_testengine_free(n,0)}activateJobs(n,t,r,i){let s,l;try{const b=c.__wbindgen_add_to_stack_pointer(-16),w=P(n,c.__wbindgen_export,c.__wbindgen_export2),y=j,_=P(i,c.__wbindgen_export,c.__wbindgen_export2),M=j;c.testengine_activateJobs(b,this.__wbg_ptr,w,y,t,r,_,M);var m=f().getInt32(b+0,!0),p=f().getInt32(b+4,!0),a=f().getInt32(b+8,!0),d=f().getInt32(b+12,!0),g=m,u=p;if(d)throw g=0,u=0,F(a);return s=g,l=u,L(g,u)}finally{c.__wbindgen_add_to_stack_pointer(16),c.__wbindgen_export3(s,l,1)}}advanceTime(n){let t,r;try{const d=c.__wbindgen_add_to_stack_pointer(-16);c.testengine_advanceTime(d,this.__wbg_ptr,n);var i=f().getInt32(d+0,!0),s=f().getInt32(d+4,!0),l=f().getInt32(d+8,!0),m=f().getInt32(d+12,!0),p=i,a=s;if(m)throw p=0,a=0,F(l);return t=p,r=a,L(p,a)}finally{c.__wbindgen_add_to_stack_pointer(16),c.__wbindgen_export3(t,r,1)}}assignUserTask(n,t,r){let i,s;try{const u=c.__wbindgen_add_to_stack_pointer(-16),b=P(n,c.__wbindgen_export,c.__wbindgen_export2),w=j,y=P(t,c.__wbindgen_export,c.__wbindgen_export2),_=j;c.testengine_assignUserTask(u,this.__wbg_ptr,b,w,y,_,r);var l=f().getInt32(u+0,!0),m=f().getInt32(u+4,!0),p=f().getInt32(u+8,!0),a=f().getInt32(u+12,!0),d=l,g=m;if(a)throw d=0,g=0,F(p);return i=d,s=g,L(d,g)}finally{c.__wbindgen_add_to_stack_pointer(16),c.__wbindgen_export3(i,s,1)}}broadcastSignal(n,t){let r,i;try{const g=c.__wbindgen_add_to_stack_pointer(-16),u=P(n,c.__wbindgen_export,c.__wbindgen_export2),b=j,w=P(t,c.__wbindgen_export,c.__wbindgen_export2),y=j;c.testengine_broadcastSignal(g,this.__wbg_ptr,u,b,w,y);var s=f().getInt32(g+0,!0),l=f().getInt32(g+4,!0),m=f().getInt32(g+8,!0),p=f().getInt32(g+12,!0),a=s,d=l;if(p)throw a=0,d=0,F(m);return r=a,i=d,L(a,d)}finally{c.__wbindgen_add_to_stack_pointer(16),c.__wbindgen_export3(r,i,1)}}cancelInstance(n){let t,r;try{const d=c.__wbindgen_add_to_stack_pointer(-16),g=P(n,c.__wbindgen_export,c.__wbindgen_export2),u=j;c.testengine_cancelInstance(d,this.__wbg_ptr,g,u);var i=f().getInt32(d+0,!0),s=f().getInt32(d+4,!0),l=f().getInt32(d+8,!0),m=f().getInt32(d+12,!0),p=i,a=s;if(m)throw p=0,a=0,F(l);return t=p,r=a,L(p,a)}finally{c.__wbindgen_add_to_stack_pointer(16),c.__wbindgen_export3(t,r,1)}}completeAgentJob(n,t,r){let i,s;try{const u=c.__wbindgen_add_to_stack_pointer(-16),b=P(n,c.__wbindgen_export,c.__wbindgen_export2),w=j,y=P(t,c.__wbindgen_export,c.__wbindgen_export2),_=j,M=P(r,c.__wbindgen_export,c.__wbindgen_export2),I=j;c.testengine_completeAgentJob(u,this.__wbg_ptr,b,w,y,_,M,I);var l=f().getInt32(u+0,!0),m=f().getInt32(u+4,!0),p=f().getInt32(u+8,!0),a=f().getInt32(u+12,!0),d=l,g=m;if(a)throw d=0,g=0,F(p);return i=d,s=g,L(d,g)}finally{c.__wbindgen_add_to_stack_pointer(16),c.__wbindgen_export3(i,s,1)}}completeJob(n,t){let r,i;try{const g=c.__wbindgen_add_to_stack_pointer(-16),u=P(n,c.__wbindgen_export,c.__wbindgen_export2),b=j,w=P(t,c.__wbindgen_export,c.__wbindgen_export2),y=j;c.testengine_completeJob(g,this.__wbg_ptr,u,b,w,y);var s=f().getInt32(g+0,!0),l=f().getInt32(g+4,!0),m=f().getInt32(g+8,!0),p=f().getInt32(g+12,!0),a=s,d=l;if(p)throw a=0,d=0,F(m);return r=a,i=d,L(a,d)}finally{c.__wbindgen_add_to_stack_pointer(16),c.__wbindgen_export3(r,i,1)}}completeUserTask(n,t){let r,i;try{const g=c.__wbindgen_add_to_stack_pointer(-16),u=P(n,c.__wbindgen_export,c.__wbindgen_export2),b=j,w=P(t,c.__wbindgen_export,c.__wbindgen_export2),y=j;c.testengine_completeUserTask(g,this.__wbg_ptr,u,b,w,y);var s=f().getInt32(g+0,!0),l=f().getInt32(g+4,!0),m=f().getInt32(g+8,!0),p=f().getInt32(g+12,!0),a=s,d=l;if(p)throw a=0,d=0,F(m);return r=a,i=d,L(a,d)}finally{c.__wbindgen_add_to_stack_pointer(16),c.__wbindgen_export3(r,i,1)}}correlateMessage(n,t,r){let i,s;try{const u=c.__wbindgen_add_to_stack_pointer(-16),b=P(n,c.__wbindgen_export,c.__wbindgen_export2),w=j,y=P(t,c.__wbindgen_export,c.__wbindgen_export2),_=j,M=P(r,c.__wbindgen_export,c.__wbindgen_export2),I=j;c.testengine_correlateMessage(u,this.__wbg_ptr,b,w,y,_,M,I);var l=f().getInt32(u+0,!0),m=f().getInt32(u+4,!0),p=f().getInt32(u+8,!0),a=f().getInt32(u+12,!0),d=l,g=m;if(a)throw d=0,g=0,F(p);return i=d,s=g,L(d,g)}finally{c.__wbindgen_add_to_stack_pointer(16),c.__wbindgen_export3(i,s,1)}}createInstance(n,t,r){let i,s;try{const u=c.__wbindgen_add_to_stack_pointer(-16),b=P(n,c.__wbindgen_export,c.__wbindgen_export2),w=j,y=P(t,c.__wbindgen_export,c.__wbindgen_export2),_=j;c.testengine_createInstance(u,this.__wbg_ptr,b,w,y,_,$r(r)?Number.MAX_SAFE_INTEGER:r>>0);var l=f().getInt32(u+0,!0),m=f().getInt32(u+4,!0),p=f().getInt32(u+8,!0),a=f().getInt32(u+12,!0),d=l,g=m;if(a)throw d=0,g=0,F(p);return i=d,s=g,L(d,g)}finally{c.__wbindgen_add_to_stack_pointer(16),c.__wbindgen_export3(i,s,1)}}debugClear(){c.testengine_debugClear(this.__wbg_ptr)}debugCreateInstance(n,t,r){let i,s;try{const u=c.__wbindgen_add_to_stack_pointer(-16),b=P(n,c.__wbindgen_export,c.__wbindgen_export2),w=j,y=P(t,c.__wbindgen_export,c.__wbindgen_export2),_=j,M=P(r,c.__wbindgen_export,c.__wbindgen_export2),I=j;c.testengine_debugCreateInstance(u,this.__wbg_ptr,b,w,y,_,M,I);var l=f().getInt32(u+0,!0),m=f().getInt32(u+4,!0),p=f().getInt32(u+8,!0),a=f().getInt32(u+12,!0),d=l,g=m;if(a)throw d=0,g=0,F(p);return i=d,s=g,L(d,g)}finally{c.__wbindgen_add_to_stack_pointer(16),c.__wbindgen_export3(i,s,1)}}get debugIsPaused(){return c.testengine_debugIsPaused(this.__wbg_ptr)!==0}debugResume(){let n,t;try{const a=c.__wbindgen_add_to_stack_pointer(-16);c.testengine_debugResume(a,this.__wbg_ptr);var r=f().getInt32(a+0,!0),i=f().getInt32(a+4,!0),s=f().getInt32(a+8,!0),l=f().getInt32(a+12,!0),m=r,p=i;if(l)throw m=0,p=0,F(s);return n=m,t=p,L(m,p)}finally{c.__wbindgen_add_to_stack_pointer(16),c.__wbindgen_export3(n,t,1)}}debugStep(){let n,t;try{const a=c.__wbindgen_add_to_stack_pointer(-16);c.testengine_debugStep(a,this.__wbg_ptr);var r=f().getInt32(a+0,!0),i=f().getInt32(a+4,!0),s=f().getInt32(a+8,!0),l=f().getInt32(a+12,!0),m=r,p=i;if(l)throw m=0,p=0,F(s);return n=m,t=p,L(m,p)}finally{c.__wbindgen_add_to_stack_pointer(16),c.__wbindgen_export3(n,t,1)}}deploy(n){let t,r;try{const d=c.__wbindgen_add_to_stack_pointer(-16),g=P(n,c.__wbindgen_export,c.__wbindgen_export2),u=j;c.testengine_deploy(d,this.__wbg_ptr,g,u);var i=f().getInt32(d+0,!0),s=f().getInt32(d+4,!0),l=f().getInt32(d+8,!0),m=f().getInt32(d+12,!0),p=i,a=s;if(m)throw p=0,a=0,F(l);return t=p,r=a,L(p,a)}finally{c.__wbindgen_add_to_stack_pointer(16),c.__wbindgen_export3(t,r,1)}}deployForm(n){let t,r;try{const d=c.__wbindgen_add_to_stack_pointer(-16),g=P(n,c.__wbindgen_export,c.__wbindgen_export2),u=j;c.testengine_deployForm(d,this.__wbg_ptr,g,u);var i=f().getInt32(d+0,!0),s=f().getInt32(d+4,!0),l=f().getInt32(d+8,!0),m=f().getInt32(d+12,!0),p=i,a=s;if(m)throw p=0,a=0,F(l);return t=p,r=a,L(p,a)}finally{c.__wbindgen_add_to_stack_pointer(16),c.__wbindgen_export3(t,r,1)}}deployResource(n,t){let r,i;try{const g=c.__wbindgen_add_to_stack_pointer(-16),u=P(n,c.__wbindgen_export,c.__wbindgen_export2),b=j,w=P(t,c.__wbindgen_export,c.__wbindgen_export2),y=j;c.testengine_deployResource(g,this.__wbg_ptr,u,b,w,y);var s=f().getInt32(g+0,!0),l=f().getInt32(g+4,!0),m=f().getInt32(g+8,!0),p=f().getInt32(g+12,!0),a=s,d=l;if(p)throw a=0,d=0,F(m);return r=a,i=d,L(a,d)}finally{c.__wbindgen_add_to_stack_pointer(16),c.__wbindgen_export3(r,i,1)}}events(){let n,t;try{const a=c.__wbindgen_add_to_stack_pointer(-16);c.testengine_events(a,this.__wbg_ptr);var r=f().getInt32(a+0,!0),i=f().getInt32(a+4,!0),s=f().getInt32(a+8,!0),l=f().getInt32(a+12,!0),m=r,p=i;if(l)throw m=0,p=0,F(s);return n=m,t=p,L(m,p)}finally{c.__wbindgen_add_to_stack_pointer(16),c.__wbindgen_export3(n,t,1)}}failJob(n,t,r){let i,s;try{const u=c.__wbindgen_add_to_stack_pointer(-16),b=P(n,c.__wbindgen_export,c.__wbindgen_export2),w=j,y=P(r,c.__wbindgen_export,c.__wbindgen_export2),_=j;c.testengine_failJob(u,this.__wbg_ptr,b,w,t,y,_);var l=f().getInt32(u+0,!0),m=f().getInt32(u+4,!0),p=f().getInt32(u+8,!0),a=f().getInt32(u+12,!0),d=l,g=m;if(a)throw d=0,g=0,F(p);return i=d,s=g,L(d,g)}finally{c.__wbindgen_add_to_stack_pointer(16),c.__wbindgen_export3(i,s,1)}}migrate(n,t,r){let i,s;try{const u=c.__wbindgen_add_to_stack_pointer(-16),b=P(n,c.__wbindgen_export,c.__wbindgen_export2),w=j,y=P(t,c.__wbindgen_export,c.__wbindgen_export2),_=j,M=P(r,c.__wbindgen_export,c.__wbindgen_export2),I=j;c.testengine_migrate(u,this.__wbg_ptr,b,w,y,_,M,I);var l=f().getInt32(u+0,!0),m=f().getInt32(u+4,!0),p=f().getInt32(u+8,!0),a=f().getInt32(u+12,!0),d=l,g=m;if(a)throw d=0,g=0,F(p);return i=d,s=g,L(d,g)}finally{c.__wbindgen_add_to_stack_pointer(16),c.__wbindgen_export3(i,s,1)}}modify(n,t,r){let i,s;try{const u=c.__wbindgen_add_to_stack_pointer(-16),b=P(n,c.__wbindgen_export,c.__wbindgen_export2),w=j,y=P(t,c.__wbindgen_export,c.__wbindgen_export2),_=j,M=P(r,c.__wbindgen_export,c.__wbindgen_export2),I=j;c.testengine_modify(u,this.__wbg_ptr,b,w,y,_,M,I);var l=f().getInt32(u+0,!0),m=f().getInt32(u+4,!0),p=f().getInt32(u+8,!0),a=f().getInt32(u+12,!0),d=l,g=m;if(a)throw d=0,g=0,F(p);return i=d,s=g,L(d,g)}finally{c.__wbindgen_add_to_stack_pointer(16),c.__wbindgen_export3(i,s,1)}}constructor(){const n=c.testengine_new();return this.__wbg_ptr=n,Yn.register(this,this.__wbg_ptr,this),this}get now(){return c.testengine_now(this.__wbg_ptr)}reset(){c.testengine_reset(this.__wbg_ptr)}resolveIncident(n){let t,r;try{const d=c.__wbindgen_add_to_stack_pointer(-16),g=P(n,c.__wbindgen_export,c.__wbindgen_export2),u=j;c.testengine_resolveIncident(d,this.__wbg_ptr,g,u);var i=f().getInt32(d+0,!0),s=f().getInt32(d+4,!0),l=f().getInt32(d+8,!0),m=f().getInt32(d+12,!0),p=i,a=s;if(m)throw p=0,a=0,F(l);return t=p,r=a,L(p,a)}finally{c.__wbindgen_add_to_stack_pointer(16),c.__wbindgen_export3(t,r,1)}}setVariables(n,t,r){let i,s;try{const u=c.__wbindgen_add_to_stack_pointer(-16),b=P(n,c.__wbindgen_export,c.__wbindgen_export2),w=j,y=P(t,c.__wbindgen_export,c.__wbindgen_export2),_=j;c.testengine_setVariables(u,this.__wbg_ptr,b,w,y,_,r);var l=f().getInt32(u+0,!0),m=f().getInt32(u+4,!0),p=f().getInt32(u+8,!0),a=f().getInt32(u+12,!0),d=l,g=m;if(a)throw d=0,g=0,F(p);return i=d,s=g,L(d,g)}finally{c.__wbindgen_add_to_stack_pointer(16),c.__wbindgen_export3(i,s,1)}}snapshot(){let n,t;try{const a=c.__wbindgen_add_to_stack_pointer(-16);c.testengine_snapshot(a,this.__wbg_ptr);var r=f().getInt32(a+0,!0),i=f().getInt32(a+4,!0),s=f().getInt32(a+8,!0),l=f().getInt32(a+12,!0),m=r,p=i;if(l)throw m=0,p=0,F(s);return n=m,t=p,L(m,p)}finally{c.__wbindgen_add_to_stack_pointer(16),c.__wbindgen_export3(n,t,1)}}throwError(n,t,r){let i,s;try{const u=c.__wbindgen_add_to_stack_pointer(-16),b=P(n,c.__wbindgen_export,c.__wbindgen_export2),w=j,y=P(t,c.__wbindgen_export,c.__wbindgen_export2),_=j,M=P(r,c.__wbindgen_export,c.__wbindgen_export2),I=j;c.testengine_throwError(u,this.__wbg_ptr,b,w,y,_,M,I);var l=f().getInt32(u+0,!0),m=f().getInt32(u+4,!0),p=f().getInt32(u+8,!0),a=f().getInt32(u+12,!0),d=l,g=m;if(a)throw d=0,g=0,F(p);return i=d,s=g,L(d,g)}finally{c.__wbindgen_add_to_stack_pointer(16),c.__wbindgen_export3(i,s,1)}}tickNow(n){let t,r;try{const d=c.__wbindgen_add_to_stack_pointer(-16);c.testengine_tickNow(d,this.__wbg_ptr,n);var i=f().getInt32(d+0,!0),s=f().getInt32(d+4,!0),l=f().getInt32(d+8,!0),m=f().getInt32(d+12,!0),p=i,a=s;if(m)throw p=0,a=0,F(l);return t=p,r=a,L(p,a)}finally{c.__wbindgen_add_to_stack_pointer(16),c.__wbindgen_export3(t,r,1)}}unassignUserTask(n){let t,r;try{const d=c.__wbindgen_add_to_stack_pointer(-16),g=P(n,c.__wbindgen_export,c.__wbindgen_export2),u=j;c.testengine_unassignUserTask(d,this.__wbg_ptr,g,u);var i=f().getInt32(d+0,!0),s=f().getInt32(d+4,!0),l=f().getInt32(d+8,!0),m=f().getInt32(d+12,!0),p=i,a=s;if(m)throw p=0,a=0,F(l);return t=p,r=a,L(p,a)}finally{c.__wbindgen_add_to_stack_pointer(16),c.__wbindgen_export3(t,r,1)}}updateRetries(n,t){let r,i;try{const g=c.__wbindgen_add_to_stack_pointer(-16),u=P(n,c.__wbindgen_export,c.__wbindgen_export2),b=j;c.testengine_updateRetries(g,this.__wbg_ptr,u,b,t);var s=f().getInt32(g+0,!0),l=f().getInt32(g+4,!0),m=f().getInt32(g+8,!0),p=f().getInt32(g+12,!0),a=s,d=l;if(p)throw a=0,d=0,F(m);return r=a,i=d,L(a,d)}finally{c.__wbindgen_add_to_stack_pointer(16),c.__wbindgen_export3(r,i,1)}}updateUserTask(n,t){let r,i;try{const g=c.__wbindgen_add_to_stack_pointer(-16),u=P(n,c.__wbindgen_export,c.__wbindgen_export2),b=j,w=P(t,c.__wbindgen_export,c.__wbindgen_export2),y=j;c.testengine_updateUserTask(g,this.__wbg_ptr,u,b,w,y);var s=f().getInt32(g+0,!0),l=f().getInt32(g+4,!0),m=f().getInt32(g+8,!0),p=f().getInt32(g+12,!0),a=s,d=l;if(p)throw a=0,d=0,F(m);return r=a,i=d,L(a,d)}finally{c.__wbindgen_add_to_stack_pointer(16),c.__wbindgen_export3(r,i,1)}}}Symbol.dispose&&(jn.prototype[Symbol.dispose]=jn.prototype.free);function Fr(){return{__proto__:null,"./nanobpmn_engine_bg.js":{__proto__:null,__wbg___wbindgen_throw_bb96b2010945f0bc:function(n,t){throw new Error(L(n,t))},__wbindgen_cast_0000000000000001:function(n,t){const r=L(n,t);return zr(r)},__wbindgen_object_drop_ref:function(n){F(n)}}}}const Yn=typeof FinalizationRegistry>"u"?{register:()=>{},unregister:()=>{}}:new FinalizationRegistry(e=>c.__wbg_testengine_free(e,1));function zr(e){Ze===je.length&&je.push(je.length+1);const n=Ze;return Ze=je[n],je[n]=e,n}function Or(e){e<1028||(je[e]=Ze,Ze=e)}let Fe=null;function f(){return(Fe===null||Fe.buffer.detached===!0||Fe.buffer.detached===void 0&&Fe.buffer!==c.memory.buffer)&&(Fe=new DataView(c.memory.buffer)),Fe}function L(e,n){return Vr(e>>>0,n)}let We=null;function dn(){return(We===null||We.byteLength===0)&&(We=new Uint8Array(c.memory.buffer)),We}function Ur(e){return je[e]}let je=new Array(1024).fill(void 0);je.push(void 0,null,!0,!1);let Ze=je.length;function $r(e){return e==null}function P(e,n,t){if(t===void 0){const m=Ke.encode(e),p=n(m.length,1)>>>0;return dn().subarray(p,p+m.length).set(m),j=m.length,p}let r=e.length,i=n(r,1)>>>0;const s=dn();let l=0;for(;l<r;l++){const m=e.charCodeAt(l);if(m>127)break;s[i+l]=m}if(l!==r){l!==0&&(e=e.slice(l)),i=t(i,r,r=l+e.length*3,1)>>>0;const m=dn().subarray(i+l,i+r),p=Ke.encodeInto(e,m);l+=p.written,i=t(i,r,l,1)>>>0}return j=l,i}function F(e){const n=Ur(e);return Or(e),n}let ln=new TextDecoder("utf-8",{ignoreBOM:!0,fatal:!0});ln.decode();const Gr=2146435072;let _n=0;function Vr(e,n){return _n+=n,_n>=Gr&&(ln=new TextDecoder("utf-8",{ignoreBOM:!0,fatal:!0}),ln.decode(),_n=n),ln.decode(dn().subarray(e,e+n))}const Ke=new TextEncoder;"encodeInto"in Ke||(Ke.encodeInto=function(e,n){const t=Ke.encode(e);return n.set(t),{read:e.length,written:t.length}});let j=0,c;function Yr(e,n){return c=e.exports,Fe=null,We=null,c}async function Qr(e,n){if(typeof Response=="function"&&e instanceof Response){if(!e.ok)throw new Error(`failed to fetch Wasm: ${e.status} ${e.statusText} fetching '${e.url}'`);if(typeof WebAssembly.instantiateStreaming=="function")try{return await WebAssembly.instantiateStreaming(e,n)}catch(i){if(t(e.type)&&e.headers.get("Content-Type")!=="application/wasm")console.warn("`WebAssembly.instantiateStreaming` failed because your server does not serve Wasm with `application/wasm` MIME type. Falling back to `WebAssembly.instantiate` which is slower. Original error:\n",i);else throw i}const r=await e.arrayBuffer();return await WebAssembly.instantiate(r,n)}else{const r=await WebAssembly.instantiate(e,n);return r instanceof WebAssembly.Instance?{instance:r,module:e}:r}function t(r){switch(r){case"basic":case"cors":case"default":return!0}return!1}}async function qr(e){if(c!==void 0)return c;e!==void 0&&(Object.getPrototypeOf(e)===Object.prototype?{module_or_path:e}=e:console.warn("using deprecated parameters for the initialization function; pass a single object instead")),e===void 0&&(e=new URL("/pr-preview/pr-99/assets/nanobpmn_engine_bg-DRNrIVE8.wasm",import.meta.url));const n=Fr();(typeof e=="string"||typeof Request=="function"&&e instanceof Request||typeof URL=="function"&&e instanceof URL)&&(e=fetch(e));const{instance:t,module:r}=await Qr(await e,n);return Yr(t)}let an=null;function Jr(e){return an||(an=qr(void 0).then(()=>{}).catch(n=>{throw an=null,n})),an}function X(e){return JSON.parse(e)}class Hr{constructor(n){O(this,"engine");this.engine=n}deploy(n){return JSON.parse(this.engine.deploy(n))}createInstance(n,t){return X(this.engine.createInstance(n,t||"{}"))}activateJobs(n,t,r,i){return JSON.parse(this.engine.activateJobs(n,t,r,i))}completeJob(n,t){return X(this.engine.completeJob(n,t||"{}"))}completeAgentJob(n,t){const{variables:r,...i}=t??{};return X(this.engine.completeAgentJob(n,JSON.stringify(r??{}),JSON.stringify(i??{})))}failJob(n,t,r){return X(this.engine.failJob(n,t,r))}throwError(n,t,r){return X(this.engine.throwError(n,t,r))}updateRetries(n,t){return X(this.engine.updateRetries(n,t))}resolveIncident(n){return X(this.engine.resolveIncident(n))}setVariables(n,t,r){return X(this.engine.setVariables(n,t||"{}",r))}broadcastSignal(n,t){return X(this.engine.broadcastSignal(n,t||"{}"))}cancelInstance(n){return X(this.engine.cancelInstance(n))}modify(n,t,r){return X(this.engine.modify(n,JSON.stringify(t??[]),JSON.stringify(r??[])))}completeUserTask(n,t){return X(this.engine.completeUserTask(n,t||"{}"))}assignUserTask(n,t,r){return X(this.engine.assignUserTask(n,t,r))}unassignUserTask(n){return X(this.engine.unassignUserTask(n))}updateUserTask(n,t){return X(this.engine.updateUserTask(n,t||"{}"))}correlateMessage(n,t,r){return X(this.engine.correlateMessage(n,t,r||"{}"))}advanceTime(n){return X(this.engine.advanceTime(n))}reset(){this.engine.reset()}events(){return JSON.parse(this.engine.events())}snapshot(){return X(this.engine.snapshot())}free(){this.engine.free()}}async function Wr(e){return await Jr(),new Hr(new jn)}class vt extends Error{constructor(t,r){super(t);O(this,"retries");this.name="JobFailure",this.retries=r==null?void 0:r.retries}}function Zr(e,n=[]){if(e.instances.filter(i=>!i.completed).length===0)return e.totalInstances>0?"completed":"idle";if(e.incidents.length>0)return"incidents";const r=new Set(n);return e.jobs.some(i=>!r.has(i.jobType))?"unhandledJobs":e.userTasks.some(i=>i.state==="Created")?"userTasks":e.timers.length>0?"timers":e.messageSubscriptions.length>0?"messages":e.signalSubscriptions.length>0?"signals":"idle"}function Kr(e,n=[]){const t=new Set(n);return[...new Set(e.jobs.map(r=>r.jobType))].filter(r=>!t.has(r)).sort()}async function Xr(e,n,t){let r;try{const i=await n(t);r=JSON.stringify(i??{})}catch(i){const s=i instanceof vt&&i.retries!==void 0?i.retries:Math.max(0,t.retries-1),l=i instanceof Error?i.message:String(i);e.failJob(t.key,s,l);return}e.completeJob(t.key,r)}async function ei(e,n,t){let r;try{r=await n(t),JSON.stringify(r)}catch(i){const s=i instanceof vt&&i.retries!==void 0?i.retries:Math.max(0,t.retries-1),l=i instanceof Error?i.message:String(i);e.failJob(t.key,s,l);return}e.completeAgentJob(t.key,r)}async function ni(e,n,t={}){const r=t.maxJobsPerActivation??10,i=t.lockTimeoutMs??3e4,s=t.worker??"bojtos",l=t.agents??{};for(const u of Object.keys(l))if(u in n)throw new Error(`dispatchRound: job type "${u}" is registered as both a worker and an agent — register it as exactly one`);const m=[];for(const[u,b]of Object.entries(n))for(const w of e.activateJobs(u,r,i,s))m.push({handler:b,job:w});const p=[];for(const[u,b]of Object.entries(l))for(const w of e.activateJobs(u,r,i,s))p.push({handler:b,job:w});for(const{handler:u,job:b}of m)await Xr(e,u,b);for(const{handler:u,job:b}of p)await ei(e,u,b);const a=e.snapshot(),d=m.length+p.length;if(d>0)return{snapshot:a,handled:d};const g=[...Object.keys(n),...Object.keys(l)];return{snapshot:a,handled:d,reason:Zr(a,g),unhandled:Kr(a,g)}}function ti({bpmn:e}){const n=h.useRef(null),[t,r]=h.useState("loading"),[i,s]=h.useState(null),[l,m]=h.useState([]),[p,a]=h.useState(null),d=h.useRef(e),g=h.useRef(0),u=h.useRef(new Map),b=h.useCallback((S,E)=>{u.current.set(S,E)},[]),w=h.useCallback(S=>u.current.get(S),[]),y=h.useCallback((S,E)=>{const N=S.deploy(E);return d.current=E,u.current.clear(),m(N.processIds),a(null),s(null),N.processIds},[]);h.useEffect(()=>{let S=!1;return r("loading"),m([]),a(null),s(null),Wr().then(E=>{if(S){E.free();return}try{y(E,e)}catch(N){E.free(),s(String(N)),r("error");return}n.current=E,r("ready")}).catch(E=>{S||(s(String(E)),r("error"))}),()=>{var E;S=!0,(E=n.current)==null||E.free(),n.current=null,u.current.clear()}},[e]);const _=h.useCallback(S=>{const E=n.current;if(!E)return null;try{const N=S(E);return a(N),s(null),N}catch(N){return s(String(N)),null}},[]),M=h.useCallback((S,E)=>_(N=>N.createInstance(S,E)),[_]),I=h.useCallback((S,E)=>_(N=>N.completeUserTask(S,E)),[_]),C=h.useCallback(S=>_(E=>E.advanceTime(S)),[_]),W=h.useCallback((S,E)=>_(N=>N.broadcastSignal(S,E)),[_]);function Z(S,E){const[N]=S.activateJobs(E,1,3e4,"manual-control");if(!N)throw new Error(`No waiting job of type "${E}" to resolve.`);return N}const ce=h.useCallback((S,E)=>_(N=>{const Y=Z(N,S);return N.completeJob(Y.key,E)}),[_]),ee=h.useCallback((S,E,N)=>_(Y=>{const U=Z(Y,S);return Y.throwError(U.key,E,N)}),[_]),se=h.useCallback((S,E,N)=>_(Y=>Y.correlateMessage(S,E,N)),[_]),V=h.useCallback(async(S,E)=>{const N=n.current;if(!N)return null;const Y=g.current;try{const U=await ni(N,S,E);return n.current!==N||g.current!==Y?null:(a(U.snapshot),s(null),U)}catch(U){return n.current!==N||g.current!==Y||(a(N.snapshot()),s(String(U))),null}},[]),ne=h.useCallback(()=>{const S=n.current;if(S){g.current++;try{S.reset(),y(S,d.current)}catch(E){s(String(E))}}},[y]),ge=h.useCallback(S=>{const E=n.current;if(!E)return null;g.current++;try{return E.reset(),y(E,S)}catch(N){return s(String(N)),null}},[y]);return{phase:t,error:i,processIds:l,snapshot:p,createInstance:M,stepWorkers:V,completeUserTask:I,advanceTime:C,broadcastSignal:W,completeJobManually:ce,throwJobError:ee,correlateMessage:se,reset:ne,redeploy:ge,setRunImage:b,getRunImage:w}}function ri(e,n){return e.slice(n)}function ii(e,n,t,r){const i=e.snapshot,s="⏸ waiting for a human — complete the task below to continue",l=i.userTasks.some(m=>m.state==="Created");if(e.handled>0){const m=i.activeElementIds.map(t),p=n.length?` via ${n.map(a=>`${t(a.from)} → ${t(a.to)}`).join(", ")}`:"";return i.completedInstances>=1?{kind:"done",text:`⏭ round handled ${e.handled} job${e.handled===1?"":"s"}${p} — ✅ process instance completed`}:l?{kind:"human",text:`⏭ round handled ${e.handled} job${e.handled===1?"":"s"}${p} — ${s}`}:{kind:"step",text:`⏭ round handled ${e.handled} job${e.handled===1?"":"s"}${p} — now at ${m.length?m.join(", "):"—"}`}}switch(e.reason){case"completed":return{kind:"done",text:"✅ process instance completed"};case"userTasks":return{kind:"human",text:s};case"timers":return{kind:"step",text:"⏱ waiting on a timer — advance the clock to continue"};case"messages":return{kind:"step",text:"✉ waiting on a message — correlate it to continue"};case"signals":return{kind:"step",text:"📶 waiting on a signal — broadcast it to continue"};case"incidents":return{kind:"error",text:"A job failed — incident on the diagram"};case"unhandledJobs":{const m=e.unhandled??[];return r&&m.length>0&&m.every(p=>r.has(p))?{kind:"human",text:s}:{kind:"error",text:`⏭ waiting on job type(s) with no worker registered: ${m.join(", ")}`}}case"idle":return{kind:"step",text:"Nothing to step — no instance is running."};default:return{kind:"step",text:e.reason?`Step blocked on an unrecognized reason: ${e.reason}`:"Nothing to step — no instance is running."}}}const oi="the Scripted or Endpoint brain";async function ai(){return await en()===null}async function en(e=oi){const n=navigator.gpu;if(!n)return`This browser doesn't expose WebGPU at all. Use a recent Chrome, Edge, or Safari 17+ with hardware acceleration on, or pick ${e}.`;let t;try{t=await n.requestAdapter()}catch(r){return`WebGPU adapter request failed (${r instanceof Error?r.message:String(r)}). Try ${e} instead.`}return t?null:`This browser supports the WebGPU API, but no GPU adapter is available — hardware acceleration may be off, or this device/VM has no usable GPU. Pick ${e} instead.`}const si=[{id:"Qwen2.5-1.5B-Instruct-q4f16_1-MLC",label:"Qwen2.5 1.5B",downloadLabel:"~1.0 GB"},{id:"SmolLM2-1.7B-Instruct-q4f16_1-MLC",label:"SmolLM2 1.7B",downloadLabel:"~1.1 GB"},{id:"Llama-3.2-1B-Instruct-q4f16_1-MLC",label:"Llama 3.2 1B",downloadLabel:"~0.7 GB"},{id:"gemma-2-2b-it-q4f16_1-MLC",label:"Gemma 2 2B",downloadLabel:"~1.5 GB"},{id:"Llama-3.2-1B-Instruct-q4f32_1-MLC",label:"Llama 3.2 1B (f32, wider GPU support)",downloadLabel:"~1.1 GB"},{id:"SmolLM2-360M-Instruct-q4f32_1-MLC",label:"SmolLM2 360M (tiny, f32)",downloadLabel:"~0.6 GB"},{id:"SmolLM2-360M-Instruct-q4f16_1-MLC",label:"SmolLM2 360M (tiny)",downloadLabel:"~0.3 GB"}];function Mt(e){return Sn.get(e)??{}}const Sn=new Map;async function di(){if(Sn.size>0)return;const{prebuiltAppConfig:e}=await _e(async()=>{const{prebuiltAppConfig:n}=await import("./vendor-webllm-DT0Ab8E6.js");return{prebuiltAppConfig:n}},[]);for(const n of e.model_list)Sn.set(n.model_id,{vramRequiredMB:n.vram_required_MB,requiredFeatures:n.required_features})}const pn=si.map(e=>({id:e.id,label:`${e.label} (${e.downloadLabel})`,downloadLabel:e.downloadLabel,...Mt(e.id)})),xt=pn[0].id;async function li(){return await di(),pn.map(e=>({...e,...Mt(e.id)}))}function Nt(){const e=navigator.deviceMemory;return typeof e=="number"?e*1024:null}function ci(e,n=Nt()){return n==null||e.vramRequiredMB==null||n>=e.vramRequiredMB?null:`${e.label} needs roughly ${Math.round(e.vramRequiredMB)} MB of GPU memory; this device looks like it has about ${Math.round(n)} MB available. It may still work, but expect it to fail or fall back to slow shared memory — try a smaller model (e.g. SmolLM2 360M) if it doesn't load.`}async function mi(e){try{const{hasModelInCache:n}=await _e(async()=>{const{hasModelInCache:t}=await import("./vendor-webllm-DT0Ab8E6.js");return{hasModelInCache:t}},[]);return await n(e)}catch{return!1}}function cn(e){return/device (was )?lost|device_hung|device_removed|already been disposed|gpudevicelostinfo/i.test(e)}function Qn(){return"The GPU device was lost — the driver reset while the model was loading or running. This is a browser/driver-level failure, not a problem with the model: fully quit and reopen the browser (a lost device usually persists for the life of the GPU process), check chrome://gpu still reports hardware acceleration, and update your GPU driver if it recurs. The Scripted and Endpoint brains don't use the GPU at all."}class sn{constructor(){O(this,"kind","browser");O(this,"model",null);O(this,"engine",null);O(this,"worker",null);O(this,"generation",0);O(this,"chat",async(n,t=512,r)=>{var s,l;const i=this.engine;if(!i||!this.model)throw new Error("BrowserBrain.chat called before connect()");try{const m=await i.chat.completions.create({messages:n,temperature:0,max_tokens:t,stream:!0});let p="";for await(const a of m){const d=((l=(s=a.choices[0])==null?void 0:s.delta)==null?void 0:l.content)??"";d&&(p+=d,r==null||r(d))}return p}catch(m){const p=m instanceof Error?m.message:String(m);throw cn(p)?(this.teardown(),new Error(`The in-browser model stopped: ${Qn()}`)):m}})}async connect(n=xt,t){var p,a;const r=await en();if(r)throw new Error(r);if(this.engine&&this.model===n)return n;const i=++this.generation,s=d=>{i===this.generation&&(t==null||t({progress:d.progress??0,text:d.text??""}))};this.teardown();let l,m;try{const{CreateWebWorkerMLCEngine:d}=await _e(async()=>{const{CreateWebWorkerMLCEngine:g}=await import("./vendor-webllm-DT0Ab8E6.js");return{CreateWebWorkerMLCEngine:g}},[]);m=new Worker(new URL("/pr-preview/pr-99/assets/webllm.worker-Dc1cCqhL.js",import.meta.url),{type:"module"}),l=await d(m,n,{initProgressCallback:s})}catch(d){if(m==null||m.terminate(),i!==this.generation)throw new Error("cancelled");const g=d instanceof Error?d.message:String(d);if(cn(g))throw new Error(`Couldn't load ${n} in the browser (${g}). ${Qn()}`);const u=(a=(p=pn.find(b=>b.id===n))==null?void 0:p.requiredFeatures)==null?void 0:a.includes("shader-f16");throw new Error(`Couldn't load ${n} in the browser (${g}). `+(u?"This model needs WebGPU with shader-f16; try one of the f32 models in the list, or the endpoint brain.":"Try a smaller model, check your connection, or use the endpoint brain instead."))}if(i!==this.generation)throw l.unload().catch(()=>{}),m==null||m.terminate(),new Error("cancelled");return this.engine=l,this.worker=m??null,this.model=n,n}teardown(){const{engine:n,worker:t}=this;this.engine=null,this.worker=null,this.model=null,n==null||n.unload().catch(()=>{}),t==null||t.terminate()}cancelConnect(){this.generation++}dispose(){this.generation++,this.teardown()}}const Et="http://localhost:11434/v1";function kt(){var n;const e=((n=globalThis.location)==null?void 0:n.hostname)??"";return e==="localhost"||e==="127.0.0.1"||e==="[::1]"||e==="::1"}function mn(e,n={hostname:(t=>(t=globalThis.location)==null?void 0:t.hostname)()??"",origin:(r=>(r=globalThis.location)==null?void 0:r.origin)()??""}){let i;try{i=new URL(It(e)).hostname}catch{return null}const s=l=>l==="localhost"||l==="127.0.0.1"||l==="::1"||l==="[::1]";return!s(i)||s(n.hostname)?null:`This page is served from ${n.origin||"a non-local origin"}, so it can't reach ${e}. A local model server only accepts requests from a page on localhost. Open this page at http://localhost instead, or use the Scripted or In-browser brain.`}function It(e){let n=e.trim().replace(/\/+$/,"");return n.endsWith("/chat/completions")&&(n=n.slice(0,-17)),/\/v\d+$/.test(n)||(n=`${n}/v1`),n}class qn extends Error{constructor(n,t){super(n),this.status=t,this.name="HttpError"}}class Jn{constructor(n=Et,t="",r=""){O(this,"kind","endpoint");O(this,"baseUrl");O(this,"model",null);O(this,"models",[]);O(this,"apiKey");O(this,"requestedModel");O(this,"chat",async(n,t=512,r)=>{var a,d,g;if(!this.model)throw new Error("EndpointBrain.chat called before connect()");const i=await fetch(`${this.baseUrl}/chat/completions`,{method:"POST",headers:this.headers(),body:JSON.stringify({model:this.model,messages:n,temperature:0,max_tokens:t,stream:!0})});if(!i.ok||!i.body){const u=await i.text().catch(()=>"");throw new Error(`chat/completions HTTP ${i.status} ${i.statusText}${u?` — ${u.slice(0,300)}`:""}`)}const s=i.body.getReader(),l=new TextDecoder;let m="",p="";for(;;){const{value:u,done:b}=await s.read();if(b)break;m+=l.decode(u,{stream:!0});let w;for(;(w=m.indexOf(`
`))>=0;){const y=m.slice(0,w).trim();if(m=m.slice(w+1),!y.startsWith("data:"))continue;const _=y.slice(5).trim();if(_==="[DONE]")continue;let M;try{M=JSON.parse(_)}catch{continue}M.model&&(this.model=M.model);const I=(a=M.choices)==null?void 0:a[0],C=((d=I==null?void 0:I.delta)==null?void 0:d.content)??((g=I==null?void 0:I.message)==null?void 0:g.content)??"";C&&(p+=C,r==null||r(C))}}return p});this.baseUrl=It(n),this.apiKey=t.trim(),this.requestedModel=r.trim()}headers(){const n={"Content-Type":"application/json"};return this.apiKey&&(n.Authorization=`Bearer ${this.apiKey}`),n}async listModels(){let n;try{n=await fetch(`${this.baseUrl}/models`,{headers:this.headers()})}catch(r){const i=mn(this.baseUrl);throw new Error(i??`Can't reach ${this.baseUrl} (${r instanceof Error?r.message:String(r)}). Is the server running? For Ollama, check the app is up — and if this page is served from another origin, allow it with OLLAMA_ORIGINS.`)}if(!n.ok)throw new qn(`${this.baseUrl}/models returned HTTP ${n.status} ${n.statusText}`,n.status);const t=await n.json();return this.models=(t.data??[]).map(r=>r.id).filter(r=>!!r),this.models}async connect(){try{const n=await this.listModels(),t=this.requestedModel||n[0];if(!t)throw new Error(`No models available at ${this.baseUrl}. Pull one first — e.g. \`ollama pull llama3.2:3b\` — or name one explicitly.`);this.model=t}catch(n){const t=n instanceof qn&&[404,405,501].includes(n.status);if(!this.requestedModel||!t)throw n;this.models=[],this.model=this.requestedModel}return await this.validate(),this.model}async validate(){const n=await fetch(`${this.baseUrl}/chat/completions`,{method:"POST",headers:this.headers(),body:JSON.stringify({model:this.model,messages:[{role:"user",content:"Reply with ok."}],temperature:0,max_tokens:1,stream:!1})}).catch(r=>{throw new Error(`Can't reach ${this.baseUrl}/chat/completions (${r instanceof Error?r.message:String(r)}). Check the endpoint URL, API key, model name, and any local CORS settings.`)});if(!n.ok){const r=await n.text().catch(()=>"");throw new Error(`chat/completions HTTP ${n.status} ${n.statusText}${r?` — ${r.slice(0,300)}`:""}`)}const t=await n.json().catch(()=>({}));t.model&&(this.model=t.model)}dispose(){}}const pi=[{id:"onnx-community/Florence-2-base-ft",label:"Florence-2 base",downloadLabel:"~0.4 GB"},{id:"onnx-community/Florence-2-large-ft",label:"Florence-2 large (higher quality)",downloadLabel:"~1.6 GB"}],Tt=pi.map(e=>({...e,label:`${e.label} (${e.downloadLabel})`})),jt=Tt[0].id,ui="<OCR>",Hn="UNKNOWN (scripted brain — connect the in-browser model to read a photo)";function gi(e,n){if(e)return typeof e=="function"?e(n):e[n]}class hi{constructor(n){O(this,"kind","scripted-vision");O(this,"model",null);O(this,"read",async(n,t,r)=>{const i=typeof n=="string"?gi(this.lookup,n)??Hn:Hn;return r==null||r(i),i});this.lookup=n}dispose(){}}function bi(e){return new hi(e)}class Wn{constructor(){O(this,"kind","browser-vision");O(this,"model",null);O(this,"modelHandle",null);O(this,"processor",null);O(this,"loadImage",null);O(this,"generation",0);O(this,"read",async(n,t,r)=>{const i=this.modelHandle,s=this.processor,l=this.loadImage;if(!i||!s||!l||!this.model)throw new Error("BrowserVisionBrain.read called before connect()");const m=t&&t.startsWith("<")?t:ui,p=await l(n),a=s.construct_prompts(m),d=await s(p,a),g=await i.generate({...d,max_new_tokens:512,num_beams:1,do_sample:!1}),u=s.batch_decode(g,{skip_special_tokens:!1})[0],b=s.post_process_generation(u,m,p.size),w=_i(b,m);return r==null||r(w),w})}async connect(n=jt,t){var m,p;const r=await en("the scripted-vision fallback");if(r)throw new Error(r);if(this.modelHandle&&this.model===n)return n;const i=++this.generation,s=a=>{i===this.generation&&(t==null||t({progress:(a.progress??0)/100,text:a.file?`${a.status??"loading"} ${a.file}`:a.status??""}))};this.teardown();let l;try{const{Florence2ForConditionalGeneration:a,AutoProcessor:d,load_image:g}=await _e(async()=>{const{Florence2ForConditionalGeneration:w,AutoProcessor:y,load_image:_}=await import("./transformers.web-ZZjRzBhq.js");return{Florence2ForConditionalGeneration:w,AutoProcessor:y,load_image:_}},[]),u=await a.from_pretrained(n,{dtype:"fp32",device:"webgpu",progress_callback:s}),b=await d.from_pretrained(n);l={model:u,processor:b,loadImage:g}}catch(a){if(i!==this.generation)throw new Error("cancelled");const d=a instanceof Error?a.message:String(a);throw new Error(`Couldn't load ${n} in the browser (${d}). Try the smaller Florence-2 base model, check your connection, or use the scripted-vision fallback.`)}if(i!==this.generation)throw Promise.resolve((p=(m=l.model).dispose)==null?void 0:p.call(m)).catch(()=>{}),new Error("cancelled");return this.modelHandle=l.model,this.processor=l.processor,this.loadImage=l.loadImage,this.model=n,n}teardown(){var t;const n=this.modelHandle;this.modelHandle=null,this.processor=null,this.loadImage=null,this.model=null,Promise.resolve((t=n==null?void 0:n.dispose)==null?void 0:t.call(n)).catch(()=>{})}cancelConnect(){this.generation++}dispose(){this.generation++,this.teardown()}}function _i(e,n){const t=e[n];if(typeof t=="string")return t.trim();if(t&&typeof t=="object"){const r=t.labels;return Array.isArray(r)?r.join(" ").trim():JSON.stringify(t)}return""}async function wi(){return await ai()?"browser":kt()?"endpoint":"scripted"}function fi(){const[e,n]=h.useState("scripted"),t=h.useRef(!1),[r,i]=h.useState("idle"),[s,l]=h.useState(null),[m,p]=h.useState(null),[a,d]=h.useState(null),[g,u]=h.useState(null),[b,w]=h.useState(null),[y,_]=h.useState(null),[M,I]=h.useState(xt),[C,W]=h.useState(Et),[Z,ce]=h.useState(""),[ee,se]=h.useState([]),[V,ne]=h.useState("idle"),[ge,S]=h.useState(null),[E,N]=h.useState(""),[Y,U]=h.useState(null),ie=h.useRef(null),[Ye,Pe]=h.useState("scripted-vision"),[De,Me]=h.useState("idle"),[un,Ae]=h.useState(null),[Ce,he]=h.useState(jt),[we,Be]=h.useState(null),[Qe,xe]=h.useState(null),[ze,qe]=h.useState(null),[R,de]=h.useState(null),Q=h.useRef(null),fe=h.useRef(!1),Je=h.useRef(0),le=h.useCallback(T=>async(...B)=>{try{return await T.chat(...B)}catch($){const ye=$ instanceof Error?$.message:String($);throw T instanceof sn&&cn(ye)&&(U(null),p(null),i("error"),l(ye)),$}},[]),Le=h.useCallback(T=>async(...B)=>{try{return await T.read(...B)}catch($){const ye=$ instanceof Error?$.message:String($);throw cn(ye)&&(de(null),Be(null),Me("error"),Ae(ye)),$}},[]);h.useEffect(()=>{en().then(T=>{w(T),u(T===null),t.current||(t.current=!0,wi().then(n))}),en("the scripted-vision fallback").then(T=>{qe(T),fe.current||(fe.current=!0,Pe(T===null?"browser-vision":"scripted-vision"))})},[]),h.useEffect(()=>{let T=!1;return _(null),mi(M).then(B=>{T||_(B)}),()=>{T=!0}},[M]),h.useEffect(()=>()=>{var T;return(T=ie.current)==null?void 0:T.dispose()},[]),h.useEffect(()=>()=>{var T;return(T=Q.current)==null?void 0:T.dispose()},[]);const Oe=h.useCallback(T=>{n(T),i("idle"),l(null),p(null),d(null),U(null)},[]),nn=h.useCallback(T=>{var B,$;fe.current=!0,(B=Q.current)==null||B.cancelConnect(),($=Q.current)==null||$.dispose(),Q.current=null,Pe(T),Me("idle"),Ae(null),Be(null),xe(null),de(null)},[]),ke=h.useCallback(()=>{var T;(T=ie.current)==null||T.dispose(),ie.current=null,U(null),p(null)},[]),Re=h.useCallback(()=>{ie.current instanceof sn&&ie.current.cancelConnect(),ke(),i("idle"),d(null),l(null)},[ke]),tn=h.useCallback(async()=>{const T=++Je.current,B=()=>T!==Je.current,$=mn(C);if($){se([]),ne("error"),S($);return}ne("loading"),S(null);const ye=new Jn(C,E);try{const Ne=await ye.listModels();if(B())return;se(Ne),ne("ready"),ce($e=>$e&&Ne.includes($e)?$e:Ne[0]??"")}catch(Ne){if(B())return;se([]),ce(""),ne("error"),S(Ne instanceof Error?Ne.message:String(Ne))}finally{ye.dispose()}},[C,E]),gn=h.useCallback(async()=>{var T;if(e==="scripted"){U(null),i("ready");return}if(e==="endpoint"){const B=mn(C);if(B){ke(),l(B),i("error");return}}i("connecting"),l(null),d(null);try{if(e==="browser"){const B=ie.current instanceof sn?ie.current:new sn;ie.current&&ie.current!==B&&ie.current.dispose(),ie.current=B;const $=await B.connect(M,d);p($),U(()=>le(B)),_(!0)}else{(T=ie.current)==null||T.dispose();const B=new Jn(C,E,Z);ie.current=B;const $=await B.connect();p($),U(()=>le(B))}i("ready")}catch(B){const $=B instanceof Error?B.message:String(B);if($==="cancelled")return;l($),i("error"),U(null)}finally{d(null)}},[e,M,C,Z,E,ke,le]),Ue=h.useCallback(()=>{var T;(T=Q.current)==null||T.dispose(),Q.current=null,de(null),Be(null)},[]),hn=h.useCallback(()=>{var T;(T=Q.current)==null||T.cancelConnect(),Ue(),Me("idle"),xe(null),Ae(null)},[Ue]),bn=h.useCallback(async()=>{if(Ye==="scripted-vision"){Ue(),Me("ready"),Ae(null);return}Me("connecting"),Ae(null),xe(null);try{const T=Q.current instanceof Wn?Q.current:new Wn;Q.current&&Q.current!==T&&Q.current.dispose(),Q.current=T;const B=await T.connect(Ce,xe);Be(B),de(()=>Le(T)),Me("ready")}catch(T){const B=T instanceof Error?T.message:String(T);if(B==="cancelled")return;Ae(B),Me("error"),de(null),Be(null)}finally{xe(null)}},[Ye,Ce,Ue,Le]);return{kind:e,setKind:Oe,status:r,error:s,modelInUse:m,progress:a,webgpu:g,webgpuReason:b,browserModelCached:y,cancelConnect:Re,browserModel:M,setBrowserModel:I,endpointUrl:C,setEndpointUrl:W,endpointModel:Z,setEndpointModel:ce,endpointModels:ee,endpointModelsStatus:V,endpointModelsError:ge,listEndpointModels:tn,apiKey:E,setApiKey:N,connect:gn,chat:Y,visionKind:Ye,setVisionKind:nn,visionStatus:De,visionError:un,visionModel:Ce,setVisionModel:he,visionModelInUse:we,visionProgress:Qe,visionWebgpuReason:ze,connectVision:bn,cancelVisionConnect:hn,vision:R}}const Pn="#s=",yi=["scripted","browser","endpoint"];function vi(e){return typeof e=="string"&&yi.includes(e)}function Mi(e){try{const n=JSON.parse(e);if(n&&typeof n=="object"){const t=n,r={};return vi(t.brain)&&(r.brain=t.brain),r}}catch{}return{}}function St(e=location.hash){if(!e.startsWith(Pn))return{};let n;try{n=decodeURIComponent(e.slice(Pn.length))}catch{return{}}return Mi(n)}function xi(e){const n=Object.entries(e).filter(([,t])=>t!==void 0);return n.length===0?"":Pn+encodeURIComponent(JSON.stringify(Object.fromEntries(n)))}function Ni(e){const n={...St(),...e},t=xi(n),r=new URL(location.href);r.hash=t,history.replaceState(history.state,"",r)}const Zn=[{kind:"scripted",label:"Scripted",hint:"No model. The example's stand-in decides — deterministic and offline."},{kind:"browser",label:"In-browser (WebGPU)",hint:"A small quantised model on your GPU. First run downloads weights."},{kind:"endpoint",label:"API endpoint",hint:"Any OpenAI-compatible server. Ollama by default. Local pages only."}],Kn=[{kind:"scripted-vision",label:"Scripted",hint:"No model. The example's known plate is returned — deterministic and offline."},{kind:"browser-vision",label:"In-browser (WebGPU)",hint:"Reads the photo with a vision model on your GPU. First run downloads weights."}];function Ei({brain:e,showText:n=!0,showVision:t=!1}){return o.jsxs("div",{className:"brain",children:[n&&o.jsx(ki,{brain:e}),n&&t&&o.jsx("hr",{className:"brain-divider"}),t&&o.jsx(Ii,{brain:e})]})}function ki({brain:e}){const n=Zn.find(b=>b.kind===e.kind),t=mn(e.endpointUrl),r=kt(),[i,s]=h.useState(pn);h.useEffect(()=>{li().then(s)},[]);const{kind:l,endpointUrl:m,apiKey:p,listEndpointModels:a}=e;h.useEffect(()=>{if(l!=="endpoint"||t)return;const b=setTimeout(()=>void a(),400);return()=>clearTimeout(b)},[l,m,p,t,a]);const d=i.find(b=>b.id===e.browserModel),g=d?ci(d,Nt()):null,u=e.webgpu===!0?"browser":r&&e.webgpu===!1?"endpoint":null;return o.jsxs("div",{className:"brain-section",children:[o.jsxs("div",{className:"brain-kinds",children:[Zn.map(b=>o.jsxs(q,{size:"sm",variant:e.kind===b.kind?"default":"secondary",onClick:()=>e.setKind(b.kind),children:[b.label,b.kind===u&&o.jsx(H,{variant:"info",className:"brain-recommended-badge",children:"recommended"})]},b.kind)),e.status==="ready"&&e.kind!=="scripted"&&o.jsx(H,{variant:"success",children:e.modelInUse??"connected"}),e.status==="connecting"&&o.jsx(H,{variant:"info",children:"connecting…"}),e.status==="error"&&o.jsx(H,{variant:"danger",children:"not connected"})]}),o.jsx("p",{className:"field-hint",children:n.hint}),e.kind==="browser"&&o.jsxs("div",{className:"brain-config",children:[o.jsxs("div",{className:"field",children:[o.jsx(Ve,{htmlFor:"browser-model",children:"Model"}),o.jsxs(Mn,{value:e.browserModel,onValueChange:e.setBrowserModel,disabled:e.status==="connecting",children:[o.jsx(xn,{id:"browser-model",children:o.jsx(Nn,{})}),o.jsx(En,{children:i.map(b=>o.jsx(kn,{value:b.id,children:b.label},b.id))})]}),e.browserModelCached===!0&&o.jsx("p",{className:"field-hint",children:"Already downloaded in this browser — connecting will be fast."}),e.browserModelCached===!1&&o.jsx("p",{className:"field-hint",children:"Not downloaded yet — connecting fetches the weights once, then caches them for next time."})]}),e.webgpu===!1&&e.webgpuReason&&o.jsxs(me,{variant:"destructive",children:[o.jsx(pe,{children:"No WebGPU in this browser"}),o.jsx(ue,{children:e.webgpuReason})]}),e.webgpu!==!1&&g&&o.jsxs(me,{variant:"destructive",children:[o.jsx(pe,{children:"This model may not fit in GPU memory"}),o.jsx(ue,{children:g})]})]}),e.kind==="endpoint"&&o.jsxs("div",{className:"brain-config",children:[o.jsxs("div",{className:"field",children:[o.jsx(Ve,{htmlFor:"endpoint-url",children:"Endpoint"}),o.jsx(Rn,{id:"endpoint-url",value:e.endpointUrl,onChange:b=>e.setEndpointUrl(b.target.value),disabled:e.status==="connecting"}),o.jsxs("p",{className:"field-hint",children:["Ollama allows ",o.jsx("code",{children:"localhost"})," origins out of the box; set"," ",o.jsx("code",{children:"OLLAMA_ORIGINS"})," only when serving this page from another host. Best for local development — a hosted copy of this page can't reach a server on your machine at all."]}),t&&o.jsxs(me,{variant:"destructive",children:[o.jsx(pe,{children:"A local server won't work from this URL"}),o.jsx(ue,{children:t})]})]}),o.jsxs("div",{className:"field",children:[o.jsx(Ve,{htmlFor:"endpoint-model",children:"Model"}),o.jsxs("div",{className:"endpoint-model-row",children:[o.jsxs(Mn,{value:e.endpointModel,onValueChange:e.setEndpointModel,disabled:e.status==="connecting"||e.endpointModelsStatus==="loading"||e.endpointModels.length===0,children:[o.jsx(xn,{id:"endpoint-model",className:"endpoint-model-select",children:o.jsx(Nn,{placeholder:e.endpointModelsStatus==="loading"?"Loading models…":e.endpointModelsStatus==="idle"?"Enter an endpoint above":e.endpointModelsStatus==="error"?"No models — check the endpoint":e.endpointModels.length===0?"No models served":"Select a model"})}),o.jsx(En,{children:e.endpointModels.map(b=>o.jsx(kn,{value:b,children:b},b))})]}),o.jsx(q,{size:"sm",variant:"secondary",onClick:()=>void e.listEndpointModels(),disabled:e.status==="connecting"||e.endpointModelsStatus==="loading"||t!==null,children:e.endpointModelsStatus==="loading"?"Refreshing…":"Refresh"})]}),o.jsxs("p",{className:"field-hint",children:["Fetched from the endpoint's ",o.jsx("code",{children:"/models"}),". Tiny models (e.g. SmolLM2) usually can't follow the tool-calling format — prefer ",o.jsx("code",{children:"llama3.2:3b"}),", ",o.jsx("code",{children:"qwen2.5"})," or larger."]}),e.endpointModelsStatus==="error"&&!t&&o.jsxs(me,{variant:"destructive",children:[o.jsx(pe,{children:"Couldn't list models"}),o.jsx(ue,{children:e.endpointModelsError})]})]}),o.jsxs("div",{className:"field",children:[o.jsx(Ve,{htmlFor:"endpoint-key",children:"API key (optional)"}),o.jsx(Rn,{id:"endpoint-key",type:"password",value:e.apiKey,onChange:b=>e.setApiKey(b.target.value),disabled:e.status==="connecting"})]})]}),e.kind!=="scripted"&&o.jsxs("div",{className:"brain-actions",children:[o.jsx(q,{size:"sm",onClick:()=>void e.connect(),disabled:e.status==="connecting"||e.kind==="endpoint"&&(e.endpointModel===""||e.endpointModelsStatus==="loading"||t!==null),children:e.status==="ready"?"Reconnect":"Connect"}),e.status==="connecting"&&e.kind==="browser"&&o.jsx(q,{size:"sm",variant:"secondary",onClick:e.cancelConnect,children:"Cancel"}),e.progress&&o.jsxs("span",{className:"field-hint",children:[Math.round(e.progress.progress*100),"% —"," ",e.progress.text]})]}),e.error&&o.jsxs(me,{variant:"destructive",children:[o.jsx(pe,{children:"Couldn't connect"}),o.jsx(ue,{children:e.error})]})]})}function Ii({brain:e}){const n=Kn.find(r=>r.kind===e.visionKind),t=e.webgpu===!0?"browser-vision":null;return o.jsxs("div",{className:"brain-section brain-vision",children:[o.jsx(Ve,{children:"Vision (reads the image)"}),o.jsxs("div",{className:"brain-kinds",children:[Kn.map(r=>o.jsxs(q,{size:"sm",variant:e.visionKind===r.kind?"default":"secondary",onClick:()=>e.setVisionKind(r.kind),children:[r.label,r.kind===t&&o.jsx(H,{variant:"info",className:"brain-recommended-badge",children:"recommended"})]},r.kind)),e.visionStatus==="ready"&&e.visionKind==="browser-vision"&&o.jsx(H,{variant:"success",children:e.visionModelInUse??"connected"}),e.visionStatus==="connecting"&&o.jsx(H,{variant:"info",children:"connecting…"}),e.visionStatus==="error"&&o.jsx(H,{variant:"danger",children:"not connected"})]}),o.jsx("p",{className:"field-hint",children:n.hint}),e.visionKind==="scripted-vision"&&e.webgpu===!1&&e.visionWebgpuReason&&o.jsxs(me,{variant:"destructive",children:[o.jsx(pe,{children:"No WebGPU in this browser"}),o.jsx(ue,{children:e.visionWebgpuReason})]}),e.visionKind==="browser-vision"&&o.jsxs("div",{className:"brain-config",children:[o.jsxs("div",{className:"field",children:[o.jsx(Ve,{htmlFor:"vision-model",children:"Model"}),o.jsxs(Mn,{value:e.visionModel,onValueChange:e.setVisionModel,disabled:e.visionStatus==="connecting",children:[o.jsx(xn,{id:"vision-model",children:o.jsx(Nn,{})}),o.jsx(En,{children:Tt.map(r=>o.jsx(kn,{value:r.id,children:r.label},r.id))})]}),o.jsx("p",{className:"field-hint",children:"Connecting downloads the weights once (size shown above), then caches them — every token is read on your GPU, no server."})]}),e.webgpu===!1&&e.visionWebgpuReason&&o.jsxs(me,{variant:"destructive",children:[o.jsx(pe,{children:"No WebGPU in this browser"}),o.jsx(ue,{children:e.visionWebgpuReason})]})]}),e.visionKind==="browser-vision"&&o.jsxs("div",{className:"brain-actions",children:[o.jsx(q,{size:"sm",onClick:()=>void e.connectVision(),disabled:e.visionStatus==="connecting",children:e.visionStatus==="ready"?"Reconnect":"Connect"}),e.visionStatus==="connecting"&&o.jsx(q,{size:"sm",variant:"secondary",onClick:e.cancelVisionConnect,children:"Cancel"}),e.visionProgress&&o.jsxs("span",{className:"field-hint",children:[Math.round(e.visionProgress.progress*100),"% —"," ",e.visionProgress.text]})]}),e.visionError&&o.jsxs(me,{variant:"destructive",children:[o.jsx(pe,{children:"Couldn't connect the vision brain"}),o.jsx(ue,{children:e.visionError})]})]})}function Ti({imageInput:e,value:n,onSelect:t,disabled:r=!1}){const[i,s]=h.useState(null),[l,m]=h.useState(!1),p=h.useRef(null),a=h.useId(),d=h.useId(),g=h.useCallback(w=>{s(URL.createObjectURL(w)),t({imageName:w.name,pixels:w})},[t]);h.useEffect(()=>{if(i)return()=>URL.revokeObjectURL(i)},[i]);const u=h.useCallback(w=>{const y=w==null?void 0:w[0];y&&y.type.startsWith("image/")&&g(y)},[g]),b=(n==null?void 0:n.imageId)!=null?e.seedImages.find(w=>w.id===n.imageId):void 0;return o.jsxs("div",{className:"image-input",children:[e.label&&o.jsx("p",{className:"field-hint",children:e.label}),o.jsx("p",{className:"image-input-label",id:a,children:"Seed photos"}),o.jsx("div",{className:"image-gallery",role:"group","aria-labelledby":a,children:e.seedImages.map(w=>{const y=(n==null?void 0:n.imageId)===w.id;return o.jsxs("button",{type:"button","aria-pressed":y,className:`image-thumb${y?" image-thumb--selected":""}`,disabled:r,title:w.label??w.id,onClick:()=>{s(null),p.current&&(p.current.value=""),t({imageId:w.id,pixels:w.file})},children:[o.jsx("img",{src:w.thumb??w.file,alt:w.label??w.id}),w.label&&o.jsx("span",{children:w.label})]},w.id)})}),o.jsx("label",{className:"image-input-label",htmlFor:d,children:"Or upload your own photo"}),o.jsxs("div",{className:`image-drop${l?" image-drop--over":""}`,onDragOver:w=>{w.preventDefault(),r||m(!0)},onDragLeave:()=>m(!1),onDrop:w=>{w.preventDefault(),m(!1),r||u(w.dataTransfer.files)},children:[o.jsx("input",{ref:p,id:d,type:"file",accept:"image/*",disabled:r,onChange:w=>u(w.target.files)}),o.jsx("p",{className:"field-hint",children:"Drag a photo here, or pick one. Uploading a photo the model has never seen is the proof this runs for real — nothing leaves your browser."})]}),(i||b)&&o.jsxs("div",{className:"image-preview",children:[o.jsx("img",{src:i??(b==null?void 0:b.file),alt:i?(n==null?void 0:n.imageName)??"uploaded photo":(b==null?void 0:b.label)??(b==null?void 0:b.id)??"selected photo"}),o.jsx("span",{className:"field-hint",children:i?`Uploaded: ${(n==null?void 0:n.imageName)??"your photo"}`:`Selected: ${(b==null?void 0:b.label)??(b==null?void 0:b.id)}`}),o.jsx("button",{type:"button",className:"image-clear-btn",disabled:r,onClick:()=>{s(null),p.current&&(p.current.value=""),t(null)},children:"Clear"})]})]})}function Pt(e){return typeof e=="object"&&e!==null}function md(e){const n=new Set,t=r=>{Pt(r)&&(typeof r.key=="string"&&n.add(r.key),Array.isArray(r.components)&&r.components.forEach(t))};return t(e),n}function ji(e){const n={},t=r=>{Pt(r)&&(typeof r.key=="string"&&"defaultValue"in r&&(n[r.key]=r.defaultValue??""),Array.isArray(r.components)&&r.components.forEach(t))};return t(e),n}const Si="wdf:section:";function At(e){return Si+e}function Xn(e){try{const n=window.localStorage.getItem(At(e));return n==="1"?!0:n==="0"?!1:void 0}catch{return}}function Pi(e,n){try{window.localStorage.setItem(At(e),n?"1":"0")}catch{}}function Ai(e,n=!0){const[t,r]=h.useState(()=>Xn(e)??n);h.useEffect(()=>{r(Xn(e)??n)},[e,n]);const i=h.useCallback(s=>{r(s),Pi(e,s)},[e]);return[t,i]}function Te({sectionId:e,title:n,description:t,defaultOpen:r=!0,className:i,children:s,...l}){const[m,p]=Ai(e,r);return o.jsx(Ft,{className:["panel",i].filter(Boolean).join(" "),"data-tour":l["data-tour"],children:o.jsxs(zt,{open:m,onOpenChange:p,children:[o.jsxs(Ot,{className:"panel-trigger",children:[o.jsxs("span",{className:"panel-trigger-text",children:[o.jsx("span",{className:"panel-title",children:n}),t!=null&&o.jsx("span",{className:"panel-desc",children:t})]}),o.jsx(Ut,{className:"panel-chevron","aria-hidden":!0})]}),o.jsx($t,{children:o.jsx(Gt,{children:s})})]})})}function Di(e){return e.entries!==void 0}function Ci(e){const n=[];let t=null;for(const r of e)r.turn!==void 0?t&&t.turn===r.turn?t.entries.push(r):(t={turn:r.turn,entries:[r]},n.push(t)):(t=null,n.push(r));return n}function et(e){if(e===void 0)return"undefined";try{return JSON.stringify(e)}catch{return"[unserializable value]"}}function Bi({activation:e,result:n,labelFor:t}){const r=e.elementId??"";return o.jsxs("div",{className:"timeline-tool",children:[o.jsxs("div",{className:"timeline-tool-head",children:[o.jsx(H,{variant:"info",children:"tool"}),o.jsx("strong",{children:t(r)||r}),o.jsx("code",{children:r})]}),e.args!==void 0&&Object.keys(e.args).length>0&&o.jsxs("div",{className:"timeline-kv",children:[o.jsx("span",{className:"timeline-kv-label",children:"arguments"}),o.jsx("code",{children:et(e.args)})]}),o.jsxs("div",{className:"timeline-kv",children:[o.jsx("span",{className:"timeline-kv-label",children:"returned"}),o.jsx("code",{children:n?et(n.result):"— waiting for the job to complete —"})]})]})}function Li({group:e,labelFor:n}){const t=e.entries.find(a=>a.kind==="llm"),r=e.entries.filter(a=>a.kind==="agent"&&a.elementId),i=e.entries.filter(a=>a.kind==="vars"&&a.elementId),s=e.entries.filter(a=>a.kind==="agent"&&!a.elementId),l=e.entries.filter(a=>a.kind==="error"),m=new Set(r.map(a=>a.elementId)),p=e.entries.filter(a=>a.kind==="tool"||a.kind==="vars"&&a.elementId&&!m.has(a.elementId)).sort((a,d)=>a.id-d.id);return o.jsxs("div",{className:"timeline-turn",children:[o.jsxs("div",{className:"timeline-turn-head",children:[o.jsxs(H,{variant:t!=null&&t.pending?"warning":"neutral",children:["Turn ",e.turn]}),(t==null?void 0:t.pending)&&o.jsx("span",{className:"timeline-pending",children:"thinking…"})]}),t&&o.jsx("blockquote",{className:"timeline-reply",children:t.text}),s.map(a=>o.jsx("div",{className:"timeline-note",children:a.text},a.id)),r.map(a=>o.jsx(Bi,{activation:a,result:i.find(d=>d.elementId===a.elementId),labelFor:n},a.id)),p.map(a=>o.jsxs("div",{className:`log-line log-${a.kind}`,children:[a.pending?"⏳ ":"",a.text]},a.id)),l.map(a=>o.jsxs("div",{className:"timeline-error",children:["⚠ ",a.text]},a.id))]})}function Ri({log:e,elementStats:n=[],incidents:t=[],labelFor:r=i=>i}){const i=h.useMemo(()=>Ci(e),[e]),[s,l]=h.useState(!1),m=h.useRef(null);h.useEffect(()=>{const a=m.current;a&&(a.scrollTop=a.scrollHeight)},[i]);const p=()=>{var g;const a={log:e.map(({id:u,...b})=>b),elementStats:n,incidents:t},d=JSON.stringify(a,null,2);(g=navigator.clipboard)!=null&&g.writeText&&navigator.clipboard.writeText(d).then(()=>{l(!0),setTimeout(()=>l(!1),1500)}).catch(()=>{})};return o.jsxs(Te,{sectionId:"activity",className:"grow",title:"Activity",description:"Agent turns, model replies, and tool calls — read top to bottom as a story.",children:[o.jsx("div",{className:"timeline-toolbar",children:o.jsx(q,{variant:"secondary",size:"sm",onClick:p,children:s?"Copied!":"Copy run as JSON"})}),o.jsx("div",{className:"timeline",ref:m,children:i.length===0?o.jsx("div",{className:"log-empty",children:"Press Run or Step to start."}):i.map(a=>Di(a)?o.jsx(Li,{group:a,labelFor:r},`turn-${a.turn}-${a.entries[0].id}`):o.jsxs("div",{className:`log-line log-${a.kind}`,children:[a.pending?"⏳ ":"",a.text]},a.id))}),(n.length>0||t.length>0)&&o.jsxs("div",{className:"timeline-engine-view",children:[n.length>0&&o.jsxs("div",{className:"timeline-stats",children:[o.jsx("span",{className:"timeline-kv-label",children:"Element completion"}),o.jsx("ul",{children:n.filter(a=>a.completed>0||(a.active??0)>0).map(a=>o.jsxs("li",{children:[o.jsx("code",{children:r(a.elementId)||a.elementId})," ","completed ",a.completed,a.active?`, ${a.active} active`:""]},a.elementId))})]}),t.length>0&&o.jsxs("div",{className:"timeline-incidents",children:[o.jsx("span",{className:"timeline-kv-label",children:"Incidents"}),o.jsx("ul",{children:t.map((a,d)=>o.jsxs("li",{children:[o.jsx("code",{children:r(a.elementId)||a.elementId})," —"," ",a.reason]},`${a.elementId}-${d}`))})]})]})]})}const Ee={diagram:"diagram",runButton:"run-button",variablesPanel:"variables-panel",codePanel:"code-panel",brainPanel:"brain-panel"};function nt(e){return`[data-tour="${e}"]`}function Fi(e=location.search){return new URLSearchParams(e).get("tour")}function zi(e,n){var t;return((t=e.elementStats.find(r=>r.elementId===n))==null?void 0:t.completed)??0}function Oi(e,n){return!e||e.kind==="click"||!n?!1:e.kind==="activeElement"?n.activeElementIds.includes(e.elementId):zi(n,e.elementId)>=(e.atLeast??1)}function Ui(e){return"anchor"in e?nt(e.anchor):`${nt(Ee.diagram)} [data-element-id="${$i(e.elementId)}"]`}function $i(e){return typeof CSS<"u"&&typeof CSS.escape=="function"?CSS.escape(e):e.replace(/[^a-zA-Z0-9_-]/g,n=>`\\${n}`)}function Gi(e){return e.map(n=>{const t=!!n.waitFor&&n.waitFor.kind!=="click";return{element:Ui(n.target),popover:{title:n.title,description:t?`${n.description} (continues automatically once you reach that point — or use Next to skip ahead)`:n.description,showButtons:["next","previous","close"]},disableActiveInteraction:!1,skipMissingElement:n.skipMissingElement??!0}})}async function Vi(e,n={}){var s;const[{driver:t}]=await Promise.all([_e(()=>import("./driver.js-bj_ppY-Q.js"),[]),_e(()=>Promise.resolve({}),__vite__mapDeps([0]))]),r=Gi(e),i=t({steps:r,showProgress:!0,allowClose:!0,skipMissingElement:!0,onHighlighted:(l,m,{index:p})=>{var a;p!==void 0&&((a=n.onIndexChange)==null||a.call(n,p))},onDestroyed:()=>{var l;(l=n.onDestroyed)==null||l.call(n)}});return i.drive(),(s=n.onIndexChange)==null||s.call(n,i.getActiveIndex()??0),{moveNext:()=>i.moveNext(),activeIndex:()=>i.getActiveIndex()??-1,destroy:()=>i.destroy()}}const Yi=300;function Qi(e,n){const[t,r]=h.useState(!1),i=h.useRef(null),s=h.useRef(0),l=h.useRef(-1),m=h.useRef(null),p=h.useRef(n);h.useEffect(()=>{p.current=n},[n]);const a=h.useCallback(()=>{m.current!==null&&(clearInterval(m.current),m.current=null)},[]),d=h.useRef(0),g=h.useCallback(()=>{var b;d.current+=1,a(),(b=i.current)==null||b.destroy(),i.current=null,r(!1)},[a]),u=h.useCallback(()=>{if(!e||e.steps.length===0||i.current)return;const b=d.current+=1;Vi(e.steps,{onIndexChange:w=>{s.current=w},onDestroyed:()=>{a(),i.current=null,r(!1)}}).then(w=>{if(b!==d.current){w.destroy();return}i.current=w,r(!0),m.current=setInterval(()=>{const y=s.current;if(y===l.current)return;const _=e.steps[y];_&&Oi(_.waitFor,p.current())&&(l.current=y,w.moveNext())},Yi)})},[e,a]);return h.useEffect(()=>g,[g]),{active:t,start:u,stop:g}}const Ie=650,wn="__agent__",tt="__model__",rt="__template__:",qi=h.lazy(async()=>{await Promise.all([_e(()=>Promise.resolve({}),__vite__mapDeps([1])),_e(()=>Promise.resolve({}),__vite__mapDeps([2]))]);const{RuntimeDiagram:e}=await _e(async()=>{const{RuntimeDiagram:n}=await import("./RuntimeDiagram-B2IYfHo7.js");return{RuntimeDiagram:n}},__vite__mapDeps([3,4,5]));return{default:e}}),fn=h.lazy(()=>_e(()=>import("./MonacoEditor-BWVwCA_S.js").then(e=>e.M),__vite__mapDeps([6,4,7]))),Ji=h.lazy(()=>_e(()=>import("./vendor-modeler-BRi0wbco.js"),__vite__mapDeps([8,4,5,9,10,11,12,1,2]))),it=h.lazy(async()=>{const{FormRenderer:e}=await _e(async()=>{const{FormRenderer:n}=await import("./FormRenderer-CEW7R2wZ.js");return{FormRenderer:n}},__vite__mapDeps([13,4,11,9,10,14]));return{default:e}});function yn(e,n){try{return JSON.stringify(e??{},null,n)}catch{return"[unserializable value]"}}function Hi({example:e,initialBrainKind:n,initialTourId:t}){var B,$,ye,Ne,$e,Cn,Bn,Ln;const[r,i]=h.useState(e.bpmn),s=fi(),[l,m]=h.useState(null);h.useEffect(()=>{n&&n!==s.kind&&s.setKind(n)},[]),h.useEffect(()=>{Ni({brain:s.kind})},[s.kind]);const[p,a]=h.useState(()=>Object.fromEntries(e.handlers.map(v=>[v.elementId,v.source]))),[d,g]=h.useState(e.scriptedAgent??""),[u,b]=h.useState(()=>Xe(e.templates)),w=h.useMemo(()=>Tr(e,p,r,u),[e,p,r,u]),y=w.model,_=ti({bpmn:w.resolvedBpmn}),M=Qi(e.tour,()=>_.snapshot);h.useEffect(()=>{var v;t&&((v=e.tour)==null?void 0:v.id)===t&&M.start()},[]);const I=y.startFormId?((B=e.forms)==null?void 0:B[y.startFormId])??null:null,[C,W]=h.useState(()=>({...e.seed,...I?ji(I):{}})),[Z,ce]=h.useState(y.agent?wn:(($=e.handlers[0])==null?void 0:$.elementId)??""),[ee,se]=h.useState(!1),[V,ne]=h.useState(!1),[ge,S]=h.useState(null),[E,N]=h.useState([]),[Y,U]=h.useState({}),[ie,Ye]=h.useState(!1),Pe=h.useRef(null),[De,Me]=h.useState({}),[un,Ae]=h.useState(!1),Ce=h.useRef(null),he=h.useRef(!1),we=h.useRef(0),Be=h.useRef(0),Qe=h.useRef({current:void 0}),xe=h.useRef({}),ze=h.useRef({}),qe=h.useMemo(()=>{const v=new Map;for(const x of y.processes){for(const k of x.tasks)v.set(k.elementId,k.label);for(const k of x.agents){v.set(k.elementId,k.label);for(const D of k.tools)v.set(D.elementId,D.label)}for(const k of x.userTasks)v.set(k.elementId,k.label)}return x=>v.get(x)??x},[y]),R=h.useCallback(v=>{N(x=>{if(v.key){const k=x.findIndex(D=>D.key===v.key);if(k>=0){const D=[...x];return D[k]={...D[k],...v},D}}return[...x,{...v,id:Be.current++}].slice(-80)})},[]),de=h.useMemo(()=>{var v;return((v=_.snapshot)==null?void 0:v.userTasks.find(x=>x.state==="Created"))??null},[_.snapshot]),Q=h.useMemo(()=>{const v=y.processes.flatMap(k=>k.tasks),x=new Map;for(const k of e.handlers){if(!k.manualControl)continue;const D=v.find(A=>A.elementId===k.elementId);D&&x.set(D.jobType,{...k.manualControl,elementId:k.elementId})}return x},[e.handlers,y]),fe=h.useMemo(()=>{if(!_.snapshot)return null;for(const v of _.snapshot.jobs){const x=Q.get(v.jobType);if(x&&v.state==="Created")return{job:v,control:x}}return null},[_.snapshot,Q]),Je=h.useMemo(()=>{if(!y.agent||!_.snapshot)return[];const v=new Map(_.snapshot.elementStats.map(x=>[x.elementId,x.completed]));return y.agent.tools.filter(x=>(v.get(x.elementId)??0)===0)},[y.agent,_.snapshot]),le=de?y.userTasks.find(v=>v.elementId===de.elementId):void 0,Le=le!=null&&le.formId?((ye=e.forms)==null?void 0:ye[le.formId])??null:null,Oe=h.useCallback(async(v,x,k,D)=>{var ve,re,ae;let A=k,oe=0;for(;we.current===D&&A&&A.completedInstances<1&&oe++<80;){const J=await _.stepWorkers(v,{agents:x});if(we.current!==D)return A;A=(J==null?void 0:J.snapshot)??A;const te=(ve=A.instances[0])==null?void 0:ve.variables;if(te&&U({...te}),A.userTasks.some(G=>G.state==="Created")){R({kind:"human",text:"⏸ waiting for a human — complete the task below to continue"});break}if(!J){R({kind:"error",text:"▶ run stopped — no dispatch round was returned"});break}if(J.handled===0){const G=A.messageSubscriptions[0];if(J.reason==="messages"&&G){if(R({kind:"step",text:`⏳ parked on a message catch event — waiting for "${G.messageName}"`,elementId:G.elementId}),await new Promise(K=>setTimeout(K,Ie)),we.current!==D)return A;R({kind:"vars",text:`📨 correlating message "${G.messageName}" (key: ${G.correlationKey})`,elementId:G.elementId});const z=_.correlateMessage(G.messageName,G.correlationKey,"{}");if(z){A=z;const K=(re=A.instances[0])==null?void 0:re.variables;K&&U({...K}),await new Promise(be=>setTimeout(be,Ie));continue}R({kind:"error",text:`▶ run stopped — correlating "${G.messageName}" (key: ${G.correlationKey}) failed`,elementId:G.elementId})}if(J.reason==="signals"&&A.signalSubscriptions.length>0){const z=A.signalSubscriptions[0],K=A.signalSubscriptions.length;if(R({kind:"step",text:`⏳ parked on ${K} open signal subscription${K===1?"":"s"} — waiting for "${z.signalName}"`,elementId:z.elementId}),await new Promise(Ge=>setTimeout(Ge,Ie)),we.current!==D)return A;const be=_.broadcastSignal(z.signalName,"{}");if(be){A=be,R({kind:"vars",text:`📡 broadcasting signal "${z.signalName}" — every waiting subscription unblocks`,elementId:z.elementId});const Ge=(ae=A.instances[0])==null?void 0:ae.variables;Ge&&U({...Ge}),await new Promise(Ct=>setTimeout(Ct,Ie));continue}R({kind:"error",text:`▶ run stopped — broadcasting signal "${z.signalName}" failed`,elementId:z.elementId})}if(J.reason==="timers"){const z=A.timers.reduce((K,be)=>Math.min(K,be.dueInMs),1/0);if(Number.isFinite(z)){if(R({kind:"step",text:`⏳ parked on a timer — ${(Math.max(z,0)/1e3).toFixed(1)}s left on the clock`}),await new Promise(be=>setTimeout(be,Ie)),we.current!==D)return A;const K=_.advanceTime(Math.max(z,0)+1);if(K){A=K,R({kind:"step",text:"🕐 the clock advanced — timer fired"}),await new Promise(be=>setTimeout(be,Ie));continue}}}break}await new Promise(G=>setTimeout(G,Ie))}return we.current!==D||(A&&A.completedInstances>=1?R({kind:"done",text:"✅ process instance completed"}):A&&A.incidentElementIds.length>0&&R({kind:"error",text:"A job failed — incident on the diagram"})),A},[_,R]),nn=h.useCallback(async v=>{var A,oe,ve;if(!fe||he.current)return;const{job:x,control:k}=fe,D=++we.current;he.current=!0,se(!0);try{let re,ae;if(v==="complete")re=_.completeJobManually(x.jobType,"{}"),ae="  ↳ completed normally";else if(k.action.kind==="timer"){const J=((oe=(A=_.snapshot)==null?void 0:A.timers[0])==null?void 0:oe.dueInMs)??0;re=_.advanceTime(Math.max(J,0)+1),ae="  ↳ advanced the clock — timer fired"}else{const{errorCode:J,message:te}=k.action;re=_.throwJobError(x.jobType,J,te),ae=`  ↳ threw BPMN error ${J}: ${te}`}if(re){R({kind:"vars",text:ae,elementId:x.elementId});const J=(ve=re.instances[0])==null?void 0:ve.variables;J&&U({...J}),await new Promise(te=>setTimeout(te,Ie)),await Oe(xe.current,ze.current,re,D)}else R({kind:"error",text:"  ↳ failed to resolve the manual job",elementId:x.elementId})}finally{he.current=!1,se(!1)}},[fe,_,R,Oe]),ke=h.useCallback(async()=>{var J;let v=null;try{y.agent&&d.trim()&&(v=_r(d))}catch(te){return S(te instanceof Error?te.message:String(te)),null}Qe.current={current:void 0};let x;if(e.imageInput){const te=s.vision;x={read:te??bi(e.scriptedVision).read,live:!!te,resolve:z=>_.getRunImage(z)}}const k=yr(y,w.handlers,R,Qe.current,x);for(const te of Q.keys())delete k[te];const D={};if(y.agents.length>0){if(s.kind!=="scripted"&&s.chat){const G=new Map;for(const z of y.agents)G.set(z.jobType,[...G.get(z.jobType)??[],z]);for(const[z,K]of G)D[z]=Rr(K,s.chat,R,{turnRef:Qe.current,requiredTools:e.requiredTools})}else if(v&&y.agent){const G=y.agent.elementId;D[y.agent.jobType]=async z=>{if(z.elementId!==G)throw new Error(`No scripted agent handler for "${z.elementId}" — only "${G}" (the primary process's first agent host) is driven by the scripted brain. Use a live brain to exercise more than one host.`);const K=await v(z),be=(K.activateElements??[]).map(Ge=>Ge.elementId).join(", ");return R({kind:"agent",text:K.completionConditionFulfilled?"🤖 scripted agent: done":`🤖 scripted agent: calling ${be||"(nothing)"}`}),K}}}N([]),Me({});const A={...e.seed,...C,...lr(e.imageInput?l:null)};U(A),xe.current=k,ze.current=D;const oe=_.redeploy(r),ve=(oe==null?void 0:oe[0])??y.processId;R({kind:"start",text:`Starting "${ve}" — ${y.agent?s.kind==="scripted"||!s.chat?"scripted brain":`live brain (${s.modelInUse??s.kind})`:"no agent in this model"}`});const re=_.createInstance(ve,JSON.stringify(A)),ae=(J=re==null?void 0:re.instances[0])==null?void 0:J.key;return e.imageInput&&l&&ae&&_.setRunImage(ae,l),{workers:k,agents:D,snap:re}},[_,e,w,r,d,C,l,y,s,R,Q]),Re=!!_.snapshot&&_.snapshot.completedInstances<1,tn=!Re&&!!I&&!ie,gn=h.useCallback(async()=>{if(!(_.phase!=="ready"||he.current||V||w.hasErrors)){he.current=!0,se(!0);try{let v=xe.current,x=ze.current,k=_.snapshot;const D=++we.current;if(!Re){if(Pe.current&&!Pe.current.validate())return;S(null);const A=await ke();if(!A)return;v=A.workers,x=A.agents,k=A.snap,await new Promise(oe=>setTimeout(oe,Ie))}await Oe(v,x,k,D)}finally{he.current=!1,se(!1)}}},[_,V,w.hasErrors,Re,ke,Oe]),Ue=h.useCallback(async()=>{var v;if(!(_.phase!=="ready"||he.current||V||w.hasErrors)){he.current=!0,ne(!0);try{let x=xe.current,k=ze.current,D=_.snapshot;if(!Re){if(Pe.current&&!Pe.current.validate())return;S(null);const ae=await ke();if(!ae)return;x=ae.workers,k=ae.agents,D=ae.snap}if(!D||D.completedInstances>=1)return;const A=D.takenSequenceFlows.length,oe=await _.stepWorkers(x,{agents:k});if(!oe){R({kind:"error",text:"⏭ step failed — no dispatch round was returned"});return}const ve=(v=oe.snapshot.instances[0])==null?void 0:v.variables;ve&&U({...ve});const re=ri(oe.snapshot.takenSequenceFlows,A);R(ii(oe,re,qe,Q))}finally{he.current=!1,ne(!1)}}},[_,V,w.hasErrors,Re,ke,R,qe,Q]),hn=h.useCallback(()=>{he.current=!1,we.current++,se(!1),ne(!1),_.reset(),N([]),U({})},[_]),bn=h.useCallback(()=>{var k;if(!de||Ce.current&&!Ce.current.validate())return;const v=_.completeUserTask(de.key,JSON.stringify(De));R({kind:"human",text:`👤 ${yn(De)}`});const x=(k=v==null?void 0:v.instances[0])==null?void 0:k.variables;U(D=>({...D,...De,...x??{}})),v&&v.completedInstances>=1&&R({kind:"done",text:"✅ process instance completed"})},[de,De,_,R]),T=h.useMemo(()=>{var v,x;return _.phase==="loading"?o.jsx(H,{variant:"neutral",children:"Booting engine…"}):_.phase==="error"?o.jsx(H,{variant:"danger",children:"Engine error"}):ee?o.jsx(H,{variant:"info",children:"Running…"}):V?o.jsx(H,{variant:"info",children:"Stepping…"}):(((v=_.snapshot)==null?void 0:v.incidentElementIds.length)??0)>0?o.jsx(H,{variant:"danger",children:"Incident"}):de?o.jsx(H,{variant:"warning",children:"Waiting for a human"}):(((x=_.snapshot)==null?void 0:x.completedInstances)??0)>=1?o.jsx(H,{variant:"success",children:"Completed"}):_.snapshot?o.jsx(H,{variant:"warning",children:"Paused"}):o.jsx(H,{variant:"neutral",children:"Ready"})},[_.phase,_.snapshot,ee,V,de]);return o.jsxs("div",{className:"runner",children:[o.jsxs("section",{className:"intro",children:[o.jsx("h1",{children:e.title}),o.jsx("p",{children:e.blurb}),o.jsxs("div",{className:"controls",children:[o.jsx(q,{"data-tour":Ee.runButton,onClick:()=>void gn(),disabled:_.phase!=="ready"||ee||V||w.hasErrors||tn,children:"▶ Run"}),o.jsx(q,{variant:"secondary",onClick:()=>void Ue(),disabled:_.phase!=="ready"||ee||V||w.hasErrors||tn||(((Ne=_.snapshot)==null?void 0:Ne.completedInstances)??0)>=1,children:"⏭ Step"}),o.jsx(q,{variant:"secondary",onClick:hn,disabled:_.phase!=="ready"||V,children:"↺ Reset"}),e.tour&&o.jsx(q,{variant:"secondary",onClick:M.start,disabled:M.active,children:M.active?"Touring…":`🧭 ${e.tour.label}`}),T]}),_.phase==="error"&&o.jsxs(me,{variant:"destructive",children:[o.jsx(pe,{children:"Engine error"}),o.jsx(ue,{children:_.error})]}),ge&&o.jsxs(me,{variant:"destructive",children:[o.jsx(pe,{children:"Code didn't compile"}),o.jsx(ue,{children:ge})]}),w.hasErrors&&o.jsxs(me,{variant:"destructive",children:[o.jsx(pe,{children:"Run is disabled — the diagram has unresolved references"}),o.jsx(ue,{children:o.jsx("ul",{className:"diagnostics",children:w.diagnostics.filter(v=>v.severity==="error").map((v,x)=>o.jsx("li",{children:v.message},x))})})]}),!w.hasErrors&&w.diagnostics.length>0&&o.jsxs(me,{children:[o.jsx(pe,{children:"Heads up"}),o.jsx(ue,{children:o.jsx("ul",{className:"diagnostics",children:w.diagnostics.map((v,x)=>o.jsx("li",{children:v.message},x))})})]})]}),o.jsxs("div",{className:"grid",children:[o.jsxs("div",{className:"col",children:[o.jsx(Te,{sectionId:"process","data-tour":Ee.diagram,title:"Process",description:`${y.processName} — live token (green), incidents (red).`,children:o.jsx(h.Suspense,{fallback:o.jsx("div",{className:"diagram-fallback",children:_.phase==="loading"?"Booting the engine…":"Loading diagram…"}),children:o.jsx(qi,{xml:w.resolvedBpmn,activeIds:(($e=_.snapshot)==null?void 0:$e.activeElementIds)??[],incidentIds:((Cn=_.snapshot)==null?void 0:Cn.incidentElementIds)??[],className:"diagram"})})}),de&&o.jsxs(Te,{sectionId:"human-task",title:(le==null?void 0:le.label)??"Human task",description:Le?`Rendered from the model's form "${le==null?void 0:le.formId}".`:"This task has no linked form — complete it with no variables.",children:[Je.length>0&&o.jsxs(me,{variant:"destructive",children:[o.jsx(pe,{children:"The agent didn't finish its checks"}),o.jsxs(ue,{children:["It completed without running"," ",Je.map(v=>v.label||v.elementId).join(", "),". The process took the default path to this task, so the findings below have no value to report."]})]}),Le&&o.jsx(h.Suspense,{fallback:o.jsx("div",{className:"form-fallback",children:"Loading form…"}),children:o.jsx(it,{ref:Ce,schema:Le,values:De,onChange:(v,x)=>Me(k=>({...k,[v]:x})),context:Y,onValidityChange:Ae})}),o.jsx(q,{onClick:bn,disabled:!!Le&&!un,children:"Complete task"})]}),fe&&o.jsx(Te,{sectionId:"manual-job",title:fe.control.label,description:"This job is held here on purpose — pick how it resolves.",children:o.jsxs("div",{className:"controls",children:[o.jsx(q,{onClick:()=>void nn("complete"),disabled:ee||V,children:fe.control.completeLabel??"✅ Complete normally"}),o.jsx(q,{variant:"secondary",onClick:()=>void nn("action"),disabled:ee||V,children:fe.control.action.label})]})}),o.jsxs("div",{className:"row",children:[o.jsx(Te,{sectionId:"variables",className:"grow","data-tour":Ee.variablesPanel,title:"Variables",description:"The instance payload, live.",children:o.jsx("pre",{className:"vars",children:yn(Y,2)})}),o.jsx(Ri,{log:E,elementStats:(Bn=_.snapshot)==null?void 0:Bn.elementStats,incidents:(Ln=_.snapshot)==null?void 0:Ln.incidents,labelFor:qe})]})]}),o.jsxs("div",{className:"col",children:[(y.agent||e.imageInput)&&o.jsx(Te,{sectionId:"brain","data-tour":Ee.brainPanel,title:"Brain",description:y.agent?`What drives “${y.agent.label}”. The model recommends; the process governs.`:"What reads the image. The model recommends; the process governs.",children:o.jsx(Ei,{brain:s,showText:!!y.agent,showVision:!!e.imageInput})}),o.jsxs(Te,{sectionId:"start",title:"Start",description:y.startFormId?`The model's start form "${y.startFormId}".`:e.imageInput?"Pick a seed photo or upload your own to read.":"The starting payload.",children:[e.imageInput&&o.jsx(Ti,{imageInput:e.imageInput,value:l,onSelect:m,disabled:ee}),e.scenarios&&o.jsx("div",{className:"scenarios",children:e.scenarios.map(v=>o.jsx(q,{size:"sm",variant:"secondary",disabled:ee,onClick:()=>W(x=>({...x,...v.variables})),children:v.label},v.label))}),I?o.jsx(h.Suspense,{fallback:o.jsx("div",{className:"form-fallback",children:"Loading form…"}),children:o.jsx(it,{ref:Pe,schema:I,values:C,onChange:(v,x)=>W(k=>({...k,[v]:x})),disabled:ee,onValidityChange:Ye})}):o.jsx("pre",{className:"vars",children:yn(C,2)})]}),o.jsx(Te,{sectionId:"code",className:"editors","data-tour":Ee.codePanel,title:"Code",description:"One handler per BPMN element, plus a model tab holding the editable diagram — select an element there to edit its properties. Return variables to merge, or throw to fail the job.",children:o.jsx(h.Suspense,{fallback:o.jsx("div",{className:"editor-fallback",children:"Loading editor…"}),children:o.jsxs(Vt,{value:Z,onValueChange:ce,children:[o.jsxs(Yt,{children:[o.jsx(rn,{value:tt,children:"model"}),y.agent&&o.jsx(rn,{value:wn,children:"agent (scripted)"}),e.handlers.map(v=>{var x;return o.jsx(rn,{value:v.elementId,children:((x=y.tasks.find(k=>k.elementId===v.elementId))==null?void 0:x.label)??v.elementId},v.elementId)}),Object.keys(u).map(v=>o.jsx(rn,{value:rt+v,children:v},v))]}),o.jsxs(on,{value:tt,children:[o.jsxs("div",{className:"editor-meta",children:[o.jsx("strong",{children:"Model"}),o.jsx("code",{children:"click an element to edit its properties on the right — Run re-reads whatever you leave here"}),o.jsx(q,{variant:"secondary",size:"sm",onClick:()=>i(e.bpmn),disabled:r===e.bpmn,children:"Revert to original"})]}),o.jsx(Ji,{value:r,onChange:i})]}),y.agent&&o.jsxs(on,{value:wn,children:[o.jsxs("div",{className:"editor-meta",children:[o.jsx("strong",{children:y.agent.label}),o.jsx("code",{children:s.kind==="scripted"||!s.chat?"in use":"unused — a live brain is connected"})]}),o.jsx("div",{className:"editor-wrap",children:o.jsx(fn,{height:"360px",defaultLanguage:"javascript",value:d,onChange:v=>g(v??""),options:vn})})]}),e.handlers.map(v=>{var x;return o.jsxs(on,{value:v.elementId,children:[o.jsxs("div",{className:"editor-meta",children:[o.jsx("strong",{children:((x=y.tasks.find(k=>k.elementId===v.elementId))==null?void 0:x.label)??v.elementId}),o.jsx("code",{children:v.standsInFor??v.elementId})]}),o.jsx("div",{className:"editor-wrap",children:o.jsx(fn,{height:"360px",defaultLanguage:"javascript",value:p[v.elementId],onChange:k=>a(D=>({...D,[v.elementId]:k??""})),options:vn})})]},v.elementId)}),Object.keys(u).map(v=>o.jsxs(on,{value:rt+v,children:[o.jsxs("div",{className:"editor-meta",children:[o.jsx("strong",{children:v}),o.jsxs("code",{children:["prompt / template text — substitutes"," ","{{"+v+"}}"]})]}),o.jsx("div",{className:"editor-wrap",children:o.jsx(fn,{height:"360px",defaultLanguage:"markdown",value:u[v],onChange:x=>b(k=>Xe(k,{[v]:x??""})),options:vn})})]},v))]})})}),y.agent&&o.jsx(Te,{sectionId:"tools",title:"Tools, as the model sees them",description:o.jsxs(o.Fragment,{children:["Read from the diagram — element name, documentation, and every",o.jsx("code",{children:" fromAi(…)"})," argument."]}),children:o.jsx("ul",{className:"tool-list",children:y.agent.tools.map(v=>o.jsxs("li",{children:[o.jsx("code",{children:v.elementId}),o.jsxs("span",{children:[" — ",v.documentation||v.label]}),v.args.length>0&&o.jsx("ul",{children:v.args.map(x=>o.jsxs("li",{children:[o.jsxs("code",{children:[x.name,": ",x.type]})," ","— ",x.description]},x.name))})]},v.elementId))})})]})]})]})}const vn={minimap:{enabled:!1},fontSize:13,scrollBeyondLastLine:!1,tabSize:2,automaticLayout:!0},Wi=`<?xml version="1.0" encoding="UTF-8"?>\r
...
}`,go={id:"learn-multi-instance-parallel",title:"Parallel multi-instance",group:"learn-bpmn",blurb:`A multi-instance activity runs its task once per element of a collection, spawning that many job instances of the same element in parallel, and only lets the token move on once every one of them completes. Run this and watch three 'Process item' jobs activate together for apple, banana, cherry, and complete (in any order) before the process reaches its end event. Nothing about the diagram says "three" — that comes from the collection, so use the buttons in the Start panel on the right to swap between one, three, and six items and hit Run again; the Activity panel logs one 'Process item' line per element, so the fan-out is right there to count. The property tying the two together is in the Code panel: open the model tab, click "Process item", and expand Multi-instance in the properties panel on the right — Input collection holds \`items\`, the FEEL expression naming the variable to fan out over. Drop it entirely and the activity silently degenerates to a single ordinary instance, with no error to tell you it happened. Revert to original puts it back.`,docsUrl:"https://docs.camunda.io/docs/components/modeler/bpmn/multi-instance/",bpmn:po,seed:{items:["apple","banana","cherry"]},scenarios:[{label:"One item — a single instance",variables:{items:["apple"]}},{label:"Three items — fans out to three",variables:{items:["apple","banana","cherry"]}},{label:"Six items — fans out to six",variables:{items:["apple","banana","cherry","damson","elderberry","fig"]}}],handlers:[{elementId:"Activity_process",standsInFor:"job worker — process-item",source:uo}]},ho=Object.freeze(Object.defineProperty({__proto__:null,default:go},Symbol.toStringTag,{value:"Module"})),bo=`<?xml version="1.0" encoding="UTF-8"?>\r
...
}`,fo={id:"learn-service-task",title:"Service task + sequence flow",group:"learn-bpmn",blurb:`A service task is a unit of work a worker (not a human) performs; a sequence flow is the arrow that hands the token from one to the next once its task completes. Run this and watch each task activate, run its handler, and complete in order — Prepare package, then Dispatch courier — before the process reaches its end event. The link between the two halves is the job type: in the Code panel, open the model tab, click "Prepare package", and expand Task definition in the properties panel on the right — Job type is the name a worker has to subscribe to in order to be handed this task's work. (This page wires its own handlers up from whatever the model declares, so renaming it here keeps working; on a real cluster the worker is a separate process started with a job type of its own, and a mismatch means nobody ever activates the job, so the run stalls forever.)`,docsUrl:"https://docs.camunda.io/docs/components/modeler/bpmn/service-tasks/",bpmn:bo,seed:{item:"camunda-t-shirt"},handlers:[{elementId:"Activity_prepare",standsInFor:"job worker — prepare-package",source:_o},{elementId:"Activity_dispatch",standsInFor:"job worker — dispatch-courier",source:wo}]},yo=Object.freeze(Object.defineProperty({__proto__:null,default:fo},Symbol.toStringTag,{value:"Module"})),vo=`<?xml version="1.0" encoding="UTF-8"?>\r
...
`,Po="Camunda Cloud",Ao="8.10.0",Do={name:"Camunda Web Modeler",version:"9b5d5ef"},Co=19,Bo="learn-user-task-form-review",Lo=[{text:`# Review request
...
`,$o=`Please verify export compliance for this shipment and notify the team of your decision.\r
`,Go={id:"compliance-walkthrough",label:"Take the tour",steps:[{title:"Start a run",description:"Press Run to send a shipment through the compliance agent.",target:{anchor:Ee.runButton}},{title:"The agent picks its own tools",description:"This AI Agent reads the shipment notes and decides, turn by turn, which of the tools below it to call — nothing here is hard-coded into a fixed sequence.",target:{elementId:"ComplianceCheckAgent"}},{title:"Watch the token move",description:"The agent's first move is to look up the genetic marker mentioned in the notes.",target:{elementId:"VerifyGeneticMarker"},waitFor:{kind:"activeElement",elementId:"VerifyGeneticMarker"}},{title:"A cleared shipment notifies the export team",description:"Once the compliance score comes back clean, the process notifies the export team automatically — no human review needed for this scenario.",target:{elementId:"NotifyExportTeam"},waitFor:{kind:"elementCompleted",elementId:"NotifyExportTeam"}},{title:"Everything the run recorded",description:"The variables panel shows the marker record, the country lookup, the compliance score, and the final decision — exactly what each tool and the agent wrote along the way.",target:{anchor:Ee.variablesPanel}}],successEvent:{kind:"instanceCompleted"}},Vo=`<?xml version="1.0" encoding="UTF-8"?>
...
}`,ba={id:"seed-export-compliance",title:"Seed export compliance agent",blurb:"An AI agent picks its own tools to check a shipment, then a gateway routes on its decision — cleared shipments notify the export team, flagged ones go to a human. The LLM recommends; the BPMN process governs.",docsUrl:"https://camunda.com/blog/agentic-ai/",bpmn:Vo,forms:{"seed-export-shipment-ready":Ko,"seed-export-compliance-review":aa},seed:{scenario:ot,shipmentNotes:""},scenarios:[{label:"Likely cleared (TP53 → Brazil)",variables:{scenario:ot,shipmentNotes:""}},{label:"Likely flagged (BRCA1 → Germany)",variables:{scenario:la,shipmentNotes:""}}],scriptedAgent:ca,templates:da,tour:Go,requiredTools:["RecordComplianceDecision"],handlers:[{elementId:"VerifyGeneticMarker",standsInFor:"JDBC connector — UCSC hg38",source:ma},{elementId:"CheckDestinationCountry",standsInFor:"GraphQL connector — countries API",source:pa},{elementId:"ComputeComplianceScore",standsInFor:"REST connector — api.mathjs.org",source:ua},{elementId:"RecordComplianceDecision",standsInFor:"Script task — FEEL",source:ga},{elementId:"NotifyExportTeam",standsInFor:"REST connector — httpbin.io",source:ha}]},_a=`You are a loan origination assistant at a retail bank. Your job is to gather everything a senior loan officer needs to decide an application — you do **not** decide it yourself.
...
}`,$a=`async (job, { text, num, sleep, trace }) => {
...
}`,qa={id:"loan-origination",title:"Loan origination agent",blurb:"An AI agent gathers a loan case with its own tools — customer lookup, credit bureau, an underwriting policy, a status update — then every application passes through a mandatory senior-officer review before a gateway routes it to an offer or a decline. The agent advises; the process governs.",docsUrl:"https://camunda.com/orchestrate/agents/",bpmn:ya,forms:{"loan-application":Ta,"loan-senior-officer-review":La},seed:at,scenarios:[{label:"Strong applicant (policy recommends approve)",variables:at},{label:"Marginal applicant (policy recommends decline)",variables:za}],scriptedAgent:Oa,templates:Fa,tour:fa,requiredTools:["AssessApplication","UpdateApplicationStatus"],handlers:[{elementId:"QueryCustomer",standsInFor:"CRM connector — customer lookup",source:Ua},{elementId:"CreditBureauLookup",standsInFor:"REST connector — credit bureau",source:$a},{elementId:"AssessApplication",standsInFor:"Script task — underwriting policy (FEEL)",source:Ga},{elementId:"UpdateApplicationStatus",standsInFor:"REST connector — origination system",source:Va},{elementId:"IssueLoanOffer",standsInFor:"REST connector — offer/booking system",source:Ya},{elementId:"SendDeclineNotice",standsInFor:"REST connector — notifications",source:Qa}]},Ja=`<?xml version="1.0" encoding="UTF-8"?>
...
}`,Za=`async (job, { sleep, trace }) => {
  await sleep(400);
  trace("handing over to the carrier");

  // Throw to fail the job and raise an incident on the diagram — try it.
  return { shipped: true, tracking: "1Z" + Math.floor(Math.random() * 1e9) };
}`,Ka={id:"order-process",title:"Order process with service workers",blurb:"The getting-started order process: check inventory, charge payment, ship. No agent and no human step — the same runner, driven entirely by what's in the diagram.",docsUrl:"https://docs.camunda.io/docs/next/guides/getting-started-orchestration-cluster/",bpmn:Ja,seed:{item:"camunda-t-shirt",quantity:3},handlers:[{elementId:"Activity_0tw2fu0",standsInFor:"job worker — check-inventory",source:Ha},{elementId:"Activity_1ppsbgi",standsInFor:"job worker — charge-payment",source:Wa},{elementId:"Activity_08pg6im",standsInFor:"job worker — ship-items",source:Za}]},Xa=`<?xml version="1.0" encoding="UTF-8"?>\r
...
}`,ns={id:"rocket-launch",title:"Rocket launch",blurb:"The getting-started rocket launch, boiled down to one service task: launch. The smallest possible example, and the smallest possible test of the framework's extensibility.",bpmn:Xa,seed:{missionName:"Apollo 11",destination:"the Moon",fuelLevel:100},scenarios:[{label:"Full tanks — launch succeeds",variables:{missionName:"Apollo 11",destination:"the Moon",fuelLevel:100}},{label:"Low fuel — mission scrubbed",variables:{missionName:"Apollo 13",destination:"the Moon",fuelLevel:30}}],handlers:[{elementId:"Activity_LaunchRocket",standsInFor:"job worker — launch-rocket",source:es}]},ts=`<?xml version="1.0" encoding="UTF-8"?>\r
...
`,rs=`async (job, { text, sleep }) => {
  ...
  return { shipped: true, tracking: "1Z" + Math.floor(Math.random() * 1e9) };
}`,as={id:"order-process-boundary-events",title:"Order process with boundary events",blurb:"The getting-started order process, extended with a timer and an error boundary event: charge payment can be declined, and a delayed shipment can escalate — both fired by hand from the runner rather than by chance.",docsUrl:"https://github.com/camunda/camunda-8-get-started/tree/main/2-order-process-with-service-workers",bpmn:ts,seed:{item:"camunda-t-shirt",quantity:3},handlers:[{elementId:"Activity_0tw2fu0",standsInFor:"job worker — check-inventory",source:rs},{elementId:"Activity_1ppsbgi",standsInFor:"job worker — charge-payment",source:is,manualControl:{label:"Charge payment method",completeLabel:"✅ Complete normally",action:{kind:"error",errorCode:"CHARGE_DECLINED",message:"The card issuer declined the charge.",label:"❌ Simulate: card declined"}}},{elementId:"Activity_08pg6im",standsInFor:"job worker — ship-items",source:os,manualControl:{label:"Ship items",completeLabel:"✅ Ship it",action:{kind:"timer",label:"🕐 Fire the shipping-delayed timer"}}}]},ss="/pr-preview/pr-99/assets/de-bmw-mini-JBSk7QcF.jpg",ds="/pr-preview/pr-99/assets/de-bmw-mini.thumb-CUUmJrRO.jpg",ls="/pr-preview/pr-99/assets/uk-d651-rnb-XGipy2QN.jpg",cs="/pr-preview/pr-99/assets/uk-d651-rnb.thumb-mjEcbhUf.jpg",ms="/pr-preview/pr-99/assets/uk-mk70-orj-Cn6O3Xfm.jpg",ps="/pr-preview/pr-99/assets/uk-mk70-orj.thumb-CaeZ2vqU.jpg",us="/pr-preview/pr-99/assets/uk-ni-ijz-8992-YXV44tgk.jpg",gs="/pr-preview/pr-99/assets/uk-ni-ijz-8992.thumb-DYwok8jV.jpg",hs="/pr-preview/pr-99/assets/us-hyundai-genesis-gGpAIEpi.jpg",bs="/pr-preview/pr-99/assets/us-hyundai-genesis.thumb-DEEt19Mw.jpg",_s=`<?xml version="1.0" encoding="UTF-8"?>
...
}`,Js={id:"plate-recognition",title:"Read a number plate from a photo",blurb:"Pick the plate's country, then a photo goes into the run, an in-browser vision model reads the number plate on the reader's own GPU, and a human confirms or corrects it before the process records the result. The vision model recommends; the BPMN process governs. No server, no API key — with no model connected it falls back to a deterministic scripted reading.",docsUrl:"https://docs.camunda.io/docs/components/modeler/forms/camunda-forms-reference/",bpmn:_s,forms:{"plate-recognition-country":Us,"plate-recognition-confirm":Es,"plate-recognition-manual":Ds},seed:{country:"auto"},imageInput:{label:"Pick a seed photo (its plate is known, so the scripted reader works offline) or upload your own — a live in-browser model reads a photo it has never seen.",seedImages:Vs},scriptedVision:Ys,handlers:[{elementId:"ExtractPlate",standsInFor:"Vision model — Florence-2 <OCR> on WebGPU (in-browser)",source:Qs},{elementId:"RecordResult",standsInFor:"Script task — records the governed outcome",source:qs}]},Hs=[ns,ba,qa,Ka,as,Js],Ws=Object.assign({"./learn-error-boundary/index.ts":eo,"./learn-exclusive-gateway/index.ts":ao,"./learn-message-correlation/index.ts":mo,"./learn-multi-instance-parallel/index.ts":ho,"./learn-service-task/index.ts":yo,"./learn-signal-broadcast/index.ts":Eo,"./learn-timer-catch-event/index.ts":jo,"./learn-user-task-form/index.ts":Oo}),Zs=Object.values(Ws).map(e=>e.default).sort((e,n)=>e.id.localeCompare(n.id)),He=[...Hs,...Zs];function Dn(){return"/pr-preview/pr-99/"}function Ks(e){const n=Dn();return e.startsWith(n)?"/"+e.slice(n.length):e}function Xs(e=location.pathname){const t=Ks(e).match(/^\/examples\/([^/]+)\/?$/);if(t)try{return{kind:"example",id:decodeURIComponent(t[1])}}catch{return{kind:"gallery"}}return{kind:"gallery"}}function ed(e=location.search){return new URLSearchParams(e).get("embed")==="1"}function nd(){return Dn()}function dt(e){return`${Dn()}examples/${encodeURIComponent(e)}`}function lt(e,n={}){const t=new URL(location.href);t.pathname=e,t.search=n.search??t.search,n.hash!==void 0&&(t.hash=n.hash),n.replace?history.replaceState(history.state,"",t):history.pushState(history.state,"",t),window.dispatchEvent(new PopStateEvent("popstate"))}function ct(){return{route:Xs(),embed:ed()}}function td(){const[e,n]=h.useState(ct);return h.useEffect(()=>{const t=()=>n(ct());return window.addEventListener("popstate",t),()=>window.removeEventListener("popstate",t)},[]),e}const rd="web-demo-framework:height",id="web-demo-framework:request-height";function od(e){return{type:rd,height:Math.ceil(e)}}const mt="embed-height-auto";function ad(e){h.useEffect(()=>{if(!e||typeof window>"u"||window.parent===window)return;const n=document.documentElement;n.classList.add(mt);let t=-1;const r=(l=!1)=>{const m=document.documentElement.scrollHeight;!l&&Math.abs(m-t)<2||(t=m,window.parent.postMessage(od(m),"*"))},i=l=>{if(l.source!==window.parent)return;const m=l.data;!m||m.type!==id||r(!0)};window.addEventListener("message",i),r();const s=new ResizeObserver(()=>r());return s.observe(n),()=>{s.disconnect(),window.removeEventListener("message",i),n.classList.remove(mt)}},[e])}function sd(){const{route:e,embed:n}=td(),t=St().brain,r=Fi();ad(n);const i=e.kind==="example"?e.id:He[0].id,s=He.find(d=>d.id===i)??He[0],l=He.filter(d=>d.group!=="learn-bpmn"),m=He.filter(d=>d.group==="learn-bpmn"),p=d=>{lt(dt(d),{hash:location.hash})},a=o.jsxs(o.Fragment,{children:[!n&&e.kind==="gallery"&&o.jsxs(o.Fragment,{children:[o.jsx("nav",{className:"example-picker","aria-label":"Scenario examples",children:l.map(d=>o.jsx(q,{size:"sm",variant:d.id===s.id?"default":"secondary",onClick:()=>p(d.id),children:d.title},d.id))}),m.length>0&&o.jsxs(o.Fragment,{children:[o.jsx("h2",{className:"example-group-heading",id:"learn-bpmn-heading",children:"Learn BPMN"}),o.jsx("nav",{className:"example-picker","aria-labelledby":"learn-bpmn-heading",children:m.map(d=>o.jsx(q,{size:"sm",variant:d.id===s.id?"default":"secondary",onClick:()=>p(d.id),children:d.title},d.id))})]})]}),!n&&e.kind==="example"&&o.jsx("div",{className:"example-nav",children:o.jsx(q,{size:"sm",variant:"secondary",onClick:()=>lt(nd()),children:"← All examples"})}),o.jsxs("div",{className:"example-meta",children:[s.docsUrl&&o.jsx("a",{className:"docs-link",href:s.docsUrl,target:"_blank",rel:"noreferrer noopener",children:"View on camunda.com ↗"}),n&&o.jsx("a",{className:"open-full-page",href:dt(s.id)+(location.hash||""),target:"_top",rel:"noreferrer",children:"Open full page ↗"})]}),o.jsx(Hi,{example:s,initialBrainKind:t,initialTourId:r},s.id)]});return n?o.jsx("div",{className:"c4-ui app-shell app-embed",children:o.jsx("main",{id:"main",className:"layout layout-embed",children:a})}):o.jsxs("div",{className:"c4-ui app-shell",children:[o.jsx(Qt,{appName:"Runnable Camunda examples",trailing:o.jsx("span",{className:"app-subtitle",children:"model + code + optional LLM, in your browser"})}),o.jsx("main",{id:"main",className:"layout",children:a})]})}Rt.createRoot(document.getElementById("root")).render(o.jsx(h.StrictMode,{children:o.jsx(qt,{children:o.jsx(sd,{})})}));export{_e as _,md as c};
