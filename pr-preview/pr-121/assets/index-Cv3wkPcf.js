...
`)}async function ai(e,n,t,o,r,s){let d="";n({kind:"llm",text:"LLM thinking…",key:t,pending:!0,turn:s});const c=await e(o,r,m=>{d+=m,n({kind:"llm",text:`${Tn(d)} ▍`,key:t,pending:!0,turn:s})});return n({kind:"llm",text:Tn(c||d)||"(empty reply)",key:t,pending:!1,turn:s}),c}function si(e,n){switch(e){case"number":return typeof n=="number"&&Number.isFinite(n)?{ok:!0,value:n}:typeof n=="string"&&n.trim()!==""&&Number.isFinite(Number(n))?{ok:!0,value:Number(n)}:{ok:!1};case"boolean":return typeof n=="boolean"?{ok:!0,value:n}:typeof n=="string"&&/^(true|false)$/i.test(n.trim())?{ok:!0,value:n.trim().toLowerCase()==="true"}:{ok:!1};default:return typeof n=="object"?{ok:!1}:{ok:!0,value:String(n)}}}function di(e,n,t){const o={},r=new Map,s=new Map;for(const{tool:d,args:c}of e){const m={};for(const a of d.args){const p=c[a.name];if(!(p!=null&&p!=="")){n({kind:"error",text:`🤖 ${d.elementId}: model supplied no value for "${a.name}"`,turn:t,elementId:d.elementId});continue}const g=r.get(a.name);if(g!==void 0&&g!==d.elementId){n({kind:"error",text:`🤖 argument name collision on "${a.name}": both ${g} and ${d.elementId} declare it — ${g} already claimed it this turn, ${d.elementId}'s value is dropped`,turn:t,elementId:d.elementId});continue}const h=si(a.type,p);if(!h.ok){n({kind:"error",text:`🤖 ${d.elementId}: "${a.name}" is declared as ${a.type} but the model supplied ${JSON.stringify(p)} — rejected, not passed through`,turn:t,elementId:d.elementId});continue}o[a.name]=h.value,m[a.name]=h.value,r.set(a.name,d.elementId)}s.set(d.elementId,m)}return{variablesOut:o,forHistory:s}}function li(e,n,t,o={}){const{maxNewTokens:r=384,allowRepeats:s=!1,allowMultiToolTurns:d=!1,turnRef:c,requiredTools:m=[],maxEarlyDoneNudges:a=1,maxUnproductiveTurns:p=3}=o;let u=0;const g=new Set,h=[];let f=0,N=[],v=[];return async _=>{const x=_.variables,E=x.toolCallResult;E!==void 0&&h.length&&(h[h.length-1]=`${h[h.length-1]} → ${Tn(JSON.stringify(E),160)}`);let q=0;for(;;){const J=await Y();if(J)return J;if(q+=1,q>=p)return t({kind:"error",text:`🤖 ${q} turns in a row activated nothing — completing the agent. The model has lost the reply format; whatever it has already run stands.`,turn:u}),{completionConditionFulfilled:!0}}async function Y(){if(u+=1,c&&(c.current=u),u>e.maxModelCalls)return t({kind:"error",text:`Turn budget spent (maxModelCalls=${e.maxModelCalls}) — completing the agent.`,turn:u}),{completionConditionFulfilled:!0};const J=s?e.tools:e.tools.filter(P=>!g.has(P.elementId));if(J.length===0)return t({kind:"agent",text:"🤖 every tool has run — completing the agent",turn:u}),{completionConditionFulfilled:!0};const be=[{role:"system",content:ii(e,d,J)},{role:"user",content:ri(e,x,h,J,N,v,s)}];N=[],v=[];let Ce;try{Ce=await ai(n,t,`llm-turn-${u}`,be,r,u)}catch(P){return t({kind:"error",text:`LLM call failed: ${P instanceof Error?P.message:String(P)} — completing the agent.`,turn:u}),{completionConditionFulfilled:!0}}const ge=ti(Ce);if(oi(ge)&&at(ge).length===0){const P=m.filter(j=>!g.has(j));return P.length&&f<a?(f+=1,N=P,t({kind:"agent",text:`🤖 model says it is done, but ${P.join(", ")} hasn't run — asking once more`,turn:u}),null):(t({kind:"agent",text:"🤖 model says it is done",turn:u}),{completionConditionFulfilled:!0})}const Me=at(ge);if(Me.length===0)return t({kind:"error",text:"🤖 model named no tool (and didn't say it was done) — asking again",turn:u}),v=['it named no tool and did not say it was done — reply with {"tool": "...", "arguments": {...}} or {"done": true}'],null;const ee=[],fe=[],de=[];for(const P of Me){const j=e.tools.find(H=>H.elementId===P.name);if(!j){fe.push(P.name);continue}if(!s&&g.has(j.elementId)){de.push(j.elementId);continue}ee.push({tool:j,args:P.args})}if(fe.length&&t({kind:"error",text:`🤖 model named a tool that doesn't exist: ${fe.join(", ")} — nothing activated`,turn:u}),de.length&&t({kind:"error",text:`🤖 model asked to re-run ${de.join(", ")} — skipped (already run)`,turn:u}),ee.length===0)return t({kind:"agent",text:"🤖 nothing activated — asking again",turn:u}),v=[...fe.length?[`${fe.join(", ")} ${fe.length===1?"is":"are"} not a real tool`]:[],...de.length?[`${de.join(", ")} has already run and will never run again — pick a different tool, or reply {"done": true} if nothing is left to do`]:[]],null;const{variablesOut:C,forHistory:S}=di(ee,t,u);for(const{tool:P}of ee)g.add(P.elementId),h.push(`- ${P.elementId}(${JSON.stringify(S.get(P.elementId))})`);for(const{tool:P}of ee)t({kind:"agent",text:`🤖 calling ${P.elementId}`,turn:u,elementId:P.elementId,args:S.get(P.elementId)??{}});return{activateElements:ee.map(P=>({elementId:P.tool.elementId})),variables:C}}}}function ci(e,n,t,o={}){const r=new Map(e.map(s=>[s.elementId,li(s,n,t,o)]));return async s=>{const d=r.get(s.elementId);if(!d)throw new Error(`No agent host registered for "${s.elementId}"`);return d(s)}}class Fn{__destroy_into_raw(){const n=this.__wbg_ptr;return this.__wbg_ptr=0,dt.unregister(this),n}free(){const n=this.__destroy_into_raw();l.__wbg_testengine_free(n,0)}activateJobs(n,t,o,r){let s,d;try{const h=l.__wbindgen_add_to_stack_pointer(-16),f=A(n,l.__wbindgen_export,l.__wbindgen_export2),N=I,v=A(r,l.__wbindgen_export,l.__wbindgen_export2),_=I;l.testengine_activateJobs(h,this.__wbg_ptr,f,N,t,o,v,_);var c=y().getInt32(h+0,!0),m=y().getInt32(h+4,!0),a=y().getInt32(h+8,!0),p=y().getInt32(h+12,!0),u=c,g=m;if(p)throw u=0,g=0,V(a);return s=u,d=g,$(u,g)}finally{l.__wbindgen_add_to_stack_pointer(16),l.__wbindgen_export3(s,d,1)}}advanceTime(n){let t,o;try{const p=l.__wbindgen_add_to_stack_pointer(-16);l.testengine_advanceTime(p,this.__wbg_ptr,n);var r=y().getInt32(p+0,!0),s=y().getInt32(p+4,!0),d=y().getInt32(p+8,!0),c=y().getInt32(p+12,!0),m=r,a=s;if(c)throw m=0,a=0,V(d);return t=m,o=a,$(m,a)}finally{l.__wbindgen_add_to_stack_pointer(16),l.__wbindgen_export3(t,o,1)}}assignUserTask(n,t,o){let r,s;try{const g=l.__wbindgen_add_to_stack_pointer(-16),h=A(n,l.__wbindgen_export,l.__wbindgen_export2),f=I,N=A(t,l.__wbindgen_export,l.__wbindgen_export2),v=I;l.testengine_assignUserTask(g,this.__wbg_ptr,h,f,N,v,o);var d=y().getInt32(g+0,!0),c=y().getInt32(g+4,!0),m=y().getInt32(g+8,!0),a=y().getInt32(g+12,!0),p=d,u=c;if(a)throw p=0,u=0,V(m);return r=p,s=u,$(p,u)}finally{l.__wbindgen_add_to_stack_pointer(16),l.__wbindgen_export3(r,s,1)}}broadcastSignal(n,t){let o,r;try{const u=l.__wbindgen_add_to_stack_pointer(-16),g=A(n,l.__wbindgen_export,l.__wbindgen_export2),h=I,f=A(t,l.__wbindgen_export,l.__wbindgen_export2),N=I;l.testengine_broadcastSignal(u,this.__wbg_ptr,g,h,f,N);var s=y().getInt32(u+0,!0),d=y().getInt32(u+4,!0),c=y().getInt32(u+8,!0),m=y().getInt32(u+12,!0),a=s,p=d;if(m)throw a=0,p=0,V(c);return o=a,r=p,$(a,p)}finally{l.__wbindgen_add_to_stack_pointer(16),l.__wbindgen_export3(o,r,1)}}cancelInstance(n){let t,o;try{const p=l.__wbindgen_add_to_stack_pointer(-16),u=A(n,l.__wbindgen_export,l.__wbindgen_export2),g=I;l.testengine_cancelInstance(p,this.__wbg_ptr,u,g);var r=y().getInt32(p+0,!0),s=y().getInt32(p+4,!0),d=y().getInt32(p+8,!0),c=y().getInt32(p+12,!0),m=r,a=s;if(c)throw m=0,a=0,V(d);return t=m,o=a,$(m,a)}finally{l.__wbindgen_add_to_stack_pointer(16),l.__wbindgen_export3(t,o,1)}}completeAgentJob(n,t,o){let r,s;try{const g=l.__wbindgen_add_to_stack_pointer(-16),h=A(n,l.__wbindgen_export,l.__wbindgen_export2),f=I,N=A(t,l.__wbindgen_export,l.__wbindgen_export2),v=I,_=A(o,l.__wbindgen_export,l.__wbindgen_export2),x=I;l.testengine_completeAgentJob(g,this.__wbg_ptr,h,f,N,v,_,x);var d=y().getInt32(g+0,!0),c=y().getInt32(g+4,!0),m=y().getInt32(g+8,!0),a=y().getInt32(g+12,!0),p=d,u=c;if(a)throw p=0,u=0,V(m);return r=p,s=u,$(p,u)}finally{l.__wbindgen_add_to_stack_pointer(16),l.__wbindgen_export3(r,s,1)}}completeJob(n,t){let o,r;try{const u=l.__wbindgen_add_to_stack_pointer(-16),g=A(n,l.__wbindgen_export,l.__wbindgen_export2),h=I,f=A(t,l.__wbindgen_export,l.__wbindgen_export2),N=I;l.testengine_completeJob(u,this.__wbg_ptr,g,h,f,N);var s=y().getInt32(u+0,!0),d=y().getInt32(u+4,!0),c=y().getInt32(u+8,!0),m=y().getInt32(u+12,!0),a=s,p=d;if(m)throw a=0,p=0,V(c);return o=a,r=p,$(a,p)}finally{l.__wbindgen_add_to_stack_pointer(16),l.__wbindgen_export3(o,r,1)}}completeUserTask(n,t){let o,r;try{const u=l.__wbindgen_add_to_stack_pointer(-16),g=A(n,l.__wbindgen_export,l.__wbindgen_export2),h=I,f=A(t,l.__wbindgen_export,l.__wbindgen_export2),N=I;l.testengine_completeUserTask(u,this.__wbg_ptr,g,h,f,N);var s=y().getInt32(u+0,!0),d=y().getInt32(u+4,!0),c=y().getInt32(u+8,!0),m=y().getInt32(u+12,!0),a=s,p=d;if(m)throw a=0,p=0,V(c);return o=a,r=p,$(a,p)}finally{l.__wbindgen_add_to_stack_pointer(16),l.__wbindgen_export3(o,r,1)}}correlateMessage(n,t,o){let r,s;try{const g=l.__wbindgen_add_to_stack_pointer(-16),h=A(n,l.__wbindgen_export,l.__wbindgen_export2),f=I,N=A(t,l.__wbindgen_export,l.__wbindgen_export2),v=I,_=A(o,l.__wbindgen_export,l.__wbindgen_export2),x=I;l.testengine_correlateMessage(g,this.__wbg_ptr,h,f,N,v,_,x);var d=y().getInt32(g+0,!0),c=y().getInt32(g+4,!0),m=y().getInt32(g+8,!0),a=y().getInt32(g+12,!0),p=d,u=c;if(a)throw p=0,u=0,V(m);return r=p,s=u,$(p,u)}finally{l.__wbindgen_add_to_stack_pointer(16),l.__wbindgen_export3(r,s,1)}}createInstance(n,t,o){let r,s;try{const g=l.__wbindgen_add_to_stack_pointer(-16),h=A(n,l.__wbindgen_export,l.__wbindgen_export2),f=I,N=A(t,l.__wbindgen_export,l.__wbindgen_export2),v=I;l.testengine_createInstance(g,this.__wbg_ptr,h,f,N,v,bi(o)?Number.MAX_SAFE_INTEGER:o>>0);var d=y().getInt32(g+0,!0),c=y().getInt32(g+4,!0),m=y().getInt32(g+8,!0),a=y().getInt32(g+12,!0),p=d,u=c;if(a)throw p=0,u=0,V(m);return r=p,s=u,$(p,u)}finally{l.__wbindgen_add_to_stack_pointer(16),l.__wbindgen_export3(r,s,1)}}debugClear(){l.testengine_debugClear(this.__wbg_ptr)}debugCreateInstance(n,t,o){let r,s;try{const g=l.__wbindgen_add_to_stack_pointer(-16),h=A(n,l.__wbindgen_export,l.__wbindgen_export2),f=I,N=A(t,l.__wbindgen_export,l.__wbindgen_export2),v=I,_=A(o,l.__wbindgen_export,l.__wbindgen_export2),x=I;l.testengine_debugCreateInstance(g,this.__wbg_ptr,h,f,N,v,_,x);var d=y().getInt32(g+0,!0),c=y().getInt32(g+4,!0),m=y().getInt32(g+8,!0),a=y().getInt32(g+12,!0),p=d,u=c;if(a)throw p=0,u=0,V(m);return r=p,s=u,$(p,u)}finally{l.__wbindgen_add_to_stack_pointer(16),l.__wbindgen_export3(r,s,1)}}get debugIsPaused(){return l.testengine_debugIsPaused(this.__wbg_ptr)!==0}debugResume(){let n,t;try{const a=l.__wbindgen_add_to_stack_pointer(-16);l.testengine_debugResume(a,this.__wbg_ptr);var o=y().getInt32(a+0,!0),r=y().getInt32(a+4,!0),s=y().getInt32(a+8,!0),d=y().getInt32(a+12,!0),c=o,m=r;if(d)throw c=0,m=0,V(s);return n=c,t=m,$(c,m)}finally{l.__wbindgen_add_to_stack_pointer(16),l.__wbindgen_export3(n,t,1)}}debugStep(){let n,t;try{const a=l.__wbindgen_add_to_stack_pointer(-16);l.testengine_debugStep(a,this.__wbg_ptr);var o=y().getInt32(a+0,!0),r=y().getInt32(a+4,!0),s=y().getInt32(a+8,!0),d=y().getInt32(a+12,!0),c=o,m=r;if(d)throw c=0,m=0,V(s);return n=c,t=m,$(c,m)}finally{l.__wbindgen_add_to_stack_pointer(16),l.__wbindgen_export3(n,t,1)}}deploy(n){let t,o;try{const p=l.__wbindgen_add_to_stack_pointer(-16),u=A(n,l.__wbindgen_export,l.__wbindgen_export2),g=I;l.testengine_deploy(p,this.__wbg_ptr,u,g);var r=y().getInt32(p+0,!0),s=y().getInt32(p+4,!0),d=y().getInt32(p+8,!0),c=y().getInt32(p+12,!0),m=r,a=s;if(c)throw m=0,a=0,V(d);return t=m,o=a,$(m,a)}finally{l.__wbindgen_add_to_stack_pointer(16),l.__wbindgen_export3(t,o,1)}}deployForm(n){let t,o;try{const p=l.__wbindgen_add_to_stack_pointer(-16),u=A(n,l.__wbindgen_export,l.__wbindgen_export2),g=I;l.testengine_deployForm(p,this.__wbg_ptr,u,g);var r=y().getInt32(p+0,!0),s=y().getInt32(p+4,!0),d=y().getInt32(p+8,!0),c=y().getInt32(p+12,!0),m=r,a=s;if(c)throw m=0,a=0,V(d);return t=m,o=a,$(m,a)}finally{l.__wbindgen_add_to_stack_pointer(16),l.__wbindgen_export3(t,o,1)}}deployResource(n,t){let o,r;try{const u=l.__wbindgen_add_to_stack_pointer(-16),g=A(n,l.__wbindgen_export,l.__wbindgen_export2),h=I,f=A(t,l.__wbindgen_export,l.__wbindgen_export2),N=I;l.testengine_deployResource(u,this.__wbg_ptr,g,h,f,N);var s=y().getInt32(u+0,!0),d=y().getInt32(u+4,!0),c=y().getInt32(u+8,!0),m=y().getInt32(u+12,!0),a=s,p=d;if(m)throw a=0,p=0,V(c);return o=a,r=p,$(a,p)}finally{l.__wbindgen_add_to_stack_pointer(16),l.__wbindgen_export3(o,r,1)}}events(){let n,t;try{const a=l.__wbindgen_add_to_stack_pointer(-16);l.testengine_events(a,this.__wbg_ptr);var o=y().getInt32(a+0,!0),r=y().getInt32(a+4,!0),s=y().getInt32(a+8,!0),d=y().getInt32(a+12,!0),c=o,m=r;if(d)throw c=0,m=0,V(s);return n=c,t=m,$(c,m)}finally{l.__wbindgen_add_to_stack_pointer(16),l.__wbindgen_export3(n,t,1)}}failJob(n,t,o){let r,s;try{const g=l.__wbindgen_add_to_stack_pointer(-16),h=A(n,l.__wbindgen_export,l.__wbindgen_export2),f=I,N=A(o,l.__wbindgen_export,l.__wbindgen_export2),v=I;l.testengine_failJob(g,this.__wbg_ptr,h,f,t,N,v);var d=y().getInt32(g+0,!0),c=y().getInt32(g+4,!0),m=y().getInt32(g+8,!0),a=y().getInt32(g+12,!0),p=d,u=c;if(a)throw p=0,u=0,V(m);return r=p,s=u,$(p,u)}finally{l.__wbindgen_add_to_stack_pointer(16),l.__wbindgen_export3(r,s,1)}}migrate(n,t,o){let r,s;try{const g=l.__wbindgen_add_to_stack_pointer(-16),h=A(n,l.__wbindgen_export,l.__wbindgen_export2),f=I,N=A(t,l.__wbindgen_export,l.__wbindgen_export2),v=I,_=A(o,l.__wbindgen_export,l.__wbindgen_export2),x=I;l.testengine_migrate(g,this.__wbg_ptr,h,f,N,v,_,x);var d=y().getInt32(g+0,!0),c=y().getInt32(g+4,!0),m=y().getInt32(g+8,!0),a=y().getInt32(g+12,!0),p=d,u=c;if(a)throw p=0,u=0,V(m);return r=p,s=u,$(p,u)}finally{l.__wbindgen_add_to_stack_pointer(16),l.__wbindgen_export3(r,s,1)}}modify(n,t,o){let r,s;try{const g=l.__wbindgen_add_to_stack_pointer(-16),h=A(n,l.__wbindgen_export,l.__wbindgen_export2),f=I,N=A(t,l.__wbindgen_export,l.__wbindgen_export2),v=I,_=A(o,l.__wbindgen_export,l.__wbindgen_export2),x=I;l.testengine_modify(g,this.__wbg_ptr,h,f,N,v,_,x);var d=y().getInt32(g+0,!0),c=y().getInt32(g+4,!0),m=y().getInt32(g+8,!0),a=y().getInt32(g+12,!0),p=d,u=c;if(a)throw p=0,u=0,V(m);return r=p,s=u,$(p,u)}finally{l.__wbindgen_add_to_stack_pointer(16),l.__wbindgen_export3(r,s,1)}}constructor(){const n=l.testengine_new();return this.__wbg_ptr=n,dt.register(this,this.__wbg_ptr,this),this}get now(){return l.testengine_now(this.__wbg_ptr)}reset(){l.testengine_reset(this.__wbg_ptr)}resolveIncident(n){let t,o;try{const p=l.__wbindgen_add_to_stack_pointer(-16),u=A(n,l.__wbindgen_export,l.__wbindgen_export2),g=I;l.testengine_resolveIncident(p,this.__wbg_ptr,u,g);var r=y().getInt32(p+0,!0),s=y().getInt32(p+4,!0),d=y().getInt32(p+8,!0),c=y().getInt32(p+12,!0),m=r,a=s;if(c)throw m=0,a=0,V(d);return t=m,o=a,$(m,a)}finally{l.__wbindgen_add_to_stack_pointer(16),l.__wbindgen_export3(t,o,1)}}setVariables(n,t,o){let r,s;try{const g=l.__wbindgen_add_to_stack_pointer(-16),h=A(n,l.__wbindgen_export,l.__wbindgen_export2),f=I,N=A(t,l.__wbindgen_export,l.__wbindgen_export2),v=I;l.testengine_setVariables(g,this.__wbg_ptr,h,f,N,v,o);var d=y().getInt32(g+0,!0),c=y().getInt32(g+4,!0),m=y().getInt32(g+8,!0),a=y().getInt32(g+12,!0),p=d,u=c;if(a)throw p=0,u=0,V(m);return r=p,s=u,$(p,u)}finally{l.__wbindgen_add_to_stack_pointer(16),l.__wbindgen_export3(r,s,1)}}snapshot(){let n,t;try{const a=l.__wbindgen_add_to_stack_pointer(-16);l.testengine_snapshot(a,this.__wbg_ptr);var o=y().getInt32(a+0,!0),r=y().getInt32(a+4,!0),s=y().getInt32(a+8,!0),d=y().getInt32(a+12,!0),c=o,m=r;if(d)throw c=0,m=0,V(s);return n=c,t=m,$(c,m)}finally{l.__wbindgen_add_to_stack_pointer(16),l.__wbindgen_export3(n,t,1)}}throwError(n,t,o){let r,s;try{const g=l.__wbindgen_add_to_stack_pointer(-16),h=A(n,l.__wbindgen_export,l.__wbindgen_export2),f=I,N=A(t,l.__wbindgen_export,l.__wbindgen_export2),v=I,_=A(o,l.__wbindgen_export,l.__wbindgen_export2),x=I;l.testengine_throwError(g,this.__wbg_ptr,h,f,N,v,_,x);var d=y().getInt32(g+0,!0),c=y().getInt32(g+4,!0),m=y().getInt32(g+8,!0),a=y().getInt32(g+12,!0),p=d,u=c;if(a)throw p=0,u=0,V(m);return r=p,s=u,$(p,u)}finally{l.__wbindgen_add_to_stack_pointer(16),l.__wbindgen_export3(r,s,1)}}tickNow(n){let t,o;try{const p=l.__wbindgen_add_to_stack_pointer(-16);l.testengine_tickNow(p,this.__wbg_ptr,n);var r=y().getInt32(p+0,!0),s=y().getInt32(p+4,!0),d=y().getInt32(p+8,!0),c=y().getInt32(p+12,!0),m=r,a=s;if(c)throw m=0,a=0,V(d);return t=m,o=a,$(m,a)}finally{l.__wbindgen_add_to_stack_pointer(16),l.__wbindgen_export3(t,o,1)}}unassignUserTask(n){let t,o;try{const p=l.__wbindgen_add_to_stack_pointer(-16),u=A(n,l.__wbindgen_export,l.__wbindgen_export2),g=I;l.testengine_unassignUserTask(p,this.__wbg_ptr,u,g);var r=y().getInt32(p+0,!0),s=y().getInt32(p+4,!0),d=y().getInt32(p+8,!0),c=y().getInt32(p+12,!0),m=r,a=s;if(c)throw m=0,a=0,V(d);return t=m,o=a,$(m,a)}finally{l.__wbindgen_add_to_stack_pointer(16),l.__wbindgen_export3(t,o,1)}}updateRetries(n,t){let o,r;try{const u=l.__wbindgen_add_to_stack_pointer(-16),g=A(n,l.__wbindgen_export,l.__wbindgen_export2),h=I;l.testengine_updateRetries(u,this.__wbg_ptr,g,h,t);var s=y().getInt32(u+0,!0),d=y().getInt32(u+4,!0),c=y().getInt32(u+8,!0),m=y().getInt32(u+12,!0),a=s,p=d;if(m)throw a=0,p=0,V(c);return o=a,r=p,$(a,p)}finally{l.__wbindgen_add_to_stack_pointer(16),l.__wbindgen_export3(o,r,1)}}updateUserTask(n,t){let o,r;try{const u=l.__wbindgen_add_to_stack_pointer(-16),g=A(n,l.__wbindgen_export,l.__wbindgen_export2),h=I,f=A(t,l.__wbindgen_export,l.__wbindgen_export2),N=I;l.testengine_updateUserTask(u,this.__wbg_ptr,g,h,f,N);var s=y().getInt32(u+0,!0),d=y().getInt32(u+4,!0),c=y().getInt32(u+8,!0),m=y().getInt32(u+12,!0),a=s,p=d;if(m)throw a=0,p=0,V(c);return o=a,r=p,$(a,p)}finally{l.__wbindgen_add_to_stack_pointer(16),l.__wbindgen_export3(o,r,1)}}}Symbol.dispose&&(Fn.prototype[Symbol.dispose]=Fn.prototype.free);function mi(){return{__proto__:null,"./nanobpmn_engine_bg.js":{__proto__:null,__wbg___wbindgen_throw_bb96b2010945f0bc:function(n,t){throw new Error($(n,t))},__wbindgen_cast_0000000000000001:function(n,t){const o=$(n,t);return pi(o)},__wbindgen_object_drop_ref:function(n){V(n)}}}}const dt=typeof FinalizationRegistry>"u"?{register:()=>{},unregister:()=>{}}:new FinalizationRegistry(e=>l.__wbg_testengine_free(e,1));function pi(e){Xe===Re.length&&Re.push(Re.length+1);const n=Xe;return Xe=Re[n],Re[n]=e,n}function ui(e){e<1028||(Re[e]=Xe,Xe=e)}let De=null;function y(){return(De===null||De.buffer.detached===!0||De.buffer.detached===void 0&&De.buffer!==l.memory.buffer)&&(De=new DataView(l.memory.buffer)),De}function $(e,n){return fi(e>>>0,n)}let Qe=null;function ln(){return(Qe===null||Qe.byteLength===0)&&(Qe=new Uint8Array(l.memory.buffer)),Qe}function hi(e){return Re[e]}let Re=new Array(1024).fill(void 0);Re.push(void 0,null,!0,!1);let Xe=Re.length;function bi(e){return e==null}function A(e,n,t){if(t===void 0){const c=en.encode(e),m=n(c.length,1)>>>0;return ln().subarray(m,m+c.length).set(c),I=c.length,m}let o=e.length,r=n(o,1)>>>0;const s=ln();let d=0;for(;d<o;d++){const c=e.charCodeAt(d);if(c>127)break;s[r+d]=c}if(d!==o){d!==0&&(e=e.slice(d)),r=t(r,o,o=d+e.length*3,1)>>>0;const c=ln().subarray(r+d,r+o),m=en.encodeInto(e,c);d+=m.written,r=t(r,o,d,1)>>>0}return I=d,r}function V(e){const n=hi(e);return ui(e),n}let cn=new TextDecoder("utf-8",{ignoreBOM:!0,fatal:!0});cn.decode();const gi=2146435072;let kn=0;function fi(e,n){return kn+=n,kn>=gi&&(cn=new TextDecoder("utf-8",{ignoreBOM:!0,fatal:!0}),cn.decode(),kn=n),cn.decode(ln().subarray(e,e+n))}const en=new TextEncoder;"encodeInto"in en||(en.encodeInto=function(e,n){const t=en.encode(e);return n.set(t),{read:e.length,written:t.length}});let I=0,l;function _i(e,n){return l=e.exports,De=null,Qe=null,l}async function wi(e,n){if(typeof Response=="function"&&e instanceof Response){if(!e.ok)throw new Error(`failed to fetch Wasm: ${e.status} ${e.statusText} fetching '${e.url}'`);if(typeof WebAssembly.instantiateStreaming=="function")try{return await WebAssembly.instantiateStreaming(e,n)}catch(r){if(t(e.type)&&e.headers.get("Content-Type")!=="application/wasm")console.warn("`WebAssembly.instantiateStreaming` failed because your server does not serve Wasm with `application/wasm` MIME type. Falling back to `WebAssembly.instantiate` which is slower. Original error:\n",r);else throw r}const o=await e.arrayBuffer();return await WebAssembly.instantiate(o,n)}else{const o=await WebAssembly.instantiate(e,n);return o instanceof WebAssembly.Instance?{instance:o,module:e}:o}function t(o){switch(o){case"basic":case"cors":case"default":return!0}return!1}}async function yi(e){if(l!==void 0)return l;e!==void 0&&(Object.getPrototypeOf(e)===Object.prototype?{module_or_path:e}=e:console.warn("using deprecated parameters for the initialization function; pass a single object instead")),e===void 0&&(e=new URL("/web-demo-framework/pr-preview/pr-121/assets/nanobpmn_engine_bg-DRNrIVE8.wasm",import.meta.url));const n=mi();(typeof e=="string"||typeof Request=="function"&&e instanceof Request||typeof URL=="function"&&e instanceof URL)&&(e=fetch(e));const{instance:t,module:o}=await wi(await e,n);return _i(t)}let sn=null;function vi(e){return sn||(sn=yi(void 0).then(()=>{}).catch(n=>{throw sn=null,n})),sn}function ne(e){return JSON.parse(e)}class xi{constructor(n){z(this,"engine");this.engine=n}deploy(n){return JSON.parse(this.engine.deploy(n))}createInstance(n,t){return ne(this.engine.createInstance(n,t||"{}"))}activateJobs(n,t,o,r){return JSON.parse(this.engine.activateJobs(n,t,o,r))}completeJob(n,t){return ne(this.engine.completeJob(n,t||"{}"))}completeAgentJob(n,t){const{variables:o,...r}=t??{};return ne(this.engine.completeAgentJob(n,JSON.stringify(o??{}),JSON.stringify(r??{})))}failJob(n,t,o){return ne(this.engine.failJob(n,t,o))}throwError(n,t,o){return ne(this.engine.throwError(n,t,o))}updateRetries(n,t){return ne(this.engine.updateRetries(n,t))}resolveIncident(n){return ne(this.engine.resolveIncident(n))}setVariables(n,t,o){return ne(this.engine.setVariables(n,t||"{}",o))}broadcastSignal(n,t){return ne(this.engine.broadcastSignal(n,t||"{}"))}cancelInstance(n){return ne(this.engine.cancelInstance(n))}modify(n,t,o){return ne(this.engine.modify(n,JSON.stringify(t??[]),JSON.stringify(o??[])))}completeUserTask(n,t){return ne(this.engine.completeUserTask(n,t||"{}"))}assignUserTask(n,t,o){return ne(this.engine.assignUserTask(n,t,o))}unassignUserTask(n){return ne(this.engine.unassignUserTask(n))}updateUserTask(n,t){return ne(this.engine.updateUserTask(n,t||"{}"))}correlateMessage(n,t,o){return ne(this.engine.correlateMessage(n,t,o||"{}"))}advanceTime(n){return ne(this.engine.advanceTime(n))}reset(){this.engine.reset()}events(){return JSON.parse(this.engine.events())}snapshot(){return ne(this.engine.snapshot())}free(){this.engine.free()}}async function Ei(e){return await vi(),new xi(new Fn)}class $t extends Error{constructor(t,o){super(t);z(this,"retries");this.name="JobFailure",this.retries=o==null?void 0:o.retries}}function ki(e,n=[]){if(e.instances.filter(r=>!r.completed).length===0)return e.totalInstances>0?"completed":"idle";if(e.incidents.length>0)return"incidents";const o=new Set(n);return e.jobs.some(r=>!o.has(r.jobType))?"unhandledJobs":e.userTasks.some(r=>r.state==="Created")?"userTasks":e.timers.length>0?"timers":e.messageSubscriptions.length>0?"messages":e.signalSubscriptions.length>0?"signals":"idle"}function Ni(e,n=[]){const t=new Set(n);return[...new Set(e.jobs.map(o=>o.jobType))].filter(o=>!t.has(o)).sort()}async function Pi(e,n,t){let o;try{const r=await n(t);o=JSON.stringify(r??{})}catch(r){const s=r instanceof $t&&r.retries!==void 0?r.retries:Math.max(0,t.retries-1),d=r instanceof Error?r.message:String(r);e.failJob(t.key,s,d);return}e.completeJob(t.key,o)}async function Mi(e,n,t){let o;try{o=await n(t),JSON.stringify(o)}catch(r){const s=r instanceof $t&&r.retries!==void 0?r.retries:Math.max(0,t.retries-1),d=r instanceof Error?r.message:String(r);e.failJob(t.key,s,d);return}e.completeAgentJob(t.key,o)}async function Si(e,n,t={}){const o=t.maxJobsPerActivation??10,r=t.lockTimeoutMs??3e4,s=t.worker??"bojtos",d=t.agents??{};for(const g of Object.keys(d))if(g in n)throw new Error(`dispatchRound: job type "${g}" is registered as both a worker and an agent — register it as exactly one`);const c=[];for(const[g,h]of Object.entries(n))for(const f of e.activateJobs(g,o,r,s))c.push({handler:h,job:f});const m=[];for(const[g,h]of Object.entries(d))for(const f of e.activateJobs(g,o,r,s))m.push({handler:h,job:f});for(const{handler:g,job:h}of c)await Pi(e,g,h);for(const{handler:g,job:h}of m)await Mi(e,g,h);const a=e.snapshot(),p=c.length+m.length;if(p>0)return{snapshot:a,handled:p};const u=[...Object.keys(n),...Object.keys(d)];return{snapshot:a,handled:p,reason:ki(a,u),unhandled:Ni(a,u)}}function Bi({bpmn:e}){const n=b.useRef(null),[t,o]=b.useState("loading"),[r,s]=b.useState(null),[d,c]=b.useState([]),[m,a]=b.useState(null),p=b.useRef(e),u=b.useRef(0),g=b.useRef(null),h=b.useRef(new Map),f=b.useCallback((C,S)=>{h.current.set(C,S)},[]),N=b.useCallback(C=>h.current.get(C),[]),v=b.useCallback((C,S)=>{const P=C.deploy(S);return p.current=S,h.current.clear(),c(P.processIds),a(null),s(null),P.processIds},[]);b.useEffect(()=>{let C=!1;return o("loading"),c([]),a(null),s(null),Ei().then(S=>{if(C){S.free();return}try{v(S,e)}catch(P){S.free(),s(String(P)),o("error");return}n.current=S,o("ready")}).catch(S=>{C||(s(String(S)),o("error"))}),()=>{var S;C=!0,(S=n.current)==null||S.free(),n.current=null,h.current.clear()}},[e]);const _=b.useCallback(C=>{const S=n.current;if(!S)return null;try{const P=C(S);return a(P),s(null),P}catch(P){return s(String(P)),null}},[]),x=b.useCallback((C,S)=>_(P=>P.createInstance(C,S)),[_]),E=b.useCallback((C,S)=>_(P=>P.completeUserTask(C,S)),[_]),q=b.useCallback(C=>_(S=>S.advanceTime(C)),[_]),Y=b.useCallback((C,S)=>_(P=>P.broadcastSignal(C,S)),[_]);function J(C,S){const[P]=C.activateJobs(S,1,3e4,"manual-control");if(!P)throw new Error(`No waiting job of type "${S}" to resolve.`);return P}const be=b.useCallback((C,S)=>_(P=>{const j=J(P,C);return P.completeJob(j.key,S)}),[_]),Ce=b.useCallback((C,S,P)=>_(j=>{const H=J(j,C);return j.throwError(H.key,S,P)}),[_]),ge=b.useCallback((C,S,P)=>_(j=>j.correlateMessage(C,S,P)),[_]),Me=b.useCallback(async(C,S)=>{const P=n.current;if(!P)return null;const j=u.current,H=Si(P,C,S);g.current=H;try{const ye=await H;return n.current!==P||u.current!==j?null:(a(ye.snapshot),s(null),ye)}catch(ye){return n.current!==P||u.current!==j||(a(P.snapshot()),s(String(ye))),null}finally{g.current===H&&(g.current=null)}},[]),ee=b.useCallback(async()=>{var C;await((C=g.current)==null?void 0:C.catch(()=>{}))},[]),fe=b.useCallback(async()=>{await ee();const C=n.current;if(C){u.current++;try{C.reset(),v(C,p.current)}catch(S){s(String(S))}}},[v,ee]),de=b.useCallback(async C=>{await ee();const S=n.current;if(!S)return null;u.current++;try{return S.reset(),v(S,C)}catch(P){return s(String(P)),null}},[v,ee]);return{phase:t,error:r,processIds:d,snapshot:m,createInstance:x,stepWorkers:Me,completeUserTask:E,advanceTime:q,broadcastSignal:Y,completeJobManually:be,throwJobError:Ce,correlateMessage:ge,reset:fe,redeploy:de,setRunImage:f,getRunImage:N}}const Ri="web-demo-framework:height",Ci="web-demo-framework:ready";function Ii(){return{type:Ci}}const Ai="web-demo-framework:request-height";function Ti(e){return{type:Ri,height:Math.ceil(e)}}const lt="embed-height-auto";function Fi(e=document){return Math.max(e.documentElement.offsetHeight,e.body.scrollHeight)}function ji(e){b.useEffect(()=>{if(!e||typeof window>"u"||window.parent===window)return;const n=document.documentElement;n.classList.add(lt);let t=-1;const o=(d=!1)=>{const c=Fi();!d&&Math.abs(c-t)<2||(t=c,window.parent.postMessage(Ti(c),"*"))},r=d=>{if(d.source!==window.parent)return;const c=d.data;!c||c.type!==Ai||o(!0)};window.addEventListener("message",r),o();const s=new ResizeObserver(()=>o());return s.observe(n),()=>{s.disconnect(),window.removeEventListener("message",r),n.classList.remove(lt)}},[e])}function Di(e){const n=b.useRef(!1);b.useEffect(()=>{!e||n.current||typeof window>"u"||window.parent===window||(n.current=!0,window.parent.postMessage(Ii(),"*"))},[e])}function Li(e,n){return e.slice(n)}function Oi(e,n,t,o){const r=e.snapshot,s="⏸ waiting for a human — complete the task below to continue",d=r.userTasks.some(c=>c.state==="Created");if(e.handled>0){const c=r.activeElementIds.map(t),m=n.length?` via ${n.map(a=>`${t(a.from)} → ${t(a.to)}`).join(", ")}`:"";return r.completedInstances>=1?{kind:"done",text:`⏭ round handled ${e.handled} job${e.handled===1?"":"s"}${m} — ✅ process instance completed`}:d?{kind:"human",text:`⏭ round handled ${e.handled} job${e.handled===1?"":"s"}${m} — ${s}`}:{kind:"step",text:`⏭ round handled ${e.handled} job${e.handled===1?"":"s"}${m} — now at ${c.length?c.join(", "):"—"}`}}switch(e.reason){case"completed":return{kind:"done",text:"✅ process instance completed"};case"userTasks":return{kind:"human",text:s};case"timers":return{kind:"step",text:"⏱ waiting on a timer — advance the clock to continue"};case"messages":return{kind:"step",text:"✉ waiting on a message — correlate it to continue"};case"signals":return{kind:"step",text:"📶 waiting on a signal — broadcast it to continue"};case"incidents":return{kind:"error",text:"A job failed — incident on the diagram"};case"unhandledJobs":{const c=e.unhandled??[];return o&&c.length>0&&c.every(m=>o.has(m))?{kind:"human",text:s}:{kind:"error",text:`⏭ waiting on job type(s) with no worker registered: ${c.join(", ")}`}}case"idle":return{kind:"step",text:"Nothing to step — no instance is running."};default:return{kind:"step",text:e.reason?`Step blocked on an unrecognized reason: ${e.reason}`:"Nothing to step — no instance is running."}}}const zi="the Scripted or Endpoint brain";async function un(e=zi){const n=navigator.gpu;if(!n)return`This browser doesn't expose WebGPU at all. Use a recent Chrome, Edge, or Safari 17+ with hardware acceleration on, or pick ${e}.`;let t;try{t=await n.requestAdapter()}catch(o){return`WebGPU adapter request failed (${o instanceof Error?o.message:String(o)}). Try ${e} instead.`}return t?null:`This browser supports the WebGPU API, but no GPU adapter is available — hardware acceleration may be off, or this device/VM has no usable GPU. Pick ${e} instead.`}const $i=[{id:"Qwen2.5-1.5B-Instruct-q4f16_1-MLC",label:"Qwen2.5 1.5B",downloadLabel:"~1.0 GB"},{id:"SmolLM2-1.7B-Instruct-q4f16_1-MLC",label:"SmolLM2 1.7B",downloadLabel:"~1.1 GB"},{id:"Llama-3.2-1B-Instruct-q4f16_1-MLC",label:"Llama 3.2 1B",downloadLabel:"~0.7 GB"},{id:"gemma-2-2b-it-q4f16_1-MLC",label:"Gemma 2 2B",downloadLabel:"~1.5 GB"},{id:"Llama-3.2-1B-Instruct-q4f32_1-MLC",label:"Llama 3.2 1B (f32, wider GPU support)",downloadLabel:"~1.1 GB"},{id:"SmolLM2-360M-Instruct-q4f32_1-MLC",label:"SmolLM2 360M (tiny, f32)",downloadLabel:"~0.6 GB"},{id:"SmolLM2-360M-Instruct-q4f16_1-MLC",label:"SmolLM2 360M (tiny)",downloadLabel:"~0.3 GB"}];function Ut(e){return jn.get(e)??{}}const jn=new Map;async function Ui(){if(jn.size>0)return;const{prebuiltAppConfig:e}=await he(async()=>{const{prebuiltAppConfig:n}=await import("./vendor-webllm-DT0Ab8E6.js");return{prebuiltAppConfig:n}},[]);for(const n of e.model_list)jn.set(n.model_id,{vramRequiredMB:n.vram_required_MB,requiredFeatures:n.required_features})}const _n=$i.map(e=>({id:e.id,label:`${e.label} (${e.downloadLabel})`,downloadLabel:e.downloadLabel,...Ut(e.id)})),Vt=_n[0].id;async function Vi(){return await Ui(),_n.map(e=>({...e,...Ut(e.id)}))}function qt(){const e=navigator.deviceMemory;return typeof e=="number"?e*1024:null}function qi(e,n=qt()){return n==null||e.vramRequiredMB==null||n>=e.vramRequiredMB?null:`${e.label} needs roughly ${Math.round(e.vramRequiredMB)} MB of GPU memory; this device looks like it has about ${Math.round(n)} MB available. It may still work, but expect it to fail or fall back to slow shared memory — try a smaller model (e.g. SmolLM2 360M) if it doesn't load.`}async function Gi(e){try{const{hasModelInCache:n}=await he(async()=>{const{hasModelInCache:t}=await import("./vendor-webllm-DT0Ab8E6.js");return{hasModelInCache:t}},[]);return await n(e)}catch{return!1}}function hn(e){return/device (was )?lost|device_hung|device_removed|already been disposed|gpudevicelostinfo/i.test(e)}function ct(){return"The GPU device was lost — the driver reset while the model was loading or running. This is a browser/driver-level failure, not a problem with the model: fully quit and reopen the browser (a lost device usually persists for the life of the GPU process), check chrome://gpu still reports hardware acceleration, and update your GPU driver if it recurs. The Scripted and Endpoint brains don't use the GPU at all."}class dn{constructor(){z(this,"kind","browser");z(this,"model",null);z(this,"engine",null);z(this,"worker",null);z(this,"generation",0);z(this,"chat",async(n,t=512,o)=>{var s,d;const r=this.engine;if(!r||!this.model)throw new Error("BrowserBrain.chat called before connect()");try{const c=await r.chat.completions.create({messages:n,temperature:0,max_tokens:t,stream:!0});let m="";for await(const a of c){const p=((d=(s=a.choices[0])==null?void 0:s.delta)==null?void 0:d.content)??"";p&&(m+=p,o==null||o(p))}return m}catch(c){const m=c instanceof Error?c.message:String(c);throw hn(m)?(this.teardown(),new Error(`The in-browser model stopped: ${ct()}`)):c}})}async connect(n=Vt,t){var m,a;const o=await un();if(o)throw new Error(o);if(this.engine&&this.model===n)return n;const r=++this.generation,s=p=>{r===this.generation&&(t==null||t({progress:p.progress??0,text:p.text??""}))};this.teardown();let d,c;try{const{CreateWebWorkerMLCEngine:p}=await he(async()=>{const{CreateWebWorkerMLCEngine:u}=await import("./vendor-webllm-DT0Ab8E6.js");return{CreateWebWorkerMLCEngine:u}},[]);c=new Worker(new URL("/web-demo-framework/pr-preview/pr-121/assets/webllm.worker-Dc1cCqhL.js",import.meta.url),{type:"module"}),d=await p(c,n,{initProgressCallback:s})}catch(p){if(c==null||c.terminate(),r!==this.generation)throw new Error("cancelled");const u=p instanceof Error?p.message:String(p);if(hn(u))throw new Error(`Couldn't load ${n} in the browser (${u}). ${ct()}`);const g=(a=(m=_n.find(h=>h.id===n))==null?void 0:m.requiredFeatures)==null?void 0:a.includes("shader-f16");throw new Error(`Couldn't load ${n} in the browser (${u}). `+(g?"This model needs WebGPU with shader-f16; try one of the f32 models in the list, or the endpoint brain.":"Try a smaller model, check your connection, or use the endpoint brain instead."))}if(r!==this.generation)throw d.unload().catch(()=>{}),c==null||c.terminate(),new Error("cancelled");return this.engine=d,this.worker=c??null,this.model=n,n}teardown(){const{engine:n,worker:t}=this;this.engine=null,this.worker=null,this.model=null,n==null||n.unload().catch(()=>{}),t==null||t.terminate()}cancelConnect(){this.generation++}dispose(){this.generation++,this.teardown()}}const On="http://localhost:11434/v1",bn=e=>e==="localhost"||e==="127.0.0.1"||e==="::1"||e==="[::1]";function Gt(){var e;return bn(((e=globalThis.location)==null?void 0:e.hostname)??"")}function Nn(e){try{return bn(new URL(zn(e)).hostname)}catch{return!1}}function gn(e,n={hostname:(t=>(t=globalThis.location)==null?void 0:t.hostname)()??"",origin:(o=>(o=globalThis.location)==null?void 0:o.origin)()??""}){let r;try{r=new URL(zn(e)).hostname}catch{return null}return!bn(r)||bn(n.hostname)?null:`This page is served from ${n.origin||"a non-local origin"}, so it can't reach ${e}. A local model server only accepts requests from a page on localhost. Open this page at http://localhost instead, or use the Scripted or In-browser brain.`}function zn(e){let n=e.trim().replace(/\/+$/,"");return n.endsWith("/chat/completions")&&(n=n.slice(0,-17)),/\/v\d+$/.test(n)||(n=`${n}/v1`),n}class mt extends Error{constructor(n,t){super(n),this.status=t,this.name="HttpError"}}class pt{constructor(n=On,t="",o=""){z(this,"kind","endpoint");z(this,"baseUrl");z(this,"model",null);z(this,"models",[]);z(this,"apiKey");z(this,"requestedModel");z(this,"chat",async(n,t=512,o)=>{var a,p,u;if(!this.model)throw new Error("EndpointBrain.chat called before connect()");const r=await fetch(`${this.baseUrl}/chat/completions`,{method:"POST",headers:this.headers(),body:JSON.stringify({model:this.model,messages:n,temperature:0,max_tokens:t,stream:!0})});if(!r.ok||!r.body){const g=await r.text().catch(()=>"");throw new Error(`chat/completions HTTP ${r.status} ${r.statusText}${g?` — ${g.slice(0,300)}`:""}`)}const s=r.body.getReader(),d=new TextDecoder;let c="",m="";for(;;){const{value:g,done:h}=await s.read();if(h)break;c+=d.decode(g,{stream:!0});let f;for(;(f=c.indexOf(`
`))>=0;){const N=c.slice(0,f).trim();if(c=c.slice(f+1),!N.startsWith("data:"))continue;const v=N.slice(5).trim();if(v==="[DONE]")continue;let _;try{_=JSON.parse(v)}catch{continue}_.model&&(this.model=_.model);const x=(a=_.choices)==null?void 0:a[0],E=((p=x==null?void 0:x.delta)==null?void 0:p.content)??((u=x==null?void 0:x.message)==null?void 0:u.content)??"";E&&(m+=E,o==null||o(E))}}return m});this.baseUrl=zn(n),this.apiKey=t.trim(),this.requestedModel=o.trim()}headers(){const n={"Content-Type":"application/json"};return this.apiKey&&(n.Authorization=`Bearer ${this.apiKey}`),n}async listModels(){let n;try{n=await fetch(`${this.baseUrl}/models`,{headers:this.headers()})}catch(o){const r=gn(this.baseUrl);throw new Error(r??`Can't reach ${this.baseUrl} (${o instanceof Error?o.message:String(o)}). Is the server running? For Ollama, check the app is up — and if this page is served from another origin, allow it with OLLAMA_ORIGINS.`)}if(!n.ok)throw new mt(`${this.baseUrl}/models returned HTTP ${n.status} ${n.statusText}`,n.status);const t=await n.json();return this.models=(t.data??[]).map(o=>o.id).filter(o=>!!o),this.models}async connect(){try{const n=await this.listModels(),t=this.requestedModel||n[0];if(!t)throw new Error(`No models available at ${this.baseUrl}. Pull one first — e.g. \`ollama pull llama3.2:3b\` — or name one explicitly.`);this.model=t}catch(n){const t=n instanceof mt&&[404,405,501].includes(n.status);if(!this.requestedModel||!t)throw n;this.models=[],this.model=this.requestedModel}return await this.validate(),this.model}async validate(){const n=await fetch(`${this.baseUrl}/chat/completions`,{method:"POST",headers:this.headers(),body:JSON.stringify({model:this.model,messages:[{role:"user",content:"Reply with ok."}],temperature:0,max_tokens:1,stream:!1})}).catch(o=>{throw new Error(`Can't reach ${this.baseUrl}/chat/completions (${o instanceof Error?o.message:String(o)}). Check the endpoint URL, API key, model name, and any local CORS settings.`)});if(!n.ok){const o=await n.text().catch(()=>"");throw new Error(`chat/completions HTTP ${n.status} ${n.statusText}${o?` — ${o.slice(0,300)}`:""}`)}const t=await n.json().catch(()=>({}));t.model&&(this.model=t.model)}dispose(){}}const ut="gemini-nano";function fn(){const e=globalThis.LanguageModel;return typeof(e==null?void 0:e.create)=="function"&&typeof e.availability=="function"?e:null}function Hi(){return fn()!==null}async function Ht(){const e=fn();if(!e)return"This browser has no built-in AI model. Chrome's Prompt API (Gemini Nano) needs Chrome 138+ on desktop Windows 10/11, macOS 13+, Linux or a Chromebook Plus. Use the Scripted, In-browser (WebGPU) or API endpoint brain instead.";let n;try{n=await e.availability()}catch(t){return`Chrome couldn't report on its built-in model (${t instanceof Error?t.message:String(t)}).`}return n==="unavailable"?"Chrome exposes the built-in AI API here, but Gemini Nano can't run on this device. Chrome requires ~22 GB free on the volume holding your Chrome profile, and either a GPU with more than 4 GB of VRAM or 16 GB of RAM with 4+ CPU cores. Check chrome://on-device-internals for the details.":null}class ht{constructor(){z(this,"kind","chrome");z(this,"model",null);z(this,"warm",null);z(this,"connecting",null);z(this,"chat",async(n,t,o)=>{if(!this.model)throw new Error("ChromeBrain.chat called before connect()");const r=fn();if(!r)throw new Error("Chrome's built-in AI API went away.");const s=n.filter(m=>m.role==="system"),d=n.filter(m=>m.role!=="system"),c=await r.create(s.length?{initialPrompts:s}:void 0);try{const m=c.promptStreaming(d).getReader();let a="";for(;;){const{done:p,value:u}=await m.read();if(p)break;u&&(a+=u,o==null||o(u))}return a}finally{c.destroy()}})}async connect(n){const t=await Ht();if(t)throw new Error(t);const o=fn();this.dispose();const r=new AbortController;this.connecting=r;try{this.warm=await o.create({signal:r.signal,monitor:s=>{s.addEventListener("downloadprogress",d=>{n==null||n({progress:d.loaded,text:"Downloading Gemini Nano"})})}})}catch(s){if(r.signal.aborted)throw new Error("cancelled");const d=s instanceof Error?s.message:String(s);throw new Error(`Chrome couldn't start its built-in model (${d}). The first run downloads Gemini Nano and must be triggered by a click — press Connect again, and check chrome://on-device-internals if it keeps failing.`)}finally{this.connecting=null}return this.model=ut,ut}cancelConnect(){var n;(n=this.connecting)==null||n.abort()}dispose(){var n,t;(n=this.connecting)==null||n.abort(),this.connecting=null,(t=this.warm)==null||t.destroy(),this.warm=null,this.model=null}}const Ji=[{id:"onnx-community/Florence-2-base-ft",label:"Florence-2 base",downloadLabel:"~0.4 GB"},{id:"onnx-community/Florence-2-large-ft",label:"Florence-2 large (higher quality)",downloadLabel:"~1.6 GB"}],Jt=Ji.map(e=>({...e,label:`${e.label} (${e.downloadLabel})`})),Wt=Jt[0].id,Wi="<OCR>",bt="UNKNOWN (scripted brain — connect the in-browser model to read a photo)";function Ki(e,n){if(e)return typeof e=="function"?e(n):e[n]}class Zi{constructor(n){z(this,"kind","scripted-vision");z(this,"model",null);z(this,"read",async(n,t,o)=>{const r=typeof n=="string"?Ki(this.lookup,n)??bt:bt;return o==null||o(r),r});this.lookup=n}dispose(){}}function Yi(e){return new Zi(e)}class gt{constructor(){z(this,"kind","browser-vision");z(this,"model",null);z(this,"modelHandle",null);z(this,"processor",null);z(this,"loadImage",null);z(this,"generation",0);z(this,"read",async(n,t,o)=>{const r=this.modelHandle,s=this.processor,d=this.loadImage;if(!r||!s||!d||!this.model)throw new Error("BrowserVisionBrain.read called before connect()");const c=t&&t.startsWith("<")?t:Wi,m=await d(n),a=s.construct_prompts(c),p=await s(m,a),u=await r.generate({...p,max_new_tokens:512,num_beams:1,do_sample:!1}),g=s.batch_decode(u,{skip_special_tokens:!1})[0],h=s.post_process_generation(g,c,m.size),f=Qi(h,c);return o==null||o(f),f})}async connect(n=Wt,t){var c,m;const o=await un("the scripted-vision fallback");if(o)throw new Error(o);if(this.modelHandle&&this.model===n)return n;const r=++this.generation,s=a=>{r===this.generation&&(t==null||t({progress:(a.progress??0)/100,text:a.file?`${a.status??"loading"} ${a.file}`:a.status??""}))};this.teardown();let d;try{const{Florence2ForConditionalGeneration:a,AutoProcessor:p,load_image:u}=await he(async()=>{const{Florence2ForConditionalGeneration:f,AutoProcessor:N,load_image:v}=await import("./transformers.web-D4adwrl9.js");return{Florence2ForConditionalGeneration:f,AutoProcessor:N,load_image:v}},[]),g=await a.from_pretrained(n,{dtype:"fp32",device:"webgpu",progress_callback:s}),h=await p.from_pretrained(n);d={model:g,processor:h,loadImage:u}}catch(a){if(r!==this.generation)throw new Error("cancelled");const p=a instanceof Error?a.message:String(a);throw new Error(`Couldn't load ${n} in the browser (${p}). Try the smaller Florence-2 base model, check your connection, or use the scripted-vision fallback.`)}if(r!==this.generation)throw Promise.resolve((m=(c=d.model).dispose)==null?void 0:m.call(c)).catch(()=>{}),new Error("cancelled");return this.modelHandle=d.model,this.processor=d.processor,this.loadImage=d.loadImage,this.model=n,n}teardown(){var t;const n=this.modelHandle;this.modelHandle=null,this.processor=null,this.loadImage=null,this.model=null,Promise.resolve((t=n==null?void 0:n.dispose)==null?void 0:t.call(n)).catch(()=>{})}cancelConnect(){this.generation++}dispose(){this.generation++,this.teardown()}}function Qi(e,n){const t=e[n];if(typeof t=="string")return t.trim();if(t&&typeof t=="object"){const o=t.labels;return Array.isArray(o)?o.join(" ").trim():JSON.stringify(t)}return""}function Xi(){const[e,n]=b.useState("scripted"),[t,o]=b.useState("idle"),[r,s]=b.useState(null),[d,c]=b.useState(null),[m,a]=b.useState(null),[p,u]=b.useState(null),[g,h]=b.useState(null),[f,N]=b.useState(null),[v,_]=b.useState(null),[x,E]=b.useState(Vt),[q,Y]=b.useState(Gt()?On:""),[J,be]=b.useState(""),[Ce,ge]=b.useState([]),[Me,ee]=b.useState("idle"),[fe,de]=b.useState(null),[C,S]=b.useState(""),[P,j]=b.useState(null),H=b.useRef(null),[ye,Oe]=b.useState("scripted-vision"),[wn,ve]=b.useState("idle"),[He,re]=b.useState(null),[Fe,tn]=b.useState(Wt),[yn,xe]=b.useState(null),[je,Ie]=b.useState(null),[vn,xn]=b.useState(null),[Je,Q]=b.useState(null),U=b.useRef(null),We=b.useRef(!1),ze=b.useRef(0),Ne=b.useCallback(B=>async(...K)=>{try{return await B.chat(...K)}catch(F){const W=F instanceof Error?F.message:String(F);throw B instanceof dn&&hn(W)&&(j(null),c(null),o("error"),s(W)),F}},[]),Ae=b.useCallback(B=>async(...K)=>{try{return await B.read(...K)}catch(F){const W=F instanceof Error?F.message:String(F);throw hn(W)&&(Q(null),xe(null),ve("error"),re(W)),F}},[]);b.useEffect(()=>{un().then(B=>{h(B),u(B===null)}),Ht().then(_),un("the scripted-vision fallback").then(B=>{xn(B),We.current||(We.current=!0,Oe(B===null?"browser-vision":"scripted-vision"))})},[]),b.useEffect(()=>{let B=!1;return N(null),Gi(x).then(K=>{B||N(K)}),()=>{B=!0}},[x]),b.useEffect(()=>()=>{var B;return(B=H.current)==null?void 0:B.dispose()},[]),b.useEffect(()=>()=>{var B;return(B=U.current)==null?void 0:B.dispose()},[]);const Ke=b.useCallback(B=>{n(B),o("idle"),s(null),c(null),a(null),j(null)},[]),O=b.useCallback(B=>{var K,F;We.current=!0,(K=U.current)==null||K.cancelConnect(),(F=U.current)==null||F.dispose(),U.current=null,Oe(B),ve("idle"),re(null),xe(null),Ie(null),Q(null)},[]),oe=b.useCallback(()=>{var B;(B=H.current)==null||B.dispose(),H.current=null,j(null),c(null)},[]),Te=b.useCallback(()=>{const B=H.current;(B instanceof dn||B instanceof ht)&&B.cancelConnect(),oe(),o("idle"),a(null),s(null)},[oe]),Se=b.useCallback(async()=>{const B=++ze.current,K=()=>B!==ze.current;if(!q.trim()){ge([]),be(""),ee("idle"),de(null);return}const F=gn(q);if(F){ge([]),be(""),ee("error"),de(F);return}ee("loading"),de(null);const W=new pt(q,C);try{const Ee=await W.listModels();if(K())return;ge(Ee),ee("ready"),be(Ve=>Ve&&Ee.includes(Ve)?Ve:Ee[0]??"")}catch(Ee){if(K())return;ge([]),be(""),ee("error"),de(Ee instanceof Error?Ee.message:String(Ee))}finally{W.dispose()}},[q,C]),on=b.useCallback(async()=>{var B,K;if(e==="scripted"){j(null),o("ready");return}if(e==="endpoint"){const F=gn(q);if(F){oe(),s(F),o("error");return}}o("connecting"),s(null),a(null);try{if(e==="browser"){const F=H.current instanceof dn?H.current:new dn;H.current&&H.current!==F&&H.current.dispose(),H.current=F;const W=await F.connect(x,a);c(W),j(()=>Ne(F)),N(!0)}else if(e==="chrome"){(B=H.current)==null||B.dispose();const F=new ht;H.current=F;const W=await F.connect(a);_(null),c(W),j(()=>Ne(F))}else{(K=H.current)==null||K.dispose();const F=new pt(q,C,J);H.current=F;const W=await F.connect();c(W),j(()=>Ne(F))}o("ready")}catch(F){const W=F instanceof Error?F.message:String(F);if(W==="cancelled")return;s(W),o("error"),j(null)}finally{a(null)}},[e,x,q,J,C,oe,Ne]),$e=b.useCallback(()=>{var B;(B=U.current)==null||B.dispose(),U.current=null,Q(null),xe(null)},[]),_e=b.useCallback(()=>{var B;(B=U.current)==null||B.cancelConnect(),$e(),ve("idle"),Ie(null),re(null)},[$e]),Ue=b.useCallback(async()=>{if(ye==="scripted-vision"){$e(),ve("ready"),re(null);return}ve("connecting"),re(null),Ie(null);try{const B=U.current instanceof gt?U.current:new gt;U.current&&U.current!==B&&U.current.dispose(),U.current=B;const K=await B.connect(Fe,Ie);xe(K),Q(()=>Ae(B)),ve("ready")}catch(B){const K=B instanceof Error?B.message:String(B);if(K==="cancelled")return;re(K),ve("error"),Q(null),xe(null)}finally{Ie(null)}},[ye,Fe,$e,Ae]);return{kind:e,setKind:Ke,status:t,error:r,modelInUse:d,progress:m,webgpu:p,webgpuReason:g,browserModelCached:f,chromeAiReason:v,cancelConnect:Te,browserModel:x,setBrowserModel:E,endpointUrl:q,setEndpointUrl:Y,endpointModel:J,setEndpointModel:be,endpointModels:Ce,endpointModelsStatus:Me,endpointModelsError:fe,listEndpointModels:Se,apiKey:C,setApiKey:S,connect:on,chat:P,visionKind:ye,setVisionKind:O,visionStatus:wn,visionError:He,visionModel:Fe,setVisionModel:tn,visionModelInUse:yn,visionProgress:je,visionWebgpuReason:vn,connectVision:Ue,cancelVisionConnect:_e,vision:Je}}const Dn="#s=",er=["scripted","browser","chrome","endpoint"];function nr(e){return typeof e=="string"&&er.includes(e)}function tr(e){try{const n=JSON.parse(e);if(n&&typeof n=="object"){const t=n,o={};return nr(t.brain)&&(o.brain=t.brain),o}}catch{}return{}}function Kt(e=location.hash){if(!e.startsWith(Dn))return{};let n;try{n=decodeURIComponent(e.slice(Dn.length))}catch{return{}}return tr(n)}function or(e){const n=Object.entries(e).filter(([,t])=>t!==void 0);return n.length===0?"":Dn+encodeURIComponent(JSON.stringify(Object.fromEntries(n)))}function ir(e){const n={...Kt(),...e},t=or(n),o=new URL(location.href);o.hash=t,history.replaceState(history.state,"",o)}const ft=[{kind:"scripted",label:"Scripted",hint:"No model. The example's stand-in decides — deterministic and offline."},{kind:"browser",label:"In-browser (WebGPU)",hint:"A small quantised model on your GPU. First run downloads weights."},{kind:"chrome",label:"Chrome built-in",hint:"Gemini Nano, built into Chrome. Chrome owns the weights — no download from this page, no API key."},{kind:"endpoint",label:"API endpoint",hint:"Any OpenAI-compatible server: a local Ollama, or a remote provider with an API key."}],rr=[{mode:"ollama",label:"Ollama (local)"},{mode:"remote",label:"Provider URL + key"}],_t=[{kind:"scripted-vision",label:"Scripted",hint:"No model. The example's known plate is returned — deterministic and offline."},{kind:"browser-vision",label:"In-browser (WebGPU)",hint:"Reads the photo with a vision model on your GPU. First run downloads weights."}];function ar({brain:e,showText:n=!0,showVision:t=!1}){return i.jsxs("div",{className:"brain",children:[n&&i.jsx(sr,{brain:e}),n&&t&&i.jsx("hr",{className:"brain-divider"}),t&&i.jsx(dr,{brain:e})]})}function sr({brain:e}){const n=ft.find(v=>v.kind===e.kind),t=ft.filter(v=>v.kind!=="chrome"||Hi()),o=gn(e.endpointUrl),r=Gt(),s=r&&Nn(e.endpointUrl)?"ollama":"remote",d=v=>{Nn(v)!==Nn(e.endpointUrl)&&e.setApiKey(""),e.setEndpointUrl(v)},c=v=>{v!==s&&d(v==="ollama"?On:"")},[m,a]=b.useState(_n);b.useEffect(()=>{Vi().then(a)},[]);const{kind:p,endpointUrl:u,apiKey:g,listEndpointModels:h}=e;b.useEffect(()=>{if(p!=="endpoint"||o)return;const v=setTimeout(()=>void h(),400);return()=>clearTimeout(v)},[p,u,g,o,h]);const f=m.find(v=>v.id===e.browserModel),N=f?qi(f,qt()):null;return i.jsxs("div",{className:"brain-section",children:[i.jsxs("div",{className:"brain-modes",children:[i.jsx("div",{className:"brain-kinds",role:"group","aria-label":"Agent brain",children:t.map(v=>i.jsx(X,{size:"sm",variant:e.kind===v.kind?"default":"secondary","aria-pressed":e.kind===v.kind,onClick:()=>e.setKind(v.kind),children:v.label},v.kind))}),i.jsxs("div",{className:"brain-status",children:[e.status==="ready"&&e.kind!=="scripted"&&i.jsx(te,{variant:"success",className:"brain-status-badge",children:e.modelInUse??"connected"}),e.status==="connecting"&&i.jsx(te,{variant:"info",className:"brain-status-badge",children:"connecting…"}),e.status==="error"&&i.jsx(te,{variant:"danger",className:"brain-status-badge",children:"not connected"})]})]}),i.jsx("p",{className:"field-hint",children:n.hint}),e.kind==="browser"&&i.jsxs("div",{className:"brain-config",children:[i.jsxs("div",{className:"field",children:[i.jsx(Ge,{htmlFor:"browser-model",children:"Model"}),i.jsxs(Bn,{value:e.browserModel,onValueChange:e.setBrowserModel,disabled:e.status==="connecting",children:[i.jsx(Rn,{id:"browser-model",children:i.jsx(Cn,{})}),i.jsx(In,{children:m.map(v=>i.jsx(An,{value:v.id,children:v.label},v.id))})]}),e.browserModelCached===!0&&i.jsx("p",{className:"field-hint",children:"Already downloaded in this browser — connecting will be fast."}),e.browserModelCached===!1&&i.jsx("p",{className:"field-hint",children:"Not downloaded yet — connecting fetches the weights once, then caches them for next time."})]}),e.webgpu===!1&&e.webgpuReason&&i.jsxs(le,{variant:"destructive",children:[i.jsx(ce,{children:"No WebGPU in this browser"}),i.jsx(me,{children:e.webgpuReason})]}),e.webgpu!==!1&&N&&i.jsxs(le,{variant:"destructive",children:[i.jsx(ce,{children:"This model may not fit in GPU memory"}),i.jsx(me,{children:N})]})]}),e.kind==="chrome"&&i.jsxs("div",{className:"brain-config",children:[i.jsx("p",{className:"field-hint",children:"Nothing to configure: Chrome downloads and manages Gemini Nano itself, so the first Connect may fetch it once and later visits reuse it. Prompts never leave your machine. It's a very small model — expect it to follow the tool-calling format less reliably than an endpoint model."}),e.chromeAiReason&&i.jsxs(le,{variant:"destructive",children:[i.jsx(ce,{children:"Chrome's built-in model isn't available here"}),i.jsx(me,{children:e.chromeAiReason})]})]}),e.kind==="endpoint"&&i.jsxs("div",{className:"brain-config",children:[r?i.jsx("div",{className:"brain-kinds",role:"group","aria-label":"Endpoint provider",children:rr.map(v=>i.jsx(X,{size:"sm",variant:s===v.mode?"default":"secondary","aria-pressed":s===v.mode,disabled:e.status==="connecting",onClick:()=>c(v.mode),children:v.label},v.mode))}):i.jsxs("p",{className:"field-hint",children:["This page isn't served from ",i.jsx("code",{children:"localhost"}),", so a local Ollama isn't offered — it only accepts requests from a page on localhost. Point this at a remote OpenAI-compatible provider, or open this page at ",i.jsx("code",{children:"http://localhost"})," to use Ollama."]}),i.jsxs("div",{className:"field",children:[i.jsx(Ge,{htmlFor:"endpoint-url",children:"Endpoint"}),i.jsx(et,{id:"endpoint-url",value:e.endpointUrl,placeholder:"https://api.openai.com/v1",onChange:v=>d(v.target.value),disabled:e.status==="connecting"}),s==="ollama"?i.jsxs("p",{className:"field-hint",children:["Ollama allows ",i.jsx("code",{children:"localhost"})," origins out of the box; set"," ",i.jsx("code",{children:"OLLAMA_ORIGINS"})," only when serving this page from another host. Best for local development — a hosted copy of this page can't reach a server on your machine at all."]}):i.jsxs("p",{className:"field-hint",children:["The base URL of any OpenAI-compatible provider — it must serve"," ",i.jsx("code",{children:"/models"})," and ",i.jsx("code",{children:"/chat/completions"}),". Calls go straight from this browser to that host."]}),o&&i.jsxs(le,{variant:"destructive",children:[i.jsx(ce,{children:"A local server won't work from this URL"}),i.jsx(me,{children:o})]})]}),i.jsxs("div",{className:"field",children:[i.jsx(Ge,{htmlFor:"endpoint-model",children:"Model"}),i.jsxs("div",{className:"endpoint-model-row",children:[i.jsxs(Bn,{value:e.endpointModel,onValueChange:e.setEndpointModel,disabled:e.status==="connecting"||e.endpointModelsStatus==="loading"||e.endpointModels.length===0,children:[i.jsx(Rn,{id:"endpoint-model",className:"endpoint-model-select",children:i.jsx(Cn,{placeholder:e.endpointModelsStatus==="loading"?"Loading models…":e.endpointModelsStatus==="idle"?"Enter an endpoint above":e.endpointModelsStatus==="error"?"No models — check the endpoint":e.endpointModels.length===0?"No models served":"Select a model"})}),i.jsx(In,{children:e.endpointModels.map(v=>i.jsx(An,{value:v,children:v},v))})]}),i.jsx(X,{size:"sm",variant:"secondary",onClick:()=>void e.listEndpointModels(),disabled:e.status==="connecting"||e.endpointModelsStatus==="loading"||e.endpointUrl.trim()===""||o!==null,children:e.endpointModelsStatus==="loading"?"Refreshing…":"Refresh"})]}),i.jsxs("p",{className:"field-hint",children:["Fetched from the endpoint's ",i.jsx("code",{children:"/models"}),". Tiny models (e.g. SmolLM2) usually can't follow the tool-calling format — prefer ",i.jsx("code",{children:"llama3.2:3b"}),", ",i.jsx("code",{children:"qwen2.5"})," or larger."]}),e.endpointModelsStatus==="error"&&!o&&i.jsxs(le,{variant:"destructive",children:[i.jsx(ce,{children:"Couldn't list models"}),i.jsx(me,{children:e.endpointModelsError})]})]}),i.jsxs("div",{className:"field",children:[i.jsx(Ge,{htmlFor:"endpoint-key",children:s==="ollama"?"API key (optional)":"API key"}),i.jsx(et,{id:"endpoint-key",type:"password",value:e.apiKey,onChange:v=>e.setApiKey(v.target.value),disabled:e.status==="connecting"}),i.jsx("p",{className:"field-hint",children:s==="ollama"?"A local Ollama ignores this — leave it blank.":"Sent as a bearer token to the endpoint above, from this browser only. It's held in memory for this tab, never stored or logged, and cleared if the endpoint moves between a local and a remote host."})]})]}),e.kind!=="scripted"&&i.jsxs("div",{className:"brain-actions",children:[i.jsx(X,{size:"sm",onClick:()=>void e.connect(),disabled:e.status==="connecting"||e.kind==="chrome"&&e.chromeAiReason!==null||e.kind==="endpoint"&&(e.endpointUrl.trim()===""||e.endpointModel===""||e.endpointModelsStatus==="loading"||o!==null),children:e.status==="ready"?"Reconnect":"Connect"}),e.status==="connecting"&&(e.kind==="browser"||e.kind==="chrome")&&i.jsx(X,{size:"sm",variant:"secondary",onClick:e.cancelConnect,children:"Cancel"}),e.progress&&i.jsxs("span",{className:"field-hint",children:[Math.round(e.progress.progress*100),"% —"," ",e.progress.text]})]}),e.progress&&i.jsx("div",{className:"brain-progress",role:"progressbar","aria-valuenow":Math.round(e.progress.progress*100),"aria-valuemin":0,"aria-valuemax":100,children:i.jsx("div",{className:"brain-progress-bar",style:{width:`${Math.round(e.progress.progress*100)}%`}})}),e.error&&i.jsxs(le,{variant:"destructive",children:[i.jsx(ce,{children:"Couldn't connect"}),i.jsx(me,{children:e.error})]})]})}function dr({brain:e}){const n=_t.find(t=>t.kind===e.visionKind);return i.jsxs("div",{className:"brain-section brain-vision",children:[i.jsx(Ge,{children:"Vision (reads the image)"}),i.jsxs("div",{className:"brain-modes",children:[i.jsx("div",{className:"brain-kinds",role:"group","aria-label":"Vision brain",children:_t.map(t=>i.jsx(X,{size:"sm",variant:e.visionKind===t.kind?"default":"secondary","aria-pressed":e.visionKind===t.kind,onClick:()=>e.setVisionKind(t.kind),children:t.label},t.kind))}),i.jsxs("div",{className:"brain-status",children:[e.visionStatus==="ready"&&e.visionKind==="browser-vision"&&i.jsx(te,{variant:"success",className:"brain-status-badge",children:e.visionModelInUse??"connected"}),e.visionStatus==="connecting"&&i.jsx(te,{variant:"info",className:"brain-status-badge",children:"connecting…"}),e.visionStatus==="error"&&i.jsx(te,{variant:"danger",className:"brain-status-badge",children:"not connected"})]})]}),i.jsx("p",{className:"field-hint",children:n.hint}),e.visionKind==="scripted-vision"&&e.webgpu===!1&&e.visionWebgpuReason&&i.jsxs(le,{variant:"destructive",children:[i.jsx(ce,{children:"No WebGPU in this browser"}),i.jsx(me,{children:e.visionWebgpuReason})]}),e.visionKind==="browser-vision"&&i.jsxs("div",{className:"brain-config",children:[i.jsxs("div",{className:"field",children:[i.jsx(Ge,{htmlFor:"vision-model",children:"Model"}),i.jsxs(Bn,{value:e.visionModel,onValueChange:e.setVisionModel,disabled:e.visionStatus==="connecting",children:[i.jsx(Rn,{id:"vision-model",children:i.jsx(Cn,{})}),i.jsx(In,{children:Jt.map(t=>i.jsx(An,{value:t.id,children:t.label},t.id))})]}),i.jsx("p",{className:"field-hint",children:"Connecting downloads the weights once (size shown above), then caches them — every token is read on your GPU, no server."})]}),e.webgpu===!1&&e.visionWebgpuReason&&i.jsxs(le,{variant:"destructive",children:[i.jsx(ce,{children:"No WebGPU in this browser"}),i.jsx(me,{children:e.visionWebgpuReason})]})]}),e.visionKind==="browser-vision"&&i.jsxs("div",{className:"brain-actions",children:[i.jsx(X,{size:"sm",onClick:()=>void e.connectVision(),disabled:e.visionStatus==="connecting",children:e.visionStatus==="ready"?"Reconnect":"Connect"}),e.visionStatus==="connecting"&&i.jsx(X,{size:"sm",variant:"secondary",onClick:e.cancelVisionConnect,children:"Cancel"}),e.visionProgress&&i.jsxs("span",{className:"field-hint",children:[Math.round(e.visionProgress.progress*100),"% —"," ",e.visionProgress.text]})]}),e.visionError&&i.jsxs(le,{variant:"destructive",children:[i.jsx(ce,{children:"Couldn't connect the vision brain"}),i.jsx(me,{children:e.visionError})]})]})}function lr({imageInput:e,value:n,onSelect:t,disabled:o=!1}){const[r,s]=b.useState(null),[d,c]=b.useState(!1),m=b.useRef(null),a=b.useId(),p=b.useId(),u=b.useCallback(f=>{s(URL.createObjectURL(f)),t({imageName:f.name,pixels:f})},[t]);b.useEffect(()=>{if(r)return()=>URL.revokeObjectURL(r)},[r]);const g=b.useCallback(f=>{const N=f==null?void 0:f[0];N&&N.type.startsWith("image/")&&u(N)},[u]),h=(n==null?void 0:n.imageId)!=null?e.seedImages.find(f=>f.id===n.imageId):void 0;return i.jsxs("div",{className:"image-input",children:[e.label&&i.jsx("p",{className:"field-hint",children:e.label}),i.jsx("p",{className:"image-input-label",id:a,children:"Seed photos"}),i.jsx("div",{className:"image-gallery",role:"group","aria-labelledby":a,children:e.seedImages.map(f=>{const N=(n==null?void 0:n.imageId)===f.id;return i.jsxs("button",{type:"button","aria-pressed":N,className:`image-thumb${N?" image-thumb--selected":""}`,disabled:o,title:f.label??f.id,onClick:()=>{s(null),m.current&&(m.current.value=""),t({imageId:f.id,pixels:f.file})},children:[i.jsx("img",{src:f.thumb??f.file,alt:f.label??f.id}),f.label&&i.jsx("span",{children:f.label})]},f.id)})}),i.jsx("label",{className:"image-input-label",htmlFor:p,children:"Or upload your own photo"}),i.jsxs("div",{className:`image-drop${d?" image-drop--over":""}`,onDragOver:f=>{f.preventDefault(),o||c(!0)},onDragLeave:()=>c(!1),onDrop:f=>{f.preventDefault(),c(!1),o||g(f.dataTransfer.files)},children:[i.jsx("input",{ref:m,id:p,type:"file",accept:"image/*",disabled:o,onChange:f=>g(f.target.files)}),i.jsx("p",{className:"field-hint",children:"Drag a photo here, or pick one. Uploading a photo the model has never seen is the proof this runs for real — nothing leaves your browser."})]}),(r||h)&&i.jsxs("div",{className:"image-preview",children:[i.jsx("img",{src:r??(h==null?void 0:h.file),alt:r?(n==null?void 0:n.imageName)??"uploaded photo":(h==null?void 0:h.label)??(h==null?void 0:h.id)??"selected photo"}),i.jsx("span",{className:"field-hint",children:r?`Uploaded: ${(n==null?void 0:n.imageName)??"your photo"}`:`Selected: ${(h==null?void 0:h.label)??(h==null?void 0:h.id)}`}),i.jsx("button",{type:"button",className:"image-clear-btn",disabled:o,onClick:()=>{s(null),m.current&&(m.current.value=""),t(null)},children:"Clear"})]})]})}function Zt(e){return typeof e=="object"&&e!==null}function El(e){const n=new Set,t=o=>{Zt(o)&&(typeof o.key=="string"&&n.add(o.key),Array.isArray(o.components)&&o.components.forEach(t))};return t(e),n}function cr(e){const n={},t=o=>{Zt(o)&&(typeof o.key=="string"&&"defaultValue"in o&&(n[o.key]=o.defaultValue??""),Array.isArray(o.components)&&o.components.forEach(t))};return t(e),n}const mr="wdf:section:v2:";function Yt(e){return mr+e}function wt(e){try{const n=window.localStorage.getItem(Yt(e));return n==="1"?!0:n==="0"?!1:void 0}catch{return}}function pr(e,n){try{window.localStorage.setItem(Yt(e),n?"1":"0")}catch{}}function $n(e,n=!0){const[t,o]=b.useState(()=>wt(e)??n);b.useEffect(()=>{o(wt(e)??n)},[e,n]);const r=b.useCallback(s=>{o(s),pr(e,s)},[e]);return[t,r]}function Le({sectionId:e,title:n,description:t,defaultOpen:o=!0,className:r,children:s,...d}){const[c,m]=$n(e,o);return i.jsx(lo,{className:["panel",r].filter(Boolean).join(" "),"data-tour":d["data-tour"],children:i.jsxs(co,{open:c,onOpenChange:m,children:[i.jsxs(mo,{className:"panel-trigger",children:[i.jsxs("span",{className:"panel-trigger-text",children:[i.jsx("span",{className:"panel-title",children:n}),t!=null&&i.jsx("span",{className:"panel-desc",children:t})]}),i.jsx(po,{className:"panel-chevron","aria-hidden":!0})]}),i.jsx(uo,{children:i.jsx(ho,{children:s})})]})})}function ur(e){return e.entries!==void 0}function hr(e){const n=[];let t=null;for(const o of e)o.turn!==void 0?t&&t.turn===o.turn?t.entries.push(o):(t={turn:o.turn,entries:[o]},n.push(t)):(t=null,n.push(o));return n}function yt(e){if(e===void 0)return"undefined";try{return JSON.stringify(e)}catch{return"[unserializable value]"}}function br({activation:e,result:n,labelFor:t}){const o=e.elementId??"";return i.jsxs("div",{className:"timeline-tool",children:[i.jsxs("div",{className:"timeline-tool-head",children:[i.jsx(te,{variant:"info",children:"tool"}),i.jsx("strong",{children:t(o)||o}),i.jsx("code",{children:o})]}),e.args!==void 0&&Object.keys(e.args).length>0&&i.jsxs("div",{className:"timeline-kv",children:[i.jsx("span",{className:"timeline-kv-label",children:"arguments"}),i.jsx("code",{children:yt(e.args)})]}),i.jsxs("div",{className:"timeline-kv",children:[i.jsx("span",{className:"timeline-kv-label",children:"returned"}),i.jsx("code",{children:n?yt(n.result):"— waiting for the job to complete —"})]})]})}function gr({group:e,labelFor:n}){const t=e.entries.find(a=>a.kind==="llm"),o=e.entries.filter(a=>a.kind==="agent"&&a.elementId),r=e.entries.filter(a=>a.kind==="vars"&&a.elementId),s=e.entries.filter(a=>a.kind==="agent"&&!a.elementId),d=e.entries.filter(a=>a.kind==="error"),c=new Set(o.map(a=>a.elementId)),m=e.entries.filter(a=>a.kind==="tool"||a.kind==="vars"&&a.elementId&&!c.has(a.elementId)).sort((a,p)=>a.id-p.id);return i.jsxs("div",{className:"timeline-turn",children:[i.jsxs("div",{className:"timeline-turn-head",children:[i.jsxs(te,{variant:t!=null&&t.pending?"warning":"neutral",children:["Turn ",e.turn]}),(t==null?void 0:t.pending)&&i.jsx("span",{className:"timeline-pending",children:"thinking…"})]}),t&&i.jsx("blockquote",{className:"timeline-reply",children:t.text}),s.map(a=>i.jsx("div",{className:"timeline-note",children:a.text},a.id)),o.map(a=>i.jsx(br,{activation:a,result:r.find(p=>p.elementId===a.elementId),labelFor:n},a.id)),m.map(a=>i.jsxs("div",{className:`log-line log-${a.kind}`,children:[a.pending?"⏳ ":"",a.text]},a.id)),d.map(a=>i.jsxs("div",{className:"timeline-error",children:["⚠ ",a.text]},a.id))]})}function fr({log:e,elementStats:n=[],incidents:t=[],labelFor:o=d=>d,variables:r,hasAgent:s=!1}){const d=b.useMemo(()=>hr(e),[e]),[c,m]=b.useState(!1),[a,p]=$n("engine-view",!1),u=b.useRef(null);b.useEffect(()=>{const h=u.current;h&&(h.scrollTop=h.scrollHeight)},[d]);const g=()=>{var N;const h={log:e.map(({id:v,..._})=>_),elementStats:n,incidents:t},f=JSON.stringify(h,null,2);(N=navigator.clipboard)!=null&&N.writeText&&navigator.clipboard.writeText(f).then(()=>{m(!0),setTimeout(()=>m(!1),1500)}).catch(()=>{})};return i.jsxs(Le,{sectionId:"activity",className:"grow activity-card",title:s?"Agent activity":"Activity",description:s?"Agent turns, model replies, and tool calls — read top to bottom as a story.":"Every step the engine took — read top to bottom as a story.",children:[i.jsx("div",{className:"timeline-toolbar",children:i.jsx(X,{variant:"secondary",size:"sm",onClick:g,children:c?"Copied!":"Copy run as JSON"})}),i.jsx("div",{className:"timeline",ref:u,children:d.length===0?i.jsx("div",{className:"log-empty",children:"Press Run or Step to start."}):d.map(h=>ur(h)?i.jsx(gr,{group:h,labelFor:o},`turn-${h.turn}-${h.entries[0].id}`):i.jsxs("div",{className:`log-line log-${h.kind}`,children:[h.pending?"⏳ ":"",h.text]},h.id))}),r,(n.length>0||t.length>0)&&i.jsxs("details",{className:"engine-view",open:a,onToggle:h=>p(h.currentTarget.open),children:[i.jsxs("summary",{children:["Element completion",t.length>0&&` · ${t.length} incident${t.length===1?"":"s"}`]}),i.jsxs("div",{className:"timeline-engine-view",children:[n.length>0&&i.jsxs("div",{className:"timeline-stats",children:[i.jsx("span",{className:"timeline-kv-label",children:"Element completion"}),i.jsx("ul",{children:n.filter(h=>h.completed>0||(h.active??0)>0).map(h=>i.jsxs("li",{children:[i.jsx("code",{children:o(h.elementId)||h.elementId})," ","completed ",h.completed,h.active?`, ${h.active} active`:""]},h.elementId))})]}),t.length>0&&i.jsxs("div",{className:"timeline-incidents",children:[i.jsx("span",{className:"timeline-kv-label",children:"Incidents"}),i.jsx("ul",{children:t.map((h,f)=>i.jsxs("li",{children:[i.jsx("code",{children:o(h.elementId)||h.elementId})," —"," ",h.reason]},`${h.elementId}-${f}`))})]})]})]})]})}const Pe={diagram:"diagram",runButton:"run-button",variablesPanel:"variables-panel",codePanel:"code-panel",brainPanel:"brain-panel"};function vt(e){return`[data-tour="${e}"]`}function _r(e=location.search){return new URLSearchParams(e).get("tour")}function wr(e){return"anchor"in e?vt(e.anchor):`${vt(Pe.diagram)} [data-element-id="${yr(e.elementId)}"]`}function yr(e){return typeof CSS<"u"&&typeof CSS.escape=="function"?CSS.escape(e):e.replace(/[^a-zA-Z0-9_-]/g,n=>`\\${n}`)}function vr(e){return e.map(n=>({element:wr(n.target),popover:{title:n.title,description:n.description,showButtons:["next","previous","close"]},disableActiveInteraction:!1,skipMissingElement:n.skipMissingElement??!0}))}async function xr(e){const[{driver:n}]=await Promise.all([he(()=>import("./driver.js-bj_ppY-Q.js"),[]),he(()=>Promise.resolve({}),__vite__mapDeps([0]))]),t=n({steps:vr(e),showProgress:!0,allowClose:!0,skipMissingElement:!0});return t.drive(),{isActive:()=>t.isActive(),destroy:()=>t.destroy()}}const Er=300;function kr(e){const[n,t]=b.useState(!1),o=b.useRef(null),r=b.useRef(null),s=b.useRef(0),d=b.useCallback(()=>{r.current!==null&&(clearInterval(r.current),r.current=null)},[]),c=b.useCallback(()=>{var a;s.current+=1,d(),(a=o.current)==null||a.destroy(),o.current=null,t(!1)},[d]),m=b.useCallback(()=>{if(!e||e.steps.length===0||o.current)return;const a=s.current+=1;xr(e.steps).then(p=>{if(a!==s.current||!p.isActive()){p.destroy();return}o.current=p,t(!0);const u=setInterval(()=>{if(o.current!==p){clearInterval(u);return}p.isActive()||(clearInterval(u),r.current===u&&(r.current=null),o.current=null,t(!1))},Er);r.current=u})},[e,d]);return b.useEffect(()=>c,[c]),{active:n,start:m,stop:c}}function Nr(){return typeof window>"u"||!window.matchMedia?!1:window.matchMedia("(prefers-reduced-motion: reduce)").matches}function Pr({enabled:e,ready:n,targetRef:t,start:o}){const r=b.useRef(!1),[s,d]=b.useState(!1),c=b.useRef(o);b.useEffect(()=>{c.current=o},[o]),b.useEffect(()=>{if(!e||r.current)return;const m=t.current;if(!m||typeof IntersectionObserver>"u"){d(!0);return}const a=new IntersectionObserver(p=>{p.some(u=>u.isIntersecting)&&(d(!0),a.disconnect())},{threshold:.01});return a.observe(m),()=>a.disconnect()},[e,t]),b.useEffect(()=>{!e||r.current||!n||!s||Nr()||(r.current=!0,c.current())},[e,n,s])}const Be=650,Pn="__agent__",xt="__model__",Et="__template__:";function Mr(e){return e.kind.toLowerCase().includes("boundary")}const Sr=b.lazy(async()=>{await Promise.all([he(()=>Promise.resolve({}),__vite__mapDeps([1])),he(()=>Promise.resolve({}),__vite__mapDeps([2])),he(()=>Promise.resolve({}),__vite__mapDeps([3]))]);const{RuntimeDiagram:e}=await he(async()=>{const{RuntimeDiagram:n}=await import("./RuntimeDiagram-DTnJz5cT.js");return{RuntimeDiagram:n}},__vite__mapDeps([4,5,6]));return{default:e}}),Mn=b.lazy(()=>he(()=>import("./MonacoEditor-BNA-dabx.js").then(e=>e.M),__vite__mapDeps([7,5,8]))),Br=b.lazy(()=>he(()=>import("./vendor-modeler-BzScQTrW.js"),__vite__mapDeps([9,5,6,10,11,12,13,1,2,3]))),kt=b.lazy(async()=>{const{FormRenderer:e}=await he(async()=>{const{FormRenderer:n}=await import("./FormRenderer-CCyI0y9T.js");return{FormRenderer:n}},__vite__mapDeps([14,5,12,10,11,15]));return{default:e}});function mn(e,n){try{return JSON.stringify(e??{},null,n)}catch{return"[unserializable value]"}}function Rr(e){const n=mn(e).replace(/\s+/g," ");return n.length>78?`${n.slice(0,78)}…`:n}function Cr({example:e,compact:n=!1,autostart:t=!1,initialBrainKind:o,initialTourId:r}){var Hn,Jn,Wn,Kn,Zn,Yn,Qn,Xn;const[s,d]=b.useState(e.bpmn),c=b.useRef(null),m=Xi(),[a,p]=b.useState(null);b.useEffect(()=>{o&&o!==m.kind&&m.setKind(o)},[]),b.useEffect(()=>{ir({brain:m.kind})},[m.kind]);const[u,g]=b.useState(()=>Object.fromEntries(e.handlers.map(w=>[w.elementId,w.source]))),[h,f]=b.useState(e.scriptedAgent??""),[N,v]=b.useState(()=>nn(e.templates)),_=b.useMemo(()=>ni(e,u,s,N),[e,u,s,N]),x=_.model,E=Bi({bpmn:_.resolvedBpmn});Di(E.phase==="ready");const q=kr(e.tour);b.useEffect(()=>{var w;r&&((w=e.tour)==null?void 0:w.id)===r&&q.start()},[]);const Y=x.startFormId?((Hn=e.forms)==null?void 0:Hn[x.startFormId])??null:null,[J,be]=b.useState(()=>({...e.seed,...Y?cr(Y):{}})),[Ce,ge]=b.useState(x.agent?Pn:((Jn=e.handlers[0])==null?void 0:Jn.elementId)??""),Me=b.useMemo(()=>{const w=(e.scenarios??[]).findIndex(k=>Object.entries(k.variables).every(([M,T])=>JSON.stringify(J[M])===JSON.stringify(T)));return w===-1?null:w},[e.scenarios,J]),[ee,fe]=$n(n?"start-compact":"start",n?!1:!!Y),[de,C]=b.useState(!1),[S,P]=b.useState(!1),[j,H]=b.useState(!1),[ye,Oe]=b.useState(null),[wn,ve]=b.useState([]),[He,re]=b.useState({}),Fe=b.useMemo(()=>({...e.seed,...J,...jo(e.imageInput?a:null)}),[e.seed,e.imageInput,J,a]),[tn,yn]=b.useState(null),xe=b.useRef(null),[je,Ie]=b.useState({}),[vn,xn]=b.useState(!1),Je=b.useRef(null),Q=b.useRef(!1),U=b.useRef(0),We=b.useRef(0),ze=b.useRef({current:void 0}),Ne=b.useRef({}),Ae=b.useRef({}),Ke=b.useMemo(()=>{const w=new Map;for(const k of x.processes){for(const M of k.tasks)w.set(M.elementId,M.label);for(const M of k.agents){w.set(M.elementId,M.label);for(const T of M.tools)w.set(T.elementId,T.label)}for(const M of k.userTasks)w.set(M.elementId,M.label)}return k=>w.get(k)??k},[x]),O=b.useCallback(w=>{ve(k=>{if(w.key){const M=k.findIndex(T=>T.key===w.key);if(M>=0){const T=[...k];return T[M]={...T[M],...w},T}}return[...k,{...w,id:We.current++}].slice(-80)})},[]),oe=b.useMemo(()=>{var w;return((w=E.snapshot)==null?void 0:w.userTasks.find(k=>k.state==="Created"))??null},[E.snapshot]),Te=b.useMemo(()=>{const w=x.processes.flatMap(M=>M.tasks),k=new Map;for(const M of e.handlers){if(!M.manualControl)continue;const T=w.find(R=>R.elementId===M.elementId);T&&k.set(T.jobType,{...M.manualControl,elementId:M.elementId})}return k},[e.handlers,x]),Se=b.useMemo(()=>{if(!E.snapshot)return null;for(const w of E.snapshot.jobs){const k=Te.get(w.jobType);if(k&&w.state==="Created")return{job:w,control:k}}return null},[E.snapshot,Te]),on=b.useMemo(()=>{const w=e.requiredTools;if(!x.agent||!E.snapshot||!(w!=null&&w.length))return[];const k=new Map(E.snapshot.elementStats.map(M=>[M.elementId,M.completed]));return x.agent.tools.filter(M=>w.includes(M.elementId)&&(k.get(M.elementId)??0)===0)},[x.agent,E.snapshot,e.requiredTools]),$e=b.useMemo(()=>{var M,T;return!oe||!x.agent?!1:new Set(x.agent.tools.map(R=>R.elementId)).has(oe.elementId)?!0:(((T=(M=E.snapshot)==null?void 0:M.elementStats.find(R=>R.elementId===x.agent.elementId))==null?void 0:T.completed)??0)===0},[oe,x.agent,E.snapshot]),_e=oe?x.userTasks.find(w=>w.elementId===oe.elementId):void 0,Ue=_e!=null&&_e.formId?((Wn=e.forms)==null?void 0:Wn[_e.formId])??null:null,B=b.useCallback(async(w,k,M,T)=>{var pe,ae,se;let R=M,we=0;for(;U.current===T&&R&&R.completedInstances<1&&we++<80;){const Z=await E.stepWorkers(w,{agents:k});if(U.current!==T)return R;R=(Z==null?void 0:Z.snapshot)??R;const G=(pe=R.instances[0])==null?void 0:pe.variables;if(G&&re({...G}),R.userTasks.some(D=>D.state==="Created")){O({kind:"human",text:"⏸ waiting for a human — complete the task below to continue"});break}if(!Z){O({kind:"error",text:"▶ run stopped — no dispatch round was returned"});break}if(Z.handled===0){const D=R.messageSubscriptions.find(L=>!Mr(L));if(Z.reason==="messages"&&D){if(O({kind:"step",text:`⏳ parked on a message catch event — waiting for "${D.messageName}"`,elementId:D.elementId}),await new Promise(ie=>setTimeout(ie,Be)),U.current!==T)return R;O({kind:"vars",text:`📨 correlating message "${D.messageName}" (key: ${D.correlationKey})`,elementId:D.elementId});const L=E.correlateMessage(D.messageName,D.correlationKey,"{}");if(L){R=L;const ie=(ae=R.instances[0])==null?void 0:ae.variables;ie&&re({...ie}),await new Promise(ue=>setTimeout(ue,Be));continue}O({kind:"error",text:`▶ run stopped — correlating "${D.messageName}" (key: ${D.correlationKey}) failed`,elementId:D.elementId})}if(Z.reason==="signals"&&R.signalSubscriptions.length>0){const L=R.signalSubscriptions[0],ie=R.signalSubscriptions.length;if(O({kind:"step",text:`⏳ parked on ${ie} open signal subscription${ie===1?"":"s"} — waiting for "${L.signalName}"`,elementId:L.elementId}),await new Promise(qe=>setTimeout(qe,Be)),U.current!==T)return R;const ue=E.broadcastSignal(L.signalName,"{}");if(ue){R=ue,O({kind:"vars",text:`📡 broadcasting signal "${L.signalName}" — every waiting subscription unblocks`,elementId:L.elementId});const qe=(se=R.instances[0])==null?void 0:se.variables;qe&&re({...qe}),await new Promise(io=>setTimeout(io,Be));continue}O({kind:"error",text:`▶ run stopped — broadcasting signal "${L.signalName}" failed`,elementId:L.elementId})}if(Z.reason==="timers"){const L=R.timers.reduce((ie,ue)=>Math.min(ie,ue.dueInMs),1/0);if(Number.isFinite(L)){if(O({kind:"step",text:`⏳ parked on a timer — ${(Math.max(L,0)/1e3).toFixed(1)}s left on the clock`}),await new Promise(ue=>setTimeout(ue,Be)),U.current!==T)return R;const ie=E.advanceTime(Math.max(L,0)+1);if(ie){R=ie,O({kind:"step",text:"🕐 the clock advanced — timer fired"}),await new Promise(ue=>setTimeout(ue,Be));continue}}}break}await new Promise(D=>setTimeout(D,Be))}return U.current!==T||(R&&R.completedInstances>=1?O({kind:"done",text:"✅ process instance completed"}):R&&R.incidentElementIds.length>0&&O({kind:"error",text:"A job failed — incident on the diagram"})),R},[E,O]),K=b.useCallback(async w=>{var R,we,pe,ae;if(!Se||Q.current)return;const{job:k,control:M}=Se,T=++U.current;Q.current=!0,P(!0);try{let se,Z;if(w==="complete")se=E.completeJobManually(k.jobType,"{}"),Z="  ↳ completed normally";else if(M.action.kind==="timer"){const G=((we=(R=E.snapshot)==null?void 0:R.timers[0])==null?void 0:we.dueInMs)??0;se=E.advanceTime(Math.max(G,0)+1),Z="  ↳ advanced the clock — timer fired"}else if(M.action.kind==="message"){const{messageName:G}=M.action,D=(pe=E.snapshot)==null?void 0:pe.messageSubscriptions.find(L=>L.messageName===G);if(!D){O({kind:"error",text:`  ↳ no open subscription for "${G}" to correlate against`,elementId:k.elementId});return}se=E.correlateMessage(G,D.correlationKey,"{}"),Z=`  ↳ published "${G}" (key: ${D.correlationKey})`}else{const{errorCode:G,message:D}=M.action;se=E.throwJobError(k.jobType,G,D),Z=`  ↳ threw BPMN error ${G}: ${D}`}if(se){O({kind:"vars",text:Z,elementId:k.elementId});const G=(ae=se.instances[0])==null?void 0:ae.variables;G&&re({...G}),await new Promise(D=>setTimeout(D,Be)),await B(Ne.current,Ae.current,se,T)}else O({kind:"error",text:"  ↳ failed to resolve the manual job",elementId:k.elementId})}finally{U.current===T&&(Q.current=!1,P(!1))}},[Se,E,O,B]),F=b.useCallback(async()=>{var Z;let w=null;try{x.agent&&h.trim()&&(w=qo(h))}catch(G){return Oe(G instanceof Error?G.message:String(G)),null}ze.current={current:void 0};let k;if(e.imageInput){const G=m.vision;k={read:G??Yi(e.scriptedVision).read,live:!!G,resolve:L=>E.getRunImage(L)}}const M=Jo(x,_.handlers,O,ze.current,k);for(const G of Te.keys())delete M[G];const T={};if(x.agents.length>0)if(m.kind!=="scripted"&&m.chat){const D=new Map;for(const L of x.agents)D.set(L.jobType,[...D.get(L.jobType)??[],L]);for(const[L,ie]of D)T[L]=ci(ie,m.chat,O,{turnRef:ze.current,requiredTools:e.requiredTools})}else w&&x.agent&&(T[x.agent.jobType]=async D=>{const L=await w(D),ie=(L.activateElements??[]).map(qe=>qe.elementId).join(", "),ue=x.agents.length>1?` (${D.elementId})`:"";return O({kind:"agent",text:L.completionConditionFulfilled?`🤖 scripted agent${ue}: done`:`🤖 scripted agent${ue}: calling ${ie||"(nothing)"}`}),L});ve([]),Ie({});const R=Fe;re(R),Ne.current=M,Ae.current=T;const we=await E.redeploy(s),pe=(we==null?void 0:we[0])??x.processId;O({kind:"start",text:`Starting "${pe}" — ${x.agent?m.kind==="scripted"||!m.chat?"scripted brain":`live brain (${m.modelInUse??m.kind})`:"no agent in this model"}`});let ae;if(x.startMessage){const{messageName:G,correlationKey:D}=x.startMessage,L=To(D,R);O({kind:"step",text:`📨 publishing "${G}" (key: ${L}) — a message start event has no other way in`,elementId:x.startMessage.elementId}),ae=E.correlateMessage(G,L,JSON.stringify(R))}else ae=E.createInstance(pe,JSON.stringify(R));const se=(Z=ae==null?void 0:ae.instances[0])==null?void 0:Z.key;return e.imageInput&&a&&se&&E.setRunImage(se,a),{workers:M,agents:T,snap:ae}},[E,e,_,s,h,J,a,Fe,x,m,O,Te]),W=!!E.snapshot&&E.snapshot.completedInstances<1,Ee=!W&&!!Y&&tn!==!0,Ve=!W&&!!Y&&tn===!1,En=ee||de;b.useEffect(()=>{n&&Ve&&C(!0)},[n,Ve]);const Vn=w=>{fe(w),w||C(!1)},qn=b.useCallback(async()=>{if(E.phase!=="ready"||Q.current||j||_.hasErrors)return;Q.current=!0,P(!0);const w=++U.current;try{let k=Ne.current,M=Ae.current,T=E.snapshot;if(!W){if(xe.current&&!xe.current.validate())return;Oe(null);const R=await F();if(!R)return;k=R.workers,M=R.agents,T=R.snap,await new Promise(we=>setTimeout(we,Be))}await B(k,M,T,w)}finally{U.current===w&&(Q.current=!1,P(!1))}},[E,j,_.hasErrors,W,F,B]),Gn=E.phase==="ready"&&!S&&!j&&!_.hasErrors&&!Ee;Pr({enabled:t,ready:Gn,targetRef:c,start:()=>void qn()});const Xt=b.useCallback(async()=>{var k;if(E.phase!=="ready"||Q.current||j||_.hasErrors)return;Q.current=!0,H(!0);const w=++U.current;try{let M=Ne.current,T=Ae.current,R=E.snapshot;if(!W){if(xe.current&&!xe.current.validate())return;Oe(null);const Z=await F();if(!Z)return;M=Z.workers,T=Z.agents,R=Z.snap}if(!R||R.completedInstances>=1)return;const we=R.takenSequenceFlows.length,pe=await E.stepWorkers(M,{agents:T});if(!pe){O({kind:"error",text:"⏭ step failed — no dispatch round was returned"});return}const ae=(k=pe.snapshot.instances[0])==null?void 0:k.variables;ae&&re({...ae});const se=Li(pe.snapshot.takenSequenceFlows,we);O(Oi(pe,se,Ke,Te))}finally{U.current===w&&(Q.current=!1,H(!1))}},[E,j,_.hasErrors,W,F,O,Ke,Te]),eo=b.useCallback(async()=>{Q.current=!1,U.current++,P(!1),H(!1),Q.current=!0;try{await E.reset()}finally{Q.current=!1}ve([]),re({})},[E]),no=b.useCallback(async()=>{var T;if(!oe||Q.current||Je.current&&!Je.current.validate())return;const w=++U.current,k=E.completeUserTask(oe.key,JSON.stringify(je));O({kind:"human",text:`👤 ${mn(je)}`});const M=(T=k==null?void 0:k.instances[0])==null?void 0:T.variables;if(re(R=>({...R,...je,...M??{}})),k&&k.completedInstances>=1){O({kind:"done",text:"✅ process instance completed"});return}if(k){Q.current=!0,P(!0);try{await B(Ne.current,Ae.current,k,w)}finally{U.current===w&&(Q.current=!1,P(!1))}}},[oe,je,E,O,B]),to=b.useMemo(()=>{var w,k;return E.phase==="loading"?i.jsx(te,{variant:"neutral",children:"Booting engine…"}):E.phase==="error"?i.jsx(te,{variant:"danger",children:"Engine error"}):S?i.jsx(te,{variant:"info",children:"Running…"}):j?i.jsx(te,{variant:"info",children:"Stepping…"}):(((w=E.snapshot)==null?void 0:w.incidentElementIds.length)??0)>0?i.jsx(te,{variant:"danger",children:"Incident"}):oe?i.jsx(te,{variant:"warning",children:"Waiting for a human"}):(((k=E.snapshot)==null?void 0:k.completedInstances)??0)>=1?i.jsx(te,{variant:"success",children:"Completed"}):E.snapshot?i.jsx(te,{variant:"warning",children:"Paused"}):i.jsx(te,{variant:"neutral",children:"Ready"})},[E.phase,E.snapshot,S,j,oe]),oo=b.useMemo(()=>e.blurb.split(/\n\s*\n/).map(w=>w.trim()).filter(Boolean),[e.blurb]);return i.jsxs("div",{className:"runner",ref:c,children:[n?i.jsx("h1",{className:"visually-hidden",children:e.title}):i.jsxs("section",{className:"intro",children:[i.jsx("h1",{children:e.title}),oo.map(w=>i.jsx("p",{children:w},w))]}),e.imageInput&&i.jsx(lr,{imageInput:e.imageInput,value:a,onSelect:p,disabled:S}),i.jsxs("div",{className:"scenario",children:[i.jsx("span",{className:"scenario-label",id:"scenario-label",children:e.scenariosLabel??"Example input"}),e.scenarios&&i.jsx("div",{className:"scenario-toggle",role:"group","aria-labelledby":"scenario-label",children:e.scenarios.map((w,k)=>i.jsx(X,{size:"sm",variant:k===Me?"default":"secondary","aria-pressed":k===Me,disabled:S,onClick:()=>be(M=>({...M,...w.variables})),children:w.label},w.label))}),i.jsxs("button",{type:"button",className:"scenario-input-button",onClick:()=>Vn(!En),"aria-expanded":En,"aria-controls":"start-input-editor",title:"Edit the starting payload",children:[i.jsx("span",{className:"scenario-edit-icon","aria-hidden":!0,children:"✎"})," ","input: ",i.jsx("code",{children:Rr(J)})]}),Ee&&i.jsx("span",{className:"scenario-hint",children:"Fill in the input to enable Run"})]}),i.jsxs("div",{className:"inline-input-editor",id:"start-input-editor",hidden:!En,children:[i.jsxs("div",{className:"inline-input-editor-head",children:[i.jsxs("div",{children:[i.jsx("div",{className:"inline-input-editor-title",children:x.startFormId?"Start form":"Start payload"}),i.jsx("div",{className:"inline-input-editor-copy",children:x.startFormId?`Rendered from the model's start form "${x.startFormId}".`:"The variables the instance starts with."})]}),i.jsx(X,{size:"sm",variant:"secondary",onClick:()=>Vn(!1),children:"Done"})]}),Y?i.jsx(b.Suspense,{fallback:i.jsx("div",{className:"form-fallback",children:"Loading form…"}),children:i.jsx(kt,{ref:xe,schema:Y,values:J,onChange:(w,k)=>be(M=>({...M,[w]:k})),disabled:S,onValidityChange:yn})}):i.jsx("pre",{className:"vars",children:mn(J,2)})]}),!n&&(x.agent||e.imageInput)&&i.jsx(Le,{sectionId:"brain",className:"brain-card","data-tour":Pe.brainPanel,title:"Agent brain",description:x.agent?`What drives “${x.agent.label}”. The model recommends; the process governs.`:"What reads the image. The model recommends; the process governs.",children:i.jsx(ar,{brain:m,showText:!!x.agent,showVision:!!e.imageInput})}),i.jsxs("div",{className:"controls",children:[i.jsx(X,{"data-tour":Pe.runButton,onClick:()=>void qn(),disabled:!Gn,children:"▶ Run"}),i.jsx(X,{variant:"secondary",onClick:()=>void Xt(),disabled:E.phase!=="ready"||S||j||_.hasErrors||Ee||(((Kn=E.snapshot)==null?void 0:Kn.completedInstances)??0)>=1,children:"⏭ Step"}),i.jsx(X,{variant:"secondary",onClick:()=>void eo(),disabled:E.phase!=="ready"||j,children:"↺ Reset"}),e.tour&&i.jsx(X,{variant:"secondary",onClick:q.start,disabled:q.active,children:q.active?"Touring…":`🧭 ${e.tour.label}`}),to]}),E.phase==="error"&&i.jsxs(le,{variant:"destructive",children:[i.jsx(ce,{children:"Engine error"}),i.jsx(me,{children:E.error})]}),ye&&i.jsxs(le,{variant:"destructive",children:[i.jsx(ce,{children:"Code didn't compile"}),i.jsx(me,{children:ye})]}),_.hasErrors&&i.jsxs(le,{variant:"destructive",children:[i.jsx(ce,{children:"Run is disabled — the diagram has unresolved references"}),i.jsx(me,{children:i.jsx("ul",{className:"diagnostics",children:_.diagnostics.filter(w=>w.severity==="error").map((w,k)=>i.jsx("li",{children:w.message},k))})})]}),!_.hasErrors&&_.diagnostics.length>0&&i.jsxs(le,{children:[i.jsx(ce,{children:"Heads up"}),i.jsx(me,{children:i.jsx("ul",{className:"diagnostics",children:_.diagnostics.map((w,k)=>i.jsx("li",{children:w.message},k))})})]}),i.jsxs("div",{className:"grid",children:[i.jsxs("div",{className:"col",children:[i.jsx(Le,{sectionId:"process","data-tour":Pe.diagram,title:"Process",description:`${x.processName} — live token (green), incidents (red).`,children:i.jsx(b.Suspense,{fallback:i.jsx("div",{className:"diagram-fallback",children:E.phase==="loading"?"Booting the engine…":"Loading diagram…"}),children:i.jsx(Sr,{xml:_.resolvedBpmn,activeIds:((Zn=E.snapshot)==null?void 0:Zn.activeElementIds)??[],incidentIds:((Yn=E.snapshot)==null?void 0:Yn.incidentElementIds)??[],className:"diagram"})})}),oe&&i.jsxs(Le,{sectionId:"human-task",title:(_e==null?void 0:_e.label)??"Human task",description:Ue?`Rendered from the model's form "${_e==null?void 0:_e.formId}".`:"This task has no linked form — complete it with no variables.",children:[on.length>0&&!$e&&i.jsxs(le,{variant:"destructive",children:[i.jsx(ce,{children:"The agent didn't finish its checks"}),i.jsxs(me,{children:["It completed without running"," ",on.map(w=>w.label||w.elementId).join(", "),". The process took the default path to this task, so the findings below have no value to report."]})]}),Ue&&i.jsx(b.Suspense,{fallback:i.jsx("div",{className:"form-fallback",children:"Loading form…"}),children:i.jsx(kt,{ref:Je,schema:Ue,values:je,onChange:(w,k)=>Ie(M=>({...M,[w]:k})),context:He,onValidityChange:xn})}),i.jsx(X,{onClick:no,disabled:!!Ue&&!vn,children:"Complete task"})]}),Se&&i.jsx(Le,{sectionId:"manual-job",title:Se.control.label,description:"This job is held here on purpose — pick how it resolves.",children:i.jsxs("div",{className:"controls",children:[i.jsx(X,{onClick:()=>void K("complete"),disabled:S||j,children:Se.control.completeLabel??"✅ Complete normally"}),i.jsx(X,{variant:"secondary",onClick:()=>void K("action"),disabled:S||j,children:Se.control.action.label})]})})]}),i.jsx("div",{className:"col",children:i.jsx(fr,{log:wn,elementStats:(Qn=E.snapshot)==null?void 0:Qn.elementStats,incidents:(Xn=E.snapshot)==null?void 0:Xn.incidents,labelFor:Ke,hasAgent:!!x.agent,variables:i.jsxs("div",{className:"vars-block","data-tour":Pe.variablesPanel,children:[i.jsx("div",{className:"vars-head",children:"Instance variables"}),i.jsx("pre",{className:"vars",children:mn(Object.keys(He).length>0?He:Fe,2)})]})})})]}),!n&&i.jsxs("div",{className:"runner-secondary",children:[i.jsx(Le,{sectionId:"code",className:"editors","data-tour":Pe.codePanel,defaultOpen:!1,title:"Code",description:"One handler per BPMN element, plus a model tab holding the editable diagram — select an element there to edit its properties. Return variables to merge, or throw to fail the job.",children:i.jsx(b.Suspense,{fallback:i.jsx("div",{className:"editor-fallback",children:"Loading editor…"}),children:i.jsxs(bo,{value:Ce,onValueChange:ge,children:[i.jsxs(go,{children:[i.jsx(rn,{value:xt,children:"model"}),x.agent&&i.jsx(rn,{value:Pn,children:"agent (scripted)"}),e.handlers.map(w=>{var k;return i.jsx(rn,{value:w.elementId,children:((k=x.tasks.find(M=>M.elementId===w.elementId))==null?void 0:k.label)??w.elementId},w.elementId)}),Object.keys(N).map(w=>i.jsx(rn,{value:Et+w,children:w},w))]}),i.jsxs(an,{value:xt,children:[i.jsxs("div",{className:"editor-meta",children:[i.jsx("strong",{children:"Model"}),i.jsx("code",{children:"click an element to edit its properties on the right — Run re-reads whatever you leave here"}),i.jsx(X,{variant:"secondary",size:"sm",onClick:()=>d(e.bpmn),disabled:s===e.bpmn,children:"Revert to original"})]}),i.jsx(Br,{value:s,onChange:d})]}),x.agent&&i.jsxs(an,{value:Pn,children:[i.jsxs("div",{className:"editor-meta",children:[i.jsx("strong",{children:x.agent.label}),i.jsx("code",{children:m.kind==="scripted"||!m.chat?"in use":"unused — a live brain is connected"})]}),i.jsx("div",{className:"editor-wrap",children:i.jsx(Mn,{height:"360px",defaultLanguage:"javascript",value:h,onChange:w=>f(w??""),options:Sn})})]}),e.handlers.map(w=>{var k;return i.jsxs(an,{value:w.elementId,children:[i.jsxs("div",{className:"editor-meta",children:[i.jsx("strong",{children:((k=x.tasks.find(M=>M.elementId===w.elementId))==null?void 0:k.label)??w.elementId}),i.jsx("code",{children:w.standsInFor??w.elementId})]}),i.jsx("div",{className:"editor-wrap",children:i.jsx(Mn,{height:"360px",defaultLanguage:"javascript",value:u[w.elementId],onChange:M=>g(T=>({...T,[w.elementId]:M??""})),options:Sn})})]},w.elementId)}),Object.keys(N).map(w=>i.jsxs(an,{value:Et+w,children:[i.jsxs("div",{className:"editor-meta",children:[i.jsx("strong",{children:w}),i.jsxs("code",{children:["prompt / template text — substitutes"," ","{{"+w+"}}"]})]}),i.jsx("div",{className:"editor-wrap",children:i.jsx(Mn,{height:"360px",defaultLanguage:"markdown",value:N[w],onChange:k=>v(M=>nn(M,{[w]:k??""})),options:Sn})})]},w))]})})}),x.agent&&i.jsx(Le,{sectionId:"tools",defaultOpen:!1,title:"Tools, as the model sees them",description:i.jsxs(i.Fragment,{children:["Read from the diagram — element name, documentation, and every",i.jsx("code",{children:" fromAi(…)"})," argument."]}),children:i.jsx("ul",{className:"tool-list",children:x.agent.tools.map(w=>i.jsxs("li",{children:[i.jsx("code",{children:w.elementId}),i.jsxs("span",{children:[" — ",w.documentation||w.label]}),w.args.length>0&&i.jsx("ul",{children:w.args.map(k=>i.jsxs("li",{children:[i.jsxs("code",{children:[k.name,": ",k.type]})," ","— ",k.description]},k.name))})]},w.elementId))})})]})]})}const Sn={minimap:{enabled:!1},fontSize:13,scrollBeyondLastLine:!1,tabSize:2,automaticLayout:!0},Ir=`<?xml version="1.0" encoding="UTF-8"?>\r
...
}`,Ss={id:"loan-origination",title:"Loan origination agent",blurb:"An AI agent gathers a loan case with its own tools — customer lookup, credit bureau, an underwriting policy, a status update — then every application passes through a mandatory senior-officer review before a gateway routes it to an offer or a decline. The agent advises; the process governs.",docsUrl:"https://camunda.com/orchestrate/agents/",bpmn:ns,forms:{"loan-application":ls,"loan-senior-officer-review":fs},seed:Pt,scenarios:[{label:"Strong applicant (policy recommends approve)",variables:Pt},{label:"Marginal applicant (policy recommends decline)",variables:ys}],scriptedAgent:vs,templates:ws,tour:es,requiredTools:["AssessApplication","UpdateApplicationStatus"],handlers:[{elementId:"QueryCustomer",standsInFor:"CRM connector — customer lookup",source:xs},{elementId:"CreditBureauLookup",standsInFor:"REST connector — credit bureau",source:Es},{elementId:"AssessApplication",standsInFor:"Script task — underwriting policy (FEEL)",source:ks},{elementId:"UpdateApplicationStatus",standsInFor:"REST connector — origination system",source:Ns},{elementId:"IssueLoanOffer",standsInFor:"REST connector — offer/booking system",source:Ps},{elementId:"SendDeclineNotice",standsInFor:"REST connector — notifications",source:Ms}]},Bs=`<?xml version="1.0" encoding="UTF-8"?>
