const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/driver-CTZuBZOi.css","assets/diagram-js-DAKGYcfb.css","assets/bpmn-js-BEOU0ddW.css","assets/bpmn-embedded-DcP4ujb9.css","assets/RuntimeDiagram-DTnJz5cT.js","assets/vendor-react-9Ma26nY1.js","assets/Viewer-D_7S4Gwm.js","assets/MonacoEditor-C4cphgcG.js","assets/MonacoEditor-B3OBTlkp.css","assets/vendor-modeler-BzScQTrW.js","assets/vendor-design-system-CUrMBNMa.js","assets/vendor-design-system-BHuUzrJ2.css","assets/parser-DkgAe_kI.js","assets/ModelEditor-Dwlgp6JA.css","assets/FormRenderer-BNfJup3y.js","assets/FormRenderer-D1JIHOW6.css"])))=>i.map(i=>d[i]);
var io=Object.defineProperty;var ro=(e,n,t)=>n in e?io(e,n,{enumerable:!0,configurable:!0,writable:!0,value:t}):e[n]=t;var z=(e,n,t)=>ro(e,typeof n!="symbol"?n+"":n,t);import{r as b,j as i,i as ao}from"./vendor-react-9Ma26nY1.js";import{B as Q,a as te,L as Ge,S as Sn,b as Bn,c as Rn,d as Cn,e as In,A as le,f as ce,g as me,I as Xn,C as so,h as lo,i as co,j as mo,k as po,l as uo,T as ho,m as bo,n as rn,o as an,p as go,q as fo}from"./vendor-design-system-CUrMBNMa.js";(function(){const n=document.createElement("link").relList;if(n&&n.supports&&n.supports("modulepreload"))return;for(const r of document.querySelectorAll('link[rel="modulepreload"]'))o(r);new MutationObserver(r=>{for(const s of r)if(s.type==="childList")for(const d of s.addedNodes)d.tagName==="LINK"&&d.rel==="modulepreload"&&o(d)}).observe(document,{childList:!0,subtree:!0});function t(r){const s={};return r.integrity&&(s.integrity=r.integrity),r.referrerPolicy&&(s.referrerPolicy=r.referrerPolicy),r.crossOrigin==="use-credentials"?s.credentials="include":r.crossOrigin==="anonymous"?s.credentials="omit":s.credentials="same-origin",s}function o(r){if(r.ep)return;r.ep=!0;const s=t(r);fetch(r.href,s)}})();const _o="modulepreload",wo=function(e){return"/web-demo-framework/pr-preview/pr-121/"+e},et={},be=function(n,t,o){let r=Promise.resolve();if(t&&t.length>0){let d=function(a){return Promise.all(a.map(p=>Promise.resolve(p).then(u=>({status:"fulfilled",value:u}),u=>({status:"rejected",reason:u}))))};document.getElementsByTagName("link");const c=document.querySelector("meta[property=csp-nonce]"),m=(c==null?void 0:c.nonce)||(c==null?void 0:c.getAttribute("nonce"));r=d(t.map(a=>{if(a=wo(a),a in et)return;et[a]=!0;const p=a.endsWith(".css"),u=p?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${a}"]${u}`))return;const g=document.createElement("link");if(g.rel=p?"stylesheet":_o,p||(g.as="script"),g.crossOrigin="",g.href=a,m&&g.setAttribute("nonce",m),document.head.appendChild(g),p)return new Promise((h,f)=>{g.addEventListener("load",h),g.addEventListener("error",()=>f(new Error(`Unable to preload CSS for ${a}`)))})}))}function s(d){const c=new Event("vite:preloadError",{cancelable:!0});if(c.payload=d,window.dispatchEvent(c),!c.defaultPrevented)throw d}return r.then(d=>{for(const c of d||[])c.status==="rejected"&&s(c.reason);return n().catch(s)})},yo="io.camunda.agenticai:aiagent",Ee="http://www.omg.org/spec/BPMN/20100524/MODEL",vo="http://camunda.org/schema/zeebe/1.0";function pn(e,n){return Array.from(e.getElementsByTagNameNS(vo,n))}function Ct(e,n){return pn(e,n).filter(t=>xo(t)===e)}function xo(e){let n=e.parentElement;for(;n;){if(n.namespaceURI===Ee&&n.localName!=="extensionElements")return n;n=n.parentElement}return null}function Dn(e){const n=Ct(e,"taskDefinition")[0],t=n==null?void 0:n.getAttribute("type");return t||(e.localName==="scriptTask"?e.getAttribute("id")??null:null)}function nt(e){const n=Array.from(e.children).find(t=>t.namespaceURI===Ee&&t.localName==="documentation");return((n==null?void 0:n.textContent)??"").trim()}function tt(e){if(!e)return"";const n=e.startsWith("=")?e.slice(1):e,t=n.match(/"((?:[^"\\]|\\.)*)"/g);return t?t.map(o=>o.slice(1,-1).replace(/\\n/g,`
`).replace(/\\t/g,"	").replace(/\\"/g,'"').replace(/\\\\/g,"\\")).join("").trim():n.trim()}function It(e){const n=[],t=o=>{for(const r of Array.from(o.attributes))n.push(r.value);for(const r of Array.from(o.children))t(r)};return t(e),n.join(`
`)}function Eo(e){return At(It(e))}function ko(e){const n=Array.from(e.children).find(t=>t.namespaceURI===Ee&&t.localName==="extensionElements");return n?At(It(n)):[]}function At(e){const n=/fromAi\(\s*toolCall\.([A-Za-z_$][\w$]*)\s*,\s*"((?:[^"\\]|\\.)*)"\s*(?:,\s*"(\w+)")?/g,t=[],o=new Set;for(const r of e.matchAll(n)){const s=r[1];o.has(s)||(o.add(s),t.push({name:s,description:(r[2]??"").replace(/&#10;/g,`
`).replace(/\\"/g,'"').replace(/&quot;/g,'"').replace(/&#39;/g,"'").trim(),type:r[3]??"string"}))}return t}function No(e){const n={};for(const t of Ct(e,"input")){const o=t.getAttribute("target");o&&(n[o]=t.getAttribute("source")??"")}return n}function Po(e){return Array.from(e.getElementsByTagNameNS(Ee,"adHocSubProcess")).filter(n=>(Dn(n)??"").startsWith(yo))}const Mo=new Set(["subProcess","adHocSubProcess","callActivity"]),So=new Set(["adHocSubProcess","subProcess","transaction"]);function Bo(e){let n=e.parentElement;for(;n;){if(n.namespaceURI===Ee&&So.has(n.localName))return n;n=n.parentElement}return null}function Ro(e,n){const t=No(e),o=Number((t["data.limits.maxModelCalls"]??"").replace(/^=/,""));return{elementId:e.getAttribute("id")??"agent",label:e.getAttribute("name")??"Agent",jobType:Dn(e),systemPrompt:tt(t["data.systemPrompt.prompt"]),userPrompt:tt(t["data.userPrompt.prompt"]),maxModelCalls:Number.isFinite(o)&&o>0?o:10,tools:n}}function Co(e,n){var g;const t=e.getAttribute("id")??"",o=e.getAttribute("name")??t,r=Po(e);r.length>1&&n.push({severity:"warning",elementId:r.map(h=>h.getAttribute("id")).join(", "),message:`Process "${o}" hosts ${r.length} AI Agent sub-processes (${r.map(h=>h.getAttribute("id")).join(", ")}). Each gets its own independent agent state (turn counter, called tools) — the run itself is shared across hosts, but each host's agent state within it is not.`});const s=[],d=new Map(r.map(h=>[h,[]]));for(const h of Array.from(e.getElementsByTagName("*"))){if(h.namespaceURI!==Ee||r.includes(h))continue;const f=h.getAttribute("id");if(!f)continue;const k=Bo(h),v=k&&r.includes(k)?k:null;if(v&&Mo.has(h.localName)){const E=h.getAttribute("name")??f,V=nt(h);s.push({elementId:f,label:E,jobType:"",documentation:V,isTool:!0,compound:!0}),d.get(v).push({elementId:f,label:E,jobType:"",documentation:V,args:ko(h),compound:!0});continue}const _=Dn(h);if(!_)continue;const x={elementId:f,label:h.getAttribute("name")??f,jobType:_,documentation:nt(h),isTool:v!=null};s.push(x),v&&d.get(v).push({elementId:f,label:x.label,jobType:_,documentation:x.documentation,args:Eo(h)})}const c=r.map(h=>Ro(h,d.get(h))),m=Array.from(e.getElementsByTagNameNS(Ee,"userTask")).map(h=>{var f;return{elementId:h.getAttribute("id")??"",label:h.getAttribute("name")??h.getAttribute("id")??"",formId:((f=pn(h,"formDefinition")[0])==null?void 0:f.getAttribute("formId"))??void 0}}),a=Array.from(e.children).find(h=>h.namespaceURI===Ee&&h.localName==="startEvent"),p=a?((g=pn(a,"formDefinition")[0])==null?void 0:g.getAttribute("formId"))??void 0:void 0,u=a?Io(a):void 0;return{processId:t,processName:o,tasks:s,agents:c,userTasks:m,startFormId:p,startMessage:u}}function Io(e){var s;const n=Array.from(e.children).find(d=>d.namespaceURI===Ee&&d.localName==="messageEventDefinition"),t=n==null?void 0:n.getAttribute("messageRef");if(!t)return;const o=Array.from(e.ownerDocument.getElementsByTagNameNS(Ee,"message")).find(d=>d.getAttribute("id")===t);if(!o)return;const r=o.getAttribute("name");if(r)return{messageName:r,correlationKey:((s=pn(o,"subscription")[0])==null?void 0:s.getAttribute("correlationKey"))??"",elementId:e.getAttribute("id")??""}}function Ao(e,n){const t=e.trim().replace(/^=/,"").trim(),o=t.match(/^"((?:[^"\\]|\\.)*)"$/);if(o)return o[1].replace(/\\"/g,'"');if(/^[A-Za-z_$][\w$]*$/.test(t)){const r=n[t];return r==null?"":String(r)}return t}function To(e,n={}){const t=new DOMParser().parseFromString(e,"application/xml"),o=t.getElementsByTagName("parsererror")[0];if(o)throw new Error(`Invalid BPMN XML: ${o.textContent}`);const r=Array.from(t.getElementsByTagNameNS(Ee,"process"));if(r.length===0)throw new Error("No <bpmn:process> in the diagram.");const s=[],d=r.map(m=>Co(m,s));let c=n.processId?d.find(m=>m.processId===n.processId):void 0;return n.processId&&!c&&s.push({severity:"warning",message:`Requested process "${n.processId}" not found — falling back to "${d[0].processId}".`}),c??(c=d[0]),d.length>1&&s.push({severity:"warning",message:`Diagram has ${d.length} <bpmn:process> elements (${d.map(m=>m.processId).join(", ")}); using "${c.processId}" as the active process. Pass a processId to parseModel to target another.`}),{processes:d,diagnostics:s,processId:c.processId,processName:c.processName,tasks:c.tasks,agent:c.agents[0]??null,agents:d.flatMap(m=>m.agents),userTasks:c.userTasks,startFormId:c.startFormId,startMessage:c.startMessage}}function Fo(e){return e?e.imageId?{imageId:e.imageId}:e.imageName?{imageName:e.imageName}:{}:{}}function Tt(e,n){return n?e.pixels:e.imageId??e.pixels}const jo="No image selected — pick or upload a photo to read.";function ot(){return jo}function Do(e,n){return async t=>{const o=e.resolve(n);if(!o)return ot();const r=Tt(o,e.live);if(r===void 0)return ot();try{return await e.read(r,t)}catch(s){return`Couldn't read the image (${s instanceof Error?s.message:String(s)}).`}}}function Lo(e,n){return async()=>{const t=e.resolve(n);if(t)return Tt(t,e.live)}}function Oo(){return`<!doctype html><html><head><meta charset="utf-8"></head><body><script>
    "use strict";
    ...
    post({ kind: "ready" });
  <\/script></body></html>`}function Ft(e,n={}){const{timeoutMs:t=5e3,onTrace:o,onVision:r,onImage:s}=n,d=`${Date.now()}-${Math.random().toString(36).slice(2)}`;return new Promise((c,m)=>{const a=document.createElement("iframe");a.setAttribute("sandbox","allow-scripts"),a.style.display="none",a.setAttribute("aria-hidden","true");let p=!1,u;const g=()=>{u&&clearTimeout(u),window.removeEventListener("message",f),a.remove()},h=v=>{p||(p=!0,g(),v())};function f(v){var x;if(v.source!==a.contentWindow)return;const _=v.data;if(!(!_||typeof _!="object")){if(_.kind==="ready"){const E=e.job,V=e.kind==="run-handler"?{kind:"run-handler",id:d,source:e.source,job:E,hasVision:e.hasVision}:{kind:"run-agent",id:d,source:e.source,job:E};(x=a.contentWindow)==null||x.postMessage(V,"*");return}"id"in _&&_.id!==d||(_.kind==="trace"?o==null||o(_.text):_.kind==="vision-request"?k(_.callId,r,"vision",_.prompt):_.kind==="image-request"?k(_.callId,s,"image"):_.kind==="result"?h(()=>c(_.value)):_.kind==="error"&&h(()=>m(new Error(_.message))))}}function k(v,_,x,...E){const V=Z=>{var J;return(J=a.contentWindow)==null?void 0:J.postMessage(Z,"*")};if(!_){V({kind:"helper-error",id:d,callId:v,message:`${x} helper is not available.`});return}Promise.resolve().then(()=>_(...E)).then(Z=>V({kind:"helper-result",id:d,callId:v,value:Z}),Z=>V({kind:"helper-error",id:d,callId:v,message:Z instanceof Error?Z.message:String(Z)}))}window.addEventListener("message",f),u=setTimeout(()=>{h(()=>m(new Error(`Handler timed out after ${t}ms — the sandboxed run was terminated.`)))},t),a.srcdoc=Oo(),document.body.appendChild(a)})}function jt(e){return{key:e.key,type:e.type,elementId:e.elementId,instanceKey:e.instanceKey,variables:e.variables??{}}}function zo(e,n,t){const o=typeof t.vision=="function";return Ft({kind:"run-handler",source:e,job:jt(n),hasVision:o},{onTrace:t.trace,onVision:t.vision?r=>t.vision(r):void 0,onImage:t.image?()=>t.image():void 0})}function $o(e,n){return Ft({kind:"run-agent",source:e,job:jt(n)})}function Dt(e,n){try{new Function(`"use strict"; return (${e});`)}catch{throw new Error(`${n} has a syntax error.`)}}function Uo(e){return Dt(e,"Handler code"),(n,t)=>zo(e,n,t)}function Vo(e){return Dt(e,"Agent code"),n=>$o(e,n)}function qo(e,n,t,o){return{sleep:r=>new Promise(s=>setTimeout(s,r)),trace:r=>n({kind:"tool",text:`   ${r}`,elementId:e.elementId,turn:t}),text:(r,s="")=>{const d=e.variables[r];return typeof d=="string"?d:d==null?s:String(d)},num:(r,s=0)=>{const d=e.variables[r],c=typeof d=="number"?d:Number(d);return Number.isFinite(c)?c:s},...o?{vision:Do(o,e.instanceKey),image:Lo(o,e.instanceKey)}:{}}}function Go(e){if(e===void 0)return"undefined";try{return JSON.stringify(e)}catch{return"[unserializable value]"}}function Ho(e,n,t,o,r){const s={},d=e.processes.flatMap(m=>m.tasks),c=new Map(d.map(m=>[m.elementId,m.label]));for(const m of d)m.compound||s[m.jobType]||(s[m.jobType]=async a=>{const p=n[a.elementId];if(!p)throw new Error(`No handler registered for ${a.elementId} (job type ${a.type})`);const u=c.get(a.elementId)??a.elementId,g=o==null?void 0:o.current;t({kind:"tool",text:`▶ ${u}`,elementId:a.elementId,turn:g});const h=await p(a,qo(a,t,g,r));return t({kind:"vars",text:`  ↳ ${Go(h)}`,elementId:a.elementId,result:h,turn:g}),h});return s}const Jo=/\{\{\s*([A-Za-z][A-Za-z0-9_-]*)\s*\}\}/g;function nn(...e){const n=Object.create(null);for(const t of e)if(t)for(const o of Object.keys(t))n[o]=t[o];return n}function Lt(e){return(e.split("/").pop()??e).replace(/\.[^./]+$/,"")}function Ot(e){return e.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;")}function Wo(e){return Ot(e).replace(/"/g,"&quot;").replace(/\n/g,"&#10;").replace(/\t/g,"&#9;")}function Ko(e){return e.replace(/\\/g,"\\\\").replace(/&/g,"&amp;").replace(/"/g,"\\&#34;").replace(/\n/g,"&#10;").replace(/\t/g,"&#9;").replace(/</g,"&lt;").replace(/>/g,"&gt;")}function Zo(e){return JSON.stringify(e).slice(1,-1)}function Yo(e,n){const t=e.lastIndexOf("<",n),o=e.lastIndexOf(">",n);if(t<=o)return"text";const r=e.slice(t,n);if((r.match(/"/g)??[]).length%2===0)return"text";const d=r.lastIndexOf('"');return(r.slice(d+1).match(/&#34;|&quot;/g)??[]).length%2===1?"feel-literal":"attribute"}function Qo(e,n,t="xml"){const o=[],r=new Set;return{result:e.replace(Jo,(d,c,m)=>{const a=c.trim();if(!Object.prototype.hasOwnProperty.call(n,a))return r.has(a)||(r.add(a),o.push(a)),d;const p=n[a];if(t==="json")return Zo(p);const u=Yo(e,m);return u==="feel-literal"?Ko(p):u==="attribute"?Wo(p):Ot(p)}),unresolved:o}}function Xo(){return{processes:[],diagnostics:[],processId:"",processName:"",tasks:[],agent:null,agents:[],userTasks:[],startFormId:void 0}}function ei(e,n={},t=e.bpmn,o={}){const r=[],s=nn(e.templates,o),{result:d,unresolved:c}=Qo(t,s,"xml");for(const _ of c)r.push({severity:"warning",message:`Template placeholder "{{${_}}}" has no matching prompt/template content — left in the model as-is, not substituted.`});let m;try{m=To(d)}catch(_){return r.push({severity:"error",message:_ instanceof Error?_.message:String(_)}),{resolvedBpmn:d,model:Xo(),handlers:{},forms:{},diagnostics:r,hasErrors:!0}}r.push(...m.diagnostics);const a=m.processes.flatMap(_=>_.tasks),p=new Map(e.handlers.map(_=>[_.elementId,_.source])),u={};for(const _ of a){if(_.compound)continue;const x=n[_.elementId]??p.get(_.elementId);if(x===void 0){r.push({severity:"error",elementId:_.elementId,jobType:_.jobType,message:`No handler for "${_.label}" (${_.elementId}, job type "${_.jobType}"). Add a handler for this element, or remove it from the diagram.`});continue}try{u[_.elementId]=Uo(x)}catch(E){r.push({severity:"error",elementId:_.elementId,jobType:_.jobType,message:`"${_.label}" (${_.elementId}): handler code didn't compile — ${E instanceof Error?E.message:String(E)}`})}}const g=new Set(a.map(_=>_.elementId)),h=new Set([...p.keys(),...Object.keys(n)]);for(const _ of h)g.has(_)||r.push({severity:"error",elementId:_,message:`Handler "${_}" doesn't match any element in the current diagram — likely orphaned by a rename. Rename it back, or remove the handler.`});const f={},k=e.forms??{},v=(_,x)=>{if(!_)return;const E=k[_];E?f[_]=E:r.push({severity:"error",formId:_,message:`${x} references form "${_}", which has no matching schema.`})};for(const _ of m.processes){v(_.startFormId,`The start event of process "${_.processName}"`);for(const x of _.userTasks)v(x.formId,`User task "${x.label}" (${x.elementId})`)}return{resolvedBpmn:d,model:m,handlers:u,forms:f,diagnostics:r,hasErrors:r.some(_=>_.severity==="error")}}function ni(e){const n=e.indexOf("{");if(n<0)return null;let t=0;for(let o=n;o<e.length;o++)if(e[o]==="{")t++;else if(e[o]==="}"&&(t--,t===0))try{const r=JSON.parse(e.slice(n,o+1));return typeof r=="object"&&r!==null&&!Array.isArray(r)?r:null}catch{return null}return null}function An(e,n=220){const t=e.replace(/\s+/g," ").trim();return t.length>n?`${t.slice(0,n-1)}…`:t}function it(e){const n=e.arguments??e.args??e.parameters??e.input;return n&&typeof n=="object"&&!Array.isArray(n)?n:{}}function rt(e){if(!e)return[];const n=e.tool??e.name??e.action;if(typeof n=="string"&&n.trim())return[{name:n.trim(),args:it(e)}];const t=e.tools??e.tool_calls??e.toolset??e.actions,o=Array.isArray(t)?t:Object.values(e).find(s=>Array.isArray(s))??[],r=[];for(const s of o)if(typeof s=="string")s.trim()&&r.push({name:s.trim(),args:{}});else if(s&&typeof s=="object"){const d=s,c=d.name??d.tool??d.id??d.function;typeof c=="string"&&c.trim()&&r.push({name:c.trim(),args:it(d)})}return r}function ti(e){if(!e)return!1;const n=e.done??e.finished??e.complete;return typeof n=="boolean"?n:typeof n=="string"?n.toLowerCase()==="true":!1}function at(e){const n=e.args.length?e.args.map(o=>`      ${o.name} (${o.type}) — ${o.description}`).join(`
...
`)}async function ri(e,n,t,o,r,s){let d="";n({kind:"llm",text:"LLM thinking…",key:t,pending:!0,turn:s});const c=await e(o,r,m=>{d+=m,n({kind:"llm",text:`${An(d)} ▍`,key:t,pending:!0,turn:s})});return n({kind:"llm",text:An(c||d)||"(empty reply)",key:t,pending:!1,turn:s}),c}function ai(e,n){switch(e){case"number":return typeof n=="number"&&Number.isFinite(n)?{ok:!0,value:n}:typeof n=="string"&&n.trim()!==""&&Number.isFinite(Number(n))?{ok:!0,value:Number(n)}:{ok:!1};case"boolean":return typeof n=="boolean"?{ok:!0,value:n}:typeof n=="string"&&/^(true|false)$/i.test(n.trim())?{ok:!0,value:n.trim().toLowerCase()==="true"}:{ok:!1};default:return typeof n=="object"?{ok:!1}:{ok:!0,value:String(n)}}}function si(e,n,t){const o={},r=new Map,s=new Map;for(const{tool:d,args:c}of e){const m={};for(const a of d.args){const p=c[a.name];if(!(p!=null&&p!=="")){n({kind:"error",text:`🤖 ${d.elementId}: model supplied no value for "${a.name}"`,turn:t,elementId:d.elementId});continue}const g=r.get(a.name);if(g!==void 0&&g!==d.elementId){n({kind:"error",text:`🤖 argument name collision on "${a.name}": both ${g} and ${d.elementId} declare it — ${g} already claimed it this turn, ${d.elementId}'s value is dropped`,turn:t,elementId:d.elementId});continue}const h=ai(a.type,p);if(!h.ok){n({kind:"error",text:`🤖 ${d.elementId}: "${a.name}" is declared as ${a.type} but the model supplied ${JSON.stringify(p)} — rejected, not passed through`,turn:t,elementId:d.elementId});continue}o[a.name]=h.value,m[a.name]=h.value,r.set(a.name,d.elementId)}s.set(d.elementId,m)}return{variablesOut:o,forHistory:s}}function di(e,n,t,o={}){const{maxNewTokens:r=384,allowRepeats:s=!1,allowMultiToolTurns:d=!1,turnRef:c,requiredTools:m=[],maxEarlyDoneNudges:a=1,maxUnproductiveTurns:p=3}=o;let u=0;const g=new Set,h=[];let f=0,k=[],v=[];return async _=>{const x=_.variables,E=x.toolCallResult;E!==void 0&&h.length&&(h[h.length-1]=`${h[h.length-1]} → ${An(JSON.stringify(E),160)}`);let V=0;for(;;){const J=await Z();if(J)return J;if(V+=1,V>=p)return t({kind:"error",text:`🤖 ${V} turns in a row activated nothing — completing the agent. The model has lost the reply format; whatever it has already run stands.`,turn:u}),{completionConditionFulfilled:!0}}async function Z(){if(u+=1,c&&(c.current=u),u>e.maxModelCalls)return t({kind:"error",text:`Turn budget spent (maxModelCalls=${e.maxModelCalls}) — completing the agent.`,turn:u}),{completionConditionFulfilled:!0};const J=s?e.tools:e.tools.filter(P=>!g.has(P.elementId));if(J.length===0)return t({kind:"agent",text:"🤖 every tool has run — completing the agent",turn:u}),{completionConditionFulfilled:!0};const ge=[{role:"system",content:oi(e,d,J)},{role:"user",content:ii(e,x,h,J,k,v,s)}];k=[],v=[];let Ce;try{Ce=await ri(n,t,`llm-turn-${u}`,ge,r,u)}catch(P){return t({kind:"error",text:`LLM call failed: ${P instanceof Error?P.message:String(P)} — completing the agent.`,turn:u}),{completionConditionFulfilled:!0}}const fe=ni(Ce);if(ti(fe)&&rt(fe).length===0){const P=m.filter(j=>!g.has(j));return P.length&&f<a?(f+=1,k=P,t({kind:"agent",text:`🤖 model says it is done, but ${P.join(", ")} hasn't run — asking once more`,turn:u}),null):(t({kind:"agent",text:"🤖 model says it is done",turn:u}),{completionConditionFulfilled:!0})}const Pe=rt(fe);if(Pe.length===0)return t({kind:"error",text:"🤖 model named no tool (and didn't say it was done) — asking again",turn:u}),v=['it named no tool and did not say it was done — reply with {"tool": "...", "arguments": {...}} or {"done": true}'],null;const X=[],_e=[],de=[];for(const P of Pe){const j=e.tools.find(H=>H.elementId===P.name);if(!j){_e.push(P.name);continue}if(!s&&g.has(j.elementId)){de.push(j.elementId);continue}X.push({tool:j,args:P.args})}if(_e.length&&t({kind:"error",text:`🤖 model named a tool that doesn't exist: ${_e.join(", ")} — nothing activated`,turn:u}),de.length&&t({kind:"error",text:`🤖 model asked to re-run ${de.join(", ")} — skipped (already run)`,turn:u}),X.length===0)return t({kind:"agent",text:"🤖 nothing activated — asking again",turn:u}),v=[..._e.length?[`${_e.join(", ")} ${_e.length===1?"is":"are"} not a real tool`]:[],...de.length?[`${de.join(", ")} has already run and will never run again — pick a different tool, or reply {"done": true} if nothing is left to do`]:[]],null;const{variablesOut:R,forHistory:M}=si(X,t,u);for(const{tool:P}of X)g.add(P.elementId),h.push(`- ${P.elementId}(${JSON.stringify(M.get(P.elementId))})`);for(const{tool:P}of X)t({kind:"agent",text:`🤖 calling ${P.elementId}`,turn:u,elementId:P.elementId,args:M.get(P.elementId)??{}});return{activateElements:X.map(P=>({elementId:P.tool.elementId})),variables:R}}}}function li(e,n,t,o={}){const r=new Map(e.map(s=>[s.elementId,di(s,n,t,o)]));return async s=>{const d=r.get(s.elementId);if(!d)throw new Error(`No agent host registered for "${s.elementId}"`);return d(s)}}class Tn{__destroy_into_raw(){const n=this.__wbg_ptr;return this.__wbg_ptr=0,st.unregister(this),n}free(){const n=this.__destroy_into_raw();l.__wbg_testengine_free(n,0)}activateJobs(n,t,o,r){let s,d;try{const h=l.__wbindgen_add_to_stack_pointer(-16),f=A(n,l.__wbindgen_export,l.__wbindgen_export2),k=I,v=A(r,l.__wbindgen_export,l.__wbindgen_export2),_=I;l.testengine_activateJobs(h,this.__wbg_ptr,f,k,t,o,v,_);var c=y().getInt32(h+0,!0),m=y().getInt32(h+4,!0),a=y().getInt32(h+8,!0),p=y().getInt32(h+12,!0),u=c,g=m;if(p)throw u=0,g=0,U(a);return s=u,d=g,$(u,g)}finally{l.__wbindgen_add_to_stack_pointer(16),l.__wbindgen_export3(s,d,1)}}advanceTime(n){let t,o;try{const p=l.__wbindgen_add_to_stack_pointer(-16);l.testengine_advanceTime(p,this.__wbg_ptr,n);var r=y().getInt32(p+0,!0),s=y().getInt32(p+4,!0),d=y().getInt32(p+8,!0),c=y().getInt32(p+12,!0),m=r,a=s;if(c)throw m=0,a=0,U(d);return t=m,o=a,$(m,a)}finally{l.__wbindgen_add_to_stack_pointer(16),l.__wbindgen_export3(t,o,1)}}assignUserTask(n,t,o){let r,s;try{const g=l.__wbindgen_add_to_stack_pointer(-16),h=A(n,l.__wbindgen_export,l.__wbindgen_export2),f=I,k=A(t,l.__wbindgen_export,l.__wbindgen_export2),v=I;l.testengine_assignUserTask(g,this.__wbg_ptr,h,f,k,v,o);var d=y().getInt32(g+0,!0),c=y().getInt32(g+4,!0),m=y().getInt32(g+8,!0),a=y().getInt32(g+12,!0),p=d,u=c;if(a)throw p=0,u=0,U(m);return r=p,s=u,$(p,u)}finally{l.__wbindgen_add_to_stack_pointer(16),l.__wbindgen_export3(r,s,1)}}broadcastSignal(n,t){let o,r;try{const u=l.__wbindgen_add_to_stack_pointer(-16),g=A(n,l.__wbindgen_export,l.__wbindgen_export2),h=I,f=A(t,l.__wbindgen_export,l.__wbindgen_export2),k=I;l.testengine_broadcastSignal(u,this.__wbg_ptr,g,h,f,k);var s=y().getInt32(u+0,!0),d=y().getInt32(u+4,!0),c=y().getInt32(u+8,!0),m=y().getInt32(u+12,!0),a=s,p=d;if(m)throw a=0,p=0,U(c);return o=a,r=p,$(a,p)}finally{l.__wbindgen_add_to_stack_pointer(16),l.__wbindgen_export3(o,r,1)}}cancelInstance(n){let t,o;try{const p=l.__wbindgen_add_to_stack_pointer(-16),u=A(n,l.__wbindgen_export,l.__wbindgen_export2),g=I;l.testengine_cancelInstance(p,this.__wbg_ptr,u,g);var r=y().getInt32(p+0,!0),s=y().getInt32(p+4,!0),d=y().getInt32(p+8,!0),c=y().getInt32(p+12,!0),m=r,a=s;if(c)throw m=0,a=0,U(d);return t=m,o=a,$(m,a)}finally{l.__wbindgen_add_to_stack_pointer(16),l.__wbindgen_export3(t,o,1)}}completeAgentJob(n,t,o){let r,s;try{const g=l.__wbindgen_add_to_stack_pointer(-16),h=A(n,l.__wbindgen_export,l.__wbindgen_export2),f=I,k=A(t,l.__wbindgen_export,l.__wbindgen_export2),v=I,_=A(o,l.__wbindgen_export,l.__wbindgen_export2),x=I;l.testengine_completeAgentJob(g,this.__wbg_ptr,h,f,k,v,_,x);var d=y().getInt32(g+0,!0),c=y().getInt32(g+4,!0),m=y().getInt32(g+8,!0),a=y().getInt32(g+12,!0),p=d,u=c;if(a)throw p=0,u=0,U(m);return r=p,s=u,$(p,u)}finally{l.__wbindgen_add_to_stack_pointer(16),l.__wbindgen_export3(r,s,1)}}completeJob(n,t){let o,r;try{const u=l.__wbindgen_add_to_stack_pointer(-16),g=A(n,l.__wbindgen_export,l.__wbindgen_export2),h=I,f=A(t,l.__wbindgen_export,l.__wbindgen_export2),k=I;l.testengine_completeJob(u,this.__wbg_ptr,g,h,f,k);var s=y().getInt32(u+0,!0),d=y().getInt32(u+4,!0),c=y().getInt32(u+8,!0),m=y().getInt32(u+12,!0),a=s,p=d;if(m)throw a=0,p=0,U(c);return o=a,r=p,$(a,p)}finally{l.__wbindgen_add_to_stack_pointer(16),l.__wbindgen_export3(o,r,1)}}completeUserTask(n,t){let o,r;try{const u=l.__wbindgen_add_to_stack_pointer(-16),g=A(n,l.__wbindgen_export,l.__wbindgen_export2),h=I,f=A(t,l.__wbindgen_export,l.__wbindgen_export2),k=I;l.testengine_completeUserTask(u,this.__wbg_ptr,g,h,f,k);var s=y().getInt32(u+0,!0),d=y().getInt32(u+4,!0),c=y().getInt32(u+8,!0),m=y().getInt32(u+12,!0),a=s,p=d;if(m)throw a=0,p=0,U(c);return o=a,r=p,$(a,p)}finally{l.__wbindgen_add_to_stack_pointer(16),l.__wbindgen_export3(o,r,1)}}correlateMessage(n,t,o){let r,s;try{const g=l.__wbindgen_add_to_stack_pointer(-16),h=A(n,l.__wbindgen_export,l.__wbindgen_export2),f=I,k=A(t,l.__wbindgen_export,l.__wbindgen_export2),v=I,_=A(o,l.__wbindgen_export,l.__wbindgen_export2),x=I;l.testengine_correlateMessage(g,this.__wbg_ptr,h,f,k,v,_,x);var d=y().getInt32(g+0,!0),c=y().getInt32(g+4,!0),m=y().getInt32(g+8,!0),a=y().getInt32(g+12,!0),p=d,u=c;if(a)throw p=0,u=0,U(m);return r=p,s=u,$(p,u)}finally{l.__wbindgen_add_to_stack_pointer(16),l.__wbindgen_export3(r,s,1)}}createInstance(n,t,o){let r,s;try{const g=l.__wbindgen_add_to_stack_pointer(-16),h=A(n,l.__wbindgen_export,l.__wbindgen_export2),f=I,k=A(t,l.__wbindgen_export,l.__wbindgen_export2),v=I;l.testengine_createInstance(g,this.__wbg_ptr,h,f,k,v,hi(o)?Number.MAX_SAFE_INTEGER:o>>0);var d=y().getInt32(g+0,!0),c=y().getInt32(g+4,!0),m=y().getInt32(g+8,!0),a=y().getInt32(g+12,!0),p=d,u=c;if(a)throw p=0,u=0,U(m);return r=p,s=u,$(p,u)}finally{l.__wbindgen_add_to_stack_pointer(16),l.__wbindgen_export3(r,s,1)}}debugClear(){l.testengine_debugClear(this.__wbg_ptr)}debugCreateInstance(n,t,o){let r,s;try{const g=l.__wbindgen_add_to_stack_pointer(-16),h=A(n,l.__wbindgen_export,l.__wbindgen_export2),f=I,k=A(t,l.__wbindgen_export,l.__wbindgen_export2),v=I,_=A(o,l.__wbindgen_export,l.__wbindgen_export2),x=I;l.testengine_debugCreateInstance(g,this.__wbg_ptr,h,f,k,v,_,x);var d=y().getInt32(g+0,!0),c=y().getInt32(g+4,!0),m=y().getInt32(g+8,!0),a=y().getInt32(g+12,!0),p=d,u=c;if(a)throw p=0,u=0,U(m);return r=p,s=u,$(p,u)}finally{l.__wbindgen_add_to_stack_pointer(16),l.__wbindgen_export3(r,s,1)}}get debugIsPaused(){return l.testengine_debugIsPaused(this.__wbg_ptr)!==0}debugResume(){let n,t;try{const a=l.__wbindgen_add_to_stack_pointer(-16);l.testengine_debugResume(a,this.__wbg_ptr);var o=y().getInt32(a+0,!0),r=y().getInt32(a+4,!0),s=y().getInt32(a+8,!0),d=y().getInt32(a+12,!0),c=o,m=r;if(d)throw c=0,m=0,U(s);return n=c,t=m,$(c,m)}finally{l.__wbindgen_add_to_stack_pointer(16),l.__wbindgen_export3(n,t,1)}}debugStep(){let n,t;try{const a=l.__wbindgen_add_to_stack_pointer(-16);l.testengine_debugStep(a,this.__wbg_ptr);var o=y().getInt32(a+0,!0),r=y().getInt32(a+4,!0),s=y().getInt32(a+8,!0),d=y().getInt32(a+12,!0),c=o,m=r;if(d)throw c=0,m=0,U(s);return n=c,t=m,$(c,m)}finally{l.__wbindgen_add_to_stack_pointer(16),l.__wbindgen_export3(n,t,1)}}deploy(n){let t,o;try{const p=l.__wbindgen_add_to_stack_pointer(-16),u=A(n,l.__wbindgen_export,l.__wbindgen_export2),g=I;l.testengine_deploy(p,this.__wbg_ptr,u,g);var r=y().getInt32(p+0,!0),s=y().getInt32(p+4,!0),d=y().getInt32(p+8,!0),c=y().getInt32(p+12,!0),m=r,a=s;if(c)throw m=0,a=0,U(d);return t=m,o=a,$(m,a)}finally{l.__wbindgen_add_to_stack_pointer(16),l.__wbindgen_export3(t,o,1)}}deployForm(n){let t,o;try{const p=l.__wbindgen_add_to_stack_pointer(-16),u=A(n,l.__wbindgen_export,l.__wbindgen_export2),g=I;l.testengine_deployForm(p,this.__wbg_ptr,u,g);var r=y().getInt32(p+0,!0),s=y().getInt32(p+4,!0),d=y().getInt32(p+8,!0),c=y().getInt32(p+12,!0),m=r,a=s;if(c)throw m=0,a=0,U(d);return t=m,o=a,$(m,a)}finally{l.__wbindgen_add_to_stack_pointer(16),l.__wbindgen_export3(t,o,1)}}deployResource(n,t){let o,r;try{const u=l.__wbindgen_add_to_stack_pointer(-16),g=A(n,l.__wbindgen_export,l.__wbindgen_export2),h=I,f=A(t,l.__wbindgen_export,l.__wbindgen_export2),k=I;l.testengine_deployResource(u,this.__wbg_ptr,g,h,f,k);var s=y().getInt32(u+0,!0),d=y().getInt32(u+4,!0),c=y().getInt32(u+8,!0),m=y().getInt32(u+12,!0),a=s,p=d;if(m)throw a=0,p=0,U(c);return o=a,r=p,$(a,p)}finally{l.__wbindgen_add_to_stack_pointer(16),l.__wbindgen_export3(o,r,1)}}events(){let n,t;try{const a=l.__wbindgen_add_to_stack_pointer(-16);l.testengine_events(a,this.__wbg_ptr);var o=y().getInt32(a+0,!0),r=y().getInt32(a+4,!0),s=y().getInt32(a+8,!0),d=y().getInt32(a+12,!0),c=o,m=r;if(d)throw c=0,m=0,U(s);return n=c,t=m,$(c,m)}finally{l.__wbindgen_add_to_stack_pointer(16),l.__wbindgen_export3(n,t,1)}}failJob(n,t,o){let r,s;try{const g=l.__wbindgen_add_to_stack_pointer(-16),h=A(n,l.__wbindgen_export,l.__wbindgen_export2),f=I,k=A(o,l.__wbindgen_export,l.__wbindgen_export2),v=I;l.testengine_failJob(g,this.__wbg_ptr,h,f,t,k,v);var d=y().getInt32(g+0,!0),c=y().getInt32(g+4,!0),m=y().getInt32(g+8,!0),a=y().getInt32(g+12,!0),p=d,u=c;if(a)throw p=0,u=0,U(m);return r=p,s=u,$(p,u)}finally{l.__wbindgen_add_to_stack_pointer(16),l.__wbindgen_export3(r,s,1)}}migrate(n,t,o){let r,s;try{const g=l.__wbindgen_add_to_stack_pointer(-16),h=A(n,l.__wbindgen_export,l.__wbindgen_export2),f=I,k=A(t,l.__wbindgen_export,l.__wbindgen_export2),v=I,_=A(o,l.__wbindgen_export,l.__wbindgen_export2),x=I;l.testengine_migrate(g,this.__wbg_ptr,h,f,k,v,_,x);var d=y().getInt32(g+0,!0),c=y().getInt32(g+4,!0),m=y().getInt32(g+8,!0),a=y().getInt32(g+12,!0),p=d,u=c;if(a)throw p=0,u=0,U(m);return r=p,s=u,$(p,u)}finally{l.__wbindgen_add_to_stack_pointer(16),l.__wbindgen_export3(r,s,1)}}modify(n,t,o){let r,s;try{const g=l.__wbindgen_add_to_stack_pointer(-16),h=A(n,l.__wbindgen_export,l.__wbindgen_export2),f=I,k=A(t,l.__wbindgen_export,l.__wbindgen_export2),v=I,_=A(o,l.__wbindgen_export,l.__wbindgen_export2),x=I;l.testengine_modify(g,this.__wbg_ptr,h,f,k,v,_,x);var d=y().getInt32(g+0,!0),c=y().getInt32(g+4,!0),m=y().getInt32(g+8,!0),a=y().getInt32(g+12,!0),p=d,u=c;if(a)throw p=0,u=0,U(m);return r=p,s=u,$(p,u)}finally{l.__wbindgen_add_to_stack_pointer(16),l.__wbindgen_export3(r,s,1)}}constructor(){const n=l.testengine_new();return this.__wbg_ptr=n,st.register(this,this.__wbg_ptr,this),this}get now(){return l.testengine_now(this.__wbg_ptr)}reset(){l.testengine_reset(this.__wbg_ptr)}resolveIncident(n){let t,o;try{const p=l.__wbindgen_add_to_stack_pointer(-16),u=A(n,l.__wbindgen_export,l.__wbindgen_export2),g=I;l.testengine_resolveIncident(p,this.__wbg_ptr,u,g);var r=y().getInt32(p+0,!0),s=y().getInt32(p+4,!0),d=y().getInt32(p+8,!0),c=y().getInt32(p+12,!0),m=r,a=s;if(c)throw m=0,a=0,U(d);return t=m,o=a,$(m,a)}finally{l.__wbindgen_add_to_stack_pointer(16),l.__wbindgen_export3(t,o,1)}}setVariables(n,t,o){let r,s;try{const g=l.__wbindgen_add_to_stack_pointer(-16),h=A(n,l.__wbindgen_export,l.__wbindgen_export2),f=I,k=A(t,l.__wbindgen_export,l.__wbindgen_export2),v=I;l.testengine_setVariables(g,this.__wbg_ptr,h,f,k,v,o);var d=y().getInt32(g+0,!0),c=y().getInt32(g+4,!0),m=y().getInt32(g+8,!0),a=y().getInt32(g+12,!0),p=d,u=c;if(a)throw p=0,u=0,U(m);return r=p,s=u,$(p,u)}finally{l.__wbindgen_add_to_stack_pointer(16),l.__wbindgen_export3(r,s,1)}}snapshot(){let n,t;try{const a=l.__wbindgen_add_to_stack_pointer(-16);l.testengine_snapshot(a,this.__wbg_ptr);var o=y().getInt32(a+0,!0),r=y().getInt32(a+4,!0),s=y().getInt32(a+8,!0),d=y().getInt32(a+12,!0),c=o,m=r;if(d)throw c=0,m=0,U(s);return n=c,t=m,$(c,m)}finally{l.__wbindgen_add_to_stack_pointer(16),l.__wbindgen_export3(n,t,1)}}throwError(n,t,o){let r,s;try{const g=l.__wbindgen_add_to_stack_pointer(-16),h=A(n,l.__wbindgen_export,l.__wbindgen_export2),f=I,k=A(t,l.__wbindgen_export,l.__wbindgen_export2),v=I,_=A(o,l.__wbindgen_export,l.__wbindgen_export2),x=I;l.testengine_throwError(g,this.__wbg_ptr,h,f,k,v,_,x);var d=y().getInt32(g+0,!0),c=y().getInt32(g+4,!0),m=y().getInt32(g+8,!0),a=y().getInt32(g+12,!0),p=d,u=c;if(a)throw p=0,u=0,U(m);return r=p,s=u,$(p,u)}finally{l.__wbindgen_add_to_stack_pointer(16),l.__wbindgen_export3(r,s,1)}}tickNow(n){let t,o;try{const p=l.__wbindgen_add_to_stack_pointer(-16);l.testengine_tickNow(p,this.__wbg_ptr,n);var r=y().getInt32(p+0,!0),s=y().getInt32(p+4,!0),d=y().getInt32(p+8,!0),c=y().getInt32(p+12,!0),m=r,a=s;if(c)throw m=0,a=0,U(d);return t=m,o=a,$(m,a)}finally{l.__wbindgen_add_to_stack_pointer(16),l.__wbindgen_export3(t,o,1)}}unassignUserTask(n){let t,o;try{const p=l.__wbindgen_add_to_stack_pointer(-16),u=A(n,l.__wbindgen_export,l.__wbindgen_export2),g=I;l.testengine_unassignUserTask(p,this.__wbg_ptr,u,g);var r=y().getInt32(p+0,!0),s=y().getInt32(p+4,!0),d=y().getInt32(p+8,!0),c=y().getInt32(p+12,!0),m=r,a=s;if(c)throw m=0,a=0,U(d);return t=m,o=a,$(m,a)}finally{l.__wbindgen_add_to_stack_pointer(16),l.__wbindgen_export3(t,o,1)}}updateRetries(n,t){let o,r;try{const u=l.__wbindgen_add_to_stack_pointer(-16),g=A(n,l.__wbindgen_export,l.__wbindgen_export2),h=I;l.testengine_updateRetries(u,this.__wbg_ptr,g,h,t);var s=y().getInt32(u+0,!0),d=y().getInt32(u+4,!0),c=y().getInt32(u+8,!0),m=y().getInt32(u+12,!0),a=s,p=d;if(m)throw a=0,p=0,U(c);return o=a,r=p,$(a,p)}finally{l.__wbindgen_add_to_stack_pointer(16),l.__wbindgen_export3(o,r,1)}}updateUserTask(n,t){let o,r;try{const u=l.__wbindgen_add_to_stack_pointer(-16),g=A(n,l.__wbindgen_export,l.__wbindgen_export2),h=I,f=A(t,l.__wbindgen_export,l.__wbindgen_export2),k=I;l.testengine_updateUserTask(u,this.__wbg_ptr,g,h,f,k);var s=y().getInt32(u+0,!0),d=y().getInt32(u+4,!0),c=y().getInt32(u+8,!0),m=y().getInt32(u+12,!0),a=s,p=d;if(m)throw a=0,p=0,U(c);return o=a,r=p,$(a,p)}finally{l.__wbindgen_add_to_stack_pointer(16),l.__wbindgen_export3(o,r,1)}}}Symbol.dispose&&(Tn.prototype[Symbol.dispose]=Tn.prototype.free);function ci(){return{__proto__:null,"./nanobpmn_engine_bg.js":{__proto__:null,__wbg___wbindgen_throw_bb96b2010945f0bc:function(n,t){throw new Error($(n,t))},__wbindgen_cast_0000000000000001:function(n,t){const o=$(n,t);return mi(o)},__wbindgen_object_drop_ref:function(n){U(n)}}}}const st=typeof FinalizationRegistry>"u"?{register:()=>{},unregister:()=>{}}:new FinalizationRegistry(e=>l.__wbg_testengine_free(e,1));function mi(e){Xe===Re.length&&Re.push(Re.length+1);const n=Xe;return Xe=Re[n],Re[n]=e,n}function pi(e){e<1028||(Re[e]=Xe,Xe=e)}let Le=null;function y(){return(Le===null||Le.buffer.detached===!0||Le.buffer.detached===void 0&&Le.buffer!==l.memory.buffer)&&(Le=new DataView(l.memory.buffer)),Le}function $(e,n){return gi(e>>>0,n)}let Qe=null;function ln(){return(Qe===null||Qe.byteLength===0)&&(Qe=new Uint8Array(l.memory.buffer)),Qe}function ui(e){return Re[e]}let Re=new Array(1024).fill(void 0);Re.push(void 0,null,!0,!1);let Xe=Re.length;function hi(e){return e==null}function A(e,n,t){if(t===void 0){const c=en.encode(e),m=n(c.length,1)>>>0;return ln().subarray(m,m+c.length).set(c),I=c.length,m}let o=e.length,r=n(o,1)>>>0;const s=ln();let d=0;for(;d<o;d++){const c=e.charCodeAt(d);if(c>127)break;s[r+d]=c}if(d!==o){d!==0&&(e=e.slice(d)),r=t(r,o,o=d+e.length*3,1)>>>0;const c=ln().subarray(r+d,r+o),m=en.encodeInto(e,c);d+=m.written,r=t(r,o,d,1)>>>0}return I=d,r}function U(e){const n=ui(e);return pi(e),n}let cn=new TextDecoder("utf-8",{ignoreBOM:!0,fatal:!0});cn.decode();const bi=2146435072;let En=0;function gi(e,n){return En+=n,En>=bi&&(cn=new TextDecoder("utf-8",{ignoreBOM:!0,fatal:!0}),cn.decode(),En=n),cn.decode(ln().subarray(e,e+n))}const en=new TextEncoder;"encodeInto"in en||(en.encodeInto=function(e,n){const t=en.encode(e);return n.set(t),{read:e.length,written:t.length}});let I=0,l;function fi(e,n){return l=e.exports,Le=null,Qe=null,l}async function _i(e,n){if(typeof Response=="function"&&e instanceof Response){if(!e.ok)throw new Error(`failed to fetch Wasm: ${e.status} ${e.statusText} fetching '${e.url}'`);if(typeof WebAssembly.instantiateStreaming=="function")try{return await WebAssembly.instantiateStreaming(e,n)}catch(r){if(t(e.type)&&e.headers.get("Content-Type")!=="application/wasm")console.warn("`WebAssembly.instantiateStreaming` failed because your server does not serve Wasm with `application/wasm` MIME type. Falling back to `WebAssembly.instantiate` which is slower. Original error:\n",r);else throw r}const o=await e.arrayBuffer();return await WebAssembly.instantiate(o,n)}else{const o=await WebAssembly.instantiate(e,n);return o instanceof WebAssembly.Instance?{instance:o,module:e}:o}function t(o){switch(o){case"basic":case"cors":case"default":return!0}return!1}}async function wi(e){if(l!==void 0)return l;e!==void 0&&(Object.getPrototypeOf(e)===Object.prototype?{module_or_path:e}=e:console.warn("using deprecated parameters for the initialization function; pass a single object instead")),e===void 0&&(e=new URL("/web-demo-framework/pr-preview/pr-121/assets/nanobpmn_engine_bg-DRNrIVE8.wasm",import.meta.url));const n=ci();(typeof e=="string"||typeof Request=="function"&&e instanceof Request||typeof URL=="function"&&e instanceof URL)&&(e=fetch(e));const{instance:t,module:o}=await _i(await e,n);return fi(t)}let sn=null;function yi(e){return sn||(sn=wi(void 0).then(()=>{}).catch(n=>{throw sn=null,n})),sn}function ne(e){return JSON.parse(e)}class vi{constructor(n){z(this,"engine");this.engine=n}deploy(n){return JSON.parse(this.engine.deploy(n))}createInstance(n,t){return ne(this.engine.createInstance(n,t||"{}"))}activateJobs(n,t,o,r){return JSON.parse(this.engine.activateJobs(n,t,o,r))}completeJob(n,t){return ne(this.engine.completeJob(n,t||"{}"))}completeAgentJob(n,t){const{variables:o,...r}=t??{};return ne(this.engine.completeAgentJob(n,JSON.stringify(o??{}),JSON.stringify(r??{})))}failJob(n,t,o){return ne(this.engine.failJob(n,t,o))}throwError(n,t,o){return ne(this.engine.throwError(n,t,o))}updateRetries(n,t){return ne(this.engine.updateRetries(n,t))}resolveIncident(n){return ne(this.engine.resolveIncident(n))}setVariables(n,t,o){return ne(this.engine.setVariables(n,t||"{}",o))}broadcastSignal(n,t){return ne(this.engine.broadcastSignal(n,t||"{}"))}cancelInstance(n){return ne(this.engine.cancelInstance(n))}modify(n,t,o){return ne(this.engine.modify(n,JSON.stringify(t??[]),JSON.stringify(o??[])))}completeUserTask(n,t){return ne(this.engine.completeUserTask(n,t||"{}"))}assignUserTask(n,t,o){return ne(this.engine.assignUserTask(n,t,o))}unassignUserTask(n){return ne(this.engine.unassignUserTask(n))}updateUserTask(n,t){return ne(this.engine.updateUserTask(n,t||"{}"))}correlateMessage(n,t,o){return ne(this.engine.correlateMessage(n,t,o||"{}"))}advanceTime(n){return ne(this.engine.advanceTime(n))}reset(){this.engine.reset()}events(){return JSON.parse(this.engine.events())}snapshot(){return ne(this.engine.snapshot())}free(){this.engine.free()}}async function xi(e){return await yi(),new vi(new Tn)}class zt extends Error{constructor(t,o){super(t);z(this,"retries");this.name="JobFailure",this.retries=o==null?void 0:o.retries}}function Ei(e,n=[]){if(e.instances.filter(r=>!r.completed).length===0)return e.totalInstances>0?"completed":"idle";if(e.incidents.length>0)return"incidents";const o=new Set(n);return e.jobs.some(r=>!o.has(r.jobType))?"unhandledJobs":e.userTasks.some(r=>r.state==="Created")?"userTasks":e.timers.length>0?"timers":e.messageSubscriptions.length>0?"messages":e.signalSubscriptions.length>0?"signals":"idle"}function ki(e,n=[]){const t=new Set(n);return[...new Set(e.jobs.map(o=>o.jobType))].filter(o=>!t.has(o)).sort()}async function Ni(e,n,t){let o;try{const r=await n(t);o=JSON.stringify(r??{})}catch(r){const s=r instanceof zt&&r.retries!==void 0?r.retries:Math.max(0,t.retries-1),d=r instanceof Error?r.message:String(r);e.failJob(t.key,s,d);return}e.completeJob(t.key,o)}async function Pi(e,n,t){let o;try{o=await n(t),JSON.stringify(o)}catch(r){const s=r instanceof zt&&r.retries!==void 0?r.retries:Math.max(0,t.retries-1),d=r instanceof Error?r.message:String(r);e.failJob(t.key,s,d);return}e.completeAgentJob(t.key,o)}async function Mi(e,n,t={}){const o=t.maxJobsPerActivation??10,r=t.lockTimeoutMs??3e4,s=t.worker??"bojtos",d=t.agents??{};for(const g of Object.keys(d))if(g in n)throw new Error(`dispatchRound: job type "${g}" is registered as both a worker and an agent — register it as exactly one`);const c=[];for(const[g,h]of Object.entries(n))for(const f of e.activateJobs(g,o,r,s))c.push({handler:h,job:f});const m=[];for(const[g,h]of Object.entries(d))for(const f of e.activateJobs(g,o,r,s))m.push({handler:h,job:f});for(const{handler:g,job:h}of c)await Ni(e,g,h);for(const{handler:g,job:h}of m)await Pi(e,g,h);const a=e.snapshot(),p=c.length+m.length;if(p>0)return{snapshot:a,handled:p};const u=[...Object.keys(n),...Object.keys(d)];return{snapshot:a,handled:p,reason:Ei(a,u),unhandled:ki(a,u)}}function Si({bpmn:e}){const n=b.useRef(null),[t,o]=b.useState("loading"),[r,s]=b.useState(null),[d,c]=b.useState([]),[m,a]=b.useState(null),p=b.useRef(e),u=b.useRef(0),g=b.useRef(null),h=b.useRef(new Map),f=b.useCallback((R,M)=>{h.current.set(R,M)},[]),k=b.useCallback(R=>h.current.get(R),[]),v=b.useCallback((R,M)=>{const P=R.deploy(M);return p.current=M,h.current.clear(),c(P.processIds),a(null),s(null),P.processIds},[]);b.useEffect(()=>{let R=!1;return o("loading"),c([]),a(null),s(null),xi().then(M=>{if(R){M.free();return}try{v(M,e)}catch(P){M.free(),s(String(P)),o("error");return}n.current=M,o("ready")}).catch(M=>{R||(s(String(M)),o("error"))}),()=>{var M;R=!0,(M=n.current)==null||M.free(),n.current=null,h.current.clear()}},[e]);const _=b.useCallback(R=>{const M=n.current;if(!M)return null;try{const P=R(M);return a(P),s(null),P}catch(P){return s(String(P)),null}},[]),x=b.useCallback((R,M)=>_(P=>P.createInstance(R,M)),[_]),E=b.useCallback((R,M)=>_(P=>P.completeUserTask(R,M)),[_]),V=b.useCallback(R=>_(M=>M.advanceTime(R)),[_]),Z=b.useCallback((R,M)=>_(P=>P.broadcastSignal(R,M)),[_]);function J(R,M){const[P]=R.activateJobs(M,1,3e4,"manual-control");if(!P)throw new Error(`No waiting job of type "${M}" to resolve.`);return P}const ge=b.useCallback((R,M)=>_(P=>{const j=J(P,R);return P.completeJob(j.key,M)}),[_]),Ce=b.useCallback((R,M,P)=>_(j=>{const H=J(j,R);return j.throwError(H.key,M,P)}),[_]),fe=b.useCallback((R,M,P)=>_(j=>j.correlateMessage(R,M,P)),[_]),Pe=b.useCallback(async(R,M)=>{const P=n.current;if(!P)return null;const j=u.current,H=Mi(P,R,M);g.current=H;try{const ye=await H;return n.current!==P||u.current!==j?null:(a(ye.snapshot),s(null),ye)}catch(ye){return n.current!==P||u.current!==j||(a(P.snapshot()),s(String(ye))),null}finally{g.current===H&&(g.current=null)}},[]),X=b.useCallback(async()=>{var R;await((R=g.current)==null?void 0:R.catch(()=>{}))},[]),_e=b.useCallback(async()=>{await X();const R=n.current;if(R){u.current++;try{R.reset(),v(R,p.current)}catch(M){s(String(M))}}},[v,X]),de=b.useCallback(async R=>{await X();const M=n.current;if(!M)return null;u.current++;try{return M.reset(),v(M,R)}catch(P){return s(String(P)),null}},[v,X]);return{phase:t,error:r,processIds:d,snapshot:m,createInstance:x,stepWorkers:Pe,completeUserTask:E,advanceTime:V,broadcastSignal:Z,completeJobManually:ge,throwJobError:Ce,correlateMessage:fe,reset:_e,redeploy:de,setRunImage:f,getRunImage:k}}const Bi="web-demo-framework:height",Ri="web-demo-framework:ready";function Ci(){return{type:Ri}}const Ii="web-demo-framework:request-height";function Ai(e){return{type:Bi,height:Math.ceil(e)}}const dt="embed-height-auto";function Ti(e=document){return Math.max(e.documentElement.offsetHeight,e.body.scrollHeight)}function Fi(e){b.useEffect(()=>{if(!e||typeof window>"u"||window.parent===window)return;const n=document.documentElement;n.classList.add(dt);let t=-1;const o=(d=!1)=>{const c=Ti();!d&&Math.abs(c-t)<2||(t=c,window.parent.postMessage(Ai(c),"*"))},r=d=>{if(d.source!==window.parent)return;const c=d.data;!c||c.type!==Ii||o(!0)};window.addEventListener("message",r),o();const s=new ResizeObserver(()=>o());return s.observe(n),()=>{s.disconnect(),window.removeEventListener("message",r),n.classList.remove(dt)}},[e])}function ji(e){const n=b.useRef(!1);b.useEffect(()=>{!e||n.current||typeof window>"u"||window.parent===window||(n.current=!0,window.parent.postMessage(Ci(),"*"))},[e])}function Di(e,n){return e.slice(n)}function Li(e,n,t,o){const r=e.snapshot,s="⏸ waiting for a human — complete the task below to continue",d=r.userTasks.some(c=>c.state==="Created");if(e.handled>0){const c=r.activeElementIds.map(t),m=n.length?` via ${n.map(a=>`${t(a.from)} → ${t(a.to)}`).join(", ")}`:"";return r.completedInstances>=1?{kind:"done",text:`⏭ round handled ${e.handled} job${e.handled===1?"":"s"}${m} — ✅ process instance completed`}:d?{kind:"human",text:`⏭ round handled ${e.handled} job${e.handled===1?"":"s"}${m} — ${s}`}:{kind:"step",text:`⏭ round handled ${e.handled} job${e.handled===1?"":"s"}${m} — now at ${c.length?c.join(", "):"—"}`}}switch(e.reason){case"completed":return{kind:"done",text:"✅ process instance completed"};case"userTasks":return{kind:"human",text:s};case"timers":return{kind:"step",text:"⏱ waiting on a timer — advance the clock to continue"};case"messages":return{kind:"step",text:"✉ waiting on a message — correlate it to continue"};case"signals":return{kind:"step",text:"📶 waiting on a signal — broadcast it to continue"};case"incidents":return{kind:"error",text:"A job failed — incident on the diagram"};case"unhandledJobs":{const c=e.unhandled??[];return o&&c.length>0&&c.every(m=>o.has(m))?{kind:"human",text:s}:{kind:"error",text:`⏭ waiting on job type(s) with no worker registered: ${c.join(", ")}`}}case"idle":return{kind:"step",text:"Nothing to step — no instance is running."};default:return{kind:"step",text:e.reason?`Step blocked on an unrecognized reason: ${e.reason}`:"Nothing to step — no instance is running."}}}const Oi="the Scripted or Endpoint brain";async function un(e=Oi){const n=navigator.gpu;if(!n)return`This browser doesn't expose WebGPU at all. Use a recent Chrome, Edge, or Safari 17+ with hardware acceleration on, or pick ${e}.`;let t;try{t=await n.requestAdapter()}catch(o){return`WebGPU adapter request failed (${o instanceof Error?o.message:String(o)}). Try ${e} instead.`}return t?null:`This browser supports the WebGPU API, but no GPU adapter is available — hardware acceleration may be off, or this device/VM has no usable GPU. Pick ${e} instead.`}const zi=[{id:"Qwen2.5-1.5B-Instruct-q4f16_1-MLC",label:"Qwen2.5 1.5B",downloadLabel:"~1.0 GB"},{id:"SmolLM2-1.7B-Instruct-q4f16_1-MLC",label:"SmolLM2 1.7B",downloadLabel:"~1.1 GB"},{id:"Llama-3.2-1B-Instruct-q4f16_1-MLC",label:"Llama 3.2 1B",downloadLabel:"~0.7 GB"},{id:"gemma-2-2b-it-q4f16_1-MLC",label:"Gemma 2 2B",downloadLabel:"~1.5 GB"},{id:"Llama-3.2-1B-Instruct-q4f32_1-MLC",label:"Llama 3.2 1B (f32, wider GPU support)",downloadLabel:"~1.1 GB"},{id:"SmolLM2-360M-Instruct-q4f32_1-MLC",label:"SmolLM2 360M (tiny, f32)",downloadLabel:"~0.6 GB"},{id:"SmolLM2-360M-Instruct-q4f16_1-MLC",label:"SmolLM2 360M (tiny)",downloadLabel:"~0.3 GB"}];function $t(e){return Fn.get(e)??{}}const Fn=new Map;async function $i(){if(Fn.size>0)return;const{prebuiltAppConfig:e}=await be(async()=>{const{prebuiltAppConfig:n}=await import("./vendor-webllm-DT0Ab8E6.js");return{prebuiltAppConfig:n}},[]);for(const n of e.model_list)Fn.set(n.model_id,{vramRequiredMB:n.vram_required_MB,requiredFeatures:n.required_features})}const _n=zi.map(e=>({id:e.id,label:`${e.label} (${e.downloadLabel})`,downloadLabel:e.downloadLabel,...$t(e.id)})),Ut=_n[0].id;async function Ui(){return await $i(),_n.map(e=>({...e,...$t(e.id)}))}function Vt(){const e=navigator.deviceMemory;return typeof e=="number"?e*1024:null}function Vi(e,n=Vt()){return n==null||e.vramRequiredMB==null||n>=e.vramRequiredMB?null:`${e.label} needs roughly ${Math.round(e.vramRequiredMB)} MB of GPU memory; this device looks like it has about ${Math.round(n)} MB available. It may still work, but expect it to fail or fall back to slow shared memory — try a smaller model (e.g. SmolLM2 360M) if it doesn't load.`}async function qi(e){try{const{hasModelInCache:n}=await be(async()=>{const{hasModelInCache:t}=await import("./vendor-webllm-DT0Ab8E6.js");return{hasModelInCache:t}},[]);return await n(e)}catch{return!1}}function hn(e){return/device (was )?lost|device_hung|device_removed|already been disposed|gpudevicelostinfo/i.test(e)}function lt(){return"The GPU device was lost — the driver reset while the model was loading or running. This is a browser/driver-level failure, not a problem with the model: fully quit and reopen the browser (a lost device usually persists for the life of the GPU process), check chrome://gpu still reports hardware acceleration, and update your GPU driver if it recurs. The Scripted and Endpoint brains don't use the GPU at all."}class dn{constructor(){z(this,"kind","browser");z(this,"model",null);z(this,"engine",null);z(this,"worker",null);z(this,"generation",0);z(this,"chat",async(n,t=512,o)=>{var s,d;const r=this.engine;if(!r||!this.model)throw new Error("BrowserBrain.chat called before connect()");try{const c=await r.chat.completions.create({messages:n,temperature:0,max_tokens:t,stream:!0});let m="";for await(const a of c){const p=((d=(s=a.choices[0])==null?void 0:s.delta)==null?void 0:d.content)??"";p&&(m+=p,o==null||o(p))}return m}catch(c){const m=c instanceof Error?c.message:String(c);throw hn(m)?(this.teardown(),new Error(`The in-browser model stopped: ${lt()}`)):c}})}async connect(n=Ut,t){var m,a;const o=await un();if(o)throw new Error(o);if(this.engine&&this.model===n)return n;const r=++this.generation,s=p=>{r===this.generation&&(t==null||t({progress:p.progress??0,text:p.text??""}))};this.teardown();let d,c;try{const{CreateWebWorkerMLCEngine:p}=await be(async()=>{const{CreateWebWorkerMLCEngine:u}=await import("./vendor-webllm-DT0Ab8E6.js");return{CreateWebWorkerMLCEngine:u}},[]);c=new Worker(new URL("/web-demo-framework/pr-preview/pr-121/assets/webllm.worker-Dc1cCqhL.js",import.meta.url),{type:"module"}),d=await p(c,n,{initProgressCallback:s})}catch(p){if(c==null||c.terminate(),r!==this.generation)throw new Error("cancelled");const u=p instanceof Error?p.message:String(p);if(hn(u))throw new Error(`Couldn't load ${n} in the browser (${u}). ${lt()}`);const g=(a=(m=_n.find(h=>h.id===n))==null?void 0:m.requiredFeatures)==null?void 0:a.includes("shader-f16");throw new Error(`Couldn't load ${n} in the browser (${u}). `+(g?"This model needs WebGPU with shader-f16; try one of the f32 models in the list, or the endpoint brain.":"Try a smaller model, check your connection, or use the endpoint brain instead."))}if(r!==this.generation)throw d.unload().catch(()=>{}),c==null||c.terminate(),new Error("cancelled");return this.engine=d,this.worker=c??null,this.model=n,n}teardown(){const{engine:n,worker:t}=this;this.engine=null,this.worker=null,this.model=null,n==null||n.unload().catch(()=>{}),t==null||t.terminate()}cancelConnect(){this.generation++}dispose(){this.generation++,this.teardown()}}const Ln="http://localhost:11434/v1",bn=e=>e==="localhost"||e==="127.0.0.1"||e==="::1"||e==="[::1]";function qt(){var e;return bn(((e=globalThis.location)==null?void 0:e.hostname)??"")}function kn(e){try{return bn(new URL(On(e)).hostname)}catch{return!1}}function gn(e,n={hostname:(t=>(t=globalThis.location)==null?void 0:t.hostname)()??"",origin:(o=>(o=globalThis.location)==null?void 0:o.origin)()??""}){let r;try{r=new URL(On(e)).hostname}catch{return null}return!bn(r)||bn(n.hostname)?null:`This page is served from ${n.origin||"a non-local origin"}, so it can't reach ${e}. A local model server only accepts requests from a page on localhost. Open this page at http://localhost instead, or use the Scripted or In-browser brain.`}function On(e){let n=e.trim().replace(/\/+$/,"");return n.endsWith("/chat/completions")&&(n=n.slice(0,-17)),/\/v\d+$/.test(n)||(n=`${n}/v1`),n}class ct extends Error{constructor(n,t){super(n),this.status=t,this.name="HttpError"}}class mt{constructor(n=Ln,t="",o=""){z(this,"kind","endpoint");z(this,"baseUrl");z(this,"model",null);z(this,"models",[]);z(this,"apiKey");z(this,"requestedModel");z(this,"chat",async(n,t=512,o)=>{var a,p,u;if(!this.model)throw new Error("EndpointBrain.chat called before connect()");const r=await fetch(`${this.baseUrl}/chat/completions`,{method:"POST",headers:this.headers(),body:JSON.stringify({model:this.model,messages:n,temperature:0,max_tokens:t,stream:!0})});if(!r.ok||!r.body){const g=await r.text().catch(()=>"");throw new Error(`chat/completions HTTP ${r.status} ${r.statusText}${g?` — ${g.slice(0,300)}`:""}`)}const s=r.body.getReader(),d=new TextDecoder;let c="",m="";for(;;){const{value:g,done:h}=await s.read();if(h)break;c+=d.decode(g,{stream:!0});let f;for(;(f=c.indexOf(`
`))>=0;){const k=c.slice(0,f).trim();if(c=c.slice(f+1),!k.startsWith("data:"))continue;const v=k.slice(5).trim();if(v==="[DONE]")continue;let _;try{_=JSON.parse(v)}catch{continue}_.model&&(this.model=_.model);const x=(a=_.choices)==null?void 0:a[0],E=((p=x==null?void 0:x.delta)==null?void 0:p.content)??((u=x==null?void 0:x.message)==null?void 0:u.content)??"";E&&(m+=E,o==null||o(E))}}return m});this.baseUrl=On(n),this.apiKey=t.trim(),this.requestedModel=o.trim()}headers(){const n={"Content-Type":"application/json"};return this.apiKey&&(n.Authorization=`Bearer ${this.apiKey}`),n}async listModels(){let n;try{n=await fetch(`${this.baseUrl}/models`,{headers:this.headers()})}catch(o){const r=gn(this.baseUrl);throw new Error(r??`Can't reach ${this.baseUrl} (${o instanceof Error?o.message:String(o)}). Is the server running? For Ollama, check the app is up — and if this page is served from another origin, allow it with OLLAMA_ORIGINS.`)}if(!n.ok)throw new ct(`${this.baseUrl}/models returned HTTP ${n.status} ${n.statusText}`,n.status);const t=await n.json();return this.models=(t.data??[]).map(o=>o.id).filter(o=>!!o),this.models}async connect(){try{const n=await this.listModels(),t=this.requestedModel||n[0];if(!t)throw new Error(`No models available at ${this.baseUrl}. Pull one first — e.g. \`ollama pull llama3.2:3b\` — or name one explicitly.`);this.model=t}catch(n){const t=n instanceof ct&&[404,405,501].includes(n.status);if(!this.requestedModel||!t)throw n;this.models=[],this.model=this.requestedModel}return await this.validate(),this.model}async validate(){const n=await fetch(`${this.baseUrl}/chat/completions`,{method:"POST",headers:this.headers(),body:JSON.stringify({model:this.model,messages:[{role:"user",content:"Reply with ok."}],temperature:0,max_tokens:1,stream:!1})}).catch(o=>{throw new Error(`Can't reach ${this.baseUrl}/chat/completions (${o instanceof Error?o.message:String(o)}). Check the endpoint URL, API key, model name, and any local CORS settings.`)});if(!n.ok){const o=await n.text().catch(()=>"");throw new Error(`chat/completions HTTP ${n.status} ${n.statusText}${o?` — ${o.slice(0,300)}`:""}`)}const t=await n.json().catch(()=>({}));t.model&&(this.model=t.model)}dispose(){}}const pt="gemini-nano";function fn(){const e=globalThis.LanguageModel;return typeof(e==null?void 0:e.create)=="function"&&typeof e.availability=="function"?e:null}function Gi(){return fn()!==null}async function Gt(){const e=fn();if(!e)return"This browser has no built-in AI model. Chrome's Prompt API (Gemini Nano) needs Chrome 138+ on desktop Windows 10/11, macOS 13+, Linux or a Chromebook Plus. Use the Scripted, In-browser (WebGPU) or API endpoint brain instead.";let n;try{n=await e.availability()}catch(t){return`Chrome couldn't report on its built-in model (${t instanceof Error?t.message:String(t)}).`}return n==="unavailable"?"Chrome exposes the built-in AI API here, but Gemini Nano can't run on this device. Chrome requires ~22 GB free on the volume holding your Chrome profile, and either a GPU with more than 4 GB of VRAM or 16 GB of RAM with 4+ CPU cores. Check chrome://on-device-internals for the details.":null}class ut{constructor(){z(this,"kind","chrome");z(this,"model",null);z(this,"warm",null);z(this,"connecting",null);z(this,"chat",async(n,t,o)=>{if(!this.model)throw new Error("ChromeBrain.chat called before connect()");const r=fn();if(!r)throw new Error("Chrome's built-in AI API went away.");const s=n.filter(m=>m.role==="system"),d=n.filter(m=>m.role!=="system"),c=await r.create(s.length?{initialPrompts:s}:void 0);try{const m=c.promptStreaming(d).getReader();let a="";for(;;){const{done:p,value:u}=await m.read();if(p)break;u&&(a+=u,o==null||o(u))}return a}finally{c.destroy()}})}async connect(n){const t=await Gt();if(t)throw new Error(t);const o=fn();this.dispose();const r=new AbortController;this.connecting=r;try{this.warm=await o.create({signal:r.signal,monitor:s=>{s.addEventListener("downloadprogress",d=>{n==null||n({progress:d.loaded,text:"Downloading Gemini Nano"})})}})}catch(s){if(r.signal.aborted)throw new Error("cancelled");const d=s instanceof Error?s.message:String(s);throw new Error(`Chrome couldn't start its built-in model (${d}). The first run downloads Gemini Nano and must be triggered by a click — press Connect again, and check chrome://on-device-internals if it keeps failing.`)}finally{this.connecting=null}return this.model=pt,pt}cancelConnect(){var n;(n=this.connecting)==null||n.abort()}dispose(){var n,t;(n=this.connecting)==null||n.abort(),this.connecting=null,(t=this.warm)==null||t.destroy(),this.warm=null,this.model=null}}const Hi=[{id:"onnx-community/Florence-2-base-ft",label:"Florence-2 base",downloadLabel:"~0.4 GB"},{id:"onnx-community/Florence-2-large-ft",label:"Florence-2 large (higher quality)",downloadLabel:"~1.6 GB"}],Ht=Hi.map(e=>({...e,label:`${e.label} (${e.downloadLabel})`})),Jt=Ht[0].id,Ji="<OCR>",ht="UNKNOWN (scripted brain — connect the in-browser model to read a photo)";function Wi(e,n){if(e)return typeof e=="function"?e(n):e[n]}class Ki{constructor(n){z(this,"kind","scripted-vision");z(this,"model",null);z(this,"read",async(n,t,o)=>{const r=typeof n=="string"?Wi(this.lookup,n)??ht:ht;return o==null||o(r),r});this.lookup=n}dispose(){}}function Zi(e){return new Ki(e)}class bt{constructor(){z(this,"kind","browser-vision");z(this,"model",null);z(this,"modelHandle",null);z(this,"processor",null);z(this,"loadImage",null);z(this,"generation",0);z(this,"read",async(n,t,o)=>{const r=this.modelHandle,s=this.processor,d=this.loadImage;if(!r||!s||!d||!this.model)throw new Error("BrowserVisionBrain.read called before connect()");const c=t&&t.startsWith("<")?t:Ji,m=await d(n),a=s.construct_prompts(c),p=await s(m,a),u=await r.generate({...p,max_new_tokens:512,num_beams:1,do_sample:!1}),g=s.batch_decode(u,{skip_special_tokens:!1})[0],h=s.post_process_generation(g,c,m.size),f=Yi(h,c);return o==null||o(f),f})}async connect(n=Jt,t){var c,m;const o=await un("the scripted-vision fallback");if(o)throw new Error(o);if(this.modelHandle&&this.model===n)return n;const r=++this.generation,s=a=>{r===this.generation&&(t==null||t({progress:(a.progress??0)/100,text:a.file?`${a.status??"loading"} ${a.file}`:a.status??""}))};this.teardown();let d;try{const{Florence2ForConditionalGeneration:a,AutoProcessor:p,load_image:u}=await be(async()=>{const{Florence2ForConditionalGeneration:f,AutoProcessor:k,load_image:v}=await import("./transformers.web-D4adwrl9.js");return{Florence2ForConditionalGeneration:f,AutoProcessor:k,load_image:v}},[]),g=await a.from_pretrained(n,{dtype:"fp32",device:"webgpu",progress_callback:s}),h=await p.from_pretrained(n);d={model:g,processor:h,loadImage:u}}catch(a){if(r!==this.generation)throw new Error("cancelled");const p=a instanceof Error?a.message:String(a);throw new Error(`Couldn't load ${n} in the browser (${p}). Try the smaller Florence-2 base model, check your connection, or use the scripted-vision fallback.`)}if(r!==this.generation)throw Promise.resolve((m=(c=d.model).dispose)==null?void 0:m.call(c)).catch(()=>{}),new Error("cancelled");return this.modelHandle=d.model,this.processor=d.processor,this.loadImage=d.loadImage,this.model=n,n}teardown(){var t;const n=this.modelHandle;this.modelHandle=null,this.processor=null,this.loadImage=null,this.model=null,Promise.resolve((t=n==null?void 0:n.dispose)==null?void 0:t.call(n)).catch(()=>{})}cancelConnect(){this.generation++}dispose(){this.generation++,this.teardown()}}function Yi(e,n){const t=e[n];if(typeof t=="string")return t.trim();if(t&&typeof t=="object"){const o=t.labels;return Array.isArray(o)?o.join(" ").trim():JSON.stringify(t)}return""}function Qi(){const[e,n]=b.useState("scripted"),[t,o]=b.useState("idle"),[r,s]=b.useState(null),[d,c]=b.useState(null),[m,a]=b.useState(null),[p,u]=b.useState(null),[g,h]=b.useState(null),[f,k]=b.useState(null),[v,_]=b.useState(null),[x,E]=b.useState(Ut),[V,Z]=b.useState(qt()?Ln:""),[J,ge]=b.useState(""),[Ce,fe]=b.useState([]),[Pe,X]=b.useState("idle"),[_e,de]=b.useState(null),[R,M]=b.useState(""),[P,j]=b.useState(null),H=b.useRef(null),[ye,ze]=b.useState("scripted-vision"),[wn,ve]=b.useState("idle"),[He,ie]=b.useState(null),[Te,tn]=b.useState(Jt),[yn,xe]=b.useState(null),[Fe,Ie]=b.useState(null),[vn,xn]=b.useState(null),[Je,ee]=b.useState(null),G=b.useRef(null),We=b.useRef(!1),$e=b.useRef(0),Me=b.useCallback(B=>async(...W)=>{try{return await B.chat(...W)}catch(T){const Y=T instanceof Error?T.message:String(T);throw B instanceof dn&&hn(Y)&&(j(null),c(null),o("error"),s(Y)),T}},[]),je=b.useCallback(B=>async(...W)=>{try{return await B.read(...W)}catch(T){const Y=T instanceof Error?T.message:String(T);throw hn(Y)&&(ee(null),xe(null),ve("error"),ie(Y)),T}},[]);b.useEffect(()=>{un().then(B=>{h(B),u(B===null)}),Gt().then(_),un("the scripted-vision fallback").then(B=>{xn(B),We.current||(We.current=!0,ze(B===null?"browser-vision":"scripted-vision"))})},[]),b.useEffect(()=>{let B=!1;return k(null),qi(x).then(W=>{B||k(W)}),()=>{B=!0}},[x]),b.useEffect(()=>()=>{var B;return(B=H.current)==null?void 0:B.dispose()},[]),b.useEffect(()=>()=>{var B;return(B=G.current)==null?void 0:B.dispose()},[]);const Ke=b.useCallback(B=>{n(B),o("idle"),s(null),c(null),a(null),j(null)},[]),O=b.useCallback(B=>{var W,T;We.current=!0,(W=G.current)==null||W.cancelConnect(),(T=G.current)==null||T.dispose(),G.current=null,ze(B),ve("idle"),ie(null),xe(null),Ie(null),ee(null)},[]),pe=b.useCallback(()=>{var B;(B=H.current)==null||B.dispose(),H.current=null,j(null),c(null)},[]),Ae=b.useCallback(()=>{const B=H.current;(B instanceof dn||B instanceof ut)&&B.cancelConnect(),pe(),o("idle"),a(null),s(null)},[pe]),Se=b.useCallback(async()=>{const B=++$e.current,W=()=>B!==$e.current;if(!V.trim()){fe([]),ge(""),X("idle"),de(null);return}const T=gn(V);if(T){fe([]),ge(""),X("error"),de(T);return}X("loading"),de(null);const Y=new mt(V,R);try{const ke=await Y.listModels();if(W())return;fe(ke),X("ready"),ge(De=>De&&ke.includes(De)?De:ke[0]??"")}catch(ke){if(W())return;fe([]),ge(""),X("error"),de(ke instanceof Error?ke.message:String(ke))}finally{Y.dispose()}},[V,R]),on=b.useCallback(async()=>{var B,W;if(e==="scripted"){j(null),o("ready");return}if(e==="endpoint"){const T=gn(V);if(T){pe(),s(T),o("error");return}}o("connecting"),s(null),a(null);try{if(e==="browser"){const T=H.current instanceof dn?H.current:new dn;H.current&&H.current!==T&&H.current.dispose(),H.current=T;const Y=await T.connect(x,a);c(Y),j(()=>Me(T)),k(!0)}else if(e==="chrome"){(B=H.current)==null||B.dispose();const T=new ut;H.current=T;const Y=await T.connect(a);_(null),c(Y),j(()=>Me(T))}else{(W=H.current)==null||W.dispose();const T=new mt(V,R,J);H.current=T;const Y=await T.connect();c(Y),j(()=>Me(T))}o("ready")}catch(T){const Y=T instanceof Error?T.message:String(T);if(Y==="cancelled")return;s(Y),o("error"),j(null)}finally{a(null)}},[e,x,V,J,R,pe,Me]),re=b.useCallback(()=>{var B;(B=G.current)==null||B.dispose(),G.current=null,ee(null),xe(null)},[]),Ue=b.useCallback(()=>{var B;(B=G.current)==null||B.cancelConnect(),re(),ve("idle"),Ie(null),ie(null)},[re]),Ve=b.useCallback(async()=>{if(ye==="scripted-vision"){re(),ve("ready"),ie(null);return}ve("connecting"),ie(null),Ie(null);try{const B=G.current instanceof bt?G.current:new bt;G.current&&G.current!==B&&G.current.dispose(),G.current=B;const W=await B.connect(Te,Ie);xe(W),ee(()=>je(B)),ve("ready")}catch(B){const W=B instanceof Error?B.message:String(B);if(W==="cancelled")return;ie(W),ve("error"),ee(null),xe(null)}finally{Ie(null)}},[ye,Te,re,je]);return{kind:e,setKind:Ke,status:t,error:r,modelInUse:d,progress:m,webgpu:p,webgpuReason:g,browserModelCached:f,chromeAiReason:v,cancelConnect:Ae,browserModel:x,setBrowserModel:E,endpointUrl:V,setEndpointUrl:Z,endpointModel:J,setEndpointModel:ge,endpointModels:Ce,endpointModelsStatus:Pe,endpointModelsError:_e,listEndpointModels:Se,apiKey:R,setApiKey:M,connect:on,chat:P,visionKind:ye,setVisionKind:O,visionStatus:wn,visionError:He,visionModel:Te,setVisionModel:tn,visionModelInUse:yn,visionProgress:Fe,visionWebgpuReason:vn,connectVision:Ve,cancelVisionConnect:Ue,vision:Je}}const jn="#s=",Xi=["scripted","browser","chrome","endpoint"];function er(e){return typeof e=="string"&&Xi.includes(e)}function nr(e){try{const n=JSON.parse(e);if(n&&typeof n=="object"){const t=n,o={};return er(t.brain)&&(o.brain=t.brain),o}}catch{}return{}}function Wt(e=location.hash){if(!e.startsWith(jn))return{};let n;try{n=decodeURIComponent(e.slice(jn.length))}catch{return{}}return nr(n)}function tr(e){const n=Object.entries(e).filter(([,t])=>t!==void 0);return n.length===0?"":jn+encodeURIComponent(JSON.stringify(Object.fromEntries(n)))}function or(e){const n={...Wt(),...e},t=tr(n),o=new URL(location.href);o.hash=t,history.replaceState(history.state,"",o)}const gt=[{kind:"scripted",label:"Scripted",hint:"No model. The example's stand-in decides — deterministic and offline."},{kind:"browser",label:"In-browser (WebGPU)",hint:"A small quantised model on your GPU. First run downloads weights."},{kind:"chrome",label:"Chrome built-in",hint:"Gemini Nano, built into Chrome. Chrome owns the weights — no download from this page, no API key."},{kind:"endpoint",label:"API endpoint",hint:"Any OpenAI-compatible server: a local Ollama, or a remote provider with an API key."}],ir=[{mode:"ollama",label:"Ollama (local)"},{mode:"remote",label:"Provider URL + key"}],ft=[{kind:"scripted-vision",label:"Scripted",hint:"No model. The example's known plate is returned — deterministic and offline."},{kind:"browser-vision",label:"In-browser (WebGPU)",hint:"Reads the photo with a vision model on your GPU. First run downloads weights."}];function rr({brain:e,showText:n=!0,showVision:t=!1}){return i.jsxs("div",{className:"brain",children:[n&&i.jsx(ar,{brain:e}),n&&t&&i.jsx("hr",{className:"brain-divider"}),t&&i.jsx(sr,{brain:e})]})}function ar({brain:e}){const n=gt.find(v=>v.kind===e.kind),t=gt.filter(v=>v.kind!=="chrome"||Gi()),o=gn(e.endpointUrl),r=qt(),s=r&&kn(e.endpointUrl)?"ollama":"remote",d=v=>{kn(v)!==kn(e.endpointUrl)&&e.setApiKey(""),e.setEndpointUrl(v)},c=v=>{v!==s&&d(v==="ollama"?Ln:"")},[m,a]=b.useState(_n);b.useEffect(()=>{Ui().then(a)},[]);const{kind:p,endpointUrl:u,apiKey:g,listEndpointModels:h}=e;b.useEffect(()=>{if(p!=="endpoint"||o)return;const v=setTimeout(()=>void h(),400);return()=>clearTimeout(v)},[p,u,g,o,h]);const f=m.find(v=>v.id===e.browserModel),k=f?Vi(f,Vt()):null;return i.jsxs("div",{className:"brain-section",children:[i.jsxs("div",{className:"brain-modes",children:[i.jsx("div",{className:"brain-kinds",role:"group","aria-label":"Agent brain",children:t.map(v=>i.jsx(Q,{size:"sm",variant:e.kind===v.kind?"default":"secondary","aria-pressed":e.kind===v.kind,onClick:()=>e.setKind(v.kind),children:v.label},v.kind))}),i.jsxs("div",{className:"brain-status",children:[e.status==="ready"&&e.kind!=="scripted"&&i.jsx(te,{variant:"success",className:"brain-status-badge",children:e.modelInUse??"connected"}),e.status==="connecting"&&i.jsx(te,{variant:"info",className:"brain-status-badge",children:"connecting…"}),e.status==="error"&&i.jsx(te,{variant:"danger",className:"brain-status-badge",children:"not connected"})]})]}),i.jsx("p",{className:"field-hint",children:n.hint}),e.kind==="browser"&&i.jsxs("div",{className:"brain-config",children:[i.jsxs("div",{className:"field",children:[i.jsx(Ge,{htmlFor:"browser-model",children:"Model"}),i.jsxs(Sn,{value:e.browserModel,onValueChange:e.setBrowserModel,disabled:e.status==="connecting",children:[i.jsx(Bn,{id:"browser-model",children:i.jsx(Rn,{})}),i.jsx(Cn,{children:m.map(v=>i.jsx(In,{value:v.id,children:v.label},v.id))})]}),e.browserModelCached===!0&&i.jsx("p",{className:"field-hint",children:"Already downloaded in this browser — connecting will be fast."}),e.browserModelCached===!1&&i.jsx("p",{className:"field-hint",children:"Not downloaded yet — connecting fetches the weights once, then caches them for next time."})]}),e.webgpu===!1&&e.webgpuReason&&i.jsxs(le,{variant:"destructive",children:[i.jsx(ce,{children:"No WebGPU in this browser"}),i.jsx(me,{children:e.webgpuReason})]}),e.webgpu!==!1&&k&&i.jsxs(le,{variant:"destructive",children:[i.jsx(ce,{children:"This model may not fit in GPU memory"}),i.jsx(me,{children:k})]})]}),e.kind==="chrome"&&i.jsxs("div",{className:"brain-config",children:[i.jsx("p",{className:"field-hint",children:"Nothing to configure: Chrome downloads and manages Gemini Nano itself, so the first Connect may fetch it once and later visits reuse it. Prompts never leave your machine. It's a very small model — expect it to follow the tool-calling format less reliably than an endpoint model."}),e.chromeAiReason&&i.jsxs(le,{variant:"destructive",children:[i.jsx(ce,{children:"Chrome's built-in model isn't available here"}),i.jsx(me,{children:e.chromeAiReason})]})]}),e.kind==="endpoint"&&i.jsxs("div",{className:"brain-config",children:[r?i.jsx("div",{className:"brain-kinds",role:"group","aria-label":"Endpoint provider",children:ir.map(v=>i.jsx(Q,{size:"sm",variant:s===v.mode?"default":"secondary","aria-pressed":s===v.mode,disabled:e.status==="connecting",onClick:()=>c(v.mode),children:v.label},v.mode))}):i.jsxs("p",{className:"field-hint",children:["This page isn't served from ",i.jsx("code",{children:"localhost"}),", so a local Ollama isn't offered — it only accepts requests from a page on localhost. Point this at a remote OpenAI-compatible provider, or open this page at ",i.jsx("code",{children:"http://localhost"})," to use Ollama."]}),i.jsxs("div",{className:"field",children:[i.jsx(Ge,{htmlFor:"endpoint-url",children:"Endpoint"}),i.jsx(Xn,{id:"endpoint-url",value:e.endpointUrl,placeholder:"https://api.openai.com/v1",onChange:v=>d(v.target.value),disabled:e.status==="connecting"}),s==="ollama"?i.jsxs("p",{className:"field-hint",children:["Ollama allows ",i.jsx("code",{children:"localhost"})," origins out of the box; set"," ",i.jsx("code",{children:"OLLAMA_ORIGINS"})," only when serving this page from another host. Best for local development — a hosted copy of this page can't reach a server on your machine at all."]}):i.jsxs("p",{className:"field-hint",children:["The base URL of any OpenAI-compatible provider — it must serve"," ",i.jsx("code",{children:"/models"})," and ",i.jsx("code",{children:"/chat/completions"}),". Calls go straight from this browser to that host."]}),o&&i.jsxs(le,{variant:"destructive",children:[i.jsx(ce,{children:"A local server won't work from this URL"}),i.jsx(me,{children:o})]})]}),i.jsxs("div",{className:"field",children:[i.jsx(Ge,{htmlFor:"endpoint-model",children:"Model"}),i.jsxs("div",{className:"endpoint-model-row",children:[i.jsxs(Sn,{value:e.endpointModel,onValueChange:e.setEndpointModel,disabled:e.status==="connecting"||e.endpointModelsStatus==="loading"||e.endpointModels.length===0,children:[i.jsx(Bn,{id:"endpoint-model",className:"endpoint-model-select",children:i.jsx(Rn,{placeholder:e.endpointModelsStatus==="loading"?"Loading models…":e.endpointModelsStatus==="idle"?"Enter an endpoint above":e.endpointModelsStatus==="error"?"No models — check the endpoint":e.endpointModels.length===0?"No models served":"Select a model"})}),i.jsx(Cn,{children:e.endpointModels.map(v=>i.jsx(In,{value:v,children:v},v))})]}),i.jsx(Q,{size:"sm",variant:"secondary",onClick:()=>void e.listEndpointModels(),disabled:e.status==="connecting"||e.endpointModelsStatus==="loading"||e.endpointUrl.trim()===""||o!==null,children:e.endpointModelsStatus==="loading"?"Refreshing…":"Refresh"})]}),i.jsxs("p",{className:"field-hint",children:["Fetched from the endpoint's ",i.jsx("code",{children:"/models"}),". Tiny models (e.g. SmolLM2) usually can't follow the tool-calling format — prefer ",i.jsx("code",{children:"llama3.2:3b"}),", ",i.jsx("code",{children:"qwen2.5"})," or larger."]}),e.endpointModelsStatus==="error"&&!o&&i.jsxs(le,{variant:"destructive",children:[i.jsx(ce,{children:"Couldn't list models"}),i.jsx(me,{children:e.endpointModelsError})]})]}),i.jsxs("div",{className:"field",children:[i.jsx(Ge,{htmlFor:"endpoint-key",children:s==="ollama"?"API key (optional)":"API key"}),i.jsx(Xn,{id:"endpoint-key",type:"password",value:e.apiKey,onChange:v=>e.setApiKey(v.target.value),disabled:e.status==="connecting"}),i.jsx("p",{className:"field-hint",children:s==="ollama"?"A local Ollama ignores this — leave it blank.":"Sent as a bearer token to the endpoint above, from this browser only. It's held in memory for this tab, never stored or logged, and cleared if the endpoint moves between a local and a remote host."})]})]}),e.kind!=="scripted"&&i.jsxs("div",{className:"brain-actions",children:[i.jsx(Q,{size:"sm",onClick:()=>void e.connect(),disabled:e.status==="connecting"||e.kind==="chrome"&&e.chromeAiReason!==null||e.kind==="endpoint"&&(e.endpointUrl.trim()===""||e.endpointModel===""||e.endpointModelsStatus==="loading"||o!==null),children:e.status==="ready"?"Reconnect":"Connect"}),e.status==="connecting"&&(e.kind==="browser"||e.kind==="chrome")&&i.jsx(Q,{size:"sm",variant:"secondary",onClick:e.cancelConnect,children:"Cancel"}),e.progress&&i.jsxs("span",{className:"field-hint",children:[Math.round(e.progress.progress*100),"% —"," ",e.progress.text]})]}),e.progress&&i.jsx("div",{className:"brain-progress",role:"progressbar","aria-valuenow":Math.round(e.progress.progress*100),"aria-valuemin":0,"aria-valuemax":100,children:i.jsx("div",{className:"brain-progress-bar",style:{width:`${Math.round(e.progress.progress*100)}%`}})}),e.error&&i.jsxs(le,{variant:"destructive",children:[i.jsx(ce,{children:"Couldn't connect"}),i.jsx(me,{children:e.error})]})]})}function sr({brain:e}){const n=ft.find(t=>t.kind===e.visionKind);return i.jsxs("div",{className:"brain-section brain-vision",children:[i.jsx(Ge,{children:"Vision (reads the image)"}),i.jsxs("div",{className:"brain-modes",children:[i.jsx("div",{className:"brain-kinds",role:"group","aria-label":"Vision brain",children:ft.map(t=>i.jsx(Q,{size:"sm",variant:e.visionKind===t.kind?"default":"secondary","aria-pressed":e.visionKind===t.kind,onClick:()=>e.setVisionKind(t.kind),children:t.label},t.kind))}),i.jsxs("div",{className:"brain-status",children:[e.visionStatus==="ready"&&e.visionKind==="browser-vision"&&i.jsx(te,{variant:"success",className:"brain-status-badge",children:e.visionModelInUse??"connected"}),e.visionStatus==="connecting"&&i.jsx(te,{variant:"info",className:"brain-status-badge",children:"connecting…"}),e.visionStatus==="error"&&i.jsx(te,{variant:"danger",className:"brain-status-badge",children:"not connected"})]})]}),i.jsx("p",{className:"field-hint",children:n.hint}),e.visionKind==="scripted-vision"&&e.webgpu===!1&&e.visionWebgpuReason&&i.jsxs(le,{variant:"destructive",children:[i.jsx(ce,{children:"No WebGPU in this browser"}),i.jsx(me,{children:e.visionWebgpuReason})]}),e.visionKind==="browser-vision"&&i.jsxs("div",{className:"brain-config",children:[i.jsxs("div",{className:"field",children:[i.jsx(Ge,{htmlFor:"vision-model",children:"Model"}),i.jsxs(Sn,{value:e.visionModel,onValueChange:e.setVisionModel,disabled:e.visionStatus==="connecting",children:[i.jsx(Bn,{id:"vision-model",children:i.jsx(Rn,{})}),i.jsx(Cn,{children:Ht.map(t=>i.jsx(In,{value:t.id,children:t.label},t.id))})]}),i.jsx("p",{className:"field-hint",children:"Connecting downloads the weights once (size shown above), then caches them — every token is read on your GPU, no server."})]}),e.webgpu===!1&&e.visionWebgpuReason&&i.jsxs(le,{variant:"destructive",children:[i.jsx(ce,{children:"No WebGPU in this browser"}),i.jsx(me,{children:e.visionWebgpuReason})]})]}),e.visionKind==="browser-vision"&&i.jsxs("div",{className:"brain-actions",children:[i.jsx(Q,{size:"sm",onClick:()=>void e.connectVision(),disabled:e.visionStatus==="connecting",children:e.visionStatus==="ready"?"Reconnect":"Connect"}),e.visionStatus==="connecting"&&i.jsx(Q,{size:"sm",variant:"secondary",onClick:e.cancelVisionConnect,children:"Cancel"}),e.visionProgress&&i.jsxs("span",{className:"field-hint",children:[Math.round(e.visionProgress.progress*100),"% —"," ",e.visionProgress.text]})]}),e.visionError&&i.jsxs(le,{variant:"destructive",children:[i.jsx(ce,{children:"Couldn't connect the vision brain"}),i.jsx(me,{children:e.visionError})]})]})}function dr({imageInput:e,value:n,onSelect:t,disabled:o=!1}){const[r,s]=b.useState(null),[d,c]=b.useState(!1),m=b.useRef(null),a=b.useId(),p=b.useId(),u=b.useCallback(f=>{s(URL.createObjectURL(f)),t({imageName:f.name,pixels:f})},[t]);b.useEffect(()=>{if(r)return()=>URL.revokeObjectURL(r)},[r]);const g=b.useCallback(f=>{const k=f==null?void 0:f[0];k&&k.type.startsWith("image/")&&u(k)},[u]),h=(n==null?void 0:n.imageId)!=null?e.seedImages.find(f=>f.id===n.imageId):void 0;return i.jsxs("div",{className:"image-input",children:[e.label&&i.jsx("p",{className:"field-hint",children:e.label}),i.jsx("p",{className:"image-input-label",id:a,children:"Seed photos"}),i.jsx("div",{className:"image-gallery",role:"group","aria-labelledby":a,children:e.seedImages.map(f=>{const k=(n==null?void 0:n.imageId)===f.id;return i.jsxs("button",{type:"button","aria-pressed":k,className:`image-thumb${k?" image-thumb--selected":""}`,disabled:o,title:f.label??f.id,onClick:()=>{s(null),m.current&&(m.current.value=""),t({imageId:f.id,pixels:f.file})},children:[i.jsx("img",{src:f.thumb??f.file,alt:f.label??f.id}),f.label&&i.jsx("span",{children:f.label})]},f.id)})}),i.jsx("label",{className:"image-input-label",htmlFor:p,children:"Or upload your own photo"}),i.jsxs("div",{className:`image-drop${d?" image-drop--over":""}`,onDragOver:f=>{f.preventDefault(),o||c(!0)},onDragLeave:()=>c(!1),onDrop:f=>{f.preventDefault(),c(!1),o||g(f.dataTransfer.files)},children:[i.jsx("input",{ref:m,id:p,type:"file",accept:"image/*",disabled:o,onChange:f=>g(f.target.files)}),i.jsx("p",{className:"field-hint",children:"Drag a photo here, or pick one. Uploading a photo the model has never seen is the proof this runs for real — nothing leaves your browser."})]}),(r||h)&&i.jsxs("div",{className:"image-preview",children:[i.jsx("img",{src:r??(h==null?void 0:h.file),alt:r?(n==null?void 0:n.imageName)??"uploaded photo":(h==null?void 0:h.label)??(h==null?void 0:h.id)??"selected photo"}),i.jsx("span",{className:"field-hint",children:r?`Uploaded: ${(n==null?void 0:n.imageName)??"your photo"}`:`Selected: ${(h==null?void 0:h.label)??(h==null?void 0:h.id)}`}),i.jsx("button",{type:"button",className:"image-clear-btn",disabled:o,onClick:()=>{s(null),m.current&&(m.current.value=""),t(null)},children:"Clear"})]})]})}function Kt(e){return typeof e=="object"&&e!==null}function xl(e){const n=new Set,t=o=>{Kt(o)&&(typeof o.key=="string"&&n.add(o.key),Array.isArray(o.components)&&o.components.forEach(t))};return t(e),n}function lr(e){const n={},t=o=>{Kt(o)&&(typeof o.key=="string"&&"defaultValue"in o&&(n[o.key]=o.defaultValue??""),Array.isArray(o.components)&&o.components.forEach(t))};return t(e),n}const cr="wdf:section:v2:";function Zt(e){return cr+e}function _t(e){try{const n=window.localStorage.getItem(Zt(e));return n==="1"?!0:n==="0"?!1:void 0}catch{return}}function mr(e,n){try{window.localStorage.setItem(Zt(e),n?"1":"0")}catch{}}function zn(e,n=!0){const[t,o]=b.useState(()=>_t(e)??n);b.useEffect(()=>{o(_t(e)??n)},[e,n]);const r=b.useCallback(s=>{o(s),mr(e,s)},[e]);return[t,r]}function Oe({sectionId:e,title:n,description:t,defaultOpen:o=!0,className:r,children:s,...d}){const[c,m]=zn(e,o);return i.jsx(so,{className:["panel",r].filter(Boolean).join(" "),"data-tour":d["data-tour"],children:i.jsxs(lo,{open:c,onOpenChange:m,children:[i.jsxs(co,{className:"panel-trigger",children:[i.jsxs("span",{className:"panel-trigger-text",children:[i.jsx("span",{className:"panel-title",children:n}),t!=null&&i.jsx("span",{className:"panel-desc",children:t})]}),i.jsx(mo,{className:"panel-chevron","aria-hidden":!0})]}),i.jsx(po,{children:i.jsx(uo,{children:s})})]})})}function pr(e){return e.entries!==void 0}function ur(e){const n=[];let t=null;for(const o of e)o.turn!==void 0?t&&t.turn===o.turn?t.entries.push(o):(t={turn:o.turn,entries:[o]},n.push(t)):(t=null,n.push(o));return n}function wt(e){if(e===void 0)return"undefined";try{return JSON.stringify(e)}catch{return"[unserializable value]"}}function hr({activation:e,result:n,labelFor:t}){const o=e.elementId??"";return i.jsxs("div",{className:"timeline-tool",children:[i.jsxs("div",{className:"timeline-tool-head",children:[i.jsx(te,{variant:"info",children:"tool"}),i.jsx("strong",{children:t(o)||o}),i.jsx("code",{children:o})]}),e.args!==void 0&&Object.keys(e.args).length>0&&i.jsxs("div",{className:"timeline-kv",children:[i.jsx("span",{className:"timeline-kv-label",children:"arguments"}),i.jsx("code",{children:wt(e.args)})]}),i.jsxs("div",{className:"timeline-kv",children:[i.jsx("span",{className:"timeline-kv-label",children:"returned"}),i.jsx("code",{children:n?wt(n.result):"— waiting for the job to complete —"})]})]})}function br({group:e,labelFor:n}){const t=e.entries.find(a=>a.kind==="llm"),o=e.entries.filter(a=>a.kind==="agent"&&a.elementId),r=e.entries.filter(a=>a.kind==="vars"&&a.elementId),s=e.entries.filter(a=>a.kind==="agent"&&!a.elementId),d=e.entries.filter(a=>a.kind==="error"),c=new Set(o.map(a=>a.elementId)),m=e.entries.filter(a=>a.kind==="tool"||a.kind==="vars"&&a.elementId&&!c.has(a.elementId)).sort((a,p)=>a.id-p.id);return i.jsxs("div",{className:"timeline-turn",children:[i.jsxs("div",{className:"timeline-turn-head",children:[i.jsxs(te,{variant:t!=null&&t.pending?"warning":"neutral",children:["Turn ",e.turn]}),(t==null?void 0:t.pending)&&i.jsx("span",{className:"timeline-pending",children:"thinking…"})]}),t&&i.jsx("blockquote",{className:"timeline-reply",children:t.text}),s.map(a=>i.jsx("div",{className:"timeline-note",children:a.text},a.id)),o.map(a=>i.jsx(hr,{activation:a,result:r.find(p=>p.elementId===a.elementId),labelFor:n},a.id)),m.map(a=>i.jsxs("div",{className:`log-line log-${a.kind}`,children:[a.pending?"⏳ ":"",a.text]},a.id)),d.map(a=>i.jsxs("div",{className:"timeline-error",children:["⚠ ",a.text]},a.id))]})}function gr({log:e,elementStats:n=[],incidents:t=[],labelFor:o=d=>d,variables:r,hasAgent:s=!1}){const d=b.useMemo(()=>ur(e),[e]),[c,m]=b.useState(!1),[a,p]=zn("engine-view",!1),u=b.useRef(null);b.useEffect(()=>{const h=u.current;h&&(h.scrollTop=h.scrollHeight)},[d]);const g=()=>{var k;const h={log:e.map(({id:v,..._})=>_),elementStats:n,incidents:t},f=JSON.stringify(h,null,2);(k=navigator.clipboard)!=null&&k.writeText&&navigator.clipboard.writeText(f).then(()=>{m(!0),setTimeout(()=>m(!1),1500)}).catch(()=>{})};return i.jsxs(Oe,{sectionId:"activity",className:"grow activity-card",title:s?"Agent activity":"Activity",description:s?"Agent turns, model replies, and tool calls — read top to bottom as a story.":"Every step the engine took — read top to bottom as a story.",children:[i.jsx("div",{className:"timeline-toolbar",children:i.jsx(Q,{variant:"secondary",size:"sm",onClick:g,children:c?"Copied!":"Copy run as JSON"})}),i.jsx("div",{className:"timeline",ref:u,children:d.length===0?i.jsx("div",{className:"log-empty",children:"Press Run or Step to start."}):d.map(h=>pr(h)?i.jsx(br,{group:h,labelFor:o},`turn-${h.turn}-${h.entries[0].id}`):i.jsxs("div",{className:`log-line log-${h.kind}`,children:[h.pending?"⏳ ":"",h.text]},h.id))}),r,(n.length>0||t.length>0)&&i.jsxs("details",{className:"engine-view",open:a,onToggle:h=>p(h.currentTarget.open),children:[i.jsxs("summary",{children:["Element completion",t.length>0&&` · ${t.length} incident${t.length===1?"":"s"}`]}),i.jsxs("div",{className:"timeline-engine-view",children:[n.length>0&&i.jsxs("div",{className:"timeline-stats",children:[i.jsx("span",{className:"timeline-kv-label",children:"Element completion"}),i.jsx("ul",{children:n.filter(h=>h.completed>0||(h.active??0)>0).map(h=>i.jsxs("li",{children:[i.jsx("code",{children:o(h.elementId)||h.elementId})," ","completed ",h.completed,h.active?`, ${h.active} active`:""]},h.elementId))})]}),t.length>0&&i.jsxs("div",{className:"timeline-incidents",children:[i.jsx("span",{className:"timeline-kv-label",children:"Incidents"}),i.jsx("ul",{children:t.map((h,f)=>i.jsxs("li",{children:[i.jsx("code",{children:o(h.elementId)||h.elementId})," —"," ",h.reason]},`${h.elementId}-${f}`))})]})]})]})]})}const Ne={diagram:"diagram",runButton:"run-button",variablesPanel:"variables-panel",codePanel:"code-panel",brainPanel:"brain-panel"};function yt(e){return`[data-tour="${e}"]`}function fr(e=location.search){return new URLSearchParams(e).get("tour")}function _r(e){return"anchor"in e?yt(e.anchor):`${yt(Ne.diagram)} [data-element-id="${wr(e.elementId)}"]`}function wr(e){return typeof CSS<"u"&&typeof CSS.escape=="function"?CSS.escape(e):e.replace(/[^a-zA-Z0-9_-]/g,n=>`\\${n}`)}function yr(e){return e.map(n=>({element:_r(n.target),popover:{title:n.title,description:n.description,showButtons:["next","previous","close"]},disableActiveInteraction:!1,skipMissingElement:n.skipMissingElement??!0}))}async function vr(e){const[{driver:n}]=await Promise.all([be(()=>import("./driver.js-bj_ppY-Q.js"),[]),be(()=>Promise.resolve({}),__vite__mapDeps([0]))]),t=n({steps:yr(e),showProgress:!0,allowClose:!0,skipMissingElement:!0});return t.drive(),{isActive:()=>t.isActive(),destroy:()=>t.destroy()}}const xr=300;function Er(e){const[n,t]=b.useState(!1),o=b.useRef(null),r=b.useRef(null),s=b.useRef(0),d=b.useCallback(()=>{r.current!==null&&(clearInterval(r.current),r.current=null)},[]),c=b.useCallback(()=>{var a;s.current+=1,d(),(a=o.current)==null||a.destroy(),o.current=null,t(!1)},[d]),m=b.useCallback(()=>{if(!e||e.steps.length===0||o.current)return;const a=s.current+=1;vr(e.steps).then(p=>{if(a!==s.current||!p.isActive()){p.destroy();return}o.current=p,t(!0);const u=setInterval(()=>{if(o.current!==p){clearInterval(u);return}p.isActive()||(clearInterval(u),r.current===u&&(r.current=null),o.current=null,t(!1))},xr);r.current=u})},[e,d]);return b.useEffect(()=>c,[c]),{active:n,start:m,stop:c}}function kr(){return typeof window>"u"||!window.matchMedia?!1:window.matchMedia("(prefers-reduced-motion: reduce)").matches}function Nr({enabled:e,ready:n,targetRef:t,start:o}){const r=b.useRef(!1),[s,d]=b.useState(!1),c=b.useRef(o);b.useEffect(()=>{c.current=o},[o]),b.useEffect(()=>{if(!e||r.current)return;const m=t.current;if(!m||typeof IntersectionObserver>"u"){d(!0);return}const a=new IntersectionObserver(p=>{p.some(u=>u.isIntersecting)&&(d(!0),a.disconnect())},{threshold:.01});return a.observe(m),()=>a.disconnect()},[e,t]),b.useEffect(()=>{!e||r.current||!n||!s||kr()||(r.current=!0,c.current())},[e,n,s])}const Be=650,Nn="__agent__",vt="__model__",xt="__template__:";function Pr(e){return e.kind.toLowerCase().includes("boundary")}const Mr=b.lazy(async()=>{await Promise.all([be(()=>Promise.resolve({}),__vite__mapDeps([1])),be(()=>Promise.resolve({}),__vite__mapDeps([2])),be(()=>Promise.resolve({}),__vite__mapDeps([3]))]);const{RuntimeDiagram:e}=await be(async()=>{const{RuntimeDiagram:n}=await import("./RuntimeDiagram-DTnJz5cT.js");return{RuntimeDiagram:n}},__vite__mapDeps([4,5,6]));return{default:e}}),Pn=b.lazy(()=>be(()=>import("./MonacoEditor-C4cphgcG.js").then(e=>e.M),__vite__mapDeps([7,5,8]))),Sr=b.lazy(()=>be(()=>import("./vendor-modeler-BzScQTrW.js"),__vite__mapDeps([9,5,6,10,11,12,13,1,2,3]))),Et=b.lazy(async()=>{const{FormRenderer:e}=await be(async()=>{const{FormRenderer:n}=await import("./FormRenderer-BNfJup3y.js");return{FormRenderer:n}},__vite__mapDeps([14,5,12,10,11,15]));return{default:e}});function mn(e,n){try{return JSON.stringify(e??{},null,n)}catch{return"[unserializable value]"}}function Br(e){const n=mn(e).replace(/\s+/g," ");return n.length>78?`${n.slice(0,78)}…`:n}function Rr({example:e,compact:n=!1,autostart:t=!1,initialBrainKind:o,initialTourId:r}){var Gn,Hn,Jn,Wn,Kn,Zn,Yn,Qn;const[s,d]=b.useState(e.bpmn),c=b.useRef(null),m=Qi(),[a,p]=b.useState(null);b.useEffect(()=>{o&&o!==m.kind&&m.setKind(o)},[]),b.useEffect(()=>{or({brain:m.kind})},[m.kind]);const[u,g]=b.useState(()=>Object.fromEntries(e.handlers.map(w=>[w.elementId,w.source]))),[h,f]=b.useState(e.scriptedAgent??""),[k,v]=b.useState(()=>nn(e.templates)),_=b.useMemo(()=>ei(e,u,s,k),[e,u,s,k]),x=_.model,E=Si({bpmn:_.resolvedBpmn});ji(E.phase==="ready");const V=Er(e.tour);b.useEffect(()=>{var w;r&&((w=e.tour)==null?void 0:w.id)===r&&V.start()},[]);const Z=x.startFormId?((Gn=e.forms)==null?void 0:Gn[x.startFormId])??null:null,[J,ge]=b.useState(()=>({...e.seed,...Z?lr(Z):{}})),[Ce,fe]=b.useState(x.agent?Nn:((Hn=e.handlers[0])==null?void 0:Hn.elementId)??""),Pe=b.useMemo(()=>{const w=(e.scenarios??[]).findIndex(N=>Object.entries(N.variables).every(([S,F])=>JSON.stringify(J[S])===JSON.stringify(F)));return w===-1?null:w},[e.scenarios,J]),[X,_e]=zn(n?"start-compact":"start",n?!1:!!Z),[de,R]=b.useState(!1),[M,P]=b.useState(!1),[j,H]=b.useState(!1),[ye,ze]=b.useState(null),[wn,ve]=b.useState([]),[He,ie]=b.useState({}),Te=b.useMemo(()=>({...e.seed,...J,...Fo(e.imageInput?a:null)}),[e.seed,e.imageInput,J,a]),[tn,yn]=b.useState(null),xe=b.useRef(null),[Fe,Ie]=b.useState({}),[vn,xn]=b.useState(!1),Je=b.useRef(null),ee=b.useRef(!1),G=b.useRef(0),We=b.useRef(0),$e=b.useRef({current:void 0}),Me=b.useRef({}),je=b.useRef({}),Ke=b.useMemo(()=>{const w=new Map;for(const N of x.processes){for(const S of N.tasks)w.set(S.elementId,S.label);for(const S of N.agents){w.set(S.elementId,S.label);for(const F of S.tools)w.set(F.elementId,F.label)}for(const S of N.userTasks)w.set(S.elementId,S.label)}return N=>w.get(N)??N},[x]),O=b.useCallback(w=>{ve(N=>{if(w.key){const S=N.findIndex(F=>F.key===w.key);if(S>=0){const F=[...N];return F[S]={...F[S],...w},F}}return[...N,{...w,id:We.current++}].slice(-80)})},[]),pe=b.useMemo(()=>{var w;return((w=E.snapshot)==null?void 0:w.userTasks.find(N=>N.state==="Created"))??null},[E.snapshot]),Ae=b.useMemo(()=>{const w=x.processes.flatMap(S=>S.tasks),N=new Map;for(const S of e.handlers){if(!S.manualControl)continue;const F=w.find(C=>C.elementId===S.elementId);F&&N.set(F.jobType,{...S.manualControl,elementId:S.elementId})}return N},[e.handlers,x]),Se=b.useMemo(()=>{if(!E.snapshot)return null;for(const w of E.snapshot.jobs){const N=Ae.get(w.jobType);if(N&&w.state==="Created")return{job:w,control:N}}return null},[E.snapshot,Ae]),on=b.useMemo(()=>{if(!x.agent||!E.snapshot)return[];const w=new Map(E.snapshot.elementStats.map(N=>[N.elementId,N.completed]));return x.agent.tools.filter(N=>(w.get(N.elementId)??0)===0)},[x.agent,E.snapshot]),re=pe?x.userTasks.find(w=>w.elementId===pe.elementId):void 0,Ue=re!=null&&re.formId?((Jn=e.forms)==null?void 0:Jn[re.formId])??null:null,Ve=b.useCallback(async(w,N,S,F)=>{var ue,ae,se;let C=S,we=0;for(;G.current===F&&C&&C.completedInstances<1&&we++<80;){const K=await E.stepWorkers(w,{agents:N});if(G.current!==F)return C;C=(K==null?void 0:K.snapshot)??C;const q=(ue=C.instances[0])==null?void 0:ue.variables;if(q&&ie({...q}),C.userTasks.some(D=>D.state==="Created")){O({kind:"human",text:"⏸ waiting for a human — complete the task below to continue"});break}if(!K){O({kind:"error",text:"▶ run stopped — no dispatch round was returned"});break}if(K.handled===0){const D=C.messageSubscriptions.find(L=>!Pr(L));if(K.reason==="messages"&&D){if(O({kind:"step",text:`⏳ parked on a message catch event — waiting for "${D.messageName}"`,elementId:D.elementId}),await new Promise(oe=>setTimeout(oe,Be)),G.current!==F)return C;O({kind:"vars",text:`📨 correlating message "${D.messageName}" (key: ${D.correlationKey})`,elementId:D.elementId});const L=E.correlateMessage(D.messageName,D.correlationKey,"{}");if(L){C=L;const oe=(ae=C.instances[0])==null?void 0:ae.variables;oe&&ie({...oe}),await new Promise(he=>setTimeout(he,Be));continue}O({kind:"error",text:`▶ run stopped — correlating "${D.messageName}" (key: ${D.correlationKey}) failed`,elementId:D.elementId})}if(K.reason==="signals"&&C.signalSubscriptions.length>0){const L=C.signalSubscriptions[0],oe=C.signalSubscriptions.length;if(O({kind:"step",text:`⏳ parked on ${oe} open signal subscription${oe===1?"":"s"} — waiting for "${L.signalName}"`,elementId:L.elementId}),await new Promise(qe=>setTimeout(qe,Be)),G.current!==F)return C;const he=E.broadcastSignal(L.signalName,"{}");if(he){C=he,O({kind:"vars",text:`📡 broadcasting signal "${L.signalName}" — every waiting subscription unblocks`,elementId:L.elementId});const qe=(se=C.instances[0])==null?void 0:se.variables;qe&&ie({...qe}),await new Promise(oo=>setTimeout(oo,Be));continue}O({kind:"error",text:`▶ run stopped — broadcasting signal "${L.signalName}" failed`,elementId:L.elementId})}if(K.reason==="timers"){const L=C.timers.reduce((oe,he)=>Math.min(oe,he.dueInMs),1/0);if(Number.isFinite(L)){if(O({kind:"step",text:`⏳ parked on a timer — ${(Math.max(L,0)/1e3).toFixed(1)}s left on the clock`}),await new Promise(he=>setTimeout(he,Be)),G.current!==F)return C;const oe=E.advanceTime(Math.max(L,0)+1);if(oe){C=oe,O({kind:"step",text:"🕐 the clock advanced — timer fired"}),await new Promise(he=>setTimeout(he,Be));continue}}}break}await new Promise(D=>setTimeout(D,Be))}return G.current!==F||(C&&C.completedInstances>=1?O({kind:"done",text:"✅ process instance completed"}):C&&C.incidentElementIds.length>0&&O({kind:"error",text:"A job failed — incident on the diagram"})),C},[E,O]),B=b.useCallback(async w=>{var C,we,ue,ae;if(!Se||ee.current)return;const{job:N,control:S}=Se,F=++G.current;ee.current=!0,P(!0);try{let se,K;if(w==="complete")se=E.completeJobManually(N.jobType,"{}"),K="  ↳ completed normally";else if(S.action.kind==="timer"){const q=((we=(C=E.snapshot)==null?void 0:C.timers[0])==null?void 0:we.dueInMs)??0;se=E.advanceTime(Math.max(q,0)+1),K="  ↳ advanced the clock — timer fired"}else if(S.action.kind==="message"){const{messageName:q}=S.action,D=(ue=E.snapshot)==null?void 0:ue.messageSubscriptions.find(L=>L.messageName===q);if(!D){O({kind:"error",text:`  ↳ no open subscription for "${q}" to correlate against`,elementId:N.elementId});return}se=E.correlateMessage(q,D.correlationKey,"{}"),K=`  ↳ published "${q}" (key: ${D.correlationKey})`}else{const{errorCode:q,message:D}=S.action;se=E.throwJobError(N.jobType,q,D),K=`  ↳ threw BPMN error ${q}: ${D}`}if(se){O({kind:"vars",text:K,elementId:N.elementId});const q=(ae=se.instances[0])==null?void 0:ae.variables;q&&ie({...q}),await new Promise(D=>setTimeout(D,Be)),await Ve(Me.current,je.current,se,F)}else O({kind:"error",text:"  ↳ failed to resolve the manual job",elementId:N.elementId})}finally{G.current===F&&(ee.current=!1,P(!1))}},[Se,E,O,Ve]),W=b.useCallback(async()=>{var K;let w=null;try{x.agent&&h.trim()&&(w=Vo(h))}catch(q){return ze(q instanceof Error?q.message:String(q)),null}$e.current={current:void 0};let N;if(e.imageInput){const q=m.vision;N={read:q??Zi(e.scriptedVision).read,live:!!q,resolve:L=>E.getRunImage(L)}}const S=Ho(x,_.handlers,O,$e.current,N);for(const q of Ae.keys())delete S[q];const F={};if(x.agents.length>0)if(m.kind!=="scripted"&&m.chat){const D=new Map;for(const L of x.agents)D.set(L.jobType,[...D.get(L.jobType)??[],L]);for(const[L,oe]of D)F[L]=li(oe,m.chat,O,{turnRef:$e.current,requiredTools:e.requiredTools})}else w&&x.agent&&(F[x.agent.jobType]=async D=>{const L=await w(D),oe=(L.activateElements??[]).map(qe=>qe.elementId).join(", "),he=x.agents.length>1?` (${D.elementId})`:"";return O({kind:"agent",text:L.completionConditionFulfilled?`🤖 scripted agent${he}: done`:`🤖 scripted agent${he}: calling ${oe||"(nothing)"}`}),L});ve([]),Ie({});const C=Te;ie(C),Me.current=S,je.current=F;const we=await E.redeploy(s),ue=(we==null?void 0:we[0])??x.processId;O({kind:"start",text:`Starting "${ue}" — ${x.agent?m.kind==="scripted"||!m.chat?"scripted brain":`live brain (${m.modelInUse??m.kind})`:"no agent in this model"}`});let ae;if(x.startMessage){const{messageName:q,correlationKey:D}=x.startMessage,L=Ao(D,C);O({kind:"step",text:`📨 publishing "${q}" (key: ${L}) — a message start event has no other way in`,elementId:x.startMessage.elementId}),ae=E.correlateMessage(q,L,JSON.stringify(C))}else ae=E.createInstance(ue,JSON.stringify(C));const se=(K=ae==null?void 0:ae.instances[0])==null?void 0:K.key;return e.imageInput&&a&&se&&E.setRunImage(se,a),{workers:S,agents:F,snap:ae}},[E,e,_,s,h,J,a,Te,x,m,O,Ae]),T=!!E.snapshot&&E.snapshot.completedInstances<1,Y=!T&&!!Z&&tn!==!0,ke=!T&&!!Z&&tn===!1,De=X||de;b.useEffect(()=>{n&&ke&&R(!0)},[n,ke]);const Un=w=>{_e(w),w||R(!1)},Vn=b.useCallback(async()=>{if(E.phase!=="ready"||ee.current||j||_.hasErrors)return;ee.current=!0,P(!0);const w=++G.current;try{let N=Me.current,S=je.current,F=E.snapshot;if(!T){if(xe.current&&!xe.current.validate())return;ze(null);const C=await W();if(!C)return;N=C.workers,S=C.agents,F=C.snap,await new Promise(we=>setTimeout(we,Be))}await Ve(N,S,F,w)}finally{G.current===w&&(ee.current=!1,P(!1))}},[E,j,_.hasErrors,T,W,Ve]),qn=E.phase==="ready"&&!M&&!j&&!_.hasErrors&&!Y;Nr({enabled:t,ready:qn,targetRef:c,start:()=>void Vn()});const Qt=b.useCallback(async()=>{var N;if(E.phase!=="ready"||ee.current||j||_.hasErrors)return;ee.current=!0,H(!0);const w=++G.current;try{let S=Me.current,F=je.current,C=E.snapshot;if(!T){if(xe.current&&!xe.current.validate())return;ze(null);const K=await W();if(!K)return;S=K.workers,F=K.agents,C=K.snap}if(!C||C.completedInstances>=1)return;const we=C.takenSequenceFlows.length,ue=await E.stepWorkers(S,{agents:F});if(!ue){O({kind:"error",text:"⏭ step failed — no dispatch round was returned"});return}const ae=(N=ue.snapshot.instances[0])==null?void 0:N.variables;ae&&ie({...ae});const se=Di(ue.snapshot.takenSequenceFlows,we);O(Li(ue,se,Ke,Ae))}finally{G.current===w&&(ee.current=!1,H(!1))}},[E,j,_.hasErrors,T,W,O,Ke,Ae]),Xt=b.useCallback(async()=>{ee.current=!1,G.current++,P(!1),H(!1),ee.current=!0;try{await E.reset()}finally{ee.current=!1}ve([]),ie({})},[E]),eo=b.useCallback(()=>{var S;if(!pe||Je.current&&!Je.current.validate())return;const w=E.completeUserTask(pe.key,JSON.stringify(Fe));O({kind:"human",text:`👤 ${mn(Fe)}`});const N=(S=w==null?void 0:w.instances[0])==null?void 0:S.variables;ie(F=>({...F,...Fe,...N??{}})),w&&w.completedInstances>=1&&O({kind:"done",text:"✅ process instance completed"})},[pe,Fe,E,O]),no=b.useMemo(()=>{var w,N;return E.phase==="loading"?i.jsx(te,{variant:"neutral",children:"Booting engine…"}):E.phase==="error"?i.jsx(te,{variant:"danger",children:"Engine error"}):M?i.jsx(te,{variant:"info",children:"Running…"}):j?i.jsx(te,{variant:"info",children:"Stepping…"}):(((w=E.snapshot)==null?void 0:w.incidentElementIds.length)??0)>0?i.jsx(te,{variant:"danger",children:"Incident"}):pe?i.jsx(te,{variant:"warning",children:"Waiting for a human"}):(((N=E.snapshot)==null?void 0:N.completedInstances)??0)>=1?i.jsx(te,{variant:"success",children:"Completed"}):E.snapshot?i.jsx(te,{variant:"warning",children:"Paused"}):i.jsx(te,{variant:"neutral",children:"Ready"})},[E.phase,E.snapshot,M,j,pe]),to=b.useMemo(()=>e.blurb.split(/\n\s*\n/).map(w=>w.trim()).filter(Boolean),[e.blurb]);return i.jsxs("div",{className:"runner",ref:c,children:[n?i.jsx("h1",{className:"visually-hidden",children:e.title}):i.jsxs("section",{className:"intro",children:[i.jsx("h1",{children:e.title}),to.map(w=>i.jsx("p",{children:w},w))]}),e.imageInput&&i.jsx(dr,{imageInput:e.imageInput,value:a,onSelect:p,disabled:M}),i.jsxs("div",{className:"scenario",children:[i.jsx("span",{className:"scenario-label",id:"scenario-label",children:e.scenariosLabel??"Example input"}),e.scenarios&&i.jsx("div",{className:"scenario-toggle",role:"group","aria-labelledby":"scenario-label",children:e.scenarios.map((w,N)=>i.jsx(Q,{size:"sm",variant:N===Pe?"default":"secondary","aria-pressed":N===Pe,disabled:M,onClick:()=>ge(S=>({...S,...w.variables})),children:w.label},w.label))}),i.jsxs("button",{type:"button",className:"scenario-input-button",onClick:()=>Un(!De),"aria-expanded":De,"aria-controls":"start-input-editor",title:"Edit the starting payload",children:[i.jsx("span",{className:"scenario-edit-icon","aria-hidden":!0,children:"✎"})," ","input: ",i.jsx("code",{children:Br(J)})]}),Y&&i.jsx("span",{className:"scenario-hint",children:"Fill in the input to enable Run"})]}),i.jsxs("div",{className:"inline-input-editor",id:"start-input-editor",hidden:!De,children:[i.jsxs("div",{className:"inline-input-editor-head",children:[i.jsxs("div",{children:[i.jsx("div",{className:"inline-input-editor-title",children:x.startFormId?"Start form":"Start payload"}),i.jsx("div",{className:"inline-input-editor-copy",children:x.startFormId?`Rendered from the model's start form "${x.startFormId}".`:"The variables the instance starts with."})]}),i.jsx(Q,{size:"sm",variant:"secondary",onClick:()=>Un(!1),children:"Done"})]}),Z?i.jsx(b.Suspense,{fallback:i.jsx("div",{className:"form-fallback",children:"Loading form…"}),children:i.jsx(Et,{ref:xe,schema:Z,values:J,onChange:(w,N)=>ge(S=>({...S,[w]:N})),disabled:M,onValidityChange:yn})}):i.jsx("pre",{className:"vars",children:mn(J,2)})]}),!n&&(x.agent||e.imageInput)&&i.jsx(Oe,{sectionId:"brain",className:"brain-card","data-tour":Ne.brainPanel,title:"Agent brain",description:x.agent?`What drives “${x.agent.label}”. The model recommends; the process governs.`:"What reads the image. The model recommends; the process governs.",children:i.jsx(rr,{brain:m,showText:!!x.agent,showVision:!!e.imageInput})}),i.jsxs("div",{className:"controls",children:[i.jsx(Q,{"data-tour":Ne.runButton,onClick:()=>void Vn(),disabled:!qn,children:"▶ Run"}),i.jsx(Q,{variant:"secondary",onClick:()=>void Qt(),disabled:E.phase!=="ready"||M||j||_.hasErrors||Y||(((Wn=E.snapshot)==null?void 0:Wn.completedInstances)??0)>=1,children:"⏭ Step"}),i.jsx(Q,{variant:"secondary",onClick:()=>void Xt(),disabled:E.phase!=="ready"||j,children:"↺ Reset"}),e.tour&&i.jsx(Q,{variant:"secondary",onClick:V.start,disabled:V.active,children:V.active?"Touring…":`🧭 ${e.tour.label}`}),no]}),E.phase==="error"&&i.jsxs(le,{variant:"destructive",children:[i.jsx(ce,{children:"Engine error"}),i.jsx(me,{children:E.error})]}),ye&&i.jsxs(le,{variant:"destructive",children:[i.jsx(ce,{children:"Code didn't compile"}),i.jsx(me,{children:ye})]}),_.hasErrors&&i.jsxs(le,{variant:"destructive",children:[i.jsx(ce,{children:"Run is disabled — the diagram has unresolved references"}),i.jsx(me,{children:i.jsx("ul",{className:"diagnostics",children:_.diagnostics.filter(w=>w.severity==="error").map((w,N)=>i.jsx("li",{children:w.message},N))})})]}),!_.hasErrors&&_.diagnostics.length>0&&i.jsxs(le,{children:[i.jsx(ce,{children:"Heads up"}),i.jsx(me,{children:i.jsx("ul",{className:"diagnostics",children:_.diagnostics.map((w,N)=>i.jsx("li",{children:w.message},N))})})]}),i.jsxs("div",{className:"grid",children:[i.jsxs("div",{className:"col",children:[i.jsx(Oe,{sectionId:"process","data-tour":Ne.diagram,title:"Process",description:`${x.processName} — live token (green), incidents (red).`,children:i.jsx(b.Suspense,{fallback:i.jsx("div",{className:"diagram-fallback",children:E.phase==="loading"?"Booting the engine…":"Loading diagram…"}),children:i.jsx(Mr,{xml:_.resolvedBpmn,activeIds:((Kn=E.snapshot)==null?void 0:Kn.activeElementIds)??[],incidentIds:((Zn=E.snapshot)==null?void 0:Zn.incidentElementIds)??[],className:"diagram"})})}),pe&&i.jsxs(Oe,{sectionId:"human-task",title:(re==null?void 0:re.label)??"Human task",description:Ue?`Rendered from the model's form "${re==null?void 0:re.formId}".`:"This task has no linked form — complete it with no variables.",children:[on.length>0&&i.jsxs(le,{variant:"destructive",children:[i.jsx(ce,{children:"The agent didn't finish its checks"}),i.jsxs(me,{children:["It completed without running"," ",on.map(w=>w.label||w.elementId).join(", "),". The process took the default path to this task, so the findings below have no value to report."]})]}),Ue&&i.jsx(b.Suspense,{fallback:i.jsx("div",{className:"form-fallback",children:"Loading form…"}),children:i.jsx(Et,{ref:Je,schema:Ue,values:Fe,onChange:(w,N)=>Ie(S=>({...S,[w]:N})),context:He,onValidityChange:xn})}),i.jsx(Q,{onClick:eo,disabled:!!Ue&&!vn,children:"Complete task"})]}),Se&&i.jsx(Oe,{sectionId:"manual-job",title:Se.control.label,description:"This job is held here on purpose — pick how it resolves.",children:i.jsxs("div",{className:"controls",children:[i.jsx(Q,{onClick:()=>void B("complete"),disabled:M||j,children:Se.control.completeLabel??"✅ Complete normally"}),i.jsx(Q,{variant:"secondary",onClick:()=>void B("action"),disabled:M||j,children:Se.control.action.label})]})})]}),i.jsx("div",{className:"col",children:i.jsx(gr,{log:wn,elementStats:(Yn=E.snapshot)==null?void 0:Yn.elementStats,incidents:(Qn=E.snapshot)==null?void 0:Qn.incidents,labelFor:Ke,hasAgent:!!x.agent,variables:i.jsxs("div",{className:"vars-block","data-tour":Ne.variablesPanel,children:[i.jsx("div",{className:"vars-head",children:"Instance variables"}),i.jsx("pre",{className:"vars",children:mn(Object.keys(He).length>0?He:Te,2)})]})})})]}),!n&&i.jsxs("div",{className:"runner-secondary",children:[i.jsx(Oe,{sectionId:"code",className:"editors","data-tour":Ne.codePanel,defaultOpen:!1,title:"Code",description:"One handler per BPMN element, plus a model tab holding the editable diagram — select an element there to edit its properties. Return variables to merge, or throw to fail the job.",children:i.jsx(b.Suspense,{fallback:i.jsx("div",{className:"editor-fallback",children:"Loading editor…"}),children:i.jsxs(ho,{value:Ce,onValueChange:fe,children:[i.jsxs(bo,{children:[i.jsx(rn,{value:vt,children:"model"}),x.agent&&i.jsx(rn,{value:Nn,children:"agent (scripted)"}),e.handlers.map(w=>{var N;return i.jsx(rn,{value:w.elementId,children:((N=x.tasks.find(S=>S.elementId===w.elementId))==null?void 0:N.label)??w.elementId},w.elementId)}),Object.keys(k).map(w=>i.jsx(rn,{value:xt+w,children:w},w))]}),i.jsxs(an,{value:vt,children:[i.jsxs("div",{className:"editor-meta",children:[i.jsx("strong",{children:"Model"}),i.jsx("code",{children:"click an element to edit its properties on the right — Run re-reads whatever you leave here"}),i.jsx(Q,{variant:"secondary",size:"sm",onClick:()=>d(e.bpmn),disabled:s===e.bpmn,children:"Revert to original"})]}),i.jsx(Sr,{value:s,onChange:d})]}),x.agent&&i.jsxs(an,{value:Nn,children:[i.jsxs("div",{className:"editor-meta",children:[i.jsx("strong",{children:x.agent.label}),i.jsx("code",{children:m.kind==="scripted"||!m.chat?"in use":"unused — a live brain is connected"})]}),i.jsx("div",{className:"editor-wrap",children:i.jsx(Pn,{height:"360px",defaultLanguage:"javascript",value:h,onChange:w=>f(w??""),options:Mn})})]}),e.handlers.map(w=>{var N;return i.jsxs(an,{value:w.elementId,children:[i.jsxs("div",{className:"editor-meta",children:[i.jsx("strong",{children:((N=x.tasks.find(S=>S.elementId===w.elementId))==null?void 0:N.label)??w.elementId}),i.jsx("code",{children:w.standsInFor??w.elementId})]}),i.jsx("div",{className:"editor-wrap",children:i.jsx(Pn,{height:"360px",defaultLanguage:"javascript",value:u[w.elementId],onChange:S=>g(F=>({...F,[w.elementId]:S??""})),options:Mn})})]},w.elementId)}),Object.keys(k).map(w=>i.jsxs(an,{value:xt+w,children:[i.jsxs("div",{className:"editor-meta",children:[i.jsx("strong",{children:w}),i.jsxs("code",{children:["prompt / template text — substitutes"," ","{{"+w+"}}"]})]}),i.jsx("div",{className:"editor-wrap",children:i.jsx(Pn,{height:"360px",defaultLanguage:"markdown",value:k[w],onChange:N=>v(S=>nn(S,{[w]:N??""})),options:Mn})})]},w))]})})}),x.agent&&i.jsx(Oe,{sectionId:"tools",defaultOpen:!1,title:"Tools, as the model sees them",description:i.jsxs(i.Fragment,{children:["Read from the diagram — element name, documentation, and every",i.jsx("code",{children:" fromAi(…)"})," argument."]}),children:i.jsx("ul",{className:"tool-list",children:x.agent.tools.map(w=>i.jsxs("li",{children:[i.jsx("code",{children:w.elementId}),i.jsxs("span",{children:[" — ",w.documentation||w.label]}),w.args.length>0&&i.jsx("ul",{children:w.args.map(N=>i.jsxs("li",{children:[i.jsxs("code",{children:[N.name,": ",N.type]})," ","— ",N.description]},N.name))})]},w.elementId))})})]})]})}const Mn={minimap:{enabled:!1},fontSize:13,scrollBeyondLastLine:!1,tabSize:2,automaticLayout:!0},Cr=`<?xml version="1.0" encoding="UTF-8"?>\r
...
}`,Wr={id:"learn-multi-instance-parallel",title:"Parallel multi-instance",group:"learn-bpmn",blurb:["A multi-instance activity runs its task once per element of a collection, spawning that many job instances of the same element in parallel, and only lets the token move on once every one of them completes.",`Run this and watch three 'Process item' jobs activate together for apple, banana, cherry, and complete (in any order) before the process reaches its end event. Nothing about the diagram says "three" — that comes from the collection, so use the buttons in the Start panel on the right to swap between one, three, and six items and hit Run again; the Activity panel logs one 'Process item' line per element, so the fan-out is right there to count.`,'The property tying the two together is in the Code panel: open the model tab, click "Process item", and expand Multi-instance in the properties panel on the right — Input collection holds `items`, the FEEL expression naming the variable to fan out over. Drop it entirely and the activity silently degenerates to a single ordinary instance, with no error to tell you it happened. Revert to original puts it back.'].join(`

`),docsUrl:"https://docs.camunda.io/docs/components/modeler/bpmn/multi-instance/",bpmn:Hr,seed:{items:["apple","banana","cherry"]},scenarios:[{label:"One item — a single instance",variables:{items:["apple"]}},{label:"Three items — fans out to three",variables:{items:["apple","banana","cherry"]}},{label:"Six items — fans out to six",variables:{items:["apple","banana","cherry","damson","elderberry","fig"]}}],handlers:[{elementId:"Activity_process",standsInFor:"job worker — process-item",source:Jr}]},Kr=Object.freeze(Object.defineProperty({__proto__:null,default:Wr},Symbol.toStringTag,{value:"Module"})),Zr=`<?xml version="1.0" encoding="UTF-8"?>\r
...
`),docsUrl:"https://docs.camunda.io/docs/components/modeler/bpmn/service-tasks/",bpmn:Zr,seed:{item:"camunda-t-shirt"},handlers:[{elementId:"Activity_prepare",standsInFor:"job worker — prepare-package",source:Yr},{elementId:"Activity_dispatch",standsInFor:"job worker — dispatch-courier",source:Qr}]},ea=Object.freeze(Object.defineProperty({__proto__:null,default:Xr},Symbol.toStringTag,{value:"Module"})),na=`<?xml version="1.0" encoding="UTF-8"?>\r
...
`,ma="Camunda Cloud",pa="8.10.0",ua={name:"Camunda Web Modeler",version:"9b5d5ef"},ha=19,ba="learn-user-task-form-review",ga=[{text:`# Review request
...
`,xa=`Please verify export compliance for this shipment and notify the team of your decision.\r
`,Ea={id:"compliance-walkthrough",label:"Take the tour",steps:[{title:"Start a run",description:"Press Run to send a shipment through the compliance agent.",target:{anchor:Ne.runButton}},{title:"The agent picks its own tools",description:"This AI Agent reads the shipment notes and decides, turn by turn, which of the tools below it to call — nothing here is hard-coded into a fixed sequence.",target:{elementId:"ComplianceCheckAgent"}},{title:"Watch the token move",description:"The agent's first move is to look up the genetic marker mentioned in the notes.",target:{elementId:"VerifyGeneticMarker"}},{title:"A cleared shipment notifies the export team",description:"Once the compliance score comes back clean, the process notifies the export team automatically — no human review needed for this scenario.",target:{elementId:"NotifyExportTeam"}},{title:"Everything the run recorded",description:"The variables panel shows the marker record, the country lookup, the compliance score, and the final decision — exactly what each tool and the agent wrote along the way.",target:{anchor:Ne.variablesPanel}}]},ka=`<?xml version="1.0" encoding="UTF-8"?>
...
}`,Za={id:"seed-export-compliance",title:"Seed export compliance agent",blurb:"An AI agent picks its own tools to check a shipment, then a gateway routes on its decision — cleared shipments notify the export team, flagged ones go to a human. The LLM recommends; the BPMN process governs.",hero:{headline:"The LLM *recommends*. The process *governs*.",lede:"An agentic ad-hoc sub-process chooses its own compliance checks, but the gateway after it — not the model — decides whether a shipment ships or goes to a human.",tagline:"Anatomy of an enterprise agent"},docsUrl:"https://camunda.com/blog/agentic-ai/",bpmn:ka,forms:{"seed-export-shipment-ready":Ia,"seed-export-compliance-review":za},seed:{scenario:kt,shipmentNotes:""},scenariosLabel:"Example shipment",scenarios:[{label:"Likely cleared (TP53 → Brazil)",variables:{scenario:kt,shipmentNotes:""}},{label:"Likely flagged (BRCA1 → Germany)",variables:{scenario:Va,shipmentNotes:""}}],scriptedAgent:qa,templates:Ua,tour:Ea,requiredTools:["RecordComplianceDecision"],handlers:[{elementId:"VerifyGeneticMarker",standsInFor:"JDBC connector — UCSC hg38",source:Ga},{elementId:"CheckDestinationCountry",standsInFor:"GraphQL connector — countries API",source:Ha},{elementId:"ComputeComplianceScore",standsInFor:"REST connector — api.mathjs.org",source:Ja},{elementId:"RecordComplianceDecision",standsInFor:"Script task — FEEL",source:Wa},{elementId:"NotifyExportTeam",standsInFor:"REST connector — httpbin.io",source:Ka}]},Ya=`You are a loan origination assistant at a retail bank. Your job is to gather everything a senior loan officer needs to decide an application — you do **not** decide it yourself.
...
}`,xs=`async (job, { text, num, sleep, trace }) => {
...
}`,Ms={id:"loan-origination",title:"Loan origination agent",blurb:"An AI agent gathers a loan case with its own tools — customer lookup, credit bureau, an underwriting policy, a status update — then every application passes through a mandatory senior-officer review before a gateway routes it to an offer or a decline. The agent advises; the process governs.",docsUrl:"https://camunda.com/orchestrate/agents/",bpmn:es,forms:{"loan-application":ds,"loan-senior-officer-review":gs},seed:Nt,scenarios:[{label:"Strong applicant (policy recommends approve)",variables:Nt},{label:"Marginal applicant (policy recommends decline)",variables:ws}],scriptedAgent:ys,templates:_s,tour:Xa,requiredTools:["AssessApplication","UpdateApplicationStatus"],handlers:[{elementId:"QueryCustomer",standsInFor:"CRM connector — customer lookup",source:vs},{elementId:"CreditBureauLookup",standsInFor:"REST connector — credit bureau",source:xs},{elementId:"AssessApplication",standsInFor:"Script task — underwriting policy (FEEL)",source:Es},{elementId:"UpdateApplicationStatus",standsInFor:"REST connector — origination system",source:ks},{elementId:"IssueLoanOffer",standsInFor:"REST connector — offer/booking system",source:Ns},{elementId:"SendDeclineNotice",standsInFor:"REST connector — notifications",source:Ps}]},Ss=`<?xml version="1.0" encoding="UTF-8"?>
...
`,Bs=`async (job, { text, sleep }) => {
  ...
  return { shipped: true, tracking: "1Z" + Math.floor(Math.random() * 1e9) };
}`,Is={id:"order-process",title:"Order process with service workers",blurb:"The getting-started order process: check inventory, charge payment, ship. No agent and no human step — the same runner, driven entirely by what's in the diagram.",docsUrl:"https://docs.camunda.io/docs/next/guides/getting-started-orchestration-cluster/",bpmn:Ss,seed:{item:"camunda-t-shirt",quantity:3},handlers:[{elementId:"Activity_0tw2fu0",standsInFor:"job worker — check-inventory",source:Bs},{elementId:"Activity_1ppsbgi",standsInFor:"job worker — charge-payment",source:Rs},{elementId:"Activity_08pg6im",standsInFor:"job worker — ship-items",source:Cs}]},As=`<?xml version="1.0" encoding="UTF-8"?>\r
...
`,Ts=`async (job, { text, num, sleep, trace }) => {
  // The starting variables arrive on 'job.variables'.
...
}`,Fs={id:"rocket-launch",title:"Rocket launch",blurb:"The getting-started rocket launch, boiled down to one service task: launch. The smallest possible example, and the smallest possible test of the framework's extensibility.",bpmn:As,seed:{missionName:"Apollo 11",destination:"the Moon",fuelLevel:100},scenarios:[{label:"Full tanks — launch succeeds",variables:{missionName:"Apollo 11",destination:"the Moon",fuelLevel:100}},{label:"Low fuel — mission scrubbed",variables:{missionName:"Apollo 13",destination:"the Moon",fuelLevel:30}}],handlers:[{elementId:"Activity_LaunchRocket",standsInFor:"job worker — launch-rocket",source:Ts}]},js=`<?xml version="1.0" encoding="UTF-8"?>\r
...
`,Ds=`async (job, { text, sleep }) => {
  ...
  return { shipped: true, tracking: "1Z" + Math.floor(Math.random() * 1e9) };
}`,zs={id:"order-process-boundary-events",title:"Order process with boundary events",blurb:"The getting-started order process, extended with a timer and an error boundary event: charge payment can be declined, and a delayed shipment can escalate — both fired by hand from the runner rather than by chance.",docsUrl:"https://github.com/camunda/camunda-8-get-started/tree/main/2-order-process-with-service-workers",bpmn:js,seed:{item:"camunda-t-shirt",quantity:3},handlers:[{elementId:"Activity_0tw2fu0",standsInFor:"job worker — check-inventory",source:Ds},{elementId:"Activity_1ppsbgi",standsInFor:"job worker — charge-payment",source:Ls,manualControl:{label:"Charge payment method",completeLabel:"✅ Complete normally",action:{kind:"error",errorCode:"CHARGE_DECLINED",message:"The card issuer declined the charge.",label:"❌ Simulate: card declined"}}},{elementId:"Activity_08pg6im",standsInFor:"job worker — ship-items",source:Os,manualControl:{label:"Ship items",completeLabel:"✅ Ship it",action:{kind:"timer",label:"🕐 Fire the shipping-delayed timer"}}}]},$s="/web-demo-framework/pr-preview/pr-121/assets/de-bmw-mini-JBSk7QcF.jpg",Us="/web-demo-framework/pr-preview/pr-121/assets/de-bmw-mini.thumb-CUUmJrRO.jpg",Vs="/web-demo-framework/pr-preview/pr-121/assets/uk-d651-rnb-XGipy2QN.jpg",qs="/web-demo-framework/pr-preview/pr-121/assets/uk-d651-rnb.thumb-mjEcbhUf.jpg",Gs="/web-demo-framework/pr-preview/pr-121/assets/uk-mk70-orj-Cn6O3Xfm.jpg",Hs="/web-demo-framework/pr-preview/pr-121/assets/uk-mk70-orj.thumb-CaeZ2vqU.jpg",Js="/web-demo-framework/pr-preview/pr-121/assets/uk-ni-ijz-8992-YXV44tgk.jpg",Ws="/web-demo-framework/pr-preview/pr-121/assets/uk-ni-ijz-8992.thumb-DYwok8jV.jpg",Ks="/web-demo-framework/pr-preview/pr-121/assets/us-hyundai-genesis-gGpAIEpi.jpg",Zs="/web-demo-framework/pr-preview/pr-121/assets/us-hyundai-genesis.thumb-DEEt19Mw.jpg",Ys=`<?xml version="1.0" encoding="UTF-8"?>
...
`,Rd=[{text:"# Submit an invoice for payment",type:"text",layout:{row:"Row_heading",columns:null},id:"Field_Heading"},{text:`The fields below already hold a clean, matching scenario. To try the others, replace the values with one of these sets before submitting:
...
}`,rl={id:"invoice-payment",title:"Invoice payment approval agent",blurb:"A human-in-the-loop agent: the tool that releases money is a user task inside the agent's own tool loop, so approval is something the agent asks for and reasons about — and payment has exactly one incoming path, from the approved branch. A second, post-hoc sign-off outside the agent sees only what actually happened.",hero:{headline:"The agent can *ask* to pay. Only a human can *approve* it.",lede:"Camunda's human-in-the-loop agent pattern, running here on a wasm engine in your browser. Deny the release in the reviewer form and watch the agent read the denial and change course.",tagline:"Human-in-the-loop agent"},docsUrl:"https://github.com/camunda/camunda-8-tutorials/tree/main/examples/human-in-the-loop-agent",bpmn:Bd,forms:{"invoice-submit":Dd,"payment-release-request":Gd,"compliance-signoff":Xd},seed:Ze,scenariosLabel:"Invoice to review",scenarios:[{label:"Clean match — invoice equals the PO",variables:Ze},{label:"Documented overage — 4.5% over, with a reason",variables:{...Ze,invoiceNumber:"INV-10251",invoiceAmount:4389,invoiceNotes:"Includes pre-approved rush freight surcharge agreed with procurement on 12 Jan."}},{label:"Foreign currency — EUR invoice against a USD PO",variables:{...Ze,invoiceNumber:"INV-10262",invoiceAmount:3860,invoiceCurrency:"EUR",invoiceNotes:"Quarterly office supplies delivery per PO, billed in euros."}},{label:"Vague justification — 7% over, no reason given",variables:{...Ze,invoiceNumber:"INV-10277",invoiceAmount:4494,invoiceNotes:"Additional items supplied."}}],scriptedAgent:el,handlers:[{elementId:"ConvertCurrency",standsInFor:"HTTP connector — api.frankfurter.app exchange rates",source:nl},{elementId:"ReleasePayment",standsInFor:"HTTP connector — accounts-payable payment rail",source:tl},{elementId:"RecordReleaseDenied",standsInFor:"script task — hand the denial back to the agent",source:ol},{elementId:"NotifyVendorDispute",standsInFor:"HTTP connector — vendor dispute notice",source:il}]},al=[Fs,Za,Ms,rl,Is,zs,Sd],sl=Object.assign({"./learn-error-boundary/index.ts":Fr,"./learn-exclusive-gateway/index.ts":$r,"./learn-message-correlation/index.ts":Gr,"./learn-multi-instance-parallel/index.ts":Kr,"./learn-service-task/index.ts":ea,"./learn-signal-broadcast/index.ts":ra,"./learn-timer-catch-event/index.ts":la,"./learn-user-task-form/index.ts":ya}),dl=Object.values(sl).map(e=>e.default).sort((e,n)=>e.id.localeCompare(n.id)),Ye=[...al,...dl];function $n(){return"/web-demo-framework/pr-preview/pr-121/"}function ll(e){const n=$n();return e.startsWith(n)?"/"+e.slice(n.length):e}function cl(e=location.pathname){const t=ll(e).match(/^\/examples\/([^/]+)\/?$/);if(t)try{return{kind:"example",id:decodeURIComponent(t[1])}}catch{return{kind:"gallery"}}return{kind:"gallery"}}function ml(e=location.search){return new URLSearchParams(e).get("embed")==="1"}function pl(e=location.search){return new URLSearchParams(e).get("view")==="compact"?"compact":"full"}function ul(e=location.search){return new URLSearchParams(e).get("autostart")==="1"}function Mt(e){return`${$n()}examples/${encodeURIComponent(e)}`}const St="p";function hl(){const e=new URLSearchParams(location.search),n=e.get(St);if(!n)return!1;const t=n.replace(/[\t\n\r]/g,"");if(!t.startsWith("/")||t.startsWith("//")||t.startsWith("/\\"))return!1;e.delete(St);try{const o=new URL($n(),location.href),r=new URL(t.slice(1),o);return r.origin!==location.origin?!1:(r.search=e.toString(),r.hash=location.hash,history.replaceState(null,"",r),!0)}catch{return!1}}function bl(e,n={}){const t=new URL(location.href);t.pathname=e,t.search=n.search??t.search,n.hash!==void 0&&(t.hash=n.hash),n.replace?history.replaceState(history.state,"",t):history.pushState(history.state,"",t),window.dispatchEvent(new PopStateEvent("popstate"))}function Bt(){return{route:cl(),embed:ml(),view:pl(),autostart:ul()}}function gl(){const[e,n]=b.useState(Bt);return b.useEffect(()=>{const t=()=>n(Bt());return window.addEventListener("popstate",t),()=>window.removeEventListener("popstate",t)},[]),e}const Rt={headline:"The model *runs*. The code is *yours* to edit.",lede:"Every example on this page is a real BPMN process executing in your browser on the nano WebAssembly engine — edit the model, edit the handlers, swap the LLM, and run it again.",tagline:"Runnable Camunda examples"};function fl({text:e}){return i.jsx(i.Fragment,{children:e.split(/\*([^*]+)\*/g).map((n,t)=>t%2===1?i.jsx("em",{children:n},t):i.jsx(b.Fragment,{children:n},t))})}function _l(){const{route:e,embed:n,view:t,autostart:o}=gl(),r=n&&t==="compact",s=Wt().brain,d=fr();Fi(n);const c=e.kind==="example"?e.id:Ye[0].id,m=Ye.find(f=>f.id===c)??Ye[0],a=Ye.filter(f=>f.group!=="learn-bpmn"),p=Ye.filter(f=>f.group==="learn-bpmn"),u=f=>{bl(Mt(f),{hash:location.hash})},g=m.hero??Rt,h=i.jsxs(i.Fragment,{children:[!n&&i.jsxs(i.Fragment,{children:[i.jsxs("section",{className:"hero",children:[i.jsx("h1",{children:i.jsx(fl,{text:g.headline})}),g.lede&&i.jsx("p",{children:g.lede})]}),i.jsx("nav",{className:"example-picker","aria-label":"Scenario examples",children:a.map(f=>i.jsx(Q,{size:"sm",variant:f.id===m.id?"default":"secondary","aria-current":f.id===m.id?"page":void 0,onClick:()=>u(f.id),children:f.title},f.id))}),p.length>0&&i.jsxs(i.Fragment,{children:[i.jsx("h2",{className:"example-group-heading",id:"learn-bpmn-heading",children:"Learn BPMN"}),i.jsx("nav",{className:"example-picker","aria-labelledby":"learn-bpmn-heading",children:p.map(f=>i.jsx(Q,{size:"sm",variant:f.id===m.id?"default":"secondary","aria-current":f.id===m.id?"page":void 0,onClick:()=>u(f.id),children:f.title},f.id))})]})]}),i.jsxs("div",{className:"example-meta",children:[!n&&m.docsUrl&&i.jsx("a",{className:"docs-link",href:m.docsUrl,target:"_blank",rel:"noreferrer noopener",children:"View on camunda.com ↗"}),n&&i.jsx("a",{className:"open-full-page",href:Mt(m.id)+(location.hash||""),target:"_top",rel:"noreferrer",children:r?"Open the editable version ↗":"Open full page ↗"})]}),i.jsx(Rr,{example:m,compact:r,autostart:o,initialBrainKind:s,initialTourId:d},m.id)]});return n?i.jsx("div",{className:`c4-ui app-shell app-embed${r?" app-compact":""}`,children:i.jsx("main",{id:"main",className:`layout layout-embed${r?" layout-compact":""}`,children:h})}):i.jsxs("div",{className:"c4-ui app-shell",children:[i.jsx(go,{className:"topbar",logo:i.jsx("span",{className:"brand-dot","aria-hidden":!0}),appName:"Runnable Camunda examples",trailing:i.jsx("span",{className:"app-subtitle",children:g.tagline??Rt.tagline})}),i.jsx("main",{id:"main",className:"layout",children:h}),i.jsx("footer",{className:"footer",children:"Running locally in your browser on the nano WebAssembly BPMN engine — no cluster, no server, no data leaving the page."})]})}hl();ao.createRoot(document.getElementById("root")).render(i.jsx(b.StrictMode,{children:i.jsx(fo,{children:i.jsx(_l,{})})}));export{be as _,xl as c};
