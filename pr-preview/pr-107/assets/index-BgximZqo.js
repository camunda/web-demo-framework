...
`)}async function Gr(e,n,t,r,o,s){let l="";n({kind:"llm",text:"LLM thinking…",key:t,pending:!0,turn:s});const m=await e(r,o,h=>{l+=h,n({kind:"llm",text:`${Sn(l)} ▍`,key:t,pending:!0,turn:s})});return n({kind:"llm",text:Sn(m||l)||"(empty reply)",key:t,pending:!1,turn:s}),m}function Vr(e,n){switch(e){case"number":return typeof n=="number"&&Number.isFinite(n)?{ok:!0,value:n}:typeof n=="string"&&n.trim()!==""&&Number.isFinite(Number(n))?{ok:!0,value:Number(n)}:{ok:!1};case"boolean":return typeof n=="boolean"?{ok:!0,value:n}:typeof n=="string"&&/^(true|false)$/i.test(n.trim())?{ok:!0,value:n.trim().toLowerCase()==="true"}:{ok:!1};default:return typeof n=="object"?{ok:!1}:{ok:!0,value:String(n)}}}function Yr(e,n,t){const r={},o=new Map,s=new Map;for(const{tool:l,args:m}of e){const h={};for(const a of l.args){const p=m[a.name];if(!(p!=null&&p!=="")){n({kind:"error",text:`🤖 ${l.elementId}: model supplied no value for "${a.name}"`,turn:t,elementId:l.elementId});continue}const d=o.get(a.name);if(d!==void 0&&d!==l.elementId){n({kind:"error",text:`🤖 argument name collision on "${a.name}": both ${d} and ${l.elementId} declare it — ${d} already claimed it this turn, ${l.elementId}'s value is dropped`,turn:t,elementId:l.elementId});continue}const _=Vr(a.type,p);if(!_.ok){n({kind:"error",text:`🤖 ${l.elementId}: "${a.name}" is declared as ${a.type} but the model supplied ${JSON.stringify(p)} — rejected, not passed through`,turn:t,elementId:l.elementId});continue}r[a.name]=_.value,h[a.name]=_.value,o.set(a.name,l.elementId)}s.set(l.elementId,h)}return{variablesOut:r,forHistory:s}}function Qr(e,n,t,r={}){const{maxNewTokens:o=384,allowRepeats:s=!1,allowMultiToolTurns:l=!1,turnRef:m,requiredTools:h=[],maxEarlyDoneNudges:a=1,maxUnproductiveTurns:p=3}=r;let u=0;const d=new Set,_=[];let f=0,y=[],b=[];return async M=>{const I=M.variables,B=I.toolCallResult;B!==void 0&&_.length&&(_[_.length-1]=`${_[_.length-1]} → ${Sn(JSON.stringify(B),160)}`);let V=0;for(;;){const ne=await ae();if(ne)return ne;if(V+=1,V>=p)return t({kind:"error",text:`🤖 ${V} turns in a row activated nothing — completing the agent. The model has lost the reply format; whatever it has already run stands.`,turn:u}),{completionConditionFulfilled:!0}}async function ae(){if(u+=1,m&&(m.current=u),u>e.maxModelCalls)return t({kind:"error",text:`Turn budget spent (maxModelCalls=${e.maxModelCalls}) — completing the agent.`,turn:u}),{completionConditionFulfilled:!0};const ne=s?e.tools:e.tools.filter(L=>!d.has(L.elementId));if(ne.length===0)return t({kind:"agent",text:"🤖 every tool has run — completing the agent",turn:u}),{completionConditionFulfilled:!0};const xe=[{role:"system",content:Ur(e,l,ne)},{role:"user",content:$r(e,I,_,ne,y,b,s)}];y=[],b=[];let Ne;try{Ne=await Gr(n,t,`llm-turn-${u}`,xe,o,u)}catch(L){return t({kind:"error",text:`LLM call failed: ${L instanceof Error?L.message:String(L)} — completing the agent.`,turn:u}),{completionConditionFulfilled:!0}}const ue=zr(Ne);if(Or(ue)&&Wn(ue).length===0){const L=h.filter(H=>!d.has(H));return L.length&&f<a?(f+=1,y=L,t({kind:"agent",text:`🤖 model says it is done, but ${L.join(", ")} hasn't run — asking once more`,turn:u}),null):(t({kind:"agent",text:"🤖 model says it is done",turn:u}),{completionConditionFulfilled:!0})}const se=Wn(ue);if(se.length===0)return t({kind:"error",text:"🤖 model named no tool (and didn't say it was done) — asking again",turn:u}),b=['it named no tool and did not say it was done — reply with {"tool": "...", "arguments": {...}} or {"done": true}'],null;const J=[],N=[],E=[];for(const L of se){const H=e.tools.find(Q=>Q.elementId===L.name);if(!H){N.push(L.name);continue}if(!s&&d.has(H.elementId)){E.push(H.elementId);continue}J.push({tool:H,args:L.args})}if(N.length&&t({kind:"error",text:`🤖 model named a tool that doesn't exist: ${N.join(", ")} — nothing activated`,turn:u}),E.length&&t({kind:"error",text:`🤖 model asked to re-run ${E.join(", ")} — skipped (already run)`,turn:u}),J.length===0)return t({kind:"agent",text:"🤖 nothing activated — asking again",turn:u}),b=[...N.length?[`${N.join(", ")} ${N.length===1?"is":"are"} not a real tool`]:[],...E.length?[`${E.join(", ")} has already run and will never run again — pick a different tool, or reply {"done": true} if nothing is left to do`]:[]],null;const{variablesOut:S,forHistory:K}=Yr(J,t,u);for(const{tool:L}of J)d.add(L.elementId),_.push(`- ${L.elementId}(${JSON.stringify(K.get(L.elementId))})`);for(const{tool:L}of J)t({kind:"agent",text:`🤖 calling ${L.elementId}`,turn:u,elementId:L.elementId,args:K.get(L.elementId)??{}});return{activateElements:J.map(L=>({elementId:L.tool.elementId})),variables:S}}}}function qr(e,n,t,r={}){const o=new Map(e.map(s=>[s.elementId,Qr(s,n,t,r)]));return async s=>{const l=o.get(s.elementId);if(!l)throw new Error(`No agent host registered for "${s.elementId}"`);return l(s)}}class Pn{__destroy_into_raw(){const n=this.__wbg_ptr;return this.__wbg_ptr=0,Kn.unregister(this),n}free(){const n=this.__destroy_into_raw();c.__wbg_testengine_free(n,0)}activateJobs(n,t,r,o){let s,l;try{const _=c.__wbindgen_add_to_stack_pointer(-16),f=A(n,c.__wbindgen_export,c.__wbindgen_export2),y=j,b=A(o,c.__wbindgen_export,c.__wbindgen_export2),M=j;c.testengine_activateJobs(_,this.__wbg_ptr,f,y,t,r,b,M);var m=w().getInt32(_+0,!0),h=w().getInt32(_+4,!0),a=w().getInt32(_+8,!0),p=w().getInt32(_+12,!0),u=m,d=h;if(p)throw u=0,d=0,O(a);return s=u,l=d,z(u,d)}finally{c.__wbindgen_add_to_stack_pointer(16),c.__wbindgen_export3(s,l,1)}}advanceTime(n){let t,r;try{const p=c.__wbindgen_add_to_stack_pointer(-16);c.testengine_advanceTime(p,this.__wbg_ptr,n);var o=w().getInt32(p+0,!0),s=w().getInt32(p+4,!0),l=w().getInt32(p+8,!0),m=w().getInt32(p+12,!0),h=o,a=s;if(m)throw h=0,a=0,O(l);return t=h,r=a,z(h,a)}finally{c.__wbindgen_add_to_stack_pointer(16),c.__wbindgen_export3(t,r,1)}}assignUserTask(n,t,r){let o,s;try{const d=c.__wbindgen_add_to_stack_pointer(-16),_=A(n,c.__wbindgen_export,c.__wbindgen_export2),f=j,y=A(t,c.__wbindgen_export,c.__wbindgen_export2),b=j;c.testengine_assignUserTask(d,this.__wbg_ptr,_,f,y,b,r);var l=w().getInt32(d+0,!0),m=w().getInt32(d+4,!0),h=w().getInt32(d+8,!0),a=w().getInt32(d+12,!0),p=l,u=m;if(a)throw p=0,u=0,O(h);return o=p,s=u,z(p,u)}finally{c.__wbindgen_add_to_stack_pointer(16),c.__wbindgen_export3(o,s,1)}}broadcastSignal(n,t){let r,o;try{const u=c.__wbindgen_add_to_stack_pointer(-16),d=A(n,c.__wbindgen_export,c.__wbindgen_export2),_=j,f=A(t,c.__wbindgen_export,c.__wbindgen_export2),y=j;c.testengine_broadcastSignal(u,this.__wbg_ptr,d,_,f,y);var s=w().getInt32(u+0,!0),l=w().getInt32(u+4,!0),m=w().getInt32(u+8,!0),h=w().getInt32(u+12,!0),a=s,p=l;if(h)throw a=0,p=0,O(m);return r=a,o=p,z(a,p)}finally{c.__wbindgen_add_to_stack_pointer(16),c.__wbindgen_export3(r,o,1)}}cancelInstance(n){let t,r;try{const p=c.__wbindgen_add_to_stack_pointer(-16),u=A(n,c.__wbindgen_export,c.__wbindgen_export2),d=j;c.testengine_cancelInstance(p,this.__wbg_ptr,u,d);var o=w().getInt32(p+0,!0),s=w().getInt32(p+4,!0),l=w().getInt32(p+8,!0),m=w().getInt32(p+12,!0),h=o,a=s;if(m)throw h=0,a=0,O(l);return t=h,r=a,z(h,a)}finally{c.__wbindgen_add_to_stack_pointer(16),c.__wbindgen_export3(t,r,1)}}completeAgentJob(n,t,r){let o,s;try{const d=c.__wbindgen_add_to_stack_pointer(-16),_=A(n,c.__wbindgen_export,c.__wbindgen_export2),f=j,y=A(t,c.__wbindgen_export,c.__wbindgen_export2),b=j,M=A(r,c.__wbindgen_export,c.__wbindgen_export2),I=j;c.testengine_completeAgentJob(d,this.__wbg_ptr,_,f,y,b,M,I);var l=w().getInt32(d+0,!0),m=w().getInt32(d+4,!0),h=w().getInt32(d+8,!0),a=w().getInt32(d+12,!0),p=l,u=m;if(a)throw p=0,u=0,O(h);return o=p,s=u,z(p,u)}finally{c.__wbindgen_add_to_stack_pointer(16),c.__wbindgen_export3(o,s,1)}}completeJob(n,t){let r,o;try{const u=c.__wbindgen_add_to_stack_pointer(-16),d=A(n,c.__wbindgen_export,c.__wbindgen_export2),_=j,f=A(t,c.__wbindgen_export,c.__wbindgen_export2),y=j;c.testengine_completeJob(u,this.__wbg_ptr,d,_,f,y);var s=w().getInt32(u+0,!0),l=w().getInt32(u+4,!0),m=w().getInt32(u+8,!0),h=w().getInt32(u+12,!0),a=s,p=l;if(h)throw a=0,p=0,O(m);return r=a,o=p,z(a,p)}finally{c.__wbindgen_add_to_stack_pointer(16),c.__wbindgen_export3(r,o,1)}}completeUserTask(n,t){let r,o;try{const u=c.__wbindgen_add_to_stack_pointer(-16),d=A(n,c.__wbindgen_export,c.__wbindgen_export2),_=j,f=A(t,c.__wbindgen_export,c.__wbindgen_export2),y=j;c.testengine_completeUserTask(u,this.__wbg_ptr,d,_,f,y);var s=w().getInt32(u+0,!0),l=w().getInt32(u+4,!0),m=w().getInt32(u+8,!0),h=w().getInt32(u+12,!0),a=s,p=l;if(h)throw a=0,p=0,O(m);return r=a,o=p,z(a,p)}finally{c.__wbindgen_add_to_stack_pointer(16),c.__wbindgen_export3(r,o,1)}}correlateMessage(n,t,r){let o,s;try{const d=c.__wbindgen_add_to_stack_pointer(-16),_=A(n,c.__wbindgen_export,c.__wbindgen_export2),f=j,y=A(t,c.__wbindgen_export,c.__wbindgen_export2),b=j,M=A(r,c.__wbindgen_export,c.__wbindgen_export2),I=j;c.testengine_correlateMessage(d,this.__wbg_ptr,_,f,y,b,M,I);var l=w().getInt32(d+0,!0),m=w().getInt32(d+4,!0),h=w().getInt32(d+8,!0),a=w().getInt32(d+12,!0),p=l,u=m;if(a)throw p=0,u=0,O(h);return o=p,s=u,z(p,u)}finally{c.__wbindgen_add_to_stack_pointer(16),c.__wbindgen_export3(o,s,1)}}createInstance(n,t,r){let o,s;try{const d=c.__wbindgen_add_to_stack_pointer(-16),_=A(n,c.__wbindgen_export,c.__wbindgen_export2),f=j,y=A(t,c.__wbindgen_export,c.__wbindgen_export2),b=j;c.testengine_createInstance(d,this.__wbg_ptr,_,f,y,b,Kr(r)?Number.MAX_SAFE_INTEGER:r>>0);var l=w().getInt32(d+0,!0),m=w().getInt32(d+4,!0),h=w().getInt32(d+8,!0),a=w().getInt32(d+12,!0),p=l,u=m;if(a)throw p=0,u=0,O(h);return o=p,s=u,z(p,u)}finally{c.__wbindgen_add_to_stack_pointer(16),c.__wbindgen_export3(o,s,1)}}debugClear(){c.testengine_debugClear(this.__wbg_ptr)}debugCreateInstance(n,t,r){let o,s;try{const d=c.__wbindgen_add_to_stack_pointer(-16),_=A(n,c.__wbindgen_export,c.__wbindgen_export2),f=j,y=A(t,c.__wbindgen_export,c.__wbindgen_export2),b=j,M=A(r,c.__wbindgen_export,c.__wbindgen_export2),I=j;c.testengine_debugCreateInstance(d,this.__wbg_ptr,_,f,y,b,M,I);var l=w().getInt32(d+0,!0),m=w().getInt32(d+4,!0),h=w().getInt32(d+8,!0),a=w().getInt32(d+12,!0),p=l,u=m;if(a)throw p=0,u=0,O(h);return o=p,s=u,z(p,u)}finally{c.__wbindgen_add_to_stack_pointer(16),c.__wbindgen_export3(o,s,1)}}get debugIsPaused(){return c.testengine_debugIsPaused(this.__wbg_ptr)!==0}debugResume(){let n,t;try{const a=c.__wbindgen_add_to_stack_pointer(-16);c.testengine_debugResume(a,this.__wbg_ptr);var r=w().getInt32(a+0,!0),o=w().getInt32(a+4,!0),s=w().getInt32(a+8,!0),l=w().getInt32(a+12,!0),m=r,h=o;if(l)throw m=0,h=0,O(s);return n=m,t=h,z(m,h)}finally{c.__wbindgen_add_to_stack_pointer(16),c.__wbindgen_export3(n,t,1)}}debugStep(){let n,t;try{const a=c.__wbindgen_add_to_stack_pointer(-16);c.testengine_debugStep(a,this.__wbg_ptr);var r=w().getInt32(a+0,!0),o=w().getInt32(a+4,!0),s=w().getInt32(a+8,!0),l=w().getInt32(a+12,!0),m=r,h=o;if(l)throw m=0,h=0,O(s);return n=m,t=h,z(m,h)}finally{c.__wbindgen_add_to_stack_pointer(16),c.__wbindgen_export3(n,t,1)}}deploy(n){let t,r;try{const p=c.__wbindgen_add_to_stack_pointer(-16),u=A(n,c.__wbindgen_export,c.__wbindgen_export2),d=j;c.testengine_deploy(p,this.__wbg_ptr,u,d);var o=w().getInt32(p+0,!0),s=w().getInt32(p+4,!0),l=w().getInt32(p+8,!0),m=w().getInt32(p+12,!0),h=o,a=s;if(m)throw h=0,a=0,O(l);return t=h,r=a,z(h,a)}finally{c.__wbindgen_add_to_stack_pointer(16),c.__wbindgen_export3(t,r,1)}}deployForm(n){let t,r;try{const p=c.__wbindgen_add_to_stack_pointer(-16),u=A(n,c.__wbindgen_export,c.__wbindgen_export2),d=j;c.testengine_deployForm(p,this.__wbg_ptr,u,d);var o=w().getInt32(p+0,!0),s=w().getInt32(p+4,!0),l=w().getInt32(p+8,!0),m=w().getInt32(p+12,!0),h=o,a=s;if(m)throw h=0,a=0,O(l);return t=h,r=a,z(h,a)}finally{c.__wbindgen_add_to_stack_pointer(16),c.__wbindgen_export3(t,r,1)}}deployResource(n,t){let r,o;try{const u=c.__wbindgen_add_to_stack_pointer(-16),d=A(n,c.__wbindgen_export,c.__wbindgen_export2),_=j,f=A(t,c.__wbindgen_export,c.__wbindgen_export2),y=j;c.testengine_deployResource(u,this.__wbg_ptr,d,_,f,y);var s=w().getInt32(u+0,!0),l=w().getInt32(u+4,!0),m=w().getInt32(u+8,!0),h=w().getInt32(u+12,!0),a=s,p=l;if(h)throw a=0,p=0,O(m);return r=a,o=p,z(a,p)}finally{c.__wbindgen_add_to_stack_pointer(16),c.__wbindgen_export3(r,o,1)}}events(){let n,t;try{const a=c.__wbindgen_add_to_stack_pointer(-16);c.testengine_events(a,this.__wbg_ptr);var r=w().getInt32(a+0,!0),o=w().getInt32(a+4,!0),s=w().getInt32(a+8,!0),l=w().getInt32(a+12,!0),m=r,h=o;if(l)throw m=0,h=0,O(s);return n=m,t=h,z(m,h)}finally{c.__wbindgen_add_to_stack_pointer(16),c.__wbindgen_export3(n,t,1)}}failJob(n,t,r){let o,s;try{const d=c.__wbindgen_add_to_stack_pointer(-16),_=A(n,c.__wbindgen_export,c.__wbindgen_export2),f=j,y=A(r,c.__wbindgen_export,c.__wbindgen_export2),b=j;c.testengine_failJob(d,this.__wbg_ptr,_,f,t,y,b);var l=w().getInt32(d+0,!0),m=w().getInt32(d+4,!0),h=w().getInt32(d+8,!0),a=w().getInt32(d+12,!0),p=l,u=m;if(a)throw p=0,u=0,O(h);return o=p,s=u,z(p,u)}finally{c.__wbindgen_add_to_stack_pointer(16),c.__wbindgen_export3(o,s,1)}}migrate(n,t,r){let o,s;try{const d=c.__wbindgen_add_to_stack_pointer(-16),_=A(n,c.__wbindgen_export,c.__wbindgen_export2),f=j,y=A(t,c.__wbindgen_export,c.__wbindgen_export2),b=j,M=A(r,c.__wbindgen_export,c.__wbindgen_export2),I=j;c.testengine_migrate(d,this.__wbg_ptr,_,f,y,b,M,I);var l=w().getInt32(d+0,!0),m=w().getInt32(d+4,!0),h=w().getInt32(d+8,!0),a=w().getInt32(d+12,!0),p=l,u=m;if(a)throw p=0,u=0,O(h);return o=p,s=u,z(p,u)}finally{c.__wbindgen_add_to_stack_pointer(16),c.__wbindgen_export3(o,s,1)}}modify(n,t,r){let o,s;try{const d=c.__wbindgen_add_to_stack_pointer(-16),_=A(n,c.__wbindgen_export,c.__wbindgen_export2),f=j,y=A(t,c.__wbindgen_export,c.__wbindgen_export2),b=j,M=A(r,c.__wbindgen_export,c.__wbindgen_export2),I=j;c.testengine_modify(d,this.__wbg_ptr,_,f,y,b,M,I);var l=w().getInt32(d+0,!0),m=w().getInt32(d+4,!0),h=w().getInt32(d+8,!0),a=w().getInt32(d+12,!0),p=l,u=m;if(a)throw p=0,u=0,O(h);return o=p,s=u,z(p,u)}finally{c.__wbindgen_add_to_stack_pointer(16),c.__wbindgen_export3(o,s,1)}}constructor(){const n=c.testengine_new();return this.__wbg_ptr=n,Kn.register(this,this.__wbg_ptr,this),this}get now(){return c.testengine_now(this.__wbg_ptr)}reset(){c.testengine_reset(this.__wbg_ptr)}resolveIncident(n){let t,r;try{const p=c.__wbindgen_add_to_stack_pointer(-16),u=A(n,c.__wbindgen_export,c.__wbindgen_export2),d=j;c.testengine_resolveIncident(p,this.__wbg_ptr,u,d);var o=w().getInt32(p+0,!0),s=w().getInt32(p+4,!0),l=w().getInt32(p+8,!0),m=w().getInt32(p+12,!0),h=o,a=s;if(m)throw h=0,a=0,O(l);return t=h,r=a,z(h,a)}finally{c.__wbindgen_add_to_stack_pointer(16),c.__wbindgen_export3(t,r,1)}}setVariables(n,t,r){let o,s;try{const d=c.__wbindgen_add_to_stack_pointer(-16),_=A(n,c.__wbindgen_export,c.__wbindgen_export2),f=j,y=A(t,c.__wbindgen_export,c.__wbindgen_export2),b=j;c.testengine_setVariables(d,this.__wbg_ptr,_,f,y,b,r);var l=w().getInt32(d+0,!0),m=w().getInt32(d+4,!0),h=w().getInt32(d+8,!0),a=w().getInt32(d+12,!0),p=l,u=m;if(a)throw p=0,u=0,O(h);return o=p,s=u,z(p,u)}finally{c.__wbindgen_add_to_stack_pointer(16),c.__wbindgen_export3(o,s,1)}}snapshot(){let n,t;try{const a=c.__wbindgen_add_to_stack_pointer(-16);c.testengine_snapshot(a,this.__wbg_ptr);var r=w().getInt32(a+0,!0),o=w().getInt32(a+4,!0),s=w().getInt32(a+8,!0),l=w().getInt32(a+12,!0),m=r,h=o;if(l)throw m=0,h=0,O(s);return n=m,t=h,z(m,h)}finally{c.__wbindgen_add_to_stack_pointer(16),c.__wbindgen_export3(n,t,1)}}throwError(n,t,r){let o,s;try{const d=c.__wbindgen_add_to_stack_pointer(-16),_=A(n,c.__wbindgen_export,c.__wbindgen_export2),f=j,y=A(t,c.__wbindgen_export,c.__wbindgen_export2),b=j,M=A(r,c.__wbindgen_export,c.__wbindgen_export2),I=j;c.testengine_throwError(d,this.__wbg_ptr,_,f,y,b,M,I);var l=w().getInt32(d+0,!0),m=w().getInt32(d+4,!0),h=w().getInt32(d+8,!0),a=w().getInt32(d+12,!0),p=l,u=m;if(a)throw p=0,u=0,O(h);return o=p,s=u,z(p,u)}finally{c.__wbindgen_add_to_stack_pointer(16),c.__wbindgen_export3(o,s,1)}}tickNow(n){let t,r;try{const p=c.__wbindgen_add_to_stack_pointer(-16);c.testengine_tickNow(p,this.__wbg_ptr,n);var o=w().getInt32(p+0,!0),s=w().getInt32(p+4,!0),l=w().getInt32(p+8,!0),m=w().getInt32(p+12,!0),h=o,a=s;if(m)throw h=0,a=0,O(l);return t=h,r=a,z(h,a)}finally{c.__wbindgen_add_to_stack_pointer(16),c.__wbindgen_export3(t,r,1)}}unassignUserTask(n){let t,r;try{const p=c.__wbindgen_add_to_stack_pointer(-16),u=A(n,c.__wbindgen_export,c.__wbindgen_export2),d=j;c.testengine_unassignUserTask(p,this.__wbg_ptr,u,d);var o=w().getInt32(p+0,!0),s=w().getInt32(p+4,!0),l=w().getInt32(p+8,!0),m=w().getInt32(p+12,!0),h=o,a=s;if(m)throw h=0,a=0,O(l);return t=h,r=a,z(h,a)}finally{c.__wbindgen_add_to_stack_pointer(16),c.__wbindgen_export3(t,r,1)}}updateRetries(n,t){let r,o;try{const u=c.__wbindgen_add_to_stack_pointer(-16),d=A(n,c.__wbindgen_export,c.__wbindgen_export2),_=j;c.testengine_updateRetries(u,this.__wbg_ptr,d,_,t);var s=w().getInt32(u+0,!0),l=w().getInt32(u+4,!0),m=w().getInt32(u+8,!0),h=w().getInt32(u+12,!0),a=s,p=l;if(h)throw a=0,p=0,O(m);return r=a,o=p,z(a,p)}finally{c.__wbindgen_add_to_stack_pointer(16),c.__wbindgen_export3(r,o,1)}}updateUserTask(n,t){let r,o;try{const u=c.__wbindgen_add_to_stack_pointer(-16),d=A(n,c.__wbindgen_export,c.__wbindgen_export2),_=j,f=A(t,c.__wbindgen_export,c.__wbindgen_export2),y=j;c.testengine_updateUserTask(u,this.__wbg_ptr,d,_,f,y);var s=w().getInt32(u+0,!0),l=w().getInt32(u+4,!0),m=w().getInt32(u+8,!0),h=w().getInt32(u+12,!0),a=s,p=l;if(h)throw a=0,p=0,O(m);return r=a,o=p,z(a,p)}finally{c.__wbindgen_add_to_stack_pointer(16),c.__wbindgen_export3(r,o,1)}}}Symbol.dispose&&(Pn.prototype[Symbol.dispose]=Pn.prototype.free);function Jr(){return{__proto__:null,"./nanobpmn_engine_bg.js":{__proto__:null,__wbg___wbindgen_throw_bb96b2010945f0bc:function(n,t){throw new Error(z(n,t))},__wbindgen_cast_0000000000000001:function(n,t){const r=z(n,t);return Hr(r)},__wbindgen_object_drop_ref:function(n){O(n)}}}}const Kn=typeof FinalizationRegistry>"u"?{register:()=>{},unregister:()=>{}}:new FinalizationRegistry(e=>c.__wbg_testengine_free(e,1));function Hr(e){Ze===De.length&&De.push(De.length+1);const n=Ze;return Ze=De[n],De[n]=e,n}function Wr(e){e<1028||(De[e]=Ze,Ze=e)}let Re=null;function w(){return(Re===null||Re.buffer.detached===!0||Re.buffer.detached===void 0&&Re.buffer!==c.memory.buffer)&&(Re=new DataView(c.memory.buffer)),Re}function z(e,n){return ei(e>>>0,n)}let We=null;function sn(){return(We===null||We.byteLength===0)&&(We=new Uint8Array(c.memory.buffer)),We}function Zr(e){return De[e]}let De=new Array(1024).fill(void 0);De.push(void 0,null,!0,!1);let Ze=De.length;function Kr(e){return e==null}function A(e,n,t){if(t===void 0){const m=Ke.encode(e),h=n(m.length,1)>>>0;return sn().subarray(h,h+m.length).set(m),j=m.length,h}let r=e.length,o=n(r,1)>>>0;const s=sn();let l=0;for(;l<r;l++){const m=e.charCodeAt(l);if(m>127)break;s[o+l]=m}if(l!==r){l!==0&&(e=e.slice(l)),o=t(o,r,r=l+e.length*3,1)>>>0;const m=sn().subarray(o+l,o+r),h=Ke.encodeInto(e,m);l+=h.written,o=t(o,r,l,1)>>>0}return j=l,o}function O(e){const n=Zr(e);return Wr(e),n}let dn=new TextDecoder("utf-8",{ignoreBOM:!0,fatal:!0});dn.decode();const Xr=2146435072;let yn=0;function ei(e,n){return yn+=n,yn>=Xr&&(dn=new TextDecoder("utf-8",{ignoreBOM:!0,fatal:!0}),dn.decode(),yn=n),dn.decode(sn().subarray(e,e+n))}const Ke=new TextEncoder;"encodeInto"in Ke||(Ke.encodeInto=function(e,n){const t=Ke.encode(e);return n.set(t),{read:e.length,written:t.length}});let j=0,c;function ni(e,n){return c=e.exports,Re=null,We=null,c}async function ti(e,n){if(typeof Response=="function"&&e instanceof Response){if(!e.ok)throw new Error(`failed to fetch Wasm: ${e.status} ${e.statusText} fetching '${e.url}'`);if(typeof WebAssembly.instantiateStreaming=="function")try{return await WebAssembly.instantiateStreaming(e,n)}catch(o){if(t(e.type)&&e.headers.get("Content-Type")!=="application/wasm")console.warn("`WebAssembly.instantiateStreaming` failed because your server does not serve Wasm with `application/wasm` MIME type. Falling back to `WebAssembly.instantiate` which is slower. Original error:\n",o);else throw o}const r=await e.arrayBuffer();return await WebAssembly.instantiate(r,n)}else{const r=await WebAssembly.instantiate(e,n);return r instanceof WebAssembly.Instance?{instance:r,module:e}:r}function t(r){switch(r){case"basic":case"cors":case"default":return!0}return!1}}async function ri(e){if(c!==void 0)return c;e!==void 0&&(Object.getPrototypeOf(e)===Object.prototype?{module_or_path:e}=e:console.warn("using deprecated parameters for the initialization function; pass a single object instead")),e===void 0&&(e=new URL("/pr-preview/pr-107/assets/nanobpmn_engine_bg-DRNrIVE8.wasm",import.meta.url));const n=Jr();(typeof e=="string"||typeof Request=="function"&&e instanceof Request||typeof URL=="function"&&e instanceof URL)&&(e=fetch(e));const{instance:t,module:r}=await ti(await e,n);return ni(t)}let on=null;function ii(e){return on||(on=ri(void 0).then(()=>{}).catch(n=>{throw on=null,n})),on}function ee(e){return JSON.parse(e)}class oi{constructor(n){F(this,"engine");this.engine=n}deploy(n){return JSON.parse(this.engine.deploy(n))}createInstance(n,t){return ee(this.engine.createInstance(n,t||"{}"))}activateJobs(n,t,r,o){return JSON.parse(this.engine.activateJobs(n,t,r,o))}completeJob(n,t){return ee(this.engine.completeJob(n,t||"{}"))}completeAgentJob(n,t){const{variables:r,...o}=t??{};return ee(this.engine.completeAgentJob(n,JSON.stringify(r??{}),JSON.stringify(o??{})))}failJob(n,t,r){return ee(this.engine.failJob(n,t,r))}throwError(n,t,r){return ee(this.engine.throwError(n,t,r))}updateRetries(n,t){return ee(this.engine.updateRetries(n,t))}resolveIncident(n){return ee(this.engine.resolveIncident(n))}setVariables(n,t,r){return ee(this.engine.setVariables(n,t||"{}",r))}broadcastSignal(n,t){return ee(this.engine.broadcastSignal(n,t||"{}"))}cancelInstance(n){return ee(this.engine.cancelInstance(n))}modify(n,t,r){return ee(this.engine.modify(n,JSON.stringify(t??[]),JSON.stringify(r??[])))}completeUserTask(n,t){return ee(this.engine.completeUserTask(n,t||"{}"))}assignUserTask(n,t,r){return ee(this.engine.assignUserTask(n,t,r))}unassignUserTask(n){return ee(this.engine.unassignUserTask(n))}updateUserTask(n,t){return ee(this.engine.updateUserTask(n,t||"{}"))}correlateMessage(n,t,r){return ee(this.engine.correlateMessage(n,t,r||"{}"))}advanceTime(n){return ee(this.engine.advanceTime(n))}reset(){this.engine.reset()}events(){return JSON.parse(this.engine.events())}snapshot(){return ee(this.engine.snapshot())}free(){this.engine.free()}}async function ai(e){return await ii(),new oi(new Pn)}class Pt extends Error{constructor(t,r){super(t);F(this,"retries");this.name="JobFailure",this.retries=r==null?void 0:r.retries}}function si(e,n=[]){if(e.instances.filter(o=>!o.completed).length===0)return e.totalInstances>0?"completed":"idle";if(e.incidents.length>0)return"incidents";const r=new Set(n);return e.jobs.some(o=>!r.has(o.jobType))?"unhandledJobs":e.userTasks.some(o=>o.state==="Created")?"userTasks":e.timers.length>0?"timers":e.messageSubscriptions.length>0?"messages":e.signalSubscriptions.length>0?"signals":"idle"}function di(e,n=[]){const t=new Set(n);return[...new Set(e.jobs.map(r=>r.jobType))].filter(r=>!t.has(r)).sort()}async function li(e,n,t){let r;try{const o=await n(t);r=JSON.stringify(o??{})}catch(o){const s=o instanceof Pt&&o.retries!==void 0?o.retries:Math.max(0,t.retries-1),l=o instanceof Error?o.message:String(o);e.failJob(t.key,s,l);return}e.completeJob(t.key,r)}async function ci(e,n,t){let r;try{r=await n(t),JSON.stringify(r)}catch(o){const s=o instanceof Pt&&o.retries!==void 0?o.retries:Math.max(0,t.retries-1),l=o instanceof Error?o.message:String(o);e.failJob(t.key,s,l);return}e.completeAgentJob(t.key,r)}async function mi(e,n,t={}){const r=t.maxJobsPerActivation??10,o=t.lockTimeoutMs??3e4,s=t.worker??"bojtos",l=t.agents??{};for(const d of Object.keys(l))if(d in n)throw new Error(`dispatchRound: job type "${d}" is registered as both a worker and an agent — register it as exactly one`);const m=[];for(const[d,_]of Object.entries(n))for(const f of e.activateJobs(d,r,o,s))m.push({handler:_,job:f});const h=[];for(const[d,_]of Object.entries(l))for(const f of e.activateJobs(d,r,o,s))h.push({handler:_,job:f});for(const{handler:d,job:_}of m)await li(e,d,_);for(const{handler:d,job:_}of h)await ci(e,d,_);const a=e.snapshot(),p=m.length+h.length;if(p>0)return{snapshot:a,handled:p};const u=[...Object.keys(n),...Object.keys(l)];return{snapshot:a,handled:p,reason:si(a,u),unhandled:di(a,u)}}function pi({bpmn:e}){const n=g.useRef(null),[t,r]=g.useState("loading"),[o,s]=g.useState(null),[l,m]=g.useState([]),[h,a]=g.useState(null),p=g.useRef(e),u=g.useRef(0),d=g.useRef(new Map),_=g.useCallback((N,E)=>{d.current.set(N,E)},[]),f=g.useCallback(N=>d.current.get(N),[]),y=g.useCallback((N,E)=>{const S=N.deploy(E);return p.current=E,d.current.clear(),m(S.processIds),a(null),s(null),S.processIds},[]);g.useEffect(()=>{let N=!1;return r("loading"),m([]),a(null),s(null),ai().then(E=>{if(N){E.free();return}try{y(E,e)}catch(S){E.free(),s(String(S)),r("error");return}n.current=E,r("ready")}).catch(E=>{N||(s(String(E)),r("error"))}),()=>{var E;N=!0,(E=n.current)==null||E.free(),n.current=null,d.current.clear()}},[e]);const b=g.useCallback(N=>{const E=n.current;if(!E)return null;try{const S=N(E);return a(S),s(null),S}catch(S){return s(String(S)),null}},[]),M=g.useCallback((N,E)=>b(S=>S.createInstance(N,E)),[b]),I=g.useCallback((N,E)=>b(S=>S.completeUserTask(N,E)),[b]),B=g.useCallback(N=>b(E=>E.advanceTime(N)),[b]),V=g.useCallback((N,E)=>b(S=>S.broadcastSignal(N,E)),[b]);function ae(N,E){const[S]=N.activateJobs(E,1,3e4,"manual-control");if(!S)throw new Error(`No waiting job of type "${E}" to resolve.`);return S}const ne=g.useCallback((N,E)=>b(S=>{const K=ae(S,N);return S.completeJob(K.key,E)}),[b]),xe=g.useCallback((N,E,S)=>b(K=>{const L=ae(K,N);return K.throwError(L.key,E,S)}),[b]),Ne=g.useCallback((N,E,S)=>b(K=>K.correlateMessage(N,E,S)),[b]),ue=g.useCallback(async(N,E)=>{const S=n.current;if(!S)return null;const K=u.current;try{const L=await mi(S,N,E);return n.current!==S||u.current!==K?null:(a(L.snapshot),s(null),L)}catch(L){return n.current!==S||u.current!==K||(a(S.snapshot()),s(String(L))),null}},[]),se=g.useCallback(()=>{const N=n.current;if(N){u.current++;try{N.reset(),y(N,p.current)}catch(E){s(String(E))}}},[y]),J=g.useCallback(N=>{const E=n.current;if(!E)return null;u.current++;try{return E.reset(),y(E,N)}catch(S){return s(String(S)),null}},[y]);return{phase:t,error:o,processIds:l,snapshot:h,createInstance:M,stepWorkers:ue,completeUserTask:I,advanceTime:B,broadcastSignal:V,completeJobManually:ne,throwJobError:xe,correlateMessage:Ne,reset:se,redeploy:J,setRunImage:_,getRunImage:f}}function ui(e,n){return e.slice(n)}function hi(e,n,t,r){const o=e.snapshot,s="⏸ waiting for a human — complete the task below to continue",l=o.userTasks.some(m=>m.state==="Created");if(e.handled>0){const m=o.activeElementIds.map(t),h=n.length?` via ${n.map(a=>`${t(a.from)} → ${t(a.to)}`).join(", ")}`:"";return o.completedInstances>=1?{kind:"done",text:`⏭ round handled ${e.handled} job${e.handled===1?"":"s"}${h} — ✅ process instance completed`}:l?{kind:"human",text:`⏭ round handled ${e.handled} job${e.handled===1?"":"s"}${h} — ${s}`}:{kind:"step",text:`⏭ round handled ${e.handled} job${e.handled===1?"":"s"}${h} — now at ${m.length?m.join(", "):"—"}`}}switch(e.reason){case"completed":return{kind:"done",text:"✅ process instance completed"};case"userTasks":return{kind:"human",text:s};case"timers":return{kind:"step",text:"⏱ waiting on a timer — advance the clock to continue"};case"messages":return{kind:"step",text:"✉ waiting on a message — correlate it to continue"};case"signals":return{kind:"step",text:"📶 waiting on a signal — broadcast it to continue"};case"incidents":return{kind:"error",text:"A job failed — incident on the diagram"};case"unhandledJobs":{const m=e.unhandled??[];return r&&m.length>0&&m.every(h=>r.has(h))?{kind:"human",text:s}:{kind:"error",text:`⏭ waiting on job type(s) with no worker registered: ${m.join(", ")}`}}case"idle":return{kind:"step",text:"Nothing to step — no instance is running."};default:return{kind:"step",text:e.reason?`Step blocked on an unrecognized reason: ${e.reason}`:"Nothing to step — no instance is running."}}}const gi="the Scripted or Endpoint brain";async function cn(e=gi){const n=navigator.gpu;if(!n)return`This browser doesn't expose WebGPU at all. Use a recent Chrome, Edge, or Safari 17+ with hardware acceleration on, or pick ${e}.`;let t;try{t=await n.requestAdapter()}catch(r){return`WebGPU adapter request failed (${r instanceof Error?r.message:String(r)}). Try ${e} instead.`}return t?null:`This browser supports the WebGPU API, but no GPU adapter is available — hardware acceleration may be off, or this device/VM has no usable GPU. Pick ${e} instead.`}const bi=[{id:"Qwen2.5-1.5B-Instruct-q4f16_1-MLC",label:"Qwen2.5 1.5B",downloadLabel:"~1.0 GB"},{id:"SmolLM2-1.7B-Instruct-q4f16_1-MLC",label:"SmolLM2 1.7B",downloadLabel:"~1.1 GB"},{id:"Llama-3.2-1B-Instruct-q4f16_1-MLC",label:"Llama 3.2 1B",downloadLabel:"~0.7 GB"},{id:"gemma-2-2b-it-q4f16_1-MLC",label:"Gemma 2 2B",downloadLabel:"~1.5 GB"},{id:"Llama-3.2-1B-Instruct-q4f32_1-MLC",label:"Llama 3.2 1B (f32, wider GPU support)",downloadLabel:"~1.1 GB"},{id:"SmolLM2-360M-Instruct-q4f32_1-MLC",label:"SmolLM2 360M (tiny, f32)",downloadLabel:"~0.6 GB"},{id:"SmolLM2-360M-Instruct-q4f16_1-MLC",label:"SmolLM2 360M (tiny)",downloadLabel:"~0.3 GB"}];function At(e){return An.get(e)??{}}const An=new Map;async function _i(){if(An.size>0)return;const{prebuiltAppConfig:e}=await pe(async()=>{const{prebuiltAppConfig:n}=await import("./vendor-webllm-DT0Ab8E6.js");return{prebuiltAppConfig:n}},[]);for(const n of e.model_list)An.set(n.model_id,{vramRequiredMB:n.vram_required_MB,requiredFeatures:n.required_features})}const hn=bi.map(e=>({id:e.id,label:`${e.label} (${e.downloadLabel})`,downloadLabel:e.downloadLabel,...At(e.id)})),Ct=hn[0].id;async function fi(){return await _i(),hn.map(e=>({...e,...At(e.id)}))}function Dt(){const e=navigator.deviceMemory;return typeof e=="number"?e*1024:null}function wi(e,n=Dt()){return n==null||e.vramRequiredMB==null||n>=e.vramRequiredMB?null:`${e.label} needs roughly ${Math.round(e.vramRequiredMB)} MB of GPU memory; this device looks like it has about ${Math.round(n)} MB available. It may still work, but expect it to fail or fall back to slow shared memory — try a smaller model (e.g. SmolLM2 360M) if it doesn't load.`}async function yi(e){try{const{hasModelInCache:n}=await pe(async()=>{const{hasModelInCache:t}=await import("./vendor-webllm-DT0Ab8E6.js");return{hasModelInCache:t}},[]);return await n(e)}catch{return!1}}function mn(e){return/device (was )?lost|device_hung|device_removed|already been disposed|gpudevicelostinfo/i.test(e)}function Xn(){return"The GPU device was lost — the driver reset while the model was loading or running. This is a browser/driver-level failure, not a problem with the model: fully quit and reopen the browser (a lost device usually persists for the life of the GPU process), check chrome://gpu still reports hardware acceleration, and update your GPU driver if it recurs. The Scripted and Endpoint brains don't use the GPU at all."}class an{constructor(){F(this,"kind","browser");F(this,"model",null);F(this,"engine",null);F(this,"worker",null);F(this,"generation",0);F(this,"chat",async(n,t=512,r)=>{var s,l;const o=this.engine;if(!o||!this.model)throw new Error("BrowserBrain.chat called before connect()");try{const m=await o.chat.completions.create({messages:n,temperature:0,max_tokens:t,stream:!0});let h="";for await(const a of m){const p=((l=(s=a.choices[0])==null?void 0:s.delta)==null?void 0:l.content)??"";p&&(h+=p,r==null||r(p))}return h}catch(m){const h=m instanceof Error?m.message:String(m);throw mn(h)?(this.teardown(),new Error(`The in-browser model stopped: ${Xn()}`)):m}})}async connect(n=Ct,t){var h,a;const r=await cn();if(r)throw new Error(r);if(this.engine&&this.model===n)return n;const o=++this.generation,s=p=>{o===this.generation&&(t==null||t({progress:p.progress??0,text:p.text??""}))};this.teardown();let l,m;try{const{CreateWebWorkerMLCEngine:p}=await pe(async()=>{const{CreateWebWorkerMLCEngine:u}=await import("./vendor-webllm-DT0Ab8E6.js");return{CreateWebWorkerMLCEngine:u}},[]);m=new Worker(new URL("/pr-preview/pr-107/assets/webllm.worker-Dc1cCqhL.js",import.meta.url),{type:"module"}),l=await p(m,n,{initProgressCallback:s})}catch(p){if(m==null||m.terminate(),o!==this.generation)throw new Error("cancelled");const u=p instanceof Error?p.message:String(p);if(mn(u))throw new Error(`Couldn't load ${n} in the browser (${u}). ${Xn()}`);const d=(a=(h=hn.find(_=>_.id===n))==null?void 0:h.requiredFeatures)==null?void 0:a.includes("shader-f16");throw new Error(`Couldn't load ${n} in the browser (${u}). `+(d?"This model needs WebGPU with shader-f16; try one of the f32 models in the list, or the endpoint brain.":"Try a smaller model, check your connection, or use the endpoint brain instead."))}if(o!==this.generation)throw l.unload().catch(()=>{}),m==null||m.terminate(),new Error("cancelled");return this.engine=l,this.worker=m??null,this.model=n,n}teardown(){const{engine:n,worker:t}=this;this.engine=null,this.worker=null,this.model=null,n==null||n.unload().catch(()=>{}),t==null||t.terminate()}cancelConnect(){this.generation++}dispose(){this.generation++,this.teardown()}}const Bt="http://localhost:11434/v1";function pn(e,n={hostname:(t=>(t=globalThis.location)==null?void 0:t.hostname)()??"",origin:(r=>(r=globalThis.location)==null?void 0:r.origin)()??""}){let o;try{o=new URL(Lt(e)).hostname}catch{return null}const s=l=>l==="localhost"||l==="127.0.0.1"||l==="::1"||l==="[::1]";return!s(o)||s(n.hostname)?null:`This page is served from ${n.origin||"a non-local origin"}, so it can't reach ${e}. A local model server only accepts requests from a page on localhost. Open this page at http://localhost instead, or use the Scripted or In-browser brain.`}function Lt(e){let n=e.trim().replace(/\/+$/,"");return n.endsWith("/chat/completions")&&(n=n.slice(0,-17)),/\/v\d+$/.test(n)||(n=`${n}/v1`),n}class et extends Error{constructor(n,t){super(n),this.status=t,this.name="HttpError"}}class nt{constructor(n=Bt,t="",r=""){F(this,"kind","endpoint");F(this,"baseUrl");F(this,"model",null);F(this,"models",[]);F(this,"apiKey");F(this,"requestedModel");F(this,"chat",async(n,t=512,r)=>{var a,p,u;if(!this.model)throw new Error("EndpointBrain.chat called before connect()");const o=await fetch(`${this.baseUrl}/chat/completions`,{method:"POST",headers:this.headers(),body:JSON.stringify({model:this.model,messages:n,temperature:0,max_tokens:t,stream:!0})});if(!o.ok||!o.body){const d=await o.text().catch(()=>"");throw new Error(`chat/completions HTTP ${o.status} ${o.statusText}${d?` — ${d.slice(0,300)}`:""}`)}const s=o.body.getReader(),l=new TextDecoder;let m="",h="";for(;;){const{value:d,done:_}=await s.read();if(_)break;m+=l.decode(d,{stream:!0});let f;for(;(f=m.indexOf(`
`))>=0;){const y=m.slice(0,f).trim();if(m=m.slice(f+1),!y.startsWith("data:"))continue;const b=y.slice(5).trim();if(b==="[DONE]")continue;let M;try{M=JSON.parse(b)}catch{continue}M.model&&(this.model=M.model);const I=(a=M.choices)==null?void 0:a[0],B=((p=I==null?void 0:I.delta)==null?void 0:p.content)??((u=I==null?void 0:I.message)==null?void 0:u.content)??"";B&&(h+=B,r==null||r(B))}}return h});this.baseUrl=Lt(n),this.apiKey=t.trim(),this.requestedModel=r.trim()}headers(){const n={"Content-Type":"application/json"};return this.apiKey&&(n.Authorization=`Bearer ${this.apiKey}`),n}async listModels(){let n;try{n=await fetch(`${this.baseUrl}/models`,{headers:this.headers()})}catch(r){const o=pn(this.baseUrl);throw new Error(o??`Can't reach ${this.baseUrl} (${r instanceof Error?r.message:String(r)}). Is the server running? For Ollama, check the app is up — and if this page is served from another origin, allow it with OLLAMA_ORIGINS.`)}if(!n.ok)throw new et(`${this.baseUrl}/models returned HTTP ${n.status} ${n.statusText}`,n.status);const t=await n.json();return this.models=(t.data??[]).map(r=>r.id).filter(r=>!!r),this.models}async connect(){try{const n=await this.listModels(),t=this.requestedModel||n[0];if(!t)throw new Error(`No models available at ${this.baseUrl}. Pull one first — e.g. \`ollama pull llama3.2:3b\` — or name one explicitly.`);this.model=t}catch(n){const t=n instanceof et&&[404,405,501].includes(n.status);if(!this.requestedModel||!t)throw n;this.models=[],this.model=this.requestedModel}return await this.validate(),this.model}async validate(){const n=await fetch(`${this.baseUrl}/chat/completions`,{method:"POST",headers:this.headers(),body:JSON.stringify({model:this.model,messages:[{role:"user",content:"Reply with ok."}],temperature:0,max_tokens:1,stream:!1})}).catch(r=>{throw new Error(`Can't reach ${this.baseUrl}/chat/completions (${r instanceof Error?r.message:String(r)}). Check the endpoint URL, API key, model name, and any local CORS settings.`)});if(!n.ok){const r=await n.text().catch(()=>"");throw new Error(`chat/completions HTTP ${n.status} ${n.statusText}${r?` — ${r.slice(0,300)}`:""}`)}const t=await n.json().catch(()=>({}));t.model&&(this.model=t.model)}dispose(){}}const tt="gemini-nano";function un(){const e=globalThis.LanguageModel;return typeof(e==null?void 0:e.create)=="function"&&typeof e.availability=="function"?e:null}function vi(){return un()!==null}async function Rt(){const e=un();if(!e)return"This browser has no built-in AI model. Chrome's Prompt API (Gemini Nano) needs Chrome 138+ on desktop Windows 10/11, macOS 13+, Linux or a Chromebook Plus. Use the Scripted, In-browser (WebGPU) or API endpoint brain instead.";let n;try{n=await e.availability()}catch(t){return`Chrome couldn't report on its built-in model (${t instanceof Error?t.message:String(t)}).`}return n==="unavailable"?"Chrome exposes the built-in AI API here, but Gemini Nano can't run on this device. Chrome requires ~22 GB free on the volume holding your Chrome profile, and either a GPU with more than 4 GB of VRAM or 16 GB of RAM with 4+ CPU cores. Check chrome://on-device-internals for the details.":null}class rt{constructor(){F(this,"kind","chrome");F(this,"model",null);F(this,"warm",null);F(this,"connecting",null);F(this,"chat",async(n,t,r)=>{if(!this.model)throw new Error("ChromeBrain.chat called before connect()");const o=un();if(!o)throw new Error("Chrome's built-in AI API went away.");const s=n.filter(h=>h.role==="system"),l=n.filter(h=>h.role!=="system"),m=await o.create(s.length?{initialPrompts:s}:void 0);try{const h=m.promptStreaming(l).getReader();let a="";for(;;){const{done:p,value:u}=await h.read();if(p)break;u&&(a+=u,r==null||r(u))}return a}finally{m.destroy()}})}async connect(n){const t=await Rt();if(t)throw new Error(t);const r=un();this.dispose();const o=new AbortController;this.connecting=o;try{this.warm=await r.create({signal:o.signal,monitor:s=>{s.addEventListener("downloadprogress",l=>{n==null||n({progress:l.loaded,text:`Downloading Gemini Nano — ${Math.round(l.loaded*100)}%`})})}})}catch(s){if(o.signal.aborted)throw new Error("cancelled");const l=s instanceof Error?s.message:String(s);throw new Error(`Chrome couldn't start its built-in model (${l}). The first run downloads Gemini Nano and must be triggered by a click — press Connect again, and check chrome://on-device-internals if it keeps failing.`)}finally{this.connecting=null}return this.model=tt,tt}cancelConnect(){var n;(n=this.connecting)==null||n.abort()}dispose(){var n;(n=this.warm)==null||n.destroy(),this.warm=null,this.model=null}}const Mi=[{id:"onnx-community/Florence-2-base-ft",label:"Florence-2 base",downloadLabel:"~0.4 GB"},{id:"onnx-community/Florence-2-large-ft",label:"Florence-2 large (higher quality)",downloadLabel:"~1.6 GB"}],Ft=Mi.map(e=>({...e,label:`${e.label} (${e.downloadLabel})`})),zt=Ft[0].id,xi="<OCR>",it="UNKNOWN (scripted brain — connect the in-browser model to read a photo)";function Ni(e,n){if(e)return typeof e=="function"?e(n):e[n]}class Ei{constructor(n){F(this,"kind","scripted-vision");F(this,"model",null);F(this,"read",async(n,t,r)=>{const o=typeof n=="string"?Ni(this.lookup,n)??it:it;return r==null||r(o),o});this.lookup=n}dispose(){}}function ki(e){return new Ei(e)}class ot{constructor(){F(this,"kind","browser-vision");F(this,"model",null);F(this,"modelHandle",null);F(this,"processor",null);F(this,"loadImage",null);F(this,"generation",0);F(this,"read",async(n,t,r)=>{const o=this.modelHandle,s=this.processor,l=this.loadImage;if(!o||!s||!l||!this.model)throw new Error("BrowserVisionBrain.read called before connect()");const m=t&&t.startsWith("<")?t:xi,h=await l(n),a=s.construct_prompts(m),p=await s(h,a),u=await o.generate({...p,max_new_tokens:512,num_beams:1,do_sample:!1}),d=s.batch_decode(u,{skip_special_tokens:!1})[0],_=s.post_process_generation(d,m,h.size),f=Ii(_,m);return r==null||r(f),f})}async connect(n=zt,t){var m,h;const r=await cn("the scripted-vision fallback");if(r)throw new Error(r);if(this.modelHandle&&this.model===n)return n;const o=++this.generation,s=a=>{o===this.generation&&(t==null||t({progress:(a.progress??0)/100,text:a.file?`${a.status??"loading"} ${a.file}`:a.status??""}))};this.teardown();let l;try{const{Florence2ForConditionalGeneration:a,AutoProcessor:p,load_image:u}=await pe(async()=>{const{Florence2ForConditionalGeneration:f,AutoProcessor:y,load_image:b}=await import("./transformers.web-9iRW7sOn.js");return{Florence2ForConditionalGeneration:f,AutoProcessor:y,load_image:b}},[]),d=await a.from_pretrained(n,{dtype:"fp32",device:"webgpu",progress_callback:s}),_=await p.from_pretrained(n);l={model:d,processor:_,loadImage:u}}catch(a){if(o!==this.generation)throw new Error("cancelled");const p=a instanceof Error?a.message:String(a);throw new Error(`Couldn't load ${n} in the browser (${p}). Try the smaller Florence-2 base model, check your connection, or use the scripted-vision fallback.`)}if(o!==this.generation)throw Promise.resolve((h=(m=l.model).dispose)==null?void 0:h.call(m)).catch(()=>{}),new Error("cancelled");return this.modelHandle=l.model,this.processor=l.processor,this.loadImage=l.loadImage,this.model=n,n}teardown(){var t;const n=this.modelHandle;this.modelHandle=null,this.processor=null,this.loadImage=null,this.model=null,Promise.resolve((t=n==null?void 0:n.dispose)==null?void 0:t.call(n)).catch(()=>{})}cancelConnect(){this.generation++}dispose(){this.generation++,this.teardown()}}function Ii(e,n){const t=e[n];if(typeof t=="string")return t.trim();if(t&&typeof t=="object"){const r=t.labels;return Array.isArray(r)?r.join(" ").trim():JSON.stringify(t)}return""}function Ti(){const[e,n]=g.useState("scripted"),[t,r]=g.useState("idle"),[o,s]=g.useState(null),[l,m]=g.useState(null),[h,a]=g.useState(null),[p,u]=g.useState(null),[d,_]=g.useState(null),[f,y]=g.useState(null),[b,M]=g.useState(null),[I,B]=g.useState(Ct),[V,ae]=g.useState(Bt),[ne,xe]=g.useState(""),[Ne,ue]=g.useState([]),[se,J]=g.useState("idle"),[N,E]=g.useState(null),[S,K]=g.useState(""),[L,H]=g.useState(null),Q=g.useRef(null),[he,ze]=g.useState("scripted-vision"),[gn,je]=g.useState("idle"),[Le,ge]=g.useState(null),[Oe,bn]=g.useState(zt),[_n,Se]=g.useState(null),[be,W]=g.useState(null),[fn,qe]=g.useState(null),[Ue,Ee]=g.useState(null),te=g.useRef(null),R=g.useRef(!1),ve=g.useRef(0),Me=g.useCallback(T=>async(...Y)=>{try{return await T.chat(...Y)}catch(D){const Z=D instanceof Error?D.message:String(D);throw T instanceof an&&mn(Z)&&(H(null),m(null),r("error"),s(Z)),D}},[]),ke=g.useCallback(T=>async(...Y)=>{try{return await T.read(...Y)}catch(D){const Z=D instanceof Error?D.message:String(D);throw mn(Z)&&(Ee(null),Se(null),je("error"),ge(Z)),D}},[]);g.useEffect(()=>{cn().then(T=>{_(T),u(T===null)}),Rt().then(M),cn("the scripted-vision fallback").then(T=>{qe(T),R.current||(R.current=!0,ze(T===null?"browser-vision":"scripted-vision"))})},[]),g.useEffect(()=>{let T=!1;return y(null),yi(I).then(Y=>{T||y(Y)}),()=>{T=!0}},[I]),g.useEffect(()=>()=>{var T;return(T=Q.current)==null?void 0:T.dispose()},[]),g.useEffect(()=>()=>{var T;return(T=te.current)==null?void 0:T.dispose()},[]);const en=g.useCallback(T=>{n(T),r("idle"),s(null),m(null),a(null),H(null)},[]),_e=g.useCallback(T=>{var Y,D;R.current=!0,(Y=te.current)==null||Y.cancelConnect(),(D=te.current)==null||D.dispose(),te.current=null,ze(T),je("idle"),ge(null),Se(null),W(null),Ee(null)},[]),Pe=g.useCallback(()=>{var T;(T=Q.current)==null||T.dispose(),Q.current=null,H(null),m(null)},[]),$e=g.useCallback(()=>{const T=Q.current;(T instanceof an||T instanceof rt)&&T.cancelConnect(),Pe(),r("idle"),a(null),s(null)},[Pe]),nn=g.useCallback(async()=>{const T=++ve.current,Y=()=>T!==ve.current,D=pn(V);if(D){ue([]),J("error"),E(D);return}J("loading"),E(null);const Z=new nt(V,S);try{const Ae=await Z.listModels();if(Y())return;ue(Ae),J("ready"),xe(Ve=>Ve&&Ae.includes(Ve)?Ve:Ae[0]??"")}catch(Ae){if(Y())return;ue([]),xe(""),J("error"),E(Ae instanceof Error?Ae.message:String(Ae))}finally{Z.dispose()}},[V,S]),Ge=g.useCallback(async()=>{var T,Y;if(e==="scripted"){H(null),r("ready");return}if(e==="endpoint"){const D=pn(V);if(D){Pe(),s(D),r("error");return}}r("connecting"),s(null),a(null);try{if(e==="browser"){const D=Q.current instanceof an?Q.current:new an;Q.current&&Q.current!==D&&Q.current.dispose(),Q.current=D;const Z=await D.connect(I,a);m(Z),H(()=>Me(D)),y(!0)}else if(e==="chrome"){(T=Q.current)==null||T.dispose();const D=new rt;Q.current=D;const Z=await D.connect(a);M(null),m(Z),H(()=>Me(D))}else{(Y=Q.current)==null||Y.dispose();const D=new nt(V,S,ne);Q.current=D;const Z=await D.connect();m(Z),H(()=>Me(D))}r("ready")}catch(D){const Z=D instanceof Error?D.message:String(D);if(Z==="cancelled")return;s(Z),r("error"),H(null)}finally{a(null)}},[e,I,V,ne,S,Pe,Me]),Ie=g.useCallback(()=>{var T;(T=te.current)==null||T.dispose(),te.current=null,Ee(null),Se(null)},[]),Je=g.useCallback(()=>{var T;(T=te.current)==null||T.cancelConnect(),Ie(),je("idle"),W(null),ge(null)},[Ie]),wn=g.useCallback(async()=>{if(he==="scripted-vision"){Ie(),je("ready"),ge(null);return}je("connecting"),ge(null),W(null);try{const T=te.current instanceof ot?te.current:new ot;te.current&&te.current!==T&&te.current.dispose(),te.current=T;const Y=await T.connect(Oe,W);Se(Y),Ee(()=>ke(T)),je("ready")}catch(T){const Y=T instanceof Error?T.message:String(T);if(Y==="cancelled")return;ge(Y),je("error"),Ee(null),Se(null)}finally{W(null)}},[he,Oe,Ie,ke]);return{kind:e,setKind:en,status:t,error:o,modelInUse:l,progress:h,webgpu:p,webgpuReason:d,browserModelCached:f,chromeAiReason:b,cancelConnect:$e,browserModel:I,setBrowserModel:B,endpointUrl:V,setEndpointUrl:ae,endpointModel:ne,setEndpointModel:xe,endpointModels:Ne,endpointModelsStatus:se,endpointModelsError:N,listEndpointModels:nn,apiKey:S,setApiKey:K,connect:Ge,chat:L,visionKind:he,setVisionKind:_e,visionStatus:gn,visionError:Le,visionModel:Oe,setVisionModel:bn,visionModelInUse:_n,visionProgress:be,visionWebgpuReason:fn,connectVision:wn,cancelVisionConnect:Je,vision:Ue}}const Cn="#s=",ji=["scripted","browser","chrome","endpoint"];function Si(e){return typeof e=="string"&&ji.includes(e)}function Pi(e){try{const n=JSON.parse(e);if(n&&typeof n=="object"){const t=n,r={};return Si(t.brain)&&(r.brain=t.brain),r}}catch{}return{}}function Ot(e=location.hash){if(!e.startsWith(Cn))return{};let n;try{n=decodeURIComponent(e.slice(Cn.length))}catch{return{}}return Pi(n)}function Ai(e){const n=Object.entries(e).filter(([,t])=>t!==void 0);return n.length===0?"":Cn+encodeURIComponent(JSON.stringify(Object.fromEntries(n)))}function Ci(e){const n={...Ot(),...e},t=Ai(n),r=new URL(location.href);r.hash=t,history.replaceState(history.state,"",r)}const at=[{kind:"scripted",label:"Scripted",hint:"No model. The example's stand-in decides — deterministic and offline."},{kind:"browser",label:"In-browser (WebGPU)",hint:"A small quantised model on your GPU. First run downloads weights."},{kind:"chrome",label:"Chrome built-in",hint:"Gemini Nano, built into Chrome. Chrome owns the weights — no download from this page, no API key."},{kind:"endpoint",label:"API endpoint",hint:"Any OpenAI-compatible server. Ollama by default. Local pages only."}],st=[{kind:"scripted-vision",label:"Scripted",hint:"No model. The example's known plate is returned — deterministic and offline."},{kind:"browser-vision",label:"In-browser (WebGPU)",hint:"Reads the photo with a vision model on your GPU. First run downloads weights."}];function Di({brain:e,showText:n=!0,showVision:t=!1}){return i.jsxs("div",{className:"brain",children:[n&&i.jsx(Bi,{brain:e}),n&&t&&i.jsx("hr",{className:"brain-divider"}),t&&i.jsx(Li,{brain:e})]})}function Bi({brain:e}){const n=at.find(d=>d.kind===e.kind),t=at.filter(d=>d.kind!=="chrome"||vi()),r=pn(e.endpointUrl),[o,s]=g.useState(hn);g.useEffect(()=>{fi().then(s)},[]);const{kind:l,endpointUrl:m,apiKey:h,listEndpointModels:a}=e;g.useEffect(()=>{if(l!=="endpoint"||r)return;const d=setTimeout(()=>void a(),400);return()=>clearTimeout(d)},[l,m,h,r,a]);const p=o.find(d=>d.id===e.browserModel),u=p?wi(p,Dt()):null;return i.jsxs("div",{className:"brain-section",children:[i.jsxs("div",{className:"brain-modes",children:[i.jsx("div",{className:"brain-kinds",role:"group","aria-label":"Agent brain",children:t.map(d=>i.jsx(q,{size:"sm",variant:e.kind===d.kind?"default":"secondary","aria-pressed":e.kind===d.kind,onClick:()=>e.setKind(d.kind),children:d.label},d.kind))}),i.jsxs("div",{className:"brain-status",children:[e.status==="ready"&&e.kind!=="scripted"&&i.jsx(oe,{variant:"success",className:"brain-status-badge",children:e.modelInUse??"connected"}),e.status==="connecting"&&i.jsx(oe,{variant:"info",className:"brain-status-badge",children:"connecting…"}),e.status==="error"&&i.jsx(oe,{variant:"danger",className:"brain-status-badge",children:"not connected"})]})]}),i.jsx("p",{className:"field-hint",children:n.hint}),e.kind==="browser"&&i.jsxs("div",{className:"brain-config",children:[i.jsxs("div",{className:"field",children:[i.jsx(Qe,{htmlFor:"browser-model",children:"Model"}),i.jsxs(Nn,{value:e.browserModel,onValueChange:e.setBrowserModel,disabled:e.status==="connecting",children:[i.jsx(En,{id:"browser-model",children:i.jsx(kn,{})}),i.jsx(In,{children:o.map(d=>i.jsx(Tn,{value:d.id,children:d.label},d.id))})]}),e.browserModelCached===!0&&i.jsx("p",{className:"field-hint",children:"Already downloaded in this browser — connecting will be fast."}),e.browserModelCached===!1&&i.jsx("p",{className:"field-hint",children:"Not downloaded yet — connecting fetches the weights once, then caches them for next time."})]}),e.webgpu===!1&&e.webgpuReason&&i.jsxs(de,{variant:"destructive",children:[i.jsx(le,{children:"No WebGPU in this browser"}),i.jsx(ce,{children:e.webgpuReason})]}),e.webgpu!==!1&&u&&i.jsxs(de,{variant:"destructive",children:[i.jsx(le,{children:"This model may not fit in GPU memory"}),i.jsx(ce,{children:u})]})]}),e.kind==="chrome"&&i.jsxs("div",{className:"brain-config",children:[i.jsx("p",{className:"field-hint",children:"Nothing to configure: Chrome downloads and manages Gemini Nano itself, so the first Connect may fetch it once and later visits reuse it. Prompts never leave your machine. It's a very small model — expect it to follow the tool-calling format less reliably than an endpoint model."}),e.chromeAiReason&&i.jsxs(de,{variant:"destructive",children:[i.jsx(le,{children:"Chrome's built-in model isn't available here"}),i.jsx(ce,{children:e.chromeAiReason})]})]}),e.kind==="endpoint"&&i.jsxs("div",{className:"brain-config",children:[i.jsxs("div",{className:"field",children:[i.jsx(Qe,{htmlFor:"endpoint-url",children:"Endpoint"}),i.jsx(Vn,{id:"endpoint-url",value:e.endpointUrl,onChange:d=>e.setEndpointUrl(d.target.value),disabled:e.status==="connecting"}),i.jsxs("p",{className:"field-hint",children:["Ollama allows ",i.jsx("code",{children:"localhost"})," origins out of the box; set"," ",i.jsx("code",{children:"OLLAMA_ORIGINS"})," only when serving this page from another host. Best for local development — a hosted copy of this page can't reach a server on your machine at all."]}),r&&i.jsxs(de,{variant:"destructive",children:[i.jsx(le,{children:"A local server won't work from this URL"}),i.jsx(ce,{children:r})]})]}),i.jsxs("div",{className:"field",children:[i.jsx(Qe,{htmlFor:"endpoint-model",children:"Model"}),i.jsxs("div",{className:"endpoint-model-row",children:[i.jsxs(Nn,{value:e.endpointModel,onValueChange:e.setEndpointModel,disabled:e.status==="connecting"||e.endpointModelsStatus==="loading"||e.endpointModels.length===0,children:[i.jsx(En,{id:"endpoint-model",className:"endpoint-model-select",children:i.jsx(kn,{placeholder:e.endpointModelsStatus==="loading"?"Loading models…":e.endpointModelsStatus==="idle"?"Enter an endpoint above":e.endpointModelsStatus==="error"?"No models — check the endpoint":e.endpointModels.length===0?"No models served":"Select a model"})}),i.jsx(In,{children:e.endpointModels.map(d=>i.jsx(Tn,{value:d,children:d},d))})]}),i.jsx(q,{size:"sm",variant:"secondary",onClick:()=>void e.listEndpointModels(),disabled:e.status==="connecting"||e.endpointModelsStatus==="loading"||r!==null,children:e.endpointModelsStatus==="loading"?"Refreshing…":"Refresh"})]}),i.jsxs("p",{className:"field-hint",children:["Fetched from the endpoint's ",i.jsx("code",{children:"/models"}),". Tiny models (e.g. SmolLM2) usually can't follow the tool-calling format — prefer ",i.jsx("code",{children:"llama3.2:3b"}),", ",i.jsx("code",{children:"qwen2.5"})," or larger."]}),e.endpointModelsStatus==="error"&&!r&&i.jsxs(de,{variant:"destructive",children:[i.jsx(le,{children:"Couldn't list models"}),i.jsx(ce,{children:e.endpointModelsError})]})]}),i.jsxs("div",{className:"field",children:[i.jsx(Qe,{htmlFor:"endpoint-key",children:"API key (optional)"}),i.jsx(Vn,{id:"endpoint-key",type:"password",value:e.apiKey,onChange:d=>e.setApiKey(d.target.value),disabled:e.status==="connecting"})]})]}),e.kind!=="scripted"&&i.jsxs("div",{className:"brain-actions",children:[i.jsx(q,{size:"sm",onClick:()=>void e.connect(),disabled:e.status==="connecting"||e.kind==="chrome"&&e.chromeAiReason!==null||e.kind==="endpoint"&&(e.endpointModel===""||e.endpointModelsStatus==="loading"||r!==null),children:e.status==="ready"?"Reconnect":"Connect"}),e.status==="connecting"&&(e.kind==="browser"||e.kind==="chrome")&&i.jsx(q,{size:"sm",variant:"secondary",onClick:e.cancelConnect,children:"Cancel"}),e.progress&&i.jsxs("span",{className:"field-hint",children:[Math.round(e.progress.progress*100),"% —"," ",e.progress.text]})]}),e.progress&&i.jsx("div",{className:"brain-progress",role:"progressbar","aria-valuenow":Math.round(e.progress.progress*100),"aria-valuemin":0,"aria-valuemax":100,children:i.jsx("div",{className:"brain-progress-bar",style:{width:`${Math.round(e.progress.progress*100)}%`}})}),e.error&&i.jsxs(de,{variant:"destructive",children:[i.jsx(le,{children:"Couldn't connect"}),i.jsx(ce,{children:e.error})]})]})}function Li({brain:e}){const n=st.find(t=>t.kind===e.visionKind);return i.jsxs("div",{className:"brain-section brain-vision",children:[i.jsx(Qe,{children:"Vision (reads the image)"}),i.jsxs("div",{className:"brain-modes",children:[i.jsx("div",{className:"brain-kinds",role:"group","aria-label":"Vision brain",children:st.map(t=>i.jsx(q,{size:"sm",variant:e.visionKind===t.kind?"default":"secondary","aria-pressed":e.visionKind===t.kind,onClick:()=>e.setVisionKind(t.kind),children:t.label},t.kind))}),i.jsxs("div",{className:"brain-status",children:[e.visionStatus==="ready"&&e.visionKind==="browser-vision"&&i.jsx(oe,{variant:"success",className:"brain-status-badge",children:e.visionModelInUse??"connected"}),e.visionStatus==="connecting"&&i.jsx(oe,{variant:"info",className:"brain-status-badge",children:"connecting…"}),e.visionStatus==="error"&&i.jsx(oe,{variant:"danger",className:"brain-status-badge",children:"not connected"})]})]}),i.jsx("p",{className:"field-hint",children:n.hint}),e.visionKind==="scripted-vision"&&e.webgpu===!1&&e.visionWebgpuReason&&i.jsxs(de,{variant:"destructive",children:[i.jsx(le,{children:"No WebGPU in this browser"}),i.jsx(ce,{children:e.visionWebgpuReason})]}),e.visionKind==="browser-vision"&&i.jsxs("div",{className:"brain-config",children:[i.jsxs("div",{className:"field",children:[i.jsx(Qe,{htmlFor:"vision-model",children:"Model"}),i.jsxs(Nn,{value:e.visionModel,onValueChange:e.setVisionModel,disabled:e.visionStatus==="connecting",children:[i.jsx(En,{id:"vision-model",children:i.jsx(kn,{})}),i.jsx(In,{children:Ft.map(t=>i.jsx(Tn,{value:t.id,children:t.label},t.id))})]}),i.jsx("p",{className:"field-hint",children:"Connecting downloads the weights once (size shown above), then caches them — every token is read on your GPU, no server."})]}),e.webgpu===!1&&e.visionWebgpuReason&&i.jsxs(de,{variant:"destructive",children:[i.jsx(le,{children:"No WebGPU in this browser"}),i.jsx(ce,{children:e.visionWebgpuReason})]})]}),e.visionKind==="browser-vision"&&i.jsxs("div",{className:"brain-actions",children:[i.jsx(q,{size:"sm",onClick:()=>void e.connectVision(),disabled:e.visionStatus==="connecting",children:e.visionStatus==="ready"?"Reconnect":"Connect"}),e.visionStatus==="connecting"&&i.jsx(q,{size:"sm",variant:"secondary",onClick:e.cancelVisionConnect,children:"Cancel"}),e.visionProgress&&i.jsxs("span",{className:"field-hint",children:[Math.round(e.visionProgress.progress*100),"% —"," ",e.visionProgress.text]})]}),e.visionError&&i.jsxs(de,{variant:"destructive",children:[i.jsx(le,{children:"Couldn't connect the vision brain"}),i.jsx(ce,{children:e.visionError})]})]})}function Ri({imageInput:e,value:n,onSelect:t,disabled:r=!1}){const[o,s]=g.useState(null),[l,m]=g.useState(!1),h=g.useRef(null),a=g.useId(),p=g.useId(),u=g.useCallback(f=>{s(URL.createObjectURL(f)),t({imageName:f.name,pixels:f})},[t]);g.useEffect(()=>{if(o)return()=>URL.revokeObjectURL(o)},[o]);const d=g.useCallback(f=>{const y=f==null?void 0:f[0];y&&y.type.startsWith("image/")&&u(y)},[u]),_=(n==null?void 0:n.imageId)!=null?e.seedImages.find(f=>f.id===n.imageId):void 0;return i.jsxs("div",{className:"image-input",children:[e.label&&i.jsx("p",{className:"field-hint",children:e.label}),i.jsx("p",{className:"image-input-label",id:a,children:"Seed photos"}),i.jsx("div",{className:"image-gallery",role:"group","aria-labelledby":a,children:e.seedImages.map(f=>{const y=(n==null?void 0:n.imageId)===f.id;return i.jsxs("button",{type:"button","aria-pressed":y,className:`image-thumb${y?" image-thumb--selected":""}`,disabled:r,title:f.label??f.id,onClick:()=>{s(null),h.current&&(h.current.value=""),t({imageId:f.id,pixels:f.file})},children:[i.jsx("img",{src:f.thumb??f.file,alt:f.label??f.id}),f.label&&i.jsx("span",{children:f.label})]},f.id)})}),i.jsx("label",{className:"image-input-label",htmlFor:p,children:"Or upload your own photo"}),i.jsxs("div",{className:`image-drop${l?" image-drop--over":""}`,onDragOver:f=>{f.preventDefault(),r||m(!0)},onDragLeave:()=>m(!1),onDrop:f=>{f.preventDefault(),m(!1),r||d(f.dataTransfer.files)},children:[i.jsx("input",{ref:h,id:p,type:"file",accept:"image/*",disabled:r,onChange:f=>d(f.target.files)}),i.jsx("p",{className:"field-hint",children:"Drag a photo here, or pick one. Uploading a photo the model has never seen is the proof this runs for real — nothing leaves your browser."})]}),(o||_)&&i.jsxs("div",{className:"image-preview",children:[i.jsx("img",{src:o??(_==null?void 0:_.file),alt:o?(n==null?void 0:n.imageName)??"uploaded photo":(_==null?void 0:_.label)??(_==null?void 0:_.id)??"selected photo"}),i.jsx("span",{className:"field-hint",children:o?`Uploaded: ${(n==null?void 0:n.imageName)??"your photo"}`:`Selected: ${(_==null?void 0:_.label)??(_==null?void 0:_.id)}`}),i.jsx("button",{type:"button",className:"image-clear-btn",disabled:r,onClick:()=>{s(null),h.current&&(h.current.value=""),t(null)},children:"Clear"})]})]})}function Ut(e){return typeof e=="object"&&e!==null}function Md(e){const n=new Set,t=r=>{Ut(r)&&(typeof r.key=="string"&&n.add(r.key),Array.isArray(r.components)&&r.components.forEach(t))};return t(e),n}function Fi(e){const n={},t=r=>{Ut(r)&&(typeof r.key=="string"&&"defaultValue"in r&&(n[r.key]=r.defaultValue??""),Array.isArray(r.components)&&r.components.forEach(t))};return t(e),n}const zi="wdf:section:v2:";function $t(e){return zi+e}function dt(e){try{const n=window.localStorage.getItem($t(e));return n==="1"?!0:n==="0"?!1:void 0}catch{return}}function Oi(e,n){try{window.localStorage.setItem($t(e),n?"1":"0")}catch{}}function Bn(e,n=!0){const[t,r]=g.useState(()=>dt(e)??n);g.useEffect(()=>{r(dt(e)??n)},[e,n]);const o=g.useCallback(s=>{r(s),Oi(e,s)},[e]);return[t,o]}function Fe({sectionId:e,title:n,description:t,defaultOpen:r=!0,className:o,children:s,...l}){const[m,h]=Bn(e,r);return i.jsx(Jt,{className:["panel",o].filter(Boolean).join(" "),"data-tour":l["data-tour"],children:i.jsxs(Ht,{open:m,onOpenChange:h,children:[i.jsxs(Wt,{className:"panel-trigger",children:[i.jsxs("span",{className:"panel-trigger-text",children:[i.jsx("span",{className:"panel-title",children:n}),t!=null&&i.jsx("span",{className:"panel-desc",children:t})]}),i.jsx(Zt,{className:"panel-chevron","aria-hidden":!0})]}),i.jsx(Kt,{children:i.jsx(Xt,{children:s})})]})})}function Ui(e){return e.entries!==void 0}function $i(e){const n=[];let t=null;for(const r of e)r.turn!==void 0?t&&t.turn===r.turn?t.entries.push(r):(t={turn:r.turn,entries:[r]},n.push(t)):(t=null,n.push(r));return n}function lt(e){if(e===void 0)return"undefined";try{return JSON.stringify(e)}catch{return"[unserializable value]"}}function Gi({activation:e,result:n,labelFor:t}){const r=e.elementId??"";return i.jsxs("div",{className:"timeline-tool",children:[i.jsxs("div",{className:"timeline-tool-head",children:[i.jsx(oe,{variant:"info",children:"tool"}),i.jsx("strong",{children:t(r)||r}),i.jsx("code",{children:r})]}),e.args!==void 0&&Object.keys(e.args).length>0&&i.jsxs("div",{className:"timeline-kv",children:[i.jsx("span",{className:"timeline-kv-label",children:"arguments"}),i.jsx("code",{children:lt(e.args)})]}),i.jsxs("div",{className:"timeline-kv",children:[i.jsx("span",{className:"timeline-kv-label",children:"returned"}),i.jsx("code",{children:n?lt(n.result):"— waiting for the job to complete —"})]})]})}function Vi({group:e,labelFor:n}){const t=e.entries.find(a=>a.kind==="llm"),r=e.entries.filter(a=>a.kind==="agent"&&a.elementId),o=e.entries.filter(a=>a.kind==="vars"&&a.elementId),s=e.entries.filter(a=>a.kind==="agent"&&!a.elementId),l=e.entries.filter(a=>a.kind==="error"),m=new Set(r.map(a=>a.elementId)),h=e.entries.filter(a=>a.kind==="tool"||a.kind==="vars"&&a.elementId&&!m.has(a.elementId)).sort((a,p)=>a.id-p.id);return i.jsxs("div",{className:"timeline-turn",children:[i.jsxs("div",{className:"timeline-turn-head",children:[i.jsxs(oe,{variant:t!=null&&t.pending?"warning":"neutral",children:["Turn ",e.turn]}),(t==null?void 0:t.pending)&&i.jsx("span",{className:"timeline-pending",children:"thinking…"})]}),t&&i.jsx("blockquote",{className:"timeline-reply",children:t.text}),s.map(a=>i.jsx("div",{className:"timeline-note",children:a.text},a.id)),r.map(a=>i.jsx(Gi,{activation:a,result:o.find(p=>p.elementId===a.elementId),labelFor:n},a.id)),h.map(a=>i.jsxs("div",{className:`log-line log-${a.kind}`,children:[a.pending?"⏳ ":"",a.text]},a.id)),l.map(a=>i.jsxs("div",{className:"timeline-error",children:["⚠ ",a.text]},a.id))]})}function Yi({log:e,elementStats:n=[],incidents:t=[],labelFor:r=s=>s,variables:o}){const s=g.useMemo(()=>$i(e),[e]),[l,m]=g.useState(!1),[h,a]=Bn("engine-view",!1),p=g.useRef(null);g.useEffect(()=>{const d=p.current;d&&(d.scrollTop=d.scrollHeight)},[s]);const u=()=>{var f;const d={log:e.map(({id:y,...b})=>b),elementStats:n,incidents:t},_=JSON.stringify(d,null,2);(f=navigator.clipboard)!=null&&f.writeText&&navigator.clipboard.writeText(_).then(()=>{m(!0),setTimeout(()=>m(!1),1500)}).catch(()=>{})};return i.jsxs(Fe,{sectionId:"activity",className:"grow activity-card",title:"Agent activity",description:"Agent turns, model replies, and tool calls — read top to bottom as a story.",children:[i.jsx("div",{className:"timeline-toolbar",children:i.jsx(q,{variant:"secondary",size:"sm",onClick:u,children:l?"Copied!":"Copy run as JSON"})}),i.jsx("div",{className:"timeline",ref:p,children:s.length===0?i.jsx("div",{className:"log-empty",children:"Press Run or Step to start."}):s.map(d=>Ui(d)?i.jsx(Vi,{group:d,labelFor:r},`turn-${d.turn}-${d.entries[0].id}`):i.jsxs("div",{className:`log-line log-${d.kind}`,children:[d.pending?"⏳ ":"",d.text]},d.id))}),o,(n.length>0||t.length>0)&&i.jsxs("details",{className:"engine-view",open:h,onToggle:d=>a(d.currentTarget.open),children:[i.jsxs("summary",{children:["Element completion",t.length>0&&` · ${t.length} incident${t.length===1?"":"s"}`]}),i.jsxs("div",{className:"timeline-engine-view",children:[n.length>0&&i.jsxs("div",{className:"timeline-stats",children:[i.jsx("span",{className:"timeline-kv-label",children:"Element completion"}),i.jsx("ul",{children:n.filter(d=>d.completed>0||(d.active??0)>0).map(d=>i.jsxs("li",{children:[i.jsx("code",{children:r(d.elementId)||d.elementId})," ","completed ",d.completed,d.active?`, ${d.active} active`:""]},d.elementId))})]}),t.length>0&&i.jsxs("div",{className:"timeline-incidents",children:[i.jsx("span",{className:"timeline-kv-label",children:"Incidents"}),i.jsx("ul",{children:t.map((d,_)=>i.jsxs("li",{children:[i.jsx("code",{children:r(d.elementId)||d.elementId})," —"," ",d.reason]},`${d.elementId}-${_}`))})]})]})]})]})}const Te={diagram:"diagram",runButton:"run-button",variablesPanel:"variables-panel",codePanel:"code-panel",brainPanel:"brain-panel"};function ct(e){return`[data-tour="${e}"]`}function Qi(e=location.search){return new URLSearchParams(e).get("tour")}function qi(e,n){var t;return((t=e.elementStats.find(r=>r.elementId===n))==null?void 0:t.completed)??0}function Ji(e,n){return!e||e.kind==="click"||!n?!1:e.kind==="activeElement"?n.activeElementIds.includes(e.elementId):qi(n,e.elementId)>=(e.atLeast??1)}function Hi(e){return"anchor"in e?ct(e.anchor):`${ct(Te.diagram)} [data-element-id="${Wi(e.elementId)}"]`}function Wi(e){return typeof CSS<"u"&&typeof CSS.escape=="function"?CSS.escape(e):e.replace(/[^a-zA-Z0-9_-]/g,n=>`\\${n}`)}function Zi(e){return e.map(n=>{const t=!!n.waitFor&&n.waitFor.kind!=="click";return{element:Hi(n.target),popover:{title:n.title,description:t?`${n.description} (continues automatically once you reach that point — or use Next to skip ahead)`:n.description,showButtons:["next","previous","close"]},disableActiveInteraction:!1,skipMissingElement:n.skipMissingElement??!0}})}async function Ki(e,n={}){var s;const[{driver:t}]=await Promise.all([pe(()=>import("./driver.js-bj_ppY-Q.js"),[]),pe(()=>Promise.resolve({}),__vite__mapDeps([0]))]),r=Zi(e),o=t({steps:r,showProgress:!0,allowClose:!0,skipMissingElement:!0,onHighlighted:(l,m,{index:h})=>{var a;h!==void 0&&((a=n.onIndexChange)==null||a.call(n,h))},onDestroyed:()=>{var l;(l=n.onDestroyed)==null||l.call(n)}});return o.drive(),(s=n.onIndexChange)==null||s.call(n,o.getActiveIndex()??0),{moveNext:()=>o.moveNext(),activeIndex:()=>o.getActiveIndex()??-1,destroy:()=>o.destroy()}}const Xi=300;function eo(e,n){const[t,r]=g.useState(!1),o=g.useRef(null),s=g.useRef(0),l=g.useRef(-1),m=g.useRef(null),h=g.useRef(n);g.useEffect(()=>{h.current=n},[n]);const a=g.useCallback(()=>{m.current!==null&&(clearInterval(m.current),m.current=null)},[]),p=g.useRef(0),u=g.useCallback(()=>{var _;p.current+=1,a(),(_=o.current)==null||_.destroy(),o.current=null,r(!1)},[a]),d=g.useCallback(()=>{if(!e||e.steps.length===0||o.current)return;const _=p.current+=1;Ki(e.steps,{onIndexChange:f=>{s.current=f},onDestroyed:()=>{a(),o.current=null,r(!1)}}).then(f=>{if(_!==p.current){f.destroy();return}o.current=f,r(!0),m.current=setInterval(()=>{const y=s.current;if(y===l.current)return;const b=e.steps[y];b&&Ji(b.waitFor,h.current())&&(l.current=y,f.moveNext())},Xi)})},[e,a]);return g.useEffect(()=>u,[u]),{active:t,start:d,stop:u}}const Ce=650,vn="__agent__",mt="__model__",pt="__template__:",no=g.lazy(async()=>{await Promise.all([pe(()=>Promise.resolve({}),__vite__mapDeps([1])),pe(()=>Promise.resolve({}),__vite__mapDeps([2])),pe(()=>Promise.resolve({}),__vite__mapDeps([3]))]);const{RuntimeDiagram:e}=await pe(async()=>{const{RuntimeDiagram:n}=await import("./RuntimeDiagram-DTnJz5cT.js");return{RuntimeDiagram:n}},__vite__mapDeps([4,5,6]));return{default:e}}),Mn=g.lazy(()=>pe(()=>import("./MonacoEditor-D0O6ZIMY.js").then(e=>e.M),__vite__mapDeps([7,5,8]))),to=g.lazy(()=>pe(()=>import("./vendor-modeler-DdWqT7hy.js"),__vite__mapDeps([9,5,6,10,11,12,13,1,2,3]))),ut=g.lazy(async()=>{const{FormRenderer:e}=await pe(async()=>{const{FormRenderer:n}=await import("./FormRenderer-Xl_-2lYL.js");return{FormRenderer:n}},__vite__mapDeps([14,5,12,10,11,15]));return{default:e}});function ln(e,n){try{return JSON.stringify(e??{},null,n)}catch{return"[unserializable value]"}}function ro(e){const n=ln(e).replace(/\s+/g," ");return n.length>78?`${n.slice(0,78)}…`:n}function io({example:e,initialBrainKind:n,initialTourId:t}){var Ve,Rn,Fn,zn,On,Un,$n,Gn;const[r,o]=g.useState(e.bpmn),s=Ti(),[l,m]=g.useState(null);g.useEffect(()=>{n&&n!==s.kind&&s.setKind(n)},[]),g.useEffect(()=>{Ci({brain:s.kind})},[s.kind]);const[h,a]=g.useState(()=>Object.fromEntries(e.handlers.map(v=>[v.elementId,v.source]))),[p,u]=g.useState(e.scriptedAgent??""),[d,_]=g.useState(()=>Xe(e.templates)),f=g.useMemo(()=>Fr(e,h,r,d),[e,h,r,d]),y=f.model,b=pi({bpmn:f.resolvedBpmn}),M=eo(e.tour,()=>b.snapshot);g.useEffect(()=>{var v;t&&((v=e.tour)==null?void 0:v.id)===t&&M.start()},[]);const I=y.startFormId?((Ve=e.forms)==null?void 0:Ve[y.startFormId])??null:null,[B,V]=g.useState(()=>({...e.seed,...I?Fi(I):{}})),[ae,ne]=g.useState(y.agent?vn:((Rn=e.handlers[0])==null?void 0:Rn.elementId)??""),xe=g.useMemo(()=>{const v=(e.scenarios??[]).findIndex(x=>Object.entries(x.variables).every(([k,C])=>JSON.stringify(B[k])===JSON.stringify(C)));return v===-1?null:v},[e.scenarios,B]),[Ne,ue]=Bn("start",!!I),[se,J]=g.useState(!1),[N,E]=g.useState(!1),[S,K]=g.useState(null),[L,H]=g.useState([]),[Q,he]=g.useState({}),ze=g.useMemo(()=>({...e.seed,...B,...wr(e.imageInput?l:null)}),[e.seed,e.imageInput,B,l]),[gn,je]=g.useState(!1),Le=g.useRef(null),[ge,Oe]=g.useState({}),[bn,_n]=g.useState(!1),Se=g.useRef(null),be=g.useRef(!1),W=g.useRef(0),fn=g.useRef(0),qe=g.useRef({current:void 0}),Ue=g.useRef({}),Ee=g.useRef({}),te=g.useMemo(()=>{const v=new Map;for(const x of y.processes){for(const k of x.tasks)v.set(k.elementId,k.label);for(const k of x.agents){v.set(k.elementId,k.label);for(const C of k.tools)v.set(C.elementId,C.label)}for(const k of x.userTasks)v.set(k.elementId,k.label)}return x=>v.get(x)??x},[y]),R=g.useCallback(v=>{H(x=>{if(v.key){const k=x.findIndex(C=>C.key===v.key);if(k>=0){const C=[...x];return C[k]={...C[k],...v},C}}return[...x,{...v,id:fn.current++}].slice(-80)})},[]),ve=g.useMemo(()=>{var v;return((v=b.snapshot)==null?void 0:v.userTasks.find(x=>x.state==="Created"))??null},[b.snapshot]),Me=g.useMemo(()=>{const v=y.processes.flatMap(k=>k.tasks),x=new Map;for(const k of e.handlers){if(!k.manualControl)continue;const C=v.find(P=>P.elementId===k.elementId);C&&x.set(C.jobType,{...k.manualControl,elementId:k.elementId})}return x},[e.handlers,y]),ke=g.useMemo(()=>{if(!b.snapshot)return null;for(const v of b.snapshot.jobs){const x=Me.get(v.jobType);if(x&&v.state==="Created")return{job:v,control:x}}return null},[b.snapshot,Me]),en=g.useMemo(()=>{if(!y.agent||!b.snapshot)return[];const v=new Map(b.snapshot.elementStats.map(x=>[x.elementId,x.completed]));return y.agent.tools.filter(x=>(v.get(x.elementId)??0)===0)},[y.agent,b.snapshot]),_e=ve?y.userTasks.find(v=>v.elementId===ve.elementId):void 0,Pe=_e!=null&&_e.formId?((Fn=e.forms)==null?void 0:Fn[_e.formId])??null:null,$e=g.useCallback(async(v,x,k,C)=>{var me,re,we;let P=k,fe=0;for(;W.current===C&&P&&P.completedInstances<1&&fe++<80;){const $=await b.stepWorkers(v,{agents:x});if(W.current!==C)return P;P=($==null?void 0:$.snapshot)??P;const ie=(me=P.instances[0])==null?void 0:me.variables;if(ie&&he({...ie}),P.userTasks.some(G=>G.state==="Created")){R({kind:"human",text:"⏸ waiting for a human — complete the task below to continue"});break}if(!$){R({kind:"error",text:"▶ run stopped — no dispatch round was returned"});break}if($.handled===0){const G=P.messageSubscriptions[0];if($.reason==="messages"&&G){if(R({kind:"step",text:`⏳ parked on a message catch event — waiting for "${G.messageName}"`,elementId:G.elementId}),await new Promise(X=>setTimeout(X,Ce)),W.current!==C)return P;R({kind:"vars",text:`📨 correlating message "${G.messageName}" (key: ${G.correlationKey})`,elementId:G.elementId});const U=b.correlateMessage(G.messageName,G.correlationKey,"{}");if(U){P=U;const X=(re=P.instances[0])==null?void 0:re.variables;X&&he({...X}),await new Promise(ye=>setTimeout(ye,Ce));continue}R({kind:"error",text:`▶ run stopped — correlating "${G.messageName}" (key: ${G.correlationKey}) failed`,elementId:G.elementId})}if($.reason==="signals"&&P.signalSubscriptions.length>0){const U=P.signalSubscriptions[0],X=P.signalSubscriptions.length;if(R({kind:"step",text:`⏳ parked on ${X} open signal subscription${X===1?"":"s"} — waiting for "${U.signalName}"`,elementId:U.elementId}),await new Promise(Ye=>setTimeout(Ye,Ce)),W.current!==C)return P;const ye=b.broadcastSignal(U.signalName,"{}");if(ye){P=ye,R({kind:"vars",text:`📡 broadcasting signal "${U.signalName}" — every waiting subscription unblocks`,elementId:U.elementId});const Ye=(we=P.instances[0])==null?void 0:we.variables;Ye&&he({...Ye}),await new Promise(Vt=>setTimeout(Vt,Ce));continue}R({kind:"error",text:`▶ run stopped — broadcasting signal "${U.signalName}" failed`,elementId:U.elementId})}if($.reason==="timers"){const U=P.timers.reduce((X,ye)=>Math.min(X,ye.dueInMs),1/0);if(Number.isFinite(U)){if(R({kind:"step",text:`⏳ parked on a timer — ${(Math.max(U,0)/1e3).toFixed(1)}s left on the clock`}),await new Promise(ye=>setTimeout(ye,Ce)),W.current!==C)return P;const X=b.advanceTime(Math.max(U,0)+1);if(X){P=X,R({kind:"step",text:"🕐 the clock advanced — timer fired"}),await new Promise(ye=>setTimeout(ye,Ce));continue}}}break}await new Promise(G=>setTimeout(G,Ce))}return W.current!==C||(P&&P.completedInstances>=1?R({kind:"done",text:"✅ process instance completed"}):P&&P.incidentElementIds.length>0&&R({kind:"error",text:"A job failed — incident on the diagram"})),P},[b,R]),nn=g.useCallback(async v=>{var P,fe,me;if(!ke||be.current)return;const{job:x,control:k}=ke,C=++W.current;be.current=!0,J(!0);try{let re,we;if(v==="complete")re=b.completeJobManually(x.jobType,"{}"),we="  ↳ completed normally";else if(k.action.kind==="timer"){const $=((fe=(P=b.snapshot)==null?void 0:P.timers[0])==null?void 0:fe.dueInMs)??0;re=b.advanceTime(Math.max($,0)+1),we="  ↳ advanced the clock — timer fired"}else{const{errorCode:$,message:ie}=k.action;re=b.throwJobError(x.jobType,$,ie),we=`  ↳ threw BPMN error ${$}: ${ie}`}if(re){R({kind:"vars",text:we,elementId:x.elementId});const $=(me=re.instances[0])==null?void 0:me.variables;$&&he({...$}),await new Promise(ie=>setTimeout(ie,Ce)),await $e(Ue.current,Ee.current,re,C)}else R({kind:"error",text:"  ↳ failed to resolve the manual job",elementId:x.elementId})}finally{W.current===C&&(be.current=!1,J(!1))}},[ke,b,R,$e]),Ge=g.useCallback(async()=>{var $;let v=null;try{y.agent&&p.trim()&&(v=Ir(p))}catch(ie){return K(ie instanceof Error?ie.message:String(ie)),null}qe.current={current:void 0};let x;if(e.imageInput){const ie=s.vision;x={read:ie??ki(e.scriptedVision).read,live:!!ie,resolve:U=>b.getRunImage(U)}}const k=Sr(y,f.handlers,R,qe.current,x);for(const ie of Me.keys())delete k[ie];const C={};if(y.agents.length>0){if(s.kind!=="scripted"&&s.chat){const G=new Map;for(const U of y.agents)G.set(U.jobType,[...G.get(U.jobType)??[],U]);for(const[U,X]of G)C[U]=qr(X,s.chat,R,{turnRef:qe.current,requiredTools:e.requiredTools})}else if(v&&y.agent){const G=y.agent.elementId;C[y.agent.jobType]=async U=>{if(U.elementId!==G)throw new Error(`No scripted agent handler for "${U.elementId}" — only "${G}" (the primary process's first agent host) is driven by the scripted brain. Use a live brain to exercise more than one host.`);const X=await v(U),ye=(X.activateElements??[]).map(Ye=>Ye.elementId).join(", ");return R({kind:"agent",text:X.completionConditionFulfilled?"🤖 scripted agent: done":`🤖 scripted agent: calling ${ye||"(nothing)"}`}),X}}}H([]),Oe({});const P=ze;he(P),Ue.current=k,Ee.current=C;const fe=b.redeploy(r),me=(fe==null?void 0:fe[0])??y.processId;R({kind:"start",text:`Starting "${me}" — ${y.agent?s.kind==="scripted"||!s.chat?"scripted brain":`live brain (${s.modelInUse??s.kind})`:"no agent in this model"}`});const re=b.createInstance(me,JSON.stringify(P)),we=($=re==null?void 0:re.instances[0])==null?void 0:$.key;return e.imageInput&&l&&we&&b.setRunImage(we,l),{workers:k,agents:C,snap:re}},[b,e,f,r,p,B,l,ze,y,s,R,Me]),Ie=!!b.snapshot&&b.snapshot.completedInstances<1,Je=!Ie&&!!I&&!gn,wn=g.useCallback(async()=>{if(b.phase!=="ready"||be.current||N||f.hasErrors)return;be.current=!0,J(!0);const v=++W.current;try{let x=Ue.current,k=Ee.current,C=b.snapshot;if(!Ie){if(Le.current&&!Le.current.validate())return;K(null);const P=await Ge();if(!P)return;x=P.workers,k=P.agents,C=P.snap,await new Promise(fe=>setTimeout(fe,Ce))}await $e(x,k,C,v)}finally{W.current===v&&(be.current=!1,J(!1))}},[b,N,f.hasErrors,Ie,Ge,$e]),T=g.useCallback(async()=>{var x;if(b.phase!=="ready"||be.current||N||f.hasErrors)return;be.current=!0,E(!0);const v=++W.current;try{let k=Ue.current,C=Ee.current,P=b.snapshot;if(!Ie){if(Le.current&&!Le.current.validate())return;K(null);const $=await Ge();if(!$)return;k=$.workers,C=$.agents,P=$.snap}if(!P||P.completedInstances>=1)return;const fe=P.takenSequenceFlows.length,me=await b.stepWorkers(k,{agents:C});if(!me){R({kind:"error",text:"⏭ step failed — no dispatch round was returned"});return}const re=(x=me.snapshot.instances[0])==null?void 0:x.variables;re&&he({...re});const we=ui(me.snapshot.takenSequenceFlows,fe);R(hi(me,we,te,Me))}finally{W.current===v&&(be.current=!1,E(!1))}},[b,N,f.hasErrors,Ie,Ge,R,te,Me]),Y=g.useCallback(()=>{be.current=!1,W.current++,J(!1),E(!1),b.reset(),H([]),he({})},[b]),D=g.useCallback(()=>{var k;if(!ve||Se.current&&!Se.current.validate())return;const v=b.completeUserTask(ve.key,JSON.stringify(ge));R({kind:"human",text:`👤 ${ln(ge)}`});const x=(k=v==null?void 0:v.instances[0])==null?void 0:k.variables;he(C=>({...C,...ge,...x??{}})),v&&v.completedInstances>=1&&R({kind:"done",text:"✅ process instance completed"})},[ve,ge,b,R]),Z=g.useMemo(()=>{var v,x;return b.phase==="loading"?i.jsx(oe,{variant:"neutral",children:"Booting engine…"}):b.phase==="error"?i.jsx(oe,{variant:"danger",children:"Engine error"}):se?i.jsx(oe,{variant:"info",children:"Running…"}):N?i.jsx(oe,{variant:"info",children:"Stepping…"}):(((v=b.snapshot)==null?void 0:v.incidentElementIds.length)??0)>0?i.jsx(oe,{variant:"danger",children:"Incident"}):ve?i.jsx(oe,{variant:"warning",children:"Waiting for a human"}):(((x=b.snapshot)==null?void 0:x.completedInstances)??0)>=1?i.jsx(oe,{variant:"success",children:"Completed"}):b.snapshot?i.jsx(oe,{variant:"warning",children:"Paused"}):i.jsx(oe,{variant:"neutral",children:"Ready"})},[b.phase,b.snapshot,se,N,ve]),Ae=g.useMemo(()=>e.blurb.split(/\n\s*\n/).map(v=>v.trim()).filter(Boolean),[e.blurb]);return i.jsxs("div",{className:"runner",children:[i.jsxs("section",{className:"intro",children:[i.jsx("h1",{children:e.title}),Ae.map(v=>i.jsx("p",{children:v},v))]}),e.imageInput&&i.jsx(Ri,{imageInput:e.imageInput,value:l,onSelect:m,disabled:se}),i.jsxs("div",{className:"scenario",children:[i.jsx("span",{className:"scenario-label",id:"scenario-label",children:e.scenariosLabel??"Example input"}),e.scenarios&&i.jsx("div",{className:"scenario-toggle",role:"group","aria-labelledby":"scenario-label",children:e.scenarios.map((v,x)=>i.jsx(q,{size:"sm",variant:x===xe?"default":"secondary","aria-pressed":x===xe,disabled:se,onClick:()=>V(k=>({...k,...v.variables})),children:v.label},v.label))}),i.jsxs("button",{type:"button",className:"scenario-input-button",onClick:()=>ue(!Ne),"aria-expanded":Ne,"aria-controls":"start-input-editor",title:"Edit the starting payload",children:[i.jsx("span",{className:"scenario-edit-icon","aria-hidden":!0,children:"✎"})," ","input: ",i.jsx("code",{children:ro(B)})]}),Je&&i.jsx("span",{className:"scenario-hint",children:"Fill in the input to enable Run"})]}),i.jsxs("div",{className:"inline-input-editor",id:"start-input-editor",hidden:!Ne,children:[i.jsxs("div",{className:"inline-input-editor-head",children:[i.jsxs("div",{children:[i.jsx("div",{className:"inline-input-editor-title",children:y.startFormId?"Start form":"Start payload"}),i.jsx("div",{className:"inline-input-editor-copy",children:y.startFormId?`Rendered from the model's start form "${y.startFormId}".`:"The variables the instance starts with."})]}),i.jsx(q,{size:"sm",variant:"secondary",onClick:()=>ue(!1),children:"Done"})]}),I?i.jsx(g.Suspense,{fallback:i.jsx("div",{className:"form-fallback",children:"Loading form…"}),children:i.jsx(ut,{ref:Le,schema:I,values:B,onChange:(v,x)=>V(k=>({...k,[v]:x})),disabled:se,onValidityChange:je})}):i.jsx("pre",{className:"vars",children:ln(B,2)})]}),(y.agent||e.imageInput)&&i.jsx(Fe,{sectionId:"brain",className:"brain-card","data-tour":Te.brainPanel,title:"Agent brain",description:y.agent?`What drives “${y.agent.label}”. The model recommends; the process governs.`:"What reads the image. The model recommends; the process governs.",children:i.jsx(Di,{brain:s,showText:!!y.agent,showVision:!!e.imageInput})}),i.jsxs("div",{className:"controls",children:[i.jsx(q,{"data-tour":Te.runButton,onClick:()=>void wn(),disabled:b.phase!=="ready"||se||N||f.hasErrors||Je,children:"▶ Run"}),i.jsx(q,{variant:"secondary",onClick:()=>void T(),disabled:b.phase!=="ready"||se||N||f.hasErrors||Je||(((zn=b.snapshot)==null?void 0:zn.completedInstances)??0)>=1,children:"⏭ Step"}),i.jsx(q,{variant:"secondary",onClick:Y,disabled:b.phase!=="ready"||N,children:"↺ Reset"}),e.tour&&i.jsx(q,{variant:"secondary",onClick:M.start,disabled:M.active,children:M.active?"Touring…":`🧭 ${e.tour.label}`}),Z]}),b.phase==="error"&&i.jsxs(de,{variant:"destructive",children:[i.jsx(le,{children:"Engine error"}),i.jsx(ce,{children:b.error})]}),S&&i.jsxs(de,{variant:"destructive",children:[i.jsx(le,{children:"Code didn't compile"}),i.jsx(ce,{children:S})]}),f.hasErrors&&i.jsxs(de,{variant:"destructive",children:[i.jsx(le,{children:"Run is disabled — the diagram has unresolved references"}),i.jsx(ce,{children:i.jsx("ul",{className:"diagnostics",children:f.diagnostics.filter(v=>v.severity==="error").map((v,x)=>i.jsx("li",{children:v.message},x))})})]}),!f.hasErrors&&f.diagnostics.length>0&&i.jsxs(de,{children:[i.jsx(le,{children:"Heads up"}),i.jsx(ce,{children:i.jsx("ul",{className:"diagnostics",children:f.diagnostics.map((v,x)=>i.jsx("li",{children:v.message},x))})})]}),i.jsxs("div",{className:"grid",children:[i.jsxs("div",{className:"col",children:[i.jsx(Fe,{sectionId:"process","data-tour":Te.diagram,title:"Process",description:`${y.processName} — live token (green), incidents (red).`,children:i.jsx(g.Suspense,{fallback:i.jsx("div",{className:"diagram-fallback",children:b.phase==="loading"?"Booting the engine…":"Loading diagram…"}),children:i.jsx(no,{xml:f.resolvedBpmn,activeIds:((On=b.snapshot)==null?void 0:On.activeElementIds)??[],incidentIds:((Un=b.snapshot)==null?void 0:Un.incidentElementIds)??[],className:"diagram"})})}),ve&&i.jsxs(Fe,{sectionId:"human-task",title:(_e==null?void 0:_e.label)??"Human task",description:Pe?`Rendered from the model's form "${_e==null?void 0:_e.formId}".`:"This task has no linked form — complete it with no variables.",children:[en.length>0&&i.jsxs(de,{variant:"destructive",children:[i.jsx(le,{children:"The agent didn't finish its checks"}),i.jsxs(ce,{children:["It completed without running"," ",en.map(v=>v.label||v.elementId).join(", "),". The process took the default path to this task, so the findings below have no value to report."]})]}),Pe&&i.jsx(g.Suspense,{fallback:i.jsx("div",{className:"form-fallback",children:"Loading form…"}),children:i.jsx(ut,{ref:Se,schema:Pe,values:ge,onChange:(v,x)=>Oe(k=>({...k,[v]:x})),context:Q,onValidityChange:_n})}),i.jsx(q,{onClick:D,disabled:!!Pe&&!bn,children:"Complete task"})]}),ke&&i.jsx(Fe,{sectionId:"manual-job",title:ke.control.label,description:"This job is held here on purpose — pick how it resolves.",children:i.jsxs("div",{className:"controls",children:[i.jsx(q,{onClick:()=>void nn("complete"),disabled:se||N,children:ke.control.completeLabel??"✅ Complete normally"}),i.jsx(q,{variant:"secondary",onClick:()=>void nn("action"),disabled:se||N,children:ke.control.action.label})]})})]}),i.jsx("div",{className:"col",children:i.jsx(Yi,{log:L,elementStats:($n=b.snapshot)==null?void 0:$n.elementStats,incidents:(Gn=b.snapshot)==null?void 0:Gn.incidents,labelFor:te,variables:i.jsxs("div",{className:"vars-block","data-tour":Te.variablesPanel,children:[i.jsx("div",{className:"vars-head",children:"Instance variables"}),i.jsx("pre",{className:"vars",children:ln(Object.keys(Q).length>0?Q:ze,2)})]})})})]}),i.jsxs("div",{className:"runner-secondary",children:[i.jsx(Fe,{sectionId:"code",className:"editors","data-tour":Te.codePanel,defaultOpen:!1,title:"Code",description:"One handler per BPMN element, plus a model tab holding the editable diagram — select an element there to edit its properties. Return variables to merge, or throw to fail the job.",children:i.jsx(g.Suspense,{fallback:i.jsx("div",{className:"editor-fallback",children:"Loading editor…"}),children:i.jsxs(er,{value:ae,onValueChange:ne,children:[i.jsxs(nr,{children:[i.jsx(tn,{value:mt,children:"model"}),y.agent&&i.jsx(tn,{value:vn,children:"agent (scripted)"}),e.handlers.map(v=>{var x;return i.jsx(tn,{value:v.elementId,children:((x=y.tasks.find(k=>k.elementId===v.elementId))==null?void 0:x.label)??v.elementId},v.elementId)}),Object.keys(d).map(v=>i.jsx(tn,{value:pt+v,children:v},v))]}),i.jsxs(rn,{value:mt,children:[i.jsxs("div",{className:"editor-meta",children:[i.jsx("strong",{children:"Model"}),i.jsx("code",{children:"click an element to edit its properties on the right — Run re-reads whatever you leave here"}),i.jsx(q,{variant:"secondary",size:"sm",onClick:()=>o(e.bpmn),disabled:r===e.bpmn,children:"Revert to original"})]}),i.jsx(to,{value:r,onChange:o})]}),y.agent&&i.jsxs(rn,{value:vn,children:[i.jsxs("div",{className:"editor-meta",children:[i.jsx("strong",{children:y.agent.label}),i.jsx("code",{children:s.kind==="scripted"||!s.chat?"in use":"unused — a live brain is connected"})]}),i.jsx("div",{className:"editor-wrap",children:i.jsx(Mn,{height:"360px",defaultLanguage:"javascript",value:p,onChange:v=>u(v??""),options:xn})})]}),e.handlers.map(v=>{var x;return i.jsxs(rn,{value:v.elementId,children:[i.jsxs("div",{className:"editor-meta",children:[i.jsx("strong",{children:((x=y.tasks.find(k=>k.elementId===v.elementId))==null?void 0:x.label)??v.elementId}),i.jsx("code",{children:v.standsInFor??v.elementId})]}),i.jsx("div",{className:"editor-wrap",children:i.jsx(Mn,{height:"360px",defaultLanguage:"javascript",value:h[v.elementId],onChange:k=>a(C=>({...C,[v.elementId]:k??""})),options:xn})})]},v.elementId)}),Object.keys(d).map(v=>i.jsxs(rn,{value:pt+v,children:[i.jsxs("div",{className:"editor-meta",children:[i.jsx("strong",{children:v}),i.jsxs("code",{children:["prompt / template text — substitutes"," ","{{"+v+"}}"]})]}),i.jsx("div",{className:"editor-wrap",children:i.jsx(Mn,{height:"360px",defaultLanguage:"markdown",value:d[v],onChange:x=>_(k=>Xe(k,{[v]:x??""})),options:xn})})]},v))]})})}),y.agent&&i.jsx(Fe,{sectionId:"tools",defaultOpen:!1,title:"Tools, as the model sees them",description:i.jsxs(i.Fragment,{children:["Read from the diagram — element name, documentation, and every",i.jsx("code",{children:" fromAi(…)"})," argument."]}),children:i.jsx("ul",{className:"tool-list",children:y.agent.tools.map(v=>i.jsxs("li",{children:[i.jsx("code",{children:v.elementId}),i.jsxs("span",{children:[" — ",v.documentation||v.label]}),v.args.length>0&&i.jsx("ul",{children:v.args.map(x=>i.jsxs("li",{children:[i.jsxs("code",{children:[x.name,": ",x.type]})," ","— ",x.description]},x.name))})]},v.elementId))})})]})]})}const xn={minimap:{enabled:!1},fontSize:13,scrollBeyondLastLine:!1,tabSize:2,automaticLayout:!0},oo=`<?xml version="1.0" encoding="UTF-8"?>\r
