const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/driver-CTZuBZOi.css","assets/diagram-js-DAKGYcfb.css","assets/bpmn-js-BEOU0ddW.css","assets/bpmn-embedded-BFLZ0TIv.css","assets/RuntimeDiagram-DTnJz5cT.js","assets/vendor-react-9Ma26nY1.js","assets/Viewer-D_7S4Gwm.js","assets/MonacoEditor-C9N921Qr.js","assets/MonacoEditor-D6kYW_CN.css","assets/vendor-modeler-BSHvadVJ.js","assets/vendor-design-system-B7LgQvIL.js","assets/vendor-design-system-camx4DLJ.css","assets/parser-DkgAe_kI.js","assets/ModelEditor-Dwlgp6JA.css","assets/FormRenderer-D8wmGgq_.js","assets/FormRenderer-D1JIHOW6.css"])))=>i.map(i=>d[i]);
var Yt=Object.defineProperty;var Qt=(e,n,t)=>n in e?Yt(e,n,{enumerable:!0,configurable:!0,writable:!0,value:t}):e[n]=t;var R=(e,n,t)=>Qt(e,typeof n!="symbol"?n+"":n,t);import{r as g,j as i,i as qt}from"./vendor-react-9Ma26nY1.js";import{B as H,a as oe,L as Qe,S as Nn,b as En,c as kn,d as In,e as Tn,A as ce,f as me,g as pe,I as Gn,C as Jt,h as Ht,i as Wt,j as Zt,k as Kt,l as Xt,T as er,m as nr,n as tn,o as rn,p as tr,q as rr}from"./vendor-design-system-B7LgQvIL.js";(function(){const n=document.createElement("link").relList;if(n&&n.supports&&n.supports("modulepreload"))return;for(const o of document.querySelectorAll('link[rel="modulepreload"]'))r(o);new MutationObserver(o=>{for(const s of o)if(s.type==="childList")for(const l of s.addedNodes)l.tagName==="LINK"&&l.rel==="modulepreload"&&r(l)}).observe(document,{childList:!0,subtree:!0});function t(o){const s={};return o.integrity&&(s.integrity=o.integrity),o.referrerPolicy&&(s.referrerPolicy=o.referrerPolicy),o.crossOrigin==="use-credentials"?s.credentials="include":o.crossOrigin==="anonymous"?s.credentials="omit":s.credentials="same-origin",s}function r(o){if(o.ep)return;o.ep=!0;const s=t(o);fetch(o.href,s)}})();const ir="modulepreload",or=function(e){return"/"+e},Vn={},he=function(n,t,r){let o=Promise.resolve();if(t&&t.length>0){let l=function(a){return Promise.all(a.map(p=>Promise.resolve(p).then(u=>({status:"fulfilled",value:u}),u=>({status:"rejected",reason:u}))))};document.getElementsByTagName("link");const m=document.querySelector("meta[property=csp-nonce]"),h=(m==null?void 0:m.nonce)||(m==null?void 0:m.getAttribute("nonce"));o=l(t.map(a=>{if(a=or(a),a in Vn)return;Vn[a]=!0;const p=a.endsWith(".css"),u=p?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${a}"]${u}`))return;const d=document.createElement("link");if(d.rel=p?"stylesheet":ir,p||(d.as="script"),d.crossOrigin="",d.href=a,h&&d.setAttribute("nonce",h),document.head.appendChild(d),p)return new Promise((b,_)=>{d.addEventListener("load",b),d.addEventListener("error",()=>_(new Error(`Unable to preload CSS for ${a}`)))})}))}function s(l){const m=new Event("vite:preloadError",{cancelable:!0});if(m.payload=l,window.dispatchEvent(m),!m.defaultPrevented)throw l}return o.then(l=>{for(const m of l||[])m.status==="rejected"&&s(m.reason);return n().catch(s)})},ar="io.camunda.agenticai:aiagent",Be="http://www.omg.org/spec/BPMN/20100524/MODEL",sr="http://camunda.org/schema/zeebe/1.0";function jn(e,n){return Array.from(e.getElementsByTagNameNS(sr,n))}function vt(e,n){return jn(e,n).filter(t=>dr(t)===e)}function dr(e){let n=e.parentElement;for(;n;){if(n.namespaceURI===Be&&n.localName!=="extensionElements")return n;n=n.parentElement}return null}function Dn(e){const n=vt(e,"taskDefinition")[0],t=n==null?void 0:n.getAttribute("type");return t||(e.localName==="scriptTask"?e.getAttribute("id")??null:null)}function Yn(e){const n=Array.from(e.children).find(t=>t.namespaceURI===Be&&t.localName==="documentation");return((n==null?void 0:n.textContent)??"").trim()}function Qn(e){if(!e)return"";const n=e.startsWith("=")?e.slice(1):e,t=n.match(/"((?:[^"\\]|\\.)*)"/g);return t?t.map(r=>r.slice(1,-1).replace(/\\n/g,`
...
}`,ts={id:"loan-origination",title:"Loan origination agent",blurb:"An AI agent gathers a loan case with its own tools — customer lookup, credit bureau, an underwriting policy, a status update — then every application passes through a mandatory senior-officer review before a gateway routes it to an offer or a decline. The agent advises; the process governs.",docsUrl:"https://camunda.com/orchestrate/agents/",bpmn:ja,forms:{"loan-application":Ra,"loan-senior-officer-review":Ya},seed:ht,scenarios:[{label:"Strong applicant (policy recommends approve)",variables:ht},{label:"Marginal applicant (policy recommends decline)",variables:Ja}],scriptedAgent:Ha,templates:qa,tour:Ta,requiredTools:["AssessApplication","UpdateApplicationStatus"],handlers:[{elementId:"QueryCustomer",standsInFor:"CRM connector — customer lookup",source:Wa},{elementId:"CreditBureauLookup",standsInFor:"REST connector — credit bureau",source:Za},{elementId:"AssessApplication",standsInFor:"Script task — underwriting policy (FEEL)",source:Ka},{elementId:"UpdateApplicationStatus",standsInFor:"REST connector — origination system",source:Xa},{elementId:"IssueLoanOffer",standsInFor:"REST connector — offer/booking system",source:es},{elementId:"SendDeclineNotice",standsInFor:"REST connector — notifications",source:ns}]},rs=`<?xml version="1.0" encoding="UTF-8"?>
...
}`,rd={id:"plate-recognition",title:"Read a number plate from a photo",blurb:"Pick the plate's country, then a photo goes into the run, an in-browser vision model reads the number plate on the reader's own GPU, and a human confirms or corrects it before the process records the result. The vision model recommends; the BPMN process governs. No server, no API key — with no model connected it falls back to a deterministic scripted reading.",docsUrl:"https://docs.camunda.io/docs/components/modeler/forms/camunda-forms-reference/",bpmn:ks,forms:{"plate-recognition-country":Ws,"plate-recognition-confirm":Ds,"plate-recognition-manual":$s},seed:{country:"auto"},imageInput:{label:"Pick a seed photo (its plate is known, so the scripted reader works offline) or upload your own — a live in-browser model reads a photo it has never seen.",seedImages:Xs},scriptedVision:ed,handlers:[{elementId:"ExtractPlate",standsInFor:"Vision model — Florence-2 <OCR> on WebGPU (in-browser)",source:nd},{elementId:"RecordResult",standsInFor:"Script task — records the governed outcome",source:td}]},id=[cs,Ea,ts,ss,gs,rd],od=Object.assign({"./learn-error-boundary/index.ts":co,"./learn-exclusive-gateway/index.ts":bo,"./learn-message-correlation/index.ts":yo,"./learn-multi-instance-parallel/index.ts":No,"./learn-service-task/index.ts":jo,"./learn-signal-broadcast/index.ts":Do,"./learn-timer-catch-event/index.ts":Fo,"./learn-user-task-form/index.ts":Ho}),ad=Object.values(od).map(e=>e.default).sort((e,n)=>e.id.localeCompare(n.id)),He=[...id,...ad];function Gt(){return"/"}function sd(e=location.pathname){const t=e.match(/^\/examples\/([^/]+)\/?$/);if(t)try{return{kind:"example",id:decodeURIComponent(t[1])}}catch{return{kind:"gallery"}}return{kind:"gallery"}}function dd(e=location.search){return new URLSearchParams(e).get("embed")==="1"}function bt(e){return`${Gt()}examples/${encodeURIComponent(e)}`}const _t="p";function ld(){const e=new URLSearchParams(location.search),n=e.get(_t);if(!n)return!1;const t=n.replace(/[\t\n\r]/g,"");if(!t.startsWith("/")||t.startsWith("//")||t.startsWith("/\\"))return!1;e.delete(_t);try{const r=new URL(Gt(),location.href),o=new URL(t.slice(1),r);return o.origin!==location.origin?!1:(o.search=e.toString(),o.hash=location.hash,history.replaceState(null,"",o),!0)}catch{return!1}}function cd(e,n={}){const t=new URL(location.href);t.pathname=e,t.search=n.search??t.search,n.hash!==void 0&&(t.hash=n.hash),n.replace?history.replaceState(history.state,"",t):history.pushState(history.state,"",t),window.dispatchEvent(new PopStateEvent("popstate"))}function ft(){return{route:sd(),embed:dd()}}function md(){const[e,n]=g.useState(ft);return g.useEffect(()=>{const t=()=>n(ft());return window.addEventListener("popstate",t),()=>window.removeEventListener("popstate",t)},[]),e}const pd="web-demo-framework:height",ud="web-demo-framework:request-height";function hd(e){return{type:pd,height:Math.ceil(e)}}const wt="embed-height-auto";function gd(e){g.useEffect(()=>{if(!e||typeof window>"u"||window.parent===window)return;const n=document.documentElement;n.classList.add(wt);let t=-1;const r=(l=!1)=>{const m=document.documentElement.scrollHeight;!l&&Math.abs(m-t)<2||(t=m,window.parent.postMessage(hd(m),"*"))},o=l=>{if(l.source!==window.parent)return;const m=l.data;!m||m.type!==ud||r(!0)};window.addEventListener("message",o),r();const s=new ResizeObserver(()=>r());return s.observe(n),()=>{s.disconnect(),window.removeEventListener("message",o),n.classList.remove(wt)}},[e])}const yt={headline:"The model *runs*. The code is *yours* to edit.",lede:"Every example on this page is a real BPMN process executing in your browser on the nano WebAssembly engine — edit the model, edit the handlers, swap the LLM, and run it again.",tagline:"Runnable Camunda examples"};function bd({text:e}){return i.jsx(i.Fragment,{children:e.split(/\*([^*]+)\*/g).map((n,t)=>t%2===1?i.jsx("em",{children:n},t):i.jsx(g.Fragment,{children:n},t))})}function _d(){const{route:e,embed:n}=md(),t=zt().brain,r=Qi();gd(n);const o=e.kind==="example"?e.id:He[0].id,s=He.find(u=>u.id===o)??He[0],l=He.filter(u=>u.group!=="learn-bpmn"),m=He.filter(u=>u.group==="learn-bpmn"),h=u=>{cd(bt(u),{hash:location.hash})},a=s.hero??yt,p=i.jsxs(i.Fragment,{children:[!n&&i.jsxs(i.Fragment,{children:[i.jsxs("section",{className:"hero",children:[i.jsx("h1",{children:i.jsx(bd,{text:a.headline})}),a.lede&&i.jsx("p",{children:a.lede})]}),i.jsx("nav",{className:"example-picker","aria-label":"Scenario examples",children:l.map(u=>i.jsx(H,{size:"sm",variant:u.id===s.id?"default":"secondary","aria-current":u.id===s.id?"page":void 0,onClick:()=>h(u.id),children:u.title},u.id))}),m.length>0&&i.jsxs(i.Fragment,{children:[i.jsx("h2",{className:"example-group-heading",id:"learn-bpmn-heading",children:"Learn BPMN"}),i.jsx("nav",{className:"example-picker","aria-labelledby":"learn-bpmn-heading",children:m.map(u=>i.jsx(H,{size:"sm",variant:u.id===s.id?"default":"secondary","aria-current":u.id===s.id?"page":void 0,onClick:()=>h(u.id),children:u.title},u.id))})]})]}),i.jsxs("div",{className:"example-meta",children:[s.docsUrl&&i.jsx("a",{className:"docs-link",href:s.docsUrl,target:"_blank",rel:"noreferrer noopener",children:"View on camunda.com ↗"}),n&&i.jsx("a",{className:"open-full-page",href:bt(s.id)+(location.hash||""),target:"_top",rel:"noreferrer",children:"Open full page ↗"})]}),i.jsx(io,{example:s,initialBrainKind:t,initialTourId:r},s.id)]});return n?i.jsx("div",{className:"c4-ui app-shell app-embed",children:i.jsx("main",{id:"main",className:"layout layout-embed",children:p})}):i.jsxs("div",{className:"c4-ui app-shell",children:[i.jsx(tr,{className:"topbar",logo:i.jsx("span",{className:"brand-dot","aria-hidden":!0}),appName:"Runnable Camunda examples",trailing:i.jsx("span",{className:"app-subtitle",children:a.tagline??yt.tagline})}),i.jsx("main",{id:"main",className:"layout",children:p}),i.jsx("footer",{className:"footer",children:"Running locally in your browser on the nano WebAssembly BPMN engine — no cluster, no server, no data leaving the page."})]})}ld();qt.createRoot(document.getElementById("root")).render(i.jsx(g.StrictMode,{children:i.jsx(rr,{children:i.jsx(_d,{})})}));export{he as _,vd as c};
