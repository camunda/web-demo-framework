import{a as n}from"./index-CMsB8bDT.js";import"./vendor-react-9Ma26nY1.js";import"./vendor-design-system-B2HQUYYn.js";const t=`<?xml version="1.0" encoding="UTF-8"?>
      ...
      <bpmn:serviceTask id="ConvertCurrency" name="Convert currency" zeebe:modelerTemplate="io.camunda.connectors.HttpJson.v2" zeebe:modelerTemplateVersion="13">
        ...
        <bpmn:extensionElements>
          ...
          <zeebe:ioMapping>
            ...
            <zeebe:input source="={&#10;  amount: fromAi(toolCall.amount, &#34;The invoice amount in its original currency, to convert to USD.&#34;, &#34;number&#34;),&#10;  from: fromAi(toolCall.fromCurrency, &#34;The invoice&#39;s original currency as a three-letter ISO-4217 code, taken from the invoice.&#34;, &#34;string&#34;),&#10;  to: &#34;USD&#34;&#10;}" target="queryParameters" />
...
}`,k={...n,bpmn:t,forms:{"invoice-submit":m,"payment-release-request":y,"compliance-signoff":x},seed:e,scenariosLabel:"Invoice to review",scenarios:[{label:"Clean match — invoice equals the PO",variables:e},{label:"Documented overage — 4.5% over, with a reason",variables:{...e,invoiceNumber:"INV-10251",invoiceAmount:4389,invoiceNotes:"Includes pre-approved rush freight surcharge agreed with procurement on 12 Jan."}},{label:"Foreign currency — EUR invoice against a USD PO",variables:{...e,invoiceNumber:"INV-10262",invoiceAmount:3860,invoiceCurrency:"EUR",invoiceNotes:"Quarterly office supplies delivery per PO, billed in euros."}},{label:"Vague justification — 7% over, reason too thin",variables:{...e,invoiceNumber:"INV-10277",invoiceAmount:4494,invoiceNotes:"Additional items supplied."}}],scriptedAgent:C,handlers:[{elementId:"ConvertCurrency",standsInFor:"HTTP connector — api.frankfurter.app exchange rates",source:S},{elementId:"ReleasePayment",standsInFor:"HTTP connector — accounts-payable payment rail",source:D},{elementId:"RecordReleaseDenied",standsInFor:"script task — hand the denial back to the agent",source:T},{elementId:"NotifyVendorDispute",standsInFor:"HTTP connector — vendor dispute notice",source:A}]};export{k as invoicePayment};
