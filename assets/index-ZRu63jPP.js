const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/driver-CTZuBZOi.css","assets/diagram-js-DAKGYcfb.css","assets/bpmn-embedded-BFLZ0TIv.css","assets/RuntimeDiagram-B2IYfHo7.js","assets/vendor-react-9Ma26nY1.js","assets/Viewer-D_7S4Gwm.js","assets/MonacoEditor-BOEpRDyu.js","assets/MonacoEditor-D6kYW_CN.css","assets/vendor-modeler-BqwyI_Cq.js","assets/vendor-design-system-B7LgQvIL.js","assets/vendor-design-system-camx4DLJ.css","assets/parser-DkgAe_kI.js","assets/ModelEditor-Dwlgp6JA.css","assets/FormRenderer-CDiMcKlI.js","assets/FormRenderer-D1JIHOW6.css"])))=>i.map(i=>d[i]);
var Lt=Object.defineProperty;var Pt=(e,n,t)=>n in e?Lt(e,n,{enumerable:!0,configurable:!0,writable:!0,value:t}):e[n]=t;var O=(e,n,t)=>Pt(e,typeof n!="symbol"?n+"":n,t);import{r as h,j as i,i as Rt}from"./vendor-react-9Ma26nY1.js";import{B as Q,a as J,L as Fe,S as _n,b as Mn,c as vn,d as xn,e as Nn,A as le,f as ce,g as de,I as Ln,C as zt,h as Bt,i as Ot,j as Ft,k as Ut,l as $t,T as Yt,m as Gt,n as Xe,o as en,p as Vt,q as Qt}from"./vendor-design-system-B7LgQvIL.js";(function(){const n=document.createElement("link").relList;if(n&&n.supports&&n.supports("modulepreload"))return;for(const r of document.querySelectorAll('link[rel="modulepreload"]'))o(r);new MutationObserver(r=>{for(const a of r)if(a.type==="childList")for(const l of a.addedNodes)l.tagName==="LINK"&&l.rel==="modulepreload"&&o(l)}).observe(document,{childList:!0,subtree:!0});function t(r){const a={};return r.integrity&&(a.integrity=r.integrity),r.referrerPolicy&&(a.referrerPolicy=r.referrerPolicy),r.crossOrigin==="use-credentials"?a.credentials="include":r.crossOrigin==="anonymous"?a.credentials="omit":a.credentials="same-origin",a}function o(r){if(r.ep)return;r.ep=!0;const a=t(r);fetch(r.href,a)}})();const Jt="modulepreload",Ht=function(e){return"/"+e},Pn={},me=function(n,t,o){let r=Promise.resolve();if(t&&t.length>0){let l=function(s){return Promise.all(s.map(c=>Promise.resolve(c).then(g=>({status:"fulfilled",value:g}),g=>({status:"rejected",reason:g}))))};document.getElementsByTagName("link");const u=document.querySelector("meta[property=csp-nonce]"),m=(u==null?void 0:u.nonce)||(u==null?void 0:u.getAttribute("nonce"));r=l(t.map(s=>{if(s=Ht(s),s in Pn)return;Pn[s]=!0;const c=s.endsWith(".css"),g=c?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${s}"]${g}`))return;const p=document.createElement("link");if(p.rel=c?"stylesheet":Jt,c||(p.as="script"),p.crossOrigin="",p.href=s,m&&p.setAttribute("nonce",m),document.head.appendChild(p),c)return new Promise((b,f)=>{p.addEventListener("load",b),p.addEventListener("error",()=>f(new Error(`Unable to preload CSS for ${s}`)))})}))}function a(l){const u=new Event("vite:preloadError",{cancelable:!0});if(u.payload=l,window.dispatchEvent(u),!u.defaultPrevented)throw l}return r.then(l=>{for(const u of l||[])u.status==="rejected"&&a(u.reason);return n().catch(a)})},Zt="io.camunda.agenticai:aiagent",Ie="http://www.omg.org/spec/BPMN/20100524/MODEL",Wt="http://camunda.org/schema/zeebe/1.0";function In(e,n){return Array.from(e.getElementsByTagNameNS(Wt,n))}function ct(e,n){return In(e,n).filter(t=>qt(t)===e)}function qt(e){let n=e.parentElement;for(;n;){if(n.namespaceURI===Ie&&n.localName!=="extensionElements")return n;n=n.parentElement}return null}function Sn(e){const n=ct(e,"taskDefinition")[0],t=n==null?void 0:n.getAttribute("type");return t||(e.localName==="scriptTask"?e.getAttribute("id")??null:null)}function Rn(e){const n=Array.from(e.children).find(t=>t.namespaceURI===Ie&&t.localName==="documentation");return((n==null?void 0:n.textContent)??"").trim()}function zn(e){if(!e)return"";const n=e.startsWith("=")?e.slice(1):e,t=n.match(/"((?:[^"\\]|\\.)*)"/g);return t?t.map(o=>o.slice(1,-1).replace(/\\n/g,`
...
`)}function Kt(e){return ut(dt(e))}function Xt(e){const n=Array.from(e.children).find(t=>t.namespaceURI===Ie&&t.localName==="extensionElements");return n?ut(dt(n)):[]}function ut(e){const n=/fromAi\(\s*toolCall\.([A-Za-z_$][\w$]*)\s*,\s*"((?:[^"\\]|\\.)*)"\s*(?:,\s*"(\w+)")?/g,t=[],o=new Set;for(const r of e.matchAll(n)){const a=r[1];o.has(a)||(o.add(a),t.push({name:a,description:(r[2]??"").replace(/&#10;/g,`
`).replace(/\\"/g,'"').replace(/&quot;/g,'"').replace(/&#39;/g,"'").trim(),type:r[3]??"string"}))}return t}function eo(e){const n={};for(const t of ct(e,"input")){const o=t.getAttribute("target");o&&(n[o]=t.getAttribute("source")??"")}return n}function no(e){return Array.from(e.getElementsByTagNameNS(Ie,"adHocSubProcess")).filter(n=>(Sn(n)??"").startsWith(Zt))}const to=new Set(["subProcess","adHocSubProcess","callActivity"]),oo=new Set(["adHocSubProcess","subProcess","transaction"]);function ro(e){let n=e.parentElement;for(;n;){if(n.namespaceURI===Ie&&oo.has(n.localName))return n;n=n.parentElement}return null}function io(e,n){const t=eo(e),o=Number((t["data.limits.maxModelCalls"]??"").replace(/^=/,""));return{elementId:e.getAttribute("id")??"agent",label:e.getAttribute("name")??"Agent",jobType:Sn(e),systemPrompt:zn(t["data.systemPrompt.prompt"]),userPrompt:zn(t["data.userPrompt.prompt"]),maxModelCalls:Number.isFinite(o)&&o>0?o:10,tools:n}}function so(e,n){var g;const t=e.getAttribute("id")??"",o=e.getAttribute("name")??t,r=no(e);r.length>1&&n.push({severity:"warning",elementId:r.map(p=>p.getAttribute("id")).join(", "),message:`Process "${o}" hosts ${r.length} AI Agent sub-processes (${r.map(p=>p.getAttribute("id")).join(", ")}). Each gets its own independent agent state (turn counter, called tools) — the run itself is shared across hosts, but each host's agent state within it is not.`});const a=[],l=new Map(r.map(p=>[p,[]]));for(const p of Array.from(e.getElementsByTagName("*"))){if(p.namespaceURI!==Ie||r.includes(p))continue;const b=p.getAttribute("id");if(!b)continue;const f=ro(p),_=f&&r.includes(f)?f:null;if(_&&to.has(p.localName)){const I=p.getAttribute("name")??b,D=Rn(p);a.push({elementId:b,label:I,jobType:"",documentation:D,isTool:!0,compound:!0}),l.get(_).push({elementId:b,label:I,jobType:"",documentation:D,args:Xt(p),compound:!0});continue}const y=Sn(p);if(!y)continue;const M={elementId:b,label:p.getAttribute("name")??b,jobType:y,documentation:Rn(p),isTool:_!=null};a.push(M),_&&l.get(_).push({elementId:b,label:M.label,jobType:y,documentation:M.documentation,args:Kt(p)})}const u=r.map(p=>io(p,l.get(p))),m=Array.from(e.getElementsByTagNameNS(Ie,"userTask")).map(p=>{var b;return{elementId:p.getAttribute("id")??"",label:p.getAttribute("name")??p.getAttribute("id")??"",formId:((b=In(p,"formDefinition")[0])==null?void 0:b.getAttribute("formId"))??void 0}}),s=e.getElementsByTagNameNS(Ie,"startEvent")[0],c=s?((g=In(s,"formDefinition")[0])==null?void 0:g.getAttribute("formId"))??void 0:void 0;return{processId:t,processName:o,tasks:a,agents:u,userTasks:m,startFormId:c}}function ao(e,n={}){const t=new DOMParser().parseFromString(e,"application/xml"),o=t.getElementsByTagName("parsererror")[0];if(o)throw new Error(`Invalid BPMN XML: ${o.textContent}`);const r=Array.from(t.getElementsByTagNameNS(Ie,"process"));if(r.length===0)throw new Error("No <bpmn:process> in the diagram.");const a=[],l=r.map(m=>so(m,a));let u=n.processId?l.find(m=>m.processId===n.processId):void 0;return n.processId&&!u&&a.push({severity:"warning",message:`Requested process "${n.processId}" not found — falling back to "${l[0].processId}".`}),u??(u=l[0]),l.length>1&&a.push({severity:"warning",message:`Diagram has ${l.length} <bpmn:process> elements (${l.map(m=>m.processId).join(", ")}); using "${u.processId}" as the active process. Pass a processId to parseModel to target another.`}),{processes:l,diagnostics:a,processId:u.processId,processName:u.processName,tasks:u.tasks,agent:u.agents[0]??null,agents:l.flatMap(m=>m.agents),userTasks:u.userTasks,startFormId:u.startFormId}}function lo(e){return e?e.imageId?{imageId:e.imageId}:e.imageName?{imageName:e.imageName}:{}:{}}function mt(e,n){return n?e.pixels:e.imageId??e.pixels}const co="No image selected — pick or upload a photo to read.";function Bn(){return co}function uo(e,n){return async t=>{const o=e.resolve(n);if(!o)return Bn();const r=mt(o,e.live);if(r===void 0)return Bn();try{return await e.read(r,t)}catch(a){return`Couldn't read the image (${a instanceof Error?a.message:String(a)}).`}}}function mo(e,n){return async()=>{const t=e.resolve(n);if(t)return mt(t,e.live)}}function po(){return`<!doctype html><html><head><meta charset="utf-8"></head><body><script>
    "use strict";
    ...
    post({ kind: "ready" });
  <\/script></body></html>`}function pt(e,n={}){const{timeoutMs:t=5e3,onTrace:o,onVision:r,onImage:a}=n,l=`${Date.now()}-${Math.random().toString(36).slice(2)}`;return new Promise((u,m)=>{const s=document.createElement("iframe");s.setAttribute("sandbox","allow-scripts"),s.style.display="none",s.setAttribute("aria-hidden","true");let c=!1,g;const p=()=>{g&&clearTimeout(g),window.removeEventListener("message",f),s.remove()},b=y=>{c||(c=!0,p(),y())};function f(y){var I;if(y.source!==s.contentWindow)return;const M=y.data;if(!(!M||typeof M!="object")){if(M.kind==="ready"){const D=e.job,G=e.kind==="run-handler"?{kind:"run-handler",id:l,source:e.source,job:D,hasVision:e.hasVision}:{kind:"run-agent",id:l,source:e.source,job:D};(I=s.contentWindow)==null||I.postMessage(G,"*");return}"id"in M&&M.id!==l||(M.kind==="trace"?o==null||o(M.text):M.kind==="vision-request"?_(M.callId,r,"vision",M.prompt):M.kind==="image-request"?_(M.callId,a,"image"):M.kind==="result"?b(()=>u(M.value)):M.kind==="error"&&b(()=>m(new Error(M.message))))}}function _(y,M,I,...D){const G=W=>{var ae;return(ae=s.contentWindow)==null?void 0:ae.postMessage(W,"*")};if(!M){G({kind:"helper-error",id:l,callId:y,message:`${I} helper is not available.`});return}Promise.resolve().then(()=>M(...D)).then(W=>G({kind:"helper-result",id:l,callId:y,value:W}),W=>G({kind:"helper-error",id:l,callId:y,message:W instanceof Error?W.message:String(W)}))}window.addEventListener("message",f),g=setTimeout(()=>{b(()=>m(new Error(`Handler timed out after ${t}ms — the sandboxed run was terminated.`)))},t),s.srcdoc=po(),document.body.appendChild(s)})}function gt(e){return{key:e.key,type:e.type,elementId:e.elementId,instanceKey:e.instanceKey,variables:e.variables??{}}}function go(e,n,t){const o=typeof t.vision=="function";return pt({kind:"run-handler",source:e,job:gt(n),hasVision:o},{onTrace:t.trace,onVision:t.vision?r=>t.vision(r):void 0,onImage:t.image?()=>t.image():void 0})}function ho(e,n){return pt({kind:"run-agent",source:e,job:gt(n)})}function ht(e,n){try{new Function(`"use strict"; return (${e});`)}catch{throw new Error(`${n} has a syntax error.`)}}function bo(e){return ht(e,"Handler code"),(n,t)=>go(e,n,t)}function fo(e){return ht(e,"Agent code"),n=>ho(e,n)}function yo(e,n,t,o){return{sleep:r=>new Promise(a=>setTimeout(a,r)),trace:r=>n({kind:"tool",text:`   ${r}`,elementId:e.elementId,turn:t}),text:(r,a="")=>{const l=e.variables[r];return typeof l=="string"?l:l==null?a:String(l)},num:(r,a=0)=>{const l=e.variables[r],u=typeof l=="number"?l:Number(l);return Number.isFinite(u)?u:a},...o?{vision:uo(o,e.instanceKey),image:mo(o,e.instanceKey)}:{}}}function wo(e){if(e===void 0)return"undefined";try{return JSON.stringify(e)}catch{return"[unserializable value]"}}function _o(e,n,t,o,r){const a={},l=e.processes.flatMap(m=>m.tasks),u=new Map(l.map(m=>[m.elementId,m.label]));for(const m of l)m.compound||a[m.jobType]||(a[m.jobType]=async s=>{const c=n[s.elementId];if(!c)throw new Error(`No handler registered for ${s.elementId} (job type ${s.type})`);const g=u.get(s.elementId)??s.elementId,p=o==null?void 0:o.current;t({kind:"tool",text:`▶ ${g}`,elementId:s.elementId,turn:p});const b=await c(s,yo(s,t,p,r));return t({kind:"vars",text:`  ↳ ${wo(b)}`,elementId:s.elementId,result:b,turn:p}),b});return a}const Mo=/\{\{\s*([A-Za-z][A-Za-z0-9_-]*)\s*\}\}/g;function Ze(...e){const n=Object.create(null);for(const t of e)if(t)for(const o of Object.keys(t))n[o]=t[o];return n}function bt(e){return(e.split("/").pop()??e).replace(/\.[^./]+$/,"")}function ft(e){return e.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;")}function vo(e){return ft(e).replace(/"/g,"&quot;").replace(/\n/g,"&#10;").replace(/\t/g,"&#9;")}function xo(e){return e.replace(/\\/g,"\\\\").replace(/&/g,"&amp;").replace(/"/g,"\\&#34;").replace(/\n/g,"&#10;").replace(/\t/g,"&#9;").replace(/</g,"&lt;").replace(/>/g,"&gt;")}function No(e){return JSON.stringify(e).slice(1,-1)}function Io(e,n){const t=e.lastIndexOf("<",n),o=e.lastIndexOf(">",n);if(t<=o)return"text";const r=e.slice(t,n);if((r.match(/"/g)??[]).length%2===0)return"text";const l=r.lastIndexOf('"');return(r.slice(l+1).match(/&#34;|&quot;/g)??[]).length%2===1?"feel-literal":"attribute"}function ko(e,n,t="xml"){const o=[],r=new Set;return{result:e.replace(Mo,(l,u,m)=>{const s=u.trim();if(!Object.prototype.hasOwnProperty.call(n,s))return r.has(s)||(r.add(s),o.push(s)),l;const c=n[s];if(t==="json")return No(c);const g=Io(e,m);return g==="feel-literal"?xo(c):g==="attribute"?vo(c):ft(c)}),unresolved:o}}function Eo(){return{processes:[],diagnostics:[],processId:"",processName:"",tasks:[],agent:null,agents:[],userTasks:[],startFormId:void 0}}function To(e,n={},t=e.bpmn,o={}){const r=[],a=Ze(e.templates,o),{result:l,unresolved:u}=ko(t,a,"xml");for(const M of u)r.push({severity:"warning",message:`Template placeholder "{{${M}}}" has no matching prompt/template content — left in the model as-is, not substituted.`});let m;try{m=ao(l)}catch(M){return r.push({severity:"error",message:M instanceof Error?M.message:String(M)}),{resolvedBpmn:l,model:Eo(),handlers:{},forms:{},diagnostics:r,hasErrors:!0}}r.push(...m.diagnostics);const s=m.processes.flatMap(M=>M.tasks),c=new Map(e.handlers.map(M=>[M.elementId,M.source])),g={};for(const M of s){if(M.compound)continue;const I=n[M.elementId]??c.get(M.elementId);if(I===void 0){r.push({severity:"error",elementId:M.elementId,jobType:M.jobType,message:`No handler for "${M.label}" (${M.elementId}, job type "${M.jobType}"). Add a handler for this element, or remove it from the diagram.`});continue}try{g[M.elementId]=bo(I)}catch(D){r.push({severity:"error",elementId:M.elementId,jobType:M.jobType,message:`"${M.label}" (${M.elementId}): handler code didn't compile — ${D instanceof Error?D.message:String(D)}`})}}const p=new Set(s.map(M=>M.elementId)),b=new Set([...c.keys(),...Object.keys(n)]);for(const M of b)p.has(M)||r.push({severity:"error",elementId:M,message:`Handler "${M}" doesn't match any element in the current diagram — likely orphaned by a rename. Rename it back, or remove the handler.`});const f={},_=e.forms??{},y=(M,I)=>{if(!M)return;const D=_[M];D?f[M]=D:r.push({severity:"error",formId:M,message:`${I} references form "${M}", which has no matching schema.`})};for(const M of m.processes){y(M.startFormId,`The start event of process "${M.processName}"`);for(const I of M.userTasks)y(I.formId,`User task "${I.label}" (${I.elementId})`)}return{resolvedBpmn:l,model:m,handlers:g,forms:f,diagnostics:r,hasErrors:r.some(M=>M.severity==="error")}}function jo(e){const n=e.indexOf("{");if(n<0)return null;let t=0;for(let o=n;o<e.length;o++)if(e[o]==="{")t++;else if(e[o]==="}"&&(t--,t===0))try{const r=JSON.parse(e.slice(n,o+1));return typeof r=="object"&&r!==null&&!Array.isArray(r)?r:null}catch{return null}return null}function kn(e,n=220){const t=e.replace(/\s+/g," ").trim();return t.length>n?`${t.slice(0,n-1)}…`:t}function On(e){const n=e.arguments??e.args??e.parameters??e.input;return n&&typeof n=="object"&&!Array.isArray(n)?n:{}}function Fn(e){if(!e)return[];const n=e.tool??e.name??e.action;if(typeof n=="string"&&n.trim())return[{name:n.trim(),args:On(e)}];const t=e.tools??e.tool_calls??e.toolset??e.actions,o=Array.isArray(t)?t:Object.values(e).find(a=>Array.isArray(a))??[],r=[];for(const a of o)if(typeof a=="string")a.trim()&&r.push({name:a.trim(),args:{}});else if(a&&typeof a=="object"){const l=a,u=l.name??l.tool??l.id??l.function;typeof u=="string"&&u.trim()&&r.push({name:u.trim(),args:On(l)})}return r}function So(e){if(!e)return!1;const n=e.done??e.finished??e.complete;return typeof n=="boolean"?n:typeof n=="string"?n.toLowerCase()==="true":!1}function Un(e){const n=e.args.length?e.args.map(o=>`      ${o.name} (${o.type}) — ${o.description}`).join(`
`):"      (none)",t=e.documentation||e.label;return`${e.elementId}
    purpose: ${t}
    arguments:
${n}`}function Ao(e,n,t){const o=e.systemPrompt||"You are an agent driving a business process. Use the tools available to you.",r=t[0]??e.tools[0];if(t.length===0)return`${o}
...
character, with nothing added. When your work is finished, reply exactly
{"done": true} and no tool.`}function Co(e,n,t,o,r=[],a=[],l=!1){const u=e.userPrompt||"Carry out your task.",m=Object.entries(n).filter(([,c])=>typeof c=="string"&&c.trim().length>0).map(([c,g])=>`  ${c}: ${String(g)}`),s=[u,m.length?`Case data:
${m.join(`
...
`,qr=`Please verify export compliance for this shipment and notify the team of your decision.\r
`,Kr={id:"compliance-walkthrough",label:"Take the tour",steps:[{title:"Start a run",description:"Press Run to send a shipment through the compliance agent.",target:{anchor:Me.runButton}},{title:"The agent picks its own tools",description:"This AI Agent reads the shipment notes and decides, turn by turn, which of the tools below it to call — nothing here is hard-coded into a fixed sequence.",target:{elementId:"ComplianceCheckAgent"}},{title:"Watch the token move",description:"The agent's first move is to look up the genetic marker mentioned in the notes.",target:{elementId:"VerifyGeneticMarker"},waitFor:{kind:"activeElement",elementId:"VerifyGeneticMarker"}},{title:"A cleared shipment notifies the export team",description:"Once the compliance score comes back clean, the process notifies the export team automatically — no human review needed for this scenario.",target:{elementId:"NotifyExportTeam"},waitFor:{kind:"elementCompleted",elementId:"NotifyExportTeam"}},{title:"Everything the run recorded",description:"The variables panel shows the marker record, the country lookup, the compliance score, and the final decision — exactly what each tool and the agent wrote along the way.",target:{anchor:Me.variablesPanel}}],successEvent:{kind:"instanceCompleted"}},Xr=`<?xml version="1.0" encoding="UTF-8"?>
...
}`,Ii={id:"seed-export-compliance",title:"Seed export compliance agent",blurb:"An AI agent picks its own tools to check a shipment, then a gateway routes on its decision — cleared shipments notify the export team, flagged ones go to a human. The LLM recommends; the BPMN process governs.",docsUrl:"https://camunda.com/blog/agentic-ai/",bpmn:Xr,forms:{"seed-export-shipment-ready":ai,"seed-export-compliance-review":hi},seed:{scenario:tt,shipmentNotes:""},scenarios:[{label:"Likely cleared (TP53 → Brazil)",variables:{scenario:tt,shipmentNotes:""}},{label:"Likely flagged (BRCA1 → Germany)",variables:{scenario:yi,shipmentNotes:""}}],scriptedAgent:wi,templates:fi,tour:Kr,requiredTools:["RecordComplianceDecision"],handlers:[{elementId:"VerifyGeneticMarker",standsInFor:"JDBC connector — UCSC hg38",source:_i},{elementId:"CheckDestinationCountry",standsInFor:"GraphQL connector — countries API",source:Mi},{elementId:"ComputeComplianceScore",standsInFor:"REST connector — api.mathjs.org",source:vi},{elementId:"RecordComplianceDecision",standsInFor:"Script task — FEEL",source:xi},{elementId:"NotifyExportTeam",standsInFor:"REST connector — httpbin.io",source:Ni}]},ki=`You are a loan origination assistant at a retail bank. Your job is to gather everything a senior loan officer needs to decide an application — you do **not** decide it yourself.
...
}`,ts={id:"loan-origination",title:"Loan origination agent",blurb:"An AI agent gathers a loan case with its own tools — customer lookup, credit bureau, an underwriting policy, a status update — then every application passes through a mandatory senior-officer review before a gateway routes it to an offer or a decline. The agent advises; the process governs.",docsUrl:"https://camunda.com/orchestrate/agents/",bpmn:ji,forms:{"loan-application":zi,"loan-senior-officer-review":Vi},seed:ot,scenarios:[{label:"Strong applicant (policy recommends approve)",variables:ot},{label:"Marginal applicant (policy recommends decline)",variables:Hi}],scriptedAgent:Zi,templates:Ji,tour:Ti,requiredTools:["AssessApplication","UpdateApplicationStatus"],handlers:[{elementId:"QueryCustomer",standsInFor:"CRM connector — customer lookup",source:Wi},{elementId:"CreditBureauLookup",standsInFor:"REST connector — credit bureau",source:qi},{elementId:"AssessApplication",standsInFor:"Script task — underwriting policy (FEEL)",source:Ki},{elementId:"UpdateApplicationStatus",standsInFor:"REST connector — origination system",source:Xi},{elementId:"IssueLoanOffer",standsInFor:"REST connector — offer/booking system",source:es},{elementId:"SendDeclineNotice",standsInFor:"REST connector — notifications",source:ns}]},os=`<?xml version="1.0" encoding="UTF-8"?>
...
}`,as={id:"order-process",title:"Order process with service workers",blurb:"The getting-started order process: check inventory, charge payment, ship. No agent and no human step — the same runner, driven entirely by what's in the diagram.",docsUrl:"https://docs.camunda.io/docs/next/guides/getting-started-orchestration-cluster/",bpmn:os,seed:{item:"camunda-t-shirt",quantity:3},handlers:[{elementId:"Activity_0tw2fu0",standsInFor:"job worker — check-inventory",source:rs},{elementId:"Activity_1ppsbgi",standsInFor:"job worker — charge-payment",source:is},{elementId:"Activity_08pg6im",standsInFor:"job worker — ship-items",source:ss}]},ls=`<?xml version="1.0" encoding="UTF-8"?>\r
...
}`,oa={id:"plate-recognition",title:"Read a number plate from a photo",blurb:"Pick the plate's country, then a photo goes into the run, an in-browser vision model reads the number plate on the reader's own GPU, and a human confirms or corrects it before the process records the result. The vision model recommends; the BPMN process governs. No server, no API key — with no model connected it falls back to a deterministic scripted reading.",docsUrl:"https://docs.camunda.io/docs/components/modeler/forms/camunda-forms-reference/",bpmn:ks,forms:{"plate-recognition-country":Ws,"plate-recognition-confirm":Ls,"plate-recognition-manual":$s},seed:{country:"auto"},imageInput:{label:"Pick a seed photo (its plate is known, so the scripted reader works offline) or upload your own — a live in-browser model reads a photo it has never seen.",seedImages:Xs},scriptedVision:ea,handlers:[{elementId:"ExtractPlate",standsInFor:"Vision model — Florence-2 <OCR> on WebGPU (in-browser)",source:na},{elementId:"RecordResult",standsInFor:"Script task — records the governed outcome",source:ta}]},on=[ds,Ii,ts,as,hs,oa];function At(){return"/"}function ra(e=location.pathname){const t=e.match(/^\/examples\/([^/]+)\/?$/);if(t)try{return{kind:"example",id:decodeURIComponent(t[1])}}catch{return{kind:"gallery"}}return{kind:"gallery"}}function ia(e=location.search){return new URLSearchParams(e).get("embed")==="1"}function sa(){return At()}function it(e){return`${At()}examples/${encodeURIComponent(e)}`}function st(e,n={}){const t=new URL(location.href);t.pathname=e,t.search=n.search??t.search,n.hash!==void 0&&(t.hash=n.hash),n.replace?history.replaceState(history.state,"",t):history.pushState(history.state,"",t),window.dispatchEvent(new PopStateEvent("popstate"))}function at(){return{route:ra(),embed:ia()}}function aa(){const[e,n]=h.useState(at);return h.useEffect(()=>{const t=()=>n(at());return window.addEventListener("popstate",t),()=>window.removeEventListener("popstate",t)},[]),e}const la="web-demo-framework:height",ca="web-demo-framework:request-height";function da(e){return{type:la,height:Math.ceil(e)}}const lt="embed-height-auto";function ua(e){h.useEffect(()=>{if(!e||typeof window>"u"||window.parent===window)return;const n=document.documentElement;n.classList.add(lt);let t=-1;const o=(l=!1)=>{const u=document.documentElement.scrollHeight;!l&&Math.abs(u-t)<2||(t=u,window.parent.postMessage(da(u),"*"))},r=l=>{if(l.source!==window.parent)return;const u=l.data;!u||u.type!==ca||o(!0)};window.addEventListener("message",r),o();const a=new ResizeObserver(()=>o());return a.observe(n),()=>{a.disconnect(),window.removeEventListener("message",r),n.classList.remove(lt)}},[e])}function ma(){const{route:e,embed:n}=aa(),t=Et().brain,o=Br();ua(n);const r=e.kind==="example"?e.id:on[0].id,a=on.find(m=>m.id===r)??on[0],l=m=>{st(it(m),{hash:location.hash})},u=i.jsxs(i.Fragment,{children:[!n&&e.kind==="gallery"&&i.jsx("nav",{className:"example-picker",children:on.map(m=>i.jsx(Q,{size:"sm",variant:m.id===a.id?"default":"secondary",onClick:()=>l(m.id),children:m.title},m.id))}),!n&&e.kind==="example"&&i.jsx("div",{className:"example-nav",children:i.jsx(Q,{size:"sm",variant:"secondary",onClick:()=>st(sa()),children:"← All examples"})}),i.jsxs("div",{className:"example-meta",children:[a.docsUrl&&i.jsx("a",{className:"docs-link",href:a.docsUrl,target:"_blank",rel:"noreferrer noopener",children:"View on camunda.com ↗"}),n&&i.jsx("a",{className:"open-full-page",href:it(a.id)+(location.hash||""),target:"_top",rel:"noreferrer",children:"Open full page ↗"})]}),i.jsx(Zr,{example:a,initialBrainKind:t,initialTourId:o},a.id)]});return n?i.jsx("div",{className:"c4-ui app-shell app-embed",children:i.jsx("main",{id:"main",className:"layout layout-embed",children:u})}):i.jsxs("div",{className:"c4-ui app-shell",children:[i.jsx(Vt,{appName:"Runnable Camunda examples",trailing:i.jsx("span",{className:"app-subtitle",children:"model + code + optional LLM, in your browser"})}),i.jsx("main",{id:"main",className:"layout",children:u})]})}Rt.createRoot(document.getElementById("root")).render(i.jsx(h.StrictMode,{children:i.jsx(Qt,{children:i.jsx(ma,{})})}));export{me as _,ba as c};
