import{p as i}from"./index-BvRnL2ci.js";import"./vendor-react-9Ma26nY1.js";import"./vendor-design-system-B2HQUYYn.js";const a="/web-demo-framework/assets/de-bmw-mini-JBSk7QcF.jpg",r="/web-demo-framework/assets/de-bmw-mini.thumb-CUUmJrRO.jpg",d="/web-demo-framework/assets/uk-d651-rnb-XGipy2QN.jpg",m="/web-demo-framework/assets/uk-d651-rnb.thumb-mjEcbhUf.jpg",l="/web-demo-framework/assets/uk-mk70-orj-Cn6O3Xfm.jpg",s="/web-demo-framework/assets/uk-mk70-orj.thumb-CaeZ2vqU.jpg",p="/web-demo-framework/assets/uk-ni-ijz-8992-YXV44tgk.jpg",c="/web-demo-framework/assets/uk-ni-ijz-8992.thumb-DYwok8jV.jpg",u="/web-demo-framework/assets/us-hyundai-genesis-gGpAIEpi.jpg",b="/web-demo-framework/assets/us-hyundai-genesis.thumb-DEEt19Mw.jpg",g=`<?xml version="1.0" encoding="UTF-8"?>
...
}`,$={...i,bpmn:g,forms:{"plate-recognition-country":J,"plate-recognition-confirm":R,"plate-recognition-manual":T},seed:{country:"auto"},imageInput:{label:"Pick a seed photo (its plate is known, so the scripted reader works offline) or upload your own — a live in-browser model reads a photo it has never seen.",seedImages:U},scriptedVision:K,handlers:[{elementId:"ExtractPlate",standsInFor:"Vision model — Florence-2 <OCR> on WebGPU (in-browser)",source:L},{elementId:"RecordResult",standsInFor:"Script task — records the governed outcome",source:W}]};export{$ as plateRecognition};
